...
**已知問題：** [Microsoft 知識庫文件編號 935807](http://support.microsoft.com/kb/935807) 詳細記錄了目前已知安裝此安全性更新可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e9b64746-6afa-4a30-833d-e058e000c821">Windows Vista (英文下載更新程式)</a>
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=e9b64746-6afa-4a30-833d-e058e000c821">Windows Vista (中文下載更新程式)</a></td>
<td style="border:1px solid black;">資訊洩漏</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=0df5d190-3ad7-42d5-8629-43c47ec450cb">Windows Vista x64 Edition (英文下載更新程式)</a>
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=0df5d190-3ad7-42d5-8629-43c47ec450cb">Windows Vista x64 Edition (中文下載更新程式)</a></td>
<td style="border:1px solid black;">資訊洩漏</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
...
Microsoft 更新這個公告與相關安全性更新以解決 [Microsoft 知識庫文件編號 935807](http://support.microsoft.com/kb/935807)中識別的問題，這些問題會影響到 Windows Vista，在 LogFiles\\Firewall 資料夾遺失或該檔案毀損的情況下會造成更新安裝失敗。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2007-3038](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3038)。
...
感謝[賽門鐵克](http://www.symantec.com/index.jsp)的 Jim Hoagland 和 Ollie Whitehouse 回報 Windows Vista 防火牆封鎖規則資訊洩漏弱點 – CVE-2007-3038
...
-   V2.0 (2007 年 8 月 15 日)： 此更新已修訂並重新發行，以解決 [Microsoft 知識庫文件編號 935807](http://support.microsoft.com/kb/935807) 中所述之問題。
