...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|----------------|
| Windows 2000 Service Pack 4 [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=5b8e728c-cb9f-4176-93a0-bf42d6387f93)│[中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=5b8e728c-cb9f-4176-93a0-bf42d6387f93)                                                                         | 阻絕服務       | 中度           |
| Windows XP Service Pack 2 [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=8615e6f3-415b-4c23-ba52-7eef70a11d77)│[中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=8615e6f3-415b-4c23-ba52-7eef70a11d77)                                                                           | 遠端執行程式碼 | 重大           |
| Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2 [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=7e994340-c616-4f66-845b-7eaf095e968a)                                                                                                                                               | 遠端執行程式碼 | 重大           |
| Windows Server 2003 Service Pack 1 與 Windows Server 2003 Service Pack 2 [英文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=39e6c6d2-7e6f-4992-a731-36f44fe2d87f)│[中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=39e6c6d2-7e6f-4992-a731-36f44fe2d87f)          | 阻絕服務       | 重要           |
| Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2 [英文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=da424772-079c-4351-9759-8886e0f1ba79)│[中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=da424772-079c-4351-9759-8886e0f1ba79) | 阻絕服務       | 重要           |
| Windows Server 2003 SP1 for Itanium-based Systems 和 Windows Server 2003 SP2 for Itanium-based Systems [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=028592ff-2b69-472e-b186-bd2cc76bdfa4)                                                                                                                                  | 阻絕服務       | 重要           |
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2007-2218](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-2218)。
...
**什麼是 Schannel？**  
安全通道 (Schannel) 安全性套件是執行安全通訊端層 (SSL) 和傳輸層安全性 (TLS) 網際網路標準驗證通訊協定的安全性支援提供者 (SSP)。 Schannel 是提供驗證服務以在用戶端和伺服器之間提供安全通訊的安全性套件之一部分。 如需更多關於 Schannel 的資訊，請造訪下列 [MSDN 網站](https://msdn2.microsoft.com/en-us/library/ms678421.aspx) (英文)。
...
**注意：**您可以在同一個命令中合併使用這些參數。 為符合回溯相容性，安全性更新程式也支援舊版安裝程式使用的安裝參數。 如需有關支援的安裝參數的其他資訊，請參閱 [Microsoft 知識庫文件編號 262841](https://support.microsoft.com/kb/262841)。如需更多關於安裝程式套件的相關資訊，請造訪 [Microsoft TechNet 網站](https://go.microsoft.com/fwlink/?linkid=38951)(英文)。
...
**注意：**如需受支援版本的完整清單，請參閱[支援週期索引](https://support.microsoft.com/gp/lifeselectindex/)。 如需 Service Pack 的完整清單，請參閱[週期支援的 Service Pack](https://support.microsoft.com/gp/lifesupsps)。 如需支援週期原則的詳細資訊，請參閱[Microsoft 產品技術支援週期網站](https://support.microsoft.com/lifecycle/)。
...
**注意：**您可以在同一個命令中合併使用這些參數。 為符合回溯相容性，安全性更新程式也支援舊版安裝程式使用的安裝參數中的許多參數。 如需有關支援的安裝參數的其他資訊，請參閱 [Microsoft 知識庫文件編號 262841](https://support.microsoft.com/kb/262841)。如需更多關於安裝程式套件的相關資訊，請造訪 [Microsoft TechNet 網站](https://go.microsoft.com/fwlink/?linkid=38951)(英文)。
