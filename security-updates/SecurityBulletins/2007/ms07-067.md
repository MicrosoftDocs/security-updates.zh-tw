...
這個安全性更新也能解決 [Microsoft 安全性摘要報告 944653](https://technet.microsoft.com/security/advisory/944653) 中首先提出的弱點。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2007-5587](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-5587)。
...
是。 當本安全性公告初次發行時，此弱點尚未被公開揭發。 這項弱點已被指派一般性弱點編號 [CVE-2007-5587](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-5587)。Microsoft 安全性摘要報告 944653 首先說明此弱點。
