...
下列軟體已經過測試判斷哪些版本會受到影響。 其他版本超過它們的支援週期或不受影響。 若要瞭解您的軟體版本的支援週期，請造訪 [Microsoft 產品技術支援週期網站](https://go.microsoft.com/fwlink/?linkid=21742)。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=812e62c5-6e19-4b3b-8a10-861b871e1b41">Microsoft Windows 2000 Server Service Pack 4 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=812e62c5-6e19-4b3b-8a10-861b871e1b41">Microsoft Windows 2000 Server Service Pack 4 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=28e84603-8159-4429-aaff-a1020531e84f">Windows Server 2003 Service Pack 1 與 Windows Server 2003 Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=28e84603-8159-4429-aaff-a1020531e84f">Windows Server 2003 Service Pack 1 與 Windows Server 2003 Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=107902f9-be94-457f-a936-519efbd64779">Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=107902f9-be94-457f-a936-519efbd64779">Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e5e5b425-fe7d-49d5-973f-f3fd7a1e04eb">Windows Server 2003 SP1 for Itanium-based Systems 和 Windows Server 2003 SP2 for Itanium-based Systems (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
**我安裝了 ADAM，該怎麼辦？**    
此弱點程式碼在 ADAM Service Pack 1 中不存在。但 ADAM Service Pack 1 之前的版本的確含有弱點程式碼。建議您安裝 ADAM Service Pack 1。 如需更多有關 ADAM Service Pack 1 的資訊，請造訪 [ADAM SP1 下載網站](https://www.microsoft.com/download/details.aspx?familyid=9688f8b9-1034-4ef6-a3e5-2a2a57b5c8e4&displaylang=en)。
...
如需更多有關 ADAM 的資訊，請參閱 [Active Directory Application Mode 簡介](https://www.microsoft.com/windowsserver2003/adam/default.mspx) (英文)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2007-0040](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0040)。
...
-   **在防火牆封鎖下列項目：**  
    ...
    此連接埠可用來起始與受影響元件的連線。 在企業防火牆封鎖此連接埠 (含輸入及輸出) 有助於保護防火牆後的系統免遭此弱點的影響。 建議您封鎖所有網際網路中來路不明的輸入通訊，以防他人利用其他連接埠攻擊系統。 如需更多關於連接埠的資訊，請造訪 [TCP 和 UDP 連接埠的指派](https://go.microsoft.com/fwlink/?linkid=21312) (英文)。
...
**什麼是 LDAP？**    
[LDAP](https://msdn2.microsoft.com/en-us/library/aa503238.aspx) (輕量型目錄存取通訊協定) 是一種業界標準通訊協定，可讓獲授權的使用者查詢或修改中繼目錄的資料。 在 Windows Server 2000 和 Windows Server 2003 中便是利用 LDAP 通訊協定來存取 Active Directory 內的資料。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2007-3028](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3028)。
...
-   **在防火牆封鎖下列項目：**  
    ...
    上述連接埠用於起始與受影響元件的連線。 在企業防火牆封鎖這些連接埠 (含輸入及輸出) 有助於保護防火牆後的系統免遭此弱點的影響。 建議您封鎖所有網際網路中來路不明的輸入通訊，以防他人利用其他連接埠攻擊系統。 如需更多關於連接埠的資訊，請造訪 [TCP 和 UDP 連接埠的指派](https://go.microsoft.com/fwlink/?linkid=21312) (英文)。
...
-   感謝 [NGSSoftware](https://www.nextgenss.com/) 的 Peter Winter-Smith 回報 Windows Active Directory 拒絕服務弱點 -CVE-2007-3028。
-   感謝 [IBM Internet Security Systems x-Force](https://xforce.iss.net/) 的 Neel Mehta 回報 Windows Active Directory 遠端執行程式碼弱點 - CVE-2007-0040。
