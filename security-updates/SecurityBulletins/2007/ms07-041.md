...
**已知問題：** [Microsoft 知識庫文件編號 939373](http://support.microsoft.com/kb/939373) 詳細記錄了目前已知安裝此安全性更新可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=fccbfe90-f838-47df-8310-352e2fb47132">Microsoft Internet Information Service (IIS) 5.1 (英文下載更新程式)</a>
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=fccbfe90-f838-47df-8310-352e2fb47132">Microsoft Internet Information Service (IIS) 5.1 (中文下載更新程式)</a></td>
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2005-4360](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2005-4360)。
...
-   **使用 URLScan 2.5**   
    安裝 [URLScan](http://www.microsoft.com/technet/security/tools/urlscan.mspx) 能協助防止受影響系統遭到嘗試利用此弱點的攻擊。  
    1.  使用預設 URLScan.ini 設定來安裝 URLScan。  
    2.  重新啟動 IISAdmin 與 WWW Publishing 等服務讓變更生效。  
-   **為了防範利用此弱點的網路攻擊，請使用以下項目封鎖對連接埠 80 (TCP) 的存取：**  
  
    -   Windows 防火牆。  
    -   網際網路通訊協定安全性 (IPsec)。 如需更多關於 IPSec 及如何套用篩選的資訊，請參閱 [Microsoft 知識庫文件編號 313190](http://support.microsoft.com/kb/313190) 與 [Microsoft 知識庫文件編號 813878](http://support.microsoft.com/kb/813878)。
...
-   感謝 [Watchfire](http://www.watchfire.com/) 的 Jonathan Afek 和 Adi Sharabani 協助 Microsoft 解決 IIS 記憶體要求弱點 (CVE-2005-4360) 並提供該弱點之額外相關資訊。
-   或謝 [NGSSoftware](http://www.ngssoftware.com/) 的 Peter Winter-Smith 協助 Microsoft 解決 IIS 記憶體要求弱點 (CVE-2005-4360) 並提供該弱點之額外相關資訊。
