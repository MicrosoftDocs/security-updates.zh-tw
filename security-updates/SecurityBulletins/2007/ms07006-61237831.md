...
-   Microsoft Windows XP Service Pack 2 — [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=f821b3a0-4e5a-4737-b9bf-1249f6683f4d)│[中文下載更新程式](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&familyid=f821b3a0-4e5a-4737-b9bf-1249f6683f4d)
-   Microsoft Windows XP Professional x64 Edition — [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=75abff9b-c2b5-4151-b366-4be652882944)
-   Microsoft Windows Server 2003 和 Microsoft Windows Server 2003 Service Pack 1 — [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=418acc52-0ebd-4623-81a7-5eacc21c3965)│[中文下載更新程式](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&familyid=418acc52-0ebd-4623-81a7-5eacc21c3965)
-   Microsoft Windows Server 2003 for Itanium-based Systems 及 Microsoft Windows Server 2003 SP1 for Itanium-based Systems — [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=dc33a2fc-2d01-4577-b133-017493d1f278)
-   Microsoft Windows Server 2003 x64 Edition — [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=c3e55066-b34e-485d-ac04-179f8e3a407a)
...
|--------------------------------------------------------------------------------------------------------------------------|------------|---------------------------|---------------------|------------------------------------|
| Windows Shell Hardware Detection 弱點 - [CVE-2007-0211](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0211) | 權限提高   | 重要                      | 重要                | 重要                               |
...
|-------------------------------------------------------------------------|-----------------------------|---------------------------|---------------------|------------------------------------|
| [**MS06-045**](http://technet.microsoft.com/security/bulletin/ms06-045) | 不適用                      | 取代                      | 取代                | 取代                               |
...
作業系統執行新硬體的偵測與註冊作業的方式中，存在 Windows Shell [權限提高](http://go.microsoft.com/fwlink/?linkid=21142)的弱點。 這項弱點可能讓經過驗證的使用者取得完整控制權。
...
**這個弱點的範圍為何？**  
這是[權限提高](http://go.microsoft.com/fwlink/?linkid=21142)弱點。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 攻擊者必須擁有有效的系統登入認證並執行程式，才能利用這項弱點。
...
這兩個弱點都存在於 Windows Shell 中，而這個更新可解決一項 [MS06-045](http://technet.microsoft.com/security/bulletin/ms06-045) 尚未涵蓋的弱點。MS06-045 能完全保護該公告中所提及的弱點，但是它並沒有對這個新弱點提供解決之道。 此更新程式會取代 MS06-045。您必須安裝此更新程式，讓系統不受這兩個弱點的影響。
