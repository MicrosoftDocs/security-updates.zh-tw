...
-   感謝 Piotr Bania 與 [TippingPoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/)合作回報 Windows Media Player 執行程式碼弱點解壓縮面板 - CVE-2007-3035。
-   感謝 Piotr Bania 與 [TippingPoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作回報 Windows Media Player 執行程式碼弱點剖析面板 - CVE-2007-3037。
-   感謝 [IOActive](https://www.ioactive.com) 的 Dan Kaminsky 回報 [Microsoft 知識庫文件編號 940893](https://support.microsoft.com/kb/940893) 中描述的 Windows Media Player 深度防禦變更
