...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=83d94d8e-dda6-4d74-b40d-476c2f0a3af4">英文下載更新程式</a>│<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=83d94d8e-dda6-4d74-b40d-476c2f0a3af4">中文下載更新程式</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5e09d13b-d4b0-48fd-9880-73c180570267">英文下載更新程式</a>│<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=5e09d13b-d4b0-48fd-9880-73c180570267">中文下載更新程式</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9d93c0ce-5124-4234-ba84-3c27005e010f">Microsoft Excel 2003 Service Pack 2(英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=9d93c0ce-5124-4234-ba84-3c27005e010f">Microsoft Excel 2003 Service Pack 2(中文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=11f42977-8828-494a-a183-d1aba827b708">Microsoft Excel 2003 Viewer(英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=11f42977-8828-494a-a183-d1aba827b708">Microsoft Excel 2003 Viewer(中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-023">MS07-023</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/mac/downloads.aspx?pid=download&amp;location=/mac/download/office2004/office2004_1136.xml&amp;secid=4&amp;ssid=35&amp;flgnosysreq=true">Microsoft Office 2004 for Mac(英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-023">MS07-023</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9ab28283-0320-4527-b033-5e80ef32cd34">Microsoft Office Excel 2007 英文下載更新程式</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=9ab28283-0320-4527-b033-5e80ef32cd34">Microsoft Office Excel 2007 中文下載更新程式</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-023">MS07-023</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e592ae5b-09ac-4f5b-b457-a54c9850ad4a">適用於 Word、Excel 及 PowerPoint 2007 檔案格式的 Microsoft Office 相容性套件(英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=e592ae5b-09ac-4f5b-b457-a54c9850ad4a">適用於 Word、Excel 及 PowerPoint 2007 檔案格式的 Microsoft Office 相容性套件(中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-023">MS07-023</a></td>
</tr>
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2007-1756](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-1756)。
...
-   **開啟未知或不信任來源的檔案時，使用 Microsoft Office Isolated Conversion Environment (MOICE)**  
    ...
    適用於 Word、Excel 及 PowerPoint 2007 檔案格式的 Microsoft Office 相容性套件新增的 Microsoft Office Isolated Conversion Environment (MOICE) 功能可讓您更安全地開啟 Word、Excel 和 PowerPoint 二進位格式檔案。 如需更多有關 MOICE 的詳細資訊，請參閱以下 [Microsoft 知識庫文件編號 935865](https://support.microsoft.com/kb/935865)。
    ...
    **因應措施的影響：** 以 MOICE 轉換為 2007 Microsoft Office System Open XML 格式的 Office 2003 和先前格式化的文件無法保留巨集功能。 此外，附有密碼或以數位版權管理保護的文件則無法轉換。
    ...
    -   **使用 Microsoft Office 檔案封鎖原則來封鎖開啟來自於未知或不信任來源與位置的 Office 2003 和先前文件。**  
        ...
        **因應措施的影響：** 使用者若設定檔案封鎖原則、但尚未依照 Microsoft [知識庫文件編號 92248](https://support.microsoft.com/kb/922848) 所討論設定特殊的「豁免目錄」，將無法在 Office 2003 或 2007 Microsoft Office System 中開啟 Office 2003 檔案或先前版本。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2007-3029](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3029)。
...
-   **開啟未知或不信任來源的檔案時，使用 Microsoft Office Isolated Conversion Environment (MOICE)**  
    ...
    適用於 Word、Excel 及 PowerPoint 2007 檔案格式的 Microsoft Office 相容性套件內含的 Microsoft Office Isolated Conversion Environment (MOICE) 功能可讓您更安全地開啟 Word、Excel 和 PowerPoint 二進位格式檔案。 如需更多有關 MOICE 的詳細資訊，請參閱以下 [Microsoft 知識庫文件編號 935865](https://support.microsoft.com/kb/935865)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2007-3030](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3030)。
...
**Windows Vista 注意事項：** Microsoft 未支援安裝 MBSA 2.0.1 到執行 Windows Vista 的系統，但您可先將 MBSA 2.0.1 安裝在受支援的作業系統，再從遠端掃描 Windows Vista 系統。 如需有關 Windows Vista 的 MBSA 支援之其他資訊，請造訪 [MBSA 網站](https://www.microsoft.com/technet/security/tools/mbsahome.mspx)。 亦可參閱 [Microsoft 知識庫文件編號 931943](https://support.microsoft.com/kb/931943)： Windows Vista 的 Microsoft Baseline Security Analyzer (MBSA) 支援。
  
**注意：**MBSA 1.2.1 使用的 Office Detection Tool (ODT) 整合版本不支援此安全性更新的遠端掃描。 如需有關 MBSA 的詳細資訊，請造訪 MBSA 網站 &lt;[https://go.microsoft.com/fwlink/?LinkId=21134](https://go.microsoft.com/fwlink/?linkid=21134)&gt;。
...
-   您的電腦上必須安裝有 [Microsoft Office 2004 for Mac 11.3.5 Update](https://www.microsoft.com/mac/downloads.aspx?pid=download&location=/mac/download/office2004/office2004_1135.xml&secid=4&ssid=33&flgnosysreq=true)。  
...
從 [Microsoft Mactopia 網站](https://www.microsoft.com/mac/downloads.aspx?pid=download&location=/mac/download/office2004/office2004_1136.xml&secid=4&ssid=35&flgnosysreq=true)下載並安裝適當語言版本的 Microsoft Office 2004 for Mac 11.3.6 Update。
...
<td style="border:1px solid black;"><strong>移除資訊</strong></td>
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具。
<strong>注意：</strong>當您移除此更新時，系統可能會提示您在 CD 光碟機中插入 2007 Microsoft Office System CD。 此外，您可能沒有從 [控制台] 內 [新增或移除程式] 工具中解除安裝更新的選項。 這個問題有數個可能的原因。 如需更多關於移除程式的資訊，請參閱 <a href="https://support.microsoft.com/kb/903771">Microsoft 知識庫文件編號 903771</a>。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">如需完整的檔案資訊清單，請參閱本節中的＜檔案資訊＞小節</td>
...
**注意：**當您移除此更新時，系統可能會提示您在 CD 光碟機中插入 2007 Microsoft Office system CD。 此外，您可能沒有從 \[控制台\] 內 \[新增或移除程式\] 工具中解除安裝更新的選項。 這個問題有數個可能的原因。 如需更多關於移除程式的資訊，請參閱 [Microsoft 知識庫文件編號 903771](https://support.microsoft.com/kb/903771)。
