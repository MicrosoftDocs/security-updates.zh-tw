...
|-----------------------------------------------------------------------------------------------------------|----------------|-----------------------------|---------------------------|-----------------------------------------------------------|
| OLE 對話方塊記憶體損毀弱點 - [CVE-2007-0026](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0026) | 遠端執行程式碼 | 重要                        | 重要                      | 重要                                                      |
...
-   感謝 [Immunity, Inc.](https://www.immunityinc.com/) 的 Kostya Kortchinsky 和 [EADS Common Research Center](https://www.eads.net/) 的 Fabrice Desclaux 回報 OLE 對話方塊記憶體損毀弱點 (CVE-2007-0026)。
