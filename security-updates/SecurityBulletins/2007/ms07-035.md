...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|----------------|---------------------------------------------------------------------|
| Windows 2000 Service Pack 4 [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=3918ac76-ebb6-4886-9a9e-808eafb96b1b)│[中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=3918ac76-ebb6-4886-9a9e-808eafb96b1b)                                                       | 遠端執行程式碼 | 重大           | [MS06-051](https://technet.microsoft.com/security/bulletin/ms06-051) |
| Windows XP Service Pack 2 [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=27c7f1b9-2d1d-40cb-ad7e-bfedb6156a9c)│[中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=27c7f1b9-2d1d-40cb-ad7e-bfedb6156a9c)                                                         | 遠端執行程式碼 | 重大           | [MS06-051](https://technet.microsoft.com/security/bulletin/ms06-051) |
| Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2 [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=0ba12191-1e6f-443b-9150-7ab8b2deb7c2)                                                                                                                             | 遠端執行程式碼 | 重大           | [MS06-051](https://technet.microsoft.com/security/bulletin/ms06-051) |
| Windows Server 2003 Service Pack 1 與 Windows Server 2003 Service Pack 2 [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=d554dff4-bcfb-4bbc-8fa0-af2f939d2610)│[中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=d554dff4-bcfb-4bbc-8fa0-af2f939d2610)          | 遠端執行程式碼 | 重大           | [MS06-051](https://technet.microsoft.com/security/bulletin/ms06-051) |
| Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2 [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=170473d8-6bb1-4fbd-8494-a059dbfdf182)│[中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=170473d8-6bb1-4fbd-8494-a059dbfdf182) | 遠端執行程式碼 | 重大           | [MS06-051](https://technet.microsoft.com/security/bulletin/ms06-051) |
| Windows Server 2003 SP1 for Itanium-based Systems 和 Windows Server 2003 SP2 for Itanium-based Systems [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=f5e45e3c-4cac-41a5-99f7-42c2c2c73e99)                                                                                                                | 遠端執行程式碼 | 重大           | [MS06-051](https://technet.microsoft.com/security/bulletin/ms06-051) |
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2007-2219](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-2219)。
...
**什麼是 Win32 API？**    
Microsoft Win32 應用程式發展介面 (API) 提供所有 Windows 應用程式使用的 32 位元服務。 您可以為應用程式提供圖形化使用者介面；存取系統資源 (如記憶體和裝置)；顯示圖形和格式化文字；整合音訊、視訊、網路或安全性。 如需更多資訊，請參閱 [Microsoft 程式開發人員網路](https://msdn2.microsoft.com/en-us/library/aa383750.aspx) (英文)。
...
-   感謝 [VeriSign](https://www.verisign.com) 的 Billy Rios 回報 Win32 API 弱點 (CVE-2007-2219)。
