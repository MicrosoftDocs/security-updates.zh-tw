...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2007-0934](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0934)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2007-0936](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0936)。
...
-   對於 Microsoft Office XP 支援版本，請參閱＜建立管理安裝點＞。 如需更多有關如何將用戶端系統的來源從更新的管理安裝點變更到 Office XP 原始基準來源或 Service Pack 3 (SP3) 之詳細資訊，請參閱 [Microsoft 知識庫文件編號 922665](https://support.microsoft.com/kb/922665)。    
...
**注意：**在受管理的環境中工作的系統管理員可以在 Office Admin Update Center 上，找到用於在組織中部署 Office 更新的完整資源。 在該網站上，向下捲動並在＜更新資源＞部分下尋找您要更新的軟體版本。 [Windows Installer Documentation](https://go.microsoft.com/fwlink/?linkid=21685) 也提供有關 Windows Installer 支援的安裝參數的其他資訊。
...
感謝 [Vigilant Minds](https://www.vigilantminds.com/) 的 Chris Ries 回報 Visio 文件包裝弱點 – (CVE-2007-0936)。
