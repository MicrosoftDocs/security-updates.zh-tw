...
|-----------------------------------------------------------------------------------------------------------------|----------------|-----------------------------|---------------------------|---------------------|------------------------------------|
| HTML Help ActiveX 控制項弱點 - [CVE-2007-0214](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0214) | 遠端執行程式碼 | 重大                        | 重大                      | 中度                | 中度                               |
...
|-------------------------------------------------------------------------|-----------------------------|---------------------------|---------------------|------------------------------------|
| [**MS06-046**](https://technet.microsoft.com/security/bulletin/ms06-046) | 取代                        | 取代                      | 取代                | 取代                               |

**安裝此安全性更新後，已知可能會發生的問題有哪些？**  
[Microsoft 知識庫文件編號 928843](https://support.microsoft.com/kb/928843) 詳細記錄了目前已知安裝此安全性更新可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。
...
-   **暫時避免在 Internet Explorer 中執行 HTML Help ActiveX 控制項**  
    ...
    **警告：**如果使用「登錄編輯程式」的方式錯誤，可能造成嚴重問題，以致於您必須重新安裝作業系統。   Microsoft 無法保證您可以解決因為不正確使用「登錄編輯程式」所造成的問題。 請自行承擔使用「登錄編輯程式」的風險。  
    ...
    如需在 Internet Explorer 中停止執行 ActiveX 控制項的詳細步驟，請參閱 [Microsoft 知識庫文件編號 240797](https://support.microsoft.com/kb/240797)。請按照這些步驟，並在登錄中建立 Compatibility Flags 值，以避免在 Internet Explorer 中產生 HTML Help ActiveX 控制項。  
...
Microsoft [HTML Help](https://msdn.microsoft.com/library/en-us/htmlhelp/html/vsconhh1start.asp) 是 Windows 平台的標準說明系統。 HTML Help ActiveX 控制項是用來將說明導覽及輔助視窗功能插入 HTML 檔案中的程式 (Hhctrl.ocx)。 HTML Help ActiveX 控制項是設計搭配 Internet Explorer 和 Shdocvw.dll 元件使用。 Shdocvw.dll 向其主機公開介面，讓系統將其當成 ActiveX 控制項分別主控。 Shdocvw.dll 元件也常被稱為 WebBrowser 控制項。 如需更多關於 HTML Help ActiveX 控制項的資訊，請參閱[產品說明文件](https://msdn.microsoft.com/library/en-us/htmlhelp/html/vsconocxov.asp)和 HTML HELP API 支援。
...
-   感謝 [BreakingPoint Systems](https://www.bpointsys.com/) 的 HD Moore 協助 Microsoft 解決 HTML Help 的弱點 (CVE-2007-0214)。
