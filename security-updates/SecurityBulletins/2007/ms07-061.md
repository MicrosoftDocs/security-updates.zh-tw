...
此安全性更新還可解決先前在 [Microsoft 安全性摘要報告 943521](https://technet.microsoft.com/security/advisory/943521) 中所描述的弱點。如需更多資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的常見問題集小節。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8ba1c2f9-1bde-4e97-b327-21259c5e5104">Windows XP Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=8ba1c2f9-1bde-4e97-b327-21259c5e5104">Windows XP Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms06-045">MS06-045</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4ef7fdd7-8887-4c64-a70c-c6ae734d7c5f">Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms06-045">MS06-045</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e5d8a866-2c1f-4035-8325-c1be61a75c3b">Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=e5d8a866-2c1f-4035-8325-c1be61a75c3b">Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms06-045">MS06-045</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=bf26da08-15b8-4d65-ba12-4cc74c7a1326">Windows Server 2003 x64 Edition 和 Windows 2003 Server x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=bf26da08-15b8-4d65-ba12-4cc74c7a1326">Windows Server 2003 x64 Edition 和 Windows 2003 Server x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms06-045">MS06-045</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1c055f11-3273-4a4c-a33f-bf61ac9ec4c5">Windows Server 2003 SP1 for Itanium-based Systems 和 Windows Server 2003 SP2 for Itanium based Systems (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms06-045">MS06-045</a></td>
</tr>
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2007-3896](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3896)。
...
是。 當本安全性公告初次發行時，此弱點尚未被公開揭發。 這項弱點已被指派一般性弱點編號 [CVE-2007-3896](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3896)。此弱點先前已描述於 [Microsoft 安全性摘要報告 943521](https://technet.microsoft.com/security/advisory/943521)。

**當本安全性公告發行時，Microsoft 是否已接獲任何消息，指出這項弱點已遭有心人士利用？**  
是。 當本安全性公告發行時，Microsoft 已接獲本弱點已遭有心人士惡用的訊息。

**套用本安全性更新是否可以保護客戶避免受到已公開發佈利用這項弱點的惡意程式碼攻擊？**  
是。 本安全性更新解決目前遭到利用的這項弱點。 列出的弱點已被指派一般性弱點編號 [CVE-2007-3896](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3896)。
...
**注意：**如需受支援版本的完整清單，請參閱[支援週期索引](https://support.microsoft.com/gp/lifeselectindex/)。 如需 Service Pack 的完整清單，請參閱[週期支援的 Service Pack](https://support.microsoft.com/gp/lifesupsps)。 如需支援週期原則的詳細資訊，請參閱[Microsoft Baseline](https://support.microsoft.com/lifecycle/)。
...
-   感謝 [Secunia](https://secunia.com/) 的 Carsten H.Eiram 協助我們解決 Windows URI 處理弱點 (CVE-2007-3896)。
-   感謝 [Finjan](https://www.finjan.com/) 的 Aviv Raff 協助我們解決 Windows URI 處理弱點 (CVE-2007-3896)。
-   感謝 [GNUCITIZEN](https://www.gnucitizen.org/) 的 Petko Petkov 協助我們解決 Windows URI 處理弱點 (CVE-2007-3896)。
