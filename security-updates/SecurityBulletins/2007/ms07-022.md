...
-   Microsoft Windows 2000 Service Pack 4 — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=b3599afb-7673-4ef6-a2b1-d77e39fd782c)│[中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=b3599afb-7673-4ef6-a2b1-d77e39fd782c)
-   Microsoft Windows XP Service Pack 2 — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=eeaee4a7-4858-4b6b-9c6d-a9f1eae19b51)│[中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=eeaee4a7-4858-4b6b-9c6d-a9f1eae19b51)
-   Microsoft Windows Server 2003、Microsoft Windows Server 2003 Service Pack 1 和 Microsoft 2003 Service Pack 2 — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=5e94a29c-7ec0-4459-92eb-d43b524fd6fd)│[中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=5e94a29c-7ec0-4459-92eb-d43b524fd6fd)
...
|---------------------------------------------------------------------------------------------------------|------------|---------------------------------------|-------------------------------------|-------------------------------|----------------------------------------------|----------------------------------------------|
| 核心本機權限提高弱點 - [CVE-2007-1206](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-1206) | 權限提高   | 重要                                  | 重要                                | 重要                          | 重要                                         | 重要                                         |
...
如需更多此問題的相關資訊，請參閱 [Microsoft 知識庫文件編號 931784](https://support.microsoft.com/kb/931784/)。[Microsoft 知識庫文件編號 931784](https://support.microsoft.com/kb/931784/) 詳細記錄了目前已知安裝這個修訂過的安全性更新後可能會發生的問題。
...
|-------------------------------------------------------------------------|---------------------------------------|-------------------------------------|-------------------------------|----------------------------------------------|----------------------------------------------|
| [**MS06-049**](https://technet.microsoft.com/security/bulletin/ms06-049) | 取代                                  | 不適用                              | 不適用                        | 不適用                                       | 不適用                                       |
...
**必要條件**  
這個安全性更新需要 Windows XP Service Pack 2。如需更多關於如何取得最新 Windows XP Service Pack 的資訊，請參閱 Microsoft 知識庫文件編號 322389。如需更多關於如何如何取得 Windows XP Professional Service Pack 2 的資訊，請參閱[下載中心](https://www.microsoft.com/download/details.aspx?familyid=893fd6c0-6283-44c3-bb84-b2f0315b2ae6&displaylang=en)。
...
-   感謝 [eEye](https://www.eeye.com/) 回報核心本機權限提高弱點 (CVE-2007-1206)。

**取得其他安全性更新：**  

其他安全性問題的更新可由下列位置取得：

-   安全性更新可以從 [Microsoft 下載中心](https://go.microsoft.com/fwlink/?linkid=21129)取得。 您也可以利用 "security patch" 關鍵字搜尋輕易地找到安全性更新。
