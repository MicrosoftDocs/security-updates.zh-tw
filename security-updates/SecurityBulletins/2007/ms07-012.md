...
若想瞭解如何透過 Software Update Services 部署這個安全性更新，請造訪 [Software Update Services 網站](https://go.microsoft.com/fwlink/?linkid=21125)。 如需更多關於利用 Windows Server Update Services 部署安全性更新的資訊，請造訪 [Windows Server Update Services 網站](https://www.microsoft.com/taiwan/windowsserversystem/updateservices/evaluation/overview.mspx)。
...
-   感謝 [Immunity, Inc.](https://www.immunityinc.com/) 的 Kostya Kortchinsky 和 [EADS Common Research Center](https://www.eads.net/) 的 Fabrice Desclaux 回報 MFC 記憶體損毀弱點 (CVE-2007-0025)。
...
-   V1.1 (2007 年 2 月 21 日) 公告更新： 電子郵件攻擊模式已加入其他說明。 當使用者與 RTF 電子郵件訊息內格式錯誤的內嵌 OLE 物件進行互動時，攻擊者也可能會嘗試利用此弱點。 本公告也因安全性更新發現有新問題而修訂，詳見[Microsoft 知識庫文件編號 924667](https://support.microsoft.com/?kbid=924667)。
