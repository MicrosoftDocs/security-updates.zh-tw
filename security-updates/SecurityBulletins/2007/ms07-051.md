...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7cd248ed-d154-4dce-89ef-ceefd2700965">Microsoft Windows 2000 Service Pack 4 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=7cd248ed-d154-4dce-89ef-ceefd2700965">Microsoft Windows 2000 Service Pack 4 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-020">MS07-020</a></td>
</tr>
</tbody>
</table>
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2007-3040](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3040)。
...
-   **暫時避免在 Internet Explorer 中執行 Agent ActiveX 控制項**  
    ...
    **警告：**如果使用「登錄編輯程式」的方式錯誤，可能造成嚴重問題，以致於您必須重新安裝作業系統。 Microsoft 無法保證您可以解決因為不正確使用 \[登錄編輯程式\] 所造成的問題。 請自行承擔使用「登錄編輯程式」的風險。
    ...
    -   [群組原則群組原則物件編輯器？](https://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/techref/47ba1311-6cca-414f-98c9-2d7f99fca8a3.mspx)  
...
**什麼是 Microsoft Agent？**  
Microsoft Agent 是 Microsoft Windows 作業系統的元件，它會使用互動式動畫字元來引導使用者，並可讓電腦的使用和學習更加容易。 如需更多資訊，請瀏覽 [Microsoft Agent 網站](https://www.microsoft.com/msagent/default.asp) (英文)。
...
-   感謝 [Assurent Secure Technologies](https://www.assurent.com/) 的 Vulnerability Research 團隊回報 Agent 遠端執行程式碼弱點 - [CVE-2007-3040](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3040)
-   感謝 [Palo Alto Networks](https://www.paloaltonetworks.com/) 的 Yamata Li 回報 Agent 遠端執行程式碼弱點 - [CVE-2007-3040](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3040)
-   感謝匿名研究人員與 VeriSign [iDefense VCP](https://labs.idefense.com/) 合作，共同回報 Agent 遠端執行程式碼弱點 - [CVE-2007-3040](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3040)
