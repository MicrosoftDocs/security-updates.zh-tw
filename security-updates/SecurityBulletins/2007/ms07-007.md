...
-   Microsoft Windows XP Service Pack 2 — [下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=ce695e0e-938c-4fc6-a9a2-0eb9fc3e5512)│[下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=ce695e0e-938c-4fc6-a9a2-0eb9fc3e5512)
...
|-------------------------------------------------------------------------------------------------------------------|------------|---------------------------|
| Windows Image Acquisition 弱點 - [CVE-2007-0210](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0210) | 權限提高   | 重要                      |
...
在 Windows XP Service Pack 2 中，Window Image Acquisition 服務啟動應用程式的方式存在一個[權限提高](https://go.microsoft.com/fwlink/?linkid=21142)的弱點。 這項弱點可能讓已登入系統的使用者取得完整控制權。
...
**這個弱點的範圍為何？**  
這是[權限提高](https://go.microsoft.com/fwlink/?linkid=21142)弱點。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 如果要嘗試利用此弱點，攻擊者必須能夠從本機登入系統並執行程式。

**造成這個弱點的原因為何？**  
Windows Image Acquisition 服務中的未檢查緩衝區。

**什麼是 Windows Image Acquisition 服務 (WIA)？**  
Windows Image Acquisition (WIA) 可啟用影像處理程式 (例如 Microsoft Picture It! 2000、Kodak Imaging 或 Adobe Photoshop)，以便與數位相機和掃描器等影像處理裝置進行通訊。 WIA 可支援數位相機與低階和高階掃描器；也能讓您從 [IEEE 1394](https://www.1394ta.org/technology/) 型的數位影片 (DV) 錄影機和通用序列匯流排 (USB) 網路攝影機中擷取靜止影像。
