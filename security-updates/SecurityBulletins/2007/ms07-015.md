...
-   Microsoft Office 2000 Service Pack 3 — [英文下載更新程式 (KB 929062)](https://www.microsoft.com/download/details.aspx?familyid=20e089e7-7dd3-44a4-abfe-6d8c27721683)│[中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=20e089e7-7dd3-44a4-abfe-6d8c27721683)
    ...
    -   Microsoft Word 2000
-   Microsoft Office XP Service Pack 3 — [英文下載更新程式 (KB926063)](https://www.microsoft.com/download/details.aspx?familyid=c54b1fda-1237-48f7-ad19-f0830ee0e8ff)│[中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=c54b1fda-1237-48f7-ad19-f0830ee0e8ff)
    ...
    -   Microsoft Word 2002
-   Microsoft Office 2003 Service Pack 2 — [英文下載更新程式 (KB929064)](https://www.microsoft.com/download/details.aspx?familyid=bb0973e7-275d-4491-9ba1-91eaea84eefd)│[中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=bb0973e7-275d-4491-9ba1-91eaea84eefd)
...
-   Microsoft Project 2000 Service Release 1 — [英文下載更新程式 (KB929062)](https://www.microsoft.com/download/details.aspx?familyid=3df54b5c-cb82-4a99-9b90-edab38ad6310)│[中文下載更新程式 (KB929062)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=3df54b5c-cb82-4a99-9b90-edab38ad6310)
-   Microsoft Project 2002 Service Pack 1 — [英文下載更新程式 (KB929063)](https://www.microsoft.com/download/details.aspx?familyid=419191dc-01b8-4e2a-ba5b-71bf3066c169)│[中文下載更新程式 (KB929063)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=419191dc-01b8-4e2a-ba5b-71bf3066c169)
-   Microsoft Visio 2002 Service Pack 2 — [英文下載更新程式 (KB929063)](https://www.microsoft.com/download/details.aspx?familyid=f50a5111-0926-4221-96df-18294230ed1e)│[英文下載更新程式 (KB929063)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=f50a5111-0926-4221-96df-18294230ed1e)
-   Microsoft Office 2004 for Mac — [下載更新程式 (KB932185)](https://www.microsoft.com/taiwan/mac/)
...
|----------------------------------------------------------------------------------------------------------------------------|----------------|-----------------------|---------------------|-----------------------|-------------------------------|
| PowerPoint 格式錯誤的記錄記憶體損毀弱點 - [CVE-2006-3877](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3877) | 遠端執行程式碼 | 重大                  | 重要                | 重要                  | 重要                          |
| Excel 格式錯誤的記錄弱點 - [CVE-2007-0671](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0671)                | 遠端執行程式碼 | 重大                  | 重要                | 重要                  | 重要                          |
...
|-------------------------------------------------------------------------|-----------------------|---------------------|----------------|-------------------------------|
| [**MS06-062**](https://technet.microsoft.com/security/bulletin/ms06-062) | 取代                  | 取代                | 取代           | 取代                          |

**安裝此安全性更新後，已知可能會發生的問題有哪些？**  
[Microsoft 知識庫文件編號 932554](https://support.microsoft.com/kb/932554) 詳細記錄了目前已知安裝此安全性更新可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。 如需更多資訊，請參閱 [Microsoft 知識庫文件編號 932554](https://support.microsoft.com/kb/932554)。  
[Microsoft 知識庫文件編號 XXXXX](https://support.microsoft.com/kb/912918)：
...
SMS 使用 MBSA 進行偵測。 因此，SMS 也會面臨與 MBSA 相同的限制，而無法偵測部分程式；請參閱本公告先前所述說明。**注意：**若您已利用管理安裝點來部署 Office 2000 或 Office XP，並且已從原始基準更新 AIP 的話，則可能無法使用 SMS 來部署此更新。 如需更多有關如何將用戶端電腦的來源從更新的管理安裝點變更到 Office 2003 原始基準來源或 Service Pack 2 (SP2) 之詳細資訊，請參閱 [Microsoft 知識庫文件編號 902349](https://support.microsoft.com/kb/902349)。
...
-   必須安裝 Office 2000 Service Pack 3 (SP3)。 安裝此更新之前，請先安裝 [Office 2000 SP3](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=5c011c70-47d0-4306-9fa4-8e92d36332fe)。如需有關如何安裝 Office 2000 SP3 的其他資訊，請參閱 [Microsoft 知識庫文件編號 326585](https://support.microsoft.com/default.aspx?scid=kb;%5bln%5d;326585)。
-   若要安裝 Project 2000 Service Release 1 (SR1) 更新程式，則必須安裝 Project 2000 Service Release 1 (SR1)。 安裝此更新之前，請先安裝 Project 2000 SR1。如需有關如何安裝 Project 2000 SR1 的詳細資訊，請參閱 [Microsoft 知識庫文件編號 288953](https://support.microsoft.com/kb/288953)。
...
如果要讓 [Office Update 網站](https://office.microsoft.com/zh-tw/downloads/default.aspx)偵測電腦必須安裝的更新，請造訪 Office Update 網站，然後按一下 \[檢查更新\]。 偵測完成後，您會收到建議的更新清單供您確認。 按一下 \[同意並安裝\] 以完成程序。
...
1.  [下載 Office 2000 的安全性更新](https://download.microsoft.com/download)及/或 [Project 2000 Service Pack 1](https://download.microsoft.com/download/7/e/0/7e09640b-1bfb-426a-87e9-2c452d458560/project2000-kb929062-fullfile-enu.exe)。
...
-   必須安裝 Office XP Service Pack 3 (SP3)。 安裝此更新之前，請先安裝 [Office XP SP3](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=85af7bfd-6f69-4289-8bd1-eb966bcdfb5e)。如需有關如何安裝 Office XP SP3 的其他資訊，請參閱 [Microsoft 知識庫文件編號 832671](https://support.microsoft.com/kb/832671)。
-   若要安裝 Project 2002 Service Pack 1 (SP1) 更新程式，必須安裝 Project 2002 Service Pack 1 (SP1)。 安裝此更新程式之前，請先安裝 Project 2000 SR1。如需有關如何安裝的更多資訊，請參閱 [Project 2002 Service Pack 1 (SP1)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=d64ea65b-9519-4061-9b3a-32af1a9bf888)。
...
1.  [下載 Office XP 的安全性更新](https://download.microsoft.com/download/a/8/1/a81b5bde-c873-44a6-8eab-026139ab8c47/officexp-kb929063-fullfile-enu.exe)及/或 [Project 2002 Service Pack 1](https://download.microsoft.com/download/2003/5/2/5238f1f9-f4bb-45ea-ad83-b84f4434895c/project2002-kb929063-fullfile-enu.exe) 及/或 [Visio 2002 Service Pack 2](https://download.microsoft.com/download/2003/1/1/113f4037-a4d1-4af8-a5b3-dac87e255808/visio2002-kb929063-fullfile-enu.exe)。
2.  按一下 \[將程式存到磁碟\]，然後按一下 \[確定\]。
3.  按一下 \[儲存\]。
4.  在 Windows 檔案總管中，尋找包含已儲存檔案的資料夾，然後按兩下儲存的檔案。
5.  如果系統提示您安裝更新程式，請按一下 \[是\]。
...
1.  [下載 Office 2003 的安全性更新。](https://download.microsoft.com/download/1/e/9/1e99615b-adca-4722-9bc6-4069ace587d9/office2003-kb929064-fullfile-enu.exe)
2.  按一下 \[將程式存到磁碟\]，然後按一下 \[確定\]。
3.  按一下 \[儲存\]。
4.  在 Windows 檔案總管中，尋找包含已儲存檔案的資料夾，然後按兩下儲存的檔案。
5.  如果系統提示您安裝更新程式，請按一下 \[是\]。
...
-   感謝 [VigilantMinds Inc.](https://www.microsoft.com/technet/security/bulletin/www.vigilantminds.com) 的 Chris Ries 回報 PowerPoint 格式錯誤的記錄記憶體損毀弱點 (CVE-2006-3877)。
