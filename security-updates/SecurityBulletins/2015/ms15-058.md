...
<td style="border:1px solid black;">
[**SQL Server 權限提高弱點 - CVE-2015-1761**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-1761)

</td>
<td style="border:1px solid black;">
[**SQL Server 遠端執行程式碼弱點 - CVE-2015-1762**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-1762)

</td>
<td style="border:1px solid black;">
[**SQL Server 遠端執行程式碼弱點 - CVE-2015-1763**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-1763)
