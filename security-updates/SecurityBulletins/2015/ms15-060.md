...
<td style="border:1px solid black;">
[**Microsoft 通用控制項釋放後使用弱點 - CVE-2015-1756**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-1756)
...
此弱點已經公開揭發。這項弱點已被指派一般性弱點編號 [CVE-2015-1756](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-1756)。本公告初次發行時，Microsoft 尚未接到任何有關此問題已公開用來攻擊客戶的消息。
