...
**注意：**在受支援的 Windows Server 2008 版本上，依預設不會安裝 Windows 筆記本。在這個作業系統上，當啟用[桌面體驗](https://support.microsoft.com/zh-tw/kb/947036)功能時，即會安裝它。因此，只在啟用桌面體驗時，Windows 筆記本的更新才適用。
...
<td style="border:1px solid black;">
[**Windows 筆記本遠端執行程式碼資訊安全風險 - CVE-2015-1675**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-1675)

</td>
<td style="border:1px solid black;">
[**Windows 筆記本遠端執行程式碼資訊安全風險 - CVE-2015-1695**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-1695)

</td>
<td style="border:1px solid black;" colspan="2">
[**Windows 筆記本遠端執行程式碼資訊安全風險 - CVE-2015-1696**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-1696)

</td>
<td style="border:1px solid black;">
[**Windows 筆記本遠端執行程式碼資訊安全風險 - CVE-2015-1697**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-1697)

</td>
<td style="border:1px solid black;">
[**Windows 筆記本遠端執行程式碼資訊安全風險 - CVE-2015-1698**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-1698)

</td>
<td style="border:1px solid black;">
[**Windows 筆記本遠端執行程式碼資訊安全風險 - CVE-2015-1699**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-1699)
