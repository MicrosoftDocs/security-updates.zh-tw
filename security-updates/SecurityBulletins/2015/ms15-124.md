...
此更新可協助確保在 Internet Explorer 中適當地強制執行跨網域原則，進而解決這項弱點。此弱點已經公開揭發。這項弱點已被指派一般性弱點編號 [CVE-2015-6164](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-6164)。起初發行此資訊安全公告時，Microsoft 未覺察有嘗試利用此弱點的攻擊。
