...
<td style="border:1px solid black;">
[MS08-007](https://www.microsoft.com/taiwan/technet/security/bulletin/ms08-007.mspx) 中的 946026
...
<sup>[1]</sup>執行 Windows Server 2008、Windows Server 2008 R2、Windows Server 2012 或 Windows Server 2012 R2 的系統，僅有安裝[「桌面體驗」](https://technet.microsoft.com/zh-tw/library/cc772567.aspx)功能後將受到影響。如果沒有安裝桌面體驗功能將不會提供這些系統更新。
...
<td style="border:1px solid black;">
[**WebDAV 權限提高資訊安全風險 - CVE-2015-0011**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-0011)
