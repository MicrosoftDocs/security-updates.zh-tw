---
TOCTitle: 'MS10-078'
Title: 'Microsoft Security Bulletin MS10-078 - 重要'
ms:assetid: 'ms10-078'
ms:contentKeyID: 61238604
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms10-078(v=Security.10)'
---


Microsoft Security Bulletin MS10-078 - 重要
===========================================

OpenType 字型 (CTF) 格式驅動程式中的資訊安全風險可能會允許權限提高 (2279986)
----------------------------------------------------------------------------
...
此資訊安全更新可解決 Windows OpenType 字型 (OTF) 格式驅動程式中兩項未公開報告的資訊安全風險。 對於所有受支援版本的 Windows XP 和 Windows Server 2003，此資訊安全更新的等級為「重要」。所有受支援版本的 Windows Vista、Windows Server 2008、Windows 7、Windows Server 2008 R2，皆不受此資訊安全風險影響。 如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

如果使用者檢視以蓄意製作的 OpenType 字型所呈現的內容，則這些資訊安全風險可能會允許權限提高。 攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項資訊安全風險。 匿名或遠端使用者無法利用這個資訊安全風險。

此資訊安全更新會修正 OpenType 字型 (OTF) 格式驅動程式在處理 OpenType 字型時配置記憶體及執行整數計算的方式，進而解決這些資訊安全風險。 如需更多有關資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=0553fc7c-deed-4594-a133-d621551310dc">Windows XP Service Pack 3 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=0553fc7c-deed-4594-a133-d621551310dc&amp;displaylang=zh-tw">Windows XP Service Pack 3 (中文下載更新程式)</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1ad30596-bac6-4d48-8b15-0245960c443b">Windows XP Professional x64 Edition Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-037">MS10-037</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f94763e7-b1db-4043-aa79-d5be1a42307d">Windows Server 2003 Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=f94763e7-b1db-4043-aa79-d5be1a42307d&amp;displaylang=zh-tw">Windows Server 2003 Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-037">MS10-037</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=6fca5cab-7e11-4911-a6a8-f73f113b2963">Windows Server 2003 x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=6fca5cab-7e11-4911-a6a8-f73f113b2963&amp;displaylang=zh-tw">Windows Server 2003 x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-037">MS10-037</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e8f297e2-0dfd-421a-b598-a78199ad6baa">Windows Server 2003 SP2 for Itanium-based Systems (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-037">MS10-037</a></td>
</tr>
...
<th style="border:1px solid black;" >OpenType 字型剖析資訊安全風險 - CVE-2010-2740</th>
<th style="border:1px solid black;" >OpenType 字型驗證資訊安全風險 - CVE-2010-2741</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
OpenType 字型剖析資訊安全風險 - CVE-2010-2740  
---------------------------------------------
  
由於 Windows OpenType 字型 (OTF) 格式驅動程式不當剖析蓄意製作的 OpenType 字型，因而形成提高權限的資訊安全風險。 成功利用此資訊安全風險的攻擊者可以在核心模式下執行任意程式碼。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
若要在「一般性資訊安全風險」清單標準項目中檢視此資訊安全風險，請參閱 [CVE-2010-2740](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2740) (英文)。
  
#### OpenType 字型剖析資訊安全風險 - CVE-2010-2740 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項資訊安全風險。 匿名或遠端使用者無法利用這個資訊安全風險。
  
#### OpenType 字型剖析資訊安全風險 - CVE-2010-2740 的因應措施
  
Microsoft 尚未找到此項資訊安全風險的任何因應措施。
  
#### OpenType 字型剖析資訊安全風險 - CVE-2010-2740 的常見問題集
  
**這個資訊安全風險的範圍為何？**    
這是權限提高的資訊安全風險。 成功利用此資訊安全風險的攻擊者可執行任意程式碼，並取得受影響之系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個資訊安全風險的原因為何？**    
導致此資訊安全風險的原因，是由於 OpenType 字型 (OTF) 格式驅動程在剖析蓄意製作的字型時未適當配置記憶體所致。
  
**什麼是 OpenType 字型格式？**    
OpenType 是 Microsoft 和 Adobe 合作開發的字型格式，作為 Apple 的 TrueType 字型格式的延伸。 OpenType 字型檔案內含由 TrueType 或 PostScript 外框字型組成的表格式資料。 點陣轉化器會使用該字型內含的表格中的資料組合，來呈現 TrueType 或 PostScript 字符外框。 不論使用的外框格式為何，都會用到此支援資料的一部分；而部分支援資料為 TrueType 或 PostScript 專用。 如需更多資訊，請參閱 [Microsoft 印刷樣式 OpenType 常見問題集](https://www.microsoft.com/typography/opentypefaq.mspx)。
...
是。 若協力廠商網頁瀏覽器能夠原生呈現 OpenType 字型 (OTF)，就會受到此資訊安全風險影響。 如果使用者透過這些應用程式來檢視內嵌蓄意製作字型的網站，則此資訊安全風險可能允許攻擊者以目前登入使用者的身分執行遠端程式碼。 依照預設，Internet Explorer 不受此問題影響。
  
**更新的作用何在？**    
此更新會修正 OpenType 字型 (OTF) 格式驅動程式在剖析字型時配置記憶體的方式，進而解決此資訊安全風險。
...
OpenType 字型驗證資訊安全風險 - CVE-2010-2741  
---------------------------------------------
  
由於 Windows OpenType 字型 (OTF) 格式驅動程式不當剖析蓄意製作的 OpenType 字型，因而形成提高權限的資訊安全風險。 成功利用此資訊安全風險的攻擊者可以在核心模式下執行任意程式碼。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
若要在「一般性資訊安全風險」清單標準項目中檢視此資訊安全風險，請參閱 [CVE-2010-2741](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2741) (英文)。
  
#### OpenType 字型驗證資訊安全風險 - CVE-2010-2741 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項資訊安全風險。 匿名或遠端使用者無法利用這個資訊安全風險。
  
#### OpenType 字型驗證資訊安全風險 - CVE-2010-2741 的因應措施
  
Microsoft 尚未找到此項資訊安全風險的任何因應措施。
  
#### OpenType 字型驗證資訊安全風險 - CVE-2010-2741 的常見問題集
  
**這個資訊安全風險的範圍為何？**    
這是權限提高的資訊安全風險。 成功利用此資訊安全風險的攻擊者可執行任意程式碼，並取得受影響之系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個資訊安全風險的原因為何？**    
若 OpenType 字型 (OTF) 格式驅動程式在處理蓄意製作的 OpenType 字型時未適當執行整數計算，將導致此資訊安全風險。
...
**協力廠商網頁瀏覽器是否會受此資訊安全風險影響？**  
是。 若協力廠商網頁瀏覽器能夠原生呈現 OpenType 字型 (OTF)，就會受到此資訊安全風險影響。 如果使用者透過這些應用程式來檢視內嵌蓄意製作字型的網站，則此資訊安全風險可能允許攻擊者以目前登入使用者的身分執行遠端程式碼。
  
**更新的作用何在？**    
此更新會修正 OpenType 字型 (OTF) 格式驅動程式在處理 OpenType 字型時執行整數計算的方式，進而解決此資訊安全風險。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB2279986$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2279986/zh-tw">Microsoft 知識庫文件編號 2279986</a></td>
</tr>
<tr class="even">
...
-   感謝 [Siberas](https://www.siberas.de/) 的 Sebastian Apelt 回報 OpenType 字型剖析資訊安全風險 (CVE-2010-2740)
-   感謝 [Core Security Technologies](https://www.coresecurity.com) 的 Diego Juarez 回報 OpenType 字型驗證資訊安全風險 (CVE-2010-2741)
