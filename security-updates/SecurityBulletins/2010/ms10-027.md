...
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-047">MS07-047</a></td>
</tr>
<tr class="even">
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-0268](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0268) (英文)。
...
如需瞭解如何判斷電腦上安裝的 Windows Media Player 版本，請參閱 [Microsoft 知識庫文件編號](https://support.microsoft.com/kb/190990/zh-tw) 190990。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/979402/zh-tw">Microsoft 知識庫文件編號 979402</a></td>
</tr>
<tr class="even">
...
-   感謝匿名的研究人員與 [TippingPoint](https://www.tippingpoint.com/) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，回報 Media Player 遠端執行程式碼弱點 (CVE-2010-0268)
