---
TOCTitle: 'MS10-103'
Title: 'Microsoft Security Bulletin MS10-103 - 重要'
ms:assetid: 'ms10-103'
ms:contentKeyID: 61238629
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms10-103(v=Security.10)'
---


Microsoft Security Bulletin MS10-103 - 重要
===========================================

Microsoft Publisher 中的資訊安全風險可能會允許遠端執行程式碼 (2292970)
----------------------------------------------------------------------
...
此資訊安全更新可解決 Microsoft Publisher 中五項未公開報告的資訊安全風險，該類資訊安全風險可在使用者開啟蓄意製作的 Publisher 檔案時，允許從遠端執行程式碼。 成功利用這些資訊安全風險的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

對於受支援版本的 Microsoft Publisher 2002、Microsoft Publisher 2003、Microsoft Publisher 2007 和 Microsoft Publisher 2010，此資訊安全更新的等級為「重要」。如需詳細資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此更新會修正 Microsoft Publisher 剖析蓄意製作的 Publisher 檔案的方式，藉以解決此資訊安全風險。 如需更多有關資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。

**建議。** Microsoft 建議客戶應該儘快套用此更新程式。

**已知問題。** [Microsoft 知識庫文件編號 2292970](https://support.microsoft.com/kb/2292970/zh-tw) 中記載目前已知安裝此資訊安全更新後，可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。 目前已知問題和建議解決方案僅適用於此軟體的特定版本，本文會提供詳細文章的連結。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f540692c-e404-4383-8937-4d6a36475da5">Microsoft Publisher 2002 Service Pack 3 (英文下載更新程式)</a><br />
(KB2284692)  
<a href="https://www.microsoft.com/download/details.aspx?familyid=f540692c-e404-4383-8937-4d6a36475da5&amp;displaylang=zh-tw">Microsoft Publisher 2002 Service Pack 3 (中文下載更新程式)</a><br />
(KB2284692)</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e600de65-3e9d-4e37-8906-8b7091ff523e">Microsoft Publisher 2003 Service Pack 3 (英文下載更新程式)</a><br />
(KB2284695)  
<a href="https://www.microsoft.com/download/details.aspx?familyid=e600de65-3e9d-4e37-8906-8b7091ff523e&amp;displaylang=zh-tw">Microsoft Publisher 2003 Service Pack 3 (中文下載更新程式)</a><br />
(KB2284695)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=79275011-bdc1-446a-8ea6-56fc31bd9c35">Microsoft Publisher 2007 Service Pack 2 (英文下載更新程式)</a><br />
(KB2284697)  
<a href="https://www.microsoft.com/download/details.aspx?familyid=79275011-bdc1-446a-8ea6-56fc31bd9c35&amp;displaylang=zh-tw">Microsoft Publisher 2007 Service Pack 2 (中文下載更新程式)</a><br />
(KB2284697)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-036">MS10-036</a></td>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Office 2010 (32 位元版本)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=99e18990-75e9-497e-9b4f-5d7ef8656ab2">Microsoft Publisher 2010 (32 位元版本) (英文下載更新程式)</a><br />
(KB2409055)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office 2010 (64 位元版本)</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9b27ee11-e563-4152-9691-25eec1ee9966">Microsoft Publisher 2010 (64 位元版本) (英文下載更新程式)</a><br />
(KB2409055)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
...
<th style="border:1px solid black;" >pubconv.dll 中的大小值堆積損毀資訊安全風險 - CVE-2010-2569</th>
<th style="border:1px solid black;" >pubconv.dll 中的堆積溢位資訊安全風險 - CVE-2010-2570</th>
<th style="border:1px solid black;" >Pubconv.dll 中因索引至陣列無效所導致的記憶體損毀資訊安全風險 - CVE-2010-2571</th>
<th style="border:1px solid black;" >Microsoft Publisher 記憶體損毀資訊安全風險 - CVE-2010-3954</th>
<th style="border:1px solid black;" >陣列索引記憶體損毀資訊安全風險 - CVE-2010-3955</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Publisher 2010 (32 位元版本)</td>
<td style="border:1px solid black;">不適用</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
遠端執行程式碼</td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Publisher 2010 (64 位元版本)</td>
<td style="border:1px solid black;">不適用</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
遠端執行程式碼</td>
<td style="border:1px solid black;">不適用</td>
...
pubconv.dll 中的大小值堆積損毀資訊安全風險 - CVE-2010-2569  
----------------------------------------------------------
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-2569](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2569) (英文)。
  
#### pubconv.dll 中的大小值堆積損毀資訊安全風險 - CVE-2010-2569 的緩和因素
...
-   在網頁式攻擊的案例中，攻擊者可架設一個網站，並在其中包含利用此資訊安全風險的網頁。 此外，受侵害的網站以及接受或存放使用者提供之內容或廣告的網站裡，也可能包含蓄意製作以利用本資訊安全風險的內容。 但是，攻擊者無法強迫使用者造訪網站， 而是引誘使用者自行前往。一般的做法是設法讓使用者點選電子郵件中或 Instant Messenger 訊息中連往攻擊者網站的連結，然後引誘他們開啟蓄意製作的 Publisher 檔案。
  
#### pubconv.dll 中的大小值堆積損毀資訊安全風險 - CVE-2010-2569 的因應措施
...
-   **停用 Publisher 轉換程式 DLL**
    ...
    **注意：**對於 &lt;office version&gt;，輸入系統中適當 Microsoft Office 元件的版本，例如代表 Microsoft Publisher 2002 的 "Office10"；代表 Microsoft Publisher 2003 的 "Office11"；及代表 Microsoft Publisher 2007 的 "Office12"。若要確認版本，請開啟此 Microsoft Office 元件並按一下 \[說明\]。
    ...
    **因應措施的影響。** 使用者若停用 Publisher 轉換程式 DLL，則無法開啟早於 Microsoft Publisher 2007 版本的 Publisher 檔案。
...
#### pubconv.dll 中的大小值堆積損毀資訊安全風險 - CVE-2010-2569 的常見問題集
  
**這個資訊安全風險的範圍為何？**    
這是遠端執行程式碼的資訊安全風險。 成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個資訊安全風險的原因為何？**    
Microsoft Publisher 剖析蓄意製作的 Publisher 檔案之方式中存在此資訊安全風險。
  
**什麼是 pubconv.dll？**    
Microsoft Publisher 可使用 Publisher 轉換程式 DLL 開啟早於 Microsoft Publisher 2007 版本的 Publisher 檔案。
...
pubconv.dll 中的堆積溢位資訊安全風險 - CVE-2010-2570  
----------------------------------------------------
  
在 Microsoft Publisher 剖析 Publisher 檔案的方式中，存在遠端執行程式碼資訊安全風險。 攻擊者可蓄意製作 Publisher 檔案，並以電子郵件附件的方式隨附，或存放在蓄意製作或遭入侵的網站上，然後引誘使用者開啟蓄意製作的 Publisher 檔案，以利用此項資訊安全風險。 如果使用者以系統管理的使用者權限登入，成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
  
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-2570](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2570) (英文)。
  
#### pubconv.dll 中的堆積溢位資訊安全風險 - CVE-2010-2570 的緩和因素
...
#### pubconv.dll 中的堆積溢位資訊安全風險 - CVE-2010-2570 的因應措施
...
-   **停用 Publisher 轉換程式 DLL**
    ...
    **注意：**請為您的系統使用適當的 Microsoft Office 軟體版本，例如代表 Microsoft Publisher 2002 的 "Office10"；代表 Microsoft Publisher 2003 的 "Office11"；代表 Microsoft Publisher 2007 的 "Office12"；及代表 Microsoft Publisher 2010 的 "Office14"。
...
#### pubconv.dll 中的堆積溢位資訊安全風險 - CVE-2010-2570 的常見問題集
...
**攻擊者如何利用這項資訊安全風險？**    
使用者必須使用 Microsoft Publisher 開啟蓄意製作 Publisher 檔案，此資訊安全風險才會遭到利用。
...
Pubconv.dll 中因索引至陣列無效所導致的記憶體損毀資訊安全風險 - CVE-2010-2571  
----------------------------------------------------------------------------
  
在 Microsoft Publisher 開啟 Publisher 檔案的方式中，存在遠端執行程式碼資訊安全風險。 攻擊者可蓄意製作 Publisher 檔案，並以電子郵件附件的方式隨附，或存放在蓄意製作或遭入侵的網站上，然後引誘使用者開啟蓄意製作的 Publisher 檔案，以利用此項資訊安全風險。 如果使用者以系統管理的使用者權限登入，成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
  
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-2571](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2571) (英文)。
  
#### Pubconv.dll 中因索引至陣列無效所導致的記憶體損毀資訊安全風險 - CVE-2010-2571 的緩和因素
...
#### Pubconv.dll 中因索引至陣列無效所導致的記憶體損毀資訊安全風險 - CVE-2010-2571 的因應措施
...
-   **停用 Publisher 轉換程式 DLL**
    ...
    **注意：**請為您的系統使用適當的 Microsoft Office 軟體版本，例如代表 Microsoft Publisher 2002 的 "Office10"，以及代表 Microsoft Publisher 2003 的 "Office11"。
...
#### Pubconv.dll 中因索引至陣列無效所導致的記憶體損毀資訊安全風險 - CVE-2010-2571 的常見問題集
  
**這個資訊安全風險的範圍為何？**    
這是遠端執行程式碼的資訊安全風險。 成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個資訊安全風險的原因為何？**    
在 Microsoft Publisher 剖析 Publisher 97 格式檔案的方式中存在此資訊安全風險。
...
**更新的作用何在？**    
此更新可修正 Microsoft Publisher 轉換 Publisher 97 格式檔案的方式，進而解決此項資訊安全風險。
...
Microsoft Publisher 記憶體損毀資訊安全風險 - CVE-2010-3954  
----------------------------------------------------------
  
在 Microsoft Publisher 開啟 Publisher 檔案的方式中，存在遠端執行程式碼資訊安全風險。 攻擊者可蓄意製作 Publisher 檔案，並以電子郵件附件的方式隨附，或存放在蓄意製作或遭入侵的網站上，然後引誘使用者開啟蓄意製作的 Publisher 檔案，以利用此項資訊安全風險。 如果使用者以系統管理的使用者權限登入，成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
  
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3954](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3954) (英文)。
  
#### Microsoft Publisher 記憶體損毀資訊安全風險 - CVE-2010-3954 的緩和因素
...
#### Microsoft Publisher 記憶體損毀資訊安全風險 - CVE-2010-3954 的因應措施
...
#### Microsoft Publisher 記憶體損毀資訊安全風險 - CVE-2010-3954 的常見問題集
  
**這個資訊安全風險的範圍為何？**    
這是遠端執行程式碼的資訊安全風險。 成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個資訊安全風險的原因為何？**    
在 Microsoft Publisher 剖析蓄意製作的 Publisher 檔案之方式中存在此資訊安全風險。
...
陣列索引記憶體損毀資訊安全風險 - CVE-2010-3955  
----------------------------------------------
  
在 Microsoft Publisher 開啟 Publisher 檔案的方式中，存在遠端執行程式碼資訊安全風險。 攻擊者可蓄意製作 Publisher 檔案，並以電子郵件附件的方式隨附，或存放在蓄意製作或遭入侵的網站上，然後引誘使用者開啟蓄意製作的 Publisher 檔案，以利用此項資訊安全風險。 如果使用者以系統管理的使用者權限登入，成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
  
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3955](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3955) (英文)。
  
#### 陣列索引記憶體損毀資訊安全風險 - CVE-2010-3955 的緩和因素
...
#### 陣列索引記憶體損毀資訊安全風險 - CVE-2010-3955 的因應措施
...
-   **停用 Publisher 轉換程式 DLL**
    ...
    **如何復原因應措施：**
    ...
    對於 32 位元版本的 Windows Vista、Windows Server 2008 和 Windows 7，請透過已提高權限的命令提示字元執行下列命令：
...
#### 陣列索引記憶體損毀資訊安全風險 - CVE-2010-3955 的常見問題集
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2284692/zh-tw">Microsoft 知識庫文件編號 2284692</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2284695/zh-tw">Microsoft 知識庫文件編號 2284695</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2284697/zh-tw">Microsoft 知識庫文件編號 2284697</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2409055/zh-tw">Microsoft 知識庫文件編號 2409055</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
-   感謝 [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Chaouki Bekrar 回報 pubconv.dll 中的大小值堆積損毀資訊安全風險 (CVE-2010-2569)  
-   感謝 [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Chaouki Bekrar 回報 pubconv.dll 中的堆積溢位資訊安全風險 (CVE-2010-2570)  
-   感謝 [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Chaouki Bekrar 回報 Pubconv.dll 中因索引至陣列無效所導致的記憶體損毀資訊安全風險 (CVE-2010-2571)  
-   感謝 [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Chaouki Bekrar 回報 Microsoft Publisher 記憶體損毀資訊安全風險 (CVE-2010-3954)  
-   感謝 [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Chaouki Bekrar 回報陣列索引記憶體損毀資訊安全風險 (CVE-2010-3955)
