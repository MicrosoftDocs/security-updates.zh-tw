...
**已知問題。** [Microsoft 知識庫文件編號 983235](http://support.microsoft.com/kb/983235/zh-tw) 中記載了客戶安裝此安全性更新時，可能會發生的目前已知問題。 該文件並說明了解決這些問題的建議解決方案。 目前已知問題和建議解決方案僅適用於此軟體的特定版本，本文會提供詳細文章的連結。
...
Microsoft 對於在 Windows XP 系統上安裝 Office XP 的使用者，提供一個 **Microsoft Fix it** 解決方案。 雖然這不是 Office 產品本身中的更新程式碼，但是此 **Microsoft Microsoft Fix it** 解決方案提供的保護和更新程式碼很類似，可處理在本公告所描述的弱點。 雖然應用程式相容性的風險已降至最低，但是 Microsoft 仍建議使用者先測試此 **Microsoft Fix it** 解決方案，再廣泛分發。 有關下載位置和其他詳細資料，請參閱 [Microsoft 知識庫文件編號 983235](http://support.microsoft.com/kb/983235/zh-tw)。
...
本公告 (MS10-036) 中的 Microsoft Office Excel 2003 安全性更新套件 (KB982133) 和 Microsoft Office Excel 2007 安全性更新套件 (KB982308) 亦可解決 [MS10-038](http://technet.microsoft.com/security/bulletin/ms10-038) 中所述的弱點。擁有 Microsoft Office Excel 2003 或 Microsoft Office Excel 2007 的使用者僅需安裝這些安全性更新套件一次。 使用者還必須安裝本公告中提供的相關 Microsoft Office 更新 (KB982311 或 KB982312)，才能避受本公告 (MS10-036) 中所述的弱點影響。

**此更新是否包含任何與安全性無關的功能變更？**  
此更新包含與非安全性相關的功能變更。 如需詳細資料，請參閱 [Microsoft 知識庫文件編號 983632](http://support.microsoft.com/kb/983632/zh-tw)。
...
此減輕措施解決了 [Microsoft 安全性摘要報告 (973882)](http://technet.microsoft.com/security/advisory/973882) 和 [MS09-035](http://go.microsoft.com/fwlink/?linkid=158131) 中所述之 ATL 弱點，此變更對所有受影響的平台預設為啟用，並有助於封鎖在 Microsoft Office 中載入之控制項的 ATL 弱點，包括那些並非由 Microsoft 所建立的項目。
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-1263](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1263) (英文)。
...
<td style="border:1px solid black;">Microsoft Office 2003 Service Pack 3：<br />
請參閱 <a href="http://support.microsoft.com/kb/982311/zh-tw">Microsoft 知識庫文件編號 982311</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Excel 2003 Service Pack 3：<br />
請參閱 <a href="http://support.microsoft.com/kb/982133/zh-tw">Microsoft 知識庫文件編號 982133</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office PowerPoint 2003 Service Pack 3：<br />
請參閱 <a href="http://support.microsoft.com/kb/982157/zh-tw">Microsoft 知識庫文件編號 982157</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Publisher 2003 Service Pack 3：<br />
請參閱 <a href="http://support.microsoft.com/kb/982122/zh-tw">Microsoft 知識庫文件編號 982122</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Visio 2003 Service Pack 3：<br />
請參閱 <a href="http://support.microsoft.com/kb/982126/zh-tw">Microsoft 知識庫文件編號 982126</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Word 2003 Service Pack 3：<br />
請參閱 <a href="http://support.microsoft.com/kb/982134/zh-tw">Microsoft 知識庫文件編號 982134</a></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">2007 Microsoft Office System Service Pack 1 及 2007 Microsoft Office System Service Pack 2：<br />
請參閱 <a href="http://support.microsoft.com/kb/982312">Microsoft 知識庫文件編號 982312</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Excel 2007 Service Pack 1 和 Microsoft Office Excel 2007 Service Pack 2：<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office PowerPoint 2007 Service Pack 1 和 Microsoft Office PowerPoint 2007 Service Pack 2：<br />
請參閱 <a href="http://support.microsoft.com/kb/982158/zh-tw">Microsoft 知識庫文件編號 982158</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Publisher 2007 Service Pack 1 和 Microsoft Office Publisher 2007 Service Pack 2：<br />
請參閱 <a href="http://support.microsoft.com/kb/982124/zh-tw">Microsoft 知識庫文件編號 982124</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Visio 2007 Service Pack 1 和 Microsoft Office Visio 2007 Service Pack 2：<br />
請參閱 <a href="http://support.microsoft.com/kb/982127/zh-tw">Microsoft 知識庫文件編號 982127</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Word 2007 Service Pack 1 和 Microsoft Office Word 2007 Service Pack 2：<br />
請參閱 <a href="http://support.microsoft.com/kb/982135/zh-tw">Microsoft 知識庫文件編號 982135</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
