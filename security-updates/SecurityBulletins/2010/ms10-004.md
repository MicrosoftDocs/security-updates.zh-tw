...
**已知問題。** [Microsoft 知識庫文件編號 975416](https://support.microsoft.com/kb/975416/zh-tw) 中記載了客戶安裝此安全性更新後，可能會發生的目前已知問題。 該文件並說明了解決這些問題的建議解決方案。 目前已知問題和建議解決方案僅適用於此軟體的特定版本，本文會提供詳細文章的連結。
...
[Microsoft 知識庫文件編號 975416](https://support.microsoft.com/kb/975416/zh-tw) 詳細記錄安裝此安全性更新時，目前已知可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。
...
這是因為獨立安裝的 PowerPoint Viewer 2003 [已超出支援週期](https://blogs.technet.com/office_sustained_engineering/archive/2008/12/09/excel-viewer-2003-word-viewer-2003-and-powerpoint-viewer-2003-to-retire.aspx)，所以不提供此更新。 此更新的用途是提供給 Microsoft Office PowerPoint 2003 的客戶，以利客戶發行利用 PowerPoint [將簡報封裝成光碟功能](https://support.microsoft.com/kb/828504/zh-tw) (此功能使用 PowerPoint Viewer 2003) 所製作的簡報之更新版本。
...
**MS10-003 中亦說明 Microsoft Office 2004 for Mac 的弱點。 MS10-003 與此公告 (MS10-004) 有何關聯？**  
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2010-0029](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0029)。
...
#### PowerPoint 檔案路徑處理緩衝區溢位弱點 - CVE-2010-0029 的因應措施
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2010-0030](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0030)。
...
#### PowerPoint LinkedSlideAtom 堆積溢位弱點 - CVE-2010-0030 的因應措施
...
-   **使用 Microsoft Office 檔案封鎖原則來封鎖開啟來自於未知或不信任來源與位置的 Office 2003 和先前文件**
    ...
    **因應措施的影響** 使用者若設定檔案封鎖原則、但尚未依照 [Microsoft 知識庫文件編號 922847](https://support.microsoft.com/kb/922847/zh-tw) 所討論設定特殊的「豁免目錄」，將無法在 Office 2003 中開啟 Office 2003 檔案或先前版本。
...
#### PowerPoint LinkedSlideAtom 堆積溢位弱點 - CVE-2010-0030 的常見問題集
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2010-0031](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0031)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2010-0032](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0032)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2010-0033](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0033)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2010-0034](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0034)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/973143">Microsoft 知識庫文件編號 973143</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/976881">Microsoft 知識庫文件編號 976881</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
-   感謝 [Secunia](https://secunia.com/) 的 Carsten Eiram 回報 PowerPoint 檔案路徑處理緩衝區溢位 (CVE-2010-0029)  
-   感謝 [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Sean Larsson 回報 PowerPoint LinkedSlideAtom 堆積溢位弱點 (CVE-2010-0030)  
-   感謝 [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Sean Larsson 回報 PowerPoint OEPlaceholderAtom 'placementId' 無效的陣列索引弱點 (CVE-2010-0031)  
-   感謝 [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Sean Larsson 回報 PowerPoint OEPlaceholderAtom 釋放後使用弱點 (CVE-2010-0032)  
-   感謝 SkD 與 [TippingPoint](https://www.tippingpoint.com/) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，回報 PowerPoint Viewer TextBytesAtom 記錄堆疊溢位弱點 (CVE-2010-0033)  
-   感謝 [TippingPoint DVLabs](https://dvlabs.tippingpoint.com/) 的 Cody Pierce 回報 Office PowerPoint Viewer TextCharsAtom 記錄堆疊溢位 (CVE-2010-0034)
