...
Microsoft Office Word Viewer 取代了 Word Viewer 2003 以及所有舊版的 Word Viewer。 即使未安裝 Word，您也可以利用 Word Viewer 來檢視、列印和複製 Word 文件。 如需目前支援的 Office Viewer 的詳細資訊，請參閱[支援的 Office Viewer 版本](https://support.microsoft.com/kb/979860/en-us)。
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-1900](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1900) (英文)。
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-1901](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1901) (英文)。
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-1902](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1902) (英文)。
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-1903](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1903) (英文)。
...
-   對於受支援的 2007 Microsoft Office 系統版本，請參閱＜為 2007 Office 系統建立網路安裝點＞(英文)。
    **注意：**如果您打算集中管理資訊安全更新，請使用 Windows Server Update Services。 如需更多關於使用 Windows Server Update Services 部署 2007 Microsoft Office 系統的資訊安全更新之資訊，請造訪 [Windows Server Update Services 網站](https://go.microsoft.com/fwlink/?linkid=50120)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2251389/zh-tw">Microsoft 知識庫文件編號 2251389</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">對於 Word 2003，請參閱 <a href="https://support.microsoft.com/kb/2251399/zh-tw">Microsoft 知識庫文件編號 2251399</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">對於 Word Viewer，請參閱 <a href="https://support.microsoft.com/kb/2251437/zh-tw">Microsoft 知識庫文件編號 2251437</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">對於 Word 2007，請參閱 <a href="https://support.microsoft.com/kb/2251419/zh-tw">Microsoft 知識庫文件編號 2251419</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">對於 Word、Excel 及 PowerPoint 2007 檔案格式的 Microsoft Office 相容性套件，請參閱 <a href="https://support.microsoft.com/kb/2277947/zh-tw">Microsoft 知識庫文件編號 2277947</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2092914/zh-tw">Microsoft 知識庫文件編號 2092914</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
-   感謝 [team509](https://www.team509.com/) 的 L.W.Z 與 [TippingPoint](https://www.tippingpoint.com/) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，回報 Word 記錄剖析弱點 (CVE-2010-1900)  
-   感謝 [team509](https://www.team509.com/) 的 Wushi 與 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作回報 Word RTF 剖析引擎記憶體損毀弱點 (CVE-2010-1901)  
-   感謝 [team509](https://www.team509.com/) 與 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作回報 Word RTF 剖析緩衝區溢位弱點 (CVE-2010-1902)  
-   感謝 [Check Point](https://www.checkpoint.com/) IPS Research Team 的 Rodrigo Rubira Branco 回報 Word HTML 連結的物件記憶體損毀 (CVE-2010-1903)  
-   感謝匿名的研究人員與 [TippingPoint](https://www.tippingpoint.com/) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作回報 Word HTML 連結的物件記憶體損毀弱點 (CVE-2010-1903)
