---
TOCTitle: 'MS10-062'
Title: 'Microsoft Security Bulletin MS10-062 - 重大'
ms:assetid: 'ms10-062'
ms:contentKeyID: 61238588
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms10-062(v=Security.10)'
---


Microsoft Security Bulletin MS10-062 - 重大
===========================================

MPEG-4 轉碼器的資訊安全風險可能會允許遠端執行程式碼 (975558)
------------------------------------------------------------
...
此資訊安全更新可解決 MPEG-4 轉碼器中一項未公開報告的資訊安全風險。 當使用者開啟蓄意製作的媒體檔案，或者從網站或任何提供 Web 內容的應用程式收到蓄意製作的串流內容時，這些資訊安全風險可能會允許遠端執行程式碼。 成功利用此資訊安全風險的攻擊者可以取得與本機使用者相同的使用者權限。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

對於所有受支援版本的 Windows XP、Windows Server 2003 (Itanium 型版本除外)、Windows Vista 和 Windows Server 2008 (Itanium 型版本除外)，此資訊安全更新的等級為「重大」。 Itanium 型版本的 Windows Server 2003 和 Windows Server 2008，以及所有受支援版本的 Windows 7 和 Windows Server 2008 R2，皆不受此資訊安全風險影響。 如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此資訊安全更新會修改 MPEG-4 轉碼器處理蓄意製作之媒體內容的方式，藉以解決此資訊安全風險。 如需更多有關資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2084a01c-2a91-4650-8665-7053015f2083">Windows XP Service Pack 3 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=2084a01c-2a91-4650-8665-7053015f2083&amp;displaylang=zh-tw">Windows XP Service Pack 3 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=284a0e80-fd03-4909-b354-0478f04585a1">Windows XP Professional x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=284a0e80-fd03-4909-b354-0478f04585a1&amp;displaylang=zh-tw">Windows XP Professional x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=0a942985-081f-455c-bf9d-4345392c91b0">Windows Server 2003 Service Pack 2 (中文下載更新程式) (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=0a942985-081f-455c-bf9d-4345392c91b0&amp;displaylang=zh-tw">Windows Server 2003 Service Pack 2 (中文下載更新程式) (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=284a0e80-fd03-4909-b354-0478f04585a1">Windows Server 2003 x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=284a0e80-fd03-4909-b354-0478f04585a1&amp;displaylang=zh-tw">Windows Server 2003 x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=84629c25-7827-40c1-86fb-7ffa247202a0">Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=84629c25-7827-40c1-86fb-7ffa247202a0&amp;displaylang=zh-tw">Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=36e2a74b-e5c6-47d5-9cd9-b9171be63c7d">Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=36e2a74b-e5c6-47d5-9cd9-b9171be63c7d&amp;displaylang=zh-tw">Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=fdfc393e-a54d-44dd-ba45-c2a550ffd2a1">適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a>&#42;&#42;
<a href="https://www.microsoft.com/download/details.aspx?familyid=fdfc393e-a54d-44dd-ba45-c2a550ffd2a1&amp;displaylang=zh-tw">適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2 (中文下載更新程式)</a>&#42;&#42;</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1b7af424-6286-4a80-827c-c4df4f92fe43">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a>&#42;&#42;
<a href="https://www.microsoft.com/download/details.aspx?familyid=1b7af424-6286-4a80-827c-c4df4f92fe43&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2 (中文下載更新程式)</a>&#42;&#42;</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<th style="border:1px solid black;" >MPEG-4 轉碼器資訊安全風險 - CVE-2010-0818</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
MPEG-4 轉碼器資訊安全風險 - CVE-2010-0818  
-----------------------------------------
  
MPEG-4 轉碼器處理受支援格式檔案的方式中，存在遠端執行程式碼的資訊安全風險。 如果使用者開啟蓄意製作的媒體檔案，此資訊安全風險可能會允許執行程式碼。 如果使用者以系統管理的使用者權限登入，成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
  
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-0818](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0818) (英文)。
  
#### MPEG-4 轉碼器資訊安全風險 - CVE-2010-0818 的緩和因素
...
#### MPEG-4 轉碼器資訊安全風險 - CVE-2010-0818 的因應措施
  
因應措施指的是無法徹底修正資訊安全風險，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。 Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：
  
-   **限制存取 MPEG-4 第 1 版轉碼器**
  
    若要限制存取 MPEG-4 第 1 版轉碼器，請執行下列步驟：
    ...
    **注意：**不當使用「登錄編輯程式」可能會造成嚴重的問題，甚至可能需要重新安裝您的作業系統。 Microsoft 無法保證能夠順利解決因不當使用「登錄編輯程式」所造成的問題。 請自行承擔使用 \[登錄編輯程式\] 的風險。 如需有關如何編輯登錄的資訊，請檢視「登錄編輯程式」(Regedit.exe) 中的＜變更機碼及數值＞說明主題，或是 Regedt32.exe 中的＜新增及刪除登錄中的資訊＞與＜編輯登錄資料＞說明主題。
    ...
    1.  使用包含下列命令的受管理部署指令碼，建立登錄機碼的備份：  
        ...
        **注意：**視您系統上所安裝的 MPEG-4 轉碼器版本而定，上述部分登錄機碼可能不存在。 而系統不會為不存在於其中的登錄機碼建立備份檔案。  
    2.  將以下項目儲存到副檔名為 .REG 的檔案中，例如 Restrict\_MPEG-4\_Workaround.reg：  
    ...
    **因應措施的影響。** 以 MPEG-4 第 1 版格式所編碼的檔案不會在應用程式中播放，例如使用 MPEG-4 轉碼器的 Windows Media Player。
    ...
    **注意：**上述部分登錄備份檔案可能並不存在。 實施此因應措施之前，系統不會為不存在於其中的登錄機碼建立備份檔案。
  
#### MPEG-4 轉碼器資訊安全風險 - CVE-2010-0818 的常見問題集
  
**這個資訊安全風險的範圍為何？**    
這是遠端執行程式碼的資訊安全風險。 成功利用此資訊安全風險的攻擊者可以利用提高的權限在易受影響的系統上執行任意程式碼。 攻擊者接下來將能安裝程式，或檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個資訊安全風險的原因為何？**    
Windows Media 轉碼器中所含的 MPEG-4 轉碼器，並未正確處理使用 MPEG-4 視訊編碼的蓄意製作媒體檔案。
  
**哪一個 MPEG-4 轉碼器包含資訊安全風險程式碼？**    
MPEG-4 是一套國際標準組織 (ISO) 所制定的規格，涵蓋多種多媒體展示層面的應用，包括壓縮、撰寫和傳遞。 用於 MPEG-4 視訊解碼的 MPEG-4 轉碼器包含資訊安全風險程式碼。
  
**什麼是轉碼器？**    
所謂的轉碼器，就是用來壓縮或解壓縮數位媒體檔案 (如歌曲、影片等) 的軟體。 Windows Media Player 和其他程式均使用轉碼器來播放和建立數位媒體檔案。
  
一個轉碼器可能由兩個元件組成： 一個編碼器和一個解碼器。 編碼器負責執行壓縮 (編碼) 功能，而解碼器則執行解壓縮 (解碼) 功能。 有些轉碼器包括這兩個元件，而有些轉碼器只包括其中之一。 舉例來說，當您將音訊 CD 的歌曲傳送到電腦時，Windows Media Player 預設會使用 Windows Media 音訊轉碼器，將歌曲壓縮成精簡的 WMA 檔案。 當您播放該 WMA 檔案 (或可能是從網站中串流的任何 WMA 檔案) 時，Player 會使用 Windows Media 音訊轉碼器來解壓縮檔案，如此就能透過喇叭播放音樂。
  
**攻擊者可能會利用這項資訊安全風險採取什麼行動？**    
成功利用此資訊安全風險的攻擊者可以取得與本機使用者相同的使用者權限。 如果使用者以系統管理的使用者權限登入，成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**攻擊者如何利用這項資訊安全風險？**    
使用者必須開啟蓄意製作的媒體檔案，或從網站或任何提供 Web 內容的應用程式接收蓄意製作的串流內容，此資訊安全風險才會遭到利用。
  
若是電子郵件攻擊，攻擊者可能會透過以下方式來利用這項資訊安全風險：傳送內嵌蓄意製作 MPEG-4 檔案的媒體檔案給使用者，然後引誘使用者開啟該檔案。
  
攻擊者可設計出能透過網際網路瀏覽器利用此資訊安全風險的媒體內容，並架設惡意網站來提供這些蓄意製作的媒體內容，然後引誘使用者檢視網站並開啟蓄意製作的媒體內容。
  
**因為這個資訊安全風險而承受風險的主要系統有哪些？**    
執行受影響軟體的系統風險最高。
  
**更新的作用何在？**    
此更新會修改 MPEG-4 轉碼器處理蓄意製作之媒體內容的方式，藉以解決此資訊安全風險。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB975558$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/975558/zh-tw">Microsoft 知識庫文件編號 975558</a></td>
</tr>
<tr class="even">
...
-   感謝 [Sourcefire VRT](https://www.sourcefire.com/services/sf_vrt.html) 的 Matthew Watchinski 回報 MPEG-4 轉碼器資訊安全風險 (CVE-2010-0818)
