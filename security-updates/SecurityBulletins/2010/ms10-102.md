...
**已知問題。**  [Microsoft 知識庫文件編號 2345316](http://support.microsoft.com/kb/2345316/zh-tw) 中記載客戶安裝此資訊安全更新後，可能會發生的目前已知問題。 該文件並說明了解決這些問題的建議解決方案。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b8c06bbc-6e84-4cf1-89f0-c0d34cfffaed">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a>&#42;
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=b8c06bbc-6e84-4cf1-89f0-c0d34cfffaed&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2 (中文下載更新程式)</a>&#42;</td>
<td style="border:1px solid black;">拒絕服務</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=39b7abc7-65a4-4dfd-92ba-c638e3de1118">適用於 x64 型系統的 Windows Server 2008 R2 (英文下載更新程式)</a>&#42;
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=39b7abc7-65a4-4dfd-92ba-c638e3de1118&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows Server 2008 R2 (中文下載更新程式)</a>&#42;</td>
<td style="border:1px solid black;">拒絕服務</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
由於此更新中存在特定二進位檔案，因此解除安裝此更新需要重新啟動兩次。 解除安裝更新之後系統若未重新啟動兩次，可能會發生網路連線中斷。 如需有關此項已知問題的詳細資訊，請參閱 [Microsoft 知識庫文件編號 2345316](http://support.microsoft.com/kb/2345316/zh-tw)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3960](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3960) (英文)。
...
**什麼是 VMBus？**    
VMBus 是邏輯互相磁碟分割通訊通道。 如需 VMBus 和 Hyper-V 結構的詳細資訊，請參閱 MSDN 文章：[Hyper-V 結構](http://msdn.microsoft.com/en-us/library/cc768520(bts.10).aspx) (英文)。
...
<br />
為避免網路連線中斷，解除安裝此更新需要重新啟動兩次。 如需有關此解決安裝案例的詳細資訊，請參閱 <a href="http://support.microsoft.com/kb/2345316/zh-tw">Microsoft 知識庫文件編號 2345316</a>。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2345316/zh-tw">Microsoft 知識庫文件編號 2345316</a></td>
</tr>
<tr class="odd">
...
-   感謝 [HP](http://www.hp.com) 和 [techit](http://www.techit.de) 回報 Hyper-V VMBus 資訊安全風險 (CVE-2010-3960)
