---
TOCTitle: 'MS10-102'
Title: 'Microsoft Security Bulletin MS10-102 - 重要'
ms:assetid: 'ms10-102'
ms:contentKeyID: 61238628
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms10-102(v=Security.10)'
---


Microsoft Security Bulletin MS10-102 - 重要
===========================================

Hyper-V 中的資訊安全風險可能會允許拒絕服務 (2345316)
----------------------------------------------------
...
這個資訊安全更新能解決 Windows Server 2008 Hyper-V 和 Windows Server 2008 R2 Hyper-V 中一項未公開報告的資訊安全風險。 如果通過驗證的使用者在 Hyper-V 伺服器主控的任何來賓虛擬機器上將蓄意製作的封包傳送到 VMBus，則此資訊安全風險可能會允許拒絕服務。 如果要利用這項資訊安全風險，攻擊者必須具有有效的登入認證，且能夠從來賓虛擬機器傳送蓄意製作的內容。 匿名或遠端使用者無法利用這個資訊安全風險。

對所有受支援 x64 型版本的 Windows Server 2008 與 Windows Server 2008 R2 而言，此資訊安全更新的等級為「重要」。如需詳細資訊，請參閱本節中＜受影響及不受影響的軟體＞小節。

此資訊安全更新可修正 Hyper-V 伺服器驗證傳送至其來賓虛擬機器內部 VMBus 之格式錯誤封包的方式，進而解決此資訊安全風險。 如需更多有關資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
**已知問題。**  [Microsoft 知識庫文件編號 2345316](https://support.microsoft.com/kb/2345316/zh-tw) 中記載客戶安裝此資訊安全更新後，可能會發生的目前已知問題。 該文件並說明了解決這些問題的建議解決方案。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b8c06bbc-6e84-4cf1-89f0-c0d34cfffaed">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a>&#42;
<a href="https://www.microsoft.com/download/details.aspx?familyid=b8c06bbc-6e84-4cf1-89f0-c0d34cfffaed&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2 (中文下載更新程式)</a>&#42;</td>
<td style="border:1px solid black;">拒絕服務</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=39b7abc7-65a4-4dfd-92ba-c638e3de1118">適用於 x64 型系統的 Windows Server 2008 R2 (英文下載更新程式)</a>&#42;
<a href="https://www.microsoft.com/download/details.aspx?familyid=39b7abc7-65a4-4dfd-92ba-c638e3de1118&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows Server 2008 R2 (中文下載更新程式)</a>&#42;</td>
<td style="border:1px solid black;">拒絕服務</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
如果啟用 Hyper-V 角色，更新將僅會透過自動更新提供。 但即便不啟用 Hyper-V 角色，在受影響的作業系統上也可以手動安裝此更新。
  
無論受影響的作業系統是否使用伺服器核心安裝選項進行安裝，均是如此。
...
**解除安裝此資訊安全更新後，已知可能會發生的問題有哪些？**    
由於此更新中存在特定二進位檔案，因此解除安裝此更新需要重新啟動兩次。 解除安裝更新之後系統若未重新啟動兩次，可能會發生網路連線中斷。 如需有關此項已知問題的詳細資訊，請參閱 [Microsoft 知識庫文件編號 2345316](https://support.microsoft.com/kb/2345316/zh-tw)。
...
<th style="border:1px solid black;" >Hyper-V VMBus 資訊安全風險 - CVE-2010-3960</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
Hyper-V VMBus 資訊安全風險 - CVE-2010-3960  
------------------------------------------
  
如果經過驗證的使用者在 Hyper-V 伺服器主控的任何來賓虛擬機器上傳送蓄意製作的封包到 VMBus，Windows Server 2008 Hyper-V 和 Windows Server 2008 R2 Hyper-V 中存在的資訊安全風險可能會允許拒絕服務。 攻擊者必須擁有有效的登入認證，並能夠從本機登入客體虛擬機器，才能利用這項資訊安全風險。 匿名或遠端使用者無法利用這個資訊安全風險。
  
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3960](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3960) (英文)。
  
#### Hyper-V VMBus 資訊安全風險 - CVE-2010-3960 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   攻擊者必須擁有有效的登入認證，並能夠從本機登入 Hyper-V 虛擬機器，才能利用這項資訊安全風險。 匿名或遠端使用者無法利用這個資訊安全風險。
  
#### Hyper-V VMBus 資訊安全風險 - CVE-2010-3960 的因應措施
  
Microsoft 尚未找到此項資訊安全風險的任何因應措施。
  
#### Hyper-V VMBus 資訊安全風險 - CVE-2010-3960 的常見問題集
  
**這個資訊安全風險的範圍為何？**    
這是一項拒絕服務的資訊安全風險。 成功利用此資訊安全風險的攻擊者可使受影響的 Hyper-V 伺服器停止回應，使系統必須重新啟動。 請注意拒絕服務資訊安全風險不會讓攻擊者執行程式碼或提高其使用者權限，但會導致受影響系統停止接受要求。
  
**造成這個資訊安全風險的原因為何？**    
當 Hyper-V 伺服器以錯誤的方式驗證傳送到 Hyper-V VMBus 之蓄意封裝的封包，就會導致此資訊安全風險。 由於缺少驗證，處理這些封包可能導致 Hyper-V 伺服器應用程式無回應。
...
**什麼是 VMBus？**    
VMBus 是邏輯互相磁碟分割通訊通道。 如需 VMBus 和 Hyper-V 結構的詳細資訊，請參閱 MSDN 文章：[Hyper-V 結構](https://msdn.microsoft.com/en-us/library/cc768520(bts.10).aspx) (英文)。
  
**攻擊者可能會利用這項資訊安全風險採取什麼行動？**    
成功利用此資訊安全風險的攻擊者可讓使用者的系統停止回應，直到系統重新啟動為止。 請注意，利用此資訊安全風險可讓 Hyper-V 伺服器停止回應，包括該伺服器主控的所有客體虛擬機器。
  
**攻擊者如何利用這項資訊安全風險？**    
攻擊者必須是由 Hyper-V 伺服器主控的任一客體虛擬機器中的授權使用者，且必須能夠在系統上執行任意程式碼。 攻擊者之後必須建立可建立蓄意製作之封包的自訂驅動程式，以傳送到 VMBus，藉此導致 Hyper-V 伺服器停止回應。
  
**因為這個資訊安全風險而承受風險的主要系統有哪些？**    
Hyper-V 伺服器主控的來賓虛擬機器若允許不受信任的使用者進行存取，將特別容易受此資訊安全風險影響。
  
**更新的作用何在？**    
此更新可修正 Hyper-V 伺服器驗證和處理從來賓虛擬機器傳遞到 Hyper-V VMBus 之蓄意製作的封包的方式，進而解決此資訊安全風險。
...
#### Windows Server 2008 (所有 x64 型版本)
...
<br />
為避免網路連線中斷，解除安裝此更新需要重新啟動兩次。 如需有關此解決安裝案例的詳細資訊，請參閱 <a href="https://support.microsoft.com/kb/2345316/zh-tw">Microsoft 知識庫文件編號 2345316</a>。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2345316/zh-tw">Microsoft 知識庫文件編號 2345316</a></td>
</tr>
<tr class="odd">
...
-   感謝 [HP](https://www.hp.com) 和 [techit](https://www.techit.de) 回報 Hyper-V VMBus 資訊安全風險 (CVE-2010-3960)
