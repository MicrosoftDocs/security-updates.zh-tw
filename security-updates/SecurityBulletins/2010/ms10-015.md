...
這個安全性更新也能解決 [Microsoft 安全性摘要報告 979682](https://technet.microsoft.com/security/advisory/979682) 中首先提出的弱點。
...
**已知問題。** [Microsoft 知識庫文件編號 977165](https://support.microsoft.com/kb/977165) 中記載了客戶安裝此安全性更新後，可能會發生的目前已知問題。 該文件並說明了解決這些問題的建議解決方案。 目前已知問題和建議解決方案僅適用於此軟體的特定版本，本文會提供詳細文章的連結。
...
是的。所有受影響 Windows 平台的更新套件 (KB977165) 均包含 [Microsoft 知識庫文件編號 977165](https://support.microsoft.com/kb/977165) 中所描述的 Windows 核心變更。
...
<span></span>
下列嚴重性等級是假設弱點可能造成的最嚴重影響而評定。 在本資訊安全公告發行的 30 天內，如需弱點之易遭利用性與嚴重性等級和安全性影響之間對應關係的資訊，請參閱[2 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms10-feb)中的＜弱點索引＞。 如需更多資訊，請參閱 [Microsoft 弱點索引](https://technet.microsoft.com/en-us/security/cc998259.aspx)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2010-0232](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0232)。
...
-   停用 NTVDM 子系統
    ...
    **注意：**請參閱 [Microsoft 知識庫文件編號 979682](https://support.microsoft.com/kb/979682)，取得如何自動實作此因應措施的資訊。
...
是。 這項弱點已經遭到公開揭發。 這項弱點已被指派一般性弱點編號 [CVE-2010-0232](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0232)。首次討論到此問題是在 [Microsoft 安全性摘要報告 979682](https://technet.microsoft.com/security/advisory/979682) 中。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2010-0233](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0233)。
...
<span></span>
管理您必須部署到您組織中的伺服器、桌上型電腦及行動系統的軟體和安全性更新。 如需更多資訊，請參閱 [TechNet 更新管理中心](https://technet.microsoft.com/zh-tw/updatemanagement/default.aspx) 。 [TechNet 資訊安全中心](https://go.microsoft.com/fwlink/?linkid=21132)提供了有關 Microsoft 產品安全性的其他資訊。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/977165">Microsoft 知識庫文件編號 977165</a></td>
</tr>
<tr class="even">
...
-   感謝 [Google Inc.](https://www.google.com/) 的 Tavis Ormandy 回報 Windows 核心重覆釋放相同記憶體空間弱點 (CVE-2010-0233)
