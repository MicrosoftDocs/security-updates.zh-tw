---
TOCTitle: 'MS10-028'
Title: 'Microsoft Security Bulletin MS10-028 - 重要'
ms:assetid: 'ms10-028'
ms:contentKeyID: 61238554
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms10-028(v=Security.10)'
---


Microsoft Security Bulletin MS10-028 - 重要
===========================================

Microsoft Visio 中的弱點可能會允許遠端執行程式碼 (980094)
---------------------------------------------------------
...
此安全性更新可解決 Microsoft Office Visio 中兩項未公開報告的弱點。 如果使用者開啟蓄意製作的 Visio 檔案，此弱點可能會允許遠端執行程式碼。 成功利用這類弱點的攻擊者可以取得與本機使用者相同的使用者權限。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

對於 Microsoft Office Visio 2002 Service Pack 2、Microsoft Office Visio 2003 Service Pack 3、Microsoft Office Visio 2007 Service Pack 1 和 Microsoft Office Visio 2007 Service Pack 2，此安全性更新的等級為「重要」。如需詳細資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此安全性更新可修正 Microsoft Office Visio 在開啟蓄意製作的 Visio 檔案時驗證屬性及計算索引的方式，進而解決這些弱點。 如需更多有關弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2d563cbc-d8f7-486b-8c54-25d168085376">Microsoft Office Visio 2002 Service Pack 2 (英文下載更新程式)</a><br />
(KB979364)  
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=2d563cbc-d8f7-486b-8c54-25d168085376">Microsoft Office Visio 2002 Service Pack 2 (中文下載更新程式)</a><br />
(KB979364)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=803a7ea0-a9da-46dd-9548-0177d3774be7">Microsoft Office Visio 2003 Service Pack 3 (英文下載更新程式)</a><br />
(KB979356)  
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=803a7ea0-a9da-46dd-9548-0177d3774be7">Microsoft Office Visio 2003 Service Pack 3 (中文下載更新程式)</a><br />
(KB979356)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=56fe020f-4444-4a43-aa98-e99a622f6a69">Microsoft Office Visio 2007 Service Pack 1 (英文下載更新程式)</a><br />
(KB979365)  
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=56fe020f-4444-4a43-aa98-e99a622f6a69">Microsoft Office Visio 2007 Service Pack 1 (中文下載更新程式)</a><br />
(KB979365)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-005">MS09-005</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=56fe020f-4444-4a43-aa98-e99a622f6a69">Microsoft Office Visio 2007 Service Pack 2 (英文下載更新程式)</a><br />
(KB979365)  
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=56fe020f-4444-4a43-aa98-e99a622f6a69">Microsoft Office Visio 2007 Service Pack 2 (中文下載更新程式)</a><br />
(KB979365)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
...
Microsoft Office Visio 2002 和更新版本具備內建功能，可提示使用者先 \[開啟\]、\[儲存\] 或 \[取消\]，再開啟文件。 此緩和因素可將弱點從「重大」減緩至「重要」，因為此弱點需要多個使用者動作才能奏效。
  
**哪裡可以找到 Microsoft Office Viewer 的詳細資訊？**    
如需更多關於 Microsoft Office Viewer 的目前和淘汰版本資訊，請參閱 [Microsoft 知識庫文件編號 979860](https://support.microsoft.com/?id=979860/zh-tw)。
...
<th style="border:1px solid black;" >Visio 屬性驗證記憶體損毀弱點 - CVE-2010-0254</th>
<th style="border:1px solid black;" >Visio 索引計算記憶體損毀弱點 - CVE-2010-0256</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
Visio 屬性驗證記憶體損毀弱點 - CVE-2010-0254  
--------------------------------------------
  
在 Microsoft Office Visio 處理蓄意製作的 Visio 檔案時驗證屬性的方式中，存在一項遠端執行程式碼弱點。
  
成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
  
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-0254](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0254) (英文)。
  
#### Visio 屬性驗證記憶體損毀弱點 - CVE-2010-0254 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少弱點影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   Microsoft Office Visio 2002 及更新版本的 Visio 在開啟文件前，會提示使用者 \[開啟\]、\[儲存\] 或 \[取消\]。 此為緩和因素，因為弱點需要多個使用者動作才能奏效。  
-   無法透過電子郵件自動攻擊此弱點。 使用者必須順利開啟電子郵件訊息中傳送的附件，攻擊才可進行。 攻擊者必須說服使用者開啟附件，以利用弱點。  
-   在網頁攻擊的案例中，攻擊者必須架設網站，並在其中包含蓄意製作的 Visio 檔案，以嘗試利用此弱點。 此外，受侵害的網站以及接受或存放使用者提供之內容的網站裡，也可能包含蓄意製作以利用本弱點的內容。 攻擊者並不能強迫使用者造訪蓄意製作的網站， 而是引誘使用者自行前往。一般的做法是設法讓使用者點選連往攻擊者網站的連結，然後引誘他們開啟蓄意製作的 Visio 檔案。  
-   成功利用此弱點的攻擊者可以取得與本機使用者相同的使用者權限。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
  
#### Visio 屬性驗證記憶體損毀弱點 - CVE-2010-0254 的因應措施
  
因應措施指的是無法徹底修正弱點，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。 Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：
  
-   對於來自於不受信任的來源或在非預期情況下從信任來源收到的 Visio 檔案，請勿隨意開啟。 當使用者開啟蓄意製作的檔案時，即可能遭受利用此弱點的攻擊。 副檔名 .vsd 通常與 Visio 檔案相關聯。
  
#### Visio 屬性驗證記憶體損毀弱點 - CVE-2010-0254 的常見問題集
  
**這個弱點的範圍為何？**    
這是遠端執行程式碼的弱點。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個弱點的原因為何？**    
Microsoft Office Visio 開啟蓄意製作的 Visio 檔案時採取的記憶體處理方式，是造成此弱點的原因。
...
**更新的作用何在？**    
此更新程式可修正 Microsoft Office Visio 在開啟蓄意製作的 Visio 檔案時驗證屬性的方式，進而解決此項弱點。
...
Visio 索引計算記憶體損毀弱點 - CVE-2010-0256  
--------------------------------------------
  
在 Microsoft Office Visio 處理蓄意製作的 Visio 檔案時計算索引的方式中，存在一項遠端執行程式碼弱點。
  
成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
  
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-0256](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0256) (英文)。
  
#### Visio 索引計算記憶體損毀弱點 - CVE-2010-0256 的緩和因素
...
#### Visio 索引計算記憶體損毀弱點 - CVE-2010-0256 的因應措施
  
因應措施指的是無法徹底修正弱點，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。 Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：
  
-   對於來自於不受信任的來源或在非預期情況下從信任來源收到的 Visio 檔案，請勿隨意開啟。 當使用者開啟蓄意製作的檔案時，即可能遭受利用此弱點的攻擊。
  
#### Visio 索引計算記憶體損毀弱點 - CVE-2010-0256 的常見問題集
...
**更新的作用何在？**    
此更新程式可修正 Microsoft Office Visio 在開啟蓄意製作的 Visio 檔案時計算索引的方式，進而解決此項弱點。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/979364/zh-tw">Microsoft 知識庫文件編號 979364</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/979356/zh-tw">Microsoft 知識庫文件編號 979356</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/979365/zh-tw">Microsoft 知識庫文件編號 979365</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
-   感謝 Fortinet 公司 [FortiGuard Labs](https://www.fortiguard.com/) 的 Bing Liu 回報 Visio 屬性驗證記憶體損毀弱點 (CVE-2010-0254)  
-   感謝 Fortinet 公司 [FortiGuard Labs](https://www.fortiguard.com/) 的 Bing Liu 回報 Visio 索引計算記憶體損毀弱點 (CVE-2010-0256)
