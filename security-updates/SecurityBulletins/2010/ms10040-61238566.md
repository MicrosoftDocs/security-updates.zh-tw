...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=0761c207-5465-4f42-b61f-bd02efcef27d">Internet Information Services 6.0 (英文下載更新程式)</a>[1]
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=0761c207-5465-4f42-b61f-bd02efcef27d">Internet Information Services 6.0 (中文下載更新程式)</a>[1]</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=023572ff-ce5d-4428-a96b-1245db6ff312">Internet Information Services 6.0 (英文下載更新程式)</a>[1]
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=023572ff-ce5d-4428-a96b-1245db6ff312">Internet Information Services 6.0 (中文下載更新程式)</a>[1]</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=f1f3e524-8ac6-4210-a3a8-4ffc58a606ea">Internet Information Services 6.0 (英文下載更新程式)</a>[1]</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=01382926-2313-4769-a0a5-262c4f9f18a1">Internet Information Services 7.0 (英文下載更新程式)</a>[1]
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=01382926-2313-4769-a0a5-262c4f9f18a1">Internet Information Services 7.0 (中文下載更新程式)</a>[1]</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=7fb6f2b8-c7a6-4239-99f3-cf3aacf89b0f">Internet Information Services 7.0 (英文下載更新程式)</a>[1]
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=7fb6f2b8-c7a6-4239-99f3-cf3aacf89b0f">Internet Information Services 7.0 (中文下載更新程式)</a>[1]</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=84a54246-5d9e-49e2-8170-af48b43f984d">Internet Information Services 7.0 (英文下載更新程式)</a>*[1]
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=84a54246-5d9e-49e2-8170-af48b43f984d">Internet Information Services 7.0 (中文下載更新程式)</a>*[1]</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=38286e43-89a6-4895-8ff9-69452df38706">Internet Information Services 7.0 (英文下載更新程式)</a>*[1]
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=38286e43-89a6-4895-8ff9-69452df38706">Internet Information Services 7.0 (中文下載更新程式)</a>*[1]</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=8ad19eba-9821-48b4-a942-4ee4f002f913">Internet Information Services 7.0 (英文下載更新程式)</a>[1]</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=588167cb-f62a-4fb8-8a18-ac15dc322495">Internet Information Services 7.5 (英文下載更新程式)</a>
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=588167cb-f62a-4fb8-8a18-ac15dc322495">Internet Information Services 7.5 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=1c45d0c8-1629-470b-8167-c6bf66054595">Internet Information Services 7.5 (英文下載更新程式)</a>
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=1c45d0c8-1629-470b-8167-c6bf66054595">Internet Information Services 7.5 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=5d9b7705-6280-4d2e-94fa-3160b3ce5cfa">Internet Information Services 7.5 (英文下載更新程式)</a>*
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=5d9b7705-6280-4d2e-94fa-3160b3ce5cfa">Internet Information Services 7.5 (中文下載更新程式)</a>*</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=869e900a-0063-4d8b-9b7c-7d12f6be12cd">Internet Information Services 7.5 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<sup>[1]</sup>只有在已安裝延伸驗證防護時才會影響此作業系統。 請參閱 [Microsoft 知識庫文件編號 973917](http://support.microsoft.com/kb/973917/zh-tw)。如需更多資訊，請參閱＜與本安全性更新相關的常見問題集 (FAQ)＞中的項目。
...
<span></span>
**有哪些系統受到此弱點影響？**    
此弱點會影響 Windows 7 與 Windows Server 2008 R2 系統。 此外，也會影響安裝有 [KB973917](http://support.microsoft.com/kb/973917/zh-tw) (實作延伸驗證防護的非安全性更新) 的 Windows Server 2003、Windows Vista 及 Windows Server 2008 系統。
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-1256](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1256) (英文)。
...
-   **要求權杖檢查**
    ...
    將 Internet Information Services 設定為使用延伸防護來「要求」權杖檢查 (如 [Microsoft 知識庫文件編號 973917](http://support.microsoft.com/kb/973917/zh-tw) 中所述) 的系統，不會出現此弱點。
...
延伸防護會針對 Windows Server 2003、Windows Vista 及 Windows Server 2008 以非安全性更新形式提供 (請參閱 [Microsoft 知識庫文件編號 973917](http://support.microsoft.com/kb/973917/zh-tw))。 Windows 7 與 Windows Server 2008 R2 則是將此功能設為作業系統的選用元件，在您為 Internet Information Services (IIS) Web 伺服器安裝 Windows 驗證角色服務時即會加以啟用。
  
**如何驗證我是否已啟用驗證延伸防護？**    
有數種方式可設定驗證延伸防護。 如需設定此功能的資訊 (若具此功能則可用於驗證)，請參閱 [Microsoft 知識庫文件編號 973917](http://support.microsoft.com/kb/973917/zh-tw)。
...
**因為這個弱點而承受風險的主要系統有哪些？**    
需要驗證並支援驗證延伸防護之內容的主控 Web 伺服器，受此弱點的影響最大。 只有安裝了 [Microsoft 知識庫文件編號 973917](http://support.microsoft.com/kb/973917/zh-tw) 中所述之延伸防護更新的系統才會受影響。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/982666/zh-tw">Microsoft 知識庫文件編號 982666</a></td>
</tr>
<tr class="even">
