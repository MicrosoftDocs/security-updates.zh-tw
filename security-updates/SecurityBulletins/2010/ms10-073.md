---
TOCTitle: 'MS10-073'
Title: 'Microsoft Security Bulletin MS10-073 - 重要'
ms:assetid: 'ms10-073'
ms:contentKeyID: 61238599
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms10-073(v=Security.10)'
---


Microsoft Security Bulletin MS10-073 - 重要
===========================================

Windows 核心模式驅動程式的資訊安全風險可能會允許權限提高 (981957)
-----------------------------------------------------------------
...
此資訊安全更新可解決 Windows 核心模式驅動程式中數項公開揭露的資訊安全風險。 如果攻擊者登入受影響的系統並執行蓄意製作的應用程式，則最嚴重的資訊安全風險可能會允許權限提高。 攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項資訊安全風險。 匿名或遠端使用者無法利用這個資訊安全風險。

對於所有受支援版本的 Microsoft Windows，此資訊安全更新的等級為「重要」。 如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此資訊安全更新可修正 Windows 核心模式驅動程式維護物件的參照計數的方式、從磁碟載入鍵盤配置時索引函式指標表格的方式，以及驗證視窗類別資料的方式，藉此解決這些資訊安全風險。 如需更多有關資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3966d754-d298-4e4a-9ce6-8205accd2215">Windows XP Service Pack 3 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=3966d754-d298-4e4a-9ce6-8205accd2215&amp;displaylang=zh-tw">Windows XP Service Pack 3 (中文下載更新程式)</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7fd7c675-0675-4a87-a709-edc47a30f1e2">Windows XP Professional x64 Edition Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-048">MS10-048</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8ef4378e-21ff-4290-96ba-e00a60f372d1">Windows Server 2003 Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=8ef4378e-21ff-4290-96ba-e00a60f372d1&amp;displaylang=zh-tw">Windows Server 2003 Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-048">MS10-048</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4a95c74b-cfd8-45b5-8887-777429d21745">Windows Server 2003 x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=4a95c74b-cfd8-45b5-8887-777429d21745&amp;displaylang=zh-tw">Windows Server 2003 x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-048">MS10-048</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=21637cd8-c75c-43b4-9948-be7be54af6bf">適用於 Itanium 型系統的 Windows Server 2003 SP2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-048">MS10-048</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e9f735ab-d995-4209-b2dc-197f53fdee0f">Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=e9f735ab-d995-4209-b2dc-197f53fdee0f&amp;displaylang=zh-tw">Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-048">MS10-048</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=738c8f70-b46a-4a59-bea6-078074a9c4db">Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=738c8f70-b46a-4a59-bea6-078074a9c4db&amp;displaylang=zh-tw">Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-048">MS10-048</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4dff0ebe-ccba-4675-98ca-9903f1cb6763">適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a>&#42;
<a href="https://www.microsoft.com/download/details.aspx?familyid=4dff0ebe-ccba-4675-98ca-9903f1cb6763&amp;displaylang=zh-tw">適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2 (中文下載更新程式)</a>&#42;</td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-048">MS10-048</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=da7905a9-9587-4184-8fca-ecc636a3b67e">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a>&#42;
<a href="https://www.microsoft.com/download/details.aspx?familyid=da7905a9-9587-4184-8fca-ecc636a3b67e&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2 (中文下載更新程式)</a>&#42;</td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-048">MS10-048</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b9096046-8c7a-450c-b8c5-6e9fb001e6cd">適用於 Itanium 型系統的 Windows Server 2008 和適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-048">MS10-048</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b5b31499-d242-42bf-ac78-b787ffb4d602">適用於 32 位元系統的 Windows 7 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=b5b31499-d242-42bf-ac78-b787ffb4d602&amp;displaylang=zh-tw">適用於 32 位元系統的 Windows 7 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-048">MS10-048</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c47e8b74-8cfe-42d9-9362-8786687c88ad">適用於 x64 型系統的 Windows 7 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=c47e8b74-8cfe-42d9-9362-8786687c88ad&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows 7 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-048">MS10-048</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=98e0c6ac-c30b-4d39-8ed9-1fe69e7644e5">適用於 x64 型系統的 Windows Server 2008 R2 (英文下載更新程式)</a>&#42;
<a href="https://www.microsoft.com/download/details.aspx?familyid=98e0c6ac-c30b-4d39-8ed9-1fe69e7644e5&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows Server 2008 R2 (中文下載更新程式)</a>&#42;</td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-048">MS10-048</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=44080c75-036e-4bd0-914a-74ab72189ee3">適用於 Itanium 系統的 Windows Server 2008 R2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-048">MS10-048</a></td>
</tr>
...
<th style="border:1px solid black;" >Win32k 參照計數資訊安全風險 - CVE-2010-2549</th>
<th style="border:1px solid black;" >Win32k 鍵盤配置資訊安全風險 - CVE-2010-2743</th>
<th style="border:1px solid black;" >Win32k 視窗類別資訊安全風險 - CVE-2010-2744</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
Win32k 參照計數資訊安全風險 - CVE-2010-2549  
-------------------------------------------
  
由於 Windows 核心模式驅動程式維護物件的參照計數之方式，而導致形成一項權限提高資訊安全風險。 成功利用此資訊安全風險的攻擊者可以在核心模式下執行任意程式碼。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
若要在「一般性資訊安全風險」清單標準項目中檢視此資訊安全風險，請參閱 [CVE-2010-2549](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2549) (英文)。
  
#### Win32k 參照計數資訊安全風險 CVE-2010-2549 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項資訊安全風險。 匿名或遠端使用者無法利用這個資訊安全風險。
  
#### Win32k 參照計數資訊安全風險 CVE-2010-2549 的因應措施
  
Microsoft 尚未找到此項資訊安全風險的任何因應措施。
  
#### Win32k 參照計數資訊安全風險 CVE-2010-2549 的常見問題集
  
**這個資訊安全風險的範圍為何？**    
這是權限提高的資訊安全風險。 成功利用此資訊安全風險的攻擊者可執行任意程式碼，並取得受影響之系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個資訊安全風險的原因為何？**    
此資訊安全風險形成的原因，是由於 Windows 核心模式驅動程式維護物件的參照計數的方式不當所致。
...
**什麼是參照計數？**    
物件管理員利用參照計數來記錄已分配給作業系統程序的物件指標數量。 每當物件管理員將指標分配給一個物件時，就會增加該物件的參照計數；當核心模式元件使用完指標後，便會呼叫物件管理員來減少該物件的參照計數。
...
**更新的作用何在？**    
此更新程式可修正 Windows 核心模式驅動程式維護物件的參照計數的方式，進而解決此資訊安全風險。
  
**當資訊安全公告發行時，這項資訊安全風險是否已揭發出來？**    
是。 這項資訊安全風險已經遭到公開揭發。 這項資訊安全風險已被指派「一般性資訊安全風險」編號 [CVE-2010-2549](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2549) (英文)。
  
**當本資訊安全公告發行時，Microsoft 是否已接獲任何消息，指出這項資訊安全風險已遭有心人士利用？**    
否。 當本資訊安全公告初次發行時，Microsoft 並未接到任何有關本資訊安全風險已成為公開攻擊媒介的消息，也沒有發現任何以此概念發展的程式碼公開範例。
  
Win32k 鍵盤配置資訊安全風險 - CVE-2010-2743  
-------------------------------------------
  
由於 Windows 核心模式驅動程式載入特定鍵盤配置的方式，導致形成一項權限提高資訊安全風險。 成功利用此資訊安全風險的攻擊者可以在核心模式下執行任意程式碼。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
若要在「一般性資訊安全風險」清單標準項目中檢視此資訊安全風險，請參閱 [CVE-2010-2743](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2743) (英文)。
  
#### Win32k 鍵盤配置資訊安全風險 CVE-2010-2743 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項資訊安全風險。 匿名或遠端使用者無法利用這個資訊安全風險。
  
#### Win32k 鍵盤配置資訊安全風險 CVE-2010-2743 的因應措施
  
Microsoft 尚未找到此項資訊安全風險的任何因應措施。
  
#### Win32k 鍵盤配置資訊安全風險 CVE-2010-2743 的常見問題集
  
**這個資訊安全風險的範圍為何？**    
這是權限提高的資訊安全風險。 成功利用此資訊安全風險的攻擊者可執行任意程式碼，並取得受影響之系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個資訊安全風險的原因為何？**    
當 Windows 核心模式驅動程式從磁碟載入鍵盤配置時，若未適當索引函式指標的表格，將導致此資訊安全風險形成。
  
**為什麼此資訊安全風險的嚴重性等級在所有受支援版本的 Windows Server 2003、Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2 上為「輕微」？**    
這些 Windows 版本雖然存在此資訊安全風險的相關程式碼，但攻擊者沒有任何已知的方法可以存取此程式碼。 儘管如此，本更新仍針對此程式碼提出解決方法，作為一項深度防禦措施，以防日後有心人士找到利用此程式碼提高權限的方法。
...
**更新的作用何在？**    
此更新可修正 Windows 核心模式驅動程式從磁碟載入鍵盤配置時索引函式指標表格之方式，藉此解決此資訊安全風險。
  
**當資訊安全公告發行時，這項資訊安全風險是否已揭發出來？**    
是。 這項資訊安全風險已經遭到公開揭發。 這項資訊安全風險已被指派「一般性資訊安全風險」編號 [CVE-2010-2743](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2743) (英文)。
  
**當本資訊安全公告發行時，Microsoft 是否已接獲任何消息，指出這項資訊安全風險已遭有心人士利用？**    
是。 本資訊安全公告發行之時，此資訊安全風險已在有限範圍內遭到惡意軟體利用。
  
Win32k 視窗類別資訊安全風險 - CVE-2010-2744  
-------------------------------------------
  
當 Windows 核心模式驅動程式未適當驗證視窗類別資料時，將形成一項權限提高資訊安全風險。 成功利用此資訊安全風險的攻擊者可以在核心模式下執行任意程式碼。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
若要在「一般性資訊安全風險」清單標準項目中檢視此資訊安全風險，請參閱 [CVE-2010-2744](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2744) (英文)。
  
#### Win32k 視窗類別資訊安全風險 - CVE-2010-2744 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項資訊安全風險。 匿名或遠端使用者無法利用這個資訊安全風險。
  
#### Win32k 視窗類別資訊安全風險 - CVE-2010-2744 的因應措施
  
Microsoft 尚未找到此項資訊安全風險的任何因應措施。
  
#### Win32k 視窗類別資訊安全風險 - CVE-2010-2744 的常見問題集
  
**這個資訊安全風險的範圍為何？**    
這是權限提高的資訊安全風險。 成功利用此資訊安全風險的攻擊者可執行任意程式碼，並取得受影響之系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個資訊安全風險的原因為何？**    
此資訊安全風險是由於 Windows 核心模式驅動程式未適當管理視窗類別所致。
...
**什麼是視窗類別？**    
視窗類別是一組屬性，系統利用這組屬性作為範本來建立視窗。 每個視窗都屬於某個視窗類別。 所有視窗類別皆與特定程序相關。 共有三種視窗類別。 「系統類別」是系統所登錄的視窗類別。 許多系統類別適用於所有程序，而部分系統類別則僅供系統內部使用。 由於這些類別是由系統所登錄，因此程序無法刪除它們。 「應用程式全域類別」是可執行檔或 DLL 所登錄的視窗類別，可供程序中其他所有的模組使用。 「應用程式本機類別」則是可執行檔或 .dll 所登錄、僅供其專用的任何視窗類別。 雖然您可以登錄任何數量的本機類別，但一般只會登錄一個。 此視窗類別支援應用程式主視窗的視窗程序。 如需更多關於視窗類別的資訊，請參閱 MSDN 文章：[視窗類別](https://msdn.microsoft.com/en-us/library/ms632596(v=vs.85).aspx)。
...
**更新的作用何在？**    
此更新可修正 Windows 核心模式驅動程式驗證視窗類別資料的方式，以解決此資訊安全風險。
  
**當資訊安全公告發行時，這項資訊安全風險是否已揭發出來？**    
是。 這項資訊安全風險已經遭到公開揭發。 這項資訊安全風險已被指派「一般性資訊安全風險」編號 [CVE-2010-2744](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2744) (英文)。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB981957$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/981957/zh-tw">Microsoft 知識庫文件編號 981957</a></td>
</tr>
<tr class="even">
...
-   感謝 [Kaspersky Lab](https://www.kaspersky.com) 的 Sergey Golovanov、Alexander Gostev、Maxim Golovkin 與 Alexey Monastyrsky，以及 [Design and Test Lab](https://www.dnt-lab.com) 的 Vitaly Kiktenko 和 Alexander Saprykin 回報 Win32K 鍵盤配置資訊安全風險 (CVE-2010-2743)  
-   感謝 [Symantec](https://www.symantec.com/index.jsp) 的 Joji Hamada 回報 Win32k 鍵盤配置資訊安全風險 (CVE-2010-2743)  
-   感謝 [Norman](https://www.norman.com) 的 Tarjei Mandt 協助我們解決 Win32k 視窗類別資訊安全風險 (CVE-2010-2744)
