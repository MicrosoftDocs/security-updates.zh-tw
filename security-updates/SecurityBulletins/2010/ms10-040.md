---
TOCTitle: 'MS10-040'
Title: 'Microsoft Security Bulletin MS10-040 - 重要'
ms:assetid: 'ms10-040'
ms:contentKeyID: 61238566
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms10-040(v=Security.10)'
---


Microsoft Security Bulletin MS10-040 - 重要
===========================================

Internet Information Services 的弱點可能會允許遠端執行程式碼 (982666)
---------------------------------------------------------------------
...
此安全性更新可解決 Internet Information Services (IIS) 中一項未公開報告的弱點。 如果使用者收到蓄意製作的 HTTP 要求，此弱點可能會允許遠端執行程式碼。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。

對於 IIS 6.0、IIS 7.0 及 IIS 7.5，此安全性更新的等級為「重要」。如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此安全性更新可藉由修正驗證碼檢驗來解決此弱點。 如需更多有關弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=0761c207-5465-4f42-b61f-bd02efcef27d">Internet Information Services 6.0 (英文下載更新程式)</a>[1]
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=0761c207-5465-4f42-b61f-bd02efcef27d">Internet Information Services 6.0 (中文下載更新程式)</a>[1]</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=023572ff-ce5d-4428-a96b-1245db6ff312">Internet Information Services 6.0 (英文下載更新程式)</a>[1]
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=023572ff-ce5d-4428-a96b-1245db6ff312">Internet Information Services 6.0 (中文下載更新程式)</a>[1]</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f1f3e524-8ac6-4210-a3a8-4ffc58a606ea">Internet Information Services 6.0 (英文下載更新程式)</a>[1]</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=01382926-2313-4769-a0a5-262c4f9f18a1">Internet Information Services 7.0 (英文下載更新程式)</a>[1]
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=01382926-2313-4769-a0a5-262c4f9f18a1">Internet Information Services 7.0 (中文下載更新程式)</a>[1]</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7fb6f2b8-c7a6-4239-99f3-cf3aacf89b0f">Internet Information Services 7.0 (英文下載更新程式)</a>[1]
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=7fb6f2b8-c7a6-4239-99f3-cf3aacf89b0f">Internet Information Services 7.0 (中文下載更新程式)</a>[1]</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=84a54246-5d9e-49e2-8170-af48b43f984d">Internet Information Services 7.0 (英文下載更新程式)</a>&#42;[1]
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=84a54246-5d9e-49e2-8170-af48b43f984d">Internet Information Services 7.0 (中文下載更新程式)</a>&#42;[1]</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=38286e43-89a6-4895-8ff9-69452df38706">Internet Information Services 7.0 (英文下載更新程式)</a>&#42;[1]
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=38286e43-89a6-4895-8ff9-69452df38706">Internet Information Services 7.0 (中文下載更新程式)</a>&#42;[1]</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8ad19eba-9821-48b4-a942-4ee4f002f913">Internet Information Services 7.0 (英文下載更新程式)</a>[1]</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=588167cb-f62a-4fb8-8a18-ac15dc322495">Internet Information Services 7.5 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=588167cb-f62a-4fb8-8a18-ac15dc322495">Internet Information Services 7.5 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1c45d0c8-1629-470b-8167-c6bf66054595">Internet Information Services 7.5 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=1c45d0c8-1629-470b-8167-c6bf66054595">Internet Information Services 7.5 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5d9b7705-6280-4d2e-94fa-3160b3ce5cfa">Internet Information Services 7.5 (英文下載更新程式)</a>&#42;
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=5d9b7705-6280-4d2e-94fa-3160b3ce5cfa">Internet Information Services 7.5 (中文下載更新程式)</a>&#42;</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=869e900a-0063-4d8b-9b7c-7d12f6be12cd">Internet Information Services 7.5 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<sup>[1]</sup>只有在已安裝延伸驗證防護時才會影響此作業系統。 請參閱 [Microsoft 知識庫文件編號 973917](https://support.microsoft.com/kb/973917/zh-tw)。如需更多資訊，請參閱＜與本安全性更新相關的常見問題集 (FAQ)＞中的項目。
...
| Windows XP Service Pack 2 及 Windows XP Service Pack 3 | Internet Information Services 5.1 |  
...
**有哪些系統受到此弱點影響？**    
此弱點會影響 Windows 7 與 Windows Server 2008 R2 系統。 此外，也會影響安裝有 [KB973917](https://support.microsoft.com/kb/973917/zh-tw) (實作延伸驗證防護的非安全性更新) 的 Windows Server 2003、Windows Vista 及 Windows Server 2008 系統。
  
**如果電腦沒有安裝 KB973917，是否會受到影響？**    
執行受支援版本 Windows Server 2003、Windows Vista 及 Windows Server 2008 且未安裝 KB973917 的系統，將不會受影響。 執行受支援版本 Windows 7 與 Windows Server 2008 R2 的系統會受影響。
  
**如果我未安裝 KB973917，我是否會收到此安全性更新？**    
未安裝 KB973917 更新的系統不會收到此更新，因為它們不受此安全性弱點影響。
...
<th style="border:1px solid black;" >IIS 驗證記憶體損毀弱點 - CVE-2010-1256</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
<tr class="odd">
<td style="border:1px solid black;">適用於 Itanium 型系統的 Windows Server 2003 SP2 上的 Internet Information Services 6.0</td>
<td style="border:1px solid black;"><strong>重要</strong><br />
遠端執行程式碼</td>
<td style="border:1px solid black;"><strong>重要</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Vista Service Pack 1 與 Windows Vista Service Pack 2 上的 Internet Information Services 7.0</td>
<td style="border:1px solid black;"><strong>重要</strong><br />
遠端執行程式碼</td>
<td style="border:1px solid black;"><strong>重要</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Vista x64 Edition Service Pack 1 與 Windows Vista x64 Edition Service Pack 2 上的 Internet Information Services 7.0</td>
<td style="border:1px solid black;"><strong>重要</strong><br />
遠端執行程式碼</td>
<td style="border:1px solid black;"><strong>重要</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">適用於 32 位元系統的 Windows Server 2008 與適用於 32 位元系統的 Windows Server 2008 Service Pack 2 上的 Internet Information Services 7.0&#42;</td>
<td style="border:1px solid black;"><strong>重要</strong><br />
遠端執行程式碼</td>
<td style="border:1px solid black;"><strong>重要</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">適用於 x64 型系統的 Windows Server 2008 與適用於 x64 型系統的 Windows Server 2008 Service Pack 2 上的 Internet Information Services 7.0&#42;</td>
<td style="border:1px solid black;"><strong>重要</strong><br />
遠端執行程式碼</td>
<td style="border:1px solid black;"><strong>重要</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">適用於 Itanium 型系統的 Windows Server 2008 與適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2 上的 Internet Information Services 7.0</td>
<td style="border:1px solid black;"><strong>重要</strong><br />
遠端執行程式碼</td>
<td style="border:1px solid black;"><strong>重要</strong></td>
</tr>
...
IIS 驗證記憶體損毀弱點 - CVE-2010-1256  
--------------------------------------
  
Internet Information Services (IIS) 中存在遠端執行程式碼弱點。 由於不當剖析驗證資訊，因此出現此弱點。 成功利用此弱點的攻擊者可能會在工作者處理序識別 (WPI) 的內容中執行程式碼。
  
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-1256](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1256) (英文)。
  
#### IIS 驗證記憶體損毀弱點 - CVE-2010-1256 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少弱點影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   若未在 Windows Server 2003、Windows Vista 及 Windows Server 2008 上安裝 KB973917，這些系統便不具延伸驗證防護，因此不會受影響。  
-   在所有受影響的平台上，即使系統中已安裝 KB973917，依預設並未啟用延伸驗證防護。這些系統只有在此功能已啟用時，才會受到影響。
  
#### IIS 驗證記憶體損毀弱點 - CVE-2010-1256 的因應措施
  
因應措施指的是無法徹底修正弱點，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。 Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：
  
-   **要求權杖檢查**
  
    將 Internet Information Services 設定為使用延伸防護來「要求」權杖檢查 (如 [Microsoft 知識庫文件編號 973917](https://support.microsoft.com/kb/973917/zh-tw) 中所述) 的系統，不會出現此弱點。
  
    **因應措施的影響。** 此設定變更不允許未實作延伸防護的用戶端進行驗證。
  
#### IIS 驗證記憶體損毀弱點 - CVE-2010-1256 的常見問題集
  
**這個弱點的範圍為何？**    
這是遠端執行程式碼的弱點。 成功利用此弱點的遠端已驗證攻擊者，接著可能會以與工作者處理序識別 (WPI) 相同的權限，在 IIS 伺服器上執行動作。 依預設，此識別在 Windows Server 2003、Windows Vista 及 Windows Server 2008 上會設定為網路服務帳戶。此識別在 Windows 7 與 Windows Server 2008 R2 上將設定為虛擬應用程式集區識別。
  
**造成這個弱點的原因為何？**    
若 Internet Information Services 的 Web 伺服器在剖析從用戶端收到的特定驗證資訊時未正確配置記憶體，便會導致此弱點。
  
**什麼元件會受到這個弱點的影響？**    
若 Internet Information Services 的 Web 伺服器設定為支援僅使用延伸驗證防護的驗證要求，此弱點便會影響該伺服器。 必須將延伸保護功能設定為非預設狀態，允許此元件進行權杖檢查，才會受到影響。
  
**什麼是驗證延伸防護？**    
驗證延伸防護有助於抵禦攻擊者攔截用戶端認證並將其轉寄給伺服器的攔截式 (MITM) 攻擊。 為了提供這層額外的防護，驗證延伸防護部署方式會採用系統管理員與使用者必須安裝的非安全性更新提供。
  
延伸防護會針對 Windows Server 2003、Windows Vista 及 Windows Server 2008 以非安全性更新形式提供 (請參閱 [Microsoft 知識庫文件編號 973917](https://support.microsoft.com/kb/973917/zh-tw))。 Windows 7 與 Windows Server 2008 R2 則是將此功能設為作業系統的選用元件，在您為 Internet Information Services (IIS) Web 伺服器安裝 Windows 驗證角色服務時即會加以啟用。
  
**如何驗證我是否已啟用驗證延伸防護？**    
有數種方式可設定驗證延伸防護。 如需設定此功能的資訊 (若具此功能則可用於驗證)，請參閱 [Microsoft 知識庫文件編號 973917](https://support.microsoft.com/kb/973917/zh-tw)。
  
**攻擊者可能會利用這項弱點採取什麼行動？**    
成功利用此弱點的遠端已驗證攻擊者，接著可能會以與工作者處理序識別 (WPI) 相同的權限，在 IIS 伺服器上執行動作。 WPI 依預設必須以網路服務帳戶權限來加以設定。 以 WPI (使用具備系統管理權限的帳戶) 設定應用程式集區的 IIS 伺服器 (包含 ASP 網頁)，相較於以預設 WPI 設定來設定應用程式集區的 IIS 伺服器，可能會產生較大的影響。
  
**攻擊者如何利用這項弱點？**    
若在用戶端上未啟用驗證延伸防護，但在伺服器上啟用了此功能，則在 IIS 伺服器處理驗證嘗試的方式中便會存在遠端執行程式碼的弱點。 攻擊者可建立蓄意製作的 HTTP 要求來利用此弱點。
  
**因為這個弱點而承受風險的主要系統有哪些？**    
需要驗證並支援驗證延伸防護之內容的主控 Web 伺服器，受此弱點的影響最大。 只有安裝了 [Microsoft 知識庫文件編號 973917](https://support.microsoft.com/kb/973917/zh-tw) 中所述之延伸防護更新的系統才會受影響。
  
**更新的作用何在？**    
此更新可藉由修正 IIS 驗證用戶端所傳遞之特定驗證資訊的方式，來解決此項弱點。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB982666$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/982666/zh-tw">Microsoft 知識庫文件編號 982666</a></td>
</tr>
<tr class="even">
