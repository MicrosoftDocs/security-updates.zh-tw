...
**已知問題。** [Microsoft 知識庫文件編號 968095](https://support.microsoft.com/kb/968095/zh-tw) 中記載客戶安裝此資訊安全更新後，目前已知可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。 目前已知問題和建議解決方案僅適用於此軟體的特定版本，本文會提供詳細文章的連結。
...
是。 這個更新包括非安全性變更，可提供支援，以覆寫 Microsoft Office 2007 與 Microsoft Office 2010 預設封鎖的轉換程式與篩選器清單。如需 Microsoft Office 圖形篩選工具的資訊安全設定詳細資訊，請參閱 [Microsoft 知識庫文件編號 2479871](https://support.microsoft.com/kb/2479871/zh-tw)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3945](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3945) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3946](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3946) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3947](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3947) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3949](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3949) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3950](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3950) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3951](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3951) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3952](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3952) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2289162/zh-tw">Microsoft 知識庫文件編號 2289162</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2289163/zh-tw">Microsoft 知識庫文件編號 2289163</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2288931/zh-tw">Microsoft 知識庫文件編號 2288931</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2289078/zh-tw">Microsoft 知識庫文件編號 2289078</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2456849/zh-tw">Microsoft 知識庫文件編號 2456849</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2431831/zh-tw">Microsoft 知識庫文件編號 2431831</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
-   感謝 [Palo Alto Networks](https://www.paloaltonetworks.com/) 的 Yamata Li 回報 CGM 影像轉換程式緩衝區溢位資訊安全風險 (CVE-2010-3945)  
-   感謝 [Palo Alto Networks](https://www.paloaltonetworks.com/) 的 Yamata Li 回報 PICT 影像轉換程式整數溢位資訊安全風險 (CVE-2010-3946)  
-   感謝 [Secunia Research](https://secunia.com/) 的 Alin Rad Pop 回報 PICT 影像轉換程式整數溢位資訊安全風險 (CVE-2010-3946)  
-   感謝 [Secunia Research](https://secunia.com/) 的 Carsten Eiram 回報 TIFF 影像轉換程式堆積溢位資訊安全風險 (CVE-2010-3947)  
-   感謝 [Secunia Research](https://secunia.com/) 的 Carsten Eiram 回報 TIFF 影像轉換程式緩衝區溢位資訊安全風險 (CVE-2010-3949)  
-   感謝 [Secunia Research](https://secunia.com/) 的 Carsten Eiram 回報 TIFF 影像轉換程式記憶體損毀資訊安全風險 (CVE-2010-3950)  
-   感謝 [Secunia Research](https://secunia.com/) 的 Dyon Balding 回報 FlashPix 影像轉換程式緩衝區溢位資訊安全風險 (CVE-2010-3951)  
-   感謝 [Secunia Research](https://secunia.com/) 的 Dyon Balding 回報 FlashPix 影像轉換程式堆積損毀資訊安全風險 (CVE-2010-3952)
