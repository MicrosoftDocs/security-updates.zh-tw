...
此資訊安全更新可解決 [Microsoft 資訊安全摘要報告 2286198](https://technet.microsoft.com/security/advisory/2286198) 中首先提出的弱點。
...
下列嚴重性等級是假設弱點可能造成的最嚴重影響而評定。 在本資訊安全公告發行的 30 天內，如需弱點之易遭利用性與嚴重性等級和安全性影響之間對應關係的資訊，請參閱 [8 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms10-aug)中的＜弱點索引＞。 如需更多資訊，請參閱 [Microsoft 弱點索引](https://technet.microsoft.com/en-us/security/cc998259.aspx)。
...
受影響版本的 Microsoft Windows 中存在一個遠端執行程式碼弱點。 形成這個弱點的原因，是由於 Windows 未正確剖析捷徑，因此，當作業系統顯示惡意捷徑檔案的圖示時，便可能會執行惡意程式碼。 一旦成功利用此弱點，攻擊者便能以登入的使用者身分執行任意程式碼。 此更新程式能解決先前於 [Microsoft 資訊安全摘要報告 2286198](https://technet.microsoft.com/security/advisory/2286198) 中討論的一項弱點。
  
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-2568](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2568) (英文)。
...
-   **停用捷徑圖示的顯示**
    ...
    **注意：**請參閱 [Microsoft 知識庫文件編號 2286198](https://support.microsoft.com/kb/2286198/zh-tw)，瞭解如何使用自動化 **Microsoft Fix It** 解決方案來啟用或停用本因應措施。 這個 Fix it 解決方案需要在完成時重新啟動電腦，才會生效。 這個 Fix it 解決方案會部署因應措施，因此對使用者具有相同的影響。 我們建議系統管理員先詳閱 KB 文件，再部署這個 Fix it 解決方案。
...
是。 這項弱點已經遭到公開揭發。 這項弱點已被指派「一般性弱點」編號 [CVE-2010-2568](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2568)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2286198/zh-tw">Microsoft 知識庫文件編號 2286198</a></td>
</tr>
<tr class="even">
...
-   感謝 [VirusBlokAda](https://www.anti-virus.by/) 的 Sergey I. Ulasen 和 Uleg Kopreev 回報捷徑圖示載入弱點 (CVE-2010-2568)  
-   感謝 [AV-Test](https://www.av-test.org/) 的 Andreas Marx 和 Maik Morgenstern 回報捷徑圖示載入弱點 (CVE-2010-2568)  
-   感謝 [CERT/CC](https://www.cert.org) 的 Will Dormann 協助我們解決捷徑圖示載入弱點 (CVE-2010-2568)  
