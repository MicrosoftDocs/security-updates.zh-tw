---
TOCTitle: 'MS10-054'
Title: 'Microsoft Security Bulletin MS10-054 - 重大'
ms:assetid: 'ms10-054'
ms:contentKeyID: 61238580
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms10-054(v=Security.10)'
---


Microsoft Security Bulletin MS10-054 - 重大
===========================================

SMB 伺服器中的弱點可能會允許遠端執行程式碼 (982214)
---------------------------------------------------
...
這個資訊安全更新可解決 Microsoft Windows 中數個未公開報告的弱點。 如果攻擊者蓄意製作 SMB 封包並將其傳送至受影響的系統，最嚴重的弱點可能會允許遠端執行程式碼。 最佳做法的防火牆和標準預設防火牆設定有助於防止網路受到來自企業外試圖利用這些弱點的攻擊。
...
這個資訊安全更新可修正 SMB 驗證 SMB 要求的方式，進而解決這些弱點。 如需更多有關弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=6e5e16f8-c140-4a1d-b898-8417a6bfd4d8">Windows XP Service Pack 3 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=6e5e16f8-c140-4a1d-b898-8417a6bfd4d8">Windows XP Service Pack 3 (中文下載更新程式)</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=fd6cc359-e72e-46ec-a08b-763934e3e115">Windows XP Professional x64 Edition Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-012">MS10-012</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=230e8559-e6df-49d5-acb5-b0cd4bde0bf4">Windows Server 2003 Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=230e8559-e6df-49d5-acb5-b0cd4bde0bf4">Windows Server 2003 Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-012">MS10-012</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=03804f59-748e-4832-98e4-2d88564bd10a">Windows Server 2003 x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=03804f59-748e-4832-98e4-2d88564bd10a">Windows Server 2003 x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-012">MS10-012</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e4f4f8b3-7a39-4d77-a46b-02c86ad159c3">適用於 Itanium 型系統的 Windows Server 2003 SP2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-012">MS10-012</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9087a3aa-aa55-41f6-8c4c-f322e4aa8681">Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=9087a3aa-aa55-41f6-8c4c-f322e4aa8681">Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-012">MS10-012</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=10c9d5f1-53ed-459b-a663-e69bdb845a6b">Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=10c9d5f1-53ed-459b-a663-e69bdb845a6b">Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-012">MS10-012</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=a94e2e38-116a-4b63-9328-6c33e63bbbfe">適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a>&#42;
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=a94e2e38-116a-4b63-9328-6c33e63bbbfe">適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2 (中文下載更新程式)</a>&#42;</td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-012">MS10-012</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=602dd3f6-0d09-4546-b1db-d7b6b04edb66">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a>&#42;
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=602dd3f6-0d09-4546-b1db-d7b6b04edb66">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2 (中文下載更新程式)</a>&#42;</td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-012">MS10-012</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=24d8f0a3-51a9-46c1-b870-a2239bf600e4">適用於 Itanium 型系統的 Windows Server 2008 和適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-012">MS10-012</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8d58ebc4-a5f9-4318-a6f1-168c1bcdae3c">適用於 32 位元系統的 Windows 7 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=8d58ebc4-a5f9-4318-a6f1-168c1bcdae3c">適用於 32 位元系統的 Windows 7 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-012">MS10-012</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ad1ddf94-d714-4b36-8256-42bf79d03a90">適用於 x64 型系統的 Windows 7 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=ad1ddf94-d714-4b36-8256-42bf79d03a90">適用於 x64 型系統的 Windows 7 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-012">MS10-012</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=52642a8d-1081-4496-848e-9b03baf3fdac">適用於 x64 型系統的 Windows Server 2008 R2 (英文下載更新程式)</a>&#42;
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=52642a8d-1081-4496-848e-9b03baf3fdac">適用於 x64 型系統的 Windows Server 2008 R2 (中文下載更新程式)</a>&#42;</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-012">MS10-012</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=783fb42c-3698-4b1d-a692-3ff319578931">適用於 Itanium 系統的 Windows Server 2008 R2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-012">MS10-012</a></td>
</tr>
...
<th style="border:1px solid black;" >SMB 集區溢位弱點 - CVE-2010-2550</th>
<th style="border:1px solid black;" >SMB 變數驗證弱點 - CVE-2010-2551</th>
<th style="border:1px solid black;" >SMB 堆疊耗盡弱點 - CVE-2010-2552</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
SMB 集區溢位弱點 - CVE-2010-2550  
--------------------------------
  
未經驗證的遠端執行程式碼弱點，存在於 Microsoft 伺服器訊息區 (SMB) 通訊協定軟體處理蓄意製作的 SMB 封包中。 攻擊者不需要驗證即可利用這項弱點，因此可藉由傳送蓄意製作的網路訊息至執行伺服器服務的電腦來利用弱點。 成功利用此弱點的攻擊者可以取得系統的完整控制權。
  
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-2550](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2550) (英文)。
  
#### SMB 集區溢位弱點 - CVE-2010-2550 的緩和因素
...
#### SMB 集區溢位弱點 - CVE-2010-2550 的因應措施
...
#### SMB 集區溢位弱點 - CVE-2010-2550 的常見問題集
  
**這個弱點的範圍為何？**    
這是遠端執行程式碼的弱點。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個弱點的原因為何？**    
當 Microsoft 伺服器訊息區 (SMB) 實作未正確驗證格式不正確之 SMB 要求的欄位，這時就會導致出現此弱點。
  
**什麼是 Microsoft 伺服器訊息區 (SMB) 通訊協定？**    
Microsoft 伺服器訊息區 (SMB) 通訊協定是在 Microsoft Windows 中使用的 Microsoft 網路檔案共用通訊協定。 如需詳細資訊，請參閱 [Microsoft SMB 通訊協定和 CIFS 通訊協定概觀](https://msdn.microsoft.com/en-us/library/aa365233(vs.85).aspx)。
  
**什麼是 Microsoft 伺服器訊息區第 2 版 (SMBv2)？**    
伺服器訊息區 (SMB) 是 Windows 電腦預設會使用的檔案共用通訊協定。 SMB 2.0 版 (SMBv2) 是這個通訊協定的更新，而且只支援在執行 Windows Server 2008、Windows 7 和 Windows Vista 的電腦上使用。 唯有當用戶端和伺服器都支援 SMBv2，才能使用 SMBv2。 如果用戶端或伺服器不能支援 SMBv2，將使用 SMB 1.0。 檔案作業所使用的 SMB 通訊協定版本，是在交涉階段中決定。 在交涉階段期間，Windows Vista 用戶端會向其能理解新 SMBv2 通訊協定的伺服器發出通告。 如果伺服器 (Windows Server 2008 或更新版本) 能理解 SMBv2，則會選擇 SMBv2 進行後續的通訊。 否則用戶端和伺服器會使用 SMB 1.0，並繼續如常運作。 如需更多關於 SMBv2 的資訊，請參閱 MSDN 文章：[伺服器訊息區 (SMB) 第 2 版通訊協定規格](https://msdn.microsoft.com/en-us/library/cc246482(prot.13).aspx) (英文)。
...
**攻擊者如何利用這項弱點？**    
攻擊者可以建立蓄意製作的 SMB 封包，並將此封包傳送給受影響的系統，以利用此弱點。 在 Windows Vista、Windows Server 2008、Windows 7 及 Windows 2008 R2 平台上，除非停用密碼式共用，否則攻擊者必須通過驗證才能利用此弱點。 如果停用密碼式共用，攻擊者不需通過驗證即可利用這些平台。
  
**因為這個弱點而承受風險的主要系統有哪些？**    
全部具有 SMB 伺服器服務的系統都會受到此弱點影響。 網域控制站受到此弱點影響的風險更大，因為這些系統的網路共用預設為開放給所有網域使用者。
  
**更新的作用何在？**    
此更新可修正 SMB 在格式不正確的 SMB 要求中驗證欄位的方式，進而解決弱點。
...
SMB 變數驗證弱點 - CVE-2010-2551  
--------------------------------
  
拒絕服務弱點存在於 Microsoft 伺服器訊息區 (SMB) 通訊協定軟體處理蓄意製作的 SMB 封包中。 攻擊者不需要驗證即可利用這項弱點，因此可藉由傳送蓄意製作的網路訊息至執行伺服器服務的電腦來利用弱點。
  
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-2551](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2551) (英文)。
  
#### SMB 變數驗證弱點 - CVE-2010-2551 的緩和因素
...
#### SMB 變數驗證弱點 - CVE-2010-2551 的因應措施
...
#### SMB 變數驗證弱點 - CVE-2010-2551 的常見問題集
  
**這個弱點的範圍為何？**    
這是一項拒絕服務的弱點。 成功利用此弱點的攻擊者可使受影響的系統停止回應，直到手動重新啟動系統。 請注意拒絕服務弱點不會讓攻擊者執行程式碼或提高其使用者權限，但會導致受影響系統停止接受要求。
  
**造成這個弱點的原因為何？**    
當 Microsoft 伺服器訊息區 (SMB) 通訊協定軟體在剖析蓄意製作的 SMB 封包時不正確地驗證內部變數，這時就會導致出現此弱點。 此弱點影響 SMB 第 1 及第 2 版。
...
**更新的作用何在？**    
此資訊安全更新可修正 SMB 在蓄意製作的 SMB 封包中驗證內部欄位的方式，進而解決弱點。
...
SMB 堆疊耗盡弱點 - CVE-2010-2552  
--------------------------------
  
在 Microsoft 伺服器訊息區 (SMB) 通訊協定軟體處理蓄意製作之 SMB 複合要求的方式中，存在拒絕服務弱點。 攻擊者不需要驗證即可利用這項弱點，因此可藉由傳送蓄意製作的網路訊息至執行伺服器服務的電腦來利用弱點。
  
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-2552](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2552) (英文)。
  
#### SMB 堆疊耗盡弱點 - CVE-2010-2552 的緩和因素
...
#### SMB 堆疊耗盡弱點 - CVE-2010-2552 的因應措施
...
#### SMB 堆疊耗盡弱點 - CVE-2010-2552 的常見問題集
  
**這個弱點的範圍為何？**    
這是一項拒絕服務的弱點。 成功利用此弱點的攻擊者可使受影響的系統停止回應，直到手動重新啟動系統。 請注意拒絕服務弱點不會讓攻擊者執行程式碼或提高其使用者權限，但會導致受影響系統停止接受要求。
  
**造成這個弱點的原因為何？**    
當 Microsoft 伺服器訊息區 (SMB) 通訊協定軟體未充份處理蓄意製作的複合要求，這時就會導致出現此弱點。
...
**此問題是否會影響伺服器訊息區第 1 版 (SMBv1)？**    
否。 此問題只會影響 SMBv2，因為複合要求是在 SMBv2 中導入的新功能。
  
**什麼是 SMBv2 複合要求？**    
SMBv2 複合要求是一種方法，它會將多個 SMBv2 通訊協定要求或回應合併為單一傳輸要求，供提交至基礎傳輸。
...
**更新的作用何在？**    
此資訊安全更新可修正 SMB 通訊協定軟體處理格式錯誤之複合要求的方式，進而解決此弱點。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB982214$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/982214/zh-tw">Microsoft 知識庫文件編號 982214</a></td>
</tr>
<tr class="even">
...
-   感謝 [stratsec](https://www.stratsec.net) 的 Laurent Gaffié 回報 SMB 集區溢位弱點 (CVE-2010-2550)  
-   感謝 [Sourcefire VRT](https://www.sourcefire.com/services/sf_vrt.html) 的 Todd Wease 及 Richard Johnson 回報 SMB 堆疊耗盡弱點 (CVE-2010-2552)  
-   感謝 [Codenomicon](https://www.codenomicon.com/) 的 Riku Hietamaki 及 Joshua Morin 回報 SMB 堆疊耗盡弱點 (CVE-2010-2552)
...
-   V1.1 (2010 年 8 月 23 日)： 針對 SMB 集區溢位弱點 - CVE-2010-2550，更正 Windows Server 2003、Windows 7 和 Windows Server 2008 R2 的安全性影響。本變更純屬資訊變更。
