---
TOCTitle: 'MS10-005'
Title: 'Microsoft Security Bulletin MS10-005 - 中等'
ms:assetid: 'ms10-005'
ms:contentKeyID: 61238531
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms10-005(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS10-005 - 中等
===========================================

Microsoft 小畫家中的弱點可能會允許遠端執行程式碼 (978706)
---------------------------------------------------------
...
這個安全性更新可解決 Microsoft 小畫家中一項未公開報告的弱點。 如果使用者使用 Microsoft 小畫家檢視蓄意製作的 JPEG 影像檔，這個弱點可能會允許遠端執行程式碼。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

對於 Microsoft Windows 2000、Windows XP 及 Windows Server 2003，此安全性更新的等級為「中度」。如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此安全性更新會修改 Microsoft 小畫家對 JPEG 影像檔的解碼方式，以修正此弱點。 如需更多有關弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e5861705-8f49-45cb-8a92-cf052ccf4134">Microsoft Windows 2000 Service Pack 4 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=e5861705-8f49-45cb-8a92-cf052ccf4134">Microsoft Windows 2000 Service Pack 4 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b2e70df6-7728-4fc3-8df7-8ddb9ba5202f">Windows XP Service Pack 2 及 Windows XP Service Pack 3 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=b2e70df6-7728-4fc3-8df7-8ddb9ba5202f">Windows XP Service Pack 2 及 Windows XP Service Pack 3 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f8c4acc8-c2f4-41f7-9b32-e7bd791e0155">Windows XP Professional x64 Edition Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c1efbe73-fc87-4e6a-8b36-81f125a27aec">Windows Server 2003 Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=c1efbe73-fc87-4e6a-8b36-81f125a27aec">Windows Server 2003 Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9143e435-f0d6-464b-9273-4d1f38f8ff3a">Windows Server 2003 x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=9143e435-f0d6-464b-9273-4d1f38f8ff3a">Windows Server 2003 x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ee603435-26af-4ab9-9f22-92734346dc0a">Windows Server 2003 SP2 for Itanium-based Systems (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<th style="border:1px solid black;" >MS 小畫家整數溢位弱點 - CVE-2010-0028</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
MS 小畫家整數溢位弱點 - CVE-2010-0028  
-------------------------------------
  
<span></span>
Microsoft 小畫家對 JPEG 影像檔的解碼方式存在遠端執行程式碼弱點。 如果使用者在 Microsoft 小畫家中開啟蓄意製作的 JPEG 影像檔，這個弱點可能會允許遠端執行程式碼。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來能在系統上安裝程式；檢視、變更或刪除資料；或建立新帳戶。
  
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2010-0028](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0028)。
  
#### MS 小畫家整數溢位弱點 - CVE-2010-0028 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少弱點影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   依照預設，當使用者按兩下 JPEG 檔案時，檔案將在 Windows 圖片和傳真檢視器中開啟。 若要利用此項弱點發動攻擊，攻擊者必須引誘使用者在 Microsoft 小畫家中開啟蓄意製作的檔案。  
-   攻擊者可將惡意檔案當作電子郵件的附件傳送，但攻擊者必須說服使用者開啟附件，才能利用此弱點。  
-   成功利用此弱點的攻擊者可以取得與本機使用者相同的使用者權限。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
  
#### MS 小畫家整數溢位弱點 - CVE-2010-0028 的因應措施
  
因應措施指的是無法徹底修正弱點，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。 Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：
  
-   **停用 Microsoft 小畫家**
  
    對於 32 位元的 Windows，請透過命令提示字元執行下列命令：
  
    `cacls %SystemRoot%\system32\mspaint.exe /E /P everyone:N`
  
    對於 64 位元的 Windows，請透過命令提示字元執行下列命令：
  
    `cacls %SystemRoot%\SysWOW64\mspaint.exe /E /P everyone:N`
  
    **因應措施的影響。**使用者將無法執行 Microsoft 小畫家。
...
-   **在 Windows XP 與 Windows Server 2003 上，移除 Microsoft 小畫家**
  
    1.  在 \[控制台\] 中，開啟 \[新增或移除程式\]。  
    2.  按一下 \[新增/移除 Windows 元件\]。  
    3.  在 \[Windows 元件精靈\] 中選取 \[Accessories and Utilities\]，然後按一下 \[詳細資料\]。  
    4.  選取 \[附屬應用程式\]，然後按一下 \[詳細資料\]。  
    5.  清除 \[附屬應用程式的子元件\] 中所有項目的核取方塊。 確定已核取 \[小畫家\]，然後按兩次 \[確定\]。  
    6.  在 \[Windows 元件精靈\] 中，按一下清除 \[Accessories and Utilities\] 以外所有項目的核取方塊，然後按一下 \[下一步\]。  
    7.  按一下 \[完成\] 結束精靈。
  
    **因應措施的影響** 使用者將無法執行 Microsoft 小畫家。
  
    **如何復原因應措施。** 使用 \[新增或移除程式\] 中的 \[Windows 元件精靈\] 重新安裝 Microsoft 小畫家。
  
#### MS 小畫家整數溢位弱點 - CVE-2010-0028 的常見問題集
  
**這個弱點的範圍為何？**    
這是遠端執行程式碼的弱點。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個弱點的原因為何？**    
這個弱點是因為 Microsoft 小畫家在處理 JPEG 影像解碼時的記憶體損毀所造成。
  
**什麼是 Microsoft 小畫家？**    
Microsoft 小畫家是一種用於繪製簡單或精細圖片的工具。 此外，Microsoft 小畫家也可以用於檢視及編輯掃描的相片。
...
**攻擊者如何利用這項弱點？**    
此弱點需要使用者開啟或檢視蓄意製作的影像檔。 攻擊者必須將蓄意製作的 JPEG 影像檔案傳送給使用者，並說服使用者以 Microsoft 小畫家開啟檔案。
  
**因為這個弱點而承受風險的主要系統有哪些？**    
使用者必須登入並使用 Microsoft 小畫家編輯或檢視 JPEG 影像，惡意動作才可能執行。 因此，系統上若有使用者讀取電子郵件、經常使用 Internet Explorer，或者可以存取網路共用 (如工作站或終端機伺服器)，則受此弱點影響的風險最高。
  
**更新的作用何在？**    
此更新會修改 Microsoft 小畫家對 JPEG 影像檔的解碼方式，以移除此弱點。
...
| **部署**                               |                                                                                                                               |  
| 在沒有使用者介入的情況下安裝           | Windows2000-KB978706-x86-enu /quiet                                                                                           |  
| 在不重新啟動的情況下安裝               | Windows2000-KB978706-x86-enu /norestart                                                                                       |  
| 更新記錄檔                             | KB978706.log                                                                                                                  |  
| 詳細資訊                               | 請參閱＜偵測與部署工具及指南＞小節                                                                                            |  
| **重新開機需求**                       |                                                                                                                               |  
| 需要重新開機？                         | 是，套用此安全性更新之後，您必須重新啟動系統。                                                                                |  
| HotPatching                            | 不適用                                                                                                                        |  
| **移除資訊**                           | 使用 \[控制台\] 中的 \[新增或移除程式\] 工具，或是 %Windir%\\$NTUninstallKB978706$\\Spuninst 資料夾中的 Spuninst.exe 公用程式 |  
| **檔案資訊**                           | 請參閱 [Microsoft 知識庫文件編號 978706](https://support.microsoft.com/kb/978706/zh-tw)                                        |  
| **登錄機碼驗證**                       | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB978706\\Filelist                                     |
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB978706$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/978706/zh-tw">Microsoft 知識庫文件編號 978706</a></td>
</tr>
<tr class="even">
...
-   感謝 ICST-ERCIS (中國北京大學計算機科學技術研究所信息安全工程研究中心) 的 Tielei Wang 與 [Secunia](https://secunia.com/) 合作，共同回報 MS 小畫家整數溢位弱點 (CVE-2010-0028)
