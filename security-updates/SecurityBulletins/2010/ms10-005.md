...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2010-0028](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0028)。
...
| **檔案資訊**                           | 請參閱 [Microsoft 知識庫文件編號 978706](http://support.microsoft.com/kb/978706/zh-tw)                                        |  
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/978706/zh-tw">Microsoft 知識庫文件編號 978706</a></td>
</tr>
<tr class="even">
...
-   感謝 ICST-ERCIS (中國北京大學計算機科學技術研究所信息安全工程研究中心) 的 Tielei Wang 與 [Secunia](http://secunia.com/) 合作，共同回報 MS 小畫家整數溢位弱點 (CVE-2010-0028)
