---
TOCTitle: 'MS10-047'
Title: 'Microsoft Security Bulletin MS10-047 - 重要'
ms:assetid: 'ms10-047'
ms:contentKeyID: 61238573
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms10-047(v=Security.10)'
---


Microsoft Security Bulletin MS10-047 - 重要
===========================================

Windows 核心中的弱點可能會允許權限提高 (981852)
-----------------------------------------------
...
這個資訊安全更新可解決 Microsoft Windows 中數個未公開報告的弱點。 如果攻擊者從本機登入並執行蓄意製作的應用程式，則最嚴重的弱點可能會允許權限提高。 攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這些弱點。 遠端或匿名使用者無法利用這個弱點。

對於 Windows XP、Windows Vista 及 Windows Server 2008，此資訊安全更新的等級為「重要」。對於 Windows 7 和 Windows Server 2008 R2，此資訊安全更新的等級為「中度」。如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此資訊安全更新可修正 Windows 核心物件初始化和存取控制清單的驗證，並將額外的執行階段驗證導入執行緒建立機制，以解決弱點。 如需更多有關弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e3574047-5ce5-4461-94aa-4eb3258d5e71">Windows XP Service Pack 3 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=e3574047-5ce5-4461-94aa-4eb3258d5e71">Windows XP Service Pack 3 (中文下載更新程式)</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4486f97c-4cf8-4236-bfc3-b50e72e2a5c1">Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=4486f97c-4cf8-4236-bfc3-b50e72e2a5c1">Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-021">MS10-021</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b547898e-f8a9-49dc-b49d-cffec5a001bc">Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=b547898e-f8a9-49dc-b49d-cffec5a001bc">Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-021">MS10-021</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=611765ab-b3f3-45db-92b2-ee040b9cfd27">適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a>&#42;
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=611765ab-b3f3-45db-92b2-ee040b9cfd27">適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2 (中文下載更新程式)</a>&#42;</td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-021">MS10-021</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=131f3512-1585-462e-a4f1-3f359aac44bd">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a>&#42;
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=131f3512-1585-462e-a4f1-3f359aac44bd">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2 (中文下載更新程式)</a>&#42;</td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-021">MS10-021</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=972efd3a-ec1e-49b2-835e-76f4b21b5b79">適用於 Itanium 型系統的 Windows Server 2008 和適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-021">MS10-021</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=a7d60864-5942-47ed-a6f3-1c07b4833a14">適用於 32 位元系統的 Windows 7 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=a7d60864-5942-47ed-a6f3-1c07b4833a14">適用於 32 位元系統的 Windows 7 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">拒絕服務</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-021">MS10-021</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b00ec47c-402e-4207-a4c9-6c1900f254f8">適用於 x64 型系統的 Windows 7 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=b00ec47c-402e-4207-a4c9-6c1900f254f8">適用於 x64 型系統的 Windows 7 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">拒絕服務</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-021">MS10-021</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c1ad1248-07f1-42d4-baa4-8a20837ec7b4">適用於 x64 型系統的 Windows Server 2008 R2 (英文下載更新程式)</a>&#42;
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=c1ad1248-07f1-42d4-baa4-8a20837ec7b4">適用於 x64 型系統的 Windows Server 2008 R2 (中文下載更新程式)</a>&#42;</td>
<td style="border:1px solid black;">拒絕服務</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-021">MS10-021</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f23dec0f-a33b-4d8c-a86d-0e9368ae7ff5">適用於 Itanium 系統的 Windows Server 2008 R2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">拒絕服務</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-021">MS10-021</a></td>
</tr>
...
<th style="border:1px solid black;" >Windows 核心資料初始化弱點 - CVE-2010-1888</th>
<th style="border:1px solid black;" >Windows 核心重覆釋放相同記憶體空間弱點 - CVE-2010-1889</th>
<th style="border:1px solid black;" >Windows 核心錯誤驗證弱點 - CVE-2010-1890</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
Windows 核心資料初始化弱點 - CVE-2010-1888  
------------------------------------------
  
因 Windows 核心處理特定執行緒建立嘗試的方式，導致核心內存在權限提高的弱點。 成功利用此弱點的攻擊者可以在核心模式下執行任意程式碼。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-1888](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1888) (英文)。
  
#### Windows 核心資料初始化弱點 - CVE-2010-1888 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少弱點影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項弱點。 匿名或遠端使用者無法利用這個弱點。
  
#### Windows 核心資料初始化弱點 - CVE-2010-1888 的因應措施
  
Microsoft 尚未找到此項弱點的任何因應措施。
  
#### Windows 核心資料初始化弱點 - CVE-2010-1888 的常見問題集
  
**這個弱點的範圍為何？**    
這是權限提高的弱點。 成功利用此弱點的攻擊者可執行任意程式碼，並取得受影響之系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個弱點的原因為何？**    
這個弱點是由建立特定類型的執行緒時一個罕見的狀況而造成。
...
**更新的作用何在？**    
此更新會將額外的執行階段驗證導入執行緒建立機制，以解決此弱點。
...
Windows 核心重覆釋放相同記憶體空間弱點 - CVE-2010-1889  
------------------------------------------------------
  
由於核心在處理某些錯誤時初始化物件的方式，導致 Windows 核心內存取權限提高的弱點。 成功利用此弱點的攻擊者可以在核心模式下執行任意程式碼。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-1889](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1889) (英文)。
  
#### Windows 核心重覆釋放相同記憶體空間弱點 - CVE-2010-1889 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少弱點影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項弱點。 匿名或遠端使用者無法利用這個弱點。
  
#### Windows 核心重覆釋放相同記憶體空間弱點 - CVE-2010-1889 的因應措施
  
Microsoft 尚未找到此項弱點的任何因應措施。
  
#### Windows 核心重覆釋放相同記憶體空間弱點 - CVE-2010-1889 的常見問題集
  
**這個弱點的範圍為何？**    
這是權限提高的弱點。 成功利用此弱點的攻擊者可執行任意程式碼，並取得受影響之系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個弱點的原因為何？**    
Windows 核心在處理某些錯誤時未正確初始化物件。
...
**更新的作用何在？**    
此更新可確保 Windows 核心在處理某些錯誤時正確初始化物件，以解決此弱點。
...
Windows 核心錯誤驗證弱點 - CVE-2010-1890  
----------------------------------------
  
Windows 核心在核心物件上驗證存取控制清單的方式中，存在拒絕服務弱點。 攻擊者可利用此弱點，執行蓄意製作的應用程式，使系統停止回應並自動重新啟動。
  
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-1890](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1890) (英文)。
  
#### Windows 核心錯誤驗證弱點 - CVE-2010-1890 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少弱點影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項弱點。 匿名或遠端使用者無法利用這個弱點。
  
#### Windows 核心錯誤驗證弱點 - CVE-2010-1890 的因應措施
  
Microsoft 尚未找到此項弱點的任何因應措施。
  
#### Windows 核心錯誤驗證弱點 - CVE-2010-1890 的常見問題集
  
**這個弱點的範圍為何？**    
這是一項拒絕服務的弱點。 成功利用此弱點的攻擊者將使受影響系統停止回應並自動重新啟動。 請注意，阻絕服務弱點不會讓攻擊者執行程式碼或提高其使用者權限，但會導致受影響系統停止接受要求。
  
**造成這個弱點的原因為何？**    
Windows 核心未在核心物件上正確驗證存取控制清單。
...
**更新的作用何在？**    
此更新可修正 Windows 核心驗證已套用至核心物件之存取控制清單的方式，以解決此弱點。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB981852$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/981852/zh-tw">Microsoft 知識庫文件編號 981852</a></td>
</tr>
<tr class="even">
...
-   感謝 [Google, Inc.](https://www.google.com/) 的 Tavis Ormandy 回報 Windows 核心資料初始化弱點 (CVE-2010-1888)  
-   感謝 [Google, Inc.](https://www.google.com/) 的 Tavis Ormandy 回報 Windows 核心重覆釋放相同記憶體空間弱點 (CVE-2010-1889)  
-   感謝 [Google, Inc.](https://www.google.com/) 的 Tavis Ormandy 回報 Windows 核心錯誤驗證弱點 (CVE-2010-1890)
