...
**已知問題。** [Microsoft 知識庫文件編號 978213](https://support.microsoft.com/kb/978213/zh-tw) 中記載了客戶安裝此安全性更新時，可能會發生的目前已知問題。 該文件並說明了解決這些問題的建議解決方案。 目前已知問題和建議解決方案僅適用於此軟體的特定版本，本文會提供詳細文章的連結。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=72c23b0f-4e24-4334-bc8a-334adc8bc42b">Microsoft Office XP Service Pack 3 (英文下載更新程式)</a> <br />
(KB976380)  
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=72c23b0f-4e24-4334-bc8a-334adc8bc42b">Microsoft Office XP Service Pack 3 (英文下載更新程式)</a> <br />
(KB976380)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f8eac9bc-8389-4ac8-8b29-9a8180d9fd34">Microsoft Office 2003 Service Pack 3 (英文下載更新程式)</a> <br />
(KB976382)  
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=f8eac9bc-8389-4ac8-8b29-9a8180d9fd34">Microsoft Office 2003 Service Pack 3 (英文下載更新程式)</a> <br />
(KB976382)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-013">MS08-013</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=160ad53e-6475-4550-90c2-444e4abea730">2007 Microsoft Office System Service Pack 1 與 2007 Microsoft Office System Service Pack 2 (英文下載更新程式)</a> <br />
(KB976321)  
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=160ad53e-6475-4550-90c2-444e4abea730">2007 Microsoft Office System Service Pack 1 與 2007 Microsoft Office System Service Pack 2 (英文下載更新程式)</a> <br />
(KB976321)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=436a8a66-352e-44d1-a610-c825083ad24a">Microsoft Visual Basic for Applications (英文下載更新程式)</a>[1]<br />
(KB974945)  
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=436a8a66-352e-44d1-a610-c825083ad24a">Microsoft Visual Basic for Applications (英文下載更新程式)</a>[1]<br />
(KB974945)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
...
<sup>[3]</sup>可解決本公告描述之弱點的 Visual Basic for Applications SDK 更新版本目前由 [Summit Software Company](https://www.summsoft.com/) 開放給獨立軟體廠商 (ISV)。 如需更多資訊，請參閱下一節＜與本安全性更新相關的常見問題集 (FAQ)＞。
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-0815](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0815) (英文)。

#### VBE6.DLL 堆疊記憶體損毀弱點 CVE-2010-0815 的緩和因素

緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少弱點影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：

-   依照預設，2007 Microsoft Office System 在啟動 Offic 文件中內嵌的 ActiveX 控制項前，會先以安全性警告提示使用者。 選擇不要啟用控制項的使用者即可受到此預設設定的保護。 如需更多資訊，請參閱 Microsoft Office Online 文章[啟用或停用 Office 文件中的 ActiveX 控制項](https://office.microsoft.com/en-us/help/ha100310671033.aspx) (英文)。
...
-   **在 2007 Microsoft Office System 中停用 ActiveX 控制項**
    ...
    您可以在 2007 Microsoft Office System 的 \[信任中心\] 停用 ActiveX 控制項。 請參閱 Microsoft Office Online 文章[啟用或停用 Office 文件中的 ActiveX 控制項](https://office.microsoft.com/en-us/help/ha100310671033.aspx) (英文)，取得 \[不事先通知，停用所有控制項\] 的相關指示。
...
**如何復原因應措施。** 如需有關復原此因應措施的資訊，請參閱 [Microsoft 知識庫文件編號 935865](https://support.microsoft.com/kb/935865/zh-tw)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/976380/zh-tw">Microsoft 知識庫文件編號 976380</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/976382/zh-tw">Microsoft 知識庫文件編號 976382</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/976321/zh-tw">Microsoft 知識庫文件編號 976321</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/974945/zh-tw">Microsoft 知識庫文件編號 974945</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
...
-   感謝 [NSFocus Security Team](https://www.nsfocus.com/) 回報 VBE6.DLL 堆疊記憶體損毀弱點 (CVE-2010-0815)
