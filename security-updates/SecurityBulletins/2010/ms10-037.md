...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-0819](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0819)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/980218/zh-tw">Microsoft 知識庫文件編號 980218</a></td>
</tr>
<tr class="even">
...
-   感謝 Laserforce International 的 Chris Carton 與 [Secunia](http://secunia.com/)攜手合作，共同回報 OpenType CFF 字型驅動程式記憶體損毀弱點 (CVE-2010-0819)
