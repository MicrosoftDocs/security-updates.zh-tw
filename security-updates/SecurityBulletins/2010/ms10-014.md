...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2010-0035](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0035)。
...
| **檔案資訊**                           | 請參閱 [Microsoft 知識庫文件編號 977290](https://support.microsoft.com/kb/977290/zh-tw)                                        |  
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/977290/zh-tw">Microsoft 知識庫文件編號 977290</a></td>
</tr>
<tr class="even">
