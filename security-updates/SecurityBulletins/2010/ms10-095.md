...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3966](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3966) (英文)。
...
BranchCache 是隨附於部分 Windows Server 2008 R2 和 Windows 7 作業系統版本的一項廣域網路 (WAN) 頻寬最佳化技術。 為了最佳化 WAN 頻寬，BranchCache 會從總公司的內容伺服器複製內容，並快取分公司位置的內容，允許分公司的用戶端電腦從本機存取內容，而非透過 WAN。 如需更多資訊，請參閱 [Windows Server 2008 R2 和 BranchCache](https://www.microsoft.com/windowsserver2008/en/us/branch-cache.aspx)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2385678/zh-tw">Microsoft 知識庫文件編號 2385678</a></td>
</tr>
<tr class="odd">
...
-   感謝 [Fortinet FortiGuard Labs](https://www.fortiguard.com/) 的 Haifei Li 回報 BranchCache 不安全程式庫載入資訊安全風險 (CVE-2010-3966)
