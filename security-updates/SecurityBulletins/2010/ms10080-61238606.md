---
TOCTitle: 'MS10-080'
Title: 'Microsoft Security Bulletin MS10-080 - 重要'
ms:assetid: 'ms10-080'
ms:contentKeyID: 61238606
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms10-080(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS10-080 - 重要
===========================================

Microsoft Excel 中的資訊安全風險可能會允許遠端執行程式碼 (2293211)
------------------------------------------------------------------
...
這個資訊安全更新可解決 Microsoft Office 中 13 項未公開報告的資訊安全風險。 如果使用者開啟蓄意製作的 Excel 檔案或蓄意製作的 Lotus 1-2-3 檔案，這些資訊安全風險可能會允許遠端執行程式碼。 成功利用這類任一資訊安全風險的攻擊者可以取得與本機使用者相同的使用者權限。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

對於所有受支援版本的 Microsoft Excel 2002、Microsoft Excel 2003、Microsoft Excel 2007、Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac；Open XML File Format Converter for Mac；所有受支援版本的 Microsoft Office Excel Viewer，以及 Microsoft Office 相容性套件，此資訊安全更新的等級為「重要」。 如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此更新會藉由變更 Microsoft Office Excel 剖析蓄意製作的 Excel 檔案及 Lotus 1-2-3 檔案的方式，來解決這些資訊安全風險。 如需更多有關資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。

**建議。** Microsoft 建議客戶應該儘快套用此更新程式。

**已知問題。** [Microsoft 知識庫文件編號 2293211](http://support.microsoft.com/kb/2293211/zh-tw) 中記載客戶安裝此資訊安全更新時，可能會發生的目前已知問題。 該文件並說明了解決這些問題的建議解決方案。 目前已知問題和建議解決方案僅適用於此軟體的特定版本，本文會提供詳細文章的連結。
...
<td style="border:1px solid black;">
[Microsoft Excel 2002 Service Pack 3 (英文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=ea859881-2cc5-407b-a394-5d00c5d9fd97)  
(KB2345017)  
[Microsoft Excel 2002 Service Pack 3 (中文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=ea859881-2cc5-407b-a394-5d00c5d9fd97&displaylang=zh-tw)  
(KB2345017)
...
<td style="border:1px solid black;">
[Microsoft Excel 2003 Service Pack 3 (英文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=3d9a00b8-0f80-4d36-b92a-89b61350fb36)  
(KB2344893)  
[Microsoft Excel 2003 Service Pack 3 (中文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=3d9a00b8-0f80-4d36-b92a-89b61350fb36&displaylang=zh-tw)  
(KB2344893)
...
<td style="border:1px solid black;">
[Microsoft Excel 2007 Service Pack 2 (英文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=dc9b9af5-50b0-4a07-8923-a30fd5548760)<sup>[1]</sup>
(KB2345035)  
[Microsoft Excel 2007 Service Pack 2 (中文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=dc9b9af5-50b0-4a07-8923-a30fd5548760&displaylang=zh-tw)<sup>[1]</sup>
(KB2345035)
...
<tr>
<td style="border:1px solid black;">
[Microsoft Excel Viewer Service Pack 2 (英文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=a833a94a-2dc0-4864-9c14-e196dc54c5a7)  
(KB2345088)  
[Microsoft Excel Viewer Service Pack 2 (中文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=a833a94a-2dc0-4864-9c14-e196dc54c5a7&displaylang=zh-tw)  
(KB2345088)
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office Word、Excel 及 PowerPoint 2007 檔案格式相容性套件 Service Pack 2 (英文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=7391ec2f-12c9-483c-91d8-e3ec5754da1c)  
(KB2344875)  
[Microsoft Office Word、Excel 及 PowerPoint 2007 檔案格式相容性套件 Service Pack 2 (中文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=7391ec2f-12c9-483c-91d8-e3ec5754da1c&displaylang=zh-tw)  
(KB2344875)
...
<sup>[1]</sup>針對 Microsoft Office Excel 2007 Service Pack 2，除了資訊安全更新套件 KB2345035 外，客戶也需安裝適用於 Word、Excel 與 PowerPoint 2007 檔案格式的 Microsoft Office 相容性套件 Service Pack 2 之資訊安全更新 (KB2344875)，才能獲得全面的防護，而不受此公告所述之資訊安全風險影響。
...
**MS10-079** **亦描述了** **Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac** **及** **Open XML File Format Converter for Mac** **中的資訊安全風險。** **MS10-079** **與此公告** **(MS10-080)** **有何關聯？**  
在 MS10-080 公告中，適用於 Microsoft Office 2004 for Mac (KB2422343)、Microsoft Office 2008 for Mac (KB2422352) 和 Open XML File Format Converter for Mac (KB2422398) 的資訊安全更新套件，也解決了 MS10-079 中描述的資訊安全風險。已安裝 Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac、或 Open XML File Format Converter for Mac 的使用者只需安裝這些資訊安全更新套件一次。
...
Microsoft Office 獨立式程式受影響的嚴重性等級同等於 Microsoft Office 套件中相對應元件的嚴重性等級。 例如，Microsoft Excel 獨立式安裝受影響的嚴重性等級同等於 Microsoft Office 套件隨附之 Microsoft Excel 安裝的嚴重性等級。
...
<th style="border:1px solid black;" >
Excel 記錄剖析整數溢位資訊安全風險 - CVE-2010-3230
</th>
<th style="border:1px solid black;" >
Excel 記錄剖析記憶體損毀資訊安全風險 - CVE-2010-3231
</th>
<th style="border:1px solid black;" >
Excel 檔案格式剖析資訊安全風險 - CVE-2010-3232
</th>
<th style="border:1px solid black;" >
Lotus 1-2-3 活頁簿剖析資訊安全風險 - CVE-2010-3233
</th>
<th style="border:1px solid black;" >
公式子串流記憶體損毀資訊安全風險 - CVE-2010-3234
</th>
<th style="border:1px solid black;" >
公式 Biff 記錄資訊安全風險 - CVE-2010-3235
</th>
<th style="border:1px solid black;" >
陣列超出範圍資訊安全風險 - CVE-2010-3236
</th>
</tr>
<tr>
<th colspan="8">
...
<tr class="thead">
<th style="border:1px solid black;" >
合併儲存格記錄指標資訊安全風險 - CVE-2010-3237
</th>
<th style="border:1px solid black;" >
負向未來函式資訊安全風險 - CVE-2010-3238
</th>
<th style="border:1px solid black;" >
額外記錄剖析超出界線資訊安全風險 - CVE-2010-3239
</th>
<th style="border:1px solid black;" >
即時資料陣列記錄資訊安全風險 - CVE-2010-3240
</th>
<th style="border:1px solid black;" >
在剖析中記憶體寫入超出範圍資訊安全風險 - CVE-2010-3241
</th>
<th style="border:1px solid black;" >
準刪除記錄類型剖析資訊安全風險 - CVE-2010-3242
</th>
<th style="border:1px solid black;" >
彙總嚴重性等級
</th>
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3230](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3230) (英文)。

#### Excel 記錄剖析整數溢位資訊安全風險 - CVE-2010-3230 的緩和因素
...
#### Excel 記錄剖析整數溢位資訊安全風險 - CVE-2010-3230 的因應措施

因應措施指的是無法徹底修正資訊安全風險，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。 Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：

-   **請勿開啟來自不信任來源的** **Microsoft Office** **檔案文件**

    對於來自於不受信任的來源或在非預期情況下從信任來源收到的 Microsoft Office 檔案，請勿輕易開啟或儲存。 當使用者開啟蓄意製作的檔案時，即可能遭受利用此資訊安全風險的攻擊。

#### Excel 記錄剖析整數溢位資訊安全風險 - CVE-2010-3230 的常見問題集
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3231](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3231) (英文)。

#### Excel 記錄剖析記憶體損毀資訊安全風險 - CVE-2010-3231 的緩和因素
...
#### Excel 記錄剖析記憶體損毀資訊安全風險 - CVE-2010-3231 的因應措施

因應措施指的是無法徹底修正資訊安全風險，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。 Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：

-   **請勿開啟來自不信任來源的** **Microsoft Office** **文件**

    對於來自於不受信任的來源或在非預期情況下從信任來源收到的 Microsoft Office 檔案，請勿輕易開啟或儲存。 當使用者開啟蓄意製作的檔案時，即可能遭受利用此資訊安全風險的攻擊。

#### Excel 記錄剖析記憶體損毀資訊安全風險 - CVE-2010-3231 的常見問題集
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3232](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3232) (英文)。

#### Excel 檔案格式剖析資訊安全風險 - CVE-2010-3232 的緩和因素
...
#### Excel 檔案格式剖析資訊安全風險 - CVE-2010-3232 的因應措施
...
-   **使用** **Microsoft Office** **檔案封鎖原則來封鎖開啟來自於未知或不信任來源與位置的** **Office 2003** **和先前文件**
    ...
    **因應措施的影響。** 使用者若設定檔案封鎖原則、但尚未依照 [Microsoft 知識庫文件編號 922848](http://support.microsoft.com/kb/922848/zh-tw) 所討論設定特殊的「豁免目錄」，將無法在 Office 2003 或 Office 2007 中開啟 Office 2003 檔案或先前版本。

    **如何復原因應措施：**

    適用於 Office 2003
    `Windows Registry Editor Versi``on 5.00`
    `[HKEY_CURRENT_USER\Software\Microsoft\Office\11.0\Excel\Security\FileOpenBlock]`
    `"BinaryFiles"=dword:00000000`

    Office 2007
    `Windows Registry Editor Version 5.00`
    `[HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\12.0\Excel\Security\FileOpenBloc``k]`
    `"BinaryFiles"=dword:00000000`
...
-   **開啟未知或不信任來源的檔案時，使用** **Microsoft Office Isolated Conversion Environment (MOICE)**
    ...
    **注意：**請參閱 Microsoft 知識庫文件編號 935865，瞭解如何使用自動化的 **Microsoft Fix It** 解決方案來啟用或停用本因應措施。
...
#### Excel 檔案格式剖析資訊安全風險 - CVE-2010-3232 的常見問題集
...
<span></span>
在 Microsoft Excel 處理蓄意製作的 Lotus 1-2-3 活頁簿檔案 (.wk3) 的方式中，存在遠端執行程式碼的資訊安全風險。 成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。

若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3233](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3233) (英文)。

#### Lotus 1-2-3 活頁簿剖析資訊安全風險 - CVE-2010-3233 的緩和因素

緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。 下列緩和因素可能對您的狀況有所助益。

-   無法透過電子郵件自動攻擊此資訊安全風險。 使用者必須順利開啟電子郵件訊息中傳送的附件，攻擊才可進行。
-   成功利用此資訊安全風險的攻擊者可以取得與本機使用者相同的使用者權限。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
-   在網頁式攻擊的案例中，攻擊者可架設一個網站，並在其中包含利用此資訊安全風險的網頁。 此外，受侵害的網站以及接受或存放使用者提供之內容或廣告的網站裡，也可能包含蓄意製作以利用本資訊安全風險的內容。 但是，攻擊者無法強迫使用者造訪網站， 而是引誘使用者自行前往網站，一般的做法是設法讓使用者按下電子郵件中或 Instant Messenger 訊息中連往攻擊者網站的連結，然後引誘他們開啟蓄意製作的 Lotus 1-2-3 檔案。

#### Lotus 1-2-3 活頁簿剖析資訊安全風險 - CVE-2010-3233 的因應措施
...
#### Lotus 1-2-3 活頁簿剖析資訊安全風險 - CVE-2010-3233 的常見問題集

**這個資訊安全風險的範圍為何？**  
這是遠端執行程式碼的資訊安全風險。 成功利用此資訊安全風險的攻擊者可以從遠端取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，或檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。

**造成這個資訊安全風險的原因為何？**  
當 Microsoft Excel 剖析蓄意製作的 Lotus 1-2-3 檔案時，系統記憶體可能損毀，而使攻擊者有機會執行任意程式碼。

**為什麼在** **Moderate on Microsoft Excel 2003 Service Pack 3** **將此資訊安全風險評等為「中等」？**  
依預設，在 Microsoft Excel 2003 Service Pack 3 上會封鎖開啟 Lotus 1-2-3 檔案。這項緩和因素會降低 CVE-2010-3233 在 Microsoft Excel 2003 Service Pack 3 上的嚴重性等級。如需安裝 Microsoft Office 2003 Service Pack 3 後受封鎖檔案類型的更多資訊，請參閱 [Microsoft 知識庫文件編號 938810](http://support.microsoft.com/kb/938810//zh-tw)。

**攻擊者可能會利用這項資訊安全風險採取什麼行動？**  
一旦成功利用此資訊安全風險，攻擊者便能以登入的使用者身分執行任意程式碼。 如果使用者以系統管理的使用者權限登入，則攻擊者即可取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

**攻擊者如何利用這項資訊安全風險？**  
要利用此資訊安全風險，使用者需以受影響的 Microsoft Excel 版本來開啟蓄意製作的 Lotus 1-2-3 檔案。

若是電子郵件攻擊，攻擊者可能會利用這項資訊安全風險，向使用者傳送蓄意製作的 Lotus 1-2-3 檔案，然後引誘使用者開啟該檔案。

在網頁攻擊的情況中，攻擊者必須架設含 Lotus 1-2-3 檔案的網站，攻擊者便可使用這種檔案來利用此資訊安全風險。 此外，受侵害的網站以及接受或存放使用者提供之內容的網站裡，也可能包含蓄意製作以利用本資訊安全風險的內容。 攻擊者並不能強迫使用者造訪蓄意製作的網站， 而是會引誘使用者造訪網站。一般的做法是設法讓使用者按一下連往攻擊者網站的連結，然後引誘使用者開啟蓄意製作的 Lotus 1-2-3 檔案。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3234](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3234) (英文)。

#### 公式子串流記憶體損毀資訊安全風險 - CVE-2010-3234 的緩和因素
...
#### 公式子串流記憶體損毀資訊安全風險 - CVE-2010-3234 的因應措施
...
#### 公式子串流記憶體損毀資訊安全風險 - CVE-2010-3234 的常見問題集

**這個資訊安全風險的範圍為何？**  
這是遠端執行程式碼的資訊安全風險。 成功利用此資訊安全風險的攻擊者可以從遠端取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，或檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。

**造成這個資訊安全風險的原因為何？**  
當 Microsoft Excel 在開啟蓄意製作的 Excel 檔案時驗證公式資訊，這時發生的記憶體處理錯誤可能會損毀系統記憶體，使攻擊者有機會執行任意程式碼。
...
**更新的作用何在？**  
本更新會修改 Microsoft Excel 驗證公式資訊的方式，進而移除此項資訊安全風險。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3235](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3235) (英文)。

#### 公式 Biff 記錄資訊安全風險 - CVE-2010-3235 的緩和因素
...
#### 公式 Biff 記錄資訊安全風險 - CVE-2010-3235 的因應措施
...
#### 公式 Biff 記錄資訊安全風險 - CVE-2010-3235 的常見問題集
...
**更新的作用何在？**  
本更新會修改 Microsoft Excel 驗證公式資訊的方式，進而解決此項資訊安全風險。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3236](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3236) (英文)。

#### 陣列超出範圍資訊安全風險 - CVE-2010-3236 的緩和因素
...
#### 陣列超出範圍資訊安全風險 - CVE-2010-3236 的因應措施
...
-   **使用** **Microsoft Office** **檔案封鎖原則來封鎖開啟來自於未知或不信任來源與位置的** **Office 2003** **和先前文件**
    ...
    **因應措施的影響。** 使用者若設定檔案封鎖原則、但尚未依照 [Microsoft 知識庫文件編號 922848](http://support.microsoft.com/kb/922848/zh-tw) 所討論設定特殊的「豁免目錄」，將無法在 Office 2003 中開啟 Office 2003 檔案或先前版本。

    **如何復原因應措施：**

    適用於 Office 2003
    `Windows Registry Editor Version 5.00`
    `[HKEY_CURRENT_USER\S``oftware\Microsoft\Office\11.0\Excel\Security\FileOpenBlock]`
    `"BinaryFiles"=dword:00000000`
...
#### 陣列超出範圍資訊安全風險 - CVE-2010-3236 的常見問題集
...
**更新的作用何在？**  
本更新會修改 Microsoft Excel 驗證記錄資訊的方式，進而移除此項資訊安全風險。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3237](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3237) (英文)。

#### 合併儲存格記錄指標資訊安全風險 - CVE-2010-3237 的緩和因素
...
#### 合併儲存格記錄指標資訊安全風險 - CVE-2010-3237 的因應措施
...
#### 合併儲存格記錄指標資訊安全風險 - CVE-2010-3237 的常見問題集
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3238](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3238) (英文)。

#### 負向未來函式資訊安全風險 - CVE-2010-3238 的緩和因素
...
#### 負向未來函式資訊安全風險 - CVE-2010-3238 的因應措施
...
#### 負向未來函式資訊安全風險 - CVE-2010-3238 的常見問題集

**這個資訊安全風險的範圍為何？**  
這是遠端執行程式碼的資訊安全風險。 成功利用此資訊安全風險的攻擊者可以從遠端取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，或檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。

**造成這個資訊安全風險的原因為何？**  
當 Microsoft Excel 在開啟蓄意製作的 Excel 檔案時驗證二進位檔案格式資訊，這時發生的記憶體處理錯誤可能會損毀系統記憶體，使攻擊者有機會執行任意程式碼。
...
**更新的作用何在？**  
本更新會修改 Microsoft Excel 驗證驗證二進位檔案格式資訊的方式，進而解決此項資訊安全風險。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3239](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3239) (英文)。

#### 額外記錄剖析超出界線資訊安全風險 - CVE-2010-3239 的緩和因素
...
#### 額外記錄剖析超出界線資訊安全風險 - CVE-2010-3239 的因應措施
...
#### 額外記錄剖析超出界線資訊安全風險 - CVE-2010-3239 的常見問題集
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3240](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3240) (英文)。

#### 即時資料陣列記錄資訊安全風險 - CVE-2010-3240 的緩和因素
...
#### 即時資料陣列記錄資訊安全風險 - CVE-2010-3240 的因應措施
...
-   **使用** **Microsoft Office** **檔案封鎖原則來封鎖開啟來自於未知或不信任來源與位置的** **Office 2003** **和先前文件**
    ...
    **Office 2007** 
    `Windows Registry Editor Version 5.00`
    `[HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\12.0\Excel\Security\FileOpen``Block]`
    `"BinaryFiles"=dword:00000001`
    **注意**：為將 'FileOpenBlock' 與 2007 Microsoft Office System 搭配使用，必須套用所有最新的 2007 Microsoft Office System 資訊安全更新。

    **因應措施的影響。** 使用者若設定檔案封鎖原則、但尚未依照 [Microsoft 知識庫文件編號 922848](http://support.microsoft.com/kb/922848/zh-tw) 所討論設定特殊的「豁免目錄」，將無法在 Office 2007 中開啟 Office 2003 檔案或先前版本。
...
#### 即時資料陣列記錄資訊安全風險 - CVE-2010-3240 的常見問題集
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3241](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3241) (英文)。

#### 在剖析中記憶體寫入超出範圍資訊安全風險 - CVE-2010-3241 的緩和因素
...
#### 在剖析中記憶體寫入超出範圍資訊安全風險 - CVE-2010-3241 的因應措施
...
#### 在剖析中記憶體寫入超出範圍資訊安全風險 - CVE-2010-3241 的常見問題集
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3242](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3242) (英文)。

#### 準刪除記錄類型剖析資訊安全風險 - CVE-2010-3242 的緩和因素
...
#### 準刪除記錄類型剖析資訊安全風險 - CVE-2010-3242 的因應措施
...
#### 準刪除記錄類型剖析資訊安全風險 - CVE-2010-3242 的常見問題集
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2345017/zh-tw">Microsoft 知識庫文件編號 2345017</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2344893/zh-tw">Microsoft 知識庫文件編號 2344893</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於 Microsoft Office Compatibility Pack for Word, Excel, and PowerPoint 2007 File Formats：<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">針對 Microsoft Excel 2007，請參閱 <a href="http://support.microsoft.com/kb/2345035/zh-tw">Microsoft 知識庫文件編號 2345035</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">針對 Microsoft Excel Viewer，請參閱 <a href="http://support.microsoft.com/kb/2345088/zh-tw">Microsoft 知識庫文件編號 2345088</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">針對 Word、Excel 及 PowerPoint 2007 檔案格式的 Microsoft Office 相容性套件，請參閱 <a href="http://support.microsoft.com/kb/2344875/zh-tw">Microsoft 知識庫文件編號 2344875</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
-   感謝 [Secunia](http://secunia.com/) 的 Alin Rad Pop 回報 Excel 記錄剖析整數溢位資訊安全風險 (CVE-2010-3230)  
-   感謝 [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Chaouki Bekrar 回報 Excel 記錄剖析記憶體損毀資訊安全風險 (CVE-2010-3231)  
-   感謝 Omair 回報 Excel 檔案格式剖析資訊安全風險 (CVE-2010-3232)  
-   感謝 [Secunia](http://secunia.com/) 的 Carsten H. Eiram 回報 Lotus 1-2-3 活頁簿剖析資訊安全風險 (CVE-2010-3233)  
-   感謝 [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Chaouki Bekrar 回報公式子串流記憶體損毀資訊安全風險 (CVE-2010-3234)  
-   感謝 [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Chaouki Bekrar 回報公式 Biff 記錄資訊安全風險 (CVE-2010-3235)  
-   感謝 [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Chaouki Bekrar 回報陣列超出範圍資訊安全風險 (CVE-2010-3236)  
-   感謝 [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Chaouki Bekrar 回報合併儲存格記錄指標資訊安全風險 (CVE-2010-3237)  
-   感謝 [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Chaouki Bekrar 回報負向未來函式資訊安全風險 (CVE-2010-3238)  
-   感謝 [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Chaouki Bekrar 回報額外記錄剖析超出界線資訊安全風險 (CVE-2010-3239)  
-   感謝 [Secunia](http://secunia.com/) 的 Alin Rad Pop 回報額外記錄剖析超出界線資訊安全風險 (CVE-2010-3239)  
-   感謝 [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Chaouki Bekrar 回報即時資料陣列記錄資訊安全風險 (CVE-2010-3240)  
-   感謝 [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Chaouki Bekrar 回報在剖析中記憶體寫入超出範圍資訊安全風險 (CVE-2010-3241)  
-   感謝 [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Chaouki Bekrar 回報準刪除記錄類型剖析資訊安全風險 (CVE-2010-3242)  
-   感謝 [Secunia](http://secunia.com/) 的 Carsten H. Eiram 回報準刪除記錄類型剖析資訊安全風險 (CVE-2010-3242)
