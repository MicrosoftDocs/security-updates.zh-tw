...
**已知問題。** [Microsoft 知識庫文件編號 2315011](http://support.microsoft.com/kb/2315011/zh-tw) 中記載目前已知安裝此資訊安全更新後，可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。 目前已知問題和建議解決方案僅適用於此軟體的特定版本，本文會提供詳細文章的連結。
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=d5e85841-9dea-4776-9e0e-3cd272066f37">Microsoft Outlook 2002 Service Pack 3 (英文下載更新程式)</a><br />
(KB2293422)  
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=d5e85841-9dea-4776-9e0e-3cd272066f37&amp;displaylang=zh-tw">Microsoft Outlook 2002 Service Pack 3 (中文下載更新程式)</a><br />
(KB2293422)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/technet/security/bulletin/www.microsoft.com/taiwan/technet/security/bulletin/ms06-012.mspx">MS06-012</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Office 2003 Service Pack 3</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ec8ed81e-05d0-4c20-b5fb-ebc72230a8bd">Microsoft Outlook 2003 Service Pack 3 (英文下載更新程式)</a><br />
(KB2293428)  
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=ec8ed81e-05d0-4c20-b5fb-ebc72230a8bd&amp;displaylang=zh-tw">Microsoft Outlook 2003 Service Pack 3 (中文下載更新程式)</a><br />
(KB2293428)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=6009d507-135c-4ce8-a830-925134f214dc">Microsoft Outlook 2007 Service Pack 2 (英文下載更新程式)</a><br />
(KB2288953)  
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=6009d507-135c-4ce8-a830-925134f214dc&amp;displaylang=zh-tw">Microsoft Outlook 2007 Service Pack 2 (中文下載更新程式)</a><br />
(KB2288953)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-2728](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2728) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2293422/zh-tw">Microsoft 知識庫文件編號 2293422</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2293428/zh-tw">Microsoft 知識庫文件編號 2293428</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2288953/zh-tw">Microsoft 知識庫文件編號 2288953</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
-   感謝 [Secunia](http://secunia.com/) 的 Dyon Balding 回報 Outlook 中的堆積式緩衝區溢位資訊安全風險 (CVE-2010-2728)
