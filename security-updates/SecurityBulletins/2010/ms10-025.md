...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=73b3d681-26bb-49c1-849e-1f72484cb978">Microsoft Windows 2000 Server Service Pack 4 (英文下載更新程式)</a><br />
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=73b3d681-26bb-49c1-849e-1f72484cb978">Microsoft Windows 2000 Server Service Pack 4 (中文下載更新程式)</a></td>
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-0478](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0478) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/980858/zh-tw">Microsoft 知識庫文件編號 980858</a></td>
</tr>
<tr class="even">
...
-   感謝 [CERT-LEXSI](https://cert.lexsi.com/) 的 Fabien Perigaud 回報 Media Services 堆疊式緩衝區溢位弱點 (CVE-2010-0478)

Microsoft [感謝](https://go.microsoft.com/fwlink/?linkid=21127)下列人士和公司與我們合作，提供原本的安全性更新詳細的品質問題：

-   [CERT-LEXSI](https://cert.lexsi.com/) 的 Fabien Perigaud
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/)
-   [TELUS Security Labs](https://telussecuritylabs.com/) 的 Vulnerability Research Team
