---
TOCTitle: 'MS10-029'
Title: 'Microsoft Security Bulletin MS10-029 - 中等'
ms:assetid: 'ms10-029'
ms:contentKeyID: 61238555
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms10-029(v=Security.10)'
---


Microsoft Security Bulletin MS10-029 - 中等
===========================================

Windows ISATAP 元件中的弱點可能會允許偽造 (978338)
--------------------------------------------------
...
此安全性更新可解決 Microsoft Windows 中一項未公開報告的弱點。 對於 Windows XP、Windows Server 2003、Windows Vista 和 Windows Server 2008，此安全性更新的等級為「中度」。Windows 7 和 Windows Server 2008 R2 不會遭到攻擊，因為這些作業系統已包含此安全性更新所部署的功能。 如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

攻擊者可利用此弱點偽造 IPv4 位址，藉以突破依賴來源 IPv4 位址進行篩選的篩選裝置。 此安全性更新可改變 Windows TCP/IP 堆疊檢查通道 ISATAP 封包中的來源 IPv6 位址的方式，進而解決此項弱點。 如需更多有關弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9dc3e1c2-2e9d-4d86-9fce-446c409ad613">Windows XP Service Pack 2 及 Windows XP Service Pack 3 (英文下載更新程式)</a><br />
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=9dc3e1c2-2e9d-4d86-9fce-446c409ad613">Windows XP Service Pack 2 及 Windows XP Service Pack 3 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">偽造</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=d872bd77-f491-4706-8ff5-081ac0bf3d6f">Windows XP Professional x64 Edition Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">偽造</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=cd007a6c-04b3-490c-aff4-d5af3e69d477">Windows Server 2003 Service Pack 2 (英文下載更新程式)</a><br />
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=cd007a6c-04b3-490c-aff4-d5af3e69d477">Windows Server 2003 Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">偽造</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=19cfddfe-e8da-4564-9730-babfae4a3ebb">Windows Server 2003 x64 Edition Service Pack 2 (英文下載更新程式)</a><br />
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=19cfddfe-e8da-4564-9730-babfae4a3ebb">Windows Server 2003 x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">偽造</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=916f1b09-e79e-4347-9fbc-c0cf07de397d">Windows Server 2003 SP2 for Itanium-based Systems (英文下載更新程式)</a></td>
<td style="border:1px solid black;">偽造</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=196055a6-15d1-4da8-b33d-501e69bf5176">Windows Vista、Windows Vista Service Pack 1 和 Windows Vista Service Pack 2</a><br />
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=196055a6-15d1-4da8-b33d-501e69bf5176">Windows Vista、Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">偽造</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-009">MS10-009</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7c1d1622-1b67-438d-aae4-1a3954974a36">Windows Vista x64 Edition、Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2</a><br />
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=7c1d1622-1b67-438d-aae4-1a3954974a36">Windows Vista x64 Edition、Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">偽造</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-009">MS10-009</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=61ece7bc-e9fa-4ede-ba7d-9e5a4c64b9be">適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a>\*<br />
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=61ece7bc-e9fa-4ede-ba7d-9e5a4c64b9be">適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2 (中文下載更新程式)</a>\*</td>
<td style="border:1px solid black;">偽造</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-009">MS10-009</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=72e7c7ea-55ef-457b-a03a-49aa9dea2e84">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a>\*<br />
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=72e7c7ea-55ef-457b-a03a-49aa9dea2e84">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2 (中文下載更新程式)</a>*</td>
<td style="border:1px solid black;">偽造</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-009">MS10-009</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8c48302c-a1d6-41bc-ad24-7ce7332d4842">適用於 Itanium 型系統的 Windows Server 2008 和適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2</a></td>
<td style="border:1px solid black;">偽造</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-009">MS10-009</a></td>
</tr>
...
-   **ISATAP 用戶端上的可能路由器清單 (PRL)：** PRL 可讓用戶端針對連入的 ISATAP 通道封包，進行來源位址檢查。 安裝此安全性更新後，預設會啟用 PRL，此功能有助於解決 CVE-2010-0812 所說明的 ISATAP IPv6 來源位址偽造弱點。您可在 [Microsoft 知識庫文件編號 978338](https://support.microsoft.com/kb/978338/zh-tw) 中找到 PRL 的詳細資訊。  
-   **ISATAP 介面上的「鄰近伺服器無法連線偵測功能」(NUD)：** NUD 的作用是驗證鄰近的伺服器是否可連線。 在傳送 ISATAP 封包之前，ISATAP 節點會執行 NUD。 預設不會啟用 NUD，網路系統管理員必須手動設定 NUD。 如需 NUD 及其啟用方法的詳細資訊，請參閱 [Microsoft 知識庫文件編號 978338](https://support.microsoft.com/kb/978338/zh-tw)。
  
**Microsoft Windows 2000 為什麼不受此弱點影響？**    
Microsoft Windows 2000 作業系統不含 IPv6 支援，因此不會受到影響。
  
**Windows 7 和 Windows Server 2008 R2 為什麼不受此弱點影響？**    
此安全性更新所部署的「可能路由器清單 (PRL)」和「鄰近伺服器無法連線偵測功能 (NUD)」功能，皆已隨附於 Windows 7 和 Windows Server 2008 R2 中。
  
**注意：**雖然預設會在這些平台上啟用 PRL，但不會啟用 NUD，因此必須由網路系統管理員手動設定 NUD。 如需此功能的詳細資訊，請檢閱 [Microsoft 知識庫文件編號 978338](https://support.microsoft.com/kb/978338/zh-tw)。
  
**如果我沒有啟用 IPv6，是否也會提供此更新給我？**    
會，由於這些系統上已存在弱點程式碼，因此將會透過 \[自動更新\] 提供此安全性更新。 如果客戶計畫在日後部署 IPv6，我們建議客戶安裝安此全性更新。
...
<th style="border:1px solid black;" >ISATAP IPv6 來源位址偽造弱點 - CVE-2010-0812</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
**\*Server Core 安裝會受影響。** 此更新適用於支援的 Windows Server 2008 版本 (無論是否使用 Server Core 安裝選項安裝)，且嚴重性等級亦相同。 如需更多關於此安裝選項的資訊，請參閱 MSDN 文章：[Server Core](https://msdn.microsoft.com/en-us/library/ms723891(vs.85).aspx) (英文)。 請注意，Server Core 安裝選項不適用於某些 Windows Server 2008 版本；請參閱[比較 Server Core 安裝選項](https://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx) (英文)。
  
ISATAP IPv6 來源位址偽造弱點 - CVE-2010-0812  
--------------------------------------------
  
由於 Windows 在通道 ISATAP 封包中檢查內部封包的 IPv6 來源位址之方式，導致 Microsoft Windows IPv6 堆疊產生偽造弱點。 成功利用此弱點的攻擊者可以模擬出一個位址，來避開邊緣防火牆或主機防火牆。 此外，當目標電腦使用攻擊者指定的來源 IPv6 位址回覆訊息時，可能會洩露資訊。
  
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-0812](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0812) (英文)。
  
#### ISATAP IPv6 來源位址偽造弱點 - CVE-2010-0812 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少弱點影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   此弱點只會影響已設定 ISATAP 介面的 Windows 系統。
  
#### ISATAP IPv6 來源位址偽造弱點 - CVE-2010-0812 的因應措施
...
-   **停用 ISATAP IPv6 介面**
    ...
    若要停用 ISATAP IPv6 介面，請透過已提高權限的命令提示字元執行下列命令：
  
    `netsh interface isatap set state disabled`
  
    **注意：**您必須以系統管理員身分登入，或必須擁有系統管理認證才能完成此因應措施。
  
    **因應措施的影響。** 停用 ISATAP 介面會阻止系統使用 ISATAP 作為 IPv6 通道機制。
  
    **如何復原因應措施：**
  
    若要重新啟用 ISATAP IPv6 介面，請透過已提高權限的命令提示字元執行下列命令：
  
    `netsh interface isatap set state enabled`
  
    **注意：**您必須以系統管理員身分登入，或必須擁有系統管理認證才能復原此因應措施。
  
#### ISATAP IPv6 來源位址偽造弱點 - CVE-2010-0812 的常見問題集
  
**這個弱點的範圍為何？**    
這是一個偽造弱點。 攻擊者可利用此弱點偽造 IPv4 位址，來突破依賴來源 IPv4 位址進行篩選的篩選裝置。
  
**造成這個弱點的原因為何？**    
形成這個弱點的原因，是由於 Windows TCP/IP 堆疊未正確檢查通道 ISATAP 封包中的來源 IPv6 位址。
  
**什麼是 ISATAP？**    
內部網站自動通道定址通訊協定 (ISATAP) 在 IPv4 內部網路內提供 IPv6 連線功能。 如需 ISATAP 的相關資訊，請參閱 [RFC5214： 內部網站自動通道定址通訊協定 (ISATAP)](https://www.ietf.org/rfc/rfc5214.txt)。
  
**攻擊者可能會利用這項弱點採取什麼行動？**    
攻擊者可能會偽裝成另一個使用者或系統，以突破邊界防火牆或主機防火牆之類的來源位址篩選器。
  
**攻擊者如何利用這項弱點？**    
攻擊者可在 ISATAP 連線中建立蓄意製作的網路封包，並在封包中加入與對應的 IPv4 來源位址不符的 IPv6 來源位址，藉以利用此項弱點。
  
**因為這個弱點而承受風險的主要系統有哪些？**    
所有啟用 IPv6 ISATAP 功能的作業系統都會受到這個弱點影響。
  
**更新的作用何在？**    
此更新可改變 Windows TCP/IP 堆疊檢查通道 ISATAP 封包中的來源 IPv6 位址的方式，進而解決此項弱點。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB978338$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/978338/zh-tw">Microsoft 知識庫文件編號 978338</a></td>
</tr>
<tr class="even">
...
感謝 National EW Research & Simulation Center (位於 Rafael) 的 Gabi Nakibly 報告 ISATAP IPv6 來源位址偽造弱點 (CVE-2010-0812)
...
-   V1.1 (2010 年 5 月 7 日)： 已更正所有 Windows Vista 和 Windows Server 2008 更新套件的公告取代資訊。
