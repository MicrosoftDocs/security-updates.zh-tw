---
TOCTitle: 'MS10-057'
Title: 'Microsoft Security Bulletin MS10-057 - 重要'
ms:assetid: 'ms10-057'
ms:contentKeyID: 61238583
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms10-057(v=Security.10)'
---


Microsoft Security Bulletin MS10-057 - 重要
===========================================

Microsoft Office Excel 中的弱點可能會允許遠端執行程式碼 (2269707)
-----------------------------------------------------------------
...
這個資訊安全更新可解決 Microsoft Office 中一項未公開報告的弱點。 如果使用者開啟蓄意製作的 Excel 檔案，此弱點可能會允許遠端執行程式碼。 成功利用此弱點的攻擊者可以取得與登入使用者相同的使用者權限。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

對於所有受支援版本的 Microsoft Office Excel 2002、Microsoft Office Excel 2003、Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac 及 Open XML File Format Converter for Mac，此資訊安全更新的等級為「重要」。 如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此更新可以變更 Microsoft Office Excel 剖析蓄意製作之 Excel 檔案的方式，以解決弱點。 如需更多有關弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。

**建議。** Microsoft 建議客戶應該儘快套用此更新程式。

**已知問題。** [Microsoft 知識庫文件編號 2269707](https://support.microsoft.com/kb/2269707/zh-tw) 中記載目前已知安裝此資訊安全更新後，可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2002 Service Pack 3 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=032e1530-8736-4e1c-a704-967679227619)  
(KB2264397)  
[Microsoft Office Excel 2002 Service Pack 3 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=032e1530-8736-4e1c-a704-967679227619)  
(KB2264397)
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2003 Service Pack 3 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=7cecbce3-bbb7-47d1-bda3-64d7e0f69f62)  
(KB2264403)  
[Microsoft Office Excel 2003 Service Pack 3 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=7cecbce3-bbb7-47d1-bda3-64d7e0f69f62)  
(KB2264403)
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-2562](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2562) (英文)。

#### Excel 記憶體損毀弱點 - CVE-2010-2562 的緩和因素
...
#### Excel 記憶體損毀弱點 - CVE-2010-2562 的因應措施
...
-   **對於來自於不受信任的來源，或在非預期情況下從信任來源收到的 Microsoft Office 檔案，請勿隨意開啟**

    對於來自於不受信任的來源、或在非預期情況下從信任來源收到的 Microsoft Office 檔案，請勿隨意開啟。 當使用者開啟蓄意製作的檔案時，即可能遭受利用此弱點的攻擊。

#### Excel 記憶體損毀弱點 - CVE-2010-2562 的常見問題集
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2264397/zh-tw">Microsoft 知識庫文件編號 2264397</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2264403/zh-tw">Microsoft 知識庫文件編號 2264403</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
-   感謝 [Core Security Technologies](https://www.coresecurity.com/) 的 Damián Frizza 回報 Excel 記憶體損毀弱點 (CVE-2010-2562)
...
-   V1.1 (2010 年 8 月 23 日)： 在＜提要＞的＜已知問題＞下新增 Microsoft 知識庫文件編號 2269707 的連結。
