...
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms08-069">MS08-069</a></td>
</tr>
<tr class="even">
...
Microsoft XML Core Services 包含在 Microsoft 以外的其他非作業系統軟體中，但亦可供單獨下載。 如需關於 Microsoft XML Core Services 的各種現行版本以及安裝此服務的產品等資訊，請參閱 [Microsoft 知識庫文件編號 269238](http://support.microsoft.com/kb/269238/zh-tw)。
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-2561](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2561) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2079403/zh-tw">Microsoft 知識庫文件編號 2079403</a></td>
</tr>
<tr class="even">
...
-   感謝 [Google, Inc.](http://www.google.com/) 的 SkyLined 回報 Msxml2.XMLHTTP.3.0 Response 處理記憶體損毀 CVE-2010-2561
