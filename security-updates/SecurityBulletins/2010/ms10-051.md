---
TOCTitle: 'MS10-051'
Title: 'Microsoft Security Bulletin MS10-051 - 重大'
ms:assetid: 'ms10-051'
ms:contentKeyID: 61238577
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms10-051(v=Security.10)'
---


Microsoft Security Bulletin MS10-051 - 重大
===========================================

Microsoft XML Core Services 的弱點可能會允許遠端執行程式碼 (2079403)
--------------------------------------------------------------------
...
這個資訊安全更新可解決 Microsoft XML Core Services 中一項未公開報告的弱點。 如果使用者使用 Internet Explorer 檢視蓄意製作的網頁，此弱點可能會允許遠端執行程式碼。 攻擊者並不能強迫使用者造訪這些網站。 而是引誘使用者自行前往。一般的做法是設法讓使用者按一下電子郵件或 Instant Messenger 訊息中通往攻擊者網站的連結。

對於所有受支援版本 Windows XP、Windows Vista 與 Windows 7 中的 Microsoft XML Core Services 3.0，此資訊安全更新的等級為「重大」。對於所有受支援版本 Windows Server 2003、Windows Server 2008 與 Windows Server 2008 R2 中的 Microsoft XML Core Services 3.0，此資訊安全更新的等級為「中度」。如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此資訊安全更新可確保 MSXML 正確處理 HTTP 回應，以解決此弱點。 如需更多有關弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=dbdbbe5e-2ef9-4704-80c4-27ef28fd95ef">Microsoft XML Core Services 3.0 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=dbdbbe5e-2ef9-4704-80c4-27ef28fd95ef">Microsoft XML Core Services 3.0 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-069">MS08-069</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4d4e8eeb-a0b2-41c6-9ee4-3f4beb44195e">Microsoft XML Core Services 3.0 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-069">MS08-069</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=31ce233e-4d2d-404b-84a8-683319ba8ef7">Microsoft XML Core Services 3.0 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=31ce233e-4d2d-404b-84a8-683319ba8ef7">Microsoft XML Core Services 3.0 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4d784b57-8564-4e7e-8f61-f897398e7ea5">Microsoft XML Core Services 3.0 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=4d784b57-8564-4e7e-8f61-f897398e7ea5">Microsoft XML Core Services 3.0 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-069">MS08-069</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=d87ac8b3-41fb-4cdd-b305-181a0024d85c">Microsoft XML Core Services 3.0 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-069">MS08-069</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=bbfaadf8-ab38-456c-956a-ea18c64236c9">Microsoft XML Core Services 3.0 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=bbfaadf8-ab38-456c-956a-ea18c64236c9">Microsoft XML Core Services 3.0 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-069">MS08-069</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=577131cd-1229-4746-89d7-84d75f29e1f0">Microsoft XML Core Services 3.0 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=577131cd-1229-4746-89d7-84d75f29e1f0">Microsoft XML Core Services 3.0 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-069">MS08-069</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=73b5f45c-c9d6-491f-8483-98838b2a7c04">Microsoft XML Core Services 3.0 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=73b5f45c-c9d6-491f-8483-98838b2a7c04">Microsoft XML Core Services 3.0 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-069">MS08-069</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=43ece408-4aa7-4819-b3f6-7f0719ed3213">Microsoft XML Core Services 3.0 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=43ece408-4aa7-4819-b3f6-7f0719ed3213">Microsoft XML Core Services 3.0 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-069">MS08-069</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b6faee94-e821-432d-bfa2-9008664566af">Microsoft XML Core Services 3.0 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-069">MS08-069</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=31d0f5ac-2cff-42a1-8f18-128bbfc4e57d">Microsoft XML Core Services 3.0 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=31d0f5ac-2cff-42a1-8f18-128bbfc4e57d">Microsoft XML Core Services 3.0 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=a4f6d7c2-b475-4900-82f0-75f5be0b7b63">Microsoft XML Core Services 3.0 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=a4f6d7c2-b475-4900-82f0-75f5be0b7b63">Microsoft XML Core Services 3.0 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=a48cdac5-4d78-49b5-a6d8-ecf6c58cace2">Microsoft XML Core Services 3.0 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=a48cdac5-4d78-49b5-a6d8-ecf6c58cace2">Microsoft XML Core Services 3.0 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b4d3210e-f3ad-4dbb-9390-6e98eeb99eaa">Microsoft XML Core Services 3.0 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<tr>
<td style="border:1px solid black;">
所有受支援版本的 Microsoft Office 套件；Microsoft Office 元件、檢視器及相容性套件；Microsoft Office SharePoint 伺服器；Microsoft Office Groove Server；以及 Microsoft Office Expression Web
</td>
<td style="border:1px solid black;">
...
Microsoft XML Core Services 包含在 Microsoft 以外的其他非作業系統軟體中，但亦可供單獨下載。 如需關於 Microsoft XML Core Services 的各種現行版本以及安裝此服務的產品等資訊，請參閱 [Microsoft 知識庫文件編號 269238](https://support.microsoft.com/kb/269238/zh-tw)。
...
<th style="border:1px solid black;" >Msxml2.XMLHTTP.3.0 回應處理記憶體損毀弱點 - CVE-2010-2561</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
Msxml2.XMLHTTP.3.0 回應處理記憶體損毀弱點 - CVE-2010-2561  
---------------------------------------------------------
  
Microsoft XML Core Services 處理 HTTP 回應的方式存在遠端執行程式碼弱點。 如果使用者瀏覽的網站包含蓄意製作的內容，或使用者開啟蓄意製作的 HTML 電子郵件，此弱點將允許遠端執行程式碼。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
  
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-2561](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2561) (英文)。
  
#### Msxml2.XMLHTTP.3.0 回應處理記憶體損毀弱點 - CVE-2010-2561 的緩和因素
...
#### Msxml2.XMLHTTP.3.0 回應處理記憶體損毀弱點 - CVE-2010-2561 的因應措施
  
因應措施指的是無法徹底修正弱點，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。 Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：
  
-   **避免 COM 物件在 Internet Explorer 中執行**
  
    您可以在登錄中設定控制項的 Kill Bit (刪除位元)，禁止嘗試在 Internet Explorer 中產生 COM 物件。 在 Internet Explorer 中會被此因應措施防止具現化的 COM 物件，就是 Msxml2.XMLHTTP.3.0 ActiveX 控制項。
    ...
    **警告：**如果使用「登錄編輯程式」的方式錯誤，可能造成嚴重問題，以致於您必須重新安裝作業系統。 Microsoft 無法保證您可以解決因為不正確使用 \[登錄編輯程式\] 所造成的問題。 請自行承擔使用 \[登錄編輯程式\] 的風險。
    ...
    若要設定具有 {F5078F35-C551-11D3-89B9-0000F81FE221} 值的 CLSID 的刪除位元，請將下列文字貼到「記事本」等文字編輯程式中。 然後使用 .reg 副檔名存檔。
...
-   **限制僅瀏覽信任的網站**
    ...
    您可以加入任何您相信不會對您的電腦進行惡意動作的網站。 建議您加入 **&#42;.windowsupdate.microsoft.com** 與 **&#42;.update.microsoft.com** 這兩個網站。上述網站提供各項更新，且需要 ActiveX 控制項才能安裝更新。
  
#### Msxml2.XMLHTTP.3.0 回應處理記憶體損毀弱點 - CVE-2010-2561 的常見問題集
  
**這個弱點的範圍為何？**    
這是遠端執行程式碼的弱點。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
  
**造成這個弱點的原因為何？**    
MSXML 處理 HTTP 回應方式中存在一個錯誤，此錯誤可能會損毀系統狀態，使攻擊者有機會執行任意程式碼。
...
**更新的作用何在？**    
此更新可確保 MSXML 正確處理 HTTP 回應，以解決此弱點。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB2079403$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2079403/zh-tw">Microsoft 知識庫文件編號 2079403</a></td>
</tr>
<tr class="even">
...
-   感謝 [Google, Inc.](https://www.google.com/) 的 SkyLined 回報 Msxml2.XMLHTTP.3.0 Response 處理記憶體損毀 CVE-2010-2561
