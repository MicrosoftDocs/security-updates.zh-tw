...
**已知問題。** [Microsoft 知識庫文件編號 982335](https://support.microsoft.com/kb/982335/zh-tw) 中記載目前已知安裝此資訊安全更新後，可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-0814](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0814) (英文)。
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-1881](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1881) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/981716/zh-tw">Microsoft 知識庫文件編號 981716</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/979440/zh-tw">Microsoft 知識庫文件編號 979440</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
-   感謝匿名研究人員與 [TippingPoint](https://www.tippingpoint.com/) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，回報 Access ActiveX 控制項弱點 (CVE-2010-0814)  
-   感謝 [IBM ISS X-Force](https://www.iss.net/) 的 Robert Freeman 回報 ACCWIZ.dll 未初始化的變數弱點 (CVE-2010-1881)
