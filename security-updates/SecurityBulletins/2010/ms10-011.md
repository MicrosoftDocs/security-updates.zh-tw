...
**已知問題。** [Microsoft 知識庫文件編號 978037](http://support.microsoft.com/kb/978037/zh-tw) 中記載了客戶安裝此安全性更新時，可能會發生的目前已知問題。 該文件並說明了解決這些問題的建議解決方案。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2010-0023](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0023)。
...
| **檔案資訊**                           | 請參閱 [Microsoft 知識庫文件編號 978037](http://support.microsoft.com/kb/978037/zh-tw)                                        |  
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/978037/zh-tw">Microsoft 知識庫文件編號 978037</a></td>
</tr>
<tr class="even">
...
-   感謝 Matthew 'j00ru' Jurczyk 和 [Hispasec](http://www.hispasec.com/) 的 Gynvael Coldwind 回報本機權限提高弱點 (CVE-2010-0023)
