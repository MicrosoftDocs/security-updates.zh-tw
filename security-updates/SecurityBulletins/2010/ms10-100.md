---
TOCTitle: 'MS10-100'
Title: 'Microsoft Security Bulletin MS10-100 - 重要'
ms:assetid: 'ms10-100'
ms:contentKeyID: 61238626
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms10-100(v=Security.10)'
---


Microsoft Security Bulletin MS10-100 - 重要
===========================================

同意使用者介面中的資訊安全風險可能會允許權限提高 (2442962)
----------------------------------------------------------
...
此資訊安全更新可解決同意使用者介面 (UI) 中一項未公開報告的資訊安全風險。 如果攻擊者在受影響的系統上執行蓄意製作的應用程式，這項資訊安全風險可能會允許權限提高。 攻擊者必須擁有有效的登入認證和 SeImpersonatePrivilege，並能夠從本機登入，才能利用這項資訊安全風險。 匿名或遠端使用者無法利用這個資訊安全風險。
...
此資訊安全更新可修正「同意 UI」處理自登錄讀取值的方式，進而解決此項資訊安全風險。 如需更多有關資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=85265a23-5094-4007-8d33-f402cabd1664">Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=85265a23-5094-4007-8d33-f402cabd1664&amp;displaylang=zh-tw">Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=63c7257a-16bf-4108-80b9-9dfe53528348">Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=63c7257a-16bf-4108-80b9-9dfe53528348&amp;displaylang=zh-tw">Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=14e079a8-01a4-47c9-bd47-f5c9a6ca070a">適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a>&#42;&#42;
<a href="https://www.microsoft.com/download/details.aspx?familyid=14e079a8-01a4-47c9-bd47-f5c9a6ca070a&amp;displaylang=zh-tw">適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2 (中文下載更新程式)</a>&#42;&#42;</td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=6baf92b7-a336-45f2-a1ba-c00c34dfb76f">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a>&#42;&#42;
<a href="https://www.microsoft.com/download/details.aspx?familyid=6baf92b7-a336-45f2-a1ba-c00c34dfb76f&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2 (中文下載更新程式)</a>&#42;&#42;</td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7a4b23d4-f68e-4d5b-8814-d9247145f164">適用於 Itanium 型系統的 Windows Server 2008 和適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f7c7d57a-d031-46a3-9613-eae2b9cb6401">適用於 32 位元系統的 Windows 7 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=f7c7d57a-d031-46a3-9613-eae2b9cb6401&amp;displaylang=zh-tw">適用於 32 位元系統的 Windows 7 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e52c36f5-637b-4928-83d0-27514c6cc384">適用於 x64 型系統的 Windows 7 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=e52c36f5-637b-4928-83d0-27514c6cc384&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows 7 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b823a7aa-0eb9-42dd-bf56-8907d94b314a">適用於 x64 型系統的 Windows Server 2008 R2 (英文下載更新程式)</a>&#42;&#42;
<a href="https://www.microsoft.com/download/details.aspx?familyid=b823a7aa-0eb9-42dd-bf56-8907d94b314a&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows Server 2008 R2 (中文下載更新程式)</a>&#42;&#42;</td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=66b2506d-80e0-4e32-86e6-0908ef56ae90">適用於 Itanium 系統的 Windows Server 2008 R2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<th style="border:1px solid black;" >同意 UI 模擬資訊安全風險 - CVE-2010-3961</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
同意 UI 模擬資訊安全風險 - CVE-2010-3961  
----------------------------------------
  
在「同意使用者介面 (UI)」不當處理自登錄讀取值的方式中，存在權限提高資訊安全風險。 此資訊安全風險可能會允許攻擊者以提高的權限執行程式碼。 成功利用此資訊安全風險的攻擊者可執行任意程式碼，並取得受影響之系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3961](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3961) (英文)。
  
#### 同意 UI 模擬資訊安全風險 - CVE-2010-3961 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項資訊安全風險。 匿名或遠端使用者無法利用這個資訊安全風險。  
-   為了成功利用此資訊安全風險，攻擊者必須擁有 SeImpersonatePrivilege。 下列元件也具有此使用者權限：  
    - 服務控制管理員所啟動的服務  
    - 由 COM 基礎結構啟動，並設定在特定帳戶下執行的元件物件模型 (COM)  
    - 設定作為一般使用者執行的 IIS 服務
  
#### 同意 UI 模擬資訊安全風險 - CVE-2010-3961 的因應措拖
  
Microsoft 尚未找到此項資訊安全風險的任何因應措施。
  
#### 同意 UI 模擬資訊安全風險 - CVE-2010-3961 的常見問題集
  
**這個資訊安全風險的範圍為何？**    
這是權限提高的資訊安全風險。 成功利用此資訊安全風險的攻擊者能夠以 LocalSystem 權限執行任意程式碼。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個資訊安全風險的原因為何？**    
此資訊安全風險是「同意 UI」不當處理已設為特定值的登錄機碼所導致。
  
**什麼是同意使用者介面 (UI)？**    
同意 UI 是使用者帳戶控制 (UAC) 的一部分。 完全啟用 UAC 時，互動系統管理員通常會以最小的使用者權限執行，但他們可利用同意 UI 提供明確同意，藉此自我提高權限以執行系統管理工作。 此類系統管理工作包含安裝軟體和驅動程式、變更全系統設定、檢視或變更其他使用者帳戶，以及執行系統管理工具。 如需詳細資訊，請參閱 MSDN 文章：[使用者帳戶控制](https://msdn.microsoft.com/en-us/library/aa511445.aspx) (英文)。
  
**什麼是 SeImpersonatePrivilege？**    
SeImpersonatePrivilege (也稱為「驗證後模擬用戶端」) 使用者權限是 Microsoft Windows 2000 Service Pack 4 首先引進的資訊安全設定。依照預設，會將此使用者權限指派給裝置的本機 Administrators 群組成員和裝置的 LocalService 帳戶。 SelmpersonatePrivilege 設定在 [Microsoft 知識庫文件編號 821546](https://support.microsoft.com/kb/821546/zh-tw) 中有所描述。
...
只有被授與 SeImpersonatePrivilege 的使用者帳戶可執行此攻擊。 成功利用此資訊安全風險的攻擊者可利用 LocalSystem 權限執行蓄意製作的程式碼。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
...
**更新的作用何在？**    
此更新可修正「同意 UI」處理自登錄讀取值的方式，進而解決此項資訊安全風險。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2442962/zh-tw">Microsoft 知識庫文件編號 2442962</a></td>
</tr>
<tr class="odd">
...
-   感謝 [Argeniss](https://www.argeniss.com/) 的 Cesar Cerrudo 回報同意 UI 模擬資訊安全風險 (CVE-2010-3961)。
