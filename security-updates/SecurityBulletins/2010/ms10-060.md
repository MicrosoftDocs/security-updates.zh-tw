...
**已知問題。** [Microsoft 知識庫文件編號 2265906](https://support.microsoft.com/kb/2265906/zh-tw) 中記載目前已知安裝此資訊安全更新後，可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 3.5 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=648cfca5-19eb-4658-a6ad-fe546c4c44b9)  
(KB983582)  
[Microsoft .NET Framework 2.0 Service Pack 2 和 Microsoft .NET Framework 3.5 Service Pack 1 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=1e53f250-2d4b-4f61-86ee-9f9f3a9c0b48)  
(KB983583)  
[Microsoft .NET Framework 3.5 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=648cfca5-19eb-4658-a6ad-fe546c4c44b9)  
(KB983582)  
[Microsoft .NET Framework 2.0 Service Pack 2 和 Microsoft .NET Framework 3.5 Service Pack 1 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=1e53f250-2d4b-4f61-86ee-9f9f3a9c0b48)  
(KB983583)
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 2.0 Service Pack 1 和 Microsoft .NET Framework 3.5 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=616c39f7-137a-40b9-b691-bc33c0aef7e1)  
(KB983587)  
[Microsoft .NET Framework 2.0 Service Pack 2 和 Microsoft .NET Framework 3.5 Service Pack 1 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=155bbb5c-247e-4bed-a287-527d978b7967)  
(KB983588)  
[Microsoft .NET Framework 2.0 Service Pack 1 和 Microsoft .NET Framework 3.5 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=616c39f7-137a-40b9-b691-bc33c0aef7e1)  
(KB983587)  
[Microsoft .NET Framework 2.0 Service Pack 2 和 Microsoft .NET Framework 3.5 Service Pack 1 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=155bbb5c-247e-4bed-a287-527d978b7967)  
(KB983588)
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 2.0 Service Pack 2 和 Microsoft .NET Framework 3.5 Service Pack 1 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=7712e8ad-dea4-4a43-8a7b-dc154510c104)  
(KB983589)  
[Microsoft .NET Framework 2.0 Service Pack 2 和 Microsoft .NET Framework 3.5 Service Pack 1 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=7712e8ad-dea4-4a43-8a7b-dc154510c104)  
(KB983589)
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 3.5.1 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=77d0c428-237c-4dab-9645-6400dd9e65f8)  
(KB983590)  
[Microsoft .NET Framework 3.5.1 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=77d0c428-237c-4dab-9645-6400dd9e65f8)  
(KB983590)
...
<tr>
<td style="border:1px solid black;">
安裝於 Mac 上的 [Microsoft Silverlight 2](https://www.microsoft.com/getsilverlight/get-started/install/default.aspx)<sup>[1]</sup>
(KB982926)
</td>
<td style="border:1px solid black;">
遠端執行程式碼
...
**什麼是 Silverlight？**  
Microsoft Silverlight 是 Microsoft .NET Framework 的一個跨瀏覽器、跨平台的實作工具，可讓使用者藉由網站體會媒體體驗及進行豐富的互動應用。 如需詳細資訊，請參閱 [Microsoft Silverlight](https://www.microsoft.com/silverlight/) 的官方網站。

**哪些網頁瀏覽器支援 Silverlight 應用程式？**  
為執行 Silverlight 應用程式，大多數網頁瀏覽器 (包含 Microsoft Internet Explorer) 都需要安裝 Silverlight，並和啟用對應的外掛程式。 如需 Silverlight 的詳細資訊，請參閱 [Microsoft Silverlight](https://www.microsoft.com/silverlight/) 官方網站。 請參閱瀏覽器的文件，瞭解如何停用或移除外掛程式。
...
**如何升級 Silverlight 版本？**  
Silverlight 自動更新功能可確保 Silverlight 安裝保持為最新版本的 Silverlight、Silverlight 功能和安全性功能。 如需更多關於 Silverlight 自動更新功能的資訊，請參閱 [Microsoft Silverlight Updater](https://www.microsoft.com/silverlight/resources/documentation/updater.aspx)。 已停用 Silverlight 自動更新功能的客戶，可在 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 中註冊，以取得最新版本的 Silverlight，或使用前述＜受影響及不受影響的軟體＞一節內「受影響的軟體」表中的下載連結，手動下載最新版本的 Silverlight。 如需在企業環境中部署 Silverlight 的更多資訊，請參閱 [Silverlight 企業部署指南](https://go.microsoft.com/fwlink/?linkid=119611)。

**此更新是否包含任何與安全性無關的功能變更？**  
如需目前版本 Silverlight 所含的非安全性變更的詳細資訊，請參閱 [Microsoft Silverlight 版本記錄](https://go.microsoft.com/fwlink/?linkid=92598)。
...
下列嚴重性等級是假設弱點可能造成的最嚴重影響而評定。 在本資訊安全公告發行的 30 天內，如需弱點之易遭利用性與嚴重性等級和資訊安全影響之間對應關係的資訊，請參閱 [8 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms10-aug)中的＜弱點索引＞。 如需更多資訊，請參閱 [Microsoft 弱點索引](https://technet.microsoft.com/en-us/security/cc998259.aspx)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2010-0019](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0019)。
...
-   **暫時避免在 Internet Explorer 中執行 Microsoft Silverlight ActiveX 控制項 (方法 1)**
    ...
    **警告：**如果使用「登錄編輯程式」的方式錯誤，可能造成嚴重問題，以致於您必須重新安裝作業系統。 Microsoft 無法保證您可以解決因為不正確使用 \[登錄編輯程式\] 所造成的問題。 請自行承擔使用 \[登錄編輯程式\] 的風險。
    ...
    如需在 Internet Explorer 中停止執行控制項的詳細步驟，請參閱 [Microsoft 知識庫文件編號 240797](https://support.microsoft.com/kb/240797/zh-tw)。按照這些步驟，在登錄中建立相容性旗標值，以避免在 Internet Explorer 中執行 Silverlight ActiveX 控制項。
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-1898](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1898) (英文)。

#### Microsoft Silverlight 和 Microsoft .NET Framework CLR 虛擬方法委派弱點 - CVE-2010-1898 的緩和因素

緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少弱點影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：

-   依照預設，Windows Server 2003 和 Windows Server 2008 上的 Internet Explorer 會以稱為[增強式安全性設定](https://go.microsoft.com/fwlink/?linkid=92039)的受限制模式執行。 這種模式只能在網頁式攻擊案例中減輕此弱點。 如需更多資訊，請參閱此弱點＜常見問題集＞關於 Internet Explorer 增強式安全性設定的部份。
...
-   Microsoft Silverlight 的最新版本 Silverlight 4 不受此弱點影響。 依預設，Silverlight 會定期檢查 Microsoft 網站，找出您適用的最新功能和增強功能。 若有可用的更新版本，則會下載該版本並安裝到您的電腦。 大部分系統都已經執行 Silverlight 4 版本。如需詳細資訊，請參閱 [Microsoft Silverlight Updater](https://www.microsoft.com/silverlight/resources/documentation/updater.aspx)。
...
-   **暫時避免在 Windows XP Service Pack 2 或更新版本的 Internet Explorer 中執行 Microsoft Silverlight ActiveX 控制項**
    ...
    **注意：**此因應措施僅適用於已安裝 Silverlight 的系統，而無法主動在尚未安裝 Silverlight 的系統上使用。
    ...
    如需有關 Windows XP Service Pack 2 的 Internet Explorer 管理附加元件功能的資訊，請參閱 [Microsoft 知識庫文件編號 883256](https://support.microsoft.com/kb/883256/zh-tw)。
...
-   **升級至最新版的 Microsoft Silverlight**
    ...
    Silverlight 4 不受此弱點影響。 客戶不需要安裝 Silverlight 資訊安全更新，可改為升級至最新版本的 Silverlight。 如需更多資訊，請參閱 [Microsoft Silverlight](https://www.microsoft.com/silverlight/)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2265906/zh-tw">Microsoft 知識庫文件編號 2265906</a></td>
</tr>
<tr class="odd">
...
-   感謝 [Eamon Nerbonne](https://eamon.nerbonne.org) 回報 Microsoft Silverlight 和 Microsoft .NET Framework CLR 虛擬方法委派弱點 (CVE-2010-1898)
