---
TOCTitle: 'MS10-074'
Title: 'Microsoft Security Bulletin MS10-074 - 中等'
ms:assetid: 'ms10-074'
ms:contentKeyID: 61238600
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms10-074(v=Security.10)'
---


Microsoft Security Bulletin MS10-074 - 中等
===========================================

Microsoft Foundation Classes 中的資訊安全風險可能會允許遠端執行程式碼 (2387149)
-------------------------------------------------------------------------------
...
此資訊安全更新可解決 Microsoft Foundation Class (MFC) 程式庫中一項公開報告的資訊安全風險。 如果使用者以系統管理員的使用者權限登入，並開啟以 MFC 程式庫建立的應用程式，則此資訊安全風險可能會允許遠端執行程式碼。 成功利用此資訊安全風險的攻擊者，可取得與目前登入的使用者相同的權限。 如果使用者以系統管理的使用者權限登入，則攻擊者即可取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

對於所有受支援版本的 Microsoft Windows，此資訊安全更新的等級為「中度」。 如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此資訊安全更新可針對 Windows 標題變更要求進行額外的檢查，藉此解決此資訊安全風險。 如需更多有關資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=22f46b3b-9be6-45ea-a639-9974324ce4bd">Windows XP Service Pack 3 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=22f46b3b-9be6-45ea-a639-9974324ce4bd&amp;displaylang=zh-tw">Windows XP Service Pack 3 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=285627b9-242d-4247-a4c8-55dc89386b62">Windows XP Professional x64 Edition Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=d220f04e-9dbb-4b6d-924a-23065b48b8b6">Windows Server 2003 Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=d220f04e-9dbb-4b6d-924a-23065b48b8b6&amp;displaylang=zh-tw">Windows Server 2003 Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-012">MS07-012</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=de908137-33e0-4f23-b32b-cc1bdbcb349c">Windows Server 2003 x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=de908137-33e0-4f23-b32b-cc1bdbcb349c&amp;displaylang=zh-tw">Windows Server 2003 x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=873dea9d-44cc-4e16-8a6d-dca678ce3a80">適用於 Itanium 型系統的 Windows Server 2003 SP2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=75ca4e2c-b0ae-46f4-a0fc-616510c41a55">Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=75ca4e2c-b0ae-46f4-a0fc-616510c41a55&amp;displaylang=zh-tw">Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=0a12ff95-ea5c-4c48-96c5-9494eb8f9f0d">Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=0a12ff95-ea5c-4c48-96c5-9494eb8f9f0d&amp;displaylang=zh-tw">Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=952b3594-d980-45b1-8fa3-49403784afbf">適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a>&#42;&#42;
<a href="https://www.microsoft.com/download/details.aspx?familyid=952b3594-d980-45b1-8fa3-49403784afbf&amp;displaylang=zh-tw">適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2 (中文下載更新程式)</a>&#42;&#42;</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=21128031-d935-4e2d-b001-c502a2d6022c">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a>&#42;&#42;
<a href="https://www.microsoft.com/download/details.aspx?familyid=21128031-d935-4e2d-b001-c502a2d6022c&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2 (中文下載更新程式)</a>&#42;&#42;</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2eca0c38-73f5-4f83-ab62-97f979716a1d">適用於 Itanium 型系統的 Windows Server 2008 和適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f09fbc23-cb6b-4525-8e41-8c14e8d03de9">適用於 32 位元系統的 Windows 7 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=f09fbc23-cb6b-4525-8e41-8c14e8d03de9&amp;displaylang=zh-tw">適用於 32 位元系統的 Windows 7 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=abc24826-b83a-4e01-be68-8e3a73c10494">適用於 x64 型系統的 Windows 7 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=abc24826-b83a-4e01-be68-8e3a73c10494&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows 7 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e4d27aa6-9739-4e41-9536-5f0b8d26503c">適用於 x64 型系統的 Windows Server 2008 R2 (英文下載更新程式)</a>&#42;&#42;
<a href="https://www.microsoft.com/download/details.aspx?familyid=e4d27aa6-9739-4e41-9536-5f0b8d26503c&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows Server 2008 R2 (中文下載更新程式)</a>&#42;&#42;</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c1634278-5598-45e0-81c6-f18fb5ba54cf">適用於 Itanium 系統的 Windows Server 2008 R2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<th style="border:1px solid black;" >Windows MFC 文件標題更新緩衝區溢位資訊安全風險 - CVE-2010-3227</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
Windows MFC 文件標題更新緩衝區溢位資訊安全風險 - CVE-2010-3227  
--------------------------------------------------------------
  
在使用 Microsoft Foundation Class (MFC) 程式庫撰寫的應用程式中，其管理視窗標題的方式存在遠端執行程式碼的資訊安全風險。 雖然此資訊安全風險位於 MFC 並出現在受影響的作業系統中，但唯有遠端攻擊者可以在 MFC 應用程式中影響任何視窗的視窗標題時，才能利用此資訊安全風險。 成功利用此資訊安全風險的攻擊者可在目前使用者的安全性內容中執行任意程式碼。
  
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3227](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3227) (英文)。
  
#### Windows MFC 文件標題更新緩衝區溢位資訊安全風險 - CVE-2010-3227 的緩和因素
  
Microsoft 尚未找到此項資訊安全風險的任何緩和因素。
  
#### Windows MFC 文件標題更新緩衝區溢位資訊安全風險 - CVE-2010-3227 的因應措施
  
Microsoft 尚未找到此項資訊安全風險的任何因應措施。
  
#### Windows MFC 文件標題更新緩衝區溢位資訊安全風險 - CVE-2010-3227 的常見問題集
  
**這個資訊安全風險的範圍為何？**    
此資訊安全風險是在目前登入的使用者之安全性內容中的一個遠端執行程式碼資訊安全風險。
  
**造成這個資訊安全風險的原因為何？**    
這是由 MFC 處理應用程式要求重新命名視窗標題的方式所引起的資訊安全風險。
  
**什麼是 Microsoft Foundation Class (MFC) 程式庫？**    
Microsoft Foundation Class (MFC) 程式庫是 Microsoft Windows 中用來設計程式的應用程式架構。 MFC 是以 C++ 所撰寫，並提供大部分程式碼所需要執行的標準作業，例如管理視窗、功能表和對話方塊；執行基本輸入/輸出，或儲存資料物件的集合。
  
**即使我的系統上沒有適用的攻擊模式，我是否仍會收到此更新？**    
是的，我們會針對執行軟體的所有系統 (在＜受影響的軟體＞一節中有概述) 提供此更新。 如果系統目前未安裝 MFC 應用程式，Microsoft 建議使用者安裝此更新來作為深度防禦措施，以防禦已知或日後發現的攻擊模式。
  
**是否有任何作為攻擊模式使用的 Microsoft 應用程式？**    
Microsoft 已仔細研究所有的應用程式，但未發現可成功作為攻擊模式的 Microsoft 應用程式。
  
**Microsoft 是否得知有任何協力廠商 MFC 應用程式可作為攻擊模式使用？**    
是。 Microsoft 發現有一個協力廠商應用程式可作為攻擊模式使用。 要使用此協力廠商攻擊模式來成功利用此資訊安全風險，使用者需要以 MFC 應用程式開啟蓄意製作的檔案，然後連按兩下 MFC 應用程式內的資料夾。
...
-   該應用程式根據遠端使用者可控制的資訊來設定視窗標題
  
**注意：**Microsoft 建議您將 MFC 應用程式以動態方式連結到 Windows 隨附的 MFC 版本。 如果應用程式隨附易受影響的 MFC 版本，並以靜態方式連結到該版本，則強烈建議您將應用程式更新為動態連結到 Windows 隨附的 MFC 版本。
...
**攻擊者如何利用這項資訊安全風險？**    
要成功利用此資訊安全風險，目標系統需安裝可作為攻擊模式使用的 MFC 應用程式。 可作為攻擊模式使用的 MFC 應用程式必須提供一種方法，讓遠端使用者影響 MFC 應用程式中的視窗標題。 例如，根據以 MFC 應用程式開啟的檔案內容進行視窗標題變更，以及根據網路輸入 (聊天應用程式或網頁瀏覽器等) 進行視窗標題變更。 視特定的攻擊模式而定，攻擊者可能需要引誘使用者使用其系統上安裝的特定 MFC 應用程式來開啟蓄意製作的檔案，然後執行特定的動作。 在不同的攻擊模式中 (例如聊天應用程式)，功擊者可能只需要變更聊天室的名稱，或使用蓄意製作的控制代碼來連絡使用者即可。
  
**因為這個資訊安全風險而承受風險的主要系統有哪些？**    
若安裝 MFC 應用程式並允許遠端使用者影響 MFC 應用程式內部的視窗標題，則工作站和終端機伺服器最可能受影響。 若系統管理員允許使用者登入伺服器並執行此 MFC 程式，那麼伺服器可能遭受更大的風險。 然而，最佳實務強烈建議您制止這種行為。
  
**更新的作用何在？**    
此更新可針對 Windows 標題變更要求進行額外的檢查，藉此解決此資訊安全風險。
  
**當資訊安全公告發行時，這項資訊安全風險是否已揭發出來？**    
是。 這項資訊安全風險已經遭到公開揭發。 這項資訊安全風險已被指派「一般性資訊安全風險」編號 [CVE-2010-3227](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3227) (英文)。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB2387149$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2387149/zh-tw">Microsoft 知識庫文件編號 2387149</a></td>
</tr>
<tr class="even">
...
-   感謝 [Secunia](https://secunia.com) 的 Carsten H. Eiram 協助我們解決 Windows MFC 文件標題更新緩衝區溢位資訊安全風險 (CVE-2010-3227)。
