...
<td style="border:1px solid black;"><a href="https://https://www.microsoft.com/taiwan/technet/security/bulletin/ms09-029.mspx">MS09-029</a></td>
</tr>
<tr class="even">
...
此更新包含與非安全性相關的功能變更。 如需詳細資料，請參閱 [Microsoft 知識庫文件編號 978909](https://support.microsoft.com/kb/978909/zh-tw)。
...
下列嚴重性等級是假設弱點可能造成的最嚴重影響而評定。 在本資訊安全公告發行的 30 天內，如需弱點易遭利用性與嚴重性等級和安全性影響之間對應關係的資訊，請參閱 [1 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms10-jan)中的＜弱點索引＞。 如需更多資訊，請參閱 [Microsoft 弱點索引](https://technet.microsoft.com/en-us/security/cc998259.aspx)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2010-0018](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0018)。
...
內嵌 OpenType (EOT) 字型是一種用來嵌入文件或網頁的小容量字型。 這些字型可能會嵌入特定文件格式 (例如 Word .doc 檔案)，或整合到 Web 伺服器上使用連結到 .eot 檔案的網頁。 使用 EOT 字型，可確保使用者能夠見到文件作者所欲呈現的原樣。 網頁內嵌字型工具 (WEFT) 讓網頁作者建立連結至網頁的字型物件，當訪客透過瀏覽器檢視網頁時，便會使用該字型物件中的樣式來顯示頁面。 如需詳細資訊，請參閱 MSDN 文章[關於字型內嵌](https://msdn.microsoft.com/en-us/library/ms533034.aspx)。 「受影響軟體」表格列出的所有平台均預設支援呈現 EOT 字型。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/972270/zh-tw">Microsoft 知識庫文件編號 972270</a></td>
</tr>
<tr class="even">
...
-   感謝 [Google Inc.](https://www.google.com/) 的 Tavis Ormandy 回報 LZCOMP Decompressor 弱點中的 Microtype Express 壓縮字型整數缺點 (CVE-2010-0018)
