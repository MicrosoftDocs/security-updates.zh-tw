...
**已知問題。** [Microsoft 知識庫文件編號 982665](http://support.microsoft.com/kb/982665/zh-tw) 中記載目前已知安裝此資訊安全更新後，可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。
...
Windows 7 Service Pack 1 Beta 會受此公告中所述的弱點影響。 建議執行此 Beta 版本的客戶為其系統下載並套用更新。 資訊安全更新可從 [Microsoft Update](http://go.microsoft.com/fwlink/?linkid=40747) 以及 [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) 取得。 資訊安全更新也可從 [Microsoft 下載中心](http://go.microsoft.com/fwlink/?linkid=21129)下載。
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-2553](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2553) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/982665/zh-tw">Microsoft 知識庫文件編號 982665</a></td>
</tr>
<tr class="even">
...
-   感謝匿名研究人員與 [Tipping Point](http://www.tippingpoint.com/) 的 [Zero Day Initiative](http://www.zerodayinitiative.com/) 合作，回報 Cinepak Codec 解壓縮弱點 (CVE-2010-2553)
