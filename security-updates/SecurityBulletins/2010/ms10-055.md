---
TOCTitle: 'MS10-055'
Title: 'Microsoft Security Bulletin MS10-055 - 重大'
ms:assetid: 'ms10-055'
ms:contentKeyID: 61238581
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms10-055(v=Security.10)'
---


Microsoft Security Bulletin MS10-055 - 重大
===========================================

Cinepak Codec 的弱點可能會允許遠端執行程式碼 (982665)
-----------------------------------------------------
...
此資訊安全更新可解決 Cinepak Codec 中一項未公開報告的弱點。 當使用者開啟蓄意製作的媒體檔案，或者從網站或任何提供 Web 內容的應用程式收到蓄意製作的串流內容時，這些弱點可能會允許遠端執行程式碼。 成功利用此弱點的攻擊者可以取得與本機使用者相同的使用者權限。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

對於所有受支援版本的 Windows XP、Windows Vista 及 Windows 7，此資訊安全更新的等級為「重大」。如需詳細資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此資訊安全更新可修正 Cinepak 程式碼解壓縮媒體檔案的方式，以解決此弱點。 如需更多有關弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。
...
**已知問題。** [Microsoft 知識庫文件編號 982665](https://support.microsoft.com/kb/982665/zh-tw) 中記載目前已知安裝此資訊安全更新後，可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5ddb5e34-f97a-47c6-96c8-ba2ed06ccb77">Windows XP Service Pack 3 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=5ddb5e34-f97a-47c6-96c8-ba2ed06ccb77">Windows XP Service Pack 3 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5cff5d6e-11a5-40ed-92ac-e12d287919e6">Windows XP Professional x64 Edition Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=60c81415-b61e-44a4-8dd9-cedec99eb70f">Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=60c81415-b61e-44a4-8dd9-cedec99eb70f">Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=469b732d-ca62-4a48-bb55-99f2ae4ddcf5">Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=469b732d-ca62-4a48-bb55-99f2ae4ddcf5">Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2e782ac9-b5d5-490e-a01a-7d4481eab224">適用於 32 位元系統的 Windows 7 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=2e782ac9-b5d5-490e-a01a-7d4481eab224">適用於 32 位元系統的 Windows 7 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=24751193-592f-4c44-a8d6-f4112d4f011b">適用於 x64 型系統的 Windows 7 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=24751193-592f-4c44-a8d6-f4112d4f011b">適用於 x64 型系統的 Windows 7 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
...
**Windows 7 Service Pack 1 Beta 版是否會受此弱點影響？**    
Windows 7 Service Pack 1 Beta 會受此公告中所述的弱點影響。 建議執行此 Beta 版本的客戶為其系統下載並套用更新。 資訊安全更新可從 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 以及 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 取得。 資訊安全更新也可從 [Microsoft 下載中心](https://go.microsoft.com/fwlink/?linkid=21129)下載。
...
<th style="border:1px solid black;" >Cinepak Codec 解壓縮弱點 - CVE-2010-2553</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
Cinepak Codec 解壓縮弱點 - CVE-2010-2553  
----------------------------------------
  
Cinepak Codec 處理受支援格式檔案的方式中，存在遠端執行程式碼的弱點。 如果使用者開啟蓄意製作的媒體檔案，此弱點可能會允許執行程式碼。 如果使用者以系統管理的使用者權限登入，成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
  
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-2553](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2553) (英文)。
  
#### Cinepak Codec 解壓縮弱點 - CVE-2010-2553 的緩和因素
...
#### Cinepak Codec 解壓縮弱點 - CVE-2010-2553 的因應措施
  
因應措施指的是無法徹底修正弱點，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。 Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：
  
-   **修改 iccvid.dll 的存取控制清單 (ACL)**
  
    將 iccvid.dll 的 ACL 修改為更具限制性。
  
    若為 Windows XP 的 32 位元版本，從請命令提示執行下列命令 (需要系統管理權限)：  

    `cacls %WINDIR%\SYSTEM32\iccvid.DLL /E /P everyone:N`
  
    若為 Windows XP 的 64 位元版本，從請命令提示執行下列命令 (需要系統管理權限)：  

    `cacls %WINDIR%\SYSWOW64\iccvid.DLL /E /P everyone:N `
  
    `若為 32 位元版本的` Windows Vista 和 Windows 7，請透過已提高權限的命令提示字元執行下列命令：  
    ...
    **因應措施的影響。** 用 Cinepak Codec 編碼的媒體檔案無法在多媒體中播放。
...
-   **停用在 DirectShow 中剖析以 Cinepac 編碼的媒體檔案**
    ...
    **使用互動方法**
    ...
    3.  在 \[檔案\] 功能表上，按一下 \[匯出\]。  
    4.  在 \[匯出登錄檔案\] 對話方塊中，輸入 **Drivers32\_Backup.reg**，然後按一下 \[儲存\]。  
        **注意：**依預設，這個動作會在 \[我的文件\] 資料夾中建立這個登錄機碼的備份。  
    5.  找到並選取在 \[名稱\] 處有 **vidc.cvid** 且在 \[資料\] 處有 **iccvid.dll** 之字串值。  
    6.  按下鍵盤上的 **Delete** 鍵來刪除登錄機碼。 當系統透過 \[確認機碼刪除\] 對話方塊提示您刪除登錄機碼時，請按一下 \[是\]。
    ...
    **使用管理的部署指令碼**
    ...
    2.  接著，將以下項目儲存到副檔名為 .REG 的檔案中 (例如 Disable\_Cinepak\_Parser.reg)：  
        **適用於 32 位元的 Windows 系統**：  
    ...
    **因應措施的影響。** 在使用 DirectShow 播放 MPEG Layer-3 內容的應用程式中會停用 MPEG Layer-3 剖析。
    ...
    **如何復原因應措施：**
    ...
    1.  依序按一下 \[開始\]、\[執行\]，在 \[開啟\] 方塊中輸入 **Regedit**，然後按一下 \[確定\]。  
    2.  按一下 \[檔案\] 功能表，再選取 \[匯入\]。  
    3.  在 \[匯入登錄檔案\] 對話方塊中，選取 **Drivers32\_Backup.reg**，然後按一下 \[開啟\]。
...
#### Cinepak Codec 解壓縮弱點 - CVE-2010-2553 的常見問題集
  
**這個弱點的範圍為何？**    
這是遠端執行程式碼的弱點。 成功利用此弱點的攻擊者可以利用提高的權限在易受影響的系統上執行任意程式碼。 攻擊者接下來將能安裝程式，或檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個弱點的原因為何？**    
Microsoft Windows 中所含的 Cinepak Codec 未正確處理蓄意製作的媒體檔案。
  
**什麼是 Cinepak Codec？**    
Cinepak Codec 是 Windows Media Player 所支援的媒體編碼器與解碼器。 此轉碼器允許針對媒體檔案執行 Bitstream 編碼與解碼。 Cinepak 運用了向量、以量化為基礎的影像壓縮和影格差異。
  
**什麼是轉碼器？**    
所謂的轉碼器，就是用來壓縮或解壓縮數位媒體檔案 (如歌曲、影片等) 的軟體。 Windows Media Player 和其他程式均使用轉碼器來播放和建立數位媒體檔案。
  
一個轉碼器可能由兩個元件組成： 一個編碼器和一個解碼器。 編碼器負責執行壓縮 (編碼) 功能，而解碼器則執行解壓縮 (解碼) 功能。 有些轉碼器包括這兩個元件，而有些轉碼器只包括其中之一。
  
舉例來說，當您將音訊 CD 的歌曲傳送到電腦時，Windows Media Player 預設會使用 Windows Media 音訊轉碼器，將歌曲壓縮成精簡的 WMA 檔案。 當您播放該 WMA 檔案 (或可能是從網站中串流的任何 WMA 檔案) 時，Player 會使用 Windows Media 音訊轉碼器來解壓縮檔案，如此就能透過喇叭播放音樂。
...
**更新的作用何在？**    
此更新可修正 Cinepak Codec 解壓縮媒體檔案的方式，以解決此問題。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB982665$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/982665/zh-tw">Microsoft 知識庫文件編號 982665</a></td>
</tr>
<tr class="even">
...
-   感謝匿名研究人員與 [Tipping Point](https://www.tippingpoint.com/) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，回報 Cinepak Codec 解壓縮弱點 (CVE-2010-2553)
