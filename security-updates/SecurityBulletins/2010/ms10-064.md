---
TOCTitle: 'MS10-064'
Title: 'Microsoft Security Bulletin MS10-064 - 重大'
ms:assetid: 'ms10-064'
ms:contentKeyID: 61238590
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms10-064(v=Security.10)'
---


Microsoft Security Bulletin MS10-064 - 重大
===========================================

Microsoft Outlook 中的資訊安全風險可能會允許遠端執行程式碼 (2315011)
--------------------------------------------------------------------
...
這個資訊安全更新能解決一項未公開報告的資訊安全風險。 如果使用者使用以「線上模式」連線到 Exchange 伺服器之受影響版本的 Microsoft Outlook，開啟或預覽蓄意製作的電子郵件訊息，此資訊安全風險可能會允許遠端執行程式碼。 成功利用此資訊安全風險的攻擊者可以取得與本機使用者相同的使用者權限。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

對於所有受支援版本的 Microsoft Outlook 2002，此資訊安全更新的等級為「重大」；對於所有受支援版本的 Microsoft Outlook 2003 與 Microsoft Outlook 2007，此資訊安全更新的等級為「重要」。如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此資訊安全更新可修正 Microsoft Outlook 剖析蓄意製作之電子郵件訊息中內容的方式，藉以解決此資訊安全風險。 如需更多有關資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。

**建議。** Microsoft 建議客戶立即套用此更新。

**已知問題。** [Microsoft 知識庫文件編號 2315011](https://support.microsoft.com/kb/2315011/zh-tw) 中記載目前已知安裝此資訊安全更新後，可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。 目前已知問題和建議解決方案僅適用於此軟體的特定版本，本文會提供詳細文章的連結。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=d5e85841-9dea-4776-9e0e-3cd272066f37">Microsoft Outlook 2002 Service Pack 3 (英文下載更新程式)</a><br />
(KB2293422)  
<a href="https://www.microsoft.com/download/details.aspx?familyid=d5e85841-9dea-4776-9e0e-3cd272066f37&amp;displaylang=zh-tw">Microsoft Outlook 2002 Service Pack 3 (中文下載更新程式)</a><br />
(KB2293422)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/technet/security/bulletin/www.microsoft.com/taiwan/technet/security/bulletin/ms06-012.mspx">MS06-012</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Office 2003 Service Pack 3</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ec8ed81e-05d0-4c20-b5fb-ebc72230a8bd">Microsoft Outlook 2003 Service Pack 3 (英文下載更新程式)</a><br />
(KB2293428)  
<a href="https://www.microsoft.com/download/details.aspx?familyid=ec8ed81e-05d0-4c20-b5fb-ebc72230a8bd&amp;displaylang=zh-tw">Microsoft Outlook 2003 Service Pack 3 (中文下載更新程式)</a><br />
(KB2293428)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=6009d507-135c-4ce8-a830-925134f214dc">Microsoft Outlook 2007 Service Pack 2 (英文下載更新程式)</a><br />
(KB2288953)  
<a href="https://www.microsoft.com/download/details.aspx?familyid=6009d507-135c-4ce8-a830-925134f214dc&amp;displaylang=zh-tw">Microsoft Outlook 2007 Service Pack 2 (中文下載更新程式)</a><br />
(KB2288953)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
...
| Office 及其他軟體                    |  
|--------------------------------------|  
| Microsoft Outlook 2010 (32 位元版本) |  
| Microsoft Outlook 2010 (64 位元版本) |
...
**Outlook Express、Windows Mail 或 Windows Live Mail 是否會受此公告中描述的資訊安全風險影響？**    
否，Outlook Express、Windows Mail 和 Windows Live Mail 不會受此公告所描述的資訊安全風險影響。 這些搭配 Windows 使用的線上通訊工具與 Microsoft Outlook 無關。
  
**為何此資訊安全更新對 Outlook 2002 屬於「重大」等級，但對 Outlook 2003 與 Outlook 2007 屬於「重要」等級？**    
此資訊安全風險會影響以「線上模式」連線到 Exchange 伺服器的 Microsoft Outlook；但依照預設，Microsoft Outlook 2003 與 Microsoft Outlook 2007 會以「快取 Exchange 模式」連線到 Exchange 伺服器。 此緩和因素可針對 Outlook 2003 與 Outlook 2007 將資訊安全風險從「重大」減緩至「重要」，因為這些版本在預設設定中不受影響。 Microsoft Outlook 2002 中沒有「快取 Exchange 模式」。
  
**我連線到數個郵件伺服器。 我的 Outlook 設定是否會受此資訊安全風險影響？**    
只有以「線上模式」連線到 Exchange 伺服器的設定才會受此資訊安全風險影響。 而只使用 POP 或 IMAP 郵件伺服器的 Outlook 設定則不受此資訊安全風險影響。 下表摘要說明這些受影響的設定。
  
**受影響的設定 **
  
|                                       | Exchange 線上模式 | 快取 Exchange 模式 | POP      | IMAP     |  
|---------------------------------------|-------------------|--------------------|----------|----------|  
| Microsoft Outlook 2002 Service Pack 3 | 受影響            | 不適用             | 不受影響 | 不受影響 |  
| Microsoft Outlook 2003 Service Pack 3 | 受影響            | 不受影響           | 不受影響 | 不受影響 |  
| Microsoft Outlook 2007 Service Pack 2 | 受影響            | 不受影響           | 不受影響 | 不受影響 |
  
**我在不受影響的設定中執行 Outlook。 我是否仍會收到此更新？**    
是。 無論設定為何，如果您正在執行受影響版本的 Microsoft Outlook，就會收到此更新。
  
**Microsoft Office 獨立式程式是如何受到此資訊安全風險影響？**    
Microsoft Office 獨立式程式受影響的嚴重性等級同等於 Microsoft Office 套件中相對應元件的嚴重性等級。 例如，Microsoft Outlook 獨立式安裝受影響的嚴重性等級同等於 Microsoft Office 套件隨附之 Microsoft Outlook 安裝的嚴重性等級。
...
<th style="border:1px solid black;" >Outlook 中的堆積式緩衝區溢位資訊安全風險 - CVE-2010-2728</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
Outlook 中的堆積式緩衝區溢位資訊安全風險 - CVE-2010-2728  
--------------------------------------------------------
  
Microsoft Outlook 剖析蓄意製作之電子郵件訊息內容的方式中，存在遠端執行程式碼資訊安全風險。 此資訊安全風險僅存在於以「線上模式」連線到 Exchange 伺服器的 Outlook 中。 以「快取 Exchange 模式」連線到 Exchange 伺服器的 Outlook 設定則不受影響。 此外，只使用 POP 或 IMAP 郵件伺服器的 Outlook 設定則不受此資訊安全風險影響。 成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-2728](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2728) (英文)。
  
#### Outlook 中的堆積式緩衝區溢位資訊安全風險 - CVE-2010-2728 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   成功利用此資訊安全風險的攻擊者可以取得與本機使用者相同的使用者權限。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。  
-   依照預設，Microsoft Outlook 2003 與 Microsoft Outlook 2007 會以「快取 Exchange 模式」連線到 Exchange 伺服器。 當 Outlook 以「快取 Exchange 模式」從 Exchange 伺服器擷取資料時，則不受此資訊安全風險影響。 Microsoft Outlook 2002 中沒有「快取 Exchange 模式」。  
-   當 Microsoft Outlook 用戶端未連線到 Exchange 伺服器，例如僅連線到 POP 或 IMAP 伺服器時，則不受此資訊安全風險影響。
  
#### Outlook 中的堆積式緩衝區溢位資訊安全風險 - CVE-2010-2728 的因應措施
...
-   **以純文字讀取電子郵件**
    ...
    已套用 Microsoft Office XP Service Pack 1 或更新版本的 Microsoft Outlook 2002 使用者，以及已套用 Internet Explorer 6 Service Pack 1 或更新版本的 Microsoft Outlook Express 6 使用者，可以啟用這項設定，只用純文字格式檢視所有未經數位簽章或未經加密的電子郵件訊息。
...
**攻擊者如何利用這項資訊安全風險？**    
若要利用此資訊安全風險，需要使用者使用以「線上模式」連線到 Exchange 伺服器之受影響版本的 Microsoft Outlook，開啟或預覽蓄意製作的電子郵件訊息。
  
若是電子郵件攻擊，攻擊者可能會利用此資訊安全風險，向使用者傳送蓄意製作的電子郵件訊息，然後引誘使用者預覽或開啟電子郵件。
  
**因為這個資訊安全風險而承受風險的主要系統有哪些？**    
以「線上模式」連線到 Exchange 伺服器之 Microsoft Outlook 所在的系統 (例如工作站和終端機伺服器) 風險最高。 若系統管理員允許使用者登入伺服器並執行程式，則伺服器可能遭受更大的風險。 然而，最佳實務強烈建議您制止這種行為。
  
**更新的作用何在？**    
此更新可修正 Microsoft Outlook 剖析蓄意製作之電子郵件訊息中內容的方式，藉以解決此資訊安全風險。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2293422/zh-tw">Microsoft 知識庫文件編號 2293422</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2293428/zh-tw">Microsoft 知識庫文件編號 2293428</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2288953/zh-tw">Microsoft 知識庫文件編號 2288953</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
-   感謝 [Secunia](https://secunia.com/) 的 Dyon Balding 回報 Outlook 中的堆積式緩衝區溢位資訊安全風險 (CVE-2010-2728)
