---
TOCTitle: 'MS10-013'
Title: 'Microsoft Security Bulletin MS10-013 - 重大'
ms:assetid: 'ms10-013'
ms:contentKeyID: 61238539
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms10-013(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS10-013 - 重大
===========================================

Microsoft DirectShow 中的弱點可能會允許遠端執行程式碼 (977935)
--------------------------------------------------------------
...
這個安全性更新可解決 Microsoft DirectShow 中一項未公開報告的弱點。 如果使用者開啟蓄意製作的 AVI 檔案，則此弱點可能會允許遠端執行程式碼。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

對於所有支援的 Itanium 版本 Windows Server 2003、Windows Server 2008 和 Windows Server 2008 R2，此安全性更新的等級為「重要」；對於其餘所有支援版本的 Microsoft Windows，此安全性更新的等級為「重大」。 如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此安全性更新藉由修正 DirectShow 開啟 AVI 檔案的方式，來解決此弱點。 如需更多有關弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。
...
<td style="border:1px solid black;">
[AVI 篩選器 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=ba110440-10ce-40a0-884a-8b9afd45a3e3)  
(KB977914)  
[AVI 篩選器 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=ba110440-10ce-40a0-884a-8b9afd45a3e3)  
(KB977914)
...
<td style="border:1px solid black;">
[Quartz (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=16787c93-2c95-4c13-8492-be1db9d18146)  
(KB975560)  
[DirectX 9.0 的 Quartz (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=59a8bc19-02bb-4800-bac1-464f59e1cb7b)<sup>[1]</sup>
(KB975560)  
[Quartz (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=16787c93-2c95-4c13-8492-be1db9d18146)  
(KB975560)  
[DirectX 9.0 的 Quartz (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=59a8bc19-02bb-4800-bac1-464f59e1cb7b)<sup>[1]</sup>
(KB975560)
...
<td style="border:1px solid black;">
[AVI 篩選器 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=a9beb2bd-e5f6-43f9-bbcc-a2afee5e5ceb)  
(KB977914)  
[AVI 篩選器 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=a9beb2bd-e5f6-43f9-bbcc-a2afee5e5ceb)  
(KB977914)
...
<td style="border:1px solid black;">
[Quartz (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=7ab53be3-3f42-4e61-a2bc-3ed41d8736ff)  
(KB975560)  
[Quartz (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=7ab53be3-3f42-4e61-a2bc-3ed41d8736ff)  
(KB975560)
...
<td style="border:1px solid black;">
[AVI 篩選器 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=dedc3010-a989-45f7-b9d4-f7079db3e572)  
(KB977914)
</td>
<td style="border:1px solid black;">
遠端執行程式碼
...
<td style="border:1px solid black;">
[Quartz (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=7543e819-cd36-4e89-9850-60f00c50999d)  
(KB975560)
</td>
<td style="border:1px solid black;">
遠端執行程式碼
...
<td style="border:1px solid black;">
[AVI 篩選器 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=cc5150d7-070e-4a87-9c02-d050a8cb2204)  
(KB977914)  
[AVI 篩選器 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=cc5150d7-070e-4a87-9c02-d050a8cb2204)  
(KB977914)
...
<td style="border:1px solid black;">
[Quartz (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=983c5484-6321-4765-97ec-8d42d42d1f70)  
(KB975560)  
[Quartz (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=983c5484-6321-4765-97ec-8d42d42d1f70)  
(KB975560)
...
<td style="border:1px solid black;">
[AVI 篩選器 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=db13e99b-2f2a-4474-8d6e-271b025bd07f)  
(KB977914)  
[AVI 篩選器 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=db13e99b-2f2a-4474-8d6e-271b025bd07f)  
(KB977914)
...
<td style="border:1px solid black;">
[Quartz (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=7dc20252-6091-407b-befc-c25e8f5d3fb0)  
(KB975560)  
[Quartz (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=7dc20252-6091-407b-befc-c25e8f5d3fb0)  
(KB975560)
...
<td style="border:1px solid black;">
[AVI 篩選器 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=aec66173-e2c6-4c39-8d60-8fbef6d7b764)  
(KB977914)
</td>
<td style="border:1px solid black;">
遠端執行程式碼
...
<td style="border:1px solid black;">
[Quartz (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=b1a7533a-913f-4054-b579-489a257bae5f)  
(KB975560)
</td>
<td style="border:1px solid black;">
遠端執行程式碼
...
<td style="border:1px solid black;">
[Quartz (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=7130ce0f-df38-4c96-ac54-cdbff35f03e7)  
(KB975560)  
[Quartz (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=7130ce0f-df38-4c96-ac54-cdbff35f03e7)  
(KB975560)
...
<td style="border:1px solid black;">
[Quartz (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=de7b7c8f-bd0a-4e13-bd58-d95507a6274b)  
(KB975560)  
[Quartz (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=de7b7c8f-bd0a-4e13-bd58-d95507a6274b)  
(KB975560)
...
<td style="border:1px solid black;">
[Quartz (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=5ac0a948-0bdc-4c10-9b88-16a5d7092e47)\*\*  
(KB975560)  
[Quartz (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=5ac0a948-0bdc-4c10-9b88-16a5d7092e47)\*\*  
(KB975560)
...
<td style="border:1px solid black;">
[Quartz (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=362fea40-649b-4471-aad7-db29edd0ac10)\*\*  
(KB975560)  
[Quartz (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=362fea40-649b-4471-aad7-db29edd0ac10)\*\*  
(KB975560)
...
<td style="border:1px solid black;">
[Quartz (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=effa638b-cfc1-4777-8219-7b433ed5e717)  
(KB975560)
</td>
<td style="border:1px solid black;">
遠端執行程式碼
...
<td style="border:1px solid black;">
[Quartz (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=4ec49aa2-81df-4e65-80da-6201394c4089)  
(KB975560)  
[Quartz (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=4ec49aa2-81df-4e65-80da-6201394c4089)  
(KB975560)
...
<td style="border:1px solid black;">
[Quartz (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=a8a2519c-3b89-4987-9473-920adafc78cb)  
(KB975560)  
[Quartz (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=a8a2519c-3b89-4987-9473-920adafc78cb)  
(KB975560)
...
<td style="border:1px solid black;">
[Quartz (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=a9811baa-1500-4c73-940b-57f8c5456891)\*\*  
(KB975560)  
[Quartz (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=a9811baa-1500-4c73-940b-57f8c5456891)\*\*  
(KB975560)
...
<td style="border:1px solid black;">
[Quartz (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=2ed23bf5-6217-413c-a7ba-eccc82139d68)  
(KB975560)
</td>
<td style="border:1px solid black;">
遠端執行程式碼
...
**為什麼在一些情況下，兩個更新適用於相同的受影響作業系統？**  
此公告解決二個不同元件所出現的弱點。 有兩個含不同 KB 編號的可用更新套件，每一個受影響的元件適用一個套件。 KB977914 可解決 AVI 篩選器中的弱點。 KB975560 可解決 DirectX 中的弱點。 在同時出現這兩個元件的受影響作業系統上，需要安裝這兩個更新。

在支援版本的 Microsoft Windows 2000、Windows XP 和 Windows Server 2003 上，客戶需要套用其環境適用的這兩個更新套件 KB977914 和 KB975560。 在其他受影響的作業系統上，客戶只需要套用安全性更新套件 KB975560。
...
<th style="border:1px solid black;" >
DirectShow 堆積溢位弱點 - CVE-2010-0250
</th>
<th style="border:1px solid black;" >
彙總嚴重性等級
</th>
...
<tr>
<td style="border:1px solid black;">
Microsoft Windows 2000 Service Pack 4 上的 AVI 篩選器
</td>
<td style="border:1px solid black;">
**重大**  
遠端執行程式碼
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows XP Service Pack 2 和 Windows XP Service Pack 3 上的 AVI 篩選器
</td>
<td style="border:1px solid black;">
**重大**  
遠端執行程式碼
...
<tr>
<td style="border:1px solid black;">
Windows XP Professional x64 Edition Service Pack 2 上的 AVI 篩選器
</td>
<td style="border:1px solid black;">
**重大**  
遠端執行程式碼
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2003 Service Pack 2 上的 AVI 篩選器
</td>
<td style="border:1px solid black;">
**重大**  
遠端執行程式碼
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 x64 Edition Service Pack 2 上的 AVI 篩選器
</td>
<td style="border:1px solid black;">
**重大**  
遠端執行程式碼
...
<tr class="alternateRow">
<td style="border:1px solid black;">
適用於 Itanium 型系統的 Windows Server 2003 SP2 上的 AVI 篩選器
</td>
<td style="border:1px solid black;">
**重要**  
遠端執行程式碼
...
<tr class="alternateRow">
<td style="border:1px solid black;">
適用於 Itanium 型系統的 Windows Server 2003 SP2 上的 Quartz
</td>
<td style="border:1px solid black;">
**重要**  
遠端執行程式碼
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Vista x64 Edition、Windows Vista x64 Edition Service Pack 1 及 Windows Vista x64 Edition Service Pack 2 上的 Quartz
</td>
<td style="border:1px solid black;">
**重大**  
遠端執行程式碼
...
<tr>
<td style="border:1px solid black;">
適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2 上的 Quartz\*\*
</td>
<td style="border:1px solid black;">
**重大**  
遠端執行程式碼
...
<tr class="alternateRow">
<td style="border:1px solid black;">
適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2 上的 Quartz\*\*
</td>
<td style="border:1px solid black;">
**重大**  
遠端執行程式碼
...
<tr>
<td style="border:1px solid black;">
適用於 Itanium 系統的 Windows Server 2008 和適用於 Itanium 系統的 Windows Server 2008 Service Pack 2 上的 Quartz
</td>
<td style="border:1px solid black;">
**重要**  
遠端執行程式碼
...
<tr class="alternateRow">
<td style="border:1px solid black;">
適用於 32 位元系統的 Windows 7 上的 Quartz
</td>
<td style="border:1px solid black;">
**重大**  
遠端執行程式碼
...
<tr>
<td style="border:1px solid black;">
適用於 x64 型系統的 Windows 7 上的 Quartz
</td>
<td style="border:1px solid black;">
**重大**  
遠端執行程式碼
...
<tr class="alternateRow">
<td style="border:1px solid black;">
適用於 x64 型系統的 Windows Server 2008 R2 上的 Quartz
</td>
<td style="border:1px solid black;">
**重大**  
遠端執行程式碼
...
<tr>
<td style="border:1px solid black;">
適用於 Itanium 型系統的 Windows Server 2008 R2 上的 Quartz
</td>
<td style="border:1px solid black;">
**重要**  
遠端執行程式碼
...
Microsoft DirectShow 剖析 AVI 媒體檔案的方式中，存在遠端執行程式碼的弱點。 如果使用者開啟蓄意製作的 AVI 檔案，則此弱點可能會允許遠端執行程式碼。 如果使用者以系統管理的使用者權限登入，成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2010-0250](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0250)。

#### DirectShow 堆積溢位弱點 - CVE-2010-0250 的緩和因素
...
#### DirectShow 堆積溢位弱點 - CVE-2010-0250 的因應措施

Microsoft 尚未找到此項弱點的任何因應措施。

#### DirectShow 堆積溢位弱點 - CVE-2010-0250 的常見問題集

**這個弱點的範圍為何？**  
這是遠端執行程式碼的弱點。 成功利用此弱點的攻擊者可以從遠端取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。

**造成這個弱點的原因為何？**  
Microsoft DirectShow 元件未正確處理蓄意製作的 AVI 檔案。
...
**更新的作用何在？**  
此更新藉由修正 DirectShow 開啟 AVI 檔案的方式，來解決此弱點。
...
|-----------------------------------------------------------------------------------------------------------------|---------|-----------------------|-----------------------|----------------------------|
| Microsoft Windows 2000 Service Pack 4 (AVI 篩選器)                                                              | 是      | 是                    | 是                    | 是                         |
| Microsoft Windows 2000 Service Pack 4 (Quartz)                                                                  | 否      | 否                    | 是                    | 是                         |
| Windows XP Service Pack 2 和 Windows XP Service Pack 3 (AVI 篩選器)                                             | 是      | 是                    | 是                    | 是                         |
...
| Windows Server 2003 Service Pack 2 (AVI 篩選器)                                                                 | 是      | 是                    | 是                    | 是                         |
...
<td style="border:1px solid black;">針對 Microsoft Windows 2000 上的 AVI 篩選器：<br />
Windows2000-KB977914-x86-ENU /quiet<br />
<br />
此外，對於下列其中一種組合的 Quartz：<br />
<br />
- Microsoft Windows 2000：<br />
Windows2000-KB975560-x86-ENU /quiet<br />
<br />
- 含 DirectX 9.0 的 Microsoft Windows 2000：<br />
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB977914$\Spuninst 資料夾與 %Windir%\$NTUninstallKB975560$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/977914/zh-tw">Microsoft 知識庫文件編號 977914</a> 與 <a href="https://support.microsoft.com/kb/975560/zh-tw">Microsoft 知識庫文件編號 975560</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">在沒有使用者介入的情況下安裝</td>
<td style="border:1px solid black;">對於 Windows XP Service Pack 2 和 Windows XP Service Pack 3，下列二者皆適用：<br />
- 針對 AVI 篩選器：<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">對於 Windows XP Professional x64 Edition Service Pack 2，下列二者皆適用：<br />
- 針對 AVI 篩選器：<br />
...
<tr class="odd">
<td style="border:1px solid black;">在沒有使用者介入的情況下安裝</td>
<td style="border:1px solid black;">對於所有支援 32 位元版本的 Windows Server 2003，下列二者皆適用：<br />
- 針對 AVI 篩選器：<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">對於所有支援 x64 型版本的 Windows Server 2003，下列二者皆適用：<br />
- 針對 AVI 篩選器：<br />
WindowsServer2003.WindowsXP-KB977914-x64-ENU /quiet<br />
- 針對 Quartz：<br />
WindowsServer2003.WindowsXP-KB975560-x64-ENU /quiet</td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">對於所有支援 Itanium 型版本的 Windows Server 2003，下列二者皆適用：<br />
- 針對 AVI 篩選器：<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/975560/zh-tw">Microsoft 知識庫文件編號 975560</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
...
-   感謝 [TippingPoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 回報 DirectShow 堆積溢位弱點 (CVE-2010-0250)
