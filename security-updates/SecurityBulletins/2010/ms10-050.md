...
**已知問題。** [Microsoft 知識庫文件編號 981997](http://support.microsoft.com/kb/981997/zh-tw) 中記載目前已知安裝此資訊安全更新後，可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-2564](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2564) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/981997/zh-tw">Microsoft 知識庫文件編號 981997</a></td>
</tr>
<tr class="even">
...
-   感謝 [Secunia](http://secunia.com/) 的 Dyon Balding 回報 Movie Maker 記憶體損毀弱點 (CVE-2010-2564)
