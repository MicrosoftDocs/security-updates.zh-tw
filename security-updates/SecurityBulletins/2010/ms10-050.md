---
TOCTitle: 'MS10-050'
Title: 'Microsoft Security Bulletin MS10-050 - 重要'
ms:assetid: 'ms10-050'
ms:contentKeyID: 61238576
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms10-050(v=Security.10)'
---
...
**已知問題。** [Microsoft 知識庫文件編號 981997](https://support.microsoft.com/kb/981997/zh-tw) 中記載目前已知安裝此資訊安全更新後，可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b211664b-434d-4626-816f-c77510cfd44d">Movie Maker 2.1 (英文下載更新程式)</a>[1]
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=b211664b-434d-4626-816f-c77510cfd44d">Movie Maker 2.1 (中文下載更新程式)</a>[1]</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=decb1fe6-adc8-44f7-89c5-f25767f0cefe">Movie Maker 2.1 (英文下載更新程式)</a>[1]</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-016">MS10-016</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8aded9dd-08d6-4b19-955f-0d8414868cf9">Movie Maker 6.0 (英文下載更新程式)</a>[1]<br />
<br />
<a href="https://www.microsoft.com/download/details.aspx?familyid=a1d8ed0d-a3b5-416a-ab8b-77501da62132">Movie Maker 2.6 (英文下載更新程式)</a>[2]  
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=8aded9dd-08d6-4b19-955f-0d8414868cf9">Movie Maker 6.0 (中文下載更新程式)</a>[1]<br />
<br />
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=a1d8ed0d-a3b5-416a-ab8b-77501da62132">Movie Maker 2.6 (中文下載更新程式)</a>[2]</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-016">MS10-016</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4baff9ae-dd25-4942-b45e-f281d0e1f4ac">Movie Maker 6.0 (英文下載更新程式)</a>[1]<br />
<br />
<a href="https://www.microsoft.com/download/details.aspx?familyid=0a226592-8f98-4f67-ac60-1d00cbc56598">Movie Maker 2.6 (英文下載更新程式)</a>[2]  
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=4baff9ae-dd25-4942-b45e-f281d0e1f4ac">Movie Maker 6.0 (中文下載更新程式)</a>[1]<br />
<br />
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=0a226592-8f98-4f67-ac60-1d00cbc56598">Movie Maker 2.6 (中文下載更新程式)</a>[2]</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-016">MS10-016</a></td>
</tr>
...
在 Windows 7 上執行 Windows Movie Maker 未受支援的設定之使用者，強烈建議解除安裝 Windows Movie Maker。 無法解除安裝 Windows Movie Maker 的使用者，可以套用本資訊安全公告中說明的因應措施，協助降低此弱點的風險。
  
至於 Windows 7 使用者，Microsoft 建議使用 Windows Live Movie Maker。 Windows Live Movie Maker 可從 [Microsoft 下載中心](https://www.microsoft.com/download/details.aspx?familyid=741ce3ed-baa2-4610-9f7d-42ab694e2b15&amp;displaylang=uk&displaylang=en)下載，不受在本公告中說明的弱點影響。
...
<th style="border:1px solid black;" >Movie Maker 記憶體損毀弱點 - CVE-2010-2564</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
在 Windows Movie Maker 處理蓄意製作的專案檔案的方式中，存在遠端執行程式碼弱點。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-2564](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2564) (英文)。
  
#### Movie Maker 記憶體損毀弱點 - CVE-2010-2564 的緩和因素
...
#### Movie Maker 記憶體損毀弱點 - CVE-2010-2564 的因應措施
...
#### Movie Maker 記憶體損毀弱點 - CVE-2010-2564 的常見問題集
  
**這個弱點的範圍為何？**    
這是遠端執行程式碼的弱點。 成功利用此弱點的攻擊者可以從遠端取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，或檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個弱點的原因為何？**    
在 Windows Movie Maker 剖析專案檔案格式的方式中，存在此弱點。 此弱點需要惡意使用者傳送蓄意製作的 Movie Maker 檔案，並引誘使用者開啟蓄意製作的檔案。
  
**什麼是 Windows Movie Maker？**    
Windows Movie Maker 是一個應用程式，可讓使用者在家庭影片中建立、編輯和新增特效。 Windows Movie Maker 內含於 Windows XP 和 Windows Vista 版本。
...
**攻擊者如何利用這項弱點？**    
若要利用此弱點，需要使用者使用受影響的 Windows Movie Maker 版本，開啟蓄意製作的 Movie Maker 專案檔案。
  
若是電子郵件攻擊，攻擊者可能會利用這項弱點，向使用者傳送蓄意製作的 Movie Maker 專案檔案，然後引誘使用者開啟該檔案。
  
在網頁攻擊的案例中，攻擊者必須架設網站，並在其中包含蓄意製作的 Movie Maker 專案檔案，以嘗試利用此弱點。 此外，受侵害的網站以及接受或存放使用者提供之內容的網站裡，也可能包含蓄意製作以利用本弱點的內容。 攻擊者並不能強迫使用者造訪蓄意製作的網站， 而是會引誘使用者造訪網站。一般的做法是設法讓使用者按一下連往攻擊者網站的連結，然後引誘使用者開啟蓄意製作的 Movie Maker 專案檔案。
  
**因為這個弱點而承受風險的主要系統有哪些？**    
使用 Windows Movie Maker 的 Windows 系統風險最高。
  
**更新的作用何在？**    
此更新可變更 Windows Movie Maker 剖析 Movie Maker 專案檔案的方式，以解決此弱點。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB981997$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/981997/zh-tw">Microsoft 知識庫文件編號 981997</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於所有受支援 32 位元和 x64 型版本的 Windows Vista 上所安裝的 Movie Maker 2.6：
...
-   感謝 [Secunia](https://secunia.com/) 的 Dyon Balding 回報 Movie Maker 記憶體損毀弱點 (CVE-2010-2564)
