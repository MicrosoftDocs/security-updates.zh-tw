...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-0484](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0484) (英文)。
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-0485](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0485) (英文)。
...
**當資訊安全公告發行時，這項弱點是否已被揭發出來？**    
是。 這項弱點已經遭到公開揭發。 這項弱點已被指派「一般性弱點」編號 [CVE-2010-0485](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0485)。
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-1255](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1255) (英文)。
...
TrueType 字型檔案包括 TrueType 模擬轉譯器及作業系統軟體所使用的多種不同資訊，以確保電腦螢幕上顯示的字元或列印出來的字元完全符合字型設計者的預期。 如需詳細資訊，請參閱 MSDN 文章[關於字型內嵌](http://msdn.microsoft.com/en-us/library/ms533034.aspx)。 「受影響軟體」表格列出的所有作業系統均預設支援呈現 EOT 字型。
...
**當資訊安全公告發行時，這項弱點是否已被揭發出來？**    
是。 這項弱點已經遭到公開揭發。 這項弱點已被指派「一般性弱點」編號 [CVE-2010-1255](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1255)。
...
| **檔案資訊**                           | 請參閱 [Microsoft 知識庫文件編號 979559](http://support.microsoft.com/kb/979559/zh-tw)                                        |  
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/979559/zh-tw">Microsoft 知識庫文件編號 979559</a></td>
</tr>
<tr class="even">
...
-   感謝 [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Sebastien Renaud 回報 Win32k 資料驗證不當弱點 (CVE-2010-0484)  
-   感謝 [Secunia Research](http://secunia.com/) 協助我們解決 Win32k TrueType 字型剖析弱點 (CVE-2010-1255)
