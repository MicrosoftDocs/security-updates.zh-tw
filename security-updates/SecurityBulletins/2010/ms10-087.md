...
**已知問題。** [Microsoft 知識庫文件編號 2423930](http://support.microsoft.com/kb/2423930/zh-tw) 中記載目前已知安裝此資訊安全更新後，可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。 目前已知問題和建議解決方案僅適用於此軟體的特定版本，本文會提供詳細文章的連結。
...
Microsoft 修訂此公告的目的是新增 [CVE-2010-2573](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2573) 至此更新解決的資訊安全風險。 對於 Microsoft PowerPoint 2002 和 Microsoft PowerPoint 2003，此公告 (MS10-087) 提供的 Microsoft Office 更新也將一併解決 CVE-2010-2573。 這只是資訊的變更。 已經成功套用 MS10-087 和 MS10-088 更新的客戶不必採取任何行動。

**MS10-088 與此公告 (MS10-087) 有何關聯？**  
[CVE-2010-2573](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2573) 在此公告 (MS10-087) 和 [MS10-088](http://technet.microsoft.com/security/bulletin/ms10-088) (Microsoft PowerPoint 中的資訊安全風險可能會允許遠端執行程式碼 (2293386)) 中都獲得解決。 對於 Microsoft PowerPoint 2002 和 Microsoft PowerPoint 2003，此更新 (MS10-087) 能該解決資訊安全風險。 MS10-088 可解決所有受 CVE-2010-2573 影響的其他軟體，包括 PowerPoint Viewer。
...
-   **使用 Microsoft Office 檔案封鎖原則來封鎖開啟來自於未知或不信任來源與位置的 Office 2003 和先前文件**
    ...
    **因應措施的影響。** 對於 Microsoft Office 2003 和 Microsoft Office 2007，使用者若已設定檔案封鎖原則、但尚未設定 [Microsoft 知識庫文件編號 922848](http://support.microsoft.com/kb/922848) 中所討論的特殊「豁免目錄」，將無法開啟 Office 2003 檔案或先前版本的檔案。 對於 Microsoft Office 2007，Office 2003 或先前版本會被封鎖而無法開啟，或者可以在保護模式中開啟；至於是前述哪一種情況，則視選取的開啟行為而定。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3333](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3333) (英文)。
...
-   **使用 Microsoft Office 檔案封鎖原則，來封鎖開啟來自於未知或不信任來源與位置的 RTF 文件**
    ...
    **因應措施的影響。** 使用者若已設定檔案封鎖原則，但尚未按照 [Microsoft 知識庫文件編號 922848](http://support.microsoft.com/kb/922848/zh-tw) 的說明來設定特殊豁免目錄或把檔案移到信任的位置，將無法在 Office 2003 或 2007 Microsoft Office System 中開啟 RTF 檔案。 Microsoft Office 2010 則會根據選取的開啟行為，封鎖 RTF 檔案的開啟，或在保護模式中開啟 RTF 檔案。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3334](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3334) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3335](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3335) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3336](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3336) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3337](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3337) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2289169/zh-tw">Microsoft 知識庫文件編號 2289169</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2289187/zh-tw">Microsoft 知識庫文件編號 2289187</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2289158/zh-tw">Microsoft 知識庫文件編號 2289158</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">針對 Microsoft Office 2010，請參閱 <a href="http://support.microsoft.com/kb/2289161/zh-tw">Microsoft 知識庫文件編號 2289161</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
-   感謝 [team509](http://www.team509.com/) 與 [VeriSign iDefense Labs](http://labs.idefense.com/) 合作回報 RTF 堆疊緩衝區溢位資訊安全風險 (CVE-2010-3333)  
-   感謝 [Secunia](http://secunia.com/) 的 Dyon Balding 回報 Office Art 繪圖記錄資訊安全風險 (CVE-2010-3334)  
-   感謝 [CERT 協調中心](http://www.cert.org)的 Will Dorman 回報 Office Art 繪圖記錄資訊安全風險 (CVE-2010-3334)  
-   感謝 [TippingPoint](http://www.tippingpoint.com/) 的 [Zero Day Initiative](http://www.zerodayinitiative.com/) 回報繪圖例外狀況處理資訊安全風險 (CVE-2010-3335)  
-   感謝 [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Chaouki Bekrarfor 回報 MSO 大型 SPID 讀取 AV 資訊安全風險 (CVE-2010-3336)  
-   感謝 [Fortinet’s FortiGuard Labs](http://www.fortiguard.com/) 的 Haifei Li 回報不安全程式庫載入資訊安全風險 (CVE-2010-3337)  
-   感謝 [ACROS Security](http://www.acrossecurity.com) 的 Simon Raner 回報不安全程式庫載入資訊安全風險 (CVE-2010-3337)
