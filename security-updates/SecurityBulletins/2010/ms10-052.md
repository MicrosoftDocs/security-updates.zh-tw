---
TOCTitle: 'MS10-052'
Title: 'Microsoft Security Bulletin MS10-052 - 重大'
ms:assetid: 'ms10-052'
ms:contentKeyID: 61238578
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms10-052(v=Security.10)'
---


Microsoft Security Bulletin MS10-052 - 重大
===========================================

Microsoft MPEG Layer-3 轉碼器的弱點可能會允許遠端執行程式碼 (2115168)
---------------------------------------------------------------------
...
此資訊安全更新能解決 Microsoft MPEG Layer-3 音訊轉碼器中一項未公開報告的弱點。 當使用者開啟蓄意製作的媒體檔案，或者從網站或任何提供 Web 內容的應用程式收到蓄意製作的串流內容時，這些弱點可能會允許遠端執行程式碼。 成功利用此弱點的攻擊者可以取得與本機使用者相同的使用者權限。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

對於所有受支援版本的 Windows XP 及 Windows Server 2003 (受支援的 Itanium 型版本除外)，此資訊安全更新的等級為「重大」。 如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此資訊安全更新可修正 Microsoft MPEG Layer-3 音訊轉碼器處理蓄意製作之媒體檔案中的 MPEG Layer-3 音訊串流的方式，進而解決此項弱點。 如需更多有關弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=08159149-17de-4640-8818-cb7bd4811531">Windows XP Service Pack 3 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=08159149-17de-4640-8818-cb7bd4811531">Windows XP Service Pack 3 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b7f28d7a-6b27-4059-865b-5fd55edb6299">Windows XP Professional x64 Edition Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9c2110ec-7e6c-4e73-9785-0a8196095ea0">Windows Server 2003 Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=9c2110ec-7e6c-4e73-9785-0a8196095ea0">Windows Server 2003 Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=fdfad4ca-37c4-4ac5-bebc-a5ad61299503">Windows Server 2003 x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=fdfad4ca-37c4-4ac5-bebc-a5ad61299503">Windows Server 2003 x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<th style="border:1px solid black;" >MPEG Layer-3 音訊解碼器緩衝區溢位弱點 - CVE-2010-1882</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
MPEG Layer-3 音訊解碼器緩衝區溢位弱點 - CVE-2010-1882  
-----------------------------------------------------
  
Microsoft DirectShow MP3 篩選器處理受支援格式檔案的方式中，存在遠端執行程式碼的弱點。 如果使用者開啟蓄意製作的音訊檔案，此弱點可能會允許執行程式碼。 如果使用者以系統管理的使用者權限登入，成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
  
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-1882](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1882) (英文)。
  
#### MPEG Layer-3 音訊解碼器緩衝區溢位弱點 CVE-2010-1882 的緩和因素
...
#### MPEG Layer-3 音訊解碼器緩衝區溢位弱點 CVE-2010-1882 的因應措施
  
因應措施指的是無法徹底修正弱點，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。 Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：
  
-   **Unregister l3codecx.ax**
  
    在 Windows XP 和 Windows Server 2003 系統上，請從命令提示字元執行下列命令：
...
-   **在 DirectShow 中停用 MPEG Layer-3 剖析**
  
    移除以下指定的登錄機碼可在使用 DirectShow 播放 MPEG Layer-3 內容的應用程式中防止 MPEG Layer-3 剖析。
    ...
    **使用互動方法**
    ...
    3.  在 \[檔案\] 功能表上，按一下 \[匯出\]。  
    4.  在 \[匯出登錄檔案\] 對話方塊中，輸入 **MP3\_Parser\_Backup.reg**，然後按一下 \[儲存\]。  
    ...
    3.  在 \[檔案\] 功能表上，按一下 \[匯出\]。  
    4.  在 \[匯出登錄檔案\] 對話方塊中，輸入 **MP3\_Parser\_Backup1.reg**，然後按一下 \[儲存\]。  
        **注意：**依預設，這個動作會在 \[我的文件\] 資料夾中建立這個登錄機碼的備份。  
    5.  按下鍵盤上的 **Delete** 鍵來刪除登錄機碼。 當系統透過 \[確認機碼刪除\] 對話方塊提示您刪除登錄機碼時，請按一下 \[是\]。  
    6.  依序按一下 \[開始\]、\[執行\]，在 \[開啟\] 方塊中輸入 **Regedit**，然後按一下 \[確定\]。  
    7.  找出下列子機碼：  
        HKEY\_CLASSES\_ROOT\\Wow6432Node\\CLSID\\{38BE3000-DBF4-11D0-860E-00A024CFEF6D}  
    8.  在 \[檔案\] 功能表上，按一下 \[匯出\]。  
    9.  在 \[匯出登錄檔案\] 對話方塊中，輸入 **MP3\_Parser\_Backup 2.reg**，然後按一下 \[儲存\]。  
        **注意：**依預設，這個動作會在 \[我的文件\] 資料夾中建立這個登錄機碼的備份。  
    ...
    **使用管理的部署指令碼**
    ...
    2.  接著，將以下項目儲存到副檔名為 .REG 的檔案中 (例如 Disable\_MP3\_Parser.reg)：  
        **適用於 32 位元的 Windows 系統**：  
    ...
    **使用互動方法**
    ...
    1.  依序按一下 \[開始\]、\[執行\]，在 \[開啟\] 方塊中輸入 **Regedit**，然後按一下 \[確定\]。  
    2.  按一下 \[檔案\] 功能表，再選取 \[匯入\]。  
    3.  在 \[匯入登錄檔案\] 對話方塊中，選取 **MP3\_Parser\_Backup.reg**，然後按一下 \[開啟\]。
  
    適用 64 位元的 Windows 系統：
  
    1.  依序按一下 \[開始\]、\[執行\]，在 \[開啟\] 方塊中輸入 **Regedit**，然後按一下 \[確定\]。  
    2.  按一下 \[檔案\] 功能表，再選取 \[匯入\]。  
    3.  在 \[匯入登錄檔案\] 對話方塊中，選取 **MP3\_Parser\_Backup1.reg**，然後按一下 \[開啟\]。  
    4.  在 \[匯入登錄檔案\] 對話方塊中，選取 **MP3\_Parser\_Backup2.reg**，然後按一下 \[開啟\]。
...
#### MPEG Layer-3 音訊解碼器緩衝區溢位弱點 - CVE-2010-1882 的常見問題集
  
**這個弱點的範圍為何？**    
這是遠端執行程式碼的弱點。 成功利用此弱點的攻擊者可以從遠端取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個弱點的原因為何？**    
Microsoft MPEG Layer-3 音訊轉碼器未正確處理包含 MPEG Layer-3 音訊串流之蓄意製作的媒體檔案。
  
**哪些 Microsoft MPEG Layer-3 音訊轉碼器易受影響？**    
易受影響的 MPEG Layer-3 音訊轉碼器為 MPEG Layer-3 Audio Codec for Microsoft DirectShow (l3codecx.ax)。 此 MPEG Layer-3 音訊轉碼器是以 Windows Media 及 Windows 作業系統的一部分提供。
...
若是電子郵件攻擊，攻擊者可能會透過以下方式來利用這項弱點：傳送內嵌蓄意製作媒體檔案的媒體檔案給使用者，然後引誘使用者開啟該檔案。
  
**因為這個弱點而承受風險的主要系統有哪些？**    
工作站和終端伺服器的風險最高。 如果不應擁有系統管理權限的使用者被授予登入伺服器並執行程式的能力時，伺服器會面臨更大的風險。 然而，最佳實務強烈建議您制止這種行為。
  
**更新的作用何在？**    
此更新可修正 Microsoft MPEG Layer-3 音訊轉碼器處理蓄意製作之媒體檔案中的 MPEG Layer-3 音訊串流的方式，進而解決此問題。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB2115168$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2115168/zh-tw">Microsoft 知識庫文件編號 2115168</a></td>
</tr>
<tr class="even">
...
-   感謝 n.runs AG 的 Moritz Jodeit 與 [TippingPoint 的](https://www.tippingpoint.com/)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，回報 MPEG Layer-3 音訊解碼器緩衝區溢位弱點 (CVE-2010-1882)
