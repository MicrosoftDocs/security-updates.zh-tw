...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3965](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3965) (英文)。
...
PRX 檔案包含視訊的編碼設定。 您可以將編碼設定 (例如位元速率和視訊大小)，套用至 Microsoft Expression Encoder 或 Microsoft Windows Encoder 中的視訊，然後將該設定儲存至您的硬碟，以建立 PRX 檔案。 如果您已在 Windows Encoder 中建立和儲存特定設定，也可以將該設定用於 Expression Encoder 中，這樣您就不用將 Windows Encoder 中的複雜且特定編碼設定再重做一次。 如需 PRX 檔案的詳細資訊，請參閱 MSDN 文章：[支援 PRX 檔案](https://msdn.microsoft.com/en-us/library/cc294539.aspx)。
...
是。 這項資訊安全風險已經遭到公開揭發。 這項資訊安全風險已被指派「一般性資訊安全風險」編號 [CVE-2010-3965](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3965) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2447961/zh-tw">Microsoft 知識庫文件編號 2447961</a></td>
</tr>
<tr class="even">
