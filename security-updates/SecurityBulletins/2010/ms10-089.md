...
**已知問題。** [Microsoft 知識庫文件編號 2316074](http://support.microsoft.com/kb/2316074/zh-tw) 中記載目前已知安裝此資訊安全更新後，可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=5f2ee08e-e289-47db-bd3f-7b9cfc1eb985">Forefront Unified Access Gateway 2010 (英文下載更新程式)</a>[1]<br />
(KB2433585)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=db0b70c8-1fa5-4d92-9888-3500c7566b19">Forefront Unified Access Gateway 2010 Update 1 (英文下載更新程式)</a>[1]<br />
(KB2433584)</td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=4e3ee07a-771c-46ee-959f-82389bab67d7">Forefront Unified Access Gateway 2010 Update 2 (英文下載更新程式)</a>[1]<br />
(KB2418933)</td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
...
Microsoft 將這些更新發行至 [Microsoft 下載中心](http://go.microsoft.com/fwlink/?linkid=21129)，以利客戶盡快開始更新其系統。 一旦測試完成，確定可順利透過本公司的其他標準發佈方法來提供這些更新，我們也將經由這些管道發佈更新。
  
**何處可找到檔案資訊詳細資料？**    
關於檔案資訊詳細資料的位置，請見＜資訊安全更新部署＞一節中的參考表。
  
**Intelligent Application Gateway (IAG) 是否受到本公告所描述的資訊安全風險影響？**    
是。 Microsoft Intelligent Application Gateway 2007 Service Pack 2 會受到 UAG 重新導向偽造資訊安全風險 (CVE-2010-2732) 和 UAG XSS 影響允許 EOP 資訊安全風險 (CVE-2010-2733) 影響。 如需更多資訊，IAG 客戶應該連絡其 OEM。 美國和加拿大地區的客戶也可以電洽 1-800-936-3100 連絡客戶服務與支援部門，以取得技術支援。國際客戶也可以電洽 1-425-454-7946 連絡服務與現場安全支援團隊，以取得技術支援。與資訊安全更新有關的支援電話，Microsoft 一概不予收費。 如需更多關於如何連絡微軟以獲得支援問題的資訊，請造訪 [Microsoft 支援](http://go.microsoft.com/fwlink/?linkid=21155)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-2732](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2732) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-2733](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2733) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-2734](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2734) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-3936](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3936) (英文)。
...
資訊安全更新可以從 [Microsoft 下載中心](http://go.microsoft.com/fwlink/?linkid=21129)取得， 您也可以利用「資訊安全更新」("security update") 關鍵字搜尋輕易地找到資訊安全更新。 一旦測試完成，確定可順利透過本公司的其他標準發佈方法來提供這些更新，我們也將經由這些管道發佈更新。
...
<td style="border:1px solid black;">Forefront Unified Access Gateway 2010 (KB2433585)：<br />
請參閱 <a href="http://support.microsoft.com/kb/2433585/zh-tw">Microsoft 知識庫文件編號 2433585</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Forefront Unified Access Gateway 2010 Update 1 (KB2433584)：<br />
請參閱 <a href="http://support.microsoft.com/kb/2433584/zh-tw">Microsoft 知識庫文件編號 2433584</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Forefront Unified Access Gateway 2010 Update 2 (KB2418933)：<br />
請參閱 <a href="http://support.microsoft.com/kb/2418933/zh-tw">Microsoft 知識庫文件編號 2418933</a></td>
</tr>
<tr class="even">
...
**此更新的注意事項：**但是，此更新不能結合 /quiet 和 /forcerestart 使用。 請參閱 [Microsoft 知識庫文件編號 2316074](http://support.microsoft.com/kb/2316074/zh-tw)，查看這個關於安裝參數選項的已知問題。
