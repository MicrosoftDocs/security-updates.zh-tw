...
-   Microsoft Windows XP Service Pack 1 和 Microsoft Windows XP Service Pack 2 – 下載更新程式 [中文版](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=b8c867c2-b7cd-4e2f-90e0-169b2c7125dc) | [英文版](https://www.microsoft.com/download/details.aspx?familyid=b8c867c2-b7cd-4e2f-90e0-169b2c7125dc)
-   Microsoft Windows XP 64-Bit Edition Service Pack 1 (Itanium) – 下載更新程式 [英文版](https://www.microsoft.com/download/details.aspx?familyid=2f68945e-eeb8-42bc-a8ad-0d3991204889)
...
|-------------------------------------------------------------------------------------------------|------------|---------------------------|---------------------------|
| 具名管道弱點 - [CAN-2005-0051](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-0051) | 資訊洩露   | 重要                      | 中度                      |
...
使用這個作業系統版本的客戶應優先考慮移轉至支援的作業系統版本，以避免因潛在的弱點而遭受攻擊。 如需瞭解 Windows Service Pack 產品生命週期的相關資訊，請造訪 [Microsoft 產品技術支援週期準則網站](https://support.microsoft.com/gp/lifecycle/zh-tw)。 如需瞭解 Windows 產品生命週期的相關資訊，請造訪 [Microsoft 產品技術支援週期準則網站](https://support.microsoft.com/gp/lifecycle/zh-tw)。
...
是。 SMS 能協助偵測及部署本安全性更新。 如需關於 SMS 的詳細資訊，請造訪 [SMS 網站](https://www.microsoft.com/taiwan/smserver/default.htm)。 要偵測 Microsoft Windows 及其他受影響的 Microsoft 產品，需要使用安全性更新盤點工具 (Security Update Inventory Tool)。 如需更多有關安全性更新盤點工具限制的資訊，請參閱 [Microsoft 知識庫文件編號 306460](https://support.microsoft.com/kb/306460/zh-tw/)。
...
-   **停用 Computer Browser 服務**
    ...
    **因應措施的影響：**如果停用了 Computer Browser 服務，明確依賴 Computer Browser 服務的任何服務可能會在系統事件記錄檔中記錄錯誤訊息。 如需更多關於 Computer Browser 服務的資訊，請參閱 [Microsoft 知識庫文件編號 188001](https://support.microsoft.com/kb/188001)。

-   **使用群組原則設定，在所有不需要 Computer Browser 服務的受影響系統上停用此項功能。**
    因為 Computer Browser 服務會是可能的攻擊媒介，請使用群組原則設定停用這項功能。 您可以使用 Windows 2000 或 Windows Server 2003 網域環境中的群組原則物件功能，在本機、站台、網域或組織單位層級中停用這項服務的啟動。 如需更多關於透過登入指令檔停用這個服務的資訊，請參閱 [Microsoft 知識庫文件編號 297789](https://support.microsoft.com/kb/297789) (英文)。
...
-   **在防火牆中封鎖 TCP 連接埠 139 和 445：**
    ...
    上述連接埠用於起始與受影響通訊協定的連線。 在防火牆封鎖上述連接埠有助於保護防火牆後的系統免遭此弱點的攻擊。 建議您封鎖所有網際網路中來路不明的輸入通訊，以防他人利用其他連接埠攻擊系統。 如需更多關於連接埠的資訊，請造訪這個[網站](https://go.microsoft.com/fwlink/?linkid=21312)。

-   **使用個人防火牆，例如**[**網際網路連線防火牆**](https://go.microsoft.com/fwlink/?linkid=33335)**(內建於 Windows XP) 且不要啟用 \[File and Printer Sharing for Microsoft Networks\]。**
...
-   **請在支援此功能的系統中啟用進階 TCP/IP 篩選功能。**
    ...
    您可以啟用進階的 TCP/IP 篩選功能，封鎖所有來路不明的輸入網路流量。 如需更多關於如何設定 TCP/IP 篩選功能的資訊，請參閱 [Microsoft 知識庫文件編號 309798](https://support.microsoft.com/kb/309798)。 雖然此文件參照 Windows 2000，但也適用於 Windows XP。

-   **在受影響的系統中使用 IPSec 封鎖受影響的連接埠。**

    使用網際網路通訊協定安全性 (IPSec) 保護網路通訊。 如需更多關於 IPSec 及如何套用篩選的資訊，請參閱 [Microsoft 知識庫文件編號 313190](https://support.microsoft.com/kb/313190) 與 [Microsoft 知識庫文件編號 813878](https://support.microsoft.com/kb/813878)。 雖然此文件參照 Windows 2000，但也適用於 Windows XP。
...
**什麼是具名管道？**  
使用具名管道可以提供同一部電腦 (或網路中不同電腦) 上處理序之間的通訊。 典型的具名管道資源包括檔案共用和列印共用。 如需更多關於具名管道的詳細資訊，請造訪 [MSDN Library 網站](https://msdn.microsoft.com/library/default.asp?url=/library/en-us/ipc/base/named_pipes.asp)。
...
-   [Herve Schauer Consultants](https://www.hsc.fr) 的 Jean-Baptiste Marchandfor 報告具名管道弱點 (CAN-2005-0051)。
