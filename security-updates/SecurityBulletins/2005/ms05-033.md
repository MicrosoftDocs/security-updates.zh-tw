...
-   Microsoft Windows XP Service Pack 1 和 Microsoft Windows XP Service Pack 2 – [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=b8ba775e-e9a7-47e9-81a9-a68a71b9faac) │ [中文下載更新程式](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&familyid=b8ba775e-e9a7-47e9-81a9-a68a71b9faac)
-   Microsoft Windows XP 64-Bit Edition Service Pack 1 (Itanium) – [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=c6161d9e-1672-479e-8baf-754a64dfab47)
-   Microsoft Windows XP 64-Bit Edition Version 2003 (Itanium) – [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=c23a4e16-e228-4a80-a4cb-9dcef462b97a)
-   Microsoft Windows XP Professional x64 Edition – [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=b281550b-8fae-4ff3-9bb7-e4ba325779b9)
-   Microsoft Windows Server 2003 和 Microsoft Windows Server 2003 Service Pack 1 – [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=22095e78-a559-40ea-8b65-9c727f4e752f) │ [中文下載更新程式](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&familyid=22095e78-a559-40ea-8b65-9c727f4e752f)
-   Microsoft Windows Server 2003 for Itanium-based Systems 及具備 SP1 的 Microsoft Windows Server 2003 for Itanium-based Systems – [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=c23a4e16-e228-4a80-a4cb-9dcef462b97a)
-   Microsoft Windows Server 2003 x64 Edition – [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=dcc6840f-e626-4266-a63a-cddec0ec44d6)
-   Windows 2000 上的 Microsoft Windows Services for UNIX 3.5 – [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=7c3dd615-b82d-4520-9c3a-376283b01d5b)
-   Windows 2000 上的 Microsoft Windows Services for UNIX 3.0 – [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=8eaad650-54db-44bc-ac9b-fc8a50f5a3b5)
-   Windows 2000 上的 Microsoft Windows Services for UNIX 2.2 – [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=32c4e286-2c4d-491a-9e05-4ca0b055d5dc)
-   Windows 2000 上的 Microsoft Windows Services for UNIX 2.1 – [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=a41c701c-c0bb-40b3-88c5-ccc484202b2c)
-   Windows 2000 上的 Microsoft Windows Services for UNIX 2.0 – [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=bda20bf9-6abf-487d-9334-c75fd7227274)
...
|------------------------------------------------------------------------------------------------|------------|---------------------------|---------------------------|---------------------|------------------------------------|--------------------------------------|
| Telnet 弱點 - [CAN-2005-1205](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1205) | 資訊洩露   | 中度                      | 中度                      | 中度                | 中度                               | 中度                                 |
...
**此更新程式是否包含任何其他功能的變更？**  
是。除了本公告＜弱點詳細資訊＞中列出的變更外，這個更新還包含下列功能上的變更：已新增新的登錄機碼，允許客戶指定 Telnet 用戶端可能會洩漏的其他環境變數。如需更多資訊，請參閱 [Microsoft 知識庫文件編號 900934](http://support.microsoft.com/kb/900934)。
...
是。但 MBSA 僅會判斷支援的程式是否需要更新。例如，MBSA 不支援 Windows Services for UNIX，因此不會偵測該程式是否需要更新。然而，Microsoft 已開發出新版[企業更新掃描工具](http://support.microsoft.com/kb/894193) (EST)，可協助客戶判斷 Windows Services for UNIX 是否需要安全性更新。如需有關 MBSA 目前無法偵測的程式詳細資訊，請參閱 [Microsoft 知識庫文件編號 306460](http://support.microsoft.com/kb/306460)。如需有關 MBSA 的詳細資訊，請造訪 [MBSA 網站](http://go.microsoft.com/fwlink/?linkid=21134)。
...
是。Microsoft 已建立新版 EST，可判斷您是否需要套用 Windows Services for UNIX 更新。如需本月發行的 EST 版本的詳細資訊，請瀏覽下列 [Microsoft 網站](http://support.microsoft.com/kb/894193)。如需本月發行的 EST 版本的詳細部署資訊，請瀏覽下列 [Microsoft 網站](http://support.microsoft.com/kb/894192)。SMS 客戶也可以造訪 [Microsoft 網站](http://support.microsoft.com/kb/894154)取得此工具版本， 或是從 [SMS 網站](http://www.microsoft.com/taiwan/smserver/default.htm)取得這個工具。

**是否可以使用 Systems Management Server (SMS) 來判斷是否需要此更新？**  
是。SMS 能協助偵測及部署本安全性更新。SMS 使用 MBSA 來進行偵測，因此 SMS 也會面臨與 MBSA 相同的限制，而無法偵測部份程式；請參閱本公告先前所述說明。此外也會備有 SMS 客戶能取得的 EST 版本，讓 SMS 系統管理員享受整合式的體驗。若要下載這個版本的 EST，請瀏覽下列 [Microsoft 網站](http://support.microsoft.com/kb/894194)。若要偵測 Microsoft Windows 及其他受影響的 Microsoft 產品，需要使用安全性更新盤點工具 (Security Update Inventory Tool)。如需更多有關安全性更新盤點工具 (Security Update Inventory Tool) 限制的資訊，請參閱 [Microsoft 知識庫文件編號 306460](http://support.microsoft.com/kb/306460)。
...
**什麼是 Telnet？**  
[Telnet](http://www.ietf.org/rfc/rfc0854.txt) 是一種業界標準通訊協定，可以讓使用者在 Telnet 伺服器上建立遠端終端機工作階段。由於這是終端機工作階段，所以只有命令列介面。Telnet 主要是用在命令提示字元中進行簡易的遠端管理。這和 Microsoft 超級終端機是不一樣的應用程式。Microsoft 超級終端機並不會受此問題影響。

**什麼是 Microsoft Windows Services for UNIX？**  
[Microsoft Windows Services for UNIX](http://www.microsoft.com/windows/sfu/productinfo/overview/default.asp) 這項產品可以讓客戶在 Windows 系統上執行 UNIX 應用程式。此功能會在標準 POSIX 子系統之外提供加強的 UNIX 環境子系統，藉此延伸 UNIX 應用程式、背景程式和指令碼的支援。Windows Service for UNIX 允許客戶執行 UNIX 應用程式、背景程式和指令碼。
...
**更新的作用何在？**  
本更新會限制 Telnet 傳送至 Telnet 伺服器的工作階段變數，因而移除此項弱點。[Internet RFC 1572](http://www.ietf.org/rfc/rfc1572.txt) 定義了一組可向已更新 Telnet 用戶端要求且為人熟知的變數。由於 Windows Services for UNIX Telnet 伺服器仍在使用 SFUTLNTVER 和 SFUTLNTMODE 變數，因此這個已更新的 Telnet 用戶端也會繼續允許使用這兩個變數。而其他所有工作階段變數則會受到限制。
...
此更新程式不需要重新開機。如果需要的檔案正在使用中，更新程式會要求重新開機。在此情況下，系統會出現訊息提示您重新開機。若要減少重新開機的可能性，請在安裝安全性更新之前，停止所有受影響的服務，並關閉所有可能使用受影響檔案的應用程式。有關系統可能會提示您重新開機的原因的更多資訊，請參閱 [Microsoft 知識庫文件編號 887012](http://support.microsoft.com/kb/887012)。
...
此更新程式不需要重新開機。有關系統可能會提示您重新開機的原因的更多資訊，請參閱 [Microsoft 知識庫文件編號 887012](http://support.microsoft.com/kb/887012)。
...
-   與 [iDEFENSE](http://www.idefense.com) 合作的 [Gaël Delalleau](mailto:gael.delalleau+moz@m4x.org) 回報 Telnet 弱點 (CAN-2005-1205)。
