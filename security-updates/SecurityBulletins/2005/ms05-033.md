---
TOCTitle: 'MS05-033'
Title: 'Microsoft Security Bulletin MS05-033 - 中等'
ms:assetid: 'ms05-033'
ms:contentKeyID: 61237412
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms05-033(v=Security.10)'
---

Microsoft Security Bulletin MS05-033 - 中等
===========================================

Telnet 用戶端中的弱點可能會導致資訊洩露 (896428)
------------------------------------------------

發行: 2005年6月14日 | 更新: 2005年7月12日

**發佈日期：** 2005 年 6 月 14 日  
**更新日期：** 2005 年 7 月 13 日  
**版本：** 2.0

#### 摘要

**應該閱讀此文件的對象：** 使用 Microsoft Telnet 用戶端的客戶
...
-   Microsoft Windows XP Service Pack 1 和 Microsoft Windows XP Service Pack 2 – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=b8ba775e-e9a7-47e9-81a9-a68a71b9faac) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=b8ba775e-e9a7-47e9-81a9-a68a71b9faac)
-   Microsoft Windows XP 64-Bit Edition Service Pack 1 (Itanium) – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=c6161d9e-1672-479e-8baf-754a64dfab47)
-   Microsoft Windows XP 64-Bit Edition Version 2003 (Itanium) – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=c23a4e16-e228-4a80-a4cb-9dcef462b97a)
-   Microsoft Windows XP Professional x64 Edition – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=b281550b-8fae-4ff3-9bb7-e4ba325779b9)
-   Microsoft Windows Server 2003 和 Microsoft Windows Server 2003 Service Pack 1 – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=22095e78-a559-40ea-8b65-9c727f4e752f) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=22095e78-a559-40ea-8b65-9c727f4e752f)
-   Microsoft Windows Server 2003 for Itanium-based Systems 及具備 SP1 的 Microsoft Windows Server 2003 for Itanium-based Systems – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=c23a4e16-e228-4a80-a4cb-9dcef462b97a)
-   Microsoft Windows Server 2003 x64 Edition – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=dcc6840f-e626-4266-a63a-cddec0ec44d6)
-   Windows 2000 上的 Microsoft Windows Services for UNIX 3.5 – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=7c3dd615-b82d-4520-9c3a-376283b01d5b)
-   Windows 2000 上的 Microsoft Windows Services for UNIX 3.0 – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=8eaad650-54db-44bc-ac9b-fc8a50f5a3b5)
-   Windows 2000 上的 Microsoft Windows Services for UNIX 2.2 – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=32c4e286-2c4d-491a-9e05-4ca0b055d5dc)
-   Windows 2000 上的 Microsoft Windows Services for UNIX 2.1 – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=a41c701c-c0bb-40b3-88c5-ccc484202b2c)
-   Windows 2000 上的 Microsoft Windows Services for UNIX 2.0 – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=bda20bf9-6abf-487d-9334-c75fd7227274)
...
這個更新程式能解決一項新發現且未公開報告的弱點。如果攻擊者成功利用這項資訊洩露弱點，就可以針對以開放式連線連接惡意 Telnet 伺服器的使用者，從遠端讀取其工作階段變數。本公告的＜弱點詳細資訊＞部分會提供這項弱點的相關資訊。

我們建議客戶考慮安裝這項安全性更新。

**嚴重性等級和弱點識別碼：**

| 弱點識別碼                                                                                     | 弱點的影響 | Windows XP Service Pack 1 | Windows XP Service Pack 2 | Windows Server 2003 | Windows Server 2003 Service Pack 1 | Windows Services for UNIX (所有版本) |
|------------------------------------------------------------------------------------------------|------------|---------------------------|---------------------------|---------------------|------------------------------------|--------------------------------------|
| Telnet 弱點 - [CAN-2005-1205](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1205) | 資訊洩露   | 中度                      | 中度                      | 中度                | 中度                               | 中度                                 |
...
**Microsoft 為什麼重新發行本公告？**  
在發行本公告後，我們確定公告中所提弱點也會影響 Windows Services for Unix 2.0 及 Windows Services for Unix 2.1。Microsoft 在公告中新增了與這些安全性更新有關的附加資訊。未使用 Windows Services for Unix 2.0 及 Windows Services for UNIX 2.1 的客戶，如果之前已安裝了本公告當初發行時所提供的安全性更新，則不必安裝新的安全性更新。

**此更新程式是否包含任何其他功能的變更？**  
是。除了本公告＜弱點詳細資訊＞中列出的變更外，這個更新還包含下列功能上的變更：已新增新的登錄機碼，允許客戶指定 Telnet 用戶端可能會洩漏的其他環境變數。如需更多資訊，請參閱 [Microsoft 知識庫文件編號 900934](https://support.microsoft.com/kb/900934)。
...
是。但 MBSA 僅會判斷支援的程式是否需要更新。例如，MBSA 不支援 Windows Services for UNIX，因此不會偵測該程式是否需要更新。然而，Microsoft 已開發出新版[企業更新掃描工具](https://support.microsoft.com/kb/894193) (EST)，可協助客戶判斷 Windows Services for UNIX 是否需要安全性更新。如需有關 MBSA 目前無法偵測的程式詳細資訊，請參閱 [Microsoft 知識庫文件編號 306460](https://support.microsoft.com/kb/306460)。如需有關 MBSA 的詳細資訊，請造訪 [MBSA 網站](https://go.microsoft.com/fwlink/?linkid=21134)。
...
是。Microsoft 已建立新版 EST，可判斷您是否需要套用 Windows Services for UNIX 更新。如需本月發行的 EST 版本的詳細資訊，請瀏覽下列 [Microsoft 網站](https://support.microsoft.com/kb/894193)。如需本月發行的 EST 版本的詳細部署資訊，請瀏覽下列 [Microsoft 網站](https://support.microsoft.com/kb/894192)。SMS 客戶也可以造訪 [Microsoft 網站](https://support.microsoft.com/kb/894154)取得此工具版本， 或是從 [SMS 網站](https://www.microsoft.com/taiwan/smserver/default.htm)取得這個工具。

**是否可以使用 Systems Management Server (SMS) 來判斷是否需要此更新？**  
是。SMS 能協助偵測及部署本安全性更新。SMS 使用 MBSA 來進行偵測，因此 SMS 也會面臨與 MBSA 相同的限制，而無法偵測部份程式；請參閱本公告先前所述說明。此外也會備有 SMS 客戶能取得的 EST 版本，讓 SMS 系統管理員享受整合式的體驗。若要下載這個版本的 EST，請瀏覽下列 [Microsoft 網站](https://support.microsoft.com/kb/894194)。若要偵測 Microsoft Windows 及其他受影響的 Microsoft 產品，需要使用安全性更新盤點工具 (Security Update Inventory Tool)。如需更多有關安全性更新盤點工具 (Security Update Inventory Tool) 限制的資訊，請參閱 [Microsoft 知識庫文件編號 306460](https://support.microsoft.com/kb/306460)。

弱點詳細資料
------------

#### Telnet 弱點 - CAN-2005-1205：

如果攻擊者成功利用這項資訊洩露弱點，就可以針對以開放式連線連接惡意 Telnet 伺服器的使用者，從遠端讀取其工作階段變數。

#### Telnet 弱點 - CAN-2005-1205 的緩和因素：

-   在網頁式攻擊的案例中，攻擊者必須架設一個網站，並在其中包含利用此弱點的網頁。攻擊者並不能強制使用者造訪惡意的網站， 而是引誘他們自行前往。一般的做法是設法讓使用者按一下通往攻擊者網站的連結。
-   成功利用這項弱點的攻擊者只能讀取受影響使用者的工作階段變數。但是不包含密碼雜湊之類的重要資料。
-   只有在 Windows 2000 上執行時，所有 Windows Services for UNIX 版本才會受此弱點的影響。如果在其他作業系統上執行 Windows Services for UNIX，就不會受到此問題的影響。

#### Telnet 弱點 - CAN-2005-1205 的因應措施：

Microsoft 已經測試過以下的因應措施。這些因應措施並不能徹底解決弱點，但是有助於封鎖已知的攻擊行為。如果因應措施會降低功能，以下小節將會描述功能降低的情況。

-   **解除預設 Telnet 用戶端的登錄：**
    若要協助防止旁人利用 Telnet URL 進行攻擊，您可以移除 Telnet、Tn3270 和 Rlogin 處理常式。這樣會防止 Internet Explorer 和其他應用程式自動啟動 Telnet 工作階段。
    ...
    **因應措施的影響：** 這些變更將防止使用 Telnet 處理 Telnet、Tn3270 或 Rlogin URL，因此有助於防範相關的攻擊。

#### Telnet 弱點 - CAN-2005-1205 的常見問題集：

**這個弱點的範圍為何？**  
這是一個資訊洩露的弱點。如果攻擊者成功利用這項弱點，就可以針對以開放式連線連接惡意 Telnet 伺服器的使用者，從遠端讀取其工作階段變數。請注意，這個弱點不會直接允許攻擊者執行程式碼或提升權限， 但可能會用來產生可以進一步破壞受影響系統的資訊。

**造成這個弱點的原因為何？**  
Telnet 用戶端的設計即是用來提供這類資訊。

**什麼是 Telnet？**  
[Telnet](https://www.ietf.org/rfc/rfc0854.txt) 是一種業界標準通訊協定，可以讓使用者在 Telnet 伺服器上建立遠端終端機工作階段。由於這是終端機工作階段，所以只有命令列介面。Telnet 主要是用在命令提示字元中進行簡易的遠端管理。這和 Microsoft 超級終端機是不一樣的應用程式。Microsoft 超級終端機並不會受此問題影響。

**什麼是 Microsoft Windows Services for UNIX？**  
[Microsoft Windows Services for UNIX](https://www.microsoft.com/windows/sfu/productinfo/overview/default.asp) 這項產品可以讓客戶在 Windows 系統上執行 UNIX 應用程式。此功能會在標準 POSIX 子系統之外提供加強的 UNIX 環境子系統，藉此延伸 UNIX 應用程式、背景程式和指令碼的支援。Windows Service for UNIX 允許客戶執行 UNIX 應用程式、背景程式和指令碼。

**攻擊者可能會利用這項弱點採取什麼行動？**  
如果攻擊者成功利用這項弱點，就可以針對以開放式連線連接惡意 Telnet 伺服器的使用者，從遠端讀取其工作階段變數。
...
-   攻擊者也可以建立電子郵件，並附加蓄意製作的 Telnet URL。攻擊者可能會引誘使用者檢視或預覽含 Telnet URL 的電子郵件訊息，然後引誘使用者按下 Telnet URL，以嘗試利用此弱點。

**因為這個弱點而承受風險的主要系統有哪些？**  
所有受影響的作業系統都可能受到這個弱點影響。然而，攻擊者必須要將此問題與其他弱點結合才能影響系統。

**更新的作用何在？**  
本更新會限制 Telnet 傳送至 Telnet 伺服器的工作階段變數，因而移除此項弱點。[Internet RFC 1572](https://www.ietf.org/rfc/rfc1572.txt) 定義了一組可向已更新 Telnet 用戶端要求且為人熟知的變數。由於 Windows Services for UNIX Telnet 伺服器仍在使用 SFUTLNTVER 和 SFUTLNTMODE 變數，因此這個已更新的 Telnet 用戶端也會繼續允許使用這兩個變數。而其他所有工作階段變數則會受到限制。
...
**注意：**使用 **/quiet** 參數將會隱藏所有訊息。這包括隱藏失敗訊息。當系統管理員使用 **/quiet** 參數時，則應該採取妥當的做法驗證是否已順利安裝。此外，系統管理員還應該在使用此參數時檢視 KB896428.log 檔，查看是否有任何失敗訊息。
...
此更新程式不需要重新開機。如果需要的檔案正在使用中，更新程式會要求重新開機。在此情況下，系統會出現訊息提示您重新開機。若要減少重新開機的可能性，請在安裝安全性更新之前，停止所有受影響的服務，並關閉所有可能使用受影響檔案的應用程式。有關系統可能會提示您重新開機的原因的更多資訊，請參閱 [Microsoft 知識庫文件編號 887012](https://support.microsoft.com/kb/887012)。

**移除資訊**

如果要移除此更新程式，請使用 \[控制台\] 中的 \[新增或移除程式\] 工具。

系統管理員也可以使用 Spuninst.exe 公用程式來移除此安全性更新。Spuninst.exe 公用程式位於 %Windir%\\$NTUninstallKB896428$\\Spuninst 資料夾中。
...
-   **登錄機碼驗證**
    ...
    **注意：**此登錄機碼可能未包含完整的安裝檔案清單。此外，當系統管理員或 OEM 將 896428 安全性更新整合或匯集到 Windows 安裝來源檔時，可能未正確建立這個登錄機碼。
...
-   **登錄機碼驗證**
    ...
    **注意：**這些登錄機碼可能未包含完整的安裝檔案清單。此外，當系統管理員或 OEM 將 896428 安全性更新整合或匯集到 Windows 安裝來源檔時，可能未正確建立這些登錄機碼。

#### Windows Services for UNIX (所有版本)

**必要條件**  
這個安全性更新程式需要在 Windows 2000 上執行 Windows Services for UNIX 2.0、2.1、2.2、3.0 或 3.5 版。
...
在 Windows Services for UNIX 2.0 上，如想在不需要使用者介入的狀況下安裝安全性更新，請在命令提示字元使用下列命令：
...
此更新程式不需要重新開機。有關系統可能會提示您重新開機的原因的更多資訊，請參閱 [Microsoft 知識庫文件編號 887012](https://support.microsoft.com/kb/887012)。

**移除資訊**

若要移除此安全性更新，請使用 \[控制台\] 中的 \[新增/移除程式\]。

系統管理員也可以使用 Hotfix.exe 公用程式來移除此安全性更新。Hotfix.exe 公用程式位於 %Windir%\\$NTUninstallKB896428$ 資料夾中。
...
-   與 [iDEFENSE](https://www.idefense.com) 合作的 [Gaël Delalleau](mailto:gael.delalleau+moz@m4x.org) 回報 Telnet 弱點 (CAN-2005-1205)。
...
-   V1.1 (2005 年 6 月 15 日)：公告「感謝」小節加入更多細節。
-   V1.2 (2005 年 6 月 29 日)：公告「安全性更新資訊」小節新增與 Windows XP x64 Professional Edition 登錄機碼驗證有關之資訊。
-   V2.0 (2005 年 7 月 12 日)：更新公告，提供 Services for UNIX 2.0 及 Services for UNIX 2.1 之安全性更新。「安全性更新資訊」小節亦加入與新增之安全性更新有關之資訊。
