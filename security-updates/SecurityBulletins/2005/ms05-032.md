...
|---------------------------------------------------------------------------------------------------------|------------|-----------------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Microsoft Agent 弱點 - [CAN-2005-1214](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1214) | 偽造       | 非重大                | 中度         | 中度                      | 中度                      | 輕微                | 輕微                               |
...
-   依照預設，Windows Server 2003 的 Internet Explorer 會以稱為「[增強式安全性設定](https://msdn2.microsoft.com/en-us/library/ms537183.aspx)」的受限制模式執行。 此模式可緩和這項弱點。 如需更多資訊，請參閱此弱點＜常見問題集＞關於 Internet Explorer 增強式安全性設定的部份。
...
是。 依照預設，Windows Server 2003 的 Internet Explorer 會以稱為「[增強式安全性設定](https://msdn2.microsoft.com/en-us/library/ms537183.aspx)」的受限制模式執行。 此模式可緩和這項弱點。
...
-   [Michael Krax](https://www.mikx.de/) 回報 Microsoft Agent 弱點 (CAN-2005-1214)。
