...
此外，這項更新會針對下列物件的舊版本設定 [Kill Bit](https://support.microsoft.com/kb/240797) (刪除位元)。
...
**必要條件**  
這個安全性更新程式需要 Microsoft Windows XP Service Pack 2 或 Windows XP Professional x64。如需更多資訊，請參閱 [Microsoft 知識庫文件編號 322389](https://support.microsoft.com/kb/322389)。
...
-   [SEC Consult](https://www.sec-consult.com/) 的 Bernhard Mueller 與 Martin Eiszner 回報 COM 物件例項記憶體損毀弱點 - CAN-2005-1990 中的類別識別項子集。
-   [NSFOCUS Security Team](https://www.nsfocus.com/) 回報 COM 物件例項記憶體損毀弱點 - CAN-2005-1990 中的其中一個類別識別項。
