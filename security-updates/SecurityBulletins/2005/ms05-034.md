...
-   Microsoft Internet Security and Acceleration (ISA) Server 2000 Service Pack 2 – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=e579813b-0372-45be-8070-3f4d7d4cb89c)。
...
|---------------------------------------------------------------------------------------------------------------|--------------------|-----------------|
| HTTP 內容標題弱點 - [CAN-2005-1215](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1215)          | 權限提高、快取中毒 | 中度            |
| NetBIOS 預先定義篩選器弱點 - [CAN-2005-1216](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1216) | 權限提高           | 中度            |
| 基本驗證弱點 - [CAN-2005-1217](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1217)               | 資訊洩露           | 中度            |
| **所有弱點的彙總嚴重性**                                                                                      |                    | **中度**        |
...
否。 MBSA 不支援 ISA Server，因此無法偵測該程式是否需要更新程式。 但是，Microsoft 已經開發出[企業更新掃描工具](https://support.microsoft.com/kb/894193) (EST) 版本，能協助客戶判斷是否需要此安全性更新。
...
是。 Microsoft 已建立新版 EST，可判斷您是否需要套用此更新。 如需本月發行的 EST 版本的詳細資訊，請瀏覽下列 [Microsoft 網站](https://support.microsoft.com/kb/894193)。 如需本月發行的 EST 版本的詳細部署資訊，請瀏覽下列 [Microsoft 網站](https://support.microsoft.com/kb/894192)。 SMS 客戶也可以前往下列 [Microsoft 網站](https://support.microsoft.com/kb/894154)取得這個工具版本， 或是從 [SMS 網站](https://www.microsoft.com/taiwan/smserver/default.htm)取得這個工具。

**是否可以使用 Systems Management Server (SMS) 來判斷是否需要此更新？**  
是。 SMS 能協助偵測及部署本安全性更新。 SMS 使用 MBSA 來進行偵測，因此 SMS 也會面臨與 MBSA 相同的限制，而無法偵測部份程式；請參閱本公告先前所述說明。
不過，SMS 客戶也可以從下列 [Microsoft 網站](https://support.microsoft.com/kb/894194)取得 EST 版本，帶給 SMS 系統管理員整合式的體驗。
...
ISA Server 2000 中存在資訊洩露弱點，會讓成功利用這項弱點的攻擊者，藉著在驗證處理時監視用戶端和 ISA Server 之間的 HTTP 流量，取得機密資訊。 在 Web 發佈的案例中，基本驗證在傳入 Web 要求接聽程式中是啟用的。 此問題先前已在 [Microsoft 知識庫文件編號 821724](https://support.microsoft.com/kb/821724) 中提出因應之道，並於 [MS04-039](https://www.microsoft.com/taiwan/security/bulletin/ms04-039.mspx) 中進行迴歸。
...
-   [Watchfire](https://www.watchfire.com) 的 Steve Orrin 回報 HTTP 內容標題弱點 (CAN-2005-1215)。
