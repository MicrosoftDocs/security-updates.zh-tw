...
**安全性更新取代資訊：** 此更新程式取代 Microsoft 安全性公告 [MS05-052](https://technet.microsoft.com/security/bulletin/ms05-052) 中提供的安全性更新程式。兩者都是積存更新。

**警告：** [Microsoft 知識庫文件編號 905915](https://support.microsoft.com/kb/905915) 詳細記錄了目前已知安裝此安全性更新後可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。 如需更多資訊，請參閱 [Microsoft 知識庫文件編號 905915](https://support.microsoft.com/kb/905915)。

此更新包含已在 [MS04-004](https://www.microsoft.com/taiwan/security/bulletins/ms04-004.asp) 和 [MS04-025](https://www.microsoft.com/taiwan/security/bulletin/ms04-025.mspx) 之後發行的 Hotfix，但僅會安裝在需要的系統中。 [MS04-004](https://www.microsoft.com/taiwan/security/bulletins/ms04-004.asp) 或 [MS04-025](https://www.microsoft.com/taiwan/security/bulletin/ms04-025.mspx) 發行後已從 Microsoft 或支援服務提供者收到 Hotfix 的客戶請參閱此公告中常見問題集的下列問題：「MS04-004 發行之後我又收到來自 Microsoft 或支援服務提供者的 Hotfix。這次安全性更新是否包含這一個 Hotfix？」以判斷如何確定是否已安裝必要的 Hotfix。 [Microsoft 知識庫文件編號 905915](https://support.microsoft.com/kb/905915) 也會在內容中提供詳細資訊。
...
|---------------------------------------------------------------------------------------------------------------------------|----------------|--------------------------------------|------------------------------------------------------|-------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|----------------------------------------------------|
| 檔案下載對話方塊操作弱點 - [CAN-2005-2829](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-2829)               | 遠端執行程式碼 | 中度                                 | 中度                                                 | 中度                                                                                | 輕微                                                                               | 中度                                               |
| HTTPS Proxy 弱點 - [CAN-2005-2830](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-2830)                       | 資訊洩漏       | 中度                                 | 中度                                                 | 中度                                                                                | 中度                                                                               | 中度                                               |
| COM 物件例項記憶體損毀弱點 - [CAN-2005-2831](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-2831)             | 遠端執行程式碼 | 重大                                 | 重大                                                 | 重大                                                                                | 中度                                                                               | 重大                                               |
| 不相符的文件物件模型物件記憶體損毀弱點 - [CAN-2005-1790](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1790) | 遠端執行程式碼 | 重大                                 | 重大                                                 | 重大                                                                                | 中度                                                                               | 重大                                               |
...
[Microsoft 知識庫文件編號 905915](https://support.microsoft.com/kb/905915) 詳細記錄了目前已知安裝此安全性更新後可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。 如需更多資訊，請參閱 [Microsoft 知識庫文件編號 905915](https://support.microsoft.com/kb/905915)。

**MS04-004 發行之後我又收到來自 Microsoft 或支援服務提供者的 Hotfix。這次安全性更新是否包含這一個 Hotfix？**  
是。 當您在下列系統中安裝安全性更新時，安裝程式會檢查系統中要更新的一個或多個檔案是否先前已由 Microsoft Hotfix 更新過：執行 Internet Explorer 6 Service Pack 1 的 Microsoft Windows 2000 Service Pack 4 或 Microsoft Windows XP Service Pack 1。 然而，安裝程式僅會偵測 Microsoft 安全性公告 [MS04-038](https://go.microsoft.com/fwlink/?linkid=31851) 和 Internet Explorer [更新彙總套件 873377](https://support.microsoft.com/kb/873377) 或 Internet Explorer [更新彙總套件 889669](https://support.microsoft.com/kb/889669) 之後發行的 Hotfix。
如果您必須在已安裝 [MS05-054](https://go.microsoft.com/fwlink/?linkid=53511) 更新的系統上套用安全性公告 [MS04-038](https://go.microsoft.com/fwlink/?linkid=31851) 發行之前的 Hotfix，請參閱 [Microsoft 知識庫文件編號 905915](https://support.microsoft.com/kb/905915)，以瞭解更多資訊。

對於 Microsoft Windows XP Service Pack 2 或 Windows Server 2003 或更新版本之 Internet Explorer 6，此安全性更新提供包含在 [MS04-025](https://go.microsoft.com/fwlink/?linkid=31981) 或更新版本的 Internet Explorer 安全性更新中的 Hotfix。 但是，只有當您先前已安裝 Internet Explorer Hotfix 以更新本公告＜安全性更新資訊＞部份中所列任何檔案，才會安裝本安全性更新內檔案的 Hotfix 版本。

對於 Windows XP Service Pack 1 和 Windows 2000 Service Pack 4 之 Internet Explorer 5.01 Service Pack 4、Internet Explorer 5.5 Service Pack 2 和 Internet Explorer 6 Service Pack 1，[MS05-054](https://go.microsoft.com/fwlink/?linkid=53511) 安全性更新包含 [MS04-004](https://go.microsoft.com/fwlink/?linkid=22189) 之後一直到 [MS05-054](https://go.microsoft.com/fwlink/?linkid=53511) 的 Hotfix，以及後者的積存更新。無論您先前是否安裝 Internet Explorer Hotfix 以更新本公告＜安全性更新資訊＞部份中所列任何檔案，都會安裝本安全性更新內檔案的 Hotfix 版本。

**此更新程式是否包含功能上的任何安全性相關變更？**  
是。 除了本公告的＜弱點詳細資訊＞部份中列出的變更以及先前 Internet Explorer 安全性公告內加入的變更外，此更新還加入下列變更：

-   這個積存安全性更新會設定 First4Internet XCP 解除安裝 ActiveX 控制項的 [Kill Bit](https://support.microsoft.com/kb/240797) (刪除位元)。 如需更多關於此 ActiveX 控制項的資訊，請造訪 [SONY BMG](https://cp.sonybmg.com/xcp/english/uninstall.html) 網站。 這個控制項的舊版本已發現含有安全性弱點。 為了協助保護已安裝此控制項的客戶，此更新可避免在 Internet Explorer 中執行這個舊版控制項。 更新會針對這個控制項的不受支援較舊版本設定 Kill Bit (刪除位元) 以達成此目的。 此 Kill Bit (刪除位元) 的設定允許 ActiveX 控制項擁有者權限。 如需更多關於 Kill Bit (刪除位元) 的相關資訊，請參閱 [Microsoft 知識庫文件編號 240797](https://support.microsoft.com/kb/240797)。此 ActiveX 控制項的類別識別項 (CLSID) 為：
...
-   這個積存安全性更新還包含在允許 COM 物件可於 Internet Explorer 中執行前，Microsoft 安全性更新 [MS05-052](https://go.microsoft.com/fwlink/?linkid=50690) 中所引入的檢查功能。 這項變更的目的是為了避免不應在 Internet Explorer 中產生的 COM 物件在 Internet Explorer 中產生：
    -   [Microsoft 知識庫文件編號 909889](https://support.microsoft.com/kb/909889)：由於積存安全性更新 896688 (MS05-052) 進行了深度防禦變更，因此 Internet Explorer 可能不會如所預期的載入 ActiveX 控制項。
    -   [Microsoft 知識庫文件編號 909738](https://support.microsoft.com/kb/909738)： 由於積存安全性更新 896688 (MS05-052) 進行了深度防禦變更，因此 Internet Explorer 中包含自訂 ActiveX 控制項的網頁可能不會如所預期的載入。

**此更新程式是否包含任何其他功能的變更？**  
是。 除了本公告＜弱點詳細資料＞中列出的變更外，這個更新還包含先前 Internet Explorer 公告內的非安全性相關變更。

這個更新會設定 Microsoft MciWndx ActiveX 控制項的 [Kill Bit](https://support.microsoft.com/kb/240797) (刪除位元)。 Internet Explorer 已經不再支援這個控制項，而且此更新可避免控制項在 Internet Explorer 中執行。 如需有關 Kill Bit (刪除位元) 的相關資訊，請參閱 [Microsoft 知識庫文件編號 240797](https://support.microsoft.com/kb/240797)。ActiveX 控制項的 CLSID 為 288F1523-FAC4-11CE-B16F-00AA0060D93D。

**注意：**此控制項對於指令碼並未標示為安全，並且不會使用到 IObjectSafety 介面。 除非至少滿足這些 ActiveX 控制項需求的其中一項，才能夠在 Internet Explorer 中執行 ActiveX 控制項。 如需更多關於 IObjectSafety 介面需求的相關資訊，請參閱 [Microsoft 知識庫文件編號 216434](https://support.microsoft.com/kb/216434) 和 [Microsoft 知識庫文件編號 909738](https://support.microsoft.com/kb/909738)。
...
是。 Windows 98、Windows 98 Second Edition 以及 Windows Millennium Edition 均會嚴重受本安全性公告提出的弱點影響。 本次安全性公告提供這些平台的重大安全性更新，並且只可從 [Microsoft Update 網站](https://update.microsoft.com/microsoftupdate/)或 [Windows Update 網站](https://go.microsoft.com/fwlink/?linkid=21130)下載。 如需更多有關嚴重性等級的資訊，請造訪這個[網站](https://technet.microsoft.com/security/bulletin/rating)。
...
否。 雖然 Windows 98、Windows 98 Second Edition 以及 Windows Millennium Edition 包含了受影響元件，但是因為這項弱點需要相當程度的使用者互動，因此不會產生重大的影響。 如需更多有關嚴重性等級的資訊，請造訪這個[網站](https://technet.microsoft.com/security/bulletin/rating)。
...
基本驗證指的是認證以純文字形式傳送到 Proxy Server，或使用 Base64 編碼的進行編碼。 Base64 編碼並不是一種被視為與純文字相同的加密技術。 如需更多關於其他驗證方法的資訊，請參閱[產品說明文件](https://go.microsoft.com/fwlink/?linkid=56562)。
...
如需避免控制項在 Internet Explorer 內執行的詳細步驟，請參閱 [Microsoft 知識庫文件編號 240797](https://support.microsoft.com/kb/240797)。按照這些步驟，在登錄中建立相容性旗標值，避免在 Internet Explorer 中產生 COM 物件。
...
-   \[限制的網站\] 區域可阻止讀取 HTML 電子郵件訊息時使用 ActiveX 控制項，有助於減少企圖利用這個弱點的攻擊。 然而，如果使用者按一下電子郵件訊息中的連結，仍有可能因為網頁式攻擊而受到此弱點的影響。  
    而依照預設，Outlook Express 6、Outlook 2002 和 Outlook 2003 都會在「受限制的網站區域」開啟 HTML 電子郵件訊息。 此外，如果已經安裝 [Outlook 電子郵件安全性更新程式](https://go.microsoft.com/fwlink/?linkid=33334) (英文)，Outlook 98 和 Outlook 2000 也會在 \[限制的網站\] 區域開啟 HTML 電子郵件訊息。 如果已經安裝 Microsoft 安全性公告 [MS04-018](https://go.microsoft.com/fwlink/?linkid=19527)，Outlook Express 5.5 Service Pack 2 會在「受限制的網站區域」開啟 HTML 電子郵件訊息。
-   依照預設，Windows Server 2003 的 Internet Explorer 會以稱為「[增強式安全性設定](https://msdn.microsoft.com/library/default.asp?url=/workshop/security/szone/overview/esc_changes.asp)」的受限制模式執行。 此模式可緩和這項弱點。 如需更多資訊，請參閱此公告＜常見問題集＞關於 Internet Explorer 增強式安全性設定的部份。
...
-   [CERT/CC](https://www.cert.org/) 的 Will Dormann 報告 COM 物件例項記憶體損毀弱點 ([CAN-2005-2831](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-2831)) 中紀錄的多個類別識別項。
-   感謝 [Secunia](https://www.secunia.com/) 的 Andreas Sandblad 和 Jakob Balle 報告檔案下載對話方塊操作弱點 - ([CAN-2005-2829](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-2829))。
