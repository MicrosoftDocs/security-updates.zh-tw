...
**安全性更新取代資訊：**此更新取代 Microsoft 安全性公告 [MS05-014](https://go.microsoft.com/fwlink/?linkid=37180) 中提供的更新， 兩者都是積存更新。

**警告：**[Microsoft 知識庫文件編號 890923](https://support.microsoft.com/kb/890923) 詳細記錄目前已知安裝此安全性更新後可能會發生的問題。該文件並說明了解決這些問題的建議解決方案。如需更多資訊，請參閱 [Microsoft 知識庫文件編號 890923](https://support.microsoft.com/kb/890923)。

此更新包含已在 [MS04-004](https://www.microsoft.com/taiwan/security/bulletins/ms04-004.asp) 或 [MS04-025](https://go.microsoft.com/fwlink/?linkid=31981) 中發行的 Hotfix，但僅會安裝在需要的系統中。[MS04-004](https://www.microsoft.com/taiwan/security/bulletins/ms04-004.asp) 或 [MS04-025](https://go.microsoft.com/fwlink/?linkid=31981) 發行後已從 Microsoft 或支援服務提供者收到 Hotfix 的客戶請參閱常見問題集：「MS04-004 發行之後我又收到來自 Microsoft 或支援服務提供者的 Hotfix。這次安全性更新是否包含這一個 Hotfix？」以判斷如何確定已安裝必要 Hotfix。[Microsoft 知識庫文件編號 890923](https://support.microsoft.com/kb/890923) 也會在內容中提供詳細資訊。
...
|-------------------------------------------------------------------------------------------------------------|----------------|---------------------------------------------------------|------------------------------------------------------|-------------------------------------------------------------------------------------|---------------------------------------------|----------------------------------------------------|
| DHTML 物件記憶體損毀弱點 - [CAN-2005-0553](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-0553) | 遠端執行程式碼 | 重大                                                    | 重大                                                 | 重大                                                                                | 重要                                        | 重大                                               |
| URL 剖析記憶體損毀弱點 - [CAN-2005-0554](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-0554)   | 遠端執行程式碼 | 重大                                                    | 重大                                                 | 重大                                                                                | 重大                                        | 重大                                               |
| 內容警告器記憶體損毀弱點 - [CAN-2005-0555](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-0555) | 遠端執行程式碼 | 中度                                                    | 中度                                                 | 中度                                                                                | 中度                                        | 中度                                               |
...
如果您必須在已安裝 [MS05-020](https://go.microsoft.com/fwlink/?linkid=43944) 更新的系統上套用 Microsoft 安全性公告 [MS04-038](https://www.microsoft.com/taiwan/security/bulletin/ms04-038.mspx) 之前發行的 Hotfix，請參閱 [Microsoft 知識庫文件編號 890923](https://support.microsoft.com/kb/890923)，以瞭解更多資訊。

對於 Microsoft Windows XP Service Pack 2、Windows Server 2003 以及 Windows 64-Bit Edition Version 2003 (Itanium) 中的 Internet Explorer 6，這項安全性更新包含 [MS04-025](https://go.microsoft.com/fwlink/?linkid=31981) 所附或之後的 Hotfix，以及所有此更新中的安全性問題修正程式。但是，只有您先前安裝 Internet Explorer Hotfix 以更新本公告＜安全性更新資訊＞部份中所列任何檔案，才會安裝本安全性更新內檔案的 Hotfix 版本。

對於 Windows XP 中的 Internet Explorer 5.01、Internet Explorer 5.5 SP2 以及 Internet Explorer 6，[MS05-020](https://go.microsoft.com/fwlink/?linkid=43944) 安全性更新包含 [MS04-004](https://www.microsoft.com/taiwan/security/bulletins/ms04-004.asp) 之後一直到 [MS05-020](https://go.microsoft.com/fwlink/?linkid=43944) 的 Hotfix，以及後者的積存更新。無論您先前是否安裝 Internet Explorer Hotfix 以更新本公告＜安全性更新資訊＞部份中所列任何檔案，都會安裝本安全性更新內檔案的 Hotfix 版本。
...
-   **如果您使用的是 Outlook 2002 或更新的版本，或 Outlook Express 6 SP1 或更新的版本，請用純文字格式閱讀電子郵件，保護自己的電腦不受 HTML 電子郵件攻擊模式的侵害。**
    ...
    如需 Outlook Express 6 中這項設定的相關說明，請參閱 [Microsoft 知識庫文件編號 291387](https://support.microsoft.com/kb/291387/en-us)。
...
**什麼是 DHTML 物件？**  
Dynamic HTML (DHTML) 物件模型允許在網頁上呈現比 HTML 更多的動態內容。如需更多關於 DHTML 的資訊，請參閱[產品說明文件](https://msdn.microsoft.com/workshop/author/dhtml/dhtml_node_entry.asp)。

**什麼是競爭狀況？**  
[競爭狀況](https://go.microsoft.com/fwlink/?linkid=21142)通常與同步處理錯誤有關，這種錯誤提供某項程序干擾另一項程序的機會，可能導致遠端執行程式碼的弱點。舉例來說，競爭狀況可能來自於多執行緒作業系統及軟體內事件的相對時序。競爭狀況經常難以用可預測的方式來利用。如需更多關於競爭狀況的資訊，請參閱 [MSDN Library 網站](https://msdn.microsoft.com/library/en-us/cpguide/html/cpconmanagedthreadingbestpractices.asp)。
...
-   **封鎖內容分級檔案 (.rat 檔案) 以協助防範電子郵件攻擊。**
    ...
    當使用者安裝 .rat 檔時，即可能遭受利用此弱點的攻擊。要使用 Outlook 與 Outlook Express 協助封鎖這些檔案，請參閱 [Microsoft 知識庫文件編號 837388](https://support.microsoft.com/kb/837388) 與 [Microsoft 知識庫文件編號 291387](https://support.microsoft.com/kb/291387/en-us)。企業客戶可考慮將內容分級檔案 (.rat 檔案)，新增至企業閘道電子郵件篩選器封鎖的非安全檔案清單中。
...
Internet Explorer 內容警告器允許您將網頁內容的合適性區分等級，並控制您的使用者能造訪哪些網站。這項功能適用於定義更安全的環境，保護您的使用者不會接觸網際網路中的不當內容。如需更多關於內容警告器的相關資訊，請參閱[產品文件](https://www.microsoft.com/resources/documentation/ie/6/all/reskit/en-us/part2/c05ie6rk.mspx)。

Microsoft IIS Web 伺服器管理員可以透過 Internet Explorer 內容警告器支援的內容分級功能，將網站上的內容分級。如需更多關於內容分級的資訊，請參閱[產品文件](https://www.microsoft.com/resources/documentation/iis/6/all/proddocs/en-us/pub_ucr.mspx)。
...
**必要條件**  
此更新需要 Windows XP Service Pack 2 的 Internet Explorer 6 (6.00.2900.2180 版)。如需更多資訊，請參閱 [Microsoft 知識庫文件編號 322389](https://support.microsoft.com/kb/322389)。
...
**注意：**如需更多資訊，請參閱本安全性公告＜與本安全性更新相關的常見問題集 (FAQ)＞部分中的「MS04-004 發行之後我又收到來自 Microsoft 或支援服務提供者的 Hotfix。這次安全性更新是否包含這一個 Hotfix？」 如果您要在安裝了 [MS05-020](https://go.microsoft.com/fwlink/?linkid=43944) 更新的系統上套用在 Microsoft 安全性公告 [MS04-038](https://www.microsoft.com/taiwan/security/bulletin/ms04-038.mspx) 之前發行的 Hotfix，而且需要更多資訊，也請參閱 [Microsoft 知識庫文件編號 890923](https://support.microsoft.com/kb/890923)。
...
-   與 [iDEFENSE](https://www.idefense.com/) 合作的Berend-Jan Wever 回報 DHTML 物件記憶體損毀弱點 (CAN-2005-0553)。
-   與 [iDEFENSE](https://www.idefense.com/) 合作的 3APA3A 及 axle@bytefall 回報 URL 剖析記憶體損毀弱點 (CAN-2005-0554)。
-   [SIA Group](https://www.siainternational.com/) 的 Andres Tarasco 回報內容警告器記憶體損毀弱點 (CAN-2005-0555)。
