...
-   Microsoft Windows 2000 Service Pack 4 – [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=261a7d4d-90fc-4529-9c4a-b630196c6a83)
-   Microsoft Windows XP Service Pack 1 和 Microsoft Windows XP Service Pack 2 – [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=4c1c2c16-99e7-4701-a3f8-65b803b8b881)
-   Microsoft Windows Server 2003 和 Microsoft Windows Server 2003 Service Pack 1 – [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=8ab86ba3-54cd-44d7-8016-de6e3ed51021)
...
-   [適用於 Netware 的 Windows 服務](http://www.microsoft.com/windows2000/sfn/default.mspx)
...
|--------------------------------------------------------------------------------------------------------------------|----------------|--------------|------------|---------------------|------------------------------------|
| Client Service for NetWare 弱點 - [CAN-2005-1985](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1985) | 遠端執行程式碼 | 重要         | 重要       | 重要                | 重要                               |
...
是。 SMS 能協助偵測及部署本安全性更新。 如需關於 SMS 的詳細資訊，請造訪 [SMS 網站](http://www.microsoft.com/taiwan/smserver/)。 若要偵測 Microsoft Windows 及其他受影響的 Microsoft 產品，需要使用安全性更新盤點工具 (Security Update Inventory Tool)。 如需更多關於安全性更新盤點工具 (Security Update Inventory Tool) 的資訊，請造訪下列 [SMS 網站](http://www.microsoft.com/taiwan/smserver/)。 如需更多關於安全性更新盤點工具 (Security Update Inventory Tool) 的使用限制資訊，請參閱 [Microsoft 知識庫文件編號 306460](http://support.microsoft.com/kb/306460)。您可以使用 SMS 的[目錄與軟體發佈](http://go.microsoft.com/fwlink/?linkid=33333)功能以部署此更新。
...
**注意：**CSNW 常與網際網路封包交換 (IPX) 和循序封包交換 (SPX) 等通訊協定有關聯。 但是，CSNW 可以透過任何已安裝的通訊協定，而被利用。 因為 TCP/IP 是最廣為使用的通訊協定，因此下列的因應措施是以 TCP/IP 為根據。 若 IPX 和 SPX 等通訊協定也在使用中，您也應該針對這些通訊協定封鎖適當的連接埠。 如需更多關於 IPX 和 SPX 的資訊，請造訪下列 [Microsoft 網站](http://microsoft.com/resources/documentation/windows/xp/all/reskit/en-us/prch_cnn_goue.asp) (英文)。
...
-   **在防火牆中封鎖 TCP 連接埠 139 和 445：**
    ...
    上述連接埠用於起始與受影響元件的連線。 在企業防火牆封鎖上述連接埠 (含輸入及輸出) 有助於保護防火牆後的系統免遭此弱點的影響。 建議您封鎖所有網際網路中來路不明的輸入通訊，以防他人利用其他連接埠攻擊系統。 如需更多關於連接埠的資訊，請造訪這個[網站](http://go.microsoft.com/fwlink/?linkid=21312)。
