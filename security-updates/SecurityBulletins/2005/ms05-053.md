...
|---------------------------------------------------------------------------------------------------------|----------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| 圖形轉譯引擎弱點 - [CAN-2005-2123](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-2123)     | 遠端執行程式碼 | 重大         | 重大                      | 重大                      | 重大                | 重大                               |
| Windows 中繼檔案弱點 - [CAN-2005-2124](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-2124) | 遠端執行程式碼 | 重大         | 重大                      | 無                        | 重大                | 無                                 |
| 增強型中繼檔案弱點 - [CAN-2005-0803](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-0803)   | 拒絕服務       | 中度         | 中度                      | 無                        | 中度                | 無                                 |
...
-   [eEye Digital Security](https://www.eeye.com/html/) 回報中繼檔案弱點 (CAN-2005-2123)。
-   [Venustech AdDLab](https://www.venustech.com.cn)、[eEye Digital Security](https://www.eeye.com/html/) 與 [Symantec Security Response](https://securityresponse.symantec.com) 的 Peter Ferrie 回報 Windows 中繼檔案弱點 (CAN-2005-2124)。
