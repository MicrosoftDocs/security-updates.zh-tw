...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">色彩管理模組弱點 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1219">CAN-2005-1219</a></td>
...
**何謂 Microsoft 色彩管理模組？**  
Microsoft 色彩管理模組允許作業系統在不同的服務及應用程式之間，提供一致的色彩對應。此外，可使用本模組將色彩從某個色彩空間轉換為另一色彩空間 (例如，從 RGB 轉換為 CMYK)。如需關於色彩管理的其他資訊，請造訪這個[網站](https://www.microsoft.com/whdc/device/display/color/icmwp.mspx)
  
**何謂 International Color Consortium (ICC)？**  
International Color Consortium 是一個組織，宗旨是提供一套標準，讓廠商能實作色彩管理，確保跨廠商相容性。如需關於 International Color Consortium (ICC) 的其他資訊，請造訪這個[網站](https://www.color.org/)
...
-   [Information & Communication Security Technology Center (ICST)](https://www.icst.org.tw) 的 Shih-hao Weng 回報色彩管理模組弱點 (CAN-2005-1219)。
