...
-   Microsoft Windows XP Service Pack 1 – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=91488ddd-1d7e-4277-916a-d5f2ee0b6327) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=91488ddd-1d7e-4277-916a-d5f2ee0b6327)。
-   Microsoft Windows XP 64-Bit Edition Service Pack 1 (Itanium) – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=1dc37a74-bf1e-4afe-8198-d5ca460a3872)。
-   Microsoft Windows XP 64-Bit Edition Version 2003 (Itanium) – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=2024382a-14a9-4231-8835-e2720c562190)。
-   Microsoft Windows Server 2003 – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=b7097610-8aab-4a2f-94c9-18d32e1c297c) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=b7097610-8aab-4a2f-94c9-18d32e1c297c)。
-   Microsoft Windows Server 2003 for Itanium-based Systems – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=2024382a-14a9-4231-8835-e2720c562190)。
...
|---------------------------------------------------------------------------------------------------|----------------|---------------------------|---------------------|
| 網路用戶端弱點 - [CAN-2005-1207](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1207) | 遠端執行程式碼 | 重要                      | 中度                |
...
是。 SMS 能協助偵測及部署本安全性更新。 如需關於 SMS 的詳細資訊，請造訪 [SMS 網站](https://www.microsoft.com/taiwan/smserver/default.htm)。 您可以使用 SMS 的[目錄與軟體發佈](https://go.microsoft.com/fwlink/?linkid=33333)功能以部署此更新。
...
-   《[Windows Server 2003 安全性指南](https://www.microsoft.com/technet/security/prodtech/windowsserver2003/w2003hg/sgch00.mspx)》(英文) 建議停用網路用戶端服務。 遵守這些指導方針的環境，可以降低這項弱點所產生的風險。
...
如果停用**網路用戶端**服務，您無法使用網頁發佈精靈，將資料發佈到網際網路上使用 WebDAV 通訊協定的位置。 如果停用這項服務，任何明確依賴這項服務的服務將不能啟動。 如需更多關於 WebDAV 的資訊，請參閱下列[產品說明文件](https://www.microsoft.com/windows2000/en/server/iis/default.asp?url=/windows2000/en/server/iis/htm/core/wcwdcp.htm)。
...
-   [Next Generation Security Software Ltd.](https://www.ngssoftware.com/) 的 Mark Litchfield 回報網路用戶端弱點 (CAN-2005-1207)。
