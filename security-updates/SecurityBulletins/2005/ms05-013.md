...
**警告：**[Microsoft 知識庫文件編號 891781](https://support.microsoft.com/kb/891781) 詳細記錄了目前已知安裝此安全性更新後可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。 如需更多資訊，請參閱 [Microsoft 知識庫文件編號 891781](https://support.microsoft.com/kb/891781)。

**已測試軟體及安全性更新下載位置：**

**受影響的軟體：**

-   Microsoft Windows 2000 Service Pack 3 和 Microsoft Windows 2000 Service Pack 4 – 下載更新程式 [中文版](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=aea07cba-0e2b-4a22-91ed-1d23bb012c04) | [英文版](https://www.microsoft.com/download/details.aspx?familyid=aea07cba-0e2b-4a22-91ed-1d23bb012c04)
-   Microsoft Windows XP Service Pack 1 和 Microsoft Windows XP Service Pack 2 – 下載更新程式 [中文版](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=9490e7d2-03c2-463a-b3d0-b949f5295208) | [英文版](https://www.microsoft.com/download/details.aspx?familyid=9490e7d2-03c2-463a-b3d0-b949f5295208)
-   Microsoft Windows XP 64-Bit Edition Service Pack 1 (Itanium) – 下載更新程式 [英文版](https://www.microsoft.com/download/details.aspx?familyid=9e0247b8-240e-416c-9586-acd5ef8578de)
-   Microsoft Windows XP 64-Bit Edition Version 2003 (Itanium) – 下載更新程式 [英文版](https://www.microsoft.com/download/details.aspx?familyid=2ce98263-2ab4-4fe3-8b0b-5b3155119730)
-   Microsoft Windows Server 2003 – 下載更新程式 [中文版](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=e99f5bdd-8ea8-4837-960e-0d20dea9ac4d) | [英文版](https://www.microsoft.com/download/details.aspx?familyid=e99f5bdd-8ea8-4837-960e-0d20dea9ac4d)
-   Microsoft Windows Server 2003 for Itanium-based Systems – 下載更新程式 [英文版](https://www.microsoft.com/download/details.aspx?familyid=2ce98263-2ab4-4fe3-8b0b-5b3155119730)
...
|----------------------------------------------------------------------------------------------------------------------------|----------------|-----------------------|--------------|------------|---------------------------|---------------------|
| DHTML 編輯元件 ActiveX 控制項跨網域弱點 - [CAN-2004-1319](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2004-1319) | 遠端執行程式碼 | 重大                  | 重大         | 重大       | 重要                      | 中度                |
...
是。 這項弱點會對 Windows 98、Windows 98 Second Edition 或 Windows Millennium Edition 帶來重大的影響。 本安全性公告中含有這些平台的重大安全性更新，僅可從 [Windows Update 網站](https://go.microsoft.com/fwlink/?linkid=21130)下載。 如需更多有關嚴重性等級的資訊，請造訪這個[網站](https://technet.microsoft.com/security/bulletin/rating)
...
-   斯洛維尼亞文 – [下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=e418a1bd-5520-47d7-9ac0-6237ffcae629&displaylang=sl)
-   斯洛伐克文 – [下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=e418a1bd-5520-47d7-9ac0-6237ffcae629&displaylang=sk)
...
[Internet Explorer 增強式安全性設定](https://msdn.microsoft.com/library/default.asp?url=/workshop/security/szone/overview/esc_changes.asp)，是一組預先設定好的 Internet Explorer 設定，可以降低使用者或系統管理員在伺服器下載及執行惡意網頁內容的可能性。 Internet Explorer 增強式安全性設定降低風險的方法，是修改多項安全性相關的設定。 包括 \[網際網路選項\] 對話方塊中的 \[安全性\] 及 \[進階\] 索引標籤設定。 其中較重要的修改項目包括：
...
**注意：**2004 年 4 月 20 日之後，新的安全性公告資料將不再更新 MBSA 1.1.1 及更早版本所使用的 Mssecure.xml 檔。 因此，於該日期之後運用 MBSA 1.1.1 或更早版本進行的任何掃描，都不會具有完整效果。 所有的使用者都應該升級至 MBSA 1.2，因為此版本能提供較為精確的安全性更新偵測，並且能支援其他的產品。 使用者可以由 [MBSA 網站](https://go.microsoft.com/fwlink/?linkid=21134) (英文) 下載 MBSA 1.2.1。 如需更多有關 MBSA 支援的資訊，請造訪 [Microsoft Baseline Security Analyzer 1.2.1 Q&A 網站](https://go.microsoft.com/fwlink/?linkid=33332)。
...
-   依預設，Windows Server 2003 的 Internet Explorer 會以稱為「增強式安全性設定」的受限制模式執行。 此模式可緩和這項弱點。 如需更多資訊，請參閱此安全性更新＜常見問題集＞關於 [Internet Explorer 增強式安全性設定](https://msdn.microsoft.com/library/default.asp?url=/workshop/security/szone/overview/esc_changes.asp)的部分。
...
-   **如果您使用的是 Outlook Express 5.5 SP2，請安裝 Microsoft 安全性公告 MS04-018 中描述的更新。**
    ...
    使用 Outlook Express 5.5 Service Pack 2 並已安裝 Microsoft 安全性公告 [MS04-018](https://www.microsoft.com/taiwan/security/bulletin/ms04-018.mspx) 的客戶可降低受到電子郵件式攻擊的風險；這類攻擊僅在使用者按一下電子郵件訊息中的惡意連結時才會奏效。
...
-   **暫時不讓 DHTML 編輯元件 ActiveX 控制項在 Internet Explorer 中執行。**
    ...
    **警告：**如果使用「登錄編輯程式」的方式錯誤，可能會造成嚴重問題，以致於必須重新安裝作業系統。 Microsoft 無法保證您在錯誤使用「登錄編輯程式」之後，能解除所導致的問題。 如要使用「登錄編輯程式」，請自行負擔相關的風險。
    ...
    如需有關停止 ActiveX 控制項在 Internet Explorer 執行的詳細步驟說明，請參閱 [Microsoft 知識庫文件編號 240797](https://support.microsoft.com/kb/240797)。 請按照該文件的步驟，在登錄中建立相容性旗標 DWORD 值，藉此避免在 Internet Explorer 中產生受影響的控制項
