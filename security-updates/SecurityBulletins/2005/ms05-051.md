...
-   [eEye Digital Security](https://www.eeye.com/html/) 回報 MSDTC 弱點 (CAN-2005-2119)。
-   [Application Security Inc.](https://www.appsecinc.com/) 的 Cesar Cerrudo 回報 COM+ 弱點 (CAN-2005-1978)。
-   [iDefense](https://www.idefense.com) 回報 TIP 弱點 (CAN-2005-1979) 以及分散式 TIP 弱點 (CAN-2005-1780)。
