---
TOCTitle: 'MS17-023'
Title: 'Microsoft 資訊安全公告 MS17-023 - 重大'
ms:assetid: 'ms17-023'
ms:contentKeyID: 74430827
ms:date: '03/10/2017'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms17-023(v=Security.10)'
---

Microsoft 資訊安全公告 MS17-023 - 重大
======================================

Adobe Flash Player 的安全性更新 (4014329)
-----------------------------------------
...
如需有關此更新的詳細資訊，請參閱 [Microsoft 知識庫文章 4014329](https://support.microsoft.com/zh-tw/kb/4014329)。

弱點資訊
--------

<span id="sectionToggle1"></span>
安全性更新可修正下列弱點，詳情請參閱 Adobe 資訊安全公告 [APSB17-07](https://helpx.adobe.com/tw/security/products/flash-player/apsb17-07.html)。
...
<sup>[2]</sup>適用於 Windows 10 更新的 Adobe Flash Player 更新可透過 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 或 [Microsoft Update Catalog](https://catalog.update.microsoft.com/v7/site/home.aspx) 取得。
...
-   **防止 Adobe Flash Player 在受影系統中的 Office 2010 執行**
    ...
    **警告**如果使用 \[登錄編輯程式\] 的方式錯誤，可能造成嚴重問題，以致於您必須重新安裝作業系統。Microsoft 無法保證可以解決您不當使用 \[登錄編輯程式\] 所導致的問題。請自行承擔使用 \[登錄編輯程式\] 的風險。
    ...
    如需避免控制項在 Internet Explorer 中執行的詳細步驟，請參閱 [Microsoft 知識庫文章 240797](https://technet.microsoft.com/zh-tw/library/cc179076.aspx)。按照文章中的步驟，在登錄中建立 Compatibility Flags 值，以避免在 Internet Explorer 中產生 COM 物件。
