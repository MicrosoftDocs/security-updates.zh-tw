...
<td style="border:1px solid black;">
[**Win32k 權限提高弱點 – CVE-2017-0024**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2017-0024)

</td>
<td style="border:1px solid black;">
[**Win32k 權限提高弱點 – CVE-2017-0026**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2017-0026)

</td>
<td style="border:1px solid black;">
[**Win32k 權限提高弱點 - CVE-2017-0056**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2017-0056)

</td>
<td style="border:1px solid black;">
[**Win32k 權限提高弱點 – CVE-2017-0078**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2017-0078)
...
<tr>
<td style="border:1px solid black;">
[適用於 32 位元系統的 Windows Server 2008 Service Pack 2](https://catalog.update.microsoft.com/v7/site/search.aspx?q=kb4012497)  
(4012497)
...
<tr>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 Service Pack 2](https://catalog.update.microsoft.com/v7/site/search.aspx?q=kb4012497)  
(4012497)
...
<tr>
<td style="border:1px solid black;">
[適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2](https://catalog.update.microsoft.com/v7/site/search.aspx?q=kb4012497)  
(4012497)
...
<tr>
<td style="border:1px solid black;">
[32 位元系統的 Windows Server 2008 Service Pack 2](https://catalog.update.microsoft.com/v7/site/search.aspx?q=kb4012497) (Server Core 安裝)  
(4012497)
...
<tr>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 Service Pack 2](https://catalog.update.microsoft.com/v7/site/search.aspx?q=kb4012497) (Server Core 安裝)  
(4012497)
...
<td style="border:1px solid black;">
[**Win32k 權限提高弱點 – CVE-2017-0079**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2017-0079)

</td>
<td style="border:1px solid black;">
[**Win32k 權限提高弱點 – CVE-2017-0080**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2017-0080)

</td>
<td style="border:1px solid black;">
[**Win32k 權限提高弱點 - CVE-2017-0081**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2017-0081)

</td>
<td style="border:1px solid black;">
[**Win32k 權限提高弱點 – CVE-2017-0082**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2017-0082)
...
安全性更新 4012497 同時公告於 [MS17-013](https://go.microsoft.com/fwlink/?linkid=842210)，是針對受支援版本的 Windows Vista 和 Windows Server 2008，因為弱點修正程式對於特定產品有整合性的影響。因為公告是依據它們所解決的弱點來細分，而不是依據發行的更新套件細分，所以各自解決不同弱點的個別公告可能會列在相同的更新套件中，做為提供其個別修正的媒介。這種情況常見於如 Internet Explorer 或 Silverlight 等產品的累積更新，其中單一更新解決在個別公告中不同的資訊安全漏洞。
