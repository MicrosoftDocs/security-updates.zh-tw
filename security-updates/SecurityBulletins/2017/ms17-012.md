...
<td style="border:1px solid black;">
[**Device Guard 安全性功能略過弱點 - CVE-2017-0007**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2017-0007)

</td>
<td style="border:1px solid black;">
[**SMBv2/SMBv3 Null 取值阻斷服務弱點 - CVE-2017-0016**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2017-0016)

</td>
<td style="border:1px solid black;">
[**Windows DLL 載入遠端執行程式碼弱點 - CVE-2017-0039**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2017-0039)

</td>
<td style="border:1px solid black;">
[**Windows DNS 查詢資訊洩漏弱點 – CVE-2017-0057**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2017-0057)

</td>
<td style="border:1px solid black;">
[**Windows COM 權限提高弱點 - CVE-2017-0100**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2017-0100)

</td>
<td style="border:1px solid black;">
[**iSNS Server 記憶體損毀弱點 - CVE-2017-0104**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2017-0104)
...
<tr>
<td style="border:1px solid black;">
[適用於 32 位元系統的 Windows Server 2008 Service Pack 2](https://catalog.update.microsoft.com/v7/site/search.aspx?q=kb3217587)  
(3217587)
...
<tr>
<td style="border:1px solid black;">
[適用於 32 位元系統的 Windows Server 2008 Service Pack 2](https://catalog.update.microsoft.com/v7/site/search.aspx?q=kb4012021)  
(4012021)
...
<tr>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 Service Pack 2](https://catalog.update.microsoft.com/v7/site/search.aspx?q=kb3217587)  
(3217587)
...
<tr>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 Service Pack 2](https://catalog.update.microsoft.com/v7/site/search.aspx?q=kb4012021)  
(4012021)
...
<tr>
<td style="border:1px solid black;">
[適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2](https://catalog.update.microsoft.com/v7/site/search.aspx?q=kb3217587)  
(3217587)
...
<tr>
<td style="border:1px solid black;">
[32 位元系統的 Windows Server 2008 Service Pack 2](https://catalog.update.microsoft.com/v7/site/search.aspx?q=kb3217587) (Server Core 安裝)  
(3217587)
...
<tr>
<td style="border:1px solid black;">
[x64 型系統的 Windows Server 2008 Service Pack 2](https://catalog.update.microsoft.com/v7/site/search.aspx?q=kb3217587) (Server Core 安裝)  
(3217587)
...
-   **為 IMJPTIP 設定刪除位元**
    ...
    如需避免控制項在 Internet Explorer 中執行的詳細步驟，請參閱 [Microsoft 知識庫文章 240797](https://support.microsoft.com/zh-tw/kb/240797)。按照本文中的步驟，在登錄中建立 Compatibility Flags 值，以避免在 Internet Explorer 中產生 COM 物件。
