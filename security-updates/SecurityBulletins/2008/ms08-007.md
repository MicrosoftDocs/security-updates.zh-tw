...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-0080](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0080)。
...
-   感謝 [COSEINC Vulnerability Research Lab](http://www.coseinc.com/) 的 Steven 回報 WebDAV Mini-Redirector 堆積溢位弱點 (CVE-2008-0080)。
