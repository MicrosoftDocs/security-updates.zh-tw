...
**已知問題。** [Microsoft 知識庫文件編號 941693](http://support.microsoft.com/kb/941693) 詳細記錄了目前已知解除安裝此安全性更新可能會發生的問題。
...
[Microsoft 知識庫文件編號 941693](http://support.microsoft.com/kb/941693) 詳細記錄了目前已知解除安裝此安全性更新可能會發生的問題。 MS08-025 (核心) 和 MS08-021 (GDI) 所提供的安全性更新之間有共用的二進位檔案。 若安裝這兩個安全性更新 (MS08-025 與 MS08-021) 之後再解除安裝 MS08-025 (核心) 所提供的更新，則 MS08-021 (GDI) 所提供的更新可能會還原回易受影響的版本，這樣的話會導致 MS08-021 (GDI) 更新被重新提供到易受影響的系統。
  
**何處可找到檔案資訊詳細資料？**    
檔案資訊詳細資訊可在 [Microsoft 知識庫文件編號 941693](http://support.microsoft.com/kb/941693)中找到。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-1084](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1084)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/941693">Microsoft 知識庫文件編號 941693</a></td>
</tr>
<tr class="even">
...
-   感謝 [SkyRecon](http://www.skyrecon.com/) 的 Thomas Garnier 回報 Windows 核心弱點 (CVE-2008-1084)。
