...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2b498065-d682-4227-b23e-d234d7d6a3fe">Microsoft Internet Information Services 5.1 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=2b498065-d682-4227-b23e-d234d7d6a3fe">Microsoft Internet Information Services 5.1 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms06-034">MS06-034</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=df9875f7-04d6-486e-bdb5-35e9e305fa1d">Microsoft Internet Information Services 6.0 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms06-034">MS06-034</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=6583e798-d16d-419c-aee1-30c3e6c635b3">Microsoft Internet Information Services 6.0 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=6583e798-d16d-419c-aee1-30c3e6c635b3">Microsoft Internet Information Services 6.0 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms06-034">MS06-034</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e8286174-8209-409f-8805-e534715a741c">Microsoft Internet Information Services 6.0 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=e8286174-8209-409f-8805-e534715a741c">Microsoft Internet Information Services 6.0 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms06-034">MS06-034</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=29faa70d-f1ac-4da4-b72a-faf1973cd845">Microsoft Internet Information Services 6.0 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms06-034">MS06-034</a></td>
</tr>
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-0075](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-5357)。
...
**攻擊者可能會利用這項弱點採取什麼行動？**  
成功利用此弱點的攻擊者，接著可能會以與工作者處理序識別 (WPI) 相同的權限，在 IIS 伺服器上執行動作；WPI 預設使用網路服務帳戶權限設定。 利用網路服務帳戶權限所設定的服務可取得已驗證的使用者等級存取權，而非管理等級存取權。 如需更多資訊，請參閱 [NetworkService 帳戶](https://msdn2.microsoft.com/en-us/library/ms684272(vs.85).aspx)。 以 WPI (使用具備系統管理權限的帳戶) 設定應用程式集區的 IIS 伺服器，相較於以預設 WPI 設定來設定應用程式集區的 IIS 伺服器，可能會產生更嚴重的影響。
  
當網路服務帳戶從遠端驗證時會使用電腦的認證，但是伺服器本身的權限層級會大幅降低，因此沒有本機系統管理員權限。 如需更多資訊，請參閱[網路服務帳戶](https://msdn2.microsoft.com/en-us/library/ms684272(vs.85).aspx) (英文)、[IIS 和內建帳戶 (IIS 6.0)](https://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/iis/3648346f-e4f5-474b-86c7-5a86e85fa1ff.mspx) (英文)、[設定工作者處理序識別 (IIS 6.0)](https://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/iis/76be66e2-1db1-432e-95be-14ff59c2ec75.mspx) (英文) 及[設定 IIS 6.0 應用程式集區 (IIS 6.0)](https://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/iis/2a231dcb-d786-4b6d-b3ba-bda04061a5e7.mspx) (英文)。
  
**攻擊者如何利用這項弱點？**  
攻擊者可以把蓄意製作的輸入內容傳給 ASP 網頁。 ASP 網頁可能已經存在，或可能由使用者在主控環境中上載。
  
**IIS 工作者處理序是什麼？**  
工作者處理序是針對 Web 伺服器執行伺服器端處理工作的程序**。** 如需工作者處理序及其如何在 IIS 6.0 中實作的資訊，請參閱[工作者處理序 (IIS 6.0)](https://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/iis/29f53968-0115-451f-b26d-5ad58d87b5d1.mspx) (英文)。 工作者處理序及其如何獨立執行 Web 應用程式的其他資訊，請參閱[工作者處理序隔離模式 (IIS 6.0)](https://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/iis/333f3410-b566-49bc-8399-57bcc404db8c.mspx) (英文)。
