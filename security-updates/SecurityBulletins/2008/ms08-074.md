---
TOCTitle: 'MS08-074'
Title: 'Microsoft Security Bulletin MS08-074 - 重大'
ms:assetid: 'ms08-074'
ms:contentKeyID: 61238265
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms08-074(v=Security.10)'
---



Microsoft Security Bulletin MS08-074 - 重大
===========================================

Microsoft Office Excel 的弱點可能會允許遠端執行程式碼 (959070)
--------------------------------------------------------------
...
對於所有受支援版本的 Microsoft Office Excel 2000，此安全性更新的等級為重大。對於所有受支援版本的 Microsoft Office Excel 2002、Microsoft Office Excel 2003、Microsoft Office Excel Viewer 2003、Microsoft Office Excel 2007、Microsoft Office Compatibility Pack、Microsoft Office Excel Viewer、Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac 和 Open XML File Format Converter for Mac，此安全性更新的等級為重大。 如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此安全性更新透過修改 Microsoft Office Excel 開啟 Excel 檔案之方式解決這些弱點。 如需更多有關弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。

**建議。** Microsoft 建議客戶立即套用此更新。

**已知問題。** [Microsoft 知識庫文件編號 959070](https://support.microsoft.com/kb/959070) 中有記載目前已知安裝此安全性更新後，可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2000 Service Pack 3(英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=f39d2a49-f861-4f2d-bf91-94a8a85af40c)  
(KB958435)  
[Microsoft Office Excel 2000 Service Pack 3(中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=f39d2a49-f861-4f2d-bf91-94a8a85af40c)  
(KB958435)
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2002 Service Pack 3(英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=72076e21-2aa3-48e8-883a-c3cb756fc72a)  
(KB958372)  
[Microsoft Office Excel 2002 Service Pack 3(中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=72076e21-2aa3-48e8-883a-c3cb756fc72a)  
(KB958372)
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2003 Service Pack 3(英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=6c0771e5-fcd4-4365-b903-1a3bd95d9e66)  
(KB958436)  
[Microsoft Office Excel 2003 Service Pack 3(中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=6c0771e5-fcd4-4365-b903-1a3bd95d9e66)  
(KB958436)
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2007(英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=68bb8d99-f28b-4efd-9314-3eee0bb00ccf)  
(KB958437)\*  
[Microsoft Office Excel 2007(中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=68bb8d99-f28b-4efd-9314-3eee0bb00ccf)  
(KB958437)\*
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2007 Service Pack 1(英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=68bb8d99-f28b-4efd-9314-3eee0bb00ccf)  
(KB958437)\*  
[Microsoft Office Excel 2007 Service Pack 1(中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=68bb8d99-f28b-4efd-9314-3eee0bb00ccf)  
(KB958437)\*
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office Excel Viewer 2003(英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=4b3989ef-02b8-4bd2-b2ab-c3716079936e)  
(KB958434)  
[Microsoft Office Excel Viewer 2003(中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=4b3989ef-02b8-4bd2-b2ab-c3716079936e)  
(KB958434)
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office Excel Viewer 2003 Service Pack 3(英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=4b3989ef-02b8-4bd2-b2ab-c3716079936e)  
(KB958434)  
[Microsoft Office Excel Viewer 2003 Service Pack 3(中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=4b3989ef-02b8-4bd2-b2ab-c3716079936e)  
(KB958434)
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office Excel Viewer(英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=9dbb35c1-aa7a-481b-a330-8ba916ddd443)  
(KB958442)  
[Microsoft Office Excel Viewer(中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=9dbb35c1-aa7a-481b-a330-8ba916ddd443)  
(KB958442)
...
<tr>
<td style="border:1px solid black;">
[適用於 Word、Excel 及 PowerPoint 2007 檔案格式的 Microsoft Office 相容性套件(英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=99cca4ed-f1f9-4cfd-a986-edbec82ced4f)  
(KB958439)  
[適用於 Word、Excel 及 PowerPoint 2007 檔案格式的 Microsoft Office 相容性套件(中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=99cca4ed-f1f9-4cfd-a986-edbec82ced4f)  
(KB958439)
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office Compatibility Pack for Word, Excel, and PowerPoint 2007 File Formats Service Pack 1(英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=99cca4ed-f1f9-4cfd-a986-edbec82ced4f)  
(KB958439)  
[Microsoft Office Compatibility Pack for Word, Excel, and PowerPoint 2007 File Formats Service Pack 1(中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=99cca4ed-f1f9-4cfd-a986-edbec82ced4f)  
(KB958439)
...
\*針對 Microsoft Office Excel 2007 和 Microsoft Office Excel 2007 Service Pack 1，除了安全性更新套件 KB958437 外，客戶也需安裝[適用於 Word、Excel 及 PowerPoint 2007 檔案格式的 Microsoft Office 相容性套件](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=99cca4ed-f1f9-4cfd-a986-edbec82ced4f)的安全性更新 (KB958439)，以免受此公告中描述的弱點影響。 已成功安裝 KB958437 和 KB958439 更新套件的客戶不必重新安裝。
...
**為何於 2009 年 1 月 28 日修訂此公告？**      
Microsoft 修訂此公告，以說明針對 Microsoft Office Excel 2007 的支援版本，除了安全性更新套件 KB958437 外，客戶也需安裝[適用於 Word、Excel 及 PowerPoint 2007 檔案格式的 Microsoft Office 相容性套件](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=99cca4ed-f1f9-4cfd-a986-edbec82ced4f)的安全性更新 (KB958439)，以免受此公告中描述的弱點影響。 已成功安裝 KB958437 和 KB958439 安全性更新套件的客戶不必重新安裝。

**Excel 2007 為什麼需要更新 KB958439** ？ 
Microsoft Office Excel 2007 支援版本包含內含弱點的 Excel 轉換程式元件，此由適用於 Word、Excel 及 PowerPoint 2007 檔案格式的 Microsoft Office 相容性套件的更新程式 (KB958439) 所更新。 Microsoft Office Excel 2007 和 Microsoft Office Excel 2007 Service Pack 1 的更新程式 (KB958437) 不會更新 Excel 轉換程式元件。

**何處可找到檔案資訊詳細資料？**      
檔案資訊詳細資料請參閱 [Microsoft 知識庫文件編號 959070](https://support.microsoft.com/kb/959070)。

**MS08-072 也有描述 Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac 和 Open XML File Format Converter for Mac 中的弱點。 MS08-072 與此公告 (MS08-074) 有何關聯？**      
Microsoft Office 2004 for Mac (960402)、Microsoft Office 2008 for Mac (960401) 和 Open XML File Format Converter for Mac (960403) 的安全性更新，也可以解決 MS08-072 所描述的弱點。已安裝 Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac 或 Open XML File Format Converter for Mac 的使用者，必須安裝這項安全性更新，但只要安裝一次即可。
...
<th style="border:1px solid black;" >檔案格式剖析弱點 - CVE-2008-4265</th>
<th style="border:1px solid black;" >檔案格式剖析弱點 - CVE-2008-4264</th>
<th style="border:1px solid black;" >Excel 全域陣列記憶體損毀弱點 - CVE-2008-4266</th>
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-4265](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4265)。
  
#### 檔案格式剖析弱點 CVE-2008-4265 的緩和因素
...
#### 檔案格式剖析弱點 CVE-2008-4265 的因應措施
  
因應措施指的是無法徹底修正弱點，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。 Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：
  
-   對於來自於不受信任的來源或在非預期情況下從信任來源收到的 Microsoft Office 檔案，請勿輕易開啟或儲存。 當使用者開啟蓄意製作的檔案時，即可能遭受利用此弱點的攻擊。
  
#### 檔案格式剖析弱點 CVE-2008-4265 的常見問題集
  
**這個弱點的範圍為何？**        
這是遠端執行程式碼的弱點。 成功利用此弱點的攻擊者可以從遠端取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，或檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個弱點的原因為何？**        
當受影響 Excel 版本的使用者開啟由攻擊者所提供之蓄意製作的 Excel 試算表時，Microsoft Office Excel 中存在可允許攻擊者執行程式碼的弱點。 Microsoft Office Excel 剖析 Excel 試算表檔案格式的方式中存在特定弱點。
...
**更新的作用何在？**        
此更新程式改變了 Microsoft Office Excel 對於開啟蓄意製作之 Excel 檔案的處理方式，藉以移除弱點。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-4264](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4264)。
  
#### 檔案格式剖析弱點 CVE-2008-4264 的緩和因素
...
Excel 全域陣列記憶體損毀弱點 - CVE-2008-4266  
--------------------------------------------
  
 
由於堆疊損毀，導致 Microsoft Office Excel 在載入 Excel 記錄時存在遠端執行程式碼的弱點。 如果使用者開啟蓄意製作、其中含有格式錯誤物件的 Excle 檔案，此弱點可能會允許遠端執行程式碼。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-4266](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4266)。
  
#### Excel 全域陣列記憶體損毀弱點 CVE-2008-4266 的緩和因素
...
#### Excel 全域陣列記憶體損毀弱點 CVE-2008-4266 的因應措施
  
因應措施指的是無法徹底修正弱點，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。 Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：
  
-   對於來自於不受信任的來源或在非預期情況下從信任來源收到的 Microsoft Office 檔案，請勿輕易開啟或儲存。 當使用者開啟蓄意製作的檔案時，即可能遭受利用此弱點的攻擊。
  
#### Excel 全域陣列記憶體損毀弱點 CVE-2008-4266 的常見問題集
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/959070">Microsoft 知識庫文件編號 959070</a></td>
</tr>
<tr class="even">
...
-   感謝 [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Joshua J. Drake 回報檔案格式剖析弱點 (CVE-2008-4265)  
-   感謝 [signedness.org](https://www.signedness.org/) 的 Claes M Nyberg 回報檔案格式剖析弱點 (CVE-2008-4264)  
-   感謝 [Secunia](https://secunia.com/) 的 Dyon Balding 回報 Excel 全域陣列記憶體損毀弱點 (CVE-2008-4266)
...
-   V2.0 (2009 年 2 月 03 日)： ＜受影響的軟體＞表新增註腳，而＜與本安全性更新相關的常見問題集＞章節則新增兩個項目，內容與 Microsoft Office Excel 2007 支援版本的安全性更新 KB958437 和 KB958439 相關。安全性更新二進位檔案或偵測沒有變更。 具有 Microsoft Office Excel 2007 或 Microsoft Office Excel 2007 Service Pack 1，且已成功安裝 KB958437 和 KB958439 的客戶不必重新安裝。
