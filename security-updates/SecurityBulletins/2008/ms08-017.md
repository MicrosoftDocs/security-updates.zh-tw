...
<td style="border:1px solid black;">
[Microsoft Office Web Components 2000 (英文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=806c654a-35e3-4385-855a-4b803249bfcf)  
(KB931660)  
[Microsoft Office Web Components 2000 (中文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&familyid=806c654a-35e3-4385-855a-4b803249bfcf)  
(KB931660)
...
<td style="border:1px solid black;">
[Microsoft Office Web Components 2000 (英文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=f54d2a5e-c0ed-4f70-9746-38dd61c8e9d7)  
(KB932031)  
[Microsoft Office Web Components 2000 (中文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&familyid=f54d2a5e-c0ed-4f70-9746-38dd61c8e9d7)  
(KB932031)
...
<td style="border:1px solid black;">
[Microsoft Office Web Components 2000 (英文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=d71b23fa-a873-406d-bad7-e38e565dee39)  
(KB933367)  
[Microsoft Office Web Components 2000 (中文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&familyid=d71b23fa-a873-406d-bad7-e38e565dee39)  
(KB933367)
...
<td style="border:1px solid black;">
[Microsoft Office Web Components 2000 (英文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=2fe10ccd-40cb-4090-b83d-eae3d4eca174)  
(KB933369)  
[Microsoft Office Web Components 2000 (中文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&familyid=2fe10ccd-40cb-4090-b83d-eae3d4eca174)  
(KB933369)
...
<td style="border:1px solid black;">
[Microsoft Office Web Components 2000 (英文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=5fddd54f-7a33-4ea3-b68d-b96a9bae509d&displaylang=en)  
(KB939714)
</td>
<td style="border:1px solid black;">
遠端執行程式碼
...
<td style="border:1px solid black;">
[Microsoft Office Web Components 2000 (英文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=71de76ba-b62c-4a7a-a78a-9317f5255b13)  
(KB941305)
</td>
<td style="border:1px solid black;">
遠端執行程式碼
...
<td style="border:1px solid black;">
[Microsoft Office Web Components 2000 (英文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=526d87bd-c3da-412e-8765-c15987ae9b01)  
(KB948257)
</td>
<td style="border:1px solid black;">
遠端執行程式碼
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2006-4695](http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4695)。
...
-   **避免在 Internet Explorer 中執行 Office Web 元件庫**。
    ...
    **注意：**我們建議您在編輯登錄之前先將之備份。
    ...
    如需避免控制項在 Office Web 元件庫中執行的詳細步驟，請參閱 [Microsoft 知識庫文件編號 240797](http://support.microsoft.com/kb/240797)。依照文件的步驟，在登錄中建立相容性旗標值，以避免執行 Office Web 元件程式庫。
...
**什麼是 Kill Bit (刪除位元)？**    
Kill Bit ( 刪除位元 ) 是避免從 Internet Explorer 啟用 ActiveX 控制項的方法，即使系統上有控制項。 (如需 Kill Bit (刪除位元) 的更多資訊，請參閱 [Microsoft 知識庫文件編號 240797](http://support.microsoft.com/default.aspx?scid=kb;en-us;q240797&id=kb;en-us;q240797))。 通常當安全性弱點涉及 ActiveX 控制項時，安全性更新會提供新控制項，並在容易受到影響的控制項上設定 Kill Bit (刪除位元)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2007-1201](http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-1201)。
...
**更新的作用何在？**    
這個更新程式會設定 Office Web 元件的類別識別項 (CLSID) 清單的 Kill Bit (刪除位元)，藉以解決已知的安全性問題。 為了協助保護客戶，此更新程式可避免在 Internet Explorer 中產生這些 CLSID。 如需有關 Kill Bit (刪除位元) 的詳細資訊，請參閱 [Microsoft 知識庫文件編號 240797](http://support.microsoft.com/default.aspx?scid=kb;en-us;q240797&id=kb;en-us;q240797)。
...
**注意**：您可以在同一個命令中合併使用這些參數。 為符合回溯相容性，安全性更新程式也支援舊版安裝程式使用的安裝參數。 如需有關支援的安裝參數的其他資訊，請參閱 [Microsoft 知識庫文件編號 262841](http://support.microsoft.com/kb/262841)。如需更多關於安裝程式的資訊，請造訪 [Microsoft TechNet 網站](http://go.microsoft.com/fwlink/?linkid=38951)。 如需更多關於出現於本公告中術語的相關資訊 (如 *Hotfix*)，請參閱 [Microsoft 知識庫文件編號 824684](http://support.microsoft.com/kb/824684)。
...
| **重新開機需求**                       |                                                                                                                                                                                                                                                   |  
| 需要重新啟動                           | 若要減少重新開機的可能性，請在安裝安全性更新之前，停止所有受影響的服務，並關閉所有可能使用受影響檔案的應用程式。 有關系統可能會提示您重新開機的原因的更多資訊，請參閱 [Microsoft 知識庫文件編號 887012](http://support.microsoft.com/kb/887012)。 |  
| Hotpatching                            | 不適用                                                                                                                                                                                                                                            |  
...
-   感謝 [VigilantMinds Inc.](http://www.vigilantminds.com) 的 Chris Ries 回報 Office Web 元件 URL 剖析弱點 - (CVE-2006-4695)。  
-   感謝 [NCNIPC](http://www.nipc.org.cn) 的 Xiao Hui 回報 Office Web 元件 URL 剖析弱點 - (CVE-2006-4695)。  
-   感謝 [Finjan](http://www.finjan.com/) 的 Yuval Ben-Itzhak 回報 Office Web 元件資料來源弱點 - (CVE-2007-1201)。
