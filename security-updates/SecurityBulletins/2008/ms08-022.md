---
TOCTitle: 'MS08-022'
Title: 'Microsoft Security Bulletin MS08-022 - 重大'
ms:assetid: 'ms08-022'
ms:contentKeyID: 61238109
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms08-022(v=Security.10)'
---



Microsoft Security Bulletin MS08-022 - 重大
===========================================

VBScript 與 JScript 指令碼引擎中的弱點可能會允許遠端執行程式碼 (944338)
-----------------------------------------------------------------------

發行: 2008年4月8日 | 更新: 2008年8月13日
...
這個安全性更新可解決 Windows 的 VBScript 與 JScript 指令碼引擎中一項未公開報告的弱點。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。

這是適用於所有受支援版本之 Microsoft Windows 2000、Windows XP 及 Windows Server 2003 的重大安全性更新。如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此安全性更新會修正 VBScript 與 JScript 引擎對網頁中指令碼的解碼方式，藉此解決此項弱點。 如需更多有關弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。

**建議。** Microsoft 建議客戶立即套用此更新

**已知問題。** [Microsoft 知識庫文件編號 944338](https://support.microsoft.com/kb/944338) 中有記載目前已知安裝此安全性更新後，可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8e3ff44f-145b-4a68-9ad4-4a55d74b216e">VBScript 5.1 與 JScript 5.1 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=8e3ff44f-145b-4a68-9ad4-4a55d74b216e">VBScript 5.1 與 JScript 5.1 (中文下載更新程式)</a></td>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8e3ff44f-145b-4a68-9ad4-4a55d74b216e">VBScript 5.6 與 JScript 5.6 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=8e3ff44f-145b-4a68-9ad4-4a55d74b216e">VBScript 5.6 與 JScript 5.6 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms06-023">MS06-023</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c0124698-3b94-4474-9473-22a2f39a4a56">VBScript 5.6 與 JScript 5.6 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=c0124698-3b94-4474-9473-22a2f39a4a56">VBScript 5.6 與 JScript 5.6 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms06-023">MS06-023</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=87b80ae3-e299-4d15-a135-3b1bcf943652">VBScript 5.6 與 JScript 5.6 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms06-023">MS06-023</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=88518aa6-e334-4529-aa63-0bf2ef417ce3">VBScript 5.6 與 JScript 5.6 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=88518aa6-e334-4529-aa63-0bf2ef417ce3">VBScript 5.6 與 JScript 5.6 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms06-023">MS06-023</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=12cefefc-8553-4dca-9850-c653371de61e">VBScript 5.6 與 JScript 5.6 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=12cefefc-8553-4dca-9850-c653371de61e">VBScript 5.6 與 JScript 5.6 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms06-023">MS06-023</a></td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=fe22a828-cca4-4b51-bbd5-995c65fead21">VBScript 5.6 與 JScript 5.6 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms06-023">MS06-023</a></td>
</tr>
...
**為何於 2008 年 8 月 13 日修訂此安全性公告？**    
Microsoft 修訂此安全性公告，以宣布重要的已知問題已新增至 [Microsoft 知識庫文件編號 944338](https://support.microsoft.com/kb/944338)。已知問題及其解決方案如下：
  
-   如果系統上已安裝 Windows Internet Explorer 7，則設定問題會導致系統無法收到 VBScript 5.6 和 JScript 5.6 的更新。 解決方案僅為此安全性更新的偵測變更。 已成功更新系統的客戶不需要重新安裝此更新。  
-   在 Microsoft Windows 2000 Service Pack 4 上套用 VBScript 5.1 和 JScript 5.1 的更新後，可能會發生程式庫登錄問題。解決方案為 [Microsoft 知識庫文件編號 944338](https://support.microsoft.com/kb/944338)中所記錄的因應措施。已成功更新系統的客戶不需要重新安裝此更新。
  
**何處可找到檔案資訊詳細資料？**    
檔案資訊詳細資訊可在 [Microsoft 知識庫文件編號 944338](https://support.microsoft.com/kb/944338)中找到。
  
**我使用的是 JScript 5.1 和/或 VBScript 5.1，是否會受影響？**    
是，您的軟體會受影響。 此更新將套用於您的軟體，並且會將版本等級變更為 JScript 5.6 和/或 VBScript 5.6。[Microsoft 知識庫文件編號 944338](https://support.microsoft.com/kb/944338) 中的檔案資訊適用於您的情況。
  
**我使用的版本比本安全性公告中討論的 JScript 5.1 和 VBScript 5.1 軟體舊。 該怎麼辦？**    
...
<th style="border:1px solid black;" >VBScript/JScript 遠端執行程式碼弱點 - CVE-2008-0083</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4 上的 VBScript 5.1 和 JScript 5.1</td>
<td style="border:1px solid black;"><strong>重大</strong><br />
遠端執行程式碼</td>
<td style="border:1px solid black;"><strong>重大</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4 上的 VBScript 5.6 和 JScript 5.6</td>
<td style="border:1px solid black;"><strong>重大</strong><br />
遠端執行程式碼</td>
<td style="border:1px solid black;"><strong>重大</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Windows XP Service Pack 2 上的 VBScript 5.6 和 JScript 5.6</td>
<td style="border:1px solid black;"><strong>重大</strong><br />
遠端執行程式碼</td>
<td style="border:1px solid black;"><strong>重大</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2 上的 VBScript 5.6 和 JScript 5.6</td>
<td style="border:1px solid black;"><strong>重大</strong><br />
遠端執行程式碼</td>
<td style="border:1px solid black;"><strong>重大</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2 上的 VBScript 5.6 和 JScript 5.6</td>
<td style="border:1px solid black;"><strong>重大</strong><br />
遠端執行程式碼</td>
<td style="border:1px solid black;"><strong>重大</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows Server 2003 x64 Edition 和 Windows 2003 Server x64 Edition Service Pack 2 上的 VBScript 5.6 和 JScript 5.6</td>
<td style="border:1px solid black;"><strong>重大</strong><br />
遠端執行程式碼</td>
<td style="border:1px solid black;"><strong>重大</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">適用於 Itanium 型系統的 Windows Server 2003 SP1 和適用於 Itanium 型系統的 Windows Server 2003 SP2 上的 VBScript 5.6 和 JScript 5.6</td>
<td style="border:1px solid black;"><strong>重大</strong><br />
遠端執行程式碼</td>
<td style="border:1px solid black;"><strong>重大</strong></td>
</tr>
...
VBScript/JScript 遠端執行程式碼弱點 - CVE-2008-0083  
---------------------------------------------------
  
 
VBScript 與 JScript 指令碼引擎解碼網頁指令碼的方式存在一個遠端執行程式碼弱點。 當使用者開啟蓄意製作的檔案或造訪執行蓄意製作指令碼的網站時，弱點就可能會允許遠端執行程式碼。 如果使用者以系統管理的使用者權限登入，成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
  
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-0083](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0083)。
  
#### VBScript/JScript 遠端執行程式碼弱點 - CVE-2008-0083 的緩和因素
...
-   使用 Internet Explorer 7 的系統出貨時包含的是 VBScript.dll 5.7 版和 JScript.dll 5.7 版，不是此弱點影響。  
-   依照預設，Windows Server 2003 的 Internet Explorer 會以稱為「[增強式安全性設定](https://msdn2.microsoft.com/en-us/library/ms537180.aspx)」的受限制模式執行。 這個模式會將網際網路區域的安全性層級設為 \[高\]。 對於尚未被新增至 \[信任的網站\] 區域的網站，這是一種緩和因素。 如需更多資訊，請參閱此弱點＜常見問題集＞關於 Internet Explorer 增強式安全性設定的部份。
  
#### VBScript/JScript 遠端執行程式碼弱點 - CVE-2008-0083 的因應措施
  
因應措施指的是無法徹底修正弱點，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。 Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：
  
-   解除登錄 VBScript.Encode 與 JScript.Encode COM 物件。  
    **警告：**不當使用「登錄編輯程式」可能會造成嚴重的問題，甚至可能需要重新安裝您的作業系統。 Microsoft 無法保證能夠順利解決因不當使用「登錄編輯程式」所造成的問題。 請自行承擔使用 \[登錄編輯程式\] 的風險。 如需有關如何編輯登錄的資訊，請檢視「登錄編輯程式」(Regedit.exe) 中的＜變更機碼及數值＞說明主題，或是 Regedt32.exe 中的＜新增及刪除登錄中的資訊＞與＜編輯登錄資料＞說明主題。
    ...
    -   使用互動方法：  
        ...
        2.  展開 \[HKEY\_CLASSES\_ROOT\]。  
        3.  按一下 \[VBScript.Encode\]。  
        4.  按一下 \[檔案\]，再選取 \[匯出\]。  
        5.  在 \[匯出登錄檔案\] 對話方塊中，鍵入 **vbscript\_encode\_configuration\_backup.reg**   
            並按一下 \[儲存\]。  
        6.  按 Delete 鍵。  
        7.  按一下 \[確定\]。  
        8.  為 **JScript.Encode** 重複步驟 3 至 7。  
        9.  關閉任何開啟的 Internet Explorer 執行個體。  
    -   使用管理的部署指令碼：  
        1.  使用包含下列命令的管理部署指令碼，建立登錄機碼的備份：  
        ...
        2.  將下列登錄機碼儲存到副檔名為 .REG 的檔案中 (例如 Disable\_vbscript\_and\_jscript\_encode.reg)：  
    ...
    **因應措施的影響** 編碼指令碼將無法運作，但一般指令碼仍可持續運作。
...
#### VBScript/JScript 遠端執行程式碼弱點 - CVE-2008-0083 的常見問題集
...
**造成這個弱點的原因為何？**    
VBScript 與 JScript 指令碼引擎對網頁指令碼進行解碼以允許將指令碼載入記憶體以便執行的方式導致這個弱點。
  
**什麼是指令碼解碼？**    
網頁設計師使用網頁和伺服器端動態伺服器網頁 (.ASP) 中的指令碼來為網頁新增功能。 網頁設計師還會將這些指令碼編碼，以防使用者看到、複製或採用網頁中內嵌的指令碼以作其他用途。 當需要執行指令碼時，指令碼引擎會將指令碼解碼，以便將指令碼載入記憶體。
...
**因為這個弱點而承受風險的主要系統有哪些？**    
使用 Internet Explorer 瀏覽網頁且所用 VBScript.dll 和 JScript.dll 版本低於 5.6.0.8835 的用戶端或工作站系統的風險最高。
  
**我用的是 Windows Server 2003 的 Internet Explorer。這樣是否會減輕此弱點的影響？**    
是。 依照預設，Windows Server 2003 的 Internet Explorer 會以稱為「[增強式安全性設定](https://msdn2.microsoft.com/en-us/library/ms537180.aspx)」的受限制模式執行。 這個模式會將[網際網路區域](https://msdn2.microsoft.com/en-us/library/ms537183.aspx)的安全性層級設為 \[高\]。 對於尚未被新增至 \[信任的網站\] 區域的網站，這是一種緩和因素。
  
**什麼是 Internet Explorer 增強式安全性設定？**    
Internet Explorer [增強式安全性設定](https://msdn2.microsoft.com/en-us/library/ms537180.aspx)是一組預先設定好的 Internet Explorer 設定，可以降低使用者或系統管理員在伺服器上下載及執行蓄意製作之網頁內容的可能性。 Internet Explorer 增強式安全性設定降低風險的方法，是修改多項安全性相關的設定。 包括 \[網際網路選項\] 對話方塊中的 \[安全性\] 及 \[進階\] 索引標籤設定。 其中較重要的修改項目包括：
...
如需更多有關 Internet Explorer 增強式安全性設定的資訊，請參閱[管理 Internet Explorer 增強式安全性設定](https://www.microsoft.com/download/details.aspx?familyid=d41b036c-e2e1-4960-99bb-9757f7e9e31b&displaylang=en)指南 (英文)。
  
**更新的作用何在？**    
此安全性更新會修正 VBScript 與 JScript 引擎對網頁中指令碼的解碼方式，藉此解決此項弱點。 VBScript 指令碼引擎被命名為 VBScript.dll；JScript 指令碼引擎被命名為 JScript.dll。
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4：<br />
使用 [控制台] 中的 [新增或移除程式] 工具，或 %Windir%\$NTUninstallKB944338$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/944338">Microsoft 知識庫文件編號 944338</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>移除資訊</strong></td>
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或 %Windir%\$NTUninstallKB944338$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/944338">Microsoft 知識庫文件編號 944338</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">HotPatching</td>
<td style="border:1px solid black;">本安全性更新不支援 HotPatching。 如需關於 HotPatching 的詳細資訊，請參閱 <a href="https://support.microsoft.com/kb/897341/en-us">Microsoft 知識庫文件編號 897341</a>。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>移除資訊</strong></td>
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或 %Windir%\$NTUninstallKB944338$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
...
-   感謝[賽門鐵克](https://www.symantec.com/)的 Peter Ferrie 回報 VBScript/Jscript 遠端執行程式碼弱點 (CVE-2008-0083)。
...
-   V1.0 (2008 年 4 月 8 日)： 公告發行。
-   V1.1 (2008 年 4 月 9 日)： 公告已更新。 於弱點嚴重性等級表中將 JScript 和 VBScript 合併。
-   V2.0 (2008 年 8 月 13 日)： 新增已知問題連結。 另外還新增一個項目至＜與本安全性更新相關的常見問題集 (FAQ)＞章節，內容與已知問題和解決方案相關。 解決方案中針對某個問題加入此安全性更新的部署變更，並且包含另一個問題的因應措施。 已成功更新系統的客戶不需要重新安裝此更新。
