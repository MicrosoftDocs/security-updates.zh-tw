---
TOCTitle: 'MS08-061'
Title: 'Microsoft Security Bulletin MS08-061 - 重要'
ms:assetid: 'ms08-061'
ms:contentKeyID: 61238252
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms08-061(v=Security.10)'
---


Microsoft Security Bulletin MS08-061 - 重要
===========================================

Windows 核心中的弱點可能會允許權限提高 (954211)
-----------------------------------------------
...
這個安全性更新可解決在 Windows 核心中一項公開揭發和二項未公開報告的弱點。 成功利用這類弱點的攻擊者可以取得受影響系統的完整控制權。 遠端或匿名使用者無法利用這個弱點。
...
此安全性更新可以修正在新視窗建立程序期間傳遞的視窗屬性驗證、從多重執行緒發出的系統呼叫的處理方式，以及從使用者模式傳遞至 Windows 核心的參數驗證，藉此解決此類弱點。 如需更多有關弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。

**建議。** Microsoft 建議客戶應該儘快套用此更新程式。

**已知問題。** [Microsoft 知識庫文件編號 954211](https://support.microsoft.com/kb/954211) 中有記載目前已知安裝此安全性更新後，可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3a6165a6-d7e7-4526-9291-290caf0639b4">Microsoft Windows 2000 Service Pack 4 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=3a6165a6-d7e7-4526-9291-290caf0639b4">Microsoft Windows 2000 Service Pack 4 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-025">MS08-025</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7718bf14-c26c-43f3-be67-4c79ab5b2607">Windows XP Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=7718bf14-c26c-43f3-be67-4c79ab5b2607">Windows XP Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-025">MS08-025</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7718bf14-c26c-43f3-be67-4c79ab5b2607">Windows XP Service Pack 3 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=7718bf14-c26c-43f3-be67-4c79ab5b2607">Windows XP Service Pack 3 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b06d3a02-b6e4-4d40-913a-3759a31f20f3">Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-025">MS08-025</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=6e696762-d652-4a8f-ab8f-622f9746c320">Windows Server 2003 Service Pack 1 與 Windows Server 2003 Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=6e696762-d652-4a8f-ab8f-622f9746c320">Windows Server 2003 Service Pack 1 與 Windows Server 2003 Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-025">MS08-025</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=57ca28ea-e5e1-4191-a3d6-84aa90a3d668">Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=57ca28ea-e5e1-4191-a3d6-84aa90a3d668">Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-025">MS08-025</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1e6c3f81-85bb-48e6-a5af-635a7e540c93">Windows Server 2003 SP1 for Itanium-based Systems 和 Windows Server 2003 SP2 for Itanium-based Systems (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-025">MS08-025</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3483b400-cedc-441f-ba8e-594e3df89190">Windows Vista 和 Windows Vista Service Pack 1 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=3483b400-cedc-441f-ba8e-594e3df89190">Windows Vista 和 Windows Vista Service Pack 1 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-025">MS08-025</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=905ab030-14a5-4a3d-aa11-e8f957f6a1ea">Windows Vista x64 Edition 和 Windows Vista x64 Edition Service Pack 1 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=905ab030-14a5-4a3d-aa11-e8f957f6a1ea">Windows Vista x64 Edition 和 Windows Vista x64 Edition Service Pack 1 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-025">MS08-025</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8b97114a-71aa-47a2-b9e7-f4e158c18c80">適用於 32 位元系統的 Windows Server 2008 (英文下載更新程式)</a>\*<br/>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=8b97114a-71aa-47a2-b9e7-f4e158c18c80">適用於 32 位元系統的 Windows Server 2008 (中文下載更新程式)</a>\*</td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-025">MS08-025</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=6e641db2-90c8-458f-9795-3e46b70a5203">適用於 x64 型系統的 Windows Server 2008 (英文下載更新程式)</a>\*<br/>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=6e641db2-90c8-458f-9795-3e46b70a5203">適用於 x64 型系統的 Windows Server 2008 (中文下載更新程式)</a>\*</td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-025">MS08-025</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b6546e1c-bf7b-4354-8574-6c16fa707de0">適用於 Itanium 系統的 Windows Server 2008 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-025">MS08-025</a></td>
</tr>
...
**何處可找到檔案資訊詳細資料？**    
檔案資訊詳細資料請參閱 [Microsoft 知識庫文件編號 954211](https://support.microsoft.com/kb/954211)。
  
**為何本次更新中仍然包含數個已回報的安全性弱點？**    
因為解決這些弱點所需的修正作業位於相關檔案中，所以在本次更新中仍然提供對這些弱點的支援。 客戶不需要安裝數個幾乎相同的更新，只需要安裝本更新即可。
  
**安裝此安全性更新後，已知可能會發生的問題有哪些？**    
[Microsoft 知識庫文件編號 954211](https://support.microsoft.com/kb/954211) 詳細記錄了安裝此安全性更新時，目前已知可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。
...
<th style="border:1px solid black;" >Windows 核心視窗建立弱點 - CVE-2008-2250</th>
<th style="border:1px solid black;" >Windows 核心未處理例外狀況弱點 - CVE-2008-2251</th>
<th style="border:1px solid black;" >Windows 核心記憶體損毀弱點 - CVE-2008-2252</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
Windows 核心視窗建立弱點 - CVE-2008-2250  
----------------------------------------
  
 
之所以會存在一個權限提高弱點，是因為 Windows 核心並未正確驗證在新視窗建立程序期間傳遞的視窗屬性。 成功利用此弱點的攻擊者可以在核心模式下執行任意程式碼。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-2250](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2250)。
  
#### Windows 核心視窗建立弱點的緩和因素 - CVE-2008-2250
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少弱點影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   攻擊者必須擁有有效的登入認證，並能夠從本機登入易受影響的系統，才能利用這項弱點。 匿名或遠端使用者無法利用這個弱點。
  
#### Windows 核心視窗建立弱點的因應措施 - CVE-2008-2250
  
Microsoft 尚未找到此項弱點的任何因應措施。
  
#### Windows 核心視窗建立弱點的常見問題集 - CVE-2008-2250
  
**這個弱點的範圍為何？**    
這是權限提高的弱點。 成功利用此弱點的攻擊者可執行任意程式碼，並取得受影響之系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個弱點的原因為何？**    
Windows 核心在新視窗建立時不當地處理從父視窗傳遞至子視窗的輸入資訊。
...
**更新的作用何在？**    
更新程式會正確驗證在新視窗建立程序期間傳遞的視窗屬性，藉此解決此弱點。
...
Windows 核心未處理例外狀況弱點 - CVE-2008-2251  
----------------------------------------------
  
 
由於 Windows 核心中一個可能的「重覆釋放相同記憶體空間 (Double Free)」的狀況，因而存在權限提高弱點。 此弱點可能會允許攻擊者以提高的權限執行程式碼。 成功利用此弱點的攻擊者可執行任意程式碼，並取得受影響之系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-2251](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2251)。
  
#### Windows 核心未處理例外狀況弱點的緩和因素 - CVE-2008-2251
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少弱點影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   攻擊者必須擁有有效的登入認證，並能夠從本機登入易受影響的系統，才能利用這項弱點。 匿名或遠端使用者無法利用這個弱點。
  
#### Windows 核心未處理例外狀況弱點的因應措施 - CVE-2008-2251
  
Microsoft 尚未找到此項弱點的任何因應措施。
  
#### Windows 核心未處理例外狀況弱點的常見問題集 - CVE-2008-2251
  
**這個弱點的範圍為何？**    
這是權限提高的弱點。 成功利用此弱點的攻擊者可執行任意程式碼，並取得受影響之系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個弱點的原因為何？**    
造成弱點的原因，是因為 Windows 核心並未正確處理從多重執行緒發出的特定系統呼叫所致。
...
攻擊者可以讓受影響的系統在處理蓄意製作的程式時，嘗試解除或「釋放」可能為了重複使用而擱置的記憶體。 解除已經釋放的記憶體可能會導致記憶體損毀。 攻擊者可能會在記憶體中放入任意程式碼，然後在發生損毀時執行。 接著程式碼會在系統權限層級中執行。
...
**更新的作用何在？**    
更新程式可修正多重執行緒發出的系統呼叫的處理方式，藉此解決此項弱點。
  
**當安全性公告發行時，這項弱點是否已被揭發出來？**    
是。 當本安全性公告初次發行時，此弱點尚未被公開揭發。 這項弱點已被指派一般性弱點編號 [CVE-2008-2251](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2251)。
  
**當本安全性公告發行時，Microsoft 是否已接獲任何消息，指出這項弱點已遭有心人士利用？**    
否。 當本安全性公告初次發行時，Microsoft 並未接到任何有關本弱點已成為公開攻擊媒介的消息，也沒有發現任何以此概念發展的程式碼公開範例。
  
Windows 核心記憶體損毀弱點 - CVE-2008-2252  
------------------------------------------
  
 
由於 Windows 核心使用錯誤的方式驗證從使用者模式傳遞至核心的輸入，因此存在權限提高的弱點。 此弱點可能會允許攻擊者以提高的權限執行程式碼。 成功利用此弱點的攻擊者可執行任意程式碼，並取得受影響之系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-2252](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2252)。
  
#### Windows 核心記憶體損毀弱點的緩和因素 - CVE-2008-2252
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少弱點影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   攻擊者必須擁有有效的登入認證，並能夠從本機登入易受影響的系統，才能利用這項弱點。 匿名或遠端使用者無法利用這個弱點。
  
#### Windows 核心記憶體損毀弱點的因應措施 - CVE-2008-2252
  
Microsoft 尚未找到此項弱點的任何因應措施。
  
#### Windows 核心記憶體損毀弱點的常見問題集 - CVE-2008-2252
  
**這個弱點的範圍為何？**    
這是權限提高的弱點。 成功利用此弱點的攻擊者可執行任意程式碼，並取得受影響之系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個弱點的原因為何？**    
因為 Windows 核心不當地驗證從使用者模式傳遞至核心的輸入資訊，造成這個弱點。
...
**更新的作用何在？**    
此更新會正確驗證由使用者模式傳遞至 Windows 核心的參數，進而解決此項弱點。
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4：<br />
使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB954211$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/954211">Microsoft 知識庫文件編號 954211</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>移除資訊</strong></td>
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB954211$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/954211">Microsoft 知識庫文件編號 954211</a></td>
...
-   感謝 [iShadow](https://www.ishadow.com/) 的 Paul Caton 回報 Windows 核心視窗建立弱點 - (CVE-2008-2250)  
-   感謝 [SkyRecon](https://www.skyrecon.com/) 的 Thomas Garnier 回報 Windows 核心記憶體損毀弱點 - (CVE-2008-2252)
