---
TOCTitle: 'MS08-019'
Title: 'Microsoft Security Bulletin MS08-019 - 重要'
ms:assetid: 'ms08-019'
ms:contentKeyID: 61238106
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms08-019(v=Security.10)'
---



Microsoft Security Bulletin MS08-019 - 重要
===========================================

Microsoft Visio 中的弱點可能會允許遠端執行程式碼 (949032)
---------------------------------------------------------
...
此安全性更新可解決 Microsoft Office Visio 中一項未公開報告的弱點，該弱點可在使用者開啟蓄意製作的 Visio 檔案時，允許從遠端執行程式碼。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

對於 Microsoft Office Visio 2002 Service Pack 2、Microsoft Office Visio 2003 Service Pack 2、Microsoft Office Visio 2003 Service Pack 3、Microsoft Office Visio 2007 及 Microsoft Office Visio 2007 Service Pack 1，此安全性更新的等級為重要。如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此安全性更新透過修改 Microsoft Visio 開啟 Visio 檔案時執行驗證的方式解決此弱點。 如需更多有關弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。

**建議。** Microsoft 建議客戶應該儘快套用此更新程式。

**已知問題。** [Microsoft 知識庫文件編號 949032](https://support.microsoft.com/kb/949032) 詳細記錄了目前已知安裝此安全性更新可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=0056a936-def5-40fa-bcfc-0ab0dd5c3964">Microsoft Visio 2002 Service Pack 3 (英文下載更新程式)</a><br />
(KB947896)  
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=0056a936-def5-40fa-bcfc-0ab0dd5c3964">Microsoft Visio 2002 Service Pack 3 (中文下載更新程式)</a><br />
(KB947896)</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=18af0ce6-99a0-4471-8d26-9700a8a8e631">Microsoft Visio 2003 Service Pack 2 (英文下載更新程式)</a><br />
(KB947650)  
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=18af0ce6-99a0-4471-8d26-9700a8a8e631">Microsoft Visio 2003 Service Pack 2 (中文下載更新程式)</a><br />
(KB947650)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-030">MS07-030</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=18af0ce6-99a0-4471-8d26-9700a8a8e631">Microsoft Visio 2003 Service Pack 3 (英文下載更新程式)</a><br />
(KB947650)  
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=18af0ce6-99a0-4471-8d26-9700a8a8e631">Microsoft Visio 2003 Service Pack 3 (中文下載更新程式)</a><br />
(KB947650)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-030">MS07-030</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=0510a1bb-b464-452c-900f-7f4e58ed9c7e">Microsoft Visio 2007 (英文下載更新程式)</a><br />
(KB947590)  
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=0510a1bb-b464-452c-900f-7f4e58ed9c7e">Microsoft Visio 2007 (中文下載更新程式)</a><br />
(KB947590)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=0510a1bb-b464-452c-900f-7f4e58ed9c7e">Microsoft Visio 2007 Service Pack 1 (英文下載更新程式)</a><br />
(KB947590)  
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=0510a1bb-b464-452c-900f-7f4e58ed9c7e">Microsoft Visio 2007 Service Pack 1 (中文下載更新程式)</a><br />
(KB947590)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
...
**何處可找到檔案資訊詳細資料？**    
檔案資訊詳細資訊可在 [Microsoft 知識庫文件編號 949032](https://support.microsoft.com/kb/949032)中找到。
...
<th style="border:1px solid black;" >Visio 物件標頭弱點 CVE-2008-1089</th>
<th style="border:1px solid black;" >Visio 記憶體驗證弱點 CVE-2008-1090</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office Visio 2002 Service Pack 3</td>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Office Visio 2003 Service Pack 2</td>
<td style="border:1px solid black;"><strong>重要</strong><br />
遠端執行程式碼</td>
<td style="border:1px solid black;"><strong>中度</strong><br />
遠端執行程式碼</td>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Office Visio 2007</td>
<td style="border:1px solid black;"><strong>重要</strong><br />
遠端執行程式碼</td>
<td style="border:1px solid black;"><strong>中度</strong><br />
遠端執行程式碼</td>
...
Visio 物件標頭弱點 CVE-2008-1089  
--------------------------------
  
 
Microsoft Visio 驗證蓄意製作檔案中的物件標頭資料的方式中，存在遠端執行程式碼的弱點。 攻擊者可傳送格式錯誤的檔案，以電子郵件附件的方式隨附，或存放在蓄意製作或遭入侵的網站上，以利用此弱點。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-1089](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1089)。
  
#### Visio 物件標頭弱點 - CVE-2008-1089 的緩和因素
...
#### Visio 物件標頭弱點 - CVE-2008-1089 的因應措施
  
因應措施指的是無法徹底修正弱點，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。 Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：
  
-   使用 Microsoft Visio 2003 Viewer 或 Microsoft Visio 2007 Viewer 開啟與檢視檔案。 Microsoft Visio 2003 Viewer 和 Microsoft Visio 2007 Viewer 不受此問題影響。  
-   對於來自於不受信任的來源或在非預期情況下從信任來源收到的 Visio 檔案，請勿輕易開啟或儲存。 當使用者開啟蓄意製作的檔案時，即可能遭受利用此弱點的攻擊。
  
#### Visio 物件標頭弱點 - CVE-2008-1089 的常見問題集
  
**這個弱點的範圍為何？**    
這是遠端執行程式碼的弱點。 成功利用此弱點的攻擊者可以從遠端取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，或檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個弱點的原因為何？**    
Microsoft Visio 在開啟 Visio 檔案時未適當驗證物件標頭資料。
...
**攻擊者如何利用這項弱點？**    
此弱點需要使用者透過受影響的 Microsoft Visio 版本來開啟格式錯誤的 Visio 檔案。
  
若是電子郵件攻擊，攻擊者可能會利用這項弱點，向使用者傳送格式錯誤的 Visio 檔案，然後引誘使用者開啟該檔案。
...
**因為這個弱點而承受風險的主要系統有哪些？**    
使用 Microsoft Visio 時所透過的系統風險最高。 若系統管理員允許使用者登入伺服器並執行程式，則伺服器可能遭受更大的風險。 然而，最佳實務強烈建議您制止這種行為。
  
**更新的作用何在？**    
在開啟 Visio 檔案時，此更新可在為物件標頭資料配置空間時執行驗證，進而移除此弱點。
...
Visio 記憶體驗證弱點 - CVE-2008-1090  
------------------------------------
  
 
在將蓄意製作的 .DXF 檔案從磁碟載入記憶體時，Microsoft Visio 驗證記憶體配置的方式中存在遠端執行程式碼的弱點。 攻擊者可傳送格式錯誤的檔案，以電子郵件附件的方式隨附，或存放在蓄意製作或遭入侵的網站上，以利用此弱點。
  
如果使用者以系統管理的使用者權限登入，成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
  
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-1090](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1090)。
  
#### Visio 記憶體驗證弱點 - CVE-2008-1090 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少弱點影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   根據預設，AutoCAD 繪圖檔案 (.DXF 副檔名) 不會透過 Visio 登錄，而且在蓄意製作的 .DXF 檔上按兩下並不會將其開啟。 攻擊者必須說服使用者開啟 Visio、選取 \[開啟\] 來開啟 .DXF 檔並將預設檔案類型 "All Visio Files" 變更為 "AutoCAD Drawing" 才能利用弱點進行攻擊。  
-   在網頁式攻擊的案例中，攻擊者可架設一個網站，並在其中包含利用此弱點的網頁。 此外，受侵害的網站以及接受或存放使用者提供之內容或廣告的網站裡，也可能包含蓄意製作以利用本弱點的內容。 但是，攻擊者無法強迫使用者造訪網站， 而是引誘使用者自行前往。一般的做法是設法讓使用者按一下電子郵件或 Instant Messenger 訊息中通往攻擊者網站的連結。  
-   成功利用此弱點的攻擊者可以取得與本機使用者相同的使用者權限。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。  
-   無法透過電子郵件自動攻擊此弱點。 使用者必須順利開啟電子郵件訊息中傳送的附件，攻擊才可進行。
  
#### Visio 記憶體驗證弱點 - CVE-2008-1090 的因應措施
  
因應措施指的是無法徹底修正弱點，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。 Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：
  
-   **限制 DWGDP.DLL 的存取權限以停用 Visio 防止其開啟 .DXF 檔。**  
    若要限制 DWGDP.DLL 的存取權限，請在命令提示字元中鍵入以下命令：  
    **注意：**  對於 Vista 系統而言，必須使用具備系統管理員權限的帳戶才能實作此因應措施。  
    **適用於 Windows XP**  
    ...
    **因應措施的影響：** 實作此因應措施的影響是 Visio 將再也不會開啟 AutoCAD 繪圖檔案 (.DXF)。 若不需要開啟 AutoCAD 繪圖檔案，則此因應措施應不會影響您系統的功能。  
...
-   **使用 Microsoft Visio 2003 Viewer 或 Microsoft Visio 2007 Viewer 來開啟與檢視 Visio 檔案。** Microsoft Visio 2003 Viewer 和 Microsoft Visio 2007 Viewer 不受此問題影響。  
-   **對於來自於不受信任的來源或在非預期情況下從信任來源收到的 Microsoft Office 檔案，請勿輕易開啟或儲存。** 當使用者開啟蓄意製作的檔案時，即可能遭受利用此弱點的攻擊。
  
#### Visio 記憶體驗證弱點 - CVE-2008-1090 的常見問題集
  
**這個弱點的範圍為何？**    
這是遠端執行程式碼的弱點。 成功利用此弱點的攻擊者可以從遠端取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，或檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個弱點的原因為何？**    
在將蓄意製作的 .DXF 檔案從磁碟載入記憶體時，Microsoft Visio 未適當驗證記憶體配置。
  
**攻擊者可能會利用這項弱點採取什麼行動？**    
一旦成功利用此弱點，攻擊者便能以登入的使用者身分執行任意程式碼。 如果使用者以系統管理的使用者權限登入，則攻擊者即可取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
  
**攻擊者如何利用這項弱點？**    
此弱點需要使用者透過受影響的 Microsoft Visio 版本來開啟格式錯誤的 .DXF 檔案。
...
**更新的作用何在？**    
此更新可在將 Visio 檔案從磁碟載入記憶體時正確驗證記憶體配置，進而移除此項弱點。
...
| Office 2003 Service Pack 3                  | 是         |  
| 2007 Microsoft Office System                | 是         |  
| 2007 Microsoft Office System Service Pack 1 | 是         |
...
| 2007 Microsoft Office System Service Pack 1 | 否      | 否                     | 是                    | 是        |
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/949032">Microsoft 知識庫文件編號 949032</a></td>
</tr>
<tr class="even">
...
-   感謝一位匿名的發現者回報 Visio 物件標頭弱點 - CVE-2008-1089。  
-   感謝一位匿名的發現者回報 Visio 記憶體驗證弱點 - CVE-2008-1090。
