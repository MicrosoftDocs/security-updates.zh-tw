---
TOCTitle: 'MS08-015'
Title: 'Microsoft Security Bulletin MS08-015 - 重大'
ms:assetid: 'ms08-015'
ms:contentKeyID: 61238102
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms08-015(v=Security.10)'
---

Microsoft Security Bulletin MS08-015 - 重大
===========================================

Microsoft Outlook 中的弱點可能會允許遠端執行程式碼 (949031)
-----------------------------------------------------------
...
這個安全性更新可解決 Microsoft Office Outlook 中一項未公開報告的弱點。 當 Outlook 收到蓄意製作的 mailto URI，此弱點可能會允許遠端執行程式碼。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。 光是透過 Outlook 預覽窗格檢視電子郵件，並不會導致這個弱點遭到利用。

對於受支援版本的 Microsoft Office Outlook 2000 Service Pack 3、Outlook 2002 Service Pack 3、Outlook 2003 Service Pack 2 與 Service Pack 3，以及 Outlook 2007，此安全性更新的等級為「重大」。如需更多資訊，請參閱本節中的**受影響及不受影響的軟體**小節。

這個安全性更新透過修改 Microsoft Outlook 處理 mailto URI 的方式解決此弱點。 如需更多有關弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=714a49cd-5bca-4719-96a1-e1077f279533">Outlook 2000 Service Pack 3 (英文下載更新程式)</a><br />
(KB946986)  
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=714a49cd-5bca-4719-96a1-e1077f279533">Outlook 2000 Service Pack 3 (中文下載更新程式)</a><br />
(KB946986)</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=59853687-d885-4059-9460-ee403855dbd8">Outlook 2002 Service Pack 3 (英文下載更新程式)</a><br />
(KB946985)  
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=59853687-d885-4059-9460-ee403855dbd8">Outlook 2002 Service Pack 3 (中文下載更新程式)</a><br />
(KB946985)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-003">MS07-003</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=fccc7c4c-8496-4682-bd46-6590503c1bf2">Outlook 2003 Service Pack 2 (英文下載更新程式)</a><br />
(KB945432)  
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=fccc7c4c-8496-4682-bd46-6590503c1bf2">Outlook 2003 Service Pack 2 (中文下載更新程式)</a><br />
(KB945432)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-003">MS07-003</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=fccc7c4c-8496-4682-bd46-6590503c1bf2">Outlook 2003 Service Pack 3 (英文下載更新程式)</a><br />
(KB945432)  
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=fccc7c4c-8496-4682-bd46-6590503c1bf2">Outlook 2003 Service Pack 3 (中文下載更新程式)</a><br />
(KB945432)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4e2baf00-88eb-4eb6-961a-54245b363c21">Outlook 2007 (英文下載更新程式)</a><br />
(KB946983)  
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=4e2baf00-88eb-4eb6-961a-54245b363c21">Outlook 2007 (中文下載更新程式)</a><br />
(KB946983)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
...
<th style="border:1px solid black;" >Outlook URI 弱點 - CVE-2008-0110</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
Outlook URI 弱點 - CVE-2008-0110  
--------------------------------
  
Outlook 中存在遠端執行程式碼的弱點。 當 Outlook 收到蓄意製作的 mailto URI，此弱點可能會允許遠端執行程式碼。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
  
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-0110](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0110)。
  
#### Outlook URI 弱點 - CVE-2008-0110 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少弱點影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   在網頁式攻擊的案例中，攻擊者必須架設一個網站，並說服使用者按下蓄意製作的 mailto URI，才能利用這個弱點。 但是，攻擊者無法強迫使用者造訪網站， 而是引誘使用者自行前往。一般的做法是設法讓使用者按一下電子郵件或 Instant Messenger 訊息中通往攻擊者網站的連結。  
-   無法透過電子郵件自動攻擊此弱點。 使用者必須開啟含有蓄意製作的 mailto URI 的電子郵件訊息並按下 mailto 連結，攻擊才會成功。  
-   光是透過 Outlook 預覽窗格檢視電子郵件，並不會導致這個弱點遭到利用。
  
#### Outlook URI 弱點 - CVE-2008-0110 的因應措施
  
-   **停用 Outlook mailto 處理常式**  
  
    在系統登錄機碼中停用 mailto 處理常式有助於保護受影響系統避免受到嘗試利用此弱點的攻擊之影響。
    ...
    **注意：** 不當使用「登錄編輯程式」可能會造成嚴重的問題，甚至可能需要重新安裝您的作業系統。 Microsoft 無法保證能夠順利解決因不當使用「登錄編輯程式」所造成的問題。 請自行承擔使用 \[登錄編輯程式\] 的風險。 如需有關如何編輯登錄的資訊，請檢視「登錄編輯程式」(Regedit.exe) 中的＜變更機碼及數值＞說明主題，或是 Regedt32.exe 中的＜新增及刪除登錄中的資訊＞與＜編輯登錄資料＞說明主題。
    ...
    3.  展開 \[mailto\]。  
    4.  若要在編輯之前備份該登錄，請在 \[檔案\] 功能表上按一下滑鼠左鍵，選取 \[匯出...\] 在 \[匯出登錄檔案\] 對話方塊中，鍵入 **mailto\_backup.reg** 並選取 \[儲存\]。  
    5.  在 \[mailto\] 上按一下滑鼠右鍵，然後選取 \[刪除\]。
  
    **因應措施的影響：** 使用此因應措施設定系統的使用者，將無法處理正常啟動應用程式之 mailto 動作的 mailto 要求。
    ...
    **如何復原因應措施：**  
    ...
    2.  展開 \[HKEY\_CLASSES\_ROOT\]。  
    3.  展開 \[mailto\]。  
    4.  若要還原登錄檔，請在 \[檔案\] 功能表上按一下滑鼠左鍵，選取 \[匯入...\] 在 \[匯出登錄檔案\] 對話方塊中，選取 \[mailto\_backup.reg\] 再選取 \[開啟\]。
  
#### Outlook URI 弱點 - CVE-2008-0110 的常見問題集
  
**這個弱點的範圍為何？**  
這是 Outlook 中的一個遠端執行程式碼弱點。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。
  
**造成這個弱點的原因為何？**  
Microsoft Outlook 對於從網路瀏覽器傳給 Outlook 用戶端的 mailto URI 未執行充分的驗證。
...
**攻擊者如何利用這項弱點？**  
此弱點需要使用者以含有 Microsoft Outlook 的受影響系統，造訪蓄意製作或遭入侵的網站。
  
在網頁式攻擊的案例中，攻擊者必須架設一個網站，並說服使用者按下蓄意製作的 mailto URI，才能利用這個弱點。 攻擊者並不能強迫使用者造訪蓄意製作的網站， 而是引誘他們自行前往。一般的做法是設法讓使用者按一下通往攻擊者網站的連結。
  
**因為這個弱點而承受風險的主要系統有哪些？**  
系統例如使用 Microsoft Outlook 的桌上型電腦用戶端或終端伺服器系統的風險最高。
  
**更新的作用何在？**  
本更新會修改 Microsoft Outlook 驗證從網路瀏覽器傳來的 mailto URI 的方式，因而移除此項弱點。
...
| Microsoft Outlook 2003 Service Pack 2 與 Service Pack 3 | 是         |  
...
| Microsoft Outlook 2003 Service Pack 2 與 Service Pack 3 | 是      | 是                     | 是                    | 是        |  
...
適用於所有支援受版本的 Outlook 2002：
  
| 檔案名稱     | \[版本\]    | 日期                | 時間  | 大小    |  
|--------------|-------------|---------------------|-------|---------|  
| Outlvbs.dll  | 10.0.6711.0 | 2004 年 4 月8 日    | 2:24  | 47816   |  
| Cdooff.dll   | 10.0.6777.0 | 2005 年 9 月 19 日  | 20:36 | 236232  |  
| Dlgsetp.dll  | 10.0.6711.0 | 2004 年 4 月8 日    | 2:24  | 80584   |  
| Dumpster.dll | 10.0.6711.0 | 2004 年 4 月8 日    | 2:24  | 39624   |  
...
| Olmail.fae   | 10.0.6711.0 | 2004 年 4 月8 日    | 2:24  | 133824  |  
| Oltask.fae   | 10.0.6751.0 | 2005 年 2 月 15 日  | 7:43  | 166600  |  
| Outlcm.dll   | 10.0.6711.0 | 2004 年 4 月8 日    | 2:24  | 543424  |  
...
| **部署**                               |                                                                                                                                               |  
| 在沒有使用者介入的情況下安裝           | Outlook2007-kb946983-fullfile-x86-glb /passive                                                                                                |  
| 在不重新啟動的情況下安裝               | Outlook2007-kb946983-fullfile-x86-glb /norestart                                                                                              |  
| 更新記錄檔                             | 使用者可透過 /log 參數啟用詳細資訊記錄；請參閱 [Microsoft 知識庫文件編號 912203](https://support.microsoft.com/kb/912203) 以取得更多詳細資訊。 |  
| 詳細資訊                               | 請參閱＜偵測與部署工具及指南＞小節。                                                                                                          |  
| **重新開機需求**                       |                                                                                                                                               |  
| 需要重新開機？                         | 此更新程式不需要重新開機。                                                                                                                    |  
| Hotpatching                            | 不適用                                                                                                                                        |  
| **移除資訊**                           | 使用 \[控制台\] 中的 \[新增或移除程式\] 工具。                                                                                                |  
| **檔案資訊**                           | 如需完整的檔案資訊清單，請參閱本節中的＜檔案資訊＞小節                                                                                        |  
| **登錄機碼驗證**                       | 不適用                                                                                                                                        |
...
此安全性更新需要搭配在系統上安裝 Windows Installer 3.1。
  
如果要安裝最新版本的 Windows 3.1 Installer，請造訪下列 Microsoft 網站：
...
| 參數                        | 描述                                                                        |  
|-----------------------------|-----------------------------------------------------------------------------|  
| */extract:\[***path***\]*   | 將套件的內容解壓縮到路徑資料夾。 若未指定路徑，則會顯示 \[瀏覽\] 對話方塊。 |  
...
**注意**：您可以在同一個命令中合併使用這些參數。 為符合回溯相容性，安全性更新程式也支援舊版安裝程式使用的安裝參數。 如需有關受支援安裝參數的其他資訊，請參閱 [Microsoft 知識庫文件編號 912203](https://support.microsoft.com/kb/912203)。如需更多關於安裝程式的相關資訊，請造訪 [Microsoft TechNet 網站](https://go.microsoft.com/fwlink/?linkid=38951)。
...
-   感謝 [iDefense Labs](https://labs.idefense.com/) 的 Greg MacManus 回報 Outlook URI 弱點 (CVE-2008-0110)
