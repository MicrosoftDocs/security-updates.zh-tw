...
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-021">MS08-021</a></td>
</tr>
<tr class="even">
...
**何處可找到檔案資訊詳細資料？**    
檔案資訊詳細資料請參閱 [Microsoft 知識庫文件編號 956802](https://support.microsoft.com/kb/956802)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-2249](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2249)。
...
**什麼是 GDI？**    
Microsoft Windows 圖形裝置介面 (GDI) 可讓應用程式在視訊畫面及印表機上使用圖形和格式化文字。 Windows 應用程式不會直接存取圖形硬體。 而是由 GDI 代表應用程式與裝置驅動程式互動。 如需更多關於 GDI 的資訊，請造訪 [Windows GDI 起始網頁。](https://msdn.microsoft.com/en-us/library/ms536795.aspx)
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-3465](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3465)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/956802">Microsoft 知識庫文件編號 956802</a></td>
</tr>
<tr class="even">
...
-   感謝 [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Jun Mao 回報 GDI 整數溢位弱點 (CVE-2008-2249)  
-   Juan Caballero 與[卡內基美隆大學 Bitblaze 小組及加州大學柏克萊分校](https://bitblaze.cs.berkeley.edu/)合作回報 GDI 堆積溢位弱點 (CVE-2008-3465)
