...
**何處可找到檔案資訊詳細資料？**    
檔案資訊詳細資料請參閱 [Microsoft 知識庫文件編號 953155](https://support.microsoft.com/kb/953155)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-1446](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1446)。
...
System Center Configuration Manager (Configuration Manager) 2007 使用 WSUS 3.0 來偵測更新。 如需更多關於 Configuration Manager 2007 軟體更新管理的資訊，請造訪 [System Center Configuration Manager 2007](https://technet.microsoft.com/en-us/library/bb735860.aspx) 網站。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/953155">Microsoft 知識庫文件編號 953155</a></td>
</tr>
<tr class="even">
...
-   感謝 [CERT/CC](https://www.cert.org/) 回報 IPP 服務整數溢位弱點 - CVE-2008-1446
