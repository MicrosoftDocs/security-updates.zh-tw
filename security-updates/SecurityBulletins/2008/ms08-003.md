---
TOCTitle: 'MS08-003'
Title: 'Microsoft Security Bulletin MS08-003 - 重要'
ms:assetid: 'ms08-003'
ms:contentKeyID: 61238090
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms08-003(v=Security.10)'
---

Microsoft Security Bulletin MS08-003 - 重要
===========================================

Active Directory 中的弱點可能會允許拒絕服務 (946538)
----------------------------------------------------
...
這個重要安全性更新可解決在 Microsoft Windows 2000 Server 及 Windows Server 2003 與 Active Directory 應用程式模式 (ADAM) (安裝於 Windows XP 及 Windows Server 2003) 上實作 Active Directory 的一項未公開報告的弱點，此弱點可能會發生拒絕服務的情況。 在 Windows Server 2003 及 Windows XP 上，攻擊者必須擁有有效的登入認證，才能利用這項弱點。 成功利用此弱點的攻擊者可使該系統停止回應，或自動重新啟動。

這是適用於所有受支援版本 Microsoft Windows 2000 的重要安全性更新，以及適用於 Windows XP 及 Windows Server 2003 的中度安全性更新。如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

這個安全性更新透過驗證用戶端 LDAP 要求來解決此項弱點。 如需更多有關弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9df0875d-0466-4974-b4c0-1ecc777173b1">Active Directory (英文下載更新程式)</a><br />
(KB943484)  
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=9df0875d-0466-4974-b4c0-1ecc777173b1">Active Directory (中文下載更新程式)</a><br />
(KB943484)</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=bff7dcb9-5d00-442e-b03c-ce923d213faa">ADAM (英文下載更新程式)</a><br />
(KB931374)  
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=bff7dcb9-5d00-442e-b03c-ce923d213faa">ADAM (中文下載更新程式)</a><br />
(KB931374)</td>
<td style="border:1px solid black;">拒絕服務</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=36e36e1a-ed0d-45a6-b707-766fabc01fbd">ADAM (英文下載更新程式)</a><br />
(KB931374)</td>
<td style="border:1px solid black;">拒絕服務</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=63d3d784-f057-4686-b85e-ab5fbab5a722">Active Directory (英文下載更新程式)</a><br />
(KB943484)  
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=63d3d784-f057-4686-b85e-ab5fbab5a722">Active Directory (中文下載更新程式)</a><br />
(KB943484)</td>
<td style="border:1px solid black;">拒絕服務</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-039">MS07-039</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 Service Pack 1 與 Windows Server 2003 Service Pack 2</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=60781cf3-7c6d-4795-a9d0-bc18ee356e94">ADAM (英文下載更新程式)</a><br />
(KB931374)  
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=60781cf3-7c6d-4795-a9d0-bc18ee356e94">ADAM (中文下載更新程式)</a><br />
(KB931374)</td>
<td style="border:1px solid black;">拒絕服務</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=835d647a-dce6-476e-b7c4-928a67b0acfb">Active Directory (英文下載更新程式)</a><br />
(KB943484)  
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=835d647a-dce6-476e-b7c4-928a67b0acfb">Active Directory (中文下載更新程式)</a><br />
(KB943484)</td>
<td style="border:1px solid black;">拒絕服務</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-039">MS07-039</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5e97698d-8150-44f9-9d34-87a0db6ba5a7">ADAM (英文下載更新程式)</a><br />
(KB931374)  
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=5e97698d-8150-44f9-9d34-87a0db6ba5a7">ADAM (中文下載更新程式)</a><br />
(KB931374)</td>
<td style="border:1px solid black;">拒絕服務</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=eda8af09-1a4c-4163-a8bb-97dacdebeae4">Active Directory (英文下載更新程式)</a><br />
(KB943484)</td>
<td style="border:1px solid black;">拒絕服務</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-039">MS07-039</a></td>
...
<th style="border:1px solid black;" >Active Directory 弱點 - CVE-2008-0088</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
<strong>阻絕服務</strong></td>
<td style="border:1px solid black;"><strong>重要</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">安裝在 Windows XP Professional Service Pack 2 上的 ADAM</td>
<td style="border:1px solid black;"><strong>中度</strong><br />
<strong>阻絕服務</strong></td>
<td style="border:1px solid black;"><strong>中度</strong></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">ADAM Windows XP Professional x64 Edition 和 Windows XP Professional Edition Service Pack 2</td>
<td style="border:1px solid black;"><strong>中度</strong><br />
<strong>阻絕服務</strong></td>
<td style="border:1px solid black;"><strong>中度</strong></td>
</tr>
...
<tr class="even">
<td style="border:1px solid black;">Windows Server 2003 SP1 for Itanium-based Systems 和 Windows Server 200 SP2 for Itanium-based Systems 上的 Active Directory</td>
<td style="border:1px solid black;"><strong>中度</strong><br />
<strong>阻絕服務</strong></td>
<td style="border:1px solid black;"><strong>中度</strong></td>
</tr>
...
Active Directory 弱點 - CVE-2008-0088  
-------------------------------------
  
在 Microsoft Windows 2000 及 Windows Server 2003 上實作 Active Directory 時存在拒絕服務弱點。實作 Windows XP 及 Windows Server 2003 上安裝的 Active Directory 應用程式模式 (ADAM) 時也存在此弱點。這是不當驗證蓄意製作的 LDAP 要求所產生的弱點。 成功利用此弱點的攻擊者可使該電腦停止回應，並自動重新啟動。
  
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-0088](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0088)。
  
#### Active Directory 弱點 - CVE-2008-0088 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少弱點影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
Microsoft 尚未找到此項弱點的任何緩和因素。
  
#### Active Directory 弱點 - CVE-2008-0088 的因應措施
  
因應措施指的是無法徹底修正弱點，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。 Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：
  
-   **在周邊防火牆中封鎖 TCP 連接埠 389 和 3268**  
  
    上述連接埠用於起始與受影響元件的連線。 在企業防火牆封鎖此連接埠 (含輸入及輸出) 有助於保護防火牆後的系統免遭此弱點的影響。 建議您封鎖所有網際網路中來路不明的輸入通訊，以防他人利用其他連接埠攻擊系統。 如需更多關於連接埠的資訊，請造訪「TCP 和 UDP 連接埠的指派網站」(英文)。
...
#### Active Directory 弱點 - CVE-2008-0088 的常見問題集
...
[ADAM](https://technet2.microsoft.com/windowsserver/en/library/29fb059e-544c-4577-bf7c-ba4b08df48431033.mspx?mfr=true) 是一項輕量型目錄存取通訊協定 (LDAP) 目錄服務，它是做為使用者服務執行，而非做為系統服務執行。
...
#### 含 Active Directory 的 Windows 2000 Server (KB943484)
...
<td style="border:1px solid black;">Windows 2000 Service Pack 4：<br />
使用 [控制台] 中的 [新增或移除程式] 工具，或 %Windir%\\$NTUninstall kb943484$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>未來將包含於 Service Pack 中的內容</strong></td>
<td style="border:1px solid black;">此問題的更新程式屬於選用元件，因此不會包含在以後的 Service Pack 或更新彙總套件中</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>部署</strong></td>
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>移除資訊</strong></td>
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或 %Windir%\\$NTUninstallKB931374$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">如需完整的檔案資訊清單，請參閱下一小節＜檔案資訊＞</td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">針對所有受支援的 Windows XP x64 版本：
...
**注意：** Windows XP Home Service Pack 2、Windows XP Tablet Edition Service Pack 2 和 Windows XP Media Center Edition Service Pack 2 的支援版本因為不含 ADAM 或 Active Directory 伺服器元件，所以不受影響。
...
#### 包含 Active Directory 的 Windows Server 2003 (所有版本) (KB943484)
...
使用 [控制台] 中的 [新增或移除程式] 工具，或位於 %Windir%\\$NTUninstallKB943484$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">如需完整的檔案資訊清單，請參閱下一小節＜檔案資訊＞</td>
...
#### 含 ADAM 的 Windows Server 2003 (所有版本) (KB931374)
...
<tr class="even">
<td style="border:1px solid black;"><strong>移除資訊</strong></td>
<td style="border:1px solid black;">適用於所有受支援 32 位元版本和 x64 版本的 Windows Server 2003：
使用 [控制台] 中的 [新增或移除程式] 工具，或位於 %Windir%\\$NTUninstallKB931374$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">如需完整的檔案資訊清單，請參閱下一小節＜檔案資訊＞</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">適用於所有受支援的 32 位元版本、x64 版本的 Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2：<br />
...
-   感謝 [SkyRecon](https://www.skyrecon.com/) 的 Thomas Garnier 回報 Active Directory 弱點 (CVE-2008-0088)。
