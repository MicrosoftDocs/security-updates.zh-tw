...
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms07-022">MS07-022</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/932596">Microsoft 安全性摘要報告 (932596)</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms07-066">MS07-066</a></td>
</tr>
<tr class="even">
...
**何處可找到檔案資訊詳細資料？**    
檔案資訊詳細資料請參閱 [Microsoft 知識庫文件編號 956841](http://support.microsoft.com/kb/956841)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-4036](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4036)。
...
VAD 是一種應用程式專用的虛擬記憶體，可讓每個應用程式擁有自己的專用位址空間。 如需更多關於 VAD 的資訊，請參閱 MSDN 文章 [Windows NT 虛擬記憶體管理員 (英文)](http://msdn.microsoft.com/en-us/library/ms810616.aspx) 和[管理 Win32 的虛擬記憶體 (英文)](http://msdn.microsoft.com/en-us/library/ms810616.aspx)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/956841">Microsoft 知識庫文件編號 956841</a></td>
</tr>
<tr class="even">
