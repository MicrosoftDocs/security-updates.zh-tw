---
TOCTitle: 'MS08-064'
Title: 'Microsoft Security Bulletin MS08-064 - 重要'
ms:assetid: 'ms08-064'
ms:contentKeyID: 61238255
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms08-064(v=Security.10)'
---



Microsoft Security Bulletin MS08-064 - 重要
===========================================

Virtual Address Descriptor 操作中的弱點可能會允許權限提高 (956841)
------------------------------------------------------------------
...
這個安全性更新可解決 Virtual Address Descriptor 中一項未公開報告的弱點。 如果使用者執行蓄意製作的應用程式，則弱點可能會允許權限提高。 經驗證的攻擊者成功利用這個弱點後，即可在受影響的系統上提高權限。 接下來，攻擊者就能安裝程式，檢視、變更或刪除資料，或是建立具有完整系統管理權限的新帳戶。

對於所有受支援版本的 Windows XP、Windows Server 2003、Windows Vista 與 Windows Server 2008，此安全性更新的等級為「重要」。如需詳細資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此安全性更新是藉由修改 Virtual Address Descriptor 處理記憶體配置變數的方式來解決弱點。 如需更多有關弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=25997b73-a640-49c1-b19e-768a18bbe22c">Windows XP Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=25997b73-a640-49c1-b19e-768a18bbe22c">Windows XP Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-022">MS07-022</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=25997b73-a640-49c1-b19e-768a18bbe22c">Windows XP Service Pack 3 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=25997b73-a640-49c1-b19e-768a18bbe22c">Windows XP Service Pack 3 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=50fae854-0bde-46f8-9444-b9e0d9bfecad">Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/932596">Microsoft 安全性摘要報告 (932596)</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e8ef3d5f-dd8e-4945-92cd-9d3e30b16667">Windows Server 2003 Service Pack 1 與 Windows Server 2003 Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=e8ef3d5f-dd8e-4945-92cd-9d3e30b16667">Windows Server 2003 Service Pack 1 與 Windows Server 2003 Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-022">MS07-022</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c2e754f9-086a-494c-bc19-5feed7df8b65">Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=c2e754f9-086a-494c-bc19-5feed7df8b65">Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/932596">Microsoft 安全性摘要報告 (932596)</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5a3832ec-3f8f-42c1-a603-b1330d527547">Windows Server 2003 SP1 for Itanium-based Systems 和 Windows Server 2003 SP2 for Itanium-based Systems (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b4212db5-093e-497d-b999-2e3780f9f7c2">Windows Vista (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=b4212db5-093e-497d-b999-2e3780f9f7c2">Windows Vista (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-066">MS07-066</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b4212db5-093e-497d-b999-2e3780f9f7c2">Windows Vista Service Pack 1 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=b4212db5-093e-497d-b999-2e3780f9f7c2">Windows Vista Service Pack 1 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c20808cb-c30a-4b53-91e5-810eb6b4b2e3">Windows Vista x64 Edition (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=c20808cb-c30a-4b53-91e5-810eb6b4b2e3">Windows Vista x64 Edition (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-066">MS07-066</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c20808cb-c30a-4b53-91e5-810eb6b4b2e3">Windows Vista x64 Edition Service Pack 1 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=c20808cb-c30a-4b53-91e5-810eb6b4b2e3">Windows Vista x64 Edition Service Pack 1 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ec9eeb82-0497-4c55-94bb-9a47cb3521b4">適用於 32 位元系統的 Windows Server 2008 (英文下載更新程式)</a>\*<br/>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=ec9eeb82-0497-4c55-94bb-9a47cb3521b4">適用於 32 位元系統的 Windows Server 2008 (中文下載更新程式)</a>\*</td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=0bc178b8-f8ae-4f41-8f88-fb6a75be1bca">適用於 x64 型系統的 Windows Server 2008 (英文下載更新程式)</a>\*<br/>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=0bc178b8-f8ae-4f41-8f88-fb6a75be1bca">適用於 x64 型系統的 Windows Server 2008 (中文下載更新程式)</a>\*</td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=0af72663-4945-4916-8c55-090ba4d82793">適用於 Itanium 系統的 Windows Server 2008 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
**何處可找到檔案資訊詳細資料？**    
檔案資訊詳細資料請參閱 [Microsoft 知識庫文件編號 956841](https://support.microsoft.com/kb/956841)。
...
<th style="border:1px solid black;" >Virtual Address Descriptor 權限提高弱點 - CVE-2008-4036</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
Virtual Address Descriptor 權限提高弱點 - CVE-2008-4036  
-------------------------------------------------------
  
 
Memory Manager 處理記憶體配置和 Virtual Address Descriptors (VADs) 的方式中，存在權限提高弱點。 如果通過驗證的攻擊者在受影響的系統上執行蓄意製作的程式，這項弱點可能會允許權限提高。 成功利用此弱點的攻擊者在受影響系統上提高權限。 接下來，攻擊者就能安裝程式，檢視、變更或刪除資料，或是建立具有完整系統管理權限的新帳戶。
  
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-4036](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4036)。
  
#### Virtual Address Descriptor 權限提高弱點的緩和因素 - CVE-2008-4036
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少弱點影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   攻擊者必須通過驗證才能利用這項弱點。
  
#### Virtual Address Descriptor 權限提高弱點的因應措施 - CVE-2008-4036
  
Microsoft 尚未找到此項弱點的任何因應措施。
  
#### Virtual Address Descriptor 權限提高弱點的常見問題集 - CVE-2008-4036
  
**這個弱點的範圍為何？**    
這是權限提高的弱點。 成功利用此弱點的攻擊者在受影響系統上提高權限。 接下來，攻擊者就能安裝程式，檢視、變更或刪除資料，或是建立具有完整系統管理權限的新帳戶。
  
**造成這個弱點的原因為何？**    
Memory Manager 減去變數時，未正確地處理整數溢位，因而導致記憶體配置對應錯誤。
  
**什麼是 Virtual Address Descriptor？**    
VAD 是一種應用程式專用的虛擬記憶體，可讓每個應用程式擁有自己的專用位址空間。 如需更多關於 VAD 的資訊，請參閱 MSDN 文章 [Windows NT 虛擬記憶體管理員 (英文)](https://msdn.microsoft.com/en-us/library/ms810616.aspx) 和[管理 Win32 的虛擬記憶體 (英文)](https://msdn.microsoft.com/en-us/library/ms810616.aspx)。
  
**攻擊者可能會利用這項弱點採取什麼行動？**    
成功利用此弱點的攻擊者在受影響系統上提高權限。 接下來，攻擊者就能安裝程式，檢視、變更或刪除資料，或是建立具有完整系統管理權限的新帳戶。
  
**攻擊者如何利用這項弱點？**    
通過驗證的攻擊者可以執行蓄意製作的程式，而該程式可能導致整數溢位，進而毀損記憶體，而允許程式碼執行。
  
**因為這個弱點而承受風險的主要系統有哪些？**    
Windows XP、Windows Server 2003、Windows Vista 和 Windows Server 2008 可能因為這個弱點而承受風險。
  
**更新的作用何在？**    
此弱點是由整數溢位造成的。 此更新程式會在 VAD 參數周圍新增額外的驗證，藉以移除此項弱點。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB956841$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/956841">Microsoft 知識庫文件編號 956841</a></td>
</tr>
<tr class="even">
