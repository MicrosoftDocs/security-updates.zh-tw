...
**何處可找到檔案資訊詳細資料？**    
檔案資訊詳細資料可在 [Microsoft 知識庫文件編號 958215](https://support.microsoft.com/kb/958215) 中找到。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-4258](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4258)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-4259](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4259)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-4260](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4260)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-4261](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4261)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/958215">Microsoft 知識庫文件編號 958215</a></td>
</tr>
<tr class="even">
...
-   感謝 Brett Moore 與 [TippingPoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作回報 HTML 物件記憶體損毀弱點 (CVE-2008-4259)  
-   感謝 [Casaba Security](https://www.casabasecurity.com/) 的 Chris Weber 回報未經初始化的記憶體損毀弱點 (CVE-2008-4260)  
-   感謝 [Verisign iDefense Labs](https://labs.idefense.com/) 的 Jun Mao 回報 HTML 轉譯記憶體損毀弱點 (CVE-2008-4261)
