---
TOCTitle: 'MS08-032'
Title: 'Microsoft Security Bulletin MS08-032 - 中等'
ms:assetid: 'ms08-032'
ms:contentKeyID: 61238119
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms08-032(v=Security.10)'
---



Microsoft Security Bulletin MS08-032 - 中等
===========================================

ActiveX Kill Bit (刪除位元) 的積存安全性更新 (950760)
-----------------------------------------------------

發行: 2008年6月11日 | 更新: 2009年4月13日
...
這個安全性更新可解決 Microsoft Speech API 的一項公開報告的弱點。 如果使用者使用 Internet Explorer 檢視蓄意製作的網頁，而且啟用 Windows 的語音辨識功能，此弱點可能會允許遠端執行程式碼。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。 此更新還包含 BackWeb 製作的軟體 Kill Bit (刪除位元)。

對於 Microsoft Windows 2000 Service Pack 4、所有受支援版本的 Windows XP，以及所有原始發行版本的 Windows Vista 版本，此安全性更新的等級為「中度」。 但是， Kill Bit (刪除位元) 的部署也包括 Windows Vista Service Pack 1。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=cedfd988-232c-4cba-ac65-beb54b8946e0">Microsoft Windows 2000 Service Pack 4 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=cedfd988-232c-4cba-ac65-beb54b8946e0">Microsoft Windows 2000 Service Pack 4 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-023">MS08-023</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2d8957c2-e473-4dca-8d68-19fdaea36e26">Windows XP Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=2d8957c2-e473-4dca-8d68-19fdaea36e26">Windows XP Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-023">MS08-023</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2d8957c2-e473-4dca-8d68-19fdaea36e26">Windows XP Service Pack 3 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=2d8957c2-e473-4dca-8d68-19fdaea36e26">Windows XP Service Pack 3 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=62874096-7d17-4116-9795-4756e2fb6dae">Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=62874096-7d17-4116-9795-4756e2fb6dae">Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-023">MS08-023</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=dadead99-09cb-4f2b-850d-e98a627cb9f8">Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=dadead99-09cb-4f2b-850d-e98a627cb9f8">Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">低</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-023">MS08-023</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=84f9b533-b0cb-46d1-b4a8-5c9469abbd22">Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=84f9b533-b0cb-46d1-b4a8-5c9469abbd22">Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">低</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-023">MS08-023</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ac35ce19-d761-4529-9f55-1e1b5b2447ad">Windows Server 2003 SP1 for Itanium-based Systems 和 Windows Server 2003 SP2 for Itanium-based Systems (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">低</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-023">MS08-023</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4af6575e-b061-45a6-b3d8-ecb32d76b2d3">Windows Vista 和 Windows Vista Service Pack 1 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=4af6575e-b061-45a6-b3d8-ecb32d76b2d3">Windows Vista 和 Windows Vista Service Pack 1 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-023">MS08-023</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=67576acb-9cb6-4c76-9a72-dc5e5556b658">Windows Vista x64 Edition 和 Windows Vista x64 Edition Service Pack 1 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=67576acb-9cb6-4c76-9a72-dc5e5556b658">Windows Vista x64 Edition 和 Windows Vista x64 Edition Service Pack 1 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-023">MS08-023</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8a507fba-8c93-4952-91e4-98e9e7affbd2">適用於 32 位元系統的 Windows Server 2008 (英文下載更新程式)</a>\*
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=8a507fba-8c93-4952-91e4-98e9e7affbd2">適用於 32 位元系統的 Windows Server 2008 (中文下載更新程式)</a>\*</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">低</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-023">MS08-023</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1a11499d-a008-407f-9084-a5189fa27015">適用於 x64 型系統的 Windows Server 2008 (英文下載更新程式)</a>\*
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=1a11499d-a008-407f-9084-a5189fa27015">適用於 x64 型系統的 Windows Server 2008 (中文下載更新程式)</a>\*</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">低</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-023">MS08-023</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=59b1689c-e723-4d87-973e-4beac107a6f7">適用於 Itanium 系統的 Windows Server 2008 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">低</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-023">MS08-023</a></td>
</tr>
...
\***Windows Server 2008 Server Core 安裝不受影響，但是將會提供此更新。** 如果 Windows Server 2008 是使用 Server Core 安裝選項安裝，即使受到這些弱點影響的檔案可能會出現在系統上，這項更新解決的弱點並不會影響受支援的 Windows Server 2008 版本。 但是我們仍會將此更新提供給具有受影響之檔案的使用者，因為相較於您系統上目前的檔案，此更新檔案較新 (其版本號碼較高)。 如需這個安裝選項的詳細資訊，請參閱 [Server Core](https://msdn.microsoft.com/en-us/library/ms723891(vs.85).aspx) (英文)。 請注意，Server Core 安裝選項不適用於某些 Windows Server 2008 版本；請參閱[比較 Server Core 安裝選項](https://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx) (英文)。
  
**受影響軟體的注意事項：** Microsoft 並未針對此更新為其設定 Kill Bit (刪除位元) 的協力廠商控制項評估嚴重性等級。 但是，Kill Bit (刪除位元) 將會跨所有平台進行部署；包括不受 Microsoft 軟體弱點影響的平台。 另請參閱本節的＜協力廠商 Kill Bit (刪除位元)＞小節。
...
會提供這個更新程式給使用 Windows Server 2008 Server Core 安裝的使用者，但是使用者無須進行安裝。 如需更多關於 Server Core 安裝選項的詳細資訊，請參閱 [Server Core](https://msdn.microsoft.com/en-us/library/ms723891(vs.85).aspx) (英文)。 請注意，Server Core 安裝選項不適用於某些 Windows Server 2008 版本；請參閱[比較 Server Core 安裝選項](https://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx) (英文)。
...
<th style="border:1px solid black;" >Speech API 弱點 - CVE-2007-0675</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
\*對於受支援的 Windows Server 2008 的版本，無論是否使用 Server Core 安裝選項，這個更新的嚴重性等級都一樣。 如需這個安裝選項的詳細資訊，請參閱 [Server Core](https://msdn.microsoft.com/en-us/library/ms723891(vs.85).aspx) (英文)。 請注意，Server Core 安裝選項不適用於某些 Windows Server 2008 版本；請參閱[比較 Server Core 安裝選項](https://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx) (英文)。
  
**受影響軟體的注意事項：** Microsoft 並未針對此更新為其設定 Kill Bit (刪除位元) 的協力廠商控制項評估嚴重性等級。 但是，Kill Bit (刪除位元) 將會跨所有平台進行部署；包括不受 Microsoft 軟體弱點影響的平台。 另請參閱本節的＜協力廠商 Kill Bit (刪除位元)＞小節。
  
Speech API 弱點 - CVE-2007-0675  
-------------------------------
  
 
Speech 元件 sapi.dll 中存在遠端執行程式碼的弱點。攻擊者可蓄意製作網頁以利用此弱點。 當使用者檢視網頁時，此弱點可能會允許遠端執行程式碼。 使用者必須啟用 Windows Vista 中的語音辨識功能。 成功利用此弱點的攻擊者可以取得與登入使用者相同的使用者權限。
  
此控制項的設計原本不是在 Internet Explorer 中具現化。
  
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2007-0675](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0675)。
  
#### Speech API 弱點 - CVE-2007-0675 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少弱點影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   Windows Vista 的語音辨識功能預設不啟用。  
...
#### Speech API 弱點 - CVE-2007-0675 的因應措施
...
-   **避免 COM 物件在 Internet Explorer 中執行**
    ...
    **注意：** 包含 ActiveX 物件的類別識別項與對應檔案記錄於＜Speech API 弱點 - CVE-2007-0675 的常見問題集＞一節的＜更新的作用何在？＞。 以此節中的類別識別項取代下方的 {XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX}。
...
#### Speech API 弱點 - CVE-2007-0675 的常見問題集
  
**這個弱點的範圍為何？**    
這是遠端執行程式碼的弱點。 成功利用此弱點的攻擊者可以取得與登入使用者相同的使用者權限。 Windows Vista 中的語音辨識功能必須啟用和設定，攻擊者才能成功利用此弱點。
...
**造成這個弱點的原因為何？**    
語音辨識功能啟用並設定後，可能透過 Internet Explorer 播放一個音訊檔案而發出命令，使攻擊者能夠執行任意程式碼。
  
**攻擊者可能會利用這項弱點採取什麼行動？**    
成功利用此弱點的攻擊者可以取得與本機使用者相同的使用者權限。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
  
使用語音命令無法使系統執行有權限的功能，例如 UAC 不提示輸入系統管理員認證而建立使用者。 UAC 提示預設無法透過語音命令操控。 有其他障礙會使攻擊難以進行，包括喇叭與麥克風的位置、麥克風的回音，以及語音輸入的清晰度。
...
**為什麼此安全性更新不包含 Windows** **Vista** **Service Pack 1？**  
這個更新未設定 Windows Vista Service Pack 1 的 Kill Bit (刪除位元)，因為 CVE-2007-0675 描述的弱點已在 Service Pack 更新中解決了。
  
**什麼是 SAPI？**    
SAPI 是 Microsoft 語音應用程式設計介面，專供開發人員為應用程式新增語音辨識及文字轉語音功能。
  
**當安全性公告發行時，這項弱點是否已揭發出來？**    
是。 這項弱點已經遭到公開揭發。 這項弱點已被指派一般性弱點編號 CVE-2007-0675。資訊安全業界也將此弱點命名為「Vista 語音辨識」。
...
-   BackWeb 已發行[安全性公告](https://go.microsoft.com/fwlink/?linkid=119280)和更新，以解決此弱點。 如需詳細資訊及下載位置，請參閱 [BackWeb](https://go.microsoft.com/fwlink/?linkid=119280) 的安全性公告。 此 Kill Bit (刪除位元) 是應 ActiveX 控制項的擁有者要求而設定。 需要此控制項支援的客戶請連絡 [BackWeb](https://go.microsoft.com/fwlink/?linkid=119280)。 此 ActiveX 控制項的類別識別項 (CLSID) 為：  
...
| XP Service Pack 2 及 Windows XP Service Pack 3                                                         | 是       |  
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4：<br />
使用 [控制台] 中的 [新增或移除程式] 工具，或 %Windir%\\$NTUninstallKB950760$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;">更新記錄檔</td>
<td style="border:1px solid black;">所有受支援版本的 Windows XP 與 Windows XP Professional：<br />
KB950760.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">詳細資訊</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">所有受支援的 Windows Server 2003 版本：<br />
...
-   V1.1 (2009 年 4 月 13 日)： 在「受影響的軟體」與「嚴重性等級」表底下的註腳中，說明 Windows Server 2008 Server Core 安裝不受此公告所討論的弱點影響，但是仍會提供此更新。 另外還新增一個項目至＜與本安全性更新相關的常見問題集 (FAQ)＞章節，重申此類安裝無須安裝此更新。
