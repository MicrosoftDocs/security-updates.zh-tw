---
TOCTitle: 'MS08-026'
Title: 'Microsoft Security Bulletin MS08-026 - 重大'
ms:assetid: 'ms08-026'
ms:contentKeyID: 61238113
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms08-026(v=Security.10)'
---



Microsoft Security Bulletin MS08-026 - 重大
===========================================

Microsoft Word 中的弱點可能會允許遠端執行程式碼 (951207)
--------------------------------------------------------
...
這個安全性更新可解決 Microsoft Word 中數個未公開報告的弱點，這些弱點可在使用者開啟蓄意製作的 Word 檔案時，允許從遠端執行程式碼。 成功利用這類弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

對於受支援版本的 Microsoft Word 2000 與 Microsoft Outlook 2007，此安全性更新的等級為「重大」；對於受支援版本的 Microsoft Word 2002；Microsoft Word 2003；Microsoft Word Viewer 2003 與 Microsoft Word Viewer 2003 Service Pack 3；Microsoft Word 2007；Microsoft Office Compatibility Pack for Word, Excel, and PowerPoint 2007 File Formats；以及 Microsoft Office 2004 for Mac 與 Microsoft Office 2008 for Mac，此安全性更新的等級為「重要」。 如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

這個安全性更新透過修改 Microsoft Word 處理蓄意製作的 Word 檔案之方式，解決此弱點。 如需更多有關弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。

**注意：** 此更新包括其他安全防護措施，可防範攻擊者使用 Microsoft Word 利用先前在 [Microsoft 安全性摘要報告 950627](https://technet.microsoft.com/security/advisory/950627) 中描述的 Microsoft Jet 資料庫引擎之弱點所進行的公開攻擊。除了安裝此更新外，我們建議客戶安裝 [Microsoft 安全性公告 MS08-028： Microsoft Jet 資料庫引擎的弱點可能會允許遠端執行程式碼 (950749)](https://technet.microsoft.com/security/bulletin/ms08-028) 提供的更新，以取得最新防護來防範此類攻擊。
...
<td style="border:1px solid black;">
[Microsoft Word 2000 Service Pack 3 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=9215ff71-38c0-416a-b89a-fe3474160f41)  
(KB950250)  
[Microsoft Word 2000 Service Pack 3 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=9215ff71-38c0-416a-b89a-fe3474160f41)  
(KB950250)
...
<td style="border:1px solid black;">
[Microsoft Word 2002 Service Pack 3 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=b348a518-221e-4567-a797-999715a8b2ef)  
(KB950243)  
[Microsoft Word 2002 Service Pack 3 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=b348a518-221e-4567-a797-999715a8b2ef)  
(KB950243)
...
<td style="border:1px solid black;">
[Microsoft Word 2003 Service Pack 2 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=bc33d144-f917-47b8-961f-744ca847e14c)  
(KB950241)  
[Microsoft Word 2003 Service Pack 2 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=bc33d144-f917-47b8-961f-744ca847e14c)  
(KB950241)
...
<td style="border:1px solid black;">
[Microsoft Word 2003 Service Pack 3 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=bc33d144-f917-47b8-961f-744ca847e14c)  
(KB950241)  
[Microsoft Word 2003 Service Pack 3 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=bc33d144-f917-47b8-961f-744ca847e14c)  
(KB950241)
...
<td style="border:1px solid black;">
[Microsoft Word 2007 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=071ceaa2-12e3-4401-9331-2a54a93e2550)  
(KB950113)  
[Microsoft Word 2007 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=071ceaa2-12e3-4401-9331-2a54a93e2550)  
(KB950113)
...
<td style="border:1px solid black;">
[Microsoft Outlook 2007 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=071ceaa2-12e3-4401-9331-2a54a93e2550)  
(KB950113)  
[Microsoft Outlook 2007 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=071ceaa2-12e3-4401-9331-2a54a93e2550)  
(KB950113)
...
<td style="border:1px solid black;">
[Microsoft Word 2007 Service Pack 1 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=071ceaa2-12e3-4401-9331-2a54a93e2550)  
(KB950113)  
[Microsoft Word 2007 Service Pack 1 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=071ceaa2-12e3-4401-9331-2a54a93e2550)  
(KB950113)
...
<td style="border:1px solid black;">
[Microsoft Outlook 2007 Service Pack 1 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=071ceaa2-12e3-4401-9331-2a54a93e2550)  
(KB950113)  
[Microsoft Outlook 2007 Service Pack 1 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=071ceaa2-12e3-4401-9331-2a54a93e2550)  
(KB950113)
...
<tr>
<td style="border:1px solid black;">
[Microsoft Word Viewer 2003 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=bce7ea31-2bf0-4930-aff9-837bcc82a682)  
(KB950625)  
[Microsoft Word Viewer 2003 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=bce7ea31-2bf0-4930-aff9-837bcc82a682)  
(KB950625)
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Word Viewer 2003 Service Pack 3 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=bce7ea31-2bf0-4930-aff9-837bcc82a682)  
(KB950625)  
[Microsoft Word Viewer 2003 Service Pack 3 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=bce7ea31-2bf0-4930-aff9-837bcc82a682)  
(KB950625)
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office Compatibility Pack for Word, Excel, and PowerPoint 2007 File Formats (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=2d718f37-c5d1-4e15-a7e1-5a15fedef52f)  
(KB951808)  
[Microsoft Office Compatibility Pack for Word, Excel, and PowerPoint 2007 File Formats (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=2d718f37-c5d1-4e15-a7e1-5a15fedef52f)  
(KB951808)
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office Compatibility Pack for Word, Excel, and PowerPoint 2007 File Formats Service Pack 1 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=2d718f37-c5d1-4e15-a7e1-5a15fedef52f)  
(KB951808)
</td>
<td style="border:1px solid black;">
不適用
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office 2004 for Mac (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=99f54471-ccf9-4d94-a882-a05ecd128adc)  
(KB952332)
</td>
<td style="border:1px solid black;">
不適用
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office 2008 for Mac (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=395d1487-a3a6-4106-a0f8-4d6e1d6d89d2)  
(KB952331)
</td>
<td style="border:1px solid black;">
不適用
...
是，如果本公告中討論的元件隨附於您系統上安裝的 Office 套件版本，無論是否安裝此元件，我們都會為您的系統提供更新。 用於掃描受影響系統的偵測邏輯之設計旨在檢查隨附於特定 Office 套件的所有元件的更新，並會將這些更新提供給系統。 使用者若選擇不針對未加安裝但含在 Office 套件版本的元件套用更新，並不會提高該系統的安全性風險。 然而，如果使用者選擇安裝更新，則對系統的安全性或效能也不會有負面的影響。 如需有關此問題的詳細資訊，請參閱 [Microsoft 知識庫文件編號 830335](https://support.microsoft.com/kb/830335)。

**何處可找到檔案資訊詳細資料？**    
檔案資訊詳細資料可在 [Microsoft 知識庫文件編號 951207](https://support.microsoft.com/kb/951207)中找到。

**為何本次更新中仍然包含數個已發佈的安全性弱點？**    
因為解決這些弱點所需的修正作業位於相關檔案中，所以在本次更新中仍然提供對這些弱點的支援。 客戶不需要安裝數個幾乎相同的更新，只需要安裝本更新即可。

**此更新程式是否包含功能上的任何安全性相關變更？**    
是。 除了本公告＜弱點詳細資料＞一節中列出的變更外，此更新包含安全性警告的邏輯增強功能，可降低 Word 成為攻擊媒介，讓攻擊者得以利用 Microsoft Jet 資料庫引擎的弱點 (先前著述於 [Microsoft 安全性摘要報告 950627](https://support.microsoft.com/kb/95627)) 之風險。在此更新發佈之前，Word 在開啟蓄意製作且包含惡意 Jet 資料庫檔案的 Word 文件時，容易遭受攻擊。 套用此更新後，Word 會在使用者開啟 Word 文件時，提示使用者進行確認，然後再執行 SQL 命令或查詢。 除了安裝此更新外，我們十分建議客戶安裝 [Microsoft 安全性公告 MS08-028： Microsoft Jet 資料庫引擎的弱點可能會允許遠端執行程式碼 (917344)](https://technet.microsoft.com/security/bulletin/ms08-028) 提供的更新，以取得最新防護來防範此類攻擊。

**此更新屬於 Microsoft Word 的更新。 為何「受影響的軟體」表中會提到 Microsoft Outlook 2007 和 Microsoft Outlook 2007 Service Pack 1？**    
必須加以更新以解決本公告所載之弱點的檔案屬於 Microsoft Word 的核心檔案。 對於 Microsoft Word 2007 與 Microsoft Word 2007 Service Pack 1，當中的某些核心檔案是與 Microsoft Outlook 2007 及 Microsoft Outlook 2007 Service Pack 1 共用，並為 Outlook 提供編輯等功能。 因此，Outlook 2007 與 Outlook 2007 Service Pack 1 也需要進行更新，且 Word 2007 與 Word 2007 Service Pack 1 及 Outlook 2007 與 Outlook 2007 Service Pack 1 均透過同一套件提供維護。

僅安裝 Outlook 2007 或 Outlook 2007 Service Pack 1 的系統仍然需要將此 Word 更新套用於其系統。 具有 Outlook 2007 或 Outlook 2007 Service Pack 1 且也安裝了 Word 2007 或 Word 2007 Service Pack 1 的系統也需要套用此更新，但這些系統只需要安裝一次。 如需有關此問題的詳細資訊，請參閱 [Microsoft 知識庫文件編號 949370](https://support.microsoft.com/kb/949370)。

**我使用的是 Microsoft Office 2003 Service Pack 2。這個更新是否包含任何其他的安全性功能？**    
是的，作為 Microsoft Office 2003 服務模型的一部份，當 Microsoft Office 2003 Service Pack 2 使用者安裝此更新時，會將其系統升級到 Microsoft Office 2003 Service Pack 3 最初發行的安全性功能。2008 年 1 月 1 日後發行的所有 Microsoft Office 2003 Service Pack 2 更新都會包含這些安全性功能，這些安全性功能原本建置於 [Microsoft Office 2003 Service Pack 3](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=e25b7049-3e13-433b-b9d2-5e3c1132f206)。我們已徹底測試這個更新，不過跟所有更新一樣，我們建議使用者針對其系統環境和設定執行適當的測試。 如需有關此問題的詳細資訊，請參閱 [Microsoft 知識庫文件編號 951646](https://support.microsoft.com/kb/951646)。

**為什麼此更新對 Word 2000 屬於「重大」等級，但對所有其他受影響的 Word 版本僅屬於「重要」？**    
執行 Word 2002 或更新版本的使用者可使用一項內建功能，該功能提示使用者使用者開啟文件前，先執行 \[開啟\]、\[儲存\] 或 \[取消\] 選項。 此緩和因素可將弱點從「重大」減緩至「重要」，因為此弱點需要多個使用者動作才能奏效。
...
需要舊版額外支援服務的客戶，請連絡 Microsoft 客戶小組人員、技術支援經理或適當的 Microsoft 協力廠商，以取得所需的額外支援。 尚未簽訂聯盟、優先或授權合約的客戶，可以連絡當地的 Microsoft 銷售辦公室。 如需連絡資訊，請造訪 [Microsoft 全球資訊網站](https://go.microsoft.com/fwlink/?linkid=33329)，選擇國家，然後按一下 \[Go\] 查看各地的連絡電話號碼。 連絡時，請指明要連絡當地優先支援服務行銷經理。 如需更多資訊，請參閱 [Windows 作業系統產品技術支援週期常見問題集](https://go.microsoft.com/fwlink/?linkid=new) (英文)。
...
<th style="border:1px solid black;" >物件剖析弱點 - CVE-2008-1091</th>
<th style="border:1px solid black;" >Word 階層式樣式表 (CSS) 弱點 - CVE-2008-1434</th>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Word 2003 Service Pack 2 與 Microsoft Word 2003 Service Pack 3</td>
<td style="border:1px solid black;"><strong>重要</strong><br />
遠端執行程式碼</td>
<td style="border:1px solid black;"><strong>重要</strong><br />
遠端執行程式碼</td>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Word Viewer 2003 與 Microsoft Word Viewer 2003 Service Pack 3</td>
<td style="border:1px solid black;"><strong>重要</strong><br />
遠端執行程式碼</td>
<td style="border:1px solid black;"><strong>重要</strong><br />
遠端執行程式碼</td>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Word 2007 與 Microsoft Word 2007 Service Pack 1</td>
<td style="border:1px solid black;"><strong>重要</strong><br />
遠端執行程式碼</td>
<td style="border:1px solid black;"><strong>重要</strong><br />
遠端執行程式碼</td>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Outlook 2007 與 Microsoft Outlook 2007 Service Pack 1</td>
<td style="border:1px solid black;"><strong>重大</strong><br />
遠端執行程式碼</td>
<td style="border:1px solid black;"><strong>重要</strong><br />
遠端執行程式碼</td>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office Compatibility Pack for Word, Excel, and PowerPoint 2007 File Formats 與 Microsoft Office Compatibility Pack for Word, Excel, and PowerPoint 2007 File Formats Service Pack 1</td>
<td style="border:1px solid black;"><strong>重要</strong><br />
遠端執行程式碼</td>
<td style="border:1px solid black;"><strong>重要</strong><br />
遠端執行程式碼</td>
...
物件剖析弱點 - CVE-2008-1091  
----------------------------
  
 
Microsoft Office 處理蓄意製作的 RTF 格式 (.rtf) 檔案的方式中，存在遠端執行程式碼的弱點。 如果使用者在 Word 開啟蓄意製作且含有格式錯誤字串的 .rtf 檔案，或者預覽 RTF 電子郵件中蓄意製作且含有格式錯誤字串的 .rtf 檔案，則此弱點可能會允許從遠端執行程式碼。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-1091](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1091)。
  
#### 物件剖析弱點 - CVE-2008-1091 的緩和因素
...
-   在開啟文件之前，系統會提示已安裝並使用 [Office 2000 的 Office 文件開啟確認工具](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=8b5762d2-077f-4031-9ee6-c9538e9f2a2f)之使用者 \[開啟\]、\[儲存\] 或 \[取消\] 等選項。 Office 文件開啟確認工具的功能已內建在 Office XP 和更新版本的 Office 中。
  
#### 物件剖析弱點 - CVE-2008-1091 的因應措施
...
-   **使用 Microsoft Office 檔案封鎖原則以避免開啟來自於未知或不信任來源與位置的 Office 2003 和舊版文件。**
    ...
    **注意：** 為將 'FileOpenBlock' 與 Office 2007 搭配使用，必須套用截至 2007 年 5 月的所有最新 Office 2007 安全性更新。
  
    **因應措施的影響：** 使用者若設定檔案封鎖原則、但尚未依照 [Microsoft 知識庫文件編號 922848](https://support.microsoft.com/kb/922848) 所討論設定特殊的「豁免目錄」，將無法在 Office 2003 或 2007 Microsoft Office System 中開啟 RTF 檔案。
...
**攻擊者如何利用這項弱點？**      
此弱點需要使用者透過受影響 Microsoft Word 版本來開啟蓄意製作的 RTF 檔案。
  
若是電子郵件攻擊，攻擊者可能會透過以下方式利用此弱點：傳送蓄意製作的 RTF 電子郵件給將 Word 作為預設編輯程式並以 RTF 格式或 HTML 預覽電子郵件的系統。
  
**注意：** 根據預設，Outlook 2003 不會將 Word 作為其預設編輯程式。 但 Outlook 2007 則是如此。
  
若是網頁式攻擊，攻擊者必須架設網站，其中包含嘗試利用此弱點時必須使用的 .rtf 檔案。 此外，受侵害的網站以及接受或存放使用者提供之內容的網站裡，也可能包含蓄意製作以利用本弱點的內容。 攻擊者並不能強迫使用者造訪蓄意製作的網站， 而是引誘使用者自行前往，一般的做法是設法讓使用者按一下電子郵件或 Instant Messenger 訊息中通往攻擊者網站的連結。
  
**因為這個弱點而承受風險的主要系統有哪些？**      
使用 Microsoft Word 與/或 Microsoft Outlook 的系統之風險最高。 若系統管理員允許使用者登入伺服器並執行程式，則伺服器可能遭受更大的風險。 然而，最佳實務強烈建議您制止這種行為。
...
Word 階層式樣式表 (CSS) 弱點 - CVE-2008-1434  
--------------------------------------------
  
 
Microsoft Word 處理蓄意製作 Word 檔的方式中，存在遠端執行程式碼的弱點。 如果使用者開啟蓄意製作且含有格式錯誤的 CSS 值之 Word 檔案，此弱點可能會允許從遠端執行程式碼。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-1434](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1434)。
  
#### Word 階層式樣式表 (CSS) 弱點 - CVE-2008-1434 的緩和因素
...
#### Word 階層式樣式表弱點 - CVE-2008-1434 的因應措施
...
-   **使用 Microsoft Office 檔案封鎖原則以避免開啟來自於未知或不信任來源與位置的 Office 2003 和舊版文件。**
    ...
    **因應措施的影響：** 使用者若設定檔案封鎖原則、但尚未依照 [Microsoft 知識庫文件編號 922848](https://support.microsoft.com/kb/922848) 的說明來設定特殊的「豁免目錄」，將無法在 Word 或 Outlook 中開啟 HTML 文件。
    ...
    **因應措施的影響：** 使用者若設定檔案封鎖原則、但尚未依照 [Microsoft 知識庫文件編號 922848](https://support.microsoft.com/kb/922848) 所討論設定特殊的「豁免目錄」，將無法在 Office 2003 或 2007 Microsoft Office System 中開啟 HTML 檔案。
...
#### Word 階層式樣式表弱點 - CVE-2008-1434 的常見問題集
  
**這個弱點的範圍為何？**      
這是遠端執行程式碼的弱點。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個弱點的原因為何？**      
造成這個弱點的原因在於：處理蓄意製作 Word 檔案中的 CSS 值時發生記憶體處理錯誤。 此錯誤可能會損毀系統記憶體，使攻擊者有機會執行任意程式碼。
...
**更新的作用何在？**      
此更新會修改 Word 開啟 Word 檔案時，處理 CSS 值時管理記憶體的方式，進而移除此項弱點。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/951207">Microsoft 知識庫文件編號 951207</a></td>
</tr>
<tr class="even">
...
#### Word 2003 與 Word 2003 Viewer (所有版本)
...
#### Word 2007 與 Microsoft Office Compatibility Pack for Word, Excel, and PowerPoint 2007 File Formats (所有版本)
...
從 [Microsoft Mactopia 網站](https://www.microsoft.com/mac/downloads.mspx?pid=mactopia_office2004&fid=632ec4b3-b998-4f22-b9d6-93c09c385479%20viewer)下載並安裝適當語言版本的 Microsoft Office 2004 for Mac 11.4.2 Update。
  
-   結束所有正在執行的應用程式，包括防毒應用程式、所有 Microsoft Office 應用程式、Microsoft Messenger for Mac 及 Office Notifications，因為這些程式可能會影響到安裝工作。  
-   開啟桌面上的 \[Microsoft Office 2004 for Mac 11.4.2 Update\] 磁碟區。 本步驟可能已經為您執行完畢。  
-   若要開始更新程序，請在 \[Microsoft Office 2004 for Mac 11.4.2 Update\] 磁碟區視窗中，按兩下 \[Microsoft Office 2004 for Mac 11.4.2 Update\] 應用程式，然後依照螢幕上的指示執行。  
-   如果成功完成安裝，您可將更新安裝程式由硬碟上移除。 若要確認安裝是否完成，請參閱以下＜確認更新的安裝＞標題之說明。 若要移除更新安裝程式，請先將 \[Microsoft Office 2004 for Mac 11.4.2 Update\] 磁碟區移至資源回收筒，然後將您下載的檔案拖放到資源回收筒中。
...
從 [Microsoft Mactopia 網站](https://www.microsoft.com/mac/downloads.mspx?pid=mactopia_office2004&fid=632ec4b3-b998-4f22-b9d6-93c09c385479%20viewer)下載並安裝適當語言版本的 Microsoft Office 2008 for Mac Service Pack 1。
  
-   結束所有正在執行的應用程式，包括防毒應用程式、所有 Microsoft Office 應用程式、Microsoft Messenger for Mac 及 Office Notifications，因為這些程式可能會影響到安裝工作。  
-   開啟桌面上的 \[Microsoft Office 2008 for Mac Service Pack1\] 磁碟區。 本步驟可能已經為您執行完畢。  
-   若要開始更新程序，請在 \[Microsoft Office 2008 for Mac Service Pack 1\] 磁碟區視窗中，按兩下 \[Microsoft Office 2008 for Mac Service Pack 1\] 應用程式，然後依照螢幕上的指示執行。  
-   如果成功完成安裝，您可將更新安裝程式由硬碟上移除。 若要確認安裝是否完成，請參閱以下＜確認更新的安裝＞標題之說明。 若要移除更新安裝程式，請先將 Microsoft Office 2008 for Mac Service Pack 1 磁碟區移至資源回收筒，然後將您下載的檔案拖放到資源回收筒中。
...
-   感謝 Jun Mao 與 [iDefense Labs](https://labs.idefense.com/) 合作，回報 Word 階層式樣式表 (CSS) 弱點 - CVE-2008-1434。  
-   感謝 [team509](https://www.team509.com/) 的 wushi 與 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，回報物件剖析弱點 - CVE-2008-1091。
