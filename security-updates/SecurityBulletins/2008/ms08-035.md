...
**已知問題。**  [Microsoft 知識庫文件編號 953235](https://support.microsoft.com/kb/953235) 詳細記錄了目前已知安裝此安全性更新可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。
...
Microsoft 已經發現導向到安裝此更新的伺服器的 LDAP 查詢，嘗試在 Microsoft Exchange Server 的 Exchange 管理主控台顯示大量信箱清單時，可能會失敗。 如需此問題的詳細資訊，請參閱 [Microsoft 知識庫文件編號 953235](https://support.microsoft.com/kb/953235) 的＜已知問題＞小節。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-1445](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1445)。
...
-   **在周邊防火牆中封鎖 TCP 連接埠 389 和 3268**
    ...
    上述連接埠用於起始與受影響元件的連線。 在企業防火牆封鎖上述連接埠 (含輸入及輸出) 有助於保護防火牆後的系統免遭此弱點的影響。 建議您封鎖所有網際網路中來路不明的輸入通訊，以防他人利用其他連接埠攻擊系統。 如需更多關於連接埠的資訊，請參閱 [TCP 和 UDP 連接埠的指派](https://go.microsoft.com/fwlink/?linkid=21312) (英文)。
...
[ADAM](https://technet2.microsoft.com/windowsserver/en/library/29fb059e-544c-4577-bf7c-ba4b08df48431033.mspx?mfr=true) 是一項輕量型目錄存取通訊協定 (LDAP) 目錄服務，是以 Windows XP 和 Windows Server 2003 使用者服務的形式執行，而非系統服務。
  
**什麼是 Active Directory 輕量型目錄服務 (AD LDS)？**    
[AD LDS](https://technet2.microsoft.com/windowsserver2008/en/library/6a3bedf7-9c5b-4ada-9a51-6b794adc9ab81033.mspx?mfr=true) 是一項輕量型目錄存取通訊協定 (LDAP) 目錄服務，是以 Windows Server 2008 使用者服務的形式執行，而非系統服務。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/953235">Microsoft 知識庫文件編號 953235</a></td>
</tr>
<tr class="even">
...
-   感謝 [Securify](https://www.securify.com/) 的 Alex Matthews 回報 Active Directory 弱點 – (CVE-2008-1445)
