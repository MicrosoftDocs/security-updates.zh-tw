---
TOCTitle: 'MS08-021'
Title: 'Microsoft Security Bulletin MS08-021 - 重大'
ms:assetid: 'ms08-021'
ms:contentKeyID: 61238108
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms08-021(v=Security.10)'
---



Microsoft Security Bulletin MS08-021 - 重大
===========================================

GDI 中的弱點可能會允許遠端執行程式碼 (948590)
---------------------------------------------
...
這個安全性更新可解決 GDI 中兩項未公開報告的弱點。 如果使用者開啟蓄意製作的 EMF 或 WMF 影像檔案，利用上述弱點可能會允許遠端執行程式碼。 成功利用這類弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。

這是適用於 Microsoft Windows 2000 Service Pack 4 以及所有受支援版本之 Windows XP、Windows Server 2003、Windows Vista 及 Windows Server 2008 的重要安全性更新。如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此安全性更新可藉由修改 GDI 處理整數計算與字串參數的方式來解決此弱點。 如需更多有關弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=caac000a-22b6-48cb-aa00-1a0bfe886de2">Microsoft Windows 2000 Service Pack 4 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=caac000a-22b6-48cb-aa00-1a0bfe886de2">Microsoft Windows 2000 Service Pack 4 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-046">MS07-046</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c2763dd8-a03e-4a48-aa86-a7ec00250a7a">Windows XP Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=c2763dd8-a03e-4a48-aa86-a7ec00250a7a">Windows XP Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-046">MS07-046</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=166f2ab5-913c-47a9-86fe-b814797b751e">Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-046">MS07-046</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=bee91d80-d49a-4d3d-82d6-d5aa63f54979">Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=bee91d80-d49a-4d3d-82d6-d5aa63f54979">Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-046">MS07-046</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e3dde449-e062-4ce0-a9f4-433bff23e224">Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=e3dde449-e062-4ce0-a9f4-433bff23e224">Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-046">MS07-046</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7886a802-f2b5-489c-b14b-631f4c4c0742">Windows Server 2003 SP1 for Itanium-based Systems 和 Windows Server 2003 SP2 for Itanium based Systems (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-046">MS07-046</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9b51deb8-3873-4146-977f-7e3d0840a4c5">Windows Vista 和 Windows Vista Service Pack 1 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=9b51deb8-3873-4146-977f-7e3d0840a4c5">Windows Vista 和 Windows Vista Service Pack 1 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4ad6dcd1-6ea5-43bf-8bee-a5f507beadc6">Windows Vista x64 Edition 和 Windows Vista x64 Edition Service Pack 1 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=4ad6dcd1-6ea5-43bf-8bee-a5f507beadc6">Windows Vista x64 Edition 和 Windows Vista x64 Edition Service Pack 1 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=006d5c47-53e6-4ee1-932c-497611804938">適用於 32 位元系統的 Windows Server 2008 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=006d5c47-53e6-4ee1-932c-497611804938">適用於 32 位元系統的 Windows Server 2008 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8909f144-655b-4f07-916f-fd967f1efb2b">適用於 x64 系統的 Windows Server 2008 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=8909f144-655b-4f07-916f-fd967f1efb2b">適用於 x64 系統的 Windows Server 2008 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b7771a4a-4e4f-48d1-8551-bb8b778ca5a7">適用於 Itanium 系統的 Windows Server 2008 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=b7771a4a-4e4f-48d1-8551-bb8b778ca5a7">適用於 Itanium 系統的 Windows Server 2008 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
...
**何處可找到檔案資訊詳細資料？**    
檔案資訊詳細資訊可在 [Microsoft 知識庫文件編號 948590](https://support.microsoft.com/kb/948590)中找到。
...
<th style="border:1px solid black;" >GDI 堆積溢位弱點 - CVE-2008-1083</th>
<th style="border:1px solid black;" >GDI 堆疊溢位弱點 – CVE-2008-1087</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
GDI 堆積溢位弱點 - CVE-2008-1083  
--------------------------------
  
 
GDI 處理整數計算的方式中，存在遠端執行程式碼的弱點。 如果使用者開啟蓄意製作的 EMF 或 WMF 影像檔案，此弱點可能會允許遠端執行程式碼。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來能在系統上安裝程式；檢視、變更或刪除資料；或建立新帳戶。
  
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-1083](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1083)。
  
#### GDI 堆積溢位弱點 - CVE-2008-1083 的緩和因素
...
#### GDI 堆積溢位弱點 - CVE-2008-1083 的因應措施
  
因應措施指的是無法徹底修正弱點，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。 Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能。
  
-   修改登錄以關閉中繼檔案處理  
    套用了 [MS07-017](https://go.microsoft.com/fwlink/?linkid=84687) 或使用 Windows Vista 或 Windows Server 2008 的客戶可透過修改登錄來停用中繼檔案處理。 這個設定有助於保護受影響系統，防範嘗試利用此弱點所發動的攻擊。  
    若要修改機碼，請依照下列步驟進行：  
    ...
    **因應措施的影響：** 關閉中繼檔案的處理可能導致軟體或系統元件的外觀品質降低。 關閉中繼檔案的處理也可能導致軟體或系統元件完全失敗。 此動作已被識別為可能會造成重大功能影響，在決定其適用性之前，應先仔細進行評估與測試。
    ...
    如需更多關於這個設定的資訊，請參閱 [Microsoft 知識庫文件編號 941835](https://support.microsoft.com/kb/941835)。
    ...
    **有關因應措施資訊的重要通知。**
    ...
    本文所提供的因應措施資訊僅作為未知安全性弱點的臨時 (緊急) 解決方案。 一旦 Microsoft 提供安全性更新，或在安全性公告中提供更詳盡的因應措施資訊，則不應繼續使用或依賴此因應措施；您應該立即套用所有安全性更新與/或 Microsoft 隨後提供的更新因應措施資訊。 在將此因應措施套用於沒有可用之安全性更新的 Microsoft 軟體版本這一事件中，若有 Microsoft 軟體的最新版本解決了基本安全性弱點或即將更新以解決基本安全性弱點，那麼就不能僅依靠此因應措施來作為永久解決方案；您應該儘早安裝此 Microsoft 軟體及安全性更新的最新版本。
  
#### GDI 堆積溢位弱點 - CVE-2008-1083 的常見問題集
  
**這個弱點的範圍為何？**    
這是遠端執行程式碼的弱點。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個弱點的原因為何？**    
當 GDI 不恰當處理蓄意製作的 EMF 或 WMF 影像檔案中格式錯誤的標題時，發生緩衝區溢位，因此導致此弱點。
  
**什麼是 GDI？**    
Microsoft Windows 圖形裝置介面 (GDI) 可讓應用程式在視訊畫面及印表機上使用圖形和格式化文字。 Windows 應用程式不會直接存取圖形硬體。 而是由 GDI 代表應用程式與裝置驅動程式互動。 如需更多關於 GDI 的資訊，請造訪 [Windows GDI 起始網頁。](https://msdn2.microsoft.com/en-us/library/ms536795.aspx)
  
**什麼是 Windows 中繼檔案 (WMF) 與增強型中繼檔案 (EMF) 影像格式？**  
...
如需有關影像類型及格式的更多資訊，請參閱 [Microsoft 知識庫文件編號 320314](https://support.microsoft.com/default.aspx?scid=kb;en-us;320314)。您也可以在 [MSDN Library 網站](https://msdn2.microsoft.com/en-us/library/ms536391.aspx)中找到有關這些檔案格式的其他資訊。
...
若是電子郵件攻擊，攻擊者可能會利用這項弱點，向使用者傳送蓄意製作的 EMF 或 WMF 影像檔案或內嵌有蓄意製作之 EMF 或 WMF 影像檔案的 Office 文件，然後說服使用者開啟該文件或檢視含有蓄意製作影像檔案的電子郵件。
  
在網頁攻擊的案例中，攻擊者必須架設網站，其中包含嘗試利用此弱點的 EMF 或 WMF 影像檔案。 此外，受侵害的網站以及接受或存放使用者提供之內容的網站裡，也可能包含蓄意製作以利用本弱點的內容。 攻擊者並不能強迫使用者造訪蓄意製作的網站， 而是引誘使用者自行前往，一般的做法是設法讓使用者按一下電子郵件或 Instant Messenger 訊息中通往攻擊者網站的連結。
  
**因為這個弱點而承受風險的主要系統有哪些？**    
目前支援的所有 Windows 系統皆有風險。 Windows XP Service Pack 3 不受此弱點的影響。
  
**更新的作用何在？**    
更新程式能透過修改 GDI 執行整數計算的方式，來防止發生堆積溢位狀況，進而移除此項弱點。
...
GDI 堆疊溢位弱點 - CVE-2008-1087  
--------------------------------
  
 
GDI 處理 EMF 檔案之檔案名稱參數的方式中，存在遠端執行程式碼的弱點。 如果使用者開啟蓄意製作的 EMF 影像檔案，此弱點可能會允許遠端執行程式碼。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來能在系統上安裝程式；檢視、變更或刪除資料；或建立新帳戶。
  
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-1087](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1087)。
  
#### GDI 堆疊溢位弱點 - CVE-2008-1087 的緩和因素
...
#### GDI 堆疊溢位弱點 - CVE-2008-1087 的因應措施
...
#### GDI 堆疊溢位弱點 - CVE-2008-1087 的常見問題集
  
**這個弱點的範圍為何？**    
這是遠端執行程式碼的弱點。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個弱點的原因為何？**    
當 GDI 不恰當處理蓄意製作的 EMF 影像檔案中格式錯誤的檔案名稱參數時，發生堆疊溢位，因此導致此弱點。
  
**什麼是 GDI？**    
Microsoft Windows 圖形裝置介面 (GDI) 可讓應用程式在視訊畫面及印表機上使用圖形和格式化文字。 Windows 應用程式不會直接存取圖形硬體。 而是由 GDI 代表應用程式與裝置驅動程式互動。 如需更多關於 GDI 的資訊，請造訪 [Windows GDI 起始網頁。](https://msdn2.microsoft.com/en-us/library/ms536795.aspx)
  
**什麼是 Windows 增強型中繼檔案 (EMF) 影像格式？**  
EMF 影像是 32 位元格式，可同時包含向量資訊及點陣圖資訊。 此格式是 Windows 中繼檔案格式的加強版，包含更多的功能。
...
在網頁攻擊的案例中，攻擊者必須架設網站，其中包含嘗試利用此弱點的 EMF 影像檔案。 此外，受侵害的網站以及接受或存放使用者提供之內容的網站裡，也可能包含蓄意製作以利用本弱點的內容。 攻擊者並不能強迫使用者造訪蓄意製作的網站， 而是引誘使用者自行前往，一般的做法是設法讓使用者按一下電子郵件或 Instant Messenger 訊息中通往攻擊者網站的連結。
  
**因為這個弱點而承受風險的主要系統有哪些？**    
目前支援的所有 Windows 系統皆有風險。 Windows XP Service Pack 3 不受此弱點的影響。
  
**更新的作用何在？**    
更新程式能透過修改 GDI 處理檔案名稱參數的方式，來防止發生堆疊溢位狀況，進而移除此項弱點。
...
| 適用於 Itanium 系統的 Windows Vista 和適用於 Itanium 系統的 Windows Vista Service Pack 1               | 否      | 否                     | 請參閱下面的＜Windows Vista 和 Windows Server 2008 注意事項＞ | 是        |  
| Windows Server 2008                                                                                    | 否      | 否                     | 請參閱下面的＜Windows Vista 和 Windows Server 2008 注意事項＞ | 是        |
...
**Windows** **Vista** **和 Windows Server 2008 注意事項**：Microsoft Systems Management Server 2003 Service Pack 3 包含對 Windows Vista 管理能力的支援。
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4：<br />
使用 [控制台] 中的 [新增或移除程式] 工具，或 %Windir%\$NTUninstallKB948590Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/948590">Microsoft 知識庫文件編號 948590</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>移除資訊</strong></td>
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或 %Windir%\$NTUninstallKB948590$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/948590">Microsoft 知識庫文件編號 948590</a></td>
...
-   感謝 [iDefense Labs](https://labs.idefense.com/) 的 Jun Mao 回報 GDI 堆積溢位弱點 (CVE-2008-1083)。  
-   感謝 [Zero Day Initiative](https://www.zerodayinitiative.com/) 的 Sebastian Apelt 回報 GDI 堆積溢位弱點 (CVE-2008-1083)。  
-   感謝 [SkyRecon](https://www.skyrecon.com/) 的 Thomas Garnier 回報 GDI 堆積溢位弱點 (CVE-2008-1083)。  
-   感謝 Yamata Li 回報 GDI 堆疊溢位弱點 (CVE-2008-1087)。
