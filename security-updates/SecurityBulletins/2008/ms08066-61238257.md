...
**已知問題。** [Microsoft 知識庫文件編號 956803](http://support.microsoft.com/kb/956803) 中有記載目前已知安裝此安全性更新後，可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b16d9dac-c430-4dd8-a1e5-9a614801f1d9">Windows XP Service Pack 2 及 Windows XP Service Pack 3 (英文下載更新程式)</a>
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=b16d9dac-c430-4dd8-a1e5-9a614801f1d9">Windows XP Service Pack 2 及 Windows XP Service Pack 3 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=5b607efc-c6fb-4079-8478-e4f3262386d3">Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ee88ff2d-1b12-4f4c-a081-9f27a6fba074">Windows Server 2003 Service Pack 1 與 Windows Server 2003 Service Pack 2 (英文下載更新程式)</a>
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=ee88ff2d-1b12-4f4c-a081-9f27a6fba074">Windows Server 2003 Service Pack 1 與 Windows Server 2003 Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ab4d94d3-458c-4946-ab7f-03a279629d25">Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=ab4d94d3-458c-4946-ab7f-03a279629d25">Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=63234f85-6e5d-4ef6-b7cf-d1d2c78a5517">Windows Server 2003 SP1 for Itanium-based Systems 和 Windows Server 2003 SP2 for Itanium-based Systems (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
**何處可找到檔案資訊詳細資料？**    
檔案資訊詳細資料請參閱 [Microsoft 知識庫文件編號 956803](http://support.microsoft.com/kb/956803)。
  
**安裝此安全性更新後，已知可能會發生的問題有哪些？**    
[Microsoft 知識庫文件編號 956803](http://support.microsoft.com/kb/956803) 詳細記錄了安裝此安全性更新時，目前已知可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-3464](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3464)。
...
**什麼是 AFD 元件？**    
AFD 元件提供包含於 afd.sys 檔案的「附屬功能驅動程式」，可支援 Windows Socket 應用程式。 afd.sys 驅動程式會以核心模式執行，並管理 Winsock TCP/IP 通訊通訊協定。 此 Winsock 核心介面提供 TDI 傳輸的存取權限。 如需更多關於 AFD 元件的資訊，請參閱下列 [Microsoft 網站](http://msdn.microsoft.com/en-us/library/aa940505.aspx)。
  
**什麼是 TDI 元件？**  
傳輸驅動程式介面 (TDI) 定義了曝露在所有傳輸通訊協定堆疊上緣的核心模式網路介面。 這類堆疊的最高層級通訊協定驅動程式，支援用於更高層級核心模式網路用戶端的 TDI 介面。 如需更多關於 TDI 元件的資訊，請參閱下列 [Microsoft 網站](http://msdn.microsoft.com/en-us/library/ms801224.aspx)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/956803">Microsoft 知識庫文件編號 956803</a></td>
</tr>
<tr class="even">
...
-   感謝 [SkyRecon](http://www.skyrecon.com/) 的 Fabien Le Mentec 回報 AFD 核心覆寫弱點 (CVE-2008-3464)
