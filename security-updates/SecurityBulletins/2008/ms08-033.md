...
**已知問題。** [Microsoft 知識庫文件編號 951698](https://support.microsoft.com/kb/951698) 中有記載目前已知安裝此安全性更新後，可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。
...
此公告之修訂旨在宣佈 [Microsoft 知識庫文件編號 951698](https://support.microsoft.com/kb/951698) 已經更新，以說明和 Microsoft Baseline Security Analyzer (MBSA) 2.1 相關的已知問題之修正，以及此更新的偵測資訊。
...
**何處可找到檔案資訊詳細資料？**    
檔案資訊詳細資料可在 [Microsoft 知識庫文件編號 951698](https://support.microsoft.com/kb/951698)中找到。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-0011](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0011)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-1444](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1444)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/951698">Microsoft 知識庫文件編號 951698</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">在某些情況下，此更新程式不需要重新開機。 如果需要的檔案正在使用中，更新程式會要求重新開機。 在此情況下，系統會出現訊息建議您重新開機。<br />
<br />
若要減少重新開機的可能性，請在安裝安全性更新之前，停止所有受影響的服務，並關閉所有可能使用受影響檔案的應用程式。 如需系統可能會提示您重新啟動的原因之詳細資訊，請參閱 <a href="https://support.microsoft.com/kb/887012">Microsoft 知識庫文件編號 887012</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">HotPatching</td>
<td style="border:1px solid black;">不適用。</td>
...
-   感謝 [IBM Internet Security Systems X-Force](https://xforce.iss.net/) 研究人員 Mark Dowd 回報 MJPEG 解碼器弱點 (CVE-2008-0011)  
-   感謝匿名研究人員與 [TippingPoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作回報格式剖析弱點 (CVE-2008-1444)
