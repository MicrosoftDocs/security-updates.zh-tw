...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=714a49cd-5bca-4719-96a1-e1077f279533">Outlook 2000 Service Pack 3 (英文下載更新程式)</a><br />
(KB946986)  
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=714a49cd-5bca-4719-96a1-e1077f279533">Outlook 2000 Service Pack 3 (中文下載更新程式)</a><br />
(KB946986)</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=59853687-d885-4059-9460-ee403855dbd8">Outlook 2002 Service Pack 3 (英文下載更新程式)</a><br />
(KB946985)  
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=59853687-d885-4059-9460-ee403855dbd8">Outlook 2002 Service Pack 3 (中文下載更新程式)</a><br />
(KB946985)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms07-003">MS07-003</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=fccc7c4c-8496-4682-bd46-6590503c1bf2">Outlook 2003 Service Pack 2 (英文下載更新程式)</a><br />
(KB945432)  
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=fccc7c4c-8496-4682-bd46-6590503c1bf2">Outlook 2003 Service Pack 2 (中文下載更新程式)</a><br />
(KB945432)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms07-003">MS07-003</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=fccc7c4c-8496-4682-bd46-6590503c1bf2">Outlook 2003 Service Pack 3 (英文下載更新程式)</a><br />
(KB945432)  
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=fccc7c4c-8496-4682-bd46-6590503c1bf2">Outlook 2003 Service Pack 3 (中文下載更新程式)</a><br />
(KB945432)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=4e2baf00-88eb-4eb6-961a-54245b363c21">Outlook 2007 (英文下載更新程式)</a><br />
(KB946983)  
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=4e2baf00-88eb-4eb6-961a-54245b363c21">Outlook 2007 (中文下載更新程式)</a><br />
(KB946983)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-0110](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0110)。
...
| 更新記錄檔                             | 使用者可透過 /log 參數啟用詳細資訊記錄；請參閱 [Microsoft 知識庫文件編號 912203](http://support.microsoft.com/kb/912203) 以取得更多詳細資訊。 |  
...
**注意**：您可以在同一個命令中合併使用這些參數。 為符合回溯相容性，安全性更新程式也支援舊版安裝程式使用的安裝參數。 如需有關受支援安裝參數的其他資訊，請參閱 [Microsoft 知識庫文件編號 912203](http://support.microsoft.com/kb/912203)。如需更多關於安裝程式的相關資訊，請造訪 [Microsoft TechNet 網站](http://go.microsoft.com/fwlink/?linkid=38951)。
...
-   感謝 [iDefense Labs](http://labs.idefense.com/) 的 Greg MacManus 回報 Outlook URI 弱點 (CVE-2008-0110)
