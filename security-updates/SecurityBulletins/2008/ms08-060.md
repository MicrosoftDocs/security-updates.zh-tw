...
**何處可找到檔案資訊詳細資料？**    
檔案資訊詳細資料請參閱 [Microsoft 知識庫文件編號 957280](https://support.microsoft.com/kb/957280)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-4023](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4023)。
...
**什麼是 LDAP？**    
輕量型目錄存取通訊協定 ([LDAP](https://msdn2.microsoft.com/en-us/library/aa503238.aspx)) 是一個開放的網路通訊協定標準，其設計旨在提供分散式目錄的存取。
  
**什麼是 LDAP over SSL？**    
依照預設，LDAP 流量的傳輸不安全。 但是，可以透過使用安全通訊端層 (SSL) / 傳輸層安全性 (TLS) 技術，讓 LDAP 流量變成機密又安全。 根據 [Microsoft 知識庫文件編號 321051](https://support.microsoft.com/kb/321051/en-us) 中的指示，系統管理員可以透過從 Microsoft 憑證授權單位 (CA) 或非 Microsoft CA 安裝正確格式化的憑證，來啟動 LDAP over SSL (LDAPS)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/957280">Microsoft 知識庫文件編號 957280</a></td>
</tr>
<tr class="even">
...
-   感謝 [nCircle](https://www.ncircle.com/) 的 Paul Miseiko 回報 Active Directory 溢位弱點 (CVE-2008-4023)
