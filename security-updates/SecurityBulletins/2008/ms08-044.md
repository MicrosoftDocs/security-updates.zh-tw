...
**何處可找到檔案資訊詳細資料？**    
檔案資訊詳細資料可在 [Microsoft 知識庫文件編號 924090](https://support.microsoft.com/kb/924090)中找到。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-3019](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3019)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-3018](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3018)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-3021](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3021)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-3020](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3020)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-3460](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3460)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/921595">Microsoft 知識庫文件編號 921595</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/921596">Microsoft 知識庫文件編號 921596</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/921598">Microsoft 知識庫文件編號 921598</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/925256">Microsoft 知識庫文件編號 925256</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/955428">Microsoft 知識庫文件編號 955428</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
-   感謝 [NGS Software](https://www.nextgenss.com/) 的 Shaun Colley 回報 Microsoft 格式錯誤的 PICT 篩選器弱點 (CVE-2008-3018)。  
-   感謝 [Zero Day Initiative (ZDI)](https://www.zerodayinitiative.com/) 回報 Microsoft PICT 篩選器剖析弱點 (CVE-2008-3021)。  
-   感謝匿名研究人員與 [iDefense VCP](https://labs.idefense.com/) 合作回報 Microsoft 格式錯誤的 BMP 篩選器弱點 (CVE-2008-3020)。  
-   感謝 [iDefense VCP](https://labs.idefense.com/) 的 Damian Put working 合作回報 Microsoft Office WPG 影像檔案堆積損毀弱點 (CVE-2008-3460)。
