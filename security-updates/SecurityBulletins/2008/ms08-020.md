...
**何處可找到檔案資訊詳細資料？**    
檔案資訊詳細資訊可在 [Microsoft 知識庫文件編號 945553](https://support.microsoft.com/kb/945553)中找到。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-0087](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0087)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/945553">Microsoft 知識庫文件編號 945553</a></td>
</tr>
<tr class="even">
...
-   感謝 [Trusteer](https://www.trusteer.com/) 的 Amit Klein 回報 DNS 偽造攻擊弱點 – (CVE-2008-0087)。  
-   感謝 [Scanit](https://www.scanit.be/) 的 Alla Berzroutchko 回報 DNS 偽造攻擊弱點 – (CVE-2008-0087)。  
-   感謝 [Nominet UK](https://www.nominet.org.uk/) 的 Roy Arends 回報 DNS 偽造攻擊弱點 – (CVE-2008-0087)。
