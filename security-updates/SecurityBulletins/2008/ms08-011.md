...
**已知問題。** [Microsoft 知識庫文件編號 947081](https://support.microsoft.com/kb/947081) 詳細記錄了目前已知安裝此安全性更新可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=30c9c3fe-fb85-43d9-bbc3-0b30d3a20286">Microsoft Works 6 File Converter (英文下載更新程式)</a><br />
(KB943973)  
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=30c9c3fe-fb85-43d9-bbc3-0b30d3a20286">Microsoft Works 6 File Converter (中文下載更新程式)</a><br />
(KB943973)</td>
...
**此更新如何解決此公告所討論的弱點？**    
此更新以不受影響的轉換程式版本，取代受影響系統上有弱點的 Works File Converter 版本。 不過在安裝此更新後，當使用者第一次嘗試開啟 .wps 檔案時，系統會提示使用者從 [Microsoft 下載中心下載 Microsoft Works 6 - 9 Converter](https://www.microsoft.com/download/details.aspx?familyid=bf41401e-70fa-465d-ae2e-cf44dbf05297&displaylang=en)。 在系統上安裝 Microsoft Works 6 - 9 Converter 後，系統不會再提示使用者重新安裝 Microsoft Works 6 - 9 Converter。
...
[Microsoft 知識庫文件編號 947081](https://support.microsoft.com/kb/947081) 詳細記錄了目前已知安裝此安全性更新可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2007-0216](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0216)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-0105](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0105)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-0108](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0108)。
...
SMS 2.0 和 SMS 2003 可利用內含安全性更新盤點工具 (SUIT) 的 SMS SUS Feature Pack 來偵測安全性更新。 另請參閱[適用於 Systems Management Server 2.0 的下載](https://technet.microsoft.com/en-us/sms/bb676799.aspx) (英文)。
...
適用於 Windows 95、Windows 98、Windows 98 SE 及 Windows Millennium Edition 的 Windows Installer 2.0 Redistributable 如需更多關於出現於本公告中術語的相關資訊 (如 *Hotfix*)，請參閱 [Microsoft 知識庫文件編號 824684](https://support.microsoft.com/kb/824684)。
...
-   感謝 [VeriSign iDefense VCP](https://labs.idefense.com/) 回報 Microsoft Works Converter 溢位弱點 (CVE-2008-0108)。  
-   感謝 Damian Put 與 [VeriSign iDefense VCP](https://labs.idefense.com/) 合作，共同回報 Microsoft Works 堆積損毀弱點 (CVE-2007-0216)。  
-   感謝 [IBM Internet Security Systems X-Force](https://xforce.iss.net/) 回報 Microsoft Works File Converter 索引表格弱點 (CVE-2008-0105)。
