---
TOCTitle: 'MS08-066'
Title: 'Microsoft Security Bulletin MS08-066 - 重要'
ms:assetid: 'ms08-066'
ms:contentKeyID: 61238257
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms08-066(v=Security.10)'
---



Microsoft Security Bulletin MS08-066 - 重要
===========================================

Microsoft 附屬功能驅動程式中的弱點可能會允許權限提高 (956803)
-------------------------------------------------------------

發行: 2008年10月15日 | 更新: 2009年1月16日
...
這個安全性更新可解決 Microsoft 附屬功能驅動程式中一項未公開報告的弱點。 成功利用此弱點的本機攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。

這是適用於所有受支援版本 Windows XP 及 Windows Server 2003 的重要安全性更新。如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此安全性更新會正確驗證從使用者模式經由 AFD 元件傳遞至 Windows 核心的輸入，進而解決此弱點。 如需更多有關此弱點的資訊，請參閱下節＜弱點資訊＞下的＜常見問題集 (FAQ)＞小節。

**建議。** Microsoft 建議客戶應該儘快套用此更新程式。

**已知問題。** [Microsoft 知識庫文件編號 956803](https://support.microsoft.com/kb/956803) 中有記載目前已知安裝此安全性更新後，可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b16d9dac-c430-4dd8-a1e5-9a614801f1d9">Windows XP Service Pack 2 及 Windows XP Service Pack 3 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=b16d9dac-c430-4dd8-a1e5-9a614801f1d9">Windows XP Service Pack 2 及 Windows XP Service Pack 3 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5b607efc-c6fb-4079-8478-e4f3262386d3">Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ee88ff2d-1b12-4f4c-a081-9f27a6fba074">Windows Server 2003 Service Pack 1 與 Windows Server 2003 Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=ee88ff2d-1b12-4f4c-a081-9f27a6fba074">Windows Server 2003 Service Pack 1 與 Windows Server 2003 Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ab4d94d3-458c-4946-ab7f-03a279629d25">Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=ab4d94d3-458c-4946-ab7f-03a279629d25">Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=63234f85-6e5d-4ef6-b7cf-d1d2c78a5517">Windows Server 2003 SP1 for Itanium-based Systems 和 Windows Server 2003 SP2 for Itanium-based Systems (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
**為何於 2009 年 1 月 16 日修訂此安全性公告？**   
Microsoft 修訂此安全性公告旨在宣佈此安全性更新的偵測變更。 經過更正之後，偵測便可為先前未收到此安全性更新的受影響系統提供安全性更新。 已成功更新系統的客戶不需要重新安裝此更新。
  
**何處可找到檔案資訊詳細資料？**    
檔案資訊詳細資料請參閱 [Microsoft 知識庫文件編號 956803](https://support.microsoft.com/kb/956803)。
  
**安裝此安全性更新後，已知可能會發生的問題有哪些？**    
[Microsoft 知識庫文件編號 956803](https://support.microsoft.com/kb/956803) 詳細記錄了安裝此安全性更新時，目前已知可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。
...
<th style="border:1px solid black;" >AFD 核心覆寫弱點 - CVE-2008-3464</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
AFD 核心覆寫弱點 - CVE-2008-3464  
--------------------------------
  
 
由於 Windows 使用錯誤的方式驗證從使用者模式傳遞至核心的輸入，因此附屬功能驅動程式 (afd.sys) 中存在權限提高弱點。 此弱點可能會允許攻擊者以提高的權限執行程式碼。 成功利用此弱點的本機攻擊者可執行任意程式碼，並取得受影響之系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-3464](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3464)。
  
#### AFD 核心覆寫弱點的緩和因素 - CVE-2008-3464
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少弱點影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   攻擊者必須擁有有效的登入認證，並能夠從本機登入易受影響的系統，才能利用這項弱點。 匿名或遠端使用者無法利用這個弱點。
  
#### AFD 核心覆寫弱點的因應措施 - CVE-2008-3464
  
Microsoft 尚未找到此項弱點的任何因應措施。
  
#### AFD 核心覆寫弱點的常見問題集 - CVE-2008-3464
  
**這個弱點的範圍為何？**    
這是權限提高的弱點。 成功利用此弱點的攻擊者可執行任意程式碼，並取得受影響之系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個弱點的原因為何？**    
將資料從使用者模式傳遞至核心時，AFD 元件未適當地驗證使用者提供的輸入。
  
**什麼是 AFD 元件？**    
AFD 元件提供包含於 afd.sys 檔案的「附屬功能驅動程式」，可支援 Windows Socket 應用程式。 afd.sys 驅動程式會以核心模式執行，並管理 Winsock TCP/IP 通訊通訊協定。 此 Winsock 核心介面提供 TDI 傳輸的存取權限。 如需更多關於 AFD 元件的資訊，請參閱下列 [Microsoft 網站](https://msdn.microsoft.com/en-us/library/aa940505.aspx)。
  
**什麼是 TDI 元件？**  
傳輸驅動程式介面 (TDI) 定義了曝露在所有傳輸通訊協定堆疊上緣的核心模式網路介面。 這類堆疊的最高層級通訊協定驅動程式，支援用於更高層級核心模式網路用戶端的 TDI 介面。 如需更多關於 TDI 元件的資訊，請參閱下列 [Microsoft 網站](https://msdn.microsoft.com/en-us/library/ms801224.aspx)。
...
**更新的作用何在？**    
此更新程式會正確驗證從使用者模式經由 AFD 元件傳遞至 Windows 核心的輸入，進而移除此弱點。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB956803$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/956803">Microsoft 知識庫文件編號 956803</a></td>
</tr>
<tr class="even">
...
-   感謝 [SkyRecon](https://www.skyrecon.com/) 的 Fabien Le Mentec 回報 AFD 核心覆寫弱點 (CVE-2008-3464)
...
-   V1.1 (2009 年 1 月 16 日)： 新增一個項目至＜與本安全性更新相關的常見問題集 (FAQ)＞章節，說明此公告之修訂屬於此安全性更新之偵測變更。 經過更正的偵測可為先前未收到此安全性更新的受影響系統提供安全性更新。 已成功更新系統的客戶不需要重新安裝此更新。
