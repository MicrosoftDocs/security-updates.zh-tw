...
Microsoft 修訂此公告，以說明相關 [Microsoft 知識庫文件編號 950759](http://support.microsoft.com/kb/949785)中的檔案資訊已更新。

**何處可找到檔案資訊詳細資料？**    
檔案資訊詳細資料可在 [Microsoft 知識庫文件編號 949785](http://support.microsoft.com/kb/949785) 中找到。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-0120](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0120)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-0121](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0121)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-1455](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1455)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/949785">Microsoft 知識庫文件編號 949785</a></td>
</tr>
<tr class="even">
...
-   感謝 [Reversemode.com](http://reversemode.com/) 的 Ruben Santamarta 與 [iDefense Labs](http://labs.idefense.com/) 合作回報 記憶體配置及計算弱點 (CVE-2008-0120 和 CVE-2008-0121)。  
-   感謝 [Venustech](http://www.venustech.com.cn/) 的 ADLab 回報剖析溢位弱點 (CVE-2008-1455)。
