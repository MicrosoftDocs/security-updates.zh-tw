---
TOCTitle: 'MS08-051'
Title: 'Microsoft Security Bulletin MS08-051 - 重大'
ms:assetid: 'ms08-051'
ms:contentKeyID: 61238138
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms08-051(v=Security.10)'
---



Microsoft Security Bulletin MS08-051 - 重大
===========================================

Microsoft PowerPoint 中的弱點可能會允許遠端執行程式碼 (949785)
--------------------------------------------------------------
...
此安全性更新可解決 Microsoft Office PowerPoint 和 Microsoft Office PowerPoint Viewer 中三項未公開報告的弱點，這些弱點可在使用者開啟蓄意製作的 PowerPoint 檔案時，允許從遠端執行程式碼。 成功利用這些弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

對於 Microsoft Office PowerPoint 2000 受支援的版本，此安全性更新的等級為「重大」；對於 Microsoft Office PowerPoint 2002、Microsoft Office PowerPoint 2003、Microsoft Office PowerPoint 2007、Microsoft Office PowerPoint Viewer 2003、適用於 Word、Excel 及 PowerPoint 2007 檔案格式的 Microsoft Office 相容性套件和 Microsoft Office 2004 for Mac 的受支援版本，此安全性更新的等級為「重要」。 如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

安全性更新會修改開啟 PowerPoint 檔案時 Microsoft Office PowerPoint 配置記憶體的方式，藉此解決這項弱點。 如需更多有關弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。
...
<td style="border:1px solid black;">
[Microsoft Office PowerPoint 2000 Service Pack 3 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=e7c044d8-778a-4985-b25b-4f7f6e4abadd)  
(KB949007)  
[Microsoft Office PowerPoint 2000 Service Pack 3 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=e7c044d8-778a-4985-b25b-4f7f6e4abadd)  
(KB949007)
...
<td style="border:1px solid black;">
[Microsoft Office PowerPoint 2002 Service Pack 3 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=f8921074-7985-4d42-ac2b-d2f3b1d466ba)  
(KB948995)  
[Microsoft Office PowerPoint 2002 Service Pack 3 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=f8921074-7985-4d42-ac2b-d2f3b1d466ba)  
(KB948995)
...
<td style="border:1px solid black;">
[Microsoft Office PowerPoint 2003 Service Pack 2 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=7a7c21f0-5e0e-4dee-9710-1ce3d565913f)  
(KB948988)  
[Microsoft Office PowerPoint 2003 Service Pack 2 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=7a7c21f0-5e0e-4dee-9710-1ce3d565913f)  
(KB948988)
...
<td style="border:1px solid black;">
[Microsoft Office PowerPoint 2003 Service Pack 3 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=7a7c21f0-5e0e-4dee-9710-1ce3d565913f)  
(KB948988)  
[Microsoft Office PowerPoint 2003 Service Pack 3 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=7a7c21f0-5e0e-4dee-9710-1ce3d565913f)  
(KB948988)
...
<td style="border:1px solid black;">
[Microsoft Office PowerPoint 2007 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=55fd618a-e9c5-4f1e-b9a5-b2e47ec98ef1)  
(KB951338)  
[Microsoft Office PowerPoint 2007 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=55fd618a-e9c5-4f1e-b9a5-b2e47ec98ef1)  
(KB951338)
...
<td style="border:1px solid black;">
[Microsoft Office PowerPoint 2007 Service Pack 1 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=55fd618a-e9c5-4f1e-b9a5-b2e47ec98ef1)  
(KB951338)  
[Microsoft Office PowerPoint 2007 Service Pack 1 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=55fd618a-e9c5-4f1e-b9a5-b2e47ec98ef1)  
(KB951338)
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office PowerPoint Viewer 2003 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=911c8872-dec8-4b8e-9708-93dcabd3e036) (KB949041)  
[Microsoft Office PowerPoint Viewer 2003 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=911c8872-dec8-4b8e-9708-93dcabd3e036) (KB949041)
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office Compatibility Pack for Word, Excel, and PowerPoint 2007 File Formats (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=84ce5d58-0010-4945-bce9-67a41f898f2f) (KB954038)  
[Microsoft Office Compatibility Pack for Word, Excel, and PowerPoint 2007 File Formats (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=84ce5d58-0010-4945-bce9-67a41f898f2f) (KB954038)
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office Compatibility Pack for Word, Excel, and PowerPoint 2007 File Formats Service Pack 1 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=84ce5d58-0010-4945-bce9-67a41f898f2f) (KB954038)  
[Microsoft Office Compatibility Pack for Word, Excel, and PowerPoint 2007 File Formats Service Pack 1 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=84ce5d58-0010-4945-bce9-67a41f898f2f) (KB954038)
...
Microsoft 修訂此公告，以說明相關 [Microsoft 知識庫文件編號 950759](https://support.microsoft.com/kb/949785)中的檔案資訊已更新。

**何處可找到檔案資訊詳細資料？**    
檔案資訊詳細資料可在 [Microsoft 知識庫文件編號 949785](https://support.microsoft.com/kb/949785) 中找到。
...
**此公告所討論的 Office 元件包含在電腦上所安裝的 Office 套件中；但是我並未選擇安裝此特定元件。 我是否會收到這份更新？**    
...
<th style="border:1px solid black;" >記憶體配置弱點 - CVE-2008-0120</th>
<th style="border:1px solid black;" >記憶體計算弱點 - CVE-2008-0121</th>
<th style="border:1px solid black;" >剖析溢位弱點 - CVE-2008-1455</th>
...
記憶體配置弱點 - CVE-2008-0120  
------------------------------
  
 
Microsoft Office PowerPoint Viewer 2003 處理蓄意製作的 PowerPoint 檔案的方式中，存在遠端執行程式碼的弱點。 攻擊者可蓄意製作 PowerPoint 檔案，並以電子郵件附件的方式隨附，或存放在蓄意製作或遭入侵的網站上，以利用此弱點。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-0120](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0120)。
  
#### 記憶體配置弱點 - CVE-2008-0120 的緩和因素
...
**攻擊者如何利用這項弱點？**      
此弱點需要使用者使用受影響的 Microsoft PowerPoint Viewer 2003 版本，來開啟蓄意製作的 PowerPoint 檔案。
...
**因為這個弱點而承受風險的主要系統有哪些？**      
工作站和終端伺服器等使用 Microsoft PowerPoint Viewer 2003 之系統的風險最高。 若系統管理員允許使用者登入伺服器並執行程式，則伺服器可能遭受更大的風險。 然而，最佳實務強烈建議您制止這種行為。
  
**更新的作用何在？**      
此更新會修改開啟 PowerPoint 檔案時 PowerPoint Viewer 2003 驗證記憶體配置的方式，藉以移除此項弱點。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-0121](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0121)。
  
#### 記憶體計算弱點 - CVE-2008-0121 的緩和因素
...
#### 記憶體計算弱點 - CVE-2008-0121 的因應措施
  
因應措施指的是無法徹底修正弱點，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。 Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：
  
-   對於來自於不受信任的來源或在非預期情況下從信任來源收到的 Microsoft Office 檔案，請勿輕易開啟或儲存。 當使用者開啟蓄意製作的檔案時，即可能遭受利用此弱點的攻擊。
  
#### 記憶體計算弱點 - CVE-2008-0121 的常見問題集
  
**這個弱點的範圍為何？**      
這是遠端執行程式碼的弱點。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個弱點的原因為何？**      
PowerPoint Viewer 2003 在蓄意製作的 PowerPoint 檔案中處理格式錯誤的圖片索引時，發生記憶體計算錯誤，因此導致此弱點。 此錯誤可能會損毀系統記憶體，使攻擊者有機會執行任意程式碼。
...
**更新的作用何在？**      
此更新會驗證開啟 PowerPoint 檔案時 PowerPoint Viewer 2003 計算記憶體配置要求的方式，藉以移除此項弱點。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-1455](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1455)。
  
#### 剖析溢位弱點 - CVE-2008-1455 的緩和因素
...
-   **開啟未知或不信任來源的檔案時，使用 Microsoft Office Isolated Conversion Environment (MOICE)**
    ...
    立即下載 FileFormatConverters.exe 套件
...
#### 剖析溢位弱點 - CVE-2008-1455 的常見問題集
  
**這個弱點的範圍為何？**      
這是遠端執行程式碼的弱點。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個弱點的原因為何？**      
此弱點是在剖析蓄意製作的 PowerPoint 檔案之清單值時，發生記憶體計算錯誤所致。 此錯誤可能會損毀系統記憶體，使攻擊者有機會執行任意程式碼。
...
**因為這個弱點而承受風險的主要系統有哪些？**      
工作站和終端伺服器等使用 Microsoft Office PowerPoint 之系統的風險最高。 若系統管理員允許使用者登入伺服器並執行程式，則伺服器可能遭受更大的風險。 然而，最佳實務強烈建議您制止這種行為。
  
**更新的作用何在？**      
此更新會修改開啟 PowerPoint 檔案時 Microsoft Office PowerPoint 驗證資料的方式，藉以移除此項弱點。
...
| Microsoft Office Compatibility Pack for Word, Excel, and PowerPoint 2007 File Formats 與 Microsoft Office Compatibility Pack for Word, Excel, and PowerPoint 2007 File Formats Service Pack 1 | 是       |  
...
| Microsoft Office Compatibility Pack for Word, Excel, and PowerPoint 2007 File Formats 與 Microsoft Office Compatibility Pack for Word, Excel, and PowerPoint 2007 File Formats Service Pack 1 | 否      | 否                     | 是                    | 是                         |  
...
更新時常會寫入您應用程式執行所需的相同檔案和登錄設定。 這可能會觸發不相容性，而拉長部署安全性更新的時間。 您可以使用 [Application Compatibility Toolkit 5.0](https://www.microsoft.com/download/details.aspx?familyid=24da89e9-b581-47b0-b45e-492dd6da2971&displaylang=en) 隨附的 Update Compatibility Evaluator 元件，針對所安裝的應用程式簡化其測試和驗證 Windows 更新的過程。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/949785">Microsoft 知識庫文件編號 949785</a></td>
</tr>
<tr class="even">
...
#### PowerPoint 2007 與適用於 Word、Excel 及 PowerPoint 2007 檔案格式的 Microsoft Office 相容性套件 (所有版本)
...
-   感謝 [Reversemode.com](https://reversemode.com/) 的 Ruben Santamarta 與 [iDefense Labs](https://labs.idefense.com/) 合作回報 記憶體配置及計算弱點 (CVE-2008-0120 和 CVE-2008-0121)。  
-   感謝 [Venustech](https://www.venustech.com.cn/) 的 ADLab 回報剖析溢位弱點 (CVE-2008-1455)。
...
-   V1.1 (2008 年 8 月 21 日)： 新增項目至＜與本安全性更新相關的常見問題集 (FAQ)＞一節，說明相關 Microsoft 知識庫文件編號 949785 中的檔案資訊已更新。 此外，亦將＜提要＞中誤將 Microsoft Office 2008 for Mac 參照為受影響軟體的資訊移除。
