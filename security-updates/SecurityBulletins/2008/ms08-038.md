...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=06739ca6-7368-4acb-bb67-7e8146071a29">Windows Vista 和 Windows Vista Service Pack 1 (英文下載更新程式)</a>
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=06739ca6-7368-4acb-bb67-7e8146071a29">Windows Vista 和 Windows Vista Service Pack 1 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=74ea0893-7c2f-4fad-ad27-588ad953b046">Windows Vista x64 Edition 和 Windows Vista x64 Edition Service Pack 1 (英文下載更新程式)</a>
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=74ea0893-7c2f-4fad-ad27-588ad953b046">Windows Vista x64 Edition 和 Windows Vista x64 Edition Service Pack 1 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=189a4170-b495-4904-9cbd-209e7494d303">適用於 32 位元系統的 Windows Server 2008 (英文下載更新程式)</a>\*<br/>
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=189a4170-b495-4904-9cbd-209e7494d303">適用於 32 位元系統的 Windows Server 2008 (中文下載更新程式)</a>\*</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=85d8701d-f8c7-4079-8a21-a3a9d5ba71ce">適用於 x64 型系統的 Windows Server 2008 (英文下載更新程式)</a>\*<br/>
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=85d8701d-f8c7-4079-8a21-a3a9d5ba71ce">適用於 x64 型系統的 Windows Server 2008 (中文下載更新程式)</a>\*</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b30ee4f0-850f-4ff3-86a4-663603a0a802">適用於 Itanium 系統的 Windows Server 2008 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
**何處可找到檔案資訊詳細資料？**    
檔案資訊詳細資料可在 [Microsoft 知識庫文件編號 950582](http://support.microsoft.com/kb/950582) 中找到。
  
**此更新程式是否包含功能上的任何安全性相關變更？**  
是。 除了本公告＜弱點詳細資料＞一節所列的變更之外，這個安全性更新也解決了 Windows Vista 和 Windows Server 2008 系統中與自動執行功能相關的已知問題。 此更新會正確地停用 NoDriveTypeAutorun 登錄機碼所控制的按右鍵和按兩下行為。 這樣便可修正 Windows Vista 與 Windows Server 2008 中 [CVE-2008-0951](http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0951) 所識別的問題。如需此登錄機碼用法的詳細資訊，請參閱 TechNet 文章 [NoDriveTypeAutoRun](http://www.microsoft.com/technet/prodtechnol/windows2000serv/reskit/regentry/91525.mspx?mfr=true) (英文)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-1435](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1435)。
...
**什麼是 Windows 搜尋？**  
Windows 搜尋是 Windows Vista 和 Windows Server 2008 的標準元件，預設為啟用。 Windows 搜尋可讓您立即搜尋大部分的一般檔案和資料類型，例如電子郵件、聯絡人、行事曆約會、文件、照片、多媒體和其他協力廠商所延伸的格式。 這些功能可讓消費者和資訊工作者在家庭和企業環境中，更有效率地尋找、管理和組織與日俱增的常用資料。 如需更多資訊，請參閱 [Windows 搜尋首頁](http://www.microsoft.com/windows/products/winfamily/desktopsearch/default.mspx)。 雖然 Windows 搜尋是 Windows XP 的增益集，但是 Windows XP 系統不受這個問題影響。
...
是。 這項弱點已經遭到公開揭發。 這項弱點已被指派一般性弱點編號 [CVE-2008-1435](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1435)。本安全性公告除了解決公開揭露的弱點之外，也會解決透過內部調查所發現的其他問題。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/950582">Microsoft 知識庫文件編號 950582</a></td>
</tr>
<tr class="odd">
