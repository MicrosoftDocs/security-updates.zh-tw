---
TOCTitle: 'MS06-030'
Title: 'Microsoft Security Bulletin MS06-030 - 重大'
ms:assetid: 'ms06-030'
ms:contentKeyID: 61237777
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms06-030(v=Security.10)'
---

Microsoft Security Bulletin MS06-030 - 重大
===========================================
...
-   Microsoft Windows 2000 Service Pack 4 — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=6ec86784-6b12-410b-8068-028c58ed5df7) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=6ec86784-6b12-410b-8068-028c58ed5df7)
-   Microsoft Windows XP Service Pack 1 和 Microsoft Windows XP Service Pack 2 — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=c17ddc07-204b-4a7f-8c5a-36b7865a030c) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=c17ddc07-204b-4a7f-8c5a-36b7865a030c)
-   Microsoft Windows XP Professional x64 Edition — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=89fbbdd0-7504-4807-9337-08324aa457e7)
-   Microsoft Windows Server 2003 和 Microsoft Windows Server 2003 Service Pack 1 — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=%2043d69a41-6acb-4c64-89dc-2b9aef6e98fd) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=43d69a41-6acb-4c64-89dc-2b9aef6e98fd)
-   Microsoft Windows Server 2003 for Itanium-based Systems 及 Microsoft Windows Server 2003 SP1 for Itanium-based Systems — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=e1d13c18-72d1-40b8-95b3-08aef8db9213)
-   Microsoft Windows Server 2003 x64 Edition — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=b6018a61-b0ec-467e-9025-059d3c9f1c5f)
...
|---------------------------------------------------------------------------------------------------------------|------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| SMB 驅動程式權限提高的弱點 - [CVE-2006-2373](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2373) | 權限提高   | 重要         | 重要                      | 重要                      | 重要                | 重要                               |
| SMB 無效的控制代碼弱點 - [CVE-2006-2374](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2374)     | 拒絕服務   | 中度         | 中度                      | 中度                      | 中度                | 中度                               |
...
-   Microsoft Windows XP Professional x64 Edition 的嚴重性等級與 (註解： 驗證何者) Windows Server 2003 Service Pack 1 或 Windows XP Service Pack 2 的嚴重性等級相同。
...
<span></span>
**這次發行的更新程式取代了哪些更新？**  
本安全性更新取代了一個先前發行的安全性更新。 下表列出安全性公告編號和受影響的作業系統。
...
**Microsoft Windows NT Workstation 4.0 Service Pack 6a 與 Windows 2000 Service Pack 2 的延伸安全性更新支援服務已在 2004 年 6 月 30 日到期。Microsoft Windows NT Server 4.0 Service Pack 6a 的延伸安全性更新支援服務已在 2004 年 12 月 31 日到期。Microsoft Windows 2000 Service Pack 3 的延伸安全性更新支援服務已在 2005 年 6 月 30 日到期。我仍在使用這些作業系統其中之一，該怎麼辦？**  
Windows NT Workstation 4.0 Service Pack 6a、Windows NT Server 4.0 Service Pack 6a、Windows 2000 Service Pack 2 和 Windows 2000 Service Pack 3 的產品支援週期已結束。 使用這些作業系統版本的客戶應優先考慮移轉至支援的版本，以避免因潛在的弱點而遭受攻擊。 如需瞭解 Windows 產品生命週期的相關資訊，請造訪下列 [Microsoft 產品技術支援週期網站](https://go.microsoft.com/fwlink/?linkid=21742)。 如需瞭解這些作業系統版本延伸安全性更新支援服務週期的相關資訊，請造訪 [Microsoft 產品支援服務網站](https://go.microsoft.com/fwlink/?linkid=33328)。
...
<span></span>
#### SMB 驅動程式權限提高的弱點 - CVE-2006-2373

伺服器訊息區 (SMB) 中的權限提高弱點，可以讓成功利用此弱點的攻擊者取得受影響系統的完整控制權。

#### SMB 驅動程式權限提高弱點 - CVE-2006-2373 的緩和因素：

-   攻擊者若想成功攻擊，必須擁有有效的登入認證，且必須於本機登入，才能利用這項弱點。

#### SMB 驅動程式權限提高弱點 - CVE-2006-2373 的因應措施：

Microsoft 已經測試過以下的因應措施。 雖然這些因應措施不能徹底解決弱點，但有助於封鎖已知的攻擊行為。 如果因應措施會降低功能，以下小節將會描述功能降低的情況。

**注意：**下列步驟需要系統管理員權限。 為了封鎖已知的攻擊模式，我們建議的兩項因應措施都必須執行。 我們建議您在套用因應措施後，重新啟動電腦。

-   **停用 Workstation 服務**

    停用 Workstation 服務有助於保護受影響的系統免遭此弱點的攻擊。 若要停用 Workstation 服務，請執行這些步驟：
...
您也可以在命令提示字元下使用下列命令來停止及停用 Workstation 服務：

`sc stop lanmanworkstation & sc config lanmanworkstation start= disabled`

**因應措施的影響：** 如停用 Workstation 服務，用戶端將無法存取 SMB 共用資訊。

-   **刪除 MRxSmb 驅動程式登錄項目**

    將 MRxSmb 登錄項目刪除可協助保護受影響的系統，使其弱點不受利用。 若要刪除 MRxSmb 機碼，請依照下列步驟進行：
    ...
    **注意：**不當使用「登錄編輯程式」可能會造成嚴重的問題，甚至可能需要重新安裝您的作業系統。 Microsoft 無法保證能夠順利解決因不當使用「登錄編輯程式」所造成的問題。 請自行承擔使用「登錄編輯程式」的風險。 如需有關如何編輯登錄的資訊，請檢視「登錄編輯程式」(Regedit.exe) 中的＜變更機碼及數值＞說明主題，或是 Regedt32.exe 中的＜新增及刪除登錄中的資訊＞與＜編輯登錄資料＞說明主題。
    ...
    2.  瀏覽至 HKLM\\System\\CurrentControlSet\\Services。
    3.  在 MRxSmb 機碼上按下滑鼠右鍵，並「匯出」該機碼。
    4.  在 MRxSmb 機碼上按下滑鼠右鍵，並「刪除」該機碼。

    **因應措施的影響：** 如將 MRxSmb 登錄機碼刪除，用戶端將無法存取 SMB 共用資訊。

#### SMB 驅動程式權限提高弱點 - CVE-2006-2373 的常見問題集：

**這個弱點的範圍為何？**  
這是權限提高的弱點。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。

**造成這個弱點的原因為何？**  
造成弱點的原因在於受影響的作業系統用來驗證某些 SMB 要求的程序。

**什麼是 SMB？**  
伺服器訊息區 (SMB) 和其後續產品 Common Internet File System (CIFS) 是網際網路標準通訊協定，Windows 將其用來共用檔案、印表機、序列埠，也可用來在電腦間互相通訊。 因此，SMB 必須使用具名管道及郵件插槽。 在網路環境中，伺服器讓用戶端可使用檔案系統及資源。 用戶端作出資源的 SMB 要求。 伺服器作出 SMB 回應。 這就是用戶端伺服器的要求回應通訊協定。
...
**什麼人可以利用此弱點？**  
若要嘗試利用此弱點，攻擊者必須要能在本機上登入系統並執行程式。

**攻擊者會如何利用這個弱點？**  
如果要利用此弱點，攻擊者首先必須登入系統。 接著，攻擊者便可執行蓄意設計以利用此弱點的應用程式，並進一步取得受影響系統的完整控制權。

**因為這個弱點而承受風險的主要系統有哪些？**  
Microsoft Windows 2000、Windows XP 及 Windows Server 2003 等允許使用者以互動方式登入的系統 (包括作為終端伺服器的系統) 受此弱點影響的風險最高。

**這項弱點是否會對 Windows 98、Windows 98 Second Edition 或 Windows Millennium Edition 帶來重大的影響？**  
否。 Windows 98、Windows 98 Second Edition 以及 Windows Millennium Edition 不含有受影響的元件。

**是否能透過網際網路利用這個弱點？**   否。 攻擊者必須能夠登入要攻擊的特定系統才行。 攻擊者無法利用此弱點在遠端載入及執行程式。

**更新的作用何在？**  
更新程式會修正受影響作業系統處理 SMB 相關要求的方式，進而解決此弱點。
...
#### SMB 無效的控制代碼弱點 - CVE-2006-2374

伺服器訊息區 (SMB) 中有拒絕服務弱點。成功利用此弱點的攻擊者可使受影響的系統停止回應。

#### SMB 無效的控制代碼弱點 - CVE-2006-2374 的緩和因素：

-   攻擊者若想成功攻擊，必須擁有有效的登入認證，且必須於本機登入，才能利用這項弱點。

#### SMB 無效的控制代碼弱點 - CVE-2006-2374 的因應措施：

Microsoft 已經測試過以下的因應措施。 雖然這些因應措施不能徹底解決弱點，但有助於封鎖已知的攻擊行為。 如果因應措施會降低功能，以下小節將會描述功能降低的情況。

**注意：**下列步驟需要系統管理員權限。 為了封鎖已知的攻擊模式，我們建議的兩項因應措施都必須執行。 我們建議您在套用此因應措施後，重新啟動電腦。
...
#### SMB 無效的控制代碼弱點 - CVE-2006-2374 的常見問題集：

**這個弱點的範圍為何？**  
這是[拒絕服務](https://go.microsoft.com/fwlink/?linkid=21142)的弱點。 利用此弱點的攻擊者可使受影響的系統停止回應。 在這段期間，受影響的系統將無法回應要求。 請注意，雖然拒絕服務弱點不會讓攻擊者執行程式碼或提高其使用者權限，但會導致受影響系統停止回應。
...
**注意：**使用 **/quiet** 參數將會隱藏所有訊息。 這包括隱藏失敗訊息。 當系統管理員使用 **/quiet** 參數時，則應該採取妥當的做法驗證是否已順利安裝。 當系統管理員使用這個參數時，也應檢閱 KB914389.log 檔案，查看是否有任何失敗訊息。
...
此安全性更新在具備 5.2.3790.1830 版 Smb.sys 及 Rdbss.sys 檔案的系統上，可支援 HotPatching。如您使用了 HotPatching，您可在執行 Microsoft Windows Server 2003 Service Pack 1 的系統上，安裝安全性更新而無須重新啟動伺服器。 如需關於 HotPatching 及利用 HotPatching 部署安全性更新的進一步資訊，請參閱 [Microsoft 知識庫文件編號 897341](https://support.microsoft.com/kb/897341)。
...
系統管理員也可以使用 Spuninst.exe 公用程式來移除此安全性更新。 Spuninst.exe 公用程式位於 %Windir%\\$NTUninstallKB914389$\\Spuninst 資料夾中。
...
-   **登錄機碼驗證**
    ...
    **注意**：機碼可能未包含完整的安裝檔案清單。 而且，如果系統管理員或 OEM 將安全性更新整合或匯集到 Windows 安裝原始檔時，可能無法正確建立這些登錄機碼。
...
| 檔案名稱   | 版本          | 日期               | 時間  | 大小      |
|------------|---------------|--------------------|-------|-----------|
| Mrxsmb.sys | 5.0.2195.7097 | 2006 年 5 月 31 日 | 07:14 | 415,536   |
...
-   感謝 [Rubén Santamarta](https://www.reversemode.com/) 協助 [iDefense](https://www.idefense.com/) 回報 SMB 權限提高弱點 - CVE-2006-2373
-   感謝 [Rubén Santamarta](https://www.reversemode.com/) 協助 [iDefense](https://www.idefense.com/) 回報 SMB 無效的控制代碼弱點 - CVE-2006-2374
...
**注意：**SMS 使用 Microsoft Baseline Security Analyzer、Microsoft Office Detection Tool 以及企業更新掃描工具，為安全性公告的更新偵測及部署作業提供相當廣泛的支援。 不過這些工具可能無法偵測部分的軟體更新。 在這些情況中，系統管理員可以利用 SMS 的清查功能，判斷特定系統所需要的更新程式。 如需這個程序的詳細資訊，請造訪這個[網站](https://go.microsoft.com/fwlink/?linkid=33341)。 某些安全性更新程式在電腦重新啟動之後，會需要系統管理員的權限。 系統管理員可以用 Elevated Rights Deployment Tool (隨 [SMS 2003 Administration Feature Pack](https://www.microsoft.com/taiwan/smserver/downloads/20/featurepacks/adminpack/default.htm) 和 [SMS 管理功能套件](https://www.microsoft.com/taiwan/smserver/downloads/20/featurepacks/adminpack/default.htm) 提供) 來安裝這些更新。
