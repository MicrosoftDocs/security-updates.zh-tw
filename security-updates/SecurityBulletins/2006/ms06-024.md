---
TOCTitle: 'MS06-024'
Title: 'Microsoft Security Bulletin MS06-024 - 重大'
ms:assetid: 'ms06-024'
ms:contentKeyID: 61237771
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms06-024(v=Security.10)'
---

Microsoft Security Bulletin MS06-024 - 重大
===========================================

Windows Media Player 中的弱點可能會允許遠端執行程式碼 (917734)
--------------------------------------------------------------

發行: 2006年6月13日 | 更新: 2006年7月28日

**版本:** 1.2

#### 摘要

**應該閱讀此文件的對象：** 使用 Microsoft Windows Media Player 的客戶
...
-   Microsoft Windows XP Service Pack 1 上的 Windows Media Player for XP – [下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=11372cc0-3da9-49ad-bb08-1493ce3cd0bd)│[中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=11372cc0-3da9-49ad-bb08-1493ce3cd0bd)
-   Microsoft Windows XP Service Pack 2 上的 Windows Media Player 9 – [下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=c00be4c3-34ba-4858-90d7-520b7d240e33)│[中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=c00be4c3-34ba-4858-90d7-520b7d240e33)
-   Microsoft Windows XP Professional x64 Edition 上的 Windows Media Player 10 – [下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=f59065ec-0279-48ec-ab27-8abca715ac01)
-   Microsoft Windows Server 2003 上的 Windows Media Player 9 – [下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=c00be4c3-34ba-4858-90d7-520b7d240e33)│[中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=c00be4c3-34ba-4858-90d7-520b7d240e33)
-   Microsoft Windows Server 2003 Service Pack 1 上的 Windows Media Player 10 – [下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=4f933b0c-7d2d-4049-92da-bbbe97371594)│[中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=4f933b0c-7d2d-4049-92da-bbbe97371594)
-   Microsoft Windows Server 2003 x64 Edition 上的 Windows Media Player 10 – [下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=facc7dfe-9b3b-48dd-a068-5bb9c6b60f87)
...
-   安裝於 Windows 2000 Service Pack 4 上的 Microsoft Windows Media Player 7.1 – [下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=5abb6258-9468-4188-a178-aa46f100ab61)│[中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=5abb6258-9468-4188-a178-aa46f100ab61)
-   安裝於 Windows 2000 Service Pack 4 或 Windows XP Service Pack 1 上的 Microsoft Windows Media Player 9 – [下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=c00be4c3-34ba-4858-90d7-520b7d240e33)│[中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=c00be4c3-34ba-4858-90d7-520b7d240e33)
-   安裝於 Windows XP Service Pack 1 或 Windows XP Service Pack 2 上的 Microsoft Windows Media Player 10 – [下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=0f641572-74fd-4281-953f-6f2f12e001e0)│[中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=0f641572-74fd-4281-953f-6f2f12e001e0)
-   **不受影響的軟體：**

    -   所有 Microsoft Windows 作業系統版本上的 Windows Media Player 6.4
    -   Microsoft Windows Server 2003 for Itanium-based Systems 及 Microsoft Windows Server 2003 SP1 for Itanium-based Systems

    **注意：**＜受影響的軟體＞部份適用隨附於 Microsoft Windows 作業系統的 Windows Media Player。 ＜受影響的元件＞部分適用於下載並安裝在 Microsoft Windows 上的 Windows Media Player。
...
| 弱點識別碼                                                                                                     | 弱點的影響     | Windows Media Player 7.1 | Windows Media Player for XP | Windows Media Player 9 (所有版本) | Windows Media Player 10 (所有版本) |
|----------------------------------------------------------------------------------------------------------------|----------------|--------------------------|-----------------------------|-----------------------------------|------------------------------------|
| Windows Media Player PNG 弱點 [CVE-2006-0025](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0025) | 遠端執行程式碼 | 重要                     | 重要                        | 重大                              | 重大                               |
...
| 公告編號                                                                                                                     | Windows Media Player 7.1 | Windows Media Player for XP | Windows Media Player 9 (所有版本) | Windows Media Player 10 (所有版本) |
|------------------------------------------------------------------------------------------------------------------------------|--------------------------|-----------------------------|-----------------------------------|------------------------------------|
| [**MS06-005**](https://technet.microsoft.com/security/bulletin/ms06-005)([911565](https://support.microsoft.com/?kbid=911565)) | 取代                     | 取代                        | 取代                              | 取代                               |

**我安裝了 Windows Media Player (KB917734) 安全性更新程式。 我安裝的 Wmp.dll 或 Wmpui.dll 應該是什麼版本？**  
請參閱圖表，來判斷您應該安裝的 Wmp.dll 或 Wmpui.dll 檔案版本。

| Windows 作業系統：                                                                                                                                                            | 檔案名稱  | 檔案版本    |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------|-------------|
| [Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=5abb6258-9468-4188-a178-aa46f100ab61)Windows Media Player 7.1        | wmpui.dll | 7.10.0.3078 |
| [Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=c00be4c3-34ba-4858-90d7-520b7d240e33)Windows Media Player 9          | wmp.dll   | 9.0.0.3349  |
| [Windows XP Service Pack 1](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=11372cc0-3da9-49ad-bb08-1493ce3cd0bd)Windows Media Player for XP       | wmpui.dll | 8.0.0.4496  |
| [Windows XP Service Pack 1](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=c00be4c3-34ba-4858-90d7-520b7d240e33)Windows Media Player 9            | wmp.dll   | 9.0.0.3349  |
| [Windows XP Service Pack 1](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=0f641572-74fd-4281-953f-6f2f12e001e0)Windows Media Player 10           | wmp.dll   | 10.0.0.4036 |
| [Windows XP Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=c00be4c3-34ba-4858-90d7-520b7d240e33)Windows Media Player 9            | wmp.dll   | 9.0.0.3349  |
| [Windows XP Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=0f641572-74fd-4281-953f-6f2f12e001e0)Windows Media Player 10           | wmp.dll   | 10.0.0.4036 |
...
| [Windows Server 2003](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=c00be4c3-34ba-4858-90d7-520b7d240e33)Windows Media Player 9                  | wmp.dll   | 9.0.0.3349  |
| [Windows Server 2003 Service Pack 1](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=4f933b0c-7d2d-4049-92da-bbbe97371594) Windows Media Player 10 | wmp.dll   | 10.0.0.3704 |
...
Microsoft 只針對重大安全性問題發行安全性更新。 在這段支援服務期間，不會對非重大安全性的問題提供安全性更新程式。 如想瞭解這些作業系統的 Microsoft 技術支援週期準則，請造訪這個[網站](https://go.microsoft.com/fwlink/?linkid=33327)。

如需更多有關嚴重性等級的資訊，請造訪這個[網站](https://technet.microsoft.com/security/bulletin/rating)。

本安全性公告中有此平台的重大安全性更新，並且僅可從 [Windows Update 網站](https://go.microsoft.com/fwlink/?linkid=21130)下載。 如需更多有關嚴重性等級的資訊，請造訪這個[網站](https://technet.microsoft.com/security/bulletin/rating)。
...
**我是否可使用 Microsoft Baseline Security Analyzer (MBSA) 或 企業 更新掃描工具 (EST) 來判斷是否需要此更新程式？**  

以下表格提供此安全性更新的 MBSA 偵測摘要。

| 產品                                  | MBSA 1.2.1 | 企業更新掃描工具 (EST)？ | MBSA 2.0 |
|---------------------------------------|------------|--------------------------|----------|
| **Windows Media Player 7.1**          | 有         | 不適用                   | 有       |
| **Windows Media Player for XP**       | 有         | 不適用                   | 有       |
| **Windows Media Player 9**            | 有         | 不適用                   | 有       |
| **Microsoft Windows Media Player 10** | 沒有       | 有                       | 有       |

MBSA 1.2.1 目前不支援偵測 Windows Media Player 10。
...
**是否可以使用 企業 更新掃描工具 (EST) 的某個版本判斷是否需要此更新程式？**  
...
| 產品                                  | SMS 2.0       | SMS 2003 |
|---------------------------------------|---------------|----------|
| **Windows Media Player 7.1**          | 有            | 有       |
| **Windows Media Player for XP**       | 有            | 有       |
| **Windows Media Player 9**            | 有            | 有       |
| **Microsoft Windows Media Player 10** | 有 (使用 EST) | 有       |

SMS 使用 MBSA 進行偵測。 因此，SMS 也會面臨與 MBSA 相同的限制，而無法偵測部分軟體；請參閱本公告先前所述說明。
SMS 2.0 可使用 SMS SUS Feature Pack 中的安全性更新盤點工具 (Security Update Inventory Tool) 來偵測安全性更新。 SMS SUIT 使用 MBSA 1.2.1 引擎進行偵測。 如需更多關於安全性更新盤點工具 (Security Update Inventory Tool) 的資訊，請造訪下列 [Microsoft 網站](https://www.microsoft.com/smserver/downloads/2003/featurepacks/suspack)。 如需更多有關安全性更新盤點工具 (Security Update Inventory Tool) 限制的資訊，請參閱 [Microsoft 知識庫文件編號 306460](https://support.microsoft.com/kb/306460)。SMS SUS Feature Pack 中也含有 Microsoft Office Inventory Tool，可用於偵測 Microsoft Office 應用程式所需的更新。
...
如需有關 EST 的詳細資訊，請參閱常見問題集＜什麼是企業更新掃描工具 (EST)？＞及以下 [Microsoft 網站](https://support.microsoft.com/kb/894193)。

弱點詳細資料
------------

<span></span>
#### Windows Media Player PNG 弱點 - CVE-2006-0025

Windows Media Player 處理 PNG 影像的方式，使其存在遠端程式碼執行的弱點。 如果使用者造訪了惡意網站，或是開啟含有惡意內容的電子郵件，攻擊者就可利用蓄意製作的 Windows Media Player 內容遠端執行程式碼，藉以利用本弱點。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。

#### Windows Media Player PNG 弱點 - CVE-2006-0025 的緩和因素：
...
-   使用 Microsoft Windows 2000 Service Pack 4 加上 WIndows Media Player 7.1，或是 Windows XP Service Pack 1 加上 Windows Media Player for XP 的時候，使用者並不受網頁式攻擊的影響。 使用者若是下載並安裝了惡意的 Windows Media Player 面板，就依然會受影響。
-   若是電子郵件攻擊，攻擊者可能會利用這項弱點，向使用者傳送蓄意製作的 .WMZ 檔案，然後引誘使用者開啟該檔案。
-   成功利用此弱點的攻擊者可以取得與本機使用者相同的使用者權限。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

#### Windows Media Player PNG 弱點 - CVE-2006-0025 的因應措施：
...
1.  **修改 DirectX "Filter Graph no thread" 登錄機碼上的存取控制清單。**

    修改 "Filter Graph no thread" 登錄機碼上的存取控制清單，有助於保護受影響的系統免於嘗試利用這項弱點的攻擊。 要修改 Filter Graph no Thread 分隔登錄機碼，請依照下列步驟進行。
    ...
    **注意：**請記下對話方塊中列出的權限，以便日後可以還原這些值。
    ...
    2.  展開 **HKEY\_CLASSES\_ROOT**，展開 **CLSID**，然後按一下 **{E436EBB8-524F-11CE-9F53-0020AF0BA770}**。
    3.  按一下 \[安全性\]，再按 \[使用權限\]。
    ...
    **注意：**請記下對話方塊中列出的權限，以便日後可以還原這些值。
    ...
    6.  您會收到無人能夠存取此登錄機碼的訊息。 按一下 \[是\]，然後按一下 \[確定\] 關閉 \[{ E436EBB8-524F-11CE-9F53-0020AF0BA770} 的權限\] 對話方塊。

    注意：若您已備份並移除了 DirectX "Filter Graph no thread" 登錄機碼，就不需要再修改 DirectX "Filter Graph no thread" 登錄機碼的存取控制清單。

    **因應措施的影響：** 此因應措施將停用不定數量具備 DirectX 功能的應用程式之影像呈現及音訊與視訊播放。

2.  **備份並移除 DirectX "Filter Graph no thread" 登錄機碼。**

    移除 "Filter Graph no thread" 登錄機碼可協助保護受影響的系統，使其此項弱點不被利用。 如要備份並移除 "Filter Graph no thread" 登錄機碼，請依照下列步驟進行：
    ...
    **因應措施的影響：** 此因應措施停用不定數量具備 DirectX 功能的應用程式之影像呈現及音訊與視訊播放。

3.  **取消登錄 Wmp.dll**

    取消登錄 Wmp.dll 登錄機碼可協助保護受影響的系統，使其此項弱點免於被利用。 若要修改 Wmp.dll 登錄機碼，請依照下列步驟進行。

    1.  按一下 \[開始\]，按一下 \[執行\]，鍵入 **regsvr32 -u %windir%\\system32\\wmp.dll**，再按一下 \[確定\]。
...
4.  **解除 WMZ 副檔名關聯**
    ...
    在 Windows 中解除 WMZ 的關聯可避免預覽或開啟指向格式錯誤之 PNG 檔案的 WMZ 檔案。

    1.  啟動 Windows 檔案總管。
    2.  按下 \[工具\]、\[資料夾選項\]，接著選取 \[檔案類型\] 索引標籤。
    3.  捲動清單，找出 WMZ 檔案副檔名，然後按下 \[刪除\]。

    **注意：**移除面板檔案關聯的因應措施必須配合至少以上其中一項因應措施同時執行。

    **因應措施的影響：** 本因應措施會讓使用者無法按兩下檔案將面板檔案套用到 Windows Media Player 上。 使用者仍可套用在預設面板目錄中的面板檔案。

#### Windows Media Player PNG 弱點 - CVE-2006-0025 的常見問題集：

**這個弱點的範圍為何？**  
因 Windows Media Player 處理 PNG 影像的方式，使其存在遠端程式碼執行的弱點。 如果使用者造訪了惡意網站，或是按下電子郵件中蓄意製作的 WMZ 檔案，攻擊者便可利用蓄意製作的 Windows Media Player 內容遠端執行程式碼，藉以利用本弱點。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。

如果使用者以系統管理的使用者權限登入，成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

**造成這個弱點的原因為何？**  
Windows Media Player 內的 PNG 處理程式碼中所存在的未檢查緩衝區。

**Windows Media Player 是什麼？**  
Windows Media Player 是供個人電腦使用的 Windows 作業系統的功能， 可是播放音訊與視訊。
...
是。 此弱點對於 Windodws 98 Second Edition 和 Windows Millennium Edition 上的 Windows Media Player 9 是一重大弱點。 本次安全性公告中所列的安全性更新不一定會包含這些平台的重大安全性更新。 我們將儘快發佈這些安全性更新程式。 這些安全性更新發行後，只能從[](https://go.microsoft.com/fwlink/?linkid=21130)Windows Update 網站下載。 如需更多有關嚴重性等級的資訊，請造訪這個[網站](https://technet.microsoft.com/security/bulletin/rating)。

**更新的作用何在？**  
本更新會在 Windows Media Player 將程式碼傳送至分配的緩衝區之前，修改驗證處理程式碼的方式，進而移除此項弱點。
...
系統管理員也可以使用 Spuninst.exe 公用程式來移除此安全性更新。 Spuninst.exe 公用程式位於： %Windir%\\$NTUninstallKB917734$\\Spuninst 資料夾或 %Windir%\\$NtUninstallKB917734\_WMP9$\\Spuninst 資料夾。
...
Windows Server 2003 Standard x64 Edition、Windows Server 2003 Enterprise x64 Edition 和 Windows Server 2003 Datacenter x64 Edition、Windows Server 2003 R2 Standard x64 Edition、Windows Server 2003 R2 Enterprise x64 Edition 和 Windows Server 2003 R2 Datacenter x64 Edition 等系統上的 Media Player 10：
...
系統管理員也可以使用 Spuninst.exe 公用程式來移除此安全性更新。 Spuninst.exe 公用程式位於 %Windir%\\$NTUninstallKB917734\_WMP8$\\Spuninst 資料夾或 %Windir%\\$NTUninstallKB917734\_WMP9$\\Spuninst 資料夾或 %Windir%\\$NTUninstallKB917734\_WMP10$\\Spuninst 資料夾或 %Windir%\\$NTUninstallKB917734$\\Spuninst 資料夾中。
...
安裝於 Windows XP Home Edition Service Pack 1、Windows XP Professional Service Pack 1、Windows XP Tablet PC Edition、Windows XP Media Center Edition 上的 Windows Media Player for XP：

| 檔案名稱  | 版本       | 日期               | 時間  | 大小      |
|-----------|------------|--------------------|-------|-----------|
| wmpui.dll | 8.0.0.4496 | 2006 年 4 月 24 日 | 23:17 | 1,425,680 |

安裝於 Windows XP Home Edition Service Pack 1、Windows XP Professional Service Pack 1、Windows XP Tablet PC Edition、Windows XP Media Center Edition、Windows XP Home Edition Service Pack 2、Windows XP Professional Service Pack 2、Windows XP Tablet PC Edition 2005 以及 Windows XP Media Center Edition 2005 上的 Windows Media Player 9：

| 檔案名稱 | 版本       | 日期               | 時間  | 大小      |
|----------|------------|--------------------|-------|-----------|
| wmp.dll  | 9.0.0.3349 | 2006 年 4 月 24 日 | 22:40 | 4,730,880 |

安裝於 Windows XP Home Edition Service Pack 1、Windows XP Professional Service Pack 1、Windows XP Tablet PC Edition、Windows XP Media Center Edition、Windows XP Home Edition Service Pack 2、Windows XP Professional Service Pack 2、Windows XP Tablet PC Edition 2005 以及 Windows XP Media Center Edition 2005 上的 Windows Media Player 10：

| 檔案名稱 | 版本        | 日期               | 時間  | 大小      |
|----------|-------------|--------------------|-------|-----------|
| wmp.dll  | 10.0.0.4036 | 2006 年 4 月 29 日 | 13:07 | 5,533,696 |

安裝於 Windows XP Professional x64 上的 Windows Media Player 10：
...
系統管理員也可以使用 Spuninst.exe 公用程式來移除此安全性更新。 Spuninst.exe 公用程式位於 %Windir%\\$NTUninstallKB917734\_WMP7$\\Spuninst 資料夾或 %Windir%\\$NTUninstallKB917734\_WMP9$\\Spuninst 資料夾中。
...
安裝於 Windows 2000 Service Pack 4 以及 Small Business Server 2000 上的 Windows Media Player 7.1：

| 檔案名稱  | 版本        | 日期               | 時間  | 大小      |
|-----------|-------------|--------------------|-------|-----------|
| wmpui.dll | 7.10.0.3078 | 2006 年 4 月 24 日 | 23:36 | 1,122,304 |

安裝於 Windows 2000 Service Pack 4 以及 Small Business Server 2000 上的 Windows Media Player 9：
...
-   感謝 [iDEFENSE](https://www.idefense.com/) 的 Greg MacManus 回報 Windows Media Player 弱點 - [CVE-2006-0025](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0025)
...
-   V1.1 (2006 年 6 月 21 日)： 針對 Windows 2000 上的 Windows Media Player 9，修訂公告＜登錄機碼驗證＞部分。

    V1.2 (2006 年 7 月 19 日)： 針對 Windows Server 2003 上的 Windows Media Player 10，修訂公告＜登錄機碼驗證＞部分。
