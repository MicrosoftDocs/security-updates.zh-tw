...
**警告：** [Microsoft 知識庫文件編號 910729](https://support.microsoft.com/kb/910729) 詳細記錄了目前已知安裝此安全性更新可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。 如需更多資訊，請參閱 [Microsoft 知識庫文件編號 910729](https://support.microsoft.com/kb/910729)。

**已測試軟體及安全性更新下載位置：**

**受影響的軟體**

-   Microsoft Office 2000 — [英文下載更新程式 (KB894540)](https://www.microsoft.com/download/details.aspx?familyid=461a126b-596f-4e84-99fd-03554ac55213) │ [中文下載更新程式 (KB894540)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=461a126b-596f-4e84-99fd-03554ac55213)
    -   Office Publisher 2000
-   Microsoft Office XP — [英文下載更新程式 (KB894541)](https://www.microsoft.com/download/details.aspx?familyid=0356b9fb-2cd5-4a50-95f6-54846d39b6ea) │ [中文下載更新程式 (KB894541)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=0356b9fb-2cd5-4a50-95f6-54846d39b6ea)
    -   Office Publisher 2002
-   Microsoft Office 2003 — [英文下載更新程式 (KB894542)](https://www.microsoft.com/download/details.aspx?familyid=2eeb43f1-e2b6-4b78-98a1-e8b04242438a) │ [中文下載更新程式 (KB894542)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=2eeb43f1-e2b6-4b78-98a1-e8b04242438a)
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Publisher 弱點 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0001">CVE-2006-0001</a></td>
...
**此更新程式是否包含任何功能的變更？**  
是。 在安裝 Publisher 2000 或 Publisher 2002 的更新後，使用者將無法開啟 Publisher 2.0 檔案。 如需更多資訊，請參閱 [Microsoft 知識庫文件編號 924685](https://support.microsoft.com/kb/924685)。此外，如果使用者開啟格式錯誤的 Publisher 檔案，Publisher 可能會當掉，但這項弱點不會遭到利用。
...
1.  [下載 Office 2000 的安全性更新。](https://download.microsoft.com/download/6/f/5/6f506c84-dc65-4157-b137-b093ad23e245/office2000-kb894540-fullfile-enu.exe)  
...
1.  [下載 Office XP 的安全性更新](https://download.microsoft.com/download/b/6/2/b62c81d9-a971-4e9c-a38f-06f577811b5c/officexp-kb894541-fullfile-enu.exe)。  
2.  按一下 \[將程式存到磁碟\]，然後按一下 \[確定\]。  
3.  按一下 \[儲存\]。  
4.  在 Windows 檔案總管中，尋找包含已儲存檔案的資料夾，然後按兩下儲存的檔案。  
5.  如果系統提示您安裝更新程式，請按一下 \[是\]。  
...
1.  [下載 Office 2003 的安全性更新](https://download.microsoft.com/download/d/7/3/d730797b-e5f8-4bae-94f4-64b5127aacf3/office2003-kb894542-fullfile-enu.exe)。  
2.  按一下 \[將程式存到磁碟\]，然後按一下 \[確定\]。  
3.  按一下 \[儲存\]。  
4.  在 Windows 檔案總管中，尋找包含已儲存檔案的資料夾，然後按兩下儲存的檔案。  
5.  如果系統提示您安裝更新程式，請按一下 \[是\]。  
...
-   感謝 [Computer Terrorism](https://www.computerterrorism.com/) 的 Stuart Pearson 回報 Microsoft Publisher 弱點 - [CVE-2006-0001](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0001)
