...
**警告：** [Microsoft 知識庫文件編號 917537](https://support.microsoft.com/kb/917537) 詳細記錄了目前已知安裝此安全性更新可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。 如需更多資訊，請參閱 [Microsoft 知識庫文件編號 917537](https://support.microsoft.com/kb/917537)。

**已測試軟體及安全性更新下載位置：**

**受影響的軟體**

-   Microsoft Windows 2000 Service Pack 4 — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=c917d6da-da2d-402c-a870-1de3cbd21ebf) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=c917d6da-da2d-402c-a870-1de3cbd21ebf)
-   Microsoft Windows XP Professional Service Pack 1 和 Microsoft Windows XP Professional Service Pack 2 — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=55d3ca3a-97fc-4e22-8ecc-9416ebc993c4) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=55d3ca3a-97fc-4e22-8ecc-9416ebc993c4)
-   Microsoft Windows XP Professional x64 Edition — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=4e19b792-7505-4453-b460-5a16915443db)
-   Microsoft Windows Server 2003 和 Microsoft Windows Server 2003 Service Pack 1 — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=c5e274a8-f962-4944-8878-6b88b1592bbf) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=c5e274a8-f962-4944-8878-6b88b1592bbf)
-   Microsoft Windows Server 2003 for Itanium-based Systems 及 Microsoft Windows Server 2003 Service Pack 1 for Itanium-based Systems — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=e2dc245e-d0f3-41b9-b090-68a2118001cb)
-   Microsoft Windows Server 2003 x64 Edition 系列 — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=f29c886d-b896-4fcf-a22b-2c1a53b1a9eb)
...
|---------------------------------------------------------------------------------------------------------------------------------------------------|----------------|--------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------|
| Internet Information Services 使用格式錯誤的動態伺服器網頁弱點 - [CVE-2006-0026](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0026) | 遠端執行程式碼 | 中度                                                                           | 重要                                                                                                                                                                                   | 重要                                                                               |
...
[Microsoft 知識庫文件編號 917537](https://support.microsoft.com/kb/917537) 詳細記錄了目前已知安裝此安全性更新可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。 如需更多資訊，請參閱 [Microsoft 知識庫文件編號 917537](https://support.microsoft.com/kb/917537)。
...
**是否可以透過網際網路利用這個弱點？**  
是。 如果攻擊者取得伺服器的寫入權限，就能透過網際網路來嘗試利用此弱點。 最佳實作的防火牆和標準預設防火牆設定有助於防止來自網際網路外界的攻擊。 Microsoft 已經針對這個問題提出如何保護電腦的因應措施。 一般使用者可以造訪[保護您的電腦網站](https://www.microsoft.com/taiwan/athome/security/protect/windowsxpsp2/default.mspx)。 IT 專業人員可以造訪[資訊安全指導中心網站](https://www.microsoft.com/taiwan/technet/security/default.mspx)。
...
此安全性更新在具備 6.0.3790.1830 版 Asp.dll 檔案的系統上，可支援 HotPatching。如您使用了 HotPatching，您可在執行 Microsoft Windows Server 2003 Service Pack 1 的系統上，安裝安全性更新而無須重新啟動伺服器。 如需關於 HotPatching 及利用 HotPatching 部署安全性更新的進一步資訊，請參閱 [Microsoft 知識庫文件編號 897341](https://support.microsoft.com/kb/897341)。
...
如需關於 Update.exe 安裝程式的詳細資訊，請造訪 [Microsoft TechNet 網站](https://go.microsoft.com/fwlink/?linkid=38951)。
...
-   感謝 [Security-Assessment.com](https://security-assessment.com/) 的 Brett Moore 回報 Internet Information Services 使用錯誤格式的動態伺服器網頁弱點 - [CVE-2006-0026](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0026)。
