---
TOCTitle: 'MS06-070'
Title: 'Microsoft Security Bulletin MS06-070 - 重大'
ms:assetid: 'ms06-070'
ms:contentKeyID: 61237817
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms06-070(v=Security.10)'
---

Microsoft Security Bulletin MS06-070 - 重大
===========================================

Workstation 服務中的弱點可能會允許遠端執行程式碼 (924270)
---------------------------------------------------------
...
-   Microsoft Windows 2000 Service Pack 4 — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=3ad5c57d-d3f6-46a1-8dee-3e16d0977f80&displaylang=en) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=3ad5c57d-d3f6-46a1-8dee-3e16d0977f80)
-   Microsoft Windows XP Service Pack 2 — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=f4c8e767-4ed2-4e36-aa43-612f3017efc7&displaylang=en) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=f4c8e767-4ed2-4e36-aa43-612f3017efc7)
...
| 弱點識別碼                                                                                                        | 弱點的影響     | Windows 2000 Service Pack 4 | Windows XP Service Pack 2 |
|-------------------------------------------------------------------------------------------------------------------|----------------|-----------------------------|---------------------------|
| Workstation 服務記憶體損毀弱點 - [CVE-2006-4691](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4691) | 遠端執行程式碼 | 重大                        | 輕微                      |
...
<span></span>
#### Workstation 服務記憶體損毀弱點 - CVE-2006-4691：
  
Workstation 服務中存在的遠端執行程式碼弱點，可以讓成功利用此弱點的攻擊者取得受影響系統的完整控制權。
  
#### Workstation 服務記憶體損毀弱點 - CVE-2006-4691 的緩和因素：
  
-   最佳實作的防火牆和標準預設防火牆設定有助於防止網路受到來自企業外的攻擊。 最佳方式建議連線至網際網路的系統盡可能曝露最少數量的連接埠。  
-   對於 Windows Server 2003，受影響的元件不易遭受攻擊。
  
#### Workstation 服務記憶體損毀弱點 - CVE-2006-4691 的因應措施：
...
-   **為了防範利用此弱點的網路攻擊，請使用個人防火牆，如 Windows XP 中提供的Windows 防火牆。**
    ...
    依照預設，Windows XP 中的 [Windows 防火牆](https://www.microsoft.com/taiwan/athome/security/protect/windowsxp/default.mspx)功能會封鎖來路不明的輸入流量，藉此協助保護網際網路連線。 我們建議您封鎖所有來路不明的網際網路輸入通訊。
...
#### Workstation 服務記憶體損毀弱點 - CVE-2006-4691 的常見問題集：
  
**這個弱點的範圍為何？**  
這是遠端執行程式碼的弱點。 成功利用此弱點的攻擊者可以從遠端取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個弱點的原因為何？**  
Workstation 服務中存在未檢查的緩衝區。
  
**什麼是 Workstation 服務？**  
本機檔案系統要求和遠端檔案或列印網路要求，都是透過 Workstation 服務來進行路由。 此服務可判斷出資源的位置，然後將要求路由到本機檔案系統或是網路元件。 當停用 Workstation 服務，所有的要求就會被假設是本機要求。
  
**攻擊者可能會利用這項弱點採取什麼行動？**  
成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。
  
**什麼人可以利用此弱點？**  
在 Windows 2000 Service Pack 4 及 Windows XP Service Pack 2 中，能將蓄意製作的訊息傳遞給受影響系統的任何匿名使用者都可以嘗試利用此弱點。
  
**攻擊者如何利用這項弱點？**  
攻擊者可以建立蓄意製作的訊息，並將訊息傳送給受影響的系統，以利用這項弱點。 訊息可能會導致受影響的系統執行程式碼。
  
**因為這個弱點而承受風險的主要系統有哪些？**  
執行 Windows 2000 Service Pack 4 與 Windows XP Service Pack 2 的系統易遭受此弱點影響。
...
**更新的作用何在？**  
本更新程式在 Workstation 服務將訊息傳遞至分配的緩衝區之前，會修改 Workstation 服務驗證訊息長度的方式，因此消除此項弱點。
...
-   感謝 eEye 回報 Workstation 服務記憶體損毀弱點 (CVE-2006-4691)。
