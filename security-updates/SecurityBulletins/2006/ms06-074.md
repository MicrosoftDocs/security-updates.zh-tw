---
TOCTitle: 'MS06-074'
Title: 'Microsoft Security Bulletin MS06-074 - 重要'
ms:assetid: 'ms06-074'
ms:contentKeyID: 61237821
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms06-074(v=Security.10)'
---

Microsoft Security Bulletin MS06-074 - 重要
===========================================
...
-   Microsoft Windows 2000 Service Pack 4 — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=ecc1e691-626b-405c-87d1-15931d1e4258&displaylang=en) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=ecc1e691-626b-405c-87d1-15931d1e4258)
-   Microsoft Windows XP Service Pack 2 — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=2b57e00f-0f47-4567-b40f-f630ba5a29cb) │[中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=2b57e00f-0f47-4567-b40f-f630ba5a29cb)
-   Microsoft Windows XP Professional x64 Edition — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=65ab5876-7c9a-4add-8b6d-0fd7d617397a)
-   Microsoft Windows Server 2003 和 Microsoft Windows Server 2003 Service Pack 1 — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=7856ee11-4f3a-4138-bfce-1b97fb25be69) │[中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=7856ee11-4f3a-4138-bfce-1b97fb25be69)
-   Microsoft Windows Server 2003 for Itanium-based Systems 及 Microsoft Windows Server 2003 SP1 for Itanium-based Systems — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=c1b01b91-c565-4d1f-90ec-f57a70fa012e)
-   Microsoft Windows Server 2003 x64 Edition — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=5b61249a-dba7-4fd5-85f3-b918044bbc92)
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">SNMP 記憶體損毀弱點 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-5583">CVE-2006-5583</a></td>
...
-   Windows XP Professional x64 Edition 嚴重性等級與 Windows XP Service Pack 2 相同。
-   Windows Server 2003 for Itanium-based Systems 嚴重性等級與 Windows Server 2003 嚴重性等級相同。
-   Windows Server 2003 Service Pack 1 for Itanium-based Systems 嚴重性等級與 Windows Server 2003 Service Pack 1 嚴重性等級相同。
...
<span></span>
#### SNMP 記憶體損毀弱點 - CVE-2006-5583：

SNMP 服務中存在的遠端執行程式碼弱點，可以讓攻擊者利用此弱點，順利取得受影響系統的完整控制權。

#### SNMP 記憶體損毀弱點 - CVE-2006-5583 的緩和因素：

-   依照預設不會安裝 SNMP 服務
-   對於需要受影響元件的客戶，最佳實作的防火牆和標準預設防火牆設定有助於防止網路受到來自企業外圍以外的攻擊。 最佳方式建議連線至網際網路的系統盡可能曝露最少數量的連接埠。

#### SNMP 記憶體損毀弱點 - CVE-2006-5583 的因應措施：

Microsoft 已經測試過以下的因應措施。 雖然這些因應措施不能徹底解決弱點，但有助於封鎖已知的攻擊行為。 如果因應措施會降低功能，以下小節將會描述功能降低的情況。

-   **限制可以管理電腦的 IP 位址。**
    1.  按一下 \[開始\]，然後按一下 \[執行\]。
    2.  在 \[開啟\] 方塊中，鍵入 **services.msc**，然後按一下 \[確定\]。
    3.  按一下 \[SNMP Service\]，然後選取 \[內容\]。
    4.  按一下 \[安全性\] 索引標籤，然後選取 \[從下列主機接受 SNMP 封包\]。
    5.  按一下 \[新增\]，輸入 IP 位址或主機名稱，然後按一下 \[新增\]，即可新增核准管理站台的 IP 位址。
-   **在防火牆封鎖下列項目：**

    -   UDP 連接埠 161

    本通訊埠用來起始與受影響元件的連線。 在防火牆封鎖上述連接埠有助於保護防火牆後的系統免遭此弱點的攻擊。 此外，請確定您已封鎖遠端系統上任何其他特別設定的 SNMP 連接埠。 建議您封鎖所有網際網路中來路不明的輸入通訊，以防他人利用其他連接埠攻擊系統。

-   **為了防範利用此弱點的網路攻擊，請使用個人防火牆，如 Windows XP 中提供的Windows 防火牆。**
    ...
    -   按一下 \[開始\]，然後按一下 \[控制台\]。
    -   按兩下 \[網路連線\]，然後按一下 \[變更您的 Windows 防火牆設定值\]。
    -   在 \[一般\] 索引標籤上，確定已選取 \[開啟 (建議選項)\] 值。 這將啟用 Windows 防火牆。
    -   啟用 Windows 防火牆後，選取 \[不允許例外\] 以禁止所有輸入流量。

    若要啟用部分程式及服務，以透過防火牆進行通訊，請取消選取 \[不允許例外\]，然後按一下 \[例外\] 索引標籤。 在 \[例外\] 索引標籤上，選取要啟用的程式、通訊協定及服務。
...
-   **停用 SNMP 服務**
    ...
    停用 SNMP 服務有助於保護受影響的系統免遭此弱點的攻擊。 若要停用 SNMP 服務，請執行這些步驟：
    ...
    您也可以在命令提示字元中使用下列命令來停止及停用 SNMP 服務：

    `sc stop SNMP & sc config SNMP start= disabled`

-   **因應措施的影響：** 如果停用 SNMP 服務，您無法從本機或遠端進行列印。 因此，我們建議您僅在不需要列印的系統上使用此因應措施。

#### SNMP 記憶體損毀弱點 - CVE-2006-5583 的常見問題集：
...
簡單網路管理通訊協定 ([SNMP](https://search.msdn.microsoft.com/search/redirect.aspx?title=snmp+functions+%5bsnmp%5d&url=https://msdn.microsoft.com/library/en-us/snmp/snmp/snmp_functions.asp)) 允許系統管理員從遠端管理網路裝置，例如伺服器、工作站、路由器、橋接器、防火牆等。 SNMP 是一種業界標準的通訊協定，可實現透過通訊協定管理由眾多不同廠商所製造的裝置。

**什麼是 SNMP 服務？**  

SNMP 服務允許由本機電腦來回應傳入的 (簡單網路管理通訊協定) SNMP 要求。 SNMP 包括監視網路裝置活動以及向網路主控台工作站報告的代理程式。

**如何得知我的系統上是否已安裝 SNMP 服務？**  

您可以執行下列步驟，確認您系統是否已安裝 SNMP 服務：
...
Microsoft Windows 系統是此弱點的主要影響目標。
...
本更新程式會在 SNMP 服務將訊息傳遞至分配的緩衝區之前，修改其驗證訊息長度的方法，進而消除此項弱點。
...
**注意：**使用 **/quiet** 參數將會隱藏所有訊息。 這包括隱藏失敗訊息。 當系統管理員使用 **/quiet** 參數時，則應該採取妥當的做法驗證是否已順利安裝。 當系統管理員使用這個參數時，也應檢閱 KB926247.log 檔案，查看是否有任何失敗訊息。
...
系統管理員也可以使用 Spuninst.exe 公用程式來移除此安全性更新。 Spuninst.exe 公用程式位於 %Windir%\\$NTUninstallKB926247$\\Spuninst 資料夾中。
...
| 檔案名稱 | 版本          | 日期               | 時間  | 大小   |
|----------|---------------|--------------------|-------|--------|
| Snmp.exe | 5.0.2195.7112 | 2006 年10 月 11 日 | 07:49 | 30,480 |
...
|----------|---------------|--------------------|-------|--------|--------|
| Snmp.exe | 5.1.2600.3038 | 2006 年11 月 20 日 | 14:12 | 33,280 | SP2GDR |
| Snmp.exe | 5.1.2600.3038 | 2006 年11 月 20 日 | 15:47 | 33,280 | SP2QFE |

Windows XP Professional x64：

| 檔案名稱  | 版本          | 日期               | 時間  | 大小   | CPU | 資料夾      |
|-----------|---------------|--------------------|-------|--------|-----|-------------|
| Snmp.exe  | 5.2.3790.2837 | 2006 年11 月 21 日 | 21:07 | 60,928 | x64 | SP1GDR      |
| Wsnmp.exe | 5.2.3790.2837 | 2006 年11 月 21 日 | 21:07 | 46,080 | x86 | SP1GDR\\WOW |
| Snmp.exe  | 5.2.3790.2837 | 2006 年11 月 21 日 | 20:56 | 60,928 | x64 | SP1QFE      |
| Wsnmp.exe | 5.2.3790.2837 | 2006 年11 月 21 日 | 20:57 | 40,960 | x86 | SP1QFE\\WOW |
...
**注意：**使用 **/quiet** 參數將會隱藏所有訊息。 這包括隱藏失敗訊息。 當系統管理員使用 **/quiet** 參數時，則應該採取妥當的做法驗證是否已順利安裝。 當系統管理員使用這個參數時，也應檢閱 KB**926247**.log 檔案，查看是否有任何失敗訊息。
...
此安全性更新可支援 HotPatching。 如需關於 HotPatching 的詳細資訊，請參閱 [Microsoft 知識庫文件編號 897341](https://support.microsoft.com/kb/897341)。
...
| Snmp.exe    | 5.2.3790.2837 | 2006 年11 月 21 日  | 20:11 | 46,080 | x86 | SP1GDR |
| Snmp.hp.exe | 5.2.3790.2837 | 2006 年11 月 21 日  | 20:11 | 6,144  | x86 | SP1GDR |
| Snmp.exe    | 5.2.3790.2837 | 2006 年11 月 21 日  | 15:53 | 40,960 | x86 | SP1QFE |
...
| 檔案名稱  | 版本          | 日期               | 時間  | 大小    | CPU   | 資料夾      |
|-----------|---------------|--------------------|-------|---------|-------|-------------|
| Snmp.exe  | 5.2.3790.615  | 2006 年11 月 21 日 | 20:57 | 97,280  | IA-64 | RTMGDR      |
| Snmp.exe  | 5.2.3790.615  | 2006 年11 月 21 日 | 20:57 | 97,280  | IA-64 | RTMQFE      |
| Snmp.exe  | 5.2.3790.2837 | 2006 年11 月 21 日 | 21:02 | 116,224 | IA-64 | SP1GDR      |
| Wsnmp.exe | 5.2.3790.2837 | 2006 年11 月 21 日 | 21:02 | 46,080  | x86   | SP1GDR\\WOW |
| Snmp.exe  | 5.2.3790.2837 | 2006 年11 月 21 日 | 21:00 | 116,224 | IA-64 | SP1QFE      |
| Wsnmp.exe | 5.2.3790.2837 | 2006 年11 月 21 日 | 21:00 | 40,960  | x86   | SP1QFE\\WOW |
...
-   感謝 [European Aeronautic Defense and Space Company](https://www.eads.com/) 的 Kostya Kortchinsky 回報 SNMP 記憶體損毀弱點 (CVE-2006-5583)。
