---
TOCTitle: 'MS06-045'
Title: 'Microsoft Security Bulletin MS06-045 - 重大'
ms:assetid: 'ms06-045'
ms:contentKeyID: 61237792
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms06-045(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS06-045 - 重大
===========================================

Windows 檔案總管的弱點可能會允許遠端執行程式碼 (921398)
-------------------------------------------------------
...
-   Microsoft Windows 2000 Service Pack 4 – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=38cee83e-b17a-4c08-90ce-fb836b9615ad&displaylang=en) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=38cee83e-b17a-4c08-90ce-fb836b9615ad)
-   Microsoft Windows XP Service Pack 1 和 Microsoft Windows XP Service Pack 2 – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=6ef68858-4c91-47fb-ae34-0be556f10ede&displaylang=en) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=6ef68858-4c91-47fb-ae34-0be556f10ede)
-   Microsoft Windows XP Professional x64 Edition – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=50935f4e-e383-493e-97c6-599cbb2b87cc&displaylang=en)
-   Microsoft Windows Server 2003 和 Microsoft Windows Server 2003 Service Pack 1 – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=759435a3-98f9-4115-b52e-d7fa9d024f16&displaylang=en) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=759435a3-98f9-4115-b52e-d7fa9d024f16)
-   Microsoft Windows Server 2003 for Itanium-based Systems 及具備 SP1 的 Microsoft Windows Server 2003 for Itanium-based Systems – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=462131c6-a728-4b3c-94de-85deccc42c3e&displaylang=en)
-   Microsoft Windows Server 2003 x64 Edition – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=50eef5c5-861d-4802-85a2-6b0627aafc2a&displaylang=en)
...
|---------------------------------------------------------------------------------------------------------------|----------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| 資料夾 GUID 程式碼執行弱點 - [CVE-2006-3281](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3281) | 遠端執行程式碼 | 重要         | 重要                      | 重要                      | 重要                | 重要                               |
...
<span></span>
#### 資料夾 GUID 程式碼執行弱點 - CVE-2006-3281：

由於 Windows 檔案總管處理拖放事件的方式，導致其中存在遠端執行程式碼的弱點。 攻擊者可以建立惡意網頁，使用者若是瀏覽惡意網站或檢視惡意電子郵件訊息，此弱點有可能可以讓攻擊者在使用者的系統中儲存檔案。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 要利用此項弱點發動攻擊，必須要有使用者的互動才能奏效。

#### 資料夾 GUID 程式碼執行弱點 - CVE-2006-3281 的緩和因素：
...
#### 資料夾 GUID 程式碼執行弱點 - CVE-2006-3281 的因應措施：
...
-   **使用群組原則設定，在所有不需要 WebClient 服務的受影響系統上停用此項功能。**
    ...
    **注意：**您也可以參閱《[Windows Serve 2003 安全性指南](https://www.microsoft.com/taiwan/technet/security/prodtech/windowsserver2003/w2003hg/sgch00.mspx)》(英文)。 其中包含了如何停用服務的資訊。
    ...
    -   [Windows Server 2003 的群組原則](https://www.microsoft.com/windowsserver2003/techinfo/overview/gpintro.mspx) (英文)
...
-   **停用檔案： 通訊協定處理常式**。
    ...
    **注意：**我們建議您在編輯登錄之前先將之備份。
    ...
    若要停用檔案： 通訊協定處理常式，請依照下列步驟進行：

    1.  關閉所有 Internet Explorer 執行個體
    2.  按一下 \[開始\]，按一下 \[執行\]，鍵入 **regedt32**，再按一下 \[確定\]。
    3.  在「登錄編輯程式」中，找出下列登錄機碼：HKEY\_LOCAL\_MACHINE\\Software\\Microsoft\\Windows\\CurrentVersion\\Policies\\Explorer
    4.  新增或編輯 DWORD 值 **NoFileUrl**
    5.  將值設定為 **1**

    **因應措施的影響：** 使用檔案： 處理常式的 URL 將無法正常運作。

-   **在防火牆中封鎖 TCP 連接埠 139 和 445：**

    雖然 WebDAV 為輸出通訊使用 TCP 連接埠 80，但 TCP 連接埠 139 及 445 可用在輸出上，以嘗試連線至惡意服務並利用此弱點。 在防火牆封鎖上述連接埠有助於保護防火牆後的系統免遭此弱點的攻擊。 建議您封鎖所有網際網路中來路不明的輸入通訊，以防他人利用其他連接埠攻擊系統。 如需更多關於連接埠的資訊，請造訪這個[網站](https://go.microsoft.com/fwlink/?linkid=21312)。

#### 資料夾 GUID 程式碼執行弱點 - CVE-2006-3281 的常見問題集：
...
**造成這個弱點的原因為何？**  
Windows 檔案總管不當處理拖放事件。 要利用此項弱點發動攻擊，必須要有使用者的互動才能奏效。

**攻擊者可能會利用這項弱點採取什麼行動？**  
攻擊者成功說服使用者造訪其網站，並將蓄意製作的檔案儲存到受影響的系統上，就可以取得使用者系統的完整控制權。
...
是。 這項弱點已經遭到公開揭發。 這項弱點已被指派一般性弱點編號 CVE-2006-3281。而規模較大的資訊安全社群也將此弱點命名為「Microsoft Internet Explorer 資訊洩漏與 HTA 檔案執行弱點」。

**當本安全性公告發行時，Microsoft 是否已接獲任何消息，指出這項弱點已遭有心人士惡用？**  
否。 當本安全性公告初次發行時，Microsoft 已發現已發行的概念驗證程式碼範例，但並未接到任何有關本弱點已成為公開攻擊媒介的消息。

**此弱點與 MS06-015 所修正的弱點有何關係？**  
這兩個弱點都存在於 Windows 檔案總管中。 不過，這個更新解決了一項 MS06-015 尚未涵蓋的弱點。MS06-015 能完全保護該公告中所提及的弱點，但是它並沒有對這個新弱點提供解決之道。 本更新程式並不會取代 MS06-015。
...
**注意：**使用 **/quiet** 參數將會隱藏所有訊息。 這包括隱藏失敗訊息。 當系統管理員使用 **/quiet** 參數時，則應該採取妥當的做法驗證是否已順利安裝。 當系統管理員使用這個參數時，也應檢閱 KB921398.log 檔案，查看是否有任何失敗訊息。
...
系統管理員也可以使用 Spuninst.exe 公用程式來移除此安全性更新。 Spuninst.exe 公用程式位於 %Windir%\\$NTUninstallKB921398$\\Spuninst 資料夾中。
...
-   **登錄機碼驗證**
    ...
    **注意：**此登錄機碼可能未包含完整的安裝檔案清單。 此外，當系統管理員或 OEM 將 921398 安全性更新整合或匯集到 Windows 安裝原始檔時，可能未正確建立這個登錄機碼。
...
-   **登錄機碼驗證**
    ...
    **注意：**這些登錄機碼可能未包含完整的安裝檔案清單。 此外，當系統管理員或 OEM 將 921398 安全性更新整合或匯集到 Windows 安裝原始檔時，可能未正確建立這些登錄機碼。
