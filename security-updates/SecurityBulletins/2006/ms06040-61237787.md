...
**警告：** [Microsoft 知識庫文件編號 921883](http://support.microsoft.com/kb/921883) 詳細記錄了目前已知安裝此安全性更新可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。 如需更多資訊，請參閱 [Microsoft 知識庫文件編號 921883](http://support.microsoft.com/kb/921883)。

**已測試軟體及安全性更新下載位置：**

**受影響的軟體**

-   Microsoft Windows 2000 Service Pack 4 — [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=3b61153d-359f-4441-a448-24062cb2387c) │ [中文下載更新程式](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&familyid=3b61153d-359f-4441-a448-24062cb2387c)
-   Microsoft Windows XP Service Pack 1 和 Microsoft Windows XP Service Pack 2 — [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=2996b9b6-03ff-4636-861a-46b3eac7a305) │ [中文下載更新程式](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&familyid=2996b9b6-03ff-4636-861a-46b3eac7a305)
-   Microsoft Windows XP Professional x64 Edition — [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=314c7c2c-9a02-4e56-98cf-97703fecf0be)
-   Microsoft Windows Server 2003 和 Microsoft Windows Server 2003 Service Pack 1 — [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=a0058f39-6dea-4dfc-9dd6-4cb45b305dec) │ [中文下載更新程式](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&familyid=a0058f39-6dea-4dfc-9dd6-4cb45b305dec)
-   Microsoft Windows Server 2003 for Itanium-based Systems 及 Microsoft Windows Server 2003 SP1 for Itanium-based Systems — [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=af970833-2044-4284-937d-3beb2e2f286d)
-   Microsoft Windows Server 2003 x64 Edition — [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=3b0c1954-fca5-4e95-abb2-6066a9d6bc76)
...
|--------------------------------------------------------------------------------------------------------------|----------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Server 服務緩衝區溢位弱點 - [CVE-2006-3439](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3439) | 遠端執行程式碼 | 重大         | 重大                      | 重大                      | 重大                | 重大                               |
...
-   **在防火牆中封鎖 TCP 連接埠 139 和 445：**
    ...
    本通訊埠用來起始與受影響元件的連線。 在防火牆封鎖 TCP 連接埠 139 與 445 有助於保護防火牆後方的系統免遭此弱點的攻擊。 建議您封鎖所有網際網路中來路不明的輸入通訊，以防他人利用其他連接埠攻擊系統。 如需更多關於連接埠的資訊，請造訪這個[網站](http://go.microsoft.com/fwlink/?linkid=21312)。
...
-   感謝 [US-CERT](http://www.us-cert.gov/) 協助我們解決 Server 服務緩衝區溢位弱點 (CVE-2006-3439)。
-   感謝 [SANS](http://www.sans.org/) 協助我們解決 Server 服務緩衝區溢位弱點 (CVE-2006-3439)。
...
-   [Microsoft TechNet 資訊安全](http://www.microsoft.com/technet/security/default.mspx)網站提供了有關 Microsoft 產品安全性的其他資訊。
...
-   V2.0 (2006 年 9 月 12 日)： 此更新已針對 Microsoft Windows 2003 和 Microsoft Windows XP Professional x64 Edition 修訂並重新發行，以解決 [Microsoft 知識庫文件編號 921883](http://support.microsoft.com/kb/921883) 中所述之問題。
