---
TOCTitle: 'MS06-041'
Title: 'Microsoft Security Bulletin MS06-041 - 重大'
ms:assetid: 'ms06-041'
ms:contentKeyID: 61237788
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms06-041(v=Security.10)'
---

Microsoft Security Bulletin MS06-041 - 重大
===========================================

DNS 解析中的弱點可能會允許遠端執行程式碼 (920683)
-------------------------------------------------
...
-   Microsoft Windows 2000 Service Pack 4 — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=144408a7-3011-458a-bc79-49b1658aa25d&displaylang=en) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=144408a7-3011-458a-bc79-49b1658aa25d)
-   Microsoft Windows XP Service Pack 1 和 Microsoft Windows XP Service Pack 2 — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=c332b95a-2956-406b-9e06-07c5e96b02e3&displaylang=en) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=c332b95a-2956-406b-9e06-07c5e96b02e3)
-   Microsoft Windows XP Professional x64 Edition — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=1be5310b-1995-4ef9-a462-04da9833f50b&displaylang=en)
-   Microsoft Windows Server 2003 和 Microsoft Windows Server 2003 Service Pack 1 — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=6d027e72-1f94-44de-95f9-f52000a991cc&displaylang=en) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=6d027e72-1f94-44de-95f9-f52000a991cc)
-   Microsoft Windows Server 2003 for Itanium-based Systems 及 Microsoft Windows Server 2003 SP1 for Itanium-based Systems — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=18477016-0b70-4c86-90c7-3535d365b7c1&displaylang=en)
-   Microsoft Windows Server 2003 x64 Edition — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=583b741c-47e2-429d-9d50-44670bb2f452&displaylang=en)
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Winsock 主機名稱弱點 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3440">CVE-2006-3440</a></td>
...
<tr class="even">
<td style="border:1px solid black;">DHCP Client 緩衝區溢位弱點 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3441">CVE-2006-3441</a></td>
...
-   Windows XP Professional x64 Edition 的嚴重性等級與 Windows Server 2003 Service Pack 1 相同。  
...
如需瞭解詳細相關資訊，請參閱 [Microsoft 知識庫文件編號 910723](https://support.microsoft.com/kb/910723/zh-tw)。
...
<span></span>
#### Winsock 主機名稱弱點 - CVE-2006-3440：
  
在 Winsock 中有一個遠端執行程式碼弱點，可讓成功利用該弱點之攻擊者取得受影響系統的完整控制權。 攻擊者必須強迫使用者開啟檔案或造訪蓄意製作的網站，以叫用受影響的 Winsock API，攻擊才有可能成功。
  
#### Winsock 主機名稱弱點 - CVE-2006-3440 的緩和因素：
  
-   如果攻擊者引誘使用者開啟蓄意製作的檔案，或檢視包含蓄意製作的網站，就可以利用此弱點。 除了可能透過預覽電子郵件外，攻擊者不能強制使用者開啟蓄意製作的檔案。
  
#### Winsock 主機名稱弱點 - CVE-2006-3440 的因應措施：
  
Microsoft 已經測試過以下的因應措施。 雖然這些因應措施不能徹底解決弱點，但有助於封鎖已知的攻擊行為。 如果因應措施會降低功能，以下小節將會描述功能降低的情況。
  
-   **修改自動撥號 DLL**
  
    修改 Windows 登錄中的自動撥號 DLL 將會防止應用程式、蓄意製作的網站或電子郵件呼叫受影響的 API 及利用此弱點。 若在預設的指定位置找不到「自動撥號 DLL」登錄值，我們建議客戶據此建立 REG\_SZ 值。  
    ...
    **注意：**我們建議您在編輯之前先將之備份。
    ...
    -   在「登錄編輯程式」中，找到下列登錄機碼： HKEY\_LOCAL\_MACHINE\\SYSTEM\\CurrentControlSet\\Services\\WinSock2\\Parameters  
    -   按兩下 REG\_SZ 值 **AutodialDLL**  
    -   將資料值設為 **kernel32.dll**  
    -   關閉 **regedt32** 公用程式並重新開機
  
#### Winsock 主機名稱弱點 - CVE-2006-3440 的常見問題集：
  
**這個弱點的範圍為何？**  
這是遠端執行程式碼的弱點。 成功利用此弱點的攻擊者可以從遠端取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個弱點的原因為何？**  
Winsock API 中的未檢查的緩衝區。
  
**什麼是 Winsock？**  
Windows Sockets 2 (Winsock) 能讓程式設計師創造出具備網際網路、內部網路與其他網路功能的先進應用程式，透過網路傳輸應用程式資料，而無需受制於所使用的網路通訊協定。 Winsock 提供程式設計師存取先進 Microsoft® Windows® 網路功能的方式，例如多點傳送與服務品質 (QOS)。 如需更多關於 Winsock 的資訊，請參閱下列 [MSDN 文章](https://windowssdk.msdn.microsoft.com/en-us/library/ms740673.aspx)。
  
**攻擊者可能會利用這項弱點採取什麼行動？**  
成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。
  
**攻擊者如何利用這項弱點？**  
如果攻擊者引誘使用者開啟蓄意製作的檔案，或檢視包含蓄意製作的網站，就可以利用此弱點。 除了可能透過預覽電子郵件外，攻擊者不能強制使用者開啟蓄意製作的檔案。此外，如果應用程式使用受到影響的 API，在不需要使用者動作反應的一般使用狀況期間，有可能造成應用程式遭到利用。
  
**因為這個弱點而承受風險的主要系統有哪些？**  
伺服器與工作站最可能受這個弱點影響。
  
**更新的作用何在？**  
本更新程式會修改在將訊息傳遞至分配的緩衝區之前，受影響函式驗證訊息的方式，進而消除此項弱點。
...
#### DHCP Client 緩衝區溢位弱點 - CVE-2006-3441：
  
在 DNS Client 服務中有一個遠端執行程式碼弱點，可讓成功利用該弱點之攻擊者取得受影響系統的完整控制權。
  
#### DHCP Client 緩衝區溢位弱點 - CVE-2006-3441 的緩和因素：
  
-   若要成功進行攻擊，攻擊者必須從主機與 DNS 伺服器之間的子網路上採取行動，或強迫目標主機發出 DNS 要求，使其接到攻擊主機傳回蓄意製作的記錄回應。
  
#### DHCP Client 緩衝區溢位弱點 - CVE-2006-3441 的因應措施：
...
-   **在網路閘道上封鎖 DNS 相關記錄**
    ...
    在網路閘道封鎖下列類型的 DNS 記錄能保護受影響的系統，避免此弱點遭受攻擊。
...
#### DHCP Client 緩衝區溢位弱點 - CVE-2006-3441 的常見問題集：
...
**什麼是 DNS？**  
網域名稱系統 (DNS) 用戶端服務可解析及快取 DNS 名稱。 DNS Client 服務必須在每一台進行 DNS 名稱解析的電腦上執行。 若要在 Active Directory 網域中尋找網域控制器，解析 DNS 名稱的能力是不可或缺的。 若要尋找使用 DNS 名稱解析來識別的裝置，DNS Client 服務也極為重要。 如需更多有關 DNS Client 服務的資訊，請參閱下列 [Microsoft TechNet 文章](https://technet2.microsoft.com/windowsserver/en/library/6715556b-dfe4-41c4-87a9-333d22e473b21033.mspx?mfr=true)。
  
**攻擊者可能會利用這項弱點採取什麼行動？**  
成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。
  
**攻擊者如何利用這項弱點？**  
匿名使用者可在同一個網路區段中傳送蓄意製作的 DNS 通訊給受影響的用戶端，以利用此弱點。 若要成功進行攻擊，攻擊者必須從主機與 DNS 伺服器之間的子網路上採取行動，或強迫目標主機發出 DNS 要求，使其接到攻擊主機傳回蓄意製作的記錄回應。
  
**因為這個弱點而承受風險的主要系統有哪些？**  
伺服器與工作站最可能受這個弱點影響。
  
**更新的作用何在？**  
此更新可驗證 DNS 用戶端處理 DNS 相關通訊的方式，進而移除此弱點。
...
**停用 DNS Client 服務或設定用戶端使用特定 DNS 伺服器是否能緩和此弱點的威脅？**  
否。 停用 DNS Client 服務或設定使用可信任的特定 DNS 伺服器並無法緩和此弱點的威脅。
...
**注意：**使用 **/quiet** 參數將會隱藏所有訊息。 這包括隱藏失敗訊息。 當系統管理員使用 **/quiet** 參數時，則應該採取妥當的做法驗證是否已順利安裝。 當系統管理員使用這個參數時，也應檢閱 KB920683.log 檔案，查看是否有任何失敗訊息。
...
此安全性更新可支援 HotPatching。 如您使用了 HotPatching，您可在執行 Microsoft Windows Server 2003 Service Pack 1 的系統上，安裝安全性更新而無須重新啟動伺服器。 如需關於 HotPatching 及利用 HotPatching 部署安全性更新的進一步資訊，請參閱 Microsoft 知識庫文件編號 897341。

Windows Update、Microsoft Update 及「自動更新」所提供的安全性更新都使用 HotPatching，因此您不需要重新啟動伺服器。

**注意：**並非所有安全性更新都支援 HotPatching，某些支援 HotPatching 的安全性更新可能會要求您在安裝安全性更新之後重新啟動伺服器。 除非被安全性更新取代的檔案是一般發行版本 (General Distribution Release，GDR) 的檔案，才支援 HotPatching。

**移除資訊**

如果要移除此更新程式，請使用 \[控制台\] 中的 \[新增或移除程式\] 工具。

系統管理員也可以使用 Spuninst.exe 公用程式來移除此安全性更新。 Spuninst.exe 公用程式位於 %Windir%\\$NTUninstallKB920683$\\Spuninst 資料夾中。
...
如需更多有關這種行為的資訊，請參閱 [Microsoft 知識庫文件編號 824994](https://support.microsoft.com/kb/824994/zh-tw)。
...
**必要條件**
這個安全性更新需要 Microsoft Windows XP Service Pack 1 或更新版本。 如需更多資訊，請參閱 [Microsoft 知識庫文件編號 322389](https://support.microsoft.com/kb/322389/zh-tw)。
...
如需更多關於如何取得最新 Service Pack 的資訊，請參閱 [Microsoft 知識庫文件編號 260910](https://support.microsoft.com/kb/260910/zh-tw)。
...
-   感謝 [NGS Software](https://www.ngssoftware.com/index.htm) 的 Peter Winter-Smith 回報 Winsock 主機名稱弱點 - (CVE-2006-3440)。
-   感謝 [ISS X-Force](https://www.iss.net/) 的 Mark Dowd 回報 DHCP Client 緩衝區溢位弱點 - (CVE-2006-3441)。
...
-   V1.1 (2006 年 9 月 13 日)：已更新 ＜感謝＞ 部分，以闡明安全性研究員的貢獻。
