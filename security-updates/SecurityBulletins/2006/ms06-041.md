...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Winsock 主機名稱弱點 - <a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3440">CVE-2006-3440</a></td>
...
<tr class="even">
<td style="border:1px solid black;">DHCP Client 緩衝區溢位弱點 - <a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3441">CVE-2006-3441</a></td>
...
**什麼是 Winsock？**  
Windows Sockets 2 (Winsock) 能讓程式設計師創造出具備網際網路、內部網路與其他網路功能的先進應用程式，透過網路傳輸應用程式資料，而無需受制於所使用的網路通訊協定。 Winsock 提供程式設計師存取先進 Microsoft® Windows® 網路功能的方式，例如多點傳送與服務品質 (QOS)。 如需更多關於 Winsock 的資訊，請參閱下列 [MSDN 文章](http://windowssdk.msdn.microsoft.com/en-us/library/ms740673.aspx)。
...
**什麼是 DNS？**  
網域名稱系統 (DNS) 用戶端服務可解析及快取 DNS 名稱。 DNS Client 服務必須在每一台進行 DNS 名稱解析的電腦上執行。 若要在 Active Directory 網域中尋找網域控制器，解析 DNS 名稱的能力是不可或缺的。 若要尋找使用 DNS 名稱解析來識別的裝置，DNS Client 服務也極為重要。 如需更多有關 DNS Client 服務的資訊，請參閱下列 [Microsoft TechNet 文章](http://technet2.microsoft.com/windowsserver/en/library/6715556b-dfe4-41c4-87a9-333d22e473b21033.mspx?mfr=true)。
...
如需更多有關這種行為的資訊，請參閱 [Microsoft 知識庫文件編號 824994](http://support.microsoft.com/kb/824994/zh-tw)。
...
-   感謝 [NGS Software](http://www.ngssoftware.com/index.htm) 的 Peter Winter-Smith 回報 Winsock 主機名稱弱點 - (CVE-2006-3440)。
-   感謝 [ISS X-Force](http://www.iss.net/) 的 Mark Dowd 回報 DHCP Client 緩衝區溢位弱點 - (CVE-2006-3441)。
