...
|----------------------------------------------------------------------------------------------------------------|----------------|---------------------------|---------------------------|---------------------|------------------------------------|
| 物件封裝程式對話方塊偽造弱點 -[CVE-2006-4692](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4692) | 遠端執行程式碼 | 中度                      | 中度                      | 輕微                | 輕微                               |
...
**什麼是物件封裝程式？**  
物件封裝程式是一種工具，可以用來建立要插入檔案的封裝。 如需更多關於物件封裝程式的資訊，請參閱以下 [Microsoft 產品說明文件](https://www.microsoft.com/resources/documentation/windows/xp/all/proddocs/en-us/packager_what_is_obj_pkg.mspx?mfr=true)。
...
-   感謝 [Secunia Research](https://www.secunia.com/) 的 Andreas Sandblad 回報物件封裝程式對話方塊偽造弱點 -CVE-2006-4692。
