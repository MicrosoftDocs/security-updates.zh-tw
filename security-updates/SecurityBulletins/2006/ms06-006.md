...
**警告：**  [Microsoft 知識庫文件編號 911564](https://support.microsoft.com/kb/911564) 詳細記錄目前已知安裝此安全性更新後可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Windows Media Player 外掛程式弱點 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0005">CVE-2006-0005</a></td>
...
-   感謝 [iDefense](https://idefense.com/) 的 John Cobb 回報 Windows Media Player 外掛程式弱點 - CVE-2006-0005。
