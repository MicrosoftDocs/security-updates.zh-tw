---
TOCTitle: 'MS06-023'
Title: 'Microsoft Security Bulletin MS06-023 - 重大'
ms:assetid: 'ms06-023'
ms:contentKeyID: 61237770
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms06-023(v=Security.10)'
---

Microsoft Security Bulletin MS06-023 - 重大
===========================================
...
**警告：** Microsoft 將此更新與 [Microsoft 安全性公告 MS06-021： Internet Explorer 積存安全性更新 (916281)](https://go.microsoft.com/fwlink/?linkid=66973) 中所包含的更新一併發佈。 我們建議您同時安裝此更新，因為該公告中的安全性更新可能會暴露此弱點，或是造成應用程式相容性上的問題。
...
-   Microsoft Windows 2000 Service Pack 4 中的 Microsoft JScript 5.1 — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=23e79abd-b1fe-4734-b3d3-fb53d286c06f)
-   安裝在 Windows 2000 Service Pack 4 中的 Microsoft JScript 5.6 和 5.5 — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=16dd21a1-c4ee-4eca-8b80-7bd1dfefb4f8) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=16dd21a1-c4ee-4eca-8b80-7bd1dfefb4f8)
-   Microsoft Windows XP Service Pack 1 和 Microsoft Windows XP Service Pack 2 中的 Microsoft JScript 5.6 — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=d28c02be-cac3-4579-9b93-939fd5d3cde6) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=d28c02be-cac3-4579-9b93-939fd5d3cde6)
-   Microsoft Windows XP Professional x64 Edition 中的 Microsoft JScript 5.6 — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=2ee3dd28-7167-4a2c-941d-a236f8cc5c4b)
-   Microsoft Windows Server 2003 和 Microsoft Windows Server 2003 Service Pack 1 中的 Microsoft JScript 5.6 — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=8963ae25-2230-47fe-aece-49d7457d96d4) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=8963ae25-2230-47fe-aece-49d7457d96d4)
-   Microsoft Windows Server 2003 for Itanium-based Systems 及 Microsoft Windows Server 2003 SP1 for Itanium-based Systems 中的 Microsoft JScript Server Extension 5.6 – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=7764c7dc-a7e4-4b91-95c2-ef7d4dce0a00)
-   Microsoft Windows Server 2003 x64 Edition 中的 Microsoft JScript 5.6 — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=bcf7ab2e-ee1c-45f9-8b1c-4b1cef683082)
-   Microsoft Windows 98、Microsoft Windows 98 Second Edition (SE) 和 Microsoft Windows Millennium Edition (ME) 中的 Microsoft JScript 5.6 — 請參閱此公告＜常見問題集＞中有關這些作業系統的詳細資訊。
...
這個更新程式能解決一項新發現的弱點。 Microsoft JScript 中存在遠端執行程式碼的弱點，可能會允許攻擊者取得受影響系統的完整控制權。 本公告的＜弱點詳細資訊＞部分會提供這項弱點的相關資訊。
...
|---------------------------------------------------------------------------------------------------------------------|----------------|-----------------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Microsoft JScript 記憶體損毀弱點 - [CVE-2006-1313](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1313) | 遠端執行程式碼 | 重大                  | 重大         | 重大                      | 重大                      | 中度                | 中度                               |
...
| 公告編號     | Windows 2000 Service Pack 4 | 安裝在 Windows 2000 Service Pack 4 中的 Microsoft JScript 5.6 和 5.5 | Windows XP Service Pack 1 | Windows XP Service Pack 2 | Windows Server 2003 | Windows Server 2003 Service Pack 1 |
|--------------|-----------------------------|----------------------------------------------------------------------|---------------------------|---------------------------|---------------------|------------------------------------|
| **MS03-008** | 不適用                      | 取代                                                                 | 取代                      | 不適用                    | 不適用              | 不適用                             |
...
| 產品                         | MBSA 1.2.1 | 企業更新掃描工具 | MBSA 2.0 |
|------------------------------|------------|------------------|----------|
| Microsoft JScript 5.1        | 沒有       | 有               | 有       |
| Microsoft JScript 5.6 和 5.5 | 沒有       | 有               | 有       |
...
| 產品                         | SMS 2.0       | SMS 2003 |
|------------------------------|---------------|----------|
| Microsoft JScript 5.1        | 有 (使用 EST) | 有       |
| Microsoft JScript 5.6 和 5.5 | 有 (使用 EST) | 有       |
...
<span></span>
#### Microsoft JScript 記憶體損毀弱點 - CVE-2006-1313：

JScript 中存在遠端執行程式碼弱點。 攻擊者可能會蓄意製作 JScript，在使用者造訪網站或檢視蓄意製作的電子郵件訊息時，允許從遠端執行程式碼，以利用這個弱點。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。

#### Microsoft JScript 記憶體損毀弱點 - CVE-2006-1313 的緩和因素：
...
#### Microsoft JScript 記憶體損毀弱點 - CVE-2006-1313 的因應措施：
...
**因應措施的影響：** 執行 ActiveX 控制項和動態指令碼之前先提示的設定會產生副作用。 許多網際網路及內部網路的網站使用 ActiveX 或動態指令碼提供額外的功能。 例如，線上電子商務網站或銀行網站會利用 ActiveX 控制項提供功能表、訂單或帳戶明細。 執行 ActiveX 控制項或動態指令碼處理前先提示屬於通用設定，會影響所有網際網路及內部網路網站。 使用這個因應措施的話，您會時常收到提示。 每次出現提示時，如果您覺得可以信任該網站，請按 \[是\] 執行 ActiveX 控制項或動態指令碼。 如果您不要收到這些網站的提示，請改用「將信任的網站加入 Internet Explorer \[信任的網站\] 區域」的步驟。
...
-   **修改 JScript.dll 上的「存取控制清單」，暫時避免在 Internet Explorer 中執行控制項**

    若要將 JScritp.dll 檔案上的存取控制清單修改成更具限制性，請按照下列步驟：

    1.  按一下 \[開始\]，按一下 \[執行\]，鍵入 **cmd**，再按一下 \[確定\]。
    2.  在命令提示字元鍵入下列命令。 記下最新檔案的 ACL，包括繼承設定。 如果您要復原這些變更，可能會需要這份清單：
    ...
    **因應措施的影響：** 使用 JScript 的應用程式及網站將不再運作。

    若要恢復其功能，您必須還原在 JScritp.dll 檔案的存取控制清單上所作的修改。

#### Microsoft JScript 記憶體損毀弱點 - CVE-2006-1313 的常見問題集：
...
**造成這個弱點的原因為何？**  
Microsoft JScript 可能會太早釋放物件而造成記憶體損毀。

**什麼是 Microsoft JScript？**  
JScript 是 Microsoft 對 ECMA 262 語言規格 (ECMAScript Edition 3) 的實作。 JScript 是一種經過解譯、以物件為基礎的指令碼語言。 如需更多資訊，請參閱[產品說明文件](https://msdn.microsoft.com/library/en-us/dnanchor/html/scriptinga.asp)。
...
**更新的作用何在？**  
更新程式會防止 JScript 所使用的物件太早被釋放，進而移除此項弱點。

**當安全性公告發行時，這項弱點是否已揭發出來？**  
否。 Microsoft 將此更新與 [Microsoft 安全性公告 MS06-021： Internet Explorer 積存安全性更新 (916281)](https://go.microsoft.com/fwlink/?linkid=66973) 中所包含的更新一併發佈。 我們建議您同時安裝此更新，因為該公告中的安全性更新可能會暴露此弱點，或是造成應用程式相容性上的問題。
...
**注意：**使用 **/quiet** 參數將會隱藏所有訊息。 這包括隱藏失敗訊息。 當系統管理員使用 **/quiet** 參數時，則應該採取妥當的做法驗證是否已順利安裝。 當系統管理員使用這個參數時，也應檢閱 KB917344.log 檔案，查看是否有任何失敗訊息。
...
系統管理員也可以使用 Spuninst.exe 公用程式來移除此安全性更新。 Spuninst.exe 公用程式位於 %Windir%\\$NTUninstallKB917344$\\Spuninst 資料夾中。
...
-   **登錄機碼驗證**
    ...
    **注意：**此登錄機碼可能未包含完整的安裝檔案清單。 此外，當系統管理員或 OEM 將 917344 安全性更新整合或匯集到 Windows 安裝原始檔時，可能未正確建立這個登錄機碼。
...
-   **登錄機碼驗證**
    ...
    **注意：**這些登錄機碼可能未包含完整的安裝檔案清單。 此外，當系統管理員或 OEM 將 917344 安全性更新整合或匯集到 Windows 安裝原始檔時，可能未正確建立這些登錄機碼。
...
#### Windows 2000 (所有版本) 上的 Microsoft JScript 5.6

**必要條件**
若為 Windows 2000，本安全性更新需要 Service Pack 4 (SP4)。 若是使用 Small Business Server 2000，本安全性更新需要 Small Business Server 2000 Service Pack 1a (SP1a) 或是與 Windows 2000 Server Service Pack 4 (SP4) 一起執行的 Small Business Server 2000。

**注意：**擁有 JScript 5.1 版的客戶應安裝＜Windows 2000 (所有版本)＞部分所提到的更新。 5.1 版是 Windows 2000 Service Pack 4 所隨附的版本。
