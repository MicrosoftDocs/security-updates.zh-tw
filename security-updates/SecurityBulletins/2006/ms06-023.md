...
**警告：** Microsoft 將此更新與 [Microsoft 安全性公告 MS06-021： Internet Explorer 積存安全性更新 (916281)](http://go.microsoft.com/fwlink/?linkid=66973) 中所包含的更新一併發佈。 我們建議您同時安裝此更新，因為該公告中的安全性更新可能會暴露此弱點，或是造成應用程式相容性上的問題。
...
|---------------------------------------------------------------------------------------------------------------------|----------------|-----------------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Microsoft JScript 記憶體損毀弱點 - [CVE-2006-1313](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1313) | 遠端執行程式碼 | 重大                  | 重大         | 重大                      | 重大                      | 中度                | 中度                               |
...
JScript 是 Microsoft 對 ECMA 262 語言規格 (ECMAScript Edition 3) 的實作。 JScript 是一種經過解譯、以物件為基礎的指令碼語言。 如需更多資訊，請參閱[產品說明文件](http://msdn.microsoft.com/library/en-us/dnanchor/html/scriptinga.asp)。
...
否。 Microsoft 將此更新與 [Microsoft 安全性公告 MS06-021： Internet Explorer 積存安全性更新 (916281)](http://go.microsoft.com/fwlink/?linkid=66973) 中所包含的更新一併發佈。 我們建議您同時安裝此更新，因為該公告中的安全性更新可能會暴露此弱點，或是造成應用程式相容性上的問題。
