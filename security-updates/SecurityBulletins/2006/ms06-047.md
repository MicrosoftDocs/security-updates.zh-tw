...
|-----------------------------------------------------------------------------------------------------------------------|----------------|-----------------------|---------------------|------------------------------------------------------------------|
| Visual Basic for Applications 弱點 - [CVE-2006-3649](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3649) | 遠端執行程式碼 | 重大                  | 重要                | 重要                                                             |
...
-   如果您已安裝 Visio 2002，就必須安裝 [Visio 2002 Service Pack 2 (SP2)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=00b9dfe4-ed08-4328-b355-4bc63d6267b2)。 安裝此更新之前，請先安裝 Visio 2002 SP2。如需有關如何安裝 Project 2002 SP1 的詳細資訊，請參閱 [Microsoft 知識庫文件編號 830242](https://support.microsoft.com/?kbid=830242)。
...
-   感謝[賽門鐵克](https://symantec.com/)的 Ka Chun Leung 回報 Visual Basic for Applications 弱點 - [CVE-2006-3649](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3649)。
