...
-   Microsoft Windows 2000 Service Pack 4 — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=3cf0b0d1-ff07-40ac-a6ac-44dc4a54f91e&displaylang=en) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=3cf0b0d1-ff07-40ac-a6ac-44dc4a54f91e)
-   Microsoft Windows XP Service Pack 2 — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=2f54258f-1071-467b-80a2-e4dbfc050667&displaylang=en) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=2f54258f-1071-467b-80a2-e4dbfc050667)
-   Microsoft Windows Server 2003 和 Microsoft Windows Server 2003 Service Pack 1 — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=f23574f7-4033-45ac-8ad8-6cced2ee9285&displaylang=en) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=f23574f7-4033-45ac-8ad8-6cced2ee9285)
...
|----------------------------------------------------------------------------------------------------------------------------------------|----------------|-----------------------------|---------------------------|-----------------------------------------------------------|
| Microsoft Client Service for NetWare 記憶體損毀弱點 - [CVE-2006-4688](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4688) | 遠端執行程式碼 | 重要                        | 重要                      | 中度                                                      |
| NetWare 驅動程式拒絕服務弱點 - [CVE-2006-4689](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4689)                        | 拒絕服務       | 中度                        | 中度                      | 輕微                                                      |
| **所有弱點的彙總嚴重性**                                                                                                               |           | **重要**                    | **重要**                  | **中度**                                                  |
...
-   **在防火牆中封鎖 TCP 連接埠 139 和 445：**
    ...
    上述連接埠用於起始與受影響元件的連線。 在防火牆封鎖 TCP 連接埠 139 與 445 有助於保護防火牆後方的系統免遭此弱點的攻擊。 建議您封鎖所有網際網路中來路不明的輸入通訊，以防他人利用其他連接埠攻擊系統。 如需更多關於連接埠的資訊，請造訪這個[網站](https://go.microsoft.com/fwlink/?linkid=21312)。
...
-   **為了防範利用此弱點的網路攻擊，請使用個人防火牆，如 Windows XP 中提供的**[**Windows 防火牆**](https://www.microsoft.com/taiwan/athome/security/protect/windowsxp/default.mspx)**。**
...
-   **為了防範利用此弱點的網路攻擊，請使用個人防火牆，如 Windows XP 中提供的**[**Windows 防火牆**](https://www.microsoft.com/taiwan/athome/security/protect/windowsxp/default.mspx)**。**
    ...
    依照預設，Windows XP 及 Windows Server 2003 中的 [Windows 防火牆功能](https://www.microsoft.com/athome/security/default.mspx)會封鎖來路不明的輸入流量，藉此協助保護網際網路連線。 我們建議您封鎖所有來路不明的網際網路輸入通訊。
...
-   感謝 [NGS Software](https://www.ngssoftware.com/) 的 Peter Winter-Smith 回報 Client Service for NetWare 記憶體損毀弱點 - CVE-2006-4668。
-   感謝 [McAfee](https://www.mcafee.com/us/) 的 Sam Arun Raj 回報 Client Service for NetWare 記憶體損毀弱點 (CVE-2006-4688) 及 Client Service for the NetWare 驅動程式 DoS 弱點 (CVE-2006-4689)。
