...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">MMC 重新導向跨網站指令碼處理弱點 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3643">CVE-2006-3643</a></td>
...
-   成功利用此弱點的攻擊者可以取得與本機使用者相同的使用者權限。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
    ...
    -   套用 Microsoft 安全性公告 [MS03-040](https://go.microsoft.com/fwlink?linkid=19873)，或套用更新的 Internet Explorer 積存安全性更新程式。  
...
-   **停用「我的電腦」區域中的動態指令碼處理**
    ...
    若您想進一步瞭解這項因應措施所修改的值，請參閱下列[網站](https://support.microsoft.com/kb/182569/zh-tw)。 有兩種方式可部署這項因應措施：  
...
Microsoft Management Console 是 Windows 環境專用的整合式管理使用者介面與管理模型。 請參閱 [Microsoft Management Console 網站](https://msdn.microsoft.com/library/default.asp?url=/library/en-us/mmc/mmc/microsoft_management_console_start_page.asp)。
...
-   感謝 [ITsec Security Services](https://www.itsec-ss.nl/) 的 Yorick Koster 回報 MMC 重新導向跨網站指令碼處理弱點 – (CVE-2006-3643)。
-   感謝 [H D Moore](https://www.microsoft.com/technet/security/bulletin/www.metasploit.com) 回報 MMC 重新導向跨網站指令碼處理弱點 – (CVE-2006-3643)。
-   感謝 [Tom Gilder](https://tom.me.uk/) 回報 MMC 重新導向跨網站指令碼處理弱點 – (CVE-2006-3643)。
