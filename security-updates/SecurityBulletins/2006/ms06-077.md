...
**警告：**[Microsoft 知識庫文件編號 926121](https://support.microsoft.com/kb/926121) 詳細記錄了目前已知安裝此安全性更新可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。 如需更多資訊，請參閱 [Microsoft 知識庫文件編號 926121](https://support.microsoft.com/kb/926121)。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">RIS 可寫入路徑弱點 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-5584">CVE-2006-5584</a></td>
...
-   **在防火牆封鎖通訊埠 69 (UDP)。**
    ...
    本通訊埠用來起始與受影響元件的連線。 在防火牆封鎖 UDP 連接埠 69 有助於保護防火牆後方的系統免遭此弱點的攻擊。 建議您封鎖所有網際網路中來路不明的輸入通訊，以防他人利用其他連接埠攻擊系統。 如需更多關於連接埠的資訊，請造訪這個[網站](https://go.microsoft.com/fwlink/?linkid=21312)。
