...
**警告：** [Microsoft 知識庫文件編號 912442](http://support.microsoft.com/kb/912442) 詳細記錄了目前已知安裝此安全性更新可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。 如需更多資訊，請參閱 [Microsoft 知識庫文件編號 912442](http://support.microsoft.com/kb/912442)。
...
如需更多關於 2004 年 8 月發行之 Exchange 2000 Server Post-Service Pack 3 更新彙總套件的相關資訊，請參閱 [Microsoft 知識庫文件編號 870540](http://support.microsoft.com/kb/870540)。
...
|-----------------------------------------------------------------------------------------------------------------------------------------------|----------------|--------------------------------|--------------------------------------------------------------------------------------|
| Microsoft Exchange Server 執行 Outlook Web Access 時之弱點 - [CVE-2006-1193](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1193) | 遠端執行程式碼 | 重要                           | 重要                                                                                 |
...
[Microsoft 知識庫文件編號 912442](http://support.microsoft.com/kb/912442) 詳細紀錄了目前已知在 Exchange Server 2003 Service Pack 1 及 Exchange Server 2003 Service Pack 2 上安裝此安全性更新後可能發生的問題。該文件並提供這些問題的建議解決方案。 如需更多資訊，請參閱 [Microsoft 知識庫文件編號 912442](http://support.microsoft.com/kb/912442)。

-   [Microsoft 知識庫文件編號 912918](http://support.microsoft.com/kb/912918)：使用者無法透過行動裝置或 Exchange 2000 Server 和 Exchange Server 2003 中的共用信箱來傳送電子郵件。

**此更新程式是否包含功能上的任何安全性相關變更？**  
是。 除了本公告＜弱點詳細資訊＞一節中列出的變更外，這個更新還包含下列安全性功能上的變更：

早於上述 Exchange 2003 版本的版本，授予完整信箱存取權限，即隱含授予以信箱所有人傳送郵件的權限。 也就是說，其他擁有完整信箱存取權限的帳戶所傳送的郵件，會以信箱所有人的身分傳送出去。 在 Exchange Server 2003 Service Pack 1 或 Exchange Server 2003 Service Pack 2 上套用安全性更新後，使用者若要模擬信箱擁有人，您必須授予使用者寄信的權限。 如需更多資訊，請參閱 [Microsoft 知識庫文件編號 912918](http://support.microsoft.com/kb/912918)。
...
此安全性更新需要使用 Exchange Server 2003 [Service Pack 2](http://www.microsoft.com/technet/prodtechnol/exchange/downloads/2003/sp2/download.mspx)。
...
此安全性更新需要使用 Exchange Server 2003 [Service Pack 1](http://www.microsoft.com/technet/prodtechnol/exchange/downloads/2003/sp1.mspx)。
...
此安全性更新程式需要 Exchange 2000 Server [Service Pack 3](http://www.microsoft.com/exchange/downloads/2000/sp3/default.asp) 與 Exchange 2000 Server Post-Service Pack 3 (SP3) 更新彙總套件。 如需更多資訊，請參閱 [Microsoft 知識庫文件編號 870540](http://support.microsoft.com/kb/870540)。若要下載必要的更新程式，請造訪此[網站](https://www.microsoft.com/download/details.aspx?familyid=363a57a4-8bed-4bbb-bbe4-abc11ab04611)。
...
-   感謝 [SEC Consult](http://www.sec-consult.com/) 的 Daniel Fabian 回報 Microsoft Exchange Server 執行 Outlook Web Access 時的弱點 - [CVE-2006-1193](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1193)
