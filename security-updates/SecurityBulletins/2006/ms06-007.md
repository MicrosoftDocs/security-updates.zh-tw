...
-   Microsoft Windows XP Service Pack 1 和 Microsoft Windows XP Service Pack 2 – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=7bb21d74-c37b-472b-bb10-71d4680680a7) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=7bb21d74-c37b-472b-bb10-71d4680680a7)
-   Microsoft Windows XP Professional x64 Edition – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=8e2538cc-cc90-4db7-8d0b-0b8ba4234e67)
-   Microsoft Windows Server 2003 和 Microsoft Windows Server 2003 Service Pack 1 – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=78d7df14-6049-4318-89ca-9c8681ced8ab) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=78d7df14-6049-4318-89ca-9c8681ced8ab)
-   Microsoft Windows Server 2003 for Itanium-based Systems 及具備 SP1 的 Microsoft Windows Server 2003 for Itanium-based Systems – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=9ae276cf-ab46-4198-bcb3-3effdf15550e)
-   Microsoft Windows Server 2003 x64 Edition – [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=12aae69e-c5c3-4e4a-9970-f5db84dd9744)
...
|-----------------------------------------------------------------------------------------------------|------------|---------------------------|---------------------------|---------------------|------------------------------------|
| IGMP v3 DoS 弱點 - [CAN-2006-0021](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2006-0021) | 拒絕服務   | 重要                      | 重要                      | 重要                | 重要                               |
...
存在[拒絕服務](https://go.microsoft.com/fwlink/?linkid=21142x)弱點，可能會允許攻擊者傳送蓄意製作的 IGMP 封包給受影響的系統。 攻擊者可能會導致受影響的系統停止回應。
...
-   感謝 [Datacom](https://www.datacom-telematica.com.br/) 的 Douglas Nascimento 報告 IGMP v3 DoS 弱點 (CAN-2006-0021)。
