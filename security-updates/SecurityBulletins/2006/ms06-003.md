...
-   必須安裝 Office 2003 Service Pack 2。 安裝此更新之前，請先安裝 [Office 2003 SP2](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=57e27a97-2db6-4654-9db6-ec7d5b4dd867)。如需有關如何安裝 Office 2003 Service Pack 2 的其他資訊，請參閱 [Microsoft 知識庫文件編號 887616](https://support.microsoft.com/kb/887616/)。
-   如需有關如何判斷電腦中安裝的 Office 2003 版本的更多資訊，請參閱 [Microsoft 知識庫文件編號 821549](https://support.microsoft.com/kb/821549)。如需更多 \[關於\] 對話方塊中所顯示版本資訊有關的資訊，請參閱 [Microsoft 知識庫文件編號 328294](https://support.microsoft.com/kb/328294)。

**移除資訊**

\[控制台\] 的 \[新增或移除程式\] 中未提供可用來移除此 Service Pack 的選項。 若要移除 Office 2003 Service Pack 2 for Language Interface Pack，您必須先移除 Office 2003，然後必須由原始 Office 2003 CD 重新安裝 Office 2003。 如需更多資訊，請按一下下列文件編號，檢視 [Microsoft 知識庫文件編號 873125](https://support.microsoft.com/kb/873125/) 內的文件
...
**安裝資訊：**
若要下載 [Office 2003 Service Pack 2 for Language Interface Pack](https://www.microsoft.com/download/details.aspx?familyid=db080de8-8193-4c32-9019-9980ecd6874a)，請選擇您的語言，然後依照＜安裝指示＞中的指示執行。

**注意：**  此下載不提供英文版本。
請參閱 Microsoft 知識庫文件 [(編號 887617)： Office 2003 Service Pack 2 for Language Interface Pack 的描述](https://support.microsoft.com/kb/887617)，以取得有關此更新的更多資訊。

#### Exchange Server 5.0 Service Pack 2

**必要條件**

此安全性更新需要使用 Server 5.0 [Service Pack 2](https://support.microsoft.com/default.aspx?kbid=168858)。

**安裝資訊：**

如需其他有關套用此更新程式時可使用的命令選項資訊，請參閱 [Microsoft 知識庫文件編號 257946](https://support.microsoft.com/default.aspx?kbid=257946)：
...
此安全性更新需要使用 Exchange Server 5.5 [Service Pack 4](https://www.microsoft.com/exchange/downloads/55/sp4.asp)。
...
-   感謝 [NGS Software](https://www.ngssoftware.com/index.htm) 的 John Heasman 與 Mark Litchfield 回報 TNEF 解碼弱點 - CVE-2006-0002
