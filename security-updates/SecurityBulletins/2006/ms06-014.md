...
-   感謝 Finjan 的 [Malicious Code Research Center (MCRC)](https://www.finjan.com/) 的 Golan Yosef，與 Microsoft 合作調查 Microsoft Windows MDAC 弱點 - [CVE-2006-0003](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0003)。
-   感謝 [Yarix](https://www.yarix.com/) 的 Stefano Meller 和 Mirko Gatto，與 Microsoft 合作調查 Microsoft Windows MDAC 弱點 - [CVE-2006-0003](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0003)。
