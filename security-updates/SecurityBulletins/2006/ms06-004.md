...
Windows Millennium Edition 中的 Internet Explorer 5.5 Service Pack 2 生命週期已結束。 使用此 Internet Explorer 版本的客戶應優先考慮移轉至 [Internet Explorer 6 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=1e1550cb-5e5d-48f5-b02b-20b602228de6&displaylang=zh-tw) 以避免受到潛在弱點的影響。 如需瞭解 Windows 產品生命週期的相關資訊，請造訪下列 [Microsoft 產品技術支援週期網站](http://support.microsoft.com/gp/lifean1)。 如需瞭解 Windows Millennium Edition 中的 Internet Explorer 5.5 Service Pack 2 的特定支援日期，請造訪下列 [Microsoft 產品技術支援週期網站](http://support.microsoft.com/gp/lifesupsps)。
