...
-   安裝了 [Windows 2000 AOL 影像支援更新](https://www.microsoft.com/windows2000/downloads/recommended/aolfix/default.asp)的 Windows 2000：
...
|-----------------------------------------------------------------------------------------------------|----------------|-----------------------|--------------|-----------------------------------------------------|---------------------------|---------------------------|---------------------|------------------------------------|
| ART 影像轉譯弱點 - [CVE-2006-2378](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2378) | 遠端執行程式碼 | 重大                  | 無           | 重大                                                | 重大                      | 重大                      | 重大                | 重大                               |
...
在套用 [Microsoft 安全性公告 MS06-021： Internet Explorer 的積存安全性更新 (916281)](https://go.microsoft.com/fwlink/?linkid=66973) 內所附的安全性更新之後，Internet Explorer 將不再轉譯 ART 影像檔案格式。 這項變更有助於防止 Internet Explorer 程序在使用者檢視無效格式的影響時意外關閉。 現在 Internet Explorer 已不再支援 ART 格式。 我們建議除了 MS06-021 外，同時套用此更新，因為此更新可徹底解決弱點。
...
-   Windows 2000 預設不支援 AOL ART 影像。 如果已安裝了 [Windows 2000 AOL 影像支援更新](https://www.microsoft.com/windows2000/downloads/recommended/aolfix/default.asp)，Windows 2000 才會受影響。 若未安裝該 AOL 影像支援更新，Windows 2000 系統上就不會存在此安全性更新所更新的檔案。
...
安裝 [Microsoft 安全性公告 MS06-021： Internet Explorer 積存安全性更新 (916281)](https://go.microsoft.com/fwlink/?linkid=66973) 之後，Internet Explorer 中將不再顯示 ART 檔案。
...
**注意：**安裝 [Microsoft 安全性公告 MS06-021： Internet Explorer 積存安全性更新 (916281)](https://go.microsoft.com/fwlink/?linkid=66973) 之後，Internet Explorer 中將不再顯示 ART 檔案。 我們建議同時安裝兩項更新。
...
Windows 2000 預設不支援 AOL ART 影像。 如果已安裝了 [Windows 2000 AOL 影像支援更新](https://www.microsoft.com/windows2000/downloads/recommended/aolfix/default.asp)，Windows 2000 才會受影響。
...
-   感謝 [iDEFENSE](https://www.idefense.com/) 回報 ART 影像轉譯弱點 (CVE-2006-2378)。
