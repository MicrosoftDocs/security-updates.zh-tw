---
TOCTitle: 'MS06-062'
Title: 'Microsoft Security Bulletin MS06-062 - 重大'
ms:assetid: 'ms06-062'
ms:contentKeyID: 61237809
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms06-062(v=Security.10)'
---

Microsoft Security Bulletin MS06-062 - 重大
===========================================
...
-   Microsoft Office 2000 Service Pack 3 - [英文下載更新程式 (KB923274)](https://www.microsoft.com/download/details.aspx?familyid=e0c7e1e4-7859-4c7e-898e-1cf05014885b) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=e0c7e1e4-7859-4c7e-898e-1cf05014885b)
    ...
    -   Microsoft Word 2000
-   Microsoft Office XP Service Pack 3 - [英文下載更新程式 (KB923273)](https://www.microsoft.com/download/details.aspx?familyid=958ee063-d88d-4e45-8555-4d1c4730f5c8) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=958ee063-d88d-4e45-8555-4d1c4730f5c8)
    ...
    -   Microsoft Word 2002
-   Microsoft Office 2003 Service Pack 1 或 Service Pack 2 - [英文下載更新程式 (KB923272)](https://www.microsoft.com/download/details.aspx?familyid=0d399f68-ec0d-4768-9846-b16b3dadf247) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=0d399f68-ec0d-4768-9846-b16b3dadf247)
...
-   Microsoft Project 2000 Service Release 1 - [英文下載更新程式 (KB923274)](https://www.microsoft.com/download/details.aspx?familyid=266a9870-cd03-45ca-877b-b5ad2c873fe5) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=266a9870-cd03-45ca-877b-b5ad2c873fe5)
-   Microsoft Project 2002 Service Pack 1 - [英文下載更新程式 (KB923273)](https://www.microsoft.com/download/details.aspx?familyid=a77dea18-d237-4bb0-9464-ce31b6ae52d6) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=a77dea18-d237-4bb0-9464-ce31b6ae52d6)
-   Microsoft Visio 2002 Service Pack 2 - [英文下載更新程式 (KB923273)](https://www.microsoft.com/download/details.aspx?familyid=fd4b7660-0fc5-43e5-9683-b6dae96136bb) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=fd4b7660-0fc5-43e5-9683-b6dae96136bb)
-   Microsoft Office 2004 for Mac - [下載更新程式 (KB924999)](https://www.microsoft.com/taiwan/mac/)
-   Microsoft Office v. X for Mac - [下載更新程式 (KB924998)](https://www.microsoft.com/taiwan/mac/)
...
| 弱點識別碼                                                                                                             | 弱點的影響     | Microsoft Office 2000 | Microsoft Office XP | Microsoft Office 2003 | Microsoft Office 2004 for Mac 或 Microsoft Office v. X for Mac |
|------------------------------------------------------------------------------------------------------------------------|----------------|-----------------------|---------------------|-----------------------|----------------------------------------------------------------|
| Office 不當記憶體存取弱點 - [CVE-2006-3434](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3434)           | 遠端執行程式碼 | 重大                  | 重要                | 重要                  | 重要                                                           |
| Office 格式錯誤的圖表紀錄弱點 - [CVE-2006-3650](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3650)       | 遠端執行程式碼 | 重大                  | 重要                | 重要                  | 重要                                                           |
| Office 格式錯誤的記錄記憶體損毀弱點 - [CVE-2006-3864](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3864) | 遠端執行程式碼 | 重大                  | 重要                | 重要                  | 重要                                                           |
| Microsoft Office 智慧標籤剖析弱點 - [CVE-2006-3868](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3868)   | 遠端執行程式碼 | 無                    | 重要                | 重要                  | 無                                                             |
...
| 公告編號                                                                | Microsoft Office 2000 | Microsoft Office XP、Project 2002 Service Pack 1 或 Visio 2002 Service Pack 2 | Microsoft Office 2003 | Microsoft Office 2004 for Mac 或 Microsoft Office v. X for Mac |
|-------------------------------------------------------------------------|-----------------------|-------------------------------------------------------------------------------|-----------------------|----------------------------------------------------------------|
| [**MS06-048**](https://technet.microsoft.com/security/bulletin/ms06-048) | 取代                  | 取代                                                                          | 取代                  | 取代                                                           |
...
| Project 2000 Service Pack 2   | 有         | 有       |
| Project 2002 Service Pack 1   | 有         | 有       |
| Visio 2002 Service Pack 2     | 有         | 有       |
...
<span></span>
#### Office 不當記憶體存取弱點 - CVE-2006-3434：

Office 中存在遠端執行程式碼的弱點。 當 Office 剖析含有格式錯誤字串的檔案時，攻擊者就可以利用這項弱點。
...
#### Office 不當記憶體存取弱點 - CVE-2006-3434 的緩和因素：
...
**造成這個弱點的原因為何？**  
處理檔案內容時，Office 未執行適當的資料驗證。 當 Office 開啟蓄意製作的檔案並剖析錯誤格式的字串時，系統記憶體可能會遭到損壞，使攻擊者有機會執行任意程式碼。
...
**我以為 Word 是隨附於 Microsoft Works Suites，但是我發現 Microsoft Works Suites 是列在「不受影響的軟體」部分。 為什麼？**  
Microsoft Works Suites 並不包含完整版 Word，因此不受這些弱點的影響。

**更新的作用何在？**  
本更新程式在 Office 剖析檔案並將字串傳遞至分配的緩衝區之前，會修改驗證字串長度的方式，因此消除此項弱點。
...
#### Office 格式錯誤的圖表紀錄弱點 - CVE-2006-3650：

Office 中存在遠端執行程式碼的弱點。 當 Office 剖析含有格式錯誤的圖表紀錄的檔案時，攻擊者就可以利用這項弱點。

如果使用者以系統管理的使用者權限登入，成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

#### Office 格式錯誤的圖表紀錄弱點 - CVE-2006-3650 的緩和因素：
...
#### Office 格式錯誤的圖表紀錄弱點 - CVE-2006-3650 的因應措施：

-   對於來自於不受信任的來源或在非預期情況下從信任來源收到的 Microsoft Office 檔案，請勿輕易開啟或儲存。 當使用者開啟蓄意製作的檔案時，即可能遭受利用此弱點的攻擊。

#### Office 格式錯誤的圖表紀錄弱點 - CVE-2006-3650 的常見問題集：
...
**造成這個弱點的原因為何？**  
處理檔案內容時，Office 未執行適當的資料驗證。 當 Office 開啟蓄意製作的檔案並剖析錯誤格式的圖表紀錄時，系統記憶體可能會遭到損壞，使攻擊者有機會執行任意程式碼。
...
#### Office 格式錯誤的記錄記憶體損毀弱點 - CVE-2006-3864：

Office 中存在遠端執行程式碼的弱點。 當 Office 剖析含有格式錯誤的記錄的檔案時，攻擊者就可以利用這項弱點。

如果使用者以系統管理的使用者權限登入，成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

#### Office 格式錯誤的記錄記憶體損毀弱點 - CVE-2006-3864 的緩和因素：
...
#### Office 格式錯誤的記錄記憶體損毀弱點 - CVE-2006-3864 的因應措施：

-   對於來自於不受信任的來源或在非預期情況下從信任來源收到的 Microsoft Office 檔案，請勿輕易開啟或儲存。 當使用者開啟蓄意製作的檔案時，即可能遭受利用此弱點的攻擊。

#### Office 格式錯誤的記錄記憶體損毀弱點 - CVE-2006-3864 的常見問題集：
...
#### Microsoft Office 智慧標籤剖析弱點 - CVE-2006-3868：

Microsoft Office 中存在遠端執行程式碼的弱點，並在當 Office 開啟蓄意製作的檔案並剖析錯誤格式的智慧標籤時，便會導致此弱點。 這類蓄意製作的檔案可能包含在電子郵件附件中，或者也可能存放在惡意網站上。 在 Outlook 上檢視或預覽格式錯誤的電子郵件訊息，並不會導致此弱點遭到利用。 攻擊者可能會蓄意製作 Office 檔案來允許遠端執行程式碼，以利用此弱點。

如果使用者以系統管理的使用者權限登入，成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

#### Microsoft Office 智慧標籤剖析弱點 - CVE-2006-3868 的緩和因素：

-   成功利用此弱點的攻擊者可以取得與本機使用者相同的使用者權限。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
-   在網頁攻擊的案例中，攻擊者必須架設網站，其中包含嘗試利用此弱點的 Office 檔案。 此外，受侵害的網站以及接受或存放使用者提供之內容的網站裡，也可能包含蓄意製作以利用本弱點的內容。攻擊者並不能強迫使用者造訪惡意的網站， 而是引誘他們自行前往。一般的做法是設法讓使用者按一下通往攻擊者網站的連結。
-   無法透過電子郵件自動攻擊此弱點。 使用者必須順利開啟電子郵件訊息中傳送的附件，攻擊才可進行。

#### Microsoft Office 智慧標籤剖析弱點 - CVE-2006-3868 的因應措施：

-   對於來自於不受信任的來源或在非預期情況下從信任來源收到的 Microsoft Office 檔案，請勿輕易開啟或儲存。 當使用者開啟蓄意製作的檔案時，即可能遭受利用此弱點的攻擊。

#### Microsoft Office 智慧標籤剖析弱點 - CVE-2006-3868 的常見問題集：
...
**造成這個弱點的原因為何？**  
當 Microsoft Office 開啟蓄意製作的 Office 檔案並剖析錯誤格式的智慧標籤時，系統記憶體可能會遭到損壞，使攻擊者有機會執行任意程式碼。
...
**更新的作用何在？**  
更新程式會在傳遞訊息至分配的緩衝區之前，修改 Microsoft Office 剖析智慧標籤長度的方法，進而移除此項弱點。

**當安全性公告發行時，這項弱點是否已揭發出來？**  
是。 這項弱點已經遭到公開揭發。 這項弱點已被指派一般性弱點編號 CVE-2006-3868。
...
1.  [下載 Office 2000 的安全性更新](https://download.microsoft.com/download/5/a/a/5aa36269-5b5a-4597-b91d-a0e213f656e3/office2000-kb923274-fullfile-enu.exe)及/或 [Project 2000 Service Pack 1](https://download.microsoft.com/download/0/0/f/00f68131-54bc-4e69-bfb7-fd66170cc33d/project2000-kb923274-fullfile-enu.exe)。
...
| 檔案名稱 | 版本       | 日期               | 時間  | 大小      |
|----------|------------|--------------------|-------|-----------|
| Mso9.dll | 9.0.0.8950 | 2006 年 9 月 06 日 | 05:58 | 5,595,185 |
...
1.  [下載 Office XP 的安全性更新](https://download.microsoft.com/download/4/8/4/4842fc39-5d06-4eeb-8293-ac84074106ac/officexp-kb923273-fullfile-enu.exe)及/或 [Project 2002 Service Pack 1](https://download.microsoft.com/download/0/6/7/067865cf-7805-4933-bc3c-f9ed874e008e/officexp-kb923273-fullfile-enu.exe) 和/或 [Visio Service Pack 2](https://download.microsoft.com/download/e/3/0/e30ee874-8089-4bb9-bb44-a655e5e1017f/visio2002-kb923273-fullfile-enu.exe)。
2.  按一下 \[將程式存到磁碟\]，然後按一下 \[確定\]。
3.  按一下 \[儲存\]。
4.  在 Windows 檔案總管中，尋找包含已儲存檔案的資料夾，然後按兩下儲存的檔案。
5.  如果系統提示您安裝更新程式，請按一下 \[是\]。
...
1.  [下載 Office 2003 的安全性更新。](https://download.microsoft.com/download/0/a/c/0ac9daa9-5d89-4613-a28e-de1e0c39c22d/office2003-kb923272-fullfile-enu.exe)
2.  按一下 \[將程式存到磁碟\]，然後按一下 \[確定\]。
3.  按一下 \[儲存\]。
4.  在 Windows 檔案總管中，尋找包含已儲存檔案的資料夾，然後按兩下儲存的檔案。
5.  如果系統提示您安裝更新程式，請按一下 \[是\]。
...
-   感謝 [Fortinet Inc](https://www.fortinet.com/). 的 Dejun Meng 回報 Office 不當記憶體存取弱點 - [CVE-2006-3434](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3434)
-   感謝 Arnaud Dovi 與 [TippingPoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，回報 Office 格式錯誤的圖表紀錄弱點 - [CVE-2006-3650](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3650)
-   感謝 [Nevis Labs](https://www.nevisnetworks.com/) 的 Sowhat Office 回報 Office 格式錯誤的記錄記憶體損毀弱點 - [CVE-2006-3864](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3864)
...
-   V1.1 (2006 年 11 月 10 日)： 已更新公告，詳細說明＜與本安全性更新相關的常見問題集 (FAQ)＞部分中的＜我在更新管理安裝點時，發現有二個 .msp 檔。 這是為什麼呢？＞和＜管理安裝點列出 mso.msp 和 pvmso.msp。我需要同時安裝這兩個套件嗎？＞。
