---
TOCTitle: 'MS06-039'
Title: 'Microsoft Security Bulletin MS06-039 - 重大'
ms:assetid: 'ms06-039'
ms:contentKeyID: 61237786
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms06-039(v=Security.10)'
---

Microsoft Security Bulletin MS06-039 - 重大
===========================================

Microsoft Office 篩選器的弱點可能會允許遠端執行程式碼 (915384)
--------------------------------------------------------------
...
-   Microsoft Office 2003 Service Pack 1 或 Service Pack 2 - [英文下載更新程式 (KB914455)](https://www.microsoft.com/download/details.aspx?familyid=66c15cd1-a33b-4eb4-9d90-87decf053768) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=66c15cd1-a33b-4eb4-9d90-87decf053768)
    -   Microsoft Project 2003
    -   Microsoft OneNote 2003
    -   Microsoft FrontPage 2003
-   Microsoft Office XP Service Pack 3 - [英文下載更新程式 (KB914796)](https://www.microsoft.com/download/details.aspx?familyid=1506fe89-1753-40ac-bb3e-a053b3eb6260) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=1506fe89-1753-40ac-bb3e-a053b3eb6260)
-   Microsoft Office 2000 Service Pack 3 - [英文下載更新程式 (KB914797)](https://www.microsoft.com/download/details.aspx?familyid=9b0a1795-da76-4935-aa90-e6aedc0cde6b) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=9b0a1795-da76-4935-aa90-e6aedc0cde6b)
-   Microsoft Project 2002 - [英文下載更新程式 (KB920102)](https://www.microsoft.com/download/details.aspx?familyid=2194ec63-582e-4e64-b71f-99918bf14ffa) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=2194ec63-582e-4e64-b71f-99918bf14ffa)
-   Microsoft Project 2000 - [英文下載更新程式 (KB920101)](https://www.microsoft.com/download/details.aspx?familyid=42493e0c-91de-49b0-b5b7-2214d55de079) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=42493e0c-91de-49b0-b5b7-2214d55de079)
-   Microsoft Works Suites：
    -   Microsoft Works Suite 2004 - [英文下載更新程式 (KB914796) (與 Microsoft Office XP 更新相同)](https://www.microsoft.com/download/details.aspx?familyid=1506fe89-1753-40ac-bb3e-a053b3eb6260) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=1506fe89-1753-40ac-bb3e-a053b3eb6260)
    -   Microsoft Works Suite 2005 - [英文下載更新程式 (KB914796) (與 Microsoft Office XP 更新相同)](https://www.microsoft.com/download/details.aspx?familyid=1506fe89-1753-40ac-bb3e-a053b3eb6260) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=1506fe89-1753-40ac-bb3e-a053b3eb6260)
    -   Microsoft Works Suite 2006 - [英文下載更新程式 (KB914796) (與 Microsoft Office XP 更新相同)](https://www.microsoft.com/download/details.aspx?familyid=1506fe89-1753-40ac-bb3e-a053b3eb6260) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=1506fe89-1753-40ac-bb3e-a053b3eb6260)
...
| 弱點識別碼                                                                                                                                              | 弱點的影響     | Microsoft Office 2003 | Microsoft Project 2003 | Microsoft OneNote 2003 | Microsoft FrontPage 2003 | Microsoft Office XP | Microsoft Office 2000 | Microsoft Project 2002 | Microsoft Project 2000 |
|---------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|-----------------------|------------------------|------------------------|--------------------------|---------------------|-----------------------|------------------------|------------------------|
| 透過具有格式錯誤的 PNG 的 Microsoft Office 遠端執行程式碼弱點 - [CVE-2006-0033](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0033) (英文) | 遠端執行程式碼 | 重要                  | 重要                   | 重要                   | 重要                     | 重要                | 重大                  | 重要                   | 不適用                 |
| 透過具有格式錯誤的 GIF 的 Microsoft Office 遠端執行程式碼弱點 - [CVE-2006-0007](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0007) (英文) | 遠端執行程式碼 | 中度                  | 中度                   | 中度                   | 中度                     | 中度                | 中度                  | 中度                   | 中度                   |
| **所有弱點的彙總嚴重性**                                                                                                                                |                | **重要**              | **重要**               | **重要**               | **重要**                 | **重要**            | **重大**              | **重要**               | **中度**               |
...
| Microsoft Project 2002 | 有         | 有       |
| Microsoft Project 2000 | 有         | 沒有     |
...
如需有關 MBSA 的詳細資訊，請造訪 [MBSA 網站](https://go.microsoft.com/fwlink/?linkid=21134) (英文)。 如需更多關於 Microsoft Update 及 MBSA 2.0 目前無法偵測的程式之相關資訊，請參閱 [Microsoft 知識庫文件編號 895660](https://support.microsoft.com/kb/895660) (英文)。
...
SMS 2.0 可使用 SMS SUS Feature Pack 中的安全性更新盤點工具 (Security Update Inventory Tool) 來偵測安全性更新。 SMS SUIT 使用 MBSA 1.2.1 引擎進行偵測。 如需更多關於安全性更新盤點工具 (Security Update Inventory Tool) 的資訊，請造訪下列 [Microsoft 網站](https://www.microsoft.com/smserver/downloads/2003/featurepacks/suspack) (英文)。 如需更多有關安全性更新盤點工具 (Security Update Inventory Tool) 限制的資訊，請參閱 [Microsoft 知識庫文件編號 306460](https://support.microsoft.com/kb/306460)。SMS SUS Feature Pack 中也含有 Microsoft Office Inventory Tool，可用於偵測 Microsoft Office 應用程式所需的更新。

SMS 2003 可使用 Microsoft Update 專用 SMS 2003 盤點工具來偵測由 [Microsoft Update](https://update.microsoft.com/microsoftupdate) 所提供，並由 [Windows Server Update Services](https://www.microsoft.com/taiwan/windowsserversystem/updateservices/evaluation/overview.mspx) 所支援的安全性更新。 如需關於 Microsoft Update 專用 SMS 2003 盤點工具的詳細資訊，請造訪下列 [Microsoft 網站](https://go.microsoft.com/fwlink/?linkid=50757) (英文)。 SMS 2003 也可以使用 Microsoft Office Inventory Tool 來偵測 Microsoft Office 應用程式所需的更新。
...
<span></span>
#### 透過具有格式錯誤的 PNG 的 Microsoft Office 遠端執行程式碼弱點 - CVE-2006-0033

Office 中存在遠端執行程式碼的弱點，而當 Office 開啟格式錯誤的 PNG 檔時，此弱點就可能遭到利用。 攻擊者可能會蓄意製作 PNG 檔案來允許遠端執行程式碼，以利用此弱點。
...
#### 透過具有格式錯誤的 PNG 的 Microsoft Office 遠端執行程式碼弱點 - CVE-2006-0033 的緩和因素：
...
-   未安裝 Office 之作業系統所提供的預設 PNG 篩選器不受此弱點影響。

**注意：**Outlook 2000 在開啟文件前，並不會提示使用者 \[開啟\]、\[儲存\] 或 \[取消\] 等選項。

#### 透過具有格式錯誤的 PNG 的 Microsoft Office 遠端執行程式碼弱點 - CVE-2006-0033 的因應措施：

Microsoft 已經測試過以下的因應措施。 這些因應措施並不能徹底解決弱點，但是有助於封鎖已知的攻擊行為。 如果因應措施會降低功能，以下小節將會描述功能降低的情況。

**對於來自於不受信任的來源或在非預期情況下從信任來源收到的 PNG 檔案，請勿輕易開啟或儲存。**

當使用者開啟 PNG 檔案時，即可能遭受利用此弱點的攻擊。

#### 透過具有格式錯誤的 PNG 的 Office 遠端執行程式碼弱點 - CVE-2006-0033 的常見問題集：

**這個弱點的範圍為何？**  
Office 中存在遠端執行程式碼的弱點，而當使用者開啟格式錯誤的 PNG 檔時，此弱點就可能遭到利用。 攻擊者可能會蓄意製作 PNG 檔案來允許遠端執行程式碼，以利用此弱點。

如果使用者以系統管理的使用者權限登入，成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

**造成這個弱點的原因為何？**  
當 Office PNG 篩選器檔案開啟格式錯誤的 PNG 檔案時，系統記憶體可能會遭到損壞，使攻擊者有機會執行任意程式碼。

**攻擊者可能會利用這項弱點採取什麼行動？**  
成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。

**攻擊者如何利用這項弱點？**  
在網頁式攻擊的案例中，攻擊者可架設一個網站，並在其中包含利用此弱點的 PNG 檔案。 此外，受侵害的網站以及接受或存放使用者提供之內容或廣告的網站裡，也可能包含蓄意製作以利用本弱點的內容。 但是，攻擊者無法強迫使用者造訪網站， 而是引誘使用者自行前往。一般的做法是設法讓使用者按一下電子郵件或 Instant Messenger 訊息中通往攻擊者網站的連結。
...
**更新的作用何在？**  
更新程式會修改 Office 將 PNG 檔案傳遞至分配的緩衝區前剖析 PNG 檔案的方法，進而移除此項弱點。
...
#### 透過具有格式錯誤的 GIF 的 Microsoft Office 遠端執行程式碼弱點 - CVE-2006-0007

Office 中存在遠端執行程式碼的弱點，而當使用者開啟格式錯誤的 GIF 檔時，此弱點就可能遭到利用。 攻擊者可能會蓄意製作 GIF 檔案來允許遠端執行程式碼，以利用此弱點。

如果使用者以系統管理的使用者權限登入，成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

#### 透過具有格式錯誤的 GIF 的 Microsoft Office 遠端執行程式碼弱點 - CVE-2006-0007 的緩和因素：

-   成功利用此弱點的攻擊者可以取得與本機使用者相同的使用者權限。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
-   無法透過電子郵件自動攻擊此弱點。 使用者必須順利開啟電子郵件訊息中傳送的附件，攻擊才可進行。
-   在 Office XP 與 Office 2003 上，無法透過網頁式攻擊的方式自動利用此弱點。 攻擊者必須架設一個網站，並在其中包含嘗試利用此弱點的 Office 檔案。 攻擊者並不能強迫使用者造訪惡意的網站， 而是引誘他們自行前往。一般的做法是設法讓使用者按一下通往攻擊者網站的連結。
-   未安裝 Office 之作業系統所提供的預設 GIF 篩選器不受此弱點影響。

**注意：**Outlook 2000 在開啟文件前，並不會提示使用者 \[開啟\]、\[儲存\] 或 \[取消\] 等選項。

#### 透過具有格式錯誤的 GIF 的 Microsoft Office 遠端執行程式碼弱點 - CVE-2006-0007 的因應措施：

Microsoft 已經測試過以下的因應措施。 這些因應措施並不能徹底解決弱點，但是有助於封鎖已知的攻擊行為。 如果因應措施會降低功能，以下小節將會描述功能降低的情況。

**對於來自於不受信任的來源或在非預期情況下從信任來源收到的 GIF 檔案，請勿輕易開啟或儲存。**

當使用者開啟 GIF 檔案時，即可能遭受利用此弱點的攻擊。

#### 透過具有格式錯誤的 GIF 的 Office 遠端執行程式碼弱點 - CVE-2006-0007 的常見問題集：
...
**造成這個弱點的原因為何？**  
當 Office 開啟蓄意製作的 GIF 檔案時，系統記憶體可能會遭到損壞，使攻擊者有機會執行任意程式碼。

**攻擊者可能會利用這項弱點採取什麼行動？**  
成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。

**攻擊者如何利用這項弱點？**  
在網頁式攻擊的案例中，攻擊者可架設一個網站，並在其中包含利用此弱點的 GIF 檔案。 此外，受侵害的網站以及接受或存放使用者提供之內容或廣告的網站裡，也可能包含蓄意製作以利用本弱點的內容。 但是，攻擊者無法強迫使用者造訪網站， 而是引誘使用者自行前往。一般的做法是設法讓使用者按一下電子郵件或 Instant Messenger 訊息中通往攻擊者網站的連結。
若是電子郵件攻擊，攻擊者可能會利用這項弱點，向使用者傳送蓄意製作的檔案，然後引誘使用者開啟該檔案。
...
1.  [下載 Office 2003 的安全性更新。](https://download.microsoft.com/download/f/b/f/fbf5215b-9b62-4706-8582-1bbc5f9d1b6d/office2003-kb914455-fullfile-enu.exe)
...
| 檔案名稱     | 版本             | 日期              | 時間  | 大小    |
|--------------|------------------|-------------------|-------|---------|
| Gifimp32.flt | 2003.1100.8020.0 | 2006 年 4 月 1 日 | 10:11 | 179,912 |
| Png32.flt    | 2003.1100.8029.0 | 2006 年 6 月 2 日 | 23:09 | 205,072 |
...
1.  [下載 Office XP 的安全性更新](https://download.microsoft.com/download/a/c/2/ac2df9e6-4da6-4c05-886f-18ef3f768528/officexp-kb914796-fullfile-enu.exe)及/或[下載 Project 2002 的安全性更新](https://download.microsoft.com/download/5/3/1/531194b4-faf9-4e5e-8313-1cfdd3d291b9/officexp-kb920102-fullfile-enu.exe)。
2.  按一下 \[將程式存到磁碟\]，然後按一下 \[確定\]。
3.  按一下 \[儲存\]。
4.  在 Windows 檔案總管中，尋找包含已儲存檔案的資料夾，然後按兩下儲存的檔案。
5.  如果系統提示您安裝更新程式，請按一下 \[是\]。
...
-   必須安裝 Office 2000 Service Pack 3 (SP3)。 安裝此更新之前，請先安裝 [Office 2000 SP3](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=5c011c70-47d0-4306-9fa4-8e92d36332fe%20_blank)。如需有關如何安裝 Office 2000 SP3 的其他資訊，請參閱 [Microsoft 知識庫文件編號 326585](https://support.microsoft.com/default.aspx?scid=kb;%5bln%5d;326585)。
...
1.  [下載 Office 2000 的安全性更新](https://download.microsoft.com/download/f/f/8/ff86ea47-28a6-4bbd-b6ac-44a8522f85ea/office2000-kb914797-fullfile-enu.exe)及/或[下載 Project 2000 的安全性更新](https://download.microsoft.com/download/f/4/e/f4e71707-7c49-4a34-8162-bb2cddfe0dbb/office2000-kb920101-fullfile-enu.exe)。
2.  按一下 \[將程式存到磁碟\]，然後按一下 \[確定\]。
3.  按一下 \[儲存\]。
4.  在 Windows 檔案總管中，尋找包含已儲存檔案的資料夾，然後按兩下儲存的檔案。
5.  如果系統提示您安裝更新程式，請按一下 \[是\]。
...
**注意：**在受管理的環境中工作的系統管理員可以在 [Office Admin Update Center](https://office.microsoft.com/en-us/fx011511561033.aspx) (英文) 上，找到用於在組織中部署 Office 更新的完整資源。 在該網站上，向下捲動並在＜更新資源＞部分下尋找您要更新的軟體版本。 [Windows Installer Documentation](https://go.microsoft.com/fwlink/?linkid=21685) (英文) 也提供有關 Windows Installer 支援參數的其他資訊。
...
-   感謝 [Fortinet Inc.](https://www.fortinet.com/) 回報透過格式錯誤的 PNG 的 Microsoft Office 遠端執行程式碼弱點 – [CVE-2006-0033](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0033)。
-   感謝 [NSFocus Security Team](https://www.nsfocus.com/english/index.htm) 回報透過格式錯誤的 GIF 的 Microsoft Office 遠端執行程式碼弱點 – [CVE-2006-0007](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-007)。
...
-   V1.1 (2006 年 7 月 12 日)： 已更新公告，詳細說明＜安全性更新部分＞中 Office 2003 部分之＜用戶端安裝檔案資訊＞和＜管理員模式安裝檔案資訊＞。
-   V1.2 (2006 年 11 月 29 日)： 已更新公告，詳細說明＜已測試軟體及安全性更新程式下載位置＞部分中的＜受影響的軟體＞。
