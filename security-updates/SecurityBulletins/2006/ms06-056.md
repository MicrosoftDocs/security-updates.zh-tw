...
**警告：** [Microsoft 知識庫文件編號 922770](https://support.microsoft.com/kb/922770) 詳細記錄了目前已知安裝此安全性更新可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。 如需更多資訊，請參閱 [Microsoft 知識庫文件編號 922770](https://support.microsoft.com/kb/922770)。
...
|-----------------------------------------------------------------------------------------------------------------------------------|------------|--------------------|
| .NET Framework 2.0 跨網站指令碼處理弱點 - [CVE-2006-3436](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3436) (英文) | 資訊洩漏   | 中度               |
...
[Microsoft 知識庫文件編號 922770](https://support.microsoft.com/kb/922770) 詳細記錄了目前已知安裝此安全性更新可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。 如需更多資訊，請參閱 [Microsoft 知識庫文件編號 922770](https://support.microsoft.com/kb/922770)。

-   [Microsoft 知識庫文件編號 923100](https://support.microsoft.com/kb/923100)：您無法安裝安全性公告 MS06-056 中所述之安全性更新，或是您可能會收到 "0x643" 錯誤碼
...
-   [Microsoft 知識庫文件編號 929110](https://support.microsoft.com/kb/929110)：在安裝 .NET Framework 2.0 (929110) 的更新之後，會從區分大小寫變成不區分大小寫的一種檔案系統。
...
是。 Microsoft 已建立新版 EST，可判斷您是否需要套用此更新。 如需本月發行的 EST 版本的下載連結與詳細資訊，請參閱 [Microsoft 知識庫文件編號 894193](https://support.microsoft.com/kb/894193)。SMS 客戶應閱讀常見問題集的「是否可以使用 Systems Management Server (SMS) 判斷是否需要此更新？」，以瞭解 SMS 和 EST 的詳細資訊。
...
-   **在執行 .NET Framework 2.0 的電腦上，不要在頁面上將控制項的 AutoPostBack 內容設為 "true"：**
    -   在執行 .NET Framework 2.0 的電腦上，AutoPostBack 是 WebForm 上的控制項內容。 依照預設，AutoPostBack 內容會設為 **false**。 如需更多資訊，請參閱[知識庫文件編號 328923](https://support.microsoft.com/?id=328923)。
...
**注意：**您可以在同一個命令中合併使用這些參數。 如需有關支援的安裝參數的其他資訊，請參閱 [Microsoft 知識庫文件編號 824687](https://support.microsoft.com/kb/824687)。如需更多關於 Windows Installer 的相關資訊，請造訪 Windows Installer MSDN 網站。
...
-   感謝 [Ernst & Young's Advanced Security Center](https://www.ey.com/security) 的 Jaswinder Hayre 回報 .NET Framework 2.0 跨網站指令碼處理弱點 - [CVE-2006-3436](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3436)。
