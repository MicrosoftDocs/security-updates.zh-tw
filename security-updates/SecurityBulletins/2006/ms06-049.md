...
**警告：** [Microsoft 知識庫文件編號 920958](https://support.microsoft.com/kb/920958) 詳細記錄了目前已知安裝此安全性更新可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。 如需更多資訊，請參閱 [Microsoft 知識庫文件編號 920958](https://support.microsoft.com/kb/920958)。

**已測試軟體及安全性更新下載位置：**

**受影響的軟體**

-   Microsoft Windows 2000 Service Pack 4 — [英文下載更新程式](https://www.microsoft.com/download/details.aspx?familyid=08806182-6a26-4663-91ea-179817350a91) │ [中文下載更新程式](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=08806182-6a26-4663-91ea-179817350a91)
...
|---------------------------------------------------------------------------------------------------------------------|------------|-----------------------------|
| Windows 2000 核心權限提高 - [CVE-2006-3444 (英文)](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3444) | 權限提高   | 重要                        |
...
Microsoft 已更新此公告及相關安全性更新，以解決 [Microsoft 知識庫文件編號 920958](https://support.microsoft.com/kb/920958) 中所述之問題。重新安裝此更新不會帶來其他的安全優點。

**安裝此安全性更新後，已知可能會發生的問題有哪些？**  
[Microsoft 知識庫文件編號 920958](https://support.microsoft.com/kb/920958) 詳細記錄了目前已知安裝此安全性更新可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。 如需更多資訊，請參閱 [Microsoft 知識庫文件編號 920958](https://support.microsoft.com/kb/920958)。

-   [Microsoft 知識庫文件編號 925308](https://support.microsoft.com/kb/925308/)： 當您建立或更新檔案時，大於 4 KB 的壓縮檔可能會損毀。
...
Windows 2000 對系統輸入的不當驗證，導致[權限提高](https://go.microsoft.com/fwlink/?linkid=21142)弱點。 這項弱點可能讓已登入系統的使用者取得完整控制權。
...
-   V2.0 (2006 年 9 月 26 日)： 此更新已針對 Microsoft Windows 2000 Service Pack 4 修訂並重新發行，以解決 [Microsoft 知識庫文件編號 920958](https://support.microsoft.com/kb/920958) 中所述之問題。
