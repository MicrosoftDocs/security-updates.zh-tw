...
|--------------------------------------------------------------------------------------------------------------------|------------|-----------------------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Microsoft Indexing Service 弱點 - [CVE-2006-0032](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0032) | 資訊洩漏   | 中度                        | 中度                      | 中度                      | 輕微                | 輕微                               |
...
|-------------------------------------------------------------------------|-----------------------------|---------------------------|---------------------------|---------------------|------------------------------------|
| [**MS05-003**](https://technet.microsoft.com/security/bulletin/ms05-003) | 未取代                      | 取代                      | 取代                      | 取代                | 不適用                             |
...
-   **在執行 IIS 5.0 的 Windows 2000 上執行 URLScan**
    安裝 [URLScan](https://www.microsoft.com/technet/security/tools/urlscan.mspx) 有助於保護受影響的系統，避免遭受嘗試利用此弱點的攻擊。
...
-   感謝 Eiji James Yoshida 回報 Microsoft Indexing Service 弱點 - [CVE-2006-0032](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0032)。
