...
本資訊安全更新也能解決 [Microsoft 資訊安全摘要報告 2847140](http://technet.microsoft.com/security/advisory/2847140) 中首先提出的資訊安全風險。
...
已實作 [Microsoft 資訊安全摘要報告 2847140](http://technet.microsoft.com/security/advisory/2847140) 中 **Microsoft Fix it 解決方案**「CVE-2013-1347 MSHTML Shim 因應措施」的客戶，在套用此更新前，不需要復原 **Microsoft Fix it 解決方案**。
...
若要以一般性資訊安全風險清單中的標準項目來檢視此資訊安全風險，請參閱 [CVE-2013-1347](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1347) (英文)。
...
-   **套用 Microsoft Fix it 解決方案「CVE-2013-1347 MSHTML Shim 因應措施」可防止此問題遭到利用。**
    ...
    請參閱 [Microsoft 知識庫文件編號 2847204](http://support.microsoft.com/kb/2847204?ln=zh-tw)，以使用自動化 **Microsoft Fix It** 解決方案來啟用或停用此因應措施。
...
是。此資訊安全風險已經遭到公開揭發。這項資訊安全風險已被指派「一般性資訊安全風險」編號 [CVE-2013-1347](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1347)。此資訊安全風險最初是在 [Microsoft 資訊安全摘要報告 2847140](http://technet.microsoft.com/security/advisory/2847140) 中提出。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2847204?ln=zh-tw">Microsoft 知識庫文件編號 2847204</a></td>
</tr>
<tr class="even">
