...
**已知問題。** [Microsoft 知識庫文件編號 2792100](https://support.microsoft.com/kb/2792100?ln=zh-tw) 中記載目前已知客戶在安裝此資訊安全更新時可能會發生的問題。該文件並說明了解決這些問題的建議解決方案。
...
<td style="border:1px solid black;">
[MS12-077](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-077) 中的 KB2761465 和 [MS13-008](https://technet.microsoft.com/zh-tw/security/bulletin/ms13-008) 中的 KB2799329
</td>
</tr>
...
<td style="border:1px solid black;">
[MS12-077 中的 KB2761465](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-077)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<sup>[1]</sup>更新僅透過 [Windows Update](https://update.microsoft.com/windowsupdate/v6/default.aspx) 提供。
...
下列嚴重性等級是假設資訊安全風險可能造成的最嚴重影響而評定。在本資訊安全公告發行的 30 天內，如需資訊安全風險之易遭利用性與嚴重性等級和資訊安全影響之間對應關係的資訊，請參閱 [2 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms13-feb)中的＜資訊安全風險入侵指數＞。如需更多資訊，請參閱 [Microsoft 資訊安全風險入侵指數](https://technet.microsoft.com/zh-tw/security/cc998259.aspx)。
...
若要以一般性資訊安全風險清單中的標準項目來檢視此資訊安全風險，請參閱 [CVE-2013-0015](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0015) (英文)。
...
-   依照預設，Windows Server 2003、Windows Server 2008、Windows Server 2008 R2 和 Windows Server 2012 上的 Internet Explorer 會以稱為[增強式資訊安全設定](https://technet.microsoft.com/library/dd883248)的受限制模式執行。此模式可緩和此資訊安全風險。如需更多資訊，請參閱此資訊安全風險＜常見問題集＞關於 Internet Explorer 增強式資訊安全設定的部份。
...
| 資訊安全風險標題                                        | CVE 編號                                                                         |
|---------------------------------------------------------|----------------------------------------------------------------------------------|
| Internet Explorer SetCapture 釋放後使用資訊安全風險     | [CVE-2013-0018](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0018) |
| Internet Explorer COmWindowProxy 釋放後使用資訊安全風險 | [CVE-2013-0019](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0019) |
| Internet Explorer CMarkup 釋放後使用資訊安全風險        | [CVE-2013-0020](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0020) |
| Internet Explorer vtable 釋放後使用資訊安全風險         | [CVE-2013-0021](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0021) |
| Internet Explorer LsGetTrailInfo 釋放後使用資訊安全風險 | [CVE-2013-0022](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0022) |
| Internet Explorer CDispNode 釋放後使用資訊安全風險      | [CVE-2013-0023](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0023) |
| Internet Explorer pasteHTML 釋放後使用資訊安全風險      | [CVE-2013-0024](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0024) |
| Internet Explorer SLayoutRun 釋放後使用資訊安全風險     | [CVE-2013-0025](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0025) |
| Internet Explorer InsertElement 釋放後使用資訊安全風險  | [CVE-2013-0026](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0026) |
| Internet Explorer CPasteCommand 釋放後使用資訊安全風險  | [CVE-2013-0027](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0027) |
| Internet Explorer CObjectElement 釋放後使用資訊安全風險 | [CVE-2013-0028](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0028) |
| Internet Explorer CHTML 釋放後使用資訊安全風險          | [CVE-2013-0029](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0029) |
...
-   依照預設，所有受支援版本的 Microsoft Outlook、Microsoft Outlook Express 及 Windows Mail 都會開啟 \[限制的網站\] 區域的 HTML 電子郵件訊息。\[限制的網站\] 區域會停用指令碼與 ActiveX 控制項，進而協助降低攻擊者能夠利用這些資訊安全風險執行惡意程式碼的風險。如果使用者按下電子郵件訊息中的連結，仍有可能因為網頁式攻擊而受此資訊安全風險遭利用的影響。
-   依照預設，Windows Server 2003、Windows Server 2008、Windows Server 2008 R2 和 Windows Server 2012 上的 Internet Explorer 會以稱為[增強式資訊安全設定](https://technet.microsoft.com/library/dd883248)的受限制模式執行。此模式能減輕這些資訊安全風險的影響。如需更多資訊，請參閱此資訊安全風險＜常見問題集＞關於 Internet Explorer 增強式資訊安全設定的部份。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2792100?ln=zh-tw">Microsoft 知識庫文件編號 2792100</a></td>
</tr>
<tr class="even">
...
| **部署**                                       |                                                                                                                                                                               |  
|                                                | 此更新僅可以從 [Windows Update](https://update.microsoft.com/windowsupdate/v6/default.aspx) 取得。                                                                             |  
| **重新開機需求**                               |                                                                                                                                                                               |  
...
| **檔案資訊**                                   | 請參閱 [Microsoft 知識庫文件編號 2792100](https://support.microsoft.com/kb/2792100?ln=zh-tw)                                                                                   |
...
-   感謝 [Omair](https://krash.in/) 與 [HP](https://www.hpenterprisesecurity.com/products) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，回報 Internet Explorer SetCapture 釋放後使用資訊安全風險 (CVE-2013-0018)  
-   感謝 Skylined 與 [HP 的](https://www.hpenterprisesecurity.com/products)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作回報 Internet Explorer COmWindowProxy 釋放後使用資訊安全風險 (CVE-2013-0019)  
-   感謝 Arthur Gerkis 與 Exodus Intelligence 合作回報 Internet Explorer CMarkup 釋放後使用資訊安全風險 (CVE-2013-0020)  
-   感謝 [Harmony Security](https://www.harmonysecurity.com/) 的 Stephen Fewer 和 [HP](https://www.hpenterprisesecurity.com/products) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，回報 Internet Explorer CMarkup 釋放後使用資訊安全風險 (CVE-2013-0020)  
-   感謝 Tencent PC Manager 回報 Internet Explorer vtable 釋放後使用資訊安全風險 (CVE-2013-0021)  
-   感謝 [Omair](https://krash.in/) 回報 Internet Explorer LsGetTrailInfo 釋放後使用資訊安全風險 (CVE-2013-0022)  
-   感謝 Arthur Gerkis 與 [HP 的](https://www.hpenterprisesecurity.com/products)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作回報 Internet Explorer CDispNode 釋放後使用資訊安全風險 (CVE-2013-0023)  
-   感謝匿名的研究人員與 [HP 的](https://www.hpenterprisesecurity.com/products)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作回報 Internet Explorer pasteHTML 釋放後使用資訊安全風險 (CVE-2013-0024)  
-   感謝 [Security-Assessment.com](https://www.security-assessment.com/) 的 Scott Bell 回報 Internet Explorer SLayoutRun 釋放後使用資訊安全風險 (CVE-2013-0025)  
...
-   感謝 [Security-Assessment.com](https://www.security-assessment.com/) 的 Scott Bell 回報 Internet Explorer CObjectElement 釋放後使用資訊安全風險 (CVE-2013-0028)  
-   感謝 Yenteasy Security Research 的 Jose A Vazquez 和 [HP](https://www.hpenterprisesecurity.com/products) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，回報 Internet Explorer CObjectElement 釋放後使用資訊安全風險 (CVE-2013-0028)  
-   感謝 [Harmony Security](https://www.harmonysecurity.com/) 的 Stephen Fewer 和 [HP](https://www.hpenterprisesecurity.com/products) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，回報 Internet Explorer CHTML 釋放後使用資訊安全風險 (CVE-2013-0029)  
-   感謝 [Aniway.Aniway@gmail.com](mailto:aniway.aniway@gmail.com) 和 [HP](https://www.hpenterprisesecurity.com/products) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，回報 Internet Explorer CHTML 釋放後使用資訊安全風險 (CVE-2013-0029)  
-   感謝 [NCC 小組](https://www.nccgroup.com/)的 Ollie Whitehouse 協助我們解決本公告中所含之其他深度防禦變更的問題
