...
下列嚴重性等級是假設資訊安全風險可能造成的最嚴重影響而評定。在本資訊安全公告發行的 30 天內，如需資訊安全風險之易遭利用性與嚴重性等級和資訊安全影響之間對應關係的資訊，請參閱 [4 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms13-apr)中的＜資訊安全風險索引＞。如需更多資訊，請參閱 [Microsoft 資訊安全風險入侵指數](https://technet.microsoft.com/zh-tw/security/cc998259.aspx)。
...
| 資訊安全風險標題                         | CVE 編號                                                                         |
|------------------------------------------|----------------------------------------------------------------------------------|
| Internet Explorer 釋放後使用資訊安全風險 | [CVE-2013-1303](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1303) |
| Internet Explorer 釋放後使用資訊安全風險 | [CVE-2013-1304](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1304) |
| Internet Explorer 釋放後使用資訊安全風險 | [CVE-2013-1338](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1338) |
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2817183">Microsoft 知識庫文件編號 2817183</a></td>
</tr>
<tr class="even">
...
| **檔案資訊**     | 請參閱 [Microsoft 知識庫文件編號 2817183](https://support.microsoft.com/kb/2817183)                                                     |
