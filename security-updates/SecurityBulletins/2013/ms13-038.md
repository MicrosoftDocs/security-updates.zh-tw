---
TOCTitle: 'MS13-038'
Title: 'Microsoft Security Bulletin MS13-038 - 重大'
ms:assetid: 'ms13-038'
ms:contentKeyID: 61238853
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms13-038(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS13-038 - 重大
===========================================

Internet Explorer 適用的資訊安全更新 (2847204)
----------------------------------------------
...
對於 Windows 用戶端上的 Internet Explorer 8，此資訊安全更新的等級為「重大」；對於 Windows 伺服器上的 Internet Explorer 8，等級為「中度」。對於 Internet Explorer 9，此資訊安全更新沒有嚴重性等級。如需詳細資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此資訊安全更新會修改 Internet Explorer 處理記憶體中物件的方式，藉此解決此資訊安全風險。如需更多有關此資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。

本資訊安全更新也能解決 [Microsoft 資訊安全摘要報告 2847140](https://technet.microsoft.com/security/advisory/2847140) 中首先提出的資訊安全風險。
...
| 知識庫文件     | [2847204](https://support.microsoft.com/kb/2847204) |
|----------------|-----------------------------------------------------|
| 檔案資訊       | 是                                                  |
| SHA1/SHA2 雜湊 | 是                                                  |
| 已知問題       | 是                                                  |
...
**此 MS13-038 更新是 Internet Explorer 的積存資訊安全更新嗎？**   
否。此 MS13-038 資訊安全更新只會解決此公告中描述的資訊安全風險。

**是否需要安裝 2013 年 5 月的 Internet Explorer積存資訊安全更新 MS13-037？**   
是。在所有情況下，MS13-038 可保護客戶免受此公告所討論的資訊安全風險影響。但是，若客戶尚未安裝最新的 Internet Explorer 積存資訊安全更新，有可能會在安裝 MS13-038 更新後發生相容性問題。

客戶必須確保已安裝最新的 Internet Explorer 積存資訊安全更新 [MS13-037](https://technet.microsoft.com/zh-tw/security/bulletin/ms13-037)，以避免發生相容性問題。

**MS13-037 和 MS13-038 都提供 Internet Explorer 資訊安全更新**。**我是否必須按照特定順序來**安裝這些資訊安全更新**？**   
否。如果多項更新都是針對同一個 Internet Explorer 版本，您就無需按照特定順序套用。

**如果我套用了 Microsoft 資訊安全摘要報告 2847140 中適用於 Internet Explorer 的自動化 Microsoft Fix it 解決方案，在套用此更新之前，是否需要先復原該因應措施？**   
已實作 [Microsoft 資訊安全摘要報告 2847140](https://technet.microsoft.com/security/advisory/2847140) 中 **Microsoft Fix it 解決方案**「CVE-2013-1347 MSHTML Shim 因應措施」的客戶，在套用此更新前，不需要復原 **Microsoft Fix it 解決方案**。
...
<th style="border:1px solid black;" >
Internet Explorer 釋放後使用資訊安全風險 - CVE-2013-1347
</th>
<th style="border:1px solid black;" >
彙總嚴重性等級
</th>
...
若要以一般性資訊安全風險清單中的標準項目來檢視此資訊安全風險，請參閱 [CVE-2013-1347](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1347) (英文)。
...
-   **套用 Microsoft Fix it 解決方案「CVE-2013-1347 MSHTML Shim 因應措施」可防止此問題遭到利用。**

    請參閱 [Microsoft 知識庫文件編號 2847204](https://support.microsoft.com/kb/2847204?ln=zh-tw)，以使用自動化 **Microsoft Fix It** 解決方案來啟用或停用此因應措施。
...
是。此資訊安全風險已經遭到公開揭發。這項資訊安全風險已被指派「一般性資訊安全風險」編號 [CVE-2013-1347](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1347)。此資訊安全風險最初是在 [Microsoft 資訊安全摘要報告 2847140](https://technet.microsoft.com/security/advisory/2847140) 中提出。

**當本資訊安全公告發行時，Microsoft 是否已接獲任何消息，指出此資訊安全風險已遭有心人士利用？**   
是。Microsoft 已發現嘗試透過 Internet Explorer 8 利用此資訊安全風險的攻擊。
...
<td style="border:1px solid black;">適用於所有 Windows XP 支援版本的 Internet Explorer 8：<br />
使用 [控制台] 中的 <strong>[新增或移除程式]</strong> 項目，或是 %Windir%\ie8updates\KB2847204-IE8\spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2847204?ln=zh-tw">Microsoft 知識庫文件編號 2847204</a></td>
</tr>
<tr class="even">
...
-   感謝 [FireEye](https://www.fireeye.com/) 的 Daniel Caselden 回報 Internet Explorer 釋放後使用資訊安全風險 (CVE-2013-1347)  
-   感謝 [iSIGHT Partners](https://www.isightpartners.com/) 與我們合作解決 Internet Explorer 釋放後使用資訊安全風險 (CVE-2013-1347)
...
-   V1.1 (2013 年 5 月 29 日)： 更新知識庫文件章節中的已知問題項目：將「無」改為「是」。
