---
TOCTitle: 'MS13-007'
Title: 'Microsoft Security Bulletin MS13-007 - 重要'
ms:assetid: 'ms13-007'
ms:contentKeyID: 61238822
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms13-007(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS13-007 - 重要
===========================================

Open Data 通訊協定中的資訊安全風險可能會允許阻斷服務 (DoS) (2769327)
--------------------------------------------------------------------

發行: 2013年1月8日 | 更新: 2013年4月10日
...
此資訊安全更新可解決 Open Data (OData) 通訊協定中一項未公開報告的資訊安全風險。如果未經驗證的攻擊者傳送蓄意製作的 HTTP 要求至受影響的網站，則此資訊安全風險可能會允許阻斷服務 (DoS)。最佳實作的防火牆和標準預設防火牆設定有助於防止網路受到來自企業外的攻擊。最佳方式建議連線至網際網路的系統盡可能曝露最少數量的連接埠。

對於 Microsoft .NET Framework 3.5、Microsoft .NET Framework 3.5 Service Pack 1、Microsoft .NET Framework 3.5.1 和 Microsoft .NET Framework 4，此資訊安全更新的等級為「重要」。對於安裝於 Microsoft Windows Server 2012 上的管理 OData IIS 擴充功能，此資訊安全更新的等級也是「重要」。如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此資訊安全更新藉由預設關閉 WCF 取代功能來解決此資訊安全風險。如需更多有關此資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
**已知問題。** [Microsoft 知識庫文件編號 2769327](https://support.microsoft.com/kb/2769327?ln=zh-tw) 中記載目前已知客戶安裝此資訊安全更新時可能會發生的問題。該文件並說明了解決這些問題的建議解決方案。
...
**何處可找到資訊安全更新的雜湊？**   
資訊安全更新的 SHA1 和 SHA2 雜湊可用來驗證下載之資訊安全更新套件的真實性。如需此更新的相關雜湊資訊，請參閱 [Microsoft 知識庫文件編號 2769327](https://support.microsoft.com/kb/2769327?ln=zh-tw)。
...
<th style="border:1px solid black;" >
取代阻斷服務 (DoS) 資訊安全風險 - CVE-2013-0005
</th>
<th style="border:1px solid black;" >
彙總嚴重性等級
</th>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
安裝在 Windows Server 2012 上的管理 OData IIS 擴充功能
</td>
<td style="border:1px solid black;">
**重要**   
阻斷服務 (DoS)
...
<tr>
<td style="border:1px solid black;">
安裝在 Windows Server 2012 (Server Core 安裝) 上的管理 OData IIS 擴充功能
</td>
<td style="border:1px solid black;">
**重要**   
阻斷服務 (DoS)
...
OData 規格中存在可能會允許阻斷服務 (DoS) 的資訊安全風險。此資訊安全風險可能會導致伺服器或服務停止回應並重新啟動。

若要以一般性資訊安全風險清單中的標準項目來檢視此資訊安全風險，請參閱 [CVE-2013-0005](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0005)。

#### 取代阻斷服務 (DoS) 資訊安全風險 - CVE-2013-0005 的緩和因素

緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。下列緩和因素可能對您的狀況有所助益：

-   最佳實作的防火牆和標準預設防火牆設定有助於防止網路受到來自企業外的攻擊。最佳方式建議連線至網際網路的系統盡可能曝露最少數量的連接埠。
-   以預設設定執行 Windows Server 2012 的系統不受此資訊安全風險影響，因為依預設不會啟用 Management OData IIS 擴充功能。只有啟用 Management OData IIS 擴充功能的 Windows Server 2012 系統才會受此資訊安全風險影響。

#### 取代阻斷服務 (DoS) 資訊安全風險 - CVE-2013-0005 的因應措施

因應措施指的是無法徹底修正資訊安全風險，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：

-   **在防火牆封鎖 OData Web 應用程式連接埠**

    OData 連接埠通常位在 TCP 連接埠 80 與 443，但也可能位在其他非標準連接埠上。評估您的環境，並且封鎖企業防火牆上主控 OData 服務之所有連接埠的輸入與輸出連線，將有助於保護系統防範嘗試利用這個資訊安全風險的攻擊。建議您封鎖所有網際網路中來路不明的輸入通訊，以防他人利用其他連接埠攻擊系統。如需更多關於連接埠的資訊，請參閱 TechNet 文章：[TCP 和 UDP 連接埠的指派](https://go.microsoft.com/fwlink/?linkid=21312) (英文)。

-   **用戶端連線至 IIS 時必須驗證**

    您可以啟用 IIS 的驗證，阻止未經驗證的攻擊者利用此資訊安全風險。如需在您的環境中實作驗證的作法相關資訊，請參閱您 IIS 版本的 TechNet 文件。
    若是 IIS7，請參閱[在 IIS 7 中設定驗證](https://technet.microsoft.com/en-us/library/cc733010(v=ws.10).aspx)

    若是 IIS6.0，請參閱 [IIS6.0 的整合式 Windows 驗證](https://technet.microsoft.com/en-us/library/cc738016(v=ws.10).aspx)

#### 取代阻斷服務 (DoS) 資訊安全風險 - CVE-2013-0005 的常見問題集

**此資訊安全風險的範圍為何？**   
這是一項阻斷服務 (DoS) 的資訊安全風險。

**造成此資訊安全風險的原因為何？**   
此資訊安全風險導因於 WCF 取代功能不當清理蓄意製作的值，進而允許資料複寫及耗盡系統資源。

**什麼是 OData？**   
Open Data (OData) 通訊協定是用於查詢和更新資料的網路通訊協定，能讓您解除鎖定資料並讓資料脫離現今應用程式中存在的結構。OData 是在 [HTTP](https://www.w3.org/protocols/)、[Atom Publishing 通訊協定](https://www.ietf.org/rfc/rfc4287.txt) (AtomPub) 與 [JSON](https://json.org/) 等 Web 技術上套用與建立，使您能存取多種應用程式、服務和儲存區的資訊。此通訊協定的出現是來自於過去數年間在多種產品內實作 AtomPub 用戶端和伺服器而來的豐富經驗。OData 可用以顯示與存取多種來源的資訊，包括但不限於關聯式資料庫、檔案系統、內容管理系統及傳統網站。如需 OData 規格的詳細資訊，請參閱 [Open Data 通訊協定網站](https://www.odata.org/)。

**什麼是管理 OData IIS 擴充功能 Web 服務？**  
  管理 OData IIS 擴充功能是一種架構，可透過於 IIS 下執行的 OData 型 Web 服務，輕鬆顯示 Windows PowerShell Cmdlet。如需更多資訊，請參閱[建立管理 OData IIS 擴充功能 Web 服務](https://msdn.microsoft.com/en-us/library/windows/desktop/hh880865(v=vs.85).aspx) (英文)。

**什麼是 WCF？**  
  Windows Communication Foundation (WCF) 是 Microsoft 的整合程式撰寫模型，可用於建立服務導向應用程式，讓開發人員製作安全可靠的交易解決方案，以利跨平台整合並與現有投資交互運用。如需 WCF 的詳細資訊，請參閱 [Windows Communication Foundation](https://msdn.microsoft.com/en-us/library/dd456779.aspx) (英文)。

**攻擊者可能會利用此資訊安全風險採取什麼行動？**   
攻擊者可以利用這項資訊安全風險發動阻斷服務 (DoS) 攻擊，干擾使用 .NET WCF 服務之網站的可用性。

**攻擊者如何利用此資訊安全風險？**   
未經驗證的攻擊者可能會傳送一些蓄意製作的 HTTP 要求至受影響的網站，造成阻斷服務 (DoS) 的情況。

**因為此資訊安全風險而承受風險的主要系統有哪些？**   
面對網際網路且已安裝 .NET Framework 和 WCF 服務的系統受到此資訊安全風險影響的風險最高。使用管理 OData IIS 擴充功能執行 IIS 的 Windows Server 2012 系統也很可能受到此資訊安全風險影響。

**更新的作用何在？**   
此更新可藉由預設關閉 WCF 取代功能來解決此資訊安全風險。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2736416?ln=zh-tw">Microsoft 知識庫文件編號 2736416</a><br />
請參閱 <a href="https://support.microsoft.com/kb/2736428?ln=zh-tw">Microsoft 知識庫文件編號 2736428</a></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">安裝於 Windows Server 2003 x64 Edition Service Pack 2 上的 Microsoft .NET Framework 3.5 Service Pack 1：<br />
NDP35SP1-KB2736416-x64.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">安裝在適用於 Itanium 系統之 Windows Server 2003 SP2 上的 Microsoft .NET Framework 3.5 Service Pack 1：<br />
NDP35SP1-KB2736416-IA64.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">安裝在適用於 Itanium 系統之 Windows Server 2003 SP2 上的 Microsoft .NET Framework 4：<br />
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">安裝於所有 x64 版本與 Itanium 版本 Windows Server 2003 上的 Microsoft .NET Framework 4：<br />
HKEY_LOCAL_MACHINE\SOFTWARE\ Wow6432Node\Microsoft\Updates\Microsoft .NET Framework 4 Client Profile\KB2736428<br />
&quot;ThisVersionInstalled&quot; = &quot;Y&quot;</td>
</tr>
</tbody>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2736418?ln=zh-tw">Microsoft 知識庫文件編號 2736418</a><br />
請參閱 <a href="https://support.microsoft.com/kb/2736422?ln=zh-tw">Microsoft 知識庫文件編號 2736422</a><br />
請參閱 <a href="https://support.microsoft.com/kb/2736428?ln=zh-tw">Microsoft 知識庫文件編號 2736428</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
...
Microsoft .NET Framework 4 的資訊安全更新支援以下的安裝參數。
...
<tr class="even">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2736693?ln=zh-tw">Microsoft 知識庫文件編號 2736693</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">安裝在 Windows Server 2012 上的管理 OData IIS 擴充功能：<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2736693?ln=zh-tw">Microsoft 知識庫文件編號 2736693</a><br />
請參閱 <a href="https://support.microsoft.com/kb/2753596?ln=zh-tw">Microsoft 知識庫文件編號 2753596</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">Microsoft .NET Framework 3.5：<br />
...
-   V1.1 (2013 年 4 月 10 日)： 為執行 Windows Server 2012 的系統新增 CVE-2013-0005 的緩和因素。
