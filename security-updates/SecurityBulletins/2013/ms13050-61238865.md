...
**我用的是*「***受影響的軟體」表*中*列出的*Windows Server 2008 (Server Core* *安裝**)* 、*Windows* *Server 2008 R2 (Server Core* *安裝**)* *或* *Windows Server 2012 (Server Core* *安裝**)* 。為什麼我沒有收到 2839894 更新？**   
...
-   **停用列印多工緩衝處理器服務**
    ...
    **使用管理部署指令碼：**
    ...
    2.  建立名稱為是 Disable\_spooler.reg 的文字檔，且要包含下列內容：`Windows Registry Editor Version 5.00[HKEY_LOCAL_MAC``HINE\SYSTEM\CurrentControlSet\Services\Spooler]"Start"=dword:00000004`
