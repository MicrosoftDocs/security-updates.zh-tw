...
**已知問題。** [Microsoft 知識庫文件編號 2797052](https://support.microsoft.com/kb/2797052) 中記載目前已知客戶在安裝此資訊安全更新時可能會發生的問題。該文件並說明了解決這些問題的建議解決方案。
...
是。KB2797052 更新可供適用於 32 位元系統的 Windows 7 Service Pack 1、適用於 x64 型系統的 Windows 7 Service Pack 1，以及適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1 之 Internet Explorer 10 Release Preview 使用。客戶若已安裝適用於 32 位元系統的 Windows 7 Service Pack 1、適用於 x64 型系統的 Windows 7 Service Pack 1，以及適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1 之 Internet Explorer 10 Release Preview，建議在其系統上套用這些更新。您可以從 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 與 [Microsoft 下載中心](https://go.microsoft.com/fwlink/?linkid=21129)取得適用於 32 位元系統的 Windows 7 Service Pack 1 以及適用於 x64 型系統的 Windows 7 Service Pack 1 之 Internet Explorer 10 Release Preview 可用的 KB2797052 更新。您可以從 [Microsoft 下載中心](https://go.microsoft.com/fwlink/?linkid=21129)取得適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1 之 Internet Explorer 10 Release Preview 可用的 KB2797052 更新。
...
若要以一般性資訊安全風險清單中的標準項目來檢視此資訊安全風險，請參閱 [CVE-2013-0030](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0030) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2797052">Microsoft 知識庫文件編號 2797052</a></td>
</tr>
<tr class="even">
...
| **部署**                                       |                                                                                                                                                                                                              |  
|                                                | 此更新僅可以從 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 取得。                                                                                                                         |  
| **重新開機需求**                               |                                                                                                                                                                                                              |  
...
| **檔案資訊**                                   | 請參閱 [Microsoft 知識庫文件編號 2797052](https://support.microsoft.com/kb/2797052)                                                                                                                           |
