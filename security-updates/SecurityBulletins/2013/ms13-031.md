...
若要以一般性資訊安全風險清單中的標準項目來檢視此資訊安全風險，請參閱 [CVE-2013-1284](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1284) (英文)。
...
若要以一般性資訊安全風險清單中的標準項目來檢視此資訊安全風險，請參閱 [CVE-2013-1294](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1294) (英文)。
...
如需上述工具以及其他可使用工具的詳細資訊，請參閱「IT 專業人員的資訊安全工具」[IT 專業人員的資訊安全工具](https://technet.microsoft.com/security/cc297183)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2813170">Microsoft 知識庫文件編號 2813170</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/kb2813170">Microsoft 知識庫文件編號 KB2813170</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;"><strong>注意：</strong>登錄機碼不存在，無法驗證此更新是否存在。</td>
...
| **檔案資訊**     | 請參閱 [Microsoft 知識庫文件編號 KB2813170](https://support.microsoft.com/kb/kb2813170)                        |
