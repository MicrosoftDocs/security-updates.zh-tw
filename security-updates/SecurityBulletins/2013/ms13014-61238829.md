...
(KB2790978)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 R2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=aadb2003-ed7b-46ee-afd0-33cec4ac39b4)  
(KB2790978)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2790978)  
(英文下載更新程式)  
[適用於 Itanium 型系統的 Windows Server 2008 R2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=8e37196c-2f43-457d-8d87-336d8775c0bf)  
(KB2790978)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2790978)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 R2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=aadb2003-ed7b-46ee-afd0-33cec4ac39b4) (Server Core 安裝)  
(KB2790978)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
若要以一般性資訊安全風險清單中的標準項目來檢視此資訊安全風險，請參閱 [CVE-2013-1281](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1281) (英文)。
...
什麼是 NFS？  
網路檔案系統 (NFS) 是一項業界標準通訊協定 (其定義請見 [RFC 1094](http://www.ietf.org/rfc/rfc1094.txt?number=1094))，可讓您以透明方式遠端存取網路間的共用檔案。Services for Network File System (NFS) 係以混用 Windows 與 UNIX 環境的企業為對象，提供檔案共用解決方案。Services for NFS 能讓使用者使用 NFS 通訊協定，在執行 Windows 作業系統的電腦與 UNIX 電腦之間傳輸檔案。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2790978">Microsoft 知識庫文件編號 2790978</a></td>
</tr>
<tr class="odd">
