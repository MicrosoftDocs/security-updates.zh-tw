...
(KB2769369)  
(英文下載更新程式)  
[適用於 32 位元系統的 Windows 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=abbc3f31-e940-4750-acb6-5af477bc8390)  
(KB2769369)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2769369)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 R2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=8de63e96-2822-4e62-af54-bd8d4c6d5c19)  
(KB2769369)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2769369)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 R2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=8de63e96-2822-4e62-af54-bd8d4c6d5c19) (Server Core 安裝)  
(KB2769369)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
若要以一般性資訊安全風險清單中的標準項目來檢視此資訊安全風險，請參閱 [CVE-2013-0011](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0011)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2769369">Microsoft 知識庫文件編號 2769369</a></td>
</tr>
<tr class="odd">
