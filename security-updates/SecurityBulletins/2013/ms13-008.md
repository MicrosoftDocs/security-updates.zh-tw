...
本資訊安全更新也能解決 [Microsoft 資訊安全摘要報告 2794220](https://technet.microsoft.com/security/advisory/2794220) 中首先提出的資訊安全風險。
...
客戶必須確保已安裝最新的 Internet Explorer 積存資訊安全更新 [MS12-077](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-077)，以避免發生相容性問題。

**如果我套用了 Microsoft 資訊安全摘要報告 2794220 中適用於 Internet Explorer 的自動化 Microsoft Fix it 解決方案，在套用此更新之前，是否需要先復原該因應措施？**   
已實作 [Microsoft 資訊安全摘要報告 2794220](https://technet.microsoft.com/security/advisory/2794220) 中 **Microsoft Fix** i**t 解決方案**「MSHTML Shim 因應措施」的客戶，在套用此更新前，不需要復原 **Microsoft Fix it** 解決方案。
...
使用此軟體舊版的客戶應優先考慮移轉至支援的版本，以避免因潛在的資訊安全風險而遭受攻擊。若要瞭解您的軟體版本的支援週期，請參閱[選擇一個產品檢視其支援週期資訊](https://support.microsoft.com/gp/lifeselect)。如需更多關於上述軟體版本的 Service Pack 的資訊，請參閱 [Service Pack 週期支援政策](https://support.microsoft.com/?ln=en-us&scid=gp%3b%5bln%5d%3blifecycle&x=13&y=15)。
...
若要以一般性資訊安全風險清單中的標準項目來檢視此資訊安全風險，請參閱 [CVE-2012-4792](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4792) (英文)。
...
-   **套用 Microsoft Fix it 解決方案「MSHTML Shim 因應措施」可防止此問題遭到利用。**
    ...
    請參閱 [Microsoft 知識庫文件編號 2799329](https://support.microsoft.com/kb/2799329?ln=zh-tw)，以使用自動化 **Microsoft Fix It** 解決方案來啟用或停用此因應措施。
...
是。此資訊安全風險已經遭到公開揭發。這項資訊安全風險已獲指派一般性資訊安全風險編號 [CVE-2012-4792](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4792)。此資訊安全風險最初是在 [Microsoft 資訊安全摘要報告 2794220](https://technet.microsoft.com/security/advisory/2794220) 中提出。
...
資訊安全更新可從 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 以及 [Windows Update](https://update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=zh-hk) 取得。資訊安全更新也可以從 [Microsoft 下載中心](https://www.microsoft.com/en-us/download/search.aspx?q=security%20update)取得。您也可以利用「資訊安全更新」("security update") 關鍵字搜尋輕易地找到資訊安全更新。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2799329?ln=zh-tw">Microsoft 知識庫文件編號 2799329</a></td>
</tr>
<tr class="even">
