...
**已知問題。** [Microsoft 知識庫文件編號 2778930](https://support.microsoft.com/kb/2778930) 中記載目前已知客戶在安裝此資訊安全更新時可能會發生的問題。該文件並說明了解決這些問題的建議解決方案。
...
<td style="border:1px solid black;">
KB2778930 取代 [MS12-078](https://go.microsoft.com/fwlink/?linkid=271624) 中的 KB2779030
</td>
</tr>
...
若要以一般性資訊安全風險清單中的標準項目來檢視此資訊安全風險，請參閱 [CVE-2013-0008](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0008)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2778930">Microsoft 知識庫文件編號 2778930</a></td>
</tr>
<tr class="odd">
...
| **檔案資訊**                                   | 請參閱 [Microsoft 知識庫文件編號 2778930](https://support.microsoft.com/kb/2778930)                            |
