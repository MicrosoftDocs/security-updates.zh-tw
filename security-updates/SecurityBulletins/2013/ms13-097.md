...
是。2898785 更新也可供 Windows 8.1 Preview 以及 Windows RT 8.1 Preview 上的 Internet Explorer 11 Preview 使用。建議使用 Internet Explorer 11 Preview 的客戶在其系統上套用這些更新。這些更新透過 [Windows Update](https://update.microsoft.com/windowsupdate/v6/default.aspx) 提供。
...
<span></span>
下列嚴重性等級是假設資訊安全風險可能造成的最嚴重影響而評定。在本資訊安全公告發行的 30 天內，如需資訊安全風險易遭利用性與嚴重性等級和資訊安全影響之間對應關係的資訊，請參閱 [12 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms13-dec)中的＜資訊安全風險索引＞。如需更多資訊，請參閱 [Microsoft 資訊安全風險入侵指數](https://technet.microsoft.com/zh-tw/security/cc998259.aspx)。
...
<th style="border:1px solid black;" >
Internet Explorer 記憶體損毀資訊安全風險 - CVE-2013-5047
</th>
<th style="border:1px solid black;" >
...
| 資訊安全風險標題                       | CVE 編號                                                                         |
|----------------------------------------|----------------------------------------------------------------------------------|
| Internet Explorer 權限提高資訊安全風險 | [CVE-2013-5045](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-5045) |
| Internet Explorer 權限提高資訊安全風險 | [CVE-2013-5046](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-5046) |
...
| 資訊安全風險標題                         | CVE 編號                                                                         |
|------------------------------------------|----------------------------------------------------------------------------------|
| Internet Explorer 記憶體損毀資訊安全風險 | [CVE-2013-5047](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-5047) |
| Internet Explorer 記憶體損毀資訊安全風險 | [CVE-2013-5048](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-5048) |
| Internet Explorer 記憶體損毀資訊安全風險 | [CVE-2013-5049](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-5049) |
| Internet Explorer 記憶體損毀資訊安全風險 | [CVE-2013-5051](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-5051) |
| Internet Explorer 記憶體損毀資訊安全風險 | [CVE-2013-5052](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-5052) |
...
<td style="border:1px solid black;">針對適用於所有 Windows XP 支援版本的 Internet Explorer 6：<br />
使用 [控制台] 中的 [新增或移除程式] 項目，或 %Windir%\$NTUninstallKB2898785$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">針對適用於所有 Windows XP 支援版本的 Internet Explorer 7：<br />
使用 [控制台] 中的 [新增或移除程式] 項目，或 %Windir%\ie7updates\KB2898785-IE7\spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">針對適用於所有 Windows XP 支援版本的 Internet Explorer 8：<br />
使用 [控制台] 中的 [新增或移除程式] 項目，或 %Windir%\ie8updates\KB2898785-IE8\spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2898785?ln=zh-tw">Microsoft 知識庫文件編號 2898785</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">或適用於 x64 系統之 Windows 7 Service Pack 1 的 Internet Explorer 11：<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於所有受支援 x64 位元版本 Windows 8 的 Internet Explorer 10：<br />
...
|                  |                                                                                                                                          |  
|------------------|------------------------------------------------------------------------------------------------------------------------------------------|  
| **部署**         | 此更新是透過 [Windows Update](https://fe1.update.microsoft.com/microsoftupdate/v6/vistadefault.aspx) 提供。                               |  
