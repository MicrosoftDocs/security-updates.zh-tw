...
是。2809289 更新可供適用於 32 位元系統的 Windows 7 Service Pack 1 以及適用於 x64 型系統的 Windows 7 Service Pack 1 之 Internet Explorer 10 Release Preview 使用。建議已安裝適用於 32 位元系統的 Windows 7 Service Pack 1 與適用於 x64 型系統的 Windows 7 Service Pack 1 之 Internet Explorer 10 Release Preview 的客戶在其系統上套用這些更新。這些更新透過 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 提供。
...
下列嚴重性等級是假設資訊安全風險可能造成的最嚴重影響而評定。在本資訊安全公告發行的 30 天內，如需資訊安全風險之易遭利用性與嚴重性等級和資訊安全影響之間對應關係的資訊，請參閱 [3 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms13-mar)中的＜資訊安全風險索引＞。如需更多資訊，請參閱 [Microsoft 資訊安全風險入侵指數](https://technet.microsoft.com/zh-tw/security/cc998259.aspx)。
...
| 資訊安全風險標題                                                | CVE 編號                                                                         |
|-----------------------------------------------------------------|----------------------------------------------------------------------------------|
| Internet Explorer OnResize 釋放後使用資訊安全風險               | [CVE-2013-0087](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0087) |
| Internet Explorer saveHistory 釋放後使用資訊安全風險            | [CVE-2013-0088](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0088) |
| Internet Explorer CMarkupBehaviorContext 釋放後使用資訊安全風險 | [CVE-2013-0089](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0089) |
| Internet Explorer CCaret 釋放後使用資訊安全風險                 | [CVE-2013-0090](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0090) |
| Internet Explorer CElement 釋放後使用資訊安全風險               | [CVE-2013-0091](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0091) |
| Internet Explorer GetMarkupPtr 釋放後使用資訊安全風險           | [CVE-2013-0092](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0092) |
| Internet Explorer onBeforeCopy 釋放後使用資訊安全風險           | [CVE-2013-0093](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0093) |
| Internet Explorer removeChild 釋放後使用資訊安全風險            | [CVE-2013-0094](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0094) |
| Internet Explorer CTreeNode 釋放後使用資訊安全風險              | [CVE-2013-1288](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1288) |
...
是。Enhanced Mitigation Experience Toolkit (EMET) 可新增其他保護層，讓這些資訊安全風險更不易遭到利用，因而有助於降低這些資訊安全風險遭到利用的機會。EMET 是一個公用程式，可套用最新的安全性緩和技術，以協助防止攻擊者成功地利用軟體中的資訊安全風險執行任意程式碼。目前，EMET 提供的支援有限，且僅提供英文版。如需更多資訊，請參閱 [Microsoft 知識庫文件編號 2458544](https://support.microsoft.com/kb/2458544)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2809289">Microsoft 知識庫文件編號 2809289</a></td>
</tr>
<tr class="even">
...
| **檔案資訊**     | 請參閱 [Microsoft 知識庫文件編號 2809289](https://support.microsoft.com/kb/2809289)                                                                                            |
...
-   感謝[Harmony Security](https://www.harmonysecurity.com) 的 Stephen Fewer 回報 Internet Explorer CCaret 釋放後使用資訊安全風險 (CVE-2013-0090)  
