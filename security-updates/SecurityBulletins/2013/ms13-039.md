...
若要以一般性資訊安全風險清單中的標準項目來檢視此資訊安全風險，請參閱 [CVE-2013-1305](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1305) (英文)。
...
-   **在企業外圍防火牆封鎖 TCP 連接埠 80 和 443**
    ...
    **如何復原因應措施**。在企業外圍防火牆取消封鎖 TCP 連接埠 80 和 443。如需更多關於連接埠的資訊，請參閱 TechNet 文章：[TCP 和 UDP 連接埠的指派](https://technet.microsoft.com/library/cc977599) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2829254?ln=zh-tw">Microsoft 知識庫文件編號 2829254</a></td>
</tr>
<tr class="odd">
...
| **檔案資訊**     | 請參閱 [Microsoft 知識庫文件編號 2829254](https://support.microsoft.com/kb/2829254?ln=zh-tw)                                              |
...
-   感謝 Marek Kroemeke、22733db72ab3ed94b5f8a1ffcde850251fe6f466、AKAT-1 與 [HP 的](https://www.hpenterprisesecurity.com/products) [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，回報 HTTP.sys 阻斷服務資訊安全風險 (CVE-2013-1305)
