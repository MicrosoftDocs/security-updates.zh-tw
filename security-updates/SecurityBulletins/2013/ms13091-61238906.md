...
<td style="border:1px solid black;">
[MS09-073](http://technet.microsoft.com/zh-tw/security/bulletin/ms09-073) 中的 975051
</td>
</tr>
<tr>
<th colspan="4">
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office 2010 Service Pack 1 (32 位元版本)](http://www.microsoft.com/downloads/details.aspx?familyid=af058c6d-5655-44da-97b0-a3c9441332b4)  
(檔案格式轉換程式)  
(2553284)
</td>
<td style="border:1px solid black;">
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office 2010 Service Pack 1 (32 位元版本)](http://www.microsoft.com/downloads/details.aspx?familyid=a74aebe9-1b09-48ae-b5f5-da078d0b0cb7)  
(校訂工具)  
(2760781)
</td>
<td style="border:1px solid black;">
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office 2010 Service Pack 2 (32 位元版本)](http://www.microsoft.com/downloads/details.aspx?familyid=af058c6d-5655-44da-97b0-a3c9441332b4)  
(檔案格式轉換程式)  
(2553284)
</td>
<td style="border:1px solid black;">
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office 2010 Service Pack 2 (32 位元版本)](http://www.microsoft.com/downloads/details.aspx?familyid=a74aebe9-1b09-48ae-b5f5-da078d0b0cb7)  
(校訂工具)  
(2760781)
</td>
<td style="border:1px solid black;">
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office 2010 Service Pack 1 (64 位元版本)](http://www.microsoft.com/downloads/details.aspx?familyid=84f1fae7-3208-4d91-9f62-30a55f99da43)  
(檔案格式轉換程式)  
(2553284)
</td>
<td style="border:1px solid black;">
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office 2010 Service Pack 1 (64 位元版本)](http://www.microsoft.com/downloads/details.aspx?familyid=65432bd6-68c3-4f2a-a305-4c1c9fe17c81)  
(校訂工具)  
(2760781)
</td>
<td style="border:1px solid black;">
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office 2010 Service Pack 2 (64 位元版本)](http://www.microsoft.com/downloads/details.aspx?familyid=84f1fae7-3208-4d91-9f62-30a55f99da43)  
(檔案格式轉換程式)  
(2553284)
</td>
<td style="border:1px solid black;">
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office 2010 Service Pack 2 (64 位元版本)](http://www.microsoft.com/downloads/details.aspx?familyid=65432bd6-68c3-4f2a-a305-4c1c9fe17c81)  
(校訂工具)  
(2760781)
</td>
<td style="border:1px solid black;">
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office 2013 (32 位元版本)](http://www.microsoft.com/downloads/details.aspx?familyid=d26026a8-ddb4-41ff-bad2-6df8e3e7d6de)  
(檔案格式轉換程式)  
(2768005)
</td>
<td style="border:1px solid black;">
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office 2013 (64 位元版本)](http://www.microsoft.com/downloads/details.aspx?familyid=24ed8a9f-d651-4e0d-a5d9-172310fea378)  
(檔案格式轉換程式)  
(2768005)
</td>
<td style="border:1px solid black;">
...
<sup>[2]</sup>更新是透過 [Windows Update](http://update.microsoft.com/windowsupdate/v6/default.aspx) 提供。
...
在某些情況下，更新可能可套用至「不受影響的軟體」表中明確列出的 Office 產品，或不適用資訊安全影響「受影響的軟體」表中所列出的 Office 產品。例如，即使資訊安全公告指出您已安裝的 Office 產品或 Office 產品版本不受影響，您還是可能收到 Microsoft Office 資訊安全更新。如需更多有關這種行為的資訊，請參閱 [Microsoft 知識庫文件編號 830335](http://support.microsoft.com/kb/830335?ln=zh-tw)。
...
若要以一般性資訊安全風險清單中的標準項目來檢視此資訊安全風險，請參閱 [CVE-2013-0082](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0082) (英文)。
...
若要以一般性資訊安全風險清單中的標準項目來檢視此資訊安全風險，請參閱 [CVE-2013-1324](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1324) (英文)。
...
若要以一般性資訊安全風險清單中的標準項目來檢視此資訊安全風險，請參閱 [CVE-2013-1325](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1325) (英文)。
...
<td style="border:1px solid black;">Microsoft Office 2003 Service Pack 3：<br />
請參閱 <a href="http://support.microsoft.com/kb/2760494?ln=zh-tw">Microsoft 知識庫文件編號 2760494</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2760415?ln=zh-tw">Microsoft 知識庫文件編號 2760415</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2553284?ln=zh-tw">Microsoft 知識庫文件編號 2553284</a> 與 <a href="http://support.microsoft.com/kb/2760781?ln=zh-tw">Microsoft 知識庫文件編號 2760781</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2768005?ln=zh-tw">Microsoft 知識庫文件編號 2768005</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<td style="border:1px solid black;">此更新是透過 <a href="http://fe1.update.microsoft.com/microsoftupdate/v6/vistadefault.aspx">Windows Update</a> 提供。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>重新開機需求</strong></td>
<td style="border:1px solid black;">在某些情況下，此更新程式不需要重新開機。如果需要的檔案正在使用中，更新程式會要求重新開機。在此情況下，系統會出現訊息提示您重新開機。<br />
