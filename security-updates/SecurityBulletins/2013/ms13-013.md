...
(KB2553234)<br />
(英文下載更新程式)<br />
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=0ae86754-69a8-4c82-855c-2ee2b7887fa5">Advanced Filter Pack</a>[1] <br />
(KB2553234)<br />
(中文下載更新程式)</td>
...
[Oracle 重大修補程式更新摘要報告 - 2012 年 10 月](https://www.oracle.com/technetwork/topics/security/cpuoct2012-1515893.html)中討論的 CVE-2012-3214 和 CVE-2012-3217 會影響 FAST Search Server 2010 for SharePoint，且可由此更新獲得解決。
...
-   停用 FAST Search Server 2010 for SharePoint 的 Advanced Filter Pack
    ...
    注意 如需更多資訊，請參閱[停用 Advanced Filter Pack](https://technet.microsoft.com/library/ff383314)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2553234">Microsoft 知識庫文件編號 2553234</a></td>
</tr>
<tr class="even">
