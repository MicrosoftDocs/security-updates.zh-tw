...
**已知問題。**[Microsoft 知識庫文件編號 2756145](https://support.microsoft.com/kb/2756145?ln=zh-tw) 中記載目前已知客戶安裝此資訊安全更新時可能會發生的問題。該文件並說明了解決這些問題的建議解決方案。目前已知問題和建議解決方案僅適用於此軟體的特定版本，本文會提供詳細文章的連結。
...
<td style="border:1px solid black;">
[MS12-043](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-043) 中的 KB2721691
</td>
</tr>
...
<td style="border:1px solid black;">
[MS12-043](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-043) 中的 KB2719985
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-043](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-043) 中的 KB2721693
</td>
</tr>
<tr>
<th colspan="5">
...
<td style="border:1px solid black;">
[MS12-043](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-043) 中的 KB2687627
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-043](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-043) 中的 KB2596856
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms12-043">MS12-043</a> 中的 KB2596856</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms12-043">MS12-043</a> 中原本的 KB2687497</td>
</tr>
<tr class="even">
...
**注意：**  視您系統上所安裝的 Microsoft XML Core Services 版本而定，此資訊安全公告可能提供不止一個資訊安全更新。另請注意，僅針對受支援版本的 Microsoft XML Core Services 提供更新。如需更多有關 Microsoft 支援的版本詳細資訊，請參閱 [Microsoft 知識庫文件編號 269238](https://support.microsoft.com/kb/269238?ln=zh-tw)。
  
**什麼是 Microsoft XML Core Services (MSXML)？**    
Microsoft XML Core Services (MSXML) 讓使用 JScript、Visual Basic Scripting Edition (VBScript) 和 Microsoft Visual Studio 6.0 的客戶能夠開發 XML 型應用程式，針對其他符合 XML 1.0 標準的應用程式，提供互通性。如需更多資訊，請瀏覽 MSDN 網站的 [MSXML](https://msdn.microsoft.com/zh-tw/library/ms763742.aspx) 文章。
...
下列嚴重性等級是假設資訊安全風險可能造成的最嚴重影響而評定。在本資訊安全公告發行的 30 天內，如需資訊安全風險易遭利用性與嚴重性等級和資訊安全影響之間對應關係的資訊，請參閱 [1 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms13-jan)中的＜資訊安全風險入侵指數＞。如需更多資訊，請參閱 [Microsoft 資訊安全風險入侵指數](https://technet.microsoft.com/security/cc998259)。
...
若要以一般性資訊安全風險清單中的標準項目來檢視此資訊安全風險，請參閱 [CVE-2013-0006](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0006)。
...
-   依照預設，Windows Server 2003、Windows Server 2008、Windows Server 2008 R2 和 Windows Server 2012 上的 Internet Explorer 會以稱為[增強式資訊安全設定](https://technet.microsoft.com/zh-tw/library/dd883248(ws.10).aspx)的受限制模式執行。此模式可緩和此資訊安全風險。
...
-   **避免在 Internet Explorer 中執行 MSXML 5.0 ActiveX 控制項**
    ...
    **警告：** 如果使用「登錄編輯程式」的方式錯誤，可能造成嚴重問題，以致於您必須重新安裝作業系統。Microsoft 無法保證您可以解決因為不正確使用 \[登錄編輯程式\] 所造成的問題。請自行承擔使用 \[登錄編輯程式\] 的風險。
    ...
    如需避免控制項在 Internet Explorer 中執行的詳細步驟，請參閱 [Microsoft 知識庫文件編號 240797](https://support.microsoft.com/kb/240797?ln=zh-tw)。按照文件中的步驟，在登錄中建立相容性旗標值，以避免在 Internet Explorer 中產生 COM 物件。
...
**什麼元件會受到這個資訊安全風險的影響？**  
該資訊安全風險會影響到 Microsoft XML Core Services (MSXML，可讓使用 JScript、Visual Basic Scripting Edition (VBScript) 和 Microsoft Visual Studio 6.0 的客戶開發 XML 型應用程式，針對其他符合 XML 1.0 標準的應用程式，提供互通性)。如需更多資訊，請瀏覽 MSDN 網站的 [MSXML](https://msdn.microsoft.com/zh-tw/library/ms763742.aspx)。

**什麼是 Microsoft XML Core Services (MSXML)？**    
Microsoft XML Core Services (MSXML) 讓使用 JScript、Visual Basic Scripting Edition (VBScript) 和 Microsoft Visual Studio 6.0 的客戶能夠開發 XML 型應用程式，針對其他符合 XML 1.0 標準的應用程式，提供互通性。如需更多資訊，請瀏覽 MSDN 網站的 [MSXML](https://msdn.microsoft.com/zh-tw/library/ms763742.aspx)。

**我的系統上安裝的 Microsoft XML Core Services 是什麼版本？**    
Microsoft XML Core Services 包含在 Microsoft 以外的其他非作業系統軟體中，但亦可供單獨下載。如需關於 Microsoft XML Core Services 的各種現行版本以及安裝此服務的產品等資訊，請參閱 [Microsoft 知識庫文件編號 269238](https://support.microsoft.com/kb/269238?ln=zh-tw)。
...
若要以一般性資訊安全風險清單中的標準項目來檢視此資訊安全風險，請參閱 [CVE-2013-0007](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0007)。
...
SMS 2003 可使用 Microsoft Update SMS 2003 盤點工具 (ITMU) 來偵測由 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 所提供，並由 [Windows Server Update Services](https://technet.microsoft.com/zh-tw/windowsserver/bb466208) 支援的資訊安全更新。如需 SMS 2003 ITMU 的詳細資訊，請參閱 [Microsoft Updates SMS 2003 盤點工具](https://technet.microsoft.com/sms/bb676783) (英文)。如需更多關於 SMS 掃描工具的資訊，請參閱 [SMS 2003 軟體更新掃描工具](https://technet.microsoft.com/sms/bb676786) (英文)。另請參閱[適用於 Systems Management Server 2003 的下載](https://technet.microsoft.com/sms/bb676766) (英文)。
...
<td style="border:1px solid black;">請參閱下列內容：<a href="https://support.microsoft.com/kb/2757638?ln=zh-tw">Microsoft 知識庫文件編號 2757638</a><br />
<a href="https://support.microsoft.com/kb/2758694?ln=zh-tw">Microsoft 知識庫文件編號 2758694</a><strong><br />
</strong><a href="https://support.microsoft.com/kb/2758696?ln=zh-tw">Microsoft 知識庫文件編號 2758696</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱下列內容：<a href="https://support.microsoft.com/kb/2757638?ln=zh-tw">Microsoft 知識庫文件編號 2757638</a><br />
<a href="https://support.microsoft.com/kb/2758694?ln=zh-tw">Microsoft 知識庫文件編號 2758694</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2760574?ln=zh-tw">Microsoft 知識庫文件編號 2760574</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
**注意：** 在受管理的環境中工作的系統管理員可以在 Office Admin Update Center 上，找到用於在組織中部署 Office 更新的完整資源。在該網站上，向下捲動並在＜更新資源＞部分下尋找您要更新的軟體版本。[Windows Installer Documentation](https://msdn.microsoft.com/zh-tw/library/aa367541.aspx) 也提供有關 Windows Installer 支援參數的其他資訊。
...
-   [適用於 Microsoft Windows 2000 及 Windows NT 4.0 的 Windows Installer 2.0 Redistributable](https://www.microsoft.com/zh-tw/download/details.aspx?id=11176)
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2687499?ln=zh-tw">Microsoft 知識庫文件編號 2687499</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2687497?ln=zh-tw">Microsoft 知識庫文件編號 2687497</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
-   感謝 [Agarri](https://www.agarri.fr/) 的 Nicolas Gregoire 回報 MSXML XSLT 資訊安全風險 (CVE-2013-0007)
