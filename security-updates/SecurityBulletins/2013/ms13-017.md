...
**已知問題。** [Microsoft 知識庫文件編號 2799494](https://support.microsoft.com/kb/2799494) 中記載目前已知客戶在安裝此資訊安全更新時可能會發生的問題。該文件並說明了解決這些問題的建議解決方案。
...
若要以一般性資訊安全風險清單中的標準項目來檢視此資訊安全風險，請參閱 [CVE-2013-1278](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1278) (英文)。
...
若要以一般性資訊安全風險清單中的標準項目來檢視此資訊安全風險，請參閱 [CVE-2013-1279](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1279) (英文)。
...
若要以一般性資訊安全風險清單中的標準項目來檢視此資訊安全風險，請參閱 [CVE-2013-1280](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1280) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2799494">Microsoft 知識庫文件編號 2799494</a></td>
</tr>
<tr class="even">
...
| **檔案資訊**                                   | 請參閱 [Microsoft 知識庫文件編號 2799494](https://support.microsoft.com/kb/2799494)                            |
...
-   感謝 [Google Inc](https://www.google.com) 的 [Gynvael Coldwind](https://gynvael.coldwind.pl/) 和 [Mateusz "j00ru" Jurczyk](https://j00ru.vexillium.org/) 回報核心競爭條件資訊安全風險 (CVE-2013-1278)  
-   感謝 [Google Inc](https://www.google.com) 的 [Gynvael Coldwind](https://gynvael.coldwind.pl/) 和 [Mateusz "j00ru" Jurczyk](https://j00ru.vexillium.org/) 回報核心競爭條件資訊安全風險 (CVE-2013-1279)
