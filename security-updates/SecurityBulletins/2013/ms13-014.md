---
TOCTitle: 'MS13-014'
Title: 'Microsoft Security Bulletin MS13-014 - 重要'
ms:assetid: 'ms13-014'
ms:contentKeyID: 61238829
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms13-014(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS13-014 - 重要
===========================================

NFS 伺服器中的資訊安全風險可能會允許阻斷服務 (DoS) (2790978)
------------------------------------------------------------
...
此資訊安全更新可解決 Microsoft Windows 中一項未公開報告的資訊安全風險。如果攻擊者嘗試在唯讀共用中執行檔案作業，此資訊安全風險可能會允許阻斷服務 (DoS)。攻擊者若利用此資訊安全風險，可導致受影響的系統停止回應並重新啟動。此資訊安全風險只會影響那些已啟用 NFS 角色的 Windows 伺服器。

對所有受支援版本的 Windows Server 2008 R2 與 Windows Server 2012，此資訊安全更新的等級為「重要」。如需詳細資訊，請參閱本節中＜受影響及不受影響的軟體＞小節。

此資訊安全更新可修正 NFS 伺服器處理檔案作業的方式，進而解決此資訊安全風險。如需更多有關此資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
(KB2790978)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 R2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=aadb2003-ed7b-46ee-afd0-33cec4ac39b4)  
(KB2790978)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2790978)  
(英文下載更新程式)  
[適用於 Itanium 型系統的 Windows Server 2008 R2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=8e37196c-2f43-457d-8d87-336d8775c0bf)  
(KB2790978)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2790978)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 R2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=aadb2003-ed7b-46ee-afd0-33cec4ac39b4) (Server Core 安裝)  
(KB2790978)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
何處 可找到資訊安全更新的雜湊？  
資訊安全更新的 SHA1 和 SHA2 雜湊可用來驗證下載之資訊安全更新套件的真實性。如需此更新的相關雜湊資訊，請參閱 [Microsoft 知識庫文件編號 2790978](https://support.microsoft.com/kb/2790978)。
...
當 Windows NFS 伺服器無法在唯讀共用中適當處理檔案作業時，存在阻斷服務 (DoS) 資訊安全風險。成功利用此資訊安全風險的攻擊者將使受影響的系統停止回應並重新啟動。

若要以一般性資訊安全風險清單中的標準項目來檢視此資訊安全風險，請參閱 [CVE-2013-1281](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1281) (英文)。

#### Null 解除參照資訊安全風險 - CVE-2013-1281 的緩和因素

緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。下列緩和因素可能對您的狀況有所助益：

-   攻擊者必須擁有檔案共用的存取權，才能利用這項資訊安全風險。匿名使用者無法利用這個資訊安全風險。
-   此資訊安全風險只會影響那些已啟用 NFS 角色的 Windows 伺服器。

#### Null 解除參照資訊安全風險 - CVE-2013-1281 的緩和因素

Microsoft 尚未找到此項資訊安全風險的任何因應措施。

#### Null 解除參照資訊安全風險 - CVE-2013-1281 的常見問題集

此資訊安全風險的範圍為何？  
這是一項阻斷服務 (DoS) 的資訊安全風險。

造成此資訊安全風險的原因為何？  
造成此資訊安全風險的原因，是由於 Microsoft NFS 伺服器無法適當處理檔案作業所致。

什麼是 NFS？  
網路檔案系統 (NFS) 是一項業界標準通訊協定 (其定義請見 [RFC 1094](https://www.ietf.org/rfc/rfc1094.txt?number=1094))，可讓您以透明方式遠端存取網路間的共用檔案。Services for Network File System (NFS) 係以混用 Windows 與 UNIX 環境的企業為對象，提供檔案共用解決方案。Services for NFS 能讓使用者使用 NFS 通訊協定，在執行 Windows 作業系統的電腦與 UNIX 電腦之間傳輸檔案。

攻擊者可能會利用此資訊安全風險採取什麼行動？  
攻擊者若利用此資訊安全風險，可導致受影響的系統停止回應並重新啟動。

攻擊者如何利用此 資訊安全風險？  
攻擊者可嘗試對唯讀共用上的檔案或資料夾重新命名，從而利用這項資訊安全風險。

因為此資訊安全風險而承受風險的主要系統有哪些？  
凡是已啟用 NFS 伺服器角色的伺服器都會受到此資訊安全風險影響。

更新的作用何在？  
此更新可修正 NFS 伺服器處理檔案作業的方式，進而解決此資訊安全風險。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2790978">Microsoft 知識庫文件編號 2790978</a></td>
</tr>
<tr class="odd">
