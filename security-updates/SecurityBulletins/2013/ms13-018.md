---
TOCTitle: 'MS13-018'
Title: 'Microsoft Security Bulletin MS13-018 - 重要'
ms:assetid: 'ms13-018'
ms:contentKeyID: 61238833
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms13-018(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS13-018 - 重要
===========================================

TCP/IP 中的資訊安全風險可能會允許阻斷服務 (DoS) (2790655)
---------------------------------------------------------
...
此資訊安全更新可解決 Microsoft Windows 中一項未公開報告的資訊安全風險。如果未經驗證的攻擊者將蓄意製作的連線終止封包傳送到伺服器，則此資訊安全風險可能會允許阻斷服務 (DoS)。

對於所有受支援版本的 Windows Server 2008、Windows Server 2008 R2 和 Windows Server 2012，此資訊安全更新的等級為「重要」；對於所有受支援版本的 Windows Vista、Windows 7、Windows 8 和 Windows RT，此資訊安全更新的等級為「中度」。如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此資訊安全更新可修正 Windows TCP/IP 堆疊對連線終止序列的處理方式，進而解決此資訊安全風險。如需更多有關此資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
**已知問題。** [Microsoft 知識庫文件編號 2790655](https://support.microsoft.com/kb/2790655) 中記載目前已知客戶在安裝此資訊安全更新時可能會發生的問題。該文件並說明了解決這些問題的建議解決方案。
...
**何處可找到資訊安全更新的雜湊？**   
資訊安全更新的 SHA1 和 SHA2 雜湊可用來驗證下載之資訊安全更新套件的真實性。如需此更新的相關雜湊資訊，請參閱 [Microsoft 知識庫文件編號 2790655](https://support.microsoft.com/kb/2790655)。
...
<th style="border:1px solid black;" >
TCP FIN WAIT 資訊安全風險 - CVE-2013-0075
</th>
<th style="border:1px solid black;" >
彙總嚴重性等級
</th>
...
Windows TCP/IP 堆疊中存在阻斷服務 (DoS) 資訊安全風險，可能會導致目標系統停止回應並自動重新啟動。TCP/IP 堆疊不當處理連線終止序列，因而導致此資訊安全風險。

若要以一般性資訊安全風險清單中的標準項目來檢視此資訊安全風險，請參閱 [CVE-2013-0075](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0075) (英文)。

#### TCP FIN WAIT 資訊安全風險 - CVE-2013-0075 的緩和因素

Microsoft 尚未找到此項資訊安全風險的任何緩和因素

#### TCP FIN WAIT 資訊安全風險 - CVE-2013-0075 的因應措施

Microsoft 尚未找到此項資訊安全風險的任何因應措施。

#### TCP FIN WAIT 資訊安全風險 - CVE-2013-0075 的常見問題集

**此資訊安全風險的範圍為何？**   
這是一項阻斷服務 (DoS) 的資訊安全風險。

**造成此資訊安全風險的原因為何？**   
Windows TCP/IP 堆疊不當處理連線終止序列，因而導致此資訊安全風險。

**攻擊者可能會利用此資訊安全風險採取什麼行動？**   
成功利用此資訊安全風險的攻擊者能夠使目標系統停止回應並自動重新啟動。

**攻擊者如何利用此資訊安全風險？**   
未經驗證的攻擊者可將蓄意製作的連線終止封包傳送至伺服器，從而利用此資訊安全風險。

**因為此資訊安全風險而承受風險的主要系統有哪些？**   
伺服器受到此資訊安全風險影響的風險最高。

**更新的作用何在？**   
此更新可修正 Windows TCP/IP 堆疊對連線終止序列的處理方式，進而解決此資訊安全風險。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2790655">Microsoft 知識庫文件編號 2790655</a></td>
</tr>
<tr class="odd">
...
| **檔案資訊**                                   | 請參閱 [Microsoft 知識庫文件編號 2790655](https://support.microsoft.com/kb/2790655)                            |
...
-   V1.1 (2013 年 2 月 19 日)： 在＜提要＞的＜已知問題＞下新增 Microsoft 知識庫文件編號 2790655 的連結。
