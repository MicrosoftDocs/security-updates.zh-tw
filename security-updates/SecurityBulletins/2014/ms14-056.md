...
下表中： 「重大」、「重要」與「中度」值代表嚴重性等級。如需更多資訊，請參閱[資訊安全公告嚴重性等級系統](https://technet.microsoft.com/security/gg309177)。下列機碼中顯示的縮寫表示最嚴重的影響：
...
若要在「一般性資訊安全風險」清單標準項目中檢視此資訊安全風險，請參閱 [CVE-2014-4140](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-4140)。
