...
<td style="border:1px solid black;">
[MS14-051 中的 2976627](https://go.microsoft.com/fwlink/?linkid=507027)
...
下表中： 「重大」、「中度」與「低」值代表嚴重性等級。如需更多資訊，請參閱[資訊安全公告嚴重性等級系統](https://technet.microsoft.com/security/gg309177)。若指出 RCE (遠端執行程式碼)、資訊洩露以及資訊安全功能略過，則表示最嚴重的影響。
...
-   感謝 [KnownSec](https://www.knownsec.com/) Team 回報 Internet Explorer 記憶體損毀資訊安全風險 (CVE-2014-4084)  
