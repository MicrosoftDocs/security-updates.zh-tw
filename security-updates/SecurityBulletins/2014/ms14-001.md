...
<td style="border:1px solid black;">
[MS13-072](https://technet.microsoft.com/zh-tw/security/bulletin/ms13-072) 中的 2760769
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS13-072](https://technet.microsoft.com/zh-tw/security/bulletin/ms13-072) 中的 2767913
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS13-072](https://technet.microsoft.com/zh-tw/security/bulletin/ms13-072) 中的 2817683
</td>
</tr>
</table>
...
| 資訊安全風險標題            | CVE 編號                                                                         |
|-----------------------------|----------------------------------------------------------------------------------|
| Word 記憶體損毀資訊安全風險 | [CVE-2014-0258](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-0258) |
| Word 記憶體損毀資訊安全風險 | [CVE-2014-0259](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-0259) |
| Word 記憶體損毀資訊安全風險 | [CVE-2014-0260](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-0260) |
...
<td style="border:1px solid black;">Microsoft Word 2013 RT 的 2827224 更新是透過 <a href="https://update.microsoft.com/windowsupdate/v6/default.aspx">Windows Update</a> 提供。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>重新開機需求</strong></td>
<td style="border:1px solid black;">在某些情況下，此更新程式不需要重新開機。如果需要的檔案正在使用中，更新程式會要求重新開機。在此情況下，系統會出現訊息提示您重新開機。<br />
