...
-   [MSXML 6.0 RTM](https://www.microsoft.com/en-us/download/details.aspx?id=3988)  
-   [MSXML 6.0 Service Pack 1](https://www.microsoft.com/en-us/download/details.aspx?id=6276)  
-   [MSXML 6.0 Service Pack 2](https://www.microsoft.com/en-us/download/details.aspx?id=9774)
...
下列嚴重性等級是假設資訊安全風險可能造成的最嚴重影響而評定。在本資訊安全公告發行的 30 天內，如需資訊安全風險之易遭利用性與嚴重性等級和資訊安全影響之間對應關係的資訊，請參閱 [6 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms14-jun)中的＜資訊安全風險索引＞。如需更多資訊，請參閱 [Microsoft 資訊安全風險入侵指數](https://technet.microsoft.com/security/cc998259)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2014-1816](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-1816)。
...
**什麼元件會受到此資訊安全風險的影響？**  
該資訊安全風險會影響到 Microsoft XML Core Services (MSXML，可讓使用 JScript、Visual Basic Scripting Edition (VBScript) 和 Microsoft Visual Studio 6.0 的客戶開發 XML 型應用程式，針對其他符合 XML 1.0 標準的應用程式，提供互通性)。如需更多資訊，請瀏覽 Microsoft Developer Network 的 [MSXML](https://msdn.microsoft.com/en-us/library/ms763742.aspx) 文章。
