...
<td style="border:1px solid black;">
[MS13-052 中的 2833940](https://go.microsoft.com/fwlink/?linkid=299844)
...
<td style="border:1px solid black;">
[MS13-052 中的 2835393](https://go.microsoft.com/fwlink/?linkid=299844)
...
<td style="border:1px solid black;">
[MS13-052 中的 2833947](https://go.microsoft.com/fwlink/?linkid=299844)
...
<td style="border:1px solid black;">
[MS13-052 中的 2833946](https://go.microsoft.com/fwlink/?linkid=299844)
...
<td style="border:1px solid black;">
[MS13-052 中的 2833959](https://go.microsoft.com/fwlink/?linkid=299844)
...
<td style="border:1px solid black;">
[MS13-052 中的 2833958](https://go.microsoft.com/fwlink/?linkid=299844)
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2014-0253](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-0253)。
...
-   **設定 &lt;serverRuntime&gt;、&lt;requestLimits&gt; 和 &lt;httpRuntime&gt; 項目，以拒絕嘗試利用這項資訊安全風險的要求**
    ...
    1.  請將 **httpRuntime/maxRequestLength** 屬性設為適用於您應用程式的特定值。預設值為 4096 KB。
        如需關於此屬性的詳細資訊，請參閱 [httpRuntime 項目 (ASP.NET 設定結構描述)](https://msdn.microsoft.com/library/e1f13641(v=vs.100).aspx)。
    2.  將 **requestLimits/maxAllowedContentLength** 屬性設為與步驟 1 中設定之 maxRequestLength 相等的值。請注意，這個值是以位元組 (B) 而非千位元組 (KB) 為單位指定。
        如需關於此屬性的詳細資訊，請參閱[要求限制 &lt;requestLimits&gt;](https://www.iis.net/configreference/system.webserver/security/requestfiltering/requestlimits) (英文)。
    3.  將 **serverRuntime/uploadReadAheadSize** 屬性設為與步驟 1 中設定之 maxRequestLength 相等的值。請注意，這個值是以位元組 (B) 而非千位元組 (KB) 為單位指定。
        如需關於此屬性的詳細資訊，請參閱[伺服器執行階段 &lt;serverRuntime&gt;](https://www.iis.net/configreference/system.webserver/serverruntime) (英文)。
...
是。此資訊安全風險已經遭到公開揭發。這項資訊安全風險已被指派一般性資訊安全風險編號 [CVE-2014-0253](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-0253)。
...
若要以一般性資訊安全風險清單中的標準項目來檢視此資訊安全風險，請參閱 [CVE-2014-0257](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-0257)。
...
若要以一般性資訊安全風險清單中的標準項目來檢視此資訊安全風險，請參閱 [CVE-2014-0295](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-0295)。
...
-   **安裝 Force ASLR 功能 Hotfix 與啟用 IFEO 登錄項目**
    ...
    如需更多資訊及安裝指示，請參閱 [Microsoft 知識庫文件編號 2639308](https://support.microsoft.com/kb/2639308)。

    **因應措施的影響。** 強制重新配置並非運用 ASLR 支援建立的映像，可能導致應用程式相容性問題。

    **如何復原因應措施。 **

    **注意：**請參閱 [Microsoft 知識庫文件編號 2639308](https://support.microsoft.com/kb/2639308)，以瞭解將 IFEO 登錄項目設為預設設定的相關資訊。
...
如需更多關於 EMET 的資訊，請參閱 [The Enhanced Mitigation Experience Toolkit](https://support.microsoft.com/kb/2458544)。

**這項更新有何作用？ 
**此更新可協助確保 .NET Framework 元件適當實作 ASLR，以解決此項資訊安全風險。

**本資訊安全公告發行時，這項資訊安全風險是否已公開揭露？ 
**是。此資訊安全風險已經遭到公開揭發。這項資訊安全風險已被指派一般性資訊安全風險編號 [CVE-2014-0295](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-0295)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2916607">Microsoft 知識庫文件編號 2916607</a></td>
</tr>
<tr class="odd">
...
2901119 更新是透過 <a href="https://go.microsoft.com/fwlink/?linkid=21130">Windows Update</a> 提供。<br />
2898865 更新是透過 <a href="https://go.microsoft.com/fwlink/?linkid=21130">Windows Update</a> 提供。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><br />
</td>
<td style="border:1px solid black;">Windows RT 上的 Microsoft .NET Framework 4.5.1：<br />
2901127 更新是透過 <a href="https://go.microsoft.com/fwlink/?linkid=21130">Windows Update</a> 提供。<br />
2898870 更新是透過 <a href="https://go.microsoft.com/fwlink/?linkid=21130">Windows Update</a> 提供。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><br />
</td>
<td style="border:1px solid black;">Windows RT 8.1 上的 Microsoft .NET Framework 4.5.1：<br />
2901128 更新是透過 <a href="https://go.microsoft.com/fwlink/?linkid=21130">Windows Update</a> 提供。<br />
2898871 更新是透過 <a href="https://go.microsoft.com/fwlink/?linkid=21130">Windows Update</a> 提供。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>重新開機需求</strong></td>
