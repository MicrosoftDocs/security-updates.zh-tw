...
<tr>
<td style="border:1px solid black;">
[適用於 32 位元系統的 Windows 7 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=f142e0b9-d289-4341-98b5-67c031c68180)  
(2978668)
...
<tr>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows 7 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=d8109881-1dd4-4de0-b45d-0d859787373e)  
(2978668)
...
<tr>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=5b94058e-6dd9-4f4b-bf85-661650fe0e8f)  
(2978668)
...
<tr>
<td style="border:1px solid black;">
[適用於 Itanium 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=f3f1e6c2-23c6-4663-981a-fed9091736ab)  
(2978668)
...
<tr>
<td style="border:1px solid black;">
[適用於 32 位元系統的 Windows 8](https://www.microsoft.com/download/details.aspx?familyid=a0989907-ca6f-45fa-bdaa-c99682fb8abd)  
(2978668)
...
<tr>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows 8](https://www.microsoft.com/download/details.aspx?familyid=3478695d-af48-43cb-872d-71ca9d09d000)  
(2978668)
...
<tr>
<td style="border:1px solid black;">
[適用於 32 位元系統的 Windows 8.1\[](https://www.microsoft.com/download/details.aspx?familyid=99125964-e3d0-4619-b106-7cec9e71178b)<sup>[1]</sup>
(2978668)
...
<tr>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows 8.1](https://www.microsoft.com/download/details.aspx?familyid=5a4d58eb-b0c2-4c98-a15c-850e4bf51dd7)<sup>[1]</sup>
(2978668)
...
<tr>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=5b94058e-6dd9-4f4b-bf85-661650fe0e8f) (Server Core 安裝)  
(2978668)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012](https://www.microsoft.com/download/details.aspx?familyid=7c963fba-9c6e-4443-af48-e3da765b6964) (Server Core 安裝)  
(2978668)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012 R2](https://www.microsoft.com/download/details.aspx?familyid=6bf31270-1fa8-4ce2-8c87-dff587044410)<sup>[1]</sup> (Server Core 安裝)  
(2978668)
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2014-0316](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-0316)。
...
**什麼是遠端程序呼叫 (RPC)？**  
Microsoft 遠端程序呼叫 (RPC) 是一種程序間的通訊 (IPC) 機制，可允許資料交換和呼叫位於不同程序中的功能。該程序可以在同一部電腦、區域網路 (LAN) 或網際網路上。Microsoft RPC 機制會使用其他 IPC 機制，例如具名管道、NetBIOS 或 Winsock，來建立用戶端和伺服器之間的通訊。使用 RPC 後，重要的程式邏輯和相關的程序程式碼就可以存在於不同的電腦上，而這對於分散式應用程式而言非常重要。如需更多資訊，請參閱[什麼是 RPC？](https://technet.microsoft.com/en-us/library/cc787851(ws.10).aspx) (英文)

**什麼是 LRPC？**  
本機 RPC (LRPC) 是 Microsoft RPC 的元件。LRPC 會於內部使用 LPC 做為在兩個處理序之間傳遞訊息的傳輸機制。

**什麼是程序間的通訊 (IPC)？**  
Microsoft Windows 作業系統提供許多機制，以促進應用程式之間的通訊和資料共用。整體而言，這些機制所啟用的活動就稱為程序間的通訊 (IPC)。某些形式的 IPC 可以促進幾個特定程序之間的分工。其他形式的 IPC 則可促進網路上的電腦之間的分工。如需更多資訊，請參閱[程序間的通訊](https://msdn.microsoft.com/en-us/library/aa365574(vs.85).aspx)(英文)。
