...
若要在「一般性資訊安全風險」清單標準項目中檢視此資訊安全風險，請參閱 [CVE-2014-4072](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-4072)。
...
-   **為桌面應用程式啟用 UseRandomizedStringHashAlgorithm 應用程式組態執行階段設定。**
    ...
    如需更多資訊，請參閱 Microsoft Developer Network 項目，[&lt;UseRandomizedStringHashAlgorithm&gt; 元素](https://msdn.microsoft.com/en-us/library/jj152924(v=vs.110).aspx) (英文)。
...
2977766 更新是透過 <a href="https://go.microsoft.com/fwlink/?linkid=21130">Windows Update</a> 提供。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><br />
</td>
<td style="border:1px solid black;">Windows RT 8.1 上的 Microsoft .NET Framework 4.5.1/4.5.2：<br />
2977765 更新是透過 <a href="https://go.microsoft.com/fwlink/?linkid=21130">Windows Update</a> 提供。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>重新開機需求</strong></td>
