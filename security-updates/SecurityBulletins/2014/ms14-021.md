...
**建議。** 大部分客戶都已啟用自動更新，並且不必須採取任何行動，因為資訊安全更新將自動下載和安裝。如需有關自動更新中特定設定選項的資訊，請參閱 [Microsoft 知識庫文件編號 294871](https://support.microsoft.com/kb/294871)。對於沒有啟用自動更新的客戶，可採取[開啟或關閉自動更新](https://windows.microsoft.com/zh-tw/windows/turn-automatic-updating-on-off)中的步驟來啟用自動更新。
...
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=393743">MS14-018</a> (請注意，這是 Internet Explorer 10 的非資訊安全更新)</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Windows 7 或 Windows Server 2008 R2 上的 Internet Explorer 11</td>
<td style="border:1px solid black;">對於 2964444 更新： <a href="https://go.microsoft.com/fwlink/?linkid=392064">MS14-012</a> (請注意，MS14-018 並非 Internet Explorer 11 的積存更新)<br />
<br />
