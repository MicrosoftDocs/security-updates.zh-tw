...
**注意：** 在受支援版本的 Windows Server 2008 上，依預設不會安裝筆記本元件。在此作業系統上，只有在[桌面體驗](http://support.microsoft.com/kb/947036)功能為啟用的情況下，才適用筆記本的更新。
  
**注意：** 在受支援版本的 Windows Server 2008 R2 上，只有在[筆跡和手寫服務](http://technet.microsoft.com/en-us/library/dd759248.aspx)功能為啟用的情況下，才適用筆記本的更新。
  
**注意：** 在受支援版本的 Windows Server 2012 上，只有在[筆跡和手寫服務](http://technet.microsoft.com/en-us/library/dd759248.aspx)功能為啟用的情況下，才適用筆記本的更新。
  
**注意** 在受支援版本的 Windows Server 2012 R2 上，只有在[筆跡和手寫服務](http://technet.microsoft.com/en-us/library/dd759248.aspx)功能為啟用的情況下，才適用筆記本的更新。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2014-1824](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-1824)。
