...
<sup>[1]</sup>此更新只能從 [Microsoft 下載中心](https://www.microsoft.com/zh-tw/download/search.aspx?q=security%20update)、[Microsoft Dynamics CustomerSource](https://www.microsoft.com/dynamics/customer/access-customersource/default.aspx) 和 [Microsoft Dynamics PartnerSource](https://mbs.microsoft.com/partnersource/) 中取得。
...
由於 Microsoft Dynamics AX 更新的服務模式，Microsoft 只將這些更新發行至 [Microsoft 下載中心](https://www.microsoft.com/zh-tw/download/search.aspx?q=security%20update)、[Microsoft Dynamics CustomerSource](https://www.microsoft.com/dynamics/customer/access-customersource/default.aspx) 和 [Microsoft Dynamics PartnerSource](https://mbs.microsoft.com/partnersource/)。
...
若要以一般性資訊安全風險清單中的標準項目來檢視此資訊安全風險，請參閱 [CVE-2014-0261](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-0261)。
...
<span></span>
這些資訊安全更新只能從 [Microsoft 下載中心](https://www.microsoft.com/zh-tw/download/search.aspx?q=security%20update)、[Microsoft Dynamics CustomerSource](https://www.microsoft.com/dynamics/customer/access-customersource/default.aspx) 和 [Microsoft Dynamics PartnerSource](https://mbs.microsoft.com/partnersource/) 中取得。
