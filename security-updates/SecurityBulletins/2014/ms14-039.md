...
是。此更新會新增新的安全性相關旗標至開發人員用於製作低層級鍵盤和滑鼠輸入勾點的結構。若需功能變更的詳細資訊，請參閱 [KBDLLHOOKSTRUCT 結構](https://msdn.microsoft.com/en-us/library/windows/desktop/ms644967(v=vs.85).aspx) (英文) 與 [MSLLHOOKSTRUCT 結構](https://msdn.microsoft.com/en-us/library/windows/desktop/ms644970(v=vs.85).aspx) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2014-2781](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-2781)。
...
**這項更新有何作用？**  
此更新會修正某些程式與完整性層級不同之程式的溝通方式，藉此解決此資訊安全風險。若需更多功能變更的詳細資訊，請參閱 [KBDLLHOOKSTRUCT 結構](https://msdn.microsoft.com/en-us/library/windows/desktop/ms644967(v=vs.85).aspx) (英文) 與 [MSLLHOOKSTRUCT 結構](https://msdn.microsoft.com/en-us/library/windows/desktop/ms644970(v=vs.85).aspx) (英文)。
