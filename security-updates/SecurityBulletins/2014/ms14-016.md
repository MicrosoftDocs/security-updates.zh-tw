...
<td style="border:1px solid black;">
[MS13-032 中的 2801109](https://go.microsoft.com/fwlink/?linkid=280660)
...
<tr>
<td style="border:1px solid black;">
[適用於 Itanium 型系統的 Windows Server 2003 SP2](https://www.microsoft.com/download/details.aspx?familyid=c079f55c-0046-4257-a45b-b6ac173c3e86)  
(已安裝 Active Directory)  
(2923392)
...
<td style="border:1px solid black;">
[MS13-032 中的 2772930](https://go.microsoft.com/fwlink/?linkid=280660)
...
<tr>
<td style="border:1px solid black;">
[適用於 32 位元系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=50cfb145-6f71-4d7e-8598-4078c7b1ab30)  
...
<tr>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e55cd385-21da-4a13-b965-be75d8195768)  
(已安裝 Active Directory 網域服務 (AD DS) 或 Active Directory 輕量型目錄服務 (AD LDS) 時)  
(2923392)
...
<tr>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=04e3b3bd-e7e4-413b-893e-9324a00d2bd8)  
...
<tr>
<td style="border:1px solid black;">
[適用於 32 位元系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=50cfb145-6f71-4d7e-8598-4078c7b1ab30) (Server Core 安裝)  
(已安裝 Active Directory 網域服務 (AD DS) 或 Active Directory 輕量型目錄服務 (AD LDS) 時)  
(2923392)
...
<tr>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e55cd385-21da-4a13-b965-be75d8195768) (Server Core 安裝)  
(已安裝 Active Directory 網域服務 (AD DS) 或 Active Directory 輕量型目錄服務 (AD LDS) 時)  
(2923392)
...
<tr>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=04e3b3bd-e7e4-413b-893e-9324a00d2bd8) (Server Core 安裝)  
(已安裝 Active Directory 網域服務 (AD DS) 角色時)  
(2923392)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012](https://www.microsoft.com/download/details.aspx?familyid=423a5216-7f79-4b52-9e08-ebb81d698d8b) (Server Core 安裝)  
(已安裝 Active Directory)  
(2923392)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012 R2](https://www.microsoft.com/download/details.aspx?familyid=f2a11309-4764-4cc7-a415-88a0c447e0ed) (Server Core 安裝)  
(已安裝 Active Directory)  
(2923392)
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2014-0317](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-0317)。
