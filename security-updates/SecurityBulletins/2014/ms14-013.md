...
-   如果您用的是 Windows Server 2008，請參閱 [Microsoft 知識庫文件編號 947036](http://support.microsoft.com/kb/947036?ln=zh-tw)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2014-0301](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-0301)。
