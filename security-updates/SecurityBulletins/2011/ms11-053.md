...
**已知問題。**[Microsoft 知識庫文件編號 2566220](https://support.microsoft.com/kb/2566220/zh-tw) 中記載了客戶安裝此資訊安全更新時，可能會發生的目前已知問題。 該文件並說明了解決這些問題的建議解決方案。
...
Windows Vista Service Pack 1 只有在支援 Bluetooth 2.1 技術的系統上才會受影響。 已安裝 [Windows Vista Feature Pack for Wireless](https://support.microsoft.com/kb/942567) 的 Windows Vista Service Pack 1 客戶可支援 Bluetooth 2.1 技術，因此會受這個資訊安全風險影響。 這些客戶將需要安裝資訊安全更新 KB2561109。尚未安裝 Windows Vista Feature Pack for Wireless 的客戶不支援 Bluetooth 2.1，因此不會受這個資訊安全風險影響。 如需更多資訊，請參閱 [Microsoft 知識庫文件編號 2566220](https://support.microsoft.com/kb/2566220/zh-tw)。
...
已針對 Windows Vista Service Pack 1 啟用 [Windows Vista Feature Pack for Wireless](https://support.microsoft.com/kb/942567)，並已成功升級至 Windows Vista Service Pack 2 的 Windows Vista Service Pack 1 客戶將需要安裝資訊安全更新 KB2532531。如需更多資訊，請參閱 [Microsoft 知識庫文件編號 2566220](https://support.microsoft.com/kb/2566220/zh-tw)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-1265](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1265) (英文)。
...
**什麼是 Bluetooth？**    
Bluetooth 是一項業界標準通訊協定，可讓電腦、手持裝置，行動電話，和其他裝置進行無線連線。 如需更多資訊，請參閱 MSDN 文章 [Bluetooth](https://msdn.microsoft.com/zh-tw/library/aa362932(vs.85).aspx) (英文)。
...
是。 Windows Vista 和 Windows 7 支援各種 Bluetooth 無線裝置，並會在系統新增卸除式 Bluetooth 裝置時安裝 Bluetooth 驅動程式。 因此，所有受支援版本的 Windows Vista 和 Windows 7 都會受影響。 如需更多資訊，請參閱 MSDN 文章：[Bluetooth 無線技術常見問題集 - 2010](https://msdn.microsoft.com/zh-tw/windows/hardware/gg487349.aspx) (英文)。
...
請參閱 <a href="https://support.microsoft.com/kb/2561109/zh-tw">Microsoft 知識庫文件編號 2561109</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於 Windows Vista Service Pack 2：<br />
請參閱 <a href="https://support.microsoft.com/kb/2532531/zh-tw">Microsoft 知識庫文件編號 2532531</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2532531/zh-tw">Microsoft 知識庫文件編號 2532531</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;"><strong>注意：</strong>登錄機碼不存在，無法驗證此更新是否存在。</td>
