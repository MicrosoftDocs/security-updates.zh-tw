...
**已知問題。**[Microsoft 知識庫文件編號 2500212](https://support.microsoft.com/kb/2500212) 中記載了客戶安裝此安全性更新時，可能會發生的目前已知問題。該文件並說明了解決這些問題的建議解決方案。
...
是的，此更新所解決的弱點與 [Microsoft 安全性摘要報告 2269637](https://technet.microsoft.com/security/advisory/2269637) 中說明的弱點類別相關，該弱點會影響應用程式載入外部程式庫的方式。此安全性更新可解決此類型弱點的一個特定執行個體。
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-3190](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3190) (英文)。
...
是。這項弱點已經遭到公開揭發。這項弱點已被指派「一般性弱點」編號 [CVE-2010-3190](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3190)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2465373">Microsoft 知識庫文件編號 2465373</a></td>
</tr>
<tr class="even">
...
**注意** ：您可以在同一個命令中合併使用這些參數。為符合回溯相容性，安全性更新程式也支援舊版安裝程式使用的安裝參數中的許多參數。有關支援的安裝參數的其他資訊，請參閱[這篇 Microsoft MSDN 文章](https://msdn.microsoft.com/en-us/library/aa372024(vs.85).aspx)。
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2538218">Microsoft 知識庫文件編號 2538218</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2538241">Microsoft 知識庫文件編號 2538241</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
...
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">Microsoft Visual Studio 2010：<br />
請參閱 <a href="https://support.microsoft.com/kb/2542054">Microsoft 知識庫文件編號 2542054</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Visual Studio 2010 Service Pack 1：<br />
請參閱 <a href="https://support.microsoft.com/kb/2565057">Microsoft 知識庫文件編號 2565057</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">Microsoft Visual Studio 2010：<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2538242">Microsoft 知識庫文件編號 2538242</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">Microsoft Visual C++ 2005 Service Pack 1 可轉散發套件 (x86)：<br />
...
<br />
如需瞭解如何使用產品代碼進行安裝驗證，請參閱 <a href="https://support.microsoft.com/kb/974653">Microsoft 知識庫文件編號 974653</a>。</td>
</tr>
</tbody>
</table>
...
如需瞭解如何使用產品代碼進行安裝驗證，請參閱 [Microsoft 知識庫文件編號 974653](https://support.microsoft.com/kb/974653)。
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2538243">Microsoft 知識庫文件編號 2538243</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">Microsoft Visual C++ 2008 Service Pack 1 Redistributable Package (x86)：<br />
...
請參閱 <a href="https://support.microsoft.com/kb/2467173">Microsoft 知識庫文件編號 2467173</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Visual C++ 2010 Redistributable Package Service Pack 1：<br />
請參閱 <a href="https://support.microsoft.com/kb/2565063">Microsoft 知識庫文件編號 2565063</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
