...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------|----------------|---------------------------------------------------------------------|
| [Windows XP Service Pack 3 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=6753ca98-feb4-4c7f-9969-9294038a2bbb&displaylang=zh-tw)                      | 遠端執行程式碼   | 重要           | [MS10-067](http://technet.microsoft.com/security/bulletin/ms10-067) |
| [Windows XP Professional x64 Edition Service Pack 2 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=3c94bc96-99ea-44a1-9052-e69de5e21f81)               | 遠端執行程式碼   | 重要           | [MS10-067](http://technet.microsoft.com/security/bulletin/ms10-067) |
| [Windows Server 2003 Service Pack 2 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=9fbfc742-6c74-49a2-b3cc-e1d5d8c84b77&displaylang=zh-tw)             | 遠端執行程式碼   | 重要           | [MS10-067](http://technet.microsoft.com/security/bulletin/ms10-067) |
| [Windows Server 2003 x64 Edition Service Pack 2 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=897b97b0-1bab-4b1b-b417-950fab0d4a65&displaylang=zh-tw) | 遠端執行程式碼   | 重要           | [MS10-067](http://technet.microsoft.com/security/bulletin/ms10-067) |
| [適用於 Itanium 型系統的 Windows Server 2003 SP2 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=ede38974-4e57-4ea1-8731-b91e96534693)                  | 遠端執行程式碼   | 重要           | [MS10-067](http://technet.microsoft.com/security/bulletin/ms10-067) |
