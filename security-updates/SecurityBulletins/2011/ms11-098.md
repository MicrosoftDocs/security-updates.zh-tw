...
**建議。** 若是系統管理員和企業安裝，或是想要手動安裝此安全性更新的使用者，Microsoft 建議客戶使用更新管理軟體，立即套用更新，或使用 [Microsoft Update](http://go.microsoft.com/fwlink/?linkid=40747) 服務檢查更新。

另請參閱本公告下文的＜偵測與部署工具及指南＞一節。

**已知問題。**[Microsoft 知識庫文件編號 2633171](http://support.microsoft.com/kb/2633171) 中記載了客戶安裝此安全性更新時，可能會發生的目前已知問題。該文件並說明了解決這些問題的建議解決方案。
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|----------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=7a6fcf8d-8c7b-4882-90d3-02db79a75238)                                                      | 權限提高       | 重要           | [MS10-047](http://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=281e5bd4-4582-4aa9-af88-518ad3152132)                                             | 權限提高       | 重要           | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a6c7c960-768d-40d4-8fe5-7d59f48ead1d)                                                   | 權限提高       | 重要           | [MS11-068](http://go.microsoft.com/fwlink/?linkid=223578) |
| [適用於 32 位元系統的 Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5a4443f8-fec8-42be-ad67-8475920f1460)\*                      | 權限提高       | 重要           | [MS11-068](http://go.microsoft.com/fwlink/?linkid=223578) |
| [適用於 32 位元系統的 Windows 7 和適用於 32 位元系統的 Windows 7 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=eb2bd108-5ef1-45be-9157-e7cbfc8afd2a) | 權限提高       | 重要           | [MS11-068](http://go.microsoft.com/fwlink/?linkid=223578) |
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2011-2018](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2018) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2633171">Microsoft 知識庫文件編號 2633171</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
請參閱 [Microsoft 知識庫文件編號 2633171](http://support.microsoft.com/kb/2633171)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   感謝 Matthew Jurczyk 與 [VeriSign iDefense Labs](http://labs.idefense.com/) 合作，回報 Windows 核心例外處理常式弱點 (CVE-2011-2018)
