---
TOCTitle: 'MS11-098'
Title: 'Microsoft Security Bulletin MS11-098 - 重要'
ms:assetid: 'ms11-098'
ms:contentKeyID: 61238730
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms11-098(v=Security.10)'
---

Microsoft Security Bulletin MS11-098 - 重要
===========================================

Windows 核心中的弱點可能會允許權限提高 (2633171)
------------------------------------------------

發行: 2011年12月13日 | 更新: 2012年2月1日
...
這個安全性更新可解決 Microsoft Windows 中一項未公開報告的弱點。如果攻擊者登入受影響的系統，並執行蓄意製作的應用程式來利用弱點，則此弱點可能會允許權限提高。攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項弱點。匿名或遠端使用者無法利用這個弱點。

對於所有受支援 32 位元版本的 Windows XP、Windows Server 2003、Windows Vista、Windows Server 2008 與 Windows 7，此安全性更新的等級為「重要」。如需詳細資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此安全性更新可協助確保 Windows 核心初始化記憶體中的物件，以解決此弱點。如需更多有關此弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。

**建議。** 若是系統管理員和企業安裝，或是想要手動安裝此安全性更新的使用者，Microsoft 建議客戶使用更新管理軟體，立即套用更新，或使用 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 服務檢查更新。

另請參閱本公告下文的＜偵測與部署工具及指南＞一節。

**已知問題。**[Microsoft 知識庫文件編號 2633171](https://support.microsoft.com/kb/2633171) 中記載了客戶安裝此安全性更新時，可能會發生的目前已知問題。該文件並說明了解決這些問題的建議解決方案。
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|----------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=7a6fcf8d-8c7b-4882-90d3-02db79a75238)                                                      | 權限提高       | 重要           | [MS10-047](https://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=281e5bd4-4582-4aa9-af88-518ad3152132)                                             | 權限提高       | 重要           | [MS10-021](https://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=a6c7c960-768d-40d4-8fe5-7d59f48ead1d)                                                   | 權限提高       | 重要           | [MS11-068](https://go.microsoft.com/fwlink/?linkid=223578) |
| [適用於 32 位元系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=5a4443f8-fec8-42be-ad67-8475920f1460)\*                      | 權限提高       | 重要           | [MS11-068](https://go.microsoft.com/fwlink/?linkid=223578) |
| [適用於 32 位元系統的 Windows 7 和適用於 32 位元系統的 Windows 7 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=eb2bd108-5ef1-45be-9157-e7cbfc8afd2a) | 權限提高       | 重要           | [MS11-068](https://go.microsoft.com/fwlink/?linkid=223578) |
...
<th style="border:1px solid black;" >Windows 核心例外處理常式弱點 - CVE-2011-2018</th>
...
Windows 核心例外處理常式弱點 - CVE-2011-2018  
--------------------------------------------
  
由於核心存取尚未正確初始化物件的方式，導致 Windows 核心中存在權限提高的弱點。成功利用此弱點的攻擊者可以在核心模式下執行任意程式碼。攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2011-2018](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2018) (英文)。
  
#### Windows 核心例外處理常式弱點 - CVE-2011-2018 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少弱點影響的嚴重性。下列緩和因素可能對您的狀況有所助益：
  
-   攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項弱點。匿名或遠端使用者無法利用這個弱點。
  
#### Windows 核心例外處理常式弱點 - CVE-2011-2018 的因應措施
  
Microsoft 尚未找到此項弱點的任何因應措施。
  
#### Windows 核心例外處理常式弱點 - CVE-2011-2018 的常見問題集
  
**這個弱點的範圍為何？**  
這是權限提高的弱點。成功利用此弱點的攻擊者可執行任意程式碼，並取得受影響之系統的完整控制權。攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個弱點的原因為何？**  
當 Windows 核心存取尚未正確初始化的物件時，便會形成此弱點。
...
**更新的作用何在？**  
此更新可協助確保 Windows 核心初始化記憶體中的物件，以解決此弱點。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB2633171$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2633171">Microsoft 知識庫文件編號 2633171</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
使用 \[控制台\] 中的 \[新增或移除程式\] 工具，或是 %Windir%\\$NTUninstallKB2633171$\\Spuninst 資料夾中的 Spuninst.exe 公用程式
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
請參閱 [Microsoft 知識庫文件編號 2633171](https://support.microsoft.com/kb/2633171)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   感謝 Matthew Jurczyk 與 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作，回報 Windows 核心例外處理常式弱點 (CVE-2011-2018)
...
-   V1.1 (2011 年 2 月 1 日)： 在＜提要＞的＜已知問題＞下新增 Microsoft 知識庫文件編號 2633171 的連結。
