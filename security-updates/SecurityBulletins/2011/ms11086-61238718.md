...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=8c7c21c5-677d-4a5d-8f2b-8ca7691b6b00">Active Directory 應用程式模式 (ADAM)</a><br />
(KB2616310)<br />
(英文下載更新程式)  
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=8c7c21c5-677d-4a5d-8f2b-8ca7691b6b00&amp;displaylang=zh-tw">Active Directory 應用程式模式 (ADAM)</a><br />
(KB2616310)<br />
(中文下載更新程式)
</div></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/zh-tw/security/bulletin/ms10-068">MS10-068</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=989cca2d-cce1-4f52-b50e-43152693f240">Active Directory 應用程式模式 (ADAM)</a><br />
(KB2616310)  
<div>
(英文下載更新程式)
</div></td>
...
(英文下載更新程式)  
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=08b27ce7-c32e-41e4-ad04-481c5eab17a7&amp;displaylang=zh-tw">Active Directory</a><br />
(KB2601626)<br />
(中文下載更新程式)  
</div>
<div>
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=f116824e-ea48-422d-b284-c9ffa7604bf5">Active Directory 應用程式模式 (ADAM)</a><br />
(KB2616310)<br />
(英文下載更新程式)  
</div>
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=f116824e-ea48-422d-b284-c9ffa7604bf5&amp;displaylang=zh-tw">Active Directory 應用程式模式 (ADAM)</a><br />
(KB2616310)<br />
(中文下載更新程式)
</div></td>
<td style="border:1px solid black;">權限提高</td>
...
(KB2601626)<br />
(英文下載更新程式)<br />
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=de5a74f2-2cc8-4677-b495-3a40fe3d6b9e&amp;displaylang=zh-tw">Active Directory</a><br />
(KB2601626)<br />
(中文下載更新程式)  
<div>
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=1af1b734-62c7-4e08-91c8-90b6d026da84">Active Directory 應用程式模式 (ADAM)</a><br />
(KB2616310)<br />
(英文下載更新程式)  
</div>
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=1af1b734-62c7-4e08-91c8-90b6d026da84&amp;displaylang=zh-tw">Active Directory 應用程式模式 (ADAM)</a><br />
(KB2616310)<br />
(中文下載更新程式)
</div></td>
<td style="border:1px solid black;">權限提高</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=2bd602cf-ae0d-4790-a5d0-6133fd7d01a0">Active Directory 輕量型目錄服務 (AD LDS)</a><br />
(KB2601626)<br />
(英文下載更新程式)  
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=2bd602cf-ae0d-4790-a5d0-6133fd7d01a0&amp;displaylang=zh-tw">Active Directory 輕量型目錄服務 (AD LDS)</a><br />
(KB2601626)<br />
(中文下載更新程式)
</div></td>
<td style="border:1px solid black;">權限提高</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=783521ad-5c50-4194-a582-4e5a1c9999e7">Active Directory 輕量型目錄服務 (AD LDS)</a><br />
(KB2601626)<br />
(英文下載更新程式)  
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=783521ad-5c50-4194-a582-4e5a1c9999e7&amp;displaylang=zh-tw">Active Directory 輕量型目錄服務 (AD LDS)</a><br />
(KB2601626)<br />
(中文下載更新程式)
</div></td>
<td style="border:1px solid black;">權限提高</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b5688923-3914-4f6c-8bc9-036fb4870cc6">Active Directory 和 Active Directory 輕量型目錄服務 (AD LDS)</a>*<br />
(KB2601626)<br />
(英文下載更新程式)  
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=b5688923-3914-4f6c-8bc9-036fb4870cc6&amp;displaylang=zh-tw">Active Directory 和 Active Directory 輕量型目錄服務 (AD LDS)</a>*<br />
(KB2601626)<br />
(中文下載更新程式)
</div></td>
<td style="border:1px solid black;">權限提高</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=51f47181-08f6-4de1-80e5-253355675965">Active Directory 和 Active Directory 輕量型目錄服務 (AD LDS)</a>*<br />
(KB2601626)<br />
(英文下載更新程式)  
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=51f47181-08f6-4de1-80e5-253355675965&amp;displaylang=zh-tw">Active Directory 和 Active Directory 輕量型目錄服務 (AD LDS)</a>*<br />
(KB2601626)<br />
(中文下載更新程式)
</div></td>
<td style="border:1px solid black;">權限提高</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b06f9f55-e3b2-4705-83d0-1b9f5de9d378">Active Directory 輕量型目錄服務 (AD LDS)</a><br />
(KB2601626)<br />
(英文下載更新程式)  
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=b06f9f55-e3b2-4705-83d0-1b9f5de9d378&amp;displaylang=zh-tw">Active Directory 輕量型目錄服務 (AD LDS)</a><br />
(KB2601626)<br />
(中文下載更新程式)
</div></td>
<td style="border:1px solid black;">權限提高</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=790f1d99-96a5-438d-b433-895b692912ce">Active Directory 輕量型目錄服務 (AD LDS)</a><br />
(KB2601626)<br />
(英文下載更新程式)  
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=790f1d99-96a5-438d-b433-895b692912ce&amp;displaylang=zh-tw">Active Directory 輕量型目錄服務 (AD LDS)</a><br />
(KB2601626)<br />
(中文下載更新程式)
</div></td>
<td style="border:1px solid black;">權限提高</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=cc1e99af-fc67-400b-a82c-171f8c4d1ac9">Active Directory 和 Active Directory 輕量型目錄服務 (AD LDS)</a>*<br />
(KB2601626)<br />
(英文下載更新程式)  
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=cc1e99af-fc67-400b-a82c-171f8c4d1ac9&amp;displaylang=zh-tw">Active Directory 和 Active Directory 輕量型目錄服務 (AD LDS)</a>*<br />
(KB2601626)<br />
(中文下載更新程式)
</div></td>
<td style="border:1px solid black;">權限提高</td>
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-2014](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2014) (英文)。
...
-   除使用 LDAPS 外，於「一律檢查 CRL」模式中***使用*** ***IPsec***型連線。
    ...
    如需關於如何為 IPsec 啟用 CRL 檢查的資訊，請參閱 TechNet 文章，[憑證撤銷清單 (CRL) 驗證 - 應用程式選擇](http://social.technet.microsoft.com/wiki/contents/articles/964.aspx)。
...
Active Directory 輕量型目錄服務 (AD LDS) 是獨立模式的 Active Directory，提供專屬的目錄服務供應用程式使用。AD LDS 適用於 Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2。AD LDS 取代了 Windows XP 和 Windows Server 2003 中的 Active Directory 應用程式模式 (ADAM)。如需 AD LDS 的詳細資訊，請參閱 TechNet 文章：[Active Directory 輕量型目錄服務](http://technet.microsoft.com/en-us/library/cc731868(ws.10).aspx)。

什麼是 Active Directory 應用程式模式？   
Active Directory 應用程式模式 (ADAM) 是一種輕量型目錄存取通訊協定 (LDAP) 目錄服務，是以 Windows XP 和 Windows Server 2003 使用者服務的形式執行，而非系統服務。如需 ADAM 的詳細資訊，請參閱 TechNet 文章：[ADAM 簡介](http://technet.microsoft.com/en-us/library/cc780837(ws.10).aspx)。
...
什麼是憑證撤銷清單 (CRL)？  
CRL 是 CA 所發行、經數位簽署的一份清單，其中列出由 CA 所發行、而隨後經 CA 撤銷的憑證。針對每一份撤銷的憑證，這份清單皆包含憑證的序號、撤銷憑證的日期，以及撤銷原因。應用程式可執行 CRL 檢查，來判斷目前憑證的撤銷狀態。如需憑證撤銷檢查的詳細資訊，請參閱 TechNet 文章：[憑證撤銷和狀態檢查](http://technet.microsoft.com/en-us/library/ee619730(ws.10).aspx)。

什麼是 LDAP over SSL (LDAPS)？  
LDAP over SSL (LDAPS) 利用安全通訊端層 (SSL)/傳輸層安全性 (TLS) 技術，對用戶端電腦和伺服器電腦之間傳輸的流量加密。

什麼是 Active Directory 網域服務？  
Active Directory 網域服務 (AD DS) 會儲存目錄資料並管理使用者和網域之間的通訊，包括使用者登入程序、驗證及目錄搜尋。Active Directory 網域控制站是執行 AD DS 的伺服器。如需 AD DS 的詳細資訊，請參閱 TechNet 文章：[Active Directory 網域服務](http://technet.microsoft.com/en-us/library/cc770946(ws.10).aspx)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2616310">Microsoft 知識庫文件編號 2616310</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;">檔案資訊</td>
<td style="border:1px solid black;">如需 Windows Server 2003 上的 Active Directory 相關資訊，請參閱 <a href="http://support.microsoft.com/kb/2601626">Microsoft 知識庫文件編號 2601626</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">如需 Windows Server 2003 上的 Active Directory 應用程式模式 (ADAM) 相關資訊，請參閱 <a href="http://support.microsoft.com/kb/2616310">Microsoft 知識庫文件編號 2616310</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">登錄機碼驗證</td>
...
<tr class="even">
<td style="border:1px solid black;">檔案資訊</td>
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2601626">Microsoft 知識庫文件編號 2601626</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">登錄機碼驗證</td>
