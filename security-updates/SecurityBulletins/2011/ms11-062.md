---
TOCTitle: 'MS11-062'
Title: 'Microsoft Security Bulletin MS11-062 - 重要'
ms:assetid: 'ms11-062'
ms:contentKeyID: 61238694
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms11-062(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-062 - 重要
===========================================

遠端存取服務 NDISTAPI 驅動程式中的資訊安全風險可能會允許權限提高 (2566454)
--------------------------------------------------------------------------
...
如果攻擊者登入受影響的系統、執行蓄意製作的應用程式來利用此資訊安全風險，然後取得受影響系統之完整控制權，則此資訊安全風險可能會允許權限提高。 攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項資訊安全風險。

此資訊安全更新可修正使用者模式輸入傳送至 Windows 核心之前，NDISTAPI 驅動程式對其進行驗證的方式，藉此解決此資訊安全風險。 如需更多有關此資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=6bc1f0ac-223d-4b0b-86cd-2ba3863955c4">Windows XP Service Pack 3 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=6bc1f0ac-223d-4b0b-86cd-2ba3863955c4&amp;displaylang=zh-tw">Windows XP Service Pack 3 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=d5ee6787-408d-4870-af70-9338158b161b">Windows XP Professional x64 Edition Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8de0f2db-aa09-48cd-a13b-e26a973e9cdc">Windows Server 2003 Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=8de0f2db-aa09-48cd-a13b-e26a973e9cdc&amp;displaylang=zh-tw">Windows Server 2003 Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8f208407-4bb3-41fe-b0d6-fc8a5e30e667">Windows Server 2003 x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=8f208407-4bb3-41fe-b0d6-fc8a5e30e667&amp;displaylang=zh-tw">Windows Server 2003 x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ef140089-d022-4ee8-9cc4-7fb25295a39d">適用於 Itanium 型系統的 Windows Server 2003 SP2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<th style="border:1px solid black;" >NDISTAPI 權限提高資訊安全風險 - CVE-2011-1974</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
NDISTAPI 權限提高資訊安全風險 - CVE-2011-1974  
---------------------------------------------
  

遠端存取服務 NDISTAPI 驅動程式中存在一個權限提高資訊安全風險。 將資料從使用者模式傳遞至 Windows 核心時，如果 NDISTAPI 驅動程式不當驗證使用者提供的輸入，就會導致此資訊安全風險。 成功利用此資訊安全風險的本機攻擊者可執行任意程式碼，並取得受影響之系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-1974](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1974) (英文)。
  
#### NDISTAPI 權限提高資訊安全風險 - CVE-2011-1974 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項資訊安全風險。
  
#### NDISTAPI 權限提高資訊安全風險 - CVE-2011-1974 的因應措施
  
Microsoft 尚未找到此項資訊安全風險的任何因應措施。
  
#### NDISTAPI 權限提高資訊安全風險 - CVE-2011-1974 的常見問答集
  
**這個資訊安全風險的範圍為何？**    
這是權限提高的資訊安全風險。
  
**造成這個資訊安全風險的原因為何？**    
將資料從使用者模式傳遞至 Windows 核心時，如果 NDISTAPI 驅動程式不當驗證使用者提供的輸入，就會導致此資訊安全風險。
  
**什麼元件會受到這個資訊安全風險的影響？**    
NDISTAPI.sys 元件會受到這個資訊安全風險的影響。
  
**什麼是遠端存取服務 (RAS)？**    
遠端存取服務 (RAS) 可讓使用者透過電話線路、網際網路或其他網路連線，連線至遠端電腦，在操作上就像系統實際連線至遠端網路一樣。 RAS 可讓使用者遠端執行各項活動，如收發電子郵件、傳真文件、擷取檔案，以及使用辦公室印表機列印文件。 如需詳細資訊，請參閱 MSDN 文章：[RAS 結構概觀 (NDIS 5.1)](https://msdn.microsoft.com/zh-tw/library/ff563285(v=vs.85).aspx) (英文)。
  
RAS 是 Windows XP 與 Windows Server 2003 的原生服務。而在更新版本的作業系統上，RAS 則是換成 Routing and Remote Access 服務 (RRAS)。 RRAS 讓電腦得以發揮網路路由器功能。 RRAS 也提供了新一代的 Windows RAS 伺服器功能。 RRAS 伺服器的功能延續並奠基於舊版作業系統中所含之 RAS 功能。
  
**什麼是 NDISTAPI 驅動程式？**    
NDISTAPI 驅動程式屬於 RAS 架構的一部分，主要是作為 NDISWAN 與 TAPI 服務之間的介面。 電話語音應用程式實作 TAPI 服務，可進行 TAPI 要求，執行設定、監控以及拆解線路與終止呼叫等作業。 NDISTAPI 驅動程式會將這些 TAPI 要求傳給 NDISWAN。 如需詳細資訊，請參閱 MSDN 文章：[NDISTAPI 結構概觀 (NDIS 5.1)](https://msdn.microsoft.com/zh-tw/library/ff554813(v=vs.85).aspx) (英文)。
  
**什麼是 NDISWAN？**    
「網路驅動程式介面標準廣域網路」(NDISWAN) 是系統所提供的 NDIS 中繼驅動程式，可提供各種功能，例如資料壓縮、加密、回送，以及 WAN Miniport 驅動程式所使用的簡易 PPP 框架。 因此，WAN Miniport 驅動程式只需要實作媒體所需的特定功能 (例如，ISDN 需要 Q931 訊號)。 如需詳細資訊，請參閱 MSDN 文章 [NDISWAN 概觀](https://msdn.microsoft.com/zh-tw/library/ff564653(v=vs.85).aspx) (英文)。
  
**什麼是 TAPI 服務？**    
「語音電話應用程式開發介面」(TAPI) 服務是一種程式開發介面，專門提供語音電話服務給具備語音電話通訊功能的應用程式。
  
**什麼是 NDIS 服務？**    
「網路驅動程式介面標準」(NDIS) 是 Windows Driver Kit 的一部分，Windows Driver Kit 是一套經過全面整合的驅動程式開發系統，其中包含 Windows Driver Device Kit，並可為 Windows 驅動程式進行穩定性與可靠性測試。 NDIS 程式庫會抽取網路驅動程式中的網路硬體。 NDIS 也會指定分層網路驅動程式之間的標準介面，藉此從上層驅動程式 (例如網路傳輸) 中抽取負責管理硬體的下層驅動程式。 NDIS 也會維護網路驅動程式的狀態資訊和參數，其中包括函式指標、控制碼、連結參數區塊，以及其他系統值。
...
**更新的作用何在？**    
此更新可修正使用者模式輸入傳送至 Windows 核心之前，NDISTAPI 驅動程式對其進行驗證的方式，藉此解決此資訊安全風險。
...
更新時常會寫入您應用程式執行所需的相同檔案和登錄設定。 這可能會觸發不相容性，而拉長部署資訊安全更新的時間。 您可以使用 [Application Compatibility Toolkit (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=24da89e9-b581-47b0-b45e-492dd6da2971&displaylang=en) 隨附的 [Update Compatibility Evaluator](https://technet2.microsoft.com/windowsvista/en/library/4279e239-37a4-44aa-aec5-4e70fe39f9de1033.mspx?mfr=true) 元件，針對所安裝的應用程式簡化其測試和驗證 Windows 更新的過程。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB2566454$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2566454/zh-tw">Microsoft 知識庫文件編號 2566454</a></td>
</tr>
<tr class="even">
...
-   感謝 的 Lufeng Li 回報 NDISTAPI 提高權限資訊安全風險 (CVE-2011-1974)
