...
這個資訊安全更新也能解決 [Microsoft 資訊安全摘要報告 2501696](https://technet.microsoft.com/security/advisory/2501696) 中首先提出的資訊安全風險。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/en/details.aspx?familyid=7f0a4616-8e3e-4925-9d95-ce6e614e45ae&amp;displaylang=en">Windows XP Service Pack 3 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=7f0a4616-8e3e-4925-9d95-ce6e614e45ae&amp;displaylang=zh-tw">Windows XP Service Pack 3 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">資訊洩漏</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/en/details.aspx?familyid=b01fe9a5-66a4-4683-963b-e78aea214579&amp;displaylang=en">Windows XP Professional x64 Edition Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">資訊洩漏</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/en/details.aspx?familyid=0209a004-f23a-40d9-991f-864046f4605f&amp;displaylang=en">Windows Server 2003 Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=0209a004-f23a-40d9-991f-864046f4605f&amp;displaylang=zh-tw">Windows Server 2003 Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">資訊洩漏</td>
<td style="border:1px solid black;">低</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/en/details.aspx?familyid=6c287571-54ea-4298-8b7d-b98b2c830cc3&amp;displaylang=en">Windows Server 2003 x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=6c287571-54ea-4298-8b7d-b98b2c830cc3&amp;displaylang=zh-tw">Windows Server 2003 x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">資訊洩漏</td>
<td style="border:1px solid black;">低</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/en/details.aspx?familyid=3fb450a0-d087-4f36-9301-05ffbf94cc1a&amp;displaylang=en">適用於 Itanium 型系統的 Windows Server 2003 SP2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">資訊洩漏</td>
<td style="border:1px solid black;">低</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/en/details.aspx?familyid=c8fce0fb-4c90-479b-8ce9-75e60d52d256&amp;displaylang=en">Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=c8fce0fb-4c90-479b-8ce9-75e60d52d256&amp;displaylang=zh-tw">Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">資訊洩漏</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/en/details.aspx?familyid=7da10b64-d0a9-4e42-aa3a-87c657122a8c&amp;displaylang=en">Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=?...?">Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">資訊洩漏</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/en/details.aspx?familyid=036f1285-7484-4e3b-8799-2c6c08166596&amp;displaylang=en">適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a>**
<a href="https://www.microsoft.com/download/details.aspx?familyid=036f1285-7484-4e3b-8799-2c6c08166596&amp;displaylang=zh-tw">適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2 (中文下載更新程式)</a>&#42;&#42;</td>
<td style="border:1px solid black;">資訊洩漏</td>
<td style="border:1px solid black;">低</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/en/details.aspx?familyid=1438cec8-8dab-4510-ad75-dc6959dac0d8&amp;displaylang=en">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a>**
<a href="https://www.microsoft.com/download/details.aspx?familyid=1438cec8-8dab-4510-ad75-dc6959dac0d8&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2 (中文下載更新程式)</a>&#42;&#42;</td>
<td style="border:1px solid black;">資訊洩漏</td>
<td style="border:1px solid black;">低</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/en/details.aspx?familyid=f35ecdd1-6b5c-40e7-a00b-ca083bdf5cba&amp;displaylang=en">適用於 Itanium 型系統的 Windows Server 2008 和適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">資訊洩漏</td>
<td style="border:1px solid black;">低</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/en/details.aspx?familyid=aed201c1-f1fb-4df9-8875-6f57ea0eb15b&amp;displaylang=en">適用於 32 位元系統的 Windows 7 和適用於 32 位元系統的 Windows 7 Service Pack 1 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=aed201c1-f1fb-4df9-8875-6f57ea0eb15b&amp;displaylang=zh-tw">適用於 32 位元系統的 Windows 7 和適用於 32 位元系統的 Windows 7 Service Pack 1 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">資訊洩漏</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/en/details.aspx?familyid=1a32bf04-7eed-4d27-a8e4-054b4a5b76cb&amp;displaylang=en">適用於 x64 型系統的 Windows 7 和適用於 x64 型系統的 Windows 7 Service Pack 1 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=1a32bf04-7eed-4d27-a8e4-054b4a5b76cb&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows 7 和適用於 x64 型系統的 Windows 7 Service Pack 1 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">資訊洩漏</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/en/details.aspx?familyid=665faa7e-2368-4421-9dd5-ea6df2c79498&amp;displaylang=en">適用於 x64 型系統的 Windows Server 2008 R2 和適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1 (英文下載更新程式)</a>**
<a href="https://www.microsoft.com/download/details.aspx?familyid=665faa7e-2368-4421-9dd5-ea6df2c79498&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows Server 2008 R2 和適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1 (中文下載更新程式)</a>&#42;&#42;</td>
<td style="border:1px solid black;">資訊洩漏</td>
<td style="border:1px solid black;">低</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/downloads/en/details.aspx?familyid=140ea384-2877-401f-ac3b-f84f6966e970&amp;displaylang=en">適用於 Itanium 型系統的 Windows Server 2008 R2 和適用於 Itanium 型系統的 Windows Server 2008 R2 Service Pack 1 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">資訊洩漏</td>
<td style="border:1px solid black;">低</td>
<td style="border:1px solid black;">無</td>
</tr>
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-0096](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0096)。
...
-   依照預設，Windows Server 2003 和 2008 上的 Internet Explorer 會以稱為[增強式資訊安全設定](https://msdn.microsoft.com/library/default.asp?url=/workshop/security/szone/overview/esc_changes.asp)的受限制模式執行。 此模式可緩和這項資訊安全風險。 如需更多關於 Internet Explorer 增強式資訊安全設定的資訊，請參閱下一小節＜我用的是適用於 Windows Server 2003、Windows Server 2008 或 Windows Server 2008 R2 的 Internet Explorer。這樣是否會減輕此資訊安全風險的影響？＞中的常見問題集項目。
...
-   **啟用 MHTML 通訊協定鎖定**
    ...
    **注意**：請參閱 [Microsoft 知識庫文件編號 2501696](https://support.microsoft.com/kb/2501696/zh-tw)，以運用自動化 **Microsoft Fix It** 解決方案來啟用與停用此因應措施。
...
**什麼是 MHTML？**  
MHTML (彙總 HTML 的 MIME 封裝) 是一種網際網路標準，可定義用來包裹 HTML 內容的 MIME 結構。 Windows 中的 MHTML 通訊協定處理常式提供[可插式通訊協定](https://msdn.microsoft.com/en-us/library/aa767916(v=vs.85).aspx)，讓應用程式能顯示以 MHTML 編碼的文件。
...
是。 這項資訊安全風險已經遭到公開揭發。 這項資訊安全風險已被指派「一般性資訊安全風險」編號 [CVE-2011-0096](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0096)。
  
**當本資訊安全公告發行時，Microsoft 是否已接獲任何消息，指出這項資訊安全風險已遭有心人士利用？**  
是。 當本資訊安全公告發行時，Microsoft 已接獲本資訊安全風險已遭有心人士惡用的訊息。
  
**套用此資訊安全更新是否可以保護客戶防範嘗試利用此資訊安全風險的程式碼 (已公開發佈) 之威脅？**  
是。 本資訊安全更新解決目前遭到利用的這項資訊安全風險。 已解決的資訊安全風險已獲指派「一般性資訊安全風險」編號 [CVE-2011-0096](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0096)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2503658/zh-tw">Microsoft 知識庫文件編號 2503658</a></td>
</tr>
<tr class="even">
...
-   感謝 [Google Security Team](https://www.google.com/) 與我們合作解決 MHTML Mime 格式 Web 要求資訊安全風險 (CVE-2011-0096)
