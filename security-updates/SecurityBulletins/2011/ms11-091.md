---
TOCTitle: 'MS11-091'
Title: 'Microsoft Security Bulletin MS11-091 - 重要'
ms:assetid: 'ms11-091'
ms:contentKeyID: 61238723
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms11-091(v=Security.10)'
---

Microsoft Security Bulletin MS11-091 - 重要
===========================================

Microsoft Publisher 中的資訊安全風險可能會允許遠端執行程式碼 (2607702)
----------------------------------------------------------------------
...
此資訊安全更新可解決 Microsoft Office 中一項公開揭露的資訊安全風險和三項未公開報告的資訊安全風險。其中最嚴重的資訊安全風險，可能會在使用者開啟蓄意製作的 Publisher 檔案時，允許遠端執行程式碼。成功利用這些資訊安全風險的攻擊者可以取得受影響系統的完整控制權。攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
...
已知問題。 [Microsoft 知識庫文件編號 2607702](https://support.microsoft.com/kb/2607702?ln=zh-tw) 中記載了客戶安裝此資訊安全更新時，可能會發生的目前已知問題。該文件並說明了解決這些問題的建議解決方案。目前已知問題和建議解決方案僅適用於此軟體的特定版本，本文會提供詳細文章的連結。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=13f3e884-37bf-4ed2-b3ed-a0e7fb48e44f">Microsoft Publisher 2003 Service Pack 3</a> (英文下載更新程式)
<div>
(KB2553084)  
</div>
<div>
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=13f3e884-37bf-4ed2-b3ed-a0e7fb48e44f">Microsoft Publisher 2003 Service Pack 3</a> (中文下載更新程式)  
</div>
<div>
(KB2553084)
</div></td>
...
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms10-103">MS10-103</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Office 2007 Service Pack 2</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2856821e-f1fd-424b-b03c-e443685eea6d">Microsoft Publisher 2007 Service Pack 2</a> (英文下載更新程式)
<div>
(KB2596705)  
</div>
<div>
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=2856821e-f1fd-424b-b03c-e443685eea6d">Microsoft Publisher 2007 Service Pack 2</a> (中文下載更新程式)  
</div>
<div>
(KB2596705)
</div></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2856821e-f1fd-424b-b03c-e443685eea6d">Microsoft Publisher 2007 Service Pack 3</a> (英文下載更新程式)
<div>
(KB2596705)  
</div>
<div>
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=2856821e-f1fd-424b-b03c-e443685eea6d">Microsoft Publisher 2007 Service Pack 3</a> (中文下載更新程式)  
</div>
<div>
(KB2596705)
</div></td>
...
| Office 及其他軟體                                                                 |  
|-----------------------------------------------------------------------------------|  
| Microsoft Publisher 2010 和 Microsoft Publisher 2010 Service Pack 1 (32 位元版本) |  
| Microsoft Publisher 2010 和 Microsoft Publisher 2010 Service Pack 1 (64 位元版本) |
...
下列嚴重性等級是假設資訊安全風險可能造成的最嚴重影響而評定。在本資訊安全公告發行的 30 天內，如需資訊安全風險易遭利用性與嚴重性等級和資訊安全影響之間對應關係的資訊，請參閱 [12 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms11-dec)中的＜資訊安全風險索引＞。如需更多資訊，請參閱 [Microsoft 資訊安全風險入侵指數](https://technet.microsoft.com/security/cc998259)。
...
<th style="border:1px solid black;" >Publisher 功能指標覆寫資訊安全風險 - CVE-2011-1508</th>
<th style="border:1px solid black;" >Publisher 陣列超出範圍索引資訊安全風險 - CVE-2011-3410</th>
<th style="border:1px solid black;" >Publisher 無效指標資訊安全風險 - CVE-2011-3411</th>
<th style="border:1px solid black;" >Publisher 記憶體損毀資訊安全風險 - CVE-2011-3412</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Publisher 2007 Service Pack 2 和 Microsoft Publisher 2007 Service Pack 3</td>
<td style="border:1px solid black;">中度 <br />
遠端執行程式碼</td>
<td style="border:1px solid black;">重要 <br />
遠端執行程式碼</td>
...
Publisher 功能指標覆寫資訊安全風險 - CVE-2011-1508  
--------------------------------------------------
  
在 Microsoft Publisher 剖析 Publisher 檔案的方式中，存在遠端執行程式碼資訊安全風險。攻擊者可蓄意製作 Publisher 檔案，並以電子郵件附件的方式隨附，或存放在蓄意製作或遭入侵的網站上，然後引誘使用者將此蓄意製作的 Publisher 檔案插入另一個 Publisher 文件，以利用此項資訊安全風險。如果使用者以系統管理的使用者權限登入，成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
  
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-1508](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1508) (英文)。
  
#### Publisher 功能指標覆寫資訊安全風險 - CVE-2011-1508 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。下列緩和因素可能對您的狀況有所助益：
  
-   在網頁攻擊的案例中，攻擊者必須架設網站，其中包含嘗試利用此資訊安全風險的 Publisher 檔案。此外，受侵害的網站以及接受或存放使用者提供之內容的網站裡，也可能包含蓄意製作以利用本資訊安全風險的內容。然而，攻擊者並不能強迫使用者造訪蓄意製作的網站， 而是引誘使用者自行前往。一般的做法是設法讓使用者按一下電子郵件中或 Instant Messenger 訊息中連往攻擊者網站的連結，然後引誘他們將蓄意製作的 Publisher 檔案插入另一個 Publisher 文件。  
...
#### Publisher 功能指標覆寫資訊安全風險 - CVE-2011-1508 的因應措施
  
因應措施指的是無法徹底修正資訊安全風險，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：
  
-   對於來自於不受信任的來源或在非預期情況下從信任來源收到的 Office 檔案，  
-   請勿  
-   隨意插入  
-    
  
    對於來自於不受信任的來源或在非預期情況下從信任來源收到的 Publisher 檔案，請勿隨意插入。當使用者將蓄意製作的 Publisher 檔案插入 Publisher 文件時，即可能遭受利用此資訊安全風險的攻擊。
  
#### Publisher 功能指標覆寫資訊安全風險 - CVE-2011-1508 的常見問題集
  
這個資訊安全風險的範圍為何？   
這是遠端執行程式碼的資訊安全風險。成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
造成這個資訊安全風險的原因為何？   
形成此資訊安全風險的原因，是由於 Microsoft Publisher 在剖析蓄意製作的 Publisher 檔案時，不當處理功能指標的記憶體所致。
  
為什麼這個資訊安全風險的等級為「中度」？   
此資訊安全風險的等級之所以為「中度」，是因為需要廣泛的使用者互動和社會工程才能成功利用此資訊安全風險。
...
攻擊者如何利用這項資訊安全風險？   
此資訊安全風險需要使用者透過受影響的 Microsoft Publisher 版本，將蓄意製作的 Publisher 檔案插入另一個 Publisher 文件。
  
若是電子郵件攻擊，攻擊者可能會利用這項資訊安全風險，向使用者傳送蓄意製作的 Publisher 檔案，然後引誘使用者將蓄意製作的檔案插入另一個 Publisher 文件。
...
更新的作用何在？   
此更新可修正 Microsoft Publisher 剖析蓄意製作之 Publisher 檔案的方式，進而解決此項資訊安全風險。
  
當資訊安全公告發行時，這項資訊安全風險是否已揭發出來？   
是。這項資訊安全風險已經遭到公開揭發。這項資訊安全風險已被指派「一般性資訊安全風險」編號 [CVE-2011-1508](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1508) (英文)。
  
當本資訊安全公告發行時，Microsoft 是否已接獲任何消息，指出這項資訊安全風險已遭有心人士利用？   
否。當本資訊安全公告初次發行時，Microsoft 尚未接到任何有關本資訊安全風險已公開用來攻擊客戶的消息。
  
套用此資訊安全更新是否可以保護客戶防範嘗試利用此資訊安全風險的程式碼 (已公開發佈) 之威脅？   
是。本資訊安全更新可解決可能透過利用已公開發佈的概念驗證程式碼來加以利用的資訊安全風險。這項獲得解決的資訊安全風險已被指派「一般性資訊安全風險」編號 [CVE-2011-1508](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1508) (英文)。
  
Publisher 陣列超出範圍索引資訊安全風險 - CVE-2011-3410  
------------------------------------------------------
  
在 Microsoft Publisher 剖析 Publisher 檔案的方式中，存在遠端執行程式碼資訊安全風險。攻擊者可蓄意製作 Publisher 檔案，並以電子郵件附件的方式隨附，或存放在蓄意製作或遭入侵的網站上，然後引誘使用者開啟蓄意製作的 Publisher 檔案，以利用此項資訊安全風險。如果使用者以系統管理的使用者權限登入，成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
  
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-3410](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3410) (英文)。
  
#### Publisher 陣列超出範圍索引資訊安全風險 - CVE-2011-3410 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。下列緩和因素可能對您的狀況有所助益：
  
-   成功利用此資訊安全風險的攻擊者可以取得與登入使用者相同的使用者權限。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。  
-   無法透過電子郵件自動攻擊此資訊安全風險。使用者必須順利開啟電子郵件訊息中傳送的附件，攻擊才可進行。  
-   在網頁攻擊的案例中，攻擊者必須架設網站，其中包含嘗試利用此資訊安全風險的 Publisher 檔案。此外，受侵害的網站以及接受或存放使用者提供之內容的網站裡，也可能包含蓄意製作以利用本資訊安全風險的內容。然而，攻擊者並不能強迫使用者造訪蓄意製作的網站， 而是引誘使用者自行前往。一般的做法是設法讓使用者按一下電子郵件中或 Instant Messenger 訊息中連往攻擊者網站的連結，然後引誘他們開啟蓄意製作的 Publisher 檔案。
  
#### Publisher 陣列超出範圍索引資訊安全風險 - CVE-2011-3410 的因應措施
...
#### Publisher 陣列超出範圍索引資訊安全風險 - CVE-2011-3410 的常見問題集
  
這個資訊安全風險的範圍為何？   
這是遠端執行程式碼的資訊安全風險。成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
造成這個資訊安全風險的原因為何？   
形成此資訊安全風險的原因，是由於 Microsoft Publisher 在剖析蓄意製作的 Publisher 檔案時，不當處理記憶體中的值所致。
  
攻擊者可能會利用這項資訊安全風險採取什麼行動？   
一旦成功利用此資訊安全風險，攻擊者便能以登入的使用者身分執行任意程式碼。如果使用者以系統管理的使用者權限登入，則攻擊者即可取得受影響系統的完整控制權。攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
  
攻擊者如何利用這項資訊安全風險？   
此資訊安全風險需要使用者透過受影響的 Microsoft Publisher 版本來開啟蓄意製作的 Publisher 檔案。
  
若是電子郵件攻擊，攻擊者可能會利用這項資訊安全風險，向使用者傳送蓄意製作的 Publisher 檔案，然後引誘使用者開啟該檔案。
...
Publisher 無效指標資訊安全風險 - CVE-2011-3411  
----------------------------------------------
  
在 Microsoft Publisher 剖析 Publisher 檔案的方式中，存在遠端執行程式碼資訊安全風險。攻擊者可蓄意製作 Publisher 檔案，並以電子郵件附件的方式隨附，或存放在蓄意製作或遭入侵的網站上，然後引誘使用者開啟蓄意製作的 Publisher 檔案，以利用此項資訊安全風險。如果使用者以系統管理的使用者權限登入，成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
  
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-3411](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3411) (英文)。
  
#### Publisher 無效指標資訊安全風險 - CVE-2011-3411 的緩和因素
...
#### Publisher 無效指標資訊安全風險 - CVE-2011-3411 的因應措施
...
#### Publisher 無效指標資訊安全風險 - CVE-2011-3411 的常見問題集
...
在網頁攻擊的案例中，攻擊者必須架設網站，其中包含嘗試利用此資訊安全風險的 Publisher 檔案。此外，受侵害的網站以及接受或存放使用者提供之內容的網站裡，也可能包含蓄意製作以利用本資訊安全風險的內容。攻擊者並不能強迫使用者造訪蓄意製作的網站， 而是引誘使用者自行前往。一般的做法是設法讓使用者按一下電子郵件中或 Instant Messenger 訊息中連往攻擊者網站的連結，然後引誘他們開啟蓄意製作的 Publisher 檔案。
...
Publisher 記憶體損毀資訊安全風險 - CVE-2011-3412  
------------------------------------------------
  
在 Microsoft Publisher 剖析 Publisher 檔案的方式中，存在遠端執行程式碼資訊安全風險。攻擊者可蓄意製作 Publisher 檔案，並以電子郵件附件的方式隨附，或存放在蓄意製作或遭入侵的網站上，然後引誘使用者開啟蓄意製作的 Publisher 檔案，以利用此項資訊安全風險。如果使用者以系統管理的使用者權限登入，成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
  
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-3412](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3412) (英文)。
  
#### Publisher 記憶體損毀資訊安全風險 - CVE-2011-3412 的緩和因素
...
#### Publisher 記憶體損毀資訊安全風險 - CVE-2011-3412 的因應措施
...
#### Publisher 記憶體損毀資訊安全風險 - CVE-2011-3412 的常見問題集
  
這個資訊安全風險的範圍為何？   
這是遠端執行程式碼的資訊安全風險。成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
造成這個資訊安全風險的原因為何？   
形成此資訊安全風險的原因，是由於 Microsoft Publisher 在剖析蓄意製作的 Publisher 檔案時，不當處理記憶體所致。
...
-   對於 Microsoft Office XP 支援版本，請參閱建立管理安裝點 (英文)。如需更多有關如何將用戶端系統的來源從更新的管理安裝點變更到 Office XP 原始基準來源之詳細資訊，請參閱 [Microsoft 知識庫文件編號 922665](https://support.microsoft.com/kb/922665?ln=zh-tw)。  
...
<br />
注意：當您移除此更新時，系統可能會提示您在 CD 光碟機中插入 Microsoft Office 2003 CD。此外，您可能沒有從 [控制台] 內 [新增或移除程式] 工具中解除安裝更新的選項。這個問題有數個可能的原因。如需有關移除的詳細資訊，請參閱 <a href="https://support.microsoft.com/kb/903771?ln=zh-tw">Microsoft 知識庫文件編號 903771</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">檔案資訊</td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2553084?ln=zh-tw">Microsoft 知識庫文件編號 2553084</a></td>
</tr>
<tr class="even">
...
-   [適用於 Microsoft Windows 2000 及 Windows NT 4.0 的 Windows Installer 2.0 Redistributable](https://www.microsoft.com/download/en/details.aspx?displaylang=en&id=11176)
...
注意：當您移除此更新時，系統可能會提示您在 CD 光碟機中插入 Microsoft Office 2003 CD。此外，您可能沒有從 \[控制台\] 內 \[新增或移除程式\] 工具中解除安裝更新的選項。這個問題有數個可能的原因。如需有關移除的詳細資訊，請參閱 [Microsoft 知識庫文件編號 903771](https://support.microsoft.com/kb/903771?ln=zh-tw)
...
<tr class="odd">
<td style="border:1px solid black;">檔案資訊</td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2596705?ln=zh-tw">Microsoft 知識庫文件編號 2596705</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">登錄機碼驗證</td>
<td style="border:1px solid black;">不適用</td>
...
注意：當您移除此更新時，系統可能會提示您在 CD 光碟機中插入 2007 Microsoft Office CD。此外，您可能沒有從 \[控制台\] 內 \[新增或移除程式\] 工具中解除安裝更新的選項。這個問題有數個可能的原因。如需有關移除的詳細資訊，請參閱 [Microsoft 知識庫文件編號 903771](https://support.microsoft.com/kb/903771?ln=zh-tw)
...
-   感謝 [CERT/CC](https://www.cert.org/) 的 Will Dormann 回報 Publisher 陣列超出範圍索引資訊安全風險 (CVE-2011-3410)  
-   感謝 [CERT/CC](https://www.cert.org/) 的 Will Dormann 回報 Publisher 無效指標資訊安全風險 (CVE-2011-3411)  
-   感謝 [CERT/CC](https://www.cert.org/) 的 Will Dormann 回報 Publisher 記憶體損毀資訊安全風險 (CVE-2011-3412)
