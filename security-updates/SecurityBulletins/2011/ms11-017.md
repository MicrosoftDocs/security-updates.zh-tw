...
**已知問題。** [Microsoft 知識庫文件編號 2508062](http://support.microsoft.com/kb/2508062/zh-tw) 中記載了客戶安裝此資訊安全更新時，可能會發生的目前已知問題。 該文件並說明了解決這些問題的建議解決方案。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-0029](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0029)。
...
<td style="border:1px solid black;">適用於遠端桌面連線 5.2：<br />
請參閱 <a href="http://support.microsoft.com/kb/2483618/zh-tw">Microsoft 知識庫文件編號 2483618</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於遠端桌面連線 6.0 和遠端桌面連線 6.1：<br />
請參閱 <a href="http://support.microsoft.com/kb/2481109/zh-tw">Microsoft 知識庫文件編號 2481109</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於遠端桌面連線 7.0：<br />
請參閱 <a href="http://support.microsoft.com/kb/2483614/zh-tw">Microsoft 知識庫文件編號 2483614</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於遠端桌面連線 6.0 用戶端多語系使用者介面 (MUI)：<br />
請參閱 <a href="http://support.microsoft.com/kb/2483619/zh-tw">Microsoft 知識庫文件編號 2483619</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">適用於遠端桌面連線 6.0：<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2481109/zh-tw">Microsoft 知識庫文件編號 2481109</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;"><strong>注意：</strong>登錄機碼不存在，無法驗證此更新是否存在。</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2483614/zh-tw">Microsoft 知識庫文件編號 2483614</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;"><strong>注意：</strong>登錄機碼不存在，無法驗證此更新是否存在。</td>
...
-   感謝 [Versafe Anti Fraud](http://www.versafe-login.com/) 的 Eyal Gruner 回報遠端桌面不安全程式庫載入資訊安全風險 (CVE-2011-0029)
