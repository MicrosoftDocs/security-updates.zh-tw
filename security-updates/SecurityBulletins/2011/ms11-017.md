---
TOCTitle: 'MS11-017'
Title: 'Microsoft Security Bulletin MS11-017 - 重要'
ms:assetid: 'ms11-017'
ms:contentKeyID: 61238649
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms11-017(v=Security.10)'
---


Microsoft Security Bulletin MS11-017 - 重要
===========================================

遠端桌面用戶端中的資訊安全風險可能會允許遠端執行程式碼 (2508062)
----------------------------------------------------------------
...
這個資訊安全更新可解決 Windows 遠端桌面用戶端中一項未公開報告的資訊安全風險。 如果使用者開啟與蓄意製作之程式庫檔案位於相同網路資料夾的合法遠端桌面設定 (.rdp) 檔案，則此資訊安全風險可能會允許遠端執行程式碼。 使用者必須造訪不受信任的遠端檔案系統位置或 WebDAV 共用，並從該位置開啟文件，然後使用有資訊安全風險的應用程式載入文件，這類攻擊才會成功。

對於遠端桌面連線 5.2 用戶端、遠端桌面連線 6.0 用戶端、遠端桌面連線 6.1 用戶端和遠端桌面連線 7.0 用戶端來說，此資訊安全更新的等級為「重要」。 如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此資訊安全更新可修正 Windows 遠端桌面用戶端載入外部程式庫的方式，進而解決此資訊安全風險。 如需更多有關資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
**已知問題。** [Microsoft 知識庫文件編號 2508062](https://support.microsoft.com/kb/2508062/zh-tw) 中記載了客戶安裝此資訊安全更新時，可能會發生的目前已知問題。 該文件並說明了解決這些問題的建議解決方案。
...
<td style="border:1px solid black;">
[遠端桌面連線 5.2 用戶端 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=1aed6080-feab-4b5e-9d26-6a3f4b92434d)  
(KB2483618)  
[遠端桌面連線 5.2 用戶端 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=1aed6080-feab-4b5e-9d26-6a3f4b92434d&displaylang=zh-tw)  
(KB2483618)
...
<td style="border:1px solid black;">
[遠端桌面連線 6.1 用戶端 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=d67e4d8c-aeb9-45e6-9555-7456c5540475)  
(KB2481109)  
[遠端桌面連線 6.1 用戶端 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=d67e4d8c-aeb9-45e6-9555-7456c5540475&displaylang=zh-tw)  
(KB2481109)
...
<td style="border:1px solid black;">
[遠端桌面連線 6.0 用戶端 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=6d4539ef-4a05-4c7d-9489-436f7b7a3ebe)<sup>[1]</sup>
(KB2481109)
</td>
<td style="border:1px solid black;">
遠端執行程式碼
...
<td style="border:1px solid black;">
[遠端桌面連線 6.0 用戶端 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=641d5d12-0790-4551-831a-e78febad17a7)<sup>[1]</sup>
(KB2481109)  
[遠端桌面連線 6.0 用戶端 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=641d5d12-0790-4551-831a-e78febad17a7&displaylang=zh-tw)<sup>[1]</sup>
(KB2481109)
...
<td style="border:1px solid black;">
[遠端桌面連線 6.0 用戶端多語系使用者介面 (MUI) (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=6fec0d06-042d-4e55-9843-009edd7d26ce)<sup>[2]</sup>
(KB2483619)
</td>
<td style="border:1px solid black;">
遠端執行程式碼
...
<td style="border:1px solid black;">
[遠端桌面連線 6.0 用戶端 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=78dbb9cf-8a18-4f0a-8edf-f1ce0c993c63)<sup>[1]</sup>
(KB2481109)  
[遠端桌面連線 6.0 用戶端 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=78dbb9cf-8a18-4f0a-8edf-f1ce0c993c63&displaylang=zh-tw)<sup>[1]</sup>
(KB2481109)
...
<td style="border:1px solid black;">
[遠端桌面連線 6.1 用戶端 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=e3ea7690-386b-4cdf-889f-b3914921c56f)  
(KB2481109)  
[遠端桌面連線 6.1 用戶端 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=e3ea7690-386b-4cdf-889f-b3914921c56f&displaylang=zh-tw)  
(KB2481109)
...
<td style="border:1px solid black;">
[遠端桌面連線 6.1 用戶端 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=5735bed6-0e3d-46a4-85d0-14ec34a82edd)  
(KB2481109)  
[遠端桌面連線 6.1 用戶端 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=5735bed6-0e3d-46a4-85d0-14ec34a82edd&displaylang=zh-tw)  
(KB2481109)
...
<td style="border:1px solid black;">
[遠端桌面連線 6.1 用戶端 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=31d790c9-92f9-4a2b-800b-8e8d2b570bb9)&#42;&#42;  
(KB2481109)  
[遠端桌面連線 6.1 用戶端 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=31d790c9-92f9-4a2b-800b-8e8d2b570bb9&displaylang=zh-tw)&#42;&#42;  
(KB2481109)
...
<td style="border:1px solid black;">
[遠端桌面連線 6.1 用戶端 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=5b0a8eb5-4bc2-4054-b952-58aa645afcf5)&#42;&#42;  
(KB2481109)  
[遠端桌面連線 6.1 用戶端 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=5b0a8eb5-4bc2-4054-b952-58aa645afcf5&displaylang=zh-tw)&#42;&#42;  
(KB2481109)
...
<td style="border:1px solid black;">
[遠端桌面連線 6.1 用戶端 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=25da7e00-745d-4d98-9dd8-52a8a4340404)  
(KB2481109)
</td>
<td style="border:1px solid black;">
遠端執行程式碼
...
<td style="border:1px solid black;">
[遠端桌面連線 7.0 用戶端 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=6a01992e-c9a1-4dc9-a3ef-7410b81f17e6)  
(KB2483614)  
[遠端桌面連線 7.0 用戶端 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=6a01992e-c9a1-4dc9-a3ef-7410b81f17e6&displaylang=zh-tw)  
(KB2483614)
...
<td style="border:1px solid black;">
[遠端桌面連線 7.0 用戶端 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=3c30f67e-7c31-4553-ba3e-e056df1bf8eb)  
(KB2483614)  
[遠端桌面連線 7.0 用戶端 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=3c30f67e-7c31-4553-ba3e-e056df1bf8eb&displaylang=zh-tw)  
(KB2483614)
...
<td style="border:1px solid black;">
[遠端桌面連線 7.0 用戶端 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=8025482b-f58f-4f5a-a133-5563c65b21f6)  
(KB2483614)  
[遠端桌面連線 7.0 用戶端 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=8025482b-f58f-4f5a-a133-5563c65b21f6&displaylang=zh-tw)  
(KB2483614)
...
<td style="border:1px solid black;">
[遠端桌面連線 7.0 用戶端 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=0768a5f4-da28-4b2e-8aff-d68f890df3e6)  
(KB2483614)  
[遠端桌面連線 7.0 用戶端 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=0768a5f4-da28-4b2e-8aff-d68f890df3e6&displaylang=zh-tw)  
(KB2483614)
...
<td style="border:1px solid black;">
[遠端桌面連線 7.0 用戶端 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=935adb10-1e7e-4501-b543-8247b88f6d18)  
(KB2483614)  
[遠端桌面連線 7.0 用戶端 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=935adb10-1e7e-4501-b543-8247b88f6d18&displaylang=zh-tw)  
(KB2483614)
...
<td style="border:1px solid black;">
[遠端桌面連線 7.0 用戶端 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=3fcb2e11-591e-484a-a992-2f1d563e6d17)&#42;&#42;  
(KB2483614)  
[遠端桌面連線 7.0 用戶端 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=3fcb2e11-591e-484a-a992-2f1d563e6d17&displaylang=zh-tw)&#42;&#42;  
(KB2483614)
...
<td style="border:1px solid black;">
[遠端桌面連線 7.0 用戶端 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=c29b6487-78f0-421c-810c-c5e45d6a2352)  
(KB2483614)
</td>
<td style="border:1px solid black;">
遠端執行程式碼
...
| 作業系統                                                      | 元件                    |
|---------------------------------------------------------------|-------------------------|
| Windows XP Professional x64 Edition Service Pack 2            | 遠端桌面連線 5.2 用戶端 |
| Windows Server 2003 Service Pack 2                            | 遠端桌面連線 5.2 用戶端 |
| Windows Server 2003 x64 Edition Service Pack 2                | 遠端桌面連線 5.2 用戶端 |
| 適用於 Itanium 型系統的 Windows Server 2003 SP2               | 遠端桌面連線 5.2 用戶端 |
| 適用於 32 位元系統的 Windows 7 Service Pack 1                 | 遠端桌面連線 7.0 用戶端 |
| 適用於 x64 型系統的 Windows 7 Service Pack 1                  | 遠端桌面連線 7.0 用戶端 |
| 適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1     | 遠端桌面連線 7.0 用戶端 |
| 適用於 Itanium 型系統的 Windows Server 2008 R2 Service Pack 1 | 遠端桌面連線 7.0 用戶端 |
...
<th style="border:1px solid black;" >
遠端桌面不安全程式庫載入資訊安全風險 - CVE-2011-0029
</th>
<th style="border:1px solid black;" >
彙總嚴重性等級
</th>
...
<tr>
<td style="border:1px solid black;">
Windows XP Service Pack 3 上的遠端桌面連線 5.2
</td>
<td style="border:1px solid black;">
**重要**   
遠端執行程式碼
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows XP Service Pack 3 上的遠端桌面連線 6.1
</td>
<td style="border:1px solid black;">
**重要**   
遠端執行程式碼
...
<tr>
<td style="border:1px solid black;">
Windows XP Professional x64 Edition Service Pack 2 上的遠端桌面連線 6.0
</td>
<td style="border:1px solid black;">
**重要**   
遠端執行程式碼
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2003 Service Pack 2 上的遠端桌面連線 6.0
</td>
<td style="border:1px solid black;">
**重要**   
遠端執行程式碼
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 Service Pack 2 上的遠端桌面連線 6.0 用戶端多語系使用者介面 (MUI)
</td>
<td style="border:1px solid black;">
**重要**   
遠端執行程式碼
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2003 x64 Edition Service Pack 2 上的遠端桌面連線 6.0
</td>
<td style="border:1px solid black;">
**重要**   
遠端執行程式碼
...
<tr>
<td style="border:1px solid black;">
Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 上的遠端桌面連線 6.1
</td>
<td style="border:1px solid black;">
**重要**   
遠端執行程式碼
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 上的遠端桌面連線 6.1
</td>
<td style="border:1px solid black;">
**重要**   
遠端執行程式碼
...
<tr>
<td style="border:1px solid black;">
適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2 上的遠端桌面連線 6.1&#42;&#42;
</td>
<td style="border:1px solid black;">
**重要**   
遠端執行程式碼
...
<tr class="alternateRow">
<td style="border:1px solid black;">
適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2 上的遠端桌面連線 6.1&#42;&#42;
</td>
<td style="border:1px solid black;">
**重要**   
遠端執行程式碼
...
<tr>
<td style="border:1px solid black;">
適用於 Itanium 型系統的 Windows Server 2008 與適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2 上的遠端桌面連線 6.1
</td>
<td style="border:1px solid black;">
**重要**   
遠端執行程式碼
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows XP Service Pack 3 上的遠端桌面連線 7.0
</td>
<td style="border:1px solid black;">
**重要**   
遠端執行程式碼
...
<tr>
<td style="border:1px solid black;">
Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 上的遠端桌面連線 7.0
</td>
<td style="border:1px solid black;">
**重要**   
遠端執行程式碼
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Vista x64 Edition Service Pack 1 與 Windows Vista x64 Edition Service Pack 2 上的遠端桌面連線 7.0
</td>
<td style="border:1px solid black;">
**重要**   
遠端執行程式碼
...
<tr>
<td style="border:1px solid black;">
適用於 32 位元系統的 Windows 7 上的遠端桌面連線 7.0
</td>
<td style="border:1px solid black;">
**重要**   
遠端執行程式碼
...
<tr class="alternateRow">
<td style="border:1px solid black;">
適用於 64 位元系統的 Windows 7 上的遠端桌面連線 7.0
</td>
<td style="border:1px solid black;">
**重要**   
遠端執行程式碼
...
<tr>
<td style="border:1px solid black;">
適用於 x64 型系統的 Windows Server 2008 R2 上的遠端桌面連線 7.0&#42;&#42;
</td>
<td style="border:1px solid black;">
**重要**   
遠端執行程式碼
...
<tr class="alternateRow">
<td style="border:1px solid black;">
適用於 Itanium 型系統的 Windows Server 2008 R2 上的遠端桌面連線 7.0&#42;&#42;
</td>
<td style="border:1px solid black;">
**重要**   
遠端執行程式碼
...
在 Windows 遠端桌面用戶端處理 DLL 檔案載入的方式中，存在遠端執行程式碼資訊安全風險。 成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-0029](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0029)。

#### 遠端桌面不安全程式庫載入資訊安全風險 - CVE-2011-0029 的緩和因素

緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：

-   使用者必須造訪不受信任的遠端檔案系統位置或 WebDAV 共用，並開啟 .rdp 檔案，這類攻擊才會成功。
-   外圍防火牆的檔案共用通訊協定 (即伺服器訊息區 (SMB)) 通常為停用。 這樣可限制此資訊安全風險的潛在攻擊媒介。

#### 遠端桌面不安全程式庫載入資訊安全風險 - CVE-2011-0029 的因應措施
...
#### 遠端桌面不安全程式庫載入資訊安全風險 - CVE-2011-0029 的常見問題集

**這個資訊安全風險的範圍為何？**  
這是遠端執行程式碼的資訊安全風險。 成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。

**造成這個資訊安全風險的原因為何？**  
此資訊安全風險導因於 Windows 遠端桌面用戶端錯誤地限制外部程式庫載入時所用的路徑。

**什麼是 Windows 遠端桌面用戶端？**  
Windows 中的遠端桌面功能，可讓使用者從第二台 Windows 電腦存取使用者電腦上的所有程式、資源和附屬應用程式。 連線後，遠端桌面可控制第一台電腦的滑鼠和鍵盤，並於畫面上顯示所有執行中的動作。
...
**攻擊者如何利用這項資訊安全風險？**  
攻擊者可能會引誘使用者開啟蓄意製作之動態連結程式庫 (DLL) 檔案所在之相同網路目錄中的合法遠端桌面設定檔 (.rdp)。 然後，開啟 .rdp 檔案時，Windows 遠端桌面用戶端可能會嘗試載入 DLL 檔案並執行其內含的任何程式碼。

在電子郵件攻擊案例中，攻擊者可能會將合法的 .rdp 附件傳送給使用者，再引誘使用者將附件放到包含蓄意製作之 DLL 檔案的目錄中，並開啟 .rdp 檔案，進而利用此資訊安全風險。 然後，開啟 .rdp 檔案時，Windows 遠端桌面用戶端可能會嘗試載入 DLL 檔案並執行其內含的任何程式碼。

在網路案例中，攻擊者可能會在 UNC 或 WebDAV 位置中放置合法的 .rdp 檔案和蓄意製作的 DLL，然後引誘使用者開啟 .rdp 檔案。

**因為這個資訊安全風險而承受資訊安全風險的主要系統有哪些？**  
此資訊安全風險主要是影響預期使用者會開啟來自不信任網路位置之附件的工作站。 若系統管理員允許使用者登入伺服器並執行程式，則伺服器也將面臨資訊安全風險。 然而，最佳實務強烈建議您制止這種行為。

**更新的作用何在？**  
此更新可修正 Windows 遠端桌面用戶端載入外部程式庫的方式，進而解決此資訊安全風險。
...
| 適用於 32 位元系統的 Windows 7 Service Pack 1                                                            | 否      | 否                    | 是                    | 是                         |
...
<td style="border:1px solid black;">適用於 Windows XP Service Pack 3 上的遠端桌面連線 5.2：<br />
WindowsXP-KB2483618-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於 Windows XP Service Pack 3 上的遠端桌面連線 6.1：<br />
WindowsXP-KB2481109-x86-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於 Windows XP Service Pack 3 上的遠端桌面連線 7.0：<br />
WindowsXP-KB2483614-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於 Windows XP Professional x64 Edition Service Pack 2 上的遠端桌面連線 6.0：<br />
...
<td style="border:1px solid black;">適用於遠端桌面連線 5.2：<br />
KB2483618.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於遠端桌面連線 6.0 和遠端桌面連線 6.1：<br />
KB2481109.log</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於遠端桌面連線 7.0：<br />
KB2483614.log</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">適用於遠端桌面連線 5.2：<br />
使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB2483618$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於遠端桌面連線 6.0 和遠端桌面連線 6.1：<br />
使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB2481109$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於遠端桌面連線 7.0：<br />
使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB2483614$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">適用於遠端桌面連線 5.2：<br />
請參閱 <a href="https://support.microsoft.com/kb/2483618/zh-tw">Microsoft 知識庫文件編號 2483618</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於遠端桌面連線 6.0 和遠端桌面連線 6.1：<br />
請參閱 <a href="https://support.microsoft.com/kb/2481109/zh-tw">Microsoft 知識庫文件編號 2481109</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於遠端桌面連線 7.0：<br />
請參閱 <a href="https://support.microsoft.com/kb/2483614/zh-tw">Microsoft 知識庫文件編號 2483614</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">在沒有使用者介入的情況下安裝</td>
<td style="border:1px solid black;">適用於 Windows Server 2003 Service Pack 2 上的遠端桌面連線 6.0：<br />
WindowsServer2003-KB2481109-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於 Windows Server 2003 Service Pack 2 上的遠端桌面連線 6.0 用戶端多語系使用者介面 (MUI)：<br />
WindowsServer2003-KB2483619-x86-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於 Windows Server 2003 x64 Edition Service Pack 2 上的遠端桌面連線 6.0：<br />
WindowsServer2003.WindowsXP-KB2481109-x64-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">在不重新啟動的情況下安裝</td>
...
<tr class="odd">
<td style="border:1px solid black;">更新記錄檔</td>
<td style="border:1px solid black;">適用於遠端桌面連線 6.0：<br />
KB2481109.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於遠端桌面連線 6.0 用戶端多語系使用者介面 (MUI)：<br />
KB2483619.log</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">詳細資訊</td>
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於遠端桌面連線 6.0 用戶端多語系使用者介面 (MUI)：<br />
使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB2483619$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">適用於遠端桌面連線 6.0：<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於遠端桌面連線 6.0 用戶端多語系使用者介面 (MUI)：<br />
請參閱 <a href="https://support.microsoft.com/kb/2483619/zh-tw">Microsoft 知識庫文件編號 2483619</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">適用於遠端桌面連線 6.0：<br />
...
<tr class="odd">
<td style="border:1px solid black;">在沒有使用者介入的情況下安裝</td>
<td style="border:1px solid black;">適用於 Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 上的遠端桌面連線 6.1：<br />
Windows6.0-KB2481109-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於 Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 上的遠端桌面連線 7.0：<br />
Windows6.0-KB2483614-x86.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於 Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 上的遠端桌面連線 6.1：<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">適用於遠端桌面連線 6.1：<br />
請參閱 <a href="https://support.microsoft.com/kb/2481109/zh-tw">Microsoft 知識庫文件編號 2481109</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;">在沒有使用者介入的情況下安裝</td>
<td style="border:1px solid black;">適用於所有受支援 32 位元版本的 Windows Server 2008 上的遠端桌面連線 6.1：<br />
Windows6.0-KB2481109-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於所有受支援 x64 版本的 Windows Server 2008 上的遠端桌面連線 6.1：<br />
Windows6.0-KB2481109-x64.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於所有受支援 Itanium 版本的 Windows Server 2008 上的遠端桌面連線 6.1：<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2481109/zh-tw">Microsoft 知識庫文件編號 2481109</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;"><strong>注意：</strong>登錄機碼不存在，無法驗證此更新是否存在。</td>
...
<tr class="odd">
<td style="border:1px solid black;">在沒有使用者介入的情況下安裝</td>
<td style="border:1px solid black;">適用於所有受支援 32 位元版本的 Windows 7 上的遠端桌面連線 7.0：<br />
Windows6.1-KB2483614-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於所有受支援 x64 版本的 Windows 7 上的遠端桌面連線 7.0：<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2483614/zh-tw">Microsoft 知識庫文件編號 2483614</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;"><strong>注意：</strong>登錄機碼不存在，無法驗證此更新是否存在。</td>
...
<tr class="odd">
<td style="border:1px solid black;">在沒有使用者介入的情況下安裝</td>
<td style="border:1px solid black;">適用於所有受支援 x64 版本的 Windows Server 2008 R2 上的遠端桌面連線 7.0：<br />
Windows6.1-KB2483614-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於所有受支援 Itanium 版本的 Windows Server 2008 R2 上的遠端桌面連線 7.0：<br />
...
-   感謝 [Versafe Anti Fraud](https://www.versafe-login.com/) 的 Eyal Gruner 回報遠端桌面不安全程式庫載入資訊安全風險 (CVE-2011-0029)
