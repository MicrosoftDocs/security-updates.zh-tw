...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2011-1976](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1976) (英文)。
...
-   依照預設，Windows Server 2003、Windows Server 2008 和 Windows Server 2008 R2 上的 Internet Explorer 會以稱為[增強式安全性設定](https://technet.microsoft.com/en-us/library/dd883248(ws.10).aspx)的受限制模式執行。此模式可緩和這項弱點。如需更多資訊，請參閱此安全性更新＜常見問題集＞關於 Internet Explorer 增強式安全性設定的部分。  
...
| **檔案資訊**                           | 請參閱 [Microsoft 知識庫文件編號 2548826](https://support.microsoft.com/kb/2548826)                                                                                                                           |  
...
| HotPatching                            | 不適用                                                                             |  
| **移除資訊**                           | 使用 \[控制台\] 中的 \[新增或移除程式\] 工具。                                     |  
| **檔案資訊**                           | 請參閱 [Microsoft 知識庫文件編號 2579115](https://support.microsoft.com/kb/2579115) |  
| **登錄機碼驗證**                       | **注意：**登錄機碼不存在，無法驗證此更新是否存在。                                 |
...
-   感謝 [Gotham Digital Science](https://www.gdssecurity.com/) 的 Adam Bixby 回報 Report Viewer 控制項 XSS 弱點 (CVE-2011-1976)
