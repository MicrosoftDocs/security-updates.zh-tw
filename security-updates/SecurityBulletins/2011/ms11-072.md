...
**已知問題。** [Microsoft 知識庫文件編號 2587505](https://support.microsoft.com/kb/2587505) 中記載了客戶安裝此安全性更新時，可能會發生的目前已知問題。該文件並說明了解決這些問題的建議解決方案。目前已知問題和建議解決方案僅適用於此軟體的特定版本，本文會提供詳細文章的連結。
...
Microsoft Excel 2003 啟用 Office 檔案驗證功能時，不會自動開啟意圖利用 CVE-2011-1986 和 CVE-2011-1987 中所描述之弱點的蓄意製作檔案；而是依預設提示使用者選擇是否要開啟這類檔案。使用者必須一一點選警告訊息來開啟檔案，弱點才有可能遭到利用。如需 Microsoft Excel 2003 中的 Office 檔案驗證之詳細資訊，請參閱 [Microsoft 安全性摘要報告 2501584](https://www.microsoft.com/technet/security/advisory/2501584.mspx)。

Microsoft Excel 2007 啟用 Office 檔案驗證功能時，不會自動開啟意圖利用 CVE-2011-1987 中所描述之弱點的蓄意製作檔案；而是依預設提示使用者選擇是否要開啟這類檔案。使用者必須一一點選警告訊息來開啟檔案，弱點才有可能遭到利用。如需 Microsoft Excel 2007 中的 Office 檔案驗證之詳細資訊，請參閱 [Microsoft 安全性摘要報告 2501584](https://www.microsoft.com/technet/security/advisory/2501584.mspx)。

在 Microsoft Excel 2010 中，依預設會啟用 Office 檔案驗證。意圖利用 CVE-2011-1987 中所描述之弱點的蓄意製作檔案會驗證失敗，並在[受保護的檢視](https://www.microsoft.com/security/pc-security/office2010.aspx)中開啟；然後使用者必須一一關閉數個警告訊息來開啟並編輯檔案，弱點才有可能遭到利用。

**如果我停止在 Excel 2003 中開啟未通過檔案驗證的檔案，有哪些好處？**  
[Microsoft 知識庫文件編號 2501584](https://support.microsoft.com/kb/2501584) 提供之「停用 Excel 2003 和 2007 文件開啟」這一項 **Microsoft Fix it** 解決方案，可將 Office 檔案驗證設為不允許在 Excel 2003 中開啟可疑的檔案，進而阻止攻擊模式利用 CVE-2011-1986 和 CVE-2011-1987 中描述的弱點。
...
[Microsoft 知識庫文件編號 2501584](https://support.microsoft.com/kb/2501584) 提供之「停用 Excel 2003 和 2007 文件開啟」這一項 **Microsoft Fix it** 解決方案，可將 Office 檔案驗證設為不允許在 Excel 2007 中開啟可疑的檔案，進而阻止攻擊模式利用 CVE-2011-1987 中描述的弱點。

請參閱 [Microsoft 知識庫文件編號 2501584](https://support.microsoft.com/kb/2501584) 中有關套用「停用 PowerPoint 2003 和 2007 文件開啟」這一項自動化 Fix it 解決方案的說明，或參閱本公告＜弱點資訊＞一節中有關 CVE-2011-1987 的「因應措施」等節，以取得手動套用解決方案的說明。

**如果我停止在 Excel 2010 中開啟未通過檔案驗證的檔案，有哪些好處？**  
[Microsoft 知識庫文件編號 2501584](https://support.microsoft.com/kb/2501584) 提供了自動化的 **Microsoft Fix it** 解決方案「停用 Excel 2010 受保護檢視中的編輯功能」，可阻止攻擊模式利用 CVE-2011-1987。如果客戶選擇稍後再安裝 Excel 2010 的安全性更新，則可以選擇套用 Fix it 解決方案以作為因應措施。

請參閱 [Microsoft 知識庫文件編號 2501584](https://support.microsoft.com/kb/2501584) 中有關套用「停用 Excel 2010 受保護檢視中的編輯功能」這一項自動化 Fix it 解決方案的說明，或參閱本公告＜弱點資訊＞一節中有關 CVE-2011-1987 的「因應措施」等節，以取得手動套用解決方案的說明。
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2011-1986](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1986) (英文)。
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2011-1987](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1987) (英文)。
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2011-1988](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1988) (英文)。
...
-   **使用 Microsoft Office 檔案封鎖原則，來封鎖開啟來自於未知或不信任來源與位置的 Office 2003 (或更早版本) 文件。**
    ...
    **因應措施的影響。** 針對 Microsoft Office 2003 和 Microsoft Office 2007，使用者若已設定檔案封鎖原則，但尚未設定特殊豁免目錄或把檔案移到信任的位置，將無法開啟 Office 2003 或更早版本的檔案。如需進一步瞭解 Microsoft Office 軟體中檔案封鎖設定之影響，請參閱 [Microsoft 知識庫文件編號 922850](https://support.microsoft.com/kb/922850)。
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2011-1989](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1989) (英文)。
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2011-1990](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1990) (英文)。
...
**Microsoft Office SharePoint Server 2007 注意事項** 上述的偵測表格是以單一伺服器 Microsoft Office SharePoint Server 2007 部署為基礎。在設定為多重系統 SharePoint 伺服器陣列組成部分的系統上，偵測工具並未偵測更新的適用性。如需更多關於同時在獨立電腦和多重伺服器設定上部署更新的資訊，請參閱 TechNet 文章：[部署 Office SharePoint Server 2007 的軟體更新](https://technet.microsoft.com/zh-tw/library/cc263467(office.12).aspx)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2553072">Microsoft 知識庫文件編號 2553072</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">Microsoft Excel 2007 Service Pack 2：<br />
請參閱 <a href="https://support.microsoft.com/kb/2553073">Microsoft 知識庫文件編號 2553073</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office 2007 Service Pack 2：<br />
請參閱 <a href="https://support.microsoft.com/kb/2553089">Microsoft 知識庫文件編號 2553089</a><br />
請參閱 <a href="https://support.microsoft.com/kb/2553090">Microsoft 知識庫文件編號 2553090</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Excel Viewer Service Pack 2：<br />
請參閱 <a href="https://support.microsoft.com/kb/2553075">Microsoft 知識庫文件編號 2553075</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於 Microsoft Office Word、Excel 及 PowerPoint 2007 檔案格式相容性套件：<br />
請參閱 <a href="https://support.microsoft.com/kb/2553074">Microsoft 知識庫文件編號 2553074</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">Microsoft Excel 2010 和 Microsoft Excel 2010 Service Pack 1 (32 位元版本)：<br />
請參閱 <a href="https://support.microsoft.com/kb/2553070">Microsoft 知識庫文件編號 2553070</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office 2010 和 Microsoft Office 2010 Service Pack 1 (32 位元版本)：<br />
請參閱 <a href="https://support.microsoft.com/kb/2553091">Microsoft 知識庫文件編號 2553091</a><br />
請參閱 <a href="https://support.microsoft.com/kb/2553096">Microsoft 知識庫文件編號 2553096</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Excel 2010 和 Microsoft Excel 2010 Service Pack 1 (64 位元版本)：<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Excel Web App：<br />
請參閱 <a href="https://support.microsoft.com/kb/2553095">Microsoft 知識庫文件編號 2553095</a></td>
</tr>
<tr class="even">
...
從 [Microsoft 下載中心](https://www.microsoft.com/download/details.aspx?familyid=868f4d9f-3498-4d59-a017-59204553889c)下載並安裝適當語言版本的 Microsoft Office 2004 for Mac 11.6.5 Update。
...
從 [Microsoft 下載中心](https://www.microsoft.com/download/details.aspx?familyid=afa79cfc-6e8a-4d0b-88aa-0d7e05031e44)下載並安裝適當語言版本的 Microsoft Office 2008 for Mac 12.3.1 Update。
...
從 [Microsoft 下載中心](https://www.microsoft.com/download/details.aspx?familyid=535fcf4a-eeb2-44eb-b2a6-9c512509c49d)下載並安裝適當語言版本的 Microsoft Office for Mac 2011 14.1.3 Update。
...
從 [Microsoft 下載中心](https://www.microsoft.com/download/details.aspx?familyid=9796588d-238f-4694-9598-1aa8d2becb55)下載並安裝適當語言版本的 Open XML File Format Converter for Mac 1.2.1 Update。
...
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">安裝在 Microsoft Office SharePoint Server 2007 Service Pack 2 (32 位元版本) 上的 Excel Services：<br />
請參閱 <a href="https://support.microsoft.com/kb/2553093">Microsoft 知識庫文件編號 2553093</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">安裝在 Microsoft Office SharePoint Server 2007 Service Pack 2 (64 位元版本) 上的 Excel Services：<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2553094">Microsoft 知識庫文件編號 2553094</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
-   感謝匿名的研究人員與 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作回報 Excel 釋放後使用 WriteAV 弱點 (CVE-2011-1986)  
-   感謝 [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Sean Larsson 回報 Excel 陣列超出範圍索引弱點 (CVE-2011-1987)  
-   感謝匿名的研究人員與 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作，回報 Excel 堆積損毀弱點 (CVE-2011-1988)  
-   感謝匿名的研究人員與 [TippingPoint](https://www.tippingpoint.com/) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，回報 Excel 條件運算式剖析弱點 (CVE-2011-1989)  
-   感謝 Omair 與 [TippingPoint](https://www.tippingpoint.com/) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，回報 Excel 陣列超出範圍索引弱點 (CVE-2011-1990)
