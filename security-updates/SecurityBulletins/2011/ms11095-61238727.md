...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=3b816964-d3c3-4f05-94c3-f54a6f54ca73">Active Directory 應用程式模式 (ADAM)</a> (英文下載更新程式)<br />
(KB2626416)  
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=3b816964-d3c3-4f05-94c3-f54a6f54ca73">Active Directory 應用程式模式 (ADAM)</a> (中文下載更新程式)<br />
(KB2626416)
</div></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=986f0087-c674-4060-8710-af3496adbfdd">Active Directory 應用程式模式 (ADAM)</a> (英文下載更新程式)<br />
(KB2626416)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/zh-tw/security/bulletin/ms11-086">MS11-086</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=01caf06f-777d-4ea8-95ca-e11d60a973ad">Active Directory</a> (英文下載更新程式)<br />
(KB2621146)<br />
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=01caf06f-777d-4ea8-95ca-e11d60a973ad">Active Directory</a> (中文下載更新程式)  
<div>
(KB2621146)<br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=6f7c7ccd-22a3-4fbc-bf21-bd0e42ab1da5">Active Directory 應用程式模式 (ADAM)</a> (英文下載更新程式)<br />
(KB2626416)  
</div>
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=6f7c7ccd-22a3-4fbc-bf21-bd0e42ab1da5">Active Directory 應用程式模式 (ADAM)</a> (中文下載更新程式)<br />
(KB2626416)
</div></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e1ba50cf-fc6b-4668-b71c-e9f75a8ac638">Active Directory</a> (英文下載更新程式)<br />
(KB2621146)<br />
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=e1ba50cf-fc6b-4668-b71c-e9f75a8ac638">Active Directory</a> (中文下載更新程式)<br />
(KB2621146)<br />
<br />
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=1b610eb3-456c-4125-94b7-1ead4face8e3">Active Directory 應用程式模式 (ADAM)</a> (英文下載更新程式)<br />
(KB2626416)  
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=1b610eb3-456c-4125-94b7-1ead4face8e3">Active Directory 應用程式模式 (ADAM)</a> (中文下載更新程式)  
</div>
<div>
(KB2626416)
</div></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=74099261-60ad-4c68-906c-60e131818955">Active Directory</a> (英文下載更新程式)<br />
(KB2621146)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/zh-tw/security/bulletin/ms11-086">MS11-086</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=470da512-2c8b-4ba9-b7bb-b9e6c45cd33f">Active Directory 輕量型目錄服務 (AD LDS)</a> (英文下載更新程式)<br />
(KB2621146)  
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=470da512-2c8b-4ba9-b7bb-b9e6c45cd33f">Active Directory 輕量型目錄服務 (AD LDS)</a> (中文下載更新程式)<br />
(KB2621146)
</div></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=8daf9a49-60cb-4813-ac7a-e9a4bf296889">Active Directory 輕量型目錄服務 (AD LDS)</a> (英文下載更新程式)<br />
(KB2621146)  
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=8daf9a49-60cb-4813-ac7a-e9a4bf296889">Active Directory 輕量型目錄服務 (AD LDS)</a> (中文下載更新程式)<br />
(KB2621146)
</div></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=6f9ddcdb-a471-4e00-a697-92a24e4ea8d4">Active Directory 和 Active Directory 輕量型目錄服務 (AD LDS)</a> (英文下載更新程式)<br />
(KB2621146)  
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=6f9ddcdb-a471-4e00-a697-92a24e4ea8d4">Active Directory 和 Active Directory 輕量型目錄服務 (AD LDS)</a> (中文下載更新程式)<br />
(KB2621146)
</div></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=5253477b-422f-404a-941e-8b69da5a2670">Active Directory 和 Active Directory 輕量型目錄服務 (AD LDS)</a> (英文下載更新程式)<br />
(KB2621146)  
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=5253477b-422f-404a-941e-8b69da5a2670">Active Directory 和 Active Directory 輕量型目錄服務 (AD LDS)</a> (中文下載更新程式)<br />
(KB2621146)
</div></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=d2e87199-6469-4bc0-a721-f43e817e4344">Active Directory 輕量型目錄服務 (AD LDS)</a> (英文下載更新程式)<br />
(KB2621146)  
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=d2e87199-6469-4bc0-a721-f43e817e4344">Active Directory 輕量型目錄服務 (AD LDS)</a> (中文下載更新程式)<br />
(KB2621146)
</div></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ba8d7aa9-8299-49a3-b0c0-b8b5eab48434">Active Directory 輕量型目錄服務 (AD LDS)</a> (英文下載更新程式)<br />
(KB2621146)  
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=ba8d7aa9-8299-49a3-b0c0-b8b5eab48434">Active Directory 輕量型目錄服務 (AD LDS)</a> (中文下載更新程式)<br />
(KB2621146)
</div></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a3e0d27c-8b29-4981-bdef-bcd037fd3408">Active Directory 和 Active Directory 輕量型目錄服務 (AD LDS)</a> (英文下載更新程式)<br />
(KB2621146)  
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=a3e0d27c-8b29-4981-bdef-bcd037fd3408">Active Directory 和 Active Directory 輕量型目錄服務 (AD LDS)</a> (中文下載更新程式)<br />
(KB2621146)
</div></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-3406](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3406) (英文)。
...
-   在企業防火牆封鎖 TCP 連接埠 389
    ...
    本通訊埠用來起始與受影響元件的連線。在企業防火牆封鎖上述連接埠 (含輸入及輸出) 有助於保護防火牆後的系統免遭此資訊安全風險的影響。建議您封鎖所有網際網路中來路不明的輸入通訊，以防他人利用其他連接埠攻擊系統。如需更多關於連接埠的資訊，請參閱 TechNet 文章：[TCP 和 UDP 連接埠的指派](http://technet.microsoft.com/zh-tw/library/cc977599.aspx) (英文)。如需 Windows 防火牆的詳細資訊，請參閱 TechNet 文章：[如何在單一電腦上設定 Windows 防火牆](http://www.microsoft.com/technet/security/smallbusiness/prodtech/windowsxp/cfgfwall.mspx) (英文)。
...
Active Directory 網域服務 (AD DS) 會儲存目錄資料並管理使用者和網域之間的通訊，包括使用者登入程序、驗證及目錄搜尋。Active Directory 網域控制站是執行 AD DS 的伺服器。如需 AD DS 的詳細資訊，請參閱 TechNet 文章：[Active Directory 網域服務](http://technet.microsoft.com/zh-tw/library/cc770946(ws.10).aspx)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2626416?ln=zh-tw">Microsoft 知識庫文件編號 2626416</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;">檔案資訊</td>
<td style="border:1px solid black;">如需 Windows Server 2003 上的 Active Directory 相關資訊，請參閱 <a href="http://support.microsoft.com/kb/2621146?ln=zh-tw">Microsoft 知識庫文件編號 2621146</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">如需 Windows Server 2003 上的 Active Directory 應用程式模式 (ADAM) 相關資訊，請參閱 <a href="http://support.microsoft.com/kb/2626416?ln=zh-tw">Microsoft 知識庫文件編號 2626416</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">登錄機碼驗證</td>
...
<tr class="even">
<td style="border:1px solid black;">檔案資訊</td>
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2621146?ln=zh-tw">Microsoft 知識庫文件編號 2621146</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">登錄機碼驗證</td>
