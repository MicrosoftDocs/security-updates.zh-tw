...
**已知問題。** [Microsoft 知識庫文件編號 2604930](http://support.microsoft.com/kb/2604930?ln=zh-tw) 中記載了客戶安裝此資訊安全更新時，可能會發生的目前已知問題。該文件並說明了解決這些問題的建議解決方案。
...
(英文下載更新程式)  
[Microsoft .NET Framework 1.0 Service Pack 3](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=a54a7ad5-0504-4cc6-9eca-ba9f31c35a17)  
(KB2572066)  
(僅限 Media Center Edition 2005 和 Tablet PC Edition 2005)  
(中文下載更新程式)  
...
(KB2572067)  
(英文下載更新程式)  
[Microsoft .NET Framework 1.1 Service Pack 1](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=6100e577-deb5-4395-b851-e19e0ca79507)  
(KB2572067)  
(中文下載更新程式)  
...
(KB2572073)  
(英文下載更新程式)  
[Microsoft .NET Framework 2.0 Service Pack 2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=719b3da5-52ca-4d56-a2c5-69711039e59d)  
(KB2572073)  
(中文下載更新程式)  
...
(KB2572078)  
(英文下載更新程式)  
[Microsoft .NET Framework 4](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=770e7b58-6544-4f59-9893-b3eadf6d6c8a)<sup>[1]</sup>
(KB2572078)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2572066 取代 [MS09-061](http://technet.microsoft.com/zh-tw/security/bulletin/ms09-061) 中的 KB953295  
KB2572067 取代 [MS10-070](http://technet.microsoft.com/zh-tw/security/bulletin/ms10-070) 中的 KB2416447  
[MS10-060](http://technet.microsoft.com/zh-tw/security/bulletin/ms10-060)中的 KB983583 由 KB2572073 取代  
KB2572078 未取代任何公告
</td>
</tr>
...
(KB2572069)  
(英文下載更新程式)  
[Microsoft .NET Framework 1.1 Service Pack 1](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=b968b0bd-577b-4ea2-a192-a80fe7c20791)  
(KB2572069)  
(中文下載更新程式)  
[Microsoft .NET Framework 2.0 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=719b3da5-52ca-4d56-a2c5-69711039e59d)  
(KB2572073)  
...
<td style="border:1px solid black;">
KB2572069 取代 [MS09-061](http://search.microsoft.com/search.aspx?mkt=zh-tw) 中的 KB953298  
[MS10-060](http://technet.microsoft.com/zh-tw/security/bulletin/ms10-060)中的 KB983583 由 KB2572073 取代  
KB2572078 未取代任何公告
</td>
</tr>
...
(KB2572075)  
(英文下載更新程式)  
[Microsoft .NET Framework 2.0 Service Pack 2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=7c27128d-eaf9-4416-b8b1-9edab9102feb)  
(KB2572075)  
(中文下載更新程式)  
[Microsoft .NET Framework 4](http://www.microsoft.com/downloads/details.aspx?familyid=770e7b58-6544-4f59-9893-b3eadf6d6c8a)<sup>[1]</sup>
(KB2572078)  
...
<td style="border:1px solid black;">
KB2572067 取代 [MS10-070](http://technet.microsoft.com/zh-tw/security/bulletin/ms10-070) 中的 KB2416447  
[MS10-060](http://technet.microsoft.com/zh-tw/security/bulletin/ms10-060)中的 KB983589 由 KB2572075 取代  
KB2572078 未取代任何公告
</td>
</tr>
<tr>
...
(KB2572076)  
(英文下載更新程式)  
[Microsoft .NET Framework 3.5.1](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=81be7ff1-3ba2-430c-9edf-619cc246daf2)  
(KB2572076)  
(中文下載更新程式)  
[Microsoft .NET Framework 4](http://www.microsoft.com/downloads/details.aspx?familyid=770e7b58-6544-4f59-9893-b3eadf6d6c8a)<sup>[1]</sup>
(KB2572078)  
...
(KB2572077)  
(英文下載更新程式)  
[Microsoft .NET Framework 3.5.1](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=98403988-7438-4260-95b5-a4796dbe0618)  
(KB2572077)  
(中文下載更新程式)  
[Microsoft .NET Framework 4](http://www.microsoft.com/downloads/details.aspx?familyid=770e7b58-6544-4f59-9893-b3eadf6d6c8a)<sup>[1]</sup>
(KB2572078)  
...
可在兩個設定檔中使用 .NET Framework 第 4 版可轉散發套件： .NET Framework 4 和 .NET Framework 4 Client Profile。.NET Framework 4 Client Profile 是 .NET Framework 4 設定檔的子集，其已針對用戶端應用程式進行最佳化。它會為多數用戶端應用程式提供功能，包括 Windows Presentation Foundation (WPF)、Windows Forms、Windows Communication Foundation (WCF) 和 ClickOnce 功能。這可為以 .NET Framework 4 Client Profile 為目標的應用程式進行更快速的部署及使用更小的安裝套件。如需詳細資訊，請參閱 MSDN 文章：[.NET Framework Client Profile](http://msdn.microsoft.com/zh-tw/library/5a4x27ek.aspx) (英文)。
...
<span></span>
下列嚴重性等級是假設資訊安全風險可能造成的最嚴重影響而評定。在本資訊安全公告發行的 30 天內，如需資訊安全風險之易遭利用性與嚴重性等級和資訊安全影響之間對應關係的資訊，請參閱 [10 月份公告摘要](http://technet.microsoft.com/security/bulletin/ms11-oct.mspx)中的＜資訊安全風險入侵指數＞。如需更多資訊，請參閱 [Microsoft 資訊安全風險入侵指數](http://technet.microsoft.com/zh-tw/security/cc998259.aspx)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-1253](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1253) (英文)。
...
-   依照預設，Windows Server 2003、Windows Server 2008 和 Windows Server 2008 R2 上的 Internet Explorer 會以稱為增強式資訊安全設定的受限制模式執行。只有針對 Windows Server 2008 和 Windows Server 2008 R2 上的網頁瀏覽攻擊案例，這種模式才能減輕此資訊安全風險。如需更多資訊，請參閱此資訊安全風險＜常見問題集＞關於 Internet [Explorer 增強式資訊安全設定](http://msdn.microsoft.com/zh-tw/library/ms537180.aspx)的部份。
...
在網站代管的情況中，成功利用此資訊安全風險的攻擊者能取得與 Microsoft .NET 應用程式在其下執行的應用程式集區，其應用程式集區身分識別相關之服務帳戶相同的權限。依授予服務帳戶的應用程式集區隔離設定和權限而定，攻擊者也許能控制網頁伺服器上的其他應用程式集區，或完全控制受影響的系統。如需更多關於應用程式集區身分識別及設定的資訊，請參閱 TechNet 文章：[設定應用程式集區身分識別](http://technet.microsoft.com/zh-tw/library/cc781986(ws.10).aspx) (英文)。
...
資訊安全更新可從 [Microsoft Update](http://go.microsoft.com/fwlink/?linkid=40747) 以及 [](http://update.microsoft.com/windowsupdate/v6/default.aspx)[Windows Update](http://update.microsoft.com/windowsupdate/v6/default.aspx)</a> 取得。資訊安全更新也可以從 [Microsoft 下載中心](http://www.microsoft.com/downloads/results.aspx?displaylang=en&freetext=security%20update)取得。您也可以利用「資訊安全更新」("security update") 關鍵字搜尋輕易地找到資訊安全更新。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2604930?ln=zh-tw">Microsoft 知識庫文件編號 2604930</a></td>
</tr>
<tr class="odd">
...
-   感謝匿名投稿人與 [Beyond Security 的 SecuriTeam Secure Disclosure](http://www.beyondsecurity.com/ssd.html) 計畫合作，回報 .NET Framework 類別繼承資訊安全風險 (CVE-2011-1253)
