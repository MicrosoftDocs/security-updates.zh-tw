...
**已知問題。**[Microsoft 知識庫文件編號 2652016](http://support.microsoft.com/kb/2652016) 中記載了客戶安裝此安全性更新時，可能會發生的目前已知問題。該文件並說明了解決這些問題的建議解決方案。目前已知問題和建議解決方案僅適用於此軟體的特定版本，本文會提供詳細文章的連結。
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2011-2010](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2010) (英文)。
...
<a href="http://support.microsoft.com/kb/2596511">Microsoft 知識庫文件編號 2596511</a></td>
</tr>
<tr class="even">
