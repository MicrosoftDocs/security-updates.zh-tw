...
**已知問題。**[Microsoft 知識庫文件編號 2567951](http://support.microsoft.com/kb/2567951) 中記載了客戶安裝此安全性更新時，可能會發生的目前已知問題。該文件並說明了解決這些問題的建議解決方案。
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2011-1978](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1978) (英文)。
...
-   安裝了 [KB2562394](http://support.microsoft.com/kb/2562394) 的客戶，一旦進行使用者互動才會遭利用。這項透過 [MS11-044](http://go.microsoft.com/fwlink/?linkid=216436)提供的更新程式，可避免網際網路區域的 ClickOnce 應用程式不先提示使用者便直接執行。如果應用程式的權限僅限於網際網路，未安裝 [KB2562394](http://support.microsoft.com/kb/2562394)的客戶便不會收到對話方塊。如需更多關於本功能的資訊，請參閱 [KB2562394](http://support.microsoft.com/kb/2562394)。
...
.NET Framework 中的 System.Net.Sockets 命名空間為需要嚴格控管網路存取的開發人員，提供 Windows Socket (Winsock) 介面管理的實作。如需更多資訊，請參閱 MSDN 文章：[System.Net.Sockets 命名空間](http://msdn.microsoft.com/en-us/library/sb27wehh.aspx) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2567951">Microsoft 知識庫文件編號 2567951</a></td>
</tr>
<tr class="odd">
