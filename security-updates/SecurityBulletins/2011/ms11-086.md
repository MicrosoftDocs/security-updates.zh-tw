---
TOCTitle: 'MS11-086'
Title: 'Microsoft Security Bulletin MS11-086 - 重要'
ms:assetid: 'ms11-086'
ms:contentKeyID: 61238718
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms11-086(v=Security.10)'
---

Microsoft Security Bulletin MS11-086 - 重要
===========================================

Active Directory 中的資訊安全風險可能會允許權限提高 (2630837)
-------------------------------------------------------------
...
這個資訊安全更新可解決 Active Directory、Active Directory 應用程式模式 (ADAM) 及 Active Directory 輕量型目錄服務 (AD LDS) 中一個未公開報告的資訊安全風險。如果將 Active Directory 設定為使用 LDAP over SSL (LDAPS)，而且攻擊者取得與有效網域帳戶相關的撤銷憑證，然後使用該撤銷憑證驗證 Active Directory 網域，此資訊安全風險可能會允許權限提高。依預設，Active Directory 不會設定為使用 LDAP over SSL。

對於安裝在所有受支援版本的 Windows XP、Windows Server 2003、Windows Vista、Windows Server 2008 (Itanium 型版本除外)、Windows 7 和 Windows Server 2008 R2 (Itanium 型版本除外) 上的 Active Directory、ADAM 和 AD LDS，此資訊安全更新的等級為「重要」。如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此資訊安全更新可藉由變更 Active Directory 針對憑證撤銷清單 (CRL) 驗證憑證的方式來解決此資訊安全風險。如需更多有關此資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8c7c21c5-677d-4a5d-8f2b-8ca7691b6b00">Active Directory 應用程式模式 (ADAM)</a><br />
(KB2616310)<br />
(英文下載更新程式)  
<div>
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=8c7c21c5-677d-4a5d-8f2b-8ca7691b6b00&amp;displaylang=zh-tw">Active Directory 應用程式模式 (ADAM)</a><br />
(KB2616310)<br />
(中文下載更新程式)
</div></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms10-068">MS10-068</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=989cca2d-cce1-4f52-b50e-43152693f240">Active Directory 應用程式模式 (ADAM)</a><br />
(KB2616310)  
<div>
(英文下載更新程式)
</div></td>
...
(英文下載更新程式)  
<div>
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=08b27ce7-c32e-41e4-ad04-481c5eab17a7&amp;displaylang=zh-tw">Active Directory</a><br />
(KB2601626)<br />
(中文下載更新程式)  
</div>
<div>
<a href="https://www.microsoft.com/download/details.aspx?familyid=f116824e-ea48-422d-b284-c9ffa7604bf5">Active Directory 應用程式模式 (ADAM)</a><br />
(KB2616310)<br />
(英文下載更新程式)  
</div>
<div>
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=f116824e-ea48-422d-b284-c9ffa7604bf5&amp;displaylang=zh-tw">Active Directory 應用程式模式 (ADAM)</a><br />
(KB2616310)<br />
(中文下載更新程式)
</div></td>
<td style="border:1px solid black;">權限提高</td>
...
(KB2601626)<br />
(英文下載更新程式)<br />
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=de5a74f2-2cc8-4677-b495-3a40fe3d6b9e&amp;displaylang=zh-tw">Active Directory</a><br />
(KB2601626)<br />
(中文下載更新程式)  
<div>
<a href="https://www.microsoft.com/download/details.aspx?familyid=1af1b734-62c7-4e08-91c8-90b6d026da84">Active Directory 應用程式模式 (ADAM)</a><br />
(KB2616310)<br />
(英文下載更新程式)  
</div>
<div>
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=1af1b734-62c7-4e08-91c8-90b6d026da84&amp;displaylang=zh-tw">Active Directory 應用程式模式 (ADAM)</a><br />
(KB2616310)<br />
(中文下載更新程式)
</div></td>
<td style="border:1px solid black;">權限提高</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2bd602cf-ae0d-4790-a5d0-6133fd7d01a0">Active Directory 輕量型目錄服務 (AD LDS)</a><br />
(KB2601626)<br />
(英文下載更新程式)  
<div>
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=2bd602cf-ae0d-4790-a5d0-6133fd7d01a0&amp;displaylang=zh-tw">Active Directory 輕量型目錄服務 (AD LDS)</a><br />
(KB2601626)<br />
(中文下載更新程式)
</div></td>
<td style="border:1px solid black;">權限提高</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=783521ad-5c50-4194-a582-4e5a1c9999e7">Active Directory 輕量型目錄服務 (AD LDS)</a><br />
(KB2601626)<br />
(英文下載更新程式)  
<div>
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=783521ad-5c50-4194-a582-4e5a1c9999e7&amp;displaylang=zh-tw">Active Directory 輕量型目錄服務 (AD LDS)</a><br />
(KB2601626)<br />
(中文下載更新程式)
</div></td>
<td style="border:1px solid black;">權限提高</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b5688923-3914-4f6c-8bc9-036fb4870cc6">Active Directory 和 Active Directory 輕量型目錄服務 (AD LDS)</a>*<br />
(KB2601626)<br />
(英文下載更新程式)  
<div>
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=b5688923-3914-4f6c-8bc9-036fb4870cc6&amp;displaylang=zh-tw">Active Directory 和 Active Directory 輕量型目錄服務 (AD LDS)</a>*<br />
(KB2601626)<br />
(中文下載更新程式)
</div></td>
<td style="border:1px solid black;">權限提高</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=51f47181-08f6-4de1-80e5-253355675965">Active Directory 和 Active Directory 輕量型目錄服務 (AD LDS)</a>*<br />
(KB2601626)<br />
(英文下載更新程式)  
<div>
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=51f47181-08f6-4de1-80e5-253355675965&amp;displaylang=zh-tw">Active Directory 和 Active Directory 輕量型目錄服務 (AD LDS)</a>*<br />
(KB2601626)<br />
(中文下載更新程式)
</div></td>
<td style="border:1px solid black;">權限提高</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b06f9f55-e3b2-4705-83d0-1b9f5de9d378">Active Directory 輕量型目錄服務 (AD LDS)</a><br />
(KB2601626)<br />
(英文下載更新程式)  
<div>
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=b06f9f55-e3b2-4705-83d0-1b9f5de9d378&amp;displaylang=zh-tw">Active Directory 輕量型目錄服務 (AD LDS)</a><br />
(KB2601626)<br />
(中文下載更新程式)
</div></td>
<td style="border:1px solid black;">權限提高</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=790f1d99-96a5-438d-b433-895b692912ce">Active Directory 輕量型目錄服務 (AD LDS)</a><br />
(KB2601626)<br />
(英文下載更新程式)  
<div>
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=790f1d99-96a5-438d-b433-895b692912ce&amp;displaylang=zh-tw">Active Directory 輕量型目錄服務 (AD LDS)</a><br />
(KB2601626)<br />
(中文下載更新程式)
</div></td>
<td style="border:1px solid black;">權限提高</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=cc1e99af-fc67-400b-a82c-171f8c4d1ac9">Active Directory 和 Active Directory 輕量型目錄服務 (AD LDS)</a>*<br />
(KB2601626)<br />
(英文下載更新程式)  
<div>
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=cc1e99af-fc67-400b-a82c-171f8c4d1ac9&amp;displaylang=zh-tw">Active Directory 和 Active Directory 輕量型目錄服務 (AD LDS)</a>*<br />
(KB2601626)<br />
(中文下載更新程式)
</div></td>
<td style="border:1px solid black;">權限提高</td>
...
| 適用於 Itanium 型系統的 Windows Server 2008 R2 和適用於 Itanium 型系統的 Windows Server 2008 R2 Service Pack 1<sup>[1]</sup> |
  
<sup>[1]</sup>這些版本的 Microsoft Windows 因為不含 ADAM、AD LDS 或 Active Directory 伺服器元件，所以不受影響。
  
與本資訊安全更新相關的常見問題集 (FAQ)  
--------------------------------------
  
我所執行的作業系統 列於受影響的軟體表內。為什麼我沒有收到這項資訊安全更新？    
此更新僅提供給已安裝受影響元件的系統。
...
<th style="border:1px solid black;" >
LDAPS 驗證略過資訊安全風險 - CVE-2011-2014  
</th>
<th style="border:1px solid black;" >
彙總嚴重性等級  
</th>
...
Active Directory 設定為使用 LDAP over SSL (LDAPS) 時，存在權限提高資訊安全風險。攻擊者可使用先前撤銷的憑證來驗證 Active Directory 網域，因而取得網路資源的存取權，或利用與該憑證相關之特定授權使用者的權限執行程式碼，藉此利用此資訊安全風險。

若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-2014](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2014) (英文)。

#### LDAPS 驗證略過資訊安全風險 - CVE-2011-2014 的緩和因素

緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。下列緩和因素可能對您的狀況有所助益：

-   最佳實作的防火牆和標準預設防火牆設定有助於防止網路受到來自企業外的攻擊。最佳方式建議連線至網際網路的系統盡可能曝露最少數量的連接埠。

#### LDAPS 驗證略過資訊安全風險 - CVE-2011-2014 的因應措施
...
-   帳戶
-   。
-   除使用 LDAPS 外，於「一律檢查 CRL」模式中***使用* *IPsec***型連線。

    如需關於如何為 IPsec 啟用 CRL 檢查的資訊，請參閱 TechNet 文章，[憑證撤銷清單 (CRL) 驗證 - 應用程式選擇](https://social.technet.microsoft.com/wiki/contents/articles/964.aspx)。

    注意：

    1.  以 IPsec 加密並保護使用憑證驗證與 CRL 檢查的 LDAPS 連線。
    2.  以 IPsec 保護使用憑證驗證與 CRL 檢查且沒有加密的 LDAPS 連線。在此情況下，LDAPS 會處理加密。對於受影響的 Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2 版本，您可以使用 AuthIP (允許使用者驗證的 IPsec 延伸) 避免攻擊者使用電腦憑證執行 IPsec 憑證驗證，然後使用撤銷的使用者憑證執行 LDAPS 驗證。
    3.  為 LDAPS 使用 NULL 封裝以防止進行兩次加密，同時請留意 IPsec 層級的憑證驗證與 SSL 中的驗證無關。這表示在每個層使用不同的憑證，仍會允許透過到期的憑證存取 LDAPS。

#### LDAPS 驗證略過資訊安全風險 - CVE-2011-2014 的常見問題集

這個資訊安全風險的範圍為何？  
這是權限提高的資訊安全風險。成功利用這項資訊安全風險的攻擊者可能使用特定授權使用者的權限，取得網路資源的存取權或執行程式碼。

造成這個資訊安全風險的原因為何？  
造成此資訊安全風險的原因是由於將 Active Directory 設定為使用 LDAPS，而且未針對與網域帳戶相關的 CRL 驗證 SSL 憑證的撤銷狀態。這會允許憑證被接受為有效的憑證，即使憑證授權單位 (CA) 已撤銷該憑證。

什麼是憑證授權單位 (CA)？    
憑證授權單位就是發行憑證的組織。憑證授權單位會建立並驗證屬於某個人或其他憑證授權單位的公開金鑰之真實性，並且驗證要求憑證的人員或組織之身分。

什麼 是Active Directory 服務？  
...
Active Directory 輕量型目錄服務 (AD LDS) 是獨立模式的 Active Directory，提供專屬的目錄服務供應用程式使用。AD LDS 適用於 Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2。AD LDS 取代了 Windows XP 和 Windows Server 2003 中的 Active Directory 應用程式模式 (ADAM)。如需 AD LDS 的詳細資訊，請參閱 TechNet 文章：[Active Directory 輕量型目錄服務](https://technet.microsoft.com/en-us/library/cc731868(ws.10).aspx)。

什麼是 Active Directory 應用程式模式？  
Active Directory 應用程式模式 (ADAM) 是一種輕量型目錄存取通訊協定 (LDAP) 目錄服務，是以 Windows XP 和 Windows Server 2003 使用者服務的形式執行，而非系統服務。如需 ADAM 的詳細資訊，請參閱 TechNet 文章：[ADAM 簡介](https://technet.microsoft.com/en-us/library/cc780837(ws.10).aspx)。
...
什麼是憑證撤銷清單 (CRL)？  
CRL 是 CA 所發行、經數位簽署的一份清單，其中列出由 CA 所發行、而隨後經 CA 撤銷的憑證。針對每一份撤銷的憑證，這份清單皆包含憑證的序號、撤銷憑證的日期，以及撤銷原因。應用程式可執行 CRL 檢查，來判斷目前憑證的撤銷狀態。如需憑證撤銷檢查的詳細資訊，請參閱 TechNet 文章：[憑證撤銷和狀態檢查](https://technet.microsoft.com/en-us/library/ee619730(ws.10).aspx)。

什麼是 LDAP over SSL (LDAPS)？  
LDAP over SSL (LDAPS) 利用安全通訊端層 (SSL)/傳輸層安全性 (TLS) 技術，對用戶端電腦和伺服器電腦之間傳輸的流量加密。

什麼是 Active Directory 網域服務？  
Active Directory 網域服務 (AD DS) 會儲存目錄資料並管理使用者和網域之間的通訊，包括使用者登入程序、驗證及目錄搜尋。Active Directory 網域控制站是執行 AD DS 的伺服器。如需 AD DS 的詳細資訊，請參閱 TechNet 文章：[Active Directory 網域服務](https://technet.microsoft.com/en-us/library/cc770946(ws.10).aspx)。

攻擊者可能會利用這項資訊安全風險採取什麼行動？  
成功利用這項資訊安全風險的攻擊者可能使用特定授權使用者的權限，取得網路資源的存取權或執行程式碼。如果使用者具有系統管理員權限，攻擊者便可安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。

攻擊者如何利用這項 資訊安全風險？  
為利用此資訊安全風險，攻擊者首先必須取得與網域上有效帳戶相關的撤銷憑證。接著攻擊者可使用這個先前撤銷的憑證來驗證 Active Directory 網域，因而取得網路資源的存取權，或利用與該憑證相關之特定授權使用者的權限執行程式碼，藉此利用此資訊安全風險。

因為這個資訊安全風險而承受風險的主要系統有哪些？  
所有執行受影響作業系統、且已安裝 Active Directory 服務的系統，都會受到此資訊安全風險影響。

更新的作用何在？  
此更新藉由變更 Active Directory 針對 CRL 驗證憑證有效性的方式來解決此資訊安全風險。
...
<td style="border:1px solid black;">針對 Windows XP Service Pack 3 上的 Active Directory 應用程式模式 (ADAM)：<br />
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB2616310$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">檔案資訊</td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2616310">Microsoft 知識庫文件編號 2616310</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;">移除資訊</td>
<td style="border:1px solid black;">如果是 Active Directory，請使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB2601626$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">如果是 Active Directory 應用程式模式 (ADAM)，請使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB2616310$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">檔案資訊</td>
<td style="border:1px solid black;">如需 Windows Server 2003 上的 Active Directory 相關資訊，請參閱 <a href="https://support.microsoft.com/kb/2601626">Microsoft 知識庫文件編號 2601626</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">如需 Windows Server 2003 上的 Active Directory 應用程式模式 (ADAM) 相關資訊，請參閱 <a href="https://support.microsoft.com/kb/2616310">Microsoft 知識庫文件編號 2616310</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">登錄機碼驗證</td>
...
<tr class="even">
<td style="border:1px solid black;">檔案資訊</td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2601626">Microsoft 知識庫文件編號 2601626</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">登錄機碼驗證</td>
...
<tr class="even">
<td style="border:1px solid black;">重新開機 需求</td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">需要重新開機？</td>
...
<tr class="odd">
<td style="border:1px solid black;">在沒有使用者介入的情況下安裝</td>
<td style="border:1px solid black;">對於所有含 AD LDS 的受支援 32 位元版本 Windows 7：<br />
Windows6.1-KB2601626-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">對於所有含 AD LDS 的受支援 x64 型版本 Windows 7：<br />
...
-   感謝 Autosécurité 的 Xavier Lassoie 和 Sébastien Godard 回報 LDAPS 驗證略過資訊安全風險 (CVE-2011-2014)
