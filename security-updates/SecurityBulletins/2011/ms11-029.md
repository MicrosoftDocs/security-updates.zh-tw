...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=59266a9d-a319-4309-a046-7f15c6da0136">Windows XP Service Pack 3 (英文下載更新程式)</a><br />
(KB2412687)  
<a href="https://www.microsoft.com/download/details.aspx?familyid=59266a9d-a319-4309-a046-7f15c6da0136&amp;displaylang=zh-tw">Windows XP Service Pack 3 (中文下載更新程式)</a><br />
(KB2412687)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3797009a-b9a4-4e83-8614-e1589c8b5090">Windows XP Professional x64 Edition Service Pack 2 (英文下載更新程式)</a><br />
(KB2412687)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-062">MS09-062</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=fd284233-e177-4064-9b02-f83dcb727dbe">Windows Server 2003 Service Pack 2 (英文下載更新程式)</a><br />
(KB2412687)  
<a href="https://www.microsoft.com/download/details.aspx?familyid=fd284233-e177-4064-9b02-f83dcb727dbe&amp;displaylang=zh-tw">Windows Server 2003 Service Pack 2 (中文下載更新程式)</a><br />
(KB2412687)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-062">MS09-062</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=d5adaf4e-4cd7-42ea-8202-31b5c856f5e3">Windows Server 2003 x64 Edition Service Pack 2 (英文下載更新程式)</a><br />
(KB2412687)  
<a href="https://www.microsoft.com/download/details.aspx?familyid=d5adaf4e-4cd7-42ea-8202-31b5c856f5e3&amp;displaylang=zh-tw">Windows Server 2003 x64 Edition Service Pack 2 (中文下載更新程式)</a><br />
(KB2412687)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-062">MS09-062</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=72a513bb-f901-4992-8562-d1afe1afec8a">適用於 Itanium 型系統的 Windows Server 2003 SP2 (英文下載更新程式)</a><br />
(KB2412687)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-062">MS09-062</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4ff2e440-79c2-4045-b225-913d1740fdb9">Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 (英文下載更新程式)</a><br />
(KB2412687)  
<a href="https://www.microsoft.com/download/details.aspx?familyid=4ff2e440-79c2-4045-b225-913d1740fdb9&amp;displaylang=zh-tw">Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 (中文下載更新程式)</a><br />
(KB2412687)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-062">MS09-062</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4d826026-e62a-4cec-8682-49fbe7f65cd6">Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 (英文下載更新程式)</a><br />
(KB2412687)  
<a href="https://www.microsoft.com/download/details.aspx?familyid=4d826026-e62a-4cec-8682-49fbe7f65cd6&amp;displaylang=zh-tw">Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 (中文下載更新程式)</a><br />
(KB2412687)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-062">MS09-062</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=fbada866-7d36-4b85-acde-fd856a998737">適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a>&#42;&#42;&#42;<br />
(KB2412687)  
<a href="https://www.microsoft.com/download/details.aspx?familyid=fbada866-7d36-4b85-acde-fd856a998737&amp;displaylang=zh-tw">適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2 (中文下載更新程式)</a>&#42;&#42;&#42;<br />
(KB2412687)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-062">MS09-062</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8f4ddfcb-374d-4cad-8c61-2b988b46f628">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a>&#42;&#42;&#42;<br />
(KB2412687)  
<a href="https://www.microsoft.com/download/details.aspx?familyid=8f4ddfcb-374d-4cad-8c61-2b988b46f628&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2 (中文下載更新程式)</a>&#42;&#42;&#42;<br />
(KB2412687)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-062">MS09-062</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2fd71543-0e18-4907-89b9-355d24d7db69">適用於 Itanium 型系統的 Windows Server 2008 和適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a><br />
(KB2412687)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms09-062">MS09-062</a></td>
...
本公告所提供的 Microsoft Office XP 資訊安全更新套件 (KB2509461) 也能解決 [MS11-023](https://technet.microsoft.com/security/bulletin/ms11-029) 資訊安全公告中提出的資訊安全風險。 已安裝 Microsoft Office XP 的使用者只需安裝此資訊安全更新套件一次。

**最新有關 GDI+ 的 Microsoft 資訊安全公告MS09-062 列出本公告未列出的受影響和不受影響軟體。 為什麼？**  
本公告中列出的軟體是經由測試判定哪些受支援版本受影響以及哪些不受影響。 [MS09-062](https://technet.microsoft.com/security/bulletin/ms09-062) 所列出的其他版本已超出支援週期，或僅只適用於安裝在已不公開支援的 Windows 2000 Service Pack 4 上的 GDI+。 若要瞭解您的軟體版本的支援週期，請造訪 [Microsoft 產品技術支援週期網站](https://go.microsoft.com/fwlink/?linkid=21742)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-0041](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0041)。
...
-   **停用中繼檔案處理**
    ...
    套用了 [MS07-017](https://go.microsoft.com/fwlink/?linkid=84687) 或使用 Windows Vista 或 Windows Server 2008 的客戶可透過修改登錄來停用中繼檔案處理。 這個設定有助於保護受影響系統，防範嘗試利用此資訊安全風險所發動的攻擊。
    ...
    **因應措施的影響。** 關閉中繼檔的處理可能導致軟體或系統元件的功能效能降低。 關閉中繼檔案的處理也可能導致軟體或系統元件完全失敗。 請評估此因應措施的適用性。 不利結果的範例包括下列情況：
    ...
    如需更多關於這個設定的資訊，請參閱 [Microsoft 知識庫文件編號 941835](https://support.microsoft.com/kb/941835/zh-tw)。
...
如需有關影像類型及格式的更多資訊，請參閱 [Microsoft 知識庫文件編號 320314](https://support.microsoft.com/kb/320314/zh-tw)。您也可以在 [MSDN Library 網站](https://msdn.microsoft.com/en-us/library/ms536391.aspx)中找到有關這些檔案格式的其他資訊。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2412687/zh-tw">Microsoft 知識庫文件編號 2412687</a></td>
</tr>
<tr class="even">
...
-   感謝 [VUPEN Threat Protection Program](https://www.vupen.com/english/services/tpp-index.php) 的 Nicolas Joly 和 Chaouki Bekrar 回報 GDI+ 整數溢位資訊安全風險 (CVE-2011-0041)
