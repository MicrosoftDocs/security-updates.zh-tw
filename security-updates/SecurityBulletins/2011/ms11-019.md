---
TOCTitle: 'MS11-019'
Title: 'Microsoft Security Bulletin MS11-019 - 重大'
ms:assetid: 'ms11-019'
ms:contentKeyID: 61238651
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms11-019(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-019 - 重大
===========================================

SMB 用戶端中的資訊安全風險可能會允許遠端執行程式碼 (2511455)
------------------------------------------------------------
...
這個資訊安全更新可解決 Microsoft Windows 中一項公開揭露的資訊安全風險和一項未公開報告的資訊安全風險。 如果攻擊者將蓄意製作的 SMB 回應傳送至一用戶端啟動的 SMB 要求，這些資訊安全風險可能會允許遠端執行程式碼。 要利用這些資訊安全風險，攻擊者必須引誘使用者啟動連至一台蓄意製作的 SMB 伺服器的 SMB 連線。

對於所有受支援版本的 Microsoft Windows，此資訊安全更新的等級為「重大」。 如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此資訊安全更新可更正 CIFS 瀏覽器處理蓄意製作的瀏覽器訊息之方式，並更正 SMB 用戶端驗證蓄意製作的 SMB 回應之方式，進而解決這些資訊安全風險。 如需更多有關資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f5378e7b-4619-4c42-9d9f-87b209c6d878">Windows XP Service Pack 3 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=f5378e7b-4619-4c42-9d9f-87b209c6d878&amp;displaylang=zh-tw">Windows XP Service Pack 3 (中文下載更新程式)</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c01441da-8933-4f60-923b-d9b00db8ba3d">Windows XP Professional x64 Edition Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-020">MS10-020</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=d46fe0bf-28c2-4696-87bc-dd3c8287fc28">Windows Server 2003 Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=d46fe0bf-28c2-4696-87bc-dd3c8287fc28&amp;displaylang=zh-tw">Windows Server 2003 Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ca0fb4d3-7651-4760-83fa-b71c86cbe459">Windows Server 2003 x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=ca0fb4d3-7651-4760-83fa-b71c86cbe459&amp;displaylang=zh-tw">Windows Server 2003 x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=87eb8b93-9829-45ec-9528-52787732044e">適用於 Itanium 型系統的 Windows Server 2003 SP2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=da8dd55d-6630-484e-836c-9feeab5cc311">Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=da8dd55d-6630-484e-836c-9feeab5cc311&amp;displaylang=zh-tw">Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-020">MS10-020</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=040f8b46-f458-4a72-a1b0-ad8a65a1194c">Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=040f8b46-f458-4a72-a1b0-ad8a65a1194c&amp;displaylang=zh-tw">Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-020">MS10-020</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b0cfd5e0-6de5-4863-b5e4-b223a0e36d72">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a>*
<a href="https://www.microsoft.com/download/details.aspx?familyid=b0cfd5e0-6de5-4863-b5e4-b223a0e36d72&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2 (中文下載更新程式)</a>&#42;</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-020">MS10-020</a></td>
</tr>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8eaf51cd-2f6e-4bbc-bc4f-9deed03649ac">適用於 Itanium 型系統的 Windows Server 2008 和適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-020">MS10-020</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=0dcba089-19f7-46ca-9e52-24eaebad4715">適用於 32 位元系統的 Windows 7 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=0dcba089-19f7-46ca-9e52-24eaebad4715&amp;displaylang=zh-tw">適用於 32 位元系統的 Windows 7 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-020">MS10-020</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=0dcba089-19f7-46ca-9e52-24eaebad4715">適用於 32 位元系統的 Windows 7 Service Pack 1 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=0dcba089-19f7-46ca-9e52-24eaebad4715&amp;displaylang=zh-tw">適用於 32 位元系統的 Windows 7 Service Pack 1 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b7fd356a-56d0-4638-8901-40acfa600f25">適用於 x64 型系統的 Windows 7 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=b7fd356a-56d0-4638-8901-40acfa600f25&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows 7 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-020">MS10-020</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b7fd356a-56d0-4638-8901-40acfa600f25">適用於 x64 型系統的 Windows 7 Service Pack 1 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=b7fd356a-56d0-4638-8901-40acfa600f25&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows 7 Service Pack 1 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=27a3847b-695b-4f60-aea5-86b0dbe68945">適用於 x64 型系統的 Windows Server 2008 R2 (英文下載更新程式)</a>*
<a href="https://www.microsoft.com/download/details.aspx?familyid=27a3847b-695b-4f60-aea5-86b0dbe68945&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows Server 2008 R2 (中文下載更新程式)</a>&#42;</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-020">MS10-020</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=27a3847b-695b-4f60-aea5-86b0dbe68945">適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1 (英文下載更新程式)</a>*
<a href="https://www.microsoft.com/download/details.aspx?familyid=27a3847b-695b-4f60-aea5-86b0dbe68945&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1 (中文下載更新程式)</a>&#42;</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1e7d3f21-bdbd-4826-855d-85422aa5f836">適用於 Itanium 系統的 Windows Server 2008 R2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-020">MS10-020</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1e7d3f21-bdbd-4826-855d-85422aa5f836">適用於 Itanium 型系統的 Windows Server 2008 R2 Service Pack 1 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<th style="border:1px solid black;" >瀏覽器集區損毀資訊安全風險 - CVE-2011-0654</th>
<th style="border:1px solid black;" >SMB 用戶端回應剖析資訊安全風險 - CVE-2011-0660</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
瀏覽器集區損毀資訊安全風險 - CVE-2011-0654  
------------------------------------------
  

Common Internet File System (CIFS) 瀏覽器通訊協定實作剖析格式錯誤的瀏覽器訊息的方式中，存在未經驗證的遠端執行程式碼資訊安全風險。 攻擊者不需要驗證即可利用這項資訊安全風險。 成功利用此資訊安全風險的攻擊者可執行任意程式碼，並取得受影響之系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-0654](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0654)。
  
#### 瀏覽器集區損毀資訊安全風險 - CVE-2011-0654 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   最佳實作的防火牆和標準預設防火牆設定有助於防止網路受到來自企業外的攻擊。 最佳方式建議連線至網際網路的系統盡可能曝露最少數量的連接埠。 在此情況下，應該從網際網路上封鎖 NetBIOS Datagram Service 連接埠 (UDP 138)。
  
#### 瀏覽器集區損毀資訊安全風險 - CVE-2011-0654 的因應措施
  
因應措施指的是無法徹底修正資訊安全風險，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。 Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：
  
-   **在防火牆中封鎖 TCP 連接埠 138**
  
    本通訊埠用來起始與受影響元件的連線。 在防火牆封鎖 UDP 連接埠 138 有助於保護防火牆後方的系統免遭此資訊安全風險的攻擊。 Microsoft 建議您封鎖所有網際網路中來路不明的輸入通訊，以防他人利用其他連接埠攻擊系統。 如需更多關於連接埠的資訊，請參閱 TechNet 文章 [TCP 和 UDP 連接埠的指派](https://go.microsoft.com/fwlink/?linkid=21312) (英文)。
  
    **因應措施的影響。** 需依靠電腦瀏覽器服務的應用程式將無法運作。 這包括網路上的芳鄰等功能及 NET VIEW 命令。
  
    **如何復原因應措施：** 取消防火牆對 TCP 通訊埠 138 的封鎖。 如需更多關於連接埠的資訊，請參閱 [TCP 和 UDP 連接埠的指派](https://go.microsoft.com/fwlink/?linkid=21312) (英文)。
  
#### 瀏覽器集區損毀資訊安全風險 - CVE-2011-0654 的常見問題集
  
**這個資訊安全風險的範圍為何？**  
這是遠端執行程式碼的資訊安全風險。 成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個資訊安全風險的原因為何？**  
這個資訊安全風險存在的原因，是由於 CIFS 瀏覽器通訊協定實作不正確剖析蓄意製作的電腦瀏覽器訊息所致。 這可能導致記憶體損毀問題，允許以系統等級權限執行程式碼。
...
**什麼是瀏覽器服務？**  
瀏覽器服務維護電腦所在的網域名稱或工作群組名稱之清單，以及執行瀏覽器服務的電腦所服務的網路區段上每台電腦所使用的通訊協定清單。 在每一網路區段上，主瀏覽器是從執行瀏覽器服務的區段上的電腦群組中選擇。 如需更多關於 Computer Browser 服務的資訊，請參閱 [Microsoft 知識庫文件編號 188001](https://support.microsoft.com/kb/188001/zh-tw)。
  
**什麼是 Common Internet File System (CIFS) 瀏覽器通訊協定？**  
CIFS 瀏覽器通訊協定定義作為網路上可用服務的結算所之伺服器所傳送及接收的訊息、在網路上提供列印或檔案共用等服務的伺服器，以及要求特定服務的詳細資訊之用戶端。 在 CIFS 瀏覽器通訊協定中，瀏覽是用於發現提供特別服務的伺服器之程序。 如需詳細資訊，請參閱 MSDN 文章，[\[MS-BRWS\]： Common Internet File System (CIFS) 瀏覽器通訊協定規格 (英文)](https://msdn.microsoft.com/en-us/library/cc224428(prot.10).aspx)。
  
**什麼是主瀏覽器？**  
主瀏覽器負責收集主機或伺服器宣告，主瀏覽器的網路區段上每台伺服器每 12 分鐘將這些宣告以資料包傳送。 主瀏覽器指示將每個網路區段的可能瀏覽器變成備份瀏覽器。 指定網路區段上的備份瀏覽器為同一區段內的用戶端電腦提供瀏覽清單。 如需更多關於 Computer Browser 服務的資訊，請參閱 [Microsoft 知識庫文件編號 188001](https://support.microsoft.com/kb/188001/zh-tw)。
  
**攻擊者可能會利用這項資訊安全風險採取什麼行動？**  
成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。 大多數利用此資訊安全風險的情況會導致受影響的系統停止回應並重新啟動。
  
**攻擊者如何利用這項資訊安全風險？**  
攻擊者可以建立蓄意製作的瀏覽器訊息，並將訊息傳送給受影響的系統，以利用這項資訊安全風險。
  
**因為這個資訊安全風險而承受風險的主要系統有哪些？**  
所有受影響的作業系統都有受攻擊的風險。 網域主控站 (PDC) 的風險很大，因為其通常是指定網域內的主瀏覽器。 網路上的任何系統可成為主瀏覽器，因此易受到影響。
  
**更新的作用何在？**  
此更新會修正 CIFS 瀏覽器處理蓄意製作之瀏覽器訊息的方式，進而解決此項資訊安全風險。
  
**當資訊安全公告發行時，這項資訊安全風險是否已揭發出來？**  
是。 這項資訊安全風險已經遭到公開揭發。 這項資訊安全風險已被指派「一般性資訊安全風險」編號 [CVE-2011-0654](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0654)。
  
**當本資訊安全公告發行時，Microsoft 是否已接獲任何消息，指出這項資訊安全風險已遭有心人士利用？**  
否。 當本資訊安全公告初次發行時，Microsoft 尚未接到任何有關本資訊安全風險已公開用來攻擊客戶的消息。
  
SMB 用戶端回應剖析資訊安全風險 - CVE-2011-0660  
----------------------------------------------
  

Microsoft 伺服器訊息區 (SMB) 用戶端驗證蓄意製作的 SMB 回應的方式中，存在未經驗證的遠端執行程式碼資訊安全風險。 攻擊者不需要驗證即可利用這項資訊安全風險，因此可藉由傳送蓄意製作的 SMB 回應至用戶端啟動的要求來利用資訊安全風險。 成功利用此資訊安全風險的攻擊者可執行任意程式碼，並取得受影響之系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-0660](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0660)。
  
#### SMB 用戶端回應剖析資訊安全風險 - CVE-2011-0660 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   最佳實作的防火牆和標準預設防火牆設定有助於防止網路受到來自企業外的攻擊。 最佳方式建議連線至網際網路的系統盡可能曝露最少數量的連接埠。 在此情況下，應該從網際網路上封鎖輸出 SMB 連接埠。
  
#### SMB 用戶端回應剖析資訊安全風險 - CVE-2011-0660 的因應措施
  
因應措施指的是無法徹底修正資訊安全風險，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。 Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：
  
-   **在防火牆中封鎖 TCP 連接埠 139 和 445**
  
    上述連接埠用於起始與受影響元件的連線。 在防火牆封鎖 TCP 連接埠 139 與 445 有助於保護防火牆後方的系統免遭此資訊安全風險的攻擊。 針對這項特定的資訊安全風險，應該同時封鎖輸入和輸出的 SMB 資料流，以降低受資訊安全風險危害的風險。 Microsoft 建議您封鎖所有網際網路中來路不明的輸入通訊，以防他人利用其他連接埠攻擊系統。 如需更多關於連接埠的資訊，請參閱 TechNet 文章 [TCP 和 UDP 連接埠的指派](https://go.microsoft.com/fwlink/?linkid=21312) (英文)。
...
#### SMB 用戶端回應剖析資訊安全風險 - CVE-2011-0660 的常見問題集
  
**這個資訊安全風險的範圍為何？**  
這是遠端執行程式碼的資訊安全風險。 成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個資訊安全風險的原因為何？**  
這個資訊安全風險存在的原因，是由於 Microsoft 伺服器訊息區 (SMB) 用戶端實作不正確驗證蓄意製作的 SMB 回應所致。
...
**哪些 SMB 版本受到此資訊安全風險影響？**  
此資訊安全風險的問題會影響 SMBv1 和 SMBv2 兩個版本。
  
**使用 Internet Explorer 是否可利用這項資訊安全風險？**  
否。 然而，此問題可能會透過網路交易利用，瀏覽器類型不限。 在網頁式攻擊案例中，攻擊者必須主控含有蓄意製作的 URI 的網頁。 瀏覽該網站的使用者將執行 SMB 連線至攻擊者控制的 SMB 伺服器，從而將格式錯誤的回應傳回給使用者。 此回應將導致使用者的系統停止回應。 此外，受侵害的網站以及接受或存放使用者提供之內容的網站裡，也可能包含蓄意製作以利用本資訊安全風險的內容。 攻擊者並不能強迫使用者造訪蓄意製作的網站， 而是引誘使用者自行前往，一般的做法是設法讓使用者按一下電子郵件或 Instant Messenger 訊息中通往攻擊者網站的連結。
...
**攻擊者如何利用這項資訊安全風險？**  
攻擊者可架設一台蓄意製作的 SMB 伺服器來利用此資訊安全風險，然後引誘使用者啟動連至此伺服器的 SMB 連線。 另外，在本機網路上的攻擊者可能會執行攔截式攻擊，以惡意的 SMB 回應來回應合法的 SMB 要求。
  
**因為這個資訊安全風險而承受風險的主要系統有哪些？**  
所有受影響的作業系統都有受攻擊的風險。
  
**更新的作用何在？**  
此資訊安全更新會修正 SMB 用戶端驗證蓄意製作之 SMB 回應的方式，進而解決此項資訊安全風險。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB2511455$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2511455/zh-tw">Microsoft 知識庫文件編號 2511455</a></td>
</tr>
<tr class="even">
