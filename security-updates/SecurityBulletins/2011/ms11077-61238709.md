...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------|----------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=9157e677-ab3f-44b0-9735-192bc7421ba7)                                                                                      | 遠端執行程式碼   | 重要           | [MS11-054](http://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0f2444ac-61bd-47cf-9c1e-da86a2b0cfb5)                                                             | 遠端執行程式碼   | 重要           | [MS11-054](http://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3bd62bf6-3400-4c03-95fe-148112b341e8)                                                                             | 遠端執行程式碼   | 重要           | [MS11-054](http://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b73f4e87-9655-46d5-beb2-ea245dcd280d)                                                                 | 遠端執行程式碼   | 重要           | [MS11-054](http://go.microsoft.com/fwlink/?linkid=220172) |
| [適用於 Itanium 型系統的 Windows Server 2003 SP2](http://www.microsoft.com/downloads/details.aspx?familyid=a618cc19-5ebc-462e-a518-d9bfe41ed98e)                                                                | 遠端執行程式碼   | 重要           | [MS11-054](http://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ff53d01b-97b7-40d2-af88-4978f1099a7c)                                                                                   | 遠端執行程式碼   | 重要           | [MS11-054](http://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=47322e11-f1cf-4f70-b939-8cac9bbfc2bc)                                                                       | 遠端執行程式碼   | 重要           | [MS11-054](http://go.microsoft.com/fwlink/?linkid=220172) |
| [適用於 32 位元系統的 Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7c7498ee-eba4-44fd-8846-0b2e96c96705)\*                                                      | 遠端執行程式碼   | 重要           | [MS11-054](http://go.microsoft.com/fwlink/?linkid=220172) |
| [適用於 x64 型系統的 Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=40386742-f397-402e-8810-63d3d6ba12a6)\*                                                       | 遠端執行程式碼   | 重要           | [MS11-054](http://go.microsoft.com/fwlink/?linkid=220172) |
| [適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3633402b-96cb-4f36-b137-d07d1baf28c7)                                                     | 遠端執行程式碼   | 重要           | [MS11-054](http://go.microsoft.com/fwlink/?linkid=220172) |
| [適用於 32 位元系統的 Windows 7 和適用於 32 位元系統的 Windows 7 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=9e40bc26-f77f-4b57-9b3d-9d053c19ac56)                                 | 遠端執行程式碼   | 重要           | [MS11-054](http://go.microsoft.com/fwlink/?linkid=220172) |
| [適用於 x64 型系統的 Windows 7 和適用於 x64 型系統的 Windows 7 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=219554e6-eb5a-42d0-90c0-42b4d0772cfd)                                   | 遠端執行程式碼   | 重要           | [MS11-054](http://go.microsoft.com/fwlink/?linkid=220172) |
| [適用於 x64 型系統的 Windows Server 2008 R2 和適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=39bd4cfb-fe61-41b8-a5a2-73a9e720fc72)\*       | 遠端執行程式碼   | 重要           | [MS11-054](http://go.microsoft.com/fwlink/?linkid=220172) |
| [適用於 Itanium 型系統的 Windows Server 2008 R2 和適用於 Itanium 型系統的 Windows Server 2008 R2 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=0d35c6d0-6d2d-42bf-a97f-4c5e01b1937e) | 遠端執行程式碼   | 重要           | [MS11-054](http://go.microsoft.com/fwlink/?linkid=220172) |
...
<span></span>
下列嚴重性等級是假設資訊安全風險可能造成的最嚴重影響而評定。在本資訊安全公告發行的 30 天內，如需資訊安全風險之易遭利用性與嚴重性等級和資訊安全影響之間對應關係的資訊，請參閱 [10 月份公告摘要](http://technet.microsoft.com/zh-tw/security/bulletin/ms11-oct)中的＜資訊安全風險入侵指數＞。如需更多資訊，請參閱 [Microsoft 資訊安全風險入侵指數](http://technet.microsoft.com/zh-tw/security/cc998259.aspx)。
...
\*會影響 Server Core 安裝。無論上述受支援的 Windows Server 2008 或 Windows Server 2008 R2 版本是否使用 Server Core 安裝選項安裝，這個更新均以相同的嚴重性等級套用。如需此安裝選項的詳細資訊，請參閱 TechNet 文章：[管理 Server Core 安裝](http://technet.microsoft.com/zh-tw/library/ee441255(ws.10).aspx) (英文) 和[維護 Server Core 安裝](http://technet.microsoft.com/zh-tw/library/ee441255(ws.10).aspx) (英文)。請注意，Server Core 安裝選項不適用於某些 Windows Server 2008 和 Windows Server 2008 R2 版本；請參閱[比較 Server Core 安裝選項](http://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-1985](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1985) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-2002](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2002) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-2003](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2003) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-2011](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2011) (英文)。
...
TrueType 字型檔案包括 TrueType 模擬轉譯器及作業系統軟體所使用的多種不同資訊，以確保電腦螢幕上顯示的字元或列印出來的字元完全符合字型設計者的預期。如需詳細資訊，請參閱 MSDN 文章[關於字型內嵌](http://msdn.microsoft.com/en-us/library/ms533034.aspx) (英文)。「受影響軟體」表格列出的所有作業系統均預設支援呈現 EOT 字型。
...
管理您必須部署到您組織中的伺服器、桌上型電腦及行動系統的軟體和資訊安全更新。如需更多資訊，請參閱 [TechNet 更新管理中心](http://technet.microsoft.com/zh-tw/updatemanagement/bb245732) (英文)。[Microsoft TechNet 資訊安全技術中心網站](http://go.microsoft.com/fwlink/?linkid=21132)提供了有關 Microsoft 產品安全性的其他資訊。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2567053">Microsoft 知識庫文件編號 2567053</a></td>
</tr>
<tr class="even">
...
-   感謝 [BitDefender](http://www.bitdefender.com/) 的 Andrei Lutas 回報 Win32k Null 指標取值資訊安全風險 (CVE-2011-1985)  
-   感謝 [Norman](http://www.norman.com/) 的 Tarjei Mandt 回報 Win32k Null 指標取值資訊安全風險 (CVE-2011-1985)  
-   感謝 Maik Wellmann 回報 Win32k TrueType 字型類型翻譯資訊安全風險 (CVE-2011-2002)  
-   感謝 [CERT/CC](http://www.cert.org/) 的 Will Dorman 回報字型庫檔案緩衝區溢位資訊安全風險 (CVE-2011-2003)
