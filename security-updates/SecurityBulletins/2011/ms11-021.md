...
**已知問題。** [Microsoft 知識庫文件編號 2489279](http://support.microsoft.com/kb/2489279/zh-tw) 中記載了客戶在安裝此資訊安全更新時可能會發生的已知問題。 該文件並說明了解決這些問題的建議解決方案。 目前已知問題和建議解決方案僅適用於此軟體的特定版本，本文會提供詳細文章的連結。
...
是。 Microsoft Excel 2003 Service Pack 3 (KB2502786) 的更新和 Microsoft Excel 2007 Service Pack 2 (KB2464583) 的更新，搭配 [MS11-023](http://technet.microsoft.com/security/bulletin/ms11-023) 中提供的更新，共同為 Office 檔案驗證功能提供支援。 如需 Office 檔案驗證功能的更多資訊，請參閱 [Microsoft 資訊安全摘要報告 2501584](http://technet.microsoft.com/security/advisory/2501584)。
...
此公告提供的 Microsoft Office 2004 for Mac (KB2505924)、Microsoft Office 2008 for Mac (KB2505927) 和 Open XML File Format Converter for Mac (KB2505935) 之資訊安全更新套件，同時解決了 [MS11-022](http://technet.microsoft.com/security/bulletin/ms11-022) 和 [MS11-023](http://technet.microsoft.com/security/bulletin/ms11-023) 資訊安全公告中描述的資訊安全風險。 此公告提供的 Microsoft Office for Mac 2011 (KB2525412) 之資訊安全更新套件同時解決了 [MS11-022](http://technet.microsoft.com/security/bulletin/ms11-022) 中描述的資訊安全風險。安裝 Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac、Open XML File Format Converter for Mac 或 Microsoft Office for Mac 2011 的使用者只需要安裝這些資訊安全更新套件一次即可。
...
若要在「一般性資訊安全風險」清單標準項目中檢視此資訊安全風險，請參閱 [CVE-2011-0097](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0097)。
...
若要在「一般性資訊安全風險」清單標準項目中檢視此資訊安全風險，請參閱 [CVE-2011-0098](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0098)。
...
若要在「一般性資訊安全風險」清單標準項目中檢視此資訊安全風險，請參閱 [CVE-2011-0101](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0101)。
...
若要在「一般性資訊安全風險」清單標準項目中檢視此資訊安全風險，請參閱 [CVE-2011-0103](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0103)。
...
若要在「一般性資訊安全風險」清單標準項目中檢視此資訊安全風險，請參閱 [CVE-2011-0104](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0104)。
...
若要在「一般性資訊安全風險」清單標準項目中檢視此資訊安全風險，請參閱 [CVE-2011-0105](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0105)。
...
若要在「一般性資訊安全風險」清單標準項目中檢視此資訊安全風險，請參閱 [CVE-2011-0978](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0978)。
...
若要在「一般性資訊安全風險」清單標準項目中檢視此資訊安全風險，請參閱 [CVE-2011-0979](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0979)。
...
-   **在Microsoft Excel中使用Microsoft Office檔案封鎖原則，封鎖開啟來自未知或不信任來源及位置的Office 2003 (或更早版本)文件**
    ...
    **因應措施的影響。** 針對 Microsoft Office 2003 和 Microsoft Office 2007，使用者若已設定檔案封鎖原則，但尚未按照 [Microsoft 知識庫文件編號 922848](http://support.microsoft.com/kb/922848/zh-tw) 的說明來設定特殊豁免目錄或把檔案移到信任的位置，將無法開啟 Office 2003 或更早版本的檔案。 Microsoft Office 2010 則會根據選取的開啟行為，封鎖 Office 2003 或更早版本的檔案的開啟，或在保護模式中開啟這類檔案。
...
若要在「一般性資訊安全風險」清單標準項目中檢視此資訊安全風險，請參閱 [CVE-2011-0980](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0980)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2466169/zh-tw">Microsoft 知識庫文件編號 2466169</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2502786/zh-tw">Microsoft 知識庫文件編號 2502786</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">針對 Microsoft Excel 2007，請參閱 <a href="http://support.microsoft.com/kb/2464583/zh-tw">Microsoft 知識庫文件編號 2464583</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">針對 Microsoft Excel Viewer，請參閱 <a href="http://support.microsoft.com/kb/2466158/zh-tw">Microsoft 知識庫文件編號 2466158</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">針對 Word、Excel 及 PowerPoint 2007 檔案格式的 Microsoft Office 相容性套件，請參閱 <a href="http://support.microsoft.com/kb/2466156/zh-tw">Microsoft 知識庫文件編號 2466156</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2466146/zh-tw">Microsoft 知識庫文件編號 2466146</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
-   感謝 [Secunia Research](http://secunia.com/) 的 Alin Rad Pop 回報 Excel 整數溢位資訊安全風險 (CVE-2011-0097)  
-   感謝 [Secunia Research](http://secunia.com/) 的 Alin Rad Pop 回報 Excel 堆積溢位資訊安全風險 (CVE-2011-0098)  
-   感謝 [Telus Security Labs](http://www.telussecuritylabs.com) 的 Muhammad Junaid Bohio 回報 Excel 記錄剖析 WriteAV 資訊安全風險 (CVE-2011-0101)  
-   感謝 Aniway 與 [TippingPoint](http://www.tippingpoint.com/) 的 [Zero Day Initiative](http://www.zerodayinitiative.com/) 合作，回報 Excel 記錄剖析 WriteAV 資訊安全風險 (CVE-2011-0101)  
-   感謝匿名的研究人員回報 Excel 記憶體損毀資訊安全風險 (CVE-2011-0103)  
-   感謝 [Check Point Vulnerability Discovery Team](http://www.checkpoint.com/) (VDT) 的 Rodrigo Rubira Branco 回報 Excel 緩衝區覆寫資訊安全風險 (CVE-2011-0104)  
-   感謝 Aniway 與 [TippingPoint](http://www.tippingpoint.com/) 的 [Zero Day Initiative](http://www.zerodayinitiative.com/) 合作，回報 Excel 資料初始化資訊安全風險 (CVE-2011-0105)  
-   感謝 Aniway 與 [TippingPoint](http://www.tippingpoint.com/) 的 [Zero Day Initiative](http://www.zerodayinitiative.com/) 合作，回報 Excel 陣列索引資訊安全風險 (CVE-2011-0978)  
-   感謝匿名研究人員與 [TippingPoint](http://www.tippingpoint.com/) 的 [Zero Day Initiative](http://www.zerodayinitiative.com/) 合作，回報 Excel 連結的清單損毀資訊安全風險 (CVE-2011-0979)  
-   感謝匿名研究人員與 [TippingPoint](http://www.tippingpoint.com/) 的 [Zero Day Initiative](http://www.zerodayinitiative.com/) 合作，回報 Excel 懸盪指標資訊安全風險 (CVE-2011-0980)
