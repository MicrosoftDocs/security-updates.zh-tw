...
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=e08266d8-fffa-40bf-b8f6-10a65ee27524&amp;displaylang=zh-tw">Windows Vista Service Pack 2</a> (中文下載更新程式)
</div></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4f2365ed-d50e-44d9-b859-1ec54d3b4d38">Windows Vista x64 Edition Service Pack 2</a> (英文下載更新程式) <a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=4f2365ed-d50e-44d9-b859-1ec54d3b4d38&amp;displaylang=zh-tw">Windows Vista x64 Edition Service Pack 2</a> (中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=f82dc413-668c-4ca8-a8c8-db74f05346bc&amp;displaylang=zh-tw">適用於 32 位元系統的 Windows Server 2008 Service Pack 2</a> (中文下載更新程式)**
</div></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
...
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=06ad5637-56a1-4478-aaa0-063e877503c9&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows Server 2008 Service Pack 2</a> (中文下載更新程式)**
</div></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
...
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=2307fa93-8e45-4841-a5a9-7e89960712f9&amp;displaylang=zh-tw">適用於 32 位元系統的 Windows 7 和適用於 32 位元系統的 Windows 7 Service Pack 1</a>(中文下載更新程式)
</div></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
...
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=62603d18-1b21-400c-8eba-202193182960&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows 7 和適用於 x64 型系統的 Windows 7 Service Pack 1</a> (中文下載更新程式)
</div></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">低</td>
<td style="border:1px solid black;">無</td>
...
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=c9cf6a22-f9ab-427a-9b16-33c60baaabb5&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows Server 2008 R2 和適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1</a> (中文下載更新程式)**
</div></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">低</td>
<td style="border:1px solid black;">無</td>
...
有許多桌面功能 (如 Windows Mail) 依預設不會安裝在 Windows Server 2008 上。但是，您可以在 Windows Server 2008 上安裝「桌面體驗」來一次安裝所有桌面功能。如需詳細資訊，請參閱 TechNet 文章：[Windows Server 2008 中的 Windows Mail、Windows Media Player 與桌面體驗中的其他功能](http://technet.microsoft.com/zh-tw/library/cc771519(ws.10).aspx)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-2016](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2016) (英文)。
...
什麼是 Windows 會議空間？   
Windows 會議空間讓您能夠與其他使用 Windows Vista 電腦的人共用文件、程式，或共用桌面。Windows 會議空間採用點對點技術；如果找不到現有的網路，便會自動建立臨機操作網路。如需詳細資訊，請參閱 [Windows 會議空間常見問題集](http://windows.microsoft.com/zh-tw/windows-vista/windows-meeting-space-frequently-asked-questions)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2620704">Microsoft 知識庫文件編號 2620704</a></td>
</tr>
<tr class="odd">
