...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-1868](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1868) (英文)。
...
**什麼是分散式檔案系統 (DFS)？**    
分散式檔案系統 (DFS) 藉由將位於不同伺服器上的共用資料夾明確連接至一或多個 DFS 命名空間，讓系統管理員能群組這些資料夾。 DFS 命名空間是組織中共用資料夾的虛擬檢視。 系統管理員可以使用 DFS 工具來選擇要出現在命名空間中的共用資料夾、設計資料夾呈現的階層架構，並決定共用資料夾在命名空間中的顯示名稱。 當使用者檢視命名空間，資料夾看起來會像是在單一硬碟中。 使用者可以瀏覽命名空間，而不須知道裝載資料的伺服器名稱或是共用資料夾。 如需更多資訊，請參閱 [DFS 技術參考](https://technet.microsoft.com/en-us/library/cc757042(ws.10).aspx) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-1869](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1869) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2535512/zh-tw">Microsoft 知識庫文件編號 2535512</a></td>
</tr>
<tr class="even">
...
-   感謝 [NGS Software](https://www.ngssoftware.com/) 的 Laurent Gaffié 回報 DFS 轉介回應資訊安全風險 (CVE-2011-1869)
