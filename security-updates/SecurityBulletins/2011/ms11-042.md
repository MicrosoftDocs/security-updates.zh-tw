---
TOCTitle: 'MS11-042'
Title: 'Microsoft Security Bulletin MS11-042 - 重大'
ms:assetid: 'ms11-042'
ms:contentKeyID: 61238674
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms11-042(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-042 - 重大
===========================================

分散式檔案系統中的資訊安全風險可能會允許遠端執行程式碼 (2535512)
----------------------------------------------------------------
...
這個資訊安全更新可解決 Microsoft 分散式檔案系統 (DFS) 中兩項未公開報告的資訊安全風險。 如果攻擊者將蓄意製作的 DFS 回應傳送至用戶端啟動的 DFS 要求，這些資訊安全風險中較嚴重者可能會允許遠端執行程式碼。 成功利用此資訊安全風險的攻擊者可執行任意程式碼，並取得受影響之系統的完整控制權。 最佳實作的防火牆和標準預設防火牆設定有助於防止網路受到來自企業外的攻擊。 最佳方式建議連線至網際網路的系統盡可能曝露最少數量的連接埠。
...
此資訊安全更新可修正 DFS 用戶端在蓄意製作之 DFS 轉介回應中驗證欄位的方式，並修正 DFS 服務處理蓄意製作之 DFS 轉介回應的方式，進而解決這些資訊安全風險。 如需更多有關此資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=67a25abd-f43c-4b01-b507-a109b739238f">Windows XP Service Pack 3 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=67a25abd-f43c-4b01-b507-a109b739238f&amp;displaylang=zh-tw">Windows XP Service Pack 3 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=af6b7627-c462-45fe-8948-70da37e60659">Windows XP Professional x64 Edition Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3aa8f1bc-07de-451a-8244-1733247e6f2e">Windows Server 2003 Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=3aa8f1bc-07de-451a-8244-1733247e6f2e&amp;displaylang=zh-tw">Windows Server 2003 Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e9018258-5a72-47a1-8584-3d1aa52317c3">Windows Server 2003 x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=e9018258-5a72-47a1-8584-3d1aa52317c3&amp;displaylang=zh-tw">Windows Server 2003 x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=96309c49-4822-4c47-b364-2ba65327cac5">適用於 Itanium 型系統的 Windows Server 2003 SP2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=aded8f20-479d-40c1-9560-c0581c6f77a2">Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=aded8f20-479d-40c1-9560-c0581c6f77a2&amp;displaylang=zh-tw">Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">阻斷服務</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=962cb40c-680c-4c37-98d4-ca9789ca7270">Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=962cb40c-680c-4c37-98d4-ca9789ca7270&amp;displaylang=zh-tw">Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">阻斷服務</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8ebfa067-0236-4454-8605-df1b99742f90">適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a>*
<a href="https://www.microsoft.com/download/details.aspx?familyid=8ebfa067-0236-4454-8605-df1b99742f90&amp;displaylang=zh-tw">適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2 (中文下載更新程式)</a>&#42;</td>
<td style="border:1px solid black;">阻斷服務</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f1d76b82-9996-4d08-894b-9c16a4b3bb1e">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a>*
<a href="https://www.microsoft.com/download/details.aspx?familyid=f1d76b82-9996-4d08-894b-9c16a4b3bb1e&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2 (中文下載更新程式)</a>&#42;</td>
<td style="border:1px solid black;">阻斷服務</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f80c89c6-27ab-4f6a-afad-9c8e92cbbce4">適用於 Itanium 型系統的 Windows Server 2008 和適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">阻斷服務</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9de1bf5d-6f25-496d-bc44-a32c5e8920fe">適用於 32 位元系統的 Windows 7 和適用於 32 位元系統的 Windows 7 Service Pack 1 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=9de1bf5d-6f25-496d-bc44-a32c5e8920fe&amp;displaylang=zh-tw">適用於 32 位元系統的 Windows 7 和適用於 32 位元系統的 Windows 7 Service Pack 1 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">阻斷服務</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=50d1c677-57aa-4e3f-bdfc-6f01b5d3bfe2">適用於 x64 型系統的 Windows 7 和適用於 x64 型系統的 Windows 7 Service Pack 1 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=50d1c677-57aa-4e3f-bdfc-6f01b5d3bfe2&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows 7 和適用於 x64 型系統的 Windows 7 Service Pack 1 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">阻斷服務</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9d66b1e7-dbf9-4475-a973-49fb85557eca">適用於 x64 型系統的 Windows Server 2008 R2 和適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1 (英文下載更新程式)</a>*
<a href="https://www.microsoft.com/download/details.aspx?familyid=9d66b1e7-dbf9-4475-a973-49fb85557eca&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows Server 2008 R2 和適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1 (中文下載更新程式)</a>&#42;</td>
<td style="border:1px solid black;">阻斷服務</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3c8455f1-b8a0-4ba2-84a2-043d25ef75c5">適用於 Itanium 型系統的 Windows Server 2008 R2 和適用於 Itanium 型系統的 Windows Server 2008 R2 Service Pack 1 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">阻斷服務</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<th style="border:1px solid black;" >DFS 記憶體損毀資訊安全風險 - CVE-2011-1868</th>
<th style="border:1px solid black;" >DFS 轉介回應資訊安全風險 - CVE-2011-1869</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
DFS 記憶體損毀資訊安全風險 - CVE-2011-1868  
------------------------------------------
  

分散式檔案系統 (DFS) 用戶端剖析蓄意製作之 DFS 回應的方式中，存在未經驗證的遠端執行程式碼資訊安全風險。 攻擊者不需要驗證即可利用這項資訊安全風險，因此可藉由傳送蓄意製作的 DFS 回應至用戶端啟動的 DFS 要求來利用資訊安全風險。 成功利用此資訊安全風險的攻擊者可執行任意程式碼，並取得受影響之系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-1868](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1868) (英文)。
  
#### DFS 記憶體損毀資訊安全風險 - CVE-2011-1868 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   最佳實作的防火牆和標準預設防火牆設定有助於防止網路受到來自企業外的攻擊。 最佳方式建議連線至網際網路的系統盡可能曝露最少數量的連接埠。
  
#### DFS 記憶體損毀資訊安全風險 - CVE-2011-1868 的因應措施
  
Microsoft 尚未找到此項資訊安全風險的任何因應措施。
  
#### DFS 記憶體損毀資訊安全風險 - CVE-2011-1868 的常見問題集
  
**這個資訊安全風險的範圍為何？**    
這是遠端執行程式碼的資訊安全風險。 成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個資訊安全風險的原因為何？**    
當 Microsoft 分散式檔案系統 (DFS) 實作在蓄意製作的 DFS 回應中不當驗證所有欄位時，就會導致此資訊安全風險。
  
**什麼是分散式檔案系統 (DFS)？**    
分散式檔案系統 (DFS) 藉由將位於不同伺服器上的共用資料夾明確連接至一或多個 DFS 命名空間，讓系統管理員能群組這些資料夾。 DFS 命名空間是組織中共用資料夾的虛擬檢視。 系統管理員可以使用 DFS 工具來選擇要出現在命名空間中的共用資料夾、設計資料夾呈現的階層架構，並決定共用資料夾在命名空間中的顯示名稱。 當使用者檢視命名空間，資料夾看起來會像是在單一硬碟中。 使用者可以瀏覽命名空間，而不須知道裝載資料的伺服器名稱或是共用資料夾。 如需更多資訊，請參閱 [DFS 技術參考](http://technet.microsoft.com/en-us/library/cc757042(ws.10).aspx) (英文)。
  
**攻擊者可能會利用這項資訊安全風險採取什麼行動？**    
成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。 大多數利用此資訊安全風險的情況會導致受影響的系統停止回應並重新啟動。
  
**攻擊者如何利用這項資訊安全風險？**    
攻擊者可架設一台蓄意製作的伺服器來利用此資訊安全風險，然後引誘使用者啟動連至此伺服器的 DFS 連線。 另外，在本機網路上的攻擊者可能會執行攔截式攻擊，以惡意的 DFS 回應來回應合法的 DFS 要求。
  
**因為這個資訊安全風險而承受風險的主要系統有哪些？**    
所有受支援版本的 Windows XP 與 Windows Server 2003 都有遭受此資訊安全風險攻擊的風險。
  
**更新的作用何在？**    
此資訊安全更新會修正 DFS 用戶端在蓄意製作之 DFS 回應中驗證欄位的方式，進而解決此項資訊安全風險。
...
DFS 轉介回應資訊安全風險 - CVE-2011-1869  
----------------------------------------
  

在 Microsoft 分散式檔案系統 (DFS) 處理蓄意製作之 DFS 轉介回應的方式中，存在阻斷服務資訊安全風險。 攻擊者不需要驗證即可利用這項資訊安全風險，因此可藉由傳送蓄意製作的網路訊息至執行伺服器服務的電腦來利用資訊安全風險。
  
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-1869](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1869) (英文)。
  
#### DFS 轉介回應資訊安全風險 - CVE-2011-1869 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   此阻斷服務資訊安全風險不會讓攻擊者執行程式碼或提高使用者權限，但會導致受影響系統停止回應，直到手動重新啟動為止。  
-   最佳實作的防火牆和標準預設防火牆設定有助於防止網路受到來自企業外的攻擊。 最佳方式建議連線至網際網路的系統盡可能曝露最少數量的連接埠。
  
#### DFS 轉介回應資訊安全風險 - CVE-2011-1869 的因應措施
  
Microsoft 尚未找到此項資訊安全風險的任何因應措施。
  
#### DFS 轉介回應資訊安全風險 - CVE-2011-1869 的常見問題集
  
**這個資訊安全風險的範圍為何？**    
這是一項阻斷服務的資訊安全風險。 成功利用此資訊安全風險的攻擊者可使受影響的系統停止回應，直到手動重新啟動系統。 請注意，阻斷服務資訊安全風險不會讓攻擊者執行程式碼或提高使用者權限，但會導致受影響系統停止接受要求。
  
**造成這個資訊安全風險的原因為何？**    
當分散式檔案系統 (DFS) 實作不正確處理蓄意製作的 DFS 轉介回應時，就會導致此資訊安全風險。
  
**什麼是分散式檔案系統 (DFS)？**    
分散式檔案系統 (DFS) 藉由將位於不同伺服器上的共用資料夾明確連接至一或多個 DFS 命名空間，讓系統管理員能群組這些資料夾。 DFS 命名空間是組織中共用資料夾的虛擬檢視。 系統管理員可以使用 DFS 工具來選擇要出現在命名空間中的共用資料夾、設計資料夾呈現的階層架構，並決定共用資料夾在命名空間中的顯示名稱。 當使用者檢視命名空間，資料夾看起來會像是在單一硬碟中。 使用者可以瀏覽命名空間，而不須知道裝載資料的伺服器名稱或是共用資料夾。 如需更多資訊，請參閱 [DFS 技術參考](http://technet.microsoft.com/en-us/library/cc757042(ws.10).aspx) (英文)。
  
**攻擊者可能會利用這項資訊安全風險採取什麼行動？**    
成功利用此資訊安全風險的攻擊者會讓使用者的系統停止回應直到手動重新啟動。
  
**攻擊者如何利用這項資訊安全風險？**    
攻擊者可架設一台蓄意製作的伺服器來利用此資訊安全風險，然後引誘使用者啟動連至此伺服器的 DFS 連線。 另外，在本機網路上的攻擊者可能會執行攔截式攻擊，以惡意的 DFS 回應來回應合法的 DFS 要求。
  
**因為這個資訊安全風險而承受風險的主要系統有哪些？**    
所有支援的 Windows 版本都有遭受此資訊安全風險攻擊的風險。
  
**更新的作用何在？**    
此資訊安全更新會修正 DFS 服務處理蓄意製作之 DFS 轉介回應的方式，進而解決此項資訊安全風險。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB2535512$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2535512/zh-tw">Microsoft 知識庫文件編號 2535512</a></td>
</tr>
<tr class="even">
...
-   感謝 [NGS Software](http://www.ngssoftware.com/) 的 Laurent Gaffié 回報 DFS 轉介回應資訊安全風險 (CVE-2011-1869)
