...
**已知問題。**[Microsoft 知識庫文件編號 2567943](https://support.microsoft.com/kb/2567943) 中記載了客戶安裝此安全性更新時，可能會發生的目前已知問題。該文件並說明了解決這些問題的建議解決方案。
...
<sup>[1]</sup>**.NET Framework 4 Client Profile 不受影響。**可在兩個設定檔中使用 .NET Framework 第 4 版可轉散發套件： .NET Framework 4 和 .NET Framework 4 Client Profile。.NET Framework 4 Client Profile 是 .NET Framework 4 的子集。此更新所解決的弱點只會影響到 .NET Framework 4，而不會影響到 .NET Framework 4 Client Profile。如需詳細資訊，請參閱 MSDN 文章：[安裝 .NET Framework](https://msdn.microsoft.com/zh-tw/library/5a4x27ek.aspx) (英文)。
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2011-1977](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1977) (英文)。
...
**什麼是 Microsoft 圖表控制項？**  
Microsoft 圖表控制項能讓您使用簡單、直覺、具視覺吸引力的圖表來建立 ASP.NET 網頁或 Windows Forms 應用程式，以進行複雜的統計或財務分析。如需圖表控制項的詳細資訊，請參閱 MSDN 文章：[圖表控制項](https://msdn.microsoft.com/en-us/library/dd456632.aspx) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2487367">Microsoft 知識庫文件編號 2487367</a></td>
</tr>
<tr class="even">
...
| **檔案資訊**                           | 請參閱 [Microsoft 知識庫文件編號 2500170](https://support.microsoft.com/kb/2500170)                                                                                                                           |
