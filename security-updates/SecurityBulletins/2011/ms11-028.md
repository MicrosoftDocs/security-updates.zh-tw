...
**已知問題。**[Microsoft 知識庫文件編號 2484015](http://support.microsoft.com/kb/2484015) 中記載了客戶安裝此安全性更新時，可能會發生的目前已知問題。該文件並說明了解決這些問題的建議解決方案。
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2010-3958](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3958)。
...
是。這項弱點已經遭到公開揭發。這項弱點已被指派「一般性弱點」編號 [CVE-2010-3958](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3958)。
...
安全性更新可從 [Microsoft Update](http://go.microsoft.com/fwlink/?linkid=40747) 以及 [Windows Update](http://update.microsoft.com) 取得。安全性更新也可以從 [Microsoft 下載中心](http://go.microsoft.com/fwlink/?linkid=21129)取得。您也可以利用「安全性更新」("security update") 關鍵字搜尋輕易地找到安全性更新。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2484015">Microsoft 知識庫文件編號 2484015</a></td>
</tr>
<tr class="odd">
