---
TOCTitle: 'MS11-007'
Title: 'Microsoft Security Bulletin MS11-007 - 重大'
ms:assetid: 'ms11-007'
ms:contentKeyID: 61238639
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms11-007(v=Security.10)'
---


Microsoft Security Bulletin MS11-007 - 重大
===========================================

OpenType 壓縮字型格式 (CFF) 驅動程式中的資訊安全風險可能會允許遠端執行程式碼 (2485376)
--------------------------------------------------------------------------------------

發行: 2011年2月8日 | 更新: 2013年7月22日
...
此資訊安全更新可解決 Windows OpenType 壓縮字型格式 (CFF) 驅動程式中一項未公開報告的資訊安全風險。如果使用者檢視以蓄意製作的 CFF 字型所呈現的內容，則該資訊安全風險可能會允許遠端執行程式碼。但是，攻擊者無法強迫使用者檢視蓄意製作的內容， 而是引誘使用者自行前往某網站。一般的做法是設法讓使用者按一下電子郵件或 Instant Messenger 訊息中通往攻擊者網站的連結。
...
此資訊安全更新可修正 Windows OpenType 壓縮字型格式 (CFF) 驅動程式對於蓄意製作之 OpenType 字型參數值的驗證方式，藉以解決此資訊安全風險。如需更多有關此資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------|----------------|---------------------------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=f86e9e64-801a-431a-b24e-772011dfa66d)                                                                                      | 權限提高         | 重要           | [MS10-091](https://technet.microsoft.com/zh-tw/security/bulletin/ms10-091) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=074396f0-a68c-4190-8dac-0b883d56e3f1)                                                             | 權限提高         | 重要           | [MS10-091](https://technet.microsoft.com/zh-tw/security/bulletin/ms10-091) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=a99c2b13-db81-4f18-9cf7-c20614ba0132)                                                                             | 權限提高         | 重要           | [MS10-091](https://technet.microsoft.com/zh-tw/security/bulletin/ms10-091) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=aeed45fb-9395-4c2b-a674-e38b04fe0914)                                                                 | 權限提高         | 重要           | [MS10-091](https://technet.microsoft.com/zh-tw/security/bulletin/ms10-091) |
| [適用於 Itanium 型系統的 Windows Server 2003 SP2](https://www.microsoft.com/download/details.aspx?familyid=bc09e42b-2eed-41b3-a03f-cb8cc94adfee)                                                                | 權限提高         | 重要           | [MS10-091](https://technet.microsoft.com/zh-tw/security/bulletin/ms10-091) |
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=d60a2098-7351-4fce-83b2-2c1c3a24faa0)                                                   | 遠端執行程式碼   | 重大           | [MS10-091](https://technet.microsoft.com/zh-tw/security/bulletin/ms10-091) |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=065ad8fe-1caf-488e-a2e1-96db29f2fa57)                           | 遠端執行程式碼   | 重大           | [MS10-091](https://technet.microsoft.com/zh-tw/security/bulletin/ms10-091) |
| [適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=88ba83b9-c14e-499a-8335-04bac1c49c0c)&#42;           | 遠端執行程式碼   | 重大           | [MS10-091](https://technet.microsoft.com/zh-tw/security/bulletin/ms10-091) |
| [適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=7c74d7f4-6372-4809-89b8-c79b05e54cdd)&#42;             | 遠端執行程式碼   | 重大           | [MS10-091](https://technet.microsoft.com/zh-tw/security/bulletin/ms10-091) |
| [適用於 Itanium 型系統的 Windows Server 2008 和適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=91d5d34b-9d7e-4e83-89a4-f1aa388dc4e4)       | 遠端執行程式碼   | 重大           | [MS10-091](https://technet.microsoft.com/zh-tw/security/bulletin/ms10-091) |
| [適用於 32 位元系統的 Windows 7 和適用於 32 位元系統的 Windows 7 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=1da57fbc-9ea4-4fc4-911d-d5c7825e012c)                                 | 遠端執行程式碼   | 重大           | [MS10-091](https://technet.microsoft.com/zh-tw/security/bulletin/ms10-091) |
| [適用於 x64 型系統的 Windows 7 和適用於 x64 型系統的 Windows 7 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=587adb89-2f6a-4893-9906-b6d6d9ada2bd)                                   | 遠端執行程式碼   | 重大           | [MS10-091](https://technet.microsoft.com/zh-tw/security/bulletin/ms10-091) |
| [適用於 x64 型系統的 Windows Server 2008 R2 和適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=638318ed-4000-4b1a-bb4b-65b795f59784)&#42;       | 遠端執行程式碼   | 重大           | [MS10-091](https://technet.microsoft.com/zh-tw/security/bulletin/ms10-091) |
| [適用於 Itanium 型系統的 Windows Server 2008 R2 和適用於 Itanium 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=4688ea0d-a467-4f24-ac52-104d05c8cae8) | 遠端執行程式碼   | 重大           | [MS10-091](https://technet.microsoft.com/zh-tw/security/bulletin/ms10-091) |
...
下列嚴重性等級是假設資訊安全風險可能造成的最嚴重影響而評定。在本資訊安全公告發行的 30 天內，如需資訊安全風險之易遭利用性與嚴重性等級和資訊安全影響之間對應關係的資訊，請參閱 [2 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms11-feb)中的＜資訊安全風險入侵指數＞。如需更多資訊，請參閱 [Microsoft 資訊安全風險入侵指數](https://technet.microsoft.com/zh-tw/security/cc998259.aspx)。
...
<th style="border:1px solid black;" >OpenType 字型編碼字元資訊安全風險 - CVE-2011-0033</th>
...
OpenType 字型編碼字元資訊安全風險 - CVE-2011-0033  
-------------------------------------------------
  
在 Windows OpenType 壓縮字型格式 (CFF) 驅動程式不當剖析蓄意製作之 OpenType 字型的方式中，存在遠端執行程式碼資訊安全風險。成功利用此資訊安全風險的攻擊者可以在核心模式下執行任意程式碼。攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
若要以一般性資訊安全風險清單中的標準項目來檢視此資訊安全風險，請參閱 [CVE-2011-0033](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0033)。
  
#### OpenType 字型編碼字元資訊安全風險 - CVE-2011-0033 的緩和因素
...
#### OpenType 字型編碼字元資訊安全風險 - CVE-2011-0033 的因應措施
  
因應措施指的是無法徹底修正資訊安全風險，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：
  
-   **在** **Windows** **檔案總管中停用預覽窗格和詳細資料窗格**
  
    在 Windows 檔案總管中停用預覽和詳細資料窗格後，即可避免在 Windows 檔案總管中自動顯示 OTF 字型。這可避免在 Windows 檔案總管中檢視惡意檔案，但無法避免通過驗證的本機使用者執行蓄意製作的程式來利用此資訊安全風險。若要在 Windows Vista、Windows Server 2008，Windows 7 及 Windows Server 2008 R2 中停用這些窗格，請執行下列步驟：
...
#### OpenType 字型編碼字元資訊安全風險 - CVE-2011-0033 的常見問題集
...
**更新的作用何在？**   
此更新可修正 Windows OpenType 壓縮字型格式 (CFF) 驅動程式對於蓄意製作之 OpenType 字型參數值的驗證方式，藉以解決此資訊安全風險。
...
管理您必須部署到您組織中的伺服器、桌上型電腦及行動系統的軟體和資訊安全更新。如需更多資訊，請參閱 [TechNet 更新管理中心](https://technet.microsoft.com/zh-tw/updatemanagement/default.aspx) (英文)。[Microsoft TechNet 資訊安全技術中心網站](https://technet.microsoft.com/zh-tw/security/default.aspx)提供了有關 Microsoft 產品安全的其他資訊。
  
資訊安全更新可從 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 以及 [Windows Update](https://update.microsoft.com/) 取得。資訊安全更新也可以從 [Microsoft 下載中心](https://www.microsoft.com/zh-tw/download/noresults.aspx?security%20update)取得。您也可以利用「資訊安全更新」("security update") 關鍵字搜尋輕易地找到資訊安全更新。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB2485376$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2485376?ln=zh-tw">Microsoft 知識庫文件編號 2485376</a></td>
</tr>
<tr class="even">
...
-   V2.1 (2013 年 7 月 22 日)： 修訂公告，宣佈一項偵測變更，將 Windows 7 語言套件排除在適用於 Windows XP Professional x64 Edition Service Pack 2 的 2485376 更新外。此變更僅屬偵測變更。已成功更新系統的客戶不必採取任何行動。
