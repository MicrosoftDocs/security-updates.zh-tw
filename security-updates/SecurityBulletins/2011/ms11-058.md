...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|----------------|-----------------------------------------------------------|
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c2d4aa38-9241-465d-8d65-aba73e936d0f)                                                                       | 阻絕服務       | 重要           | [MS09-008](https://go.microsoft.com/fwlink/?linkid=139821) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2db4098a-f4f9-4211-b55d-5d0df1409c43)                                                           | 阻絕服務       | 重要           | [MS09-008](https://go.microsoft.com/fwlink/?linkid=139821) |
| [適用於 Itanium 型系統的 Windows Server 2003 SP2](https://www.microsoft.com/download/details.aspx?familyid=1934acfa-5637-4ae9-9e9a-fc7e58930b7a)                                                          | 阻絕服務       | 重要           | [MS09-008](https://go.microsoft.com/fwlink/?linkid=139821) |
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2011-1966](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1966) (英文)。
...
**什麼是 NAPTR DNS 資源記錄？**    
命名授權指標 (NAPTR) DNS 資源記錄 (RR) 允許使用 DNS 針對各種資源名稱查詢服務，包括不在網域名稱語法中的 URI。如需更多關於 NAPTR 的資訊，請參閱 [RFC-2915](https://www.ietf.org/rfc/rfc2915.txt)。
  
**什麼是 DNS 資源記錄？**    
DNS 資源記錄 (RR) 可識別網域中的特定資源。如需詳細資訊，請參閱 TechNet 文章：[DNS 如何運作](https://technet.microsoft.com/en-us/library/dd197446(ws.10).aspx) (英文)。
  
**什麼是 URI？**    
統一資源識別項 (URI) 是一連串用來執行動作或識別網際網路或網路資源的字元。URL 是參照資源 (如網站) 之 URI 典型範例。如需更多關於 URI 的資訊，請參閱 [RFC 2396](https://www.ietf.org/rfc/rfc2915.txt)。
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2011-1970](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1970) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2562485">Microsoft 知識庫文件編號 2562485</a></td>
</tr>
<tr class="even">
