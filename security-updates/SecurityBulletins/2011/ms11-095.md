---
TOCTitle: 'MS11-095'
Title: 'Microsoft Security Bulletin MS11-095 - 重要'
ms:assetid: 'ms11-095'
ms:contentKeyID: 61238727
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms11-095(v=Security.10)'
---

Microsoft Security Bulletin MS11-095 - 重要
===========================================

Active Directory 中的資訊安全風險可能會允許遠端執行程式碼 (2640045)
-------------------------------------------------------------------
...
這個資訊安全更新可解決 Active Directory、Active Directory 應用程式模式 (ADAM) 及 Active Directory 輕量型目錄服務 (AD LDS) 中一個未公開報告的資訊安全風險。如果攻擊者登入 Active Directory 網域並執行蓄意製作的應用程式，則此資訊安全風險可能會允許遠端執行程式碼。若要利用此資訊安全風險，攻擊者必須先取得認證才能登入 Active Directory 網域。
...
此資訊安全更新可變更 Active Directory、Active Directory 應用程式模式 (ADAM) 和 Active Directory 輕量型目錄服務 (AD LDS) 處理記憶體中物件的方式，進而解決此資訊安全風險。如需更多有關此資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3b816964-d3c3-4f05-94c3-f54a6f54ca73">Active Directory 應用程式模式 (ADAM)</a> (英文下載更新程式)<br />
(KB2626416)  
<div>
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=3b816964-d3c3-4f05-94c3-f54a6f54ca73">Active Directory 應用程式模式 (ADAM)</a> (中文下載更新程式)<br />
(KB2626416)
</div></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=986f0087-c674-4060-8710-af3496adbfdd">Active Directory 應用程式模式 (ADAM)</a> (英文下載更新程式)<br />
(KB2626416)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms11-086">MS11-086</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=01caf06f-777d-4ea8-95ca-e11d60a973ad">Active Directory</a> (英文下載更新程式)<br />
(KB2621146)<br />
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=01caf06f-777d-4ea8-95ca-e11d60a973ad">Active Directory</a> (中文下載更新程式)  
<div>
(KB2621146)<br />
<br />
<a href="https://www.microsoft.com/download/details.aspx?familyid=6f7c7ccd-22a3-4fbc-bf21-bd0e42ab1da5">Active Directory 應用程式模式 (ADAM)</a> (英文下載更新程式)<br />
(KB2626416)  
</div>
<div>
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=6f7c7ccd-22a3-4fbc-bf21-bd0e42ab1da5">Active Directory 應用程式模式 (ADAM)</a> (中文下載更新程式)<br />
(KB2626416)
</div></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e1ba50cf-fc6b-4668-b71c-e9f75a8ac638">Active Directory</a> (英文下載更新程式)<br />
(KB2621146)<br />
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=e1ba50cf-fc6b-4668-b71c-e9f75a8ac638">Active Directory</a> (中文下載更新程式)<br />
(KB2621146)<br />
<br />
<a href="https://www.microsoft.com/download/details.aspx?familyid=1b610eb3-456c-4125-94b7-1ead4face8e3">Active Directory 應用程式模式 (ADAM)</a> (英文下載更新程式)<br />
(KB2626416)  
<div>
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=1b610eb3-456c-4125-94b7-1ead4face8e3">Active Directory 應用程式模式 (ADAM)</a> (中文下載更新程式)  
</div>
<div>
(KB2626416)
</div></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=74099261-60ad-4c68-906c-60e131818955">Active Directory</a> (英文下載更新程式)<br />
(KB2621146)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms11-086">MS11-086</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=470da512-2c8b-4ba9-b7bb-b9e6c45cd33f">Active Directory 輕量型目錄服務 (AD LDS)</a> (英文下載更新程式)<br />
(KB2621146)  
<div>
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=470da512-2c8b-4ba9-b7bb-b9e6c45cd33f">Active Directory 輕量型目錄服務 (AD LDS)</a> (中文下載更新程式)<br />
(KB2621146)
</div></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8daf9a49-60cb-4813-ac7a-e9a4bf296889">Active Directory 輕量型目錄服務 (AD LDS)</a> (英文下載更新程式)<br />
(KB2621146)  
<div>
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=8daf9a49-60cb-4813-ac7a-e9a4bf296889">Active Directory 輕量型目錄服務 (AD LDS)</a> (中文下載更新程式)<br />
(KB2621146)
</div></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=6f9ddcdb-a471-4e00-a697-92a24e4ea8d4">Active Directory 和 Active Directory 輕量型目錄服務 (AD LDS)</a> (英文下載更新程式)<br />
(KB2621146)  
<div>
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=6f9ddcdb-a471-4e00-a697-92a24e4ea8d4">Active Directory 和 Active Directory 輕量型目錄服務 (AD LDS)</a> (中文下載更新程式)<br />
(KB2621146)
</div></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5253477b-422f-404a-941e-8b69da5a2670">Active Directory 和 Active Directory 輕量型目錄服務 (AD LDS)</a> (英文下載更新程式)<br />
(KB2621146)  
<div>
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=5253477b-422f-404a-941e-8b69da5a2670">Active Directory 和 Active Directory 輕量型目錄服務 (AD LDS)</a> (中文下載更新程式)<br />
(KB2621146)
</div></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=d2e87199-6469-4bc0-a721-f43e817e4344">Active Directory 輕量型目錄服務 (AD LDS)</a> (英文下載更新程式)<br />
(KB2621146)  
<div>
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=d2e87199-6469-4bc0-a721-f43e817e4344">Active Directory 輕量型目錄服務 (AD LDS)</a> (中文下載更新程式)<br />
(KB2621146)
</div></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ba8d7aa9-8299-49a3-b0c0-b8b5eab48434">Active Directory 輕量型目錄服務 (AD LDS)</a> (英文下載更新程式)<br />
(KB2621146)  
<div>
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=ba8d7aa9-8299-49a3-b0c0-b8b5eab48434">Active Directory 輕量型目錄服務 (AD LDS)</a> (中文下載更新程式)<br />
(KB2621146)
</div></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=a3e0d27c-8b29-4981-bdef-bcd037fd3408">Active Directory 和 Active Directory 輕量型目錄服務 (AD LDS)</a> (英文下載更新程式)<br />
(KB2621146)  
<div>
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=a3e0d27c-8b29-4981-bdef-bcd037fd3408">Active Directory 和 Active Directory 輕量型目錄服務 (AD LDS)</a> (中文下載更新程式)<br />
(KB2621146)
</div></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
...
<th style="border:1px solid black;" >
Active Directory 緩衝區溢位資訊安全風險 - CVE-2011-3406  
</th>
<th style="border:1px solid black;" >
彙總嚴重性等級  
</th>
...
Active Directory 中存在遠端執行程式碼的資訊安全風險。若要利用此資訊安全風險，攻擊者必須先取得認證才能登入 Active Directory 網域。接著，攻擊者便可執行蓄意設計以利用此資訊安全風險的應用程式，並進一步取得受影響系統的完整控制權。攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。

若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-3406](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3406) (英文)。

#### Active Directory 緩衝區溢位資訊安全風險 - CVE-2011-3406 的緩和因素

緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。下列緩和因素可能對您的狀況有所助益：

-   為了成功利用此資訊安全風險，攻擊者在目標 Active Directory 網域中必須有一個成員帳戶認證。然而，攻擊者不需有已加入 Active Directory 網域的工作站。
-   最佳實作的防火牆和標準預設防火牆設定有助於防止網路受到來自企業外的攻擊。最佳方式建議連線至網際網路的系統盡可能曝露最少數量的連接埠。

#### Active Directory 緩衝區溢位資訊安全風險 - CVE-2011-3406 的因應措施

因應措施指的是無法徹底修正資訊安全風險，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：

-   在企業防火牆封鎖 TCP 連接埠 389

    本通訊埠用來起始與受影響元件的連線。在企業防火牆封鎖上述連接埠 (含輸入及輸出) 有助於保護防火牆後的系統免遭此資訊安全風險的影響。建議您封鎖所有網際網路中來路不明的輸入通訊，以防他人利用其他連接埠攻擊系統。如需更多關於連接埠的資訊，請參閱 TechNet 文章：[TCP 和 UDP 連接埠的指派](https://technet.microsoft.com/zh-tw/library/cc977599.aspx) (英文)。如需 Windows 防火牆的詳細資訊，請參閱 TechNet 文章：[如何在單一電腦上設定 Windows 防火牆](https://www.microsoft.com/technet/security/smallbusiness/prodtech/windowsxp/cfgfwall.mspx) (英文)。

#### Active Directory 緩衝區溢位資訊安全風險 - CVE-2011-3406 的常見問題集

這個資訊安全風險的範圍為何？  
這是網路服務內容中的一個遠端執行程式碼資訊安全風險。

造成這個資訊安全風險的原因為何？  
當 Active Directory 處理蓄意製作的查詢，並嘗試存取尚未適當初始化的記憶體緩衝區內容時，將導致此資訊安全風險。

什麼 是 Active Directory 服務？  
...
Active Directory 網域服務 (AD DS) 會儲存目錄資料並管理使用者和網域之間的通訊，包括使用者登入程序、驗證及目錄搜尋。Active Directory 網域控制站是執行 AD DS 的伺服器。如需 AD DS 的詳細資訊，請參閱 TechNet 文章：[Active Directory 網域服務](https://technet.microsoft.com/zh-tw/library/cc770946(ws.10).aspx)。

什麼是 Active Directory 輕量型目錄服務 (AD LDS)？  
Active Directory 輕量型目錄服務 (AD LDS) 是獨立模式的 Active Directory，提供專屬的目錄服務供應用程式使用。AD LDS 適用於 Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2。AD LDS 取代了 Windows XP 和 Windows Server 2003 中的 Active Directory 應用程式模式 (ADAM)。如需 AD LDS 的詳細資訊，請參閱 TechNet 文章：[Active Directory 輕量型目錄服務](https://technet.microsoft.com/zh-tw/library/cc731868(ws.10).aspx)。

什麼是 Active Directory 應用程式模式？   
Active Directory 應用程式模式 (ADAM) 是一種輕量型目錄存取通訊協定 (LDAP) 目錄服務，是以 Windows XP 和 Windows Server 2003 使用者服務的形式執行，而非系統服務。如需 ADAM 的詳細資訊，請參閱 TechNet 文章：[ADAM 簡介](https://technet.microsoft.com/zh-tw/library/cc780837(ws.10).aspx)。
...
攻擊者如何利用這項 資訊安全風險？  
若要利用此資訊安全風險，攻擊者必須先取得認證才能登入 Active Directory 網域。接著，攻擊者便可執行蓄意設計以利用此資訊安全風險的應用程式，並進一步取得受影響系統的完整控制權。

因為這個資訊安全風險而承受風險的主要系統有哪些？  
所有執行受影響作業系統、且已安裝 Active Directory 服務的系統，都會受到此資訊安全風險影響。

更新的作用何在？  
此更新可變更 Active Directory、Active Directory 應用程式模式 (ADAM) 和 Active Directory 輕量型目錄服務 (AD LDS) 處理記憶體中物件的方式，進而解決此資訊安全風險。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB2626416$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">檔案資訊</td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2626416?ln=zh-tw">Microsoft 知識庫文件編號 2626416</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;">移除資訊</td>
<td style="border:1px solid black;">如果是 Active Directory，請使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB2621146$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">如果是 Active Directory 應用程式模式 (ADAM)，請使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB2626416$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">檔案資訊</td>
<td style="border:1px solid black;">如需 Windows Server 2003 上的 Active Directory 相關資訊，請參閱 <a href="https://support.microsoft.com/kb/2621146?ln=zh-tw">Microsoft 知識庫文件編號 2621146</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">如需 Windows Server 2003 上的 Active Directory 應用程式模式 (ADAM) 相關資訊，請參閱 <a href="https://support.microsoft.com/kb/2626416?ln=zh-tw">Microsoft 知識庫文件編號 2626416</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">登錄機碼驗證</td>
...
<tr class="even">
<td style="border:1px solid black;">檔案資訊</td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2621146?ln=zh-tw">Microsoft 知識庫文件編號 2621146</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">登錄機碼驗證</td>
...
<tr class="odd">
<td style="border:1px solid black;">在沒有使用者介入的情況下安裝</td>
<td style="border:1px solid black;">針對所有受支援 x64 型版本之 Windows Server 2008 R2 上的 Active Directory 和 Active Directory 輕量型目錄服務 (AD LDS)：<br />
Windows6.1-KB2621146-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">在不重新啟動的情況下安裝</td>
