...
**已知問題。** [Microsoft 知識庫文件編號 2545814](http://support.microsoft.com/kb/2545814/zh-tw) 中記載了客戶安裝此資訊安全更新時，可能會發生的目前已知問題。 該文件並說明了解決這些問題的建議解決方案。 目前已知問題和建議解決方案僅適用於此軟體的特定版本，本文會提供詳細文章的連結。
...
<td style="border:1px solid black;">
[Microsoft PowerPoint 2002 Service Pack 3 (英文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=2e8a30ac-bcfe-4535-8ceb-723c25b43d5f)  
(KB2535802)  
[Microsoft PowerPoint 2002 Service Pack 3 (中文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=2e8a30ac-bcfe-4535-8ceb-723c25b43d5f&displaylang=zh-tw)  
(KB2535802)
...
<td style="border:1px solid black;">
[Microsoft PowerPoint 2003 Service Pack 3 (英文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=fc1cfcac-64cc-484a-97f2-3dcfe84cfdcd)  
(KB2535812)  
[Microsoft PowerPoint 2003 Service Pack 3 (中文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=fc1cfcac-64cc-484a-97f2-3dcfe84cfdcd&displaylang=zh-tw)  
(KB2535812)
...
<td style="border:1px solid black;">
[Microsoft PowerPoint 2007 Service Pack 2 (英文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=9a181739-709a-4c0d-a97f-f9891c45c04c)  
(KB2535818)  
[Microsoft PowerPoint 2007 Service Pack 2 (中文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=9a181739-709a-4c0d-a97f-f9891c45c04c&displaylang=zh-tw)  
(KB2535818)
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office Word、Excel 及 PowerPoint 2007 檔案格式相容性套件 Service Pack 2 (英文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=5be09069-1cac-4b1e-ac94-4fb7024fb4ac)  
(KB2540162)  
[Microsoft Office Word、Excel 及 PowerPoint 2007 檔案格式相容性套件 Service Pack 2 (中文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=5be09069-1cac-4b1e-ac94-4fb7024fb4ac&displaylang=zh-tw)  
(KB2540162)
...
Microsoft PowerPoint 2003 和 Microsoft PowerPoint 2007 啟用 Office 檔案驗證功能時，就不會自動開啟意圖利用這些資訊安全風險的蓄意製作檔案；依預設，軟體會提示使用者選擇是否要開啟這類檔案。 使用者必須一一點選警告訊息來開啟檔案，資訊安全風險才有可能遭到利用。 如需 Microsoft PowerPoint 2003 或 Microsoft PowerPoint 2007 中的 Office 檔案驗證之詳細資訊，請參閱 [Microsoft 資訊安全摘要報告 2501584](http://technet.microsoft.com/security/advisory/2501584)。

**如果我停止在 PowerPoint 2003 和 PowerPoint 2007 中開啟未通過檔案驗證的檔案，有哪些好處？**  
[Microsoft 知識庫文件編號 2501584](http://support.microsoft.com/kb/2501584/zh-tw) 提供之「停用 PowerPoint 2003 和 2007 文件開啟」這一項 **Microsoft Fix it** 解決方案，可將 Office 檔案驗證設為不允許在 PowerPoint 2003 和 PowerPoint 2007 中開啟可疑的檔案，進而阻止攻擊模式利用 CVE-2011-1269 和 CVE-2011-1270 中敘述之資訊安全風險。選擇暫不安裝 PowerPoint 2003 或 PowerPoint 2007 資訊安全更新的客戶，可選擇套用 Fix it 解決方案作為因應措施。
請參閱 [Microsoft 知識庫文件編號 2501584](http://support.microsoft.com/kb/2501584/zh-tw) 中有關套用「停用 PowerPoint 2003 和 2007 文件開啟」這一項自動化 Fix it 解決方案的說明，或參考本公告＜資訊安全風險資訊＞一節中有關 CVE-2011-1269 和 CVE-2011-1270 的「因應措施」等節，以取得手動套用解決方案的說明。
...
<span></span>
下列嚴重性等級是假設資訊安全風險可能造成的最嚴重影響而評定。 在本資訊安全公告發行的 30 天內，如需資訊安全風險之易遭利用性與嚴重性等級和資訊安全影響之間對應關係的資訊，請參閱 [5 月份公告摘要](http://technet.microsoft.com/security/bulletin/ms11-may)中的＜資訊安全風險索引＞。 如需更多資訊，請參閱 [Microsoft 資訊安全風險索引](http://technet.microsoft.com/en-us/security/cc998259.aspx)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-1269](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1269)。
...
-   **使用 Microsoft Office 檔案封鎖原則來封鎖開啟來自於未知或不信任來源與位置的 Office 2003 和先前文件**
    ...
    **Microsoft Office 2003 和 Microsoft Office 2007**
    ...
    下列登錄指令碼可儲存於登錄項目 (.reg) 檔案，用來設定檔案封鎖原則。 如需瞭解如何使用登錄指令碼，請參閱 [Microsoft 知識庫文件編號 310516](http://support.microsoft.com/kb/310516/zh-tw)。請使用適用於您的 Office 軟體的登錄指令碼。
    ...
    **注意：**為將 'FileOpenBlock' 與 Microsoft Office 2003 搭配使用，必須套用所有最新的 Microsoft Office 2003 資訊安全更新。 為將 'FileOpenBlock' 與 Office 2007 搭配使用，必須套用所有最新的 Office 2007 資訊安全更新。
    ...
    Microsoft Office 2007 有一個套代方案，即使用群組原則套用檔案封鎖。 如需詳細資訊，請參閱 TechNet 文章：[在 Office 2007 中設定封鎖檔案格式設定值](http://technet.microsoft.com/en-us/library/cc179186(office.12).aspx) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-1270](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1270)。
...
**注意：**Microsoft 已於 2011 年 4 月 12 日停止支援 SMS 2.0。對於 SMS 2003，Microsoft 亦於 2011 年 4 月 12 日停止支援資訊安全更新盤點工具 (SUIT)。建議客戶升級為 [System Center Configuration Manager 2007](http://technet.microsoft.com/en-us/systemcenter/bb676783.aspx)。繼續使用 SMS 2003 Service Pack 3 的客戶，亦可選用 Inventory Tool for Microsoft Updates (ITMU)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2535802/zh-tw">Microsoft 知識庫文件編號 2535802</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2535812/zh-tw">Microsoft 知識庫文件編號 2535812</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">針對 PowerPoint 2007，請參閱 <a href="http://support.microsoft.com/kb/2535818/zh-tw">Microsoft 知識庫文件編號 2535818</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">針對適用於 Word、Excel 及 PowerPoint 2007 檔案格式的 Microsoft Office 相容性套件 Service Pack 2，請參閱 <a href="http://support.microsoft.com/kb/2540162/zh-tw">Microsoft 知識庫文件編號 2540162</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
-   感謝 [CERT/CC](http://www.cert.org/) 的 Will Dormann 協助我們解決簡報記憶體損毀 RCE 資訊安全風險 (CVE-2011-1269) 和簡報緩衝區溢位 RCE 資訊安全風險 (CVE-2011-1270)
