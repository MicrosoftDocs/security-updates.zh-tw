---
TOCTitle: 'MS11-002'
Title: 'Microsoft Security Bulletin MS11-002 - 重大'
ms:assetid: 'ms11-002'
ms:contentKeyID: 61238634
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms11-002(v=Security.10)'
---


Microsoft Security Bulletin MS11-002 - 重大
===========================================
...
此資訊安全更新可解決 Microsoft Data Access Components 中兩項未公開報告的資訊安全風險。 如果使用者檢視蓄意製作的網頁，此資訊安全風險可能會允許遠端執行程式碼。 成功利用此資訊安全風險的攻擊者可以取得與本機使用者相同的使用者權限。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

對於所有受支援版本的 Windows XP、Windows Vista 和 Windows 7，此資訊安全更新的等級為「重大」；對於所有受支援版本的 Windows Server 2003、Windows Server 2008 和 Windows Server 2008 R2，此資訊安全更新的等級為「重要」。如需更多資訊，請參閱本節中＜受影響及不受影響的軟體＞小節。

資訊安全更新可確保 MDAC 正確驗證字串長度與記憶體配置，進而解決這些資訊安全風險。 如需更多有關資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7951fd7b-6b0a-4168-8519-312a62ff3289">Microsoft Data Access Components 2.8 Service Pack 1 (英文下載更新程式)</a><br />
(KB2419632)  
<a href="https://www.microsoft.com/download/details.aspx?familyid=7951fd7b-6b0a-4168-8519-312a62ff3289&amp;displaylang=zh-tw">Microsoft Data Access Components 2.8 Service Pack 1 (中文下載更新程式)</a><br />
(KB2419632)</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ce06bfdc-7b0d-4e65-9a13-e009e3a6a9f0">Microsoft Data Access Components 2.8 Service Pack 2 (英文下載更新程式)</a><br />
(KB2419635)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=d451ced7-c9c7-4c41-9d44-8f8929fca390">Microsoft Data Access Components 2.8 Service Pack 2 (英文下載更新程式)</a><br />
(KB2419635)  
<a href="https://www.microsoft.com/download/details.aspx?familyid=d451ced7-c9c7-4c41-9d44-8f8929fca390&amp;displaylang=zh-tw">Microsoft Data Access Components 2.8 Service Pack 2 (中文下載更新程式)</a><br />
(KB2419635)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3f2c8cfa-819e-4fd9-93ba-b687eb2d46fe">Microsoft Data Access Components 2.8 Service Pack 2 (英文下載更新程式)</a><br />
(KB2419635)  
<a href="https://www.microsoft.com/download/details.aspx?familyid=3f2c8cfa-819e-4fd9-93ba-b687eb2d46fe&amp;displaylang=zh-tw">Microsoft Data Access Components 2.8 Service Pack 2 (中文下載更新程式)</a><br />
(KB2419635)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8dbcbb91-464b-4eb3-b7e5-afe82febf8d7">Microsoft Data Access Components 2.8 Service Pack 2 (英文下載更新程式)</a><br />
(KB2419635)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=13445e4a-099a-4edd-864e-c44f42940500">Windows Data Access Components 6.0 (英文下載更新程式)</a><br />
(KB2419640)  
<a href="https://www.microsoft.com/download/details.aspx?familyid=13445e4a-099a-4edd-864e-c44f42940500&amp;displaylang=zh-tw">Windows Data Access Components 6.0 (中文下載更新程式)</a><br />
(KB2419640)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=fd6b806e-50d4-4f4d-96e1-7c71fca4c543">Windows Data Access Components 6.0 (英文下載更新程式)</a><br />
(KB2419640)  
<a href="https://www.microsoft.com/download/details.aspx?familyid=fd6b806e-50d4-4f4d-96e1-7c71fca4c543&amp;displaylang=zh-tw">Windows Data Access Components 6.0 (中文下載更新程式)</a><br />
(KB2419640)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3d0885ac-97b3-46b5-970d-cc810270fba3">Windows Data Access Components 6.0 (英文下載更新程式)</a>&#42;<br />
(KB2419640)  
<a href="https://www.microsoft.com/download/details.aspx?familyid=3d0885ac-97b3-46b5-970d-cc810270fba3&amp;displaylang=zh-tw">Windows Data Access Components 6.0 (中文下載更新程式)</a>&#42;<br />
(KB2419640)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8f33c57e-343c-4cdb-b667-af18a8779ad2">Windows Data Access Components 6.0 (英文下載更新程式)</a>&#42;<br />
(KB2419640)  
<a href="https://www.microsoft.com/download/details.aspx?familyid=8f33c57e-343c-4cdb-b667-af18a8779ad2&amp;displaylang=zh-tw">Windows Data Access Components 6.0 (中文下載更新程式)</a>&#42;<br />
(KB2419640)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5ecc8180-6baa-4f4b-a392-4b45a30469fc">Windows Data Access Components 6.0 (英文下載更新程式)</a><br />
(KB2419640)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3dfd4f1c-e7a5-4686-8d2c-b7a5a53c5333">Windows Data Access Components 6.0 (英文下載更新程式)</a><br />
(KB2419640)  
<a href="https://www.microsoft.com/download/details.aspx?familyid=3dfd4f1c-e7a5-4686-8d2c-b7a5a53c5333&amp;displaylang=zh-tw">Windows Data Access Components 6.0 (中文下載更新程式)</a><br />
(KB2419640)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=cf30e5c0-811b-4ecd-a6b2-874000d25074">Windows Data Access Components 6.0 (英文下載更新程式)</a><br />
(KB2419640)  
<a href="https://www.microsoft.com/download/details.aspx?familyid=cf30e5c0-811b-4ecd-a6b2-874000d25074&amp;displaylang=zh-tw">Windows Data Access Components 6.0 (中文下載更新程式)</a><br />
(KB2419640)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=cc9bac5a-3eaa-46fb-9ef4-c511b5f57996">Windows Data Access Components 6.0 (英文下載更新程式)</a>&#42;<br />
(KB2419640)  
<a href="https://www.microsoft.com/download/details.aspx?familyid=cc9bac5a-3eaa-46fb-9ef4-c511b5f57996&amp;displaylang=zh-tw">Windows Data Access Components 6.0 (中文下載更新程式)</a>&#42;<br />
(KB2419640)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ba2612ec-ffad-4cd3-85c6-ba07f70a0d24">Windows Data Access Components 6.0 (英文下載更新程式)</a><br />
(KB2419640)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
...
**Windows 7 Service Pack 1 Beta 和 Windows Server 2008 R2 Service Pack 1 Beta 版本是否會受此資訊安全風險影響？**    
Windows 7 Service Pack 1 Beta 和 Windows Server 2008 R2 Service Pack 1 Beta 會受此公告中所述的資訊安全風險影響。 建議執行這些 Beta 版本的客戶為其系統下載並套用更新程式。 資訊安全更新可從 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 以及 [Windows Update](https://update.microsoft.com/) 取得。 資訊安全更新也可從 [Microsoft 下載中心](https://go.microsoft.com/fwlink/?linkid=21129)下載。
...
下列嚴重性等級是假設資訊安全風險可能造成的最嚴重影響而評定。 在本資訊安全公告發行的 30 天內，如需資訊安全風險易遭利用性與嚴重性等級和安全性影響之間對應關係的資訊，請參閱 [1 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms11-jan)中的＜資訊安全風險索引＞。 如需更多資訊，請參閱 [Microsoft 資訊安全風險索引](https://technet.microsoft.com/en-us/security/cc998259.aspx)。
...
<th style="border:1px solid black;" >DSN 溢位資訊安全風險 - CVE-2011-0026</th>
<th style="border:1px solid black;" >ADO 記錄記憶體資訊安全風險 - CVE-2011-0027</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
<tr class="odd">
<td style="border:1px solid black;">適用於 Itanium 系統之 Windows Server 2003 SP2 上的 Microsoft Data Access Components 2.8 Service Pack 2</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
遠端執行程式碼</td>
<td style="border:1px solid black;"><strong>中度 </strong><br />
遠端執行程式碼</td>
...
<tr class="even">
<td style="border:1px solid black;">適用於 32 位元系統之 Windows Server 2008 和適用於 32 位元系統之 Windows Server 2008 Service Pack 2 上的 Windows Data Access Components 6.0&#42;</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
遠端執行程式碼</td>
<td style="border:1px solid black;"><strong>中度 </strong><br />
遠端執行程式碼</td>
...
<tr class="odd">
<td style="border:1px solid black;">適用於 x64 型系統之 Windows Server 2008 和適用於 x64 型系統之 Windows Server 2008 Service Pack 2 上的 Windows Data Access Components 6.0&#42;</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
遠端執行程式碼</td>
<td style="border:1px solid black;"><strong>中度 </strong><br />
遠端執行程式碼</td>
...
<tr class="even">
<td style="border:1px solid black;">適用於 Itanium 型系統的 Windows Server 2008 與適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2 上的 Windows Data Access Components 6.0</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
遠端執行程式碼</td>
<td style="border:1px solid black;"><strong>中度 </strong><br />
遠端執行程式碼</td>
...
<tr class="odd">
<td style="border:1px solid black;">適用於 32 位元系統之 Windows 7 上的 Windows Data Access Components 6.0</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
遠端執行程式碼</td>
<td style="border:1px solid black;"><strong>重大</strong> <br />
遠端執行程式碼</td>
...
<tr class="even">
<td style="border:1px solid black;">適用於 x64 型系統之 Windows 7 上的 Windows Data Access Components 6.0</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
遠端執行程式碼</td>
<td style="border:1px solid black;"><strong>重大</strong> <br />
遠端執行程式碼</td>
...
<tr class="odd">
<td style="border:1px solid black;">適用於 x64 型系統之 Windows Server 2008 R2 上的 Windows Data Access Components 6.0&#42;</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
遠端執行程式碼</td>
<td style="border:1px solid black;"><strong>中度 </strong><br />
遠端執行程式碼</td>
...
<tr class="even">
<td style="border:1px solid black;">適用於 Itanium 型系統之 Windows Server 2008 R2 上的 Windows Data Access Components 6.0</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
遠端執行程式碼</td>
<td style="border:1px solid black;"><strong>中度 </strong><br />
遠端執行程式碼</td>
...
DSN 溢位資訊安全風險 - CVE-2011-0026  
------------------------------------
  
Microsoft Data Access Components 驗證協力廠商 API 使用的方式中存在遠端執行程式碼的資訊安全風險。 如果使用者造訪蓄意製作的網頁，此資訊安全風險可能會允許執行程式碼。 如果使用者以系統管理的使用者權限登入，成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
  
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-0026](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0026) (英文)。
  
#### DSN 溢位資訊安全風險 - CVE-2011-0026 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   在預設的 Windows 設定中無法利用此資訊安全風險。 系統上必須裝有以不安全的方式使用特定[開放式資料庫連接](https://support.microsoft.com/kb/110093) (ODBC) API 的協力廠商應用程式，該系統才可能受此問題影響。
  
#### DSN 溢位資訊安全風險 - CVE-2011-0026 的因應措施
  
Microsoft 尚未找到此項資訊安全風險的任何因應措施。
  
#### DSN 溢位資訊安全風險 - CVE-2011-0026 的常見問題集
  
**這個資訊安全風險的範圍為何？**    
這是遠端執行程式碼的資訊安全風險。 成功利用此資訊安全風險的攻擊者可以取得與登入使用者相同的使用者權限。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
  
**這項資訊安全風險是否可能從遠端被利用？**    
目前並沒有具備此資訊安全風險的 Microsoft 應用程式。 但是，協力廠商應用程式可能會允許從不信任來源存取[開放式資料庫連接](https://support.microsoft.com/kb/110093) (ODBC) API，因而讓有心人士得以從遠端利用此資訊安全風險。 在這種情況下，匿名使用者可利用此資訊安全風險，以完整的系統管理權限執行程式碼。
  
**造成這個資訊安全風險的原因為何？**    
協力廠商應用程式可能會使用[開放式資料庫連接](https://support.microsoft.com/kb/110093) (ODBC) API，而此 API 的資料來源名稱 (DSN) 引數中有緩衝區溢位的問題。
  
**什麼是 Microsoft Data Access Components？**    
[Microsoft Data Access Components](https://msdn.microsoft.com/en-us/library/aa968814(v=vs.85).aspx) (MDAC) 是許多元件的集合，可幫助程式存取資料庫並操控其中的資料。 現代資料庫可能有各種不同的形式 (例如，SQL Server 資料庫、Microsoft Access 資料庫和 XML 檔案)，且可能位在不同的位置中 (例如，本機系統或遠端資料庫伺服器)。 MDAC 提供一組整合的功能，能夠以一致的方式與不同種類的資料來源搭配使用。 從 Windows Vista 開始，MDAC 稱為 Windows Data Access Components (WDAC)。
...
**攻擊者如何利用這項資訊安全風險？**    
攻擊者可以針對這類經由瀏覽器利用的資訊安全風險來設計並架設蓄意製作的網站，然後引誘使用者檢視該網站。 攻擊者也可能利用受侵害的網站，以及接受或裝載使用者提供內容或廣告的網站。 這些網站可能含有經過蓄意製作並利用此資訊安全風險的內容。 但是，攻擊者無法強迫使用者造訪網站， 而是引誘使用者自行前往。一般的做法是設法讓使用者按一下電子郵件訊息或 Instant Messenger 中通往攻擊者網站的連結。 攻擊者也可能使用橫幅廣告或其他方式來顯示蓄意製作的網頁內容，以便將內容傳遞到受影響的系統。
  
**因為這個資訊安全風險而承受風險的主要系統有哪些？**    
工作站和終端伺服器的風險最高。 若系統管理員允許使用者登入伺服器並執行程式，則伺服器可能遭受更大的風險。 然而，最佳實務強烈建議您制止這種行為。
  
**更新的作用何在？**    
此更新可確保 MDAC 正確驗證 MDAC API 中的字串長度，藉以解決此資訊安全風險。
...
ADO 記錄記憶體資訊安全風險 - CVE-2011-0027  
------------------------------------------
  
Microsoft Data Access Components 驗證記憶體配置的方法中存在遠端執行程式碼的資訊安全風險。 如果使用者造訪蓄意製作的網頁，此資訊安全風險可能會允許執行程式碼。 如果使用者以系統管理的使用者權限登入，成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
  
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-0027](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0027) (英文)。
  
#### ADO 記錄記憶體資訊安全風險 - CVE-2011-0027 的緩和因素
...
-   依照預設，Windows Server 2003、Windows Server 2008 和 Windows Server 2008 R2 上的 Internet Explorer 會以稱為[增強式安全性設定](https://technet.microsoft.com/en-us/library/dd883248(ws.10).aspx)的受限制模式執行。 此模式可緩和這項資訊安全風險。 如需更多資訊，請參閱此資訊安全更新＜常見問題集＞關於 Internet Explorer 增強式安全性設定的部分。
  
#### ADO 記錄記憶體資訊安全風險 - CVE-2011-0027 的因應措施
...
-   **停用 ActiveX Data Objects (ADO) DLL**
    ...
    **因應措施的影響。** 停用 ActiveX Data Objects (ADO) DLL 會中斷 MDAC 功能。
...
#### ADO 記錄記憶體資訊安全風險 - CVE-2011-0027 的常見問題集
  
**這個資訊安全風險的範圍為何？**    
這是遠端執行程式碼的資訊安全風險。 成功利用此資訊安全風險的攻擊者可以取得與登入使用者相同的使用者權限。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
  
**造成這個資訊安全風險的原因為何？**    
MDAC 處理內部資料結構時未正確配置記憶體。
  
**什麼是 Microsoft Data Access Components？**    
[Microsoft Data Access Components](https://msdn.microsoft.com/en-us/library/aa968814(v=vs.85).aspx) (MDAC) 是許多元件的集合，可幫助程式存取資料庫並操控其中的資料。 現代資料庫可能有各種不同的形式 (例如，SQL Server 資料庫、Microsoft Access 資料庫和 XML 檔案)，且可能位在不同的位置中 (例如，本機系統或遠端資料庫伺服器)。 MDAC 提供一組整合的功能，能夠以一致的方式與不同種類的資料來源搭配使用。 從 Windows Vista 開始，MDAC 稱為 Windows Data Access Components (WDAC)。
  
ActiveX Data Objects (ADO) 屬於 MDAC 的一部分，是一個非語言相關的物件模型，可用來存取由基礎 OLE DB 提供者所建構的資料。
...
**更新的作用何在？**    
此更新可確保 MDAC 正確驗證記憶體配置，藉以解決此資訊安全風險。
...
<td style="border:1px solid black;">Windows XP Service Pack 3 上的 Microsoft Data Access Components 2.8 Service Pack 1：<br />
使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB2419632$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2 上的 Microsoft Data Access Components 2.8 Service Pack 2：<br />
使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB2419635$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">Windows XP Service Pack 3 上的 Microsoft Data Access Components 2.8 Service Pack 1：<br />
請參閱 <a href="https://support.microsoft.com/kb/2419632/zh-tw">Microsoft 知識庫文件編號 2419632</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2 上的 Microsoft Data Access Components 2.8 Service Pack 2：<br />
請參閱 <a href="https://support.microsoft.com/kb/2419635/zh-tw">Microsoft 知識庫文件編號 2419635</a></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;">在沒有使用者介入的情況下安裝</td>
<td style="border:1px solid black;">所有支援的 32 位元版 Windows Server 2003 上的 Microsoft Data Access Components 2.8 Service Pack 2：<br />
WindowsServer2003-KB2419635-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">所有支援的 x64 版 Windows Server 2003 上的 Microsoft Data Access Components 2.8 Service Pack 2：<br />
WindowsServer2003.WindowsXP-KB2419635-x64-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">所有支援的 Itanium 版 Windows Server 2003 上的 Microsoft Data Access Components 2.8 Service Pack 2：<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>移除資訊</strong></td>
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB2419635$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2419635/zh-tw">Microsoft 知識庫文件編號 2419635</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;">在沒有使用者介入的情況下安裝</td>
<td style="border:1px solid black;">所有支援的 32 位元版 Windows Vista 上的 Windows Data Access Components 6.0：<br />
Windows6.0-KB2419640-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">所有支援的 x64 版 Windows Vista 上的 Windows Data Access Components 6.0：<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2419640/zh-tw">Microsoft 知識庫文件編號 2419640</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;">在沒有使用者介入的情況下安裝</td>
<td style="border:1px solid black;">所有支援的 32 位元版 Windows Server 2008 上的 Windows Data Access Components 6.0：<br />
Windows6.0-KB2419640-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">所有支援的 x64 版 Windows Server 2008 上的 Windows Data Access Components 6.0：<br />
Windows6.0-KB2419640-x64.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">所有支援的 Itanium 版 Windows Server 2008 上的 Windows Data Access Components 6.0：<br />
...
<tr class="odd">
<td style="border:1px solid black;">在沒有使用者介入的情況下安裝</td>
<td style="border:1px solid black;">所有支援的 32 位元版 Windows 7 上的 Windows Data Access Components 6.0：<br />
Windows6.1-KB2419640-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">所有支援的 x64 版 Windows 7 上的 Windows Data Access Components 6.0：<br />
...
<tr class="odd">
<td style="border:1px solid black;">在沒有使用者介入的情況下安裝</td>
<td style="border:1px solid black;">所有支援的 x64 版 Windows Server 2008 R2 上的 Windows Data Access Components 6.0：<br />
Windows6.1-KB2419640-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">所有支援的 Itanium 版 Windows Server 2008 R2 上的 Windows Data Access Components 6.0：<br />
...
-   感謝 Abdul Aziz Hariri 與 [TippingPoint](https://www.tippingpoint.com/)**的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作回報 DSN 溢位資訊安全風險 (CVE-2011-0026)  
-   感謝 Peter Vreugdenhil 與 [TippingPoint](https://www.tippingpoint.com/)**的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作回報 ADO 記錄記憶體資訊安全風險 (CVE-2011-0027)
