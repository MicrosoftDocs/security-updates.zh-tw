---
TOCTitle: 'MS11-092'
Title: 'Microsoft Security Bulletin MS11-092 - 重大'
ms:assetid: 'ms11-092'
ms:contentKeyID: 61238724
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms11-092(v=Security.10)'
---

Microsoft Security Bulletin MS11-092 - 重大
===========================================

Windows Media 中的資訊安全風險可能會允許遠端執行程式碼 (2648048)
----------------------------------------------------------------

發行: 2011年12月13日 | 更新: 2012年8月8日
...
<th style="border:1px solid black;" >Windows Media Player DVR-MS 記憶體損毀資訊安全風險 - CVE-2011-3401</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
