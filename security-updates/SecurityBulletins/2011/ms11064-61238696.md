---
TOCTitle: 'MS11-064'
Title: 'Microsoft Security Bulletin MS11-064 - 重要'
ms:assetid: 'ms11-064'
ms:contentKeyID: 61238696
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms11-064(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS11-064 - 重要
===========================================

TCP/IP 堆疊中的資訊安全風險可能會允許阻斷服務 (DoS) (2563894)
-------------------------------------------------------------

發行: 2011年8月10日

**版本:** V1.0 (2011 年 8 月 10 日)： 公告發行。

### 一般資訊

#### 提要

這個資訊安全更新可解決 Microsoft Windows 中兩項未公開報告的資訊安全風險。 如果攻擊者傳送一連串蓄意製作的「網際網路控制訊息通訊協定」(ICMP) 訊息至目標系統，或傳送蓄意製作的 URL 要求至提供網路內容且啟用 URL 式服務品質 (QoS) 功能的伺服器，則這些資訊安全風險可能會允許阻斷服務 (DoS)。 依據預設，所有 Windows 作業系統上均未啟用 URL 式服務品質 (QoS) 功能。 使用者必須手動安裝此功能，才會受此資訊安全風險影響。

對於所有受支援版本的 Windows Server 2008 與 Windows Server 2008 R2，此資訊安全更新的等級為「重要」，對於所有受支援版本的 Windows Vista 與 Windows 7 則為「中度」。如需詳細資訊，請參閱本節中＜受影響及不受影響的軟體＞小節。

此資訊安全更新會修改 Windows TCP/IP 堆疊在 URL 式 QoS 已啟用時，處理 ICMP 訊息的方式以及處理記憶體中 URL 的方式，以解決這些資訊安全風險。 如需更多有關此資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=114c2835-921a-4d3e-be91-dfd217fd26a9">Windows Vista Service Pack 2 (英文下載更新程式)</a>
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=114c2835-921a-4d3e-be91-dfd217fd26a9&amp;displaylang=zh-tw">Windows Vista Service Pack 2 (中文下載更新程式)</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=0fcee476-8d7e-49a7-b6ea-89043304a653">Windows Vista x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=0fcee476-8d7e-49a7-b6ea-89043304a653&amp;displaylang=zh-tw">Windows Vista x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">阻斷服務 (DoS)</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms10-058">MS10-058</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=c01d9132-af5f-4039-8195-95f6761f2d0e">適用於 32 位元系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a>
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=c01d9132-af5f-4039-8195-95f6761f2d0e&amp;displaylang=zh-tw">適用於 32 位元系統的 Windows Server 2008 Service Pack 2 (中文下載更新程式)</a>&#42;</td>
<td style="border:1px solid black;">阻斷服務 (DoS)</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms10-058">MS10-058</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=70797adb-d693-4102-9e7c-ba1ea8fb07d0">適用於 x64 型系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a>
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=70797adb-d693-4102-9e7c-ba1ea8fb07d0&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows Server 2008 Service Pack 2 (中文下載更新程式)</a>&#42;</td>
<td style="border:1px solid black;">阻斷服務 (DoS)</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms10-058">MS10-058</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=9babf81a-8b21-42ae-a65c-f414793516ab">適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">阻斷服務 (DoS)</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms10-058">MS10-058</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=814bbdfa-7cbc-40e5-8ca3-8fed9d13ff00">適用於 32 位元系統的 Windows 7 和適用於 32 位元系統的 Windows 7 Service Pack 1 (英文下載更新程式)</a>
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=814bbdfa-7cbc-40e5-8ca3-8fed9d13ff00&amp;displaylang=zh-tw">適用於 32 位元系統的 Windows 7 和適用於 32 位元系統的 Windows 7 Service Pack 1 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">阻斷服務 (DoS)</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms10-058">MS10-058</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=085ee785-b6ad-4c68-835a-e17bc8f12a53">適用於 x64 型系統的 Windows 7 和適用於 x64 型系統的 Windows 7 Service Pack 1 (英文下載更新程式)</a>
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=085ee785-b6ad-4c68-835a-e17bc8f12a53&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows 7 和適用於 x64 型系統的 Windows 7 Service Pack 1 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">阻斷服務 (DoS)</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms10-058">MS10-058</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=9fd2b4ba-d98e-4ad6-99f2-c471335042d3">適用於 x64 型系統的 Windows Server 2008 R2 和適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1 (英文下載更新程式)</a>
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=9fd2b4ba-d98e-4ad6-99f2-c471335042d3&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows Server 2008 R2 和適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1 (中文下載更新程式)</a>&#42;</td>
<td style="border:1px solid black;">阻斷服務 (DoS)</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms10-058">MS10-058</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=93752c8f-5461-4e6f-9cab-6401b985ef17">適用於 Itanium 型系統的 Windows Server 2008 R2 和適用於 Itanium 型系統的 Windows Server 2008 R2 Service Pack 1 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">阻斷服務 (DoS)</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms10-058">MS10-058</a></td>
</tr>
...
<th style="border:1px solid black;" >ICMP 阻斷服務 (DoS)資訊安全風險 - CVE-2011-1871</th>
<th style="border:1px solid black;" >TCP/IP QOS 阻斷服務 (DoS)資訊安全風險 - CVE-2011-1965</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
ICMP 阻斷服務 (DoS)資訊安全風險 - CVE-2011-1871  
-----------------------------------------------
  

當 TCP/IP 堆疊不當處理一連串蓄意製作的 ICMP 訊息時，Windows TCP/IP 堆疊中存在一項阻斷服務 (DoS)資訊安全風險。 成功利用此資訊安全風險的攻擊者能夠使目標系統停止回應並自動重新啟動。
  
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-1871](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1871) (英文)。
  
#### ICMP 阻斷服務 (DoS)資訊安全風險 - CVE-2011-1871 的緩和因素
  
Microsoft 尚未找到此項資訊安全風險的任何緩和因素。
  
#### ICMP 阻斷服務 (DoS)資訊安全風險 - CVE-2011-1871 的因應措施
  
因應措施指的是無法徹底修正資訊安全風險，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。 Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：
  
-   **在防火牆封鎖 ICMP**
  
在網路邊界防火牆或路由器封鎖 ICMP 訊息有助於保護防火牆或路由器後方的系統免遭此資訊安全風險的攻擊。 我們建議您封鎖所有來路不明的網際網路輸入通訊。
  
**因應措施的影響。** 這項因應措施會防止 TCP 把網路通訊最佳化，因此對效能有負面影響。 ICMP 網路封包能消除以不同 MTU 連接網路的路由器的分散現象。 分散會降低 TCP 輸送量，並增加網路阻塞。
  
#### ICMP 阻斷服務 (DoS)資訊安全風險 - CVE-2011-1871 的常見問題集
  
**這個資訊安全風險的範圍為何？**    
這是一項阻斷服務 (DoS)的資訊安全風險。
  
**造成這個資訊安全風險的原因為何？**    
當 Windows TCP/IP 堆疊不當處理一連串蓄意製作的 ICMP 訊息時，便導致此資訊安全風險。
  
**什麼元件會受到這個資訊安全風險的影響？**    
Tcpip.sys 元件會受到這個資訊安全風險影響。
  
**攻擊者可能會利用這項資訊安全風險採取什麼行動？**    
成功利用此資訊安全風險的攻擊者能夠使目標系統停止回應並自動重新啟動。
  
**攻擊者如何利用這項資訊安全風險？**    
未經驗證的遠端攻擊者可製作一個程式來傳送一連串蓄意製作的 ICMP 訊息給目標系統，進而利用此資訊安全風險。
  
**因為這個資訊安全風險而承受風險的主要系統有哪些？**    
伺服器和工作站會受到此資訊安全風險影響。
  
**更新的作用何在？**    
這項更新可修改 Windows TCP/IP 堆疊處理 ICMP 訊息的方式，進而解決此資訊安全風險。
...
TCP/IP QOS 阻斷服務 (DoS)資訊安全風險 - CVE-2011-1965  
-----------------------------------------------------
  

URL 式服務品質 (QoS) 已啟用時，如果 TCP/IP 堆疊不當處理記憶體中的 URL，Windows TCP/IP 堆疊中將會形成一項阻斷服務 (DoS)資訊安全風險。 成功利用此資訊安全風險的攻擊者能夠使目標系統停止回應並自動重新啟動。
  
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-1965](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1965) (英文)。
  
#### TCP/IP QOS 阻斷服務 (DoS)資訊安全風險 - CVE-2011-1965 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   依據預設，所有 Windows 作業系統上均未啟用 URL 式服務品質功能。 使用者必須手動安裝此功能，才會受此資訊安全風險影響。
  
#### TCP/IP QOS 阻斷服務 (DoS)資訊安全風險 - CVE-2011-1965 的因應措施
  
因應措施指的是無法徹底修正資訊安全風險，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。 Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：
  
-   停用原則式的 QoS。 如需更多資訊，請參閱 Microsoft TechNet 文章：[原則式的服務品質 (QoS)](http://technet.microsoft.com/zh-tw/library/dd919203(ws.10).aspx) (英文)。
  
#### TCP/IP QOS 阻斷服務 (DoS)資訊安全風險 - CVE-2011-1965 的常見問題集
  
**這個資訊安全風險的範圍為何？**    
這是一項阻斷服務 (DoS)的資訊安全風險。
  
**造成這個資訊安全風險的原因為何？**    
TCP/IP 堆疊不當處理記憶體中蓄意製作的 URL，是導致此資訊安全風險的原因。 只有當目標系統是使用 IIS 之類的服務來架設網頁內容，且已啟用 URL 式的 QoS 時，才會觸發此資訊安全風險。
  
**什麼元件會受到這個資訊安全風險的影響？**    
Tcpip.sys 元件會受到這個資訊安全風險影響。
  
**什麼是 URL 式服務品質 (QoS)？**    
網路的服務品質 (QoS) 是普遍適用業界的一套標準及機制，用以確保重要應用程式能維持高品質的效能。 網路系統管理員可以使用 QoS 機制，對傳出的網路資料流排定優先順序及管理傳送速率。 使用這些機制可確保資源獲得有效利用，以提供必要的服務等級。
  
Windows Server 2008 R2 允許 IT 專業人員根據 URL 排定網站資料流的優先順序。 有了 URL 式的 QoS，IT 專業人員就能確保重要的網站資料流能優先獲得處理，而較不重要的資料流則較慢處理，因此有助於提升繁忙網路的效能。 例如，IT 專業人員可指派高於外部網站的優先順序給重要內部網站的資料流，藉以讓繁忙的網路發揮最大的效能。 如需更多資訊，請參閱 Microsoft TechNet 文章：[URL 式的 QoS](http://technet.microsoft.com/zh-tw/library/dd637810(ws.10).aspx) (英文)。
...
**攻擊者如何利用這項資訊安全風險？**    
在遠端攻擊案例中，未經驗證的攻擊者會傳送蓄意製作的 URL 要求給架設網頁內容且已啟用 URL 式 QoS 的伺服器，進而利用此資訊安全風險。
  
**因為這個資訊安全風險而承受風險的主要系統有哪些？**    
架設網頁內容且已啟用 URL 式 QoS 的伺服器風險最高。 未啟用 URL 式 QoS 或是未架設網頁內容的伺服器則不受影響。 可執行 Internet Information Services (IIS) 的工作站 (如 Windows 7 系統) 如果同時啟用 IIS 及 URL 式 QoS，則其風險會提高。
  
**如果將 Windows 7 系統設定為具備 IIS 的伺服器，其風險是否會提高？**    
是。 IIS 之類的伺服器軟體可安裝及設定於 Windows 7 系統上。 雖然 Windows 7 系統被視為工作站，但在這個配置中則是扮演伺服器，因此受到這個資訊安全風險影響的風險較高。
  
**更新的作用何在？**    
此更新會修改 Windows TCP/IP 堆疊在 URL 式 QoS 已啟用時，處理記憶體中 URL 的方式，以解決此資訊安全風險。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2563894/zh-tw">Microsoft 知識庫文件編號 2563894</a></td>
</tr>
<tr class="odd">
