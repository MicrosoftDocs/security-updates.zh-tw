---
TOCTitle: 'MS11-080'
Title: 'Microsoft Security Bulletin MS11-080 - 重要'
ms:assetid: 'ms11-080'
ms:contentKeyID: 61238712
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms11-080(v=Security.10)'
---

Microsoft Security Bulletin MS11-080 - 重要
===========================================
...
此資訊安全更新可解決 Microsoft Windows 附屬功能驅動程式 (AFD) 中一項未公開的資訊安全風險。如果攻擊者登入使用者的系統並執行蓄意製作的應用程式，則這個資訊安全風險可能允許權限提高。攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項資訊安全風險。

對於所有受支援版本的 Windows XP 與 Windows Server 2003，此資訊安全更新的等級為「重要」。如需詳細資訊，請參閱本節中＜受影響及不受影響的軟體＞小節。

此資訊安全更新可修正附屬功能驅動程式 (AFD) 將來自使用者模式的輸入傳遞給 Windows 核心之前驗證輸入的方式，進而解決此資訊安全風險。如需更多有關此資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------|------------------|----------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=f1b2dceb-5bef-4522-9001-8dff0545d805)                          | 權限提高         | 重要           | [MS11-046](https://go.microsoft.com/fwlink/?linkid=217464) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=9a37864e-8543-4c52-aa73-e3c190860d76) | 權限提高         | 重要           | [MS11-046](https://go.microsoft.com/fwlink/?linkid=217464) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=29228167-b811-43d7-b4a0-91e385b598a5)                 | 權限提高         | 重要           | [MS11-046](https://go.microsoft.com/fwlink/?linkid=217464) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=0816d729-6769-4ca6-a14e-71750eca8d29)     | 權限提高         | 重要           | [MS11-046](https://go.microsoft.com/fwlink/?linkid=217464) |
| [適用於 Itanium 型系統的 Windows Server 2003 SP2](https://www.microsoft.com/download/details.aspx?familyid=42465652-2664-4fd5-9a22-ae847b08e7c8)    | 權限提高         | 重要           | [MS11-046](https://go.microsoft.com/fwlink/?linkid=217464) |
...
<th style="border:1px solid black;" >附屬功能驅動程式權限提高資訊安全風險 - CVE-2011-2005</th>
...
附屬功能驅動程式權限提高資訊安全風險 - CVE-2011-2005  
----------------------------------------------------
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-2005](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2005) (英文)。
  
#### 附屬功能驅動程式權限提高資訊安全風險 - CVE-2011-2005 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。下列緩和因素可能對您的狀況有所助益：
  
-   攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項資訊安全風險。
  
#### 附屬功能驅動程式權限提高資訊安全風險 - CVE-2011-2005 的因應措施
  
Microsoft 尚未找到此項資訊安全風險的任何因應措施。
  
#### 附屬功能驅動程式權限提高資訊安全風險 - CVE-2011-2005 的常見問題集
...
什麼是傳輸驅動程式介面 (TDI)？    
傳輸驅動程式介面 (TDI) 定義了曝露在所有傳輸通訊協定堆疊上緣的核心模式網路介面。這類堆疊的最高層級通訊協定驅動程式，支援用於更高層級核心模式網路用戶端的 TDI 介面。如需更多關於 TDI 元件的資訊，請參閱 MSDN 文章：[傳輸驅動程式介面](https://msdn.microsoft.com/en-us/library/ff565685.aspx) (英文)。
...
注意：Microsoft 已於 2011 年 4 月 12 日停止支援 SMS 2.0。對於 SMS 2003，Microsoft 亦於 2011 年 4 月 12 日停止支援資訊安全更新盤點工具 (SUIT)。建議客戶升級為 [System Center Configuration Manager 2007](https://technet.microsoft.com/zh-tw/library/bb735860.aspx)。繼續使用 SMS 2003 Service Pack 3 的客戶，亦可選用 [Microsoft Updates 盤點工具](https://technet.microsoft.com/zh-tw/sms/bb676783.aspx) (ITMU)。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB2592799$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">檔案資訊</td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2592799">Microsoft 知識庫文件編號 2592799</a></td>
</tr>
<tr class="even">
...
-   感謝 [National University of Defense Technology](https://www.nudt.edu.cn/) 的 Bo Zhou 回報附屬功能驅動程式權限提高資訊安全風險 (CVE-2011-2005)
