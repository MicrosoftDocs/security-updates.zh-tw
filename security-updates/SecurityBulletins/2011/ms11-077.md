---
TOCTitle: 'MS11-077'
Title: 'Microsoft Security Bulletin MS11-077 - 重要'
ms:assetid: 'ms11-077'
ms:contentKeyID: 61238709
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms11-077(v=Security.10)'
---

Microsoft Security Bulletin MS11-077 - 重要
===========================================
...
這個資訊安全更新可解決 Microsoft Windows 中四項未公開報告的資訊安全風險。若使用者開啟網路共用、UNC 或 WebDAV 位置，或者電子郵件附件中蓄意製作的字型檔案 (例如 .fon 檔案)，這些資訊安全風險中最嚴重者可能會允許遠端執行程式碼。使用者必須造訪不受信任的遠端檔案系統位置或 WebDAV 共用，然後開啟蓄意製作的字型檔案，或開啟電子郵件附件形式的字型檔案，這類遠端攻擊才會成功。

對於所有受支援版本的 Microsoft Windows，此資訊安全更新的等級為「重要」。如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此資訊安全更新可修正 Windows 核心模式驅動程式驗證從使用者模式傳遞的輸入、處理 TrueType 字型類型、寫入記憶體前配置適當緩衝區大小，以及管理核心模式驅動程式物件等作業的方式，以解決這些資訊安全風險。如需更多有關此資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------|----------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=9157e677-ab3f-44b0-9735-192bc7421ba7)                                                                                      | 遠端執行程式碼   | 重要           | [MS11-054](https://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=0f2444ac-61bd-47cf-9c1e-da86a2b0cfb5)                                                             | 遠端執行程式碼   | 重要           | [MS11-054](https://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3bd62bf6-3400-4c03-95fe-148112b341e8)                                                                             | 遠端執行程式碼   | 重要           | [MS11-054](https://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b73f4e87-9655-46d5-beb2-ea245dcd280d)                                                                 | 遠端執行程式碼   | 重要           | [MS11-054](https://go.microsoft.com/fwlink/?linkid=220172) |
| [適用於 Itanium 型系統的 Windows Server 2003 SP2](https://www.microsoft.com/download/details.aspx?familyid=a618cc19-5ebc-462e-a518-d9bfe41ed98e)                                                                | 遠端執行程式碼   | 重要           | [MS11-054](https://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ff53d01b-97b7-40d2-af88-4978f1099a7c)                                                                                   | 遠端執行程式碼   | 重要           | [MS11-054](https://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=47322e11-f1cf-4f70-b939-8cac9bbfc2bc)                                                                       | 遠端執行程式碼   | 重要           | [MS11-054](https://go.microsoft.com/fwlink/?linkid=220172) |
| [適用於 32 位元系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=7c7498ee-eba4-44fd-8846-0b2e96c96705)\*                                                      | 遠端執行程式碼   | 重要           | [MS11-054](https://go.microsoft.com/fwlink/?linkid=220172) |
| [適用於 x64 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=40386742-f397-402e-8810-63d3d6ba12a6)\*                                                       | 遠端執行程式碼   | 重要           | [MS11-054](https://go.microsoft.com/fwlink/?linkid=220172) |
| [適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3633402b-96cb-4f36-b137-d07d1baf28c7)                                                     | 遠端執行程式碼   | 重要           | [MS11-054](https://go.microsoft.com/fwlink/?linkid=220172) |
| [適用於 32 位元系統的 Windows 7 和適用於 32 位元系統的 Windows 7 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=9e40bc26-f77f-4b57-9b3d-9d053c19ac56)                                 | 遠端執行程式碼   | 重要           | [MS11-054](https://go.microsoft.com/fwlink/?linkid=220172) |
| [適用於 x64 型系統的 Windows 7 和適用於 x64 型系統的 Windows 7 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=219554e6-eb5a-42d0-90c0-42b4d0772cfd)                                   | 遠端執行程式碼   | 重要           | [MS11-054](https://go.microsoft.com/fwlink/?linkid=220172) |
| [適用於 x64 型系統的 Windows Server 2008 R2 和適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=39bd4cfb-fe61-41b8-a5a2-73a9e720fc72)\*       | 遠端執行程式碼   | 重要           | [MS11-054](https://go.microsoft.com/fwlink/?linkid=220172) |
| [適用於 Itanium 型系統的 Windows Server 2008 R2 和適用於 Itanium 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=0d35c6d0-6d2d-42bf-a97f-4c5e01b1937e) | 遠端執行程式碼   | 重要           | [MS11-054](https://go.microsoft.com/fwlink/?linkid=220172) |
...
下列嚴重性等級是假設資訊安全風險可能造成的最嚴重影響而評定。在本資訊安全公告發行的 30 天內，如需資訊安全風險之易遭利用性與嚴重性等級和資訊安全影響之間對應關係的資訊，請參閱 [10 月份公告摘要](https://technet.microsoft.com/zh-tw/security/bulletin/ms11-oct)中的＜資訊安全風險入侵指數＞。如需更多資訊，請參閱 [Microsoft 資訊安全風險入侵指數](https://technet.microsoft.com/zh-tw/security/cc998259.aspx)。
...
<th style="border:1px solid black;" >Win32k Null 指標取值資訊安全風險 - CVE-2011-1985</th>
<th style="border:1px solid black;" >Win32k TrueType 字型類型翻譯資訊安全風險 - CVE-2011-2002</th>
<th style="border:1px solid black;" >字型庫檔案緩衝區溢位資訊安全風險 - CVE-2011-2003</th>
<th style="border:1px solid black;" >Win32k 釋放後使用資訊安全風險 - CVE-2011-2011</th>
...
\*會影響 Server Core 安裝。無論上述受支援的 Windows Server 2008 或 Windows Server 2008 R2 版本是否使用 Server Core 安裝選項安裝，這個更新均以相同的嚴重性等級套用。如需此安裝選項的詳細資訊，請參閱 TechNet 文章：[管理 Server Core 安裝](https://technet.microsoft.com/zh-tw/library/ee441255(ws.10).aspx) (英文) 和[維護 Server Core 安裝](https://technet.microsoft.com/zh-tw/library/ee441255(ws.10).aspx) (英文)。請注意，Server Core 安裝選項不適用於某些 Windows Server 2008 和 Windows Server 2008 R2 版本；請參閱[比較 Server Core 安裝選項](https://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx) (英文)。
  
Win32k Null 指標取值資訊安全風險 - CVE-2011-1985  
------------------------------------------------
  
Windows 核心模式驅動程式對於從使用者模式輸入核心模式之資料的驗證方式，存在一個權限提高資訊安全風險。成功利用此資訊安全風險的攻擊者可在核心模式中執行任意程式碼，並取得受影響之系統的完整控制權。接下來，攻擊者就能安裝程式，檢視、變更或刪除資料，或是建立具有完整系統管理權限的新帳戶。
  
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-1985](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1985) (英文)。
  
#### Win32k Null 指標取值資訊安全風險 - CVE-2011-1985 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。下列緩和因素可能對您的狀況有所助益：
  
-   攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項資訊安全風險。匿名或遠端使用者無法利用這個資訊安全風險。
  
#### Win32k Null 指標取值資訊安全風險 - CVE-2011-1985 的因應措施
  
Microsoft 尚未找到此項資訊安全風險的任何因應措施。
  
#### Win32k Null 指標取值資訊安全風險 - CVE-2011-1985 的常見問題集
  
這個資訊安全風險的範圍為何？   
在 32 位元作業系統上，這是權限提高資訊安全風險。成功利用此資訊安全風險的攻擊者可在核心模式中執行任意程式碼，並取得受影響之系統的完整控制權。接下來，攻擊者就能安裝程式，檢視、變更或刪除資料，或是建立具有完整系統管理權限的新帳戶。在 x64 型和 Itanium 型作業系統上，這是阻斷服務 (DoS)資訊安全風險。
...
Win32k TrueType 字型類型翻譯資訊安全風險 - CVE-2011-2002  
--------------------------------------------------------
  
系統未適當處理蓄意製作的 TrueType 字型檔案時，Microsoft Windows 實作中存在阻斷服務 (DoS)資訊安全風險。成功利用此資訊安全風險的攻擊者可使受影響的系統停止回應。
  
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-2002](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2002) (英文)。
  
#### Win32k TrueType 字型類型翻譯資訊安全風險 - CVE-2011-2002 的緩和因素
...
#### Win32k TrueType 字型類型翻譯資訊安全風險 - CVE-2011-2002 的因應措施
...
#### Win32k TrueType 字型類型翻譯資訊安全風險 - CVE-2011-2002 的常見問題集
  
這個資訊安全風險的範圍為何？   
這是一項阻斷服務 (DoS)的資訊安全風險。
  
造成這個資訊安全風險的原因為何？   
此資訊安全風險導因於 Windows 核心模式驅動程式無法適當處理 TrueType 字型類型。
...
攻擊者可能會利用這項資訊安全風險採取什麼行動？   
成功利用此資訊安全風險的攻擊者將使受影響的系統停止回應並重新啟動。
  
攻擊者如何利用這項 資訊安全風險？   
攻擊者可能在網路共用上放置一個蓄意製作的 TrueType 字型。然後，當使用者在 Windows 檔案總管中瀏覽至共用時，受影響的控制項路徑即透過詳細資料和預覽窗格觸發。蓄意製作的 TrueType 字型即可利用資訊安全風險並造成系統停止回應。
  
因為這個資訊安全風險而承受風險的主要系統有哪些？   
工作站和終端伺服器的風險最高。若系統管理員允許使用者登入伺服器並執行程式，則伺服器可能遭受更大的風險。然而，最佳實務強烈建議您制止這種行為。
  
更新的作用何在？   
此更新可修正 Windows 核心模式驅動程式處理 TrueType 字型類型的方式，以解決此資訊安全風險。
...
字型庫檔案緩衝區溢位資訊安全風險 - CVE-2011-2003  
------------------------------------------------
  
Windows 核心中因不當處理蓄意製作的 .fon 字型檔案，而存在遠端執行程式碼資訊安全風險。此資訊安全風險可能會允許攻擊者在核心模式中執行程式碼，然後便能安裝程式、檢視、變更或刪除資料，或是使用完整的系統管理權限建立新帳戶。
  
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-2003](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2003) (英文)。
  
#### 字型庫檔案緩衝區溢位資訊安全風險 - CVE-2011-2003 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。下列緩和因素可能對您的狀況有所助益：
  
-   使用者必須造訪不受信任的遠端檔案系統位置或 WebDAV 共用，然後開啟蓄意製作的字型檔案 (例如 .fon 檔案)，或開啟電子郵件附件的檔案，這類遠端攻擊才會成功。  
-   外圍防火牆的檔案共用通訊協定 SMB 通常為停用。這樣可限制此資訊安全風險的潛在遠端攻擊媒介。
  
#### 字型庫檔案緩衝區溢位資訊安全風險 - CVE-2011-2003 的因應措施
...
#### 字型庫檔案緩衝區溢位資訊安全風險 - CVE-2011-2003 的常見問題集
...
攻擊者如何利用這項 資訊安全風險？   
在網路攻擊的案例中，攻擊者可能會在網路共用、UNC 或 WebDAV 位置中放置蓄意製作的字型檔案 (例如 .fon 檔案)，然後引誘使用者開啟該檔案。
  
在電子郵件攻擊案例中，攻擊者可能會傳送蓄意製作的字型檔案附件 (例如 .fon 檔案) 給使用者，然後引誘使用者打開檔案，以利用這項資訊安全風險。
  
因為這個資訊安全風險而承受風險的主要系統有哪些？   
工作站和終端伺服器的風險最高。若系統管理員允許使用者登入伺服器並執行程式，則伺服器可能遭受更大的風險。然而，最佳實務強烈建議您制止這種行為。
  
更新的作用何在？   
此更新可修正 Windows 核心模式驅動程式在寫入記憶體前配置適當緩衝區大小的方式，以解決此資訊安全風險。
...
Win32k 釋放後使用資訊安全風險 - CVE-2011-2011  
---------------------------------------------
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-2011](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2011) (英文)。
  
#### Win32k 釋放後使用資訊安全風險 - CVE-2011-2011 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。下列緩和因素可能對您的狀況有所助益：
  
-   攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項資訊安全風險。
  
#### Win32k 釋放後使用資訊安全風險 - CVE-2011-2011 的因應措施
  
Microsoft 尚未找到此項資訊安全風險的任何因應措施。
  
#### Win32k 釋放後使用資訊安全風險 - CVE-2011-2011 的常見問題集
  
這個資訊安全風險的範圍為何？   
這是權限提高的資訊安全風險。成功利用此資訊安全風險的攻擊者可在核心模式中執行任意程式碼，並取得受影響之系統的完整控制權。接下來，攻擊者就能安裝程式，檢視、變更或刪除資料，或是建立具有完整系統管理權限的新帳戶。
  
造成這個資訊安全風險的原因為何？   
此資訊安全風險導因於核心模式驅動程式未適當管理核心模式驅動程式物件。
...
TrueType 字型檔案包括 TrueType 模擬轉譯器及作業系統軟體所使用的多種不同資訊，以確保電腦螢幕上顯示的字元或列印出來的字元完全符合字型設計者的預期。如需詳細資訊，請參閱 MSDN 文章[關於字型內嵌](https://msdn.microsoft.com/en-us/library/ms533034.aspx) (英文)。「受影響軟體」表格列出的所有作業系統均預設支援呈現 EOT 字型。
...
更新的作用何在？   
此更新可修正 Windows 核心模式驅動程式管理核心模式驅動程式物件的方式，以解決此資訊安全風險。
...
管理您必須部署到您組織中的伺服器、桌上型電腦及行動系統的軟體和資訊安全更新。如需更多資訊，請參閱 [TechNet 更新管理中心](https://technet.microsoft.com/zh-tw/updatemanagement/bb245732) (英文)。[Microsoft TechNet 資訊安全技術中心網站](https://go.microsoft.com/fwlink/?linkid=21132)提供了有關 Microsoft 產品安全性的其他資訊。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB2567053$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">檔案資訊</td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2567053">Microsoft 知識庫文件編號 2567053</a></td>
</tr>
<tr class="even">
...
-   感謝 [BitDefender](https://www.bitdefender.com/) 的 Andrei Lutas 回報 Win32k Null 指標取值資訊安全風險 (CVE-2011-1985)  
-   感謝 [Norman](https://www.norman.com/) 的 Tarjei Mandt 回報 Win32k Null 指標取值資訊安全風險 (CVE-2011-1985)  
-   感謝 Maik Wellmann 回報 Win32k TrueType 字型類型翻譯資訊安全風險 (CVE-2011-2002)  
-   感謝 [CERT/CC](https://www.cert.org/) 的 Will Dorman 回報字型庫檔案緩衝區溢位資訊安全風險 (CVE-2011-2003)
