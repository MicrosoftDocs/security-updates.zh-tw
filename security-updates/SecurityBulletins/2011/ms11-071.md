...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|----------------|------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=70f944b0-9bf0-4168-b150-67d2ff68df2d)                                                                                      | 遠端執行程式碼 | 重要           | 無               |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=4b9debed-edbb-43e1-b755-0faf01980289)                                                             | 遠端執行程式碼 | 重要           | 無               |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=d44274d2-0401-4fd8-bc4f-c59f6d81c34f)                                                                             | 遠端執行程式碼 | 重要           | 無               |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=935720ee-cee0-42c2-965e-ce1b07e95e1a)                                                                 | 遠端執行程式碼 | 重要           | 無               |
| [適用於 Itanium 型系統的 Windows Server 2003 SP2](https://www.microsoft.com/download/details.aspx?familyid=78c2ac72-da89-42a4-bff9-79551b5d3c4e)                                                                | 遠端執行程式碼 | 重要           | 無               |
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=15840336-4886-4a1b-8c1e-2c535c3938f7)                                                                                   | 遠端執行程式碼 | 重要           | 無               |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e80739b4-89bb-4317-8381-991244a71cb8)                                                                       | 遠端執行程式碼 | 重要           | 無               |
| [適用於 32 位元系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=05c39ab3-7b57-4147-8913-df5df6005799)\*                                                      | 遠端執行程式碼 | 重要           | 無               |
| [適用於 x64 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=1499d988-fd55-4317-b859-ec170907d547)\*                                                       | 遠端執行程式碼 | 重要           | 無               |
| [適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6e2d2ea9-0af6-4d23-875d-3211722cd62f)                                                     | 遠端執行程式碼 | 重要           | 無               |
| [適用於 32 位元系統的 Windows 7 和適用於 32 位元系統的 Windows 7 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=76b99ab2-7e99-4aad-a419-7996bae05c48)                                 | 遠端執行程式碼 | 重要           | 無               |
| [適用於 x64 型系統的 Windows 7 和適用於 x64 型系統的 Windows 7 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=0f6d32de-d3ff-4af9-9b26-a4f12581f5fe)                                   | 遠端執行程式碼 | 重要           | 無               |
| [適用於 x64 型系統的 Windows Server 2008 R2 和適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=a8a451bd-3e5c-4845-9941-daabd9418776)\*       | 遠端執行程式碼 | 重要           | 無               |
| [適用於 Itanium 型系統的 Windows Server 2008 R2 和適用於 Itanium 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=0fdfb1f9-20b3-4d61-8019-33d1003290c8) | 遠端執行程式碼 | 重要           | 無               |
...
Microsoft 重新發行此公告，以宣佈推出一項 Windows 7 Embedded 的更新。建議執行此平台的客戶為其系統下載並套用更新程式。安全性更新可從 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 以及 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 取得。其他更新套件不受此重新發行版本影響。

**何處可找到檔案資訊詳細資料？**  
關於檔案資訊詳細資料的位置，請見＜安全性更新部署＞一節中的參考表。

**此更新是否與 Microsoft 安全性摘要報告 2269637 有關？**  
是的，此更新所解決的 Windows 元件不安全程式庫載入弱點 (CVE-2011-1991)，與 [Microsoft 安全性摘要報告 2269637](https://technet.microsoft.com/security/advisory/2269637) 中說明的弱點類別相關，該弱點會影響應用程式載入外部程式庫的方式。此安全性更新可解決此類型弱點的一個特定執行個體。
...
下列嚴重性等級是假設弱點可能造成的最嚴重影響而評定。在本安全性公告發行的 30 天內，如需弱點之易遭利用性與嚴重性等級和安全性影響之間對應關係的資訊，請參閱 [9 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms11-sep)中的＜弱點索引＞。如需更多資訊，請參閱 [Microsoft 弱點入侵指數](https://technet.microsoft.com/zh-tw/security/cc998259.aspx)。
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2011-1991](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1991) (英文)。
...
EAPHost 是一個 Microsoft Windows 網路元件，可針對 802.1X 和點對點 (PPP) 等「要求者」通訊協定實作的驗證，提供一個可延伸驗證通訊協定 (EAP) 基礎結構。此元件還可使用「驗證器」技術進行驗證，如 Microsoft 網路原則伺服器 (NPS)。如需更多資訊，請參閱 MSDN 文章：[可延伸驗證通訊協定主機](https://msdn.microsoft.com/en-us/library/aa364249(v=vs.85).aspx) (英文)。
  
**什麼是 Microsoft Management Console (MMC)？**  
Microsoft Management Console (MMC) 是一項適用於管理應用程式的可延伸通用展示服務。MMC 針對 Microsoft 和其他軟體供應商提供的嵌入式管理單元，提供一個通用的主機環境。實際的管理行為是由嵌入式管理單元提供；MMC 本身不提供任何管理功能。MMC 環境的作用，是讓嵌入式管理單元之間密切整合。如需更多資訊，請參閱 TechNet 文章：[Microsoft Management Console - 概觀](https://technet.microsoft.com/en-us/library/bb742441.aspx) (英文)。
  
**什麼是資料夾重新導向元件？**  
資料夾重新導向是 IntelliMirror 的一項功能，可讓使用者和系統管理員將資料夾的路徑重新導向到新的位置。新的位置可以是本機電腦上的資料夾，或是網路共用上的目錄。使用者能夠處理伺服器上的文件，就像文件是位於本機硬碟上一樣。例如，您可以將 \[我的文件\] 資料夾 (通常是儲存在電腦的本機硬碟上) 重新導向到一個網路位置。網路上任何電腦的使用者均可使用該資料夾中的文件。如需更多資訊，請參閱 TechNet 文章：[資料夾重新導向概觀](https://technet.microsoft.com/en-us/library/cc778976(ws.10).aspx) (英文)。
  
**什麼是輸入法 (日文) 元件？**  
日文輸入法 (IME) 可讓使用者將日文文字輸入到文件、工作表、簡報、郵件訊息、出版品及網頁中。如需關於此 IME 或其他可用 IME 的更多資訊，請參閱 MSDN 文章：[安裝與使用輸入法](https://msdn.microsoft.com/en-us/library/ee418266%28v=vs.85%29.aspx) (英文)。
...
是。這項弱點已經遭到公開揭發。這項弱點已被指派「一般性弱點」編號 [CVE-2011-1991](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1991)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2570947">Microsoft 知識庫文件編號 2570947</a></td>
</tr>
<tr class="even">
