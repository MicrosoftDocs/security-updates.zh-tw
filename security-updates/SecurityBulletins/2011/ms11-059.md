...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=6bc168d9-6664-41fb-914f-dbd7514a4b0e">適用於 32 位元系統的 Windows 7 和適用於 32 位元系統的 Windows 7 Service Pack 1 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=6bc168d9-6664-41fb-914f-dbd7514a4b0e&amp;displaylang=zh-tw">適用於 32 位元系統的 Windows 7 和適用於 32 位元系統的 Windows 7 Service Pack 1 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=aafeff2d-db9a-4b3b-b620-be4ec5f5bdcc">適用於 x64 型系統的 Windows 7 和適用於 x64 型系統的 Windows 7 Service Pack 1 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=aafeff2d-db9a-4b3b-b620-be4ec5f5bdcc&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows 7 和適用於 x64 型系統的 Windows 7 Service Pack 1 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c29deec3-4672-4658-a550-dce244434cd4">適用於 x64 型系統的 Windows Server 2008 R2 和適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?familyid=c29deec3-4672-4658-a550-dce244434cd4&amp;displaylang=zh-tw">適用於 x64 型系統的 Windows Server 2008 R2 和適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1 (中文下載更新程式)</a>&#42;</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1d6b8036-d38f-408a-a36c-027553faefc1">適用於 Itanium 型系統的 Windows Server 2008 R2 和適用於 Itanium 型系統的 Windows Server 2008 R2 Service Pack 1 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
是的，此更新所解決的 Data Access Components 不安全程式庫載入資訊安全風險 (CVE-2011-1975)，與 [Microsoft 資訊安全摘要報告 2269637](https://technet.microsoft.com/security/advisory/2269637) 中說明的資訊安全風險類別相關，該資訊安全風險會影響應用程式載入外部程式庫的方式。 此資訊安全更新可解決此類型資訊安全風險的一個特定執行個體。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-1975](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1975) (英文)。
...
Windows Data Access Components (Windows DAC) 6.0 是一套內含於 Windows Vista、Windows 7、Windows Server 2008 和 Windows Server 2008 R2 的技術，旨在提供跨企業的資料存取。 這些技術包括 Microsoft ActiveX Data Objects (ADO)、OLE DB 和 Microsoft 開放式資料庫連接 (ODBC)。 透過 Web 或 LAN 部署的資料導向主從架構應用程式可以使用這些元件輕鬆地整合各種來源的關聯式 (SQL) 及非關聯式資訊。 如需更多資訊，請參閱 MSDN 文章：[Windows Data Access Components SDK](https://msdn.microsoft.com/zh-tw/library/aa968814(v=vs.85).aspx) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2560656/zh-tw">Microsoft 知識庫文件編號 2560656</a></td>
</tr>
<tr class="odd">
