...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=6bc1f0ac-223d-4b0b-86cd-2ba3863955c4">Windows XP Service Pack 3 (英文下載更新程式)</a>
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=6bc1f0ac-223d-4b0b-86cd-2ba3863955c4&amp;displaylang=zh-tw">Windows XP Service Pack 3 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=d5ee6787-408d-4870-af70-9338158b161b">Windows XP Professional x64 Edition Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=8de0f2db-aa09-48cd-a13b-e26a973e9cdc">Windows Server 2003 Service Pack 2 (英文下載更新程式)</a>
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=8de0f2db-aa09-48cd-a13b-e26a973e9cdc&amp;displaylang=zh-tw">Windows Server 2003 Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=8f208407-4bb3-41fe-b0d6-fc8a5e30e667">Windows Server 2003 x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="http://www.microsoft.com/downloads/details.aspx?familyid=8f208407-4bb3-41fe-b0d6-fc8a5e30e667&amp;displaylang=zh-tw">Windows Server 2003 x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ef140089-d022-4ee8-9cc4-7fb25295a39d">適用於 Itanium 型系統的 Windows Server 2003 SP2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-1974](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1974) (英文)。
...
**什麼是遠端存取服務 (RAS)？**    
遠端存取服務 (RAS) 可讓使用者透過電話線路、網際網路或其他網路連線，連線至遠端電腦，在操作上就像系統實際連線至遠端網路一樣。 RAS 可讓使用者遠端執行各項活動，如收發電子郵件、傳真文件、擷取檔案，以及使用辦公室印表機列印文件。 如需詳細資訊，請參閱 MSDN 文章：[RAS 結構概觀 (NDIS 5.1)](http://msdn.microsoft.com/zh-tw/library/ff563285(v=vs.85).aspx) (英文)。
...
**什麼是 NDISTAPI 驅動程式？**    
NDISTAPI 驅動程式屬於 RAS 架構的一部分，主要是作為 NDISWAN 與 TAPI 服務之間的介面。 電話語音應用程式實作 TAPI 服務，可進行 TAPI 要求，執行設定、監控以及拆解線路與終止呼叫等作業。 NDISTAPI 驅動程式會將這些 TAPI 要求傳給 NDISWAN。 如需詳細資訊，請參閱 MSDN 文章：[NDISTAPI 結構概觀 (NDIS 5.1)](http://msdn.microsoft.com/zh-tw/library/ff554813(v=vs.85).aspx) (英文)。
  
**什麼是 NDISWAN？**    
「網路驅動程式介面標準廣域網路」(NDISWAN) 是系統所提供的 NDIS 中繼驅動程式，可提供各種功能，例如資料壓縮、加密、回送，以及 WAN Miniport 驅動程式所使用的簡易 PPP 框架。 因此，WAN Miniport 驅動程式只需要實作媒體所需的特定功能 (例如，ISDN 需要 Q931 訊號)。 如需詳細資訊，請參閱 MSDN 文章 [NDISWAN 概觀](http://msdn.microsoft.com/zh-tw/library/ff564653(v=vs.85).aspx) (英文)。
...
更新時常會寫入您應用程式執行所需的相同檔案和登錄設定。 這可能會觸發不相容性，而拉長部署資訊安全更新的時間。 您可以使用 [Application Compatibility Toolkit (英文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=24da89e9-b581-47b0-b45e-492dd6da2971&displaylang=en) 隨附的 [Update Compatibility Evaluator](http://technet2.microsoft.com/windowsvista/en/library/4279e239-37a4-44aa-aec5-4e70fe39f9de1033.mspx?mfr=true) 元件，針對所安裝的應用程式簡化其測試和驗證 Windows 更新的過程。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2566454/zh-tw">Microsoft 知識庫文件編號 2566454</a></td>
</tr>
<tr class="even">
