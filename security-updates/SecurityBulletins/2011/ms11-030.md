...
**已知問題。**[Microsoft 知識庫文件編號 2509553](http://support.microsoft.com/kb/2509553) 中記載了客戶安裝此安全性更新時，可能會發生的目前已知問題。該文件並說明了解決這些問題的建議解決方案。
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2011-0657](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0657)。
...
-   **在防火牆中封鎖 TCP 連接埠 5355 和 UDP 連接埠 5355**
    ...
    **如何復原因應措施。** 解除防火牆中對 TCP 連接埠 5355 和 UDP 連接埠 5355 的封鎖。如需更多關於連接埠的資訊，請參閱 [TCP 和 UDP 連接埠的指派](http://go.microsoft.com/fwlink/?linkid=21312) (英文)。
...
**什麼是 LLMNR？**  
連結本機多點傳送名稱解析 (LLMNR) 是提供額外方法以解析鄰近電腦名稱的新通訊協定。LLMNR 對於沒有網域名稱系統 (DNS) 伺服器的網路特別有用。LLMNR 使用要求和回覆訊息的簡單交換，將電腦名稱解析為網際網路通訊協定第 6 版 (IPv6) 或 IP 第 4 版 (IPv4) 位址。如需更多關於 LLMNR 的資訊，請參閱 Microsoft TechNet 文章：[連結本機多點傳送名稱解析](http://technet.microsoft.com/en-us/library/bb878128.aspx) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2509553">Microsoft 知識庫文件編號 2509553</a></td>
</tr>
<tr class="even">
...
-   感謝 [Google Inc.](http://www.google.com/) 的 Neel Mehta 回報 DNS 查詢弱點 (CVE-2011-0657)
