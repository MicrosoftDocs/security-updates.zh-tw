...
**已知問題。** [Microsoft 知識庫文件編號 2698365](http://support.microsoft.com/kb/2698365?ln=zh-tw) 中記載目前已知客戶安裝此資訊安全更新後，可能會發生的問題。該文件並說明了解決這些問題的建議解決方案。

#### 受影響及不受影響的軟體

下列軟體已經過測試判斷哪些版號或版本會受到影響。其他版本超過它們的支援週期或不受影響。若要瞭解您的軟體版本的支援週期，請造訪 [Microsoft 產品技術支援週期網站](http://support.microsoft.com/common/international.aspx?rdpath=gp;%5bln%5d;lifecycle)。
...
(KB2698365)  
(英文下載更新程式)  
[Microsoft Data Access Components 2.8 Service Pack 1](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=496e93ac-fcce-458f-839b-25ff1ab22fde)  
(KB2698365)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2698365)  
(英文下載更新程式)  
[Microsoft Data Access Components 2.8 Service Pack 2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=465ef3d0-df59-4f73-a06d-49a81286c01f)  
(KB2698365)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2698365)  
(英文下載更新程式)  
[Windows Data Access Components 6.0](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=0c43c093-296e-4e12-b995-4f9e3f00cbe0)  
(KB2698365)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2698365)  
(英文下載更新程式)  
[Windows Data Access Components 6.0](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=4d9b91c9-a412-4344-b934-0d2fbd9526fd)  
(KB2698365)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2698365)  
(英文下載更新程式)  
[Windows Data Access Components 6.0](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=a8ed6a19-c128-46e5-ae38-5fa9f843ba0d)  
(KB2698365)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2698365)  
(英文下載更新程式)  
[Windows Data Access Components 6.0](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=ed997ae7-2e45-4620-bcbe-a5006aaca448)  
(KB2698365)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2698365)  
(英文下載更新程式)  
[Windows Data Access Components 6.0](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=ed997ae7-2e45-4620-bcbe-a5006aaca448)<sup>[1]</sup>
(KB2698365)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2698365)  
(英文下載更新程式)  
[Windows Data Access Components 6.0](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=4040c290-bf41-4e14-8269-da95ee06d8e7)  
(KB2698365)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2698365)  
(英文下載更新程式)  
[Windows Data Access Components 6.0](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=4040c290-bf41-4e14-8269-da95ee06d8e7)<sup>[1]</sup>
(KB2698365)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2698365)  
(英文下載更新程式)  
[Windows Data Access Components 6.0](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=e749883d-221a-411a-9c85-759d50cefa9d)  
(KB2698365)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2698365)  
(英文下載更新程式)  
[Windows Data Access Components 6.0](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=e749883d-221a-411a-9c85-759d50cefa9d)<sup>[1]</sup>
(KB2698365)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2698365)  
(英文下載更新程式)  
[Windows Data Access Components 6.0](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=eeab7dbb-f6ca-44bd-a172-c07fc5803fd6)  
(KB2698365)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
<sup>[1]</sup>KB2698365 更新也適用於 Windows Data Access Components 6.1。已安裝 [KB2640696](http://www.microsoft.com/download/details.aspx?id=28422) 更新的客戶代表系統上裝有 Windows Data Access Components 6.1，因此應該安裝 KB2698365 更新以因應此資訊安全風險。
...
**何處可找到資訊安全更新的雜湊？**  
資訊安全更新的 SHA1 和 SHA2 雜湊可用來驗證下載之資訊安全更新套件的真實性。如需此更新的相關雜湊資訊，請參閱 [Microsoft 知識庫文件編號 2698365](http://support.microsoft.com/kb/2698365?ln=zh-tw)。
...
本公告所列出的受影響軟體版本已經過測試判斷哪些版本會受到影響。其他版本超出它們的支援週期。如需瞭解產品生命週期的更多資訊，請造訪 [Microsoft 支援週期](http://support.microsoft.com/common/international.aspx?rdpath=gp;%5bln%5d;lifecycle)網站。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-1891](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1891) (英文)。
...
[Microsoft Data Access Components](http://msdn.microsoft.com/zh-tw/library/aa968814(v=vs.85).aspx) (MDAC) 是許多元件的集合，可幫助程式存取資料庫並操控其中的資料。現代資料庫可能有各種不同的形式 (例如，SQL Server 資料庫、Microsoft Access 資料庫和 XML 檔案)，且可能位在不同的位置中 (例如，本機系統或遠端資料庫伺服器)。MDAC 提供一組整合的功能，能夠以一致的方式與不同種類的資料來源搭配使用。從 Windows Vista 開始，MDAC 稱為 Windows Data Access Components (WDAC)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2698365?ln=zh-tw">Microsoft 知識庫文件編號 2698365</a></td>
</tr>
<tr class="even">
...
-   感謝匿名的研究WindowsippingPoint 的](http://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/)[Zero Day Initiative](http://www.zerodayinitiative.com/) 合作，回報 ADO 快取大小堆積溢位 RCE (CVE-2012-1891)
