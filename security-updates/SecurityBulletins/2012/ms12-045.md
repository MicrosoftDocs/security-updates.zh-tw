---
TOCTitle: 'MS12-045'
Title: 'Microsoft Security Bulletin MS12-045 - 重大'
ms:assetid: 'ms12-045'
ms:contentKeyID: 61238777
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms12-045(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-045 - 重大
===========================================

Microsoft Data Access Components 中的資訊安全風險可能會允許遠端執行程式碼 (2698365)
-----------------------------------------------------------------------------------

發行: 2012年7月10日 | 更新: 2012年9月14日
...
這個資訊安全更新可解決 Microsoft Windows 中一項未公開報告的資訊安全風險。如果使用者檢視蓄意製作的網頁，此資訊安全風險可能會允許遠端執行程式碼。成功利用此資訊安全風險的攻擊者可以取得與目前使用者相同的使用者權限。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

對於所有受支援版本的 Windows XP、Windows Vista 和 Windows 7，此資訊安全更新的等級為「重大」；對於所有受支援版本的 Windows Server 2003、Windows Server 2008 和 Windows Server 2008 R2，此資訊安全更新的等級為「中度」。如需更多資訊，請參閱本節中＜受影響及不受影響的軟體＞小節。

此資訊安全更新會變更 Microsoft Data Access Components 處理記憶體中物件的方式，藉此解決此資訊安全風險。如需更多有關此資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
**已知問題。** [Microsoft 知識庫文件編號 2698365](https://support.microsoft.com/kb/2698365?ln=zh-tw) 中記載目前已知客戶安裝此資訊安全更新後，可能會發生的問題。該文件並說明了解決這些問題的建議解決方案。

#### 受影響及不受影響的軟體

下列軟體已經過測試判斷哪些版號或版本會受到影響。其他版本超過它們的支援週期或不受影響。若要瞭解您的軟體版本的支援週期，請造訪 [Microsoft 產品技術支援週期網站](https://support.microsoft.com/common/international.aspx?rdpath=gp;%5bln%5d;lifecycle)。
...
(KB2698365)  
(英文下載更新程式)  
[Microsoft Data Access Components 2.8 Service Pack 1](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=496e93ac-fcce-458f-839b-25ff1ab22fde)  
(KB2698365)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2698365)  
(英文下載更新程式)  
[Microsoft Data Access Components 2.8 Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=465ef3d0-df59-4f73-a06d-49a81286c01f)  
(KB2698365)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2698365)  
(英文下載更新程式)  
[Windows Data Access Components 6.0](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=0c43c093-296e-4e12-b995-4f9e3f00cbe0)  
(KB2698365)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2698365)  
(英文下載更新程式)  
[Windows Data Access Components 6.0](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=4d9b91c9-a412-4344-b934-0d2fbd9526fd)  
(KB2698365)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2698365)  
(英文下載更新程式)  
[Windows Data Access Components 6.0](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=a8ed6a19-c128-46e5-ae38-5fa9f843ba0d)  
(KB2698365)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2698365)  
(英文下載更新程式)  
[Windows Data Access Components 6.0](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=ed997ae7-2e45-4620-bcbe-a5006aaca448)  
(KB2698365)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2698365)  
(英文下載更新程式)  
[Windows Data Access Components 6.0](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=ed997ae7-2e45-4620-bcbe-a5006aaca448)<sup>[1]</sup>
(KB2698365)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2698365)  
(英文下載更新程式)  
[Windows Data Access Components 6.0](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=4040c290-bf41-4e14-8269-da95ee06d8e7)  
(KB2698365)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2698365)  
(英文下載更新程式)  
[Windows Data Access Components 6.0](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=4040c290-bf41-4e14-8269-da95ee06d8e7)<sup>[1]</sup>
(KB2698365)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2698365)  
(英文下載更新程式)  
[Windows Data Access Components 6.0](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=e749883d-221a-411a-9c85-759d50cefa9d)  
(KB2698365)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2698365)  
(英文下載更新程式)  
[Windows Data Access Components 6.0](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=e749883d-221a-411a-9c85-759d50cefa9d)<sup>[1]</sup>
(KB2698365)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2698365)  
(英文下載更新程式)  
[Windows Data Access Components 6.0](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=eeab7dbb-f6ca-44bd-a172-c07fc5803fd6)  
(KB2698365)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
<sup>[1]</sup>KB2698365 更新也適用於 Windows Data Access Components 6.1。已安裝 [KB2640696](https://www.microsoft.com/download/details.aspx?id=28422) 更新的客戶代表系統上裝有 Windows Data Access Components 6.1，因此應該安裝 KB2698365 更新以因應此資訊安全風險。

**不受影響的軟體**

| **作業系統**(Server Core 安裝)                                               | **元件**                           |
|------------------------------------------------------------------------------|------------------------------------|
| 適用於 32 位元系統的 Windows Server 2008 Service Pack 2 (Server Core 安裝)   | Windows Data Access Components 6.0 |
| 適用於 x64 型系統的 Windows Server 2008 Service Pack 2 (Server Core 安裝)    | Windows Data Access Components 6.0 |
| 適用於 x64 型系統的 Windows Server 2008 R2 (Server Core 安裝)                | Windows Data Access Components 6.0 |
| 適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1 (Server Core 安裝) | Windows Data Access Components 6.0 |
...
**何處可找到資訊安全更新的雜湊？**  
資訊安全更新的 SHA1 和 SHA2 雜湊可用來驗證下載之資訊安全更新套件的真實性。如需此更新的相關雜湊資訊，請參閱 [Microsoft 知識庫文件編號 2698365](https://support.microsoft.com/kb/2698365?ln=zh-tw)。
...
本公告所列出的受影響軟體版本已經過測試判斷哪些版本會受到影響。其他版本超出它們的支援週期。如需瞭解產品生命週期的更多資訊，請造訪 [Microsoft 支援週期](https://support.microsoft.com/common/international.aspx?rdpath=gp;%5bln%5d;lifecycle)網站。
...
<th style="border:1px solid black;" >
ADO 快取大小堆積溢位 RCE 安全風險 - CVE-2012-1891
</th>
<th style="border:1px solid black;" >
彙總嚴重性等級
</th>
...
<tr>
<td style="border:1px solid black;">
適用於 Itanium 系統之 Windows Server 2003 SP2 上的 Microsoft Data Access Components 2.8 Service Pack 2
</td>
<td style="border:1px solid black;">
**中度**   
遠端執行程式碼
...
<tr class="alternateRow">
<td style="border:1px solid black;">
適用於 32 位元系統的 Windows Server 2008 Service Pack 2 上的 Windows Data Access Components 6.0
</td>
<td style="border:1px solid black;">
**中度**   
遠端執行程式碼
...
<tr>
<td style="border:1px solid black;">
適用於 x64 型系統的 Windows Server 2008 Service Pack 2 上的 Windows Data Access Components 6.0
</td>
<td style="border:1px solid black;">
**中度**   
遠端執行程式碼
...
<tr class="alternateRow">
<td style="border:1px solid black;">
適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2 上的 Windows Data Access Components 6.0
</td>
<td style="border:1px solid black;">
**中度**   
遠端執行程式碼
...
<tr>
<td style="border:1px solid black;">
適用於 32 位元系統的 Windows 7 和適用於 32 位元系統的 Windows 7 Service Pack 1 上的 Windows Data Access Components 6.0
</td>
<td style="border:1px solid black;">
**重大**   
遠端執行程式碼
...
<tr class="alternateRow">
<td style="border:1px solid black;">
適用於 x64 型系統的 Windows 7 和適用於 x64 型系統的 Windows 7 Service Pack 1 上的 Windows Data Access Components 6.0
</td>
<td style="border:1px solid black;">
**重大**   
遠端執行程式碼
...
<tr>
<td style="border:1px solid black;">
適用於 x64 型系統的 Windows Server 2008 R2 和適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1 上的 Windows Data Access Components 6.0
</td>
<td style="border:1px solid black;">
**中度**   
遠端執行程式碼
...
<tr class="alternateRow">
<td style="border:1px solid black;">
適用於 Itanium 型系統的 Windows Server 2008 R2 和適用於 Itanium 型系統的 Windows Server 2008 R2 Service Pack 1 上的 Windows Data Access Components 6.0
</td>
<td style="border:1px solid black;">
**中度**   
遠端執行程式碼
...
Microsoft Data Access Components 存取記憶體中未正確初始化之物件的方式中，存在遠端執行程式碼資訊安全風險。一旦攻擊得逞，攻擊者將能在目標系統上執行任意程式碼。攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。

若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-1891](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1891) (英文)。

#### ADO 快取大小堆積溢位 RCE 安全風險 - CVE-2012-1891 的緩和因素
...
#### ADO 快取大小堆積溢位 RCE 安全風險 - CVE-2012-1891 的因應措施
...
#### ADO 快取大小堆積溢位 RCE 安全風險 - CVE-2012-1891 的常見問題集

**這個資訊安全風險的範圍為何？**  
這是目前使用者內容中的一個遠端執行程式碼資訊安全風險。

**造成這個資訊安全風險的原因為何？**  
造成此資訊安全風險的原因，是由於 Microsoft Data Access Components 處理蓄意製作的 XML 程式碼時，存取記憶體中未適當初始化的物件所致。

**什麼是Microsoft Data Access Components？**  
[Microsoft Data Access Components](https://msdn.microsoft.com/zh-tw/library/aa968814(v=vs.85).aspx) (MDAC) 是許多元件的集合，可幫助程式存取資料庫並操控其中的資料。現代資料庫可能有各種不同的形式 (例如，SQL Server 資料庫、Microsoft Access 資料庫和 XML 檔案)，且可能位在不同的位置中 (例如，本機系統或遠端資料庫伺服器)。MDAC 提供一組整合的功能，能夠以一致的方式與不同種類的資料來源搭配使用。從 Windows Vista 開始，MDAC 稱為 Windows Data Access Components (WDAC)。
...
**更新的作用何在？**  
此更新會變更 Microsoft Data Access Components 處理記憶體中物件的方式，藉此解決此資訊安全風險。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 項目，或是 %Windir%\$NTUninstallKB2698365$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2698365?ln=zh-tw">Microsoft 知識庫文件編號 2698365</a></td>
</tr>
<tr class="even">
...
-   感謝匿名的研究WindowsippingPoint 的](https://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，回報 ADO 快取大小堆積溢位 RCE (CVE-2012-1891)
...
-   V1.1 (2012 年 7 月 31 日)： 修訂公告，宣佈一項 KB2698365 的 Windows Vista 套件偵測變更，以修正 Windows Update 在重新提供更新程式方面的問題。此變更僅屬偵測變更。已成功更新系統的客戶不必採取任何行動。  
-   V1.2 (2012 年 8 月 15 日)： 釐清此更新也適用於 Windows 7 Service Pack 1 和 Windows Server 2008 R2 Service Pack 1 上的 Windows Data Access Components 6.1。這項變更僅屬資訊上的變更。已成功更新系統的客戶不必採取任何行動。  
-   V1.3 (2012 年 9 月 14 日)： 在＜提要＞的＜已知問題＞下新增 Microsoft 知識庫文件編號 2698365 的連結。
