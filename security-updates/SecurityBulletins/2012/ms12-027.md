...
[適用於 Itanium 型系統的 Microsoft SQL Server 2005 Service Pack 4](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=d0d34b4f-4bcd-4df7-8ebc-87367e889959)<sup>[1]</sup>
(Windows 通用控制項)  
(KB2597112)
...
[適用於 32 位元系統的 Microsoft SQL Server 2008 Service Pack 2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=17294713-5c03-4439-bcae-471e9b1e1ac9)<sup>[2]</sup>
(Windows 通用控制項)  
(KB2598041)
...
[適用於 x64 型系統的 Microsoft SQL Server 2008 Service Pack 2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=17294713-5c03-4439-bcae-471e9b1e1ac9)<sup>[2]</sup>
(Windows 通用控制項)  
(KB2598041)
...
[適用於 Itanium 型系統的 Microsoft SQL Server 2008 Service Pack 2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=17294713-5c03-4439-bcae-471e9b1e1ac9)<sup>[2]</sup>
(Windows 通用控制項)  
(KB2598041)
...
[適用於 32 位元系統的 Microsoft SQL Server 2008 R2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=17294713-5c03-4439-bcae-471e9b1e1ac9)<sup>[2]</sup>
(Windows 通用控制項)  
(KB2598041)
...
[適用於 x64 型系統的 Microsoft SQL Server 2008 R2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=17294713-5c03-4439-bcae-471e9b1e1ac9)<sup>[2]</sup>
(Windows 通用控制項)  
(KB2598041)
...
[適用於 Itanium 型系統的 Microsoft SQL Server 2008 R2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=17294713-5c03-4439-bcae-471e9b1e1ac9)<sup>[2]</sup>
(Windows 通用控制項)  
(KB2598041)
...
| HotPatching                        | 不適用                                                                                                                                                                                                                                                                                                                                                                                    |
| 移除資訊                           | 您無法移除此更新程式。                                                                                                                                                                                                                                                                                                                                                                    |
| 檔案資訊                           | 請參閱 [Microsoft 知識庫文件編號 2598041](http://support.microsoft.com/kb/2598041?ln=zh-tw)                                                                                                                                                                                                                                                                                               |
| 登錄機碼驗證                       | 不適用                                                                                                                                                                                                                                                                                                                                                                                    |
...
| HotPatching                        | 不適用                                                                                                                                                                                                                                                                                                                                                                                    |
| 移除資訊                           | 您無法移除此更新程式。                                                                                                                                                                                                                                                                                                                                                                    |
| 檔案資訊                           | 請參閱 [Microsoft 知識庫文件編號 2598039](http://support.microsoft.com/kb/2598039?ln=zh-tw)                                                                                                                                                                                                                                                                                               |
| 登錄機碼驗證                       | 不適用                                                                                                                                                                                                                                                                                                                                                                                    |
...
<td style="border:1px solid black;">適用於 SQL Server 2000 Analysis Services Service Pack 4：<br />
請參閱 <a href="http://support.microsoft.com/kb/983807?ln=zh-tw">Microsoft 知識庫文件編號 983807</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於 Microsoft SQL Server 2000 Service Pack 4 的 GDR 更新：<br />
請參閱 <a href="http://support.microsoft.com/kb/983808?ln=zh-tw">Microsoft 知識庫文件編號 983808</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於 Microsoft SQL Server 2000 Service Pack 4 的 QFE 更新：<br />
請參閱 <a href="http://support.microsoft.com/kb/983809?ln=zh-tw">Microsoft 知識庫文件編號 983809</a></td>
</tr>
</tbody>
</table>
...
注意 ：您可以在同一個命令中合併使用這些參數。為符合回溯相容性，資訊安全更新程式也支援舊版安裝程式使用的安裝參數中的許多參數。如需有關支援的安裝參數的其他資訊，請參閱 [Microsoft 知識庫文件編號 262841](http://support.microsoft.com/kb/262841?ln=zh-tw)。如需更多關於 Update.exe 安裝程式的相關資訊，請造訪 [Microsoft TechNet 網站](http://technet.microsoft.com/zh-tw/windowsserver/default.aspx)。
...
| 重新開機需求                       |                                                                                                                                                                                                                                                       |
| 需要重新開機？                     | 若要減少重新開機的可能性，請在安裝資訊安全更新之前，停止所有受影響的服務，並關閉所有可能使用受影響檔案的應用程式。如需系統為何會提示您重新開機的詳細資訊，請參閱 [Microsoft 知識庫文件編號 887012](http://support.microsoft.com/kb/887012?ln=zh-tw)。 |
| HotPatching                        | 不適用                                                                                                                                                                                                                                                |
| 移除資訊                           | 您無法移除此更新程式。                                                                                                                                                                                                                                |
| 檔案資訊                           | 請參閱 [Microsoft 知識庫文件編號 2645025](http://support.microsoft.com/kb/2645025?ln=zh-tw)                                                                                                                                                           |
| 登錄機碼驗證                       | 不適用                                                                                                                                                                                                                                                |
...
-   [適用於 Windows 2000 及 Windows NT 4.0 的 Windows Installer 2.0 Redistributable](http://www.microsoft.com/zh-tw/download/details.aspx?id=11176)
-   [適用於 Windows 95、Windows 98、Windows 98 SE 及 Windows Millennium Edition 的 Windows Installer 2.0 Redistributable](http://www.microsoft.com/zh-tw/download/details.aspx?id=21990)
...
注意 ：您可以在同一個命令中合併使用這些參數。為符合回溯相容性，資訊安全更新程式也支援舊版安裝程式使用的安裝參數。如需有關支援的安裝參數的其他資訊，請參閱 [Microsoft 知識庫文件編號 262841](http://support.microsoft.com/kb/262841?ln=zh-tw)。如需更多關於套件安裝程式的相關資訊，請造訪 [Microsoft TechNet 網站](http://technet.microsoft.com/zh-tw/windowsserver/default.aspx)。
...
<td style="border:1px solid black;">若要減少重新開機的可能性，請在安裝資訊安全更新之前，停止所有受影響的服務，並關閉所有可能使用受影響檔案的應用程式。如需系統為何會提示您重新開機的詳細資訊，請參閱 <a href="http://support.microsoft.com/kb/887012?ln=zh-tw">Microsoft 知識庫文件編號 887012</a>。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">HotPatching</td>
<td style="border:1px solid black;">不適用</td>
...
<td style="border:1px solid black;">檔案資訊</td>
<td style="border:1px solid black;">適用於 Microsoft Commerce Server 2002 Service Pack 4：<br />
請參閱 <a href="http://support.microsoft.com/kb/2658674?ln=zh-tw">Microsoft 知識庫文件編號 2658674</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於 Microsoft Commerce Server 2007 Service Pack 2：<br />
請參閱 <a href="http://support.microsoft.com/kb/2658677?ln=zh-tw">Microsoft 知識庫文件編號 2658677</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於 Microsoft Commerce Server 2009：<br />
請參閱 <a href="http://support.microsoft.com/kb/2655547?ln=zh-tw">Microsoft 知識庫文件編號 2655547</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於 Microsoft Commerce Server 2009 R2：<br />
請參閱 <a href="http://support.microsoft.com/kb/2658676?ln=zh-tw">Microsoft 知識庫文件編號 2658676</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">檔案資訊</td>
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/955629?ln=zh-tw">Microsoft 知識庫文件編號 955629</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">登錄機碼驗證</td>
...
<tr class="odd">
<td style="border:1px solid black;">檔案資訊</td>
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/955630?ln=zh-tw">Microsoft 知識庫文件編號 955630</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">登錄機碼驗證</td>
...
<tr class="odd">
<td style="border:1px solid black;">檔案資訊</td>
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2641426?ln=zh-tw">Microsoft 知識庫文件編號 2641426</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">登錄機碼驗證</td>
