...
**我已成功安裝原先適用於Microsoft Office 2003** **的** **KB2598361** **更新。是否需要套用重新發行的更新套件** **(KB2687626) (2012** **年** **11** **月** **13** **日發行)？**   
...
**此更新是針對** **Microsoft Office** **使用的一個共用元件。此更新是否會提供給含有該共用元件，但不會存取資訊安全風險程式碼的** **Microsoft Office** **軟體？**   
會。此更新會提供給偵測到易受影響之共用 Office 元件的系統。即使 Office 軟體含有 VBE6.dll 但不會存取資訊安全風險程式碼，仍然會收到此更新。
  
**為什麼** **Microsoft Office 2010** **和** **Microsoft Office 2010 Service Pack 1** **有多個可用的套件更新？  **  
...
**我套用了必要的** **Microsoft** **資訊安全更新，但是我的系統上還有一個受影響版本的** **Visual Basic for Applications Runtime (VBE6.dll)。如何更新此** **DLL？**   
...
**此資訊安全更新僅適用於** **Microsoft** **軟體。如何偵測協力廠商應用程式是否在我的系統上部署了受影響版本的** **Visual Basic for Applications Runtime (VBE6.dll)？**   
...
**我是協力廠商軟*體***開發人員，而且我在應用程式中使用** **Microsoft Visual Basic for Applications Runtime。我的應用程式是否容易遭到攻擊，還有如何將其更新？  **  
