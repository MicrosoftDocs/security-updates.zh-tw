---
TOCTitle: 'MS12-010'
Title: 'Microsoft Security Bulletin MS12-010 - 重大'
ms:assetid: 'ms12-010'
ms:contentKeyID: 61238742
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms12-010(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-010 - 重大
===========================================

Internet Explorer 積存資訊安全更新 (2647516)
--------------------------------------------
...
本資訊安全更新可解決 Internet Explorer 中四項未公開報告的資訊安全風險。最嚴重的資訊安全風險可能會在使用者以 Internet Explorer 檢視蓄意製作的網頁時，允許遠端執行程式碼。成功利用這類任一資訊安全風險的攻擊者可以取得與登入使用者相同的使用者權限。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

對於 Windows 用戶端上的 Internet Explorer 7、Internet Explorer 8 與 Internet Explorer 9，此資訊安全更新的等級為「重大」；而對於 Windows 伺服器上的 Internet Explorer 7、Internet Explorer 8 與 Internet Explorer 9，等級為「中度」。對於所有受支援 Windows XP 版本上的 Internet Explorer 6，此資訊安全更新的等級為「中度」。如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

本資訊安全更新會修改 Internet Explorer 在執行複製與貼上程序時處理內容的方式、處理記憶體內物件的方式，以及建立和初始化字串的方式，進而解決這些資訊安全風險。如需更多有關此資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
(英文下載更新程式)  
[Internet Explorer 6](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=a7d59fa8-0a49-4985-9f14-92218d3b5cea)  
(中文下載更新程式)
...
<td style="border:1px solid black;">
[MS11-099](https://technet.microsoft.com/zh-tw/security/bulletin/ms11-099)
</td>
</tr>
...
(英文下載更新程式)  
[Internet Explorer 6](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=c4642890-2fba-45da-bbe9-fcaa84e4aa0c)  
(中文下載更新程式)
...
(英文下載更新程式)  
[Internet Explorer 6](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=c4a52801-55b5-4eef-9db3-c29a45863198)  
(中文下載更新程式)
...
(英文下載更新程式)  
[Internet Explorer 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=6025c5d6-696c-49cd-9264-96af5766d318)  
(中文下載更新程式)
...
(英文下載更新程式)  
[Internet Explorer 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=9e157b88-2c11-44dc-b13d-1051f9c39890)  
(中文下載更新程式)
...
(英文下載更新程式)  
[Internet Explorer 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=f162ad36-c096-43ba-a440-ec4d3fb54c21)  
(中文下載更新程式)
...
(英文下載更新程式)  
[Internet Explorer 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=6ec23c7e-0166-47dc-ae86-c49b505206bb)  
(中文下載更新程式)
...
(英文下載更新程式)  
[Internet Explorer 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=b30a8cc5-b9ad-476f-928c-c49c993d0e80)  
(中文下載更新程式)
...
(英文下載更新程式)  
[Internet Explorer 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=21f7dba4-fe97-487e-8b37-45914e106db0)\*\*  
(中文下載更新程式)
...
(英文下載更新程式)  
[Internet Explorer 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=2cd8e296-dae8-41ce-8373-f8a71b4555e9)\*\*  
(中文下載更新程式)
...
(英文下載更新程式)  
[Internet Explorer 8](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=5b37f5b1-207f-4fa1-9769-c873d672e80c)  
(中文下載更新程式)
...
(英文下載更新程式)  
[Internet Explorer 8](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=3a36e94b-a39f-4b56-8a2d-42f1089dd158)  
(中文下載更新程式)
...
(英文下載更新程式)  
[Internet Explorer 8](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=bf8ad019-e710-4e16-be4f-8168df5c5343)  
(中文下載更新程式)
...
(英文下載更新程式)  
[Internet Explorer 8](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=ef4a9002-b2da-40af-abc0-737565fea179)  
(中文下載更新程式)
...
(英文下載更新程式)  
[Internet Explorer 8](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=bbf627df-0bc0-478f-aa34-a7e5f039e589)  
(中文下載更新程式)
...
(英文下載更新程式)  
[Internet Explorer 8](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=3a8b966a-bf34-42fd-8758-9a5e8e3c7689)  
(中文下載更新程式)
...
(英文下載更新程式)  
[Internet Explorer 8](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=98d5b024-0eda-4e5d-ba9d-b828ad3d048e)\*\*  
(中文下載更新程式)
...
(英文下載更新程式)  
[Internet Explorer 8](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=246f9995-fe19-43d0-8f67-0e91eb961bab)\*\*  
(中文下載更新程式)
...
(英文下載更新程式)  
[Internet Explorer 8](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=8b423683-cd29-4049-82d6-f0845842e7f0)  
(中文下載更新程式)
...
(英文下載更新程式)  
[Internet Explorer 8](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=a5d00138-4e24-4a07-92dd-3d8a14476197)  
(中文下載更新程式)
...
(英文下載更新程式)  
[Internet Explorer 8](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=3074a898-54bb-44ff-a8f4-77f831c28771)\*\*  
(中文下載更新程式)
...
(英文下載更新程式)  
[Internet Explorer 9](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=d287496a-411c-4c1b-9d98-bacc553041ae)  
(中文下載更新程式)
...
(英文下載更新程式)  
[Internet Explorer 9](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=22cc0245-1877-4c76-914f-dd68f6cd45f0)  
(中文下載更新程式)
...
(英文下載更新程式)  
[Internet Explorer 9](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=025a5af0-39f1-481c-920c-43d2b3d85dc5)\*\*  
(中文下載更新程式)
...
(英文下載更新程式)  
[Internet Explorer 9](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=c216e01d-2f46-4a46-bdc7-9d0fe98193a3)\*\*  
(中文下載更新程式)
...
(英文下載更新程式)  
[Internet Explorer 9](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=c83a9c74-a5a7-4b3e-ba36-7a7024d99fd8)  
(中文下載更新程式)
...
(英文下載更新程式)  
[Internet Explorer 9](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=bbc9d6ae-9ec5-401f-bf16-4811b63709d1)  
(中文下載更新程式)
...
(英文下載更新程式)  
[Internet Explorer 9](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=1896a6da-f7ee-484b-a97c-455fce7b82b8)\*\*  
(中文下載更新程式)
...
是。KB2647516 更新可供 Windows 開發人員預覽版本使用。建議 Windows 開發人員預覽的客戶套用更新至其系統。該更新只在 [Windows Update](https://www.update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=zh-tw) 提供。
...
需要舊版軟體額外支援服務的客戶，請連絡 Microsoft 客戶小組人員、技術支援經理或適當的 Microsoft 協力廠商，以取得所需的額外支援。尚未簽訂聯盟、優先或授權合約的客戶，可以連絡當地的 Microsoft 銷售辦公室。如需連絡資訊，請造訪 [Microsoft 全球資訊](https://technet.microsoft.com/security/advisory/)網站，在 \[Contact Information\] (連絡資訊) 清單中選擇國家，然後按一下 \[Go\] (前往) 查看各地的連絡電話號碼。連絡時，請指明要連絡當地優先支援服務行銷經理。如需更多資訊，請參閱 [Microsoft 技術支援週期準則常見問答集](https://support.microsoft.com/kb/887012?ln=zh-tw)。
...
<th style="border:1px solid black;" >
複製與貼上資訊洩漏資訊安全風險 - CVE-2012-0010
</th>
<th style="border:1px solid black;" >
HTML 配置遠端執行程式碼資訊安全風險 - CVE-2012-0011
</th>
<th style="border:1px solid black;" >
Null 位元組資訊洩漏資訊安全風險 - CVE-2012-0012
</th>
<th style="border:1px solid black;" >
VML 遠端執行程式碼資訊安全風險 - CVE-2012-0155
</th>
<th style="border:1px solid black;" >
彙總嚴重性等級
</th>
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-0010](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0010) (英文)。

#### 複製與貼上資訊洩漏資訊安全風險 - CVE-2012-0010 的緩和因素
...
#### 複製與貼上資訊洩漏資訊安全風險 - CVE-2012-0010 的因應措施
...
-   讀取電子郵件
    ...
    如需 Outlook Express 6 中這項設定的相關資訊，請參閱 [Microsoft 知識庫文件編號 291387](https://support.microsoft.com/kb/291387?ln=zh-tw)。
...
#### 複製與貼上資訊洩漏資訊安全風險 - CVE-2012-0010 的常見問題集

這個資訊安全風險的範圍為何？  
這是一個資訊洩漏的資訊安全風險。

造成這個資訊安全風險的原因為何？  
在執行複製與貼上操作時，Internet Explorer 未充分驗證資料，而讓攻擊者能趁機存取並讀取來自不同網域的內容。

攻擊者可能會利用這項資訊安全風險採取什麼行動？  
成功利用此資訊安全風險的攻擊者，能夠檢視來自其他網域或 Internet Explorer 區域的內容。

攻擊者如何利用這項 資訊安全風險？  
為了透過 Internet Explorer 來利用這項資訊安全風險，攻擊者可能會蓄意製作、架設一個網站，並引誘使用者對網站上顯示的某些內容執行複製作業，然後再引誘使用者將內容貼到目標網站上。攻擊者也可能利用受侵害的網站，以及接受或裝載使用者提供內容或廣告的網站。這些網站可能含有經過蓄意製作並利用此資訊安全風險的內容。但是，在所有情況下，攻擊者無法強迫使用者造訪這類網站， 而是引誘使用者自行前往。一般的做法是設法讓使用者按一下電子郵件訊息或 Instant Messenger 中通往攻擊者網站的連結。
...
更新的作用何在？  
此更新會修改 Internet Explorer 在執行複製與貼上程序時處理內容的方式，藉此解決此資訊安全風險。
...
Internet Explorer 存取已刪除物件的方式中，存在遠端執行程式碼資訊安全風險。此資訊安全風險可能會損毀記憶體，使攻擊者有機會透過登入使用者的權限層級執行任意程式碼。

若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-0011](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0011) (英文)。

#### HTML 配置遠端執行程式碼資訊安全風險 - CVE-2012-0011 的緩和因素
...
#### HTML 配置遠端執行程式碼資訊安全風險 - CVE-2012-0011 的因應措施
...
#### HTML 配置遠端執行程式碼資訊安全風險 - CVE-2012-0011 的常見問題集
...
Internet Explorer 中存在資訊洩漏資訊安全風險。攻擊者可蓄意製作偽裝為合法內容的網頁來利用此資訊安全風險。成功利用此資訊安全風險的攻擊者可以檢視 Internet Explorer 程序記憶體中的內容。

若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-0012](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0012) (英文)。

#### Null 位元組資訊洩漏資訊安全風險 - CVE-2012-0012 的緩和因素
...
#### Null 位元組資訊洩漏資訊安全風險 - CVE-2012-0012 的因應措施
...
#### Null 位元組資訊洩漏資訊安全風險 - CVE-2012-0012 的常見問題集
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-0155](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0155) (英文)。

#### VML 遠端執行程式碼資訊安全風險 - CVE-2012-0155 的緩和因素
...
#### VML 遠端執行程式碼資訊安全風險 - CVE-2012-0155 的因應措施
...
#### VML 遠端執行程式碼資訊安全風險 - CVE-2012-0155 的常見問答集
...
資訊安全更新可從 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 以及 [](https://www.update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=zh-tw)[Windows Update](https://www.update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=zh-tw)</a> 取得。資訊安全更新也可以從 [Microsoft 下載中心](https://www.microsoft.com/download/en/default.aspx)取得。您也可以利用「資訊安全更新」("security update") 關鍵字搜尋輕易地找到資訊安全更新。
...
<td style="border:1px solid black;">適用於所有 Windows XP 支援版本的 Internet Explorer 6：使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB2647516$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於所有 Windows XP 支援版本的 Internet Explorer 7：<br />
使用 [控制台] 中的 [新增或移除程式] 工具，或 %Windir%\ie7updates\KB2647516-IE7\spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於所有 Windows XP 支援版本的 Internet Explorer 8：<br />
使用 [控制台] 中的 [新增或移除程式] 工具，或 %Windir%\ie8updates\KB2647516-IE8\spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">檔案資訊</td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2647516?ln=zh-tw">Microsoft 知識庫文件編號 2647516</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">登錄機碼 驗證</td>
<td style="border:1px solid black;">適用於所有受支援 32 位元版本 Windows XP 的 Internet Explorer 6：<br />
...
<td style="border:1px solid black;">移除資訊</td>
<td style="border:1px solid black;">所有受支援 32 位元版本、x64 版本和 Itanium 版本 Windows Server 2003 的 Internet Explorer 6：<br />
使用 [控制台] 中的 [新增或移除程式] 工具，或 %Windir%\$NTUninstallKB2647516$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">所有受支援 32 位元版本、x64 版本和 Itanium 版本 Windows Server 2003 的 Internet Explorer 7：<br />
...
-   感謝 [Jan Schejbal](https://janschejbal.wordpress.com/) 回報複製與貼上資訊洩漏資訊安全風險 (CVE-2012-0010)  
-   感謝 [Harmony Security](https://www.harmonysecurity.com/) 的 Stephen Fewer 與 [TippingPoint](https://www.tippingpoint.com/) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作回報 HTML 配置遠端執行程式碼資訊安全風險 (CVE-2012-0011)  
-   感謝 [HP Cloud Services](https://www.hpcloud.com/) 的 Jason Hullinger 回報 Null 位元組資訊洩漏資訊安全風險 (CVE-2012-0012)  
-   感謝 [Harmony Security](https://www.harmonysecurity.com/) 的 Stephen Fewer 與 [TippingPoint](https://www.tippingpoint.com/) 的[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作回報 VML 遠端執行程式碼資訊安全風險 (CVE-2012-0155)
