...
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=128803">MS08-069</a> 中的 KB951550 由 KB2596856 取代</td>
</tr>
</tbody>
</table>
...
System Center Configuration Manager 使用 WSUS 3.0 來偵測更新。如需更多關於 System Center Configuration Manager 軟體更新管理的資訊，請造訪 [System Center](https://technet.microsoft.com/en-us/systemcenter/bb980621)。
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">安裝於所有受支援版本之 Windows XP 上的 Microsoft XML Core Services 4.0：<br />
此版本的 Microsoft XML Core Services 是隨舊版 MSXML4 一併安裝。請遵循 <a href="https://support.microsoft.com/kb/2721691">Microsoft 知識庫文件編號 2721691</a> 中的步驟移除此資訊安全更新。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Service Pack 3 上的 Microsoft XML Core Services 6.0：<br />
...
<td style="border:1px solid black;">安裝於 Windows XP 所有受支援版本上的 Microsoft XML Core Services 3.0：<br />
請參閱 <a href="https://support.microsoft.com/kb/2719985">Microsoft 知識庫文件編號 2719985</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">安裝於所有受支援版本之 Windows XP 上的 Microsoft XML Core Services 4.0：<br />
請參閱 <a href="https://support.microsoft.com/kb/2721691">Microsoft 知識庫文件編號 2721691</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">安裝於所有 Windows XP Professional Service Pack 2 上的 Microsoft XML Core Services 6.0：<br />
請參閱 <a href="https://support.microsoft.com/kb/2721693">Microsoft 知識庫文件編號 2721693</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2687627">Microsoft 知識庫文件編號 2687627</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2596856">Microsoft 知識庫文件編號 2596856</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2687497">Microsoft 知識庫文件編號 2687497</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
-   感謝 [Google Security Team](https://www.google.com/) 與我們合作解決 MSXML 未初始化記憶體損毀資訊安全風險 (CVE-2012-1889)  
-   感謝 [Qihoo 360 Security Center](https://www.360.cn/) 回報 MSXML 未初始化記憶體損毀資訊安全風險 (CVE-2012-1889)
