---
TOCTitle: 'MS12-036'
Title: 'Microsoft Security Bulletin MS12-036 - 重大'
ms:assetid: 'ms12-036'
ms:contentKeyID: 61238768
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms12-036(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-036 - 重大
===========================================

遠端桌面中的資訊安全風險可能會允許遠端執行程式碼 (2685939)
----------------------------------------------------------

發行: 2012年6月12日 | 更新: 2013年7月11日
...
對於受支援版本的 Windows Server 2003 和 Windows Server 2008；適用於 32 位元系統的 Windows 7 Service Pack 1 和適用於 x64 型系統的 Windows 7 Service Pack 1；以及所有受支援版本的 Windows Server 2008 R2，此資訊安全更新的等級為「重大」。對於所有受支援版本的 Windows XP 和 Windows Vista，以及適用於 32 位元系統的 Windows 7 和適用於 x64 型系統的 Windows 7，此資訊安全更新的等級為「中度」。如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。
...
<td style="border:1px solid black;">
KB2685939 取代 [MS12-020](https://go.microsoft.com/fwlink/?linkid=232664) 中的 KB2621440
</td>
</tr>
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-0173](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0173) (英文)。

#### 遠端桌面通訊協定資訊安全風險 - CVE-2012-0173 的緩和因素
...
#### 遠端桌面通訊協定資訊安全風險 - CVE-2012-0173 的因應措施
...
-   **不再需要使用終端機服務、遠端桌面、遠端協助及Windows Small Business Server 2003 Remote Web Workplace時，請停用這些功能**
    ...
    如需有關如何手動停用遠端桌面的資訊，請參閱[停用遠端桌面](https://www.microsoft.com/resources/documentation/windows/xp/all/proddocs/en-us/rdesktop_disable.mspx) (英文)。

    如需如何使用群組原則停用遠端桌面的資訊，請參閱 [Microsoft 知識庫文件編號 306300](https://support.microsoft.com/kb/306300)。

    如需有關遠端協助的詳細資訊，包括如何手動及使用群組原則停用遠端協助的指示，請參閱 TechNet 文章：[遠端協助](https://technet.microsoft.com/en-us/library/bb457177.aspx) (英文)。
...
-   **在執行受支援版本的Windows Vista、Windows 7、Windows Server 2008和Windows Server 2008 R2的系統上啟用網路層級驗證**
    ...
    **注意：** 請參閱 [Microsoft 知識庫文件編號 2685939](https://support.microsoft.com/kb/2685939)，瞭解如何使用自動化 **Microsoft Fix It** 解決方案，讓此因應措施發揮作用。
    ...
    **因應措施的影響。**  不支援「認證資訊安全支援提供者 (CredSSP)」通訊協定的用戶端電腦將無法存取「網路層級驗證」所保護的伺服器。**注意：** 若為在需要使用遠端桌面的 Windows XP Service Pack 3 系統之混合網路環境中部署此因應措施的系統管理員，請參閱 [Microsoft 知識庫文章編號 951608](https://support.microsoft.com/kb/951608)，以取得如何在 Windows XP Service Pack 3 中啟用 CredSSP 的詳細資訊。

    如需網路層級驗證的更多相關資訊，包括如何使用群組原則啟用網路層級驗證，請參閱 Technet 文章：[針對遠端桌面服務連線設定網路層級驗證](https://technet.microsoft.com/en-us/library/cc732713.aspx) (英文)。

#### 遠端桌面通訊協定資訊安全風險 - CVE-2012-0173 的常見問題集
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 項目，或是 %Windir%\$NTUninstallKB2685939$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2685939">Microsoft 知識庫文件編號 2685939</a></td>
</tr>
<tr class="even">
...
-   V1.0 (2012 年 6 月 12 日)： 公告發行。  
-   V1.1 (2012 年 6 月 13 日)： 在＜資訊安全風險資訊＞一節新增一項因應措施，說明如何在 Windows Vista、Windows 7、Windows Server 2008 和 Windows Server 2008 R2 作業系統中啟用網路層級驗證。  
-   V1.2 (2012 年 7 月 10 日)： 將 MS11-065 從 KB2685939 更新所取代的公告中移除。KB2685939 更新適用於 Windows XP Service Pack 3、Windows XP Professional x64 Edition Service Pack 2、Windows Server 2003 Service Pack 2、Windows Server 2003 x64 Edition Service Pack 2 及適用於 Itanium 型系統的 Windows Server 2003 SP2。這只是資訊的變更。偵測邏輯或更新檔案沒有變更。  
-   V1.3 (2013 年 7 月 11 日)： 修訂公告，宣佈一項 2685939 更新的 Windows Vista 套件偵測變更，以修正 Windows Update 在重新提供更新程式方面的問題。此變更僅屬偵測變更。已成功更新系統的客戶不必採取任何行動。
