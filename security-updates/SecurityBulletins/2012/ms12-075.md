---
TOCTitle: 'MS12-075'
Title: 'Microsoft Security Bulletin MS12-075 - 重大'
ms:assetid: 'ms12-075'
ms:contentKeyID: 61238807
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms12-075(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-075 - 重大
===========================================

Windows 核心模式驅動程式中的資訊安全風險可能會允許遠端執行程式碼 (2761226)
--------------------------------------------------------------------------
...
這個資訊安全更新可解決 Microsoft Windows 中三項未公開報告的資訊安全風險。如果使用者開啟蓄意製作的文件或是造訪內嵌 TrueType 字型檔案的惡意網頁，這些資訊安全風險中最嚴重者可能會允許遠端執行程式碼。攻擊者必須引誘使用者造訪網站，通常是設法讓使用者按下電子郵件中連往攻擊者網站的連結。
...
<td style="border:1px solid black;">
KB2761226 取代 [MS12-055](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-055) 中的 KB2731847
</td>
</tr>
...
**何處可找到資訊安全更新的雜湊？**  
資訊安全更新的 SHA1 和 SHA2 雜湊可用來驗證下載之資訊安全更新套件的真實性。如需此更新的相關雜湊資訊，請參閱 [Microsoft 知識庫文件編號 2761226](https://support.microsoft.com/kb/2761226)。

**Windows 8 Release Preview與Windows Server 2012 Release Candidate是否會受此公告中指出的資訊安全風險影響？**  
是。KB2761226 更新可供 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 使用。建議使用 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 的客戶在其系統上套用這些更新。這些更新只透過 [Windows Update](https://update.microsoft.com/windowsupdate/v6/default.aspx) 提供。
...
<th style="border:1px solid black;" >
Win32k 釋放後使用資訊安全風險 - CVE-2012-2530
</th>
<th style="border:1px solid black;" >
Win32k 釋放後使用資訊安全風險 - CVE-2012-2553
</th>
<th style="border:1px solid black;" >
TrueType 字型剖析資訊安全風險 - CVE-2012-2897
</th>
<th style="border:1px solid black;" >
彙總嚴重性等級
</th>
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-2530](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2530) (英文)。

#### Win32k 釋放後使用資訊安全風險 - CVE-2012-2530 的緩和因素

緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。下列緩和因素可能對您的狀況有所助益：

-   攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項資訊安全風險。

#### Win32k 釋放後使用資訊安全風險 - CVE-2012-2530 的因應措施

Microsoft 尚未找到此項資訊安全風險的任何因應措施。

#### Win32k 釋放後使用資訊安全風險 - CVE-2012-2530 的常見問題集
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-2553](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2553) (英文)。

#### Win32k 釋放後使用資訊安全風險 - CVE-2012-2553 的緩和因素

緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。下列緩和因素可能對您的狀況有所助益：

-   攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項資訊安全風險。

#### Win32k 釋放後使用資訊安全風險 - CVE-2012-2553 的因應措施

Microsoft 尚未找到此項資訊安全風險的任何因應措施。

#### Win32k 釋放後使用資訊安全風險 - CVE-2012-2553 的常見問題集
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-2897](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2897) (英文)。

#### TrueType 字型剖析資訊安全風險 - CVE-2012-2897 的緩和因素
...
#### TrueType 字型剖析資訊安全風險 - CVE-2012-2897 的因應措施

Microsoft 尚未找到此項資訊安全風險的任何因應措施。

#### TrueType 字型剖析資訊安全風險 - CVE-2012-2897 的常見問題集

**這個資訊安全風險的範圍為何？**  
這是遠端執行程式碼的資訊安全風險

**造成這個資訊安全風險的原因為何？**  
此資訊安全風險是由於 Windows 無法正確處理蓄意製作的 TrueType 字型 (TTF) 所致。
...
**更新的作用何在？**  
此更新可修正 Windows 處理蓄意製作的 TrueType 字型檔案的方式，藉以解決此資訊安全風險。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或下列資料夾中的 Spuninst.exe 公用程式： %Windir%\$NTUninstallKB2761226$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2761226?ln=zh-tw">Microsoft 知識庫文件編號 2761226</a></td>
</tr>
<tr class="even">
...
| **檔案資訊**                                   | 請參閱 [Microsoft 知識庫文件編號 2761226](https://support.microsoft.com/kb/2761226?ln=zh-tw)                           |
  Windows
### 其他資訊
...
-   感謝 [Google Inc](https://www.google.com/) 的 Matthew Jurczyk 回報 Windows 核心 win32k.sys 釋放後使用資訊安全風險 (CVE-2012-2553)  
-   感謝 [Documill](https://www.documill.com/) 的 Eetu Luodemaa 和 Joni Vähämäki 與 Chromium Security Rewards Program 合作回報 TrueType 字型剖析資訊安全風險 (CVE-2012-2897)
...
-   V1.1 (2012 年 11 月 16 日)： 更正 CVE-2012-2897 的資訊安全風險標題和常見問題集項目。本變更僅屬資訊上的變更。
