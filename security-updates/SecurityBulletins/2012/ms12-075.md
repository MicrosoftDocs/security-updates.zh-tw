...
<td style="border:1px solid black;">
KB2761226 取代 [MS12-055](http://technet.microsoft.com/zh-tw/security/bulletin/ms12-055) 中的 KB2731847
</td>
</tr>
...
是。KB2761226 更新可供 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 使用。建議使用 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 的客戶在其系統上套用這些更新。這些更新只透過 [Windows Update](http://update.microsoft.com/windowsupdate/v6/default.aspx) 提供。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-2530](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2530) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-2553](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2553) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-2897](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2897) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2761226?ln=zh-tw">Microsoft 知識庫文件編號 2761226</a></td>
</tr>
<tr class="even">
...
| **檔案資訊**                                   | 請參閱 [Microsoft 知識庫文件編號 2761226](http://support.microsoft.com/kb/2761226?ln=zh-tw)                           |
  Windows
### 其他資訊
...
-   感謝 [Google Inc](http://www.google.com/) 的 Matthew Jurczyk 回報 Windows 核心 win32k.sys 釋放後使用資訊安全風險 (CVE-2012-2553)  
-   感謝 [Documill](http://www.documill.com/) 的 Eetu Luodemaa 和 Joni Vähämäki 與 Chromium Security Rewards Program 合作回報 TrueType 字型剖析資訊安全風險 (CVE-2012-2897)
