...
**已知問題。** [Microsoft 知識庫文件編號 2722913](https://support.microsoft.com/kb/2722913?ln=zh-tw) 中記載目前已知客戶在安裝此資訊安全更新時可能會發生的問題。該文件並說明了解決這些問題的建議解決方案。
...
<td style="border:1px solid black;">
KB2722913 取代 [MS12-037](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-037) 中的 KB2699988
</td>
</tr>
...
<td style="border:1px solid black;">
KB2722913 取代 [MS12-044](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-044) 中的 KB2719177
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
**何處可找到資訊安全更新的雜湊？**  
資訊安全更新的 SHA1 和 SHA2 雜湊可用來驗證下載之資訊安全更新套件的真實性。如需此更新的相關雜湊資訊，請參閱 [Microsoft 知識庫文件編號 2722913](https://support.microsoft.com/kb/2722913?ln=zh-tw)。
...
[MS12-056](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-056) 將一併解決此公告中所述的 JavaScript 整數溢位遠端執行程式碼資訊安全風險 (CVE-2012-2523)。

在系統上安裝 Internet Explorer 8 的客戶，請安裝 [MS12-056](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-056) 中所述的 KB2706045 更新，以免受 CVE-2012-2523 中所述資訊安全風險影響。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-1526](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1526) (英文)。
...
-   依照預設，Windows Server 2003、Windows Server 2008 和 Windows Server 2008 R2 上的 Internet Explorer 會以稱為[增強式資訊安全設定](https://technet.microsoft.com/library/dd883248.aspx)的受限制模式執行。此模式可緩和此資訊安全風險。如需更多資訊，請參閱此資訊安全風險＜常見問題集＞關於 Internet Explorer 增強式資訊安全設定的部份。
...
是。依照預設，Windows Server 2003、Windows Server 2008 和 Windows Server 2008 R2 上的 Internet Explorer 會以稱為[增強式資訊安全設定](https://technet.microsoft.com/library/dd883248.aspx)的受限制模式執行。增強式資訊安全設定是一組預先設定好的 Internet Explorer 設定，可以降低使用者或系統管理員在伺服器下載及執行蓄意製作之網頁內容的可能性。對於您尚未新增至 Internet Explorer \[信任的網站\] 區域的網站，這是一種緩和因素。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-2521](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2521) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-2522](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2522) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-2523](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2523) (英文)。
...
**注意：** 此更新不會為 Internet Explorer 8 解決此資訊安全風險。Internet Explorer 8 可使用 [MS12-056](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-056) 中所述的 KB2706045 資訊安全更新。

**我的系統已安裝Internet Explorer 8。哪裡可以找到解決CVE-2012-2523的更新?**  
在系統上安裝 Internet Explorer 8 的客戶可以安裝 [MS12-056](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-056) 中所述的 KB2706045 更新解決 CVE-2012-2523 資訊安全風險。
...
資訊安全更新可從 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 以及 [Windows Update](https://fe1.update.microsoft.com/microsoftupdate/v6/vistadefault.aspx) 取得。資訊安全更新也可以從 [Microsoft 下載中心](https://www.microsoft.com/zh-tw/download/search.aspx?q=security%20update)取得。您也可以利用「資訊安全更新」("security update") 關鍵字搜尋輕易地找到資訊安全更新。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2722913?ln=zh-tw">Microsoft 知識庫文件編號 2722913</a></td>
</tr>
<tr class="even">
...
-   感謝 GWSlabs 與[VeriSign iDefense Labs 合作](https://labs.idefense.com/)回報配置記憶體損毀資訊安全風險 (CVE-2012-1526)  
-   感謝 Derek Soeder 與[Beyond Security 的 SecuriTeam Secure Disclosure](https://www.beyondsecurity.com/ssd.html) 專案合作回報非同步 Null 物件存取遠端執行程式碼資訊安全風險 (CVE-2012-2521)  
-   感謝 Sung-ting Tsai 和 [趨勢科技](https://www.trendmicro.com/) Ming-Chieh Pan 回報虛擬功能表損毀遠端執行程式碼資訊安全風險 (CVE-2012-2522)  
-   [Google Chrome 資訊安全小組的 Cris Neckar](https://chrome.google.com/)  
