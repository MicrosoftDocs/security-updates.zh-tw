---
TOCTitle: 'MS12-042'
Title: 'Microsoft Security Bulletin MS12-042 - 重要'
ms:assetid: 'ms12-042'
ms:contentKeyID: 61238774
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms12-042(v=Security.10)'
---
...
(KB2707511)  
(英文下載更新程式)  
[Windows XP Service Pack 3](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=0efff733-4c8d-4fce-8de3-28465c6b762b)  
(KB2707511)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2707511 取代 [MS11-098](https://technet.microsoft.com/zh-tw/security/bulletin/ms11-098) 中的 KB2633171
</td>
</tr>
...
(KB2707511)  
(英文下載更新程式)  
[Windows Server 2003 Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=855611a1-91ad-4d22-8c1c-fdcd6af4cef0)  
(KB2707511)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2709715)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=c2b47091-534f-41c3-a229-b5a9ec4b64bb)  
(KB2709715)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2709715 取代 [MS11-068](https://technet.microsoft.com/zh-tw/security/bulletin/ms11-068) 中的 KB2556532
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
(KB2709715)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows 7 Service Pack 1](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=c2b47091-534f-41c3-a229-b5a9ec4b64bb)  
(KB2709715)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2709715)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 R2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=1696726a-ed04-4c0e-b9b6-3ac4ac775c4c)  
(KB2709715)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2709715)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=1696726a-ed04-4c0e-b9b6-3ac4ac775c4c)  
(KB2709715)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
<th style="border:1px solid black;" >
使用者模式排程器記憶體損毀資訊安全風險 - CVE-2012-0217
</th>
<th style="border:1px solid black;" >
BIOS ROM 損毀資訊安全風險 - CVE-2012-1515
</th>
<th style="border:1px solid black;" >
彙總嚴重性等級
</th>
...
在 Windows 使用者模式排程器處理系統要求的方式中，存在權限提高的資訊安全風險。成功利用此資訊安全風險的攻擊者可以在核心模式下執行任意程式碼。接下來，攻擊者就能安裝程式，檢視、變更或刪除資料，或是建立具有完整系統管理權限的新帳戶。

若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-0217](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0217) (英文)。

#### 使用者模式排程器記憶體損毀資訊安全風險 CVE-2012-0217 的緩和因素

緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。下列緩和因素可能對您的狀況有所助益：

-   攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項資訊安全風險。匿名或遠端使用者無法利用這個資訊安全風險。
-   此資訊安全風險只會影響 Windows 7 與 Windows Server 2008 R2 的 Intel x64 型版本。
-   配備 AMD 或 ARM 型 CPU 的系統不受此資訊安全風險影響。

#### 使用者模式排程器記憶體損毀資訊安全風險 CVE-2012-0217 的因應措施

Microsoft 尚未找到此項資訊安全風險的任何因應措施。

#### 使用者模式排程器記憶體損毀資訊安全風險 CVE-2012-0217 的常見問題集

這個資訊安全風險的範圍為何？  
這是權限提高的資訊安全風險。

造成這個資訊安全風險的原因為何？  
造成此資訊安全風險的原因，是由於 Windows 使用者模式排程器未正確處理特定的系統要求所致。

什麼是 使用者模式排程器 (UMS)？  
使用者模式排程器 (UMS) 是一個輕量型機制，包含應用程式可用來排程其執行緒之系統 API。應用程式可在使用者模式中於 UMS 執行緒之間切換，而不需使用系統排程器並重新取得處理器的控制權 (如果核心的 UMS 執行緒封鎖。
...
更新的作用何在？  
此更新會修正 Windows 使用者模式排程器處理特定系統要求的方式，藉以解決此資訊安全風險。
...
在 Windows 處理 BIOS 記憶體的方式中，存在權限提高資訊安全風險。成功利用此資訊安全風險的攻擊者可以在核心模式下執行任意程式碼。接下來，攻擊者就能安裝程式，檢視、變更或刪除資料，或是建立具有完整系統管理權限的新帳戶。

若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-1515](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1515) (英文)。

#### BIOS ROM 損毀資訊安全風險 - CVE-2012-1515 的緩和因素

緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。下列緩和因素可能對您的狀況有所助益：

-   攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項資訊安全風險。匿名或遠端使用者無法利用這個資訊安全風險。

#### BIOS ROM 損毀資訊安全風險 - CVE-2012-1515 的因應措施

Microsoft 尚未找到此項資訊安全風險的任何因應措施。

#### BIOS ROM 損毀資訊安全風險 - CVE-2012-1515 的常見問題集

這個資訊安全風險的範圍為何？  
這是權限提高的資訊安全風險。

造成這個資訊安全風險的原因為何？  
造成此資訊安全風險的原因，是由於 Windows 未正確保護 BIOS ROM。
...
更新的作用何在？  
此更新會修正 Windows 管理 BIOS ROM 的方式，進而解決此資訊安全風險。

本資訊安全公告發行時，這項資訊安全風險是否已揭發出來？  
是。這項資訊安全風險已經遭到公開揭發。這項資訊安全風險已被指派一般性資訊安全風險編號 [CVE-2012-1515](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1515) (英文)。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 項目，或是 %Windir%\$NTUninstallKB2707511$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">檔案資訊</td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2707511?ln=zh-tw">Microsoft 知識庫文件編號 2707511</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;">檔案資訊</td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2709715?ln=zh-tw">Microsoft 知識庫文件編號 2709715</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">登錄機碼驗證</td>
...
-   感謝 [Bromium](https://www.bromium.com/) 的 Rafal Wojtczuk 和 [SUSE](https://www.suse.com/) 的 Jan Beulich 回報使用者模式排程器記憶體損毀資訊安全風險 (CVE-2012-0217)
