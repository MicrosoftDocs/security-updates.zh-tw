...
**我已成功安裝原始的** **KB2721642** **更新。我是否需要套用在** **2012** **年** **11** **月** **13** **日重新發行的** **KB2721642** **更新套件？  **  
...
**此公告描述的資訊安全風險是否影響已安裝的** **System Center Configuration Manager 2007 R2** **和** **R3，以及** **Systems Management Server 2003 R2？  **  
