---
TOCTitle: 'MS12-038'
Title: 'Microsoft Security Bulletin MS12-038 - 重大'
ms:assetid: 'ms12-038'
ms:contentKeyID: 61238770
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms12-038(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-038 - 重大
===========================================

.NET Framework 中的資訊安全風險可能會允許遠端執行程式碼 (2706726)
-----------------------------------------------------------------
...
這個資訊安全更新可解決 Microsoft .NET Framework 中一項未公開報告的資訊安全風險。如果使用者使用可執行 XAML 瀏覽器應用程式 (XBAP) 的網頁瀏覽器檢視蓄意製作的網頁，此資訊安全風險就可能允許在用戶端系統上遠端執行程式碼。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。Windows .NET Framework 應用程式也可能使用這個資訊安全風險，以略過程式碼存取安全性 (CAS) 限制。在網頁瀏覽攻擊的案例中，攻擊者可架設一個網站，並在其中包含用來利用此資訊安全風險的網頁。此外，受侵害的網站以及接受或存放使用者提供之內容或廣告的網站裡，也可能包含蓄意製作以利用本資訊安全風險的內容。但是，在所有情況下，攻擊者無法強迫使用者造訪這類網站， 而是引誘使用者自行前往。一般的做法是設法讓使用者按一下電子郵件或 Instant Messenger 訊息中連往攻擊者網站的連結。

對於所有支援的 Microsoft Windows 版本而言，Microsoft .NET Framework 2.0 Service Pack 2、Microsoft .NET Framework 3.5.1 與 Microsoft .NET Framework 4 的資訊安全更新等級為「重大」。如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此資訊安全更新可修正 .NET Framework 驗證傳遞給函數指標的資料之方式，藉此解決此資訊安全風險。如需更多有關此資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
(KB2686828)  
(英文下載更新程式)  
[Microsoft .NET Framework 2.0 Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=3206a637-a25e-4cc7-830c-08454ae86f0f)  
(KB2686828)  
(中文下載更新程式)  
...
(KB2686827)  
(英文下載更新程式)  
[Microsoft .NET Framework 4](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=fef24f6c-d81a-4078-af5d-dc7d0b53d145)<sup>[1]</sup>
(KB2686827)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2686833)  
(英文下載更新程式)  
[Microsoft .NET Framework 2.0 Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=0f4dadc9-733d-46ba-a6a8-92e7b4f49a7b)  
(KB2686833)  
(中文下載更新程式)  
[Microsoft .NET Framework 4](https://www.microsoft.com/download/details.aspx?familyid=fef24f6c-d81a-4078-af5d-dc7d0b53d145)<sup>[1]</sup>
(KB2686827)  
...
(KB2686830)  
(中文下載更新程式)  
[Microsoft .NET Framework 3.5.1](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=68d3694f-fcc9-49e6-93c2-0568b7280236)  
(KB2686830)  
(英文下載更新程式)  
[Microsoft .NET Framework 4](https://www.microsoft.com/download/details.aspx?familyid=fef24f6c-d81a-4078-af5d-dc7d0b53d145)<sup>[1]</sup>
(KB2686827)  
...
(KB2686831)  
(英文下載更新程式)  
[Microsoft .NET Framework 3.5.1](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=30b16454-cf11-49e1-9032-71c8d2b5d44b)  
(KB2686831)  
(中文下載更新程式)  
[Microsoft .NET Framework 4](https://www.microsoft.com/download/details.aspx?familyid=fef24f6c-d81a-4078-af5d-dc7d0b53d145)<sup>[1]</sup>
(KB2686827)  
...
Windows Consumer Preview 上的 Microsoft .NET Framework 3.5 和 Microsoft .NET Framework 4.5 以及 Microsoft .NET Framework 4.5 Consumer Preview 是否受此資訊安全風險影響？
是。這項資訊安全風險的回報時間，是在 Windows Consumer Preview 和 Microsoft .NET Framework 4.5 Consumer Preview 發行之後。我們建議執行此 Consumer Preview 軟體的客戶下載並套用這些更新至他們的系統。如需更多資訊，包括 Microsoft 下載中心連結，請參閱下列 Microsoft 知識庫文章：

| 受影響的軟體                                                                                                | Microsoft 知識庫文件                                                                 |
|-------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|
| Windows Consumer Preview 上的 Microsoft .NET Framework 3.5                                                  | [Microsoft 知識庫文件編號 2686868](https://support.microsoft.com/kb/2686868?ln=zh-tw) |
| Windows Consumer Preview 上的 Microsoft .NET Framework 4.5                                                  | [Microsoft 知識庫文件編號 2686837](https://support.microsoft.com/kb/2686837?ln=zh-tw) |
| Windows Server 2008、Windows 7 和 Windows Server 2008 R2 上的 Microsoft .NET Framework 4.5 Consumer Preview | [Microsoft 知識庫文件編號 2686838](https://support.microsoft.com/kb/2686838?ln=zh-tw) |

資訊安全更新可從 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 以及 [Windows Update](https://update.microsoft.com/windowsupdate/v6/default.aspx) 取得。

Windows Release Preview 上的 Microsoft .NET Framework 3.5 和 Microsoft .NET Framework 4.5，以及 Windows RT 和 Microsoft .NET Framework 4.5 Release Candidate 是否受此資訊安全風險影響？  
否。此資訊安全風險是在 Windows Release Preview、Windows RT 和 Microsoft .NET Framework 4.5 Release Candidate 發行之前回報，因此這些版本已包含此資訊安全公告所涵蓋的資訊安全風險修正程式。
...
<th style="border:1px solid black;" >
.NET Framework 記憶體存取資訊安全風險 - CVE-2012-1855
</th>
<th style="border:1px solid black;" >
彙總嚴重性等級
</th>
...
由於不當執行函數指標，導致 Microsoft .NET Framework 中存在遠端執行程式碼的資訊安全風險。成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-1855](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1855) (英文)。

#### .NET Framework 記憶體存取資訊安全風險 - CVE-2012-1855 的緩和因素
...
#### .NET Framework 記憶體存取資訊安全風險 - CVE-2012-1855 的因應措施
...
更新的作用何在？  
此更新可修正 .NET Framework 驗證傳遞給函數指標的資料之方式，藉此解決此資訊安全風險。
...
SMS 2003 可使用 Microsoft Update SMS 2003 盤點工具 (ITMU) 來偵測由 [Microsoft Update](https://update.microsoft.com/microsoftupdate) 所提供，並由 [Windows Server Update Services](https://go.microsoft.com/fwlink/?linkid=50120) 支援的資訊安全更新。如需 SMS 2003 ITMU 的詳細資訊，請參閱 [Microsoft Updates SMS 2003 盤點工具](https://technet.microsoft.com/zh-tw/sms/bb676783.aspx) (英文)。如需更多關於 SMS 掃描工具的資訊，請參閱 [SMS 2003 軟體更新掃描工具](https://technet.microsoft.com/zh-tw/sms/bb676786.aspx) (英文)。另請參閱[適用於 Systems Management Server 2003 的下載](https://technet.microsoft.com/zh-tw/sms/bb676766.aspx) (英文)。
...
如需更多資訊，請參閱 [System Center Configuration Manager](https://go.microsoft.com/fwlink/?linkid=21158)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2706726?ln=zh-tw">Microsoft 知識庫文件編號 2706726</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">登錄機碼驗證</td>
<td style="border:1px solid black;">安裝在所有受支援 32 位元版本 Windows XP 上的 Microsoft .NET Framework 2.0 Service Pack 2：<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">安裝在所有受支援 x64 版本 Windows XP Professional 上的 Microsoft .NET Framework 2.0 Service Pack 2：<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">安裝在所有受支援 x64 版本 Windows XP Professional 上的 Microsoft .NET Framework 4：<br />
...
-   感謝 Vitaliy Toropov 與 [Tipping Point](https://www.tippingpoint.com/) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，回報 .NET Framework 記憶體存取資訊安全風險 (CVE-2012-1855)
