...
(KB2686828)  
(英文下載更新程式)  
[Microsoft .NET Framework 2.0 Service Pack 2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=3206a637-a25e-4cc7-830c-08454ae86f0f)  
(KB2686828)  
(中文下載更新程式)  
...
(KB2686827)  
(英文下載更新程式)  
[Microsoft .NET Framework 4](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=fef24f6c-d81a-4078-af5d-dc7d0b53d145)<sup>[1]</sup>
(KB2686827)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2686833)  
(英文下載更新程式)  
[Microsoft .NET Framework 2.0 Service Pack 2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=0f4dadc9-733d-46ba-a6a8-92e7b4f49a7b)  
(KB2686833)  
(中文下載更新程式)  
[Microsoft .NET Framework 4](https://www.microsoft.com/download/details.aspx?familyid=fef24f6c-d81a-4078-af5d-dc7d0b53d145)<sup>[1]</sup>
(KB2686827)  
...
(KB2686830)  
(中文下載更新程式)  
[Microsoft .NET Framework 3.5.1](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=68d3694f-fcc9-49e6-93c2-0568b7280236)  
(KB2686830)  
(英文下載更新程式)  
[Microsoft .NET Framework 4](https://www.microsoft.com/download/details.aspx?familyid=fef24f6c-d81a-4078-af5d-dc7d0b53d145)<sup>[1]</sup>
(KB2686827)  
...
(KB2686831)  
(英文下載更新程式)  
[Microsoft .NET Framework 3.5.1](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=30b16454-cf11-49e1-9032-71c8d2b5d44b)  
(KB2686831)  
(中文下載更新程式)  
[Microsoft .NET Framework 4](https://www.microsoft.com/download/details.aspx?familyid=fef24f6c-d81a-4078-af5d-dc7d0b53d145)<sup>[1]</sup>
(KB2686827)  
...
|-------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|
| Windows Consumer Preview 上的 Microsoft .NET Framework 3.5                                                  | [Microsoft 知識庫文件編號 2686868](http://support.microsoft.com/kb/2686868?ln=zh-tw) |
| Windows Consumer Preview 上的 Microsoft .NET Framework 4.5                                                  | [Microsoft 知識庫文件編號 2686837](http://support.microsoft.com/kb/2686837?ln=zh-tw) |
| Windows Server 2008、Windows 7 和 Windows Server 2008 R2 上的 Microsoft .NET Framework 4.5 Consumer Preview | [Microsoft 知識庫文件編號 2686838](http://support.microsoft.com/kb/2686838?ln=zh-tw) |

資訊安全更新可從 [Microsoft Update](http://go.microsoft.com/fwlink/?linkid=40747) 以及 [Windows Update](http://update.microsoft.com/windowsupdate/v6/default.aspx) 取得。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-1855](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1855) (英文)。
...
SMS 2003 可使用 Microsoft Update SMS 2003 盤點工具 (ITMU) 來偵測由 [Microsoft Update](http://update.microsoft.com/microsoftupdate) 所提供，並由 [Windows Server Update Services](http://go.microsoft.com/fwlink/?linkid=50120) 支援的資訊安全更新。如需 SMS 2003 ITMU 的詳細資訊，請參閱 [Microsoft Updates SMS 2003 盤點工具](http://technet.microsoft.com/zh-tw/sms/bb676783.aspx) (英文)。如需更多關於 SMS 掃描工具的資訊，請參閱 [SMS 2003 軟體更新掃描工具](http://technet.microsoft.com/zh-tw/sms/bb676786.aspx) (英文)。另請參閱[適用於 Systems Management Server 2003 的下載](http://technet.microsoft.com/zh-tw/sms/bb676766.aspx) (英文)。
...
如需更多資訊，請參閱 [System Center Configuration Manager](http://go.microsoft.com/fwlink/?linkid=21158)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2706726?ln=zh-tw">Microsoft 知識庫文件編號 2706726</a></td>
</tr>
<tr class="odd">
...
-   感謝 Vitaliy Toropov 與 [Tipping Point](http://www.tippingpoint.com/) 的 [Zero Day Initiative](http://www.zerodayinitiative.com/) 合作，回報 .NET Framework 記憶體存取資訊安全風險 (CVE-2012-1855)
