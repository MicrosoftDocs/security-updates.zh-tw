...
**已知問題**。[Microsoft 知識庫文件編號 2783534](http://support.microsoft.com/kb/2783534?ln=zh-tw) 中記載目前已知客戶安裝此資訊安全更新後，可能會發生的問題。該文件並說明了解決這些問題的建議解決方案。
...
<td style="border:1px solid black;">
KB2753842 取代 [MS11-032](http://technet.microsoft.com/zh-tw/security/bulletin/ms11-032) 中的 KB2507618  
...
<td style="border:1px solid black;">
KB2753842 取代 [MS11-032](http://technet.microsoft.com/zh-tw/security/bulletin/ms11-032) 中的 KB2507618  
KB2779030 取代 [MS12-075](http://go.microsoft.com/fwlink/?linkid=270856) 中的 KB2761226
</td>
</tr>
<tr>
<th colspan="4" style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2753842 取代 [MS11-032](http://go.microsoft.com/fwlink/?linkid=212224) 中的 KB2507618  
KB2779030 取代 [MS12-075](http://go.microsoft.com/fwlink/?linkid=270856) 中的 KB2761226
</td>
</tr>
<tr class="alternateRow">
...
是。KB2753842 及 KB2779030 更新可供 Windows 8 Release Preview 與 Windows Server 2012 Release Candidate 使用。建議使用 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 的客戶在其系統上套用這些更新。這些更新只透過 [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) 提供。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-2556](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2556) (英文)。
...
是。此資訊安全風險已經遭到公開揭發。此資訊安全風險已被指派「一般性資訊安全風險」編號 [CVE-2012-2556](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2556) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-4786](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4786) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2753842?ln=zh-tw">Microsoft 知識庫文件編號 2753842</a> 與 <a href="http://support.microsoft.com/kb/2779030?ln=zh-tw">Microsoft 知識庫文件編號 2779030</a></td>
</tr>
<tr class="even">
...
| **檔案資訊**                                   | 請參閱 [Microsoft 知識庫文件編號 2753842](http://support.microsoft.com/kb/2753842?ln=zh-tw) 與 [Microsoft 知識庫文件編號 2779030](http://support.microsoft.com/kb/2779030?ln=zh-tw) |
...
-   感謝 [Documill](http://www.documill.com/) 的 Eetu Luodemaa 和 Joni Vähämäki 與 Chromium Security Rewards Program 合作回報 Windows 字型剖析資訊安全風險 (CVE-2012-2556)
