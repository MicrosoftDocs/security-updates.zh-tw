---
TOCTitle: 'MS12-078'
Title: 'Microsoft Security Bulletin MS12-078 - 重大'
ms:assetid: 'ms12-078'
ms:contentKeyID: 61238810
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms12-078(v=Security.10)'
---
...
此資訊安全更新可解決 Microsoft Windows 中一項公開揭露的資訊安全風險和一項未公開報告的資訊安全風險。如果使用者開啟蓄意製作的文件或是造訪內嵌 TrueType 或 OpenType 字型檔案的惡意網頁，這些資訊安全風險中較嚴重者可能會允許遠端執行程式碼。攻擊者必須引誘使用者造訪網站，通常是設法讓使用者按下電子郵件中連往攻擊者網站的連結。

對於所有受支援版本的 Microsoft Windows，此資訊安全更新的等級為「重大」(Server Core 安裝除外，其屬於「重要」等級)。如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此資訊安全更新可修正 Windows 核心模式驅動程式處理記憶體中物件的方式，進而解決這些資訊安全風險。如需更多有關此資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
**已知問題**。[Microsoft 知識庫文件編號 2783534](https://support.microsoft.com/kb/2783534?ln=zh-tw) 中記載目前已知客戶安裝此資訊安全更新後，可能會發生的問題。該文件並說明了解決這些問題的建議解決方案。
...
<td style="border:1px solid black;">
KB2753842 取代 [MS11-032](https://technet.microsoft.com/zh-tw/security/bulletin/ms11-032) 中的 KB2507618  
KB2779030 取代 [MS12-075](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-075) 中的 KB2761226
</td>
</tr>
...
<td style="border:1px solid black;">
KB2753842 取代 [MS11-032](https://technet.microsoft.com/zh-tw/security/bulletin/ms11-032) 中的 KB2507618  
KB2779030 取代 [MS12-075](https://go.microsoft.com/fwlink/?linkid=270856) 中的 KB2761226
</td>
</tr>
<tr>
<th colspan="4" style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2753842 取代 [MS11-032](https://go.microsoft.com/fwlink/?linkid=212224) 中的 KB2507618  
KB2779030 取代 [MS12-075](https://go.microsoft.com/fwlink/?linkid=270856) 中的 KB2761226
</td>
</tr>
<tr class="alternateRow">
...
<tr>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2](https://www.microsoft.com/download/details.aspx?familyid=fedee43c-0065-42bf-9714-171b5b74f099) (Server Core 安裝)  
(KB2753842)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 R2](https://www.microsoft.com/download/details.aspx?familyid=3dfa40ef-86a2-44a0-b523-f4a85c7ac82c) (Server Core 安裝)  
(KB2779030)  
(英文下載更新程式)
</td>
<td style="border:1px solid black;">
...
**此公告為何在2012年12月20日重新發行？**  
Microsoft 重新發行此公告的目的，是為了解決 KB2753842 更新的一項已知問題：套用原始更新後，OpenType 字型 (OTF) 在應用程式中無法正確呈現。客戶若已成功安裝原始 KB2753842 更新，即不受 CVE-2012-2556 中所述的資訊安全風險影響。然而，客戶仍需安裝重新發行的 KB2753842 更新，以解決 OpenType 字型不正確呈現的問題，並將受影響的二進位檔案更新為最新狀態。

**注意：** 我們並未針對 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 重新發行任何套件。Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 的支援期已過。

**何處可找到檔案資訊詳細資料？**  
關於檔案資訊詳細資料的位置，請見＜資訊安全更新部署＞一節中的參考表。

**何處可找到資訊安全更新的雜湊？**  
資訊安全更新的 SHA1 和 SHA2 雜湊可用來驗證下載之資訊安全更新套件的真實性。如需此更新的相關雜湊資訊，請參閱 [Microsoft 知識庫文件編號 2783534](https://support.microsoft.com/kb/2783534)。

**Windows 8 Release Preview與Windows Server 2012 Release Candidate是否會受此公告中指出的資訊安全風險影響？**  
是。KB2753842 及 KB2779030 更新可供 Windows 8 Release Preview 與 Windows Server 2012 Release Candidate 使用。建議使用 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 的客戶在其系統上套用這些更新。這些更新只透過 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 提供。
...
<th style="border:1px solid black;" >
OpenType 字型剖析資訊安全風險 - CVE-2012-2556
</th>
<th style="border:1px solid black;" >
TrueType 字型剖析資訊安全風險 - CVE-2012-4786
</th>
<th style="border:1px solid black;" >
彙總嚴重性等級
</th>
...
受影響元件處理蓄意製作之 OpenType 字型檔案的方式中，存在遠端執行程式碼的資訊安全風險。如果使用者開啟蓄意製作的 OpenType 字型檔案，此資訊安全風險可能會允許遠端執行程式碼。成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。接下來，攻擊者就能安裝程式，檢視、變更或刪除資料，或是建立具有完整系統管理權限的新帳戶。

若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-2556](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2556) (英文)。

#### OpenType 字型剖析資訊安全風險 - CVE-2012-2556 的緩和因素
...
#### OpenType 字型剖析資訊安全風險 - CVE-2012-2556 的因應措施
...
#### OpenType 字型剖析資訊安全風險 - CVE-2012-2556 的常見問題集

**此資訊安全風險的範圍為何？**  
這是遠端執行程式碼的資訊安全風險。

**造成此資訊安全風險的原因為何？**  
造成此資訊安全風險的原因，是由於 OpenType 字型 (OTF) 驅動程式處理記憶體中物件的方式不適當。
...
是。此資訊安全風險已經遭到公開揭發。此資訊安全風險已被指派「一般性資訊安全風險」編號 [CVE-2012-2556](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2556) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-4786](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4786) (英文)。

#### TrueType 字型剖析資訊安全風險 - CVE-2012-4786 的緩和因素
...
#### TrueType 字型剖析資訊安全風險 - CVE-2012-4786 的因應措施
...
#### TrueType 字型剖析資訊安全風險 - CVE-2012-4786 的常見問題集
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或下列資料夾中的 Spuninst.exe 公用程式： %Windir%\$NTUninstallKB2753842-v2$\Spuninst<br />
%Windir%\$NTUninstallKB2779030$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2753842?ln=zh-tw">Microsoft 知識庫文件編號 2753842</a> 與 <a href="https://support.microsoft.com/kb/2779030?ln=zh-tw">Microsoft 知識庫文件編號 2779030</a></td>
</tr>
<tr class="even">
...
|                                                |                                                                                                                                                                                     |  
|------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|  
| **未來將包含於Service Pack中的內容** | 此問題的更新程式將包含在以後的 Service Pack 或更新彙總套件中。                                                                                                                      |  
| **部署**                                       |                                                                                                                                                                                     |  
|                                                | 更新僅透過 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 提供。                                                                                                    |  
| **重新開機需求**                               |                                                                                                                                                                                     |  
| 需要重新開機？                                 | 是，套用此資訊安全更新之後，您必須重新啟動系統。                                                                                                                                    |  
| **移除資訊**                                   | 請依序按一下 \[控制台\]、\[系統及安全性\] 以及 \[Windows Update\] 下的 \[已安裝的更新\]，然後從更新清單中加以選取。                                                                 |  
| **檔案資訊**                                   | 請參閱 [Microsoft 知識庫文件編號 2753842](https://support.microsoft.com/kb/2753842?ln=zh-tw) 與 [Microsoft 知識庫文件編號 2779030](https://support.microsoft.com/kb/2779030?ln=zh-tw) |
...
-   感謝 [Documill](https://www.documill.com/) 的 Eetu Luodemaa 和 Joni Vähämäki 與 Chromium Security Rewards Program 合作回報 Windows 字型剖析資訊安全風險 (CVE-2012-2556)
...
-   V1.1 (2012 年 12 月 14 日)： 在＜提要＞的＜已知問題＞下新增 Microsoft 知識庫文件編號 2783534 的連結。  
-   V2.0 (2013 年 1 月 2 日)： 重新發行 KB2753842 更新，以解決原始更新程式安裝後 OpenType 字型無法正確呈現的問題。已成功安裝原始 KB2753842 更新的客戶必須安裝重新發行的更新。
