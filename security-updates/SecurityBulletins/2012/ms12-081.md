...
**已知問題。**[Microsoft 知識庫文件編號 2758857](http://support.microsoft.com/kb/2758857) 中記載目前已知客戶在安裝此資訊安全更新時可能會發生的問題。該文件並說明了解決這些問題的建議解決方案。
...
<td style="border:1px solid black;">
KB2758857 取代 [MS07-035](http://go.microsoft.com/fwlink/?linkid=91397) 中的 KB935839
</td>
</tr>
<tr>
<th colspan="4" style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2758857 取代[資訊安全摘要報告 2269637](http://technet.microsoft.com/security/advisory/2269637) 中的 KB2533623
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2758857 取代 [MS11-063](http://go.microsoft.com/fwlink/?linkid=221864) 中的 KB2567680
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
是。KB2758857 更新可供 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 使用。建議使用 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 的客戶在其系統上套用這些更新。這些更新只透過 [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) 提供。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-4774](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4774) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2758857">Microsoft 知識庫文件編號 2758857</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
請參閱 [Microsoft 知識庫文件編號 2758857](http://support.microsoft.com/kb/2758857)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   感謝 [IOActive](http://ioactive.co.uk/) 的 Lucas Apa 回報 Windows 檔案名稱剖析資訊安全風險 (CVE-2012-4774)
