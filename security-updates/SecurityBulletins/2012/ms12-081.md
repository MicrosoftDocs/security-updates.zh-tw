---
TOCTitle: 'MS12-081'
Title: 'Microsoft Security Bulletin MS12-081 - 重大'
ms:assetid: 'ms12-081'
ms:contentKeyID: 61238813
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms12-081(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-081 - 重大
===========================================

Windows 檔案處理元件中的資訊安全風險可能會允許遠端執行程式碼 (2758857)
----------------------------------------------------------------------

發行: 2012年12月11日 | 更新: 2013年5月22日
...
此資訊安全更新可解決 Microsoft Windows 中一項未公開報告的資訊安全風險。如果使用者瀏覽的資料夾包含具備蓄意製作之名稱的檔案或子資料夾，此資訊安全風險可能會允許遠端執行程式碼。成功利用此資訊安全風險的攻擊者可以取得與目前使用者相同的使用者權限。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

對於所有受支援版本的 Windows XP、Windows Server 2003、Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2，此資訊安全更新的等級為「重大」。Windows 8、Windows Server 2012 以及 Window RT 不受此資訊安全風險影響。如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此資訊安全更新可修改 Windows 處理包含蓄意製作之名稱的檔案的方式，藉此解決此資訊安全風險。如需更多有關此資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
**已知問題。**[Microsoft 知識庫文件編號 2758857](https://support.microsoft.com/kb/2758857) 中記載目前已知客戶在安裝此資訊安全更新時可能會發生的問題。該文件並說明了解決這些問題的建議解決方案。
...
<td style="border:1px solid black;">
KB2758857 取代 [MS07-035](https://go.microsoft.com/fwlink/?linkid=91397) 中的 KB935839
</td>
</tr>
<tr>
<th colspan="4" style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2758857 取代[資訊安全摘要報告 2269637](https://technet.microsoft.com/security/advisory/2269637) 中的 KB2533623
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2758857 取代 [MS11-063](https://go.microsoft.com/fwlink/?linkid=221864) 中的 KB2567680
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
**何處可找到資訊安全更新的雜湊？**  
資訊安全更新的 SHA1 和 SHA2 雜湊可用來驗證下載之資訊安全更新套件的真實性。如需此更新的相關雜湊資訊，請參閱 [Microsoft 知識庫文件編號 2758857](https://support.microsoft.com/kb/2758857)。

**Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 是否會受此公告中指出的資訊安全風險影響？**  
是。KB2758857 更新可供 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 使用。建議使用 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 的客戶在其系統上套用這些更新。這些更新只透過 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 提供。
...
<th style="border:1px solid black;" >
Windows 檔案名稱剖析資訊安全風險 - CVE-2012-4774
</th>
<th style="border:1px solid black;" >
彙總嚴重性等級
</th>
...
在 Microsoft Windows 剖析檔案名稱的方式中，存在遠端執行程式碼的資訊安全風險。此資訊安全風險可能會損毀記憶體，使攻擊者有機會透過登入目前使用者的權限層級執行任意程式碼。

若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-4774](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4774) (英文)。

#### Windows 檔案名稱剖析資訊安全風險 - CVE-2012-4774 的緩和因素
...
#### Windows 檔案名稱剖析資訊安全風險 - CVE-2012-4774 的因應措施

Microsoft 尚未找到此項資訊安全風險的任何因應措施。

#### Windows 檔案名稱剖析資訊安全風險 - CVE-2012-4774 的常見問題集

**此資訊安全風險的範圍為何？**  
這是遠端執行程式碼的資訊安全風險。

**造成此資訊安全風險的原因為何？**  
造成此資訊安全風險的原因，是由於 Windows 無法正確處理蓄意製作的檔案或子資料夾名稱，進而允許資料複製到未正確配置的記憶體。
...
**攻擊者如何利用此資訊安全風險？**  
攻擊者可引誘使用者瀏覽至蓄意製作之名稱的檔案或子資料夾所在的檔案系統，藉此利用此資訊安全風險。

在網路攻擊案例中，攻擊者可在網路共用、UNC 共用或 WebDAV 位置上主控蓄意製作之檔案名稱的檔案，然後引誘使用者瀏覽至該檔案。

在電子郵件攻擊案例中，攻擊者可將蓄意製作的檔案或子資料夾當作附件傳送並引誘使用者瀏覽至包含該附件的檔案系統，藉此利用此資訊安全風險。

在網頁式攻擊案例中，攻擊者必須架設內嵌蓄意製作名稱之檔案的網站。攻擊者無法強制使用者造訪主控檔案的網站。而是引誘使用者自行前往。一般的做法是設法讓使用者按一下電子郵件中或 Instant Messenger 訊息中連往攻擊者網站的連結。

**因為此資訊安全風險而承受風險的主要系統有哪些？**  
工作站和終端伺服器的風險最高。若系統管理員允許使用者登入伺服器並執行程式，則伺服器可能遭受更大的風險。然而，最佳實務強烈建議您制止這種行為。

**更新的作用何在？**  
此資訊安全更新可修改 Windows 處理包含蓄意製作之名稱的檔案的方式，藉此解決此資訊安全風險。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 項目，或是 %Windir%\$NTUninstallKB2758857$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2758857">Microsoft 知識庫文件編號 2758857</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
使用 \[控制台\] 中的 \[新增或移除程式\] 項目，或是 %Windir%\\$NTUninstallKB2758857$\\Spuninst 資料夾中的 Spuninst.exe 公用程式
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
請參閱 [Microsoft 知識庫文件編號 2758857](https://support.microsoft.com/kb/2758857)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   感謝 [IOActive](https://ioactive.co.uk/) 的 Lucas Apa 回報 Windows 檔案名稱剖析資訊安全風險 (CVE-2012-4774)
...
-   V1.1 (2013 年 5 月 22 日)： 在＜提要＞的＜已知問題＞下新增 Microsoft 知識庫文件編號 2758857 的連結。
