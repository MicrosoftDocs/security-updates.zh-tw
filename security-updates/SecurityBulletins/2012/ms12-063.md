...
本資訊安全更新也能解決 [Microsoft 資訊安全摘要報告 2757760](https://technet.microsoft.com/security/advisory/2757760) 中首先提出的資訊安全風險。
...
<td style="border:1px solid black;">
KB2744842 取代 [MS12-052](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-052) 中的 KB2722913
</td>
</tr>
...
(KB2744842)  
(英文更新連結程式)  
[Internet Explorer 8](https://www.microsoft.com/downloads/dzh-tw/etails.aspx?familyid=d46ec8ea-b8c8-42d9-a201-f36eb97b91b8)   
(KB2744842)  
(中文更新連結程式)
</td>
<td style="border:1px solid black;">
...
實作了 [Microsoft 資訊安全摘要報告 2757760](https://technet.microsoft.com/security/advisory/2757760) 中的 Microsoft Fix it 解決方案「在 Internet Explorer 中透過 ExecCommand 防止記憶體損毀」的客戶，在套用此更新之前不需要先復原 Microsoft Fix it 解決方案。

何處可找到檔案資訊詳細資料？  
關於檔案資訊詳細資料的位置，請見＜資訊安全更新部署＞一節中的參考表。

何處 可找到資訊安全更新的雜湊？  
資訊安全更新的 SHA1 和 SHA2 雜湊可用來驗證下載之資訊安全更新套件的真實性。如需此更新的相關雜湊資訊，請參閱 [Microsoft 知識庫文件編號 2744842](https://support.microsoft.com/kb/2744842?ln=zh-tw)。
...
下列嚴重性等級是假設資訊安全風險可能造成的最嚴重影響而評定。在本資訊安全公告發行的 30 天內，如需資訊安全風險之易遭利用性與嚴重性等級和資訊安全影響之間對應關係的資訊，請參閱 [9 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms12-sep)中的＜資訊安全風險索引＞。如需更多資訊，請參閱 [Microsoft 資訊安全風險入侵指數](https://technet.microsoft.com/zh-tw/security/cc998259.aspx)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-1529](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1529)。
...
-   依照預設，Windows Server 2003、Windows Server 2008 和 Windows Server 2008 R2 上的 Internet Explorer 會以稱為[增強式資訊安全設定](https://technet.microsoft.com/library/dd883248)的受限制模式執行。此模式可緩和這項資訊安全風險。如需更多資訊，請參閱此資訊安全風險＜常見問題集＞關於 Internet Explorer 增強式資訊安全設定的部份。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-2546](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2546)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-2548](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2548)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-2557](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2557)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-4969](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4969)。
...
-   套用 Microsoft Fix it 解決方案「 在 Internet Explorer 中透過 ***ExecCommand*** 防止記憶體損毀」可防止此資訊安全風險遭到利用
    ...
    請參閱 [Microsoft 知識庫文件編號 2744842](https://support.microsoft.com/kb/2744842?ln=zh-tw)，以運用自動化 Microsoft Fix It 解決方案來啟用或停用此因應措施。
...
-   部署 Enhanced Mitigation Experience Toolkit
    ...
    目前，EMET 提供的支援有限，且僅提供英文版。如需更多資訊，請參閱 [Microsoft 知識庫文件編號 2458544](https://support.microsoft.com/kb/2458544?ln=zh-tw)。
    ...
    注意：關於群組原則的詳細資訊，請參閱[群組原則集合](https://technet.microsoft.com/zh-tw/library/cc784165(ws.10).aspx) (英文)。
...
什麼是位址空間隨機載入 (ASLR)？  
實作「位址空間隨機載入」(ASLR) 的系統會將通常可預測的函式進入點以偽隨機方式配置在記憶體中。Windows ASLR 會將系統 DLL 和可執行檔的基底重新放入記憶體中 256 個隨機位置其中之一。因此，將位址寫入程式碼的攻擊者可能猜 256 次才會「猜對」一次。如需更多關於 ASLR 的資訊，請造訪 TechNet 雜誌文章[深入探索 Windows Vista 核心： 第 3 篇](https://technet.microsoft.com/zh-tw/magazine/2007.04.vistakernel.aspx?pr=blog)。

更新的作用何在？  
此更新會修改 Internet Explorer 處理記憶體中物件的方式，藉此解決此資訊安全風險。

本資訊安全公告發行時，這項資訊安全風險是否已揭發出來？  
是。這項資訊安全風險已經遭到公開揭發。這項資訊安全風險已被指派「一般性資訊安全風險」編號 [CVE-2012-4969](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4969)。此資訊安全風險最初是在 [Microsoft 資訊安全摘要報告 2757760](https://technet.microsoft.com/security/advisory/2757760) 中提出。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2744842?ln=zh-tw">Microsoft 知識庫文件編號 2744842</a></td>
</tr>
<tr class="even">
...
-   感謝匿名的研究人員與 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作回報 OnMove 釋放後使用資訊安全風險 (CVE-2012-1529)  
-   感謝 [Rosario Valotta](https://sites.google.com/site/tentacoloviola) 回報事件接聽程式釋放後使用資訊安全風險 (CVE-2012-2546)  
-   感謝 [Harmony Security](https://www.harmonysecurity.com/) 的 Stephen Fewer 與 [TippingPoint](https://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作回報配置釋放後使用資訊安全風險 (CVE-2012-2548)  
-   感謝匿名的研究人員與 [TippingPoint's](https://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作回報 cloneNode 釋放後使用資訊安全風險 (CVE-2012-2557)  
-   感謝匿名的研究人員與 [TippingPoint's](https://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作回報 execCommand 釋放後使用資訊安全風險 (CVE-2012-4969)  
-   感謝 [Mitre](https://www.mitre.org/) 協助我們解決 execCommand 釋放後使用資訊安全風險 (CVE-2012-4969)
