---
TOCTitle: 'MS12-082'
Title: 'Microsoft Security Bulletin MS12-082 - 重要'
ms:assetid: 'ms12-082'
ms:contentKeyID: 61238814
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms12-082(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-082 - 重要
===========================================

DirectPlay 中的資訊安全風險可能會允許遠端執行程式碼 (2770660)
-------------------------------------------------------------

發行: 2012年12月11日 | 更新: 2013年7月11日
...
此資訊安全更新可解決 Microsoft Windows 中一項未公開報告的資訊安全風險。如果攻擊者引誘使用者檢視含有內嵌內容之蓄意製作的 Office 文件，此資訊安全風險可能會允許遠端執行程式碼。成功利用此資訊安全風險的攻擊者可以取得與目前使用者相同的使用者權限。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

對於所有受支援版本的 Microsoft Windows (Windows RT 除外)，此資訊安全更新的等級為「重要」。如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此資訊安全更新藉由修正該 DirectPlay 處理蓄意製作之內容的方式，來解決此資訊安全風險。如需更多有關此資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
若是系統管理員和企業安裝，或是想要手動安裝此資訊安全更新的使用者，Microsoft 建議客戶使用更新管理軟體，立即套用更新，或使用 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 服務檢查更新。另請參閱本公告下文的＜偵測與部署工具及指南＞一節。
...
**何處可找到資訊安全更新的雜湊？**  
資訊安全更新的 SHA1 和 SHA2 雜湊可用來驗證下載之資訊安全更新套件的真實性。如需此更新的相關雜湊資訊，請參閱 [Microsoft 知識庫文件編號 2770660](https://support.microsoft.com/kb/2770660)。
...
<th style="border:1px solid black;" >
DirectPlay 堆積溢位資訊安全風險 - CVE-2012-1537
</th>
<th style="border:1px solid black;" >
彙總嚴重性等級
</th>
...
DirectPlay 處理蓄意製作內容的方式中，存在遠端執行程式碼的資訊安全風險。如果攻擊者引誘使用者檢視含有內嵌內容之蓄意製作的 Office 文件，此資訊安全風險可能會允許遠端執行程式碼。成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-1537](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1537) (英文)。

#### DirectPlay 堆積溢位資訊安全風險 - CVE-2012-1537 的緩和因素

緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。下列緩和因素可能對您的狀況有所助益：

-   成功利用此資訊安全風險的攻擊者可以取得與目前使用者相同的使用者權限。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
-   蓄意製作的 Office 文件可作為電子郵件的附件傳送，但攻擊者必須說服使用者開啟附件，才能利用資訊安全風險。
-   依照預設，DirectPlay ActiveX 控制項不包含在 Internet Explorer 中 ActiveX 控制項的預設允許清單內。唯有使用「選擇性使用 ActiveX」功能，明確核淮此控制項的客戶，才可能因嘗試利用此資訊安全風險而承受風險。然而，如果客戶在舊版的 Internet Explorer 中使用了此 ActiveX 控制項，即使客戶未明確核准其使用 ActiveX 加入宣告功能，此 ActiveX 控制項仍會在 Internet Explorer 中啟用。

#### DirectPlay 堆積溢位資訊安全風險 - CVE-2012-1537 的因應措施

因應措施指的是無法徹底修正資訊安全風險，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：

-   **使用Microsoft Office檔案封鎖原則，來封鎖開啟來自於未知或不信任來源與位置的Word 2003 (或更早版本)文件。**

    Microsoft Office 檔案封鎖原則可用來封鎖 Microsoft Word、Microsoft Excel 和 Microsoft PowerPoint 開啟特定的檔案格式類型。

    **Microsoft Word 2003與Microsoft Word 2007**  
    ...
    **注意：** 為將 'FileOpenBlock' 與 Microsoft Office 2003 搭配使用，必須套用所有最新的 Microsoft Office 2003 資訊安全更新。為將 'FileOpenBlock' 與 Office 2007 搭配使用，必須套用所有最新的 Office 2007 資訊安全更新。
    ...
    <table style="border:1px solid black;">
    <caption>Microsoft Office 軟體</caption>
    <tbody>
    <tr class="odd">
    ...
    **Microsoft Office 2010**
    ...
    5.  確保已為下列檔案類型選取 \[開啟\] 核取方塊：
        於 Microsoft Word 2010 中：
        - Word 2003 文件和範本
    6.  在 \[選取檔案類型的開啟行為\] 底下，選取 \[不開啟選取的檔案類型\] 或 \[以受保護的檢視開啟選取的檔案類型\]。不論選擇哪一個選項，都能封鎖資訊安全風險程式碼的攻擊模式。
    7.  按一下 \[確定\] 套用 \[檔案封鎖設定\]。您也可以使用群組原則套用檔案封鎖。如需更多資訊，請參閱 TechNet 文章：
    ...
    **如何復原因應措施。** 
    ...
    針對 Microsoft Word 2003 和 Microsoft Word 2007，請使用下列登錄指令碼來復原設定檔案封鎖原則時所使用的設定：
...
-   **對於來自不受信任的來源或在非預期情況下從信任來源收到的Office檔案，請勿隨意開啟**

    對於來自於不受信任的來源或在非預期情況下從信任來源收到的 Microsoft Office 檔案，請勿輕易開啟或儲存。當使用者開啟蓄意製作的檔案時，即可能遭受利用此資訊安全風險的攻擊。

#### DirectPlay 堆積溢位資訊安全風險 - CVE-2012-1537 的常見問題集

**此資訊安全風險的範圍為何？**  
這是遠端執行程式碼的資訊安全風險。

**造成此資訊安全風險的原因為何？**  
此資訊安全風險是由於 DirectPlay 無法正確處理蓄意製作的 Office 文件所致。

**什麼元件會受到此資訊安全風險的影響？**  
受到此資訊安全風險影響的元件為 Microsoft DirectX (所有受支援版本 Windows XP 版本上的 Microsoft DirectX (DirectX 9.0)、所有受支援版本 Windows Server 2003 上的 DirectX 10.1、Windows Vista 與 Windows Server 2008、所有受支援版本 Windows 7 和 Windows Server 2008 R2 上的 DirectX 11.0，以及所有受支援版本 Windows 8 和 Windows Server 2012 上的 DirectX11.1)。

**什麼是DirectPlay？**  
DirectPlay 是一種網路通訊協定，隨附於 Microsoft DirectX，協助遊戲開發人員建立多人的網路遊戲，而不必執行複雜的網路通訊協定。
...
**攻擊者如何利用此資訊安全風險？**  
在電子郵件攻擊案例中，攻擊者可能會傳送含有內嵌內容之蓄意製作的 Office 文件給使用者，然後引誘使用者開啟該檔案，來利用此資訊安全風險。

**因為此資訊安全風險而承受風險的主要系統有哪些？**  
工作站和終端伺服器的風險最高。如果不應擁有系統管理權限的使用者被授予登入伺服器並執行程式的能力時，伺服器會面臨更大的風險。然而，最佳實務強烈建議您制止這種行為。

**更新的作用何在？**  
此更新藉由修正該 DirectPlay 處理蓄意製作之內容的方式，來解決此資訊安全風險。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 項目，或是 %Windir%\$NTUninstallKB2770660$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2770660">Microsoft 知識庫文件編號 2770660</a></td>
</tr>
<tr class="even">
...
-   感謝 [Aniway](mailto:aniway.anyway@gmail.com) 與 [VeriSign iDefense Labs合作](https://labs.idefense.com/)回報 DirectPlay 堆積溢位資訊安全風險 (CVE-2012-1537)
...
-   V1.1 (2012 年 12 月 12 日)： 更正所有受影響軟體的重新開機需求項目。這只是資訊的變更。資訊安全更新檔案沒有變更。  
-   V1.2 (2013 年 7 月 11 日)： 修訂公告，宣佈一項 2770660 更新的 Windows Vista 套件偵測變更，以修正 Windows Update 在重新提供更新程式方面的問題。此變更僅屬偵測變更。已成功更新系統的客戶不必採取任何行動。
