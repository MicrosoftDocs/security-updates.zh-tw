...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------|----------------|------------------|
| [適用於 32 位元系統的 Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3f6f89b3-3bc8-4325-b8d8-9a5a398b99c6)\*\*                                                    | 遠端執行程式碼   | 重要           | 無               |
| [適用於 x64 型系統的 Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=35e6bd04-594f-42ef-97f8-abcf578b4f10)\*\*                                                     | 遠端執行程式碼   | 重要           | 無               |
| [適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d1d51b26-2d01-42a9-9bb1-9fb82c1fb914)                                                     | 遠端執行程式碼   | 重要           | 無               |
| [適用於 x64 型系統的 Windows Server 2008 R2 和適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=8c51e09b-51c3-4860-836e-6bcffde75f04)\*\*     | 遠端執行程式碼   | 重要           | 無               |
| [適用於 Itanium 型系統的 Windows Server 2008 R2 和適用於 Itanium 型系統的 Windows Server 2008 R2 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=fba58a1b-9d9f-4a10-b1df-08a0ebfa2358) | 遠端執行程式碼   | 重要           | 無               |
...
是的，此更新所解決的 Color Control Panel 不安全程式庫載入資訊安全風險 (CVE-2010-5082)，與 [Microsoft 資訊安全摘要報告 2269637](http://technet.microsoft.com/security/advisory/2269637) 中說明的資訊安全風險類別相關，該資訊安全風險會影響應用程式載入外部程式庫的方式。此資訊安全更新可解決此類型資訊安全風險的一個特定執行個體。
...
下列嚴重性等級是假設資訊安全風險可能造成的最嚴重影響而評定。在本安全性公告發行的 30 天內，如需資訊安全風險之易遭利用性與嚴重性等級和資訊安全影響之間對應關係的資訊，請參閱 [2 月份公告摘要](http://technet.microsoft.com/security/bulletin/ms12-feb)中的＜資訊安全風險入侵指數＞。如需更多資訊，請參閱 [Microsoft 資訊安全風險入侵指數](http://technet.microsoft.com/zh-tw/security/cc998259.aspx)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2010-5082](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-5082) (英文)。
...
-   **在 Windows Server 2008 和 Windows Server 2008 R2 上安裝「桌面體驗」**
    ...
    如需其他資訊，包括安裝與移除「桌面體驗」的說明，請參閱 TechNet 文章：[桌面體驗概觀](http://technet.microsoft.com/zh-tw/library/cc772567.aspx)。
...
有許多桌面功能 (如 Color Control Panel) 依預設不會安裝在 Windows Server 2008 上。但是，您可以在 Windows Server 2008 上安裝「桌面體驗」功能來一次安裝所有桌面功能。如需詳細資訊，請參閱 TechNet 文章：[桌面體驗概觀](http://technet.microsoft.com/zh-tw/library/cc772567.aspx)。
...
是。這項資訊安全風險已經遭到公開揭發。這項資訊安全風險已被指派「一般性資訊安全風險」編號 [CVE-2010-5082](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-5082)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2643719">Microsoft 知識庫文件編號 2643719</a></td>
</tr>
<tr class="odd">
