...
-   感謝 spa-s3c.blogspot.com 的 Jose A.Vazquez 與 [VeriSign iDefense Labs](http://labs.idefense.com/) 合作，回報快取物件遠端執行程式碼資訊安全風險 (CVE-2012-1522)  
-   感謝 Omair 與 [VeriSign iDefense Labs](http://labs.idefense.com/) 合作，回報屬性移除遠端執行程式碼資訊安全風險 (CVE-2012-1524)
