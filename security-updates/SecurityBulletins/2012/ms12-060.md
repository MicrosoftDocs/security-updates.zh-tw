...
**我已成功安裝原本的** **KB2687323** **更新。我是否應該套用** **2012** **年** **12** **月** **11** **日重新發行的更新套件** **(KB2726929)** **？** 
...
**我正在使用** **SQL Server 2005** **或** **SQL Server 2008，我的環境適用於哪些更新？  **
...
**需要更新** **Microsoft Office 2003、Microsoft Office 2007** **和** **Microsoft Office 2010** **的哪些元件，才能減緩此公告中指出的資訊安全風險？  
...
我**開發的軟體**包含**可轉散發**的 **ActiveX** **控制項。我該怎麼做？**
...
-   **避免在** **Internet Explorer** **中執行受影響的** **ActiveX** **控制項**
...
**我正在使用** **SQL Server 2005** **或** **SQL Server 2008，我的環境適用於哪些修補程式？  **
...
|-------------------------------------------------------|-------------------------------------------------------------------------------------|  
| **/u**                                                | 解除安裝                                                                            |  
| **/s** **或** **/passive**                            | 被動式安裝。僅顯示進度列                                                            |  
| **/quiet**                                            | 無訊息安裝。                                                                        |  
| **/norestart**                                        | 隱藏重新啟動                                                                        |  
| **/forcerestart**                                     | 安裝之後一律重新開機。                                                              |  
| **/promptrestart**                                    | 重新開機之前先提示。此選項不能與 /quiet 選項一起使用。                              |  
| **/warnrestart** **或** **/warnrestart:&lt;秒數&gt;** | 警告使用者將在30秒後重新啟動系統。可以透過命令列更改預設秒數 (例如 /warnrestart:60) |  
