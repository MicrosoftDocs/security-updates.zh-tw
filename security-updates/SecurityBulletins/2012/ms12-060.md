...
**已知問題。** [Microsoft 知識庫文件編號 2720573](https://support.microsoft.com/kb/2720573?ln=zh-tw) 中記載目前已知客戶安裝此資訊安全更新後，可能會發生的問題。該文件並說明了解決這些問題的建議解決方案。目前已知問題和建議解決方案僅適用於此軟體的特定版本，本文會提供詳細文章的連結。
...
<td style="border:1px solid black;">
KB2687323 或 KB2726929 取代 [MS12-027](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-027) 中的 KB2597112
</td>
</tr>
...
<td style="border:1px solid black;">
KB2687441 取代 [MS12-027](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-027) 中的 KB2598041
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2597986 取代[MS12-027](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-027) 中的 KB2598039
</td>
</tr>
</table>
...
<td style="border:1px solid black;">
KB983812 取代 [MS12-027](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-027) 中的 KB983808  
KB983811 取代 [MS12-027](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-027) 中的 KB983809
</td>
</tr>
</table>
...
<td style="border:1px solid black;">
KB983813 取代 [MS12-027](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-027)中的 KB983807
</td>
</tr>
<tr>
<th colspan="4" style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2716389 取代 [MS12-027](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-027) 中的 KB2645025
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2716390 取代 [MS12-027](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-027) 中的 KB2658677
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2716392 取代 [MS12-027](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-027) 中的 KB2655547
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2716393 取代 [MS12-027](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-027) 中的 KB2658676
</td>
</tr>
<tr>
<th colspan="4" style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2708940 取代 [MS12-027](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-027) 中的 KB2647488
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2708941 取代 [MS12-027](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-027) 中的 KB2647490
</td>
</tr>
<tr>
<th colspan="4" style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2708437 取代 [MS12-027](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-027) 中的 KB2641426
</td>
</tr>
</table>
...
Microsoft 產生的特定數位憑證沒有適當的時間戳記屬性，為解決此問題，Microsoft 重新發行此公告，針對所有受影響變體之 Microsoft Office 2003、Microsoft Office 2003 Web 元件及 Microsoft SQL Server 2005 的 Windows 一般控制項，以 KB2726929 更新取代 KB2687323 更新。如需詳細資訊，請參閱 [Microsoft 資訊安全摘要報告 2749655](https://technet.microsoft.com/security/advisory/2749655)。
...
轉散發 ActiveX 控制項的開發人員必須下載本公告所提供的更新，以確保隨應用程式安裝的 ActiveX 控制項為更新版本。如需使用轉散發元件的最佳作法資訊，請參閱 [Microsoft 知識庫文件編號 835322](https://support.microsoft.com/kb/835322?ln=zh-tw)，以及[隔離的應用程式和並存組件](https://msdn.microsoft.com/library/dd408052.aspx) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-1856](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1856) (英文)。
...
-   依照預設，Windows Server 2003、Windows Server 2008 和 Windows Server 2008 R2 上的 Internet Explorer 會以稱為[增強式資訊安全設定](https://technet.microsoft.com/zh-tw/library/dd883248.aspx)的受限制模式執行。此模式可緩和此資訊安全風險。如需更多資訊，請參閱此資訊安全更新＜常見問題集＞關於 Internet Explorer 增強式資訊安全設定的部分。
...
-   **避免在Internet Explorer中執行受影響的ActiveX控制項**
    ...
    **警告：** 如果使用「登錄編輯程式」的方式錯誤，可能造成嚴重問題，以致於您必須重新安裝作業系統。Microsoft 無法保證您可以解決因為不正確使用 \[登錄編輯程式\] 所造成的問題。請自行承擔使用 \[登錄編輯程式\] 的風險。
    ...
    1.  建立名稱為 Disable\_TabStrip.reg 的文字檔，並加入下列內容：

        ```
            建立名稱為 Disable_TabStrip.reg 的文字檔，並加入下列內容：
...
-   **使用Microsoft Office檔案封鎖原則，來封鎖開啟來自於未知或不信任來源與位置的RTF文件**
    ...
    **For Microsoft Office 2003和Microsoft Office 2007**
    ...
    下列登錄指令碼可儲存於登錄項目 (.reg) 檔案，用來設定檔案封鎖原則。如需瞭解如何使用登錄指令碼，請參閱 [Microsoft 知識庫文件編號 310516](https://support.microsoft.com/kb/310516?ln=zh-tw)。
...
| **重新開機需求**                               |                                                                                                                                                                                                                                                                                                                                                                                           |
| 需要重新開機？                                 | 在某些情況下，此更新程式不需要重新開機。如果需要的檔案正在使用中，更新程式會要求重新開機。在此情況下，系統會出現訊息提示您重新開機。若要減少重新開機的可能性，請在安裝資訊安全更新之前，停止所有受影響的服務，並關閉所有可能使用受影響檔案的應用程式。如需系統為何會提示您重新開機的詳細資訊，請參閱 [Microsoft 知識庫文件編號 887012](https://support.microsoft.com/kb/887012?ln=zh-tw)。 |
| HotPatching                                    | 不適用                                                                                                                                                                                                                                                                                                                                                                                    |
| **移除資訊**                                   | 您無法移除此更新程式。                                                                                                                                                                                                                                                                                                                                                                    |
| **檔案資訊**                                   | 請參閱 [Microsoft 知識庫文件編號 2726929](https://support.microsoft.com/kb/2726929?ln=zh-tw)                                                                                                                                                                                                                                                                                               |
| **登錄機碼驗證**                               | 不適用                                                                                                                                                                                                                                                                                                                                                                                    |
...
| HotPatching                                    | 不適用                                                                                                                                                                                                                                                                                                                                                                                    |
| **移除資訊**                                   | 您無法移除此更新程式。                                                                                                                                                                                                                                                                                                                                                                    |
| **檔案資訊**                                   | 請參閱 [Microsoft 知識庫文件編號 2687441](https://support.microsoft.com/kb/2687441?ln=zh-tw)                                                                                                                                                                                                                                                                                               |
| **登錄機碼驗證**                               | 不適用                                                                                                                                                                                                                                                                                                                                                                                    |
...
| HotPatching                                    | 不適用                                                                                                                                                                                                                                                                                                                                                                                    |
| **移除資訊**                                   | 您無法移除此更新程式。                                                                                                                                                                                                                                                                                                                                                                    |
| **檔案資訊**                                   | 請參閱 [Microsoft 知識庫文件編號 2597986](https://support.microsoft.com/kb/2597986?ln=zh-tw)                                                                                                                                                                                                                                                                                               |
| **登錄機碼驗證**                               | 不適用                                                                                                                                                                                                                                                                                                                                                                                    |
...
<td style="border:1px solid black;">適用於 SQL Server 2000 Analysis Services Service Pack 4：<br />
請參閱 <a href="https://support.microsoft.com/kb/983813?ln=zh-tw">Microsoft 知識庫文件編號 983813</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於 Microsoft SQL Server 2000 Service Pack 4 的 GDR 更新：<br />
請參閱 <a href="https://support.microsoft.com/kb/983812?ln=zh-tw">Microsoft 知識庫文件編號 983812</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於 Microsoft SQL Server 2000 Service Pack 4 的 QFE 更新：<br />
請參閱 <a href="https://support.microsoft.com/kb/983811?ln=zh-tw">Microsoft 知識庫文件編號 983811</a></td>
</tr>
</tbody>
</table>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2716389?ln=zh-tw">Microsoft 知識庫文件編號 2716389</a></td>
</tr>
<tr class="even">
...
-   **Microsoft Baseline Security Analyzer**
    ...
    您可以使用 Microsoft Baseline Security Analyzer (MBSA) 工具，以確認受影響系統上是否已經套用資訊安全更新程式。這項工具讓系統管理員能夠掃描本機和遠端系統，找出遺漏的資訊安全更新以及常見的錯誤資訊安全設定。如需關於 MBSA 的詳細資訊，請造訪 [Microsoft Baseline Security Analyzer 網站](https://technet.microsoft.com/zh-tw/security/cc184924.aspx) (英文)。
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2716390?ln=zh-tw">Microsoft 知識庫文件編號 2716390</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">金鑰檔案 (mscomctl.ocx) 的版本用途是確認更新的安裝</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2716392?ln=zh-tw">Microsoft 知識庫文件編號 2716392</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">金鑰檔案 (mscomctl.ocx) 的版本用途是確認更新的安裝</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2716393?ln=zh-tw">Microsoft 知識庫文件編號 2716393</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">金鑰檔案 (mscomctl.ocx) 的版本用途是確認更新的安裝</td>
...
| **檔案資訊**                                   | 請參閱 [Microsoft 知識庫文件編號 2711207](https://support.microsoft.com/kb/2711207?ln=zh-tw)                                                                       |  
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2708940?ln=zh-tw">Microsoft 知識庫文件編號 2708940</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2708941?ln=zh-tw">Microsoft 知識庫文件編號 2708941</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2708437?ln=zh-tw">Microsoft 知識庫文件編號 2708437</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
...
**注意**：您可以在同一個命令中合併使用這些參數。為符合回溯相容性，資訊安全更新程式也支援舊版安裝程式使用的安裝參數中的許多參數。有關支援的安裝參數的其他資訊，請參閱[這篇 Microsoft MSDN 文章](https://msdn.microsoft.com/zh-tw/library/aa372024(vs.85).aspx)。
