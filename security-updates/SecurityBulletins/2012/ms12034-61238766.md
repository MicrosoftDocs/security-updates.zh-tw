...
**我已經安裝了不易受風險影響的軟體版本，為什麼還會收到資訊安全更新** **KB2589337？** 
...
**我執行的是** **Windows Server 2008。為何沒有收到資訊安全更新** **KB2660649？** 
...
**我執行的是** **Windows Server 2008 R2。為何沒有收到資訊安全更新** **KB2660649？** 
...
**我所執行的作業系統列於受影響的軟體表內，並適用資訊安全更新** **KB2658846。為何我沒有收到此更新？** 
...
套**用**解決 **CV*E-*** **2012-0181** **的資訊安*全***更新封*裝是否有任*何相關特殊要求*？*** 
...
**我的系統有安裝** **Microsoft Office 2010。為什麼我沒有收到** **Microsoft Office 2010** **的更新套件** **KB2589337？** 
...
**此資訊安全更新與MS12-035** **的「.NET Framework** **中的資訊安全風險可能會允許遠端執行程式碼」有關嗎？** 
否。雖然這兩個資訊安全更新都會影響 .NET Framework，但這兩個更新影響的是不同的元件，兩者並無關聯。您可以使用任何順序套用這些更新。

**Windows 8 Consumer Preview** **是否受到此公告欲解決的任何資訊安全風險影響？**
...
**什麼是** **Windows Presentation Foundation (WPF)？** 
