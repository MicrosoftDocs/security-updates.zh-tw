---
TOCTitle: 'MS12-031'
Title: 'Microsoft Security Bulletin MS12-031 - 重要'
ms:assetid: 'ms12-031'
ms:contentKeyID: 61238763
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms12-031(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-031 - 重要
===========================================

Microsoft Visio Viewer 2010 中的資訊安全風險可能會允許遠端執行程式碼 (2597981)
------------------------------------------------------------------------------
...
這個資訊安全更新可解決 Microsoft Office 中一項未公開報告的資訊安全風險。如果使用者開啟蓄意製作的 Visio 檔案，此資訊安全風險可能會允許遠端執行程式碼。成功利用此資訊安全風險的攻擊者可以取得與目前使用者相同的使用者權限。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

對於所有受支援版本的 Microsoft Visio Viewer 2010，此資訊安全更新的等級為「重要」。如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此資訊安全更新可藉由修改 Microsoft Visio Viewer 在剖析蓄意製作的 Visio 檔案時驗證資料的方式來解決此資訊安全風險。如需更多有關此資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=0d21d110-c787-49b6-8384-6eaf9da5a38f">Microsoft Visio Viewer 2010 (32 位元版本)</a><br />
(KB2597981)<br />
(英文下載更新程式)<br />
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=0d21d110-c787-49b6-8384-6eaf9da5a38f">Microsoft Visio Viewer 2010 (32 位元版本)</a><br />
(KB2597981)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">KB2597981 取代 <a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms12-015">MS12-015</a> 中的 KB2597170</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=0d21d110-c787-49b6-8384-6eaf9da5a38f">Microsoft Visio Viewer 2010 Service Pack 1 (32 位元版本)</a><br />
(KB2597981)<br />
(英文下載更新程式)<br />
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=0d21d110-c787-49b6-8384-6eaf9da5a38f">Microsoft Visio Viewer 2010 Service Pack 1 (32 位元版本)</a><br />
(KB2597981)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=331d8247-559c-4040-bdea-84cb6fd5dee2">Microsoft Visio Viewer 2010 (64 位元版本)</a><br />
(KB2597981)<br />
(英文下載更新程式)<br />
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=331d8247-559c-4040-bdea-84cb6fd5dee2">Microsoft Visio Viewer 2010 (64 位元版本)</a><br />
(KB2597981)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=331d8247-559c-4040-bdea-84cb6fd5dee2">Microsoft Visio Viewer 2010 Service Pack 1 (64 位元版本)</a><br />
(KB2597981)<br />
(英文下載更新程式)<br />
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=331d8247-559c-4040-bdea-84cb6fd5dee2">Microsoft Visio Viewer 2010 Service Pack 1 (64 位元版本)</a><br />
(KB2597981)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
...
下列嚴重性等級是假設資訊安全風險可能造成的最嚴重影響而評定。在本資訊安全公告發行的 30 天內，如需資訊安全風險之易遭利用性與嚴重性等級和資訊安全影響之間對應關係的資訊，請參閱 [5 月份公告摘要](https://technet.microsoft.com/security/bulletin/msyy-may)中的＜資訊安全風險索引＞。如需更多資訊，請參閱 [Microsoft 資訊安全風險入侵指數](https://technet.microsoft.com/security/cc998259)。
...
<th style="border:1px solid black;" >VSD 檔案格式記憶體損毀資訊安全風險 - CVE-2012-0018</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Visio Viewer 2010 (32 位元版本)</td>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Visio Viewer 2010 (64 位元版本)</td>
<td style="border:1px solid black;">重要 <br />
遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
</tr>
...
VSD 檔案格式記憶體損毀資訊安全風險 - CVE-2012-0018  
--------------------------------------------------
  

Microsoft Visio 在處理蓄意製作的 Visio 檔案時的屬性驗證方式中存在遠端執行程式碼資訊安全風險。成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理使用者權限的使用者要小
  
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-0018](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0018) (英文)。
  
#### VSD 檔案格式記憶體損毀資訊安全風險 - CVE-2012-0018 的緩和因素
...
#### VSD 檔案格式記憶體損毀資訊安全風險 - CVE-2012-0018 的因應措施
...
-   將 \[網際網路\] 及 \[近端內部網路\] 安全性區域設定為 \[高\]，可封鎖這些區域中的 ActiveX 控制項及動態指令碼處理
    ...
    3.  在 \[此區域的安全性等級\] 下方，將滑桿移至 \[高\]，然後按一下 \[確定\]。如此即可將您所造訪的所有網站都設定為 \[高\] 安全層級。
  
    注意：如果沒有顯示滑桿，按一下 \[預設等級\]，再將滑桿移至 \[高\]，然後按一下 \[確定\]。
...
#### VSD 檔案格式記憶體損毀資訊安全風險 - CVE-2012-0018 的常見問題集
...
更新的作用何在？    
此更新可藉由修改 Microsoft Visio Viewer 在剖析蓄意製作的 Visio 檔案時驗證資料的方式來解決此資訊安全風險。
...
資訊安全更新可從 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 以及 [Windows Update](https://www.update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=zh-tw) 取得。資訊安全更新也可以從 [Microsoft 下載中心](https://www.microsoft.com/downloads/en/results.aspx?displaylang=en&freetext=security%20update)取得。您也可以利用「資訊安全更新」("security update") 關鍵字搜尋輕易地找到資訊安全更新。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2597981?ln=zh-tw">Microsoft 知識庫文件編號 2597981</a></td>
</tr>
<tr class="even">
...
-   感謝 Luigi Auriemma 與 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作回報 VSD 檔案格式記憶體損毀資訊安全風險 (CVE-2012-0018)
