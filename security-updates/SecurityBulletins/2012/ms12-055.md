---
TOCTitle: 'MS12-055'
Title: 'Microsoft Security Bulletin MS12-055 - 重要'
ms:assetid: 'ms12-055'
ms:contentKeyID: 61238787
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms12-055(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-055 - 重要
===========================================
...
此資訊安全更新可解決 Microsoft Windows 中一項未公開報告的資訊安全風險。如果攻擊者登入系統並執行蓄意製作的應用程式，則此資訊安全風險可能允許權限提高。攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項資訊安全風險。
...
(KB2731847)  
(英文下載更新程式)  
[Windows XP Service Pack 3](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=db21a230-0f6b-4d74-9f32-3718a59efd28)  
(KB2731847)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2731847 取代 [MS12-047](http://technet.microsoft.com/zh-tw/security/bulletin/ms12-047) 中的 KB2718523
</td>
</tr>
...
(KB2731847)  
(英文下載更新程式)  
[Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=a036c343-5c6e-4484-b7f7-c7161c6880fd)  
(KB2731847)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2731847)  
(英文下載更新程式)  
[Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=7f72ba9a-80b2-459d-acad-da6a8b900d6f)  
(KB2731847)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2731847)  
(英文下載更新程式)  
[適用於 Itanium 型系統的 Windows Server 2003 SP2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=9e647f22-2e80-4f4a-b648-615243741df2)  
(KB2731847)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2731847)  
(英文下載更新程式)  
[Windows Vista Service Pack 2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=41362740-876e-4c9e-9729-67dea6830438)  
(KB2731847)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2731847)  
(英文下載更新程式)  
[Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=007b4d50-b770-4e8f-b8d0-060f7bb58ad5)  
(KB2731847)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2731847)  
(英文下載更新程式)  
[適用於 32 位元系統的 Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=ec759712-2f38-41a9-8b6d-c6908cc58479)  
(KB2731847)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2731847)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=caf68d77-3315-4383-a901-ba0385ffe561)  
(KB2731847)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2731847)  
(英文下載更新程式)  
[適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=dee601c7-4ab4-4556-8d83-90864b09d365)  
(KB2731847)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2731847)  
(英文下載更新程式)  
[適用於 32 位元系統的 Windows 7](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=c709aabf-4b3f-4780-8b82-c6c33a211e31)  
(KB2731847)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2731847)  
(英文下載更新程式)  
[適用於 32 位元系統的 Windows 7 Service Pack 1](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=c709aabf-4b3f-4780-8b82-c6c33a211e31)  
(KB2731847)  
(中文下載更新程式)
...
(KB2731847)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 R2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=fc5b9df9-c836-407a-a1d4-364c1a885242)  
(KB2731847)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
<tr>
<td style="border:1px solid black;">
[適用於 32 位元系統的 Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ec759712-2f38-41a9-8b6d-c6908cc58479) (Server Core 安裝)  
(KB2731847)  
(英文下載更新程式)  
[適用於 32 位元系統的 Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=ec759712-2f38-41a9-8b6d-c6908cc58479) (Server Core 安裝)  
(KB2731847)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=caf68d77-3315-4383-a901-ba0385ffe561) (Server Core 安裝)  
(KB2731847)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=caf68d77-3315-4383-a901-ba0385ffe561) (Server Core 安裝)  
(KB2731847)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
<tr>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2](http://www.microsoft.com/downloads/details.aspx?familyid=fc5b9df9-c836-407a-a1d4-364c1a885242) (Server Core 安裝)  
(KB2731847)  
(英文下載更新程式)
</td>
<td style="border:1px solid black;">
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=fc5b9df9-c836-407a-a1d4-364c1a885242) (Server Core 安裝)  
(KB2731847)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=fc5b9df9-c836-407a-a1d4-364c1a885242) (Server Core 安裝)  
(KB2731847)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
<span></span>
我已經成功地安裝原始的 KB2731847 更新。我需要套用在 2012 年 10 月 9 日重新發行的 KB2731847 更新套件嗎？  
針對 Windows XP 和 Windows Server 2003，重新發行的更新只適用於未安裝過原始更新的 Windows XP 系統。已於其系統上成功安裝原始 KB2731847 更新的 Windows XP 和 Windows Server 2003 客戶，則不必採取任何行動。如果客戶已在其系統上安裝此更新，我們便不會再次提供更新給該客戶。

針對 Windows Vista、Windows Server 2008、Windows 7 及 Windows Server 2008 R2，客戶需套用重新發行的 KB2731847 更新套件。

為何於 2012 年 10 月 9 日  修訂此公告？
Microsoft 修訂此公告的目的，是為了重新發行 Windows XP、Windows Server 2003、Windows Vista、Windows Server 2008、Windows 7 與 Windows Server 2008 R2 的 KB2731847 更新，以解決 Microsoft 產生的特定數位憑證不具有正確時間戳記屬性的問題。如需更多資訊，請參閱 [Microsoft 資訊安全摘要報告 2749655](http://technet.microsoft.com/security/advisory/2749655)。

何處可找到檔案資訊詳細資料？ 
關於檔案資訊詳細資料的位置，請見＜資訊安全更新部署＞一節中的參考表。

何處可找到資訊安全更新的雜湊？ 
資訊安全更新的 SHA1 和 SHA2 雜湊可用來驗證下載之資訊安全更新套件的真實性。如需此更新的相關雜湊資訊，請參閱 [Microsoft 知識庫文件編號 2731847](http://support.microsoft.com/kb/2731847?ln=zh-tw)。
...
<th style="border:1px solid black;" >
Win32k 釋放後使用資訊安全風險 - CVE-2012-2527
</th>
<th style="border:1px solid black;" >
彙總嚴重性等級
</th>
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-2527](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2527) (英文)。

#### Win32k 釋放後使用資訊安全風險 - CVE-2012-2527 的緩和因素

緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。下列緩和因素可能對您的狀況有所助益：

-   攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項資訊安全風險。

#### Win32k 釋放後使用資訊安全風險 - CVE-2012-2527 的因應措施

Microsoft 尚未找到此項資訊安全風險的任何因應措施。

#### Win32k 釋放後使用資訊安全風險 - CVE-2012-2527 的常見問題集
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 項目，或是 %Windir%\$NTUninstallKB2731847-v2$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">檔案資訊</td>
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2731847?ln=zh-tw">Microsoft 知識庫文件編號 2731847</a></td>
</tr>
<tr class="even">
...
-   感謝 [Google Inc 的 Matthew Jurczyk](http://www.google.com/)回報 Win32k 釋放後使用資訊安全風險 (CVE-2012-2527)。
...
-   V2.0 (2012 年 10 月 9 日)： 修訂公告以重新發行 Windows XP、Windows Server 2003、Windows Vista、Windows Server 2008、Windows 7 及 Windows Server 2008 R2 的 KB2731847 更新。使用 Windows XP 和 Windows Server 2003 的客戶不必套用這個重新發行的更新套件，來避免 Microsoft 資訊安全摘要報告 2749655 中描述的一項數位憑證問題。使用 Windows Vista、Windows 7 及 Windows Server 2008 的客戶必須套用這個重新發行的更新套件，以避免 Microsoft 資訊安全摘要報告 2749655 中描述的一項數位憑證問題。  
-   V2.1 (2012 年 10 月 12 日)： 對重新發行的 KB2731847 更新新增一個常見問題條目，以提供部署指南。如需詳細資訊，請參閱更新常見問題集。
