...
(KB2731847)  
(英文下載更新程式)  
[Windows XP Service Pack 3](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=db21a230-0f6b-4d74-9f32-3718a59efd28)  
(KB2731847)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2731847 取代 [MS12-047](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-047) 中的 KB2718523
</td>
</tr>
...
(KB2731847)  
(英文下載更新程式)  
[Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=a036c343-5c6e-4484-b7f7-c7161c6880fd)  
(KB2731847)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2731847)  
(英文下載更新程式)  
[Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=7f72ba9a-80b2-459d-acad-da6a8b900d6f)  
(KB2731847)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2731847)  
(英文下載更新程式)  
[適用於 Itanium 型系統的 Windows Server 2003 SP2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=9e647f22-2e80-4f4a-b648-615243741df2)  
(KB2731847)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2731847)  
(英文下載更新程式)  
[Windows Vista Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=41362740-876e-4c9e-9729-67dea6830438)  
(KB2731847)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2731847)  
(英文下載更新程式)  
[Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=007b4d50-b770-4e8f-b8d0-060f7bb58ad5)  
(KB2731847)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2731847)  
(英文下載更新程式)  
[適用於 32 位元系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=ec759712-2f38-41a9-8b6d-c6908cc58479)  
(KB2731847)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2731847)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=caf68d77-3315-4383-a901-ba0385ffe561)  
(KB2731847)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2731847)  
(英文下載更新程式)  
[適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=dee601c7-4ab4-4556-8d83-90864b09d365)  
(KB2731847)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2731847)  
(英文下載更新程式)  
[適用於 32 位元系統的 Windows 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=c709aabf-4b3f-4780-8b82-c6c33a211e31)  
(KB2731847)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2731847)  
(英文下載更新程式)  
[適用於 32 位元系統的 Windows 7 Service Pack 1](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=c709aabf-4b3f-4780-8b82-c6c33a211e31)  
(KB2731847)  
(中文下載更新程式)
...
(KB2731847)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 R2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=fc5b9df9-c836-407a-a1d4-364c1a885242)  
(KB2731847)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2731847)  
(英文下載更新程式)  
[適用於 32 位元系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=ec759712-2f38-41a9-8b6d-c6908cc58479) (Server Core 安裝)  
(KB2731847)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2731847)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=caf68d77-3315-4383-a901-ba0385ffe561) (Server Core 安裝)  
(KB2731847)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2731847)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=fc5b9df9-c836-407a-a1d4-364c1a885242) (Server Core 安裝)  
(KB2731847)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
Microsoft 修訂此公告的目的，是為了重新發行 Windows XP、Windows Server 2003、Windows Vista、Windows Server 2008、Windows 7 與 Windows Server 2008 R2 的 KB2731847 更新，以解決 Microsoft 產生的特定數位憑證不具有正確時間戳記屬性的問題。如需更多資訊，請參閱 [Microsoft 資訊安全摘要報告 2749655](https://technet.microsoft.com/security/advisory/2749655)。

何處可找到檔案資訊詳細資料？  
關於檔案資訊詳細資料的位置，請見＜資訊安全更新部署＞一節中的參考表。

何處可找到資訊安全更新的雜湊？  
資訊安全更新的 SHA1 和 SHA2 雜湊可用來驗證下載之資訊安全更新套件的真實性。如需此更新的相關雜湊資訊，請參閱 [Microsoft 知識庫文件編號 2731847](https://support.microsoft.com/kb/2731847?ln=zh-tw)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-2527](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2527) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2731847?ln=zh-tw">Microsoft 知識庫文件編號 2731847</a></td>
</tr>
<tr class="even">
...
-   感謝 [Google Inc 的 Matthew Jurczyk](https://www.google.com/)回報 Win32k 釋放後使用資訊安全風險 (CVE-2012-2527)。
