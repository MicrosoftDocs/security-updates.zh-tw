...
已知問題。 [Microsoft 知識庫文件編號 2742319](https://support.microsoft.com/kb/2742319?ln=zh-tw) 中記載目前已知客戶安裝此資訊安全更新後，可能會發生的問題。該文件並說明了解決這些問題的建議解決方案。目前已知問題和建議解決方案僅適用於此軟體的特定版本，本文會提供詳細文章的連結。
...
<td style="border:1px solid black;">
[MS12-029](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-029) 中的 KB2598332 取代為 KB2687483
</td>
</tr>
...
(KB2687315)  
(英文下載更新程式)  
[Microsoft Word 2007 Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=be58b650-ee4f-405e-ab3c-c28aca48345b)<sup>[1]</sup>   
(KB2687315)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-029](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-029) 中的 KB2596917 取代為 KB2687315
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS10-079](https://technet.microsoft.com/zh-tw/security/bulletin/ms10-079) 中的 KB2345009 取代為 KB2687485
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-029](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-029) 中的 KB2596880 取代為 KB2687314
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
(KB2598237)<br />
(英文下載更新程式)<br />
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=3582ab6c-930b-4660-afcd-e2423ce56d8f">Word Automation Services</a> <br />
(KB2598237)<br />
(中文下載更新程式)</td>
...
何處 可找到資訊安全更新的雜湊？    
資訊安全更新的 SHA1 和 SHA2 雜湊可用來驗證下載之資訊安全更新套件的真實性。如需此更新的相關雜湊資訊，請參閱 [Microsoft 知識庫文件編號 2742319](https://support.microsoft.com/kb/2742319?ln=zh-tw)。
...
本公告提供的 Microsoft Office Web Apps 2010 Service Pack 1 資訊安全更新套件 (KB2687401) 也能因應 [MS12-066](https://technet.microsoft.com/zh-tw/security) 資訊安全公告中提出的資訊安全風險。
...
下列嚴重性等級是假設資訊安全風險可能造成的最嚴重影響而評定。在本資訊安全公告發行的 30 天內，如需資訊安全風險之易遭利用性與嚴重性等級和資訊安全影響之間對應關係的資訊，請參閱 [9 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms12-sep)中的＜資訊安全風險索引＞。如需更多資訊，請參閱 [Microsoft 資訊安全風險入侵指數](https://technet.microsoft.com/security/cc998259)。
...
若要以一般性資訊安全風險清單中的標準項目來檢視此資訊安全風險，請參閱 [CVE-2012-0182](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0182)。
...
-   使用 Microsoft Office 檔案封鎖原則，來封鎖開啟來自於未知或不信任來源與位置的 Office 2003 (或更早版本) 文件。
    ...
    因應措施的影響。 針對 Microsoft Office 2007，使用者若已設定檔案封鎖原則，但尚未設定特殊豁免目錄或把檔案移到信任的位置，將無法開啟 Office 2003 或更早版本的檔案。如需進一步瞭解 Microsoft Office 軟體中檔案封鎖設定之影響，請參閱 [Microsoft 知識庫文件編號 922850](https://support.microsoft.com/kb/922850?ln=zh-tw)。
...
若要以一般性資訊安全風險清單中的標準項目來檢視此資訊安全風險，請參閱 [CVE-2012-2528](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2528)。
...
-   以純文字讀取電子郵件
    ...
    已套用 Office XP Service Pack 1、Office XP Service Pack 2 或 Office XP Service Pack 3 的 Microsoft Office Outlook 2002 使用者可以啟用這項設定，只用純文字格式檢視所有未經數位簽章或未經加密的電子郵件訊息。數位簽章的電子郵件或加密的電子郵件不會受到這個設定的影響，仍然可以用原來的格式閱讀。如需更多有關如何在 Outlook 2002 中啟用此設定的資訊，請參閱 [Microsoft 知識庫文件編號 307594](https://support.microsoft.com/kb/307594?ln=zh-tw)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2687483?ln=zh-tw">Microsoft 知識庫文件編號 2687483</a> 與 <a href="https://support.microsoft.com/kb/2687485?ln=zh-tw">Microsoft 知識庫文件編號 2687485</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">檔案資訊</td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2687315?ln=zh-tw">Microsoft 知識庫文件編號 2687315</a> 與 <a href="https://support.microsoft.com/kb/2687314?ln=zh-tw">Microsoft 知識庫文件編號 2687314</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">登錄機碼驗證</td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="odd">
<td style="border:1px solid black;">檔案資訊</td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2553488?ln=zh-tw">Microsoft 知識庫文件編號 2553488</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">登錄機碼驗證</td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="odd">
<td style="border:1px solid black;">檔案資訊</td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2598237?ln=zh-tw">Microsoft 知識庫文件編號 2598237</a> 與 <a href="https://support.microsoft.com/kb/2687401?ln=zh-tw">Microsoft 知識庫文件編號 2687401</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">登錄機碼驗證</td>
<td style="border:1px solid black;">不適用</td>
...
-   感謝匿名研究人員與 [TippingPoint](https://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作回報 Word PAPX 區段損毀資訊安全風險 (CVE-2012-0182)  
-   感謝匿名研究人員與 Beyond Security 的 [SecuriTeam Secure Disclosure](https://www.beyondsecurity.com/ssd.html) 計畫合作回報 RTF 檔案 listid 釋放後使用資訊安全風險 (CVE-2012-2528)
