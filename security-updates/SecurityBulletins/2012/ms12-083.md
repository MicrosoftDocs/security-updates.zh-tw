...
(KB2765809)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 R2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=d3fb096b-87b5-4715-a093-9ec9b021a40f)  
(KB2765809)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2765809)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=d3fb096b-87b5-4715-a093-9ec9b021a40f)  
(KB2765809)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2765809)  
(英文下載更新程式)  
[適用於 Itanium 型系統的 Windows Server 2008 R2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=88a3452c-b416-41cf-867a-fdc64666c0a6)  
(KB2765809)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2765809)  
(英文下載更新程式)  
[Windows Server 2012](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=d6654bf1-1ab9-4691-8729-793eb6d0e563)  
(KB2765809)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2765809)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=d3fb096b-87b5-4715-a093-9ec9b021a40f) (Server Core 安裝)  
(KB2765809)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2765809)  
(英文下載更新程式)  
[Windows Server 2012](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=d6654bf1-1ab9-4691-8729-793eb6d0e563) (Server Core 安裝)  
(KB2765809)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-2549](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2549) (英文)。
...
-   **停用與撤銷用戶端憑證相關的網域電腦帳戶。**
    ...
    請參閱[停用或啟用電腦帳戶](https://technet.microsoft.com/zh-tw/library/cc732965.aspx)，瞭解如何在 Windows Server 2008 R2 和 Windows Server 2012 中停用電腦帳戶。

    請參閱[停用電腦帳戶](https://gallery.technet.microsoft.com/scriptcenter/ac6c44dd-db2f-487a-a51f-3ecb69b9386c)，瞭解如何使用指令碼來停用多個電腦帳戶。
...
**什麼是IP-HTTPS？**  
IP over HTTPS (IP-HTTPS) 是一項通訊協定，可以透過使用安全的 HTTP 連線來建立安全的 IP 通道。此協定常見於 Microsoft DirectAccess 部署。如需更多資訊，請參閱 [IP over HTTPS (IP-HTTPS) 通道協定](https://msdn.microsoft.com/zh-tw/library/dd358571(v=prot.20).aspx)。

**什麼是DirectAccess？**  
Windows 7 和 Windows Server 2008 R2 作業系統中引進的 DirectAccess，可讓遠端使用者使用安全通訊協定 (例如IP-HTTPS)，以安全的方式存取企業共用、網站和應用程式。如需更多資訊，請參閱 [DirectAccess](https://technet.microsoft.com/zh-tw/network/dd420463.aspx)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2765809?ln=zh-tw">Microsoft 知識庫文件編號 2765809</a></td>
</tr>
<tr class="odd">
