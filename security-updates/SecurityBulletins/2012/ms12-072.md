...
KB2727528 更新僅適用於執行受支援版本之 Windows Server 2008 且已安裝並啟用選用[「桌面體驗」功能](https://technet.microsoft.com/library/cc772567(v=ws.10))的系統。已安裝並啟用「桌面體驗」功能的 Windows Server 2008 客戶，將會有可由 KB2727528 更新處理之易受影響的元件，因此會需要安裝此資訊安全更新。未安裝「桌面體驗」功能或是已安裝但並未啟用功能的客戶，不會有此易受影響的元件，也因此不會收到資訊安全更新套件 KB2727528。

**我執行的是Windows Server 2008 R2。為何沒有收到資訊安全更新KB2727528？**  
KB2727528 更新僅適用於執行受支援版本之 Windows Server 2008 R2 且已安裝並啟用選用[「桌面體驗」功能](https://technet.microsoft.com/library/cc772567)的系統。已安裝並啟用「桌面體驗」功能的 Windows Server 2008 R2 客戶，將會有可由 KB2727528 更新處理之易受影響的元件，因此會需要安裝此資訊安全更新。未安裝「桌面體驗」功能或是已安裝但並未啟用功能的客戶，不會有此易受影響的元件，也因此不會收到資訊安全更新套件 KB2727528。
...
是。KB2727528 更新可供 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 使用。建議使用 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 的客戶在其系統上套用這些更新。該更新只在 [Windows Update](https://update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=zh-hk) 提供。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-1527](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1527) (英文)。
...
**什麼是公事包？**  
公事包是 Windows 中能夠同步處理兩個資料夾內容的功能。公事包可協助使用者在裝置 (例如 USB 隨身碟) 與電腦之間同步處理資料夾。如需更多資訊，請參閱[使用公事包同步處理](https://windows.microsoft.com/en-us/windows7/sync-using-briefcase)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-1528](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1528) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2727528?ln=zh-tw">Microsoft 知識庫文件編號 2727528</a></td>
</tr>
<tr class="even">
...
-   感謝 Tal Zeltzer 與 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作回報 Windows 公事包整數反向溢位資訊安全風險 (CVE-2012-1527)  
-   感謝 Tal Zeltzer 與 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作回報 Windows 公事包整數溢位資訊安全風險 (CVE-2012-1528)
