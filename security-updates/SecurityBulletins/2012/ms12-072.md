...
<span></span>
**我執行的是** **Windows Server 2008。為何沒有收到資訊安全更新** **KB2727528？** 
...
**我執行的是** **Windows Server 2008 R2。為何沒有收到資訊安全更新** **KB2727528？** 
...
-   **解除安裝公事包命名空間殼層延伸**
    ...
    **警告：**如果使用「登錄編輯程式」的方式錯誤，可能造成嚴重問題，以致於您必須重新安裝作業系統。Microsoft 無法保證您可以解決因為不正確使用 \[登錄編輯程式\] 所造成的問題。請自行承擔使用 \[登錄編輯程式\] 的風險。
    ...
    1.  從提高權限的命令提示字元執行下列命令，建立登錄機碼的備份：`Regedit.exe /e briefcase_workaround_rollback.reg HKEY_CLASSES_ROOT\CLSID\{85BBD920-42A0-1069-A2E4-08002B30309D}`
    2.  建立名稱為 Disable\_briefcase.reg 的文字檔，且要包含下列內容：`Windows Registry Editor Version 5.00[-HKEY_CLASSES_ROOT\CLSID\{85BBD920-42A0-1069-A2E4-08002B30309D}]`
