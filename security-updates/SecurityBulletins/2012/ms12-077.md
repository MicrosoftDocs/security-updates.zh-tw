---
TOCTitle: 'MS12-077'
Title: 'Microsoft Security Bulletin MS12-077 - 重大'
ms:assetid: 'ms12-077'
ms:contentKeyID: 61238809
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms12-077(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-077 - 重大
===========================================

Internet Explorer 積存資訊安全更新 (2761465)
--------------------------------------------
...
此資訊安全更新可解決 Internet Explorer 中三項未公開報告的資訊安全風險。最嚴重的資訊安全風險可能會在使用者以 Internet Explorer 檢視蓄意製作的網頁時，允許遠端執行程式碼。成功利用這些資訊安全風險的攻擊者可以取得與目前使用者相同的使用者權限。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

對於 Windows 用戶端上的 Internet Explorer 9 和 Internet Explorer 10，此資訊安全更新的等級為「重大」；對於 Windows 伺服器上的 Internet Explorer 9 和 Internet Explorer 10，等級為「中度」。對於 Internet Explorer 6、Internet Explorer 7 和 Internet Explorer 8，此資訊安全更新的等級為「無嚴重性等級」。如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。
...
(KB2761465)  
(英文下載更新程式)  
[Internet Explorer 6](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=e39c8368-9cd3-4f29-8c9c-aa784122bef0)   
(KB2761465)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2761465 取代 [MS12-063](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-063) 中的 KB2744842
</td>
</tr>
...
(KB2761465)  
(英文下載更新程式)  
[Internet Explorer 6](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=ed2d3c6e-b90a-49a7-867e-9549b14eb0bf)   
(KB2761465)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2761465)  
(英文下載更新程式)  
[Internet Explorer 6](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=66b552b4-8b55-45de-ba0a-940dc24e6f56)   
(KB2761465)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2761465)  
(英文下載更新程式)  
[Internet Explorer 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=d1881d12-2a40-4cb1-9428-31d6633746be)   
(KB2761465)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2761465)  
(英文下載更新程式)  
[Internet Explorer 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=18e165e9-346b-4337-81d2-77f3bf5f5f3f)   
(KB2761465)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2761465)  
(英文下載更新程式)  
[Internet Explorer 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=5ca71c15-0add-45cd-991f-e5810791c434)   
(KB2761465)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2761465)  
(英文下載更新程式)  
[Internet Explorer 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=d8025298-be72-4ef2-8914-7698494f4368)   
(KB2761465)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2761465)  
(英文下載更新程式)  
[Internet Explorer 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=2856c7b8-d5c0-444d-8273-5bd116f8898b)   
(KB2761465)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2761465)  
(英文下載更新程式)  
[Internet Explorer 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=a4824a10-4011-4ce5-9454-693d42acddf3)   
(KB2761465)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2761465)  
(英文下載更新程式)  
[Internet Explorer 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=4d49cd73-feea-44c7-86f2-048dd69233a4)   
(KB2761465)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2761465)  
(英文下載更新程式)  
[Internet Explorer 8](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=5d0a76e1-80d3-4f81-be5e-8d235babaa61)   
(KB2761465)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2761465)  
(英文下載更新程式)  
[Internet Explorer 8](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=23c4962c-8526-4e18-9b8d-50f3c3a2bf6d)   
(KB2761465)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2761465)  
(英文下載更新程式)  
[Internet Explorer 8](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=7a0c6dbd-e537-43d7-97cc-0d3df354e46a)   
(KB2761465)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2761465)  
(英文下載更新程式)  
[Internet Explorer 8](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=5b461a22-6ca4-4ab9-8874-84d7928cc668)   
(KB2761465)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2761465)  
(英文下載更新程式)  
[Internet Explorer 8](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=d19dfe38-77ef-4479-b3d9-8f6385ddee80)   
(KB2761465)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2761465)  
(英文下載更新程式)  
[Internet Explorer 8](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=8968122d-d3b9-404e-ba23-846be9041e3f)   
(KB2761465)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2761465)  
(英文下載更新程式)  
[Internet Explorer 8](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=9191365d-5541-4277-9079-f4e72e98fd19)   
(KB2761465)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2761465)  
(英文下載更新程式)  
[Internet Explorer 9](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=bd3a6f9b-7bfd-40e1-9393-a125030f2964)   
(KB2761465)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2761465 取代 [MS12-071](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-071) 中的 KB2761451
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
(KB2761465)  
(英文下載更新程式)  
[Internet Explorer 9](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=ffff647e-8d05-4c77-aea6-542ab8d76c57)   
(KB2761465)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2761465)  
(英文下載更新程式)  
[Internet Explorer 9](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=8f22603d-3a0d-49da-9691-671c0c950867)   
(KB2761465)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2761465)  
(英文下載更新程式)  
[Internet Explorer 9](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=38b15264-1a1d-41a6-8803-2d3facdb2dc3)   
(KB2761465)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2761465)  
(英文下載更新程式)  
[Internet Explorer 9](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=7accb5a9-98a1-4358-90ba-534d197885c1)   
(KB2761465)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2761465)  
(英文下載更新程式)  
[Internet Explorer 9](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=14bd26c2-b006-4465-88cc-4ecdc5de540f)   
(KB2761465)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2761465)  
(英文下載更新程式)  
[Internet Explorer 10](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=ad0ee30f-b550-434b-9fe0-ff418e052d3f)   
(KB2761465)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
<sup>[2]</sup>更新僅透過 [Windows Update](https://update.microsoft.com/windowsupdate/v6/default.aspx) 提供。
...
**何處可找到資訊安全更新的雜湊？**  
資訊安全更新的 SHA1 和 SHA2 雜湊可用來驗證下載之資訊安全更新套件的真實性。如需此更新的相關雜湊資訊，請參閱 [Microsoft 知識庫文件編號 2761465](https://support.microsoft.com/kb/2761465)。
...
是。KB2761465 更新可供 Windows 8 Release Preview 中的 Internet Explorer 10 和 Windows Server 2012 Release Candidate 中的 Internet Explorer 10 使用。建議使用 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 的客戶在其系統上套用這些更新。這些更新透過 [Windows Update](https://update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=zh-hk) 提供。

**適用於Windows 7和Windows Server 2008 R2的Internet Explorer 10 Release Preview會受此公告中所述的資訊安全風險影響嗎？**  
是。KB2761465 更新可供適用於 32 位元系統的 Windows 7 Service Pack 1、適用於 x64 型系統的 Windows 7 Service Pack 1，以及適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1 之 Internet Explorer 10 Release Preview 使用。建議已安裝適用於 32 位元系統的 Windows 7 Service Pack 1、適用於 x64 型系統的 Windows 7 Service Pack 1，以及適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1 之 Internet Explorer 10 Release Preview 客戶在其系統上套用這些更新。這些更新透過 [Windows Update](https://update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=zh-hk) 提供。
...
下列嚴重性等級是假設資訊安全風險可能造成的最嚴重影響而評定。在本資訊安全公告發行的 30 天內，如需資訊安全風險易遭利用性與嚴重性等級和資訊安全影響之間對應關係的資訊，請參閱 [12 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms12-dec)中的＜資訊安全風險索引＞。如需更多資訊，請參閱 [Microsoft 資訊安全風險入侵指數](https://technet.microsoft.com/zh-tw/security/cc998259.aspx)。
...
<th style="border:1px solid black;" >
InjectHTMLStream 釋放後使用資訊安全風險 - CVE-2012-4781
</th>
<th style="border:1px solid black;" >
CMarkup 釋放後使用資訊安全風險 - CVE-2012-4782
</th>
<th style="border:1px solid black;" >
不當參考計數釋放後使用資訊安全風險 - CVE-2012-4787
</th>
<th style="border:1px solid black;" >
彙總嚴重性等級
</th>
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-4781](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4781) (英文)。

#### InjectHTMLStream 釋放後使用資訊安全風險 - CVE-2012-4781 的緩和因素
...
#### InjectHTMLStream 釋放後使用資訊安全風險 - CVE-2012-4781 的因應措施
...
#### InjectHTMLStream 釋放後使用資訊安全風險 - CVE-2012-4781 的常見問題集
...
**我使用的是適用於Windows Server 2003、Windows Server 2008、Windows Server 2008 R2或Windows Server 2012的Internet Explorer。這樣是否會減輕此資訊安全風險的影響？**  
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-4782](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4782) (英文)。

#### CMarkup 釋放後使用資訊安全風險 - CVE-2012-4782 的緩和因素
...
#### CMarkup 釋放後使用資訊安全風險 - CVE-2012-4782 的因應措施
...
#### CMarkup 釋放後使用資訊安全風險 - CVE-2012-4782 的常見問題集
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-4787](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4787) (英文)。

#### 不當參考計數釋放後使用資訊安全風險 - CVE-2012-4787 的緩和因素
...
#### 不當參考計數釋放後使用資訊安全風險 - CVE-2012-4787 的因應措施
...
#### 不當參考計數釋放後使用資訊安全風險 - CVE-2012-4787 的常見問題集
...
<td style="border:1px solid black;">適用於所有 Windows XP 支援版本的 Internet Explorer 6：使用 [控制台] 中的 [新增或移除程式] 項目，或是 %Windir%\$NTUninstallKB2761465$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於所有 Windows XP 支援版本的 Internet Explorer 7：<br />
使用 [控制台] 中的 [新增或移除程式] 工具，或 %Windir%\ie7updates\KB2761465-IE7\spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於所有 Windows XP 支援版本的 Internet Explorer 8：<br />
使用 [控制台] 中的 [新增或移除程式] 項目，或 %Windir%\ie8updates\KB2761465-IE8\spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2761465?ln=zh-tw">Microsoft 知識庫文件編號 2761465</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><strong>移除資訊</strong></td>
<td style="border:1px solid black;">所有受支援 32 位元版本、x64 版本和 Itanium 版本 Windows Server 2003 的 Internet Explorer 6：<br />
使用 [控制台] 中的 [新增或移除程式] 項目，或 %Windir%\$NTUninstallKB2761465$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">所有受支援 32 位元版本、x64 版本和 Itanium 版本 Windows Server 2003 的 Internet Explorer 7：<br />
...
<tr class="odd">
<td style="border:1px solid black;">在不重新啟動的情況下安裝</td>
<td style="border:1px solid black;">Internet Explorer 10 all supported 32-bit editions of Windows 8:<br />
...
|                                           |                                                                                                                                                                               |  
|-------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|  
| **未來將包含於Service Pack中的內容** | 此問題的更新將包含在以後的 Service Pack 或更新彙總套件中                                                                                                                      |  
| **部署**                                  |                                                                                                                                                                               |  
...
| **檔案資訊**                              | 請參閱 [Microsoft 知識庫文件編號 2761465](https://support.microsoft.com/kb/2761465?ln=zh-tw)                                                                                   |
  Windows
### 其他資訊
...
-   感謝 [Rosario Valotta](https://sites.google.com/site/tentacoloviola) 回報 InjectHTMLStream 釋放後使用資訊安全風險 (CVE-2012-4781)  
-   感謝 [Rosario Valotta](https://sites.google.com/site/tentacoloviola) 回報 CMarkup 釋放後使用資訊安全風險 (CVE-2012-4782)  
-   感謝 [Google Inc](https://www.google.com/) 的 Fermin J. Serna 回報 不當參考計數釋放後使用資訊安全風險 (CVE-2012-4787)
