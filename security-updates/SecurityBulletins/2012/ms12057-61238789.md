...
**我已成功安裝原本的** **KB2553260** **和** **KB2589322** **更新。我是否應該套用** **2012** **年** **12** **月** **11** **日重新發行的**更新套件 (分別是 **KB2687501** **和** **KB2687510**)？  
...
**受影響的** **Microsoft Office** **軟體有多個更新套件。我需要安裝「受影響的軟體」表中列出的更新的軟體?**    
...
-   **對於來自於不受信任的來源或在非預期情況下從信任來源收到的** **Office** **檔案或內嵌的** **CGM** **檔案，請勿隨意開啟**
