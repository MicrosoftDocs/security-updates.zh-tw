...
**已知問題。** [Microsoft 知識庫文件編號 2654428](http://support.microsoft.com/kb/2654428?ln=zh-tw) 中記載了客戶安裝此資訊安全更新時，可能會發生的目前已知問題。該文件並說明了解決這些問題的建議解決方案。
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------|----------------|------------------|
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c503c7b1-24f8-40a4-8283-c1e4abf90b57)                                                                                   | 重大             | 遠端執行程式碼 | 無               |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ddbd9fcf-10c4-4089-88c0-c2a6c288222b)                                                                       | 重大             | 遠端執行程式碼 | 無               |
| [適用於 32 位元系統的 Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0c1812af-f57d-455d-a81d-5e03db99b2f7)\*                                                      | 重大             | 遠端執行程式碼 | 無               |
| [適用於 x64 型系統的 Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e1b66bb5-ea12-44a5-807a-f21ede0dc76d)\*                                                       | 重大             | 遠端執行程式碼 | 無               |
| [適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3a96ab34-8f45-48bf-a98b-9e683b50aaa0)                                                     | 重大             | 遠端執行程式碼 | 無               |
| [適用於 32 位元系統的 Windows 7 和適用於 32 位元系統的 Windows 7 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=403f355c-2273-42ac-8263-d662f5d7740c)                                 | 重大             | 遠端執行程式碼 | 無               |
| [適用於 x64 型系統的 Windows 7 和適用於 x64 型系統的 Windows 7 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=8bd8e804-ca4d-4326-bc60-345e2975b7aa)                                   | 重大             | 遠端執行程式碼 | 無               |
| [適用於 x64 型系統的 Windows Server 2008 R2 和適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=d868c5ef-165a-46a0-b832-e6ca55a910f9)\*       | 重大             | 遠端執行程式碼 | 無               |
| [適用於 Itanium 型系統的 Windows Server 2008 R2 和適用於 Itanium 型系統的 Windows Server 2008 R2 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=e5416371-495b-4dc7-a239-f9185f968969) | 重大             | 遠端執行程式碼 | 無               |
...
是。此 KB 更新可供 Windows 開發人員預覽版本使用。建議 Windows 開發人員預覽的客戶將更新套用至其系統。該更新只在 [Windows Update](http://update.microsoft.com/windowsupdate/v6/default.aspx) 提供。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-0150](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0150) (英文)。
...
是的，任何使用 msvcrt.dll 的應用程式都可能會受到此資訊安全風險影響。Microsoft 建議套用此資訊安全更新，以協助修正受影響之 Microsoft Windows 版本上的資訊安全風險。如需此問題的更多資訊，請參閱 [Microsoft 知識庫文件編號 2654428](http://support.microsoft.com/kb/2654428?ln=zh-tw) 中＜資訊安全更新的已知問題＞一節。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2654428?ln=zh-tw">Microsoft 知識庫文件編號 2654428</a></td>
</tr>
<tr class="odd">
...
-   感謝 Alexander Gavrun 與 [TippingPoint](http://www.tippingpoint.com/) [的 Zero Day Initiative](http://www.zerodayinitiative.com/) 合作回報 Msvcrt.dll 緩衝區溢位資訊安全風險 (CVE-2012-0150)
