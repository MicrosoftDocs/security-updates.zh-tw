---
TOCTitle: 'MS12-001'
Title: 'Microsoft Security Bulletin MS12-001 - 重要'
ms:assetid: 'ms12-001'
ms:contentKeyID: 61238733
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms12-001(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-001 - 重要
===========================================

Windows 核心中的弱點可能允許安全性功能略過 (2644615)
----------------------------------------------------

發行: 2012年1月10日 | 更新: 2012年2月22日
...
這個安全性更新可解決 Microsoft Windows 中一項未公開報告的弱點。此弱點可能讓攻擊者略過軟體應用程式中的 SafeSEH 安全性功能。然後攻擊者便可利用其他弱點，以利用結構化例外處理常式來執行任意程式碼。只有使用 Microsoft Visual C++ .NET 2003 編譯的軟體應用程式可用來利用這個弱點。

對於所有受支援 x64 型版本的 Windows XP 以及所有受支援版本的 Windows Server 2003、Windows Vista、Windows Server 2008、Windows 7 及 Windows Server 2008 R2，此安全性更新的等級為「重要」。如需詳細資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此安全性更新會修改 Windows 核心載入結構化例外處理表格的方式，藉以解決弱點。如需更多有關此弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。
...
**已知問題。**[Microsoft 知識庫文件編號 2644615](https://support.microsoft.com/kb/2644615) 中記載了客戶安裝此安全性更新時，可能會發生的目前已知問題。該文件並說明了解決這些問題的建議解決方案。
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|----------------|------------------|
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=46386269-6e37-4710-bfef-cedfe60d881c)                                                             | 安全性功能略過 | 重要           | 無               |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=9cdfc0fe-8f43-4e13-8a1f-2b48ff9ff472)                                                                             | 安全性功能略過 | 重要           | 無               |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=4e5783aa-6847-404c-9b75-621fa14ebbb8)                                                                 | 安全性功能略過 | 重要           | 無               |
| [適用於 Itanium 型系統的 Windows Server 2003 SP2](https://www.microsoft.com/download/details.aspx?familyid=cdf8208c-d55b-428f-bdd3-26e291dfb08d)                                                                | 安全性功能略過 | 重要           | 無               |
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=44eeb0a2-ae17-4971-8a7e-e25b260c582c)                                                                                   | 安全性功能略過 | 重要           | 無               |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=79ceba86-59a1-4138-a5de-8df20ad81b02)                                                                       | 安全性功能略過 | 重要           | 無               |
| [適用於 32 位元系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=5ab87c6c-5802-4454-bce4-12501e5b816d)\*                                                      | 安全性功能略過 | 重要           | 無               |
| [適用於 x64 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=726ff17e-ac90-4832-91e7-46f71ad2f868)\*                                                       | 安全性功能略過 | 重要           | 無               |
| [適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ba2c3d57-1bdd-44f2-9233-86c7ea6f0ddb)                                                     | 安全性功能略過 | 重要           | 無               |
| [適用於 32 位元系統的 Windows 7 和適用於 32 位元系統的 Windows 7 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=0ee22036-b7f4-40f5-8f40-a77e8faf48b2)                                 | 安全性功能略過 | 重要           | 無               |
| [適用於 x64 型系統的 Windows 7 和適用於 x64 型系統的 Windows 7 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=7444e20c-9821-4c91-9779-2728c537dd6a)                                   | 安全性功能略過 | 重要           | 無               |
| [適用於 x64 型系統的 Windows Server 2008 R2 和適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=4c73a16d-e9fa-48de-9dca-a6360ce3d029)\*       | 安全性功能略過 | 重要           | 無               |
| [適用於 Itanium 型系統的 Windows Server 2008 R2 和適用於 Itanium 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=1cc14ee8-f035-4bfc-bf38-33c6b9a2e776) | 安全性功能略過 | 重要           | 無               |
...
下列嚴重性等級是假設弱點可能造成的最嚴重影響而評定。在本安全性公告發行的 30 天內，如需弱點易遭利用性與嚴重性等級和安全性影響之間對應關係的資訊，請參閱 [1 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms12-jan)中的＜弱點入侵指數＞。如需更多資訊，請參閱 [Microsoft 弱點入侵指數](https://technet.microsoft.com/zh-tw/security/cc998259.aspx)。
...
<th style="border:1px solid black;" >Windows 核心 SafeSEH 略過弱點 - CVE-2012-0001</th>
...
Windows 核心 SafeSEH 略過弱點 - CVE-2012-0001  
---------------------------------------------
  

由於核心載入結構化例外處理表格的方式，Windows 中存在安全性功能略過弱點。成功利用此弱點的攻擊者可迴避 SafeSEH 深度防禦機制，藉以利用其他弱點。
  
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2012-0001](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0001) (英文)。
  
#### Windows 核心 SafeSEH 略過弱點 - CVE-2012-0001 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少弱點影響的嚴重性。下列緩和因素可能對您的狀況有所助益：
  
-   只有使用 Microsoft Visual C++ .NET 2003 編譯的軟體應用程式可用來利用這個弱點。
  
    **注意：** 如需協助判定用以編譯特定軟體應用程式的產品，請參閱 [Microsoft 知識庫文件編號 2644615](https://support.microsoft.com/kb/2644615)。
  
#### Windows 核心 SafeSEH 略過弱點 - CVE-2012-0001 的因應措施
  
因應措施指的是無法徹底修正弱點，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：
  
-   **使用較新版本的Microsoft VisualC++重新編譯軟體**
  
    只有使用 Microsoft Visual C++ .NET 2003 編譯的軟體應用程式可用來利用這個弱點。如果要解決此問題，請使用 Microsoft Visual C++ 2005、Microsoft Visual C++ 2008 或 Microsoft Visual C++ 2010 重新編譯模型。
  
-   **啟用結構化例外處理覆寫保護(SEHOP)**
  
    若為 Windows Vista、Windows 7、Windows Server 2008 及 Windows Server 2008 R2 系統，請參閱[如何在 Windows 作業系統中啟用結構化例外處理覆寫保護 (SEHOP)](https://support.microsoft.com/kb/956607)，以取得如何為現有應用程式啟用 SEHOP 的說明。
  
#### Windows 核心 SafeSEH 略過弱點 - CVE-2012-0001 的常見問題集
  
**這個弱點的範圍為何？**    
這是一個安全性功能略過弱點。成功利用此弱點的攻擊者可略過 SafeSEH 安全性功能，藉以利用其他弱點。
  
**造成這個弱點的原因為何？**    
此弱點是由於 Windows 核心在二進位執行期間，將結構化例外處理表格載入「負載設定」PE 標頭所造成。
  
**什麼是 Windows 核心？**    
Windows 核心是指作業系統核心。它提供系統等級的服務 (例如：裝置管理及記憶體管理)、為處理序分配處理器時間，以及管理錯誤處理。
  
**什麼元件會受到這個弱點的影響？**    
Ntdll.dll 元件會受到這個弱點的影響。
  
**攻擊者可能會利用這項弱點採取什麼行動？**    
成功利用此弱點的攻擊者可略過軟體應用程式中的 SafeSEH 安全性功能。然後攻擊者便可利用其他弱點，以利用結構化例外處理常式來執行任意程式碼。
  
**攻擊者如何利用這項弱點？**    
若要利用這項弱點執行任意程式碼，攻擊者首先必須略過 SafeSEH 安全性功能，然後利用這個安全性略過條件，藉以利用其他弱點來執行任意程式碼。
  
**什麼是結構化例外處理常式？**    
結構化例外處理常式 (SEH) 是一種用於在軟體應用程式中處理硬體與軟體例外狀況的機制。SEH 能讓程式設計師對例外狀況的處理擁有完整的控制權，提供對偵錯工具的支援，並可用於所有程式設計語言和電腦。
  
**什麼是SafeSEH？**    
SafeSEH 是一種安全性功能，可保護結構化例外處理常式在發生緩衝區溢位時免於損毀或遭劫持。
  
**因為這個弱點而承受風險的主要系統有哪些？**    
工作站和伺服器都容易受到這項弱點的影響。
  
**更新的作用何在？**    
此更新會修改 Windows 核心載入結構化例外處理表格的方式，藉以解決弱點。
...
管理您必須部署到您組織中的伺服器、桌上型電腦及行動系統的軟體和安全性更新。如需更多資訊，請參閱 [TechNet 更新管理中心](https://go.microsoft.com/fwlink/?linkid=69903) (英文)。[Microsoft TechNet 資訊安全](https://go.microsoft.com/fwlink/?linkid=21132)網站提供了有關 Microsoft 產品安全性的其他資訊。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 項目，或是 %Windir%\$NTUninstallKB2644615$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2644615">Microsoft 知識庫文件編號 2644615</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
使用 \[控制台\] 中的 \[新增或移除程式\] 項目，或是 %Windir%\\$NTUninstallKB2644615$\\Spuninst 資料夾中的 Spuninst.exe 公用程式
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
請參閱 [Microsoft 知識庫文件編號 2644615](https://support.microsoft.com/kb/2644615)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   感謝 [Accuvant LABS](https://www.accuvant.com/) 的 Joshua J. Drake 回報 Windows 核心 SafeSEH 略過弱點 (CVE-2012-0001)
...
-   V1.1 (2012 年 2 月 22 日)： 在＜提要＞的＜已知問題＞下新增 Microsoft 知識庫文件編號 2644615 的連結。
