...
<td style="border:1px solid black;">
KB2698035 取代 [MS11-078](https://technet.microsoft.com/zh-tw/security/bulletin/ms11-078) 中的 KB2572066  
   
KB2698023 取代 [MS11-100](https://technet.microsoft.com/zh-tw/security/bulletin/ms11-100) 中的 KB2656353
</td>
</tr>
...
<td style="border:1px solid black;">
KB2729450 取代 [MS12-016](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-016) 中的 KB2633880 和 [MS11-078](https://technet.microsoft.com/zh-tw/security/bulletin/ms11-078) 中的 KB2572073  
   
KB2729449 取代 [MS12-016](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-016) 中的 KB2633870 和 [MS11-078](https://technet.microsoft.com/zh-tw/security/bulletin/ms11-078) 中的 KB2572078
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2737019 取代 [MS12-034](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-034) 中的 KB2656405
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2698032 取代 [MS11-078](https://technet.microsoft.com/zh-tw/security/bulletin/ms11-078) 中的 KB2572069
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2729453 取代 [MS12-016](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-016) 中的 KB2633874 和 [MS11-078](https://technet.microsoft.com/zh-tw/security/bulletin/ms11-078) 中的 KB2572075  
   
KB2729449 取代 [MS12-016](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-016) 中的 KB2633870 和 [MS11-078](https://technet.microsoft.com/zh-tw/security/bulletin/ms11-078) 中的 KB2572078  
   
KB2729460 未取代任何更新
...
<td style="border:1px solid black;">
KB2729451 取代 [MS12-016](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-016) 中的 KB2633879 和 [MS11-078](https://technet.microsoft.com/zh-tw/security/bulletin/ms11-078) 中的 KB2572076  
   
KB2729449 取代 [MS12-016](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-016) 中的 KB2633870 和 [MS11-078](https://technet.microsoft.com/zh-tw/security/bulletin/ms11-078) 中的 KB2572078
</td>
</tr>
...
<td style="border:1px solid black;">
KB2729452 取代 [MS12-016](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-016) 中的 KB2633873 和 [MS11-078](https://technet.microsoft.com/zh-tw/security/bulletin/ms11-078) 中的 KB2572077  
   
KB2729449 取代 [MS12-016](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-016) 中的 KB2633870 和 [MS11-078](https://technet.microsoft.com/zh-tw/security/bulletin/ms11-078) 中的 KB2572078  
   
KB2729460 未取代任何更新
...
<sup>[3]</sup>Windows RT 資訊安全更新僅透過 [Windows Update](https://update.microsoft.com/windowsupdate/v6/default.aspx) 提供。
...
是的，此更新所解決的.NET Framework 不安全程式庫載入資訊安全風險 (CVE-2012-2519)，與 [Microsoft 資訊安全摘要報告 2269637](https://technet.microsoft.com/security/advisory/2269637) 中說明的資訊安全風險類別相關，該資訊安全風險會影響應用程式載入外部程式庫的方式。此資訊安全更新可解決此類型資訊安全風險的一個特定執行個體。

**.Net Framework 4.5 Release Candidate是否會受此公告中指出的資訊安全風險影響？**  
是。更新可供 Windows Vista、Windows Server 2008、Windows 7、Windows Server 2008 R2、Windows 8 Release Preview 以及 Windows Server 2012 Release Candidate 上的 Microsoft .NET Framework 4.5 Release Candidate 使用。更新亦可用於 Windows 8 Release Preview 與 Windows Server 2012 Release Candidate 上的 Microsoft .NET Framework 3.5。建議執行這些設定的客戶為其系統套用更新。這些更新僅透過 [Windows Update](https://update.microsoft.com/windowsupdate/v6/default.aspx) 提供。

**為何本次更新中仍然包含數個已回報的資訊安全風險？**  
因為解決這些資訊安全風險所需的修正作業位於相關檔案中，所以在本次更新中仍然提供對這些資訊安全風險的支援。

**此更新是否包含任何與資訊安全無關的功能變更？**  
是。除了本公告＜資訊安全風險資訊＞一節中列出的變更外，KB2756872 更新還包含 [Microsoft 知識庫文件編號 2756872](https://support.microsoft.com/kb/2756872?ln=zh-tw) 中所述的其他功能變更。請注意，此更新於 2012 年 10 月 10 日初次提供。已經安裝此更新的客戶不必採取任何行動，且我們將不會再次提供更新給該客戶。
...
下列嚴重性等級是假設資訊安全風險可能造成的最嚴重影響而評定。在本資訊安全公告發行的 30 天內，如需資訊安全風險易遭利用性與嚴重性等級和資訊安全影響之間對應關係的資訊，請參閱 [11 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms12-nov)中的＜資訊安全風險索引＞。如需更多資訊，請參閱 [Microsoft 資訊安全風險入侵指數](https://technet.microsoft.com/zh-tw/security/cc998259.aspx)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-1895](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1895) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-1896](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1896) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-2519](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2519) (英文)。
...
-   **在防火牆中封鎖TCP連接埠139和445**
    ...
    上述連接埠用於起始與受影響元件的連線。在防火牆封鎖 TCP 連接埠 139 與 445 有助於保護防火牆後方的系統免遭此資訊安全風險的攻擊。Microsoft 建議您封鎖所有網際網路中來路不明的輸入通訊，以防他人利用其他連接埠攻擊系統。如需更多關於連接埠的資訊，請參閱 TechNet 文章：[TCP 和 UDP 連接埠的指派](https://technet.microsoft.com/library/cc977599) (英文)。
...
**什麼是Entity Framework？**  
Entity Framework 是一組 ADO.NET 技術，支援資料導向軟體應用程式的開發作業。如需詳細資訊，請參閱 MSDN 文章 [Entity Framework 概觀](https://msdn.microsoft.com/zh-tw/library/bb399567.aspx)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-4776](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4776) (英文)。
...
-   **註冊WPAD**
    ...
    遵循 [Microsoft 知識庫文件編號 934864](https://support.microsoft.com/kb/934864?ln=zh-tw) 所提供的步驟註冊 WPAD。

    **因應措施的影響。** 系統管理員將會在攻擊者有機會註冊 WPAD 之前先進行此作業。

    **如何復原因應措施。** 如需更多資訊，請參閱 [Microsoft 知識庫文件編號 934864](https://support.microsoft.com/kb/934864?ln=zh-tw)。

-   **不依賴.NET應用程式中的預設Web Proxy設定**
    ...
    如需有關 the WebRequest.DefaultWebProxy 屬性的相關文件，請參閱 [WebRequest.DefaultWebProxy 屬性](https://msdn.microsoft.com/zh-tw/library/system.net.webrequest.defaultwebproxy.aspx)。
...
**我是在Windows 8、Windows Server 2012或Windows RT上執行Microsoft .NET Framework 4.5，我是否會受此問題影響？**  
否，在 Windows 8、Windows Server 2012 以及 Windows RT 上執行 Microsoft .NET Framework 4.5 的客戶不受此問題影響。2012 年 10 月 10 日發行的 Windows 8 用戶端和 Windows Server 2012 General Availability 積存更新 (KB2756872) 包含其他深度防禦變更。建議尚未安裝此更新的客戶採取此動作以作為深度防禦措施。如需更多詳細資訊，請參閱 [Microsoft 知識庫文件編號 2745030](https://support.microsoft.com/kb/2745030?ln=zh-tw) 中的＜其他相關資訊＞一節。如需下載連結與詳細資訊，請參閱 [Microsoft 知識庫文件編號 2756872](https://support.microsoft.com/kb/2756872?ln=zh-tw)。請注意，此更新包含非資訊安全相關內容。
...
**什麼是Web Proxy Auto-Discovery (WPAD)？**  
Web Proxy Auto-Discovery (WPAD) 功能可讓網路用戶端自動偵測 Proxy 設定，不需要使用者介入。WPAD 功能會將主機名稱 "wpad" 假裝為完整網域名稱，且以漸進的方式移除子網域直到發現 WPAD 伺服器回答網域名稱為止。如需更多資訊，請參閱 [WinHTTP AutoProxy 支援](https://msdn.microsoft.com/zh-tw/library/system.net.webproxy.getdefaultproxy(v=vs.110).aspx) (英文)。
...
**更新的作用何在？**  
此更新會更新 System.Net 內部的 Microsoft.Jscript 並且限制 .NET Framework 執行 WPAD 設定檔案內部所含之 JavaScript 的方式，進而解決此項資訊安全風險。此更新也會變更 WPAD 的處理方式 (使用 WinHTTP 而非 Microsoft.Jscript)。雖然可能性很低，但是這項變更可能會導致非標準的 Proxy 自動設定環境發生相容性問題。如需有關此變更的詳細資訊，請參閱 [Microsoft 知識庫文件編號 2745030](https://support.microsoft.com/kb/2745030?ln=zh-tw) 中的＜其他相關資訊＞一節。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-4777](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4777) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2745030?ln=zh-tw">Microsoft 知識庫文件編號 2745030</a></td>
</tr>
<tr class="odd">
...
<tr class="even">
<td style="border:1px solid black;"><strong>部署</strong></td>
<td style="border:1px solid black;">Windows RT 的更新僅透過 <a href="https://update.microsoft.com/windowsupdate/v6/default.aspx">Windows Update</a> 提供。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">詳細資訊</td>
<td style="border:1px solid black;">請參閱＜偵測與部署工具及指南＞小節</td>
...
Windows RT 的更新僅透過 [Windows Update](https://update.microsoft.com/windowsupdate/v6/default.aspx) 提供。
