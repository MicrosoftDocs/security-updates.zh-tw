---
TOCTitle: 'MS12-032'
Title: 'Microsoft Security Bulletin MS12-032 - 重要'
ms:assetid: 'ms12-032'
ms:contentKeyID: 61238764
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms12-032(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-032 - 重要
===========================================

TCP/IP 中的資訊安全風險可能會允許權限提高 (2688338)
---------------------------------------------------
...
這個資訊安全更新可解決 Microsoft Windows 中一項公開揭露和一項未公開報告的資訊安全風險。如果攻擊者登入系統並執行蓄意製作的應用程式，則這些資訊安全風險中較嚴重者可能允許權限提高。
...
此資訊安全更新可藉由修改 Windows 防火牆處理輸出廣播封包的方式，以及修改 Windows TCP/IP 堆疊處理 IPv6 位址繫結至本機介面的方式，來解決這些資訊安全風險。如需更多有關此資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
[Windows Vista Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=b1dc6e10-34eb-45ea-92b3-9983c00f6cb5)  
(KB2688338)
...
<td style="border:1px solid black;">
KB2688338 取代 [MS11-083](https://technet.microsoft.com/zh-tw/security/bulletin/ms11-083) 中的 KB2588516
</td>
</tr>
...
[Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=d65565d4-d865-438a-bfb7-d71af9dd884e)  
(KB2688338)  
(中文下載更新程式)
...
[適用於 32 位元系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=7ef72aab-7fd2-4330-bb6a-0c77c3943345)  
(KB2688338)  
(中文下載更新程式)
...
[適用於 32 位元系統的 Windows 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=46b8749e-3d8f-472f-a1ea-419f44c6bc00)  
(KB2688338)  
(中文下載更新程式)
...
[適用於 32 位元系統的 Windows 7 Service Pack 1](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=46b8749e-3d8f-472f-a1ea-419f44c6bc00)  
(KB2688338)  
(中文下載更新程式)
...
[適用於 x64 型系統的 Windows 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=e89fb3f1-44cb-4fc0-bbc2-8e94d6933322)  
(KB2688338)  
(中文下載更新程式)
...
[適用於 x64 型系統的 Windows 7 Service Pack 1](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=e89fb3f1-44cb-4fc0-bbc2-8e94d6933322)  
(KB2688338)  
(中文下載更新程式)
...
[適用於 x64 型系統的 Windows Server 2008 R2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=08ba4320-6c47-4f82-a54f-61a32629b985)  
(KB2688338)  
(中文下載更新程式)
...
[適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=08ba4320-6c47-4f82-a54f-61a32629b985)  
(KB2688338)  
(中文下載更新程式)
...
[適用於 x64 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=9569d980-766d-4825-bd1c-f30c93d4b035)  
(KB2688338)  
(中文下載更新程式)
...
<th style="border:1px solid black;" >
Windows 防火牆略過資訊安全風險 - CVE-2012-0174
</th>
<th style="border:1px solid black;" >
TCP/IP 重覆釋放相同記憶體空間資訊安全風險 - CVE-2012-0179
</th>
<th style="border:1px solid black;" >
彙總嚴重性等級
</th>
...
Windows 防火牆處理輸出廣播封包的方式，導致 Windows 中存在安全性功能略過資訊安全風險。成功利用此資訊安全風險的攻擊者可規避 Windows 防火牆的深度防禦機制，藉以利用其他資訊安全風險。

若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-0174](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0174) (英文)。

#### Windows 防火牆略過資訊安全風險 - CVE-2012-0174 的緩和因素

Microsoft 尚未找到此項資訊安全風險的任何緩和因素。

#### Windows 防火牆略過資訊安全風險 - CVE-2012-0174 的因應措施

Microsoft 尚未找到此項資訊安全風險的任何因應措施。

#### Windows 防火牆略過資訊安全風險 - CVE-2012-0174 的常見問題集

這個資訊安全風險的範圍為何？  
這是一個安全性功能略過資訊安全風險。成功利用此資訊安全風險的攻擊者可規避 Windows 防火牆，藉以利用其他資訊安全風險。

造成這個資訊安全風險的原因為何？  
此資訊安全風險是由 Windows 防火牆在套用輸出防火牆規則後，無法正確篩選輸出廣播封包所造成。

什麼 元件會受到此資訊安全風險的影響？  
受到此資訊安全風險影響的元件為 TCP/IP 堆疊 (tcpip.sys)。

什麼是 TCP/IP？  
TCP/IP 是一組網際網路上廣泛使用的網路通訊協定。網際網路上許多互相連接的網路是由使用不同作業系統和多種硬體架構的電腦所組成，TCP/IP 讓這些網路間能夠互相通訊。TCP/IP 內含電腦間用來溝通用的標準，以及連接網路和路由傳輸用的慣例。如需有關 TCP/IP 的詳細資訊，請參閱 TechNet 文章：網路和 TCP/IP 概觀 (英文)。

攻擊者可能會利用這項資訊安全風險採取什麼行動？  
成功利用此資訊安全風險的攻擊者可規避 Windows 防火牆。然後，攻擊者便可利用其他資訊安全風險來取得目標系統的相關資訊，或在目標系統上執行程式碼。

攻擊者如何利用這項 資訊安全風險？  
為了利用這項資訊安全風險，攻擊者首先必須取得目標電腦本機子網路的存取權限。然後，攻擊者便可利用其他資訊安全風險來取得目標系統的相關資訊，或在目標系統上執行程式碼。

因為這個資訊安全風險而承受風險的主要系統有哪些？  
工作站與伺服器最可能受這個資訊安全風險影響。

更新的作用何在？  
此更新可修改 Windows 防火牆處理輸出廣播封包的方式，藉此解決此資訊安全風險。

什麼是預設輸出防火牆規則？  
設定預設輸出防火牆規則是為了允許來自主機的所有輸出網路流量。為了封鎖不想要的輸出網路流量，客戶需要建立防火牆規則來封鎖流量。如需更多關於新增輸出防火牆規則的資訊，請參閱 TechNet 文章：建立封鎖不想要的輸出網路流量的規則。
...
Windows TCP/IP 堆疊中存在權限提高資訊安全風險，而此風險會影響 Windows 7 和 Windows Server 2008 R2。Microsoft Windows XP、Windows Server 2003、Windows Vista 及 Window Server 2008 的所有版本則不受影響。此資訊安全風險是因為 Windows TCP/IP 堆疊無法正確處理 IPv6 位址的繫結所造成。

若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-0179](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0179) (英文)。

#### TCP/IP 重覆釋放相同記憶體空間資訊安全風險 - CVE-2012-0179 的緩和因素

緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。下列緩和因素可能對您的狀況有所助益：

-   攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項資訊安全風險。

#### TCP/IP 重覆釋放相同記憶體空間資訊安全風險 - CVE-2012-0179 的因應措施

Microsoft 尚未找到此項資訊安全風險的任何因應措施。

#### TCP/IP 重覆釋放相同記憶體空間資訊安全風險 - CVE-2012-0179 的常見問題集

這個資訊安全風險的範圍為何？  
這是權限提高的資訊安全風險。

造成這個資訊安全風險的原因為何？  
此資訊安全風險是因為 Windows TCP/IP 堆疊無法正確處理 IPv6 位址至本機介面的繫結所造成。
...
因為這個資訊安全風險而承受風險的主要系統有哪些？  
工作站和伺服器均會受到此資訊安全風險影響。

更新的作用何在？  
此更新可修改 Windows TCP/IP 堆疊處理 IPv6 位址至本機介面之繫結的方式，藉此解決此資訊安全風險。

本資訊安全公告發行時，這項資訊安全風險是否已揭發出來？  
是。這項資訊安全風險已經遭到公開揭發。這項資訊安全風險已被指派「一般性資訊安全風險」編號 [CVE-2012-0179](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0179) (英文)。

當本資訊安全公告發行時，Microsoft 是否已接獲任何消息，指出這項資訊安全風險已遭有心人士利用？  
否。當本資訊安全公告初次發行時，Microsoft 尚未接獲有關本資訊安全風險遭公開利用以攻擊客戶的任何消息。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2688338?ln=zh-tw">Microsoft 知識庫文件編號 2688338</a></td>
</tr>
<tr class="odd">
...
-   感謝 [INFIGO IS](https://www.infigo.hr/) 的 Bojan Zdrnja 回報 Windows 防火牆略過資訊安全風險 (CVE-2012-0174)  
-   感謝 [Genesys Telecommunications](https://www.genesyslab.com/) 的 Anatoliy Glagolev 協助我們解決 TCP/IP 重覆釋放相同記憶體空間資訊安全風險 (CVE-2012-0179)
...
-   V1.1 (2012 年 5 月 10 日)： 更正＜資訊安全風險資訊＞一節中 CVE-2012-0174 和 CVE-2012-0179 的緩和因素
