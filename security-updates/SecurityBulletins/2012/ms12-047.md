---
TOCTitle: 'MS12-047'
Title: 'Microsoft Security Bulletin MS12-047 - 重要'
ms:assetid: 'ms12-047'
ms:contentKeyID: 61238779
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms12-047(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-047 - 重要
===========================================

Windows 核心模式驅動程式中的資訊安全風險可能會允許權限提高 (2718523)
--------------------------------------------------------------------
...
這個資訊安全更新可解決 Microsoft Windows 中一項公開揭露和一項未公開報告的資訊安全風險。如果攻擊者登入系統並執行蓄意製作的應用程式，則這些資訊安全風險可能允許權限提高。攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項資訊安全風險。

對於所有受支援版本的 Microsoft Windows，此資訊安全更新的等級為「重要」。如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此資訊安全更新可藉由修正 Windows 核心模式驅動程式處理鍵盤配置檔案的方式，以及在建立勾點程序時驗證回撥參數的方式，藉此解決這些資訊安全風險。如需更多有關此資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
(KB2718523)  
(英文下載更新程式)  
[Windows XP Service Pack 3](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=a4bc78fb-3927-4059-ae1c-35c369e39203)   
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2718523 取代 [MS12-041](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-041) 中的 KB2709162
</td>
</tr>
...
(KB2718523)  
(英文下載更新程式)  
[Windows Server 2003 Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=d53bd571-ad30-41c7-8c5f-f217097770f5)   
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2718523)  
(英文下載更新程式)  
[Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=5f261883-daec-4af3-8bc1-46da9c164de7)   
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2718523)  
(英文下載更新程式)  
[Windows Vista Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=3c957f8a-8f32-4a12-ade9-10a7e2984e88)   
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2718523)  
(英文下載更新程式)  
[Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=7300636f-aefd-46bf-a7ba-780d6f939b4f)   
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2718523)  
(英文下載更新程式)  
[適用於 32 位元系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=ed201422-7c65-4c20-a825-8cecab1aeebc)   
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2718523)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=8e1a27c9-6495-4030-8a46-264afd78a5a1)   
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2718523)  
(英文下載更新程式)  
[適用於 32 位元系統的 Windows 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=b4bed780-b120-43a1-900e-89b3be7da8b1)   
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2718523)  
(英文下載更新程式)  
[適用於 32 位元系統的 Windows 7 Service Pack 1](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=b4bed780-b120-43a1-900e-89b3be7da8b1)   
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2718523)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=3efb0de1-252b-4b72-86f3-e747f8fa2229)   
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2718523)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows 7 Service Pack 1](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=3efb0de1-252b-4b72-86f3-e747f8fa2229)   
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2718523)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 R2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=73a9ff32-4009-4fd4-a82b-1e22c09d3087)   
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2718523)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=73a9ff32-4009-4fd4-a82b-1e22c09d3087)   
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
<tr>
<td style="border:1px solid black;">
[適用於 32 位元系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ed201422-7c65-4c20-a825-8cecab1aeebc) (Server Core 安裝)  
(KB2718523)  
(英文下載更新程式)  
[適用於 32 位元系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=ed201422-7c65-4c20-a825-8cecab1aeebc) (Server Core 安裝)  
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=8e1a27c9-6495-4030-8a46-264afd78a5a1) (Server Core 安裝)  
(KB2718523)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=8e1a27c9-6495-4030-8a46-264afd78a5a1) (Server Core 安裝)  
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
<tr>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2](https://www.microsoft.com/download/details.aspx?familyid=73a9ff32-4009-4fd4-a82b-1e22c09d3087) (Server Core 安裝)  
(KB2718523)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 R2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=73a9ff32-4009-4fd4-a82b-1e22c09d3087) (Server Core 安裝)  
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=73a9ff32-4009-4fd4-a82b-1e22c09d3087) (Server Core 安裝)  
(KB2718523)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=73a9ff32-4009-4fd4-a82b-1e22c09d3087) (Server Core 安裝)  
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
何處 可找到資訊安全更新的雜湊？  
資訊安全更新的 SHA1 和 SHA2 雜湊可用來驗證下載之資訊安全更新套件的真實性。如需此更新的相關雜湊資訊，請參閱 [Microsoft 知識庫文件編號 2718523](https://support.microsoft.com/kb/2718523?ln=zh-tw)。
...
<th style="border:1px solid black;" >
鍵盤配置資訊安全風險 - CVE-2012-1890
</th>
<th style="border:1px solid black;" >
Win32k 不正確的類型處理資訊安全風險 - CVE-2012-1893
</th>
<th style="border:1px solid black;" >
彙總嚴重性等級
</th>
...
在 Windows 核心模式驅動程式處理特定鍵盤配置的方式中，存在權限提高資訊安全風險。成功利用此資訊安全風險的攻擊者可以在核心模式下執行任意程式碼。接下來，攻擊者就能安裝程式，檢視、變更或刪除資料，或是建立具有完整系統管理權限的新帳戶。

若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-1890](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1890) (英文)。

#### 鍵盤配置資訊安全風險 - CVE-2012-1890 的緩和因素

緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。下列緩和因素可能對您的狀況有所助益：

-   攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項資訊安全風險。

#### 鍵盤配置資訊安全風險 - CVE-2012-1890 的因應措施

Microsoft 尚未找到此項資訊安全風險的任何因應措施。

#### 鍵盤配置資訊安全風險 - CVE-2012-1890 的常見問題集
...
是。這項資訊安全風險已經遭到公開揭發。這項資訊安全風險已被指派一般性資訊安全風險編號 [CVE-2012-1890](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1890)。
...
當 Windows 核心模式驅動程式在建立勾點程序時不當驗證參數時，即出現權限提高資訊安全風險。成功利用此資訊安全風險的攻擊者可以在核心模式下執行任意程式碼。攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。

若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-1893](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1893) (英文)。

#### Win32k 不正確的類型處理資訊安全風險 - CVE-2012-1893 的緩和因素

緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。下列緩和因素可能對您的狀況有所助益：

-   攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項資訊安全風險。

#### Win32k 不正確的類型處理資訊安全風險 - CVE-2012-1893 的因應措施

Microsoft 尚未找到此項資訊安全風險的任何因應措施。

#### Win32k 不正確的類型處理資訊安全風險 - CVE-2012-1893 的常見問題集

這個資訊安全風險的範圍為何？  
這是權限提高的資訊安全風險。

造成這個資訊安全風險的原因為何？  
此資訊安全風險是由 Windows 核心模式驅動程式在建立勾點程序時不當驗證參數所造成。
...
更新的作用何在？  
此更新可修正 Windows 核心模式驅動程式在建立勾點程序時驗證回撥參數的方式，藉此解決此資訊安全風險。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 項目，或是 %Windir%\$NTUninstallKB2718523$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">檔案資訊</td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2718523?ln=zh-tw">Microsoft 知識庫文件編號 2718523</a></td>
</tr>
<tr class="even">
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">未來 將包含於 Service Pack 中的內容</td>
<td style="border:1px solid black;">此問題的更新將包含在以後的 Service Pack 或更新彙總套件中</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">部署</td>
...
-   感謝 [Core Security Technologies](https://www.coresecurity.com/) 的 Nicolas Economou 回報鍵盤配置資訊安全風險 (CVE-2012-1890)  
-   [感謝 Qihoo 360 Security Center](https://www.360.cn/)  
-   回報鍵盤配置資訊安全風險 (CVE-2012-1890)  
-   感謝 LufeWindows與 [Secunia Research](https://secunia.com/) 合作，回報 Win32k 不正確的類型處理資訊安全風險 (CVE-2012-1893)
