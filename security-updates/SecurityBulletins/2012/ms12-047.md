...
(KB2718523)  
(英文下載更新程式)  
[Windows XP Service Pack 3](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=a4bc78fb-3927-4059-ae1c-35c369e39203)   
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2718523 取代 [MS12-041](http://technet.microsoft.com/zh-tw/security/bulletin/ms12-041) 中的 KB2709162
</td>
</tr>
...
(KB2718523)  
(英文下載更新程式)  
[Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=d53bd571-ad30-41c7-8c5f-f217097770f5)   
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2718523)  
(英文下載更新程式)  
[Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=5f261883-daec-4af3-8bc1-46da9c164de7)   
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2718523)  
(英文下載更新程式)  
[Windows Vista Service Pack 2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=3c957f8a-8f32-4a12-ade9-10a7e2984e88)   
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2718523)  
(英文下載更新程式)  
[Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=7300636f-aefd-46bf-a7ba-780d6f939b4f)   
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2718523)  
(英文下載更新程式)  
[適用於 32 位元系統的 Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=ed201422-7c65-4c20-a825-8cecab1aeebc)   
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2718523)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=8e1a27c9-6495-4030-8a46-264afd78a5a1)   
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2718523)  
(英文下載更新程式)  
[適用於 32 位元系統的 Windows 7](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=b4bed780-b120-43a1-900e-89b3be7da8b1)   
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2718523)  
(英文下載更新程式)  
[適用於 32 位元系統的 Windows 7 Service Pack 1](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=b4bed780-b120-43a1-900e-89b3be7da8b1)   
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2718523)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows 7](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=3efb0de1-252b-4b72-86f3-e747f8fa2229)   
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2718523)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows 7 Service Pack 1](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=3efb0de1-252b-4b72-86f3-e747f8fa2229)   
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2718523)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 R2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=73a9ff32-4009-4fd4-a82b-1e22c09d3087)   
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2718523)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=73a9ff32-4009-4fd4-a82b-1e22c09d3087)   
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2718523)  
(英文下載更新程式)  
[適用於 32 位元系統的 Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=ed201422-7c65-4c20-a825-8cecab1aeebc) (Server Core 安裝)  
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2718523)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=8e1a27c9-6495-4030-8a46-264afd78a5a1) (Server Core 安裝)  
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2718523)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 R2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=73a9ff32-4009-4fd4-a82b-1e22c09d3087) (Server Core 安裝)  
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2718523)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=73a9ff32-4009-4fd4-a82b-1e22c09d3087) (Server Core 安裝)  
(KB2718523)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
何處 可找到資訊安全更新的雜湊？  
資訊安全更新的 SHA1 和 SHA2 雜湊可用來驗證下載之資訊安全更新套件的真實性。如需此更新的相關雜湊資訊，請參閱 [Microsoft 知識庫文件編號 2718523](http://support.microsoft.com/kb/2718523?ln=zh-tw)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-1890](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1890) (英文)。
...
是。這項資訊安全風險已經遭到公開揭發。這項資訊安全風險已被指派一般性資訊安全風險編號 [CVE-2012-1890](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1890)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-1893](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1893) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2718523?ln=zh-tw">Microsoft 知識庫文件編號 2718523</a></td>
</tr>
<tr class="even">
...
-   感謝 [Core Security Technologies](http://www.coresecurity.com/) 的 Nicolas Economou 回報鍵盤配置資訊安全風險 (CVE-2012-1890)  
-   [感謝 Qihoo 360 Security Center](http://www.360.cn/)  
-   回報鍵盤配置資訊安全風險 (CVE-2012-1890)  
-   感謝 LufeWindows與 [Secunia Research](http://secunia.com/) 合作，回報 Win32k 不正確的類型處理資訊安全風險 (CVE-2012-1893)
