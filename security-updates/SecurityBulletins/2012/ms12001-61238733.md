...
**已知問題。**[Microsoft 知識庫文件編號 2644615](http://support.microsoft.com/kb/2644615) 中記載了客戶安裝此安全性更新時，可能會發生的目前已知問題。該文件並說明了解決這些問題的建議解決方案。
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|----------------|------------------|
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=46386269-6e37-4710-bfef-cedfe60d881c)                                                             | 安全性功能略過 | 重要           | 無               |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9cdfc0fe-8f43-4e13-8a1f-2b48ff9ff472)                                                                             | 安全性功能略過 | 重要           | 無               |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4e5783aa-6847-404c-9b75-621fa14ebbb8)                                                                 | 安全性功能略過 | 重要           | 無               |
| [適用於 Itanium 型系統的 Windows Server 2003 SP2](http://www.microsoft.com/downloads/details.aspx?familyid=cdf8208c-d55b-428f-bdd3-26e291dfb08d)                                                                | 安全性功能略過 | 重要           | 無               |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=44eeb0a2-ae17-4971-8a7e-e25b260c582c)                                                                                   | 安全性功能略過 | 重要           | 無               |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=79ceba86-59a1-4138-a5de-8df20ad81b02)                                                                       | 安全性功能略過 | 重要           | 無               |
| [適用於 32 位元系統的 Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5ab87c6c-5802-4454-bce4-12501e5b816d)\*                                                      | 安全性功能略過 | 重要           | 無               |
| [適用於 x64 型系統的 Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=726ff17e-ac90-4832-91e7-46f71ad2f868)\*                                                       | 安全性功能略過 | 重要           | 無               |
| [適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ba2c3d57-1bdd-44f2-9233-86c7ea6f0ddb)                                                     | 安全性功能略過 | 重要           | 無               |
| [適用於 32 位元系統的 Windows 7 和適用於 32 位元系統的 Windows 7 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=0ee22036-b7f4-40f5-8f40-a77e8faf48b2)                                 | 安全性功能略過 | 重要           | 無               |
| [適用於 x64 型系統的 Windows 7 和適用於 x64 型系統的 Windows 7 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=7444e20c-9821-4c91-9779-2728c537dd6a)                                   | 安全性功能略過 | 重要           | 無               |
| [適用於 x64 型系統的 Windows Server 2008 R2 和適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=4c73a16d-e9fa-48de-9dca-a6360ce3d029)\*       | 安全性功能略過 | 重要           | 無               |
| [適用於 Itanium 型系統的 Windows Server 2008 R2 和適用於 Itanium 型系統的 Windows Server 2008 R2 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=1cc14ee8-f035-4bfc-bf38-33c6b9a2e776) | 安全性功能略過 | 重要           | 無               |
...
<span></span>
下列嚴重性等級是假設弱點可能造成的最嚴重影響而評定。在本安全性公告發行的 30 天內，如需弱點易遭利用性與嚴重性等級和安全性影響之間對應關係的資訊，請參閱 [1 月份公告摘要](http://technet.microsoft.com/security/bulletin/ms12-jan)中的＜弱點入侵指數＞。如需更多資訊，請參閱 [Microsoft 弱點入侵指數](http://technet.microsoft.com/zh-tw/security/cc998259.aspx)。
...
若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2012-0001](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0001) (英文)。
...
-   只有使用 Microsoft Visual C++ .NET 2003 編譯的軟體應用程式可用來利用這個弱點。
    ...
    **注意：**如需協助判定用以編譯特定軟體應用程式的產品，請參閱 [Microsoft 知識庫文件編號 2644615](http://support.microsoft.com/kb/2644615)。
  
#### Windows 核心 SafeSEH 略過弱點 - CVE-2012-0001 的因應措施
  
因應措施指的是無法徹底修正弱點，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：
  
-   **使用** **較新版本的** **Microsoft Visual** **C++** **重新編譯** **軟體**
...
-   **啟用** **結構化例外處理覆寫保護(SEHOP)**
  
    若為 Windows Vista、Windows 7、Windows Server 2008 及 Windows Server 2008 R2 系統，請參閱[如何在 Windows 作業系統中啟用結構化例外處理覆寫保護 (SEHOP)](http://support.microsoft.com/kb/956607)，以取得如何為現有應用程式啟用 SEHOP 的說明。
...
管理您必須部署到您組織中的伺服器、桌上型電腦及行動系統的軟體和安全性更新。如需更多資訊，請參閱 [TechNet 更新管理中心](http://go.microsoft.com/fwlink/?linkid=69903) (英文)。[Microsoft TechNet 資訊安全](http://go.microsoft.com/fwlink/?linkid=21132)網站提供了有關 Microsoft 產品安全性的其他資訊。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2644615">Microsoft 知識庫文件編號 2644615</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
請參閱 [Microsoft 知識庫文件編號 2644615](http://support.microsoft.com/kb/2644615)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   感謝 [Accuvant LABS](http://www.accuvant.com/) 的 Joshua J. Drake 回報 Windows 核心 SafeSEH 略過弱點 (CVE-2012-0001)
