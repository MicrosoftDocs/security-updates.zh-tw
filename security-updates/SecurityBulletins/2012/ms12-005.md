---
TOCTitle: 'MS12-005'
Title: 'Microsoft Security Bulletin MS12-005 - 重要'
ms:assetid: 'ms12-005'
ms:contentKeyID: 61238737
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms12-005(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-005 - 重要
===========================================

Microsoft Windows 中的弱點可能會允許遠端執行程式碼 (2584146)
------------------------------------------------------------
...
這個安全性更新可解決 Microsoft Windows 中一項未公開報告的弱點。如果使用者開啟包含惡意內嵌 ClickOnce 應用程式之蓄意製作的 Microsoft Office 檔案，此弱點可能允許遠端執行程式碼。成功利用此弱點的攻擊者可以取得與本機使用者相同的使用者權限。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

對於所有受支援版本的 Microsoft Windows，此安全性更新的等級為「重要」。如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此安全性更新是藉由變更 Windows Packager 檢查不安全檔案的方式來解決弱點。如需更多有關此弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|----------------|------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=1bcb1d1e-9261-4a36-9256-90d3df9bd4fb)                                                                                      | 遠端執行程式碼 | 重要           | 無               |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2c687796-4c41-4d17-b738-511d2fbfc126)                                                             | 遠端執行程式碼 | 重要           | 無               |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2c39be84-1eab-4794-b3ed-e529643aca21)                                                                             | 遠端執行程式碼 | 重要           | 無               |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3cf29dfd-239e-4707-92e6-952133c1c1c2)                                                                 | 遠端執行程式碼 | 重要           | 無               |
| [適用於 Itanium 型系統的 Windows Server 2003 SP2](https://www.microsoft.com/download/details.aspx?familyid=623c1c7d-6902-4876-9614-1b6e1ef80831)                                                                | 遠端執行程式碼 | 重要           | 無               |
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=038970b6-aeec-4e18-8dfe-887b260a7c87)                                                                                   | 遠端執行程式碼 | 重要           | 無               |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=23abeb12-f2fe-43fd-9c4a-4d3d244832f8)                                                                       | 遠端執行程式碼 | 重要           | 無               |
| [適用於 32 位元系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=d089d9cb-382c-4e64-94c5-69b9864010b1)\*\*                                                    | 遠端執行程式碼 | 重要           | 無               |
| [適用於 x64 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=1ac8a368-4298-4c1d-9cfd-924d6df563af)\*\*                                                     | 遠端執行程式碼 | 重要           | 無               |
| [適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3e08b242-2516-4cf6-b38e-35ec2b8b788d)                                                     | 遠端執行程式碼 | 重要           | 無               |
| [適用於 32 位元系統的 Windows 7 和適用於 32 位元系統的 Windows 7 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=7422605b-7a02-4161-b7f8-92b3ccffef64)                                 | 遠端執行程式碼 | 重要           | 無               |
| [適用於 x64 型系統的 Windows 7 和適用於 x64 型系統的 Windows 7 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=4ba46bc7-af7a-445a-84f2-b0c13674409b)                                   | 遠端執行程式碼 | 重要           | 無               |
| [適用於 x64 型系統的 Windows Server 2008 R2 和適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=db3a4814-a409-4def-944d-4eaa540b83b0)\*\*     | 遠端執行程式碼 | 重要           | 無               |
| [適用於 Itanium 型系統的 Windows Server 2008 R2 和適用於 Itanium 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=2101663a-ed3d-4850-b79a-16960ab56b45) | 遠端執行程式碼 | 重要           | 無               |
...
**此安全性更新是否與MS12-002相關？**  
否。雖然這兩個安全性更新都會影響 Windows Packager，但這兩個更新影響的是不同的元件，兩者並沒有關聯。您可以使用任何順序套用這些更新。

**此更新程式是否包含功能上的任何安全性相關變更？**  
是的，這個更新會變更 Windows Packager 識別不安全檔案的方式。
...
下列嚴重性等級是假設弱點可能造成的最嚴重影響而評定。在本安全性公告發行的 30 天內，如需弱點易遭利用性與嚴重性等級和安全性影響之間對應關係的資訊，請參閱 [1 月份公告摘要](https://technet.microsoft.com/en-us/security/bulletin/ms12-jan)中的＜弱點入侵指數＞。如需更多資訊，請參閱 [Microsoft 弱點入侵指數](https://technet.microsoft.com/zh-tw/security/cc998259.aspx)。
...
Windows Packager 載入內嵌於 Microsoft Office 檔案的 ClickOnce 應用程式的方式中存在一個遠端執行程式碼弱點。

若要在「一般性弱點」清單標準條目中檢視此弱點，請參閱 [CVE-2012-0013](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0013) (英文)。

#### 組件執行弱點 - CVE-2012-0013 的緩和因素

緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少弱點影響的嚴重性。下列緩和因素可能對您的狀況有所助益：

-   惡意檔案可作為電子郵件的附件傳送，但攻擊者必須說服使用者開啟附件，才能利用弱點。
-   成功利用此弱點的攻擊者可以取得與本機使用者相同的使用者權限。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
-   若要在網路中進行部署，ClickOnce 部署的部署資訊清單和應用程式資訊清單必須使用數位憑證簽署。

#### 組件執行弱點 - CVE-2012-0013 的因應措施
...
-   **移除.application檔案關聯**
    ...
    **注意：** 如果使用「登錄編輯程式」的方式錯誤，可能造成嚴重問題，以致於您必須重新安裝作業系統。Microsoft 無法保證您可以解決因為不正確使用 \[登錄編輯程式\] 所造成的問題。請自行承擔使用「登錄編輯程式」的風險。如需有關如何編輯登錄的資訊，請檢視「登錄編輯程式」(Regedit.exe) 中的＜變更機碼及數值＞說明主題，或是 Regedt32.exe 中的＜新增及刪除登錄中的資訊＞與＜編輯登錄資料＞說明主題。
    ...
    若要移除 .application 檔案關聯，請執行下列步驟：

    **使用互動方法**

    1.  按一下 \[開始\]，按一下 \[執行\]，鍵入 **regedit**，然後按一下 \[確定\]。
    2.  展開 \[HKEY\_CLASSES\_ROOT\]，按一下 \[.application\]，再按一下 \[檔案\] 功能表，然後選取 \[匯出\]。
    3.  在 \[匯出登錄檔案\] 對話方塊中，鍵入 **application HKCR file association registry backup.reg**，再按一下 \[儲存\]。
    ...
    6.  按一下 \[.application\]，再按一下 \[檔案\] 功能表，然後選取 \[匯出\]。
    7.  在 \[匯出登錄檔案\] 對話方塊中，鍵入 **application HKCUfile association registry backup.reg**，再按一下 \[儲存\]。
        **注意：** 依預設，這個動作會在 \[我的文件\] 資料夾中建立這個登錄機碼的備份 **。**
    ...
    **使用管理的部署指令碼**
    ...
    2.  將下列登錄機碼儲存到副檔名為 .REG 的檔案中 (例如 Delete\_Application\_File\_Association.reg)：
    ...
    **因應措施的影響。**  這個因應措施可移除 .application 檔案關聯。連按兩下應用程式檔案將不再啟動應用程式。
    ...
    **如何復原因應措施。** 
    ...
    2.  按一下 \[檔案\] 功能表，再選取 \[匯入\]。
    3.  在 \[匯出登錄檔案\] 對話方塊中，選取 \[application HKCR file association registry backup.reg\]，再按一下 \[開啟\]。
    4.  按一下 \[檔案\] 功能表，再選取 \[匯入\]。
    5.  在 \[匯出登錄檔案\] 對話方塊中，選取 \[application HKCU file association registry backup.reg\]，再按一下 \[開啟\]。
...
#### 組件執行弱點 - CVE-2012-0013 的常見問題集

**這個弱點的範圍為何？**  
這是遠端執行程式碼的弱點。成功利用此弱點的攻擊者可以從遠端取得受影響系統的完整控制權。攻擊者接下來將能安裝程式，或檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。

**造成這個弱點的原因為何？**  
此弱點的成因為 ClickOnce 應用程式檔案類型未包含於 Windows Packager 不安全檔案類型清單中，如此一來 ClickOnce 應用程式便得以內嵌至 Microsoft Office 文件中。

**什麼是 ClickOnce？**  
ClickOnce 是一項可讓開發人員建立可自行更新之 Windows 應用程式的部署技術，這類應用程式的安裝與部署僅需極少的使用者互動。ClickOnce 應用程式是指使用 ClickOnce 技術發行的任何 Windows Presentation Foundation (.xbap)、Windows Forms (.exe)、主控台應用程式 (.exe) 或 Office 解決方案 (.dll)。ClickOnce 應用程式可以三種不同的方式發行： 透過網頁、網路檔案共用或 CD-ROM 之類的媒體。如需更多資訊，請參閱 MSDN 文章︰[ClickOnce 安全性和部署](https://msdn.microsoft.com/en-us/library/t71a733d.aspx)。

**攻擊者可能會利用這項弱點採取什麼行動？**  
這個弱點可讓攻擊者將 ClickOnce 應用程式安裝程式內嵌到 Microsoft Office 文件中，不需要任何使用者互動就可以執行程式碼。

**攻擊者如何利用這項弱點？**  
若要利用此弱點，必須讓使用者開啟蓄意製作的 Microsoft Office 檔案。

若是電子郵件攻擊，攻擊者可能會利用這項弱點，向使用者傳送內嵌 ClickOnce 應用程式之蓄意製作的 Microsoft Office 檔案，然後引誘使用者開啟該檔案。

在網頁攻擊的案例中，攻擊者必須架設網站，其中包含用來嘗試利用此弱點的 Office 檔案。此外，受侵害的網站以及接受或存放使用者提供之內容的網站裡，也可能包含蓄意製作以利用本弱點的內容。攻擊者並不能強迫使用者造訪蓄意製作的網站， 而是會引誘使用者造訪網站。一般的做法是設法讓使用者按一下連往攻擊者網站的連結，然後引誘使用者開啟蓄意製作的檔案。

**因為這個弱點而承受風險的主要系統有哪些？**  
使用 Microsoft Office 的系統 (包括工作站和終端伺服器) 的風險最高。若系統管理員允許使用者登入伺服器並執行程式，則伺服器可能遭受更大的風險。然而，最佳實務強烈建議您制止這種行為。

**更新的作用何在？**  
這項更新會變更 Windows Packager 檢查不安全檔案的方式。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 項目，或是 %Windir%\$NTUninstallKB2584146$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2584146">Microsoft 知識庫文件編號 2584146</a> (英文)</td>
</tr>
<tr class="even">
...
若要減少重新開機的可能性，請在安裝安全性更新之前，停止所有受影響的服務，並關閉所有可能使用受影響檔案的應用程式。如需系統為何會提示您重新開機的詳細資訊，請參閱 [Microsoft 知識庫文件編號 887012](https://support.microsoft.com/kb/887012)。
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
使用 \[控制台\] 中的 \[新增或移除程式\] 項目，或是 %Windir%\\$NTUninstallKB2584146$\\Spuninst 資料夾中的 Spuninst.exe 公用程式
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
請參閱 [Microsoft 知識庫文件編號 2584146](https://support.microsoft.com/kb/2584146) (英文)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   感謝 Yorick Koster 與 [Beyond Security 的 SecuriTeam Secure Disclosure](https://www.beyondsecurity.com/ssd.html) 計畫合作，回報組件執行弱點 - (CVE-2012-0013)
