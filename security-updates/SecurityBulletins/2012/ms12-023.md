---
TOCTitle: 'MS12-023'
Title: 'Microsoft Security Bulletin MS12-023 - 重大'
ms:assetid: 'ms12-023'
ms:contentKeyID: 61238755
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms12-023(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-023 - 重大
===========================================

Internet Explorer 積存資訊安全更新 (2675157)
--------------------------------------------
...
此資訊安全更新可解決 Internet Explorer 中五項未公開報告的資訊安全風險。最嚴重的資訊安全風險可能會在使用者以 Internet Explorer 檢視蓄意製作的網頁時，允許遠端執行程式碼。成功利用這類任一資訊安全風險的攻擊者可以取得與目前使用者相同的使用者權限。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
...
此資訊安全更新可修改 Internet Explorer 處理蓄意製作的 HTML 內容列印方式，以及 Internet Explorer 處理記憶體中物件的方式，以解決這些資訊安全風險。如需更多有關此資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
[Internet Explorer 6](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=2a490c62-16c4-402a-b2d9-3e8cfb5bcebd)  
(KB2675157)  
(中文下載更新程式)
...
<td style="border:1px solid black;">
[MS12-010](https://technet.microsoft.com/zh-tw/security/bulletin/ms12-010) 中的 KB2647516 由 KB2675157 取代
</td>
</tr>
...
[Internet Explorer 6](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=a1b7be43-a32e-456b-8df0-c26cdf187682)  
(KB2675157)  
(中文下載更新程式)
...
[Internet Explorer 6](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=020e0d68-dd1c-4297-b565-fcc6dcf5f280)  
(KB2675157)  
(中文下載更新程式)
...
[Internet Explorer 6](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=295292d3-01a3-4574-b994-8cdbcf5a0d2e)  
(KB2675157)  
(中文下載更新程式)
...
[Internet Explorer 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=81b28dd9-87aa-46cc-94c6-2da39d0298db)  
(KB2675157)  
(英文下載更新程式)
...
[Internet Explorer 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=29ec7b06-c7aa-4149-bb2c-25af7d38a6a9)  
(KB2675157)  
(中文下載更新程式)
...
[Internet Explorer 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=17b0c139-2709-424d-9d17-827af468e858)  
(KB2675157)  
(中文下載更新程式)
...
[Internet Explorer 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=04656a93-e958-4764-afe8-27c476855506)  
(KB2675157)  
(中文下載更新程式)
...
[Internet Explorer 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=a5ef0147-595e-43b5-819f-73780fcef10d)  
(KB2675157)  
(中文下載更新程式)
...
[Internet Explorer 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=f598cad1-4d1a-40ce-a016-bb58778d5dc0)  
(KB2675157)  
(中文下載更新程式)
...
[Internet Explorer 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=2717a997-2066-4a83-ae9b-4611a0851101)  
(KB2675157)  
(中文下載更新程式)
...
[Internet Explorer 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=3e361edd-234b-4053-aa49-278b9fde4d5c)\*\*  
(KB2675157)  
(中文下載更新程式)
...
[Internet Explorer 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=60b76a3c-4530-4101-931f-45df621e1eed)\*\*  
(KB2675157)  
(中文下載更新程式)
...
[Internet Explorer 8](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=74ce0e29-046b-4ac3-89a1-b292a177972f)  
(KB2675157)  
(中文下載更新程式)
...
[Internet Explorer 8](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=646c6352-4d99-413a-a75b-71289b5d2b25)  
(KB2675157)  
(中文下載更新程式)
...
[Internet Explorer 8](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=3289a80a-d1b1-4494-bede-03d0be579acf)  
(KB2675157)  
(中文下載更新程式)
...
[Internet Explorer 8](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=dff4fb63-b319-49ed-8a9d-6b15e43d5bfd)  
(KB2675157)  
(中文下載更新程式)
...
[Internet Explorer 8](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=44284277-06a7-405d-9187-8f50a042604d)  
(KB2675157)  
(中文下載更新程式)
...
[Internet Explorer 8](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=19684033-ddeb-464f-9a22-f580a9c19f8e)  
(KB2675157)  
(中文下載更新程式)
...
[Internet Explorer 8](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=6eb6781e-7b38-4679-afbc-4e3bb5747fd8)\*\*  
(KB2675157)  
(中文下載更新程式)
...
[Internet Explorer 8](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=9a58ca0b-fad7-418e-80ae-ca478168f887)  
(KB2675157)  
(中文下載更新程式)
...
[Internet Explorer 8](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=7215f707-c536-4d81-ad66-e7bff592e400)  
(KB2675157)  
(中文下載更新程式)
...
[Internet Explorer 8](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=237d94e6-b9b9-4177-81fa-a67df2806b0e)\*\*  
(KB2675157)  
(中文下載更新程式)
...
[Internet Explorer 8](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=7bdba902-0a6e-451e-a29b-6d0a03ff5664)  
(KB2675157)  
(中文下載更新程式)
...
[Internet Explorer 9](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=51088164-13b7-4216-90f1-20c92c8b8ca9)  
(KB2675157)  
(中文下載更新程式)
...
[Internet Explorer 9](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=bbb99aee-aadd-4ec7-9e27-91cb8d90803e)  
(KB2675157)  
(中文下載更新程式)
...
[Internet Explorer 9](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=d34d7981-ed63-460d-95e4-e6da1ac41d2f)\*\*  
(KB2675157)  
(中文下載更新程式)
...
[Internet Explorer 9](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=c9d773e9-6a2e-45db-8f30-7da0082d909c)\*\*  
(KB2675157)  
(中文下載更新程式)
...
[Internet Explorer 9](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=e6724be3-ff4b-4dea-95f3-0b13998b6758)  
(KB2675157)  
(中文下載更新程式)
...
[Internet Explorer 9](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=0ff822d0-074a-409c-9174-8100618c6171)  
(KB2675157)  
(中文下載更新程式)
...
[Internet Explorer 9](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=d002bfe4-10e9-46d3-a460-06d112201ca5)\*\*  
(KB2675157)  
(中文下載更新程式)
...
是。KB2675157 更新可供 Windows 開發人員預覽版本使用。建議 Windows 開發人員預覽的客戶套用更新至其系統。該更新只在 [Windows Update](https://update.microsoft.com/windowsupdate/v6/default.aspx) 提供。
...
下列嚴重性等級是假設資訊安全風險可能造成的最嚴重影響而評定。在本資訊安全公告發行的 30 天內，如需資訊安全風險之易遭利用性與嚴重性等級和資訊安全影響之間對應關係的資訊，請參閱 [4 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms12-apr)中的＜資訊安全風險入侵指數＞。如需更多資訊，請參閱 [Microsoft 資訊安全風險入侵指數](https://technet.microsoft.com/zh-tw/security/cc998259.aspx)。
...
<th style="border:1px solid black;" >
列印功能遠端執行程式碼資訊安全風險 - CVE-2012-0168
</th>
<th style="border:1px solid black;" >
JScript9 遠端執行程式碼資訊安全風險 - CVE-2012-0169
</th>
<th style="border:1px solid black;" >
OnReadyStateChange 遠端執行程式碼資訊安全風險 - CVE-2012-0170
</th>
<th style="border:1px solid black;" >
SelectAll 遠端執行程式碼資訊安全風險 - CVE-2012-0171
</th>
<th style="border:1px solid black;" >
VML 樣式遠端執行程式碼資訊安全風險 - CVE-2012-0172
</th>
<th style="border:1px solid black;" >
彙總嚴重性等級
</th>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
適用於 x64 型系統之 Windows Server 2008 R2 的 Internet Explorer 9\*\*
</td>
<td style="border:1px solid black;">
中度   
遠端執行程式碼
...
<tr>
<td style="border:1px solid black;">
適用於 x64 型系統之 Windows Server 2008 R2 Service Pack 1 的 Internet Explorer 9\*\*
</td>
<td style="border:1px solid black;">
中度   
遠端執行程式碼
...
在 Internet Explorer 嘗試列印蓄意製作的 HTML 網頁中，存在遠端執行程式碼資訊安全風險。此資訊安全風險可讓攻擊者在目前使用者的內容中執行任意程式碼。

若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-0168](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0168) (英文)。

#### 列印功能遠端執行程式碼資訊安全風險 - CVE-2012-0168 的緩和因素

緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。下列緩和因素可能對您的狀況有所助益：

-   從 Internet Explorer 列印時，預設不會啟用 \[列印連結表\] 選項。唯有當手動選取此功能的客戶在列印網頁時，才可能受此問題影響。
-   成功利用此資訊安全風險的攻擊者可以取得與目前使用者相同的使用者權限。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

#### 列印功能遠端執行程式碼資訊安全風險 - CVE-2012-0168 的因應措施

Microsoft 尚未找到此項資訊安全風險的任何因應措施。

#### 列印功能遠端執行程式碼資訊安全風險 - CVE-2012-0168 的常見問題集

這個資訊安全風險的範圍為何？  
這是遠端執行程式碼的資訊安全風險。

造成這個資訊安全風險的原因為何？  
在某些情況下，Internet Explorer 不恰當地處理蓄意製作之 HTML 網頁的列印。
...
攻擊者如何利用這項 資訊安全風險？  
此資訊安全風險要求使用者在嘗試列印蓄意製作的 HTML 內容，需要啟用 \[列印連結表\] 選項。

在網頁型攻擊的案例中，攻擊者可以針對經由 Internet Explorer 所引起的資訊安全風險，設計並架設蓄意製作的網站，然後引誘使用者檢視該網站，並在啟用 \[列印連結表\] 選項的情況下列印網頁。一名攻擊者也可以嵌入一個 ActiveX 控制項，該控制項在內含 IE 轉譯引擎的應用程式或 Microsoft Office 文件中標示為「安全的初始化」。攻擊者也可能利用受侵害的網站，以及接受或裝載使用者提供內容或廣告的網站。這些網站可能含有經過蓄意製作並利用此資訊安全風險的內容。但是，攻擊者無法強迫使用者檢視和列印受攻擊者控制的內容。此外，攻擊者無法自動啟用 \[列印連結表\] 選項， 而是引誘使用者自行前往。一般的做法是設法讓使用者按一下電子郵件訊息或 Instant Messenger 訊息中通往攻擊者網站的連結，或開啟經由電子郵件傳送的附件，然後引誘使用者啟用 \[列印連結表\] 選項來嘗試列印蓄意製作的內容。

在電子郵件型攻擊案例中，攻擊者可將蓄意製作的電子郵件訊息傳送至潛在受害者，然後引誘潛在受害者嘗試啟用 \[列印連結表\] 選項來列印電子郵件訊息。此攻擊模式只能利用支援 \[列印連結表\] 選項的電子郵件應用程式，例如 Microsoft Outlook 2003、Microsoft Outlook Express、Windows Mail 和 Windows Live Mail。但是，如果使用網頁式電子郵件服務，則可能利用網頁式攻擊。

因為這個資訊安全風險而承受風險的主要系統有哪些？  
常使用 Internet Explorer 的系統 (例如工作站或終端伺服器) 的風險最大。

更新的作用何在？  
此更新會修改 Internet Explorer 處理蓄意製作的 HTML 內容之列印方式，藉以解決此項資訊安全風險。對 Internet Explorer 的變更也可以解決透過 Microsoft Outlook 2003、Microsoft Outlook Express、Windows Mail 和 Windows Live Mail 的電子郵件攻擊模式。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-0169](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0169) (英文)。

#### JScript9 遠端執行程式碼資訊安全風險 - CVE-2012-0169 的緩和因素
...
#### JScript9 遠端執行程式碼資訊安全風險 - CVE-2012-0169 的因應措施

因應措施指的是無法徹底修正資訊安全風險，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：

-   將 \[網際網路\] 及 \[近端內部網路\] 安全性區域設定為 \[高\]，可封鎖這些區域中的 ActiveX 控制項及動態指令碼處理

    只要將網際網路安全性區域設定變更為封鎖 ActiveX 控制項及動態指令碼處理，即可防範這個資訊安全風險遭到利用。做法是將瀏覽器的資訊安全設定設為 \[高\]。
...
#### JScript9 遠端執行程式碼資訊安全風險 - CVE-2012-0169 的常見問答集
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-0170](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0170) (英文)。

#### OnReadyStateChange 遠端執行程式碼資訊安全風險 - CVE-2012-0170 的緩和因素
...
#### OnReadyStateChange 遠端執行程式碼資訊安全風險 - CVE-2012-0170 的因應措施
...
#### OnReadyStateChange 遠端執行程式碼資訊安全風險 - CVE-2012-0170 的常見問題集
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-0171](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0171) (英文)。

#### SelectAll 遠端執行程式碼資訊安全風險 - CVE-2012-0171 的緩和因素
...
#### SelectAll 遠端執行程式碼資訊安全風險 - CVE-2012-0171 的因應措施
...
#### SelectAll 遠端執行程式碼資訊安全風險 - CVE-2012-0171 的常見問題集
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-0172](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0172) (英文)。

#### VML 樣式遠端執行程式碼資訊安全風險 - CVE-2012-0172 的緩和因素
...
#### VML 樣式遠端執行程式碼資訊安全風險 - CVE-2012-0172 的因應措施
...
#### VML 樣式遠端執行程式碼資訊安全風險 - CVE-2012-0172 的常見問題集
...
資訊安全更新可從 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 以及 [](https://www.update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=zh-tw)[Windows Update](https://update.microsoft.com/windowsupdate/v6/default.aspx)</a> 取得。資訊安全更新也可以從 [Microsoft 下載中心](https://www.microsoft.com/downloads/en/results.aspx?displaylang=en&freetext=security%20update)取得。您也可以利用「資訊安全更新」("security update") 關鍵字搜尋輕易地找到資訊安全更新。
...
<td style="border:1px solid black;">適用於所有 Windows XP 支援版本的 Internet Explorer 6：使用 [控制台] 中的 [新增或移除程式]</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於所有 Windows XP 支援版本的 Internet Explorer 7：<br />
使用 [控制台] 中的 [新增或移除程式] 工具，或 %Windir%\ie7updates\KB2675157-IE7\spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">適用於所有 Windows XP 支援版本的 Internet Explorer 8：<br />
使用 [控制台] 中的 [新增或移除程式] 工具，或 %Windir%\ie8updates\KB2675157-IE8\spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">檔案資訊</td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2675157?ln=zh-tw">Microsoft 知識庫文件編號 2675157</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">移除資訊</td>
<td style="border:1px solid black;">所有受支援 32 位元版本、x64 版本和 Itanium 版本 Windows Server 2003 的 Internet Explorer 6：<br />
使用 [控制台] 中的 [新增或移除程式] 工具，或 %Windir%\$NTUninstallKB2675157$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">所有受支援 32 位元版本、x64 版本和 Itanium 版本 Windows Server 2003 的 Internet Explorer 7：<br />
...
-   感謝 [AISec](https://www.aisec.cn/) 的 linx2008 回報列印功能遠端執行程式碼資訊安全風險 (CVE-2012-0168)  
-   感謝 [TOPdesk](https://www.topdesk.com/) 的 Roel Spilker 回報 JScript9 遠端執行程式碼資訊安全風險 (CVE-2012-0169)  
-   感謝 Jose Antonio Vazquez Gonzalez 與 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作，回報 OnReadyStateChange 遠端執行程式碼資訊安全風險 (CVE-2012-0170)  
-   感謝匿名研究人員與 [TippingPoint 的](https://www.tippingpoint.com/)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作回報 SelectAll 遠端執行程式碼資訊安全風險 (CVE-2012-0171)  
-   感謝匿名研究人員與 [TippingPoint 的](https://www.tippingpoint.com/)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作回報 VML 樣式遠端執行程式碼資訊安全風險 (CVE-2012-0172)  
...
-   IT 專業人員的資訊安全解決方案： [TechNet 安全性疑難排解與支援](https://technet.microsoft.com/security/bb980617.aspx)  
-   協助保護您的 Windows 電腦免於病毒和惡意軟體攻擊： [病毒與安全性解決方案中心](https://support.microsoft.com/contactus/cu_sc_virsec_master?ln=zh-tw)  
