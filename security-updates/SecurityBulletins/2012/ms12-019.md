...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=7da5b341-6a6f-46de-8d01-448da38e9908">Windows Vista Service Pack 2</a><br />
(英文下載更新程式)<br />
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=7da5b341-6a6f-46de-8d01-448da38e9908">Windows Vista Service Pack 2</a><br />
(中文下載更新程式)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=1ba25d9c-0fef-471f-8e30-045fe9586a9c">Windows Vista x64 Edition Service Pack 2</a><br />
(英文下載更新程式)<br />
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=1ba25d9c-0fef-471f-8e30-045fe9586a9c">Windows Vista x64 Edition Service Pack 2</a><br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">阻絕服務</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=45a4784e-5051-4628-9a19-d53f30c1fdf3">適用於 32 位元系統的 Windows Server 2008 Service Pack 2</a>**<br />
(英文下載更新程式)<br />
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=45a4784e-5051-4628-9a19-d53f30c1fdf3">適用於 32 位元系統的 Windows Server 2008 Service Pack 2</a>**<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">阻絕服務</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=503cb9c0-d6db-4deb-a555-67af0b25739b">適用於 x64 型系統的 Windows Server 2008 Service Pack 2</a>**<br />
(英文下載更新程式)<br />
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=503cb9c0-d6db-4deb-a555-67af0b25739b">適用於 x64 型系統的 Windows Server 2008 Service Pack 2</a>**<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">阻絕服務</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=f3a14012-38ae-490e-a48e-7c851f82a7e6">適用於 32 位元系統的 Windows 7 和適用於 32 位元系統的 Windows 7 Service Pack 1</a><br />
(英文下載更新程式)<br />
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=f3a14012-38ae-490e-a48e-7c851f82a7e6">適用於 32 位元系統的 Windows 7 和適用於 32 位元系統的 Windows 7 Service Pack 1</a><br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">阻絕服務</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=760b5aa4-4e65-4ff1-9ae2-771234803bf0">適用於 x64 型系統的 Windows 7 和適用於 x64 型系統的 Windows 7 Service Pack 1</a><br />
(英文下載更新程式)<br />
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=760b5aa4-4e65-4ff1-9ae2-771234803bf0">適用於 x64 型系統的 Windows 7 和適用於 x64 型系統的 Windows 7 Service Pack 1</a><br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">阻絕服務</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=86095b20-5869-4b55-8777-ee0af82aaf37">適用於 x64 型系統的 Windows Server 2008 R2 和適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1</a>**<br />
(英文下載更新程式)<br />
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=86095b20-5869-4b55-8777-ee0af82aaf37">適用於 x64 型系統的 Windows Server 2008 R2 和適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1</a>**<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">阻絕服務</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=dc5c336f-329c-4a56-8b24-555e3c8afd50">適用於 Itanium 型系統的 Windows Server 2008 R2 和適用於 Itanium 型系統的 Windows Server 2008 R2 Service Pack 1</a><br />
(英文下載更新程式)</td>
<td style="border:1px solid black;">阻絕服務</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
...
注意：在受支援版本的 Windows Vista 和 Windows Server 2008 上，預設不會安裝 DirectWrite。在這些作業系統上，會在下列任何更新過程中安裝 DirectWrite： [Windows 圖形、影像及 XPS 程式庫 (KB971512)](http://support.microsoft.com/kb/971512?ln=zh-tw)、平台更新補充程式 (KB2117917) 或 [DirectWrite 和 XPS 的更新 (KB2505189)](http://support.microsoft.com/kb/2505189?ln=zh-tw)。請注意，這些更新是透過自動更新提供。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-0156](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0156) (英文)。
...
什麼是 DirectWrite？   
DirectWrite 是一種全 Unicode、無關解析度、可轉譯多重格式文字的 API，它支援測量、繪圖及文字的點擊測試。如需更多關於 DirectWrite 的資訊，請參閱 MSDN 文章 [DirectWrite 簡介](http://msdn.microsoft.com/en-us/library/windows/desktop/dd371554(v=vs.85).aspx) (英文)。
...
是。這項資訊安全風險已經遭到公開揭發。這項資訊安全風險已被指派「一般性資訊安全風險」編號 [CVE-2012-0156](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0156) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2665364?ln=zh-tw">Microsoft 知識庫文件編號 2665364</a></td>
</tr>
<tr class="odd">
