---
TOCTitle: 'MS12-019'
Title: 'Microsoft Security Bulletin MS12-019 - 中等'
ms:assetid: 'ms12-019'
ms:contentKeyID: 61238751
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms12-019(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-019 - 中等
===========================================

DirectWrite 中的資訊安全風險可能會允許阻斷服務 (2665364)
--------------------------------------------------------
...
此資訊安全更新可解決 Windows DirectWrite 中一項公開揭露的資訊安全風險。在 Instant Messenger 型攻擊的情況中，如果攻擊者將蓄意製作的 Unicode 字元序列直接傳送至 Instant Messenger 用戶端，此資訊安全風險可能會允許阻斷服務。當 DirectWrite 轉譯蓄意製作的 Unicode 字元序列時，目標應用程式可能會變成沒有回應而無法繼續。

對於所有受支援版本的 Windows Vista、Windows Server 2008 (適用於 Itanium 型系統的 Windows Server 2008 除外)、Windows 7 和 Windows Server 2008 R2，此資訊安全更新的等級為「中度」。如需詳細資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此資訊安全更新藉由變更 DirectWrite 轉譯 Unicode 字元的方式，來解決這些資訊安全風險。如需更多有關此資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7da5b341-6a6f-46de-8d01-448da38e9908">Windows Vista Service Pack 2</a><br />
(英文下載更新程式)<br />
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=7da5b341-6a6f-46de-8d01-448da38e9908">Windows Vista Service Pack 2</a><br />
(中文下載更新程式)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1ba25d9c-0fef-471f-8e30-045fe9586a9c">Windows Vista x64 Edition Service Pack 2</a><br />
(英文下載更新程式)<br />
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=1ba25d9c-0fef-471f-8e30-045fe9586a9c">Windows Vista x64 Edition Service Pack 2</a><br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">阻絕服務</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=45a4784e-5051-4628-9a19-d53f30c1fdf3">適用於 32 位元系統的 Windows Server 2008 Service Pack 2</a>**<br />
(英文下載更新程式)<br />
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=45a4784e-5051-4628-9a19-d53f30c1fdf3">適用於 32 位元系統的 Windows Server 2008 Service Pack 2</a>**<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">阻絕服務</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=503cb9c0-d6db-4deb-a555-67af0b25739b">適用於 x64 型系統的 Windows Server 2008 Service Pack 2</a>**<br />
(英文下載更新程式)<br />
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=503cb9c0-d6db-4deb-a555-67af0b25739b">適用於 x64 型系統的 Windows Server 2008 Service Pack 2</a>**<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">阻絕服務</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f3a14012-38ae-490e-a48e-7c851f82a7e6">適用於 32 位元系統的 Windows 7 和適用於 32 位元系統的 Windows 7 Service Pack 1</a><br />
(英文下載更新程式)<br />
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=f3a14012-38ae-490e-a48e-7c851f82a7e6">適用於 32 位元系統的 Windows 7 和適用於 32 位元系統的 Windows 7 Service Pack 1</a><br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">阻絕服務</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=760b5aa4-4e65-4ff1-9ae2-771234803bf0">適用於 x64 型系統的 Windows 7 和適用於 x64 型系統的 Windows 7 Service Pack 1</a><br />
(英文下載更新程式)<br />
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=760b5aa4-4e65-4ff1-9ae2-771234803bf0">適用於 x64 型系統的 Windows 7 和適用於 x64 型系統的 Windows 7 Service Pack 1</a><br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">阻絕服務</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=86095b20-5869-4b55-8777-ee0af82aaf37">適用於 x64 型系統的 Windows Server 2008 R2 和適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1</a>**<br />
(英文下載更新程式)<br />
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=86095b20-5869-4b55-8777-ee0af82aaf37">適用於 x64 型系統的 Windows Server 2008 R2 和適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1</a>**<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">阻絕服務</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=dc5c336f-329c-4a56-8b24-555e3c8afd50">適用於 Itanium 型系統的 Windows Server 2008 R2 和適用於 Itanium 型系統的 Windows Server 2008 R2 Service Pack 1</a><br />
(英文下載更新程式)</td>
<td style="border:1px solid black;">阻絕服務</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
...
注意：在受支援版本的 Windows Vista 和 Windows Server 2008 上，預設不會安裝 DirectWrite。在這些作業系統上，會在下列任何更新過程中安裝 DirectWrite： [Windows 圖形、影像及 XPS 程式庫 (KB971512)](https://support.microsoft.com/kb/971512?ln=zh-tw)、平台更新補充程式 (KB2117917) 或 [DirectWrite 和 XPS 的更新 (KB2505189)](https://support.microsoft.com/kb/2505189?ln=zh-tw)。請注意，這些更新是透過自動更新提供。
...
<th style="border:1px solid black;" >DirectWrite 應用程式阻斷服務資訊安全風險 - CVE-2012-0156</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
DirectWrite 應用程式阻斷服務資訊安全風險 - CVE-2012-0156  
--------------------------------------------------------
  

在 DirectWrite 轉譯蓄意製作之 Unicode 字元序列的方式中，存在阻斷服務資訊安全風險。成功利用此資訊安全風險的攻擊者可使目標應用程式停止回應。
  
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-0156](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0156) (英文)。
  
#### DirectWrite 應用程式阻斷服務資訊安全風險 CVE-2012-0156 的緩和因素
  
Microsoft 尚未找到此項資訊安全風險的任何緩和因素。
  
#### DirectWrite 應用程式阻斷服務資訊安全風險 CVE-2012-0156 的因應措施
  
Microsoft 尚未找到此項資訊安全風險的任何因應措施。
  
#### DirectWrite 應用程式阻斷服務資訊安全風險 CVE-2012-0156 的常見問題集
  
這個資訊安全風險的範圍為何？    
這是一項阻斷服務的資訊安全風險。
  
造成這個資訊安全風險的原因為何？    
當 DirectWrite 不正確地轉譯記憶體中蓄意製作的 Unicode 字元序列，這時便會形成此資訊安全風險。
  
什麼是 DirectWrite？    
DirectWrite 是一種全 Unicode、無關解析度、可轉譯多重格式文字的 API，它支援測量、繪圖及文字的點擊測試。如需更多關於 DirectWrite 的資訊，請參閱 MSDN 文章 [DirectWrite 簡介](https://msdn.microsoft.com/en-us/library/windows/desktop/dd371554(v=vs.85).aspx) (英文)。
  
攻擊者可能會利用這項資訊安全風險採取什麼行動？    
成功利用此資訊安全風險的攻擊者可使目標應用程式 (例如 Windows Live Messenger) 停止回應。
  
攻擊者如何利用這項 資訊安全風險？    
在網頁式攻擊的情況中，未經驗證的攻擊者必須架設一個含有蓄意製作之 Unicode 字元序列的網站。此外，受侵害的網站以及接受或存放使用者提供之內容的網站裡，也可能包含蓄意製作以利用本資訊安全風險的內容。使用 DirectWrite 轉譯網頁內容的應用程式須剖析蓄意製作的 Unicode 字元序列，才能夠利用此資訊安全風險。當 DirectWrite 轉譯蓄意製作的 Unicode 字元序列時，受影響的應用程式可能會成沒有回應而無法繼續。但無論如何，攻擊者絕對無法強迫使用者造訪主控含蓄意製作 Unicode 字元序列之內容的網站。而是引誘使用者自行前往。一般的做法是設法讓使用者按一下電子郵件中或 Instant Messenger 訊息中連往攻擊者網站的連結。
  
在 Instant Messenger 型攻擊的情況中，未經驗證的攻擊者可將蓄意製作的 Unicode 字元序列直接傳送至 Windows Live Messenger 等 Instant Messenger 用戶端，藉此利用此資訊安全風險。當 DirectWrite 轉譯蓄意製作的 Unicode 字元序列時，目標應用程式可能會變成沒有回應而無法繼續。
  
因為這個資訊安全風險而承受風險的主要系統有哪些？    
工作站與終端機伺服器受此資訊安全風險影響的風險最高。若系統管理員允許使用者登入伺服器並執行程式，則伺服器可能遭受更大的風險。然而，最佳實務強烈建議您制止這種行為。
  
更新的作用何在？    
此更新藉由變更 DirectWrite 轉譯 Unicode 字元的方式，來解決這些資訊安全風險。
  
當資訊安全公告發行時，這項資訊安全風險是否已揭發出來？    
是。這項資訊安全風險已經遭到公開揭發。這項資訊安全風險已被指派「一般性資訊安全風險」編號 [CVE-2012-0156](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0156) (英文)。
  
當本資訊安全公告發行時，Microsoft 是否已接獲任何消息，指出這項資訊安全風險已遭有心人士利用？    
否。當本資訊安全公告初次發行時，Microsoft 尚未接獲任何有關本資訊安全風險遭公開使用以攻擊客戶的消息
...
SMS 2003 可使用 Microsoft Update SMS 2003 盤點工具 (ITMU) 來偵測由 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 所提供，並由 [Windows Server Update Services](https://go.microsoft.com/fwlink/?linkid=50120) 支援的資訊安全更新。如需 SMS 2003 ITMU 的詳細資訊，請參閱 [Microsoft Updates SMS 2003 盤點工具](https://technet.microsoft.com/zh-tw/sms/bb676783.aspx) (英文)。如需更多關於 SMS 掃描工具的資訊，請參閱 [SMS 2003 軟體更新掃描工具](https://technet.microsoft.com/en-us/sms/bb676786.aspx) (英文)。另請參閱適用於 Systems Management Server 2003 的下載 (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2665364?ln=zh-tw">Microsoft 知識庫文件編號 2665364</a></td>
</tr>
<tr class="odd">
...
-   感謝 Khaled M. Salameh 回報 DirectWrite 應用程式阻斷服務資訊安全風險 (CVE-2012-0156)
