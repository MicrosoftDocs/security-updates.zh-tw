...
<td style="border:1px solid black;">
KB2655992 取代 [MS10-049](http://go.microsoft.com/fwlink/?linkid=197104) 中的 KB980436
</td>
</tr>
...
<td style="border:1px solid black;">
KB2655992 取代 [MS12-006](http://go.microsoft.com/fwlink/?linkid=232510) 中的 KB2585542
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2655992 取代 [MS10-085](http://go.microsoft.com/fwlink/?linkid=201705) 中的 KB2207566
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
**何處可找到資訊安全更新的雜湊？**  
資訊安全更新的 SHA1 和 SHA2 雜湊可用來驗證下載之資訊安全更新套件的真實性。如需此更新的相關雜湊資訊，請參閱 [Microsoft 知識庫文件編號 2655992](http://support.microsoft.com/kb/2655992)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-1870](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1870) (英文)。
...
-   **在執行Windows Vista、Windows Server 2008、Windows 7或Windows Server 2008 R2之系統上的伺服器軟體中，排定優先處理RC4演算法**
    ...
    此攻擊只會影響在 CBC 模式中使用對稱式加密演算法的加密套件，例如 AES，並不影響 RC4 演算法。您可以在伺服器軟體中排定優先處理 RC4 演算法，以促進安全的通訊 (使用 RC4 而非 CBC 模式)。請參閱這篇 MSDN 文章：[排定 Schannel 加密套件優先順序](http://msdn.microsoft.com/en-us/library/bb870930%28v=vs.85%29.aspx) (英文)，瞭解如何執行此作業。
...
如需更多資訊，請參閱 TechNet 文章：[TLS/SSL 如何運作](http://technet.microsoft.com/en-us/library/cc783349(ws.10).aspx) (英文)。
...
是。此資訊安全風險已經遭到公開揭發。這項資訊安全風險已被指派一般性資訊安全風險編號 [CVE-2012-1870](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1870) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2655992">Microsoft 知識庫文件編號 2655992</a></td>
</tr>
<tr class="even">
