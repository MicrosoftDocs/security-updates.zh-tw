---
TOCTitle: 'MS12-024'
Title: 'Microsoft Security Bulletin MS12-024 - 重大'
ms:assetid: 'ms12-024'
ms:contentKeyID: 61238756
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms12-024(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-024 - 重大
===========================================

Windows 中的資訊安全風險可能會允許遠端執行程式碼 (2653956)
----------------------------------------------------------

發行: 2012年4月10日 | 更新: 2012年8月8日
...
這個資訊安全更新可解決 Microsoft Windows 中一項未公開報告的資訊安全風險。如果使用者或應用程式在受影響的系統上執行或安裝蓄意製作、已簽署的可攜式執行檔 (PE) 檔案，則此資訊安全風險可能會允許遠端執行程式碼。

對於所有受支援版本的 Microsoft Windows，此資訊安全更新的等級為「重大」。如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此資訊安全更新會修改 Windows Authenticode 簽章驗證功能在驗證可攜式執行檔時執行 Windows Authenticode 簽章驗證的方式，進而解決此資訊安全風險。如需更多有關此資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
**已知問題。** [Microsoft 知識庫文件編號 2653956](http://support.microsoft.com/kb/2653956?ln=zh-tw) 中記載了客戶安裝此資訊安全更新時，可能會發生的目前已知問題。該文件並說明了解決這些問題的建議解決方案。
...
(KB2653956)<br />
(英文下載更新程式)<br />
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=575afd20-cee4-4fa9-b781-9f8dfdd41ebe">Windows XP Service Pack 3</a><br />
(KB2653956)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/zh-tw/security/bulletin/ms10-019">MS10-019</a>中的 KB978601 由 KB2653956 取代</td>
</tr>
<tr class="even">
...
(KB2653956)<br />
(英文下載更新程式)<br />
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=f79c8940-ca31-4ff7-924e-847f5eef7864">Windows Server 2003 Service Pack 2</a><br />
(KB2653956)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
(KB2653956)<br />
(英文下載更新程式)<br />
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=03ebf111-1e7b-4dc2-b84f-a26c6b5f0d58">Windows Server 2003 x64 Edition Service Pack 2</a><br />
(KB2653956)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=734ff97a-7d72-4bfe-9557-7fac91902f8e">適用於 Itanium 型系統的 Windows Server 2003 SP2</a><br />
(KB2653956)<br />
(英文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
(KB2653956)<br />
(英文下載更新程式)<br />
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=c7683919-6d46-4b3e-aa98-1bef20141835">Windows Vista Service Pack 2</a><br />
(KB2653956)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
(KB2653956)<br />
(英文下載更新程式)<br />
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=4d9f8a6e-17bd-4ed3-8bc7-d5e3b11ca12a">Windows Vista x64 Edition Service Pack 2</a><br />
(KB2653956)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c36c20f7-a742-4151-b8f2-85ef80479d06">適用於 32 位元系統的 Windows Server 2008 Service Pack 2</a>*<br />
(KB2653956)<br />
(英文下載更新程式)<br />
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=c36c20f7-a742-4151-b8f2-85ef80479d06">適用於 32 位元系統的 Windows Server 2008 Service Pack 2</a>*<br />
(KB2653956)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=330cea47-221d-439e-b106-58a146fc28ee">適用於 x64 型系統的 Windows Server 2008 Service Pack 2</a>*<br />
(KB2653956)<br />
(英文下載更新程式)<br />
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=330cea47-221d-439e-b106-58a146fc28ee">適用於 x64 型系統的 Windows Server 2008 Service Pack 2</a>*<br />
(KB2653956)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1ec74522-ec1e-4b3c-bfeb-6a505cc4f11a">適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2</a><br />
(KB2653956)<br />
(英文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ac183b66-0247-4ae5-bda0-e8d0070917c8">適用於 32 位元系統的 Windows 7</a><br />
(KB2653956)<br />
(英文下載更新程式)<br />
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=ac183b66-0247-4ae5-bda0-e8d0070917c8">適用於 32 位元系統的 Windows 7</a><br />
(KB2653956)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ac183b66-0247-4ae5-bda0-e8d0070917c8">適用於 32 位元系統的 Windows 7 Service Pack 1</a><br />
(KB2653956)<br />
(英文下載更新程式)<br />
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=ac183b66-0247-4ae5-bda0-e8d0070917c8">適用於 32 位元系統的 Windows 7 Service Pack 1</a><br />
(KB2653956)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=27226e64-266f-499e-8c57-866593fc3430">適用於 x64 型系統的 Windows 7</a><br />
(KB2653956)<br />
(英文下載更新程式)<br />
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=27226e64-266f-499e-8c57-866593fc3430">適用於 x64 型系統的 Windows 7</a><br />
(KB2653956)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=27226e64-266f-499e-8c57-866593fc3430">適用於 x64 型系統的 Windows 7 Service Pack 1</a><br />
(KB2653956)<br />
(英文下載更新程式)<br />
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=27226e64-266f-499e-8c57-866593fc3430">適用於 x64 型系統的 Windows 7 Service Pack 1</a><br />
(KB2653956)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=54db1495-31bb-4435-a442-74e484630b8a">適用於 x64 型系統的 Windows Server 2008 R2</a>*<br />
(KB2653956)<br />
(英文下載更新程式)<br />
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=54db1495-31bb-4435-a442-74e484630b8a">適用於 x64 型系統的 Windows Server 2008 R2</a>*<br />
(KB2653956)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=54db1495-31bb-4435-a442-74e484630b8a">適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1</a>*<br />
(KB2653956)<br />
(英文下載更新程式)<br />
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=54db1495-31bb-4435-a442-74e484630b8a">適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1</a>*<br />
(KB2653956)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9a4115bf-028b-4dcc-8995-d3341fdf42f2">適用於 Itanium 型系統的 Windows Server 2008 R2</a><br />
(KB2653956)<br />
(英文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9a4115bf-028b-4dcc-8995-d3341fdf42f2">適用於 Itanium 型系統的 Windows Server 2008 R2 Service Pack 1</a><br />
(KB2653956)<br />
(英文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
是。KB2653956 更新可供 Windows 開發人員預覽版本使用。建議 Windows 開發人員預覽的客戶將更新套用至其系統。該更新只在 [Windows Update](http://update.microsoft.com/windowsupdate/v6/default.aspx) 提供。
  
**Windows 8 Consumer Preview是否會受此公告中指出的資訊安全風險影響？**    
是。KB2653956 更新可供 Windows 8 Consumer Preview 版本使用。建議 Windows Consumer Preview 的客戶將更新套用至其系統。該更新只在 [Windows Update](http://update.microsoft.com/windowsupdate/v6/default.aspx) 提供。
  
**我已套用此更新，但現在軟體的數位簽章無效。該怎麼辦？**  
此更新會造成 Windows Authenticode 簽章驗證功能對 PE 檔案執行嚴格的驗證。如果 Windows 判斷檔案中有不符合 Authenticode 規格的內容，則會將 PE 檔案視為「未簽署」。這可能會影響一些安裝程式。如果您正在使用受影響的安裝程式，Microsoft 建議您在使用安裝程式時，僅從已簽署檔案之通過驗證的部分解壓縮內容。
  
若在套用簽章後將其他內容附加至檔案，也會將 PE 檔案視為「未簽署」。在發行二進位檔前的建構程序中，應用程式簽署應該是最後一個步驟。如需上述問題及此資訊安全更新其他已知問題的更多資訊，請參閱 [Microsoft 知識庫文件編號 2653956](http://support.microsoft.com/kb/2653956?ln=zh-tw)。
  
**此更新是否包含功能上的任何安全性相關變更？**    
是。除了本公告＜資訊安全風險資訊＞一節中列出的變更外，此更新還包含若干深度防禦更新，可協助改善 Windows 中的資訊安全相關功能。
...
<th style="border:1px solid black;" >WinVerifyTrust 簽章驗證資訊安全風險 - CVE-2012-0151</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
WinVerifyTrust 簽章驗證資訊安全風險 - CVE-2012-0151  
---------------------------------------------------
  

用於可攜式執行檔 (PE) 檔案的 Windows Authenticode 簽章驗證功能中，存在遠端執行程式碼的資訊安全風險。匿名攻擊者可透過這個方法來利用此資訊安全風險：修改現有的已簽署執行檔，將惡意程式碼加入檔案且不讓簽章失效，藉此利用檔案未經驗證的部分。成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-0151](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0151) (英文)。
  
#### WinVerifyTrust 簽章驗證資訊安全風險 - CVE-2012-0151 的緩和因素
  
Microsoft 尚未找到此項資訊安全風險的任何緩和因素。
  
#### WinVerifyTrust 簽章驗證資訊安全風險 - CVE-2012-0151 的因應措施
  
Microsoft 尚未找到此項資訊安全風險的任何因應措施。
  
#### WinVerifyTrust 簽章驗證資訊安全風險 - CVE-2012-0151 的常見問題集
  
**這個資訊安全風險的範圍為何？**    
這是遠端執行程式碼的資訊安全風險。
  
**造成這個資訊安全風險的原因為何？**    
由於 Windows Authenticode 簽章驗證功能不當驗證蓄意製作的 PE 檔案之檔案摘要，從而導致此資訊安全風險。
  
**什麼是Windows Authenticode簽章驗證功能？**  
Windows Authenticode 簽章驗證功能 (即 WinVerifyTrust) 會在指定物件上執行信任驗證動作。此功能會將查詢傳給支援動作識別碼的信任提供者 (若有的話)。WinVerifyTrust 功能會執行兩個動作： 指定物件簽章檢查，以及信任驗證動作。如需 WinVerifyTrust 功能的相關技術資訊，請參閱 MSDN 文章：[WinVerifyTrust 功能](http://msdn.microsoft.com/zh-tw/library/aa388208(vs.85).aspx) (英文)。
  
如需 Authenticode 簡介，請參閱 MSDN 文章：[程式碼簽署簡介](http://msdn.microsoft.com/zh-tw/library/ms537361(v=vs.85).aspx) (英文)。
  
**什麼是Windows Authenticode可攜式執行檔簽章格式？**    
...
在網頁式攻擊案例中，攻擊者必須架設含有蓄意製作之 PE 檔案的網站。此外，受侵害的網站以及接受或存放使用者提供之內容的網站裡，也可能包含蓄意製作以利用本資訊安全風險的內容。攻擊者無法強迫使用者造訪主控蓄意製作之 PE 的網站。而是引誘使用者自行前往。一般的做法是設法讓使用者按一下電子郵件中或 Instant Messenger 訊息中連往攻擊者網站的連結。
  
**因為這個資訊安全風險而承受風險的主要系統有哪些？**    
工作站與伺服器最可能受這個資訊安全風險影響。
  
**更新的作用何在？**    
此資訊安全更新會修改 Windows Authenticode 簽章驗證功能在驗證可攜式執行檔時執行 Windows Authenticode 簽章驗證的方式，進而解決此資訊安全風險。
...
資訊安全更新可從 [Microsoft Update](http://go.microsoft.com/fwlink/?linkid=40747) 以及 [](http://update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=zh-hk)[Windows Update](http://update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=zh-hk)</a> 取得。資訊安全更新也可以從 [Microsoft 下載中心](http://www.microsoft.com/downloads/results.aspx?displaylang=en&freetext=security%20update)取得。您也可以利用「資訊安全更新」("security update") 關鍵字搜尋輕易地找到資訊安全更新。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 項目，或是 %Windir%\$NTUninstallKB2653956$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2653956?ln=zh-tw">Microsoft 知識庫文件編號 2653956</a></td>
</tr>
<tr class="even">
...
-   感謝 [Avast Software](http://www.avast.com/) 的 Robert Zacek 和 Igor Glucksmann 回報 WinVerifyTrust 簽章驗證資訊安全風險 (CVE-2012-0151)
  
#### Microsoft 主動保護計畫 (MAPP)
  
為了增強客戶的資訊安全Windowsrosoft 將在每月發行資訊安全更新之前，提前向重要資訊安全軟體提供者提供資訊安全風險資訊。資訊安全軟體提供者可利用此資訊安全風險資訊，透過其資訊安全軟體或裝置 (如防毒軟體、網路入侵偵測系統、或主機入侵預防系統)，為客戶提供更新的保護措施。如果要判斷是否有資訊安全軟體提供者的主動保護可用，請造訪由
...
-   V1.1 (2012 年 8 月 8 日)： 修訂公告，宣佈一項 KB2653956 的 Windows Vista 套件偵測變更，以修正 Windows Update 在重新提供更新程式方面的問題。此變更僅屬偵測變更。已成功更新系統的客戶不必採取任何行動。
