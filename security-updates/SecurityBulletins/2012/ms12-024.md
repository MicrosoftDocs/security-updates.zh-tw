...
**已知問題。** [Microsoft 知識庫文件編號 2653956](https://support.microsoft.com/kb/2653956?ln=zh-tw) 中記載了客戶安裝此資訊安全更新時，可能會發生的目前已知問題。該文件並說明了解決這些問題的建議解決方案。
...
(KB2653956)<br />
(英文下載更新程式)<br />
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=575afd20-cee4-4fa9-b781-9f8dfdd41ebe">Windows XP Service Pack 3</a><br />
(KB2653956)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms10-019">MS10-019</a>中的 KB978601 由 KB2653956 取代</td>
</tr>
<tr class="even">
...
(KB2653956)<br />
(英文下載更新程式)<br />
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=f79c8940-ca31-4ff7-924e-847f5eef7864">Windows Server 2003 Service Pack 2</a><br />
(KB2653956)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
(KB2653956)<br />
(英文下載更新程式)<br />
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=03ebf111-1e7b-4dc2-b84f-a26c6b5f0d58">Windows Server 2003 x64 Edition Service Pack 2</a><br />
(KB2653956)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
(KB2653956)<br />
(英文下載更新程式)<br />
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=c7683919-6d46-4b3e-aa98-1bef20141835">Windows Vista Service Pack 2</a><br />
(KB2653956)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
(KB2653956)<br />
(英文下載更新程式)<br />
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=4d9f8a6e-17bd-4ed3-8bc7-d5e3b11ca12a">Windows Vista x64 Edition Service Pack 2</a><br />
(KB2653956)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
(KB2653956)<br />
(英文下載更新程式)<br />
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=c36c20f7-a742-4151-b8f2-85ef80479d06">適用於 32 位元系統的 Windows Server 2008 Service Pack 2</a>*<br />
(KB2653956)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
(KB2653956)<br />
(英文下載更新程式)<br />
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=330cea47-221d-439e-b106-58a146fc28ee">適用於 x64 型系統的 Windows Server 2008 Service Pack 2</a>*<br />
(KB2653956)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
(KB2653956)<br />
(英文下載更新程式)<br />
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=ac183b66-0247-4ae5-bda0-e8d0070917c8">適用於 32 位元系統的 Windows 7</a><br />
(KB2653956)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
(KB2653956)<br />
(英文下載更新程式)<br />
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=ac183b66-0247-4ae5-bda0-e8d0070917c8">適用於 32 位元系統的 Windows 7 Service Pack 1</a><br />
(KB2653956)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
(KB2653956)<br />
(英文下載更新程式)<br />
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=27226e64-266f-499e-8c57-866593fc3430">適用於 x64 型系統的 Windows 7</a><br />
(KB2653956)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
(KB2653956)<br />
(英文下載更新程式)<br />
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=27226e64-266f-499e-8c57-866593fc3430">適用於 x64 型系統的 Windows 7 Service Pack 1</a><br />
(KB2653956)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
(KB2653956)<br />
(英文下載更新程式)<br />
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=54db1495-31bb-4435-a442-74e484630b8a">適用於 x64 型系統的 Windows Server 2008 R2</a>*<br />
(KB2653956)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
(KB2653956)<br />
(英文下載更新程式)<br />
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=54db1495-31bb-4435-a442-74e484630b8a">適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1</a>*<br />
(KB2653956)<br />
(中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
...
是。KB2653956 更新可供 Windows 開發人員預覽版本使用。建議 Windows 開發人員預覽的客戶將更新套用至其系統。該更新只在 [Windows Update](https://update.microsoft.com/windowsupdate/v6/default.aspx) 提供。
  
**Windows 8 Consumer Preview是否會受此公告中指出的資訊安全風險影響？**    
是。KB2653956 更新可供 Windows 8 Consumer Preview 版本使用。建議 Windows Consumer Preview 的客戶將更新套用至其系統。該更新只在 [Windows Update](https://update.microsoft.com/windowsupdate/v6/default.aspx) 提供。
...
若在套用簽章後將其他內容附加至檔案，也會將 PE 檔案視為「未簽署」。在發行二進位檔前的建構程序中，應用程式簽署應該是最後一個步驟。如需上述問題及此資訊安全更新其他已知問題的更多資訊，請參閱 [Microsoft 知識庫文件編號 2653956](https://support.microsoft.com/kb/2653956?ln=zh-tw)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-0151](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0151) (英文)。
...
Windows Authenticode 簽章驗證功能 (即 WinVerifyTrust) 會在指定物件上執行信任驗證動作。此功能會將查詢傳給支援動作識別碼的信任提供者 (若有的話)。WinVerifyTrust 功能會執行兩個動作： 指定物件簽章檢查，以及信任驗證動作。如需 WinVerifyTrust 功能的相關技術資訊，請參閱 MSDN 文章：[WinVerifyTrust 功能](https://msdn.microsoft.com/zh-tw/library/aa388208(vs.85).aspx) (英文)。
  
如需 Authenticode 簡介，請參閱 MSDN 文章：[程式碼簽署簡介](https://msdn.microsoft.com/zh-tw/library/ms537361(v=vs.85).aspx) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2653956?ln=zh-tw">Microsoft 知識庫文件編號 2653956</a></td>
</tr>
<tr class="even">
...
-   感謝 [Avast Software](https://www.avast.com/) 的 Robert Zacek 和 Igor Glucksmann 回報 WinVerifyTrust 簽章驗證資訊安全風險 (CVE-2012-0151)
