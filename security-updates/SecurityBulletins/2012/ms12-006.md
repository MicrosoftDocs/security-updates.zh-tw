...
本資訊安全更新也能解決 [Microsoft 資訊安全摘要報告 2588513](http://technet.microsoft.com/zh-tw/security/advisory/2588513) 中首先提出的資訊安全風險。
...
**已知問題。** [Microsoft 知識庫文件編號 2643584](http://support.microsoft.com/kb/2643584?ln=zh-tw) 中記載了客戶安裝此資訊安全更新時，可能會發生的目前已知問題。該文件並說明了解決這些問題的建議解決方案。
...
<td style="border:1px solid black;">KB2585542 取代 <a href="http://technet.microsoft.com/zh-tw/security/bulletin/ms10-049">MS10-049</a> 中的 KB980436</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">資訊洩漏</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/zh-tw/security/bulletin/ms09-059">MS09-059</a> 中的 KB975467 及 <a href="http://technet.microsoft.com/zh-tw/security/bulletin/ms10-049">MS10-049</a> 中的 KB980436 取代為 KB2585542<br />
<br />
...
<td style="border:1px solid black;">資訊洩漏</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/zh-tw/security/bulletin/ms09-059">MS09-059</a> 中的 KB975467 及 <a href="http://technet.microsoft.com/zh-tw/security/bulletin/ms10-085">MS10-085</a> 中的 KB2207566 取代為 KB2585542</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">資訊洩漏</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">KB2585542 取代 <a href="http://technet.microsoft.com/zh-tw/security/bulletin/ms10-085">MS10-085</a> 中的 KB2207566 和 <a href="http://technet.microsoft.com/zh-tw/security/bulletin/ms10-095">MS10-095</a> 中的 KB2385678</td>
</tr>
<tr class="even">
...
若要如本公告所述避免受到透過 Internet Explorer 利用 SSL 和 TLS 通訊協定資訊安全風險 (CVE-2011-3389) 的網頁型攻擊模式影響，客戶必須安裝此更新 (MS12-006} 與 [Internet Explorer 積存資訊安全更新](http://technet.microsoft.com/zh-tw/security/bulletin/ms11-099) (MS11-099)。
...
是。依照預設，此更新只會在使用 WinHTTP 元件的應用程式中啟用。如果您是開發者，並想要在應用程式中啟用此安全性功能，請參閱 MSDN 文章：[AcquireCredentialsHandle (Schannel) 功能](http://msdn.microsoft.com/zh-tw/library/windows/desktop/aa374716(v=vs.85).aspx) (英文) 和 [SCHANNEL\_CRED 結構](http://msdn.microsoft.com/zh-tw/library/windows/desktop/aa379810(v=vs.85).aspx) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2011-3389](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3389) (英文)。
...
-   **在執行Windows Vista、Windows Server 2008、Windows 7或Windows Server 2008 R2之系統上的伺服器軟體中，排定優先處理RC4演算法**
    ...
    此攻擊只會影響在 CBC 模式中使用對稱式加密演算法的加密套件，例如 AES，並不影響 RC4 演算法。您可以在伺服器軟體中排定優先處理 RC4 演算法，以促進安全的通訊 (使用 RC4 而非 CBC 模式)。請參閱這篇 MSDN 文章：[排定 Schannel 加密套件優先順序](http://msdn.microsoft.com/zh-tw/library/bb870930%28v=vs.85%29.aspx) (英文)，瞭解如何執行此作業。
...
-   **在執行Windows 7或Windows Server 2008 R2系統上的用戶端軟體中，啟用TLS 1.1和/或TLS 1.2。**
    ...
    **注意：** 請參閱 [Microsoft 知識庫文件編號 2643584](http://support.microsoft.com/kb/2643584?ln=zh-tw)，以運用自動化 **Microsoft Fix It** 解決方案來啟用或停用這項 TLS 1.1 因應措施。
...
-   **在執行Windows 7或Windows Server 2008 R2系統上的伺服器軟體中，啟用TLS 1.1**
    ...
    請參閱 [Microsoft 知識庫文件編號 2643584](http://support.microsoft.com/kb/2643584?ln=zh-tw)，以運用自動化 **Microsoft Fix It** 解決方案來啟用或停用這項 TLS 1.1 因應措施。
...
如需更多資訊，請參閱 TechNet 文章：[TLS/SSL 如何運作](http://technet.microsoft.com/zh-tw/library/cc783349(ws.10).aspx) (英文)。
...
**更新的作用何在？**    
此更新可修改 Windows 安全通道 (SChannel) 元件傳送和接收加密的網路封包之方式。此更新可解決影響 WinHTTP 的資訊安全風險並可提供全系統防護。但是，若要避免受到透過 Internet Explorer 利用此資訊安全風險的網頁型攻擊模式影響，客戶必須安裝此更新 (MS12-006) 和 [Internet Explorer 積存資訊安全更新](http://technet.microsoft.com/zh-tw/security/bulletin/ms11-099) (2618444)，即 MS11-099。
  
**本資訊安全公告發行時，此資訊安全風險是否已揭發出來？**    
是。此資訊安全風險已經遭到公開揭發。這項資訊安全風險已被指派「一般性資訊安全風險」編號 [CVE-2011-3389](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3389) (英文)。
...
資訊安全更新可從 [Microsoft Update](http://go.microsoft.com/fwlink/?linkid=40747) 以及 [](http://fe1.update.microsoft.com/microsoftupdate/v6/vistadefault.aspx)[Windows Update](http://update.microsoft.com/windowsupdate/v6/default.aspx)</a> 取得。資訊安全更新也可以從 [Microsoft 下載中心](http://www.microsoft.com/zh-tw/download/search.aspx?q=security%20update)取得。您也可以利用「資訊安全更新」("security update") 關鍵字搜尋輕易地找到資訊安全更新。
...
<td style="border:1px solid black;">適用於 Windows XP Service Pack 3：<br />
請參閱 <a href="http://support.microsoft.com/kb/2585542?ln=zh-tw">Microsoft 知識庫文件編號 2585542</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2：<br />
請參閱 <a href="http://support.microsoft.com/kb/2585542?ln=zh-tw">Microsoft 知識庫文件編號 2585542</a> 與 <a href="http://support.microsoft.com/kb/2638806?ln=zh-tw">Microsoft 知識庫文件編號 2638806</a></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2585542?ln=zh-tw">Microsoft 知識庫文件編號 2585542</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2638806?ln=zh-tw">Microsoft 知識庫文件編號 2638806</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
