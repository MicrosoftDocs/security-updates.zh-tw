...
已知問題。 [Microsoft 知識庫文件編號 2647170](http://support.microsoft.com/kb/2647170?ln=zh-tw) 中記載目前已知安裝此資訊安全更新後，可能會發生的問題。該文件並說明了解決這些問題的建議解決方案。
...
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=b04da098-666f-4760-90da-d2a17e78bf47">Windows Server 2003 Service Pack 2</a>
</div>
<div>
(中文下載更新程式)
</div></td>
...
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/zh-tw/security/bulletin/ms11-058">MS11-058</a>,<br />
<a href="http://technet.microsoft.com/zh-tw/security/bulletin/ms12-009">MS12-009</a></td>
</tr>
<tr class="even">
...
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=647eaf09-3959-439e-8418-fd25221eb6b9">Windows Server 2003 x64 Edition Service Pack 2</a>
</div>
<div>
(中文下載更新程式)
</div></td>
...
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=233c62b7-f2b1-49ce-9a7f-e51435be0d26">適用於 32 位元系統的 Windows Server 2008 Service Pack 2</a>*  
</div>
<div>
(中文下載更新程式)
</div></td>
<td style="border:1px solid black;">阻斷服務 (DoS)</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/zh-tw/security/bulletin/ms11-058">MS11-058</a></td>
</tr>
<tr class="odd">
...
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=56eae770-5990-4e1b-8b48-3d0602fcc72b">適用於 x64 型系統的 Windows Server 2008 Service Pack 2</a>*  
</div>
<div>
(中文下載更新程式)
</div></td>
...
<div>
<a href="http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=19a4f3d1-24d2-41af-a41a-e5cc2c6232e8">適用於 x64 型系統的 Windows Server 2008 R2 和適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1</a>*  
</div>
<div>
(中文下載更新程式)
</div></td>
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-0006](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0006) (英文)。
...
-   定期清除 DNS 快取
    ...
    執行下列 dnscmd 命令，請參閱 [Dnscmd Syntax](http://technet.microsoft.com/zh-tw/library/cc756116(v=ws.10).aspx) 一文：
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2647170?ln=zh-tw">Microsoft 知識庫文件編號 2647170</a></td>
</tr>
<tr class="even">
...
-   美國及加拿大地區客戶可洽詢[資訊安全支援](https://consumersecuritysupport.microsoft.com/default.aspx?mkt=zh-tw&st=1&wfxredirect=1)或 1-866-PCSAFETY (1-866-727-2338) 以取得技術支援。如需更多可用支援選項的資訊，請參閱 [Microsoft 技術支援](http://support.microsoft.com/?ln=zh-tw)。  
