---
TOCTitle: 'MS12-017'
Title: 'Microsoft Security Bulletin MS12-017 - 重要'
ms:assetid: 'ms12-017'
ms:contentKeyID: 61238749
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms12-017(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-017 - 重要
===========================================

DNS 伺服器中的資訊安全風險可能會允許阻斷服務 (DoS) (2647170)
------------------------------------------------------------

發行: 2012年3月14日 | 更新: 2012年4月18日
...
這個資訊安全更新可解決 Microsoft Windows 中一項未公開報告的資訊安全風險。如果遠端未經驗證的攻擊者將蓄意製作的 DNS 查詢傳送至目標 DNS 伺服器，此資訊安全風險可能會允許阻斷服務 (DoS)。

對於所有受支援版本的 Windows Server 2003、32 位元和 x64 型版本的 Windows Server 2008，以及 x64 型版本的 Windows Server 2008 R2，此資訊安全更新的等級為「重要」。如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此資訊安全更新可修改 DNS 伺服器處理記憶體中物件的方式，進而解決此資訊安全風險。如需更多有關此資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
已知問題。 [Microsoft 知識庫文件編號 2647170](https://support.microsoft.com/kb/2647170?ln=zh-tw) 中記載目前已知安裝此資訊安全更新後，可能會發生的問題。該文件並說明了解決這些問題的建議解決方案。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b04da098-666f-4760-90da-d2a17e78bf47">Windows Server 2003 Service Pack 2</a>
<div>
(英文下載更新程式)  
</div>
<div>
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=b04da098-666f-4760-90da-d2a17e78bf47">Windows Server 2003 Service Pack 2</a>
</div>
<div>
(中文下載更新程式)
</div></td>
...
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms11-058">MS11-058</a>,<br />
<a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms12-009">MS12-009</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=647eaf09-3959-439e-8418-fd25221eb6b9">Windows Server 2003 x64 Edition Service Pack 2</a>
<div>
(英文下載更新程式)  
</div>
<div>
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=647eaf09-3959-439e-8418-fd25221eb6b9">Windows Server 2003 x64 Edition Service Pack 2</a>
</div>
<div>
(中文下載更新程式)
</div></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=92f3af60-9a9b-4419-9e95-55f5cb54cf00">適用於 Itanium 型系統的 Windows Server 2003 SP2</a>
<div>
(英文下載更新程式)
</div></td>
<td style="border:1px solid black;">阻斷服務 (DoS)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=233c62b7-f2b1-49ce-9a7f-e51435be0d26">適用於 32 位元系統的 Windows Server 2008 Service Pack 2</a>*
<div>
(英文下載更新程式)  
</div>
<div>
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=233c62b7-f2b1-49ce-9a7f-e51435be0d26">適用於 32 位元系統的 Windows Server 2008 Service Pack 2</a>*  
</div>
<div>
(中文下載更新程式)
</div></td>
<td style="border:1px solid black;">阻斷服務 (DoS)</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms11-058">MS11-058</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=56eae770-5990-4e1b-8b48-3d0602fcc72b">適用於 x64 型系統的 Windows Server 2008 Service Pack 2</a>*
<div>
(英文下載更新程式)  
</div>
<div>
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=56eae770-5990-4e1b-8b48-3d0602fcc72b">適用於 x64 型系統的 Windows Server 2008 Service Pack 2</a>*  
</div>
<div>
(中文下載更新程式)
</div></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=19a4f3d1-24d2-41af-a41a-e5cc2c6232e8">適用於 x64 型系統的 Windows Server 2008 R2 和適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1</a>*
<div>
(英文下載更新程式)  
</div>
<div>
<a href="https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=19a4f3d1-24d2-41af-a41a-e5cc2c6232e8">適用於 x64 型系統的 Windows Server 2008 R2 和適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1</a>*  
</div>
<div>
(中文下載更新程式)
</div></td>
...
唯有「受影響的軟體」表中所列的作業系統啟用 DNS 時，才能安裝更新。依預設，這些作業系統上不會啟用 DNS，所以此更新不會提供給這些系統，除非系統已啟用 DNS。
...
<th style="border:1px solid black;" >DNS 阻斷服務 (DoS) 資訊安全風險 - CVE-2012-0006</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
DNS 阻斷服務 (DoS) 資訊安全風險 - CVE-2012-0006  
-----------------------------------------------
  

查詢網域的資源記錄時，由於 DNS 伺服器不當處理記憶體中的物件，因而導致出現阻斷服務 (DoS) 資訊安全風險。成功利用此資訊安全風險的攻擊者，可使目標系統上的 DNS 伺服器服務停止回應並自動重新啟動。
  
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-0006](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0006) (英文)。
  
#### DNS 阻斷服務 (DoS) 資訊安全風險 - CVE-2012-0006 的緩和因素
  
Microsoft 尚未找到此項資訊安全風險的任何緩和因素。
  
#### DNS 阻斷服務 (DoS) 資訊安全風險 - CVE-2012-0006 的因應措施
  
因應措施指的是無法徹底修正資訊安全風險，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：
  
-   定期清除 DNS 快取
  
    執行下列 dnscmd 命令，請參閱 [Dnscmd Syntax](https://technet.microsoft.com/zh-tw/library/cc756116(v=ws.10).aspx) 一文：
  
    dnscmd [伺服器名稱] /clearcache  

    此命令可作為排定工作執行，或視需要執行。
  
    因應措施的影響。 在指定的 DNS 伺服器中清除資源記錄的 DNS 快取記憶體。
  
    如何復原因應措施。
  
    刪除或停用正執行 dnscmd 命令之任何排定的工作。
  
#### DNS 阻斷服務 (DoS) 資訊安全風險 - CVE-2012-0006 的常見問題集
  
這個資訊安全風險的範圍為何？    
這是一項阻斷服務 (DoS) 的資訊安全風險。
  
造成這個資訊安全風險的原因為何？    
查詢資源記錄時，由於 DNS 伺服器不當處理記憶體中的物件，因而造成此資訊安全風險。
  
什麼是 DNS 資源記錄？    
DNS 資源記錄 (RR) 可識別網域中的特定資源。如需詳細資訊，請參閱 TechNet 文章：DNS 如何運作 (英文)。
  
攻擊者可能會利用這項資訊安全風險採取什麼行動？    
成功利用此資訊安全風險的攻擊者能夠使目標系統停止回應並自動重新啟動。
  
攻擊者如何利用這項 資訊安全風險？    
未經驗證的遠端攻擊者可將蓄意製作的 DNS 查詢傳送給目標 DNS 伺服器，進而利用此資訊安全風險。
  
因為這個資訊安全風險而承受風險的主要系統有哪些？    
執行 DNS 角色的伺服器風險最高。未啟用此角色的伺服器則無風險。
  
更新的作用何在？    
此更新可修改 DNS 伺服器處理記憶體中物件的方式，進而解決此資訊安全風險。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 項目，或是 %Windir%\$NTUninstallKB2647170$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">檔案資訊</td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2647170?ln=zh-tw">Microsoft 知識庫文件編號 2647170</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">移除 資訊</td>
...
-   美國及加拿大地區客戶可洽詢[資訊安全支援](https://consumersecuritysupport.microsoft.com/default.aspx?mkt=zh-tw&st=1&wfxredirect=1)或 1-866-PCSAFETY (1-866-727-2338) 以取得技術支援。如需更多可用支援選項的資訊，請參閱 [Microsoft 技術支援](https://support.microsoft.com/?ln=zh-tw)。  
-   不同國家的客戶，可以從當地的 Microsoft 分公司取得支援。如需如何連絡 Microsoft 瞭解技術支援問題的詳細資訊，請造訪[國際化支援網站](https://support.microsoft.com/common/international.aspx)。
...
-   V1.1 (2012 年 4 月 18 日)： 在＜提要＞的＜已知問題＞中新增 Microsoft 知識庫文件編號 2647170 的連結，並更正 Windows Server 2003 Service Pack 2、Windows Server 2003 x64 Edition Service Pack 2 及適用於 Itanium 型系統的 Windows Server 2003 SP2 的公告取代資訊。此變更僅屬公告變更。偵測或資訊安全更新檔案沒有變更。
