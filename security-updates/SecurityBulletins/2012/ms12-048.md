...
<td style="border:1px solid black;">
KB2691442 取代 [MS10-046](http://go.microsoft.com/fwlink/?linkid=197393) 中的 KB2286198
</td>
</tr>
...
**何處可找到資訊安全更新的雜湊？**  
資訊安全更新的 SHA1 和 SHA2 雜湊可用來驗證下載之資訊安全更新套件的真實性。如需此更新的相關雜湊資訊，請參閱 [Microsoft 知識庫文件編號 2691442](http://support.microsoft.com/kb/2691442)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-0175](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0175) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2691442">Microsoft 知識庫文件編號 2691442</a></td>
</tr>
<tr class="even">
...
-   感謝 [IBMWindowsity Systems - Application Security](http://blog.watchfire.com/) 的 Adi Cohen 回報命令插入資訊安全風險 (CVE-2012-0175)
