...
<td style="border:1px solid black;">
KB2705219 取代 [MS08-067](https://go.microsoft.com/fwlink/?linkid=130719) 中的 KB958644
</td>
</tr>
...
<td style="border:1px solid black;">
KB2712808 取代 [MS09-022](https://go.microsoft.com/fwlink/?linkid=141786) 中的 KB961501
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[適用於 Itanium 型系統的 Windows Server 2003 SP2](https://www.microsoft.com/download/details.aspx?familyid=2857701f-3447-452c-a986-9f2fe42fe64d)  
(KB2712808)
</td>
<td style="border:1px solid black;">
遠端執行程式碼
...
<tr>
<td style="border:1px solid black;">
[適用於 32 位元系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=354e502b-3016-4c5e-8611-bc1b35e1a7eb) (Server Core 安裝)  
(KB2705219)
</td>
<td style="border:1px solid black;">
阻斷服務 (DoS)
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[適用於 32 位元系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=35fb03b1-162a-4552-8bb9-6b564acbd57b) (Server Core 安裝)  
(KB2712808)
</td>
<td style="border:1px solid black;">
阻斷服務 (DoS)
...
<tr>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2b8a730c-46ac-49b7-b9ae-73062d5a79f2) (Server Core 安裝)  
(KB2705219)
</td>
<td style="border:1px solid black;">
阻斷服務 (DoS)
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e89024ca-a9e8-4ebf-91eb-cbf8e05398e7) (Server Core 安裝)  
(KB2712808)
</td>
<td style="border:1px solid black;">
阻斷服務 (DoS)
...
<tr>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2](https://www.microsoft.com/download/details.aspx?familyid=e15d2bae-1511-4d74-93cb-0d614820e175) (Server Core 安裝)  
(KB2705219)
</td>
<td style="border:1px solid black;">
阻斷服務 (DoS)
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2](https://www.microsoft.com/download/details.aspx?familyid=20c9a72f-a8b6-4b4c-a9ea-de93069cff3a) (Server Core 安裝)  
(KB2712808)
</td>
<td style="border:1px solid black;">
阻斷服務 (DoS)
...
<tr>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=e15d2bae-1511-4d74-93cb-0d614820e175) (Server Core 安裝)  
(KB2705219)
</td>
<td style="border:1px solid black;">
阻斷服務 (DoS)
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=20c9a72f-a8b6-4b4c-a9ea-de93069cff3a) (Server Core 安裝)  
(KB2712808)
</td>
<td style="border:1px solid black;">
阻斷服務 (DoS)
...
**為何於2012年10月9日修訂此公告？**  
Microsoft 修訂此公告的目的，是為了重新發行 Windows XP、Windows Server 2003、Windows Vista、Windows Server 2008、Windows 7 與 Windows Server 2008 R2 的 KB2705219 更新，以解決 Microsoft 產生的特定數位憑證不具有正確時間戳記屬性的問題。如需更多資訊，請參閱 [Microsoft 資訊安全摘要報告 2749655](https://technet.microsoft.com/security/advisory/2749655)。

**何處可找到檔案資訊詳細資料？**  
關於檔案資訊詳細資料的位置，請見＜資訊安全更新部署＞一節中的參考表。

**何處可找到資訊安全更新的雜湊？**  
資訊安全更新的 SHA1 和 SHA2 雜湊可用來驗證下載之資訊安全更新套件的真實性。如需此更新的相關雜湊資訊，請參閱 [Microsoft 知識庫文件編號 2733594](https://support.microsoft.com/kb/2733594)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-1850](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1850) (英文)。
...
**什麼是遠端系統管理通訊協定?**   
遠端系統管理通訊協定 (RAP) 處理系統管理功能，包括分享LAN Manager伺服器上的維護與印表機維護等工作。如需更多資訊,請參閱[\[MS-rap\]： 遠端系統管理通訊協定規格(英文)](https://msdn.microsoft.com/en-us/library/cc240191(v=prot.13))。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-1851](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1851) (英文)。
...
**什麼是列印多工緩衝處理器服務？**  
列印多工緩衝處理器服務是以服務形式安裝的可執行檔。作業系統啟動時會載入多工緩衝處理器，且多工緩衝處理器會繼續執行，直到作業系統關閉為止。列印多工緩衝處理器服務可管理列印程序，其中包括下列工作：擷取正確印表機驅動程式的位置、載入該驅動程式、將高階函式呼叫緩衝處理到列印工作，以及排定列印工作。特定列印作業的工作完成後，列印多工緩衝處理器服務會將作業傳送到列印路由器。如需更多資訊,請參閱[網路列印如何運作](https://technet.microsoft.com/en-us/library/cc783789(v=ws.10).aspx)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-1852](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1852) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-1853](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1853) (英文)。
...
SMS 2003 可使用 Microsoft Update SMS 2003 盤點工具 (ITMU) 來偵測由 [Microsoft Update](https://update.microsoft.com/microsoftupdate) 所提供，並由 [Windows Server Update Services](https://go.microsoft.com/fwlink/?linkid=50120) 支援的資訊安全更新。如需 SMS 2003 ITMU 的詳細資訊，請參閱 [Microsoft Updates SMS 2003 盤點工具](https://technet.microsoft.com/sms/bb676783.aspx) (英文)。如需更多關於 SMS 掃描工具的資訊，請參閱 [SMS 2003 軟體更新掃描工具](https://technet.microsoft.com/sms/bb676786.aspx) (英文)。另請參閱[適用於 Systems Management Server 2003 的下載](https://technet.microsoft.com/sms/bb676766.aspx) (英文)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2705219">Microsoft 知識庫文件編號 2705219</a><br />
請參閱 <a href="https://support.microsoft.com/kb/2712808">Microsoft 知識庫文件編號 2712808</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2705219">Microsoft 知識庫文件編號 2705219</a><strong><br />
</strong>請參閱 <a href="https://support.microsoft.com/kb/2712808">Microsoft 知識庫文件編號 2712808</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
...
-   感謝 [Palo Alto Networks](https://www.paloaltonetworks.com/) 的 Yamata Li 回報遠端系統管理通訊協定阻斷服務 (DoS) 資訊安全風險 (CVE-2012-1850)  
-   感謝[Palo Alto Networks](https://www.paloaltonetworks.com/)的 Yamata Li 回報列印多工緩衝處理器服務格式字串資訊安全風險 (CVE-2012-1851)  
-   感謝[Palo Alto Networks](https://www.paloaltonetworks.com/) 的 Yamata Li 報遠端系統管理通訊協定堆積溢位資訊安全風險 (CVE-2012-1852)  
-   感謝[Palo Alto Networks 的 Yamata Li](https://www.paloaltonetworks.com/)回報遠端系統管理通訊協定堆疊溢位資訊安全風險 (CVE-2012-1853)
