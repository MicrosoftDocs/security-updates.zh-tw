---
TOCTitle: 'MS12-033'
Title: 'Microsoft Security Bulletin MS12-033 - 重要'
ms:assetid: 'ms12-033'
ms:contentKeyID: 61238765
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms12-033(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-033 - 重要
===========================================

Windows Partition Manager 中的資訊安全風險可能會允許權限提高 (2690533)
----------------------------------------------------------------------
...
此資訊安全更新可修正 Windows Partition Manager 分配記憶體中物件的方式，藉此解決此資訊安全風險。如需更多有關此資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
(KB2690533)  
(英文下載更新程式)  
[Windows Vista Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=d9d5e290-dc57-4587-b31d-706b541924ec)  
(KB2690533)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2690533)  
(英文下載更新程式)  
[Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=827b9f15-b67d-4dd4-a39b-7c148bae5041)  
(KB2690533)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2690533)  
(英文下載更新程式)  
[適用於 32 位元系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=46e6e960-b700-4154-b91d-aca74ea9e5df)  
(KB2690533)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2690533)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=e4ab05ae-3a1c-4d6b-8c84-1165ed741356)  
(KB2690533)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2690533)  
(英文下載更新程式)  
[適用於 32 位元系統的 Windows 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=2a4433e4-7f3f-4083-b3e1-eff2d18483af)  
(KB2690533)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2690533)  
(英文下載更新程式)  
[適用於 32 位元系統的 Windows 7 Service Pack 1](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=2a4433e4-7f3f-4083-b3e1-eff2d18483af)  
(KB2690533)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2690533)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows 7](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=dfa13df5-9e4e-4cf6-b56d-af7db0a0f5ea)  
(KB2690533)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2690533)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows 7 Service Pack 1](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=dfa13df5-9e4e-4cf6-b56d-af7db0a0f5ea)  
(KB2690533)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2690533)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 R2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=095c20b3-8e6c-4846-9ba1-6ce0af5e9850)  
(KB2690533)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
(KB2690533)  
(英文下載更新程式)  
[適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=095c20b3-8e6c-4846-9ba1-6ce0af5e9850)  
(KB2690533)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
<th style="border:1px solid black;" >
隨插即用 (PnP) 設定管理員資訊安全風險 - CVE-2012-0178
</th>
<th style="border:1px solid black;" >
彙總嚴重性等級
</th>
...
Windows Partition Manager 處理裝置關聯要求的方式，存在權限提高資訊安全風險。成功利用此資訊安全風險的攻擊者可以在核心模式下執行任意程式碼。接下來，攻擊者就能安裝程式，檢視、變更或刪除資料，或是建立具有完整系統管理權限的新帳戶。

若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-0178](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0178) (英文)。

#### 隨插即用 (PnP) 設定管理員資訊安全風險 - CVE-2012-0178 的緩和因素

緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少資訊安全風險影響的嚴重性。下列緩和因素可能對您的狀況有所助益：

-   攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項資訊安全風險。

#### 隨插即用 (PnP) 設定管理員資訊安全風險 - CVE-2012-0178 的因應措施

Microsoft 尚未找到此項資訊安全風險的任何因應措施。

#### 隨插即用 (PnP) 設定管理員資訊安全風險 - CVE-2012-0178 的常見問題集

這個資訊安全風險的範圍為何？  
這是權限提高的資訊安全風險。

造成這個資訊安全風險的原因為何？  
此資訊安全風險是因為兩個或多個程序或執行緒同時呼叫隨插即用 (PnP) 設定管理員功能所造成。

什麼 元件會受到此資訊安全風險的影響？  
受到此資訊安全風險影響的元件為 Windows Partition Manager (partmgr.sys)。

什麼是 Windows Partition Manager(partmgr.sys)  ？
Windows Partition Manager 負責探索、建立、刪除及管理磁碟分割。Partition Manager 的作用是作為磁碟類別驅動程式所建立之磁碟裝置物件的篩選器驅動程式， 它負責確保所有線上磁碟都具有唯一的簽章或 GUID。
...
更新的作用何在？  
此更新可修正 Windows Partition Manager 分配記憶體中物件的方式，藉此解決此資訊安全風險。
...
資訊安全更新可從 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 以及 [](https://update.microsoft.com/windowsupdate/v6/default.aspx)[Windows Update](https://www.update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=zh-tw)</a> 取得。資訊安全更新也可以從 [Microsoft 下載中心](https://www.microsoft.com/downloads/en/results.aspx?displaylang=en&freetext=security%20update)取得。您也可以利用「資訊安全更新」("security update") 關鍵字搜尋輕易地找到資訊安全更新。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2690533?ln=zh-tw">Microsoft 知識庫文件編號 2690533</a></td>
</tr>
<tr class="odd">
