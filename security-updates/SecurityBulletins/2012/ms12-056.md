...
<td style="border:1px solid black;">kb2706045 取代 <a href="https://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a> 中的 KB2510531</td>
</tr>
<tr class="even">
...
**何處可找到資訊安全更新的雜湊？**  
資訊安全更新的 SHA1 和 SHA2 雜湊可用來驗證下載之資訊安全更新套件的真實性。如需此更新的相關雜湊資訊，請參閱 [Microsoft 知識庫文件編號 2706045](https://support.microsoft.com/kb/2706045)。
...
[MS12-052](https://go.microsoft.com/fwlink/?linkid=255327) 將一併解決此公告中所述的 JavaScript 整數溢位遠端執行程式碼資訊安全風險 (CVE-2012-2523) 。

在系統上安裝 Internet Explorer 8 的客戶，請安裝本公告中所述的 kb2706045 更新，以免受 CVE-2012-2523 中所述的資訊安全風險影響。

對於在系統上安裝 Internet Explorer 9 的客戶，請安裝 [MS12-052](https://go.microsoft.com/fwlink/?linkid=255327) 中所述的 kb2722913 更新，以免受 CVE-2012-2523 中所述的弱點影響。
...
**什麼是** JScript  **？**    
JScript 是經過解譯的物件型指令碼語言，通常用來製作更有彈性或更具互動性的網站。JScript 指令碼必須有解譯器或主機 (例如動態伺服器網頁 (ASP)、Internet Explorer 或 Windows Script Host) 才能執行。更具體而言，JScript 是 Microsoft 所實作的 ECMA 262 語言規格 (ECMAScript Edition 3)。如需詳細資訊，請參閱 MSDN 文章 [JScript 基礎](https://msdn.microsoft.com/en-us/library/6974wx4d(vs.85).aspx)(英文)，或造訪 [ECMA International 網站 (英文)。](https://www.ecma-international.org/)
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2706045">Microsoft 知識庫文件編號 2706045</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2722913">Microsoft 知識庫文件編號 2722913</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;"><strong>注意：</strong>登錄機碼不存在，無法驗證此更新是否存在。</td>
