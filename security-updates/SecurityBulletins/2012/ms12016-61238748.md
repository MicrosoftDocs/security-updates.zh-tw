...
**Windows** **開發人員預覽上的** **Microsoft .NET Framework 3.5** **和** **Microsoft .NET Framework 4.5** **以及** **Microsoft .NET Framework 4.5** **開發人員預覽是否受此資訊安全風險影響？**
...
**安裝** **Microsoft .NET Framework 2.0 Service Pack 2** **的更新**
...
**安裝** **Microsoft .NET Framework 4** **的更新**
...
**安裝** **Microsoft .NET Framework 3.5.1** **的更新**
