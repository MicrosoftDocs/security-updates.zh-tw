---
TOCTitle: 'MS12-016'
Title: 'Microsoft Security Bulletin MS12-016 - 重大'
ms:assetid: 'ms12-016'
ms:contentKeyID: 61238748
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms12-016(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-016 - 重大
===========================================

.NET Framework 和 Microsoft Silverlight 中的資訊安全風險可能會允許遠端執行程式碼 (2651026)
------------------------------------------------------------------------------------------

發行: 2012年2月14日 | 更新: 2012年7月10日
...
此資訊安全更新可解決 Microsoft .NET Framework 和 Microsoft Silverlight 中一項公開揭露的資訊安全風險和一項未公開報告的資訊安全風險。如果使用者使用可執行 XAML 瀏覽器應用程式 (XBAP) 或 Silverlight 應用程式的網頁瀏覽器來檢視蓄意製作的網頁，上述資訊安全風險可能會允許在用戶端系統上遠端執行程式碼。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

對於所有受支援版本之 Microsoft Windows 上的 Microsoft .NET Framework 2.0 Service Pack 2、Microsoft .NET Framework 3.5.1、Microsoft .NET Framework 4 以及 Microsoft Silverlight 4，此資訊安全更新的等級為「重大」。如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此資訊安全更新可修正 Microsoft .NET Framework 與 Microsoft Silverlight 使用未受管理物件的方式，進而解決上述資訊安全風險。如需更多有關此資訊安全風險的資訊，請參閱下節＜資訊安全風險資訊＞下的特定資訊安全風險項目的＜常見問題集 (FAQ)＞小節。
...
(KB2633880)  
(英文下載更新程式)  
[Microsoft .NET Framework 2.0 Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=5269e18b-d4f0-4c64-8df8-283a2ca66c59)  
(KB2633880)  
(中文下載更新程式)  
...
(KB2633870)  
(英文下載更新程式)  
[Microsoft .NET Framework 4](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=70aadf34-abdc-4577-8da9-a0669dccc119)<sup>[1]</sup>
(KB2633870)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS11-069](https://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539631 已由 KB2633880 取代  
[MS11-069](https://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539636 已由 KB2633870 取代
</td>
</tr>
...
(KB2633874)  
(英文下載更新程式)  
[Microsoft .NET Framework 2.0 Service Pack 2](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=aab7826d-539b-4e36-b3a1-afa94b37dbe7)  
(KB2633874)  
(中文下載更新程式)  
[Microsoft .NET Framework 4](https://www.microsoft.com/download/details.aspx?familyid=70aadf34-abdc-4577-8da9-a0669dccc119)<sup>[1]</sup>
(KB2633870)  
...
<td style="border:1px solid black;">
[MS11-069](https://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539633 已由 KB2633874 取代  
[MS11-069](https://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539636 已由 KB2633870 取代
</td>
</tr>
<tr>
...
(KB2633879)  
(英文下載更新程式)  
[Microsoft .NET Framework 3.5.1](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=5a5f3ee7-ca49-41c8-aeec-7c76b66712fc)  
(KB2633879)  
(中文下載更新程式)  
[Microsoft .NET Framework 4](https://www.microsoft.com/download/details.aspx?familyid=70aadf34-abdc-4577-8da9-a0669dccc119)<sup>[1]</sup>
(KB2633870)  
...
<td style="border:1px solid black;">
[MS11-069](https://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539634 已由 KB2633879 取代  
[MS11-069](https://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539636 已由 KB2633870 取代
</td>
</tr>
<tr class="alternateRow">
...
(KB2633873)  
(英文下載更新程式)  
[Microsoft .NET Framework 3.5.1](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=243e8c64-8b6e-4cea-9e99-58d4b1ad35b5)  
(KB2633873)  
(中文下載更新程式)  
[Microsoft .NET Framework 4](https://www.microsoft.com/download/details.aspx?familyid=70aadf34-abdc-4577-8da9-a0669dccc119)<sup>[1]</sup>
(KB2633870)  
...
<td style="border:1px solid black;">
[MS11-069](https://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539635 已由 KB2633873 取代  
[MS11-069](https://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539636 已由 KB2633870 取代
</td>
</tr>
<tr>
...
(KB2668562)  
(英文下載更新程式)  
[Microsoft Silverlight 4](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=4c3602f0-9781-4374-8fef-669ddd2c0d40)  
(KB2668562)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
| 安裝在所有 Microsoft Windows 用戶端版本上的 Microsoft Silverlight 5 |
| 安裝在所有 Microsoft Windows 伺服器版本上的 Microsoft Silverlight 5 |
...
**為何於2012年2月14日修訂此公告？**  
Microsoft 修訂此公告，是為了針對安裝在 Windows 用戶端和伺服器上的 Microsoft Silverlight 4，宣佈 KB2668562 的一項偵測變更，以修正一個安裝問題。此變更僅屬偵測變更。資訊安全更新檔案沒有變更。已成功更新系統的客戶不必採取任何行動。

**Windows開發人員預覽上的Microsoft .NET Framework 3.5和Microsoft .NET Framework 4.5以及Microsoft .NET Framework 4.5開發人員預覽是否受此資訊安全風險影響？**  
...
|---------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|
| Windows 開發人員預覽上的 Microsoft .NET Framework 3.5                                                   | [Microsoft 知識庫文件編號 2633877](https://support.microsoft.com/kb/2633877) |
| Windows 開發人員預覽上的 Microsoft .NET Framework 4.5                                                   | [Microsoft 知識庫文件編號 2633869](https://support.microsoft.com/kb/2633869) |
| Windows Server 2008、Windows 7 和 Windows Server 2008 R2 上的 Microsoft .NET Framework 4.5 開發人員預覽 | [Microsoft 知識庫文件編號 2638804](https://support.microsoft.com/kb/2638804) |

資訊安全更新可從 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 以及 [](https://go.microsoft.com/fwlink/?linkid=21130)[Windows Update](https://go.microsoft.com/fwlink/?linkid=21130)</a> 取得。
...
**哪些網頁瀏覽器支援Microsoft Silverlight應用程式？**  
...
**哪些版本的Microsoft Silverlight 4會受到此資訊安全風險影響？**  
Microsoft Silverlight 組建 4.1.10111 是本公告首次發行之時最新的 Microsoft Silverlight 組建版本，可以解決此資訊安全風險且不受此資訊安全風險影響。Microsoft Silverlight 組建 4.1.10111 之前的版本會受到影響。
...
與此資訊安全更新一起安裝的版本為 4.1.10111。如果您的版本號碼高於或等於此版本號碼，您的系統不受影響。
...
這個公告是說明 .NET Framework 2.0 功能層中的一項資訊安全風險。.NET Framework 3.0 Service Pack 2 安裝程式連結了 .NET Framework 2.0 Service Pack 2 安裝，因此安裝前者時，後者也會一併安裝。所以，已安裝 .NET Framework 3.0 Service Pack 2 的客戶也必須安裝 .NET Framework 2.0 Service Pack 2 的資訊安全更新。

**我已安裝.NET Framework 3.5 Service Pack 1。我必須安裝任何更新嗎？**  
這個公告是說明 .NET Framework 2.0 功能層中的一項資訊安全風險。.NET Framework 3.5 Service Pack 1 安裝程式連結了 .NET Framework 2.0 Service Pack 2 安裝與 .NET Framework 3.0 Service Pack 2 安裝。因此，已安裝 .NET Framework 3.5 Service Pack 1 的客戶必須安裝 .NET Framework 2.0 Service Pack 2 的資訊安全更新。
...
<th style="border:1px solid black;" >
.NET Framework 未受管理物件資訊安全風險 - CVE-2012-0014
</th>
<th style="border:1px solid black;" >
.NET Framework 堆積損毀資訊安全風險 - CVE-2012-0015
</th>
<th style="border:1px solid black;" >
彙總嚴重性等級
</th>
...
Microsoft .NET Framework 與 Silverlight 中存在遠端執行程式碼的資訊安全風險，可允許蓄意製作的 Microsoft .NET Framework 應用程式以不安全的方式存取記憶體。成功利用此資訊安全風險的攻擊者可在已登入使用者的安全性內容中執行任意程式碼。攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-0014](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0014) (英文)。

#### .NET Framework 未受管理物件資訊安全風險 - CVE-2012-0014 的緩和因素
...
-   依照預設，部分信任 ASP.NET 應用程式不會被授予 SocketPermission 權限。因此，從伺服器端來看，此資訊安全風險在中、低信任層級的 ASP.NET 應用程式中並不會遭到利用，除非系統管理員明確地將 SocketPermission 權限授予那些應用程式。如需更多關於 ASP.NET 信任層級的資訊，請參閱 MSDN 文章：[ASP.NET 信任層級和原則檔](https://msdn.microsoft.com/zh-tw/library/wyts434y.aspx)。

#### .NET Framework 未受管理物件資訊安全風險 - CVE-2012-0014 的因應措施
...
#### .NET Framework 未受管理物件資訊安全風險 - CVE-2012-0014 的常見問題集

**這個資訊安全風險的範圍為何？**  
這是遠端執行程式碼的資訊安全風險。成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。

**造成這個資訊安全風險的原因為何？**  
造成此資訊安全風險的原因，是由於 Microsoft .NET Framework 與 Microsoft Silverlight 使用未受管理物件的方式不適當。
...
在虛擬主機的案例中，成功利用此資訊安全風險的攻擊者能取得與 Microsoft .NET 應用程式在其下執行的應用程式集區，其應用程式集區身分識別相關之服務帳戶相同的權限。依授予服務帳戶的應用程式集區隔離設定和權限而定，攻擊者也許能控制網頁伺服器上的其他應用程式集區，或完全控制受影響的系統。如需更多關於應用程式集區身分識別及設定的資訊，請參閱 TechNet 文章：[設定應用程式集區身分識別](https://technet.microsoft.com/en-us/library/cc781986(ws.10).aspx) (英文)。
...
**更新的作用何在？**  
此更新可修正 Microsoft .NET Framework 與 Microsoft Silverlight 使用未受管理物件的方式，進而解決這項資訊安全風險。
...
Microsoft .NET Framework 中存在一項遠端執行程式碼的資訊安全風險，此資訊安全風險的成因是由於 Microsoft .NET Framework 處理蓄意製作的輸入內容時，緩衝區長度計算不正確所致。成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-0015](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0015) (英文)。

#### .NET Framework 堆積損毀資訊安全風險 - CVE-2012-0015 的緩和因素
...
#### .NET Framework 堆積損毀資訊安全風險 - CVE-2012-0015 的因應措施
...
#### .NET Framework 堆積損毀資訊安全風險 - CVE-2012-0015 的常見問題集

**這個資訊安全風險的範圍為何？**  
這是遠端執行程式碼的資訊安全風險。成功利用此資訊安全風險的攻擊者可以取得受影響系統的完整控制權。攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。

**造成這個資訊安全風險的原因為何？**  
造成此資訊安全風險的原因，是由於 .NET Framework 處理蓄意製作的輸入內容時，緩衝區長度計算不正確所致。
...
**更新的作用何在？**  
本更新可藉由修正 Microsoft .NET Framework 計算緩衝區長度的方式來解決此資訊安全風險。

**本資訊安全公告發行時，這項資訊安全風險是否已揭發出來？**  
是。這項資訊安全風險已經遭到公開揭發。這項資訊安全風險已被指派「一般性資訊安全風險」編號 [CVE-2012-0015](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0015)。

**當本資訊安全公告發行時，Microsoft是否已接獲任何消息，指出這項資訊安全風險已遭有心人士利用？**  
否。本資訊安全公告初次發行時，Microsoft 尚未接到任何有關本資訊安全風險已公開用來攻擊客戶的消息。

**套用此資訊安全更新是否可以保護客戶防範嘗試利用此資訊安全風險的程式碼(已公開發佈)之威脅？**  
是。本資訊安全更新可解決可能透過利用已公開發佈的概念驗證程式碼來加以利用的資訊安全風險。這項獲得解決的資訊安全風險已被指派「一般性資訊安全風險」編號 [CVE-2012-0015](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0015)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2651026">Microsoft 知識庫文件編號 2651026</a></td>
</tr>
<tr class="odd">
...
**安裝Microsoft .NET Framework 2.0 Service Pack 2的更新**
...
**安裝Microsoft .NET Framework 4的更新**

此資訊安全更新支援下列 Microsoft .NET Framework 4 的安裝參數。
...
**安裝Microsoft .NET Framework 3.5.1的更新**

此資訊安全更新支援下列 Microsoft .NET Framework 3.5.1 的安裝參數。
...
-   感謝 [Sumatra](https://www.sumatra.nl/) 的 Jeroen Frijters 回報 .NET Framework 未受管理物件資訊安全風險 (CVE-2012-0014)
...
-   V1.1 (2012 年 2 月 14 日)： 在更新常見問題集中增列一個條目，針對安裝在 Windows 用戶端和伺服器上的 Microsoft Silverlight 4，宣佈 KB2668562 的一項偵測變更，以修正一個安裝問題。此變更僅屬偵測變更。資訊安全更新檔案沒有變更。已成功更新系統的客戶不必採取任何行動。
-   V1.2 (2012 年 2 月 15 日)： 移除＜提要＞中誤植之已知問題。
-   V1.3 (2012 年 7 月 10 日)： Microsoft 修訂本公告，針對 Microsoft .NET Framework 2.0 Service Pack 2 的 KB2656352 更新宣佈一項小幅偵測變更，以修正一個更新提供程序的問題。資訊安全更新檔案沒有變更。已成功更新系統的客戶不必採取任何行動。
