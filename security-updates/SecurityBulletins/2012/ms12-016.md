...
(KB2633880)  
(英文下載更新程式)  
[Microsoft .NET Framework 2.0 Service Pack 2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=5269e18b-d4f0-4c64-8df8-283a2ca66c59)  
(KB2633880)  
(中文下載更新程式)  
...
(KB2633870)  
(英文下載更新程式)  
[Microsoft .NET Framework 4](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=70aadf34-abdc-4577-8da9-a0669dccc119)<sup>[1]</sup>
(KB2633870)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS11-069](http://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539631 已由 KB2633880 取代  
[MS11-069](http://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539636 已由 KB2633870 取代
</td>
</tr>
...
(KB2633874)  
(英文下載更新程式)  
[Microsoft .NET Framework 2.0 Service Pack 2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=aab7826d-539b-4e36-b3a1-afa94b37dbe7)  
(KB2633874)  
(中文下載更新程式)  
[Microsoft .NET Framework 4](https://www.microsoft.com/download/details.aspx?familyid=70aadf34-abdc-4577-8da9-a0669dccc119)<sup>[1]</sup>
(KB2633870)  
...
<td style="border:1px solid black;">
[MS11-069](http://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539633 已由 KB2633874 取代  
[MS11-069](http://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539636 已由 KB2633870 取代
</td>
</tr>
<tr>
...
(KB2633879)  
(英文下載更新程式)  
[Microsoft .NET Framework 3.5.1](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=5a5f3ee7-ca49-41c8-aeec-7c76b66712fc)  
(KB2633879)  
(中文下載更新程式)  
[Microsoft .NET Framework 4](https://www.microsoft.com/download/details.aspx?familyid=70aadf34-abdc-4577-8da9-a0669dccc119)<sup>[1]</sup>
(KB2633870)  
...
<td style="border:1px solid black;">
[MS11-069](http://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539634 已由 KB2633879 取代  
[MS11-069](http://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539636 已由 KB2633870 取代
</td>
</tr>
<tr class="alternateRow">
...
(KB2633873)  
(英文下載更新程式)  
[Microsoft .NET Framework 3.5.1](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=243e8c64-8b6e-4cea-9e99-58d4b1ad35b5)  
(KB2633873)  
(中文下載更新程式)  
[Microsoft .NET Framework 4](https://www.microsoft.com/download/details.aspx?familyid=70aadf34-abdc-4577-8da9-a0669dccc119)<sup>[1]</sup>
(KB2633870)  
...
<td style="border:1px solid black;">
[MS11-069](http://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539635 已由 KB2633873 取代  
[MS11-069](http://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539636 已由 KB2633870 取代
</td>
</tr>
<tr>
...
(KB2668562)  
(英文下載更新程式)  
[Microsoft Silverlight 4](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=4c3602f0-9781-4374-8fef-669ddd2c0d40)  
(KB2668562)  
(中文下載更新程式)
</td>
<td style="border:1px solid black;">
...
|---------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|
| Windows 開發人員預覽上的 Microsoft .NET Framework 3.5                                                   | [Microsoft 知識庫文件編號 2633877](http://support.microsoft.com/kb/2633877) |
| Windows 開發人員預覽上的 Microsoft .NET Framework 4.5                                                   | [Microsoft 知識庫文件編號 2633869](http://support.microsoft.com/kb/2633869) |
| Windows Server 2008、Windows 7 和 Windows Server 2008 R2 上的 Microsoft .NET Framework 4.5 開發人員預覽 | [Microsoft 知識庫文件編號 2638804](http://support.microsoft.com/kb/2638804) |
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-0014](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0014) (英文)。
...
-   依照預設，部分信任 ASP.NET 應用程式不會被授予 SocketPermission 權限。因此，從伺服器端來看，此資訊安全風險在中、低信任層級的 ASP.NET 應用程式中並不會遭到利用，除非系統管理員明確地將 SocketPermission 權限授予那些應用程式。如需更多關於 ASP.NET 信任層級的資訊，請參閱 MSDN 文章：[ASP.NET 信任層級和原則檔](http://msdn.microsoft.com/zh-tw/library/wyts434y.aspx)。
...
在虛擬主機的案例中，成功利用此資訊安全風險的攻擊者能取得與 Microsoft .NET 應用程式在其下執行的應用程式集區，其應用程式集區身分識別相關之服務帳戶相同的權限。依授予服務帳戶的應用程式集區隔離設定和權限而定，攻擊者也許能控制網頁伺服器上的其他應用程式集區，或完全控制受影響的系統。如需更多關於應用程式集區身分識別及設定的資訊，請參閱 TechNet 文章：[設定應用程式集區身分識別](http://technet.microsoft.com/en-us/library/cc781986(ws.10).aspx) (英文)。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-0015](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0015) (英文)。
...
**本資訊安全公告發行時，這項資訊安全風險是否已揭發出來？**  
是。這項資訊安全風險已經遭到公開揭發。這項資訊安全風險已被指派「一般性資訊安全風險」編號 [CVE-2012-0015](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0015)。

**當本資訊安全公告發行時，Microsoft是否已接獲任何消息，指出這項資訊安全風險已遭有心人士利用？**  
否。本資訊安全公告初次發行時，Microsoft 尚未接到任何有關本資訊安全風險已公開用來攻擊客戶的消息。

**套用此資訊安全更新是否可以保護客戶防範嘗試利用此資訊安全風險的程式碼(已公開發佈)之威脅？**  
是。本資訊安全更新可解決可能透過利用已公開發佈的概念驗證程式碼來加以利用的資訊安全風險。這項獲得解決的資訊安全風險已被指派「一般性資訊安全風險」編號 [CVE-2012-0015](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0015)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2651026">Microsoft 知識庫文件編號 2651026</a></td>
</tr>
<tr class="odd">
...
-   感謝 [Sumatra](http://www.sumatra.nl/) 的 Jeroen Frijters 回報 .NET Framework 未受管理物件資訊安全風險 (CVE-2012-0014)
