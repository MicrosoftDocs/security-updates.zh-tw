...
**我是 Microsoft Word 2003 Service Pack 3 或 Microsoft Word 2007 Service Pack 2 的使用者，為什麼** **當我開啟檔案的時候，會顯示一個 Office** **檔案驗證的提示訊息？**
套用 MS12-029 的更新之後，客戶可能會發現 Microsoft Word 的 Office 檔案驗證功能已經啟用。如果客戶有安裝 [Microsoft Office 檔案驗證增益集](http://www.microsoft.com/downloads/details.aspx?familyid=6a4e39a4-4c3f-4cc7-98ec-1cb2d5cb5881) (KB2501584)，但是未曾套用過 Microsoft Word 的 Office 檔案驗證架構更新，便會發生上述情形。在此情況下，由於 MS12-029 包含 Microsoft Word 的結構更新，而且 Office 檔案驗證增益集已安裝，因此 Microsoft Word 的 Office 檔案驗證功能將會啟用。
...
**Microsoft Office 獨立程式是如何** **受到此資訊安全風險影響？**
...
從 [Microsoft 下載中心](http://www.microsoft.com/downloads/details.aspx?familyid=8f85fc23-480e-4835-9ce5-0aa56702ef59)下載並安裝適當語言版本的 Microsoft Office 2008 for Mac 12.3.3 Update。
...
從 [Microsoft 下載中心](http://www.microsoft.com/downloads/details.aspx?familyid=5d88d3d4-89bd-44c3-9e5a-657998223e2f)下載並安裝適當語言版本的 Microsoft Office for Mac 2011 14.2.2 Update。
