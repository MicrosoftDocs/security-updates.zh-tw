---
TOCTitle: 'MS12-029'
Title: 'Microsoft Security Bulletin MS12-029 - 重大'
ms:assetid: 'ms12-029'
ms:contentKeyID: 61238761
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms12-029(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS12-029 - 重大
===========================================

Microsoft Word 中的資訊安全風險可能會允許遠端執行程式碼 (2680352)
-----------------------------------------------------------------

發行: 2012年5月8日 | 更新: 2012年6月20日
...
這個資訊安全更新可解決 Microsoft Office 中一項未公開報告的資訊安全風險。如果使用者開啟蓄意製作的 RTF 檔案，此資訊安全風險可能會允許遠端執行程式碼。成功利用此資訊安全風險的攻擊者可以取得與目前使用者相同的使用者權限。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

對於所有受支援版本的 Microsoft Word 2007，此資訊安全更新的等級為「重大」。對於所有受支援版本的 Microsoft Word 2003、Microsoft Office 2008 for Mac 和 Microsoft Office for Mac 2011，以及所有受支援版本的 Microsoft Office 相容性套件，此資訊安全更新的等級為「重要」。如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。
...
<td style="border:1px solid black;">
KB2598332 取代 [MS10-079](http://go.microsoft.com/fwlink/?linkid=201696) 中的 KB2344911
</td>
</tr>
...
<td style="border:1px solid black;">
KB2596917 取代 [MS10-079](http://go.microsoft.com/fwlink/?linkid=201696) 中的 KB2344993
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2665346 取代 [MS11-094](http://go.microsoft.com/fwlink/?linkid=232493) 中的 KB2644354
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2665351 取代 [MS11-089](http://go.microsoft.com/fwlink/?linkid=225739) 中的 KB2644347
</td>
</tr>
<tr>
<th colspan="5" style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2596880 取代 [MS10-079](http://go.microsoft.com/fwlink/?linkid=201696) 中的 KB2345043
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
| Office 及其他軟體                                                       |
|-------------------------------------------------------------------------|
| Microsoft Word 2010 和 Microsoft Word 2010 Service Pack 1 (32 位元版本) |
| Microsoft Word 2010 和 Microsoft Word 2010 Service Pack 1 (64 位元版本) |
...
是。Microsoft Word 2003 Service Pack 3 的 MS12-029 更新 (KB2598332) 以及 Microsoft Word 2007 Service Pack 2 的 MS12-029 更新 (KB2596917) 包含 Office 檔案驗證的架構更新。這些 Microsoft Word 的 Office 檔案驗證架構更新先前僅透過 Microsoft Word 2003 的更新 (KB2464603) 以及 Microsoft Word 2007 的更新 (KB2464605) 提供給使用者。

如需更多關於 Office 檔案驗證的資訊，請參閱 [Microsoft 安全性摘要報告 2501584](http://technet.microsoft.com/security/advisory/2501584)和 [Microsoft 知識庫文件編號 2501584](http://support.microsoft.com/kb/2501584)。

**我是 Microsoft Word 2003 Service Pack 3 或 Microsoft Word 2007 Service Pack 2 的使用者，為什麼當我開啟檔案的時候，會顯示一個 Office檔案驗證的提示訊息？**  
套用 MS12-029 的更新之後，客戶可能會發現 Microsoft Word 的 Office 檔案驗證功能已經啟用。如果客戶有安裝 [Microsoft Office 檔案驗證增益集](https://www.microsoft.com/download/details.aspx?familyid=6a4e39a4-4c3f-4cc7-98ec-1cb2d5cb5881) (KB2501584)，但是未曾套用過 Microsoft Word 的 Office 檔案驗證架構更新，便會發生上述情形。在此情況下，由於 MS12-029 包含 Microsoft Word 的結構更新，而且 Office 檔案驗證增益集已安裝，因此 Microsoft Word 的 Office 檔案驗證功能將會啟用。

您可以停用 Office 檔案驗證功能，方法是設定一個登錄機碼來避免Office 檔案驗證功能對檔案進行驗證。如需瞭解如何停用 Office 檔案驗證，請參閱[適用於 Office 2003 和 Office 2007 的 Office 檔案驗證](http://technet.microsoft.com/en-us/library/53782285-736e-4d00-b458-6170054287af.aspx)。除了停用 Office 檔案驗證功能外，Microsoft Word 2007 的客戶還有另一種做法可以選擇：客戶可以使用[信任位置功能](http://technet.microsoft.com/en-us/library/cc178948(office.12).aspx)來指定要排除在 Office 檔案驗證檢查範圍外的目錄。

**何處可找到檔案資訊詳細資料？**  
關於檔案資訊詳細資料的位置，請見＜資訊安全更新部署＞一節中的參考表。

**此資訊安全風險會如何影響 Microsoft Outlook？**  
因為資訊安全風險是存在 Microsoft Word 中，所以不會直接影響 Outlook。但如果將 Word 選為電子郵件閱讀程式 (此為 Microsoft Outlook 2007 的預設程式)，攻擊者就能將蓄意製作的 RTF 電子郵件訊息寄給目標使用者，以利用 Outlook 進行電子郵件攻擊行為。

**此資訊安全更新與 MS12-030有何關聯？**  
此公告中提供的 Microsoft Office 2008 for Mac 資訊安全更新封裝 (KB2665346) 和 Microsoft Office for Mac 2011 資訊安全更新封裝 (KB2665351)，也能解決 [MS12-030](http://go.microsoft.com/fwlink/?linkid=238499) 資訊安全公告中描述的資訊安全風險。
...
**Microsoft Office 獨立程式是如何受到此資訊安全風險影響？**  
...
<th style="border:1px solid black;" >RTF 不符資訊安全風險 - CVE-2012-0183</th>
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-0183](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0183) (英文)。
  
#### RTF 不符資訊安全風險 - CVE-2012-0183 的緩和因素
...
#### RTF 不符資訊安全風險 - CVE-2012-0183 的因應措施
...
-   **使用 Microsoft Office 檔案封鎖原則，來封鎖開啟來自於未知或不信任來源與位置的 RTF 文件**
    ...
    **因應措施的影響。** 使用者若已設定檔案封鎖原則，但尚未按照 [Microsoft 知識庫文件編號 922848](http://support.microsoft.com/kb/922848) 的說明來設定特殊豁免目錄或尚未把檔案移到信任位置，將無法在 Office 2003 或 2007 Microsoft Office System 中開啟 RTF 檔案。
...
#### RTF 不符資訊安全風險 - CVE-2012-0183 的常見問題集
...
在電子郵件攻擊案例中，攻擊者可藉由傳送內容包含蓄意製作之 RTF 格式資料的電子郵件訊息，來利用此資訊安全風險。如果收件者以 Microsoft Word 作為電子郵件檢視器，則當收件者在 Outlook 中預覽或開啟蓄意製作的 RTF 電子郵件訊息時，這項資訊安全風險便會遭到利用。攻擊者也可以藉由將蓄意製作的 RTF 檔案作為附件傳送，然後引誘使用者開啟該檔案，來利用這個資訊安全風險。請注意，Microsoft Word 是 Outlook 2007 中的預設電子郵件閱讀程式。
...
<td style="border:1px solid black;">受支援版本的 Word 2003：<br />
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/2598332">Microsoft 知識庫文件編號 2598332</a></td>
</tr>
<tr class="even">
...
#### Microsoft Office 2007 (所有版本) 和 Microsoft 相容性套件 (所有版本)
...
<tr class="odd">
<td style="border:1px solid black;">在沒有使用者介入的情況下安裝</td>
<td style="border:1px solid black;">所有受支援版本的 Word 2007：<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">關於 Word 2007，請參閱 <a href="http://support.microsoft.com/kb/2596917">Microsoft 知識庫文件編號 2596917</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">關於 Office 相容性套件，請參閱 <a href="http://support.microsoft.com/kb/2596880">Microsoft 知識庫文件編號 2596880</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
-   感謝匿名的研究人員與 [TippingPoint](http://www.tippingpoint.com/) 的 [Zero Day Initiative](http://www.zerodayinitiative.com/) 合作回報 RTF 不符資訊安全風險 (CVE-2012-0183)
...
-   V1.1 (2012 年 5 月 9 日)： 更正 Microsoft Office Compatibility Pack Service Pack 2 的更新程式取代資訊。此變更僅屬公告變更。偵測邏輯或資訊安全更新檔案沒有變更。  
-   V1.2 (2012 年 6 月 20 日)： 在更新常見問題集中加入新的條目，說明 Microsoft Word 2003 Service Pack 3 的更新 (KB2598332) 和 Microsoft Word 2007 Service Pack 2 的更新 (KB2596917) 包含 Office 檔案驗證的架構更新。
