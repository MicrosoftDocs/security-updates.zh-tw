...
<td style="border:1px solid black;">
KB2598332 取代 [MS10-079](https://go.microsoft.com/fwlink/?linkid=201696) 中的 KB2344911
</td>
</tr>
...
<td style="border:1px solid black;">
KB2596917 取代 [MS10-079](https://go.microsoft.com/fwlink/?linkid=201696) 中的 KB2344993
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2665346 取代 [MS11-094](https://go.microsoft.com/fwlink/?linkid=232493) 中的 KB2644354
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2665351 取代 [MS11-089](https://go.microsoft.com/fwlink/?linkid=225739) 中的 KB2644347
</td>
</tr>
<tr>
<th colspan="5" style="border:1px solid black;">
...
<td style="border:1px solid black;">
KB2596880 取代 [MS10-079](https://go.microsoft.com/fwlink/?linkid=201696) 中的 KB2345043
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
如需更多關於 Office 檔案驗證的資訊，請參閱 [Microsoft 安全性摘要報告 2501584](https://technet.microsoft.com/security/advisory/2501584)和 [Microsoft 知識庫文件編號 2501584](https://support.microsoft.com/kb/2501584)。
...
您可以停用 Office 檔案驗證功能，方法是設定一個登錄機碼來避免Office 檔案驗證功能對檔案進行驗證。如需瞭解如何停用 Office 檔案驗證，請參閱[適用於 Office 2003 和 Office 2007 的 Office 檔案驗證](https://technet.microsoft.com/en-us/library/53782285-736e-4d00-b458-6170054287af.aspx)。除了停用 Office 檔案驗證功能外，Microsoft Word 2007 的客戶還有另一種做法可以選擇：客戶可以使用[信任位置功能](https://technet.microsoft.com/en-us/library/cc178948(office.12).aspx)來指定要排除在 Office 檔案驗證檢查範圍外的目錄。
...
此公告中提供的 Microsoft Office 2008 for Mac 資訊安全更新封裝 (KB2665346) 和 Microsoft Office for Mac 2011 資訊安全更新封裝 (KB2665351)，也能解決 [MS12-030](https://go.microsoft.com/fwlink/?linkid=238499) 資訊安全公告中描述的資訊安全風險。
...
若要在「一般性資訊安全風險」清單標準條目中檢視此資訊安全風險，請參閱 [CVE-2012-0183](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0183) (英文)。
...
-   **使用 Microsoft Office 檔案封鎖原則，來封鎖開啟來自於未知或不信任來源與位置的 RTF 文件**
    ...
    **因應措施的影響。** 使用者若已設定檔案封鎖原則，但尚未按照 [Microsoft 知識庫文件編號 922848](https://support.microsoft.com/kb/922848) 的說明來設定特殊豁免目錄或尚未把檔案移到信任位置，將無法在 Office 2003 或 2007 Microsoft Office System 中開啟 RTF 檔案。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2598332">Microsoft 知識庫文件編號 2598332</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">關於 Word 2007，請參閱 <a href="https://support.microsoft.com/kb/2596917">Microsoft 知識庫文件編號 2596917</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">關於 Office 相容性套件，請參閱 <a href="https://support.microsoft.com/kb/2596880">Microsoft 知識庫文件編號 2596880</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
-   感謝匿名的研究人員與 [TippingPoint](https://www.tippingpoint.com/) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作回報 RTF 不符資訊安全風險 (CVE-2012-0183)
