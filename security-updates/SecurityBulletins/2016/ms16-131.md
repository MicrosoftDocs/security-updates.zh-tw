...
<td style="border:1px solid black;">
[**Microsoft Video Control 遠端執行程式碼弱點 – CVE-2016-7248**](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-7248)
...
<td style="border:1px solid black;">
[MS16-122](https://support.microsoft.com/zh-tw/kb/3190847) 中的 [3190847](http://go.microsoft.com/fwlink/?linkid=829051)
...
請注意，若在**＜受影響的軟體和弱點嚴重性等級＞**表格中，其嚴重性指示為「重大」，則 \[預覽窗格\] 是 [CVE-2016-7248](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-7248) 的攻擊媒介。
