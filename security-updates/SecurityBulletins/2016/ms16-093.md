...
安全性更新可修正下列弱點，詳情請參閱 Adobe 資訊安全公告 [APSB16-25](https://helpx.adobe.com/tw/security/products/flash-player/apsb16-25.html)。
...
**注意** 此公告討論的弱點會影響Windows Server 2016 Technical Preview 4 與 Windows Server 2016 Technical Preview 5。彙總嚴重性等級為「重大」，而影響等級為「中度」(遠端執行程式碼)。Windows Server 2016 Technical Preview 5 的更新僅透過 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 提供。不過，Windows Server 2016 Technical Preview 的更新尚未提供。為了保護弱點，Microsoft 建議客戶將Windows Server 2016 Technical Preview 4 更新至 Windows Server 2016 Technical Preview 5。
...
-   根據預設，Windows Server 2012 和 Windows Server 2012 R2 會以增強式安全性設定執行 [Enhanced Security Configuration](https://technet.microsoft.com/zh-tw/library/dd883248.aspx)r。此模式可協助降低在 Internet Explorer 中 Adobe Flash Player 弱點遭到利用的風險。
