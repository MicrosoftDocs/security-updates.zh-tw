...
<td style="border:1px solid black;">
[**.NET XML 驗證資訊安全功能略過 - CVE-2016-0132**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-0132)
...
**注意** Windows Server Technical Preview 4 將受到影響。建議執行此作業系統的客戶套用更新，您可以透過 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 取得更新。
...
請注意，這些重新發行的版本可透過 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 和 [Microsoft Update Catalog](https://catalog.update.microsoft.com/v7/site/home.aspx) 取得。
...
-   V2.0 (2016 年 5 月 10 日)：修訂公告，宣佈已重新發行 Microsoft .NET Framework 4.5.2 和 Microsoft .NET Framework 4.6/4.6.1 的安全性更新，以解決特定的列印情況問題。這些重新發行的版本可透過 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 和 [Microsoft Update Catalog](https://catalog.update.microsoft.com/v7/site/home.aspx) 取得。請注意，此重新發行的版本僅適用於 LDR (限制發行版本) 客戶。GDR (一般發行版本) 客戶不會受到影響。如需有關已重新發行的特定安全性更新的詳細資訊，請參閱此公告 (MS16-035) 的＜更新常見問題集＞一節。  
