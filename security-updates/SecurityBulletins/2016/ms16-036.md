---
TOCTitle: 'MS16-036'
Title: 'Microsoft 資訊安全公告 MS16-036 - 重大'
ms:assetid: 'ms16-036'
ms:contentKeyID: 72464254
ms:date: '05/27/2016'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms16-036(v=Security.10)'
---

Microsoft 資訊安全公告 MS16-036 - 重大
======================================

Adobe Flash Player 的安全性更新 (3144756)
-----------------------------------------
...
如需有關此更新的詳細資訊，請參閱 [Microsoft 知識庫文章編號 3144756](https://support.microsoft.com/zh-tw/kb/3144756)。

弱點資訊
--------

<span id="sectionToggle1"></span>
此安全性更新可解決 Adobe 資訊安全公告 [APSB16-08](https://helpx.adobe.com/tw/security/products/flash-player/apsb16-08.html) 中描述的以下弱點：
...
<td style="border:1px solid black;">
[Adobe Flash Player](https://www.microsoft.com/zh-tw/download/details.aspx?id=51482)  
(3144756)
...
<td style="border:1px solid black;">
[MS16-022](https://technet.microsoft.com/zh-tw/library/security/ms16-022) 中的 3135782
...
<td style="border:1px solid black;">
[Adobe Flash Player](https://www.microsoft.com/zh-tw/download/details.aspx?id=51481)  
(3144756)
...
<td style="border:1px solid black;">
[Adobe Flash Player](https://www.microsoft.com/zh-tw/download/details.aspx?id=51483)  
(3144756)
...
<td style="border:1px solid black;">
[Adobe Flash Player](https://www.microsoft.com/zh-tw/download/details.aspx?id=51480)  
(3144756)
...
<sup>[2]</sup>適用於 Windows 10 更新的 Adobe FlashPlayer 更新可透過 [Windows Update](https://update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=zh-tw) 或 [Microsoft Update Catalog](https://catalog.update.microsoft.com/v7/site/home.aspx) 取得。

**注意** Windows Server Technical Preview 4 已受到影響，彙總嚴重性等級為「重大」，而影響等級為「中度」(遠端執行程式碼)。建議執行此作業系統的客戶套用更新，您可以透過 [Windows Update](https://update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=zh-tw) 取得更新。
...
-   V1.0 (2016 年 3 月 10 日)：公告發行。

*頁面產生時間：2016-03-10 13:50-08:00。*
