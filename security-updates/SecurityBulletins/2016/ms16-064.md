...
<td style="border:1px solid black;">
[Adobe Flash Player](https://www.microsoft.com/zh-tw/download/details.aspx?id=52273)  
(3163207)
...
**注意**  Windows Server 2016 Technical Preview 5 已受到影響，彙總嚴重性等級為「重大」，而影響等級為「中度」(遠端執行程式碼)。建議執行此作業系統的客戶套用更新，您可以透過 [Windows Update](https://update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=zh-tw) 取得更新。
