---
TOCTitle: 'MS16-127'
Title: 'Microsoft 資訊安全公告 MS16-127 - 重大'
ms:assetid: 'ms16-127'
ms:contentKeyID: 74034447
ms:date: '10/12/2016'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms16-127(v=Security.10)'
---
...
如需有關此更新的詳細資訊，請參閱 [Microsoft 知識庫文章編號 3194343](https://support.microsoft.com/zh-tw/kb/3194343)。

弱點資訊
--------

 
安全性更新可修正下列弱點，詳情請參閱 Adobe 資訊安全公告 [APSB16-32](https://helpx.adobe.com/tw/security/products/flash-player/apsb16-32.html)。
...
<td style="border:1px solid black;">
[Adobe Flash Player](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=df116e5d-4820-4a9b-b70d-0c99f23a73e4)  
(3194343)
...
<td style="border:1px solid black;">
[Adobe Flash Player](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=279c8fd5-120c-4e5e-a863-eade11e8da2b)  
(3194343)
...
<td style="border:1px solid black;">
[Adobe Flash Player](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=01f67d06-5131-4490-8fa0-467b73238662)  
(3194343)
...
<td style="border:1px solid black;">
[Adobe Flash Player](https://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=3fd54cf7-510c-4f58-9aa3-90c464528ec7)  
(3194343)
...
**注意**：此公告討論的弱點會影響 Windows Server 2016 Technical Preview 5。若要保護系統免受這些弱點影響，Microsoft 建議執行此作業系統的客戶套用最新更新，您可以透過 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 提供。
...
-   **將網際網路和近端內部網路安全性區域設定為「高」，可封鎖區域內的 ActiveX 控制項和動態指令碼處理。**
    ...
    **注意**將層級設定為高安全性可能導致網站無法正確運作。如果您變更此設定後，使用網頁遇到問題，且確定此網站可安全使用，您可以將網站新增信任的網站清單。如此一來，即使採用 \[高\] 設定，該網站仍可正確運作。
