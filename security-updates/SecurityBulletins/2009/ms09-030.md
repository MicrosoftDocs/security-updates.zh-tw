...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-0566](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0566)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/969693/zh-tw">Microsoft 知識庫文件編號 969693</a></td>
</tr>
<tr class="even">
...
-   感謝 [Labo Skopia](https://www.laboskopia.com/) 的 Lionel d'Hauenens 與 [VersiSign iDefense Labs](https://www.idefense.com/) 合作，共同回報指標解除參照弱點 CVE-2009-0566 (CVE-2009-0566)。
