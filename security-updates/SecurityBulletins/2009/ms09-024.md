...
在 MS09-024 公告中，Microsoft Works 8.5 (KB967043) 與 Microsoft Works 9 (KB967044) 的安全性更新套件，同時也解決了 [MS09-017](https://go.microsoft.com/fwlink/?linkid=141704) 中所描述的弱點。已安裝 Microsoft Works 8.5 或 Microsoft Works 9 的使用者，只需安裝更新套件一次。

**什麼是 Microsoft Works 6-9 File Converter？**    
Microsoft Works 6-9 Converter 可讓 Microsoft Office Word 2003 開啟、編輯和儲存 Works 6、7、8 和 9 版所支援的 Works Word Processor 檔案格式的檔案。如需更多資訊，請參閱 [Microsoft Works 6–9 File Converter](https://www.microsoft.com/download/details.aspx?familyid=bf41401e-70fa-465d-ae2e-cf44dbf05297&displaylang=en)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-1533](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1533)。
...
-   只有安裝 Works Converter 之後，Microsoft Office Word 2003 才會受影響。 如需更多資訊，請參閱 [Microsoft Works 6–9 File Converter](https://www.microsoft.com/download/details.aspx?familyid=bf41401e-70fa-465d-ae2e-cf44dbf05297&displaylang=en)。
...
-   **若使用的 Word 2003 含有**[**Microsoft Works 6–9 File Converter**](https://www.microsoft.com/download/details.aspx?familyid=bf41401e-70fa-465d-ae2e-cf44dbf05297&displaylang=en) **以及 Word 2007，請藉由限制存取來停用 Works 6-9 Converter**
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/957838">Microsoft 知識庫文件編號 957838</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/957646">Microsoft 知識庫文件編號 957646</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
如果要移除此安全性更新程式，請使用 \[控制台\] 中的 \[新增或移除程式\] 工具。 **注意：** 當您移除此更新時，系統可能會提示您在 CD 光碟機中插入 Microsoft Office XP CD。 此外，您可能沒有從 \[控制台\] 內 \[新增或移除程式\] 工具中解除安裝更新的選項。 這個問題有數個可能的原因。 如需更多關於移除程式的資訊，請參閱 [Microsoft 知識庫文件編號 903771](https://support.microsoft.com/kb/903771)。
...
<tr class="even">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/968326">Microsoft 知識庫文件編號 968326</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/969559">Microsoft 知識庫文件編號 969559</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">Microsoft Works 8.5：<br />
請參閱 <a href="https://support.microsoft.com/kb/967043">Microsoft 知識庫文件編號 967043</a><br />
<br />
Microsoft Works 9：<br />
請參閱 <a href="https://support.microsoft.com/kb/967044">Microsoft 知識庫文件編號 967044</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
-   感謝 [NGS Software](https://www.ngssoftware.com/) 的 Shaun Colley 和 [Fourteenforty Research Institute, Inc.](https://www.fourteenforty.jp/) 的 Yuji Ukai 回報 File Converter 緩衝區溢位弱點 (CVE-2009-1533)
