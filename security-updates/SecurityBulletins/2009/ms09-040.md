---
TOCTitle: 'MS09-040'
Title: 'Microsoft Security Bulletin MS09-040 - 重要'
ms:assetid: 'ms09-040'
ms:contentKeyID: 61238309
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms09-040(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS09-040 - 重要
===========================================

訊息佇列中的弱點可能會允許權限提高 (971032)
-------------------------------------------
...
這個安全性更新可解決 Windows 訊息佇列服務 (MSMQ) 的一項未公開報告的弱點。 如果使用者在受影響的 MSMQ 服務收到蓄意製作的要求，則該弱點可能會允許權限提高。 依據預設，不會將訊息佇列元件安裝於任何受影響的作業系統版本上，且唯有具備系統管理權限的使用者才能啟用。 只有手動安裝 Message Queuing 元件的客戶可能會受此問題影響。

對於 Microsoft Windows 2000 Service Pack 4、Windows XP Service Pack 2、Windows XP Professional x64 Edition Service Pack 2、所有的 Windows Server 2003 支援版本、Windows Vista 和 Windows Vista x74 Edition，此安全性更新的等級為「重要」。 如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此安全性更新會修改 MSMQ 服務將輸入資料傳給配置的緩衝區之前，對該資料的驗證方式，進而解決此項弱點。 如需更多有關弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8ed8bad7-2885-452c-9c34-3982cd498be8">Microsoft Windows 2000 Service Pack 4 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=8ed8bad7-2885-452c-9c34-3982cd498be8">Microsoft Windows 2000 Service Pack 4 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-065">MS08-065</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=93490aa7-9985-4658-b0d7-88fb3f27ada0">Windows XP Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=93490aa7-9985-4658-b0d7-88fb3f27ada0">Windows XP Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-065">MS07-065</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=12e6be68-dc87-450e-927b-3c9b6873eb13">Windows XP Professional x64 Edition Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=52f59c56-2aba-4626-a90e-311e0e73c813">Windows Server 2003 Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=52f59c56-2aba-4626-a90e-311e0e73c813">Windows Server 2003 Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2f77ef7b-54f8-4260-b6a6-d62a0f85ef45">Windows Server 2003 x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=2f77ef7b-54f8-4260-b6a6-d62a0f85ef45">Windows Server 2003 x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ad55c653-ee6b-4c92-b7f4-3923bb916546">Windows Server 2003 SP2 for Itanium-based Systems (英文下載更新程式)</a></td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=00afd94c-b483-4155-884f-b617acca6e7d">Windows Vista (英文下載更新程式)</a></td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=a0c698aa-a913-4981-8798-6bbb8cacfb86">Windows Vista x64 Edition (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=a0c698aa-a913-4981-8798-6bbb8cacfb86">Windows Vista x64 Edition (中文下載更新程式)</a></td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<th style="border:1px solid black;" >MSMQ Null 指標弱點 - CVE-2009-1922</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
MSMQ Null 指標弱點 - CVE-2009-1922  
----------------------------------
  
<span></span>
Windows 訊息佇列服務 (MSMQ) 中存在權限提高弱點，原因在於訊息佇列服務收到 IOCTL 要求後，在剖析要求時出現特定錯誤。 MSMQ 服務以不當方式檢查輸入資料，然後再將資料傳遞至緩衝區。 成功利用此弱點的攻擊者可執行任意程式碼，並取得受影響之系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-1922](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1922)。
  
#### MSMQ Null 指標弱點 CVE-2009-1922 的緩和因素
...
#### MSMQ Null 指標弱點 CVE-2009-1922 的因應措施
...
-   **停用 Message Queuing Service：**
    ...
    -   以互動方式  
        停用 Message Queuing Service 有助於保護受影響的系統免遭此弱點的攻擊。 若要停用訊息佇列服務，請執行下列步驟：  
    ...
    -   根據群組原則：  
        ...
        **注意：** 您也可以參閱《Windows Serve 2003 安全性指南》(英文)。 其中包含了如何停用服務的資訊。  
        ...
        [瞭解群組原則功能集步驟指南 (英文)](https://technet.microsoft.com/zh-tw/library/bb742376.aspx)  
        [Windows 2000 群組原則 (英文)](https://technet.microsoft.com/zh-tw/library/bb742376.aspx)  
...
#### MSMQ Null 指標弱點 CVE-2009-1922 的常見問題集
  
**這個弱點的範圍為何？**    
這是權限提高的弱點。 成功利用此弱點的攻擊者可執行任意程式碼，並取得受影響之系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個弱點的原因為何？**    
MSMQ 服務未能正確驗證由使用者模式傳入核心模式的資料，而讓攻擊者能夠以 LOCAL SYSTEM 的權限層級執行任意程式碼。
  
**什麼是 Message Queuing？**    
Microsoft Message Queuing 技術能讓在不同時間執行的應用程式，跨越可能暫時離線的異質網路及系統進行溝通。 應用程式將訊息傳送到佇列，並讀取來自於佇列的訊息。 訊息佇列提供有保障的訊息傳遞、有效率的路由處理、安全性，和以優先順序為基礎的訊息處理。 它能用於實作非同步及同步訊息處理方式的解決方案。 如需更多關於訊息佇列的資訊，請參閱訊息佇列產品說明文件。
...
**攻擊者如何利用這項弱點？**    
攻擊者可以將蓄意製作的 IOCTL 要求傳送至 MSMQ 服務，藉此利用此弱點。 若是成功利用此弱點，可能會取得 LOCAL SYSTEM 權限，完整存取受影響的系統。
  
**因為這個弱點而承受風險的主要系統有哪些？**    
執行訊息佇列服務的工作站與伺服器受此弱點影響的風險最高。
  
**更新的作用何在？**    
此更新會修改 MSMQ 服務將輸入資料傳給配置的緩衝區之前，對該資料的驗證方式，進而解決此項弱點。
...
**Windows Vista 注意事項：** Microsoft Systems Management Server 2003 Service Pack 3 包含 Windows Vista 的支援。
...
| **部署**                               |                                                                                                                               |  
| 在沒有使用者介入的情況下安裝           | Windows2000-kb971032-x86-enu /quiet                                                                                           |  
| 在不重新啟動的情況下安裝               | Windows2000-kb971032-x86-enu /norestart                                                                                       |  
| 更新記錄檔                             | kb971032.log                                                                                                                  |  
| 詳細資訊                               | 請參閱＜偵測與部署工具及指南＞小節                                                                                            |  
| **重新開機需求**                       |                                                                                                                               |  
| 需要重新開機？                         | 是，套用此安全性更新之後，您必須重新啟動系統。                                                                                |  
| HotPatching                            | 不適用                                                                                                                        |  
| **移除資訊**                           | 使用 \[控制台\] 中的 \[新增或移除程式\] 工具，或是 %Windir%\\$NTUninstallKB971032$\\Spuninst 資料夾中的 Spuninst.exe 公用程式 |  
| **檔案資訊**                           | 請參閱 [Microsoft 知識庫文件編號 971032](https://support.microsoft.com/kb/971032/zh-tw)                                        |  
| **登錄機碼驗證**                       | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB971032\\Filelist                                     |
...
#### Windows XP Service Pack 2 及 Windows XP Professional x64 Edition Service Pack 2
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB971032$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/971032/zh-tw">Microsoft 知識庫文件編號 971032</a></td>
</tr>
<tr class="even">
...
#### Windows Vista 及 Window Vista x64 Edition
...
<tr class="odd">
<td style="border:1px solid black;">在沒有使用者介入的情況下安裝</td>
<td style="border:1px solid black;">適用於 Windows Vista：<br />
Windows6.0-KB971032-x86 /quiet<br />
<br />
適用於 Windows Vista x64 Edition：<br />
...
-   感謝 [Positive Technologies Research Team](https://en.securitylab.ru/lab/) 的 Nikita Tarakanov 回報 MSMQ Null 指標弱點 (CVE-2009-1922)
