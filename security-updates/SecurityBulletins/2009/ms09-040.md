...
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms08-065">MS08-065</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms07-065">MS07-065</a></td>
</tr>
<tr class="odd">
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-1922](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1922)。
...
-   **停用 Message Queuing Service：**
    ...
    -   根據群組原則：  
        ...
        **注意：** 您也可以參閱《Windows Serve 2003 安全性指南》(英文)。 其中包含了如何停用服務的資訊。  
        ...
        [瞭解群組原則功能集步驟指南 (英文)](http://technet.microsoft.com/zh-tw/library/bb742376.aspx)  
        [Windows 2000 群組原則 (英文)](http://technet.microsoft.com/zh-tw/library/bb742376.aspx)  
...
| **檔案資訊**                           | 請參閱 [Microsoft 知識庫文件編號 971032](http://support.microsoft.com/kb/971032/zh-tw)                                        |  
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/971032/zh-tw">Microsoft 知識庫文件編號 971032</a></td>
</tr>
<tr class="even">
...
-   感謝 [Positive Technologies Research Team](http://en.securitylab.ru/lab/) 的 Nikita Tarakanov 回報 MSMQ Null 指標弱點 (CVE-2009-1922)
