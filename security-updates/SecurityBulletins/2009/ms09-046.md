---
TOCTitle: 'MS09-046'
Title: 'Microsoft Security Bulletin MS09-046 - 重大'
ms:assetid: 'ms09-046'
ms:contentKeyID: 61238315
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms09-046(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS09-046 - 重大
===========================================

DHTML 編輯元件 ActiveX 控制項中的弱點可能會允許遠端執行程式碼 (956844)
----------------------------------------------------------------------

發行: 2009年9月9日 | 更新: 2009年10月20日
...
這個安全性更新能解決 DHTML 編輯元件 ActiveX 控制項中一項未公開報告的弱點。 攻擊者可蓄意製作網頁以利用此弱點。 當使用者檢視網頁時，此弱點可能會允許遠端執行程式碼。 成功利用此弱點的攻擊者可以取得與登入使用者相同的使用者權限。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

對於所有受支援版本的 Microsoft Windows 2000 和 Windows XP，此安全性更新的等級為「重大」；對於所有受支援版本的 Windows Server 2003，此安全性更新的等級則為「中度」。如需詳細資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

本安全性更新可透過修改 ActiveX 控制項格式化 HTML 標記的方式，解決此項弱點。 如需更多有關這些弱點的資訊，請參閱下節＜弱點資訊＞中特定弱點項目的＜常見問題集 (FAQ)＞小節。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=6dd4b0f8-6b54-49a6-a6df-9420f9fd3333">Microsoft Windows 2000 Service Pack 4 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=6dd4b0f8-6b54-49a6-a6df-9420f9fd3333">Microsoft Windows 2000 Service Pack 4 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8523d5be-88a2-4124-9b02-660f612e2a12">Windows XP Service Pack 2 及 Windows XP Service Pack 3 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=8523d5be-88a2-4124-9b02-660f612e2a12">Windows XP Service Pack 2 及 Windows XP Service Pack 3 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=dbc33f6b-61bf-409a-89b5-60002192e0e0">Windows XP Professional x64 Edition Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7478f73f-dd20-4cfa-a650-4c84f37ada2f">Windows Server 2003 Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=7478f73f-dd20-4cfa-a650-4c84f37ada2f">Windows Server 2003 Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=88bf502d-1a7c-447a-ac4c-401e1698669b">Windows Server 2003 x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=88bf502d-1a7c-447a-ac4c-401e1698669b">Windows Server 2003 x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8d881ff8-f51f-4476-8cb6-2bebd5b2047f">Windows Server 2003 SP2 for Itanium-based Systems (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
...
**此弱點與 MS09-037 中描述的弱點有何關聯？**    
此弱點與 MS09-037 中討論的 Microsoft Active Template Library (ATL) 弱點沒有關聯。使用易受影響的 ATL 版本並不會導致 DHTML 編輯元件 ActiveX 控制項弱點。
...
<th style="border:1px solid black;" >DHTML 編輯元件 ActiveX 控制項弱點 - CVE-2009-2519</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
DHTML 編輯元件 ActiveX 控制項弱點 - CVE-2009-2519  
-------------------------------------------------
  
<span></span>
DHTML 編輯元件 ActiveX 控制項中存在遠端執行程式碼弱點。 攻擊者可蓄意製作網頁以利用此弱點。 當使用者檢視網頁時，此弱點可能會允許遠端執行程式碼。 成功利用此弱點的攻擊者可以取得與登入使用者相同的使用者權限。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-2519](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2519)。
  
#### DHTML 編輯元件 ActiveX 控制項弱點 - CVE-2009-2519 的緩和因素
...
#### DHTML 編輯元件 ActiveX 控制項弱點 - CVE-2009-2519 的因應措施
  
因應措施指的是無法徹底修正弱點，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。 Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：
  
-   **避免 DHTML ActiveX 控制項 COM 物件在 Internet Explorer 中執行**
  
    您可以在登錄中設定控制項的 Kill Bit (刪除位元)，禁止嘗試在 Internet Explorer 中產生 DHTML ActiveX 控制項 COM 物件。
    ...
    **警告：**如果使用「登錄編輯程式」的方式錯誤，可能造成嚴重問題，以致於您必須重新安裝作業系統。 Microsoft 無法保證您可以解決因為不正確使用 \[登錄編輯程式\] 所造成的問題。 請自行承擔使用 \[登錄編輯程式\] 的風險。
    ...
    若要為 CLSID 值為 {2D360201-FFFS-11D1-8D03-00A0C959BC0A} 的 DHTML ActiveX 控制項設定其 Kill Bit (刪除位元)，請將下列文字貼到 \[記事本\] 之類的文字編輯程式中。 然後使用 .reg 副檔名存檔。
    ...
    **因應措施的影響：** 因為 DHTML ActiveX 控制項 COM 物件不會在 Internet Explorer 中執行，因此不會有任何影響。
...
#### DHTML 編輯元件 ActiveX 控制項弱點 - CVE-2009-2519 的常見問題集
  
**這個弱點的範圍為何？**    
這是遠端執行程式碼的弱點。 如果使用者透過具現化 ActiveX 控制項的 Internet Explorer 來檢視蓄意製作的網頁，這個弱點可能會允許遠端執行程式碼。 成功利用此弱點的攻擊者可以取得與登入使用者相同的使用者權限。
  
**造成這個弱點的原因為何？**    
在 Internet Explorer 中具現化 Microsoft DHTML 編輯元件 ActiveX 控制項時，控制項可能會使系統狀態損毀，使攻擊者有機會執行任意程式碼。
  
**什麼是 DHTML 編輯元件 ActiveX 控制項？**    
DHTML 編輯元件 ActiveX 控制項提供一個 HTML 編輯程式，您可以使用該程式，在軟體中支援動態網站 HTML 編輯。 如需更多關於 DHTML 編輯元件 ActiveX 控制項的資訊，請參閱 MSDN 文章 [MSHTML 編輯簡介](https://msdn.microsoft.com/en-us/library/aa753630(vs.85).aspx%20\l%20dhtnl_editor) (英文) 中的＜DHTML 編輯元件＞。
...
**更新的作用何在？**    
本安全性更新可透過修改 ActiveX 控制項格式化 HTML 標記的方式，解決此項弱點。
...
若要減少重新開機的可能性，請在安裝安全性更新之前，停止所有受影響的服務，並關閉所有可能使用受影響檔案的應用程式。 有關系統可能會提示您重新開機的原因的更多資訊，請參閱 <a href="https://support.microsoft.com/?id=887012">Microsoft 知識庫文件編號 887012</a>。</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB956844$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/956844/zh-tw">Microsoft 知識庫文件編號 956844</a></td>
</tr>
<tr class="even">
...
-   感謝 [Google Inc.](https://www.google.com/) 的 Tavis Ormandy 回報 DHTML 編輯元件 ActiveX 控制項弱點 (CVE-2009-2519)
...
-   V1.1 (2009 年 10 月 20 日)： 更正因應措施中 ActiveX 控制項的類別識別項「避免 DHTML ActiveX 控制項 COM 物件在 Internet Explorer 中執行」。
