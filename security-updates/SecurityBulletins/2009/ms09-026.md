---
TOCTitle: 'MS09-026'
Title: 'Microsoft Security Bulletin MS09-026 - 重要'
ms:assetid: 'ms09-026'
ms:contentKeyID: 61238295
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms09-026(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS09-026 - 重要
===========================================
...
此更新會修正 RPC 封送處理引擎更新其內部狀態的方式，以解決此弱點。 如需更多有關弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=155a79c1-e5e4-4f62-b4b0-53aca59f20ac">Microsoft Windows 2000 Service Pack 4 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=155a79c1-e5e4-4f62-b4b0-53aca59f20ac">Microsoft Windows 2000 Service Pack 4 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-058">MS07-058</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f033fa78-c451-44f8-aa6c-a49622c37f40">Windows XP Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=f033fa78-c451-44f8-aa6c-a49622c37f40">Windows XP Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-058">MS07-058</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f033fa78-c451-44f8-aa6c-a49622c37f40">Windows XP Service Pack 3 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=f033fa78-c451-44f8-aa6c-a49622c37f40">Windows XP Service Pack 3 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=20734b70-37f1-47dd-bc09-d56f93577a55">Windows XP Professional x64 Edition Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-058">MS07-058</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=62bb9e22-4f4b-4ffc-ba76-f626e94c79d5">Windows Server 2003 Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=62bb9e22-4f4b-4ffc-ba76-f626e94c79d5">Windows Server 2003 Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-058">MS07-058</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=888b8dd8-d76c-42f5-a377-1f1750d3cf56">Windows Server 2003 x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=888b8dd8-d76c-42f5-a377-1f1750d3cf56">Windows Server 2003 x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-058">MS07-058</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3084f46e-02b9-4d99-a7a1-033817f9bd9f">Windows Server 2003 SP2 for Itanium-based Systems (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-058">MS07-058</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5ca227c0-f2dd-429c-a542-e08e93527214">Windows Vista (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-058">MS07-058</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5ca227c0-f2dd-429c-a542-e08e93527214">Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=5ca227c0-f2dd-429c-a542-e08e93527214">Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=188adafe-1feb-46ad-b237-a88d35104dcd">Windows Vista x64 Edition (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=188adafe-1feb-46ad-b237-a88d35104dcd">Windows Vista x64 Edition (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-058">MS07-058</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=188adafe-1feb-46ad-b237-a88d35104dcd">Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=188adafe-1feb-46ad-b237-a88d35104dcd">Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=eaa26c6c-5bf7-4099-bb21-1e03de3a25ca">適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2</a>* (英文下載更新程式)
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=eaa26c6c-5bf7-4099-bb21-1e03de3a25ca">適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2</a>* (中文下載更新程式)</td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=447aaa4f-946b-4f23-b151-dcf46ea9f80e">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2</a>* (英文下載更新程式)
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=447aaa4f-946b-4f23-b151-dcf46ea9f80e">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2</a>* (中文下載更新程式)</td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f33012b9-5d5b-4f72-8d49-a8e1c8bc1337">適用於 Itanium 型系統的 Windows Server 2008 和適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<th style="border:1px solid black;" >RPC 封送處理引擎弱點 - CVE-2009-0568</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
RPC 封送處理引擎弱點 - CVE-2009-0568  
------------------------------------
  
 
Windows 遠端程序呼叫 (RPC) 機制中的 RPM 封送處理引擎未適當更新其內部狀態，因此存在權限提高的弱點。 未能更新內部狀態可能導致從錯誤的位置讀取指標。 成功利用此弱點的攻擊者可執行任意程式碼，並取得受影響之系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-0568](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0568)。
  
#### RPC 封送處理引擎弱點 - CVE-2009-0568 的緩和因素
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少弱點影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   受支援的 Microsoft Windows 版本未隨附於任何會遭利用此弱點的 RPC 伺服器或用戶端。 在預設設定中，攻擊者無法利用此弱點攻擊使用者。 但是，此弱點存在於 Microsoft Windows RPC 執行階段中，而且可能影響協力廠商 RPC 應用程式。
  
#### RPC 封送處理引擎弱點 - CVE-2009-0568 的因應措施
  
Microsoft 尚未找到此項弱點的任何因應措施。
  
#### RPC 封送處理引擎弱點 - CVE-2009-0568 的常見問題集
  
**這個弱點的範圍為何？**    
這是權限提高的弱點。 成功利用此弱點的攻擊者可執行任意程式碼，並取得受影響之系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個弱點的原因為何？**    
當遠端程序呼叫 (RPC) 封送處理引擎未以適當更新其內部狀態時，便會導致此弱點。 未能更新可能導致從錯誤的位置讀取指標。 只有使用內含非一致變化陣列之介面定義語言 (IDL) 的介面才會受到這個問題的影響。
  
**有哪些 RPC 應用程式可能受到這個弱點影響？**    
若要確定某個應用程式是否受到這個問題影響，使用者必須能存取編譯用戶端或伺服器應用程式所用的 IDL 檔案。 如果所產生的虛設常式包含 FC\_SMVARRAY 或 FC\_LGVARRAY，後面接著 FC\_VARIABLE REPEAT 和 FC\_VARIABLE\_OFFSET，則 RPC 應用程式就可能會受到這個弱點影響。
  
**什麼是遠端程序呼叫 (RPC)？**    
Microsoft 遠端程序呼叫 (RPC) 是一種程序間的通訊 (IPC) 機制，可允許資料交換和呼叫位於不同程序中的功能。 該程序可以在同一部電腦、區域網路 (LAN) 或網際網路上。 Microsoft RPC 機制會使用其他 IPC 機制，例如具名管道、NetBIOS 或 Winsock，來建立用戶端和伺服器之間的通訊。 使用 RPC 後，重要的程式邏輯和相關的程序程式碼就可以存在於不同的電腦上，而這對於分散式應用程式而言非常重要。 如需更多資訊，請參閱 TechNet 文章：[什麼是 RPC？](https://technet.microsoft.com/en-us/library/cc787851(ws.10).aspx) (英文)。
  
**什麼是 RPC 封送處理引擎？**    
RPC 封送處理引擎又稱為 NDR，提供 RPC 用戶端和伺服器之間的通用 RPC 介面。 NDR20 適用於 32 位元的架構，而 NDR64 則最適合用於 64 位元的架構。 無論程式的架構為何，用戶端和伺服器端都使用相同的封送處理引擎。 用戶端和伺服器會交涉要使用哪個封送處理引擎進行通訊。
  
**什麼是介面定義語言 (IDL) 檔案和應用程式設定檔 (ACF)？**    
介面定義語言 (IDL) 檔案包含用戶端和伺服器程式之間介面的描述。 RPC 應用程式會使用應用程式設定檔 (ACF) 來描述構成特定作業環境之硬體和作業系統之專屬介面的特性。 這項資訊會分成兩個檔案，是為了要分隔軟體介面和僅會影響作業環境的特性。
  
IDL 檔案會指定一個網路合約，定義用戶端和伺服器之間傳輸的內容。 將這項資訊和作業環境的相關資訊分開，便可將 IDL 檔案攜帶到其他環境。 IDL 檔案包含兩個部分： 一個[介面標頭](https://msdn.microsoft.com/en-us/library/aa378711(vs.85).aspx)和一個[介面主體](https://msdn.microsoft.com/en-us/library/aa378710(vs.85).aspx)。
  
ACF 會指定僅影響本機效能的屬性，而不是網路合約的屬性。 Microsoft RPC 可讓您將 ACF 和 IDL 屬性結合在單一 IDL 檔案中。 您也可以將多個介面結合在單一 IDL 檔案 (與其 ACF) 中。 如需更多資訊，請參閱 MSDN 文章：[IDL 和 ACF 檔案](https://msdn.microsoft.com/en-us/library/aa378708(vs.85).aspx) (英文)。
  
**什麼是程序間的通訊 (IPC)？**    
Microsoft Windows 作業系統提供許多機制，以促進應用程式之間的通訊和資料共用。 整體而言，這些機制所啟用的活動就稱為程序間的通訊 (IPC)。 某些形式的 IPC 可以促進幾個特定程序之間的分工。 其他形式的 IPC 則可促進網路上的電腦之間的分工。 如需更多資訊，請參閱 MSDN 文章：[程序間的通訊](https://msdn.microsoft.com/en-us/library/aa365574(vs.85).aspx) (英文)。
  
**攻擊者可能會利用這項弱點採取什麼行動？**    
成功利用此弱點的攻擊者能以提高的權限執行任意程式碼。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**攻擊者如何利用這項弱點？**    
攻擊者可以建立蓄意製作的 RPC 訊息，再透過受影響的 TCP 或 UDP 連接埠將訊息傳送到受影響的系統，以利用這項弱點。 然後，該訊息便允許用戶端將任意資料寫入 RPC 伺服器位址空間中的記憶體。 只有內含非一致變化陣列的 IDL 介面會受到這個問題的影響。
  
**因為這個弱點而承受風險的主要系統有哪些？**    
工作站及伺服器皆有風險。 系統若允許來自不受信任網路的 RPC 流量，則承受的風險較大。
  
**更新的作用何在？**    
此更新會修正 RPC 封送處理引擎更新其內部狀態的方式，以解決此弱點。
  
**當安全性公告發行時，這項弱點是否已被揭發出來？**    
是。 這項弱點已經遭到公開揭發。 這項弱點已被指派一般性弱點編號 [CVE-2009-0568](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0568)。
...
<td style="border:1px solid black;">適用於 Microsoft Windows 2000 Service Pack 4：<br />
使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB970238$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/970238/zh-tw">Microsoft 知識庫文件編號 970238</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>移除資訊</strong></td>
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB970238$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/??????/zh-tw">Microsoft 知識庫文件編號 970238</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
