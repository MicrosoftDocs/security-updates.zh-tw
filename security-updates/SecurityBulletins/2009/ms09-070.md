...
**已知問題。** [Microsoft 知識庫文件編號 971726](https://support.microsoft.com/kb/971726/?ln=zh-tw) 中記載了客戶安裝此資訊安全更新後，可能會發生的目前已知問題。 該文件並說明了解決這些問題的建議解決方案。
...
[Microsoft 知識庫文件編號 971726](https://support.microsoft.com/kb/971726/?ln=zh-tw) 詳細記錄安裝此資訊安全更新時，目前已知可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。
...
如需更多關於 Windows Server 2003 R2 的資訊，請參閱 [Windows Server 2003 R2](https://www.microsoft.com/windowsserver2003/default.mspx)網站 (英文)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-2508](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2508)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-2509](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2509)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/971726/?ln=zh-tw">Microsoft 知識庫文件編號 971726</a></td>
</tr>
<tr class="even">
