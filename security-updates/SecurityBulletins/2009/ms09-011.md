---
TOCTitle: 'MS09-011'
Title: 'Microsoft Security Bulletin MS09-011 - 重大'
ms:assetid: 'ms09-011'
ms:contentKeyID: 61238280
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms09-011(v=Security.10)'
---



Microsoft Security Bulletin MS09-011 - 重大
===========================================
...
此安全性更新藉由修正 DirectShow 解壓縮媒體檔案的方式，來解決此弱點。 如需更多有關弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。
...
<td style="border:1px solid black;">
[DirectX 8.1 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=0ec5b7c7-13d3-467a-b24e-3cc6fb47adf6)  
[DirectX 8.1 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=0ec5b7c7-13d3-467a-b24e-3cc6fb47adf6)
...
<td style="border:1px solid black;">
[DirectX 9.0 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=8b98ed5c-a3ab-45a7-a61e-349eae304bc6)\*  
[DirectX 9.0 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=8b98ed5c-a3ab-45a7-a61e-349eae304bc6)\*
...
<td style="border:1px solid black;">
[DirectX 9.0 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=feb5d821-f210-40e8-b1aa-2ca3170df8df)\*  
[DirectX 9.0 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=feb5d821-f210-40e8-b1aa-2ca3170df8df)\*
...
<td style="border:1px solid black;">
[DirectX 9.0 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=f1be8b7c-4874-4342-99b3-76ff725fbb9a)\*
</td>
<td style="border:1px solid black;">
遠端執行程式碼
</td>
...
<td style="border:1px solid black;">
[DirectX 9.0 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=c1b4cd76-1dd6-43fa-bb9a-20c428985bfd)\*  
[DirectX 9.0 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=c1b4cd76-1dd6-43fa-bb9a-20c428985bfd)\*
...
<td style="border:1px solid black;">
[DirectX 9.0 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=f0e1e1db-94a5-451c-ab11-6b431fa065f1)\*  
[DirectX 9.0 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=f0e1e1db-94a5-451c-ab11-6b431fa065f1)\*
...
<td style="border:1px solid black;">
[DirectX 9.0 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=8f36c215-fa8a-40c2-b680-6b1fece03b8d)\*
</td>
<td style="border:1px solid black;">
遠端執行程式碼
</td>
...
**何處可找到檔案資訊詳細資料？**    
如需檔案資訊詳細資料，請參閱 [Microsoft 知識庫文件編號 961373](https://support.microsoft.com/kb/961373/zh-tw)。
...
<tr>
<td style="border:1px solid black;">
含 DirectX 8.1 的 Microsoft Windows 2000 Service Pack
</td>
<td style="border:1px solid black;">
**重大**  
**遠端執行程式碼**
...
<tr class="alternateRow">
<td style="border:1px solid black;">
含 DirectX 9.0\* 的 Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**重大**  
**遠端執行程式碼**
...
<tr>
<td style="border:1px solid black;">
含 DirectX 9.0\* 的 Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2
</td>
<td style="border:1px solid black;">
**重大**  
**遠端執行程式碼**
...
<tr class="alternateRow">
<td style="border:1px solid black;">
含 DirectX 9.0\* 的 Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2
</td>
<td style="border:1px solid black;">
**重大**  
**遠端執行程式碼**
...
<tr>
<td style="border:1px solid black;">
含 DirectX 9.0\* 的 Windows Server 2003 SP1 for Itanium-based Systems 和 Windows Server 2003 SP2 for Itanium-based Systems
</td>
<td style="border:1px solid black;">
**重大**  
**遠端執行程式碼**
...
Microsoft DirectShow 處理受支援格式檔案的方式中，存在遠端執行程式碼的弱點。 如果使用者開啟蓄意製作的 MJPEG 檔案，此弱點可能會允許執行程式碼。 如果使用者以系統管理的使用者權限登入，成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-0084](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0084)。

#### MJPEG 解壓縮弱點 - CVE-2009-0084 的緩和因素
...
#### MJPEG 解壓縮弱點 - CVE-2009-0084 的因應措施

因應措施指的是無法徹底修正弱點，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。 Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：

-   **停用 Quartz.dll 中 MJPEG 內容的解碼**
    ...
    **使用互動方法**
    ...
    2.  找出並按一下下列登錄子機碼： HKEY\_CLASSES\_ROOT\\CLSID\\{301056D0-6DFF-11D2-9EEB-006008039E37}
    3.  按一下 \[檔案\] 功能表，再選取 \[匯出\]。
    4.  在 \[匯出登錄檔案\] 對話方塊中，輸入 **MJPEG\_Decoder\_Backup.reg**，然後再按一下 \[儲存\]。
    ...
    **如何復原因應措施：**
    ...
    1.  依序按一下 \[開始\]、\[執行\]，在 \[開啟\] 方塊中輸入 **Regedit**，然後按一下 \[確定\]。
    2.  按一下 \[檔案\] 功能表，再選取 \[匯入\]。
    3.  在 \[匯入登錄檔案\] 對話方塊中，選取 **MJPEG\_Decoder\_Backup.reg**，然後再按一下 \[開啟\]。
...
**攻擊者如何利用這項弱點？**    
使用者必須開啟蓄意製作的 MJPEG 檔案，或從網站或任何提供 Web 內容的應用程式接收蓄意製作的串流內容，此弱點才會遭到利用。
...
**更新的作用何在？**    
此更新藉由修正 DirectShow 解壓縮媒體檔案的方式，來解決此弱點。
...
<td style="border:1px solid black;">含 DirectX 8.1 的 Microsoft Windows 2000 Service Pack 4：<br />
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/961373/zh-tw">Microsoft 知識庫文件編號 961373</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">在不重新啟動的情況下安裝</td>
<td style="border:1px solid black;">含 DirectX 9.0、DirectX 9.0a、DirectX 9.0b 或 DirectX 9.0c 的所有 32 位元 Windows XP Service Pack 3 支援版本：<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>移除資訊</strong></td>
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB961373$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/961373/zh-tw">Microsoft 知識庫文件編號 961373</a></td>
...
-   感謝 [Kryptos Logic](https://www.kryptoslogic.com/) 的 Piotr Bania 回報 MJPEG 解壓縮弱點 (CVE-2009-0084)
