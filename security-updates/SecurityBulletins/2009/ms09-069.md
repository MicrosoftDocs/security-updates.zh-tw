---
TOCTitle: 'MS09-069'
Title: 'Microsoft Security Bulletin MS09-069 - 重要'
ms:assetid: 'ms09-069'
ms:contentKeyID: 61238338
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms09-069(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS09-069 - 重要
===========================================

本地安全性授權子系統服務中的弱點可能會允許拒絕服務 (974392)
-----------------------------------------------------------
...
這個資訊安全更新可解決 Microsoft Windows 中一項未公開報告的弱點。 如果通過驗證的遠端攻擊者，在透過網際網路通訊協定安全性 (LSASS) 與受影響系統的本地安全性授權子系統服務 (LSASS) 進行通訊時，傳送蓄意製作的 ISAKMP 訊息，此弱點會允許拒絕服務。

對於所有 Microsoft Windows 2000、Windows XP 及 Windows Server 2003 支援版本，此資訊安全更新的等級為「重大」。如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。

此資訊安全更新藉由變更該 LSASS 處理蓄意製作之要求的方式，來解決此弱點。 如需更多有關弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=560e01db-5f59-4ef1-9406-f5d7e0fd4128">Microsoft Windows 2000 Service Pack 4 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=560e01db-5f59-4ef1-9406-f5d7e0fd4128">Microsoft Windows 2000 Service Pack 4 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">拒絕服務</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms06-025">MS06-025</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5448b168-6bf7-4bae-9627-b88d76c4d5c5">Windows XP Service Pack 2 及 Windows XP Service Pack 3 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=5448b168-6bf7-4bae-9627-b88d76c4d5c5">Windows XP Service Pack 2 及 Windows XP Service Pack 3 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">拒絕服務</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c2bbf515-f81a-436b-947b-cbf2db85fdd9">Windows XP Professional x64 Edition Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">拒絕服務</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=a779aae1-7724-4458-94fb-a2343356ecae">Windows Server 2003 Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=a779aae1-7724-4458-94fb-a2343356ecae">Windows Server 2003 Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">拒絕服務</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=a8a9bf12-4ad6-49fd-b2b7-f379dc3309d2">Windows Server 2003 x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=a8a9bf12-4ad6-49fd-b2b7-f379dc3309d2">Windows Server 2003 x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">拒絕服務</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f5b003ad-af25-488a-91fb-98835a0bfeac">Windows Server 2003 SP2 for Itanium-based Systems (英文下載更新程式)</a></td>
<td style="border:1px solid black;">拒絕服務</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<th style="border:1px solid black;" >
本地安全性授權子系統服務資源耗盡弱點 - CVE-2009-3675  
</th>
<th style="border:1px solid black;" >
彙總嚴重性等級  
</th>
...
<span></span>
Microsoft Windows 存在一個拒絕服務弱點，原因是本地安全性授權子系統服務 (LSASS) 在透過 IPSec 進行通訊時，以不當方式處理蓄意製作的 ISAKMP 訊息所致。

若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-3675](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3675)。

#### 本地安全性授權子系統服務資源耗盡弱點 - CVE-2009-3675 的緩和因素

Microsoft 尚未找到此項弱點的任何緩和因素。

#### 本地安全性授權子系統服務資源耗盡弱點 - CVE-2009-3675 的因應措施

因應措施指的是無法徹底修正弱點，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。 Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：

-   停用 IPSec 服務

    如果 IPSec 服務並非使用中，您可以停用此服務。
    ...
    **注意：**不當使用「登錄編輯程式」可能會造成嚴重的問題，甚至可能需要重新安裝您的作業系統。 Microsoft 無法保證能夠順利解決因不當使用「登錄編輯程式」所造成的問題。 請自行承擔使用 \[登錄編輯程式\] 的風險。 如需有關如何編輯登錄的資訊，請檢視「登錄編輯程式」(Regedit.exe) 中的＜變更機碼及數值＞說明主題，或是 Regedt32.exe 中的＜新增及刪除登錄中的資訊＞與＜編輯登錄資料＞說明主題。
    ...
    -   **使用互動方法**
        ...
        3.  依序展開 \[System\]、\[CurrentControlSet\]、\[Services\]。
        4.  按一下 \[PolicyAgent\] 機碼
        5.  執行下列步驟來建立登錄機碼的備份：
            在 \[檔案\] 功能表上，按一下 \[匯出\]。
            在 \[匯出登錄檔案\] 對話方塊中，輸入 **PolicyAgent\_configuration\_backup.reg**，然後按一下 \[儲存\]。
        6.  . 在 \[PolicyAgent\] 機碼下，按兩下名稱為 \[Start\] 的值。
        7.  將 \[數值資料\] 欄位變更為 \[4\]。
        8.  按一下 \[確定\]。
        9.  . 以系統管理員的身分，在命令提示字元中執行下列命令：
    ...
    -   **使用管理的部署指令碼**
        ...
        2.  將下列登錄機碼儲存到副檔名為 .REG 的檔案中 (例如 Disable\_PolicyAgent.reg)：
        ...
        5.  執行下列步驟來建立登錄機碼的備份：
            在 \[檔案\] 功能表上，按一下 \[匯出\]。
            在 \[匯出登錄檔案\] 對話方塊中，輸入 **PolicyAgent\_configuration\_backup.reg**，然後按一下 \[儲存\]。
        6.  使用下述命令，在目標系統上執行步驟 2 所建立的登錄指令碼：
            Regedit /s Disable\_PolicyAgent.reg
        7.  將 \[數值資料\] 欄位變更為 \[4\]。
        8.  按一下 \[確定\]。
        9.  在目標系統上以系統管理員的身分，在命令提示字元中執行下列命令：
            net stop PolicyAgent

    **因應措施的影響。**特定電腦將無法使用 IPSec。
...
-   **使用互動方法**
    1.  依序按一下 \[開始\]、\[執行\]，在 \[開啟\] 方塊中輸入 **Regedit**，然後按一下 \[確定\]。
    2.  在 \[檔案\] 功能表上，按一下匯入。
    3.  在 \[匯入登錄檔案\] 對話方塊中，選取 \[PolicyAgent\_configuration\_backup.reg\]，然後按一下 \[開啟\]。
...
#### 本地安全性授權子系統服務資源耗盡弱點 - CVE-2009-3675 的常見問題集

**這個弱點的範圍為何？**  
這是一項拒絕服務的弱點。 通過驗證的遠端攻擊者可在透過 IPSec 與伺服器通訊時，傳送蓄意製作的 ISAKMP 訊息，造成 LSASS.exe 消耗系統資源，進而導致拒絕服務，並持續到重新啟動伺服器為止。

**造成這個弱點的原因為何？**  
這個弱點存在的原因，是由於 LSASS 不當處理含有格式錯誤封包的蓄意製作 ISAKMP 訊息所致。

**什麼是 IPSec** 
網際網路通訊協定安全性 (IPSec) 是一種開放標準架構，可使用密碼編譯安全性服務，透過網際網路通訊協定 (IP) 網路保護通訊安全。 IPSec 支援網路層級的對等驗證、資料來源驗證、資料完整性、資料機密性 (加密)，以及重新執行保護。 Microsoft 的 IPSec 實作，是以網際網路工程任務推動小組 (IETF) IPSec 工作小組所開發的標準為基礎。

**什麼是 LSASS？**  
本地安全性授權子系統服務 (LSASS) 提供管理本機安全性、網域驗證及 Active Directory 服務處理程序的介面。 LSASS 會為用戶端與伺服器處理驗證作業。 LSASS 也包含支援 Active Directory 公用程式的功能。

**什麼是 IKE？**  
IKE 是在 RFC 2409 中定義的一個網際網路標準，說明建立 IPSec 安全性關聯 (SAs) 的機制。 SA 是一套經過雙方同意的原則與機碼，定義出有助於保護 IPSec 對等個體之間通訊的安全性服務與機制。 具體來說，IKE 結合了 RFC 2408 中的網際網路安全性關聯與金鑰管理通訊協定 (ISAKMP)，以及 RFC 2412 中的 Oakley 金鑰判定通訊協定。
IKE 使用 Oakley 通訊協定，為受保護的通訊產生秘密金鑰資料。 IKE 使用 ISAKMP 來交涉 SA。

**什麼是 ISAKMP 訊息？**  
ISAKMP 是一套交涉受保護通訊的架構，此架構與特定的金鑰交換通訊協定、加密與完整性演算法，以及驗證方法等皆無關。 ISAKMP 包含識別及驗證對等個體、管理 SA，以及交換金鑰資料所需的設備。

**攻擊者可能會利用這項弱點採取什麼行動？**  
成功利用此弱點的攻擊者可使受影響的系統消耗 CPU 資源，而無法回應要求，直到重新啟動為止。

**攻擊者如何利用這項弱點？**  
攻擊者可以在透過 IPSEC 與 LSASS 伺服器建立連線並通過驗證後，傳送蓄意製作的 ISAKMP 訊息，以利用這項弱點。

**因為這個弱點而承受風險的主要系統有哪些？**  
要求或需要與用戶端進行 IPSec 通訊的伺服器，受此弱點影響的風險最高。

**更新的作用何在？**  
此更新會改變 LSASS 處理蓄意製作之 ISAKMP 要求的方式。
...
| **部署**                               |                                                                                                                               |
| 在沒有使用者介入的情況下安裝           | Windows2000-KB974392-x86-ENU /quiet                                                                                           |
| 在不重新啟動的情況下安裝               | Windows2000-KB974392-x86-ENU /norestart                                                                                       |
| 更新記錄檔                             | KB974392.log                                                                                                                  |
| 詳細資訊                               | 請參閱＜偵測與部署工具及指南＞小節                                                                                            |
| **重新開機需求**                       |                                                                                                                               |
| 需要重新開機？                         | 是，套用此資訊安全更新之後，您必須重新啟動系統。                                                                              |
| HotPatching                            | 不適用                                                                                                                        |
| **移除資訊**                           | 使用 \[控制台\] 中的 \[新增或移除程式\] 工具，或是 %Windir%\\$NTUninstallKB974392$\\Spuninst 資料夾中的 Spuninst.exe 公用程式 |
| **檔案資訊**                           | 請參閱 [Microsoft 知識庫文件編號 974392](https://support.microsoft.com/kb/974392/?ln=zh-tw)                                    |
| **登錄機碼驗證**                       | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB974392\\Filelist                                     |
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB974392$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/974392/?ln=zh-tw">Microsoft 知識庫文件編號 974392</a></td>
</tr>
<tr class="even">
