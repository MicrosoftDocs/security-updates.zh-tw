---
TOCTitle: 'MS09-067'
Title: 'Microsoft Security Bulletin MS09-067 - 重要'
ms:assetid: 'ms09-067'
ms:contentKeyID: 61238336
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms09-067(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS09-067 - 重要
===========================================

Microsoft Office Excel 中的弱點可能會允許遠端執行程式碼 (972652)
----------------------------------------------------------------
...
這個資訊安全公告更新可解決 Microsoft Office Excel 中數個未公開報告的弱點。 如果使用者開啟蓄意製作的 Excel 檔案，上述弱點可能會允許遠端執行程式碼。 成功利用這類任一弱點的攻擊者可以取得與本機使用者相同的使用者權限。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

對於所有受支援版本的 Microsoft Office Excel 2002、Microsoft Office Excel 2003、Microsoft Office Excel 2007、Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac；Open XML File Format Converter for Mac；所有受支援版本的 Microsoft Office Excel Viewer，以及 Microsoft Office 相容性套件，此資訊安全公告更新的等級為「重要」。

此更新會修改 Excel 開啟和剖析 Excel 檔案的方式，並且修改 Excel 處理格式錯誤記錄的方式以解決弱點。 如需更多有關弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。

**建議。** Microsoft 建議客戶應該儘快套用此更新程式。

**已知問題。** [Microsoft 知識庫文件編號 972652](https://support.microsoft.com/kb/972652/?ln=zh-tw) 中記載了客戶安裝此資訊安全公告更新後，可能會發生的目前已知問題。 該文件並說明了解決這些問題的建議解決方案。 目前已知問題和建議解決方案僅適用於此軟體的特定版本，本文會提供詳細文章的連結。
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2002 Service Pack 3 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=5672c8fc-8509-4962-ad86-ebc0f2575043)  
(KB973471)  
[Microsoft Office Excel 2002 Service Pack 3 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=5672c8fc-8509-4962-ad86-ebc0f2575043)  
(KB973471)
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2003 Service Pack 3 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=6a6a0f5d-17dc-4a34-b9a0-0774aa287ba5)  
(KB973475)  
[Microsoft Office Excel 2003 Service Pack 3 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=6a6a0f5d-17dc-4a34-b9a0-0774aa287ba5)  
(KB973475)
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2007 Service Pack 1 和 Microsoft Office Excel 2007 Service Pack 2 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=322b24ca-aff6-4ca0-acf1-440cae0f9693)\*  
(KB973593)  
[Microsoft Office Excel 2007 Service Pack 1 和 Microsoft Office Excel 2007 Service Pack 2 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=322b24ca-aff6-4ca0-acf1-440cae0f9693)\*  
(KB973593)
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office Excel Viewer 2003 Service Pack 3 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=19151e22-5642-456c-bd39-298574369cdb)  
(KB973484)  
[Microsoft Office Excel Viewer 2003 Service Pack 3 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=19151e22-5642-456c-bd39-298574369cdb)  
(KB973484)
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office Excel Viewer Service Pack 1 和 Microsoft Office Excel Viewer Service Pack 2 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=fb36df5e-ebef-46bf-9edd-67f2c76dbdb3)  
(KB973707)  
[Microsoft Office Excel Viewer Service Pack 1 和 Microsoft Office Excel Viewer Service Pack 2 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=fb36df5e-ebef-46bf-9edd-67f2c76dbdb3)  
(KB973707)
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office Word、Excel 及 PowerPoint 2007 檔案格式相容性套件 Service Pack 1 和 Microsoft Office Word、Excel 及 PowerPoint 2007 檔案格式相容性套件 Service Pack 2 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=c4c92d2e-e87d-446f-8d3e-8f4be10c70aa)  
(KB973704)  
[Microsoft Office Word、Excel 及 PowerPoint 2007 檔案格式相容性套件 Service Pack 1 和 Microsoft Office Word、Excel 及 PowerPoint 2007 檔案格式相容性套件 Service Pack 2 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=c4c92d2e-e87d-446f-8d3e-8f4be10c70aa)  
(KB973704)
...
\*針對 Microsoft Office Excel 2007 Service Pack 1 和 Microsoft Office Excel 2007 Service Pack 2，除了資訊安全公告更新套件 KB973593，客戶還需要安裝 [Microsoft Office Word、Excel 及 PowerPoint 2007 檔案格式相容性套件 Service Pack 1 和 Microsoft Office Word、Excel 及 PowerPoint 2007 檔案格式相容性套件 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c4c92d2e-e87d-446f-8d3e-8f4be10c70aa) (KB973704) 的資訊安全公告更新，才能免於受此公告中描述的弱點影響。
...
**安裝此資訊安全公告更新後，已知可能會發生的問題有哪些？**  
[Microsoft 知識庫文件編號 972652](https://support.microsoft.com/kb/972652/?ln=zh-tw) 詳細記錄安裝此資訊安全公告更新時，目前已知可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。

**此更新是否包含任何與安全性無關的功能變更？**  
是。 在這個資訊安全公告更新安裝以後，如果使用者開啟蓄意製作的 Excel 檔案，則 Excel 可能會意外結束，但是此更新所述之弱點不會遭到利用。
...
MS09-068 亦描述了 Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac 及 Open XML File Format Converter for Mac 中的弱點。 MS09-068 與此公告 (MS09-067) 有何關聯？在 MS09-067 公告中，適用於 Microsoft Office 2004 for Mac (KB976830)、Microsoft Office 2008 for Mac (KB976828) 和 Open XML File Format Converter for Mac (KB976831) 的資訊安全公告更新套件，也解決了 MS09-068 中所描述的弱點。已安裝 Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac、或 Open XML File Format Converter for Mac 的使用者只需安裝這些資訊安全公告更新套件一次。
...
<th style="border:1px solid black;" >
Excel 快取記憶體損毀弱點 - CVE-2009-3127
</th>
<th style="border:1px solid black;" >
Excel SxView 記憶體損毀弱點 - CVE-2009-3128
</th>
<th style="border:1px solid black;" >
Excel Featheader 記錄記憶體損毀弱點 - CVE-2009-3129
</th>
<th style="border:1px solid black;" >
Excel 文件剖析堆積溢位弱點 - CVE-2009-3130
</th>
<th style="border:1px solid black;" >
Excel 公式剖析記憶體損毀弱點 - CVE-2009-3131
</th>
<th style="border:1px solid black;" >
Excel 索引剖析弱點 - CVE-2009-3132
</th>
<th style="border:1px solid black;" >
Excel 文件剖析記憶體損毀弱點 - CVE-2009-3133
</th>
<th style="border:1px solid black;" >
Excel 欄位清理弱點 - CVE-2009-3134
</th>
<th style="border:1px solid black;" >
彙總嚴重性等級
</th>
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-3127](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3127)。

#### Excel 快取記憶體損毀弱點 - CVE-2009-3127 的緩和因素
...
#### Excel 快取記憶體損毀弱點 - CVE-2009-3127 的因應措施
...
-   **使用 Microsoft Office 檔案封鎖原則來封鎖開啟來自於未知或不信任來源與位置的 Office 2003 和先前文件**
    ...
    **注意：**不當修改登錄檔可能會造成嚴重的問題，甚至可能需要重新安裝您的作業系統。 Microsoft 無法保證能夠順利解決因不當修改登錄檔所造成的問題。 如要修改登錄檔，請自行承擔相關風險。
    ...
    -   適用於 Office 2003
        ...
        **注意：**為將 'FileOpenBlock' 與 Office 2003 搭配使用，必須套用所有最新 Office 2003 資訊安全公告更新。

    **因應措施的影響** 使用者若設定檔案封鎖原則、但尚未依照 Microsoft [知識庫文件編號 922848](https://support.microsoft.com/kb/922848/?ln=zh-tw) 所討論設定特殊的「豁免目錄」，將無法在 Office 2003 或 2007 Microsoft Office System 中開啟 Office 2003 檔案或先前版本。
...
#### Excel 快取記憶體損毀弱點 - CVE-2009-3127 的常見問題集

**這個弱點的範圍為何？**  
這是遠端執行程式碼的弱點。 成功利用此弱點的攻擊者可以從遠端取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，或檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。

**造成這個弱點的原因為何？**  
Microsoft Office Excel 開啟蓄意製作之 Excel 試算表時剖析 Excel 試算表檔案格式的方式存在弱點。
...
**攻擊者如何利用這項弱點？**  
要利用此弱點，必須讓使用者以受影響的 Microsoft Office Excel 版本，開啟蓄意製作的 Excel 試算表。
...
<span></span>
Microsoft Office Excel 處理蓄意製作含有格式錯誤記錄物件之 Excel 檔案的方式中，存在遠端執行程式碼的弱點。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。

若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-3128](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3128)。

#### Excel SxView 記憶體損毀弱點 - CVE-2009-3128 的緩和因素
...
#### Excel SxView 記憶體損毀弱點 - CVE-2009-3128 的因應措施
...
#### Excel SxView 記憶體損毀弱點 - CVE-2009-3128 的常見問題集
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-3129](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3129)。

#### Excel Featheader 記錄記憶體損毀弱點 - CVE-2009-3129 的緩和因素
...
#### Excel Featheader 記錄記憶體損毀弱點 - CVE-2009-3129 的因應措施
...
-   **使用 Microsoft Office 檔案封鎖原則來封鎖開啟來自於未知或不信任來源與位置的 Office 2003 和先前文件**
    ...
    **注意：**不當修改登錄檔可能會造成嚴重的問題，甚至可能需要重新安裝您的作業系統。 Microsoft 無法保證能夠順利解決因不當修改登錄檔所造成的問題。 如要修改登錄檔，請自行承擔相關風險。
    ...
    -   適用於 Office 2007
        ...
        "BinaryFiles"=dword:00000001
        **注意：**為將 'FileOpenBlock' 與 Office 2007 搭配使用，必須套用截至 2007 年 5 月的所有最新 Office 2007 資訊安全公告更新。
...
#### Excel Featheader 記錄記憶體損毀弱點 - CVE-2009-3129 的常見問題集
...
<span></span>
Microsoft Office Excel 處理蓄意製作含有格式錯誤 BIFF 記錄之 Excel 檔案的方式中，存在遠端執行程式碼的弱點。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。

若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-3130](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3130)。

#### Excel 文件剖析堆積溢位弱點 - CVE-2009-3130 的緩和因素
...
#### Excel 文件剖析堆積溢位弱點 - CVE-2009-3130 的因應措施

因應措施指的是無法徹底修正弱點，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。 Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：

-   對於來自於不受信任的來源或在非預期情況下從信任來源收到的 Excel 檔案，請勿隨意開啟。 當使用者開啟蓄意製作的檔案時，即可能遭受利用此弱點的攻擊。

#### Excel 文件剖析堆積溢位弱點 - CVE-2009-3130 的常見問題集

**這個弱點的範圍為何？**  
這是遠端執行程式碼的弱點。 成功利用此弱點的攻擊者可以從遠端取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，或檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。

**造成這個弱點的原因為何？**  
發生弱點的原因是 Excel 對於內含錯誤二進位檔案格式 (BIFF) 記錄的 Excel 檔案處理方式不正確，導致記憶體可能會遭到損壞，使攻擊者有機會執行任意程式碼。
...
**更新的作用何在？**  
此更新程式會修改 Excel 對於格式錯誤 BIFF 記錄的處理方式，進而移除此項弱點。
...
<span></span>
Microsoft Office Excel 處理蓄意製作於儲存格內嵌特殊公式之 Excel 檔案的方式中，存在遠端執行程式碼的弱點。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 然後，攻擊者可能會安裝程式，檢視、變更或刪除資料，或建立具有目前登入使用者全部使用權限的新帳戶。

若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-3131](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3131)。

#### Excel 公式剖析記憶體損毀弱點 - CVE-2009-3131 的緩和因素
...
#### Excel 公式剖析記憶體損毀弱點 - CVE-2009-3131 的因應措施

因應措施指的是無法徹底修正弱點，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。 Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：

-   對於來自於不受信任的來源或在非預期情況下從信任來源收到的 Excel 檔案，請勿隨意開啟。 當使用者開啟蓄意製作的檔案時，即可能遭受利用此弱點的攻擊。

#### Excel 公式剖析記憶體損毀弱點 - CVE-2009-3131 的常見問題集

**這個弱點的範圍為何？**  
這是遠端執行程式碼的弱點。 成功利用此弱點的攻擊者可以從遠端取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，或檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。

**造成這個弱點的原因為何？**  
Microsoft Office Excel 剖析含有蓄意製作公式之 Excel 試算表的方式中存在弱點。

**攻擊者可能會利用這項弱點採取什麼行動？**  
一旦成功利用此弱點，攻擊者便能以登入的使用者身分執行任意程式碼。 如果使用者以系統管理的使用者權限登入，則攻擊者即可取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

**攻擊者如何利用這項弱點？**  
此弱點需要使用者開啟受影響的 Microsoft Excel 版本之蓄意製作的 Excel 檔案。
...
<span></span>
由於指標損毀，導致 Microsoft Office Excel 在載入 Excel 公式時存在遠端執行程式碼的弱點。 如果使用者開啟蓄意製作且含有格式錯誤公式的 Excel 檔案，此弱點可能會允許遠端執行程式碼。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。

若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-3132](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3132)。

#### Excel 索引剖析弱點 - CVE-2009-3132 的緩和因素
...
#### Excel 索引剖析弱點 - CVE-2009-3132 的因應措施

因應措施指的是無法徹底修正弱點，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。 Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：

-   對於來自於不受信任的來源或在非預期情況下從信任來源收到的 Excel 檔案，請勿隨意開啟。 當使用者開啟蓄意製作的檔案時，即可能遭受利用此弱點的攻擊。

#### Excel 索引剖析弱點 - CVE-2009-3132 的常見問題集
...
**因為這個弱點而承受風險的主要系統有哪些？**  
使用 Microsoft Office Excel 的系統 (包括工作站和終端機伺服器)，其風險最高。 若系統管理員允許使用者登入伺服器並執行程式，則伺服器可能遭受更大的風險。 然而，最佳實務強烈建議您制止這種行為

**更新的作用何在？**  
此更新程式改變了 Microsoft Office Excel 對於開啟蓄意製作之 Excel 檔案的處理方式，藉以解決弱點。
...
<span></span>
由於記憶體損毀，導致 Microsoft Office Excel 在載入 Excel 記錄時存在遠端執行程式碼的弱點。 如果使用者開啟蓄意製作、其中含有格式錯誤物件的 Excle 檔案，此弱點可能會允許遠端執行程式碼。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。

若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-3133](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3133)。

#### Excel 文件剖析記憶體損毀弱點 - CVE-2009-3133 的緩和因素
...
#### Excel 文件剖析記憶體損毀弱點 - CVE-2009-3133 的因應措施

因應措施指的是無法徹底修正弱點，但有助於在套用更新之前封鎖已知攻擊模式的設定變更。 Microsoft 測試了下列因應措施和狀態，討論因應措施是否會降低功能：

-   對於來自於不受信任的來源或在非預期情況下從信任來源收到的 Excel 檔案，請勿隨意開啟。 當使用者開啟蓄意製作的檔案時，即可能遭受利用此弱點的攻擊。

#### Excel 文件剖析記憶體損毀弱點 - CVE-2009-3133 的常見問題集
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-3134](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3134)。

#### Excel 欄位清理弱點 - CVE-2009-3134 的緩和因素
...
#### Excel 欄位清理弱點 - CVE-2009-3134 的因應措施
...
#### Excel 欄位清理弱點 - CVE-2009-3134 的常見問題集
...
**注意：**客戶若使用 MBSA 2.1.1、Microsoft Update 和 Windows Server Update Services 所不支援的舊版軟體： 請造訪 [Microsoft Baseline Security Analyzer](https://www.microsoft.com/technet/security/tools/mbsahome.mspx) 並參考＜舊版產品支援＞(英文) 章節，了解如何以舊版工具建立完整的資訊安全公告更新偵測方式。
...
-   對於 Microsoft Office 2003 支援版本，請參閱＜建立管理安裝點＞。 如需詳細瞭解如何將用戶端電腦的來源從更新的管理安裝點變更到 Office 2003 原始基準來源或 Service Pack 3 (SP3)，請參閱 [Microsoft 知識庫文件編號 902349](https://support.microsoft.com/kb/902349/?ln=zh-tw)。
...
-   對於受支援的 2007 Microsoft Office 系統版本，請參閱＜為 2007 Office 系統建立網路安裝點＞(英文)。
    **注意：**如果您打算集中管理資訊安全公告更新，請使用 Windows Server Update Services。 如需更多關於使用 Windows Server Update Services 部署 2007 Microsoft Office 系統的資訊安全公告更新之資訊，請造訪 [Windows Server Update Services 網站](https://www.microsoft.com/taiwan/windowsserversystem/updateservices/evaluation/overview.mspx)。
...
<td style="border:1px solid black;">OfficeXP-kb973471-fullfile-enu/q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">在不重新啟動的情況下安裝</td>
<td style="border:1px solid black;">OfficeXP-kb973471-fullfile-enu /r:n</td>
</tr>
<tr class="odd">
...
<br />
若要減少重新開機的可能性，請在安裝資訊安全公告更新之前，停止所有受影響的服務，並關閉所有可能使用受影響檔案的應用程式。 有關系統可能會提示您重新開機的原因的更多資訊，請參閱 <a href="https://support.microsoft.com/kb/887012">Microsoft 知識庫文件編號 887012</a>。</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/973471/?ln=zh-tw">Microsoft 知識庫文件編號 973471</a></td>
</tr>
<tr class="even">
...
**注意**：您可以在同一個命令中合併使用這些參數。 為符合回溯相容性，資訊安全公告更新程式也支援舊版安裝程式使用的安裝參數。 有關支援的安裝參數的其他資訊，請參閱 [Microsoft 知識庫文件編號 262841](https://support.microsoft.com/kb/262841/?ln=zh-tw)。
  
**移除更新**
  
如果要移除此資訊安全公告更新程式，請使用 \[控制台\] 中的 \[新增或移除程式\] 工具。 **注意：**當您移除此更新時，系統可能會提示您在 CD 光碟機中插入 Microsoft Office XP CD。 此外，您可能沒有從 \[控制台\] 內 \[新增或移除程式\] 工具中解除安裝更新的選項。 這個問題有數個可能的原因。 如需更多關於移除程式的資訊，請參閱 [Microsoft 知識庫文件編號 903771](https://support.microsoft.com/kb/903771/?ln=zh-tw)。
...
Office2003-kb973475-fullfile-enu /q:a<br />
...
<td style="border:1px solid black;">在不重新啟動的情況下安裝</td>
<td style="border:1px solid black;">適用於 Excel 2003：<br />
Office2003-kb973475-fullfile-enu /r:n<br />
適用於 Excel Viewer 2003：<br />
...
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">適用於 Excel 2003：<br />
請參閱 <a href="https://support.microsoft.com/kb/973475/?ln=zh-tw">Microsoft 知識庫文件編號 973475</a><br />
<br />
適用於 Excel Viewer 2003：<br />
請參閱 <a href="https://support.microsoft.com/kb/973484/?ln=zh-tw">Microsoft 知識庫文件編號 973484</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
**注意**：您可以在同一個命令中合併使用這些參數。 為符合回溯相容性，資訊安全公告更新程式也支援舊版安裝程式使用的安裝參數中的許多參數。 有關支援的安裝參數的其他資訊，請參閱 [Microsoft 知識庫文件編號 262841](https://support.microsoft.com/kb/262841/?ln=zh-tw)。
...
Excel2007-kb973593-fullfile-x86-glb /passive<br />
適用於 Excel Viewer：<br />
Office2007-kb973707-fullfile-x86-glb /passive<br />
...
<td style="border:1px solid black;">在不重新啟動的情況下安裝</td>
<td style="border:1px solid black;">適用於 Excel 2007：<br />
Excel2007-kb973593-fullfile-x86-glb /norestart<br />
適用於 Excel Viewer：<br />
Office2007-kb973707-fullfile-x86-glb /norestart<br />
適用於 Microsoft Office Compatibility Pack for Word, Excel, and PowerPoint 2007 File Formats：<br />
...
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">適用於 Excel 2007：<br />
請參閱 <a href="https://support.microsoft.com/kb/973593/?ln=zh-tw">Microsoft 知識庫文件編號 973593</a><br />
<br />
適用於 Excel Viewer：<br />
請參閱 <a href="https://support.microsoft.com/kb/973707">Microsoft 知識庫文件編號 973707</a><br />
<br />
適用於 Microsoft Office Compatibility Pack for Word, Excel, and PowerPoint 2007 File Formats：<br />
請參閱 <a href="https://support.microsoft.com/kb/973704">Microsoft 知識庫文件編號 973704</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
此資訊安全公告更新需要在系統上安裝 Windows Installer 3.1 或更新版本。
...
**注意：**當您移除此更新時，系統可能會提示您在 CD 光碟機中插入 2007 Microsoft Office CD。 此外，您可能沒有從 \[控制台\] 內 \[新增或移除程式\] 工具中解除安裝更新的選項。 這個問題有數個可能的原因。 如需更多關於移除程式的資訊，請參閱 [Microsoft 知識庫文件編號 903771](https://support.microsoft.com/kb/903771/?ln=zh-tw)。
...
-   感謝 Fortinet 公司 [FortiGuard Labs](https://www.fortiguard.com) 的 Bing Liu 回報 Excel 快取記憶體損毀弱點 (CVE-2009-3127)  
-   感謝 [TippingPoint](https://www.tippingpoint.com/) 及 [Zero Day Initiative](https://www.zerodayinitiative.com/) 回報 Excel 快取記憶體損毀弱點 (CVE-2009-3127)  
-   感謝 Fortinet 公司 [FortiGuard Labs](https://www.fortiguard.com) 的 Bing Liu 回報 Excel SxView 記憶體損毀弱點 (CVE-2009-3128)  
-   感謝 [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Sean Larsson 回報 Excel Featheader 記錄記憶體損毀弱點 (CVE-2009-3129)  
-   感謝 [VUPEN Security](https://www.vupen.com/) 的 Nicolas Joly 回報 Excel 文件剖析堆積溢位弱點 (CVE-2009-3130)  
-   感謝 [VUPEN Security](https://www.vupen.com/) 的 Nicolas Joly 回報 Excel 公式剖析記憶體損毀弱點 (CVE-2009-3131)  
-   感謝 [VUPEN Security](https://www.vupen.com/) 的 Nicolas Joly 回報 Excel 索引剖析弱點 (CVE-2009-3132)  
-   感謝 [VUPEN Security](https://www.vupen.com/) 的 Nicolas Joly 回報 Excel 文件剖析記憶體損毀弱點 (CVE-2009-3133)  
-   感謝 Fortinet 公司 [FortiGuard Labs](https://www.fortiguard.com) 的 Bing Liu 回報 Excel 欄位清理弱點 (CVE-2009-3134)
