...
**已知問題。** [Microsoft 知識庫文件編號 961260](http://support.microsoft.com/kb/961260) 中有記載目前已知安裝此安全性更新後，可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。 目前已知問題和建議解決方案僅適用於此軟體的特定版本，本文會提供詳細文章的連結。
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7(英文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=e52aa1fd-e694-4322-b3ff-6abc1b4a16fe)  
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7(英文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=edbf1566-b96b-4c7d-98fe-b15f8e766792)  
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7(英文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=5ce78797-d1c0-40d4-84e1-1004389833be)
</td>
<td style="border:1px solid black;">
遠端執行程式碼
</td>
...
[Windows Internet Explorer 7(中文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=11985325-4b33-4077-82cf-6afc7a71c510)
...
**何處可找到檔案資訊詳細資料？**  
如需檔案資訊詳細資料，請參閱 [Microsoft 知識庫文件編號 961260](http://support.microsoft.com/kb/961260)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-0075](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0075)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-0076](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0076)。
...
**什麼是 CSS？**  
CSS 或階層式樣式表是使用 HTML 網頁的一種格式化方法。 如需有關 CSS 的詳細資訊，請造訪 [Microsoft TechNet 網站](http://www.microsoft.com/technet/prodtechnol/windows2000serv/reskit/iisbook/c06_cascading_style_sheets.mspx?mfr=true)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/961260">Microsoft 知識庫文件編號 961260</a></td>
</tr>
<tr class="even">
...
-   感謝 [TippingPoint](http://www.tippingpoint.com/) 及 [Zero Day Initiative](http://www.zerodayinitiative.com/) 回報未初始化的記憶體損毀弱點 (CVE-2009-0075)  
-   感謝 Sam Thomas (<http://eshu.co.uk/>) 與 [TippingPoint](http://www.tippingpoint.com/) 和 [Zero Day Initiative](http://www.zerodayinitiative.com/) 合作回報 CSS 記憶體損毀弱點 (CVE-2009-0076)
