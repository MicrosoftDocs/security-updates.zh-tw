...
這個安全性更新也能解決首先於 [Microsoft 安全性摘要報告 971778](https://technet.microsoft.com/security/advisory/971778) 中提出的弱點。
...
**已知問題。** [Microsoft 知識庫文件編號 971633](https://support.microsoft.com/kb/9671633/zh-tw) 中記載了客戶安裝此安全性更新後，可能會發生的目前已知問題。 該文件並說明了解決這些問題的建議解決方案。
...
<td style="border:1px solid black;">
[DirectX 7.0 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=e3e54348-6548-4162-b4c0-9910ec6e18b3)  
[DirectX 7.0 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=e3e54348-6548-4162-b4c0-9910ec6e18b3)
...
<td style="border:1px solid black;">
[DirectX 8.1 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=ce297c3e-8122-4276-a9c2-d1a404f8028d)  
[DirectX 8.1 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=ce297c3e-8122-4276-a9c2-d1a404f8028d)
...
<td style="border:1px solid black;">
[DirectX 9.0](https://www.microsoft.com/download/details.aspx?familyid=862db2ad-3c1f-4a26-af70-d8c4f5a69dda)\* (英文下載更新程式)  
[DirectX 9.0](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=862db2ad-3c1f-4a26-af70-d8c4f5a69dda)\* (中文下載更新程式)
...
<td style="border:1px solid black;">
[DirectX 9.0](https://www.microsoft.com/download/details.aspx?familyid=09d585cb-481d-4767-875e-9c6ebe456b80)\* (英文下載更新程式)  
[DirectX 9.0](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=09d585cb-481d-4767-875e-9c6ebe456b80)\* (中文下載更新程式)
...
<td style="border:1px solid black;">
[DirectX 9.0](https://www.microsoft.com/download/details.aspx?familyid=f8cd4803-82da-467c-8cb1-520f5a6021d4)\* (英文下載更新程式)
</td>
<td style="border:1px solid black;">
遠端執行程式碼
</td>
...
<td style="border:1px solid black;">
[DirectX 9.0](https://www.microsoft.com/download/details.aspx?familyid=571d57c5-1ef8-4dc4-a1e5-2211a805f0cc)\* (英文下載更新程式)  
[DirectX 9.0](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=571d57c5-1ef8-4dc4-a1e5-2211a805f0cc)\* (中文下載更新程式)
...
<td style="border:1px solid black;">
[DirectX 9.0](https://www.microsoft.com/download/details.aspx?familyid=1779cbc0-0c29-4fac-a3a6-8b335ffcb98e)\* (英文下載更新程式)  
[DirectX 9.0](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=1779cbc0-0c29-4fac-a3a6-8b335ffcb98e)\* (中文下載更新程式)
...
<td style="border:1px solid black;">
[DirectX 9.0](https://www.microsoft.com/download/details.aspx?familyid=48282a89-f849-405a-a31e-2676f45b5042)\* (英文下載更新程式)
</td>
<td style="border:1px solid black;">
遠端執行程式碼
</td>
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-1537](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1537)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-1538](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1538)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-1539](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1539)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/971633/zh-tw">Microsoft 知識庫文件編號 971633</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;">需要重新開機？</td>
<td style="border:1px solid black;">若要減少重新開機的可能性，請在安裝安全性更新之前，停止所有受影響的服務，並關閉所有可能使用受影響檔案的應用程式。 有關系統可能會提示您重新開機的原因的更多資訊，請參閱 <a href="https://support.microsoft.com/kb/887012/zh-tw">Microsoft 知識庫文件編號 887012</a>。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">HotPatching</td>
...
-   感謝 [SkyRecon](https://www.skyrecon.com/) 的 Thomas Garnier 與 [Safe360](https://www.360.cn/) 的 Steven Shi 回報 DirectX NULL 位元組覆寫弱點 (CVE-2009-1537)
-   感謝 [Palo Alto Networks](https://www.paloaltonetworks.com/) 的 Yamata Li 回報 DirectX 指標驗證弱點 (CVE-2009-1538)
-   感謝 [TippingPoint](https://www.tippingpoint.com/) 與 [Zero Day Initiative](https://www.zerodayinitiative.com/)、[SkyRecon](https://www.skyrecon.com/) 的 Thomas Garnier 與 [Palo Alto Networks](https://www.paloaltonetworks.com/) 的 Yamata Li 回報 DirectX 大小驗證弱點 (CVE-2009-1539)
