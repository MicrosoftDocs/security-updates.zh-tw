...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-1545](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1545)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-1546](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1546)。
...
| **檔案資訊**                           | 請參閱 [Microsoft 知識庫文件編號 971557](http://support.microsoft.com/kb/971557/zh-tw)                                        |  
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/971557/zh-tw">Microsoft 知識庫文件編號 971557</a></td>
</tr>
<tr class="even">
...
-   感謝 [Adobe Systems, Inc.](http://www.adobe.com/) 的 Vinay Anantharaman 回報格式錯誤的 AVI 標頭弱點 (CVE-2009-1545)  
-   感謝 [Adobe Systems, Inc.](http://www.adobe.com/) 的 Vinay Anantharaman 回報 AVI 整數溢位弱點 (CVE-2009-1546)
