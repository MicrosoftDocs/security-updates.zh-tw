---
TOCTitle: 'MS09-042'
Title: 'Microsoft Security Bulletin MS09-042 - 重要'
ms:assetid: 'ms09-042'
ms:contentKeyID: 61238311
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms09-042(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS09-042 - 重要
===========================================

Telnet 中的弱點可能允許遠端執行程式碼 (960859)
----------------------------------------------
...
這個安全性更新可解決 Microsoft Telnet 服務中一項公開報告的弱點。 此弱點可讓攻擊者取得認證，然後使用認證再度登入受影響的系統。 攻擊者隨後可以在系統上取得與登入使用者相同的使用者權限。 這種情況最終可能會允許在受影響的系統上遠端執行程式碼。 成功地利用這些弱點的攻擊者可以安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
...
此安全性更新解決弱點的方式是修改 Telnet 服務對驗證回覆的驗證方式，以防止認證遭轉送。 如需更多有關弱點的資訊，請參閱下節＜弱點資訊＞下的特定弱點項目的＜常見問題集 (FAQ)＞小節。
...
**已知問題。** [Microsoft 知識庫文件編號 960859](https://support.microsoft.com/kb/960859/zh-tw) 中記載了客戶安裝此安全性更新後，可能會發生的目前已知問題。 該文件並說明了解決這些問題的建議解決方案。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=240977d6-3581-4058-b9f1-7847e4edcf8a">Microsoft Windows 2000 Service Pack 4</a> (KB960859) (英文下載更新程式)
<br/>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=240977d6-3581-4058-b9f1-7847e4edcf8a">Microsoft Windows 2000 Service Pack 4</a> (KB960859) (中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b3331388-1e52-4924-b512-23275a8fde84">Windows XP Service Pack 2 和 Windows XP Service Pack 3</a> (KB960859) (英文下載更新程式)<br/>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=b3331388-1e52-4924-b512-23275a8fde84">Windows XP Service Pack 2 和 Windows XP Service Pack 3</a> (KB960859) (中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=a6ee7af3-3e39-4866-a893-92bf1c786cd4">Windows XP Professional x64 Edition Service Pack 2</a> (KB960859) (英文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3fe9c745-d87c-43b0-9b2a-356fb34282b4">Windows Server 2003 Service Pack 2</a> (KB960859) (英文下載更新程式)<br/>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=3fe9c745-d87c-43b0-9b2a-356fb34282b4">Windows Server 2003 Service Pack 2</a> (KB960859) (中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e2a788e7-a9d1-4574-b106-f8ab44c6c4a2">Windows Server 2003 x64 Edition Service Pack 2</a> (KB960859) (英文下載更新程式)<br/>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=e2a788e7-a9d1-4574-b106-f8ab44c6c4a2">Windows Server 2003 x64 Edition Service Pack 2</a> (KB960859) (中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4f625d39-29d4-44f9-b4bd-cd99f1ea422d">適用於 Itanium 型系統的 Windows Server 2003 SP2</a> (KB960859) (英文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=d77f406d-11cb-4d19-94ec-938b356c3427">Windows Vista、Windows Vista Service Pack 1 和 Windows Vista Service Pack 2</a> (KB960859) (英文下載更新程式)
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=d77f406d-11cb-4d19-94ec-938b356c3427">Windows Vista、Windows Vista Service Pack 1 和 Windows Vista Service Pack 2</a> (KB960859) (中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7a41b8c1-f955-474e-a08e-5e73964327d1">Windows Vista x64 Edition、Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2</a> (KB960859) (英文下載更新程式)<br/>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=7a41b8c1-f955-474e-a08e-5e73964327d1">Windows Vista x64 Edition、Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2</a> (KB960859) (中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=62f2e0a6-5e68-41c7-a851-d99bcff6ff3e">適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2*</a> (KB960859) (英文下載更新程式)<br/>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=62f2e0a6-5e68-41c7-a851-d99bcff6ff3e">適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2*</a> (KB960859) (中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=6e5d1db9-efef-4112-8138-62f14670cf0d">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2*</a> (KB960859) (英文下載更新程式)<br/>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=6e5d1db9-efef-4112-8138-62f14670cf0d">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2*</a> (KB960859) (中文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4b813c74-b2ae-4962-9ebb-1311193d9e2d">適用於 Itanium 型系統的 Windows Server 2008 和適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2</a> (KB960859) (英文下載更新程式)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
...
是，此公告中有更新可讓 Telnet 伺服器和用戶端加入延伸驗證防護。 如需更多資訊，請參閱 [Microsoft 安全性摘要報告 973811](https://technet.microsoft.com/security/advisory/973811)。
...
<th style="border:1px solid black;" >Telnet 認證反映弱點 - CVE-2009-1930</th>
<th style="border:1px solid black;" >彙總嚴重性等級</th>
</tr>
</thead>
<tbody>
...
Telnet 認證反映弱點 - CVE-2009-1930  
-----------------------------------
  

Microsoft Telnet 服務中存在遠端執行程式碼的弱點。 成功地利用這些弱點的攻擊者可以安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
  
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-1930](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1930)。
  
#### Telnet 認證反映弱點的緩和因素 - CVE-2009-1930
  
緩和因素是指存在於預設狀態中的設定、共用設定或一般最佳作法，可能會減少弱點影響的嚴重性。 下列緩和因素可能對您的狀況有所助益：
  
-   最佳實作的防火牆和標準預設防火牆設定有助於防止網路受到來自企業外的攻擊。 最佳方式建議連線至網際網路的系統盡可能曝露最少數量的連接埠。 在此情況下，SMB 連接埠為認證最可能反映回來的目標，因此應該從網際網路封鎖該 SMB 連接埠。  
-   成功利用此弱點的攻擊者可以取得與本機使用者相同的使用者權限。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。  
-   依照預設，Windows Vista 和 Windows Server 2008 系統並未安裝 Telnet。
  
#### Telnet 認證反映弱點的因應措施 - CVE-2009-1930
  
Microsoft 尚未找到此項弱點的任何因應措施。
  
#### Telnet 認證反映弱點的常見問題集 - CVE-2009-1930
  
**這個弱點的範圍為何？**    
這是遠端執行程式碼的弱點。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。
  
**造成這個弱點的原因為何？**    
Telnet 通訊協定無法正確加入 NTLM 認證反映保護，因此無法確保使用者的認證不會被反映回來，阻擋該位使用者。
  
**什麼是 Telnet？**    
Telnet 是雙向通訊協定，可透過 TCP 通訊協定允許命令列遠端存取。 如需詳細資訊，請參閱 MSDN 文章：[Telnet 伺服器](https://msdn.microsoft.com/zh-tw/library/aa919240.aspx) (英文)。
  
**什麼是 NTLM？**    
NTLM 是以問題/回應機制為依據的驗證通訊協定，用於判斷提供認證的真實性。
  
**攻擊者可能會利用這項弱點採取什麼行動？**    
攻擊者可利用弱點來取得登入使用者的權限，並以登入使用者具備的權限執行任何動作。 如果使用者以系統管理的使用者權限登入，成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。
  
**攻擊者如何利用這項弱點？**    
使用者必須使用受影響的 Telnet 版本存取蓄意製作的 Telnet 伺服器，此弱點才會遭到利用。 攻擊者必須主控蓄意製作的 Telnet 伺服器來利用這個弱點。 攻擊者無法強迫使用者連線至蓄意製作的 Telnet 伺服器。 相反地，攻擊者必須引誘使用者造訪 Telnet 伺服器，一般是設法讓使用者按一下電子郵件或 Instant Messenger 訊息中的連結，以連至蓄意製作的 Telnet 伺服器。
  
**因為這個弱點而承受風險的主要系統有哪些？**    
目前支援的所有 Windows 系統皆有風險。
  
**為何此弱點在 Windows** **Vista** **和 Windows Server 2008 上的嚴重性等級為「重要」，而所有其他平台則為「重大」？**    
依照預設，受支援的 Windows Vista 和 Windows Server 2008 版本上並未安裝 Telnet 用戶端。若您未手動安裝 Telnet，您的電腦將不會受此公告提及的問題影響。 依照預設，所有其他受支援的 Windows 版本都會安裝 Telnet。
  
**更新的作用何在？**    
此安全性更新藉由確保 Microsoft Telnet 服務適當加入 Windows 所提供的認證保護機制，而改善此弱點。
  
**當安全性公告發行時，這項弱點是否已被揭發出來？**    
是。 這項弱點已經遭到公開揭發。 這項弱點已被指派一般性弱點編號 [CVE-2009-1930](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1930)。
...
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB960859$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/960859/zh-tw">Microsoft 知識庫文件編號 960859</a></td>
</tr>
<tr class="even">
...
-   **檔案版本驗證**
    ...
    5.  在 \[版本\] 索引標籤上，比較檔案版本與適當檔案資訊表中記錄的版本，判斷您系統上安裝的檔案版本。  sss
...
-   V1.1 (2009 年 8 月 18 日)： 新增已知問題知識庫文件的連結。 新增 Windows Vista 和 Windows Server 2008 的緩和因素。針對 Windows 平台的嚴重性差異，新增常見問題集。 移除安全性摘要報告 973811 的連結。變更重新啟動需求。
