...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-1928](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1928)。
...
依照預設，LDAP 流量的傳輸不安全。 但是使用安全通訊端層 (SSL)/傳輸層安全性 (TLS) 技術，仍可預防 LDAP 流量遭竄改，保護流量機密。 根據 [Microsoft 知識庫文件編號 321051](https://support.microsoft.com/kb/321051) 中的指示，系統管理員可以安裝格式正確且來自 Microsoft 憑證授權單位 (CA) 或非 Microsoft CA 的數位憑證，即可啟動 LDAP over SSL (LDAPS)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/973039/?ln=zh-tw">Microsoft 知識庫文件編號 973039</a></td>
</tr>
<tr class="even">
