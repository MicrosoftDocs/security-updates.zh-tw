...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=365a8dff-2383-42f6-b567-e545461fd135">Microsoft Windows 2000 Server Service Pack 4 (英文下載更新程式)</a>
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=365a8dff-2383-42f6-b567-e545461fd135">Microsoft Windows 2000 Server Service Pack 4 (中文下載更新程式)</a></td>
...
<span></span>
License Logging 服務是什麼？License Logging 服務是一種工具，為協助客戶管理以伺服器用戶端存取使用權 (CAL) 模型所授與的 Microsoft 伺服器產品使用權而設計。
...
如何得知我的伺服器上是否使用 License Logging 服務？License Logging 服務在 not available on Microsoft Windows 2000 Professional 上不存在。 依照預設，Microsoft Windows 2000 Server 會安裝且會執行 License Logging 服務。 您可以執行下列程序來判斷是否已安裝 License Logging 服務。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-2523](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2523)。
...
-   停用 License Logging 服務
    ...
    **因應措施的影響** 如果停用 License Logging 服務，任何明確依賴 License Logging 服務的服務便可能在系統事件記錄中記錄錯誤訊息。 如需更多資訊，請參閱 [Microsoft 知識庫文件編號 316631](http://support.microsoft.com/kb/316631/?ln=zh-tw)
...
| **檔案資訊**                           | 請參閱 [Microsoft 知識庫文件編號 974783](http://support.microsoft.com/kb/974783)                                              |  
...
-   感謝 [TippingPoint DVLabs](http://dvlabs.tippingpoint.com/) 的 Cody Pierce 回報 License Logging Server 堆積溢位弱點 (CVE-2009-2523)
