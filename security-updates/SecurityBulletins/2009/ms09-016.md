...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=6abf9fb4-42d0-4c67-935f-8dc67850148b">Microsoft Forefront Threat Management Gateway, Medium Business Edition (英文下載更新程式)</a>\*<br />
(KB968075)  
...
**何處可找到檔案資訊詳細資料？**    
如需檔案資訊詳細資料，請參閱 [Microsoft 知識庫文件編號 961759](https://support.microsoft.com/kb/961759/zh-tw)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-0077](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0077)。
...
是。 這項弱點已經遭到公開揭發。 這項弱點已被指派一般性弱點編號 [CVE-2009-0077](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0077)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-0237](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0237)。
...
| **檔案資訊**                           | 請參閱 [Microsoft 知識庫文件編號 961759](https://support.microsoft.com/kb/961759/zh-tw)                                                        |  
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/961759/zh-tw">Microsoft 知識庫文件編號 961759</a></td>
</tr>
<tr class="even">
