...
**已知問題。** [Microsoft 知識庫文件編號 974571](http://support.microsoft.com/kb/974571/?ln=zh-tw) 中記載了客戶安裝此安全性更新後，可能會發生的目前已知問題。 該文件並說明了解決這些問題的建議解決方案。 目前已知問題和建議解決方案僅適用於此軟體的特定版本，本文會提供詳細文章的連結。
...
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=20067">MS04-007</a></td>
</tr>
<tr class="even">
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-2510](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2510)。
...
關於 ASN.1 的詳細資訊，請參閱 [Microsoft 知識庫文件編號 252648](http://support.microsoft.com/kb/252648/?ln=zh-tw)。
...
是。 這項弱點已經遭到公開揭發。 這項弱點已被指派一般性弱點編號 [CVE-2009-2510](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2510)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-2511](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2511)。
...
**當安全性公告發行時，這項弱點是否已揭發出來？**    
是。 這項弱點已經遭到公開揭發。 這項弱點已被指派一般性弱點編號 [CVE-2009-2511](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2511)。
...
| **檔案資訊**                           | 請參閱 [Microsoft 知識庫文件編號 974571](http://support.microsoft.com/kb/974571/?ln=zh-tw)                                    |  
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/974571/?ln=zh-tw">Microsoft 知識庫文件編號 974571</a></td>
</tr>
<tr class="even">
...
-   感謝 [Citrix](http://www.citrix.com/) 的 Ian Wright 和 Jean-Luc Giraud 協助我們解決 X.509 一般名稱中的 Null 截斷弱點 (CVE-2009-2510)  
-   感謝 [IOActive](http://www.ioactive.com/) 的 Dan Kaminsky 報告 X.509 一般名稱中的 Null 截斷弱點 (CVE-2009-2510) 以及 X.509 物件識別碼中的整數溢位弱點 (CVE-2009-2511)
