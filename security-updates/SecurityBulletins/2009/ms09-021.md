...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-0549](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0549)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-0557](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0557)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-0558](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0558)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-0559](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0559)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-0560](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0560)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-0561](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0561)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-1134](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1134)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/969683/zh-tw">Microsoft 知識庫文件編號 969683</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/969680/zh-tw">Microsoft 知識庫文件編號 969680</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">適用於 Excel 2003：<br />
請參閱 <a href="https://support.microsoft.com/kb/969681/zh-tw">Microsoft 知識庫文件編號 969681</a><br />
<br />
適用於 Excel Viewer 2003：<br />
請參閱 <a href="https://support.microsoft.com/kb/969685/zh-tw">Microsoft 知識庫文件編號 969685</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">適用於 Excel 2007：<br />
請參閱 <a href="https://support.microsoft.com/kb/969682/zh-tw">Microsoft 知識庫文件編號 969682</a><br />
<br />
適用於 Excel Viewer：<br />
請參閱 <a href="https://support.microsoft.com/kb/969682=6/zh-tw">Microsoft 知識庫文件編號 969686</a><br />
<br />
適用於 Microsoft Office Compatibility Pack for Word, Excel, and PowerPoint 2007 File Formats：<br />
請參閱 <a href="https://support.microsoft.com/kb/969679/zh-tw">Microsoft 知識庫文件編號 969679</a><br />
</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/969737/zh-tw">Microsoft 知識庫文件編號 969737</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
-   感謝 Fortinet 公司 [FortiGuard Global Security Research Team](https://www.fortiguardcenter.com/) 的 Bing Liu 回報指標損毀弱點 (CVE-2009-0549)  
-   感謝 Fortinet 公司 [FortiGuard Global Security Research Team](https://www.fortiguardcenter.com/) 的 Bing Liu 回報物件記錄損毀弱點 (CVE-2009-0557)  
-   感謝 [Secunia](https://secunia.com/) 的 Carsten H. Eiram 回報陣列索引記憶體損毀弱點 (CVE-2009-0558)  
-   感謝 [TELUS Security Labs Vulnerability Research Team](https://telussecuritylabs.com/) 回報字串複製堆疊式溢位弱點 (CVE-2009-0559)  
-   感謝 Fortinet 公司 [FortiGuard Global Security Research Team](https://www.fortiguardcenter.com/) 的 Bing Liu 回報欄位清理記憶體損毀弱點 (CVE-2009-0560)  
-   感謝 [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Sean Larsson 和 Joshua Drake 回報記錄整數溢位弱點 (CVE-2009-0561)  
-   感謝 [Secunia](https://secunia.com/) 的 Carsten H. Eiram 回報記錄整數溢位弱點 (CVE-2009-0561)  
-   感謝 [TippingPoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 回報記錄指標損毀弱點 (CVE-2009-1134)
