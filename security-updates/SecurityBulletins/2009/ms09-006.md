...
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms08-061">MS08-061</a></td>
</tr>
<tr class="even">
...
**何處可找到檔案資訊詳細資料？**    
如需檔案資訊詳細資料，請參閱 [Microsoft 知識庫文件編號 958690](http://support.microsoft.com/kb/958690)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-0081](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0081)。
...
**什麼是 GDI？**    
Microsoft Windows 圖形裝置介面 (GDI) 可讓應用程式在視訊畫面及印表機上使用圖形和格式化文字。 Windows 應用程式不會直接存取圖形硬體。 而是由 GDI 代表應用程式與裝置驅動程式互動。 如需更多關於 GDI 的資訊，請造訪 [Windows GDI 起始網頁。](http://msdn.microsoft.com/en-us/library/dd145203(vs.85).aspx)
...
如需有關影像類型及格式的更多資訊，請參閱 [Microsoft 知識庫文件編號 320314](http://support.microsoft.com/kb/320314)。您也可以在 [MSDN Library 網站](http://msdn2.microsoft.com/en-us/library/ms536391.aspx)中找到有關這些檔案格式的其他資訊。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-0082](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0082)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-0083](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0083)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/958690">Microsoft 知識庫文件編號 958690</a></td>
</tr>
<tr class="even">
...
-   感謝 Helmut Buhler (<http://home.arcor.de/clipboarder/>) 回報 Windows 核心輸入驗證弱點 (CVE-2009-0081)  
-   感謝 [SkyRecon](http://www.skyrecon.com/) 的 Thomas Garnier 回報 Windows 核心控制代碼驗證弱點 (CVE-2009-0082)
