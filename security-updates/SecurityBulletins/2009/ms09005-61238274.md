...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a30cef3f-9eaf-45bd-9a25-4b65302362cb">Microsoft Office Visio 2002 Service Pack 2(英文下載更新程式)</a><br />
(KB955654)  
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=a30cef3f-9eaf-45bd-9a25-4b65302362cb">Microsoft Office Visio 2002 Service Pack 2(中文下載更新程式)</a><br />
(KB955654)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=c9cb589e-1a37-485d-8402-7f42bcd7a1a9">Microsoft Office Visio 2003 Service Pack 3(英文下載更新程式)</a><br />
(KB955655)  
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=c9cb589e-1a37-485d-8402-7f42bcd7a1a9">Microsoft Office Visio 2003 Service Pack 3(中文下載更新程式)</a><br />
(KB955655)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms08-019">MS08-019</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=4b711e89-8de2-4f17-8afc-691e0604ff82">Microsoft Office Visio 2007 Service Pack 1(英文下載更新程式)</a><br />
(KB957831)  
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=4b711e89-8de2-4f17-8afc-691e0604ff82">Microsoft Office Visio 2007 Service Pack 1(中文下載更新程式)</a><br />
(KB957831)</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://technet.microsoft.com/security/bulletin/ms08-019">MS08-019</a></td>
...
**何處可找到檔案資訊詳細資料？**    
如需檔案資訊詳細資料，請參閱 [Microsoft 知識庫文件編號 957634](http://support.microsoft.com/kb/957634)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-0095](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0095)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-0096](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0096)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-0097](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0097)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/957634">Microsoft 知識庫文件編號 957634</a></td>
</tr>
<tr class="even">
...
-   感謝 Fortinet 公司 [FortiGuard Global Security Research Team](http://www.fortiguardcenter.com) 的 Bing Liu 回報記憶體驗證弱點 (CVE-2009-0095)  
-   感謝 Fortinet 公司 [FortiGuard Global Security Research Team](http://www.fortiguardcenter.com) 的 Bing Liu 回報記憶體損毀弱點 (CVE-2009-0096)  
-   感謝 Fortinet 公司 [FortiGuard Global Security Research Team](http://www.fortiguardcenter.com) 的 Bing Liu 回報記憶體損毀弱點 (CVE-2009-0097)
