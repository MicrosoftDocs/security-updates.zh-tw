---
TOCTitle: 'MS09-009'
Title: 'Microsoft Security Bulletin MS09-009 - 重大'
ms:assetid: 'ms09-009'
ms:contentKeyID: 61238278
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms09-009(v=Security.10)'
---



Microsoft Security Bulletin MS09-009 - 重大
===========================================
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2000 Service Pack 3 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=3dc8b670-25a5-4f46-b7de-12bc693b628a)  
(KB959964)  
[Microsoft Office Excel 2000 Service Pack 3 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=3dc8b670-25a5-4f46-b7de-12bc693b628a)  
(KB959964)
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2002 Service Pack 3 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=9a52bf4b-05f6-4b73-94b9-28ed7e20f86c)  
(KB959988)  
[Microsoft Office Excel 2002 Service Pack 3 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=9a52bf4b-05f6-4b73-94b9-28ed7e20f86c)  
(KB959988)
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2003 Service Pack 3 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=d9dbfa63-c0cb-4c84-9b8a-6e52568045b0)  
(KB959995)  
[Microsoft Office Excel 2003 Service Pack 3 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=d9dbfa63-c0cb-4c84-9b8a-6e52568045b0)  
(KB959995)
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2007 Service Pack 1 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=50d8630b-1365-4007-81a0-18c0d6d4b86e)\*  
(KB959997)  
[Microsoft Office Excel 2007 Service Pack 1 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=50d8630b-1365-4007-81a0-18c0d6d4b86e)\*  
(KB959997)
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office 2004 for Mac (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=52271140-89be-4b9c-baa2-cea09097d703)  
(KB968695)
</td>
<td style="border:1px solid black;">
不適用
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office 2008 for Mac (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=f6e407eb-11a5-433f-8006-4b822953ca98)  
(KB968694)
</td>
<td style="border:1px solid black;">
不適用
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office Excel Viewer 2003 Service Pack 3 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=c72e6087-b48f-4d2d-8366-01d9f5ff6b6c)  
(KB959993)  
[Microsoft Office Excel Viewer 2003 Service Pack 3 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=c72e6087-b48f-4d2d-8366-01d9f5ff6b6c)  
(KB959993)
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office Excel Viewer (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=58b3929c-5373-47a4-aa97-66d179758792)  
(KB960000)  
[Microsoft Office Excel Viewer (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=58b3929c-5373-47a4-aa97-66d179758792)  
(KB960000)
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office Compatibility Pack for Word, Excel, and PowerPoint 2007 File Formats Service Pack 1 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=05f7c517-e551-4dcd-b24a-5d548f2d09cf)  
(KB960003)  
[Microsoft Office Compatibility Pack for Word, Excel, and PowerPoint 2007 File Formats Service Pack 1 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=05f7c517-e551-4dcd-b24a-5d548f2d09cf)  
(KB960003)
...
\*針對 Microsoft Office Excel 2007 Service Pack 1，除了安全性更新套件 KB959997 外，客戶也需安裝[適用於 Word、Excel 及 PowerPoint 2007 檔案格式的 Microsoft Office 相容性套件](https://www.microsoft.com/download/details.aspx?familyid=05f7c517-e551-4dcd-b24a-5d548f2d09cf) Service Pack 1 (KB960003) 的安全性更新，以免受此公告中描述的弱點影響。
...
**何處可找到檔案資訊詳細資料？**    
如需檔案資訊詳細資料，請參閱 [Microsoft 知識庫文件編號 968557](https://support.microsoft.com/kb/968557/zh-tw)。
...
**為什麼此更新對 Excel 2000 屬於「重大」等級，但對所有其他受影響的 Excel 版本僅屬於「重要」？**    
...
<th style="border:1px solid black;" >
記憶體損毀弱點 - CVE-2009-0100
</th>
<th style="border:1px solid black;" >
記憶體損毀弱點 - CVE-2009-0238
</th>
<th style="border:1px solid black;" >
彙總嚴重性等級
</th>
...
Microsoft Office Excel 中含有遠端執行程式碼弱點，若使用者開啟蓄意製作而內含格式錯誤物件的 Excel 檔案，則可能允許遠端執行程式碼。 成功利用此弱點的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。

若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-0100](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0100)。

#### 記憶體損毀弱點 - CVE-2009-0100 的緩和因素
...
**攻擊者如何利用這項弱點？**    
此弱點需要使用者以受影響的 Microsoft Office Excel 版本，開啟蓄意製作的 Excel 試算表。
...
**更新的作用何在？**    
此更新程式變更 Microsoft Office Excel 開啟蓄意製作之 Excel 檔案的方式，藉以移除弱點。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-0238](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0238)。

#### 記憶體損毀弱點 - CVE-2009-0238 的緩和因素
...
#### 記憶體損毀弱點 - CVE-2009-0238 的常見問題集

**這個弱點的範圍為何？**    
這是遠端執行程式碼的弱點。 成功利用此弱點的攻擊者可以從遠端取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，或檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。

**造成這個弱點的原因為何？**    
Microsoft Office Excel 中存在弱點，於開啟蓄意製作的 Excel 試算表時，可能會允許遠端執行程式碼。 Microsoft Office Excel 剖析 Excel 試算表檔案格式的方式中存在弱點。
...
**更新的作用何在？**    
此更新程式變更 Microsoft Excel 開啟蓄意製作之 Excel 檔案的方式，藉以移除弱點。

**當安全性公告發行時，這項弱點是否已被揭發出來？**    
是。 這項弱點已經遭到公開揭發。 這項弱點已被指派一般性弱點編號 [CVE-2009-0238](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0238)。[Microsoft 安全性摘要報告 968272](https://technet.microsoft.com/security/advisory/968272) 首先說明此弱點。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/968557/zh-tw">Microsoft 知識庫文件編號 968557</a></td>
</tr>
<tr class="even">
...
<br />
適用於 Word、Excel 及 PowerPoint 2007 檔案格式 Service Pack 1 的 Microsoft Office 相容性套件：<br />
...
從 [Microsoft 下載中心](https://www.microsoft.com/download/details.aspx?familyid=52271140-89be-4b9c-baa2-cea09097d703)下載並安裝適當語言版本的 Microsoft Office 2004 for Mac 11.5.4 Update。
  
-   結束所有正在執行的應用程式，包括防毒應用程式、所有 Microsoft Office 應用程式、Microsoft Messenger for Mac 及 Office Notifications，因為這些程式可能會影響到安裝工作。  
-   開啟桌面上的 \[Microsoft Office 2004 for Mac 11.5.4 Update\] 磁碟區。 本步驟可能已經為您執行完畢。  
-   若要開始更新程序，請在 \[Microsoft Office 2004 for Mac 11.5.4 Update\] 磁碟區視窗中，按兩下 \[Microsoft Office 2004 for Mac 11.5.4 Update\] 應用程式，然後依照螢幕上的指示執行。  
-   如果成功完成安裝，您可將更新安裝程式由硬碟上移除。 若要確認安裝是否完成，請參閱以下＜確認更新的安裝＞標題之說明。 若要移除更新安裝程式，請先將 \[Microsoft Office 2004 for Mac 11.5.4 Update\] 磁碟區移至資源回收筒，然後將您下載的檔案拖放到資源回收筒中。
...
從 [Microsoft 下載中心](https://www.microsoft.com/download/details.aspx?familyid=f6e407eb-11a5-433f-8006-4b822953ca98)下載並安裝適當語言版本的 Microsoft Office 2008 for Mac 12.1.7 Update。
  
-   結束所有正在執行的應用程式，包括防毒應用程式、所有 Microsoft Office 應用程式、Microsoft Messenger for Mac 及 Office Notifications，因為這些程式可能會影響到安裝工作。  
-   開啟桌面上的 \[Microsoft Office 2008 for Mac 12.1.7 Update\] 磁碟區。 本步驟可能已經為您執行完畢。  
-   若要開始更新程序，請在 \[Microsoft Office 2008 for Mac 12.1.7 Update\] 磁碟區視窗中，按兩下 \[Microsoft Office 2008 for Mac 12.1.7 Update\] 應用程式，然後依照螢幕上的指示執行。  
-   如果成功完成安裝，您可將更新安裝程式由硬碟上移除。 若要確認安裝是否完成，請參閱以下＜確認更新的安裝＞標題之說明。 若要移除更新安裝程式，請先將 \[Microsoft Office 2008 for Mac 12.1.7 Update\] 磁碟區移至資源回收筒，然後將您下載的檔案拖放到資源回收筒中。
...
-   感謝 Fortinet，[FortiGuard Global Security Research Team](https://www.fortiguardcenter.com/) 的 Haifei Li 回報記憶體損毀弱點 (CVE-2009-0100)
