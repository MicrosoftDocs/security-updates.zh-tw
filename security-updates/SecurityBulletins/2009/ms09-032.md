---
TOCTitle: 'MS09-032'
Title: 'Microsoft Security Bulletin MS09-032 - 重大'
ms:assetid: 'ms09-032'
ms:contentKeyID: 61238301
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms09-032(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS09-032 - 重大
===========================================
...
這個安全性更新也能解決 [Microsoft 安全性摘要報告 972890](https://technet.microsoft.com/security/advisory/972890) 中首先提出的弱點。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=89d941f0-3f71-46e3-8096-716561396b72">Microsoft Windows 2000 Service Pack 4 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=89d941f0-3f71-46e3-8096-716561396b72">Microsoft Windows 2000 Service Pack 4 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">無</td>
<td style="border:1px solid black;">無**</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=24701af8-b87e-4e85-9463-f50755a1b6ad">Windows XP Service Pack 2 及 Windows XP Service Pack 3 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=24701af8-b87e-4e85-9463-f50755a1b6ad">Windows XP Service Pack 2 及 Windows XP Service Pack 3 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-032">MS08-032</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2cbf3699-7f79-4006-99e9-0a4c0d394c48">Windows XP Professional x64 Edition Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重大</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-032">MS08-032</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b0a458d6-c34c-41c7-964a-c130cfcb0d01">Windows Server 2003 Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=b0a458d6-c34c-41c7-964a-c130cfcb0d01">Windows Server 2003 Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-032">MS08-032</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8b7a7bb0-80ef-4f25-bc70-3d0ac06007c5">Windows Server 2003 x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=8b7a7bb0-80ef-4f25-bc70-3d0ac06007c5">Windows Server 2003 x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-032">MS08-032</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7be36edf-02af-402f-983a-f9ca8128b6b5">Windows Server 2003 SP2 for Itanium-based Systems (英文下載更新程式)</a></td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-032">MS08-032</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=6c90240e-c201-4dad-9835-ea71e3527b45">Windows Vista、Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=6c90240e-c201-4dad-9835-ea71e3527b45">Windows Vista、Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">無</td>
<td style="border:1px solid black;">無**</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=d2084e8d-212b-4c39-9163-a71ec6d1b1c7">Windows Vista x64 Edition、Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=d2084e8d-212b-4c39-9163-a71ec6d1b1c7">Windows Vista x64 Edition、Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">無</td>
<td style="border:1px solid black;">無**</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=0194f994-5821-4fb9-b9e1-ed6af248c995">適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2* (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=0194f994-5821-4fb9-b9e1-ed6af248c995">適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2* (中文下載更新程式)</a></td>
<td style="border:1px solid black;">無</td>
<td style="border:1px solid black;">無**</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4127b125-fdaa-489a-a80c-14b5647ac7e0">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2* (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=4127b125-fdaa-489a-a80c-14b5647ac7e0">適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2* (中文下載更新程式)</a></td>
<td style="border:1px solid black;">無</td>
<td style="border:1px solid black;">無**</td>
<td style="border:1px solid black;">無</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4082c776-318c-4e0c-83fc-2f3f472c039a">適用於 Itanium 型系統的 Windows Server 2008 和適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">無</td>
<td style="border:1px solid black;">無**</td>
<td style="border:1px solid black;">無</td>
</tr>
...
**如果我套用了 Microsoft 安全性摘要報告 972890 的因應措施，是否需要安裝此安全性更新？**    
[Microsoft 安全性摘要報告 972890](https://technet.microsoft.com/security/advisory/972890)說明可避免 Microsoft Video ActiveX 控制項在 Internet Explorer 中執行的因應措施。 客戶可以手動套用此因應措施，也可以使用 [Microsoft 知識庫文件編號 972890](https://support.microsoft.com/kb/972890/zh-tw) 中的自動化 Microsoft 修復解決方案，以啟用因應措施。 客戶若使用了前述任一種方法套用此因應措施，則不需要安裝此安全性更新。
  
無論是否套用了因應措施，都會將此更新程式提供給 Windows Vista 和 Windows Server 2008 系統。 然而，如果是使用 Server Core 安裝選項來安裝 Windows Server 2008，則這項更新所解決的弱點並不會影響受支援的 Windows Server 2008 版本，且這項更新也不會提供 Server Core 安裝。 所有客戶可以安心安裝此安全性更新，不會受到負面影響。
  
**在安裝此安全性更新之前，是否需要復原 Microsoft 安全性摘要報告 972890 的因應措施？**    
無論是手動套用此因應措施，還是使用 [Microsoft 知識庫文件編號 972890](https://support.microsoft.com/kb/972890/zh-tw) 中的 Microsoft 修復解決方案來自動啟用因應措施，客戶在安裝此更新前都不用復原 [Microsoft 安全性摘要報告 972890](https://technet.microsoft.com/security/advisory/972890) 中的因應措施，
  
如果安裝此更新程式，然後復原 Microsoft 安全性摘要報告 972890 的因應措施，會有什麼結果？   
在這種情況下，Windows Vista 和 Windows Server 2008 的客戶若安裝此安全性更新用於深度防禦，然後手動復原 [Microsoft 安全性摘要報告 972890](https://technet.microsoft.com/security/advisory/972890) 的因應措施，或者使用 [Microsoft 知識庫文件編號 972890](https://support.microsoft.com/kb/972890/zh-tw) 中的自動化 Microsoft 修復解決方案來啟用因應措施， 就無法再防止 Microsoft Video ActiveX 控制項在 Internet Explorer 中執行，這樣客戶的系統會變得容易受到影響。 此外，此更新不會重新提供這類系統，因為未來的偵測結果將產生先前由因應措施復原的成功安裝。
...
否。 此更新程式僅包含適用於 Microsoft 控制項的 Kill Bit (刪除位元)。
...
Microsoft Video ActiveX 控制項 msvidctl.dll 中存在遠端執行程式碼的弱點。攻擊者可蓄意製作網頁以利用此弱點。 當使用者檢視網頁時，此弱點可能會允許遠端執行程式碼。 成功利用此弱點的攻擊者可以取得與登入使用者相同的使用者權限。
...
-   使用 Windows Vista 或 Windows Server 2008 的客戶不受影響，因為已限制將資料傳給 Internet Explorer 中此控制項的功能。  
...
-   **避免 COM 物件在 Internet Explorer 中執行**
    ...
    **注意：**包含 ActiveX 物件的類別識別項與對應檔案記錄於＜Microsoft Video ActiveX 控制項弱點的常見問題集 - CVE-2008-0015＞一節的＜更新的作用何在？＞。 以該節中的類別識別項取代下方的 {XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX}。
...
#### Microsoft Video ActiveX 控制項弱點的常見問題集 - CVE-2008-0015
...
**造成這個弱點的原因為何？ **  
在 Internet Explorer 中具現化 Microsoft Video ActiveX 控制項時，控制項可能會使系統狀態損毀，使攻擊者有機會執行任意程式碼。
  
**什麼是 Microsoft Video ActiveX 控制項？**  
Microsoft Video 控制物件是一個 Microsoft ActiveX 控制項，可連接 Microsoft DirectShow 篩選器以用於擷取、錄製及播放視訊。 其為 Microsoft Windows Media Center 用來建立篩選器圖形以錄製和播放電視視訊的主要元件。
...
**我使用 的 Internet Explorer 適用於Vista** **或 Windows Server 2008。是否需要安裝此更新程式？**
  
雖然 Windows Vista 和 Windows Server 2008 客戶不受影響，Microsoft 仍建議這些客戶在 Internet Explorer 中對此 ActiveX 控制項移除下方所列相同類別識別項的使用支援，以做為深度防禦措施。
...
**更新的作用何在？ **  
Microsoft Video ActiveX 控制項的設計原本不是在 Internet Explorer 中具現化，因此設定 msvidctl.dll 主控之類別識別項的 Kill Bit (刪除位元) 可停用控制項：
...
System Center Configuration Manager (SCCM) 2007 使用 WSUS 3.0 來偵測更新。 如需更多關於 SCCM 2007 軟體更新管理的資訊，請造訪 [System Center Configuration Manager 2007](https://www.microsoft.com/taiwan/systemcenter/configmgr/default.mspx) 網站。
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4：<br />
使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB973346$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
...
<tr class="even">
<td style="border:1px solid black;"><strong>移除資訊</strong></td>
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或是 %Windir%\$NTUninstallKB973346$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">所有受支援 32 位元版本的 Windows XP：<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>移除資訊</strong></td>
<td style="border:1px solid black;">使用 [控制台] 中的 [新增或移除程式] 工具，或 %Windir%\$NTUninstallKB973346$\Spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
