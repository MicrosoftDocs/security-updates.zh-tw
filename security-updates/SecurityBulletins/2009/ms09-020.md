...
這個安全性更新可解決 [Microsoft 安全性摘要報告 971492](https://technet.microsoft.com/security/advisory/971492) 中描述的弱點。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8515a294-4f25-4dc5-860a-e7ad9b6c1c01">Microsoft Internet Information Services 5.0 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=8515a294-4f25-4dc5-860a-e7ad9b6c1c01">Microsoft Internet Information Services 5.0 (中文下載更新程式)</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=97da589f-4534-42f6-9f29-967b5a33c542">Microsoft Internet Information Services 5.1 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=97da589f-4534-42f6-9f29-967b5a33c542">Microsoft Internet Information Services 5.1 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8982e6d2-e1f7-4208-88e3-80b159a8e21a">Microsoft Internet Information Services 6.0 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2bd4e410-dbd8-431a-b316-e1e2f1825c3a">Microsoft Internet Information Services 6.0 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ea363223-535d-4142-9aba-3890960c6259">Microsoft Internet Information Services 6.0 (英文下載更新程式)</a>
<a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&amp;familyid=ea363223-535d-4142-9aba-3890960c6259">Microsoft Internet Information Services 6.0 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e6b806eb-e2c4-4436-8964-720db593055d">Microsoft Internet Information Services 6.0 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">權限提高</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
</tr>
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-1122](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1122)。
...
-   **停用 WebDAV**
    ...
    對於 IIS 5.0，可依照 [Microsoft 知識庫文件編號 241520](https://support.microsoft.com/kb/241520/zh-tw) 中的說明來停用 WebDAV。
...
-   **將檔案系統 ACL 變更為拒絕匿名使用者帳戶存取**
    ...
    -   [Microsoft 知識庫文件編號 271071](https://support.microsoft.com/?id=271071/zh-tw)  
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-1535](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1535)。
...
**當安全性公告發行時，這項弱點是否已被揭發出來？**    
是。 這項弱點已經遭到公開揭發。 這個弱點先是在 [Microsoft 安全性摘要報告 971492](https://technet.microsoft.com/security/advisory/971492) 中被描述為一般性弱點編號 [CVE-2009-1535](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1535)。這個弱點也被指派了一般性弱點編號 [CVE-2009-1676](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1676)。
...
| **檔案資訊**                           | 請參閱 [Microsoft 知識庫文件編號 970483](https://support.microsoft.com/kb/970483/zh-tw)                                        |  
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/970483/zh-tw">Microsoft 知識庫文件編號 970483</a></td>
</tr>
<tr class="even">
...
-   感謝 [Palo Alto Networks](https://www.paloaltonetworks.com/) 的 Yamata Li 回報 IIS 5.0 WebDAV 驗證略過弱點 (CVE-2009-1122)
