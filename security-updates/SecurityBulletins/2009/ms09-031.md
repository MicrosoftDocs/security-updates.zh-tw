...
**已知問題。** [Microsoft 知識庫文件編號 970953](https://support.microsoft.com/kb/970953/zh-tw) 中記載了客戶安裝此安全性更新後，可能會發生的目前已知問題。 該文件並說明了解決這些問題的建議解決方案。 目前已知問題和建議解決方案僅適用於此軟體的特定版本，本文會提供詳細文章的連結。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-1135](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1135)。
...
-   停用以 ISA 表單式驗證的基本驗證作為後援並停用 Radius OTP
    ...
    1.  對於執行 Microsoft Internet Security and Acceleration Server 2006 原始發行版本的客戶，請安裝從 [Microsoft 知識庫文件編號 938966](https://support.microsoft.com/kb/938966//zh-tw) 取得的 Hotfix。執行 Microsoft Internet Security and Acceleration Server 2006 支援性更新和 Microsoft Internet Security and Acceleration Server 2006 Service Pack 1 的客戶，則不需要套用 Hotfix。  
    2.  請根據文章中的指示，執行從 [Microsoft 知識庫文件編號 938966](https://support.microsoft.com/kb/938966//zh-tw)＜Hotfix 後安裝資訊＞一節中取得的 Microsoft Visual Basic 指令碼。
  
    **因應措施的影響** ISA 伺服器不允許由該網頁接聽程式服務的用戶端所進行之基本驗證。
  
    **如何復原因應措施：**
  
    1.  編輯從 [Microsoft 知識庫文件編號 938966](https://support.microsoft.com/kb/938966//zh-tw)＜Hotfix 後安裝資訊＞一節中取得的 Microsoft Visual Basic 指令碼，以將「Const SE\_VPS\_VALUE = true」修訂為「Const SE\_VPS\_VALUE = false」。  
    2.  儲存指令碼，然後執行它。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/970811/zh-tw">Microsoft 知識庫文件編號 970811</a></td>
</tr>
<tr class="even">
