...
**已知問題。** [Microsoft 知識庫文件編號 963093](http://support.microsoft.com/kb/963093/zh-tw) 中記載了客戶安裝此安全性更新後可能會發生的目前已知問題。 該文件並說明了解決這些問題的建議解決方案。
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=759f22cb-ea7f-49dd-a200-19cb83fffd8d">Windows 搜尋 4.0 (英文下載更新程式)</a>
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=759f22cb-ea7f-49dd-a200-19cb83fffd8d">Windows 搜尋 4.0 (中文下載更新程式)</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=50c56dd6-c34d-4632-a779-8bcf8fdb341b">Windows 搜尋 4.0 (英文下載更新程式)</a></td>
<td style="border:1px solid black;">資訊洩漏</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e72ef31f-5161-4fe6-8ed3-6206e02cef31">Windows 搜尋 4.0 (英文下載更新程式)</a>
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=e72ef31f-5161-4fe6-8ed3-6206e02cef31">Windows 搜尋 4.0 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">資訊洩漏</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=7ffc3680-f9bf-423b-96a7-102f4cc9c240">Windows 搜尋 4.0 (英文下載更新程式)</a>
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=7ffc3680-f9bf-423b-96a7-102f4cc9c240">Windows 搜尋 4.0 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">資訊洩漏</td>
<td style="border:1px solid black;">中度</td>
<td style="border:1px solid black;">無</td>
</tr>
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-0239](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0239)。
...
**什麼是 Windows 搜尋？**    
Windows 搜尋可讓您立即搜尋大部分的一般檔案和資料類型，例如電子郵件、聯絡人、行事曆約會、文件、照片、多媒體和其他協力廠商所延伸的格式。 這些功能可讓消費者和資訊工作者在家庭和企業環境中，更有效率地尋找、管理和組織與日俱增的常用資料。 如需更多資訊，請參閱 [Microsoft 知識庫文件編號 940157](http://support.microsoft.com/kb/940157/zh-tw)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/963093/zh-tw">Microsoft 知識庫文件編號 963093</a></td>
</tr>
<tr class="even">
...
-   感謝 [IBM Rational Application Security](http://www-01.ibm.com/software/rational/offerings/websecurity/webappsecurity.html) 的 Yair Amit 回報 Windows 搜尋指令碼執行弱點 (CVE-2009-0239)
