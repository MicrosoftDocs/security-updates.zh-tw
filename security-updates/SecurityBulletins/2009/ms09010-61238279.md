...
此安全性更新也能解決 [Microsoft 安全性摘要報告 960906](http://technet.microsoft.com/security/advisory/960906) 中首先提出的弱點。

**建議。** Microsoft 建議客戶立即套用此更新。

**已知問題。** [Microsoft 知識庫文件編號 960477](http://support.microsoft.com/kb/960477/zh-tw) 中記載目前已知安裝此安全性更新後，可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=552d322a-5282-42c7-9c1e-1d8c494a7318">Microsoft Windows 2000 Service Pack 4 (英文下載更新程式)</a>
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=552d322a-5282-42c7-9c1e-1d8c494a7318">Microsoft Windows 2000 Service Pack 4 (中文下載更新程式)</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=50a8519a-503e-43dd-a78a-c1bc764fd213">Windows XP Service Pack 2 及 Windows XP Service Pack 3 (英文下載更新程式)</a>
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=50a8519a-503e-43dd-a78a-c1bc764fd213">Windows XP Service Pack 2 及 Windows XP Service Pack 3 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">不適用</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=323f4211-5add-4e02-bce1-e5a1b489982c">Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=323f4211-5add-4e02-bce1-e5a1b489982c">Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">不適用</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=2233a4d2-7c8a-4c89-b020-100d9afb43c8">Windows Server 2003 Service Pack 1 與 Windows Server 2003 Service Pack 2 (英文下載更新程式)</a>
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=2233a4d2-7c8a-4c89-b020-100d9afb43c8">Windows Server 2003 Service Pack 1 與 Windows Server 2003 Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">不適用</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=323f4211-5add-4e02-bce1-e5a1b489982c">Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2 (英文下載更新程式)</a>
<a href="http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&amp;familyid=323f4211-5add-4e02-bce1-e5a1b489982c">Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2 (中文下載更新程式)</a></td>
<td style="border:1px solid black;">不適用</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e840b9cb-f1f4-482a-aa07-eb6b42b477c4">Windows Server 2003 SP1 for Itanium-based Systems 和 Windows Server 2003 SP2 for Itanium-based Systems (英文下載更新程式)</a></td>
<td style="border:1px solid black;">不適用</td>
<td style="border:1px solid black;">遠端執行程式碼</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">無</td>
...
<td style="border:1px solid black;">
[Microsoft Office Word 2000 Service Pack 3 (英文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=95876927-e612-414c-bdec-3632a3100415)  
(KB921606)  
[Microsoft Office Word 2000 Service Pack 3 (中文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&familyid=95876927-e612-414c-bdec-3632a3100415)  
(KB921606)
...
<td style="border:1px solid black;">
[Microsoft Office Word 2002 Service Pack 3 (英文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=e1db55c6-78fb-498d-89a5-9ad54d971546)  
(KB933399)  
[Microsoft Office Word 2002 Service Pack 3 (中文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&familyid=e1db55c6-78fb-498d-89a5-9ad54d971546)  
(KB933399)
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office Converter Pack (英文下載更新程式)](http://www.microsoft.com/downloads/details.aspx?familyid=d763fae3-b2af-47f9-a554-ec786766b3c3)  
(KB960476)
</td>
<td style="border:1px solid black;">
不適用
...
**何處可找到檔案資訊詳細資料？**    
如需檔案資訊詳細資料，請參閱 [Microsoft 知識庫文件編號 960477](http://support.microsoft.com/kb/960477/zh-tw)。

**為何本次更新中仍然包含數個已回報的安全性弱點？**    
因為解決這些弱點所需的修正作業位於相關檔案中，所以在本次更新中仍然提供對這些弱點的支援。 客戶不需要安裝數個幾乎相同的更新，只需要安裝本更新即可。

**此更新程式是否包含功能上的任何安全性相關變更？**    
是的。除了針對安全性弱點提供解決方案以外，此安全性更新也預防 WordPad 在受影響的平台開啟 Word 6.0 及 Write 檔案，以解決這些弱點。 當 WordPad 嘗試開啟 Word 6.0 或 Write 檔案時，該檔案便無法開啟，而且會顯示對話方塊。 如需更多資訊，請參閱 [Microsoft 知識庫文件編號 960477](http://support.microsoft.com/kb/960477/zh-tw)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-0087](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0087)。
...
-   所有受支援版本的 Windows XP 和 Windows Server 2003 依預設會停用受影響的元件，因此受到此弱點影響的風險較低。 只有當系統管理員手動啟用受影響的元件，這些作業系統才會受此弱點影響。 所有受支援版本的 Windows Vista 和 Windows Server 2008 均不含有受影響元件，因此也均不受影響。
    Microsoft Windows 2000 Service Pack 4 系統承受風險最大，因為預設安裝仍然啟用該轉換程式。 不過，在已套用 [MS04-041](http://go.microsoft.com/fwlink/?linkid=36667) 更新程式的 Microsoft Windows 2000 Service Pack 4 系統上，Word for Windows 6.0 轉換程式會預設為停用。
-   在開啟文件之前，系統會提示已安裝並使用 Office 2000 的 [Office 文件開啟確認工具](http://www.microsoft.com/downloads/details.aspx?familyid=8b5762d2-077f-4031-9ee6-c9538e9f2a2f)之使用者 \[開啟\]、\[儲存\] 或 \[取消\] 等選項。 Office 文件開啟確認工具的功能已內建在 Office XP 和更新版本的 Office 中。
...
系統若執行受支援版本的 Windows XP 或 Windows Server 2003，則預設不會啟用 Word for Windows 6.0 轉換程式。但是，若已手動啟用 Word for Windows 6.0 轉換程式，例如依 [Microsoft 智識庫文件編號 870883](http://support.microsoft.com/kb/870883) 中的指示啟用，則系統便受此弱點影響。 若已啟用 Word for Windows 6.0 轉換程式，則停用的詳細方式請參閱因應措施＜藉由限制存取來停用 Word 6 轉換程式＞。
在 Microsoft Windows 2000 Service Pack 4 系統上，公告嚴重性等級為「重要」，因為預設安裝中仍然啟用該轉換程式。 不過，在已套用 [MS04-041](http://go.microsoft.com/fwlink/?linkid=36667) 更新程式的 Microsoft Windows 2000 Service Pack 4 系統上，Word for Windows 6.0 轉換程式會預設為停用。
...
是。 這項弱點已經遭到公開揭發。 這項弱點已被指派一般性弱點編號 [CVE-2009-0087](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0087)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2008-4841](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4841)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-0088](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0088)。
...
Microsoft Office Converter Pack 中包含舊版 Office 未提供的檔案轉換程式及篩選器。 這些轉換程式及篩選器可讓 Office 使用原先並不支援的其他文件格式。 Microsoft Office Converter Pack 可在[網站上下載](http://go.microsoft.com/fwlink/?linkid=34318)取得。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-0235](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0235)。
...
<td style="border:1px solid black;">請參閱 <a href="http://support.microsoft.com/kb/960477/zh-tw">Microsoft 知識庫文件編號 960477</a></td>
</tr>
<tr class="even">
