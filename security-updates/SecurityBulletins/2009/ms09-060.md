...
**已知問題。** [Microsoft 知識庫文件編號 973965](https://support.microsoft.com/kb/973965/zh-tw) 中記載了客戶安裝此資訊安全更新後，可能會發生的目前已知問題。 該文件並說明了解決這些問題的建議解決方案。 目前已知問題和建議解決方案僅適用於此軟體的特定版本，本文會提供詳細文章的連結。
...
<td style="border:1px solid black;">
[Microsoft Outlook 2002 Service Pack 3 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=04878c2c-eb97-426f-be08-89036a6799db)  
(KB973702)  
[Microsoft Outlook 2002 Service Pack 3 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=04878c2c-eb97-426f-be08-89036a6799db)  
(KB973702)
...
<td style="border:1px solid black;">
[Microsoft Office Outlook 2003 Service Pack 3 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=79e2b2e8-d5e8-4014-b489-720af2b5083d)  
(KB973705)  
[Microsoft Office Outlook 2003 Service Pack 3 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=79e2b2e8-d5e8-4014-b489-720af2b5083d)  
(KB973705)
...
<td style="border:1px solid black;">
[Microsoft Office Outlook 2007 Service Pack 1 和 Microsoft Office Outlook 2007 Service Pack 2 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=d39234a3-c62c-44ba-a626-3179a183ca09)  
(KB972363)  
[Microsoft Office Outlook 2007 Service Pack 1 和 Microsoft Office Outlook 2007 Service Pack 2 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=d39234a3-c62c-44ba-a626-3179a183ca09)  
(KB972363)
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office Visio Viewer 2007、Microsoft Office Visio Viewer 2007 Service Pack 1 及 Microsoft Office Visio Viewer 2007 Service Pack 2 (英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=d20004c5-dd01-459e-8120-5f127e20c085)  
(KB973709)  
[Microsoft Office Visio Viewer 2007、Microsoft Office Visio Viewer 2007 Service Pack 1 及 Microsoft Office Visio Viewer 2007 Service Pack 2 (中文下載更新程式)](https://www.microsoft.com/download/details.aspx?displaylang=zh-tw&familyid=d20004c5-dd01-459e-8120-5f127e20c085)  
(KB973709)
...
**\***Microsoft 建議 Microsoft Visio Viewer 2002 和 Microsoft Visio Viewer 2003 的使用者升級至 [Microsoft Office Visio Viewer 2007 Service Pack 2](https://office.microsoft.com/en-us/downloads/cd102071301033.aspx)。
...
是的，適用於 Microsoft Office Outlook 2007 Service Pack 1 和 Microsoft Office Outlook 2007 Service Pack 2 (KB972363) 的更新程式封裝，包括在 [Microsoft 知識庫文件編號 969907](https://support.microsoft.com/kb/969907/zh-tw) 中說明的 Outlook 2007 變更。
...
-   [Microsoft Office 2003](https://www.microsoft.com/download/details.aspx?displaylang=en&familyid=f8079643-6e06-48d3-b581-db179e1f18f8) (KB974554) 的更新
-   [Microsoft Office XP](https://www.microsoft.com/download/details.aspx?familyid=4974495c-70c5-4c7a-8bd3-56c9505f8283&displaylang=en) (KB974556) 的更新
-   [2007 Microsoft Office System](https://www.microsoft.com/download/details.aspx?familyid=ec802723-f2b2-400a-a24d-8d8d9092f9ea&displaylang=en) (KB974234) 的更新

[Microsoft 知識庫文件編號 973965](https://support.microsoft.com/kb/973965/zh-tw)亦有提供這些 Microsoft 知識庫文件的連結。
...
Microsoft 建議 Microsoft Visio Viewer 2002 和 Microsoft Visio Viewer 2003 的所有使用者升級至最新版的 [Microsoft Visio Viewer 2007](https://office.microsoft.com/en-us/downloads/cd102071301033.aspx) 以解決此弱點。 無法升級的使用者應套用 [MS09-034](https://technet.microsoft.com/security/bulletin/ms09-034) 中的更新。MS09-034 的 Internet Explorer 更新可緩和受影響 Visio Viewer 平台所受到的攻擊行為。 這些控制項的 Kill Bit (刪除位元) 將會納入未來 ActiveX Kill Bit (刪除位元) 的積存資訊安全更新內。

**此公告與 Microsoft 安全性摘要報告 (973882) 所述的弱點有何關係？**
此公告解決 Active Template Library (ATL) 公開版本中的弱點。 ATL 未公開版本中的弱點刊載於 [Microsoft 安全性摘要報告 (973882)](https://technet.microsoft.com/security/advisory/973882)。

**這個資訊安全更新是否與 MS09-034 有關聯？**  
是。 Microsoft 資訊安全公告 [MS09-034](https://technet.microsoft.com/security/bulletin/ms09-034)《Internet Explorer 的積存資訊安全更新》包括一項減輕措施，有助於防止易受影響的 ATL 所建立之元件和控制項在 Internet Explorer 中遭到利用，還能解決與之不相關的多個弱點。 MS09-034 中提供的新深度防禦保護包括：更新 Internet Explorer 5.01、Internet Explorer 6、Internet Explorer 6 Service Pack 1、Internet Explorer 7、Internet Explorer 8，監控並協助防止所有已知公開和未公開的 ATL 弱點遭受成功的剝削，包括那些可能會導致略過 ActiveX Kill Bit (刪除位元) 安全性功能的弱點。 這些保護措施是用來保護客戶免受網頁式攻擊之害。

**若已安裝 MS09-034 更新，是否仍需安裝此更新？**  
是。 這個資訊安全公告更新可解決 Office 元件中的弱點。 安裝此更新後，使用者可確保已修正此弱點所影響的所有核心 Office 元件所用的 ATL 標頭及程式庫。

**若已安裝 MS09-034 的更新，是否仍需安裝由 Microsoft 或協力廠商發佈的其他元件和控制項以解決 Microsoft 安全性摘要報告 973882 和 Microsoft 資訊安全公告 MS09-035 所述之弱點？**  
是，您必須在發行後安裝協力廠商的更新控制項。 以 Active Template Library 開發的某些元件和控制項內的根本弱點，[MS09-034](https://technet.microsoft.com/security/bulletin/ms09-034) 的 Internet Explorer 緩和措施並無法解決。

**何處可找到檔案資訊詳細資料？**  
關於檔案資訊詳細資料的位置，請見＜資訊安全更新部署＞一節中的參考表。

**什麼是 ATL？**
Active Template Library (ATL) 是一套基於範本的 C++ 類別，可用於建立小而快速的元件物件模型 (COM) 物件。 特別支援主要的 COM 功能，包括內建實作、雙重的介面、標準 COM 列舉程式介面、連接點、Tear-Off 介面、ActiveX 控制項。 如需詳細資訊，請參閱下列 [MSDN 文章](https://msdn.microsoft.com/en-us/library/3ax346b7(vs.71).aspx)。
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-2495](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2495)。
...
**攻擊者如何利用這項弱點？**  
如果使用者的系統上有有易受影響的控制，而攻擊者略過了 [Microsoft 安全性摘要報告 (973882)](https://technet.microsoft.com/security/advisory/973882) 所述之減輕措施，那麼攻擊者就有可能讀取受影響系統之記憶體內的資訊。
...
<span></span>
管理您必須部署到您組織中的伺服器、桌上型電腦及行動系統的軟體和資訊安全更新。 如需更多資訊，請參閱 [TechNet 更新管理中心](https://www.microsoft.com/taiwan/technet/updatemanagement/default.mspx) 。 [Microsoft TechNet 資訊安全網站](https://www.microsoft.com/taiwan/technet/security/default.mspx)提供了有關 Microsoft 產品安全性的其他資訊。
...
**注意：**客戶若使用 MBSA 2.1、Microsoft Update 和 Windows Server Update Services 所不支援的舊版軟體： 請造訪 [Microsoft Baseline Security Analyzer](https://www.microsoft.com/technet/security/tools/mbsahome.mspx) 並參考＜舊版產品支援＞(英文) 章節，了解如何以舊版工具建立完整的資訊安全更新偵測方式。

**Windows Server Update Services**

透過 Windows Server Update Services (WSUS)，系統管理員可以部署 Windows 2000 作業系統及更新版本、Office XP 及更新版本、Exchange Server 2003 及 SQL Server 2000 的最新重大更新與資訊安全更新。如需更多有關如何利用 Windows Server Update Services 部署資訊安全更新的資訊，請造訪 [Windows Server Update Services 網站](https://www.microsoft.com/taiwan/windowsserversystem/updateservices/evaluation/overview.mspx)。
...
如需瞭解詳細相關資訊，請參閱 [Microsoft 知識庫文件編號 910723](https://support.microsoft.com/kb/910723/zh-tw)：＜每月發行之偵測與部署指導文件的摘要清單＞(英文)。
...
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/973702/zh-tw">Microsoft 知識庫文件編號 973702</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/973705/zh-tw">Microsoft 知識庫文件編號 973705</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">適用於所有受支援版本的 Outlook 2007：<br />
請參閱 <a href="https://support.microsoft.com/kb/972363/zh-tw">Microsoft 知識庫文件編號 972363</a><br />
<br />
適用於 Visio Viewer 2007 所有受支援的版本：<br />
請參閱 <a href="https://support.microsoft.com/kb/973709/zh-tw">Microsoft 知識庫文件編號 973709</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>登錄機碼驗證</strong></td>
<td style="border:1px solid black;">不適用</td>
...
-   感謝 [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Ryan Smith 回報 ATL Null 字串弱點 (CVE-2009-2495)
