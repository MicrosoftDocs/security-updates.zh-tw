---
TOCTitle: 'MS09-002'
Title: 'Microsoft Security Bulletin MS09-002 - 重大'
ms:assetid: 'ms09-002'
ms:contentKeyID: 61238271
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms09-002(v=Security.10)'
---



Microsoft Security Bulletin MS09-002 - 重大
===========================================

Internet Explorer 積存安全性更新 (961260)
-----------------------------------------
...
這個安全性更新可解決兩項未公開報告的弱點。 如果使用者使用 Internet Explorer 檢視蓄意製作的網頁，這些弱點可能會允許遠端執行程式碼。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。

對於在支援版本 Windows XP 和 Windows Vista 上執行的 Internet Explorer 7，此安全性更新的等級為「重大」。 對於在支援版本 Windows Server 2003 和 Windows Server 2008 上執行的 Internet Explorer 7，此安全性更新的等級為「中度」。 如需更多資訊，請參閱本節中的＜受影響及不受影響的軟體＞小節。
...
**已知問題。** [Microsoft 知識庫文件編號 961260](https://support.microsoft.com/kb/961260) 中有記載目前已知安裝此安全性更新後，可能會發生的問題。 該文件並說明了解決這些問題的建議解決方案。 目前已知問題和建議解決方案僅適用於此軟體的特定版本，本文會提供詳細文章的連結。
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7(英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=e52aa1fd-e694-4322-b3ff-6abc1b4a16fe)  
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7(英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=edbf1566-b96b-4c7d-98fe-b15f8e766792)  
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7(英文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=5ce78797-d1c0-40d4-84e1-1004389833be)
</td>
<td style="border:1px solid black;">
遠端執行程式碼
</td>
...
[Windows Internet Explorer 7(中文下載更新程式)](https://www.microsoft.com/download/details.aspx?familyid=11985325-4b33-4077-82cf-6afc7a71c510)
...
| Windows XP Service Pack 2 及 Windows XP Service Pack 3                                                 | Microsoft Internet Explorer 6                   |
| Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2              | Microsoft Internet Explorer 6                   |
| Windows Server 2003 Service Pack 1 與 Windows Server 2003 Service Pack 2                               | Microsoft Internet Explorer 6                   |
| Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2                      | Microsoft Internet Explorer 6                   |
| Windows Server 2003 SP1 for Itanium-based Systems 和 Windows Server 2003 SP2 for Itanium-based Systems | Microsoft Internet Explorer 6                   |
...
**何處可找到檔案資訊詳細資料？**    
如需檔案資訊詳細資料，請參閱 [Microsoft 知識庫文件編號 961260](https://support.microsoft.com/kb/961260)。
...
<th style="border:1px solid black;" >
未初始化的記憶體損毀弱點 - CVE-2009-0075
</th>
<th style="border:1px solid black;" >
CSS 記憶體損毀弱點 - CVE-2009-0076
</th>
<th style="border:1px solid black;" >
彙總嚴重性等級
</th>
...
若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-0075](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0075)。

#### 未初始化的記憶體損毀弱點 - CVE-2009-0075 的緩和因素
...
-   這個弱點只會影響 Windows Internet Explorer 7， 不會影響 Microsoft Internet Explorer 5 和 Microsoft Internet Explorer 6 等支援版本。

#### 未初始化的記憶體損毀弱點 - CVE-2009-0075 的因應措施
...
#### 未初始化的記憶體損毀弱點 CVE-2009-0075 的常見問題集
...
Internet Explorer 處理階層式樣式表 (CSS) 的方法中，存在遠端執行程式碼弱點。 攻擊者可蓄意製作網頁以利用此弱點。 當使用者檢視網頁時，此弱點可能會允許遠端執行程式碼。 成功利用此弱點的攻擊者可以取得與登入使用者相同的使用者權限。

若要以一般性弱點清單中的標準項目來檢視此弱點，請參閱 [CVE-2009-0076](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0076)。

#### CSS 記憶體損毀弱點 - CVE-2009-0076 的緩和因素
...
#### CSS 記憶體損毀弱點 - CVE-2009-0076 的因應措施
...
#### CSS 記憶體損毀弱點 - CVE-2009-0076 的常見問題集
...
**造成這個弱點的原因為何？**  
當 Internet Explorer 顯示內含特定 CSS 樣式時，攻擊者就可以透過登入使用者的權限層級執行任意程式碼，使記憶體損毀。
...
**什麼是 CSS？**    
CSS 或階層式樣式表是使用 HTML 網頁的一種格式化方法。 如需有關 CSS 的詳細資訊，請造訪 [Microsoft TechNet 網站](https://www.microsoft.com/technet/prodtechnol/windows2000serv/reskit/iisbook/c06_cascading_style_sheets.mspx?mfr=true)。

**更新的作用何在？**  
更新會修改 Internet Explorer 處理階層式樣式表 (CSS) 的方式。
...
<td style="border:1px solid black;">適用於所有 Windows XP 支援版本的 Internet Explorer 7：<br />
使用 [控制台] 中的 [新增或移除程式] 工具，或 %Windir%\ie7updates\KB961260-IE7\spuninst 資料夾中的 Spuninst.exe 公用程式</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/961260">Microsoft 知識庫文件編號 961260</a></td>
</tr>
<tr class="even">
...
-   感謝 [TippingPoint](https://www.tippingpoint.com/) 及 [Zero Day Initiative](https://www.zerodayinitiative.com/) 回報未初始化的記憶體損毀弱點 (CVE-2009-0075)  
-   感謝 Sam Thomas (<https://eshu.co.uk/>) 與 [TippingPoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作回報 CSS 記憶體損毀弱點 (CVE-2009-0076)
...
-   V1.1 (2009 年 3 月 2 日)： 在＜提要＞的＜已知問題＞下新增 Microsoft 知識庫文件編號 961260 的連結。
