...
1 = Disable Automatic Updates.</td><br/><br/>
<td style="border:1px solid black;">Reg_DWORD</td>
</tr>
<tr class="odd">
...
Length, in minutes, of the restart warning countdown after installing updates with a deadline or scheduled updates.</td><br/><br/>
<td style="border:1px solid black;">Reg_DWORD</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>RescheduleWaitTime</strong></td><br/><br/>
...
Note that this policy applies only to scheduled installations, not deadlines. Updates whose deadlines have expired should always be installed as soon as possible.</td><br/><br/>
<td style="border:1px solid black;">Reg_DWORD</td>
</tr>
<tr class="even">
...
(Only valid if <strong>AUOptions</strong> equals 4.)</td><br/><br/>
<td style="border:1px solid black;">Reg_DWORD</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>ScheduledInstallTime</strong></td>
<td style="border:1px solid black;">Range = n; where n = the time of day in 24-hour format (0-23).</td><br/><br/>
<td style="border:1px solid black;">Reg_DWORD</td>
</tr>
<tr class="odd">
