...
若您的伺服器上沒有 SQL Server Management Studio，可以從命令列執行 SQL 指令碼。您可以從 [Microsoft 下載中心](https://go.microsoft.com/fwlink/?linkid=70728) (https://go.microsoft.com/fwlink/?LinkId=70728) 取得 Microsoft SQL Server 2005 命令列查詢公用程式。若要開始，請執行 **sqlcmd**。
...
-   若後端電腦執行 Windows Server 2003，您至少必須執行 Microsoft SQL Server 2005 Service Pack 1 (可從 [Microsoft 下載中心](https://go.microsoft.com/fwlink/?linkid=66143) (https://go.microsoft.com/fwlink/?LinkId=66143) 取得) 做為資料庫軟體；若後端電腦執行 Windows Server® 2008，則必須使用 SQL Server 2005 Service Pack 2。
...
<td style="border:1px solid black;">請參閱 <a href="https://go.microsoft.com/fwlink/?linkid=68935">Microsoft 下載中心</a> (https://go.microsoft.com/fwlink/?LinkId=68935) 的＜Microsoft .NET Framework 2.0 版可轉散發套件 (x86)＞。對於 64 位元平台，請參閱 <a href="https://go.microsoft.com/fwlink/?linkid=70637">Microsoft 下載中心</a> (https://go.microsoft.com/fwlink/?LinkId=70637) 的＜Microsoft .NET Framework 2.0 版可轉散發套件 (x64)＞。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Management Console 3.0 for Windows Server 2003</td>
<td style="border:1px solid black;">這是使用 WSUS 3.0 SP1 使用者介面的必要條件。請參閱 <a href="https://go.microsoft.com/fwlink/?linkid=70412">Microsoft 下載中心</a> (https://go.microsoft.com/fwlink/?LinkId=70412) 的＜KB907265：適用於 Windows Server 2003 的 Microsoft Management Console 3.0＞。對於 64 位元平台，請參閱 <a href="https://go.microsoft.com/fwlink/?linkid=70638">Microsoft 下載中心</a> (https://go.microsoft.com/fwlink/?LinkId=70638) 的 ＜Microsoft Management Console 3.0 for Windows Server 2003 x64 Edition (KB907265)＞。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft 報表檢視器</td>
<td style="border:1px solid black;">這是使用 WSUS 3.0 SP1 使用者介面的必要條件。請參閱 <a href="https://go.microsoft.com/fwlink/?linkid=70410">Microsoft 下載中心</a> (https://go.microsoft.com/fwlink/?LinkId=70410) 的＜Microsoft 可轉散發報表檢視器 2005＞。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">SQL Server 2005 (選用)</td>
<td style="border:1px solid black;">若尚未安裝相容的 SQL Server 版本，WSUS 3.0 SP1 將會為您安裝 Windows Internal Database。若要安裝完整版 SQL Server 資料庫，在 Windows Server 2003 上您必須使用 (至少) SQL Server 2005 SP1 (可從 <a href="https://go.microsoft.com/fwlink/?linkid=66143">Microsoft 下載中心</a> (https://go.microsoft.com/fwlink/?LinkId=66143) 取得)；在 Windows Server 2008 則必須使用 SQL Server 2005 SP2 (可從 <a href="https://go.microsoft.com/fwlink/?linkid=84823">Microsoft 下載中心</a> at https://go.microsoft.com/fwlink/?LinkId=84823) 取得)。</td>
</tr>
</tbody>
</table>
...
2.  您可以執行 DBCC CHECKDB 以確定 WSUS 資料庫已正確建立索引。如需有關安裝 DBCC CHECKDB 的詳細資訊，請參閱 [DBCC CHECKDB](https://go.microsoft.com/fwlink/?linkid=86948) (https://go.microsoft.com/fwlink/?LinkId=86948)。  
3.  備份 WSUS 資料庫。
...
若同步處理失敗，您的第一個疑難排解步驟應該是嘗試與伺服器同步處理。若後續的同步處理動作仍然失敗，請使用 [Windows Server Update Services 3.0 操作指南](https://go.microsoft.com/fwlink/?linkid=81072) (https://go.microsoft.com/fwlink/?LinkId=81072) 中的疑難排解資訊。
...
當用戶端電腦與使用 SSL 的 WSUS 3.0 SP1 伺服器通訊時，有時候會失敗並傳回 0x8024400a 錯誤碼。如需可解決此問題的更新，請參閱 [KB 905422](https://go.microsoft.com/fwlink/?linkid=70593) (https://go.microsoft.com/fwlink/?LinkId=70593)。
...
若透過安裝憑證將 IIS 設定為使用 SSL，除非已選取 **\[需要安全通道\]**，否則仍然可以透過未加密的 HTTP 來存取站台。如需詳細資訊，請參閱 [IIS](https://go.microsoft.com/fwlink/?linkid=98084) (https://go.microsoft.com/fwlink/?LinkId=98084) 的文件。
...
若將 WSUS 3.0 SP1 安裝在上游伺服器上，並嘗試與執行 WSUS 2.0 的下游複寫伺服器進行同步處理，可能會遇到效能問題。為解決此問題，請參閱 [KB 910847](https://go.microsoft.com/fwlink/?linkid=70669) (https://go.microsoft.com/fwlink/?LinkId=70669)。
...
<tr class="even">
<td style="border:1px solid black;">Microsoft 報表檢視器</td>
<td style="border:1px solid black;">這是使用 WSUS 使用者介面的必要條件。請參閱 <a href="https://go.microsoft.com/fwlink/?linkid=70410">Microsoft 下載中心</a> (https://go.microsoft.com/fwlink/?LinkId=70410) 的＜Microsoft 可轉散發報表檢視器 2005＞。</td>
</tr>
</tbody>
</table>
