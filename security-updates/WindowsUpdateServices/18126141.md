...
ms:contentKeyID: 18126141
ms:mtpsurl: 'https://technet.microsoft.com/zh-tw/library/Cc720475(v=WS.10)'
---
...
| ![](images/Cc720475.note(WS.10).gif)附註                           |
|-------------------------------------------------------------------------------------------------|
...
| ![](images/Cc720475.Important(WS.10).gif)重要事項 |
|--------------------------------------------------------------------------------|
