...
ms:contentKeyID: 18126092
ms:mtpsurl: 'https://technet.microsoft.com/zh-tw/library/Cc720473(v=WS.10)'
---
...
| ![](images/Cc720473.note(WS.10).gif)附註        |
|------------------------------------------------------------------------------|
...
| ![](images/Cc720473.Important(WS.10).gif)重要事項                                                                                         |  
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|  
