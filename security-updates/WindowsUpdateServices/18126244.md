...
<td style="border:1px solid black;">Name of the computer<br/>
...
<td style="border:1px solid black;">Displays the updates that have been synchronized to the WSUS server for the given time period.<br/><br/>
