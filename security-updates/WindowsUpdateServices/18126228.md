...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Delete stored procedures by using the following command:<br />
<br />
<strong>use master exec sp_dropextendedproc</strong> <em>stored procedure</em><br />
<br />
