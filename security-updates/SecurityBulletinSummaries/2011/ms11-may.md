...
發行 2011 年 5 月份資訊安全公告之後，此公告摘要將取代原先於 2011 年 5 月 5 日發行的公告預先通知。如需更多有關公告預先通知服務的資訊，請參閱 [Microsoft 資訊安全公告預先通知](https://technet.microsoft.com/security/bulletin/advance)。
...
|---------------------------------------------------------------------|---------------------------------|----------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------|--------------------------|----------|  
| [MS11-036](https://technet.microsoft.com/security/bulletin/ms11-036) | 簡報記憶體損毀 RCE 資訊安全風險 | [CVE-2011-1269](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1269) | 不受影響                                                                                            | [1](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 可能撰寫出可持續利用此漏洞的程式碼 | 不適用                   | (無)     |  
| [MS11-035](https://technet.microsoft.com/security/bulletin/ms11-035) | WINS 服務失敗回應資訊安全風險   | [CVE-2011-1248](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1248) | [3](https://technet.microsoft.com/en-us/security/cc998259.aspx) – 不太可能撰寫出可利用此漏洞的程式碼 | [3](https://technet.microsoft.com/en-us/security/cc998259.aspx) – 不太可能撰寫出可利用此漏洞的程式碼 | 暫時                     | (無)     |  
| [MS11-036](https://technet.microsoft.com/security/bulletin/ms11-036) | 簡報緩衝區溢位 RCE 資訊安全風險 | [CVE-2011-1270](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1270) | 不受影響                                                                                            | [3](https://technet.microsoft.com/en-us/security/cc998259.aspx) – 不太可能撰寫出可利用此漏洞的程式碼 | 不適用                   | (無)     |
...
<td style="border:1px solid black;">
[適用於 Itanium 型系統的 Windows Server 2003 SP2](https://www.microsoft.com/download/details.aspx?familyid=4c388fe8-883a-4118-a7ff-50f1e9d0a071)  
(重大)
</td>
</tr>
<tr>
...
<td style="border:1px solid black;">
[適用於 32 位元系統的 Windows Server 2008 和適用於 32 位元系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=9019a3ff-d953-4b0b-8c7a-05aa9cf65c92)\*  
(重大)
</td>
</tr>
<tr>
...
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 和適用於 x64 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=841130fa-4522-4079-b7eb-f8466ac3ef12)\*  
(重大)
</td>
</tr>
<tr>
...
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2 和適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=8732b41e-2f25-4ee1-a8b7-a8b8b9e22d08)\*  
(重大)
</td>
</tr>
</table>
...
<td style="border:1px solid black;">
[Microsoft PowerPoint 2007 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=9a181739-709a-4c0d-a97f-f9891c45c04c)<sup>[1]</sup>
(KB2535818)  
(重要)
</td>
</tr>
...
<td style="border:1px solid black;">
[Word、Excel 與 PowerPoint 2007 檔案格式的 Microsoft Office 相容性套件 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=5be09069-1cac-4b1e-ac94-4fb7024fb4ac)  
(KB2540162)  
(重要)
</td>
</tr>
...
-   您可透過下載中心，以資訊安全和重大更新 ISO CD 影響檔的方式取得本月份 Windows Update 提供的資訊安全更新。 如需更多資訊，請參閱 [Microsoft 知識庫文件編號 913086](https://support.microsoft.com/kb/913086/zh-tw)。

**IT 專業人員資訊安全社群**

在 [IT 專業人員資訊安全區社群](https://technet.microsoft.com/zh-tw/security/cc136632.aspx)上，學習如何提升資訊安全以及改善您的 IT 基礎結構，與其他的 IT 專業人員共同參與各類資訊安全議題的討論。

#### 感謝

Microsoft [感謝](https://go.microsoft.com/fwlink/?linkid=21127)下列人士協助我們一同保護我們的客戶：

-   感謝 Luigi Auriemma 與 [TippingPoint](https://www.tippingpoint.com/) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，回報 MS11-035 中描述的問題
-   感謝 [CERT/CC](https://www.cert.org/) 的 Will Dormann 協助我們解決 MS11-036 中描述的兩項問題
