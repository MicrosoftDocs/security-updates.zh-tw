...
<sup>[1]</sup>**.NET Framework 4 Client Profile 不受影響。**可在兩個設定檔中使用 .NET Framework 第 4 版可轉散發套件： .NET Framework 4 和 .NET Framework 4 Client Profile。.NET Framework 4 Client Profile 是 .NET Framework 4 的子集。此更新所解決的弱點只會影響到 .NET Framework 4 ，而不會影響到 .NET Framework 4 Client Profile。如需詳細資訊，請參閱 MSDN 文章：[安裝 .NET Framework](https://msdn.microsoft.com/zh-tw/library/5a4x27ek.aspx)。
...
-   感謝 [Opera Software ASA](https://www.opera.com/) 的 Yngve N. Pettersen 回報 MS11-057 中描述的一個問題
-   感謝 [Lostmon Lords](https://lostmon.blogspot.com) 回報 MS11-057 中描述的一個問題
-   感謝 [Security Professionals Network Inc.](https://www.sec-pro.net/) 的 Makoto Shiotsuki 回報 MS11-057 中描述的一個問題
-   感謝匿名的研究人員與 [TippingPoint](https://www.tippingpoint.com/) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，回報 MS11-057 中描述的一個問題
-   感謝 [Harmony Security](https://www.harmonysecurity.com/) 的 Stephen Fewer 與 [TippingPoint](https://www.tippingpoint.com/) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，回報 MS11-057 中描述的兩個問題
-   感謝 [Google Inc.](https://www.google.com/) 的 Michal Zalewski 協助我們進行 ms11-057 中所述之深度防禦變更
-   感謝 Grischa Zengel ([Zengel Medizintechnik GmbH](https://www.zmt.info/)) 回報 MS11-058 中描述的一個問題
-   感謝 [Baidu Security Team](https://www.baidu.com) 的 Linlin Zhao 回報 MS11-060 中描述的兩個問題
...
-   感謝 [Gotham Digital Science](https://www.gdssecurity.com/) 的 Adam Bixby 回報 MS11-067 中描述的一個問題
-   感謝 [Qihoo 360 Security Center](https://www.360.cn/) 的 Zheng Wenbin 回報 MS11-068 中描述的一個問題
