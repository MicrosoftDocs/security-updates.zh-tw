...
發行 2008 年 4 月份公告之後，此公告摘要將取代原先於 2008 年 4 月 3 日發行的公告預先通知。如需更多有關公告預先通知服務的資訊，請參閱 [Microsoft 安全性公告預先通知](https://technet.microsoft.com/security/bulletin/advance)。

如需有關如何在 Microsoft 安全性公告發佈時收到自動通知之詳細資訊，請造訪 [Microsoft 技術安全性通知](https://go.microsoft.com/fwlink/?linkid=21163)。

Microsoft 將利用網路廣播於 2008 年 4 月 9 日，太平洋時間早上十一點 (美國與加拿大) 解答客戶對於這些公告的問題。 [立即註冊參加 4 月份安全性公告網路廣播。](https://msevents.microsoft.com/cui/webcasteventdetails.aspx?eventid=1032357219&eventcategory=4&culture=en-us&countrycode=us) 在這個日期後，此網路廣播將可隨選取得。 如需更多資訊，請參閱 [Microsoft 安全性公告摘要和網路廣播](https://www.microsoft.com/taiwan/security/bulletins/default.mspx)。
...
|------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告標題**           | [**Microsoft Project 中的弱點可能會允許遠端執行程式碼**](https://technet.microsoft.com/security/bulletin/ms08-018)                                                                                                                                                                                                                                                    |
...
|------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告標題**           | [**GDI 中的弱點可能會允許遠端執行程式碼 (948590)**](https://technet.microsoft.com/security/bulletin/ms08-021)                                                                                                                                                                       |
...
|------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告標題**           | [**VBScript 與 JScript 指令碼引擎中的弱點可能會允許遠端執行程式碼 (944338)**](https://technet.microsoft.com/security/bulletin/ms08-022)                                                                                           |
...
|------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告標題**           | [**ActiveX Kill Bit (刪除位元) 的安全性更新 (948881)**](https://technet.microsoft.com/security/bulletin/ms08-023)                                                                                                                                                                            |
...
|------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告標題**           | [**Internet Explorer 積存安全性更新 (947864)**](https://technet.microsoft.com/security/bulletin/ms08-024)                                                                                                          |
...
|------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告標題**           | [**DNS 用戶端中的弱點可能會允許偽造 (945553)**](https://technet.microsoft.com/security/bulletin/ms08-020)                                                                      |
...
|------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告標題**           | [**Windows 核心中的弱點可能會允許權限提高 (941693)**](https://technet.microsoft.com/security/bulletin/ms08-025)                                                                            |
...
|------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告標題**           | [**Microsoft Visio 中的弱點可能會允許遠端執行程式碼 (949032)**](https://technet.microsoft.com/security/bulletin/ms08-019)                                                                                                                                                                                                                                         |
...
-   感謝韓國的 [National Cyber Security Center](https://www.ncsc.go.kr/eng/) 回報 MS08-018 中描述的問題
-   感謝一位匿名的發現者回報 MS08-019 中描述的問題
-   感謝一位匿名的發現者回報 MS08-019 中描述另一項問題
-   感謝 [Trusteer](https://www.trusteer.com/) 的 Amit Klein 回報 MS08-020 中描述的問題
-   感謝 [Scanit](https://www.scanit.be/) 的 Alla Berzroutchko 回報 MS08-020 中描述的問題
-   感謝 [Nominet UK](https://www.nominet.org.uk/) 的 Roy Arends 回報 MS08-020 中描述的問題
-   感謝 [iDefense Labs](https://labs.idefense.com/) 的 Jun Mao 回報 MS08-021 中描述的問題
-   感謝 [Zero Day Initiative](https://www.zerodayinitiative.com/) 的 Sebastian Apelt 回報 MS08-021 中描述的問題
-   感謝 [SkyRecon](https://www.skyrecon.com/) 的 Thomas Garnier 回報 MS08-021 中描述的問題
-   感謝 Yamata Li 回報 MS08-021 中描述的問題
-   感謝[賽門鐵克](https://www.symantec.com/)的 Peter Ferrie 回報 MS08-022 中描述的問題
-   感謝匿名的研究人員與 [iDefense VCP](https://labs.idefense.com/vcp/) 合作回報 MS08-023 中描述的問題
-   感謝 [Secunia](https://secunia.com/) 的 Carsten Eiram 回報 MS08-024 中描述的問題
-   感謝 [SkyRecon](https://www.skyrecon.com/) 的 Thomas Garnier 回報 MS08-025 中描述的問題
