...
發行 2008 年 11 月份公告之後，此公告摘要將取代原先於 2008 年 11 月 6 日發行的公告預先通知。如需更多有關公告預先通知服務的資訊，請參閱 [Microsoft 安全性公告預先通知](https://technet.microsoft.com/security/bulletin/advance)。

如需有關如何在 Microsoft 安全性公告發佈時收到自動通知之詳細資訊，請造訪 [Microsoft 技術安全性通知](https://go.microsoft.com/fwlink/?linkid=21163)。

Microsoft 將利用網路廣播於 2008 年 11 月 12 日，太平洋時間早上十一點 (美國與加拿大) 解答客戶對於這些公告的問題。 [立即註冊參加 11 月份安全性公告網路廣播](https://msevents.microsoft.com/cui/webcasteventdetails.aspx?eventid=1032374642)。 在這個日期後，此網路廣播將可隨選取得。 如需更多資訊，請參閱 [Microsoft 安全性公告摘要和網路廣播](https://technet.microsoft.com/security/bulletin/summary)。
...
|----------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告標題**         | [**Microsoft XML Core Services 的弱點可能會允許遠端執行程式碼 (955218)**](https://go.microsoft.com/fwlink/?linkid=128803)                                                                                                                     |
...
| **最高的嚴重性等級** | [重大](https://go.microsoft.com/fwlink/?linkid=21140)                                                                                                                                                                                         |
| **弱點的影響**       | 遠端執行程式碼                                                                                                                                                                                                                               |
...
|----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告標題**         | [**SMB 中的弱點可能允許遠端執行程式碼 (957097)**](https://go.microsoft.com/fwlink/?linkid=133434)                                                                                                                                                                                                                  |
...
| **最高的嚴重性等級** | [重要](https://go.microsoft.com/fwlink/?linkid=21140)                                                                                                                                                                                                                                                              |
| **弱點的影響**       | 遠端執行程式碼                                                                                                                                                                                                                                                                                                    |
...
|-----------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|
| [MS08-068](https://go.microsoft.com/fwlink/?linkid=133434) | [SMB 中的弱點可能允許遠端執行程式碼 (957097)](https://go.microsoft.com/fwlink/?linkid=133434)                         | [CVE-2008-4037](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4037) | [1 - 可能撰寫出可持續利用此漏洞的程式碼](https://technet.microsoft.com/en-us/security/cc998259.aspx) | 此弱點的可利用程式碼目前在 Windows XP 上為公開。                                     |
| [MS08-069](https://go.microsoft.com/fwlink/?linkid=128803) | [Microsoft XML Core Services 的弱點可能會允許遠端執行程式碼 (955218)](https://go.microsoft.com/fwlink/?linkid=128803) | [CVE-2008-4029](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4029) | [1 - 可能撰寫出可持續利用此漏洞的程式碼](https://technet.microsoft.com/en-us/security/cc998259.aspx) | 針對資訊洩漏的可利用程式碼可能會用於交叉網域攻擊。                                   |
| [MS08-069](https://go.microsoft.com/fwlink/?linkid=128803) | [Microsoft XML Core Services 的弱點可能會允許遠端執行程式碼 (955218)](https://go.microsoft.com/fwlink/?linkid=128803) | [CVE-2007-0099](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0099) | [2 - 可能撰寫出偶而可利用此漏洞的程式碼](https://technet.microsoft.com/en-us/security/cc998259.aspx) | 這個弱點會造成在載入 XML 檔案時發生競爭狀況。 因此，要利用此類漏洞的程式碼非常困難。 |
| [MS08-069](https://go.microsoft.com/fwlink/?linkid=128803) | [Microsoft XML Core Services 的弱點可能會允許遠端執行程式碼 (955218)](https://go.microsoft.com/fwlink/?linkid=128803) | [CVE-2008-4033](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4033) | [2 - 可能撰寫出偶而可利用此漏洞的程式碼](https://technet.microsoft.com/en-us/security/cc998259.aspx) |                                                                                      |
...
<td style="border:1px solid black;">
[Microsoft XML Core Services 3.0](https://www.http//www.microsoft.com/downloads/details.aspx?familyid=6ed1a087-97e2-4283-9b53-b7b046654d08)  
(KB955069)  
(重大)  
[Microsoft XML Core Services 4.0](https://www.microsoft.com/download/details.aspx?familyid=96a4413c-5261-4f69-83d0-932c430abd14)  
(KB954430)  
...
Microsoft Systems Management Server (SMS) 提供了深具彈性的企業解決方案，能夠對更新程式進行方便的管理。 透過 SMS，系統管理員能判斷有哪些 Windows 系統需要安全性更新，並控制更新程式在企業中的部署，同時將對使用者造成的干擾降到最低。 現已推出新版的 SMS，System Center Configuration Manager 2007；另請參閱 [System Center Configuration Manager 2007](https://technet.microsoft.com/en-us/library/bb735860.aspx)。如需更多有關系統管理員如何能使用 SMS 2003 部署安全性更新的資訊，請參閱 [SMS 2003 安全性修補程式管理](https://go.microsoft.com/fwlink/?linkid=22939) (英文)。 SMS 2.0 使用者也可以利用 [SMS 軟體更新服務功能套件](https://go.microsoft.com/fwlink/?linkid=33340)來協助部署安全性更新。 如需 SMS 的相關資訊，請造訪 [Microsoft Systems Management Server](https://go.microsoft.com/fwlink/?linkid=21158)。
...
-   感謝 [Minded Security](https://www.mindedsecurity.com/) 的 Stefano Di Paola 回報 MS08-069 中描述的問題
