...
發行 2008 年 8 月份公告之後，此公告摘要將取代原先於 2008 年 8 月 7 日發行的公告預先通知。如需更多有關公告預先通知服務的資訊，請參閱 [Microsoft 安全性公告預先通知](https://technet.microsoft.com/security/bulletin/advance)。

如需有關如何在 Microsoft 安全性公告發佈時收到自動通知之詳細資訊，請造訪 [Microsoft 技術安全性通知](https://go.microsoft.com/fwlink/?linkid=21163)。

Microsoft 將利用網路廣播於 2008 年 8 月 13 日，太平洋時間早上十一點 (美國與加拿大) 解答客戶對於這些公告的問題。 [立即註冊參加 8 月份安全性公告網路廣播](https://msevents.microsoft.com/cui/eventdetail.aspx?eventid=1032374631&culture=en-us)。 在這個日期後，此網路廣播將可隨選取得。 如需更多資訊，請參閱 [Microsoft 安全性公告摘要和網路廣播](https://www.microsoft.com/taiwan/security/bulletins/default.mspx)。
...
|----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告標題**         | [**Microsoft Windows 影像色彩管理系統中的弱點可能會允許遠端執行程式碼 (952954)**](https://technet.microsoft.com/security/bulletin/ms08-046)                                                                                                                                                                                                                                                |
...
|----------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告標題**         | [**Internet Explorer 積存安全性更新 (953838)**](https://technet.microsoft.com/security/bulletin/ms08-045)                                                                                                                                    |
...
|----------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告標題**         | [**Microsoft Access 的 Snapshot Viewer 的 ActiveX 控制項弱點可能會允許遠端執行程式碼 (955617)**](https://technet.microsoft.com/security/bulletin/ms08-041)                                                                                         |
...
|----------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告標題**         | [**Microsoft Excel 中的弱點可能會允許遠端執行程式碼 (954066)**](https://technet.microsoft.com/security/bulletin/ms08-043)                                                                                                                                                                                                                                         |
...
|----------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告標題**         | [**Microsoft PowerPoint 中的弱點可能會允許遠端執行程式碼 (949785)**](https://technet.microsoft.com/security/bulletin/ms08-051)                                                                                                                                                                                                                                                                                        |
...
|----------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告標題**         | [**Microsoft Office 篩選器的弱點可能會允許遠端執行程式碼 (924090)**](https://technet.microsoft.com/security/bulletin/ms08-044)                                                                                        |
...
|----------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告標題**         | [**IPsec 原則處理中的弱點可能會導致資訊洩漏 (953733)**](https://technet.microsoft.com/security/bulletin/ms08-047)                                                                                                                                                                                                                                                               |
...
|----------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告標題**         | [**事件系統中的弱點可能會允許遠端執行程式碼 (950974)**](https://technet.microsoft.com/security/bulletin/ms08-049)                                                                                                                                        |
...
|----------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告標題**         | [**適用於 Outlook Express 和 Windows Mail 的安全性更新 (951066)**](https://technet.microsoft.com/security/bulletin/ms08-048)                                                                                                                    |
...
|----------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告標題**         | [**Windows Messenger 中的弱點可能會導致資訊洩漏 (955702)**](https://technet.microsoft.com/security/bulletin/ms08-050)                                                                                                                                                                                                                              |
...
|----------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告標題**         | [**Microsoft Word 的弱點可能會允許遠端執行程式碼 (955048)**](https://technet.microsoft.com/security/bulletin/ms08-042)                                                                                                                                                                                                                                        |
...
-   感謝 [ISC/SANS](https://isc.sans.org/) 回報 MS08-042 中描述的問題
-   感謝 [VeriSign iDefense](https://www.idefense.com/vcp) VCP 回報 MS08-043 中描述的問題
-   感謝 [TippingPoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 回報 MS08-043 中描述的問題
-   感謝 Jeremy Funk 回報 MS08-043 中描述的問題
-   感謝 [NGS Software](https://www.nextgenss.com/) 的 Shaun Colley 回報 MS08-044 中描述的問題
-   感謝 [Zero Day Initiative (ZDI)](https://www.zerodayinitiative.com/) 回報 MS08-044 中描述的問題
-   感謝匿名研究人員與 [iDefense VCP](https://labs.idefense.com/) 合作回報 MS08-044 中描述的問題
-   感謝 Damian Put 與 [iDefense VCP](https://labs.idefense.com/) 合作回報 MS08-044 中描述的問題
-   感謝 [Palo Alto Networks](https://www.paloaltonetworks.com/) 的 Yamata Li 回報 MS08-045 中描述的問題
-   感謝 [Google Security Team](https://www.google.com/) 的 Tavis Ormandy 回報 MS08-045 中描述的問題
-   感謝 Sam Thomas 與 [TippingPoint](https://www.tippingpoint.com/) 及 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作回報 MS08-045 中描述的問題
-   感謝 [TippingPoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 回報 MS08-045 中描述的問題
-   感謝 [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Jun Mao 回報 MS08-046 中描述的問題
-   感謝 [Core Security Technologies](https://www.coresecurity.com/) 的 Jorge Luis Alvarez Medina 回報 MS08-048 中描述的問題
-   感謝 [Palo Alto Networks](https://www.paloaltonetworks.com/) 的 Yamata Li 回報 MS08-049 中描述的問題
-   感謝 [Fortinet Security Response Team](https://www.fortinet.com/) 的 Haifei Li (cocoruder) 回報 MS08-050 中描述的問題
-   感謝 [Reversemode.com](https://reversemode.com/) 的 Ruben Santamarta 與 [iDefense Labs](https://labs.idefense.com/) 合作回報 MS08-051 中描述的問題
-   感謝 [Venustech](https://www.venustech.com.cn/) 的 ADLab 回報 MS08-051 中描述的問題
