...
|----------------------|--------------------------------------------------------------------------------------------------------------------------|
| **公告標題**         | [**Microsoft Excel 中的弱點可能會允許遠端執行程式碼 (927198)**](https://technet.microsoft.com/security/bulletin/ms07-002) |
...
|----------------------|---------------------------------------------------------------------------------------------------------------------------|
| **公告標題**         | [**Microsoft Outlook 中的弱點可能會允許遠端執行程式碼 (925938**](https://technet.microsoft.com/security/bulletin/ms07-003) |
...
|----------------------|----------------------------------------------------------------------------------------------------------------------|
| **公告標題**         | [**向量標記語言中的弱點可能會允許遠端執行程式碼 (929969)**](https://technet.microsoft.com/security/bulletin/ms07-004) |
...
|----------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告標題**         | [**Microsoft Office 2003 Brazilian Portuguese Grammar Checker 中的弱點可能會允許遠端執行程式碼 (921585)**](https://technet.microsoft.com/security/bulletin/ms07-001) |
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/mac/">重大</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com.tw/mac/">重大</a></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="even">
...
-   感謝 [CERT](https://www.securecoding.cert.org/confluence/display/seccode/cert+secure+coding+standards) 的 Jeff Gennari、[Fortinet Security Research Team](https://www.fortinet.com/) 的 Jie M、[NSFocus Security Team](https://www.nsfocus.com/)，以及 [IDefense Labs](https://labs.idefense.com/) 的 Greg MacManus 回報 [MS07-002](https://technet.microsoft.com/security/bulletin/ms07-002) 中描述的問題。  
-   感謝 [Sourcefire](https://www.sourcefire.com/) 和 [Computer Terrorism](https://www.computerterrorism.com/) 的 Stuart Pearson 回報 [MS07-003](https://technet.microsoft.com/security/bulletin/ms07-003) 中描述的問題。
...
-   客戶平台的更新程式可以從 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 網站取得。
