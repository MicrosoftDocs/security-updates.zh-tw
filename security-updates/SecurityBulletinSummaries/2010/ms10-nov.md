---
TOCTitle: 'MS10-NOV'
Title: 2010 年 11 月份 Microsoft 資訊安全公告摘要
ms:assetid: 'ms10-nov'
ms:contentKeyID: 61237710
ms:date: '04/18/2014'
...
此公告摘要列出 2010 年 11 月份所發行之資訊安全公告。

發行 2010 年 11 月份公告之後，此公告摘要將取代原先於 2010 年 11 月 4 日發行的公告預先通知。如需更多有關公告預先通知服務的資訊，請參閱 [Microsoft 資訊安全公告預先通知](https://technet.microsoft.com/security/bulletin/advance)。

如需有關如何在 Microsoft 資訊安全公告發佈時收到自動通知之詳細資訊，請造訪 [Microsoft 技術安全性通知](https://go.microsoft.com/fwlink/?linkid=21163)。

Microsoft 將利用網路廣播於 2010 年 11 月 10 日，太平洋時間早上十一點 (美國與加拿大) 解答客戶對於這些公告的問題。 [立即註冊參加 11 月份資訊安全公告網路廣播](https://msevents.microsoft.com/cui/webcasteventdetails.aspx?culture=en-us&eventid=1032454441)。 在這個日期後，此網路廣播將可隨選取得。 如需更多資訊，請參閱 [Microsoft 資訊安全公告摘要和網路廣播](https://www.microsoft.com/taiwan/security/bulletins/default.mspx)。
...
<td style="border:1px solid black;"><strong>Microsoft Office 中的資訊安全風險可能會允許遠端執行程式碼 (2423930)</strong><br />
<br />
此資訊安全更新可解決 Microsoft Office 中一項公開揭露的資訊安全風險和四項未公開報告的資訊安全風險。 最嚴重的資訊安全風險可能會在使用者開啟或預覽蓄意製作的 RTF 電子郵件時，允許遠端執行程式碼。 成功利用這類任一資訊安全風險的攻擊者可以取得與本機使用者相同的使用者權限。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。</td>
...
<td style="border:1px solid black;"><strong>Microsoft PowerPoint 中的資訊安全風險可能會允許遠端執行程式碼 (2293386)</strong><br />
<br />
此資訊安全更新可解決 Microsoft Office 中兩項未公開報告的資訊安全風險，這些資訊安全風險可在使用者開啟蓄意製作的 PowerPoint 檔案時，允許從遠端執行程式碼。 成功利用這些資訊安全風險的攻擊者可以取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。</td>
...
<td style="border:1px solid black;"><strong>Forefront Unified Access Gateway (UAG) 中的資訊安全風險可能會允許權限提高 (2316074)</strong><br />
<br />
此資訊安全更新可解決 Forefront Unified Access Gateway (UAG) 中四項未公開報告的資訊安全風險。 如果使用者透過蓄意製作的 URL 造訪受影響的網站，這些資訊安全風險中最嚴重者可能會允許權限提高。 然而，攻擊者並不能強制使用者造訪這類網站， 而是引誘使用者自行前往。一般的做法是設法讓使用者按一下電子郵件或 Instant Messenger 訊息中通往攻擊者網站的連結。</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/rating">重要</a><br />
權限提高</td>
<td style="border:1px solid black;">可能需要重新開機</td>
...
|---------------------------------------------------------------------|-----------------------------------------------------------------------------|----------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------|  
| [MS10-088](https://technet.microsoft.com/security/bulletin/ms10-088) | PowerPoint 剖析緩衝區溢位資訊安全風險                                       | [CVE-2010-2572](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2572) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 可能撰寫出可持續利用此漏洞的程式碼 | (無)                                                                                           |  
| [MS10-089](https://technet.microsoft.com/security/bulletin/ms10-089) | UAG XSS 允許 EOP 資訊安全風險                                               | [CVE-2010-2733](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2733) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 可能撰寫出可持續利用此漏洞的程式碼 | (無)                                                                                           |  
| [MS10-089](https://technet.microsoft.com/security/bulletin/ms10-089) | Forefront Unified Access Gateway 中的 UAG 行動入口網站 XSS 問題資訊安全風險 | [CVE-2010-2734](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2734) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 可能撰寫出可持續利用此漏洞的程式碼 | (無)                                                                                           |  
| [MS10-087](https://technet.microsoft.com/security/bulletin/ms10-087) | RTF 堆疊緩衝區溢位資訊安全風險                                              | [CVE-2010-3333](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3333) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 可能撰寫出可持續利用此漏洞的程式碼 | (無)                                                                                           |  
| [MS10-087](https://technet.microsoft.com/security/bulletin/ms10-087) | Office Art 繪圖記錄資訊安全風險                                             | [CVE-2010-3334](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3334) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 可能撰寫出可持續利用此漏洞的程式碼 | (無)                                                                                           |  
| [MS10-087](https://technet.microsoft.com/security/bulletin/ms10-087) | 繪圖例外狀況處理資訊安全風險                                                | [CVE-2010-3335](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3335) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 可能撰寫出可持續利用此漏洞的程式碼 | (無)                                                                                           |  
| [MS10-087](https://technet.microsoft.com/security/bulletin/ms10-087) | 不安全程式庫載入資訊安全風險                                                | [CVE-2010-3337](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3337) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 可能撰寫出可持續利用此漏洞的程式碼 | **這項資訊安全風險已經公開揭露**                                                               |  
| [MS10-089](https://technet.microsoft.com/security/bulletin/ms10-089) | Signurl.asp 中的 XSS 資訊安全風險                                           | [CVE-2010-3936](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3936) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 可能撰寫出可持續利用此漏洞的程式碼 | (無)                                                                                           |  
| [MS10-087](https://technet.microsoft.com/security/bulletin/ms10-087) | PowerPoint 整數反向溢位導致堆積損毀資訊安全風險                             | [CVE-2010-2573](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2573) | [**2**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 可能撰寫出偶爾可利用此漏洞的程式碼 | [MS10-088](https://technet.microsoft.com/security/bulletin/ms10-088) 也能解決這項資訊安全風險。 |  
| [MS10-088](https://technet.microsoft.com/security/bulletin/ms10-088) | PowerPoint 整數反向溢位導致堆積損毀資訊安全風險                             | [CVE-2010-2573](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2573) | [**2**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 可能撰寫出偶爾可利用此漏洞的程式碼 | [MS10-087](https://technet.microsoft.com/security/bulletin/ms10-087) 也能解決這項資訊安全風險。 |  
| [MS10-087](https://technet.microsoft.com/security/bulletin/ms10-087) | MSO 大型 SPID 讀取 AV 資訊安全風險                                          | [CVE-2010-3336](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3336) | [**2**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 可能撰寫出偶爾可利用此漏洞的程式碼 | (無)                                                                                           |  
| [MS10-089](https://technet.microsoft.com/security/bulletin/ms10-089) | UAG 重新導向偽造資訊安全風險                                                | [CVE-2010-2732](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2732) | [**3**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 不太可能撰寫出可利用此漏洞的程式碼 | 這只是一個偽造資訊安全風險。                                                                   |
...
<td style="border:1px solid black;">
[Microsoft Office XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=f32648e3-2fb5-472c-932f-360e5d3c0931&displaylang=zh-tw)  
(KB2289169)  
(重要)
</td>
<td style="border:1px solid black;">
[Microsoft PowerPoint 2002 Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=3efbf9f6-734a-46ac-8f92-87b6ec819bfa&displaylang=zh-tw)  
(KB2413272)  
(重要)
</td>
</tr>
...
<td style="border:1px solid black;">
[Microsoft Office 2003 Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=07a6cf76-2cea-4c54-b66d-50e9eed108ac&displaylang=zh-tw)  
(KB2289187)  
(重要)
</td>
<td style="border:1px solid black;">
[Microsoft PowerPoint 2003 Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=108286d4-fb68-40d6-a7b1-64b3a4eb87ee&displaylang=zh-tw)  
(KB2413304)  
(重要)
</td>
</tr>
...
<td style="border:1px solid black;">
[Microsoft Office 2007 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=be0c5878-60c0-4700-8836-50d369b51d04&displaylang=zh-tw)  
(KB2289158)  
(重大)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Office 2010 (32 位元版本)](https://www.microsoft.com/download/details.aspx?familyid=0b308508-0e1e-4e90-b2b8-7e32bfc5dbf4)  
(KB2289161)  
(重大)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Office 2010 (64 位元版本)](https://www.microsoft.com/download/details.aspx?familyid=534c6a2a-e7c6-4adf-8b81-e009a2b5fff4)  
(KB2289161)  
(重大)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft PowerPoint Viewer Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=df826b79-7398-45de-943c-6f6f0af1b4e3&displaylang=zh-tw)  
(KB2413381)  
(重要)
</td>
</tr>
...
[更新程式管理安全性指南](https://technet.microsoft.com/zh-tw/library/bb466251(en-us).aspx)提供您有關套用資訊安全更新的 Microsoft 最佳實作建議的其他資訊。
...
-   感謝匿名的研究人員與 [TippingPoint](https://www.tippingpoint.com/) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作回報 MS10-087 中描述的一項問題
-   感謝 [team509](https://www.team509.com/) 與 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作回報 MS10-087 中描述的一項問題
-   感謝 [Secunia](https://secunia.com/) 的 Dyon Balding 回報 MS10-087 中描述的一項問題
-   感謝 [CERT 協調中心](https://www.cert.org/) 的 Will Dorman 回報 MS10-087 中描述的一項問題
-   感謝 [TippingPoint](https://www.tippingpoint.com/) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 回報 MS10-087 中描述的一項問題
-   感謝 [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Chaouki Bekrar 回報 MS10-087 中描述的一項問題
-   感謝 [Fortinet 公司 FortiGuard Labs](https://www.fortiguard.com/) 的 Haifei Li 回報 MS10-087 中描述的一項問題
-   感謝 [ACROS Security](https://www.acrossecurity.com) 的 Simon Raner 回報 MS10-087 中描述的一項問題
-   感謝 [Secunia Research](https://secunia.com/) 的 Alin Rad Pop 回報 MS10-088 中描述的一項問題
-   感謝匿名的研究人員與 [TippingPoint](https://www.tippingpoint.com/) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作回報 MS10-088 中描述的一項問題
...
-   V1.0 (2010 年 11 月 10 日)： 公告摘要發行。
-   V1.1 (2010 年 11 月 10 日)： 針對 MS10-088，將受影響版本 "Microsoft PowerPoint Viewer" 修正為 "Microsoft PowerPoint Viewer 2007 Service Pack 2"。 這只是資訊的變更。 已成功更新系統的客戶，包括已啟用自動更新的客戶，不必採取任何行動。 先前尚未安裝此更新的客戶可能需要根據修訂後的「受影響的軟體」，重新評估其系統是否需要此更新。
-   V1.2 (2010 年 11 月 24 日)： 針對 MS10-087 修正資訊安全風險索引，將 CVE-2010-2573 新增為這項更新解決的資訊安全風險。 這只是資訊的變更。
