...
發行 2010 年 9 月份公告之後，此公告摘要將取代原先於 2010 年 9 月 9 日發行的公告預先通知。如需更多有關公告預先通知服務的資訊，請參閱 [Microsoft 安全性公告預先通知](https://technet.microsoft.com/security/bulletin/advance)。
...
|-----------------------------------------------------------|--------------------------------------------|----------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|  
| [MS10-062](https://go.microsoft.com/fwlink/?linkid=190884) | MPEG-4 轉碼器弱點                          | [CVE-2010-0818](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0818) | [**1**](https://technet.microsoft.com/zh-tw/security/cc998259.aspx) - 可能撰寫出可持續利用此漏洞的程式碼 | 由於 Windows Vista 具備風險減輕機制，因此較難在其上執行程式碼 |  
| [MS10-068](https://go.microsoft.com/fwlink/?linkid=190509) | LSASS 堆積溢位弱點                         | [CVE-2010-0820](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0820) | [**1**](https://technet.microsoft.com/zh-tw/security/cc998259.aspx) - 可能撰寫出可持續利用此漏洞的程式碼 | (無)                                                          |  
| [MS10-069](https://go.microsoft.com/fwlink/?linkid=197093) | CSRSS 本機權限提高弱點                     | [CVE-2010-1891](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1891) | [**1**](https://technet.microsoft.com/zh-tw/security/cc998259.aspx) - 可能撰寫出可持續利用此漏洞的程式碼 | (無)                                                          |  
| [MS10-067](https://go.microsoft.com/fwlink/?linkid=197102) | WordPad Word 97 文字轉換程式記憶體損毀弱點 | [CVE-2010-2563](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2563) | [**1**](https://technet.microsoft.com/zh-tw/security/cc998259.aspx) - 可能撰寫出可持續利用此漏洞的程式碼 | (無)                                                          |  
| [MS10-066](https://go.microsoft.com/fwlink/?linkid=197105) | RPC 記憶體損毀弱點                         | [CVE-2010-2567](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2567) | [**1**](https://technet.microsoft.com/zh-tw/security/cc998259.aspx) - 可能撰寫出可持續利用此漏洞的程式碼 | (無)                                                          |  
| [MS10-061](https://go.microsoft.com/fwlink/?linkid=200505) | 列印多工緩衝處理器服務模擬弱點             | [CVE-2010-2729](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2729) | [**1**](https://technet.microsoft.com/zh-tw/security/cc998259.aspx) - 可能撰寫出可持續利用此漏洞的程式碼 | **此弱點目前在網際網路生態系統中遭到利用**                    |  
| [MS10-070](https://go.microsoft.com/fwlink/?linkid=202409) | ASP.NET 填補資料庫 (Padding Oracle) 弱點   | [CVE-2010-3332](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3332) | [**1**](https://technet.microsoft.com/zh-tw/security/cc998259.aspx) - 可能撰寫出可持續利用此漏洞的程式碼 | **此弱點目前在網際網路生態系統中遭到利用**                    |  
| [MS10-065](https://go.microsoft.com/fwlink/?linkid=199537) | 目錄驗證略過弱點                           | [CVE-2010-2731](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2731) | [**1**](https://technet.microsoft.com/zh-tw/security/cc998259.aspx) - 可能撰寫出可持續利用此漏洞的程式碼 | **這項弱點已經公開揭露**                                      |  
| [MS10-063](https://go.microsoft.com/fwlink/?linkid=200378) | Uniscribe 字型剖析引擎記憶體損毀弱點       | [CVE-2010-2738](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2738) | [**1**](https://technet.microsoft.com/zh-tw/security/cc998259.aspx) - 可能撰寫出可持續利用此漏洞的程式碼 | (無)                                                          |  
| [MS10-064](https://go.microsoft.com/fwlink/?linkid=200727) | Outlook 中的堆積式緩衝區溢位弱點           | [CVE-2010-2728](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2728) | [**2**](https://technet.microsoft.com/zh-tw/security/cc998259.aspx) - 可能撰寫出偶爾可利用此漏洞的程式碼 | (無)                                                          |  
| [MS10-065](https://go.microsoft.com/fwlink/?linkid=199537) | 要求標頭緩衝區溢位弱點                     | [CVE-2010-2730](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2730) | [**2**](https://technet.microsoft.com/zh-tw/security/cc998259.aspx) - 可能撰寫出偶爾可利用此漏洞的程式碼 | (無)                                                          |  
| [MS10-065](https://go.microsoft.com/fwlink/?linkid=199537) | IIS 重複參數要求拒絕服務弱點               | [CVE-2010-1899](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1899) | [**3**](https://technet.microsoft.com/zh-tw/security/cc998259.aspx) - 不太可能撰寫出可利用此漏洞的程式碼 | 這只是拒絕服務弱點                                            |
...
(KB981550)  
(重要)  
[Active Directory 應用程式模式 (ADAM)](https://www.microsoft.com/download/details.aspx?familyid=79fb639d-2cc1-4bea-9df6-c67ed95890e3)  
(KB982000)  
(重要)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[適用於 Itanium 型系統的 Windows Server 2003 SP2](https://www.microsoft.com/download/details.aspx?familyid=1f04f151-330a-4b6c-826e-76def35daa73)  
(重要)
</td>
<td style="border:1px solid black;">
...
<sup>[1]</sup>**.NET Framework 4.0 Client Profile 不受影響。**可在兩個設定檔中使用 .NET Framework 第 4 版可轉散發套件： .NET Framework 4.0 和 .NET Framework 4.0 Client Profile。.NET Framework 4.0 Client Profile 是 .NET Framework 4.0 的子集。此更新所解決的弱點只會影響到 .NET Framework 4.0，而不會影響到 .NET Framework 4.0 Client Profile。如需更多資訊，請參閱： [安裝 .NET Framework](https://msdn.microsoft.com/zh-tw/library/5a4x27ek.aspx)。
...
-   感謝 [Kaspersky Lab](https://www.kaspersky.com/) 的 Sergey Golovanov、Alexander Gostev、Maxim Golovkin 和 Alexey Monastyrsky，以及 [Design and Test Lab](https://www.dnt-lab.com/) 的 Vitaly Kiktenko 和 Alexander Saprykin 回報 MS10-061 中描述的問題
-   感謝 [Symantec](https://www.symantec.com/index.jsp) 的 Liam O Morchu 回報 MS10-061 中描述的問題
-   感謝 [Sourcefire VRT](https://www.sourcefire.com/services/sf_vrt.html) 的 Matthew Watchinski 回報 MS10-062 中描述的問題
-   感謝 的 Carsten Book 回報 MS10-063 中描述的問題
-   感謝 Red Hat Security Response Team 的 Marc Schoenefeld 回報 MS10-063 中描述的問題
-   感謝 [Secunia](https://secunia.com/) 的 Carsten H. Eiram 回報相關資訊，幫助我們修改 MS10-063 中 CVE-2010-2738 的「弱點索引」
-   感謝 [Secunia](https://secunia.com/) 的 Dyon Balding 回報 MS10-064 中描述的問題
-   感謝 Jinsik Shim 回報 MS10-065 中描述的問題
-   感謝 Rubicon West 的 Travis Raybold 回報 MS10-065 中描述的問題
-   感謝 [Palo Alto Networks](https://www.paloaltonetworks.com/) 的 Yamata Li 回報 MS10-066 中描述的問題
-   感謝 [iDefense Labs](https://labs.idefense.com/) 的 S0lute 回報 MS10-067 中描述的問題
-   感謝 [IBM Japan](https://www.ibm.com/jp/ja/) 回報 MS10-069 中描述的問題
