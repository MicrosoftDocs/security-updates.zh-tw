...
|----------------------|-----------------------------------------------------------------------------------------------------------------------------|
| **公告標題**         | [**Microsoft Exchange 中的弱點可能會允許遠端執行程式碼 (916803)**](https://technet.microsoft.com/security/bulletin/ms06-019) |
...
|----------------------|-----------------------------------------------------------------------------------------------------------------------------------------------|
| **公告標題**         | [**Adobe 的 Macromedia Flash Player 中存在的弱點可能會允許遠端執行程式碼 (913433)**](https://technet.microsoft.com/security/bulletin/ms06-020) |
...
|----------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告標題**         | [**Microsoft Distributed Transaction Coordinator 的弱點可能會造成拒絕服務 (913580)**](https://technet.microsoft.com/security/bulletin/ms06-018)               |
...
-   感謝 [eEye Digital Security](https://www.eeye.com/html/) 回報 [MS06-018](https://technet.microsoft.com/security/bulletin/ms06-018) 中描述的問題。  
-   感謝 [McAfee](https://www.mcafee.com) 的 Xiao Chen 回報 [MS06-018](https://technet.microsoft.com/security/bulletin/ms06-018) 中描述的問題。  
-   感謝 [VenusTech](https://www.venustech.com.cn) 的 Kai Zhang 回報 [MS06-018](https://technet.microsoft.com/security/bulletin/ms06-018) 中描述的問題。
