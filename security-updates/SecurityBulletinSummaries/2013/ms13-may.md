...
-   感謝 [FireEye](http://www.fireeye.com/) 的 Daniel Caselden 回報 Internet Explorer 釋放後使用資訊安全風險 (CVE-2013-1347)
-   感謝 [iSIGHT Partners](http://www.isightpartners.com/) 與我們合作解決 Internet Explorer 釋放後使用資訊安全風險 (CVE-2013-1347)

**MS13-039**

-   感謝 Marek Kroemeke、22733db72ab3ed94b5f8a1ffcde850251fe6f466、AKAT-1 與 [HP 的](http://www.hpenterprisesecurity.com/products) [Zero Day Initiative](http://www.zerodayinitiative.com/) 合作，回報 HTTP.sys 阻斷服務資訊安全風險 (CVE-2013-1305)
...
-   感謝 [CERT/CC](http://www.cert.org/) 的 Will Dormann 回報 Word 圖形損毀資訊安全風險 (CVE-2013-1335)
...
-   V1.0 (2013 年 5 月 14 日)： 公告摘要發行。
-   V1.1 (2013 年 5 月 28 日)： 針對 MS13-037 更正 CVE-2013-3140 的一般性資訊安全風險編號。這只是資訊的變更。
