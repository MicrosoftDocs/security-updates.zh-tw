---
TOCTitle: 'MS13-FEB'
Title: 2013 年 2 月份 Microsoft 資訊安全公告摘要
ms:assetid: 'ms13-feb'
ms:contentKeyID: 61237742
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms13-feb(v=Security.10)'
---

2013 年 2 月份 Microsoft 資訊安全公告摘要
=========================================
...
此公告摘要列出 2013 年 2 月份發行之資訊安全公告。

發行 2013 年 2 月份資訊安全公告之後，此公告摘要將取代原先於 2013 年 2 月 7 日發行的公告預先通知。如需更多有關公告預先通知服務的資訊，請參閱 [Microsoft 資訊安全公告預先通知](https://technet.microsoft.com/zh-tw/security/gg309152.aspx)。

如需有關如何在 Microsoft 資訊安全公告發佈時收到自動通知之詳細資訊，請造訪 [Microsoft 技術資訊安全通知](https://technet.microsoft.com/zh-tw/security/dd252948.aspx)。

Microsoft 將利用網路廣播於 2013 年 2 月 13 日，太平洋時間早上十一點 (美國與加拿大) 解答客戶對於這些公告的問題。立即註冊參加 [2 月份資訊安全公告網路廣播](https://msevents.microsoft.com/cui/eventdetail.aspx?eventid=1032538626&culture=en-us)。在這個日期後，此網路廣播將可[隨選取得](https://msevents.microsoft.com/cui/eventdetail.aspx?eventid=1032538626&culture=en-us)。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-009">MS13-009</a></td>
<td style="border:1px solid black;"><strong>Internet Explorer</strong> <strong>積存資訊安全更新</strong> <strong>(2792100)  <br />
<br />
</strong>本資訊安全更新可解決 Internet Explorer 中十三項未公開報告的資訊安全風險。最嚴重的資訊安全風險可能會在使用者以 Internet Explorer 檢視蓄意製作的網頁時，允許遠端執行程式碼。成功利用這些資訊安全風險的攻擊者可以取得與目前使用者相同的使用者權限。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-010">MS13-010</a></td>
<td style="border:1px solid black;"><strong>向量標記語言中的資訊安全風險可能會允許遠端執行程式碼</strong> <strong>(2797052)</strong> <br />
<br />
這個資訊安全更新可解決 Microsoft 向量標記語言 (VML) 實作中一項未公開報告的資訊安全風險。如果使用者使用 Internet Explorer 檢視蓄意製作的網頁，此資訊安全風險可能會允許遠端執行程式碼。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/rating">重大</a> <br />
遠端執行程式碼</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-011">MS13-011</a></td>
<td style="border:1px solid black;"><strong>媒體解壓縮中的資訊安全風險可能會允許遠端執行程式碼</strong> <strong>(2780091)  <br />
<br />
</strong>此資訊安全更新可解決 Microsoft Windows 中一項已公開揭露的資訊安全風險。如果使用者開啟蓄意製作的媒體檔案 (例如 .mpg 檔案)、開啟包含蓄意製作之內嵌媒體檔案的 Microsoft Office 文件 (例如 .ppt 檔案)，或收到蓄意製作的串流內容，此資訊安全風險可能會允許遠端執行程式碼。成功利用此資訊安全風險的攻擊者可以取得與目前使用者相同的使用者權限。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/rating">重大</a> <br />
遠端執行程式碼</td>
<td style="border:1px solid black;">可能需要重新開機</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-012">MS13-012</a></td>
<td style="border:1px solid black;"><strong>Microsoft Exchange Server</strong> <strong>中的資訊安全風險可能會允許遠端執行程式碼</strong> <strong>(2809279)  <br />
<br />
</strong>此資訊安全更新可解決 Microsoft Exchange Server 中公開揭露的資訊安全風險。其中最嚴重的資訊安全風險存在於 Microsoft Exchange Server WebReady 文件中檢視中，如果使用者使用 Outlook Web App (OWA) 預覽蓄意製作的檔案，則此資訊安全風險可能會允許在 Exchange Server 上轉碼服務的資訊安全內容中遠端執行程式碼。Exchange 中用於 WebReady 文件檢視的轉碼服務是以 LocalService 帳戶執行。LocalService 帳戶在本機電腦擁有最低權限，在網路上提供匿名認證。</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/rating">重大</a> <br />
遠端執行程式碼</td>
<td style="border:1px solid black;">可能需要重新開機</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-020">MS13-020</a></td>
<td style="border:1px solid black;"><strong>OLE Automation</strong> <strong>中的資訊安全風險可能會允許遠端執行程式碼(2802968)  <br />
<br />
</strong>這個資訊安全更新可解決 Microsoft Windows 物件連結與嵌入 (OLE) Automation 中一項未公開報告的資訊安全風險。如果使用者開啟蓄意製作的檔案，此資訊安全風險可能會允許遠端執行程式碼。成功利用此資訊安全風險的攻擊者可以取得與目前使用者相同的使用者權限。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/rating">重大</a> <br />
遠端執行程式碼</td>
<td style="border:1px solid black;">需要重新開機</td>
<td style="border:1px solid black;">Microsoft Windows</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-013">MS13-013</a></td>
<td style="border:1px solid black;"><strong>FAST Search Server 2010 for SharePoint</strong> <strong>剖析中的資訊安全風險可能會允許遠端執行程式碼</strong> <strong>(2784242)  <br />
<br />
</strong>此資訊安全更新可解決 Microsoft FAST Search Server 2010 for SharePoint 中一項公開揭露的資訊安全風險。此資訊安全風險可能會在使用者帳戶有限制的權杖的資訊安全情況下，允許執行遠端程式碼。只有啟用 Advanced Filter Pack 的 FAST Search Server for SharePoint 才會受到此問題影響。依預設，Advanced Filter Pack 是停用的。</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-014">MS13-014</a></td>
<td style="border:1px solid black;"><strong>NFS</strong> <strong>伺服器中的資訊安全風險可能會允許阻斷服務</strong> <strong>(2790978)  <br />
<br />
</strong>此資訊安全更新可解決 Microsoft Windows 中一項未公開報告的資訊安全風險。如果攻擊者嘗試在唯讀共用中執行檔案作業，此資訊安全風險可能會允許阻斷服務 (DoS)。攻擊者若利用此資訊安全風險，可導致受影響的系統停止回應並重新啟動。此資訊安全風險只會影響那些已啟用 NFS 角色的 Windows 伺服器。</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/rating">重要</a> <br />
阻斷服務 (DoS)</td>
<td style="border:1px solid black;">需要重新開機</td>
<td style="border:1px solid black;">Microsoft Windows</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-015">MS13-015</a></td>
<td style="border:1px solid black;"><strong>.NET Framework</strong> <strong>中的資訊安全風險可能會允許權限提高</strong> <strong>(2800277)  <br />
<br />
</strong>這個資訊安全更新可解決 .NET Framework 中一項未公開報告的資訊安全風險。如果使用者檢視蓄意製作的網頁時，所使用的網頁瀏覽器可執行 XAML 瀏覽器應用程式 (XBAP)，則此資訊安全風險可能會導致資訊洩漏。Windows .NET 應用程式也可能使用這個資訊安全風險，以略過程式碼存取安全性 (CAS) 限制。成功利用此資訊安全風險的攻擊者可以取得與目前使用者相同的使用者權限。系統上帳戶使用者權限較低的使用者，其受影響的程度比擁有系統管理權限的使用者要小。</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/rating">重要</a> <br />
權限提高</td>
<td style="border:1px solid black;">可能需要重新開機</td>
<td style="border:1px solid black;">Microsoft Windows、 <br />
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-016">MS13-016</a></td>
<td style="border:1px solid black;"><strong>Windows</strong> <strong>核心模式驅動程式中的資訊安全風險可能會允許權限提高</strong> <strong>(2778344)</strong> <br />
這個資訊安全更新可解決 Microsoft Windows 中 30 項未公開報告的資訊安全風險。如果攻擊者登入系統並執行蓄意製作的應用程式，則這些資訊安全風險可能允許權限提高。攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這些資訊安全風險。</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/rating">重要</a> <br />
權限提高</td>
<td style="border:1px solid black;">需要重新開機</td>
<td style="border:1px solid black;">Microsoft Windows</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-017">MS13-017</a></td>
<td style="border:1px solid black;"><strong>Windows</strong> <strong>核心中的資訊安全風險可能會允許權限提高</strong> <strong>(2799494)</strong> <br />
這個資訊安全更新可解決所有受支援的 Microsoft Windows 版本中三項未公開報告的資訊安全風險。如果攻擊者登入系統並執行蓄意製作的應用程式，則這些資訊安全風險可能允許權限提高。攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這些資訊安全風險。</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/rating">重要</a> <br />
權限提高</td>
<td style="border:1px solid black;">需要重新開機</td>
<td style="border:1px solid black;">Microsoft Windows</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-018">MS13-018</a></td>
<td style="border:1px solid black;"><strong>TCP/IP</strong> <strong>中的資訊安全風險可能會允許阻斷服務</strong> <strong>(2790655)  <br />
</strong>此資訊安全更新可解決 Microsoft Windows 中一項未公開報告的資訊安全風險。如果未經驗證的攻擊者將蓄意製作的連線終止封包傳送到伺服器，則此資訊安全風險可能會允許阻斷服務 (DoS)。</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/rating">重要</a> <br />
阻斷服務 (DoS)</td>
<td style="border:1px solid black;">需要重新開機</td>
<td style="border:1px solid black;">Microsoft Windows</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-019">MS13-019</a></td>
<td style="border:1px solid black;"><strong>Windows Client/Server Run-time Subsystem (CSRSS)</strong> <strong>中的資訊安全風險可能會允許權限提高</strong> <strong>(2790113)  <br />
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-009">MS13-009</a></td>
<td style="border:1px solid black;">Internet Explorer SetCapture 釋放後使用資訊安全風險</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-009">MS13-009</a></td>
<td style="border:1px solid black;">Internet Explorer COmWindowProxy 釋放後使用資訊安全風險</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-009">MS13-009</a></td>
<td style="border:1px solid black;">Internet Explorer CMarkup 釋放後使用資訊安全風險</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-009">MS13-009</a></td>
<td style="border:1px solid black;">Internet Explorer vtable 釋放後使用資訊安全風險</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-009">MS13-009</a></td>
<td style="border:1px solid black;">Internet Explorer LsGetTrailInfo 釋放後使用資訊安全風險</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-009">MS13-009</a></td>
<td style="border:1px solid black;">Internet Explorer CDispNode 釋放後使用資訊安全風險</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-009">MS13-009</a></td>
<td style="border:1px solid black;">Internet Explorer pasteHTML 釋放後使用資訊安全風險</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-009">MS13-009</a></td>
<td style="border:1px solid black;">Internet Explorer SLayoutRun 釋放後使用資訊安全風險</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-009">MS13-009</a></td>
<td style="border:1px solid black;">Internet Explorer InsertElement 釋放後使用資訊安全風險</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-009">MS13-009</a></td>
<td style="border:1px solid black;">Internet Explorer CPasteCommand 釋放後使用資訊安全風險</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-009">MS13-009</a></td>
<td style="border:1px solid black;">Internet Explorer CObjectElement 釋放後使用資訊安全風險</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-009">MS13-009</a></td>
<td style="border:1px solid black;">Internet Explorer CHTML 釋放後使用資訊安全風險</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-010">MS13-010</a></td>
<td style="border:1px solid black;">VML 記憶體損毀資訊安全風險</td>
<td style="border:1px solid black;"><a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0030">CVE-2013-0030</a></td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/cc998259.aspx">1</a> - 可能撰寫出可利用此漏洞的程式碼</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/cc998259.aspx">1</a> - 可能撰寫出可利用此漏洞的程式碼</td>
<td style="border:1px solid black;">不適用</td>
<td style="border:1px solid black;">根據 Microsoft 的瞭解，本資訊安全風險主要是在有限且目標明確的攻擊中遭到利用，意圖造成資訊洩漏。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-011">MS13-011</a></td>
<td style="border:1px solid black;">媒體解壓縮資訊安全風險</td>
...
<td style="border:1px solid black;">*&#42;多項資訊安全風險，請參閱 MS13-012 公告內容以瞭解詳細資訊。<br />
<br />
這類資訊安全風險已被公開揭發。</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/cc998259.aspx">1</a> - 可能撰寫出可利用此漏洞的程式碼</td>
<td style="border:1px solid black;">不適用</td>
<td style="border:1px solid black;">*&#42;多項資訊安全風險，請參閱 MS13-013 公告內容以瞭解詳細資訊。<br />
<br />
這類資訊安全風險已被公開揭發。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-014">MS13-014</a></td>
<td style="border:1px solid black;">NULL 解除參照資訊安全風險</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-015">MS13-015</a></td>
<td style="border:1px solid black;">WinForms 回撥權限提高資訊安全風險</td>
...
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/cc998259.aspx">2</a> - 很難建立可利用此漏洞的程式碼</td>
<td style="border:1px solid black;">永久</td>
<td style="border:1px solid black;">這是最新軟體的一項深度防禦措施。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-016">MS13-016</a></td>
<td style="border:1px solid black;">Win32k 競爭條件資訊安全風險</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-017">MS13-017</a></td>
<td style="border:1px solid black;">Windows 核心參照計數資訊安全風險</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-018">MS13-018</a></td>
<td style="border:1px solid black;">TCP FIN WAIT 資訊安全風險</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-019">MS13-019</a></td>
<td style="border:1px solid black;">參照計數資訊安全風險</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/zh-tw/security/bulletin/ms13-020">MS13-020</a></td>
<td style="border:1px solid black;">OLE Automation 遠端執行程式碼資訊安全風險</td>
...
<td style="border:1px solid black;">
[**MS13-009**](https://technet.microsoft.com/zh-tw/security/bulletin/ms13-009)
</td>
<td style="border:1px solid black;">
[**MS13-010**](https://technet.microsoft.com/zh-tw/security/bulletin/ms13-010)
</td>
<td style="border:1px solid black;">
[**MS13-011**](https://technet.microsoft.com/zh-tw/security/bulletin/ms13-011)
</td>
<td style="border:1px solid black;">
[**MS13-020**](https://technet.microsoft.com/zh-tw/security/bulletin/ms13-020)
</td>
<td style="border:1px solid black;">
[**MS13-014**](https://technet.microsoft.com/zh-tw/security/bulletin/ms13-014)
</td>
<td style="border:1px solid black;">
[**MS13-015**](https://technet.microsoft.com/zh-tw/security/bulletin/ms13-015)
</td>
<td style="border:1px solid black;">
[**MS13-016**](https://technet.microsoft.com/zh-tw/security/bulletin/ms13-016)
</td>
<td style="border:1px solid black;">
[**MS13-017**](https://technet.microsoft.com/zh-tw/security/bulletin/ms13-017)
</td>
<td style="border:1px solid black;">
[**MS13-018**](https://technet.microsoft.com/zh-tw/security/bulletin/ms13-018)
</td>
<td style="border:1px solid black;">
[**MS13-019**](https://technet.microsoft.com/zh-tw/security/bulletin/ms13-019)
</td>
</tr>
...
<td style="border:1px solid black;">
[適用於 Itanium 型系統的 Windows Server 2003 SP2](https://www.microsoft.com/download/details.aspx?familyid=2a3039a4-9b46-4db8-a539-07d52bbf1b92)  
(KB2778344)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 Itanium 型系統的 Windows Server 2003 SP2](https://www.microsoft.com/download/details.aspx?familyid=3cad66f1-6651-4948-9579-9df050fdaa1b)  
(KB2799494)    
(重要)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[適用於 32 位元系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=850e319f-dd6e-4480-86c3-a5129f084817)  
(KB2778344)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 32 位元系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6d7a74c8-de4b-4bcb-8b3f-581858d0776b)  
(KB2799494)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 32 位元系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c24aa6f3-82a5-4b1f-adc8-4aece948161c)  
(KB2790655)    
(重要)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=8978769b-447b-4b01-848a-cbcdf692f17a)  
(KB2778344)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c9fbb7cc-c33b-4af9-8416-9d16015e79c1)  
(KB2799494)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2738fbe4-2163-4e77-82e6-208a7a08a70c)  
(KB2790655)    
(重要)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=0f84e24c-43f4-4851-932c-8849171b2505)  
(KB2778344)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=f3e18038-b8a1-4eba-9542-8396903a3709)  
(KB2799494)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 Itanium 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c269c175-f47c-456a-9360-f38bbdfd7ed0)  
(KB2790655)    
(重要)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[適用於 32 位元系統的 Windows 7](https://www.microsoft.com/download/details.aspx?familyid=631adede-ba0f-461f-85e1-82b60a7efec1)  
(KB2778344)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 32 位元系統的 Windows 7](https://www.microsoft.com/download/details.aspx?familyid=912ac2e1-e737-43fb-acc8-a01a918a8475)  
(KB2799494)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 32 位元系統的 Windows 7](https://www.microsoft.com/download/details.aspx?familyid=cb4270c4-cec5-49e0-a56b-97539d6352a0)  
(KB2790655)    
(中度)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[適用於 32 位元系統的 Windows 7 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=631adede-ba0f-461f-85e1-82b60a7efec1)  
(KB2778344)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 32 位元系統的 Windows 7 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=912ac2e1-e737-43fb-acc8-a01a918a8475)  
(KB2799494)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 32 位元系統的 Windows 7 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=cb4270c4-cec5-49e0-a56b-97539d6352a0)  
(KB2790655)    
(中度)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows 7](https://www.microsoft.com/download/details.aspx?familyid=8dab3aca-fde1-4bd9-b82a-e4805a2e8d39)  
(KB2778344)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows 7](https://www.microsoft.com/download/details.aspx?familyid=0d1601cc-fb76-4276-bf0b-a46b7f8055ae)  
(KB2799494)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows 7](https://www.microsoft.com/download/details.aspx?familyid=5d93cb19-7854-4b49-9743-8d6a11be2dd6)  
(KB2790655)    
(中度)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows 7 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=8dab3aca-fde1-4bd9-b82a-e4805a2e8d39)  
(KB2778344)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows 7 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=0d1601cc-fb76-4276-bf0b-a46b7f8055ae)  
(KB2799494)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows 7 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=5d93cb19-7854-4b49-9743-8d6a11be2dd6)  
(KB2790655)    
(中度)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2](https://www.microsoft.com/download/details.aspx?familyid=aadb2003-ed7b-46ee-afd0-33cec4ac39b4)  
(KB2790978)   
(重要)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2](https://www.microsoft.com/download/details.aspx?familyid=ca5a8735-1568-454d-8b4c-b83107eac036)  
(KB2778344)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2](https://www.microsoft.com/download/details.aspx?familyid=201e6d1f-425b-406e-84a1-37cee035dddb)  
(KB2799494)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2](https://www.microsoft.com/download/details.aspx?familyid=01284b28-043a-4e27-b363-c1e641164a01)  
(KB2790655)    
(重要)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=aadb2003-ed7b-46ee-afd0-33cec4ac39b4)  
(KB2790978)    
(重要)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=ca5a8735-1568-454d-8b4c-b83107eac036)  
(KB2778344)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=201e6d1f-425b-406e-84a1-37cee035dddb)  
(KB2799494)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=01284b28-043a-4e27-b363-c1e641164a01)  
(KB2790655)    
(重要)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[適用於 Itanium 型系統的 Windows Server 2008 R2](https://www.microsoft.com/download/details.aspx?familyid=8e37196c-2f43-457d-8d87-336d8775c0bf)  
(KB2790978)    
(重要)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[適用於 Itanium 型系統的 Windows Server 2008 R2](https://www.microsoft.com/download/details.aspx?familyid=99320f36-1481-446c-bc3e-d33fcfd1f2c1)  
(KB2778344)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 Itanium 型系統的 Windows Server 2008 R2](https://www.microsoft.com/download/details.aspx?familyid=9f0b132a-8616-49cd-8927-393f35d0cf21)  
(KB2799494)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 Itanium 型系統的 Windows Server 2008 R2](https://www.microsoft.com/download/details.aspx?familyid=e1be5dea-dd13-42b5-a37f-4bcd828cc65f)  
(KB2790655)    
(重要)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[適用於 Itanium 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=8e37196c-2f43-457d-8d87-336d8775c0bf)  
(KB2790978)    
(重要)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[適用於 Itanium 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=99320f36-1481-446c-bc3e-d33fcfd1f2c1)  
(KB2778344)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 Itanium 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=9f0b132a-8616-49cd-8927-393f35d0cf21)  
(KB2799494)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 Itanium 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=e1be5dea-dd13-42b5-a37f-4bcd828cc65f)  
(KB2790655)    
(重要)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[適用於 32 位元系統的 Windows 8](https://www.microsoft.com/download/details.aspx?familyid=d5395864-1822-4151-a10c-f6a036f8853f)  
(KB2778344)    
(無嚴重性等級<sup>[2]</sup>)
</td>
<td style="border:1px solid black;">
[適用於 32 位元系統的 Windows 8](https://www.microsoft.com/download/details.aspx?familyid=5b74e5b3-7b8d-4669-b403-c776e70bf072)  
(KB2799494)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 32 位元系統的 Windows 8](https://www.microsoft.com/download/details.aspx?familyid=e7739ba6-9c62-4180-a095-47fdb6c741e9)  
(KB2790655)    
(中度)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[適用於 64 位元系統的 Windows 8](https://www.microsoft.com/download/details.aspx?familyid=79aaaa3a-747a-4320-9fd2-5f4a6de3d13c)  
(KB2778344)    
(無嚴重性等級<sup>[2]</sup>)
</td>
<td style="border:1px solid black;">
[適用於 64 位元系統的 Windows 8](https://www.microsoft.com/download/details.aspx?familyid=a41a2b38-5e5c-48bc-8727-e19402519f12)  
(KB2799494)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 64 位元系統的 Windows 8](https://www.microsoft.com/download/details.aspx?familyid=dd2042b8-c784-4dfc-8fca-61905693cda5)  
(KB2790655)    
(中度)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[適用於 32 位元系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=850e319f-dd6e-4480-86c3-a5129f084817) (Server Core 安裝)  
(KB2778344)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 32 位元系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6d7a74c8-de4b-4bcb-8b3f-581858d0776b) (Server Core 安裝)  
(KB2799494)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 32 位元系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c24aa6f3-82a5-4b1f-adc8-4aece948161c) (Server Core 安裝)  
(KB2790655)    
(重要)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=8978769b-447b-4b01-848a-cbcdf692f17a) (Server Core 安裝)  
(KB2778344)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c9fbb7cc-c33b-4af9-8416-9d16015e79c1) (Server Core 安裝)  
(KB2799494)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2738fbe4-2163-4e77-82e6-208a7a08a70c) (Server Core 安裝)  
(KB2790655)    
(重要)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2](https://www.microsoft.com/download/details.aspx?familyid=aadb2003-ed7b-46ee-afd0-33cec4ac39b4) (Server Core 安裝)  
(KB2790978)    
(重要)
</td>
<td style="border:1px solid black;">
[Microsoft .NET Framework 3.5.1](https://www.microsoft.com/download/details.aspx?familyid=3b25dd48-053d-4d9e-9774-905c66c3aca9) (Server Core 安裝)  
(KB2789644)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2](https://www.microsoft.com/download/details.aspx?familyid=ca5a8735-1568-454d-8b4c-b83107eac036) (Server Core 安裝)  
(KB2778344)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2](https://www.microsoft.com/download/details.aspx?familyid=201e6d1f-425b-406e-84a1-37cee035dddb) (Server Core 安裝)  
(KB2799494)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2](https://www.microsoft.com/download/details.aspx?familyid=01284b28-043a-4e27-b363-c1e641164a01) (Server Core 安裝)  
(KB2790655)    
(重要)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=aadb2003-ed7b-46ee-afd0-33cec4ac39b4) (Server Core 安裝)  
(KB2790978)    
(重要)
</td>
<td style="border:1px solid black;">
[Microsoft .NET Framework 3.5.1](https://www.microsoft.com/download/details.aspx?familyid=0da657e5-161d-46bc-a2b7-7c4696e37062) (Server Core 安裝)  
(KB2789645)    
(重要)  
[Microsoft .NET Framework 4](https://www.microsoft.com/download/details.aspx?familyid=182f4d35-f18b-4485-be22-43becbd3cc05)<sup>[1]</sup>
(Server Core 安裝) (KB2789642)  
(重要)  
[Microsoft .NET Framework 4.5](https://www.microsoft.com/download/details.aspx?familyid=b5cfc358-e5ff-445c-8d43-3f79fead6139) (Server Core 安裝)  
(KB2789648)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=ca5a8735-1568-454d-8b4c-b83107eac036) (Server Core 安裝)  
(KB2778344)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=201e6d1f-425b-406e-84a1-37cee035dddb) (Server Core 安裝)  
(KB2799494)    
(重要)
</td>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows Server 2008 R2 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=01284b28-043a-4e27-b363-c1e641164a01) (Server Core 安裝)  
(KB2790655)    
(重要)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Windows Server 2012](https://www.microsoft.com/download/details.aspx?familyid=b284296a-1db5-47dc-af2c-bf55d0ad09e6) (Server Core 安裝)  
(KB2790978)   
(重要)
</td>
<td style="border:1px solid black;">
[Microsoft .NET Framework 3.5](https://www.microsoft.com/download/details.aspx?familyid=639674a0-12a3-4185-9858-b2a31ed2f014) (Server Core 安裝)  
(KB2789650)    
(重要)  
[Microsoft .NET Framework 4.5](https://www.microsoft.com/download/details.aspx?familyid=27d83684-d4f7-4fe0-a54d-25a3d2009be0) (Server Core 安裝)  
(KB2789649)    
(重要)
</td>
<td style="border:1px solid black;">
[Windows Server 2012](https://www.microsoft.com/download/details.aspx?familyid=aac38d33-fad6-4060-bad4-61cf7c059af9) (Server Core 安裝)  
(KB2778344)    
(無嚴重性等級<sup>[2]</sup>)
</td>
<td style="border:1px solid black;">
[Windows Server 2012](https://www.microsoft.com/download/details.aspx?familyid=4e427f56-436e-43d0-b4f8-eee8427b3741) (Server Core 安裝)  
(KB2799494)    
(重要)
</td>
<td style="border:1px solid black;">
[Windows Server 2012](https://www.microsoft.com/download/details.aspx?familyid=f74a104d-4749-4dd5-b144-2e4ce9c284a2) (Server Core 安裝)  
(KB2790655)    
(重要)
</td>
<td style="border:1px solid black;">
...
**MS13-009、MS*13-*010、MS13-017** **和** **MS13-018** ***注意事項***
...
<sup>[1]</sup>Windows RT 資訊安全更新是透過 [Windows Update](https://fe1.update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=en-us) 提供。

<sup>[2]</sup>針對指定的軟體，嚴重性等級並不適用於本更新。不過，Microsoft 仍建議此軟體的客戶套用此資訊安全更新，以做為深度防禦措施。
...
<td style="border:1px solid black;">
[**MS13-012**](https://technet.microsoft.com/zh-tw/security/bulletin/ms13-012)
</td>
<td style="border:1px solid black;">
[**MS13-013**](https://technet.microsoft.com/zh-tw/security/bulletin/ms13-013)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
**注意：**System Management Server 2003 自 2010 年 1 月 12 日起不受主流支援。如需更多有關產品生命週期的資訊，請造訪 [Microsoft 支援週期](https://support.microsoft.com/default.aspx?scid=fh;%5bln%5d;lifecycle?ln=zh-tw)。現已推出新版的 SMS，System Center Configuration Manager；請參閱前段的＜System Center Configuration Manager＞一節。
...
-   感謝 Masato Kinugawa 回報 MS13-009 中描述的一項問題
-   感謝 [Omair](https://krash.in/) 與 [HP 的](https://www.hpenterprisesecurity.com/products) [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，回報 MS13-009 中描述的兩項問題
-   感謝 SkyLined 與 [HP](https://www.hpenterprisesecurity.com/products) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，回報 MS13-009 中描述的一項問題
-   感謝 Arthur Gerkis 與 Exodus Intelligence 合作，回報 MS13-009 中描述的一項問題
-   感謝 [Harmony Security](https://www.harmonysecurity.com/) 的 Stephen Fewer 與 [HP](https://www.hpenterprisesecurity.com/products) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，回報 MS13-009 中描述的兩項問題
-   感謝 [Aniway.Aniway@gmail.com](mailto:aniway.aniway@gmail.com) 與 [HP](https://www.hpenterprisesecurity.com/products) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，回報 MS13-009 中描述的一項問題
-   感謝 Tencent PC Manager 回報 MS13-009 中描述的一項問題
-   感謝 Arthur Gerkis 與 [HP](https://www.hpenterprisesecurity.com/products) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，回報 MS13-009 中描述的一項問題
-   感謝匿名的研究人員與 [HP](https://www.hpenterprisesecurity.com/products) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，回報 MS13-009 中描述的一項問題
-   感謝 [Security-Assessment.com](https://www.security-assessment.com/) 的 Scott Bell 回報 MS13-009 中描述的兩項問題
-   感謝 Yenteasy Security Research 的 Jose A Vazquez 與 Exodus Intelligence 合作，回報 MS13-009 中描述的一項問題
-   感謝 Yenteasy Security Research 的 Jose A Vazquez 與 [HP](https://www.hpenterprisesecurity.com/products) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，回報 MS13-009 中描述的一項問題
-   感謝 IBM X-Force 的 Mark Yason 回報 MS13-009 中描述的一項問題
-   感謝 [NCC 小組](https://www.nccgroup.com/)的 Ollie Whitehouse 協助我們解決 MS13-009 中所含之其他深度防禦變更的問題
-   感謝 [Tencent Security Team](https://security.tencent.com/) 回報 MS13-011 中描述的一項問題
-   感謝 [Context Information Security](https://www.contextis.com/) 的 James Forshaw 回報 MS13-015 中描述的一項問題
-   感謝 [Google Inc](https://www.google.com/) 的 [Mateusz "j00ru" Jurczyk](https://j00ru.vexillium.org/) 和 [Tencent Security Team](https://security.tencent.com/) 回報 MS13-016 中描述的兩項問題
-   感謝 [Google Inc](https://www.google.com/) 的 [Mateusz "j00ru" Jurczyk](https://j00ru.vexillium.org/) 回報 MS13-016 中描述的 25 項問題
-   感謝 [Google Inc](https://www.google.com/) 的 [Gynvael Coldwind](https://gynvael.coldwind.pl/) 和 [Mateusz "j00ru" Jurczyk](https://j00ru.vexillium.org/) 回報 MS13-017 中描述的三項問題
-   感謝 [Google Inc](https://www.google.com/) 的 [Gynvael Coldwind](https://gynvael.coldwind.pl/) 和 [Mateusz "j00ru" Jurczyk](https://j00ru.vexillium.org/) 回報 MS13-017 中描述的兩項問題
-   感謝 Max DeLiso 協助我們解決 MS13-019 中描述的一項問題
-   感謝匿名人士與 [HP](https://www.hpenterprisesecurity.com/products) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，回報 MS13-020 中描述的一項問題
...
-   V1.0 (2013 年 2 月 12 日)： 公告摘要發行。
-   V1.1 (2013 年 2 月 12 日)： 針對 MS13-009，在 CVE-2013-0022 的＜資訊安全風險入侵指數＞中更正最新軟體版本的資訊安全風險評估。
-   V1.2 (2013 年 7 月 22 日)： 針對 MS13-014，在 CVE-2013-1281 的＜資訊安全風險入侵指數＞中更正最新軟體版本的資訊安全風險評估。
