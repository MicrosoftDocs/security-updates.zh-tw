...
<td style="border:1px solid black;">
[**MS15-116**](https://technet.microsoft.com/zh-tw/library/security/ms15-116)
...
(3085552)  
(重要)  
Microsoft Office 2007 IME (日文) Service Pack 3  
(2899473)  
(重要)
...
(3085594)  
(重要)  
Microsoft Project 2010 Service Pack 2 (32 位元版本)  
(3085614)  
(重要)  
...
(3085594)  
(重要)  
Microsoft Project 2010 Service Pack 2 (64 位元版本)  
(3085614)  
(重要)  
...
(3101360)  
(重要)  
Microsoft Access 2013 Service Pack 1 (32 位元版本)  
(3085584)  
(重要)  
...
(3101359)  
(重要)  
Microsoft Project 2013 Service Pack 1 (32 位元版本)  
(3101506)  
(重要)  
Microsoft Publisher 2013 Service Pack 1 (32 位元版本)  
(3085561)  
(重要)  
...
(3101360)  
(重要)  
Microsoft Access 2013 Service Pack 1 (64 位元版本)  
(3085584)  
(重要)  
...
(3101359)  
(重要)  
Microsoft Project 2013 Service Pack 1 (64 位元版本)  
(3101506)  
(重要)  
Microsoft Publisher 2013 Service Pack 1 (64 位元版本)  
(3085561)  
(重要)  
...
(3101509)  
(重要)  
Microsoft Project 2016 (32 位元版本)  
(2920698)  
(重要)  
Microsoft Publisher 2016 (32 位元版本)  
(2920680)  
(重要)  
...
(3101509)  
(重要)  
Microsoft Project 2016 (64 位元版本)  
(2920698)  
(重要)  
Microsoft Publisher 2016 (64 位元版本)  
(2920680)  
(重要)  
...
<td style="border:1px solid black;">
[**MS15-123**](https://technet.microsoft.com/zh-tw/library/security/ms15-123)
...
-   您可透過下載中心，以安全性和重大更新 ISO CD 影響檔的方式取得本月份 Windows Update 提供的資訊安全更新。如需更多資訊，請參閱 [Microsoft 知識庫文件編號 913086](https://support.microsoft.com/zh-tw/kb/913086)。
...
適用於 IT 專業人員的安全性解決方案：[安全性疑難排解與支援](https://technet.microsoft.com/zh-tw/security/bb980617)

協助保護您的 Windows 電腦免於病毒和惡意軟體攻擊：[Microsoft Virus Protection 與 Windows Security 支援](https://support.microsoft.com/contactus/cu_sc_virsec_master?ln=zh-tw)

根據您所在國家/地區的當地支援：[多語系支援](https://support.microsoft.com/common/international.aspx?ln=zh-tw)
...
-   V1.0 (2015 年 11 月 10 日)：公告摘要發行。
-   V1.1 (2015 年 11 月 11 日)：針對 MS15-115 新增 KB3097877 的已知問題。Microsoft 正在調查來自部分客戶的當機報告，當客戶在安裝 Windows 安全性更新 3097877 後檢視特定電子郵件時就會發生當機。我們已立即執行檢閱。
-   V2.0 (2015 年 12 月 9 日)：針對 MS15-115 更新 [Microsoft 知識庫文章 3097877](https://support.microsoft.com/zh-tw/kb/3097877)，通知客戶適用於 Windows 7 和 Windows Server 2008 R2 的 3097877 更新已發行，將修正原本更新會造成某些應用程式意外結束的問題。已成功在 Windows 7 或 Windows Server 2008 R2 系統上安裝該更新的客戶應重新安裝更新。
-   V2.1 (2015 年 12 月 9 日)：針對 MS15-122 修訂提要，移除可實際存取目標機器的攻擊者要利用 CVE-2015-6095 時所需的參照。這只是資訊的變更。已成功安裝此更新的客戶不必採取任何行動。
-   V2.2 (2015 年 12 月 17 日)：修訂公告摘要，新增已知問題至 MS15-116 和 MS15-123 的「提要」表格。安裝安全性更新 3101496 後，連絡人清單的標題列上顯示 "Lync"。如果您將商務用 Skype 使用者介面設定為在 Lync 2013 (商務用 Skype) 用戶端中顯示，就會發生此問題。Microsoft 將會持續研究此問題，並在找到更多資訊後，於此文章中發佈。
-   V3.0 (2016 年 2 月 9 日)：針對 MS15-118 修訂公告摘要，宣佈已重新發行更新 3098785，以解決 [Microsoft 知識庫文章 3318750](https://support.microsoft.com/zh-tw/kb/3318750) 中討論的已知問題，對於執行 Windows 8.1、Windows RT 或 Windows Server 2012 R2 的客戶，此問題可能發生於他們在已安裝 .NET Framework 4.5.x 完整更新版本的機器上安裝 .NET Framework 4.6 後。Microsoft 建議客戶掃描新的更新並加以下載，然後安裝重新發行的更新 3098785。如需詳細資訊，請參閱 [Microsoft 知識庫文章 3318750](https://support.microsoft.com/zh-tw/kb/3318750)。

*頁面產生時間：08.02.2016 г. 下午 05:24:00-08:00。*
