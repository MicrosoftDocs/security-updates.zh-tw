...
<td style="border:1px solid black;"><strong>Windows 核心模式驅動程式中的資訊安全風險可能會允許遠端執行程式碼 (3036220)</strong><br />
<br />
...
<sup>[1]</sup>執行此軟體的客戶應下載並安裝 Microsoft System Center 2012 R2 - Virtual Machine Manager 2012 R2 UR5 的安全性更新 (KB3023195)，以解決 MS15-017 所述的資訊安全風險。請參閱該公告以取得更多資訊。
...
<sup>[1]</sup>更新 2920791 也解決同時重新發行之 [MS14-083](https://technet.microsoft.com/zh-tw/library/security/ms14-083) 中所述的資訊安全風險。
...
-   您可透過下載中心，以安全性和重大更新 ISO CD 影響檔的方式取得本月份 Windows Update 提供的安全性更新。如需更多資訊，請參閱 [Microsoft 知識庫文章 913086](https://support.microsoft.com/kb/913086/zh-tw)。
...
-   V1.0 (2015 年 2 月 10 日)：公告摘要發行。

*頁面產生時間：2015-02-06 12:47Z-08:00。*
