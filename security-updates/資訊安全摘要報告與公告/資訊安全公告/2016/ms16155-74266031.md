...
\[4\]Microsoft .NET Framework 2.0、4.5.2 與 4.6/4.6.1 為彙總修補程式，包含所有之前的更新及本月更新。如需詳細資訊，請參閱[此頁面](https://go.microsoft.com/fwlink/?linkid=829975)。**注意** 此公告討論的弱點會影響 Windows Server 2016 Technical Preview 5。Windows Server 2016 Technical Preview 5 的更新僅透過 [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) 提供。為了保護弱點，Microsoft 建議執行 Windows Server 2016 Technical Preview 5 的客戶升級至 Windows Server 2016。
