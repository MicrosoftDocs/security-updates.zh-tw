...
<td style="border:1px solid black;">
[**PDF 文件庫資訊洩漏弱點 - CVE-2016-3370**](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-3370)

</td>
<td style="border:1px solid black;">
[**PDF 文件庫資訊洩漏弱點 - CVE-2016-3374**](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-3374)
...
<tr>
<td style="border:1px solid black;">
[適用於 32 位元系統的 Windows 8.1](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=7381b2fe-d221-4c27-b140-291dbc4802b2)  
(3184943)
...
<tr>
<td style="border:1px solid black;">
[適用於 x64 型系統的 Windows 8.1](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=64781576-612e-4bce-bba7-1e65de69535e)  
(3184943)
...
<td style="border:1px solid black;">
[Windows Server 2012  
](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=ec5e5131-8f9d-4683-bf86-462baca986b5)(3184943)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012 R2](http://www.microsoft.com/downloads/zh-tw/details.aspx?familyid=729ff102-5734-422e-a7fb-d25f52ad1eb7)  
(3184943)
...
**否。執行 Windows 10 系統的客戶只需安裝一個累積更新，就能保護系統免受 CVE-2016-3370 和 CVE-2016-3374 的影響。PDF 文件庫弱點也出現在 Microsoft Edge 公告 ([MS16-105](http://go.microsoft.com/fwlink/?linkid=823625)) 中，因為在 Windows 10 系統上，適用於這些弱點的安全性修正程式存放在 Microsoft Edge 元件中，其同時隨附於累積更新中。
