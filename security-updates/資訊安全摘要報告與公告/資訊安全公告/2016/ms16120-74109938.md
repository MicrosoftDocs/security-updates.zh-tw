...
**Windows Vista  
Vista 和 Server 2008 的 Microsoft .NET Framework 3.0、4.5.2 和 4.6 更新 (KB3188736)** \[4\]
...
<td style="border:1px solid black;" colspan="4">
**Windows Vista  
Vista 和 Server 2008 的 Microsoft .NET Framework 3.0、4.5.2 和 4.6 更新 (KB3188744)** \[4\]
...
\[5\] Microsoft .NET Framework 4.5.2 與 4.6 為彙總修補程式，包含所有之前的更新及本月更新。如需詳細資訊，請參閱[此頁面](https://go.microsoft.com/fwlink/?linkid=829975)。
