---
TOCTitle: 'MS05-039'
Title: 'Microsoft Security Bulletin MS05-039 - 重大'
ms:assetid: 'ms05-039'
ms:contentKeyID: 61237418
ms:date: '04/18/2014'
ms:mtpsurl: 'https://technet.microsoft.com/zh-TW/library/ms05-039(v=Security.10)'
---

Security Bulletin

Microsoft Security Bulletin MS05-039 - 重大
===========================================

隨插即用中的弱點能會允許遠端執行程式碼及權限提高 (899588)
---------------------------------------------------------
...
-   Microsoft Windows 2000 Service Pack 4 – [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=e39a3d96-1c37-47d2-82ef-0ac89905c88f) │ [中文下載更新程式](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&familyid=e39a3d96-1c37-47d2-82ef-0ac89905c88f)
-   Microsoft Windows XP Service Pack 1 和 Microsoft Windows XP Service Pack 2 – [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=9a3bfbdd-62ea-4db2-88d2-415e095e207f) │ [中文下載更新程式](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&familyid=9a3bfbdd-62ea-4db2-88d2-415e095e207f)
-   Microsoft Windows XP Professional x64 Edition – [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=89d90e25-4773-4782-ad06-9b7517bab3c8)
-   Microsoft Windows Server 2003 和 Microsoft Windows Server 2003 Service Pack 1 – [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=6275d7b7-dab1-47c8-8745-533eb471072c) │ [中文下載更新程式](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-tw&familyid=6275d7b7-dab1-47c8-8745-533eb471072c)
-   Microsoft Windows Server 2003 for Itanium-based Systems 及具備 SP1 的 Microsoft Windows Server 2003 for Itanium-based Systems – [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=be18d39d-3e4c-4c6f-b841-2ccd8d4c3f50)
-   Microsoft Windows Server 2003 x64 Edition – [英文下載更新程式](http://www.microsoft.com/downloads/details.aspx?familyid=d976316d-3b17-4ad4-9198-513ffdac98e4)
...
這個更新程式能解決一項新發現且未公開報告的弱點。 隨插即用 (PnP) 中存在的遠端執行程式碼弱點，可以讓成功利用此弱點的攻擊者取得受影響系統的完整控制權。 攻擊者接下來將能安裝程式，檢視、變更或刪除資料，或建立具有完整使用者權限的新帳戶。 本公告的＜弱點詳細資訊＞部分會提供這項弱點的相關資訊。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">隨插即用弱點 - <a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-xxxx">CAN-2005-1983</a></td>
<td style="border:1px solid black;">遠端執行程式碼及提高本機權限</td>
...
<span></span>
#### 隨插即用弱點 - CAN-2005-1983：
  
隨插即用中存在的遠端執行程式碼與[提高本機權限](http://go.microsoft.com/fwlink/?linkid=21142)弱點，可以讓成功利用此弱點的攻擊者取得受影響系統的完整控制權。
  
#### 隨插即用弱點 - CAN-2005-1983 的緩和因素：
  
-   在 Windows XP Service Pack 2 及 Windows Server 2003 中，攻擊者必須擁有有效的登入認證，並能夠登入本機，才能利用這項弱點。 匿名使用者或具有標準使用者帳戶的使用者無法從遠端利用此弱點。 但是，具有系統管理權限的使用者可以從遠端使用受影響的元件。  
-   在 Windows XP Service Pack 1 中，攻擊者必須擁有有效的登入認證，才能嘗試利用這項弱點。 匿名使用者無法從遠端利用此弱點。 但是，具有標準使用者帳戶的使用者可以從遠端使用受影響的元件。  
-   最佳實作的防火牆和標準預設防火牆設定有助於防止網路受到來自企業外的攻擊。 最佳方式建議連線至網際網路的系統盡可能曝露最少數量的連接埠。
  
#### 隨插即用弱點 - CAN-2005-1983 的因應措施：
...
**注意：**如＜緩和因素＞所述，Windows XP Service Pack 2 及 Windows Server 2003 受此問題的影響來源主要是本機登入的使用者。 下列因應措施的設計目的旨在協助舊版的作業系統，防禦匿名的網路攻擊。
...
#### 隨插即用弱點 - CAN-2005-1983 的常見問題集：
  
**這個弱點的範圍為何？**
  
這是遠端執行程式碼與[提高本機權限](http://go.microsoft.com/fwlink/?linkid=21142)的弱點。 在 Windows 2000 中，匿名攻擊者可以從遠端嘗試利用這項弱點。 在 Windows XP Service Pack 1 中，只有經過驗證的使用者才能從遠端嘗試利用這項弱點。 在 Window XP Service Pack 2 及 Windows Server 2003 中，只有系統管理員才能從遠端存取受影響的元件。 因此，在 Windows XP Service Pack 2 及 Windows Server 2003 中，嚴格來說，這是本機權限提高的弱點。 在 Windows XP Service Pack 2 及 Windows Server 2003 中，匿名使用者無法從遠端嘗試利用這項弱點。  
...
**攻擊者如何利用這項弱點？**  
在 Windows 2000 中，匿名攻擊者可以建立蓄意製作的訊息，並將訊息傳送給受影響的系統，嘗試利用這項弱點。 訊息可能會導致受影響的系統執行程式碼。 在 Windows XP Service Pack 1 上，只有通過驗證的使用者才可能從遠端利用此弱點。 在 Windows XP Service Pack 2 及 Windows Server 2003 中，若要嘗試利用此弱點，攻擊者必須能夠從本機登入系統，然後執行蓄意製作的應用程式。
  
**因為這個弱點而承受風險的主要系統有哪些？**  
Windows 2000 系統是此弱點的主要影響目標。在 Windows XP Service Pack 1、Windows XP Service Pack 2 及 Windows Server 2003 中，攻擊者必須擁有有效的登入認證，才能利用這項弱點。 在 Windows XP Service Pack 1、Windows XP Service Pack 2 及 Windows Server 2003 中，匿名使用者無法從遠端利用此弱點。
  
**是否可以透過網際網路利用這個弱點？**  
是，匿名使用者可以在 Windows 2000 中，通過驗證的使用者可以在 Windows XP Service Pack 1 利用這個弱點。防火牆最佳實作和標準預設防火牆設定有助於防止來自網際網路外界的攻擊。 Microsoft 已經針對這個問題提出如何保護電腦的因應措施。 一般使用者可以造訪[保護您的電腦網站](http://www.microsoft.com/taiwan/security/protect/)。 IT 專業人員可以造訪[資訊安全指導中心網站](http://www.microsoft.com/taiwan/security/guidance/default.mspx)。 在 Windows XP Service Pack 2 及 Windows Server 2003 中，攻擊者必須能夠登入要攻擊的特定系統。 匿名攻擊者無法利用此弱點從遠端載入及執行程式。
  
**更新的作用何在？**  
本更新程式會修改在將訊息傳遞至分配的緩衝區之前，隨插即用服務驗證訊息長度的方式，因而移除此項弱點。 此外，在 Windows 2000 中，更新會限制對受影響元件的匿名存取，要求使用者在嘗試從遠端使用此功能之前與受影響的元件進行驗證。 這項變更符合 Windows XP Service Pack 1 內的預設設定。
...
**注意：**使用 **/quiet** 參數將會隱藏所有訊息。 這包括隱藏失敗訊息。 當系統管理員使用 **/quiet** 參數時，則應該採取妥當的做法驗證是否已順利安裝。 使用這個參數時，也必須檢視 KB899588.log 檔案，查看是否有失敗訊息。
...
系統管理員也可以使用 Spuninst.exe 公用程式來移除此安全性更新。 Spuninst.exe 公用程式位於 %Windir%\\$NTUninstallKB899588$\\Spuninst 資料夾中。
...
-   **登錄機碼驗證**
    ...
    **注意：**此登錄機碼可能未包含完整的安裝檔案清單。 此外，當系統管理員或 OEM 將 899588 安全性更新整合或匯集到 Windows 安裝原始檔時，可能未正確建立這個登錄機碼。
...
-   **登錄機碼驗證**
    ...
    **注意：**這些登錄機碼可能未包含完整的安裝檔案清單。 此外，當系統管理員或 OEM 將 899588 安全性更新整合或匯集到 Windows 安裝原始檔時，可能未正確建立這些登錄機碼。
...
-   [ISS X-Force](http://www.iss.net) 的 Neel Mehta，回報隨插即用弱點 (CAN-2005-1983)。
-   [Herve Schauer Consultants](http://www.hsc.fr) 的 Jean-Baptiste Marchand 與我們合作解決與受影響元件相關的問題。
