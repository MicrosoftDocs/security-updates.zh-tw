...
<sup>[1]</sup>3033929 更新與透過 [MS15-025](https://go.microsoft.com/fwlink/?linkid=526462) 同時發行的 3035131 更新具有共同的受影響二進位檔。手動下載並安裝更新的客戶，及計劃一併安裝兩項更新的客戶應依序安裝 3035131 和 3033929 更新。如需更多資訊，請參閱＜摘要報告常見問題集＞。
