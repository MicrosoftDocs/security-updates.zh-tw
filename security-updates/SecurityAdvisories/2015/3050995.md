...
<td style="border:1px solid black;"><a href="https://support.microsoft.com/zh-tw/kb/3050995">3050995</a></td>
</tr>
</tbody>
</table>
...
針對使用撤銷憑證的自動更新程式 (請參閱 [Microsoft 知識庫文章 2677070](https://support.microsoft.com/zh-tw/kb/2677070) 取得詳細資料) 的 Windows Vista、Windows 7、Windows Server 2008 和 Windows Server 2008 R2 系統，以及 Windows 8、Windows 8.1、Windows RT、Windows RT 8.1、Windows Server 2012 和 Windows Server 2012 R2 系統，您可以查看事件檢視器中的應用程式記錄是否有包含下列值的項目：
...
若客戶執行 Windows Server 2003，Microsoft 建議使用更新管理軟體立即套用 3050995 更新，方法為使用 [Microsoft Update](https://update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=zh-tw) 服務檢查更新或手動下載並套用更新 (如需詳細資訊，請參閱 [Microsoft 知識庫文章編號 3050995](https://support.microsoft.com/zh-tw/kb/3050995))。
...
-   V2.0 (2015 年 3 月 26 日)：重新發行摘要報告，宣佈 Windows Server 2003 受支援版本的更新已可取得。請參閱 [Microsoft 知識庫文章編號 3050995](https://support.microsoft.com/zh-tw/kb/3050995)，以取得更多資訊及下載連結。
