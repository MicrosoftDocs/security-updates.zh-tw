...
-   Visual Basic 6.0 執行階段延伸檔案 (ActiveX 控制項) 中的弱點 [MS08-070](https://technet.microsoft.com/security/bulletin/ms08-070) 可能允許遠端執行程式碼 (932349)

這個更新也包含下列協力廠商軟體的 Kill Bit (刪除位元)：

-   **Akamai Download Manager** (Akamai 下載管理員)。 此安全性更新可針對 Akamai Technologies 所開發的 ActiveX 控制項設定 [Kill Bit](https://support.microsoft.com/kb/240797/zh-tw) (刪除位元)。 Akamai Technologies 已發行安全性更新，可解決受影響元件中的弱點。 如需更多資訊和下載位置，請參閱 Akamai Technologies 的安全性發行內容。 此 Kill Bit (刪除位元) 是應 ActiveX 控制項的擁有者要求而設定。 此 ActiveX 控制項的類別識別項 (CLSIDs) 列在本摘要報告的＜常見問題集＞。
-   **Research in Motion (RIM) AxLoader**。 此安全性更新可針對 Research In Motion (RIM) 所開發的 ActiveX 控制項設定 [Kill Bit](https://support.microsoft.com/kb/240797/zh-tw) (刪除位元)。 RIM 已發行安全性更新，可解決受影響元件中的弱點。 如需更多資訊和下載位置，請參閱 Research In Motion 的安全性發行內容。 此 Kill Bit (刪除位元) 是應 ActiveX 控制項的擁有者要求而設定。 此 ActiveX 控制項的類別識別項 (CLSIDs) 列在本摘要報告的＜常見問題集＞。

如需有關安裝此更新的詳細資訊，請參閱 [Microsoft 知識庫文件編號 960715](https://support.microsoft.com/kb/960715/zh-tw)。
...
| 參照                     | 識別                                                   |
|--------------------------|--------------------------------------------------------|
| **Microsoft 知識庫文件** | [960715](https://support.microsoft.com/kb/960715/zh-tw) |
...
是的，這個更新也包含之前在 [Microsoft 安全性摘要報告 956391](https://technet.microsoft.com/security/advisory/956391) 中設定的 Kill Bit (刪除位元)。
...
如需更多資訊，請參閱 [Microsoft 知識庫文件編號 240797](https://support.microsoft.com/kb/240797/zh-tw)。 如何避免在 Internet Explorer 中執行 ActiveX 控制項。
...
下列類別識別項與 [Akamai](https://www.akamai.com/) 設定易受影響之 ActiveX 控制項的 Kill Bit 要求有關。 詳情請參閱 Akamai 發佈的[安全性發行內容](https://go.microsoft.com/fwlink/?linkid=139453)：
...
下列類別識別項與 [Research In Motion (RIM)](https://www.rim.com/) 設定易受影響之 ActiveX 控制項的 Kill Bit 要求有關。 詳情請參閱 RIM 發佈的[安全性發行內容](https://go.microsoft.com/fwlink/?linkid=139451)：
...
下列類別識別項與 Microsoft 安全性公告 [MS08-070](https://technet.microsoft.com/security/bulletin/ms08-070) 所述的 CAPICOM 控制項相關，Visual Basic 6.0 執行階段延伸檔案 (ActiveX 控制項) 中的弱點可能允許遠端執行程式碼 (932349)：
...
Microsoft 鼓勵客戶安裝此更新。 客戶若有興趣進一步瞭解此更新，請參閱 [Microsoft 知識庫文件編號 960715](https://support.microsoft.com/kb/960715/zh-tw)。
...
-   **避免 COM 物件在 Internet Explorer 中執行**
    ...
    **警告：** 如果使用「登錄編輯程式」的方式錯誤，可能造成嚴重問題，以致於您必須重新安裝作業系統。 Microsoft 無法保證您可以解決因為不正確使用 \[登錄編輯程式\] 所造成的問題。 請自行承擔使用 \[登錄編輯程式\] 的風險。
    ...
    如需避免控制項在 Internet Explorer 中執行的詳細步驟，請參閱 [Microsoft 知識庫文件編號 240797](https://support.microsoft.com/?ln=zh-twkb/240797/zh-tw)。按照文件中的步驟，在登錄中建立相容性旗標值，以避免在 Internet Explorer 中產生 COM 物件。
