...
<td style="border:1px solid black;">
[MS11-100](https://go.microsoft.com/fwlink/?linkid=232432) 中的 2656352 以及 [MS10-070](https://go.microsoft.com/fwlink/?linkid=202409) 中的 2418241
...
<td style="border:1px solid black;">
[MS11-100](https://go.microsoft.com/fwlink/?linkid=232432) 中的 2656362 以及 [MS10-070](https://go.microsoft.com/fwlink/?linkid=202409) 中的 2416470
...
**什麼是檢視狀態？**  
檢視狀態是 ASP.NET 的一項功能，可讓網頁開發人員維護網頁狀態，並在 POST 要求或網頁更新及變更時，將資料持續保存於網頁表單。檢視狀態由 ASP.NET 開發人員廣為使用，因此在 ASP.NET 網站上隨處可見。檢視狀態一律經過剖析，即使 EnableViewState 屬性設為 False 亦然。如需更多資訊，請參閱[瞭解 ASP.NET 檢視狀態](https://msdn.microsoft.com/library/ms972976.aspx)。
...
-   **套用受影響之 Microsoft .NET Framework 版本的更新**
    ...
    大部分客戶都已啟用自動更新，並且不必須採取任何行動，因為資訊安全更新將自動下載和安裝。如需有關自動更新中特定設定選項的資訊，請參閱 [Microsoft 知識庫文件編號 294871](https://support.microsoft.com/kb/294871)。對於沒有啟用自動更新的客戶，可採取[開啟或關閉自動更新](https://go.microsoft.com/fwlink/?linkid=398470)中的步驟來啟用自動更新。
  
    若是系統管理員和企業安裝，或是想要手動安裝此資訊安全更新的使用者，Microsoft 建議客戶使用更新管理軟體，立即套用更新，或使用 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 服務檢查更新。這些更新也可以從本摘要報告內「受影響的軟體」表中所列的 Microsoft 下載中心超連結取得。如需瞭解如何手動套用更新，請參閱 [Microsoft 知識庫文件編號 2905247](https://support.microsoft.com/kb/2905247)。
  
-   **若是系統管理員和企業安裝 Web 伺服陣列**  

    Microsoft 建議遵循 [Microsoft 知識庫文件編號 2915218 中提供的指南](https://support.microsoft.com/kb/2915218)。
...
<tr class="odd">
<td style="border:1px solid black;"><strong>檔案資訊</strong></td>
<td style="border:1px solid black;">請參閱 <a href="https://support.microsoft.com/kb/2905247">Microsoft 知識庫文件編號 2905247</a></td>
</tr>
<tr class="even">
