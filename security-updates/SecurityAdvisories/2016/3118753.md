...
是的。安裝此更新可防止 Internet Explorer 執行易受攻擊的控制項，保護系統不致暴露 [MS16-001](https://go.microsoft.com/fwlink/?linkid=717999) 中所描述的弱點。
...
-   **請參閱與本摘要報告有關的 Microsoft 知識庫文章，並安裝適用的 Internet Explorer 累積更新**
    ...
    Microsoft 鼓勵客戶安裝適用的 Internet Explorer 累積更新。如需詳細資訊和下載連結，請參閱 [Microsoft 知識庫文章編號 3118753](https://support.microsoft.com/zh-tw/kb/3118753)。
