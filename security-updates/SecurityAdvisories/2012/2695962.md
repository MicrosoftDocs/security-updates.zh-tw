...
-   [Cisco ASA 5500 系列調適型安全裝置 Clientless VPN ActiveX 控制項的遠端執行程式碼資訊安全風險](https://tools.cisco.com/security/center/content/ciscosecurityadvisory/cisco-sa-20120314-asaclient)
...
| 參照                         | 識別                                                        |
|------------------------------|-------------------------------------------------------------|
| **Microsoft 知識庫文件** | [2695962](https://support.microsoft.com/kb/2695962?ln=zh-tw) |
...
Microsoft 鼓勵客戶安裝此更新。客戶若有興趣進一步瞭解此更新，請參閱 [Microsoft 知識庫文件編號 2695962](https://support.microsoft.com/kb/2695962?ln=zh-tw)。
