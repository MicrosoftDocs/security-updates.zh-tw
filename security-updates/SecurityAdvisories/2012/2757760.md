...
我們正在積極地與 [Microsoft 主動保護計畫 (MAPP)](https://www.microsoft.com/security/msrc/collaboration/mapp.aspx) 的合作夥伴合作，提供資訊讓他們用來對客戶提供更廣泛的保護。此外，我們積極地與合作夥伴一同合作，監控威脅範疇，並對嘗試利用此資訊安全風險的惡意網站採取行動。

Microsoft 持續建議客戶按照 [Microsoft Safety & Security Center](https://www.microsoft.com/security/pc-security/protect-pc.aspx) 的指示啟用防火牆、套用所有軟體更新，並安裝防毒軟體和反間諜軟體。
...
| 參照             | 識別                                                                             |
|------------------|----------------------------------------------------------------------------------|
| **CVE 參照** | [CVE-2012-4969](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4969) |
...
Microsoft 修訂此公告的目的，是為了宣布推出一項 Microsoft Fix it 解決方案「在 Internet Explorer 中透過 ExecCommand 防止記憶體損毀」，該解決方案可防止此問題遭到利用。請參閱 [Microsoft 知識庫文件編號 2757760](https://support.microsoft.com/kb/2757760?ln=zh-tw)，使用自動化的 **Microsoft Fix it** 解決方案。
...
-   **套用 Microsoft Fix it 解決方案「在 Internet Explorer 中透過ExecCommand防止記憶體損毀」可防止此問題遭到利用**
    ...
    請參閱 [Microsoft 知識庫文件編號 2757760](https://support.microsoft.com/kb/2757760?ln=zh-tw) 以運用自動化 Microsoft Fix it 解決方案來啟用或停用此因應措施。
...
-   **定期更新協力廠商軟體**
    ...
    [哪裡可以取得最新版的 Java 6？](https://java.com/en/download/faq/java_6.xml)

    [Java Update 是什麼？](https://java.com/en/download/help/java_update.xml)

    [為什麼我應該要解除安裝系統中舊版的 Java？](https://www.java.com/en/download/faq/remove_olderversions.xml)
...
-   美國及加拿大地區客戶可洽詢資訊安全支援以取得技術支援。如需更多資訊，請參閱[Microsoft 說明及支援](https://support.microsoft.com/?ln=zh-tw)。
