...
-   [防毒措施深入探索指南](https://go.microsoft.com/fwlink/?linkid=28732)
...
-   [McAfee AVERT Stinger](https://vil.nai.com/vil/stinger/)，來自 McAfee 的獨立病毒掃描器。此工具可離線使用。此工具的病毒碼會與下載檔的日期一樣新。
