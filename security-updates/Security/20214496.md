...
```  
 @echo off setlocal set PATHTOFIXES=some path %PATHTOFIXES%\\Q123456\_w2k\_sp2\_x86.exe -z -m %PATHTOFIXES%\\Q123321\_w2k\_sp2\_x86.exe -z -m %PATHTOFIXES%\\Q123789\_w2k\_sp2\_x86.exe -z -m %PATHTOFIXES%\\qchain.exe   
```  
[](#mainsection)[回到頁首](#mainsection)
