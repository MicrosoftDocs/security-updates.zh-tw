...
-   利用在 RFC 2267 ( [ftp://ftp.isi.edu/in-notes/rfc2267.txt](https://technet.microsoft.com/zh-tw/ftp://ftp.isi.edu/in-notes/rfc2267.txt) ) 中討論的 IP 外出與進入篩選規則，的確是一個很好的開始。 ICSA (<https://www.icsa.net/>) 的基本模式顯示出，只要有 30 % 的網際網路路由器及組織防火牆套用這些規則， 就能減少大約一百倍由單一攻擊者帶來的這種威脅。
...
-   未將更新的安全性修補程式送到經過評估的環境。 <https://www.microsoft.com/technet/security/bulletin/ms98-004.mspx> 中說明的 RDS 盜用，就是從 1998 年以來就有修正程式可用，因此可以防止的最佳範例。 不過，即使已有修正程式可用，根據最新的 SANS 安全性調查顯示，這仍然是前四個最容易受到侵害的地方。  
...
如需更詳細的說明和進一步的範例，建議參考下列資源： [ ](https://www.cerberus-infosec.co.uk/papers.shtml)
  
-   David Leblanc 的撰寫安全程式碼的每週專欄，位於 <https://www.ntsecurity.net>
-   Michael Howard 的《在 Microsoft® Windows 2000 中設計網頁為主的安全應用程式》 (Designing Secure Web-Based Applications for Microsoft® Windows 2000) - <https://www.microsoft.com/taiwan/mspress>
...
Microsoft 的 ISA Server ( <https://www.microsoft.com/taiwan/isaserver/> ) (Internet Security and Acceleration Server) 為現今的防火牆環境帶來新的安全維護類型。 其部份功能與優點包括：
...
-   *針對 Windows 2000 組建*。ISA Server 整合 Microsoft Windows 2000 作業系統中的許多核心服務 (<https://www.microsoft.com/taiwan/isaserver/techinfo/>)， 因此能提供一致且強大的方式來管理使用者存取、設定和規則等。 其核心功能包括驗證、管理工具、頻寬控制、SecureNAT 及 Windows 2000 技術組建的 虛擬私人網路功能  
    ([https://www.microsoft.com/technet/prodtechnol/windows2000serv/  
    deploy/confeat/vpnscen.mspx](https://www.microsoft.com/technet/prodtechnol/windows2000serv/deploy/confeat/vpnscen.mspx))。  
    使用 Active Directory 服務  
    (<https://www.microsoft.com/windows2000/server/evaluation/features/dirlist.asp>)，ISA Server 可簡化管理工作。  
...
[https://www.microsoft.com/technet/prodtechnol/windows2000serv/](https://www.microsoft.com/technet/prodtechnol/windows2000serv/deploy/confeat/nt5efs.mspx)
[deploy/confeat/nt5efs.mspx](https://www.microsoft.com/technet/prodtechnol/windows2000serv/deploy/confeat/nt5efs.mspx)
...
-   SANS: <https://www.sans.org/dosstep/roadmap.php>
-   Dave Dittrich: <https://staff.washington.edu/dittrich/misc/ddos/>
...
-   Data Recovery Journal: <https://www.drj.com>
  
**防火牆**
  
-   Microsoft Official Curriculum Course 2150- Designing Security for Windows 2000: [https://www.microsoft.com/traincert/syllabi/2150Afinal.asp](https://www.microsoft.com/traincert/syllabi/2150afinal.asp)  
-   Firewall.com: <https://www.firewall.com>
-   Vicomsoft: <https://www.vicomsoft.com/knowledge/reference/firewalls1.html>
  
**數位鑑定**
  
-   Fred Cohen and Associates: <https://www.all.net>
-   Guidance Software: <https://www.guidancesoftware.com>
-   New Technologies International: <https://www.forensics-intl.com>
  
**安全方面的書籍**
  
-   Hacking Exposed: <https://www.hackingexposed.com>
-   Internet Security with Windows NT: [https://www.windowsitlibrary.com/Content/405/13/toc.html](https://www.windowsitlibrary.com/content/405/13/toc.html)
  
**組織與協會**
  
-   International Computer Security Association: <https://www.icsa.net/>
-   International Information Systems Security Certification Consortium (ISC2): <https://www.isc2.org>
-   Computer Security Institute: <https://www.gocsi.com/>
-   International Systems Security Association: <https://www.issa.org/>
