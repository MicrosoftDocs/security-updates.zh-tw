...
-   了解《Windows 2003 安全性簡介》內所描述的三個安全性範本層級。這些範本是《Windows Server 2003 安全性》指南的一部份，您可在下列的連結中找到。 [https://go.microsoft.com/fwlink/?LinkId=14846](https://go.microsoft.com/fwlink/?linkid=14846)。
...
本單元建議的設定適用於大多數的企業，也可部署在其他使用 Windows Server 2003 的現有系統或新裝的系統。Windows Server 2003 的安全性預設設定已歷經多次的評估與測試。有關本節中所討論的預設設定及每一設定的詳細說明等資訊，請參閱同系列指南《Threats and Countermeasures: Security Settings in Windows Server 2003 and Windows XP (英文)》，網址為：[https://go.microsoft.com/fwlink/?LinkId=15159](https://go.microsoft.com/fwlink/?linkid=15159)。不過，下列所建議的設定中，大多是用於比預設安全層級還高的層級。
...
Windows Server 2003 出廠時已設定為安全狀態的預設值。在許多例子中，本單元訂定預設值與其他設定，也為本指南所定義的三個環境強制設定某些的預設值。有關所有預設設定值的詳細資訊，請參閱同系列指南《Thrests and Countermeasures: Security Settings in Windows Server 2003 and Windows XP (英文)》，網址為：[https://go.microsoft.com/fwlink/?LinkId=15159](https://go.microsoft.com/fwlink/?linkid=15159)。
...
「自動更新」系統服務啟用關鍵Windows Update 程式的下載與安裝。為了確保本指南中定義的三種環境具有更高的安裝更新軟體的控制權，請停用這項服務。欲搜尋、下載、和安裝可用的關鍵修正，請到 Windows Update 網站，網址為 <https://v4.windowsupdate.microsoft.com/en/default.asp>。
...
如需更多有關 Windows Server 2003 安全性設定的說明，請參閱： <https://www.microsoft.com/technet/treeview/default.asp?url=/technet/prodtechnol/windowsserver2003/proddocs/standard/615.asp>。
  
如需更多有關 Windows Server 2003 安全性的資訊，請參閱： [https://www.microsoft.com/technet/treeview/default.asp?url=/technet/prodtechnol/windowsserver2003/proddocs/standard/sag\_SEtopnode.asp](https://www.microsoft.com/technet/treeview/default.asp?url=/technet/prodtechnol/windowsserver2003/proddocs/standard/sag_setopnode.asp)。
  
如需更多有關 Windows Server 2003 稽核原則的資訊，請參閱： [//www.microsoft.com/technet/treeview/default.asp?url=/technet/prodtechnol/windowsserver2003/proddocs/standard/APtopnode.asp](https://www.microsoft.com//www.microsoft.com/technet/treeview/default.asp?url=/technet/prodtechnol/windowsserver2003/proddocs/standard/aptopnode.asp)。
  
如需更多有關 Microsoft Operations Manger (MOM) 的資訊，請參閱： <https://www.microsoft.com/mom/>。
  
如需更多有關 Windows Server 2003 與使用者權限指派的資訊，請參閱： [//www.microsoft.com/technet/treeview/default.asp?url=/technet/prodtechnol/windowsserver2003/proddocs/standard/URAtopnode.asp](https://www.microsoft.com//www.microsoft.com/technet/treeview/default.asp?url=/technet/prodtechnol/windowsserver2003/proddocs/standard/uratopnode.asp)。
  
如需更多有關 Windows Server 2003 不同的預設安全性設定的資訊，請參閱： [//www.microsoft.com/technet/treeview/default.asp?url=/technet/prodtechnol/windowsserver2003/proddocs/datacenter/windows\_security\_differences.asp](https://www.microsoft.com/technet/treeview/default.asp?url=/technet/prodtechnol/windowsserver2003/proddocs/datacenter/windows_security_differences.asp)。
  
如需更多有關確保 Windows 2000 終端機服務安全性的說明，請參閱： <https://www.microsoft.com/technet/treeview/default.asp?url=/technet/prodtechnol/win2kts/maintain/optimize/secw2kts.asp>。
  
如需更多有關強化 Windows Server 2003 TCP/IP 堆疊的資訊，請參閱微軟知識庫文件 Q324270，《Harden the TCP/IP Stack Against Denial of Service Attacks in Windows Server 2003 (英文)》，位於： <https://support.microsoft.com/default.aspx?scid=324270>。
  
如需更多有關強化 Windows 通訊端應用程序的說明，請參閱：知識庫文件 Q142641，《Internet Server Unavailable Because of Malicious SYN Attacks (英文)》，位於： <https://support.microsoft.com/default.aspx?scid=142641>。
  
如需更多有關 .adm 檔案定位的資訊，請參閱知識庫文件 Q228460，《Location of ADM (Administrative Template) Files in Windows (英文)》，位於： <https://support.microsoft.com/default.aspx?scid=228460>。
  
如需更多有關自訂安全性設定編輯器使用者介面的資訊，請參閱微軟知識庫文件 214752，《How to Add Custom Registry Settings to Security Configuration Editor (英文)》，位於： <https://support.microsoft.com/default.aspx?scid=214752>。
  
如需更多有關如何在 Windows 建立客戶系統管理範本檔案的資訊，請參閱知識庫文件 323639，《How to:Create Custom Administrative Templates in Windows 2000 (英文)》，位於：<https://support.microsoft.com/default.aspx?scid=kb;en-us;323639>。也可檢視《Implementing Registry-Based Group Policy (英文)》白皮書，位於：[https://www.microsoft.com/WINDOWS2000/techinfo/howitworks/management/rbppaper.asp](https://www.microsoft.com/windows2000/techinfo/howitworks/management/rbppaper.asp)。
  
如需更多有關在包括 Windows 2000 和 Windows NT 4.0 在內的混合網路內，如何能確保區域網路管理員授權階層設定工作的安全，請參閱：知識庫文件 Q305379，《Authentication Problems in Windows 2000 with NTLM 2 Levels Above 2 in a Windows NT 4.0 Domain (英文)》，位於： <https://support.microsoft.com/default.aspx?scid=305379>。
  
如需更多有關區域網路管理員相容性層級的資訊，請參閱：<https://www.microsoft.com/windows2000/techinfo/reskit/en-us/default.asp?url=/windows2000/techinfo/reskit/en-us/regentry/76052.asp>。
  
如需更多有關 NTLMv2 驗證的資訊，請參閱知識庫文件 Q239869，《How to Enable NTLM 2 Authentication for Windows 95/98/2000 and NT (英文)》，位於： <https://support.microsoft.com/default.aspx?scid=239869>。
  
如需更多有關 Windows Server 2003 預設安全性設定的資訊，請參閱： <https://www.microsoft.com/technet/treeview/default.asp?url=/technet/prodtechnol/windowsserver2003/proddocs/datacenter/sys_srv_default_settings.asp>。
  
如需更多有關智慧卡部署的資訊，請參閱：Technet 智慧卡網站，位於： <https://www.microsoft.com/technet/treeview/default.asp?url=/technet/security/topics/smrtcard/default.asp>。
  
如需更多有關 Windows Server 2003 稽核原則的資訊，請參閱： [https://www.microsoft.com/technet/treeview/default.asp?url=/technet/prodtechnol/windowsserver2003/proddocs/standard/APtopnode.asp](https://www.microsoft.com/technet/treeview/default.asp?url=/technet/prodtechnol/windowsserver2003/proddocs/standard/aptopnode.asp)。
  
如需更多有關限制匿名登錄值如何能突破信任，進入 Windows 2000 網域；請參閱： <https://support.microsoft.com/default.aspx?scid=kb;en-us;296405>。
  
如需更多有關停用錯誤報告的資訊，請參閱： <https://www.microsoft.com/technet/treeview/default.asp?url=/technet/prodtechnol/windowsserver2003/proddocs/standard/sysdm_advancd_exception_reporting.asp>。
  
如需更多有關 Windows Corporate 錯誤報告的資訊，請參閱： [https://www.google.co.uk/url?sa=U&start=1&q=https://www.microsoft.com/technet/prodtechnol/office/officexp/reskit/html/appa19.asp&e=7370](https://www.google.co.uk/url?sa=u&start=1&q=https://www.microsoft.com/technet/prodtechnol/office/officexp/reskit/html/appa19.asp&e=7370)。
