...
-   《Windows Server 2003 部署套件》的＜[設計公開金鑰基礎架構](https://go.microsoft.com/fwlink/?linkid=4735)＞一章，網址是：https://go.microsoft.com/fwlink/?LinkId=4735。
  
-   如需 PKI 概念和 Windows 2000 憑證服務功能的一般介紹，請參閱＜[*Windows 2000 公開金鑰基礎結構簡介*](https://www.microsoft.com/technet/archive/windows2000serv/evaluate/featfunc/pkiintro.mspx)＞(英文)，網址是：https://www.microsoft.com/technet/archive/windows2000serv/evaluate/  
    featfunc/pkiintro.mspx。
  
-   如需 Windows Server 2003 和 Windows XP PKI 中增強型 PKI 功能的詳細說明，請參閱＜[*Windows XP Professional 與 Windows Server 2003 中的 PKI 增強功能*](https://www.microsoft.com/technet/prodtechnol/winxppro/plan/pkienh.mspx)＞(英文)，網址是：https://www.microsoft.com/technet/prodtechnol/winxppro/plan/pkienh.mspx。
  
-   Windows 2003 Server 企業版[公開金鑰基礎結構](https://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/depkit/b1ee9920-d7ef-4ce5-b63c-3661c72e0f0b.mspx)產品文件討論了「憑證服務」的重要概念和管理工作，網址是：https://www.microsoft.com/technet/prodtechnol/windowsserver2003  
    /library/DepKit/B1EE9920-D7EF-4CE5-B63C-3661C72E0F0B.mspx
  
-   如需有關編寫憑證實施準則的詳細資訊，請參閱 RFC2527＜[*網際網路 X.509 公開金鑰基礎結構憑證原則與憑證實施架構*](https://www.ietf.org/rfc/rfc2527.txt)＞(英文)，網址是：www.ietf.org/rfc/rfc2527.txt。
  
-   如需 CPS 的範例，請參閱 [VeriSign 憑證實施準則 (CPS)](https://www.verisign.com/repository/cps/) 頁面，網址是：www.verisign.com/repository/CPS/。
  
-   如需憑證原則 OID 與 CPS URL 如何編碼到憑證中的詳細資料，請參閱 RFC 3280＜[*網際網路 X.509 公開金鑰基礎結構憑證與 CRL 設定檔*](https://www.ietf.org/rfc/rfc3280.txt)＞，網址是：www.ietf.org/rfc/rfc3280.txt。
  
-   如需對於合格子關係的詳細說明，請參閱技術文件《[*使用 Windows Server 2003 規劃與實作交互憑證或合格的分類*](https://www.microsoft.com/technet/prodtechnol/windowsserver2003/technologies/security/ws03qswp.mspx)》，網址是：https://www.microsoft.com/technet/prodtechnol/windowsserver2003/  
    technologies/security/ws03qswp.mspx。
  
-   如需企業 CA 和獨立 CA 之差異的詳細說明，請參閱「憑證服務」產品文件中的＜[憑證授權單位](https://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/serverhelp/f15bc83f-43b0-4b09-9bb5-c668e901b864.mspx)＞一節，網址是：https://www.microsoft.com/technet/prodtechnol/windowsserver2003/  
    library/ServerHelp/f15bc83f-43b0-4b09-9bb5-c668e901b864.mspx。
  
-   如需在 Windows Server 2003 內啟用匿名 LDAP 存取的更多資訊，請參閱 Microsoft 知識庫文件編號 Q326690，《[對 Active Directory 的匿名 LDAP 操作在 Windows Server 2003 網域控制站是停用的](https://support.microsoft.com/default.aspx?scid=326690)》(英文)，網址是：https://support.microsoft.com/default.aspx?scid=326690。
  
-   如需憑證撤銷的相關詳細討論，請參閱《[*疑難排解憑證狀態與撤銷*](https://www.microsoft.com/technet/prodtechnol/winxppro/support/tshtcrl.mspx)》(英文)，網址是：https://www.microsoft.com/technet/prodtechnol/winxppro/support/tshtcrl.mspx。關於 CDP 延伸的章節是特別針對本章中的一些討論。
  
-   有關安裝和使用「憑證服務」網頁註冊頁面的詳細資訊，請參閱 [Windows Server 2003 的產品說明文件](https://www.microsoft.com/windowsserver2003/proddoc/default.mspx)網頁 (英文)，網址是：https://www.microsoft.com/windowsserver2003/proddoc/default.mspx；然後搜尋 "Security"、"Public Key Infrastructure"、"Certificate Services"、"How to..." 與 "Set up a Certification Authority"。
  
-   如需「憑證範本」的詳細指南，請參閱《[*實作與管理 Windows Server 2003 中的憑證範本*](https://www.microsoft.com/technet/prodtechnol/windowsserver2003/technologies/security/ws03crtm.mspx)》(英文)，網址是：https://www.microsoft.com/technet/prodtechnol/windowsserver2003/  
    technologies/security/ws03crtm.mspx。
  
-   所有內建憑證範本的說明都可在 Windows Server 2003 產品文件的＜[疑難排解](https://www.microsoft.com/technet/prodtechnol/windowsserver2003/library/serverhelp/8dd5dd9e-d163-4260-bc9d-3286af55bad3.mspx)＞一節 (英文) 中找到，網址是：https://www.microsoft.com/technet/prodtechnol/windowsserver2003/  
    library/ServerHelp/8dd5dd9e-d163-4260-bc9d-3286af55bad3.mspx。
  
-   如需憑證自動註冊的更多資訊，請參閱《[*Windows Server 2003 中的憑證自動註冊*](https://www.microsoft.com/technet/prodtechnol/windowsserver2003/technologies/security/autoenro.mspx)》(英文)，網址是：https://www.microsoft.com/technet/prodtechnol/windowsserver2003/  
    technologies/security/autoenro.mspx。
  
-   如需 Windows Server 2003 內有關金鑰保存與管理的資訊，請參閱技術文件《[*Windows Server 2003 中的金鑰保存與管理*](https://www.microsoft.com/technet/prodtechnol/windowsserver2003/technologies/security/kyacws03.mspx)》(英文)，網址是：https://www.microsoft.com/technet/prodtechnol/windowsserver2003/  
    technologies/security/kyacws03.mspx。
  
-   如需進階憑證註冊案例的更多資訊，請參閱文件《[*進階憑證註冊與管理*](https://www.microsoft.com/technet/prodtechnol/windowsserver2003/technologies/security/advcert.mspx)》(英文)，網址是：https://www.microsoft.com/technet/prodtechnol/windowsserver2003/  
    technologies/security/advcert.mspx。
  
-   如需使用註冊網頁進行憑證註冊的有關資訊，請參閱文件《[*設定與疑難排解 Windows 2000 及 Windows Server 2003 憑證服務 Web 註冊*](https://www.microsoft.com/technet/prodtechnol/windowsserver2003/technologies/security/webenroll.mspx)》(英文)，網址是：https://www.microsoft.com/technet/prodtechnol/windowsserver2003/  
    technologies/security/webenroll.mspx。
  
-   如需實作 Windows Server 2003 PKI 的詳細資訊，請參閱文件《[實作 Microsoft Windows Server 2003 公開金鑰基礎結構的最佳作法](https://www.microsoft.com/technet/prodtechnol/windowsserver2003/technologies/security/ws3pkibp.mspx)》(英文)，網址是：https://www.microsoft.com/technet/prodtechnol/windowsserver2003/  
    technologies/security/ws3pkibp.mspx。
  
-   如需其他實作資訊，請到 [Windows 伺服器系統參考架構](https://www.microsoft.com/resources/documentation/msa/2/all/solution/en-us/msa20ik/vmhtm1.mspx)頁面下載《Microsoft 系統架構 2.0 版實作指南》，網址是：https://www.microsoft.com/resources/documentation/msa/2/all/solution/en-us/msa20ik/vmhtm1.mspx.
