...
-   Microsoft Windows Server System 網站上的＜[設計管理環境：執行群組原則部署](https://go.microsoft.com/fwlink/?linkid=35498)＞(英文)，網址是：https://go.microsoft.com/fwlink/?linkid=35498
...
-   Microsoft 技術支援服務網站上的 [Microsoft 知識庫文件編號 322756](https://go.microsoft.com/fwlink/?linkid=36365)，網址是：https://go.microsoft.com/fwlink/?linkid=36365
...
-   Microsoft Windows Small Business Server 2003, Premium Edition
    ...
    **注意：**若要取得這些 Hotfix 以及更多資訊，請參閱下列文件：
    ...
    -   Microsoft 技術支援服務網站上的 [Microsoft 知識庫文件編號 842933](https://go.microsoft.com/fwlink/?linkid=35474)，網址是：https://go.microsoft.com/fwlink/?linkid=35474

    -   Microsoft 技術支援服務網站上的 [Microsoft 知識庫文件編號 872769](https://go.microsoft.com/fwlink/?linkid=35477)，網址是：https://go.microsoft.com/fwlink/?linkid=35477
...
11. 對於將群組原則套用到已安裝 Windows XP SP2 的電腦上之 GPO，請對每一 GPO 重複這些步驟。
    ...
    **注意：**若要更新使用 Active Directory 及 Windows XP SP1 的網路環境的 GPO，Microsoft 建議您使用可免費下載的群組原則管理主控台。如需更多資訊，請參閱下列文件：
    ...
    -   Microsoft Windows Server System 網站上的《[以群組原則管理主控台管理企業](https://www.microsoft.com/taiwan/windowsserver2003/gpmc/default.mspx)》，網址是：https://www.microsoft.com/taiwan/windowsserver2003/gpmc/default.mspx
...
2.  在 \[開啟\] 方塊，鍵入 **cmd**，然後按一下 \[確定\]。
    ...
    **注意：**若需使用 GPUpdate 時可用選項的完整描述，請參閱下列文件：
    ...
    -   Microsoft 技術支援服務網站上的 [Microsoft 知識庫文件編號 298444](https://go.microsoft.com/fwlink/?linkid=35504)，網址是：https://go.microsoft.com/fwlink/?linkid=35504
...
3.  確認資訊安全中心啟動。
    ...
    **注意：**若您的設定值沒有套用，您必須排解群組原則應用程式的問題。若要排解群組原則應用程式的問題，請參閱下列文件：
    ...
    -   Microsoft 下載中心網站上的《[Windows Server 2003 群組原則的疑難排解](https://go.microsoft.com/fwlink/?linkid=35481)》(英文)，網址是：https://go.microsoft.com/fwlink/?linkid=35481
...
-   Microsoft TechNet 網站上的＜[網路相關群組原則設定的網路判斷行為](https://www.microsoft.com/taiwan/technet/community/columns/cableguy/cg0504.mspx)＞，網址是：https://www.microsoft.com/taiwan/technet/community/columns/cableguy/cg0504.mspx
...
9.  按兩下 \[Windows 防火牆: 允許經過驗證的 IPSec 繞道\]。
    ...
    **表 1   針對企業的 \[允許經過驗證的 IPSec 繞道\] 設定值**
    ...
    MSDN 網站上的＜<a href="https://go.microsoft.com/fwlink/?linkid=35503">安全性描述元的定義語言</a>＞(英文)，網址是：https://go.microsoft.com/fwlink/?linkid=35503</td>
    </tr>
    <tr class="odd">
...
4.  鍵入您要以下列語法封鎖或啟用的連接埠資訊：
    ...
    **連接埠:傳輸:範圍:狀態:名稱**
    ...
    -   Microsoft 技術支援服務網站上的 [Microsoft 知識庫文件編號 164015](https://go.microsoft.com/fwlink/?linkid=36370)，網址是：https://go.microsoft.com/fwlink/?linkid=36370
...
-   Microsoft Windows XP 網站上的＜[網際網路控制訊息通訊協定 (ICMP)](https://go.microsoft.com/fwlink/?linkid=35499)＞(英文)，網址是：https://go.microsoft.com/fwlink/?linkid=35499
...
-   Microsoft TechNet 網站上的《[Microsoft Windows XP Service Pack 2 功能變更](https://go.microsoft.com/fwlink/?linkid=35487)》(英文)，網址是：https://go.microsoft.com/fwlink/?linkid=35487
...
-   Microsoft TechNet 網站上的《[在管理環境中使用 Windows XP Professional Service Pack 2：控制網際網路通訊](https://go.microsoft.com/fwlink/?linkid=35489)》(英文)，網址是：https://go.microsoft.com/fwlink/?LinkId=35489
...
-   Microsoft TechNet 網站上的＜[減少 RPC 與 DCOM 弱點的最佳實務範例](https://go.microsoft.com/fwlink/?linkid=36371)＞(英文)，網址是：https://go.microsoft.com/fwlink/?linkid=36371
...
-   ＜ [Windows XP Service Pack 2 的 Com+ 修正項目](https://support.microsoft.com/default.aspx?scid=kb;en-us;838211)＞(英文)，網址是：https://support.microsoft.com/default.aspx?scid=kb;en-us;838211
...
9.  按兩下 \[DCOM: 在 Security Descriptor Definition Language (SDDL) 語法中的電腦存取限制\]。
    ...
    **注意：**如需 SDDL 的更多資訊，請參閱下列文件：
    ...
    -   MSDN 網站上的＜[安全性描述元的定義語言](https://go.microsoft.com/fwlink/?linkid=35503)＞(英文)，網址是：https://go.microsoft.com/fwlink/?linkid=35503
...
-   Microsoft 技術支援服務網站上的 [Microsoft 知識庫文件編號 256986](https://go.microsoft.com/fwlink/?linkid=35500)，網址是：https://go.microsoft.com/fwlink/?linkid=35500
...
-   Microsoft TechNet 網站上的＜[Microsoft Windows XP Service Pack 2 功能的變更，第二部分：網路保護技術](https://go.microsoft.com/fwlink/?linkid=35486)＞(英文)，網址是：https://go.microsoft.com/fwlink/?linkid=35486
  
-   Microsoft TechNet 網站上的＜[使用群組原則管理 Windows XP Service Pack 2](https://go.microsoft.com/fwlink/?linkid=35485)＞(英文)，網址是：https://go.microsoft.com/fwlink/?linkid=35485
  
-   Microsoft 技術支援服務網站上的＜[對管理群組原則系統管理範本 (.adm) 檔案的建議](https://go.microsoft.com/fwlink/?linkid=35502)＞(英文)，網址是：https://go.microsoft.com/fwlink/?linkid=35502
...
-   Microsoft TechNet 網站上的＜[使用群組原則部署 Windows XP Service Pack 2 (SP2)](https://go.microsoft.com/fwlink/?linkid=35501)＞(英文)，網址是：https://go.microsoft.com/fwlink/?linkid=35501
