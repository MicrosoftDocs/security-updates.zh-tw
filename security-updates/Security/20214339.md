...
本解決方案提供的指令碼和支援檔案必須遵循 Microsoft 標準使用條款。條款位於 [Microsoft – 使用條款資訊](https://www.microsoft.com/info/cpyright.htm) (英文) 頁面，網址是：https://www.microsoft.com/info/cpyright.htm。
