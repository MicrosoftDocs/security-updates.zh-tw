...
本文建議僅適用於執行 Windows 2000 Professional Service Pack 4 的電腦，因其屬於 Active Directory 網域的成員。如果 Service Pack 4 並未安裝於特定的電腦，或者您不確定是否已安裝，請造訪下列 Microsoft網站 [Windows Update (英文)](https://go.microsoft.com/fwlink/?linkid=22630) 頁面：[https://go.microsoft.com/fwlink/?LinkID=22630](https://go.microsoft.com/fwlink/?linkid=22630) 搜尋可使用的更新。如果 Service Pack 4 列出需更新的項目，在進行本文建議的程序之前，請先安裝更新程式。
...
執行這些需求極具挑戰性，但是使用具有標誌認證應用程式的 Windows 2000 Professional，將使執行變得容易許多。沒有系統管理權限的使用者，將無法正確執行尚未通過標誌驗證的應用程式。如果要搜尋標誌認證應用程式的清單，請在位於下列 Microsoft 網站上 [https://go.microsoft.com/fwlink/?LinkId=22382](https://go.microsoft.com/fwlink/?linkid=22382) 的 [Windows Catalog (英文)](https://go.microsoft.com/fwlink/?linkid=22382) 頁面，搜尋標示為 Designed for Windows 2000 的軟體。
...
-   **若要下載安全性範本**
    ...
    1.  從成員電腦中，開啟網頁瀏覽器，巡覽至 Microsoft Download Center (英文) 網站 [https://go.microsoft.com/fwlink/?LinkId=22380](https://go.microsoft.com/fwlink/?linkid=22380) 的《[Windows 2000 Security Hardening Guide (英文)](https://go.microsoft.com/fwlink/?linkid=22380)》。
...
-   **若要為桌上型電腦建立 GPO**
    ...
    4.  鍵入 **2000 Desktop 原則** 為 GPO 命名，再按一下 \[編輯\]。
        ...
        ![Desktop OU 內容](images/Cc875838.sec_win2000_pro_server_env_05(zh-tw,TechNet.10).jpg)
...
-   [Symantec](https://www.symantec.com/microsoft)，網站位於：<https://www.symantec.com/microsoft> (英文)。

-   [McAfee Security](https://www.networkassociates.com/us/products/home.htm)，網站位於：<https://www.networkassociates.com/us/products/home.htm> (英文)。

-   [ZoneAlarm](https://www.zonelabs.com/store/content/home.jsp)，網站位於：<https://www.zonelabs.com/store/content/home.jsp> (英文)。

-   [Tiny Personal Firewall](https://www.tinysoftware.com/home/tiny2?la=en)，網站位於：[https://www.tinysoftware.com/home/tiny2?la=EN](https://www.tinysoftware.com/home/tiny2?la=en) (英文)。

-   [Internet Security Systems](https://blackice.iss.net/)' BlackICE PC Protection，網站位於：[https://blackice.iss.net/](https://blackice.iss.net/.) (英文)。
...
如果您要尋找更多有關軟體廠商提供的防毒軟體與 Windows 2000 相容性的詳細資訊，請參閱 Microsoft 網站上的《[List of Antivirus Software Vendors (英文)](https://go.microsoft.com/fwlink/?linkid=22381)》頁面，網址是 [https://go.microsoft.com/fwlink/?LinkId=22381](https://go.microsoft.com/fwlink/?linkid=22381)。
...
-   **若要檢查電腦的檔案系統類型**
    ...
    3.  檔案系統應該是 NTFS。如果不是，可以使用 convert.exe 公用程式，將 FAT6 或 FAT32 轉換成 NTFS。
        ...
        ![本機磁碟 (C:)](images/Cc875838.sec_win2000_pro_server_env_13(zh-tw,TechNet.10).jpg)
...
-   《[Windows 2000 Security Hardening Guide (英文)](https://go.microsoft.com/fwlink/?linkid=22380)》，請造訪下列 Microsoft 網站下載完整的指南： [https://go.microsoft.com/fwlink/?LinkId=22380](https://go.microsoft.com/fwlink/?linkid=22380)

-   《[Guide to Securing Windows XP in Small and Medium Businesses (英文)](https://go.microsoft.com/fwlink/?linkid=19453)》網頁，位於下列 Microsoft 網站 <https://go.microsoft.com/fwlink/?linkid=19453>。

如需更多有關 Windows 2000 安全性的相關主題的詳細資訊，請參閱下列文件：

-   [Threats and Countermeasures Guide (英文)](https://go.microsoft.com/fwlink/?linkid=15159) 網頁，位於下列 Microsoft 網站 [https://go.microsoft.com/fwlink/?LinkID=15159](https://go.microsoft.com/fwlink/?linkid=15159)。
